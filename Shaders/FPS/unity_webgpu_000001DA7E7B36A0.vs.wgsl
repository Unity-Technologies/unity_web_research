...
fn main_1() {
  ...
  let x_504 : f32 = u_xlat0.y;
  u_xlat21 = (x_502 * x_504);
  let x_507 : f32 = u_xlat0.x;
  let x_509 : f32 = u_xlat0.x;
  let x_511 : f32 = u_xlat21;
  u_xlat21 = ((x_507 * x_509) + -(x_511));
  let x_514 : vec4<f32> = u_xlat0;
  let x_516 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec4<f32>(x_514.y, x_514.z, x_514.z, x_514.x) * vec4<f32>(x_516.x, x_516.y, x_516.z, x_516.z));
  let x_520 : vec4<f32> = x_185.unity_SHBr;
  let x_521 : vec4<f32> = u_xlat1;
  u_xlat0.x = dot(x_520, x_521);
  let x_525 : vec4<f32> = x_185.unity_SHBg;
  let x_526 : vec4<f32> = u_xlat1;
  u_xlat0.y = dot(x_525, x_526);
  let x_530 : vec4<f32> = x_185.unity_SHBb;
  let x_531 : vec4<f32> = u_xlat1;
  u_xlat0.z = dot(x_530, x_531);
  let x_536 : vec4<f32> = x_185.unity_SHC;
  let x_538 : f32 = u_xlat21;
  let x_541 : vec4<f32> = u_xlat0;
  vs_TEXCOORD5 = ((vec3<f32>(x_536.x, x_536.y, x_536.z) * vec3<f32>(x_538, x_538, x_538)) + vec3<f32>(x_541.x, x_541.y, x_541.z));
