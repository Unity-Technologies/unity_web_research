...
fn main_1() {
  ...
  let x_1128 : vec2<f32> = vs_TEXCOORD0;
  let x_1131 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1135 : vec4<f32> = x_26.x_Dithering_Coords;
  ...
  let x_1147 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1145.x, x_1145.y));
  u_xlat1.x = x_1147.w;
  let x_1151 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1151 * 2.0f) + -1.0f);
  let x_1156 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1156 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1162 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1162, 0.0f, 1.0f);
  let x_1166 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1166 * 2.0f) + -1.0f);
  let x_1171 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1171)) + 1.0f);
  let x_1177 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1177);
  let x_1181 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1181) + 1.0f);
  let x_1186 : f32 = u_xlat1.x;
  let x_1188 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1186 * x_1188);
  let x_1191 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1191.x, x_1191.y, x_1191.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1196 : vec4<f32> = u_xlat0;
  let x_1201 : vec3<f32> = max(abs(vec3<f32>(x_1196.x, x_1196.y, x_1196.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1202 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1201.x, x_1201.y, x_1201.z, x_1202.w);
  let x_1204 : vec4<f32> = u_xlat2;
  let x_1206 : vec3<f32> = log2(vec3<f32>(x_1204.x, x_1204.y, x_1204.z));
  let x_1207 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1206.x, x_1206.y, x_1206.z, x_1207.w);
  let x_1209 : vec4<f32> = u_xlat2;
  let x_1213 : vec3<f32> = (vec3<f32>(x_1209.x, x_1209.y, x_1209.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1214 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1213.x, x_1213.y, x_1213.z, x_1214.w);
  let x_1216 : vec4<f32> = u_xlat2;
  let x_1218 : vec3<f32> = exp2(vec3<f32>(x_1216.x, x_1216.y, x_1216.z));
  let x_1219 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1218.x, x_1218.y, x_1218.z, x_1219.w);
  let x_1221 : vec4<f32> = u_xlat2;
  let x_1228 : vec3<f32> = ((vec3<f32>(x_1221.x, x_1221.y, x_1221.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1229 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1228.x, x_1228.y, x_1228.z, x_1229.w);
  let x_1236 : vec4<f32> = u_xlat0;
  let x_1239 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1236.x, x_1236.y, x_1236.z, x_1236.x));
  ...
  u_xlat0.y = x_1263;
  let x_1267 : bool = u_xlatb0.z;
  if (x_1267) {
    let x_1272 : f32 = u_xlat11.z;
    x_1268 = x_1272;
  } else {
  ...
  let x_1285 : vec3<f32> = ((vec3<f32>(x_1278.x, x_1278.x, x_1278.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1283.x, x_1283.y, x_1283.z));
  let x_1286 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1285.x, x_1285.y, x_1285.z, x_1286.w);
  let x_1288 : vec4<f32> = u_xlat0;
  let x_1292 : vec3<f32> = (vec3<f32>(x_1288.x, x_1288.y, x_1288.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1293 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1292.x, x_1292.y, x_1292.z, x_1293.w);
  let x_1295 : vec4<f32> = u_xlat0;
  let x_1299 : vec3<f32> = (vec3<f32>(x_1295.x, x_1295.y, x_1295.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1300 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1299.x, x_1299.y, x_1299.z, x_1300.w);
  let x_1302 : vec4<f32> = u_xlat2;
  let x_1306 : vec3<f32> = (vec3<f32>(x_1302.x, x_1302.y, x_1302.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1324 : vec3<f32> = (vec3<f32>(x_1320.x, x_1320.y, x_1320.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
