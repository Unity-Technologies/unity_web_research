...
void main()
{
    ...
    u_xlat19 = u_xlat2.y * unity_MatrixV[1].z;
    u_xlat19 = unity_MatrixV[0].z * u_xlat2.x + u_xlat19;
    u_xlat19 = unity_MatrixV[2].z * u_xlat2.z + u_xlat19;
    u_xlat19 = unity_MatrixV[3].z * u_xlat2.w + u_xlat19;
