...
fn main_1() {
  ...
  u_xlat0 = ((vec3<f32>(x_1258.x, x_1258.y, x_1258.z) * x_1260) + x_1262);
  let x_1269 : vec4<f32> = vs_TEXCOORD0;
  let x_1271 : vec4<f32> = textureSample(x_EmissionMap, sampler_EmissionMap, vec2<f32>(x_1269.x, x_1269.y));
  u_xlat1 = vec3<f32>(x_1271.x, x_1271.y, x_1271.z);
  let x_1275 : vec3<f32> = u_xlat1;
  let x_1278 : vec4<f32> = x_33.x_EmissionColor;
  let x_1281 : vec3<f32> = u_xlat0;
  let x_1282 : vec3<f32> = ((x_1275 * vec3<f32>(x_1278.x, x_1278.y, x_1278.z)) + x_1281);
