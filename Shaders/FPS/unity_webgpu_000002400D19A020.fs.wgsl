...
fn main_1() {
  ...
  let x_1290 : vec3<f32> = ((vec3<f32>(x_1283.x, x_1283.y, x_1283.z) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1320 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1322 : vec3<f32> = (vec3<f32>(x_1315.x, x_1315.y, x_1315.z) * vec3<f32>(x_1320.y, x_1320.y, x_1320.y));
  let x_1323 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1322.x, x_1322.y, x_1322.z, x_1323.w);
  let x_1326 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat1.x = (x_1326 * 0.5f);
  let x_1329 : vec4<f32> = u_xlat0;
  let x_1332 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1335 : vec4<f32> = u_xlat1;
  let x_1337 : vec3<f32> = ((vec3<f32>(x_1329.x, x_1329.y, x_1329.z) * vec3<f32>(x_1332.x, x_1332.x, x_1332.x)) + vec3<f32>(x_1335.x, x_1335.x, x_1335.x));
  let x_1338 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1337.x, x_1337.y, x_1337.z, x_1338.w);
  let x_1348 : vec4<f32> = u_xlat0;
  let x_1350 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1348.x, x_1348.y, x_1348.z));
  let x_1351 : vec3<f32> = vec3<f32>(x_1350.x, x_1350.y, x_1350.z);
  ...
  let x_1511 : vec3<f32> = ((vec3<f32>(x_1504.x, x_1504.x, x_1504.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1509.x, x_1509.y, x_1509.z));
  let x_1512 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1511.x, x_1511.y, x_1511.z, x_1512.w);
  let x_1514 : vec4<f32> = u_xlat0;
  let x_1518 : vec3<f32> = (vec3<f32>(x_1514.x, x_1514.y, x_1514.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1519 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1518.x, x_1518.y, x_1518.z, x_1519.w);
  let x_1521 : vec4<f32> = u_xlat0;
  let x_1525 : vec3<f32> = (vec3<f32>(x_1521.x, x_1521.y, x_1521.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1526 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1525.x, x_1525.y, x_1525.z, x_1526.w);
  let x_1528 : vec4<f32> = u_xlat2;
  let x_1532 : vec3<f32> = (vec3<f32>(x_1528.x, x_1528.y, x_1528.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1533 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1532.x, x_1532.y, x_1532.z, x_1533.w);
  let x_1535 : vec4<f32> = u_xlat2;
  let x_1538 : vec3<f32> = max(abs(vec3<f32>(x_1535.x, x_1535.y, x_1535.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1539 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1538.x, x_1538.y, x_1538.z, x_1539.w);
  let x_1541 : vec4<f32> = u_xlat2;
  let x_1543 : vec3<f32> = log2(vec3<f32>(x_1541.x, x_1541.y, x_1541.z));
  let x_1544 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1543.x, x_1543.y, x_1543.z, x_1544.w);
  let x_1546 : vec4<f32> = u_xlat2;
  let x_1550 : vec3<f32> = (vec3<f32>(x_1546.x, x_1546.y, x_1546.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1562 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1560.x, x_1560.y, x_1560.z, x_1560.x));
  u_xlatb0 = vec3<bool>(x_1562.x, x_1562.y, x_1562.z);
  ...
  let x_1576 : f32 = x_1568;
  SV_Target0.x = x_1576;
  let x_1580 : bool = u_xlatb0.y;
  if (x_1580) {
    let x_1585 : f32 = u_xlat1.y;
    x_1581 = x_1585;
  } else {
    let x_1588 : f32 = u_xlat2.y;
    x_1581 = x_1588;
  }
  let x_1589 : f32 = x_1581;
  SV_Target0.y = x_1589;
  let x_1592 : bool = u_xlatb0.z;
  if (x_1592) {
    let x_1597 : f32 = u_xlat1.z;
    x_1593 = x_1597;
  } else {
