...
void main()
{
    ...
    vec4 txVec0 = vec4(u_xlat12.xyz,u_xlat33);
    u_xlat12.x = texture(samplerCubeShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec0);
    ...
    u_xlat12.x = texture(samplerCube(_LightTexture0, sampler_LightTexture0), u_xlat8.xyz).w;
    u_xlat2.x = u_xlat12.x * u_xlat2.x;
