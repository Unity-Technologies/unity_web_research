...
@group(0) @binding(0) var<uniform> x_87 : PGlobals;
...
fn main_1() {
  ...
  u_xlat6 = (x_39 * 66.012649536f);
  let x_44 : f32 = u_xlat0.x;
  let x_46 : f32 = u_xlat6;
  u_xlat6 = ((x_44 * 66.012649536f) + -(x_46));
  ...
  u_xlat6 = dot(vec2<f32>(x_65.x, x_65.y), vec2<f32>(1855.914672852f, 14655.830078125f));
