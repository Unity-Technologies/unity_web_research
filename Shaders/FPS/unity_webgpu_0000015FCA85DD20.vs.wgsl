...
@group(0) @binding(2) var<uniform> x_48 : VGlobals;
...
fn main_1() {
  ...
  let x_45 : vec2<f32> = u_xlat0;
  let x_51 : f32 = x_48.x_RenderViewportScaleFactor;
  vs_TEXCOORD1 = (x_45 * vec2<f32>(x_51, x_51));
  let x_56 : vec3<f32> = in_POSITION0;
  vs_TEXCOORD0 = ((vec2<f32>(x_56.x, x_56.y) * vec2<f32>(0.5f, -0.5f)) + vec2<f32>(0.5f, 0.5f));
  return;
}
