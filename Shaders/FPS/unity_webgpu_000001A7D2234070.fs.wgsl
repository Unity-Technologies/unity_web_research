...
fn main_1() {
  ...
  if (x_987) {
    ...
    SV_Target0.w = ((x_1117 * x_1119) + 1.0f);
  } else {
    let x_1130 : vec2<f32> = u_xlat21;
    let x_1131 : vec4<f32> = textureSample(x_Vignette_Mask, sampler_Vignette_Mask, x_1130);
    u_xlat1.x = x_1131.w;
    let x_1135 : f32 = u_xlat1.x;
    u_xlat1.z = (x_1135 + 0.055f);
    let x_1139 : vec3<f32> = u_xlat1;
    let x_1144 : vec2<f32> = (vec2<f32>(x_1139.x, x_1139.z) * vec2<f32>(0.077399381f, 0.947867334f));
    let x_1145 : vec3<f32> = u_xlat11;
    u_xlat11 = vec3<f32>(x_1144.x, x_1144.y, x_1145.z);
    let x_1148 : f32 = u_xlat11.y;
    u_xlat21.x = max(abs(x_1148), 1.1920929e-07f);
    let x_1154 : f32 = u_xlat21.x;
    u_xlat21.x = log2(x_1154);
    let x_1158 : f32 = u_xlat21.x;
    u_xlat21.x = (x_1158 * 2.400000095f);
    let x_1163 : f32 = u_xlat21.x;
    u_xlat21.x = exp2(x_1163);
    let x_1168 : f32 = u_xlat1.x;
    u_xlatb1 = (0.040449999f >= x_1168);
    let x_1170 : bool = u_xlatb1;
    if (x_1170) {
      let x_1175 : f32 = u_xlat11.x;
      x_1171 = x_1175;
    } else {
      let x_1178 : f32 = u_xlat21.x;
      x_1171 = x_1178;
    }
    let x_1179 : f32 = x_1171;
    u_xlat1.x = x_1179;
    let x_1182 : vec3<f32> = x_26.x_Vignette_Color;
    u_xlat11 = (-(x_1182) + vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1185 : vec3<f32> = u_xlat1;
    let x_1187 : vec3<f32> = u_xlat11;
    let x_1190 : vec3<f32> = x_26.x_Vignette_Color;
    u_xlat11 = ((vec3<f32>(x_1185.x, x_1185.x, x_1185.x) * x_1187) + x_1190);
    let x_1192 : vec4<f32> = u_xlat0;
    let x_1194 : vec3<f32> = u_xlat11;
    let x_1196 : vec4<f32> = u_xlat0;
    u_xlat11 = ((vec3<f32>(x_1192.x, x_1192.y, x_1192.z) * x_1194) + -(vec3<f32>(x_1196.x, x_1196.y, x_1196.z)));
    let x_1202 : f32 = x_26.x_Vignette_Opacity;
    let x_1204 : vec3<f32> = u_xlat11;
    let x_1206 : vec4<f32> = u_xlat0;
    u_xlat2 = ((vec3<f32>(x_1202, x_1202, x_1202) * x_1204) + vec3<f32>(x_1206.x, x_1206.y, x_1206.z));
    let x_1210 : f32 = u_xlat0.w;
    u_xlat0.x = (x_1210 + -1.0f);
    let x_1214 : f32 = u_xlat1.x;
    let x_1216 : f32 = u_xlat0.x;
    SV_Target0.w = ((x_1214 * x_1216) + 1.0f);
  }
  let x_1221 : vec2<f32> = vs_TEXCOORD1;
  let x_1224 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1228 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1230 : vec2<f32> = ((x_1221 * vec2<f32>(x_1224.x, x_1224.y)) + vec2<f32>(x_1228.z, x_1228.w));
  let x_1231 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1230.x, x_1230.y, x_1231.z, x_1231.w);
  let x_1238 : vec4<f32> = u_xlat0;
  let x_1240 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1238.x, x_1238.y));
  ...
  u_xlat1 = clamp(x_1245, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1250 : vec3<f32> = u_xlat1;
  u_xlat30 = dot(x_1250, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1256 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1256);
  let x_1260 : f32 = x_26.x_Grain_Params1.x;
  let x_1261 : f32 = u_xlat30;
  u_xlat30 = ((x_1260 * -(x_1261)) + 1.0f);
  ...
  u_xlat0 = vec4<f32>(x_1268.x, x_1268.y, x_1268.z, x_1269.w);
  let x_1271 : vec4<f32> = u_xlat0;
  let x_1274 : f32 = x_26.x_Grain_Params1.y;
  let x_1276 : f32 = x_26.x_Grain_Params1.y;
  let x_1278 : f32 = x_26.x_Grain_Params1.y;
  let x_1280 : vec3<f32> = (vec3<f32>(x_1271.x, x_1271.y, x_1271.z) * vec3<f32>(x_1274, x_1276, x_1278));
  ...
  let x_1288 : vec3<f32> = u_xlat2;
  let x_1289 : vec3<f32> = ((vec3<f32>(x_1283.x, x_1283.y, x_1283.z) * vec3<f32>(x_1285, x_1285, x_1285)) + x_1288);
  let x_1290 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1289.x, x_1289.y, x_1289.z, x_1290.w);
  let x_1292 : vec2<f32> = vs_TEXCOORD0;
  let x_1295 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1299 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1301 : vec2<f32> = ((x_1292 * vec2<f32>(x_1295.x, x_1295.y)) + vec2<f32>(x_1299.z, x_1299.w));
  let x_1302 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1301.x, x_1301.y, x_1302.z);
  let x_1309 : vec3<f32> = u_xlat1;
  let x_1311 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1309.x, x_1309.y));
  u_xlat30 = x_1311.w;
  let x_1313 : f32 = u_xlat30;
  u_xlat30 = ((x_1313 * 2.0f) + -1.0f);
  ...
  u_xlat30 = (-(abs(x_1330)) + 1.0f);
  let x_1334 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1334);
  let x_1336 : f32 = u_xlat30;
  u_xlat30 = (-(x_1336) + 1.0f);
  let x_1339 : f32 = u_xlat30;
  let x_1341 : f32 = u_xlat1.x;
  u_xlat30 = (x_1339 * x_1341);
  let x_1343 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1343.x, x_1343.y, x_1343.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  u_xlat2 = log2(x_1353);
  let x_1355 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1355 * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1359 : vec3<f32> = u_xlat2;
  u_xlat2 = exp2(x_1359);
  let x_1361 : vec3<f32> = u_xlat2;
  u_xlat2 = ((x_1361 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  ...
  let x_1421 : vec3<f32> = ((vec3<f32>(x_1414, x_1414, x_1414) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1419.x, x_1419.y, x_1419.z));
  ...
  u_xlat2 = (vec3<f32>(x_1428.x, x_1428.y, x_1428.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1432 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1432 * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1435 : vec3<f32> = u_xlat2;
  u_xlat2 = max(abs(x_1435), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1438 : vec3<f32> = u_xlat2;
  u_xlat2 = log2(x_1438);
  let x_1440 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1440 * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1443 : vec3<f32> = u_xlat2;
  u_xlat2 = exp2(x_1443);
  let x_1446 : vec4<f32> = u_xlat0;
  let x_1448 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1446.x, x_1446.y, x_1446.z, x_1446.x));
  u_xlatb0 = vec3<bool>(x_1448.x, x_1448.y, x_1448.z);
  let x_1451 : bool = u_xlatb0.x;
  if (x_1451) {
    let x_1456 : f32 = u_xlat1.x;
    x_1452 = x_1456;
  } else {
    let x_1459 : f32 = u_xlat2.x;
    x_1452 = x_1459;
  }
