...
#line 11 "Packages/com.unity.postprocessing/PostProcessing/Shaders/Builtins/ExposureHistogram.compute"
...
groupshared uint gs_histogram [ 128 ] ;
#line 30
[ numthreads ( 16 , 16 , 1 ) ]
...
#line 70
float3 color = _Source . SampleLevel ( sampler_LinearClamp , sspos , 0.0 ) . xyz ;
float luminance = Luminance ( color ) ;
float logLuminance = GetHistogramBinFromLuminance ( luminance , _ScaleOffsetRes . xy ) ;
uint idx = ( uint ) ( logLuminance * ( 128 - 1u ) ) ;
