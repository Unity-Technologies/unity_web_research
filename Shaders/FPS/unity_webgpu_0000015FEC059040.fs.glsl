...
layout(set = 0, binding = 2) uniform mediump texture2D _AreaTex;
layout(set = 0, binding = 3) uniform mediump texture2D _SearchTex;
    ...
    if(u_xlatb6){
        ...
        if(u_xlatb6){
            ...
            while(true){
                ...
                u_xlat6.xy = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat2.xy, 0.0).yx;
        ...
        while(true){
            ...
            u_xlat15.xy = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat2.yz, 0.0).xy;
        ...
        if(u_xlatb6){
            ...
            u_xlat6.xy = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat2.xy, 0.0, ivec2(-1, 0)).xy;
            u_xlat7.xz = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat2.zw, 0.0, ivec2(1, 0)).xy;
            u_xlat6.z = u_xlat7.x;
            ...
            u_xlat6.xy = textureLod(sampler2D(_AreaTex, sampler_MainTex), u_xlat6.xy, 0.0).xy;
        } else {
            u_xlat6.x = float(0.0);
            u_xlat6.y = float(0.0);
        }
        ...
        while(true){
            ...
            u_xlat3.xy = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat8.xy, 0.0).xy;
        ...
        u_xlat1.x = u_xlat8.z;
        u_xlat19 = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD0.xy, 0.0, ivec2(1, 0)).x;
        ...
        if(u_xlatb19){
            ...
            while(true){
                ...
                u_xlat5.xy = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat4.xy, 0.0).xy;
        ...
        if(u_xlatb18){
            ...
            u_xlat4.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat3.xy, 0.0, ivec2(-1, 0)).y;
            u_xlat4.z = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat3.xy, 0.0, ivec2(0, -1)).x;
            u_xlat4.yw = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat3.zw, 0.0, ivec2(1, 0)).yx;
            u_xlat7.xz = u_xlat4.xy * vec2(2.0, 2.0) + u_xlat4.zw;
            ...
            u_xlat1.xy = textureLod(sampler2D(_AreaTex, sampler_MainTex), u_xlat1.xy, 0.0).xy;
        ...
        if(u_xlatb18){
            ...
            u_xlat18 = textureLod(sampler2D(_SearchTex, sampler_MainTex), u_xlat1.xy, 0.0).w;
            u_xlat18 = u_xlat18 * -2.00787401 + 3.25;
            u_xlat1.x = _MainTex_TexelSize.x * u_xlat18 + u_xlat2.y;
            u_xlat1.y = vs_TEXCOORD3.y;
            u_xlat2.x = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat1.xy, 0.0).x;
            ...
            while(true){
                ...
                u_xlatb18 = u_xlatb18 && u_xlatb14;
                if(!u_xlatb18){break;}
                u_xlat4.xy = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat3.xy, 0.0).xy;
            ...
            u_xlat18 = textureLod(sampler2D(_SearchTex, sampler_MainTex), u_xlat14.xy, 0.0).w;
            u_xlat18 = u_xlat18 * -2.00787401 + 3.25;
            ...
            u_xlat2.y = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat1.zy, 0.0, ivec2(1, 0)).x;
            ...
            u_xlat2.xy = textureLod(sampler2D(_AreaTex, sampler_MainTex), u_xlat2.xy, 0.0).xy;
...
;
            ...
            u_xlat18 = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat1.xw, 0.0, ivec2(0, 1)).x;
            u_xlat18 = (-u_xlat14.x) * u_xlat18 + 1.0;
            u_xlat7.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat1.zw, 0.0, ivec2(1, 1)).x;
            u_xlat3.x = (-u_xlat14.y) * u_xlat7.x + u_xlat18;
            u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
            u_xlat18 = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat1.xw, 0.0, ivec2(0, -2)).x;
            u_xlat18 = (-u_xlat14.x) * u_xlat18 + 1.0;
            u_xlat1.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat1.zw, 0.0, ivec2(1, -2)).x;
    ...
    if(u_xlatb0){
        ...
        u_xlat13.x = textureLod(sampler2D(_SearchTex, sampler_MainTex), u_xlat13.xy, 0.0).w;
...
;
        ...
        u_xlat6.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.wx, 0.0, ivec2(1, 0)).y;
        u_xlat6.x = (-u_xlat13.x) * u_xlat6.x + 1.0;
        u_xlat2.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.wz, 0.0, ivec2(1, 1)).y;
        u_xlat14.x = (-u_xlat13.y) * u_xlat2.x + u_xlat6.x;
        u_xlat14.x = clamp(u_xlat14.x, 0.0, 1.0);
        u_xlat0.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.wx, 0.0, ivec2(-2, 0)).y;
        u_xlat0.x = (-u_xlat13.x) * u_xlat0.x + 1.0;
        u_xlat6.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.wz, 0.0, ivec2(-2, 1)).y;
