#line 1 "TextMeshPro/Distance Field Overlay"
static const int BEVEL_ON = 0 ;
static const int UNDERLAY_ON = 0 ;
static const int UNDERLAY_INNER = 0 ;
static const int GLOW_ON = 0 ;
static const int MASK_OFF = 0 ;
static const int UNITY_UI_CLIP_RECT = 0 ;
static const int UNITY_UI_ALPHACLIP = 0 ;
...
#line 4 "F:/src/unity_webgpu/Shaders/Includes/UnityUI.cginc"
...
float2 faceUV = ( textureUV . xy * _FaceTex_ST . xy + _FaceTex_ST . zw ) ;
float2 outlineUV = ( textureUV . xy * _OutlineTex_ST . xy + _OutlineTex_ST . zw ) ;
