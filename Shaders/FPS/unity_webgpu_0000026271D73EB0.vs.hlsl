...
#line 54
float _Glossiness , _Metallic , _Cutoff , _EdgeSize , _NoiseStrength , _DisplaceAmount ;
float4 _Color , _EdgeColor1 , _Emission ;
#line 58
...
float3 Noise = tex2D ( _Noise , IN . uv_Noise ) ;
float4 MetallicSmooth = tex2D ( _MetallicSmooth , IN . uv_MainTex ) ;
#line 82
float3 Gradient = tex2D ( _Gradient , IN . uv_MainTex ) ;
float Edge = smoothstep ( _Cutoff , _Cutoff - _EdgeSize , 1 - ( Gradient + Noise . r * ( 1 - Gradient ) * _NoiseStrength ) ) ;
#line 88
float4 c = tex2D ( _MainTex , IN . uv_MainTex ) ;
float3 EmissiveCol = c . a * _Emission ;
...
o . pos = UnityObjectToClipPos ( v . vertex ) ;
o . pack0 . xy = ( v . texcoord . xy * _Noise_ST . xy + _Noise_ST . zw ) ;
o . pack0 . zw = ( v . texcoord . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ;
...
surfIN . uv_Noise = IN . pack0 . xy ;
surfIN . uv_MainTex = IN . pack0 . zw ;
