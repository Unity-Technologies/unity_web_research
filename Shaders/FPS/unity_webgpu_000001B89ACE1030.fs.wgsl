...
fn main_1() {
  ...
  u_xlat0 = ((vec4<f32>(x_1116.w, x_1116.x, x_1116.y, x_1116.z) * vec4<f32>(x_1118.w, x_1118.x, x_1118.y, x_1118.z)) + vec4<f32>(x_1121.w, x_1121.x, x_1121.y, x_1121.z));
  let x_1126 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1126);
  let x_1128 : bool = u_xlatb1;
  if (x_1128) {
    ...
    u_xlat0.x = dot(vec3<f32>(x_1142.x, x_1142.y, x_1142.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1152 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1152.y, x_1152.z, x_1152.w, x_1152.x);
  return;
}
