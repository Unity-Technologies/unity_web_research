...
fn main_1() {
  ...
  let x_528 : vec3<f32> = u_xlat11;
  let x_529 : vec3<f32> = ((x_524 * vec3<f32>(x_525.x, x_525.z, x_525.w)) + x_528);
  let x_530 : vec4<f32> = SV_Target3;
  SV_Target3 = vec4<f32>(x_529.x, x_529.y, x_529.z, x_530.w);
  let x_533 : f32 = u_xlat3;
  SV_Target0.w = x_533;
  let x_535 : vec3<f32> = u_xlat1;
  let x_536 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_535.x, x_535.y, x_535.z, x_536.w);
  SV_Target2.w = 1.0f;
  SV_Target3.w = 1.0f;
  return;
}
