...
fn main_1() {
  ...
  u_xlatb3 = vec3<bool>(x_636.x, x_636.y, x_636.z);
  let x_640 : vec4<f32> = u_xlat0;
  hlslcc_movcTemp = x_640;
  let x_642 : bool = u_xlatb3.x;
  if (x_642) {
  ...
  let x_851 : f32 = x_843;
  u_xlat2.z = x_851;
  let x_855 : f32 = x_55.x_LumaInAlpha;
  u_xlatb0.x = (0.5f < x_855);
  ...
  if (x_859) {
    ...
    u_xlat2.w = dot(vec3<f32>(x_873.x, x_873.y, x_873.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
