...
o . color = v . color ;
o . texcoord = ( v . texcoord . xy * _HaloFalloff_ST . xy + _HaloFalloff_ST . zw ) ;
;
return o ;
}
float4 frag ( v2f i ) : COLOR
{
float a = tex2D ( _HaloFalloff , i . texcoord ) . a ;
float4 col = float4 ( i . color . rgb * a , a ) ;
;
return col ;
}
