...
#line 36 "F:/src/unity_webgpu/Shaders/Includes/UnityStandardParticleShadow.cginc"
float _Cutoff ;
...
float _Metallic ;
#line 50
float MetallicSetup_ShadowGetOneMinusReflectivity ( float2 uv )
{
float metallicity = _Metallic ;
#line 56
...
{ UnitySetupInstanceID ( v . instanceID ) ; UnitySetupCompoundMatrices ( ) ; } ;
#line 112
opos = UnityClipSpaceShadowCasterPos ( v . vertex , v . normal ) ; opos = UnityApplyLinearShadowBias ( opos ) ;
#line 127
...
float4 fragParticleShadowCaster (
