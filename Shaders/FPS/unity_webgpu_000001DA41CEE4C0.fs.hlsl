#line 1 "ProBuilder/Standard Vertex Color"
...
float4 c = tex2D ( _MainTex , IN . uv_MainTex ) * _Color * IN . vertexColor ;
o . Albedo = c . rgb ;
...
float4 color : COLOR0 ;
float3 _LightCoord : TEXCOORD3 ; float4 _ShadowCoord : TEXCOORD4 ;
#line 59
} ;
float4 _MainTex_ST ;
#line 63
