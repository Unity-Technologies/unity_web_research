...
@group(0) @binding(6) var<uniform> x_14 : UnityDrawCallInfo;

var<private> u_xlat1 : vec4<f32>;

var<private> in_POSITION0 : vec4<f32>;

@group(0) @binding(7) var<uniform> x_38 : UnityInstancing_PerDraw0;

var<private> u_xlat2 : vec4<f32>;

var<private> vs_TEXCOORD1 : vec3<f32>;

@group(0) @binding(5) var<uniform> x_91 : VGlobals;
...
fn main_1() {
  ...
  u_xlat9 = ((x_299 * x_301) + -(x_303));
  let x_306 : vec3<f32> = u_xlat0;
  let x_308 : vec3<f32> = u_xlat0;
  u_xlat1 = (vec4<f32>(x_306.y, x_306.z, x_306.z, x_306.x) * vec4<f32>(x_308.x, x_308.y, x_308.z, x_308.z));
  let x_312 : vec4<f32> = x_91.unity_SHBr;
  let x_313 : vec4<f32> = u_xlat1;
  u_xlat0.x = dot(x_312, x_313);
  let x_317 : vec4<f32> = x_91.unity_SHBg;
  let x_318 : vec4<f32> = u_xlat1;
  u_xlat0.y = dot(x_317, x_318);
  let x_322 : vec4<f32> = x_91.unity_SHBb;
  let x_323 : vec4<f32> = u_xlat1;
  u_xlat0.z = dot(x_322, x_323);
  let x_329 : vec4<f32> = x_91.unity_SHC;
  let x_331 : f32 = u_xlat9;
  let x_334 : vec3<f32> = u_xlat0;
  vs_TEXCOORD6 = ((vec3<f32>(x_329.x, x_329.y, x_329.z) * vec3<f32>(x_331, x_331, x_331)) + x_334);
