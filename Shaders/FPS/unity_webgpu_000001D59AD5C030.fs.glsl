...
void main()
{
    ...
    if(u_xlatb12){
        ...
        u_xlat35 = max(abs(u_xlat12.y), abs(u_xlat12.x));
        u_xlat35 = max(abs(u_xlat12.z), u_xlat35);
        ...
        vec4 txVec3 = vec4(u_xlat12.xyz,u_xlat35);
