...
layout(set = 0, binding = 17, std140) uniform UnityInstancing_PerDraw0 {
...
void main()
{
    ...
    gl_Position = u_xlat3;
    u_xlat4.xyz = in_TANGENT0.yyy * unity_Builtins0Array[u_xlati7 / 8].unity_ObjectToWorldArray[1].yzx;
    u_xlat4.xyz = unity_Builtins0Array[u_xlati7 / 8].unity_ObjectToWorldArray[0].yzx * in_TANGENT0.xxx + u_xlat4.xyz;
    u_xlat4.xyz = unity_Builtins0Array[u_xlati7 / 8].unity_ObjectToWorldArray[2].yzx * in_TANGENT0.zzz + u_xlat4.xyz;
    u_xlat14 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat14 = inversesqrt(u_xlat14);
    u_xlat4.xyz = vec3(u_xlat14) * u_xlat4.xyz;
    u_xlat5.x = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati7 / 8].unity_WorldToObjectArray[0].xyz);
    u_xlat5.y = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati7 / 8].unity_WorldToObjectArray[1].xyz);
    u_xlat5.z = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati7 / 8].unity_WorldToObjectArray[2].xyz);
    u_xlat7.x = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat7.x = inversesqrt(u_xlat7.x);
    u_xlat5 = u_xlat7.xxxx * u_xlat5.xyzz;
    u_xlat7.xyz = u_xlat4.xyz * u_xlat5.wxy;
    u_xlat7.xyz = u_xlat5.ywx * u_xlat4.yzx + (-u_xlat7.xyz);
    ...
    u_xlat7.x = u_xlat2.y * unity_MatrixV[1].z;
    u_xlat7.x = unity_MatrixV[0].z * u_xlat2.x + u_xlat7.x;
    u_xlat7.x = unity_MatrixV[2].z * u_xlat2.z + u_xlat7.x;
    u_xlat7.x = unity_MatrixV[3].z * u_xlat2.w + u_xlat7.x;
    vs_TEXCOORD4.z = (-u_xlat7.x);
    u_xlat7.xyz = u_xlat2.yyy * unity_MatrixVP[1].xyw;
    u_xlat7.xyz = unity_MatrixVP[0].xyw * u_xlat2.xxx + u_xlat7.xyz;
    u_xlat7.xyz = unity_MatrixVP[2].xyw * u_xlat2.zzz + u_xlat7.xyz;
    u_xlat7.xyz = unity_MatrixVP[3].xyw * u_xlat2.www + u_xlat7.xyz;
    vs_TEXCOORD4.w = u_xlat7.z;
    u_xlat2.x = float(0.5);
    u_xlat2.z = float(0.5);
    u_xlat2.y = _ProjectionParams.x;
    u_xlat4.xyz = u_xlat7.xyz * u_xlat2.xyz;
    ...
    u_xlat7.x = u_xlat5.y * u_xlat5.y;
    u_xlat7.x = u_xlat5.x * u_xlat5.x + (-u_xlat7.x);
    ...
    u_xlat0.xyz = unity_Builtins2Array[u_xlati0 / 7].unity_SHCArray.xyz * u_xlat7.xxx + u_xlat4.xyz;
    u_xlat3 = (-u_xlat1.yyyy) + unity_4LightPosY0;
    u_xlat4 = u_xlat5.yyyy * u_xlat3;
    u_xlat3 = u_xlat3 * u_xlat3;
    u_xlat6 = (-u_xlat1.xxxx) + unity_4LightPosX0;
    u_xlat1 = (-u_xlat1.zzzz) + unity_4LightPosZ0;
    u_xlat4 = u_xlat6 * u_xlat5.xxxx + u_xlat4;
    u_xlat4 = u_xlat1 * u_xlat5.wwzw + u_xlat4;
