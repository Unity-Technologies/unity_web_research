...
fn main_1() {
  ...
  let x_440 : f32 = x_30.x_EmissionColor.x;
  let x_442 : f32 = x_30.x_EmissionColor.y;
  let x_444 : f32 = x_30.x_EmissionColor.z;
  let x_447 : vec3<f32> = u_xlat1;
  let x_448 : vec3<f32> = ((x_437 * vec3<f32>(x_440, x_442, x_444)) + x_447);
  let x_449 : vec4<f32> = SV_Target3;
  SV_Target3 = vec4<f32>(x_448.x, x_448.y, x_448.z, x_449.w);
  let x_452 : vec4<f32> = u_xlat0;
  let x_453 : vec3<f32> = vec3<f32>(x_452.x, x_452.y, x_452.z);
  let x_454 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_453.x, x_453.y, x_453.z, x_454.w);
  SV_Target0.w = 1.0f;
  let x_460 : f32 = x_30.x_Glossiness;
  SV_Target1.w = x_460;
  SV_Target2.w = 1.0f;
  SV_Target3.w = 1.0f;
  return;
