...
float3 lightCoord = mul ( unity_WorldToLight , float4 ( s . posWorld , 1 ) ) . xyz ; float shadow = UnityComputeForwardShadows ( 0 , s . posWorld , 0 ) ; float atten = tex2D ( _LightTexture0 , dot ( lightCoord , lightCoord ) . rr ) . r * shadow ; ;
