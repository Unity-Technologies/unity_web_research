...
fn main_1() {
  ...
  let x_697 : vec3<f32> = ((vec3<f32>(x_691.x, x_691.z, x_691.w) * vec3<f32>(x_693.x, x_693.z, x_693.w)) + x_696);
  let x_698 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_697.x, x_697.y, x_697.z, x_698.w);
  SV_Target0.w = 1.0f;
  return;
}
