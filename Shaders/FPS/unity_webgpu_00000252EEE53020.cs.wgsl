...
fn main_1() {
  ...
  let x_1286 : vec4<i32> = u_xlati4;
  let x_1288 : vec4<f32> = u_xlat0;
  textureStore(AoResult_origX0X, vec2<i32>(x_1286.x, x_1286.y), vec4<f32>(x_1288.x, x_1288.x, x_1288.x, x_1288.x));
  let x_1290 : vec4<f32> = u_xlat3;
  let x_1293 : vec4<f32> = u_xlat0;
  u_xlat5 = (-(vec4<f32>(x_1290.y, x_1290.z, x_1290.w, x_1290.x)) + vec4<f32>(x_1293.y, x_1293.y, x_1293.y, x_1293.y));
  let x_1296 : vec4<f32> = u_xlat5;
  let x_1299 : vec4<f32> = x_65.AdditionalParams;
  u_xlat5 = (abs(x_1296) + vec4<f32>(x_1299.w, x_1299.w, x_1299.w, x_1299.w));
  let x_1302 : vec4<f32> = u_xlat5;
  u_xlat5 = (vec4<f32>(9.0f, 3.0f, 1.0f, 3.0f) / x_1302);
  let x_1304 : vec4<f32> = u_xlat5;
  u_xlat0.x = dot(x_1304, vec4<f32>(1.0f, 1.0f, 1.0f, 1.0f));
  let x_1307 : vec4<f32> = u_xlat1;
  let x_1309 : vec4<f32> = u_xlat5;
  u_xlat0.y = dot(vec4<f32>(x_1307.z, x_1307.w, x_1307.x, x_1307.y), x_1309);
  let x_1312 : vec4<f32> = u_xlat0;
  let x_1315 : vec4<f32> = x_65.AdditionalParams;
  let x_1317 : vec2<f32> = (vec2<f32>(x_1312.x, x_1312.y) + vec2<f32>(x_1315.x, x_1315.x));
  let x_1318 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1317.x, x_1317.y, x_1318.z, x_1318.w);
  let x_1321 : f32 = u_xlat0.y;
  let x_1323 : f32 = u_xlat0.x;
  u_xlat0.x = (x_1321 / x_1323);
  let x_1327 : vec4<u32> = u_xlatu2;
  let x_1330 : vec4<f32> = u_xlat0;
  textureStore(AoResult_origX0X, bitcast<vec2<i32>>(vec2<u32>(x_1327.x, x_1327.w)), vec4<f32>(x_1330.x, x_1330.x, x_1330.x, x_1330.x));
  let x_1332 : vec4<f32> = u_xlat3;
  let x_1335 : vec4<f32> = u_xlat0;
  u_xlat5 = (-(vec4<f32>(x_1332.z, x_1332.w, x_1332.x, x_1332.y)) + vec4<f32>(x_1335.z, x_1335.z, x_1335.z, x_1335.z));
  let x_1338 : vec4<f32> = u_xlat5;
  let x_1341 : vec4<f32> = x_65.AdditionalParams;
  u_xlat5 = (abs(x_1338) + vec4<f32>(x_1341.w, x_1341.w, x_1341.w, x_1341.w));
  let x_1344 : vec4<f32> = u_xlat5;
  u_xlat5 = (vec4<f32>(9.0f, 3.0f, 1.0f, 3.0f) / x_1344);
  let x_1346 : vec4<f32> = u_xlat5;
  u_xlat0.x = dot(x_1346, vec4<f32>(1.0f, 1.0f, 1.0f, 1.0f));
  let x_1349 : vec4<f32> = u_xlat1;
  let x_1351 : vec4<f32> = u_xlat5;
  u_xlat0.y = dot(vec4<f32>(x_1349.w, x_1349.x, x_1349.y, x_1349.z), x_1351);
  let x_1354 : vec4<f32> = u_xlat0;
  let x_1357 : vec4<f32> = x_65.AdditionalParams;
  let x_1359 : vec2<f32> = (vec2<f32>(x_1354.x, x_1354.y) + vec2<f32>(x_1357.x, x_1357.x));
  let x_1360 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1359.x, x_1359.y, x_1360.z, x_1360.w);
  let x_1363 : f32 = u_xlat0.y;
  let x_1365 : f32 = u_xlat0.x;
  u_xlat0.x = (x_1363 / x_1365);
  let x_1369 : vec4<i32> = u_xlati4;
  let x_1371 : vec4<f32> = u_xlat0;
  textureStore(AoResult_origX0X, vec2<i32>(x_1369.z, x_1369.w), vec4<f32>(x_1371.x, x_1371.x, x_1371.x, x_1371.x));
  let x_1373 : vec4<u32> = u_xlatu2;
  u_xlati2 = (bitcast<vec4<i32>>(x_1373) + vec4<i32>(-1i, -1i, -1i, -1i));
  let x_1377 : vec4<f32> = u_xlat3;
  let x_1380 : vec4<f32> = u_xlat0;
  u_xlat0 = (-(vec4<f32>(x_1377.w, x_1377.x, x_1377.y, x_1377.z)) + vec4<f32>(x_1380.w, x_1380.w, x_1380.w, x_1380.w));
  let x_1383 : vec4<f32> = u_xlat0;
  let x_1386 : vec4<f32> = x_65.AdditionalParams;
  u_xlat0 = (abs(x_1383) + vec4<f32>(x_1386.w, x_1386.w, x_1386.w, x_1386.w));
  let x_1389 : vec4<f32> = u_xlat0;
  u_xlat0 = (vec4<f32>(9.0f, 3.0f, 1.0f, 3.0f) / x_1389);
  let x_1391 : vec4<f32> = u_xlat0;
  u_xlat3.x = dot(x_1391, vec4<f32>(1.0f, 1.0f, 1.0f, 1.0f));
  let x_1395 : f32 = u_xlat3.x;
  let x_1397 : f32 = x_65.AdditionalParams.x;
  u_xlat3.x = (x_1395 + x_1397);
  let x_1400 : vec4<f32> = u_xlat1;
  let x_1401 : vec4<f32> = u_xlat0;
  u_xlat0.x = dot(x_1400, x_1401);
  let x_1405 : f32 = u_xlat0.x;
  let x_1407 : f32 = x_65.AdditionalParams.x;
  u_xlat0.x = (x_1405 + x_1407);
  let x_1411 : f32 = u_xlat0.x;
  let x_1413 : f32 = u_xlat3.x;
  u_xlat0.x = (x_1411 / x_1413);
  let x_1417 : vec4<i32> = u_xlati2;
  let x_1419 : vec4<f32> = u_xlat0;
  textureStore(AoResult_origX0X, vec2<i32>(x_1417.x, x_1417.y), vec4<f32>(x_1419.x, x_1419.x, x_1419.x, x_1419.x));
  return;
}
