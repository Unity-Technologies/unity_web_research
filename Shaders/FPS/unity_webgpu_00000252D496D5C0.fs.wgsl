...
fn main_1() {
  ...
  if (x_752) {
    ...
    let x_929 : f32 = x_922;
    u_xlat1.x = x_929;
    let x_932 : vec3<f32> = x_31.x_Vignette_Color;
    ...
    let x_952 : f32 = x_31.x_Vignette_Opacity;
  ...
  let x_974 : vec4<f32> = x_31.x_Grain_Params2;
  let x_978 : vec4<f32> = x_31.x_Grain_Params2;
  ...
  let x_1010 : f32 = x_31.x_Grain_Params1.x;
  ...
  let x_1024 : f32 = x_31.x_Grain_Params1.y;
  let x_1026 : f32 = x_31.x_Grain_Params1.y;
  let x_1028 : f32 = x_31.x_Grain_Params1.y;
  ...
  let x_1046 : vec4<f32> = x_31.x_Dithering_Coords;
  let x_1050 : vec4<f32> = x_31.x_Dithering_Coords;
