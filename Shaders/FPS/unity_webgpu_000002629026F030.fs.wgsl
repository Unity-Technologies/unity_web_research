...
fn main_1() {
  ...
  let x_1449 : f32 = x_26.x_PostExposure;
  let x_1451 : f32 = x_26.x_PostExposure;
  let x_1453 : f32 = x_26.x_PostExposure;
  let x_1455 : f32 = x_26.x_PostExposure;
  let x_1456 : vec4<f32> = vec4<f32>(x_1449, x_1451, x_1453, x_1455);
  u_xlat0 = (x_1446 * vec4<f32>(x_1456.x, x_1456.y, x_1456.z, x_1456.w));
  let x_1463 : vec4<f32> = u_xlat0;
  let x_1470 : vec3<f32> = ((vec3<f32>(x_1463.x, x_1463.y, x_1463.z) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1485 : vec3<f32> = ((vec3<f32>(x_1478.x, x_1478.y, x_1478.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1486 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1485.x, x_1485.y, x_1485.z, x_1486.w);
  let x_1488 : vec4<f32> = u_xlat0;
  let x_1492 : vec3<f32> = clamp(vec3<f32>(x_1488.x, x_1488.y, x_1488.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1493 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1492.x, x_1492.y, x_1492.z, x_1493.w);
  let x_1495 : vec4<f32> = u_xlat0;
  let x_1499 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1501 : vec3<f32> = (vec3<f32>(x_1495.x, x_1495.y, x_1495.z) * vec3<f32>(x_1499.y, x_1499.y, x_1499.y));
  let x_1502 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1501.x, x_1501.y, x_1501.z, x_1502.w);
  let x_1505 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat1.x = (x_1505 * 0.5f);
  let x_1508 : vec4<f32> = u_xlat0;
  let x_1511 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1514 : vec3<f32> = u_xlat1;
  let x_1516 : vec3<f32> = ((vec3<f32>(x_1508.x, x_1508.y, x_1508.z) * vec3<f32>(x_1511.x, x_1511.x, x_1511.x)) + vec3<f32>(x_1514.x, x_1514.x, x_1514.x));
  let x_1517 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1516.x, x_1516.y, x_1516.z, x_1517.w);
  let x_1527 : vec4<f32> = u_xlat0;
  let x_1529 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1527.x, x_1527.y, x_1527.z));
  ...
  let x_1533 : vec2<f32> = vs_TEXCOORD0;
  let x_1536 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1540 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1542 : vec2<f32> = ((x_1533 * vec2<f32>(x_1536.x, x_1536.y)) + vec2<f32>(x_1540.z, x_1540.w));
  let x_1543 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1542.x, x_1542.y, x_1543.z);
  let x_1550 : vec3<f32> = u_xlat1;
  let x_1552 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1550.x, x_1550.y));
  u_xlat1.x = x_1552.w;
  let x_1556 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1556 * 2.0f) + -1.0f);
  let x_1561 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1561 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1567 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1567, 0.0f, 1.0f);
  let x_1571 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1571 * 2.0f) + -1.0f);
  let x_1576 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1576)) + 1.0f);
  let x_1582 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1582);
  let x_1586 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1586) + 1.0f);
  let x_1591 : f32 = u_xlat1.x;
  let x_1593 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1591 * x_1593);
  let x_1596 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1596.x, x_1596.y, x_1596.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1601 : vec4<f32> = u_xlat0;
  let x_1605 : vec3<f32> = max(abs(vec3<f32>(x_1601.x, x_1601.y, x_1601.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1606 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1605.x, x_1605.y, x_1605.z, x_1606.w);
  let x_1608 : vec4<f32> = u_xlat2;
  let x_1610 : vec3<f32> = log2(vec3<f32>(x_1608.x, x_1608.y, x_1608.z));
  let x_1611 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1610.x, x_1610.y, x_1610.z, x_1611.w);
  let x_1613 : vec4<f32> = u_xlat2;
  let x_1617 : vec3<f32> = (vec3<f32>(x_1613.x, x_1613.y, x_1613.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1632 : vec3<f32> = ((vec3<f32>(x_1625.x, x_1625.y, x_1625.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1633 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1632.x, x_1632.y, x_1632.z, x_1633.w);
  let x_1640 : vec4<f32> = u_xlat0;
  let x_1643 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1640.x, x_1640.y, x_1640.z, x_1640.x));
  u_xlatb0 = vec3<bool>(x_1643.x, x_1643.y, x_1643.z);
  let x_1646 : bool = u_xlatb0.x;
  if (x_1646) {
    let x_1651 : f32 = u_xlat11.x;
    x_1647 = x_1651;
  } else {
  ...
  u_xlat0.x = x_1655;
  let x_1658 : bool = u_xlatb0.y;
  if (x_1658) {
    let x_1663 : f32 = u_xlat11.y;
    x_1659 = x_1663;
  } else {
    let x_1666 : f32 = u_xlat2.y;
    x_1659 = x_1666;
  }
  let x_1667 : f32 = x_1659;
  u_xlat0.y = x_1667;
  let x_1670 : bool = u_xlatb0.z;
  if (x_1670) {
    let x_1675 : f32 = u_xlat11.z;
    x_1671 = x_1675;
  } else {
  ...
  let x_1688 : vec3<f32> = ((vec3<f32>(x_1681.x, x_1681.x, x_1681.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1686.x, x_1686.y, x_1686.z));
  let x_1689 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1688.x, x_1688.y, x_1688.z, x_1689.w);
  let x_1691 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1691.x, x_1691.y, x_1691.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1695 : vec4<f32> = u_xlat0;
  let x_1698 : vec3<f32> = (vec3<f32>(x_1695.x, x_1695.y, x_1695.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1699 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1698.x, x_1698.y, x_1698.z, x_1699.w);
  let x_1701 : vec4<f32> = u_xlat2;
  let x_1704 : vec3<f32> = (vec3<f32>(x_1701.x, x_1701.y, x_1701.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1705 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1704.x, x_1704.y, x_1704.z, x_1705.w);
  let x_1707 : vec4<f32> = u_xlat2;
  let x_1710 : vec3<f32> = max(abs(vec3<f32>(x_1707.x, x_1707.y, x_1707.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1711 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1710.x, x_1710.y, x_1710.z, x_1711.w);
  let x_1713 : vec4<f32> = u_xlat2;
  let x_1715 : vec3<f32> = log2(vec3<f32>(x_1713.x, x_1713.y, x_1713.z));
  let x_1716 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1715.x, x_1715.y, x_1715.z, x_1716.w);
  let x_1718 : vec4<f32> = u_xlat2;
  let x_1721 : vec3<f32> = (vec3<f32>(x_1718.x, x_1718.y, x_1718.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1722 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1721.x, x_1721.y, x_1721.z, x_1722.w);
  let x_1724 : vec4<f32> = u_xlat2;
  let x_1726 : vec3<f32> = exp2(vec3<f32>(x_1724.x, x_1724.y, x_1724.z));
  let x_1727 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1726.x, x_1726.y, x_1726.z, x_1727.w);
  let x_1730 : vec4<f32> = u_xlat0;
  let x_1732 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1730.x, x_1730.y, x_1730.z, x_1730.x));
  u_xlatb0 = vec3<bool>(x_1732.x, x_1732.y, x_1732.z);
  ...
  SV_Target0.x = x_1746;
  let x_1750 : bool = u_xlatb0.y;
  if (x_1750) {
    let x_1755 : f32 = u_xlat1.y;
    x_1751 = x_1755;
  } else {
    let x_1758 : f32 = u_xlat2.y;
    x_1751 = x_1758;
  }
  let x_1759 : f32 = x_1751;
  SV_Target0.y = x_1759;
  let x_1762 : bool = u_xlatb0.z;
  if (x_1762) {
    let x_1767 : f32 = u_xlat1.z;
    x_1763 = x_1767;
  } else {
    let x_1770 : f32 = u_xlat2.z;
    x_1763 = x_1770;
  }
  let x_1771 : f32 = x_1763;
  SV_Target0.z = x_1771;
  let x_1774 : f32 = u_xlat0.w;
  SV_Target0.w = x_1774;
  return;
}
