...
fn main_1() {
  ...
  let x_1509 : vec2<f32> = vs_TEXCOORD0;
  let x_1512 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1516 : vec4<f32> = x_26.x_Dithering_Coords;
  ...
  let x_1528 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1526.x, x_1526.y));
  u_xlat0.x = x_1528.w;
  let x_1532 : f32 = u_xlat0.x;
  u_xlat0.x = ((x_1532 * 2.0f) + -1.0f);
  let x_1538 : f32 = u_xlat0.x;
  u_xlat10.x = ((x_1538 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1544 : f32 = u_xlat10.x;
  u_xlat10.x = clamp(x_1544, 0.0f, 1.0f);
  let x_1548 : f32 = u_xlat10.x;
  u_xlat10.x = ((x_1548 * 2.0f) + -1.0f);
  let x_1553 : f32 = u_xlat0.x;
  u_xlat0.x = (-(abs(x_1553)) + 1.0f);
  let x_1559 : f32 = u_xlat0.x;
  u_xlat0.x = sqrt(x_1559);
  let x_1563 : f32 = u_xlat0.x;
  u_xlat0.x = (-(x_1563) + 1.0f);
  let x_1568 : f32 = u_xlat0.x;
  let x_1570 : f32 = u_xlat10.x;
  u_xlat0.x = (x_1568 * x_1570);
  let x_1573 : vec4<f32> = u_xlat2;
  u_xlat10 = (vec3<f32>(x_1573.x, x_1573.y, x_1573.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1578 : vec4<f32> = u_xlat2;
  u_xlat1 = max(abs(vec3<f32>(x_1578.x, x_1578.y, x_1578.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1583 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1583);
  let x_1585 : vec3<f32> = u_xlat1;
  u_xlat1 = (x_1585 * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1589 : vec3<f32> = u_xlat1;
  u_xlat1 = exp2(x_1589);
  let x_1591 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1591 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1603 : vec4<f32> = u_xlat2;
  let x_1606 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1603.x, x_1603.y, x_1603.z, x_1603.x));
  u_xlatb2 = vec3<bool>(x_1606.x, x_1606.y, x_1606.z);
  let x_1610 : vec3<f32> = u_xlat10;
  hlslcc_movcTemp = x_1610;
  let x_1612 : bool = u_xlatb2.x;
  if (x_1612) {
    let x_1617 : f32 = u_xlat10.x;
    x_1613 = x_1617;
  } else {
  ...
  hlslcc_movcTemp.x = x_1621;
  let x_1624 : bool = u_xlatb2.y;
  if (x_1624) {
    let x_1629 : f32 = u_xlat10.y;
    x_1625 = x_1629;
  } else {
    let x_1632 : f32 = u_xlat1.y;
    x_1625 = x_1632;
  }
  let x_1633 : f32 = x_1625;
  hlslcc_movcTemp.y = x_1633;
  let x_1636 : bool = u_xlatb2.z;
  if (x_1636) {
    let x_1641 : f32 = u_xlat10.z;
    x_1637 = x_1641;
  } else {
    let x_1644 : f32 = u_xlat1.z;
    x_1637 = x_1644;
  }
  let x_1645 : f32 = x_1637;
  hlslcc_movcTemp.z = x_1645;
  let x_1647 : vec3<f32> = hlslcc_movcTemp;
  u_xlat10 = x_1647;
  let x_1648 : vec4<f32> = u_xlat0;
  let x_1653 : vec3<f32> = u_xlat10;
  let x_1654 : vec3<f32> = ((vec3<f32>(x_1648.x, x_1648.x, x_1648.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1653);
  let x_1655 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1654.x, x_1654.y, x_1654.z, x_1655.w);
  let x_1657 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1657.x, x_1657.y, x_1657.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1661 : vec4<f32> = u_xlat0;
  let x_1664 : vec3<f32> = (vec3<f32>(x_1661.x, x_1661.y, x_1661.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1665 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1664.x, x_1664.y, x_1664.z, x_1665.w);
  let x_1667 : vec4<f32> = u_xlat2;
  let x_1670 : vec3<f32> = (vec3<f32>(x_1667.x, x_1667.y, x_1667.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1687 : vec3<f32> = (vec3<f32>(x_1684.x, x_1684.y, x_1684.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  u_xlat3.x = x_1711;
  let x_1714 : bool = u_xlatb0.y;
  if (x_1714) {
    let x_1719 : f32 = u_xlat1.y;
    x_1715 = x_1719;
  } else {
    let x_1722 : f32 = u_xlat2.y;
    x_1715 = x_1722;
  }
  let x_1723 : f32 = x_1715;
  u_xlat3.y = x_1723;
  let x_1726 : bool = u_xlatb0.z;
  if (x_1726) {
    let x_1731 : f32 = u_xlat1.z;
    x_1727 = x_1731;
  } else {
