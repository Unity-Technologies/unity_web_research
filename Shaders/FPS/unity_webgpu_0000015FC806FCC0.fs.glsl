...
layout(set = 0, binding = 2) uniform mediump texture2D _CameraGBufferTexture2;
layout(set = 0, binding = 3) uniform mediump texture2D _Noise;
...
layout(set = 0, binding = 5) uniform mediump  sampler sampler_CameraGBufferTexture2;
