...
fn main_1() {
  ...
  u_xlat9 = ((x_260 * x_262) + -(x_264));
  let x_267 : vec4<f32> = u_xlat0;
  let x_269 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec4<f32>(x_267.y, x_267.z, x_267.z, x_267.x) * vec4<f32>(x_269.x, x_269.y, x_269.z, x_269.z));
  let x_273 : vec4<f32> = x_17.unity_SHBr;
  let x_274 : vec4<f32> = u_xlat1;
  u_xlat0.x = dot(x_273, x_274);
  let x_278 : vec4<f32> = x_17.unity_SHBg;
  let x_279 : vec4<f32> = u_xlat1;
  u_xlat0.y = dot(x_278, x_279);
  let x_283 : vec4<f32> = x_17.unity_SHBb;
  let x_284 : vec4<f32> = u_xlat1;
  u_xlat0.z = dot(x_283, x_284);
  let x_290 : vec4<f32> = x_17.unity_SHC;
  let x_292 : f32 = u_xlat9;
  let x_295 : vec4<f32> = u_xlat0;
  vs_TEXCOORD4 = ((vec3<f32>(x_290.x, x_290.y, x_290.z) * vec3<f32>(x_292, x_292, x_292)) + vec3<f32>(x_295.x, x_295.y, x_295.z));
