...
{
v2f o ;
o . pos = UnityObjectToClipPos ( v . vertex . xyz ) ; o . pos = UnityApplyLinearShadowBias ( o . pos ) ;
o . uv = ( v . texcoord . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ;
o . uv2 = ( v . texcoord . xy * _OutlineTex_ST . xy + _OutlineTex_ST . zw ) ;
...
{
float4 texcol = tex2D ( _MainTex , i . uv ) . a ;
