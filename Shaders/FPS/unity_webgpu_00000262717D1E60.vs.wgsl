...
fn main_1() {
  ...
  let x_267 : vec4<f32> = x_18.unity_WorldToLight[0i];
  let x_268 : vec4<f32> = u_xlat0;
  let x_271 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_267 * vec4<f32>(x_268.x, x_268.x, x_268.x, x_268.x)) + x_271);
  let x_274 : vec4<f32> = x_18.unity_WorldToLight[2i];
  let x_275 : vec4<f32> = u_xlat0;
  let x_278 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_274 * vec4<f32>(x_275.z, x_275.z, x_275.z, x_275.z)) + x_278);
  let x_282 : vec4<f32> = x_18.unity_WorldToLight[3i];
  let x_283 : vec4<f32> = u_xlat0;
  let x_286 : vec4<f32> = u_xlat1;
  vs_TEXCOORD6 = ((x_282 * vec4<f32>(x_283.w, x_283.w, x_283.w, x_283.w)) + x_286);
