...
fn main_1() {
  ...
  u_xlat0.x = ((x_1394 * 2.0f) + -1.0f);
  let x_1400 : f32 = u_xlat0.x;
  u_xlat10.x = ((x_1400 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1406 : f32 = u_xlat10.x;
  u_xlat10.x = clamp(x_1406, 0.0f, 1.0f);
  let x_1410 : f32 = u_xlat10.x;
  u_xlat10.x = ((x_1410 * 2.0f) + -1.0f);
  let x_1415 : f32 = u_xlat0.x;
  u_xlat0.x = (-(abs(x_1415)) + 1.0f);
  let x_1421 : f32 = u_xlat0.x;
  u_xlat0.x = sqrt(x_1421);
  let x_1425 : f32 = u_xlat0.x;
  u_xlat0.x = (-(x_1425) + 1.0f);
  let x_1430 : f32 = u_xlat0.x;
  let x_1432 : f32 = u_xlat10.x;
  u_xlat0.x = (x_1430 * x_1432);
  let x_1435 : vec4<f32> = u_xlat2;
  u_xlat10 = (vec3<f32>(x_1435.x, x_1435.y, x_1435.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1440 : vec4<f32> = u_xlat2;
  u_xlat1 = max(abs(vec3<f32>(x_1440.x, x_1440.y, x_1440.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1445 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1445);
  let x_1447 : vec3<f32> = u_xlat1;
  u_xlat1 = (x_1447 * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1451 : vec3<f32> = u_xlat1;
  u_xlat1 = exp2(x_1451);
  let x_1453 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1453 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1465 : vec4<f32> = u_xlat2;
  let x_1468 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1465.x, x_1465.y, x_1465.z, x_1465.x));
  u_xlatb2 = vec3<bool>(x_1468.x, x_1468.y, x_1468.z);
  let x_1472 : vec3<f32> = u_xlat10;
  hlslcc_movcTemp = x_1472;
  let x_1474 : bool = u_xlatb2.x;
  if (x_1474) {
  ...
  hlslcc_movcTemp.x = x_1483;
  let x_1486 : bool = u_xlatb2.y;
  if (x_1486) {
    let x_1491 : f32 = u_xlat10.y;
    x_1487 = x_1491;
  } else {
  ...
  hlslcc_movcTemp.y = x_1495;
  let x_1498 : bool = u_xlatb2.z;
  if (x_1498) {
  ...
  hlslcc_movcTemp.z = x_1507;
  let x_1509 : vec3<f32> = hlslcc_movcTemp;
  u_xlat10 = x_1509;
  let x_1510 : vec4<f32> = u_xlat0;
  let x_1515 : vec3<f32> = u_xlat10;
  let x_1516 : vec3<f32> = ((vec3<f32>(x_1510.x, x_1510.x, x_1510.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1515);
  let x_1517 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1516.x, x_1516.y, x_1516.z, x_1517.w);
  let x_1519 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1519.x, x_1519.y, x_1519.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1523 : vec4<f32> = u_xlat0;
  let x_1526 : vec3<f32> = (vec3<f32>(x_1523.x, x_1523.y, x_1523.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1527 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1526.x, x_1526.y, x_1526.z, x_1527.w);
  let x_1529 : vec4<f32> = u_xlat2;
  let x_1532 : vec3<f32> = (vec3<f32>(x_1529.x, x_1529.y, x_1529.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1549 : vec3<f32> = (vec3<f32>(x_1546.x, x_1546.y, x_1546.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  u_xlat3.x = x_1573;
  let x_1576 : bool = u_xlatb0.y;
  if (x_1576) {
    let x_1581 : f32 = u_xlat1.y;
    x_1577 = x_1581;
  } else {
    let x_1584 : f32 = u_xlat2.y;
    x_1577 = x_1584;
  }
  let x_1585 : f32 = x_1577;
  u_xlat3.y = x_1585;
  let x_1588 : bool = u_xlatb0.z;
  if (x_1588) {
    let x_1593 : f32 = u_xlat1.z;
    x_1589 = x_1593;
  } else {
