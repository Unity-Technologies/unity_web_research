...
fn main_1() {
  ...
  if (x_760) {
    ...
    let x_877 : vec3<f32> = (vec3<f32>(x_874.x, x_874.y, x_874.z) * x_876);
    let x_878 : vec4<f32> = u_xlat3;
    u_xlat3 = vec4<f32>(x_877.x, x_877.y, x_877.z, x_878.w);
    let x_881 : f32 = u_xlat0.w;
    u_xlat7.x = (x_881 + -1.0f);
    let x_885 : f32 = u_xlat1.x;
    let x_887 : f32 = u_xlat7.x;
    u_xlat3.w = ((x_885 * x_887) + 1.0f);
  } else {
    let x_897 : vec2<f32> = u_xlat14;
    let x_898 : vec4<f32> = textureSample(x_Vignette_Mask, sampler_Vignette_Mask, x_897);
    u_xlat1.x = x_898.w;
    let x_902 : f32 = u_xlat1.x;
    u_xlat1.z = (x_902 + 0.055f);
    let x_906 : vec4<f32> = u_xlat1;
    let x_911 : vec2<f32> = (vec2<f32>(x_906.x, x_906.z) * vec2<f32>(0.077399381f, 0.947867334f));
    let x_912 : vec3<f32> = u_xlat7;
    u_xlat7 = vec3<f32>(x_911.x, x_911.y, x_912.z);
    let x_916 : f32 = u_xlat7.y;
    u_xlat13 = max(abs(x_916), 1.1920929e-07f);
    let x_920 : f32 = u_xlat13;
    u_xlat13 = log2(x_920);
    let x_922 : f32 = u_xlat13;
    u_xlat13 = (x_922 * 2.400000095f);
    let x_925 : f32 = u_xlat13;
    u_xlat13 = exp2(x_925);
    let x_929 : f32 = u_xlat1.x;
    u_xlatb1 = (0.040449999f >= x_929);
    let x_931 : bool = u_xlatb1;
    if (x_931) {
      let x_936 : f32 = u_xlat7.x;
      x_932 = x_936;
    } else {
      let x_938 : f32 = u_xlat13;
      x_932 = x_938;
    }
    let x_939 : f32 = x_932;
    u_xlat1.x = x_939;
    let x_942 : vec3<f32> = x_31.x_Vignette_Color;
    u_xlat7 = (-(x_942) + vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_945 : vec4<f32> = u_xlat1;
    let x_947 : vec3<f32> = u_xlat7;
    let x_950 : vec3<f32> = x_31.x_Vignette_Color;
    u_xlat7 = ((vec3<f32>(x_945.x, x_945.x, x_945.x) * x_947) + x_950);
    let x_952 : vec4<f32> = u_xlat0;
    let x_954 : vec3<f32> = u_xlat7;
    let x_956 : vec4<f32> = u_xlat0;
    u_xlat7 = ((vec3<f32>(x_952.x, x_952.y, x_952.z) * x_954) + -(vec3<f32>(x_956.x, x_956.y, x_956.z)));
    let x_962 : f32 = x_31.x_Vignette_Opacity;
    let x_964 : vec3<f32> = u_xlat7;
    let x_966 : vec4<f32> = u_xlat0;
    let x_968 : vec3<f32> = ((vec3<f32>(x_962, x_962, x_962) * x_964) + vec3<f32>(x_966.x, x_966.y, x_966.z));
    let x_969 : vec4<f32> = u_xlat3;
    u_xlat3 = vec4<f32>(x_968.x, x_968.y, x_968.z, x_969.w);
    let x_972 : f32 = u_xlat0.w;
    u_xlat0.x = (x_972 + -1.0f);
    let x_976 : f32 = u_xlat1.x;
    let x_978 : f32 = u_xlat0.x;
    u_xlat3.w = ((x_976 * x_978) + 1.0f);
  }
  let x_982 : vec4<f32> = u_xlat3;
  let x_985 : f32 = x_31.x_PostExposure;
  let x_987 : f32 = x_31.x_PostExposure;
  let x_989 : f32 = x_31.x_PostExposure;
  let x_991 : f32 = x_31.x_PostExposure;
  let x_992 : vec4<f32> = vec4<f32>(x_985, x_987, x_989, x_991);
  u_xlat0 = (x_982 * vec4<f32>(x_992.x, x_992.y, x_992.z, x_992.w));
  let x_999 : vec4<f32> = u_xlat0;
  let x_1006 : vec3<f32> = ((vec3<f32>(x_999.z, x_999.x, x_999.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1007 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1006.x, x_1006.y, x_1006.z, x_1007.w);
  ...
  let x_1021 : vec3<f32> = ((vec3<f32>(x_1014.x, x_1014.y, x_1014.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1022 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1021.x, x_1021.y, x_1021.z, x_1022.w);
  let x_1024 : vec4<f32> = u_xlat0;
  let x_1028 : vec3<f32> = clamp(vec3<f32>(x_1024.x, x_1024.y, x_1024.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1029 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1028.x, x_1028.y, x_1028.z, x_1029.w);
  let x_1031 : vec4<f32> = u_xlat0;
  let x_1035 : vec3<f32> = x_31.x_Lut2D_Params;
  let x_1037 : vec3<f32> = (vec3<f32>(x_1031.x, x_1031.y, x_1031.z) * vec3<f32>(x_1035.z, x_1035.z, x_1035.z));
  let x_1038 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1037.x, x_1037.y, x_1037.z, x_1038.w);
  let x_1041 : f32 = u_xlat1.x;
  u_xlat6 = floor(x_1041);
  let x_1044 : vec3<f32> = x_31.x_Lut2D_Params;
  let x_1047 : vec2<f32> = (vec2<f32>(x_1044.x, x_1044.y) * vec2<f32>(0.5f, 0.5f));
  let x_1048 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1047.x, x_1048.y, x_1048.z, x_1047.y);
  let x_1050 : vec4<f32> = u_xlat1;
  let x_1053 : vec3<f32> = x_31.x_Lut2D_Params;
  let x_1056 : vec4<f32> = u_xlat1;
  let x_1058 : vec2<f32> = ((vec2<f32>(x_1050.y, x_1050.z) * vec2<f32>(x_1053.x, x_1053.y)) + vec2<f32>(x_1056.x, x_1056.w));
  let x_1059 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1059.x, x_1058.x, x_1058.y, x_1059.w);
  let x_1061 : f32 = u_xlat6;
  let x_1063 : f32 = x_31.x_Lut2D_Params.y;
  let x_1066 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1061 * x_1063) + x_1066);
  let x_1074 : vec4<f32> = u_xlat1;
  let x_1076 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1074.x, x_1074.z));
  u_xlat2 = vec3<f32>(x_1076.x, x_1076.y, x_1076.z);
  let x_1079 : f32 = x_31.x_Lut2D_Params.y;
  u_xlat3.x = x_1079;
  u_xlat3.y = 0.0f;
  let x_1082 : vec4<f32> = u_xlat1;
  let x_1084 : vec4<f32> = u_xlat3;
  let x_1086 : vec2<f32> = (vec2<f32>(x_1082.x, x_1082.z) + vec2<f32>(x_1084.x, x_1084.y));
  let x_1087 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1086.x, x_1086.y, x_1087.z, x_1087.w);
  let x_1092 : vec4<f32> = u_xlat1;
  let x_1094 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1092.x, x_1092.y));
  let x_1095 : vec3<f32> = vec3<f32>(x_1094.x, x_1094.y, x_1094.z);
  let x_1096 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1095.x, x_1095.y, x_1095.z, x_1096.w);
  let x_1099 : f32 = u_xlat0.x;
  let x_1101 : f32 = x_31.x_Lut2D_Params.z;
  let x_1103 : f32 = u_xlat6;
  u_xlat0.x = ((x_1099 * x_1101) + -(x_1103));
  ...
  u_xlat1 = vec4<f32>(x_1111.x, x_1111.y, x_1111.z, x_1112.w);
  let x_1114 : vec4<f32> = u_xlat0;
  let x_1116 : vec4<f32> = u_xlat1;
  let x_1119 : vec3<f32> = u_xlat2;
  let x_1120 : vec3<f32> = ((vec3<f32>(x_1114.x, x_1114.x, x_1114.x) * vec3<f32>(x_1116.x, x_1116.y, x_1116.z)) + x_1119);
  let x_1121 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1120.x, x_1120.y, x_1120.z, x_1121.w);
  let x_1123 : vec4<f32> = phase0_Input0_1;
  let x_1127 : vec4<f32> = x_31.x_Dithering_Coords;
  let x_1131 : vec4<f32> = x_31.x_Dithering_Coords;
  let x_1133 : vec2<f32> = ((vec2<f32>(x_1123.x, x_1123.y) * vec2<f32>(x_1127.x, x_1127.y)) + vec2<f32>(x_1131.z, x_1131.w));
  let x_1134 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1133.x, x_1133.y, x_1134.z, x_1134.w);
  let x_1141 : vec4<f32> = u_xlat1;
  let x_1143 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1141.x, x_1141.y));
  u_xlat1.x = x_1143.w;
  let x_1147 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1147 * 2.0f) + -1.0f);
  let x_1152 : f32 = u_xlat1.x;
  u_xlat7.x = ((x_1152 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1158 : f32 = u_xlat7.x;
  u_xlat7.x = clamp(x_1158, 0.0f, 1.0f);
  let x_1162 : f32 = u_xlat7.x;
  u_xlat7.x = ((x_1162 * 2.0f) + -1.0f);
  let x_1167 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1167)) + 1.0f);
  let x_1173 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1173);
  let x_1177 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1177) + 1.0f);
  let x_1182 : f32 = u_xlat1.x;
  let x_1184 : f32 = u_xlat7.x;
  u_xlat1.x = (x_1182 * x_1184);
  let x_1187 : vec4<f32> = u_xlat0;
  u_xlat7 = (vec3<f32>(x_1187.x, x_1187.y, x_1187.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1192 : vec4<f32> = u_xlat0;
  u_xlat2 = max(abs(vec3<f32>(x_1192.x, x_1192.y, x_1192.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1197 : vec3<f32> = u_xlat2;
  u_xlat2 = log2(x_1197);
  let x_1199 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1199 * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1203 : vec3<f32> = u_xlat2;
  u_xlat2 = exp2(x_1203);
  let x_1205 : vec3<f32> = u_xlat2;
  u_xlat2 = ((x_1205 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1214 : vec4<f32> = u_xlat0;
  let x_1217 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1214.x, x_1214.y, x_1214.z, x_1214.x));
  u_xlatb0 = vec3<bool>(x_1217.x, x_1217.y, x_1217.z);
  let x_1220 : bool = u_xlatb0.x;
  if (x_1220) {
  ...
  u_xlat0.x = x_1229;
  let x_1232 : bool = u_xlatb0.y;
  if (x_1232) {
    let x_1237 : f32 = u_xlat7.y;
    x_1233 = x_1237;
  } else {
    let x_1240 : f32 = u_xlat2.y;
    x_1233 = x_1240;
  }
  let x_1241 : f32 = x_1233;
  u_xlat0.y = x_1241;
  let x_1244 : bool = u_xlatb0.z;
  if (x_1244) {
    let x_1249 : f32 = u_xlat7.z;
    x_1245 = x_1249;
  } else {
    let x_1252 : f32 = u_xlat2.z;
    x_1245 = x_1252;
  }
  ...
  let x_1262 : vec3<f32> = ((vec3<f32>(x_1255.x, x_1255.x, x_1255.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1260.x, x_1260.y, x_1260.z));
  let x_1263 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1262.x, x_1262.y, x_1262.z, x_1263.w);
  let x_1265 : vec4<f32> = u_xlat0;
  let x_1268 : vec3<f32> = (vec3<f32>(x_1265.x, x_1265.y, x_1265.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1269 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1268.x, x_1268.y, x_1268.z, x_1269.w);
  let x_1271 : vec4<f32> = u_xlat0;
  u_xlat2 = (vec3<f32>(x_1271.x, x_1271.y, x_1271.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1275 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1275 * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1278 : vec3<f32> = u_xlat2;
  u_xlat2 = max(abs(x_1278), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1281 : vec3<f32> = u_xlat2;
  u_xlat2 = log2(x_1281);
  let x_1283 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1283 * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1286 : vec3<f32> = u_xlat2;
  u_xlat2 = exp2(x_1286);
  let x_1289 : vec4<f32> = u_xlat0;
  let x_1291 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1289.x, x_1289.y, x_1289.z, x_1289.x));
  u_xlatb0 = vec3<bool>(x_1291.x, x_1291.y, x_1291.z);
  ...
  SV_Target0.x = x_1305;
  let x_1309 : bool = u_xlatb0.y;
  if (x_1309) {
    let x_1314 : f32 = u_xlat1.y;
    x_1310 = x_1314;
  } else {
  ...
  SV_Target0.y = x_1318;
  let x_1321 : bool = u_xlatb0.z;
  if (x_1321) {
    let x_1326 : f32 = u_xlat1.z;
    x_1322 = x_1326;
  } else {
