...
fn main_1() {
  ...
  let x_1520 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1524 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1526 : vec2<f32> = ((x_1517 * vec2<f32>(x_1520.x, x_1520.y)) + vec2<f32>(x_1524.z, x_1524.w));
  let x_1527 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1526.x, x_1526.y, x_1527.z);
  let x_1534 : vec3<f32> = u_xlat1;
  let x_1536 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1534.x, x_1534.y));
  u_xlat30 = x_1536.w;
  let x_1538 : f32 = u_xlat30;
  u_xlat30 = ((x_1538 * 2.0f) + -1.0f);
  let x_1541 : f32 = u_xlat30;
  u_xlat1.x = ((x_1541 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1547 : f32 = u_xlat1.x;
  u_xlat1.x = clamp(x_1547, 0.0f, 1.0f);
  let x_1551 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1551 * 2.0f) + -1.0f);
  let x_1555 : f32 = u_xlat30;
  u_xlat30 = (-(abs(x_1555)) + 1.0f);
  let x_1559 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1559);
  let x_1561 : f32 = u_xlat30;
  u_xlat30 = (-(x_1561) + 1.0f);
  let x_1564 : f32 = u_xlat30;
  let x_1566 : f32 = u_xlat1.x;
  u_xlat30 = (x_1564 * x_1566);
  let x_1568 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1568.x, x_1568.y, x_1568.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1571 : vec4<f32> = u_xlat0;
  u_xlat2 = max(abs(vec3<f32>(x_1571.x, x_1571.y, x_1571.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1575 : vec3<f32> = u_xlat2;
  u_xlat2 = log2(x_1575);
  let x_1577 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1577 * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1579 : vec3<f32> = u_xlat2;
  u_xlat2 = exp2(x_1579);
  let x_1581 : vec3<f32> = u_xlat2;
  u_xlat2 = ((x_1581 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1584 : vec4<f32> = u_xlat0;
  let x_1586 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1584.x, x_1584.y, x_1584.z, x_1584.x));
  u_xlatb0 = vec3<bool>(x_1586.x, x_1586.y, x_1586.z);
  let x_1589 : bool = u_xlatb0.x;
  if (x_1589) {
  ...
  let x_1598 : f32 = x_1590;
  u_xlat0.x = x_1598;
  let x_1601 : bool = u_xlatb0.y;
  if (x_1601) {
    let x_1606 : f32 = u_xlat1.y;
    x_1602 = x_1606;
  } else {
    let x_1609 : f32 = u_xlat2.y;
    x_1602 = x_1609;
  }
  let x_1610 : f32 = x_1602;
  u_xlat0.y = x_1610;
  let x_1613 : bool = u_xlatb0.z;
  if (x_1613) {
    let x_1618 : f32 = u_xlat1.z;
    x_1614 = x_1618;
  } else {
  ...
  u_xlat0.z = x_1622;
  let x_1624 : f32 = u_xlat30;
  let x_1629 : vec4<f32> = u_xlat0;
  let x_1631 : vec3<f32> = ((vec3<f32>(x_1624, x_1624, x_1624) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1629.x, x_1629.y, x_1629.z));
  let x_1632 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1631.x, x_1631.y, x_1631.z, x_1632.w);
  let x_1634 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1634.x, x_1634.y, x_1634.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1637 : vec4<f32> = u_xlat0;
  u_xlat2 = (vec3<f32>(x_1637.x, x_1637.y, x_1637.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1640 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1640 * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1642 : vec3<f32> = u_xlat2;
  u_xlat2 = max(abs(x_1642), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1645 : vec3<f32> = u_xlat2;
  u_xlat2 = log2(x_1645);
  let x_1647 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1647 * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1649 : vec3<f32> = u_xlat2;
  u_xlat2 = exp2(x_1649);
  ...
  SV_Target0.x = x_1667;
  let x_1671 : bool = u_xlatb0.y;
  if (x_1671) {
    let x_1676 : f32 = u_xlat1.y;
    x_1672 = x_1676;
  } else {
    let x_1679 : f32 = u_xlat2.y;
    x_1672 = x_1679;
  }
  let x_1680 : f32 = x_1672;
  SV_Target0.y = x_1680;
  let x_1683 : bool = u_xlatb0.z;
  if (x_1683) {
