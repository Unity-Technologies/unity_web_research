...
fn main_1() {
  ...
  u_xlat3.z = x_1693;
  let x_1697 : f32 = x_26.x_LumaInAlpha;
  u_xlatb0.x = (0.5f < x_1697);
  let x_1701 : bool = u_xlatb0.x;
  if (x_1701) {
    let x_1704 : vec4<f32> = u_xlat3;
    let x_1705 : vec3<f32> = vec3<f32>(x_1704.x, x_1704.y, x_1704.z);
    let x_1706 : vec4<f32> = u_xlat0;
    u_xlat0 = vec4<f32>(x_1705.x, x_1705.y, x_1705.z, x_1706.w);
    let x_1708 : vec4<f32> = u_xlat0;
    let x_1712 : vec3<f32> = clamp(vec3<f32>(x_1708.x, x_1708.y, x_1708.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1713 : vec4<f32> = u_xlat0;
    u_xlat0 = vec4<f32>(x_1712.x, x_1712.y, x_1712.z, x_1713.w);
    let x_1715 : vec4<f32> = u_xlat0;
    u_xlat3.w = dot(vec3<f32>(x_1715.x, x_1715.y, x_1715.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
