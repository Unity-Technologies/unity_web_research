...
fn main_1() {
  ...
  u_xlat0 = (x_1128 * vec4<f32>(x_1138.x, x_1138.y, x_1138.z, x_1138.w));
  let x_1145 : vec4<f32> = u_xlat0;
  let x_1152 : vec3<f32> = ((vec3<f32>(x_1145.z, x_1145.x, x_1145.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1153 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1152.x, x_1152.y, x_1152.z, x_1153.w);
  let x_1155 : vec4<f32> = u_xlat0;
  let x_1157 : vec3<f32> = log2(vec3<f32>(x_1155.x, x_1155.y, x_1155.z));
  let x_1158 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1157.x, x_1157.y, x_1157.z, x_1158.w);
  let x_1160 : vec4<f32> = u_xlat0;
  let x_1167 : vec3<f32> = ((vec3<f32>(x_1160.x, x_1160.y, x_1160.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1168 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1167.x, x_1167.y, x_1167.z, x_1168.w);
  ...
  let x_1183 : vec3<f32> = (vec3<f32>(x_1177.x, x_1177.y, x_1177.z) * vec3<f32>(x_1181.z, x_1181.z, x_1181.z));
  let x_1184 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1183.x, x_1183.y, x_1183.z, x_1184.w);
  let x_1188 : f32 = u_xlat1.x;
  u_xlat10 = floor(x_1188);
  let x_1191 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1193 : vec2<f32> = (vec2<f32>(x_1191.x, x_1191.y) * vec2<f32>(0.5f, 0.5f));
  let x_1194 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1193.x, x_1194.y, x_1194.z, x_1193.y);
  let x_1196 : vec4<f32> = u_xlat1;
  let x_1199 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1202 : vec4<f32> = u_xlat1;
  let x_1204 : vec2<f32> = ((vec2<f32>(x_1196.y, x_1196.z) * vec2<f32>(x_1199.x, x_1199.y)) + vec2<f32>(x_1202.x, x_1202.w));
  let x_1205 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1205.x, x_1204.x, x_1204.y, x_1205.w);
  let x_1207 : f32 = u_xlat10;
  let x_1209 : f32 = x_26.x_Lut2D_Params.y;
  let x_1212 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1207 * x_1209) + x_1212);
  let x_1220 : vec4<f32> = u_xlat1;
  let x_1222 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1220.x, x_1220.z));
  ...
  let x_1227 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat3.x = x_1227;
  u_xlat3.y = 0.0f;
  ...
  u_xlat1 = vec4<f32>(x_1234.x, x_1234.y, x_1235.z, x_1235.w);
  let x_1240 : vec4<f32> = u_xlat1;
  let x_1242 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1240.x, x_1240.y));
  let x_1243 : vec3<f32> = vec3<f32>(x_1242.x, x_1242.y, x_1242.z);
  let x_1244 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1243.x, x_1243.y, x_1243.z, x_1244.w);
  let x_1247 : f32 = u_xlat0.x;
  let x_1250 : f32 = x_26.x_Lut2D_Params.z;
  let x_1252 : f32 = u_xlat10;
  u_xlat0.x = ((x_1247 * x_1250) + -(x_1252));
  let x_1256 : vec4<f32> = u_xlat2;
  let x_1259 : vec4<f32> = u_xlat1;
  let x_1261 : vec3<f32> = (-(vec3<f32>(x_1256.x, x_1256.y, x_1256.z)) + vec3<f32>(x_1259.x, x_1259.y, x_1259.z));
  let x_1262 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1261.x, x_1261.y, x_1261.z, x_1262.w);
  let x_1264 : vec4<f32> = u_xlat0;
  let x_1266 : vec4<f32> = u_xlat1;
  let x_1269 : vec4<f32> = u_xlat2;
  let x_1271 : vec3<f32> = ((vec3<f32>(x_1264.x, x_1264.x, x_1264.x) * vec3<f32>(x_1266.x, x_1266.y, x_1266.z)) + vec3<f32>(x_1269.x, x_1269.y, x_1269.z));
  let x_1272 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1271.x, x_1271.y, x_1271.z, x_1272.w);
  let x_1274 : vec2<f32> = vs_TEXCOORD0;
  let x_1277 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1281 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1283 : vec2<f32> = ((x_1274 * vec2<f32>(x_1277.x, x_1277.y)) + vec2<f32>(x_1281.z, x_1281.w));
  let x_1284 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1283.x, x_1283.y, x_1284.z, x_1284.w);
  let x_1291 : vec4<f32> = u_xlat1;
  let x_1293 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1291.x, x_1291.y));
  u_xlat1.x = x_1293.w;
  let x_1297 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1297 * 2.0f) + -1.0f);
  let x_1302 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1302 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1308 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1308, 0.0f, 1.0f);
  let x_1312 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1312 * 2.0f) + -1.0f);
  let x_1317 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1317)) + 1.0f);
  let x_1323 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1323);
  let x_1327 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1327) + 1.0f);
  let x_1332 : f32 = u_xlat1.x;
  let x_1334 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1332 * x_1334);
  let x_1337 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1337.x, x_1337.y, x_1337.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1342 : vec4<f32> = u_xlat0;
  let x_1347 : vec3<f32> = max(abs(vec3<f32>(x_1342.x, x_1342.y, x_1342.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1348 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1347.x, x_1347.y, x_1347.z, x_1348.w);
  let x_1350 : vec4<f32> = u_xlat2;
  let x_1352 : vec3<f32> = log2(vec3<f32>(x_1350.x, x_1350.y, x_1350.z));
  let x_1353 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1352.x, x_1352.y, x_1352.z, x_1353.w);
  let x_1355 : vec4<f32> = u_xlat2;
  let x_1359 : vec3<f32> = (vec3<f32>(x_1355.x, x_1355.y, x_1355.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1360 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1359.x, x_1359.y, x_1359.z, x_1360.w);
  let x_1362 : vec4<f32> = u_xlat2;
  let x_1364 : vec3<f32> = exp2(vec3<f32>(x_1362.x, x_1362.y, x_1362.z));
  let x_1365 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1364.x, x_1364.y, x_1364.z, x_1365.w);
  let x_1367 : vec4<f32> = u_xlat2;
  let x_1374 : vec3<f32> = ((vec3<f32>(x_1367.x, x_1367.y, x_1367.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1375 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1374.x, x_1374.y, x_1374.z, x_1375.w);
  let x_1382 : vec4<f32> = u_xlat0;
  let x_1385 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1382.x, x_1382.y, x_1382.z, x_1382.x));
  u_xlatb0 = vec3<bool>(x_1385.x, x_1385.y, x_1385.z);
  let x_1388 : bool = u_xlatb0.x;
  if (x_1388) {
    let x_1393 : f32 = u_xlat11.x;
    x_1389 = x_1393;
  } else {
    let x_1396 : f32 = u_xlat2.x;
    x_1389 = x_1396;
  }
  ...
  let x_1430 : vec3<f32> = ((vec3<f32>(x_1423.x, x_1423.x, x_1423.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1428.x, x_1428.y, x_1428.z));
  let x_1431 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1430.x, x_1430.y, x_1430.z, x_1431.w);
  let x_1433 : vec4<f32> = u_xlat0;
  let x_1437 : vec3<f32> = (vec3<f32>(x_1433.x, x_1433.y, x_1433.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1438 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1437.x, x_1437.y, x_1437.z, x_1438.w);
  let x_1440 : vec4<f32> = u_xlat0;
  let x_1444 : vec3<f32> = (vec3<f32>(x_1440.x, x_1440.y, x_1440.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1445 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1444.x, x_1444.y, x_1444.z, x_1445.w);
  let x_1447 : vec4<f32> = u_xlat2;
  let x_1451 : vec3<f32> = (vec3<f32>(x_1447.x, x_1447.y, x_1447.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1452 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1451.x, x_1451.y, x_1451.z, x_1452.w);
  let x_1454 : vec4<f32> = u_xlat2;
  let x_1457 : vec3<f32> = max(abs(vec3<f32>(x_1454.x, x_1454.y, x_1454.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1458 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1457.x, x_1457.y, x_1457.z, x_1458.w);
  let x_1460 : vec4<f32> = u_xlat2;
  let x_1462 : vec3<f32> = log2(vec3<f32>(x_1460.x, x_1460.y, x_1460.z));
  let x_1463 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1462.x, x_1462.y, x_1462.z, x_1463.w);
  let x_1465 : vec4<f32> = u_xlat2;
  let x_1469 : vec3<f32> = (vec3<f32>(x_1465.x, x_1465.y, x_1465.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1481 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1479.x, x_1479.y, x_1479.z, x_1479.x));
  ...
  SV_Target0.x = x_1495;
  let x_1499 : bool = u_xlatb0.y;
  if (x_1499) {
    let x_1504 : f32 = u_xlat1.y;
    x_1500 = x_1504;
  } else {
    let x_1507 : f32 = u_xlat2.y;
    x_1500 = x_1507;
  }
  let x_1508 : f32 = x_1500;
  SV_Target0.y = x_1508;
  let x_1511 : bool = u_xlatb0.z;
  if (x_1511) {
