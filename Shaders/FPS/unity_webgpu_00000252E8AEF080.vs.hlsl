...
float2 _LightCoord : TEXCOORD5 ; float4 _ShadowCoord : TEXCOORD6 ;
#line 130
} ;
float4 _MainTex_ST ;
#line 134
...
#line 204
surf ( surfIN , o ) ;
float2 lightCoord = mul ( unity_WorldToLight , float4 ( worldPos , 1 ) ) . xy ; float shadow = UnityComputeForwardShadows ( 0 , worldPos , IN . _ShadowCoord ) ; float atten = tex2D ( _LightTexture0 , lightCoord ) . w * shadow ;
float4 c = 0 ;
float3 worldN ;
