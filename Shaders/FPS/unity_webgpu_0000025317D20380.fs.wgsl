...
fn main_1() {
  ...
  let x_491 : vec3<f32> = ((vec3<f32>(x_484.x, x_484.y, x_484.z) * vec3<f32>(x_486, x_486, x_486)) + vec3<f32>(x_489.x, x_489.y, x_489.z));
  let x_492 : vec4<f32> = SV_Target3;
  SV_Target3 = vec4<f32>(x_491.x, x_491.y, x_491.z, x_492.w);
  SV_Target3.w = 1.0f;
  return;
}
