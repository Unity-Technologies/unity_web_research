...
#line 10 "F:/src/unity_webgpu/Shaders/Includes/UnityDeferredLibrary.cginc"
...
#line 78 "F:/src/unity_webgpu/Shaders/Includes/UnityDeferredLibrary.cginc"
...
#line 196
atten *= texCUBEbias ( _LightTexture0 , float4 ( mul ( unity_WorldToLight , float4 ( wpos , 1 ) ) . xyz , - 8 ) ) . w ;
#line 203
outWorldPos = wpos ;
outUV = uv ;
...
float4 res = BRDF1_Unity_PBS ( data . diffuseColor , data . specularColor , oneMinusReflectivity , data . smoothness , data . normalWorld , - eyeVec , light , ind ) ;
