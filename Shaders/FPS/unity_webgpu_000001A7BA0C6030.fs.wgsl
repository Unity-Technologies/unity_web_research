...
fn main_1() {
  ...
  let x_1230 : f32 = x_26.x_LumaInAlpha;
  u_xlatb0 = (0.5f < x_1230);
  ...
  if (x_1232) {
    ...
    u_xlat2.w = dot(vec3<f32>(x_1246.x, x_1246.y, x_1246.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
