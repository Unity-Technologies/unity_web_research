...
layout(set = 0, binding = 13, std140) uniform UnityDrawCallInfo {
...
layout(set = 0, binding = 14, std430) readonly buffer unity_ParticleInstanceData {
...
void main()
{
    ...
    u_xlatu7.xy = uvec2(uint_bitfieldExtract(floatBitsToUint(u_xlat2.w), int(8), int(8)), uint_bitfieldExtract(floatBitsToUint(u_xlat2.w), int(16), int(8)));
