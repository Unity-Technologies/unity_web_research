...
void main()
{
    ...
    u_xlat49 = u_xlat3.w * vs_COLOR0.w + (-_Cutoff);
    u_xlat49 = u_xlat49 + 9.99999975e-05;
    ...
    u_xlat52 = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat7.xy).x;
    u_xlat51 = u_xlat51 + (-u_xlat52);
    u_xlat49 = u_xlat49 * u_xlat51 + u_xlat52;
    ...
    u_xlat9.xyz = u_xlat10.xyz + vs_TEXCOORD5.xyz;
    ...
    if(u_xlatb52){
        ...
        if(u_xlatb52){
            ...
            u_xlat7.xyz = u_xlat12.xyz * vec3(u_xlat52) + u_xlat0.xyz;
        }
        u_xlat7 = textureLod(samplerCube(unity_SpecCube1, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat49);
