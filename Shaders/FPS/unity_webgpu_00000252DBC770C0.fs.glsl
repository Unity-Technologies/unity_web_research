...
void main()
{
    ...
    u_xlat24 = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec0, 0.0);
    ...
    u_xlat24 = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat5.xy).w;
    u_xlat23 = u_xlat23 * u_xlat24;
    u_xlat24 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat24 = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), vec2(u_xlat24)).x;
    u_xlat23 = u_xlat23 * u_xlat24;
