...
@group(0) @binding(2) var<uniform> x_221 : UnityInstancing_PerDraw2;
...
fn main_1() {
  ...
  u_xlat2 = (vec4<f32>(x_211.y, x_211.z, x_211.z, x_211.x) * vec4<f32>(x_213.x, x_213.y, x_213.z, x_213.z));
  ...
  let x_241 : vec4<f32> = x_221.unity_Builtins2Array[(x_237 / 7i)].unity_SHBbArray;
  let x_242 : vec4<f32> = u_xlat2;
  u_xlat3.z = dot(x_241, x_242);
  let x_246 : i32 = u_xlati0;
  let x_250 : vec4<f32> = x_221.unity_Builtins2Array[(x_246 / 7i)].unity_SHCArray;
  let x_252 : vec4<f32> = u_xlat1;
  let x_255 : vec3<f32> = u_xlat3;
  vs_TEXCOORD5 = ((vec3<f32>(x_250.x, x_250.y, x_250.z) * vec3<f32>(x_252.x, x_252.x, x_252.x)) + x_255);
...
fn main(@builtin(instance_index) gl_InstanceIndex_param : u32, @location(0) in_POSITION0_param : vec4<f32>, @location(1) in_NORMAL0_param : vec3<f32>, @location(2) in_COLOR0_param : vec4<f32>, @location(3) in_TEXCOORD0_param : vec2<f32>) -> main_out {
  ...
  main_1();
  return main_out(vs_TEXCOORD1, gl_Position, vs_TEXCOORD0, vs_COLOR0, vs_TEXCOORD2, vs_TEXCOORD5, vs_SV_InstanceID0);
}
