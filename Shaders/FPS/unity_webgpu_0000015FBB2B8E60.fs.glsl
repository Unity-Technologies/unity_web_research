...
void main()
{
    ...
    u_xlat25 = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat12.xy).w;
    u_xlat25 = u_xlat25 * u_xlat5.x;
    u_xlat4.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat4.x = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), u_xlat4.xx).x;
