...
fn main_1() {
  ...
  let x_1211 : f32 = x_26.x_PostExposure;
  let x_1213 : f32 = x_26.x_PostExposure;
  let x_1215 : f32 = x_26.x_PostExposure;
  let x_1217 : f32 = x_26.x_PostExposure;
  let x_1218 : vec4<f32> = vec4<f32>(x_1211, x_1213, x_1215, x_1217);
  u_xlat0 = (x_1208 * vec4<f32>(x_1218.x, x_1218.y, x_1218.z, x_1218.w));
  let x_1225 : vec4<f32> = u_xlat0;
  let x_1232 : vec3<f32> = ((vec3<f32>(x_1225.z, x_1225.x, x_1225.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1233 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1232.x, x_1232.y, x_1232.z, x_1233.w);
  let x_1235 : vec4<f32> = u_xlat0;
  let x_1237 : vec3<f32> = log2(vec3<f32>(x_1235.x, x_1235.y, x_1235.z));
  let x_1238 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1237.x, x_1237.y, x_1237.z, x_1238.w);
  let x_1240 : vec4<f32> = u_xlat0;
  let x_1247 : vec3<f32> = ((vec3<f32>(x_1240.x, x_1240.y, x_1240.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  ...
  let x_1261 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1263 : vec3<f32> = (vec3<f32>(x_1257.x, x_1257.y, x_1257.z) * vec3<f32>(x_1261.z, x_1261.z, x_1261.z));
  let x_1264 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1263.x, x_1263.y, x_1263.z, x_1264.w);
  let x_1268 : f32 = u_xlat1.x;
  u_xlat10 = floor(x_1268);
  let x_1271 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1273 : vec2<f32> = (vec2<f32>(x_1271.x, x_1271.y) * vec2<f32>(0.5f, 0.5f));
  let x_1274 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1273.x, x_1274.y, x_1274.z, x_1273.y);
  let x_1276 : vec4<f32> = u_xlat1;
  let x_1279 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1282 : vec4<f32> = u_xlat1;
  let x_1284 : vec2<f32> = ((vec2<f32>(x_1276.y, x_1276.z) * vec2<f32>(x_1279.x, x_1279.y)) + vec2<f32>(x_1282.x, x_1282.w));
  let x_1285 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1285.x, x_1284.x, x_1284.y, x_1285.w);
  let x_1287 : f32 = u_xlat10;
  let x_1289 : f32 = x_26.x_Lut2D_Params.y;
  let x_1292 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1287 * x_1289) + x_1292);
  let x_1300 : vec4<f32> = u_xlat1;
  let x_1302 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1300.x, x_1300.z));
  ...
  let x_1322 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1320.x, x_1320.y));
  let x_1323 : vec3<f32> = vec3<f32>(x_1322.x, x_1322.y, x_1322.z);
  let x_1324 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1323.x, x_1323.y, x_1323.z, x_1324.w);
  let x_1327 : f32 = u_xlat0.x;
  let x_1330 : f32 = x_26.x_Lut2D_Params.z;
  let x_1332 : f32 = u_xlat10;
  u_xlat0.x = ((x_1327 * x_1330) + -(x_1332));
  let x_1336 : vec4<f32> = u_xlat2;
  let x_1339 : vec4<f32> = u_xlat1;
  let x_1341 : vec3<f32> = (-(vec3<f32>(x_1336.x, x_1336.y, x_1336.z)) + vec3<f32>(x_1339.x, x_1339.y, x_1339.z));
  ...
  let x_1351 : vec3<f32> = ((vec3<f32>(x_1344.x, x_1344.x, x_1344.x) * vec3<f32>(x_1346.x, x_1346.y, x_1346.z)) + vec3<f32>(x_1349.x, x_1349.y, x_1349.z));
  let x_1352 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1351.x, x_1351.y, x_1351.z, x_1352.w);
  let x_1354 : vec2<f32> = vs_TEXCOORD0;
  let x_1357 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1361 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1363 : vec2<f32> = ((x_1354 * vec2<f32>(x_1357.x, x_1357.y)) + vec2<f32>(x_1361.z, x_1361.w));
  let x_1364 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1363.x, x_1363.y, x_1364.z, x_1364.w);
  let x_1371 : vec4<f32> = u_xlat1;
  let x_1373 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1371.x, x_1371.y));
  u_xlat1.x = x_1373.w;
  let x_1377 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1377 * 2.0f) + -1.0f);
  let x_1382 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1382 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1388 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1388, 0.0f, 1.0f);
  let x_1392 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1392 * 2.0f) + -1.0f);
  let x_1397 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1397)) + 1.0f);
  let x_1403 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1403);
  let x_1407 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1407) + 1.0f);
  let x_1412 : f32 = u_xlat1.x;
  let x_1414 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1412 * x_1414);
  let x_1417 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1417.x, x_1417.y, x_1417.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1422 : vec4<f32> = u_xlat0;
  let x_1427 : vec3<f32> = max(abs(vec3<f32>(x_1422.x, x_1422.y, x_1422.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1439 : vec3<f32> = (vec3<f32>(x_1435.x, x_1435.y, x_1435.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1454 : vec3<f32> = ((vec3<f32>(x_1447.x, x_1447.y, x_1447.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1455 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1454.x, x_1454.y, x_1454.z, x_1455.w);
  let x_1462 : vec4<f32> = u_xlat0;
  let x_1465 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1462.x, x_1462.y, x_1462.z, x_1462.x));
  u_xlatb0 = vec3<bool>(x_1465.x, x_1465.y, x_1465.z);
  let x_1468 : bool = u_xlatb0.x;
  if (x_1468) {
    let x_1473 : f32 = u_xlat11.x;
    x_1469 = x_1473;
  } else {
    let x_1476 : f32 = u_xlat2.x;
    x_1469 = x_1476;
  }
  let x_1477 : f32 = x_1469;
  u_xlat0.x = x_1477;
  let x_1480 : bool = u_xlatb0.y;
  if (x_1480) {
    let x_1485 : f32 = u_xlat11.y;
    x_1481 = x_1485;
  } else {
    let x_1488 : f32 = u_xlat2.y;
    x_1481 = x_1488;
  }
  let x_1489 : f32 = x_1481;
  u_xlat0.y = x_1489;
  let x_1492 : bool = u_xlatb0.z;
  if (x_1492) {
  ...
  let x_1508 : vec4<f32> = u_xlat0;
  let x_1510 : vec3<f32> = ((vec3<f32>(x_1503.x, x_1503.x, x_1503.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1508.x, x_1508.y, x_1508.z));
  let x_1511 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1510.x, x_1510.y, x_1510.z, x_1511.w);
  let x_1513 : vec4<f32> = u_xlat0;
  let x_1517 : vec3<f32> = (vec3<f32>(x_1513.x, x_1513.y, x_1513.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1518 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1517.x, x_1517.y, x_1517.z, x_1518.w);
  let x_1520 : vec4<f32> = u_xlat0;
  let x_1524 : vec3<f32> = (vec3<f32>(x_1520.x, x_1520.y, x_1520.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1525 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1524.x, x_1524.y, x_1524.z, x_1525.w);
  let x_1527 : vec4<f32> = u_xlat2;
  let x_1531 : vec3<f32> = (vec3<f32>(x_1527.x, x_1527.y, x_1527.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1532 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1531.x, x_1531.y, x_1531.z, x_1532.w);
  let x_1534 : vec4<f32> = u_xlat2;
  let x_1537 : vec3<f32> = max(abs(vec3<f32>(x_1534.x, x_1534.y, x_1534.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1538 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1537.x, x_1537.y, x_1537.z, x_1538.w);
  let x_1540 : vec4<f32> = u_xlat2;
  let x_1542 : vec3<f32> = log2(vec3<f32>(x_1540.x, x_1540.y, x_1540.z));
  let x_1543 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1542.x, x_1542.y, x_1542.z, x_1543.w);
  let x_1545 : vec4<f32> = u_xlat2;
  let x_1549 : vec3<f32> = (vec3<f32>(x_1545.x, x_1545.y, x_1545.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1550 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1549.x, x_1549.y, x_1549.z, x_1550.w);
  let x_1552 : vec4<f32> = u_xlat2;
  let x_1554 : vec3<f32> = exp2(vec3<f32>(x_1552.x, x_1552.y, x_1552.z));
  let x_1555 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1554.x, x_1554.y, x_1554.z, x_1555.w);
  let x_1559 : vec4<f32> = u_xlat0;
  let x_1561 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1559.x, x_1559.y, x_1559.z, x_1559.x));
  u_xlatb0 = vec3<bool>(x_1561.x, x_1561.y, x_1561.z);
  let x_1566 : bool = u_xlatb0.x;
  if (x_1566) {
    let x_1571 : f32 = u_xlat1.x;
    x_1567 = x_1571;
  } else {
    let x_1574 : f32 = u_xlat2.x;
    x_1567 = x_1574;
  }
  let x_1575 : f32 = x_1567;
  SV_Target0.x = x_1575;
  let x_1579 : bool = u_xlatb0.y;
  if (x_1579) {
    let x_1584 : f32 = u_xlat1.y;
    x_1580 = x_1584;
  } else {
    let x_1587 : f32 = u_xlat2.y;
    x_1580 = x_1587;
  }
  let x_1588 : f32 = x_1580;
  SV_Target0.y = x_1588;
  let x_1591 : bool = u_xlatb0.z;
  if (x_1591) {
    let x_1596 : f32 = u_xlat1.z;
    x_1592 = x_1596;
  } else {
