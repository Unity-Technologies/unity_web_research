...
fn main_1() {
  ...
  u_xlatb3 = vec3<bool>(x_1410.x, x_1410.y, x_1410.z);
  let x_1414 : vec4<f32> = u_xlat0;
  hlslcc_movcTemp = x_1414;
  let x_1416 : bool = u_xlatb3.x;
  if (x_1416) {
  ...
  u_xlat3 = vec4<f32>(x_1553.x, x_1553.y, x_1553.z, x_1554.w);
  ...
  u_xlat3 = vec4<f32>(x_1564.x, x_1564.y, x_1564.z, x_1565.w);
  ...
  u_xlat2.z = x_1618;
  let x_1622 : f32 = x_26.x_LumaInAlpha;
  u_xlatb0.x = (0.5f < x_1622);
  let x_1626 : bool = u_xlatb0.x;
  if (x_1626) {
    let x_1629 : vec4<f32> = u_xlat2;
    let x_1630 : vec3<f32> = vec3<f32>(x_1629.x, x_1629.y, x_1629.z);
    let x_1631 : vec4<f32> = u_xlat0;
    u_xlat0 = vec4<f32>(x_1630.x, x_1630.y, x_1630.z, x_1631.w);
    let x_1633 : vec4<f32> = u_xlat0;
    let x_1637 : vec3<f32> = clamp(vec3<f32>(x_1633.x, x_1633.y, x_1633.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1638 : vec4<f32> = u_xlat0;
    u_xlat0 = vec4<f32>(x_1637.x, x_1637.y, x_1637.z, x_1638.w);
    let x_1640 : vec4<f32> = u_xlat0;
    u_xlat2.w = dot(vec3<f32>(x_1640.x, x_1640.y, x_1640.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
