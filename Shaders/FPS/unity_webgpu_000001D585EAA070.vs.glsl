...
void main()
{
    ...
    vs_TEXCOORD1.xyz = unity_Builtins0Array[u_xlati5 / 8].unity_ObjectToWorldArray[3].xyz * in_POSITION0.www + u_xlat1.xyz;
    ...
    gl_Position = u_xlat1;
    u_xlat3.x = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati5 / 8].unity_WorldToObjectArray[0].xyz);
    u_xlat3.y = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati5 / 8].unity_WorldToObjectArray[1].xyz);
    u_xlat3.z = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati5 / 8].unity_WorldToObjectArray[2].xyz);
    ...
    u_xlat3.x = u_xlat2.y * unity_MatrixV[1].z;
    u_xlat3.x = unity_MatrixV[0].z * u_xlat2.x + u_xlat3.x;
    u_xlat3.x = unity_MatrixV[2].z * u_xlat2.z + u_xlat3.x;
    u_xlat3.x = unity_MatrixV[3].z * u_xlat2.w + u_xlat3.x;
    ...
    vs_TEXCOORD4.xyz = unity_Builtins2Array[u_xlati0 / 7].unity_SHCArray.xyz * u_xlat1.xxx + u_xlat4.xyz;
