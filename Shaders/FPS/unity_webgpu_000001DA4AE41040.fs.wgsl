...
fn main_1() {
  ...
  if (x_147) {
    ...
    let x_154 : vec3<f32> = vs_TEXCOORD2;
    ...
    let x_166 : vec3<f32> = vs_TEXCOORD2;
  ...
  if (x_329) {
    ...
    let x_348 : vec3<f32> = vs_TEXCOORD2;
  ...
  if (x_507) {
    ...
    let x_540 : vec3<f32> = vs_TEXCOORD2;
  ...
  if (x_696) {
    ...
    if (x_703) {
      ...
      let x_721 : vec3<f32> = vs_TEXCOORD2;
      ...
      let x_733 : vec3<f32> = vs_TEXCOORD2;
      ...
      let x_797 : vec3<f32> = vs_TEXCOORD2;
  ...
  u_xlat39 = dot(vec3<f32>(x_943.x, x_943.y, x_943.z), vec3<f32>(x_945.x, x_945.y, x_945.z));
  let x_948 : vec4<f32> = u_xlat4;
  let x_951 : vec4<f32> = x_18.x_WorldSpaceLightPos0;
  u_xlat1.x = dot(vec3<f32>(x_948.x, x_948.y, x_948.z), vec3<f32>(x_951.x, x_951.y, x_951.z));
  let x_956 : f32 = u_xlat1.x;
  u_xlat1.x = clamp(x_956, 0.0f, 1.0f);
  let x_960 : vec4<f32> = u_xlat4;
  let x_962 : vec4<f32> = u_xlat0;
  u_xlat14 = dot(vec3<f32>(x_960.x, x_960.y, x_960.z), vec3<f32>(x_962.x, x_962.y, x_962.z));
  let x_965 : f32 = u_xlat14;
  u_xlat14 = clamp(x_965, 0.0f, 1.0f);
  let x_968 : vec4<f32> = x_18.x_WorldSpaceLightPos0;
  let x_970 : vec4<f32> = u_xlat0;
  u_xlat0.x = dot(vec3<f32>(x_968.x, x_968.y, x_968.z), vec3<f32>(x_970.x, x_970.y, x_970.z));
  let x_975 : f32 = u_xlat0.x;
  u_xlat0.x = clamp(x_975, 0.0f, 1.0f);
  let x_980 : f32 = u_xlat0.x;
  let x_982 : f32 = u_xlat0.x;
  u_xlat13.x = (x_980 * x_982);
  let x_985 : vec3<f32> = u_xlat13;
  let x_987 : f32 = u_xlat42;
  u_xlat13.x = dot(vec2<f32>(x_985.x, x_985.x), vec2<f32>(x_987, x_987));
  let x_992 : f32 = u_xlat13.x;
  u_xlat13.x = (x_992 + -0.5f);
  let x_998 : f32 = u_xlat1.x;
  u_xlat26 = (-(x_998) + 1.0f);
  let x_1002 : f32 = u_xlat26;
  let x_1003 : f32 = u_xlat26;
  u_xlat27 = (x_1002 * x_1003);
  let x_1005 : f32 = u_xlat27;
  let x_1006 : f32 = u_xlat27;
  u_xlat27 = (x_1005 * x_1006);
  let x_1008 : f32 = u_xlat26;
  let x_1009 : f32 = u_xlat27;
  u_xlat26 = (x_1008 * x_1009);
  let x_1012 : f32 = u_xlat13.x;
  let x_1013 : f32 = u_xlat26;
  u_xlat26 = ((x_1012 * x_1013) + 1.0f);
  let x_1016 : f32 = u_xlat39;
  u_xlat27 = (-(abs(x_1016)) + 1.0f);
  let x_1020 : f32 = u_xlat27;
  let x_1021 : f32 = u_xlat27;
  u_xlat41 = (x_1020 * x_1021);
  let x_1023 : f32 = u_xlat41;
  let x_1024 : f32 = u_xlat41;
  u_xlat41 = (x_1023 * x_1024);
  let x_1026 : f32 = u_xlat27;
  let x_1027 : f32 = u_xlat41;
  u_xlat27 = (x_1026 * x_1027);
  let x_1030 : f32 = u_xlat13.x;
  let x_1031 : f32 = u_xlat27;
  u_xlat13.x = ((x_1030 * x_1031) + 1.0f);
  let x_1036 : f32 = u_xlat13.x;
  let x_1037 : f32 = u_xlat26;
  u_xlat13.x = (x_1036 * x_1037);
  let x_1040 : f32 = u_xlat42;
  let x_1041 : f32 = u_xlat42;
  u_xlat26 = (x_1040 * x_1041);
  let x_1043 : f32 = u_xlat26;
  u_xlat26 = max(x_1043, 0.002f);
  let x_1046 : f32 = u_xlat26;
  u_xlat41 = (-(x_1046) + 1.0f);
  let x_1049 : f32 = u_xlat39;
  let x_1051 : f32 = u_xlat41;
  let x_1053 : f32 = u_xlat26;
  u_xlat42 = ((abs(x_1049) * x_1051) + x_1053);
  let x_1056 : f32 = u_xlat1.x;
  let x_1057 : f32 = u_xlat41;
  let x_1059 : f32 = u_xlat26;
  u_xlat41 = ((x_1056 * x_1057) + x_1059);
  let x_1061 : f32 = u_xlat39;
  let x_1063 : f32 = u_xlat41;
  u_xlat39 = (abs(x_1061) * x_1063);
  let x_1066 : f32 = u_xlat1.x;
  let x_1067 : f32 = u_xlat42;
  let x_1069 : f32 = u_xlat39;
  u_xlat39 = ((x_1066 * x_1067) + x_1069);
  let x_1071 : f32 = u_xlat39;
  u_xlat39 = (x_1071 + 0.00001f);
  let x_1074 : f32 = u_xlat39;
  u_xlat39 = (0.5f / x_1074);
  let x_1076 : f32 = u_xlat26;
  let x_1077 : f32 = u_xlat26;
  u_xlat41 = (x_1076 * x_1077);
  let x_1079 : f32 = u_xlat14;
  let x_1080 : f32 = u_xlat41;
  let x_1082 : f32 = u_xlat14;
  u_xlat42 = ((x_1079 * x_1080) + -(x_1082));
  let x_1085 : f32 = u_xlat42;
  let x_1086 : f32 = u_xlat14;
  u_xlat14 = ((x_1085 * x_1086) + 1.0f);
  let x_1089 : f32 = u_xlat41;
  u_xlat41 = (x_1089 * 0.318309873f);
  let x_1092 : f32 = u_xlat14;
  let x_1093 : f32 = u_xlat14;
  u_xlat14 = ((x_1092 * x_1093) + 0.0000001f);
  let x_1097 : f32 = u_xlat41;
  let x_1098 : f32 = u_xlat14;
  u_xlat14 = (x_1097 / x_1098);
  let x_1100 : f32 = u_xlat39;
  let x_1101 : f32 = u_xlat14;
  u_xlat13.z = (x_1100 * x_1101);
  let x_1104 : vec4<f32> = u_xlat1;
  let x_1106 : vec3<f32> = u_xlat13;
  let x_1108 : vec2<f32> = (vec2<f32>(x_1104.x, x_1104.x) * vec2<f32>(x_1106.x, x_1106.z));
  let x_1109 : vec3<f32> = u_xlat13;
  u_xlat13 = vec3<f32>(x_1108.x, x_1109.y, x_1108.y);
  let x_1112 : f32 = u_xlat13.z;
  u_xlat39 = (x_1112 * 3.141592741f);
  let x_1115 : f32 = u_xlat39;
  u_xlat39 = max(x_1115, 0.0f);
  let x_1117 : f32 = u_xlat26;
  let x_1118 : f32 = u_xlat26;
  u_xlat26 = ((x_1117 * x_1118) + 1.0f);
  let x_1121 : f32 = u_xlat26;
  u_xlat26 = (1.0f / x_1121);
  let x_1123 : vec3<f32> = u_xlat2;
  let x_1124 : vec3<f32> = u_xlat2;
  u_xlat1.x = dot(x_1123, x_1124);
  let x_1129 : f32 = u_xlat1.x;
  u_xlatb1 = !((x_1129 == 0.0f));
  let x_1131 : bool = u_xlatb1;
  u_xlat1.x = select(0.0f, 1.0f, x_1131);
  let x_1134 : f32 = u_xlat39;
  let x_1136 : f32 = u_xlat1.x;
  u_xlat39 = (x_1134 * x_1136);
  let x_1138 : f32 = u_xlat40;
  let x_1141 : f32 = x_18.x_Glossiness;
  u_xlat1.x = (-(x_1138) + x_1141);
  let x_1145 : f32 = u_xlat1.x;
  u_xlat1.x = (x_1145 + 1.0f);
  let x_1149 : f32 = u_xlat1.x;
  u_xlat1.x = clamp(x_1149, 0.0f, 1.0f);
  let x_1152 : vec3<f32> = u_xlat5;
  let x_1153 : vec3<f32> = u_xlat13;
  let x_1156 : vec4<f32> = u_xlat6;
  let x_1158 : vec3<f32> = ((x_1152 * vec3<f32>(x_1153.x, x_1153.x, x_1153.x)) + vec3<f32>(x_1156.x, x_1156.y, x_1156.z));
  let x_1159 : vec4<f32> = u_xlat4;
  u_xlat4 = vec4<f32>(x_1158.x, x_1158.y, x_1158.z, x_1159.w);
  let x_1161 : vec3<f32> = u_xlat5;
  let x_1162 : f32 = u_xlat39;
  u_xlat5 = (x_1161 * vec3<f32>(x_1162, x_1162, x_1162));
  let x_1166 : f32 = u_xlat0.x;
  u_xlat0.x = (-(x_1166) + 1.0f);
  let x_1171 : f32 = u_xlat0.x;
  let x_1173 : f32 = u_xlat0.x;
  u_xlat13.x = (x_1171 * x_1173);
  let x_1177 : f32 = u_xlat13.x;
  let x_1179 : f32 = u_xlat13.x;
  u_xlat13.x = (x_1177 * x_1179);
  let x_1183 : f32 = u_xlat0.x;
  let x_1185 : f32 = u_xlat13.x;
  ...
  let x_1200 : vec3<f32> = ((vec3<f32>(x_1194.x, x_1194.y, x_1194.z) * vec3<f32>(x_1196.x, x_1196.x, x_1196.x)) + x_1199);
  let x_1201 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1200.x, x_1200.y, x_1201.z, x_1200.z);
  let x_1203 : vec4<f32> = u_xlat0;
  let x_1205 : vec3<f32> = u_xlat5;
  let x_1206 : vec3<f32> = (vec3<f32>(x_1203.x, x_1203.y, x_1203.w) * x_1205);
  let x_1207 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1206.x, x_1206.y, x_1207.z, x_1206.z);
  let x_1209 : vec3<f32> = u_xlat3;
  let x_1210 : vec4<f32> = u_xlat4;
  let x_1213 : vec4<f32> = u_xlat0;
  let x_1215 : vec3<f32> = ((x_1209 * vec3<f32>(x_1210.x, x_1210.y, x_1210.z)) + vec3<f32>(x_1213.x, x_1213.y, x_1213.w));
  let x_1216 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1215.x, x_1215.y, x_1216.z, x_1215.z);
  let x_1218 : vec4<f32> = u_xlat8;
  let x_1220 : f32 = u_xlat26;
  u_xlat3 = (vec3<f32>(x_1218.x, x_1218.y, x_1218.z) * vec3<f32>(x_1220, x_1220, x_1220));
  let x_1223 : vec3<f32> = u_xlat2;
  let x_1225 : vec4<f32> = u_xlat1;
  let x_1227 : vec3<f32> = (-(x_1223) + vec3<f32>(x_1225.x, x_1225.x, x_1225.x));
  let x_1228 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1227.x, x_1227.y, x_1228.z, x_1227.z);
  let x_1230 : f32 = u_xlat27;
  let x_1232 : vec4<f32> = u_xlat1;
  let x_1235 : vec3<f32> = u_xlat2;
  let x_1236 : vec3<f32> = ((vec3<f32>(x_1230, x_1230, x_1230) * vec3<f32>(x_1232.x, x_1232.y, x_1232.w)) + x_1235);
  ...
  let x_1247 : vec3<f32> = ((x_1241 * vec3<f32>(x_1242.x, x_1242.y, x_1242.z)) + vec3<f32>(x_1245.x, x_1245.y, x_1245.w));
...
@fragment
fn main(@location(2) vs_TEXCOORD2_param : vec3<f32>, @location(0) vs_TEXCOORD0_param : vec2<f32>, @location(3) vs_COLOR0_param : vec4<f32>, @location(5) vs_TEXCOORD5_param : vec4<f32>, @location(1) vs_TEXCOORD1_param : vec3<f32>, @location(4) vs_TEXCOORD3_param : vec3<f32>, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
