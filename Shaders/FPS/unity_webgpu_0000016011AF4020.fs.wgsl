...
fn main_1() {
  ...
  u_xlat0.x = exp2(x_751);
  let x_758 : vec2<f32> = vs_TEXCOORD1;
  let x_759 : vec4<f32> = textureSample(x_CameraDepthTexture, sampler_CameraDepthTexture, x_758);
  u_xlat16.x = x_759.x;
  let x_763 : f32 = u_xlat16.x;
  let x_765 : f32 = x_31.x_ZBufferParams.x;
  u_xlat16.x = (x_763 * x_765);
  let x_769 : f32 = x_31.unity_OrthoParams.w;
  let x_772 : f32 = u_xlat16.x;
  u_xlat24 = ((-(x_769) * x_772) + 1.0f);
  let x_775 : f32 = u_xlat8;
  let x_777 : f32 = u_xlat16.x;
  let x_780 : f32 = x_31.x_ZBufferParams.y;
  u_xlat8 = ((x_775 * x_777) + x_780);
  let x_782 : f32 = u_xlat24;
  let x_783 : f32 = u_xlat8;
  u_xlat8 = (x_782 / x_783);
  let x_785 : f32 = u_xlat8;
  let x_787 : f32 = x_31.x_ProjectionParams.z;
  let x_790 : f32 = x_31.x_ProjectionParams.y;
  u_xlat8 = ((x_785 * x_787) + -(x_790));
  let x_793 : f32 = u_xlat8;
  let x_796 : f32 = x_31.x_FogParams.x;
  u_xlat8 = (x_793 * x_796);
  let x_798 : f32 = u_xlat8;
  let x_799 : f32 = u_xlat8;
  u_xlat8 = (x_798 * -(x_799));
  let x_802 : f32 = u_xlat8;
  u_xlat8 = exp2(x_802);
  let x_806 : f32 = u_xlat8;
  let x_808 : f32 = u_xlat0.x;
  SV_Target0.x = (x_806 * x_808);
  let x_812 : vec4<f32> = u_xlat1;
  let x_816 : vec3<f32> = ((vec3<f32>(x_812.x, x_812.y, x_812.z) * vec3<f32>(0.5f, 0.5f, 0.5f)) + vec3<f32>(0.5f, 0.5f, 0.5f));
  let x_817 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_817.x, x_816.x, x_816.y, x_816.z);
  return;
}
