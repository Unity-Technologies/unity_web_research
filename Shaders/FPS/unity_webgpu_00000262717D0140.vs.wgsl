...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_256.y, x_256.y, x_256.y, x_256.y) * x_260);
  let x_263 : vec4<f32> = x_17.unity_WorldToLight[0i];
  let x_264 : vec4<f32> = u_xlat0;
  let x_267 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_263 * vec4<f32>(x_264.x, x_264.x, x_264.x, x_264.x)) + x_267);
  let x_270 : vec4<f32> = x_17.unity_WorldToLight[2i];
  let x_271 : vec4<f32> = u_xlat0;
  let x_274 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_270 * vec4<f32>(x_271.z, x_271.z, x_271.z, x_271.z)) + x_274);
  let x_278 : vec4<f32> = x_17.unity_WorldToLight[3i];
  let x_279 : vec4<f32> = u_xlat0;
  let x_282 : vec4<f32> = u_xlat1;
  vs_TEXCOORD5 = ((x_278 * vec4<f32>(x_279.w, x_279.w, x_279.w, x_279.w)) + x_282);
