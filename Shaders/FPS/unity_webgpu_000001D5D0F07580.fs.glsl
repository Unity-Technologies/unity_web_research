...
void main()
{
    ...
    u_xlat29 = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), vec2(u_xlat29)).x;
    u_xlat21 = texture(samplerCube(_LightTexture0, sampler_LightTexture0), u_xlat7.xyz).w;
