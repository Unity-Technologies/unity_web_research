...
fn main_1() {
  ...
  u_xlat0.z = x_1290;
  let x_1292 : vec4<f32> = phase0_Input0_1;
  let x_1296 : vec4<f32> = x_31.x_Dithering_Coords;
  let x_1300 : vec4<f32> = x_31.x_Dithering_Coords;
  let x_1302 : vec2<f32> = ((vec2<f32>(x_1292.x, x_1292.y) * vec2<f32>(x_1296.x, x_1296.y)) + vec2<f32>(x_1300.z, x_1300.w));
  let x_1303 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1302.x, x_1302.y, x_1303.z, x_1303.w);
  let x_1310 : vec4<f32> = u_xlat1;
  let x_1312 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1310.x, x_1310.y));
  u_xlat18 = x_1312.w;
  let x_1314 : f32 = u_xlat18;
  u_xlat18 = ((x_1314 * 2.0f) + -1.0f);
  let x_1317 : f32 = u_xlat18;
  u_xlat1.x = ((x_1317 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1323 : f32 = u_xlat1.x;
  u_xlat1.x = clamp(x_1323, 0.0f, 1.0f);
  let x_1327 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1327 * 2.0f) + -1.0f);
  let x_1331 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1331)) + 1.0f);
  let x_1335 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1335);
  let x_1337 : f32 = u_xlat18;
  u_xlat18 = (-(x_1337) + 1.0f);
  let x_1340 : f32 = u_xlat18;
  let x_1342 : f32 = u_xlat1.x;
  u_xlat18 = (x_1340 * x_1342);
  let x_1344 : vec4<f32> = u_xlat0;
  let x_1346 : vec3<f32> = (vec3<f32>(x_1344.x, x_1344.y, x_1344.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1347 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1346.x, x_1346.y, x_1346.z, x_1347.w);
  let x_1349 : vec4<f32> = u_xlat0;
  u_xlat2 = max(abs(vec3<f32>(x_1349.x, x_1349.y, x_1349.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  u_xlat2 = ((x_1359 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1362 : vec4<f32> = u_xlat0;
  let x_1364 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1362.x, x_1362.y, x_1362.z, x_1362.x));
  ...
  u_xlat0.z = x_1400;
  let x_1402 : f32 = u_xlat18;
  let x_1407 : vec4<f32> = u_xlat0;
  let x_1409 : vec3<f32> = ((vec3<f32>(x_1402, x_1402, x_1402) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1407.x, x_1407.y, x_1407.z));
  let x_1410 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1409.x, x_1409.y, x_1409.z, x_1410.w);
  let x_1412 : vec4<f32> = u_xlat0;
  let x_1414 : vec3<f32> = (vec3<f32>(x_1412.x, x_1412.y, x_1412.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1415 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1414.x, x_1414.y, x_1414.z, x_1415.w);
  let x_1417 : vec4<f32> = u_xlat0;
  u_xlat2 = (vec3<f32>(x_1417.x, x_1417.y, x_1417.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1420 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1420 * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1422 : vec3<f32> = u_xlat2;
  u_xlat2 = max(abs(x_1422), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1425 : vec3<f32> = u_xlat2;
  u_xlat2 = log2(x_1425);
  let x_1427 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1427 * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1429 : vec3<f32> = u_xlat2;
  u_xlat2 = exp2(x_1429);
  let x_1431 : vec4<f32> = u_xlat0;
  let x_1433 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1431.x, x_1431.y, x_1431.z, x_1431.x));
