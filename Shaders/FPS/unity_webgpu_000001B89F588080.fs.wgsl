...
fn main_1() {
  ...
  let x_1122 : vec2<f32> = vs_TEXCOORD1;
  let x_1125 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1129 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1131 : vec2<f32> = ((x_1122 * vec2<f32>(x_1125.x, x_1125.y)) + vec2<f32>(x_1129.z, x_1129.w));
  let x_1132 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1131.x, x_1131.y, x_1132.z, x_1132.w);
  let x_1139 : vec4<f32> = u_xlat1;
  let x_1141 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1139.x, x_1139.y));
  let x_1142 : vec3<f32> = vec3<f32>(x_1141.x, x_1141.y, x_1141.z);
  let x_1143 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1142.x, x_1142.y, x_1142.z, x_1143.w);
  let x_1145 : vec4<f32> = u_xlat0;
  let x_1146 : vec3<f32> = vec3<f32>(x_1145.x, x_1145.y, x_1145.z);
  let x_1147 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1146.x, x_1146.y, x_1146.z, x_1147.w);
  let x_1149 : vec4<f32> = u_xlat2;
  let x_1153 : vec3<f32> = clamp(vec3<f32>(x_1149.x, x_1149.y, x_1149.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1154 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1153.x, x_1153.y, x_1153.z, x_1154.w);
  let x_1156 : vec4<f32> = u_xlat2;
  u_xlat31 = dot(vec3<f32>(x_1156.x, x_1156.y, x_1156.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1163 : f32 = u_xlat31;
  u_xlat31 = sqrt(x_1163);
  let x_1167 : f32 = x_26.x_Grain_Params1.x;
  let x_1168 : f32 = u_xlat31;
  u_xlat31 = ((x_1167 * -(x_1168)) + 1.0f);
  let x_1172 : vec4<f32> = u_xlat0;
  let x_1174 : vec4<f32> = u_xlat1;
  let x_1176 : vec3<f32> = (vec3<f32>(x_1172.x, x_1172.y, x_1172.z) * vec3<f32>(x_1174.x, x_1174.y, x_1174.z));
  let x_1177 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1176.x, x_1176.y, x_1176.z, x_1177.w);
  let x_1179 : vec4<f32> = u_xlat1;
  let x_1182 : f32 = x_26.x_Grain_Params1.y;
  let x_1184 : f32 = x_26.x_Grain_Params1.y;
  let x_1186 : f32 = x_26.x_Grain_Params1.y;
  let x_1188 : vec3<f32> = (vec3<f32>(x_1179.x, x_1179.y, x_1179.z) * vec3<f32>(x_1182, x_1184, x_1186));
  ...
  let x_1198 : vec3<f32> = ((vec3<f32>(x_1191.x, x_1191.y, x_1191.z) * vec3<f32>(x_1193, x_1193, x_1193)) + vec3<f32>(x_1196.x, x_1196.y, x_1196.z));
  let x_1199 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1198.x, x_1198.y, x_1198.z, x_1199.w);
  let x_1201 : vec4<f32> = u_xlat0;
  let x_1205 : f32 = x_26.x_PostExposure;
  let x_1207 : f32 = x_26.x_PostExposure;
  let x_1209 : f32 = x_26.x_PostExposure;
  let x_1211 : f32 = x_26.x_PostExposure;
  let x_1212 : vec4<f32> = vec4<f32>(x_1205, x_1207, x_1209, x_1211);
  u_xlat0 = (vec4<f32>(x_1201.w, x_1201.x, x_1201.y, x_1201.z) * vec4<f32>(x_1212.x, x_1212.y, x_1212.z, x_1212.w));
  let x_1219 : vec4<f32> = u_xlat0;
  let x_1226 : vec3<f32> = ((vec3<f32>(x_1219.y, x_1219.z, x_1219.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1227 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1226.x, x_1226.y, x_1226.z, x_1227.w);
  let x_1229 : vec4<f32> = u_xlat1;
  let x_1231 : vec3<f32> = log2(vec3<f32>(x_1229.x, x_1229.y, x_1229.z));
  let x_1232 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1231.x, x_1231.y, x_1231.z, x_1232.w);
  let x_1234 : vec4<f32> = u_xlat1;
  let x_1241 : vec3<f32> = ((vec3<f32>(x_1234.x, x_1234.y, x_1234.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1242 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1241.x, x_1241.y, x_1241.z, x_1242.w);
  let x_1244 : vec4<f32> = u_xlat1;
  let x_1248 : vec3<f32> = clamp(vec3<f32>(x_1244.x, x_1244.y, x_1244.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1249 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1248.x, x_1248.y, x_1248.z, x_1249.w);
  let x_1251 : vec4<f32> = u_xlat1;
  let x_1256 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1258 : vec3<f32> = (vec3<f32>(x_1251.x, x_1251.y, x_1251.z) * vec3<f32>(x_1256.y, x_1256.y, x_1256.y));
  let x_1259 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1258.x, x_1258.y, x_1258.z, x_1259.w);
  let x_1262 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat31 = (x_1262 * 0.5f);
  let x_1264 : vec4<f32> = u_xlat1;
  let x_1267 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1270 : f32 = u_xlat31;
  let x_1272 : vec3<f32> = ((vec3<f32>(x_1264.x, x_1264.y, x_1264.z) * vec3<f32>(x_1267.x, x_1267.x, x_1267.x)) + vec3<f32>(x_1270, x_1270, x_1270));
  let x_1273 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1272.x, x_1272.y, x_1272.z, x_1273.w);
  let x_1283 : vec4<f32> = u_xlat1;
  let x_1285 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1283.x, x_1283.y, x_1283.z));
  let x_1286 : vec3<f32> = vec3<f32>(x_1285.x, x_1285.y, x_1285.z);
  let x_1287 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1287.x, x_1286.x, x_1286.y, x_1286.z);
  let x_1291 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1291);
  let x_1293 : bool = u_xlatb1;
  if (x_1293) {
    let x_1296 : vec4<f32> = u_xlat0;
    let x_1297 : vec3<f32> = vec3<f32>(x_1296.y, x_1296.z, x_1296.w);
    let x_1298 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1297.x, x_1297.y, x_1297.z, x_1298.w);
    let x_1300 : vec4<f32> = u_xlat1;
    let x_1304 : vec3<f32> = clamp(vec3<f32>(x_1300.x, x_1300.y, x_1300.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1305 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1304.x, x_1304.y, x_1304.z, x_1305.w);
    let x_1307 : vec4<f32> = u_xlat1;
    u_xlat0.x = dot(vec3<f32>(x_1307.x, x_1307.y, x_1307.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1313 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1313.y, x_1313.z, x_1313.w, x_1313.x);
  return;
}
