...
fn main_1() {
  ...
  let x_310 : f32 = x_12.x_MaxCoC;
  u_xlat0.x = (x_307 * x_310);
  let x_314 : f32 = x_12.x_MainTex_TexelSize.y;
  let x_316 : f32 = x_12.x_MainTex_TexelSize.y;
  u_xlat4 = (x_314 + x_316);
  let x_318 : f32 = u_xlat4;
  u_xlat4 = (1.0f / x_318);
  let x_320 : f32 = u_xlat4;
  let x_322 : f32 = u_xlat0.x;
  u_xlat4 = (x_320 * abs(x_322));
  let x_325 : f32 = u_xlat4;
  u_xlat4 = clamp(x_325, 0.0f, 1.0f);
  let x_330 : f32 = u_xlat0.x;
  SV_Target0.w = x_330;
  let x_334 : f32 = u_xlat4;
  u_xlat0.x = ((x_334 * -2.0f) + 3.0f);
  let x_340 : f32 = u_xlat4;
  let x_341 : f32 = u_xlat4;
  u_xlat4 = (x_340 * x_341);
  let x_343 : f32 = u_xlat4;
  let x_345 : f32 = u_xlat0.x;
  u_xlat0.x = (x_343 * x_345);
  let x_348 : vec4<f32> = u_xlat0;
  let x_350 : vec3<f32> = u_xlat1;
  let x_351 : vec3<f32> = (vec3<f32>(x_348.x, x_348.x, x_348.x) * x_350);
  let x_352 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_351.x, x_351.y, x_351.z, x_352.w);
  return;
}
