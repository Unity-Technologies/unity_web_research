...
static const float kSunScale = 400.0 * 20.0 ;
...
float3 kSkyTintInGammaSpace = ( ( float4 ( 4.59479380 , 4.59479380 , 4.59479380 , 2.0 ) . r > 2.0 ) ? pow ( _SkyTint , 1.0 / 2.2 ) : _SkyTint ) ;
float3 kScatteringWavelength = lerp (
kDefaultScatteringWavelength - kVariableRangeForScatteringWavelength ,
kDefaultScatteringWavelength + kVariableRangeForScatteringWavelength ,
float3 ( 1 , 1 , 1 ) - kSkyTintInGammaSpace ) ;
float3 kInvWavelength = 1.0 / pow ( kScatteringWavelength , 4 ) ;

float kKrESun = ( lerp ( 0.0 , 0.0025 , pow ( _AtmosphereThickness , 2.5 ) ) ) * 20.0 ;
float kKr4PI = ( lerp ( 0.0 , 0.0025 , pow ( _AtmosphereThickness , 2.5 ) ) ) * 4.0 * 3.14159265 ;
...
{
float temp = 1.0 + 0.9801 - 2.0 * ( - 0.990 ) * eyeCos ;
