...
fn main_1() {
  ...
  let x_705 : vec3<f32> = x_31.x_Bloom_Color;
  ...
  let x_724 : f32 = x_31.x_Vignette_Mode;
  u_xlatb1 = (x_724 < 0.5f);
  let x_726 : bool = u_xlatb1;
  if (x_726) {
    let x_729 : vec2<f32> = u_xlat14;
    let x_733 : vec2<f32> = x_31.x_Vignette_Center;
    ...
    let x_743 : vec4<f32> = x_31.x_Vignette_Settings;
    ...
    let x_751 : f32 = x_31.x_ScreenParams.x;
    let x_753 : f32 = x_31.x_ScreenParams.y;
    u_xlat19 = (x_751 / x_753);
    let x_755 : f32 = u_xlat19;
    u_xlat19 = (x_755 + -1.0f);
    let x_758 : f32 = x_31.x_Vignette_Settings.w;
    ...
    let x_787 : vec4<f32> = x_31.x_Vignette_Settings;
    ...
    let x_906 : f32 = x_899;
    u_xlat1.x = x_906;
    let x_909 : vec3<f32> = x_31.x_Vignette_Color;
    ...
    let x_929 : f32 = x_31.x_Vignette_Opacity;
  ...
  let x_953 : f32 = x_31.x_PostExposure;
  let x_955 : f32 = x_31.x_PostExposure;
  let x_957 : f32 = x_31.x_PostExposure;
  let x_959 : f32 = x_31.x_PostExposure;
  ...
  let x_1003 : vec2<f32> = x_31.x_Lut3D_Params;
  ...
  let x_1009 : f32 = x_31.x_Lut3D_Params.x;
  u_xlat19 = (x_1009 * 0.5f);
  let x_1011 : vec4<f32> = u_xlat1;
  let x_1014 : vec2<f32> = x_31.x_Lut3D_Params;
  ...
  let x_1038 : f32 = x_31.x_LumaInAlpha;
