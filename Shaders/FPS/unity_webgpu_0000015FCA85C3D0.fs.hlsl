...
o . texcoord = ( v . texcoord . xy . xy * _MainTex_ST . xy + _MainTex_ST . zw ) + unity_StereoEyeIndex * _RightEyeUVOffset . xy ;
return o ;
}

float4 fragmentBlit ( v2f i ) : COLOR
{
float4 col = tex2D ( _MainTex , i . texcoord ) ;
return float4 ( col . rgb , col . a * _AlphaParam ) ;
}
