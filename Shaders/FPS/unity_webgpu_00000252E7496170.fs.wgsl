...
fn main_1() {
  ...
  let x_1039 : f32 = x_31.x_PostExposure;
  let x_1041 : f32 = x_31.x_PostExposure;
  let x_1043 : f32 = x_31.x_PostExposure;
  let x_1045 : f32 = x_31.x_PostExposure;
  let x_1046 : vec4<f32> = vec4<f32>(x_1039, x_1041, x_1043, x_1045);
  u_xlat0 = (vec4<f32>(x_1035.w, x_1035.x, x_1035.y, x_1035.z) * vec4<f32>(x_1046.x, x_1046.y, x_1046.z, x_1046.w));
  let x_1053 : vec4<f32> = u_xlat0;
  let x_1060 : vec3<f32> = ((vec3<f32>(x_1053.y, x_1053.z, x_1053.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1061 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1060.x, x_1060.y, x_1060.z, x_1061.w);
  let x_1063 : vec4<f32> = u_xlat1;
  let x_1065 : vec3<f32> = log2(vec3<f32>(x_1063.x, x_1063.y, x_1063.z));
  let x_1066 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1065.x, x_1065.y, x_1065.z, x_1066.w);
  let x_1068 : vec4<f32> = u_xlat1;
  let x_1075 : vec3<f32> = ((vec3<f32>(x_1068.x, x_1068.y, x_1068.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1076 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1075.x, x_1075.y, x_1075.z, x_1076.w);
  let x_1078 : vec4<f32> = u_xlat1;
  let x_1082 : vec3<f32> = clamp(vec3<f32>(x_1078.x, x_1078.y, x_1078.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1083 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1082.x, x_1082.y, x_1082.z, x_1083.w);
  let x_1085 : vec4<f32> = u_xlat1;
  let x_1089 : vec2<f32> = x_31.x_Lut3D_Params;
  let x_1091 : vec3<f32> = (vec3<f32>(x_1085.x, x_1085.y, x_1085.z) * vec3<f32>(x_1089.y, x_1089.y, x_1089.y));
  let x_1092 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1091.x, x_1091.y, x_1091.z, x_1092.w);
  let x_1095 : f32 = x_31.x_Lut3D_Params.x;
  u_xlat19 = (x_1095 * 0.5f);
  let x_1097 : vec4<f32> = u_xlat1;
  let x_1100 : vec2<f32> = x_31.x_Lut3D_Params;
  let x_1103 : f32 = u_xlat19;
  let x_1105 : vec3<f32> = ((vec3<f32>(x_1097.x, x_1097.y, x_1097.z) * vec3<f32>(x_1100.x, x_1100.x, x_1100.x)) + vec3<f32>(x_1103, x_1103, x_1103));
  let x_1106 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1105.x, x_1105.y, x_1105.z, x_1106.w);
  let x_1116 : vec4<f32> = u_xlat1;
  let x_1118 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1116.x, x_1116.y, x_1116.z));
  let x_1119 : vec3<f32> = vec3<f32>(x_1118.x, x_1118.y, x_1118.z);
  let x_1120 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1120.x, x_1119.x, x_1119.y, x_1119.z);
  let x_1124 : f32 = x_31.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1124);
  let x_1126 : bool = u_xlatb1;
  if (x_1126) {
    ...
    u_xlat0.x = dot(vec3<f32>(x_1140.x, x_1140.y, x_1140.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1146 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1146.y, x_1146.z, x_1146.w, x_1146.x);
  return;
}
