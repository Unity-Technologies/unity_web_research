...
fn main_1() {
  ...
  let x_744 : vec3<f32> = ((vec3<f32>(x_738.x, x_738.z, x_738.w) * vec3<f32>(x_740.x, x_740.z, x_740.w)) + x_743);
  let x_745 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_744.x, x_744.y, x_744.z, x_745.w);
  SV_Target0.w = 1.0f;
  return;
}
