...
float4 c = BRDF3_Unity_PBS ( s . diffColor , s . specColor , s . oneMinusReflectivity , s . smoothness , s . normalWorld , - s . eyeVec , gi . light , gi . indirect ) ;
...
float4 c = BRDF3_Unity_PBS ( s . diffColor , s . specColor , s . oneMinusReflectivity , s . smoothness , s . normalWorld , - s . eyeVec , light , noIndirect ) ;
...
float3 emissiveColor = BRDF3_Unity_PBS ( s . diffColor , s . specColor , s . oneMinusReflectivity , s . smoothness , s . normalWorld , - s . eyeVec , gi . light , gi . indirect ) . rgb ;
#line 669
