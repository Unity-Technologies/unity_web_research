...
fn main_1() {
  ...
  let x_490 : vec4<f32> = x_33.x_EmissionColor;
  let x_493 : vec3<f32> = u_xlat0;
  let x_494 : vec3<f32> = ((x_487 * vec3<f32>(x_490.x, x_490.y, x_490.z)) + x_493);
  let x_495 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_494.x, x_494.y, x_494.z, x_495.w);
  SV_Target0.w = 1.0f;
  return;
}
