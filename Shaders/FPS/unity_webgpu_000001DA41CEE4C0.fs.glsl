...
void main()
{
    ...
    if(u_xlatb11){
        ...
        u_xlat7.y = texture(samplerCubeShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec1);
        u_xlat8.xyz = u_xlat11.xyz + vec3(-0.0078125, 0.0078125, -0.0078125);
        vec4 txVec2 = vec4(u_xlat8.xyz,u_xlat30);
        u_xlat7.z = texture(samplerCubeShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec2);
        u_xlat11.xyz = u_xlat11.xyz + vec3(0.0078125, -0.0078125, -0.0078125);
        vec4 txVec3 = vec4(u_xlat11.xyz,u_xlat30);
        u_xlat7.w = texture(samplerCubeShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec3);
    ...
    u_xlat11.x = texture(samplerCube(_LightTexture0, sampler_LightTexture0), u_xlat6.xyz).w;
    u_xlat2.x = u_xlat11.x * u_xlat2.x;
