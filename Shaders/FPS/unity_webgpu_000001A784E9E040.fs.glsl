...
void main()
{
    ...
    u_xlat31 = texture(sampler2D(_Noise, sampler_Noise), vs_TEXCOORD0.xy).x;
    u_xlat4.xy = texture(sampler2D(_MetallicSmooth, sampler_MetallicSmooth), vs_TEXCOORD0.zw).xw;
    u_xlat32 = texture(sampler2D(_Gradient, sampler_Gradient), vs_TEXCOORD0.zw).x;
    u_xlat33 = (-u_xlat32) + 1.0;
    u_xlat31 = u_xlat31 * u_xlat33;
    u_xlat31 = u_xlat31 * _NoiseStrength + u_xlat32;
    ...
    u_xlat4.xzw = vec3(u_xlat31) * _LightColor0.xyz;
    u_xlat5.xyz = u_xlat5.xyz * _Color.xyz + vec3(-0.0399999991, -0.0399999991, -0.0399999991);
    u_xlat5.xyz = vec3(u_xlat33) * u_xlat5.xyz + vec3(0.0399999991, 0.0399999991, 0.0399999991);
    u_xlat31 = (-u_xlat33) * 0.959999979 + 0.959999979;
    u_xlat6.xyz = vec3(u_xlat31) * u_xlat6.xyz;
    u_xlat31 = (-u_xlat4.y) * _Glossiness + 1.0;
    ...
    u_xlat10.xyz = u_xlat4.xzw * vec3(u_xlat20);
