...
fn main_1() {
  ...
  if (x_987) {
    ...
    u_xlat1 = vec4<f32>(x_1047.x, x_1047.y, x_1048.z, x_1048.w);
  ...
  let x_1251 : vec3<f32> = ((vec3<f32>(x_1244.z, x_1244.x, x_1244.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1280 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1282 : vec3<f32> = (vec3<f32>(x_1276.x, x_1276.y, x_1276.z) * vec3<f32>(x_1280.z, x_1280.z, x_1280.z));
  let x_1283 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1282.x, x_1282.y, x_1282.z, x_1283.w);
  let x_1287 : f32 = u_xlat1.x;
  u_xlat10 = floor(x_1287);
  let x_1290 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1292 : vec2<f32> = (vec2<f32>(x_1290.x, x_1290.y) * vec2<f32>(0.5f, 0.5f));
  let x_1293 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1292.x, x_1293.y, x_1293.z, x_1292.y);
  let x_1295 : vec4<f32> = u_xlat1;
  let x_1298 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1301 : vec4<f32> = u_xlat1;
  let x_1303 : vec2<f32> = ((vec2<f32>(x_1295.y, x_1295.z) * vec2<f32>(x_1298.x, x_1298.y)) + vec2<f32>(x_1301.x, x_1301.w));
  let x_1304 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1304.x, x_1303.x, x_1303.y, x_1304.w);
  let x_1306 : f32 = u_xlat10;
  let x_1308 : f32 = x_26.x_Lut2D_Params.y;
  let x_1311 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1306 * x_1308) + x_1311);
  let x_1319 : vec4<f32> = u_xlat1;
  let x_1321 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1319.x, x_1319.z));
  ...
  let x_1326 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat3.x = x_1326;
  u_xlat3.y = 0.0f;
  let x_1329 : vec4<f32> = u_xlat1;
  let x_1331 : vec4<f32> = u_xlat3;
  let x_1333 : vec2<f32> = (vec2<f32>(x_1329.x, x_1329.z) + vec2<f32>(x_1331.x, x_1331.y));
  let x_1334 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1333.x, x_1333.y, x_1334.z, x_1334.w);
  let x_1339 : vec4<f32> = u_xlat1;
  let x_1341 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1339.x, x_1339.y));
  let x_1342 : vec3<f32> = vec3<f32>(x_1341.x, x_1341.y, x_1341.z);
  let x_1343 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1342.x, x_1342.y, x_1342.z, x_1343.w);
  let x_1346 : f32 = u_xlat0.x;
  let x_1348 : f32 = x_26.x_Lut2D_Params.z;
  let x_1350 : f32 = u_xlat10;
  u_xlat0.x = ((x_1346 * x_1348) + -(x_1350));
  let x_1354 : vec4<f32> = u_xlat2;
  let x_1357 : vec4<f32> = u_xlat1;
  let x_1359 : vec3<f32> = (-(vec3<f32>(x_1354.x, x_1354.y, x_1354.z)) + vec3<f32>(x_1357.x, x_1357.y, x_1357.z));
  let x_1360 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1359.x, x_1359.y, x_1359.z, x_1360.w);
  let x_1362 : vec4<f32> = u_xlat0;
  let x_1364 : vec4<f32> = u_xlat1;
  let x_1367 : vec4<f32> = u_xlat2;
  let x_1369 : vec3<f32> = ((vec3<f32>(x_1362.x, x_1362.x, x_1362.x) * vec3<f32>(x_1364.x, x_1364.y, x_1364.z)) + vec3<f32>(x_1367.x, x_1367.y, x_1367.z));
  let x_1370 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1369.x, x_1369.y, x_1369.z, x_1370.w);
  let x_1372 : vec2<f32> = vs_TEXCOORD0;
  let x_1375 : vec4<f32> = x_26.x_Dithering_Coords;
  ...
  u_xlat1 = vec4<f32>(x_1381.x, x_1381.y, x_1382.z, x_1382.w);
  let x_1389 : vec4<f32> = u_xlat1;
  let x_1391 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1389.x, x_1389.y));
  u_xlat1.x = x_1391.w;
  let x_1395 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1395 * 2.0f) + -1.0f);
  let x_1400 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1400 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1406 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1406, 0.0f, 1.0f);
  let x_1410 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1410 * 2.0f) + -1.0f);
  let x_1415 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1415)) + 1.0f);
  let x_1421 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1421);
  let x_1425 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1425) + 1.0f);
  let x_1430 : f32 = u_xlat1.x;
  let x_1432 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1430 * x_1432);
  let x_1435 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1435.x, x_1435.y, x_1435.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1440 : vec4<f32> = u_xlat0;
  let x_1444 : vec3<f32> = max(abs(vec3<f32>(x_1440.x, x_1440.y, x_1440.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1445 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1444.x, x_1444.y, x_1444.z, x_1445.w);
  let x_1447 : vec4<f32> = u_xlat2;
  let x_1449 : vec3<f32> = log2(vec3<f32>(x_1447.x, x_1447.y, x_1447.z));
  let x_1450 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1449.x, x_1449.y, x_1449.z, x_1450.w);
  let x_1452 : vec4<f32> = u_xlat2;
  let x_1456 : vec3<f32> = (vec3<f32>(x_1452.x, x_1452.y, x_1452.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1457 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1456.x, x_1456.y, x_1456.z, x_1457.w);
  let x_1459 : vec4<f32> = u_xlat2;
  let x_1461 : vec3<f32> = exp2(vec3<f32>(x_1459.x, x_1459.y, x_1459.z));
  let x_1462 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1461.x, x_1461.y, x_1461.z, x_1462.w);
  let x_1464 : vec4<f32> = u_xlat2;
  let x_1471 : vec3<f32> = ((vec3<f32>(x_1464.x, x_1464.y, x_1464.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1472 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1471.x, x_1471.y, x_1471.z, x_1472.w);
  let x_1479 : vec4<f32> = u_xlat0;
  let x_1482 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1479.x, x_1479.y, x_1479.z, x_1479.x));
  u_xlatb0 = vec3<bool>(x_1482.x, x_1482.y, x_1482.z);
  ...
  u_xlat0.y = x_1506;
  let x_1509 : bool = u_xlatb0.z;
  if (x_1509) {
    let x_1514 : f32 = u_xlat11.z;
    x_1510 = x_1514;
  } else {
  ...
  let x_1527 : vec3<f32> = ((vec3<f32>(x_1520.x, x_1520.x, x_1520.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1525.x, x_1525.y, x_1525.z));
  let x_1528 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1527.x, x_1527.y, x_1527.z, x_1528.w);
  let x_1530 : vec4<f32> = u_xlat0;
  let x_1533 : vec3<f32> = (vec3<f32>(x_1530.x, x_1530.y, x_1530.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1534 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1533.x, x_1533.y, x_1533.z, x_1534.w);
  let x_1536 : vec4<f32> = u_xlat0;
  let x_1539 : vec3<f32> = (vec3<f32>(x_1536.x, x_1536.y, x_1536.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1540 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1539.x, x_1539.y, x_1539.z, x_1540.w);
  let x_1542 : vec4<f32> = u_xlat2;
  let x_1545 : vec3<f32> = (vec3<f32>(x_1542.x, x_1542.y, x_1542.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1546 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1545.x, x_1545.y, x_1545.z, x_1546.w);
  let x_1548 : vec4<f32> = u_xlat2;
  let x_1551 : vec3<f32> = max(abs(vec3<f32>(x_1548.x, x_1548.y, x_1548.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1552 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1551.x, x_1551.y, x_1551.z, x_1552.w);
  let x_1554 : vec4<f32> = u_xlat2;
  let x_1556 : vec3<f32> = log2(vec3<f32>(x_1554.x, x_1554.y, x_1554.z));
  let x_1557 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1556.x, x_1556.y, x_1556.z, x_1557.w);
  let x_1559 : vec4<f32> = u_xlat2;
  let x_1562 : vec3<f32> = (vec3<f32>(x_1559.x, x_1559.y, x_1559.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1563 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1562.x, x_1562.y, x_1562.z, x_1563.w);
  let x_1565 : vec4<f32> = u_xlat2;
  let x_1567 : vec3<f32> = exp2(vec3<f32>(x_1565.x, x_1565.y, x_1565.z));
  let x_1568 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1567.x, x_1567.y, x_1567.z, x_1568.w);
  let x_1571 : vec4<f32> = u_xlat0;
  let x_1573 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1571.x, x_1571.y, x_1571.z, x_1571.x));
  u_xlatb0 = vec3<bool>(x_1573.x, x_1573.y, x_1573.z);
  let x_1578 : bool = u_xlatb0.x;
  if (x_1578) {
  ...
  SV_Target0.x = x_1587;
  let x_1591 : bool = u_xlatb0.y;
  if (x_1591) {
    let x_1596 : f32 = u_xlat1.y;
    x_1592 = x_1596;
  } else {
    let x_1599 : f32 = u_xlat2.y;
    x_1592 = x_1599;
  }
  let x_1600 : f32 = x_1592;
  SV_Target0.y = x_1600;
  let x_1603 : bool = u_xlatb0.z;
  if (x_1603) {
    let x_1608 : f32 = u_xlat1.z;
    x_1604 = x_1608;
  } else {
