...
#line 35
float4 frag ( unity_v2f_deferred i ) : COLOR
{
...
float3 rgb = BRDF1_Unity_PBS ( 0 , data . specularColor , oneMinusReflectivity , data . smoothness , data . normalWorld , - eyeVec , light , ind ) . rgb ;
#line 88
