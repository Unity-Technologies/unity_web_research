...
fn main_1() {
  ...
  let x_481 : vec4<f32> = x_33.x_EmissionColor;
  let x_484 : vec3<f32> = u_xlat0;
  let x_485 : vec3<f32> = ((x_478 * vec3<f32>(x_481.x, x_481.y, x_481.z)) + x_484);
  let x_486 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_485.x, x_485.y, x_485.z, x_486.w);
  SV_Target0.w = 1.0f;
  return;
}
