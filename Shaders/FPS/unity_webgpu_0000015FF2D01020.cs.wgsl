...
@group(0) @binding(2) var x_Source : texture_2d<f32>;

var<private> u_xlatb136 : bool;

@group(0) @binding(3) var x_Destination_origX0X : texture_storage_2d<r32float, write>;
...
fn main_1() {
  ...
  if ((x_207 == 0u)) {
    ...
    let x_9070 : vec4<f32> = textureLoad(x_Source, vec2<i32>(0i, 0i), 0i);
    u_xlat68.x = x_9070.x;
    let x_9074 : f32 = u_xlat68.x;
    let x_9077 : f32 = u_xlat0.x;
    u_xlat0.x = (-(x_9074) + x_9077);
    let x_9083 : f32 = u_xlat0.x;
    u_xlatb136 = (0.0f < x_9083);
    let x_9085 : bool = u_xlatb136;
    if (x_9085) {
      let x_9091 : f32 = x_2845.x_Params2.x;
      x_9087 = x_9091;
    } else {
      let x_9094 : f32 = x_2845.x_Params2.y;
      x_9087 = x_9094;
    }
    let x_9095 : f32 = x_9087;
    u_xlat136 = x_9095;
    let x_9096 : f32 = u_xlat136;
    let x_9098 : f32 = x_2845.x_Params2.w;
    u_xlat136 = (x_9096 * -(x_9098));
    let x_9101 : f32 = u_xlat136;
    u_xlat136 = exp2(x_9101);
    let x_9103 : f32 = u_xlat136;
    u_xlat136 = (-(x_9103) + 1.0f);
    let x_9107 : f32 = u_xlat0.x;
    let x_9108 : f32 = u_xlat136;
    let x_9111 : f32 = u_xlat68.x;
    u_xlat0.x = ((x_9107 * x_9108) + x_9111);
    let x_9118 : vec2<f32> = u_xlat0;
    textureStore(x_Destination_origX0X, vec2<i32>(0i, 0i), vec4<f32>(x_9118.x, x_9118.x, x_9118.x, x_9118.x));
  }
  return;
}
