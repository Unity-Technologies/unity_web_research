...
fn main_1() {
  ...
  vs_TEXCOORD6 = ((vec3<f32>(x_624.x, x_624.y, x_624.z) * vec3<f32>(x_626.z, x_626.z, x_626.z)) + vec3<f32>(x_629.x, x_629.y, x_629.w));
  ...
  u_xlat1 = (vec4<f32>(x_648.y, x_648.w, x_648.z, x_648.x) * x_650);
  let x_653 : vec4<f32> = x_19.unity_SHBr;
  let x_654 : vec4<f32> = u_xlat1;
  u_xlat2.x = dot(x_653, x_654);
  let x_658 : vec4<f32> = x_19.unity_SHBg;
  let x_659 : vec4<f32> = u_xlat1;
  u_xlat2.y = dot(x_658, x_659);
  let x_664 : vec4<f32> = x_19.unity_SHBb;
  let x_665 : vec4<f32> = u_xlat1;
  u_xlat2.z = dot(x_664, x_665);
