...
fn main_1() {
  ...
  let x_394 : vec4<f32> = in_TEXCOORD0;
  let x_398 : vec4<f32> = x_43.x_Noise_ST;
  let x_402 : vec4<f32> = x_43.x_Noise_ST;
  vs_TEXCOORD1 = ((vec2<f32>(x_394.x, x_394.y) * vec2<f32>(x_398.x, x_398.y)) + vec2<f32>(x_402.z, x_402.w));
