...
fn main_1() {
  ...
  let x_1588 : f32 = x_26.x_PostExposure;
  let x_1590 : f32 = x_26.x_PostExposure;
  ...
  u_xlat0 = (vec4<f32>(x_1584.w, x_1584.x, x_1584.y, x_1584.z) * vec4<f32>(x_1595.x, x_1595.y, x_1595.z, x_1595.w));
  let x_1602 : vec4<f32> = u_xlat0;
  u_xlat1 = ((vec3<f32>(x_1602.y, x_1602.z, x_1602.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1610 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1610);
  let x_1612 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1612 * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1619 : vec3<f32> = u_xlat1;
  u_xlat1 = clamp(x_1619, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1623 : vec3<f32> = u_xlat1;
  let x_1626 : vec2<f32> = x_26.x_Lut3D_Params;
  u_xlat1 = (x_1623 * vec3<f32>(x_1626.y, x_1626.y, x_1626.y));
  let x_1630 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat31 = (x_1630 * 0.5f);
  let x_1632 : vec3<f32> = u_xlat1;
  let x_1634 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1637 : f32 = u_xlat31;
  u_xlat1 = ((x_1632 * vec3<f32>(x_1634.x, x_1634.x, x_1634.x)) + vec3<f32>(x_1637, x_1637, x_1637));
  let x_1648 : vec3<f32> = u_xlat1;
  let x_1649 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, x_1648);
  let x_1650 : vec3<f32> = vec3<f32>(x_1649.x, x_1649.y, x_1649.z);
  let x_1651 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1651.x, x_1650.x, x_1650.y, x_1650.z);
  let x_1655 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1655);
  let x_1657 : bool = u_xlatb1;
  if (x_1657) {
    let x_1660 : vec4<f32> = u_xlat0;
    u_xlat1 = vec3<f32>(x_1660.y, x_1660.z, x_1660.w);
    let x_1662 : vec3<f32> = u_xlat1;
    u_xlat1 = clamp(x_1662, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1666 : vec3<f32> = u_xlat1;
    u_xlat0.x = dot(x_1666, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1671 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1671.y, x_1671.z, x_1671.w, x_1671.x);
  return;
}
