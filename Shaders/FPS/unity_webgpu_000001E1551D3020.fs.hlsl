#line 1 "Particles/Standard Surface"
static const int SHADOWS_SHADOWMASK = 0 ;
static const int PROCEDURAL_INSTANCING_ON = 0 ;
static const int FOG_LINEAR = 0 ;
static const int FOG_EXP = 0 ;
static const int FOG_EXP2 = 0 ;
static const int _FADING_ON = 0 ;
static const int _REQUIRE_UV2 = 0 ;
static const int EFFECT_BUMP = 0 ;
static const int LIGHTMAP_SHADOW_MIXING = 0 ;
static const int VERTEXLIGHT_ON = 0 ;
...
#line 121 "F:/src/unity_webgpu/Shaders/Includes/HLSLSupport.cginc"
#pragma warning ( disable : 3205 )
#pragma warning ( disable : 3568 )
#pragma warning ( disable : 3571 )
#pragma warning ( disable : 3206 )
#line 40 "F:/src/unity_webgpu/Shaders/Includes/UnityShaderVariables.cginc"
float4 _Time ;
float4 _SinTime ;
float4 _CosTime ;
...
#line 243
Texture2D_half unity_Lightmap ; SamplerState samplerunity_Lightmap ;

Texture2D_half unity_LightmapInd ;
...
#line 298
Texture3D_float unity_ProbeVolumeSH ; SamplerState samplerunity_ProbeVolumeSH ;
#line 304
...
#line 8 "F:/src/unity_webgpu/Shaders/Includes/UnityShaderUtilities.cginc"
...
#line 80 "F:/src/unity_webgpu/Shaders/Includes/UnityInstancing.cginc"
...
#line 272
cbuffer UnityInstancing_PerDraw0 { struct _type_PerDraw0 {
...
cbuffer UnityInstancing_PerDraw1 { struct _type_PerDraw1 {
#line 303
} unity_Builtins1Array [ 2 ] ; }

cbuffer UnityInstancing_PerDraw2 { struct _type_PerDraw2 {
#line 315
...
cbuffer UnityInstancing_PerDraw3 { struct _type_PerDraw3 {
...
{
float4 clipPos ;
float3 posWorld = mul ( unity_Builtins0Array [ unity_InstanceID ] . unity_ObjectToWorldArray , float4 ( inPos , 1.0 ) ) . xyz ;
#line 355
clipPos = mul ( unity_MatrixVP , float4 ( posWorld , 1.0 ) ) ;
...
{
#line 366
return mul ( unity_MatrixVP , mul ( unity_Builtins0Array [ unity_InstanceID ] . unity_ObjectToWorldArray , float4 ( pos , 1.0 ) ) ) ;
...
void UnitySetupCompoundMatrices ( )
{
unity_MatrixMVP_Instanced = mul ( unity_MatrixVP , unity_Builtins0Array [ unity_InstanceID ] . unity_ObjectToWorldArray ) ;
unity_MatrixMV_Instanced = mul ( unity_MatrixV , unity_Builtins0Array [ unity_InstanceID ] . unity_ObjectToWorldArray ) ;
unity_MatrixTMV_Instanced = transpose ( unity_MatrixMV_Instanced ) ;
unity_MatrixITMV_Instanced = transpose ( mul ( unity_Builtins0Array [ unity_InstanceID ] . unity_WorldToObjectArray , unity_MatrixInvV ) ) ;
}
#line 58 "F:/src/unity_webgpu/Shaders/Includes/UnityCG.cginc"
struct appdata_base {
...
{
return mul ( unity_MatrixV , mul ( unity_Builtins0Array [ unity_InstanceID ] . unity_ObjectToWorldArray , float4 ( pos , 1.0 ) ) ) . xyz ;
}
...
{
return normalize ( mul ( ( float3x3 ) unity_Builtins0Array [ unity_InstanceID ] . unity_ObjectToWorldArray , dir ) ) ;
}
#line 171
inline float3 UnityWorldToObjectDir ( in float3 dir )
{
return normalize ( mul ( ( float3x3 ) unity_Builtins0Array [ unity_InstanceID ] . unity_WorldToObjectArray , dir ) ) ;
}
#line 177
inline float3 UnityObjectToWorldNormal ( in float3 norm )
{
#line 183
return normalize ( mul ( norm , ( float3x3 ) unity_Builtins0Array [ unity_InstanceID ] . unity_WorldToObjectArray ) ) ;
...
{
float3 worldPos = mul ( unity_Builtins0Array [ unity_InstanceID ] . unity_ObjectToWorldArray , localPos ) . xyz ;
return UnityWorldSpaceLightDir ( worldPos ) ;
}
#line 210
inline float3 ObjSpaceLightDir ( in float4 v )
{
float3 objSpaceLightPos = mul ( unity_Builtins0Array [ unity_InstanceID ] . unity_WorldToObjectArray , _WorldSpaceLightPos0 ) . xyz ;
#line 219
...
{
float3 objSpaceCameraPos = mul ( unity_Builtins0Array [ unity_InstanceID ] . unity_WorldToObjectArray , float4 ( _WorldSpaceCameraPos . xyz , 1 ) ) . xyz ;
...
float3 viewN = normalize ( mul ( ( float3x3 ) unity_MatrixITMV_Instanced , normal ) ) ;
...
float3 x ;
#line 333
x . r = dot ( unity_Builtins2Array [ unity_InstanceID ] . unity_SHArArray , normal ) ;
x . g = dot ( unity_Builtins2Array [ unity_InstanceID ] . unity_SHAgArray , normal ) ;
x . b = dot ( unity_Builtins2Array [ unity_InstanceID ] . unity_SHAbArray , normal ) ;
...
x1 . r = dot ( unity_Builtins2Array [ unity_InstanceID ] . unity_SHBrArray , vB ) ;
x1 . g = dot ( unity_Builtins2Array [ unity_InstanceID ] . unity_SHBgArray , vB ) ;
x1 . b = dot ( unity_Builtins2Array [ unity_InstanceID ] . unity_SHBbArray , vB ) ;
#line 351
float vC = normal . x * normal . x - normal . y * normal . y ;
x2 = unity_Builtins2Array [ unity_InstanceID ] . unity_SHCArray . rgb * vC ;
...
v2f_img o ;
o = ( v2f_img ) 0 ; ;
{ UnitySetupInstanceID ( v . instanceID ) ; UnitySetupCompoundMatrices ( ) ; } ;
;
...
{
float4 wPos = mul ( unity_Builtins0Array [ unity_InstanceID ] . unity_ObjectToWorldArray , vertex ) ;
...
#line 4 "F:/src/unity_webgpu/Shaders/Includes/UnityLightingCommon.cginc"
float4 _LightColor0 ;
float4 _SpecColor ;
...
#line 6 "F:/src/unity_webgpu/Shaders/Includes/UnityGBuffer.cginc"
...
#line 12 "F:/src/unity_webgpu/Shaders/Includes/UnityStandardBRDF.cginc"
...
#line 16 "F:/src/unity_webgpu/Shaders/Includes/UnityDeprecated.cginc"
...
#line 485 "F:/src/unity_webgpu/Shaders/Includes/UnityImageBasedLighting.cginc"
...
#line 133 "F:/src/unity_webgpu/Shaders/Includes/UnityDeprecated.cginc"
...
#line 9 "F:/src/unity_webgpu/Shaders/Includes/UnityStandardUtils.cginc"
...
ambient_contrib = SHEvalLinearL0L1_SampleProbeVolume ( float4 ( normal , 1.0 ) , worldPos ) ;
else
...
#line 15 "F:/src/unity_webgpu/Shaders/Includes/UnityShadowLibrary.cginc"
...
float atten = 1.0f ;
#line 214
atten = unity_Builtins2Array [ unity_InstanceID ] . unity_SHCArray . w ;
#line 218
...
#line 10 "F:/src/unity_webgpu/Shaders/Includes/UnityGlobalIllumination.cginc"
...
float3 specular ;
#line 155
float3 originalReflUVW = glossIn . reflUVW ;
...
#line 173
float3 env1 = Unity_GlossyEnvironment ( unity_SpecCube1 , samplerunity_SpecCube0 , data . probeHDR [ 1 ] , glossIn ) ;
...
#line 8 "F:/src/unity_webgpu/Shaders/Includes/Lighting.cginc"
...
#line 35 "F:/src/unity_webgpu/Shaders/Includes/UnityPBSLighting.cginc"
...
float4 c = BRDF1_Unity_PBS ( s . Albedo , specColor , oneMinusReflectivity , s . Smoothness , s . Normal , viewDir , gi . light , gi . indirect ) ;
c . a = outputAlpha ;
return c ;
}
...
float4 c = BRDF1_Unity_PBS ( s . Albedo , s . Specular , oneMinusReflectivity , s . Smoothness , s . Normal , viewDir , gi . light , gi . indirect ) ;
c . a = outputAlpha ;
return c ;
}
...
#line 40 "F:/src/unity_webgpu/Shaders/Includes/AutoLight.cginc"
sampler2D _ShadowMapTexture ;
#line 43
inline float unitySampleShadow ( float4 shadowCoord )
{
...
#line 119 "F:/src/unity_webgpu/Shaders/Includes/UnityStandardParticleInstancing.cginc"
void vertInstancingSetup ( ) { }
void vertInstancingColor ( inout float4 color ) { }
...
#line 41 "F:/src/unity_webgpu/Shaders/Includes/UnityStandardParticles.cginc"
...
{
float4 color = tex2D ( tex , IN . texcoord ) ;
#line 101
return color ;
}
...
{
o = ( Input ) 0 ; ;
float4 clipPosition = UnityObjectToClipPosInstanced ( v . vertex ) ;

;
o . texcoord = ( v . texcoords . xy . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ; ;
o . projectedPosition = ComputeScreenPos ( clipPosition ) ; o . projectedPosition . z = - UnityObjectToViewPos ( v . vertex ) . z ; ;
;
}

void surf ( Input IN , inout SurfaceOutputStandard o )
{
float4 albedo = readTexture ( _MainTex , IN ) ;
albedo *= _Color ;
...
#line 319
float3 emission = readTexture ( _EmissionMap , IN ) . rgb * cameraFade * softParticlesFade ;
#line 324
;
...
float4 fragParticleUnlit ( VertexOutput IN ) : COLOR
{
;
float4 albedo = readTexture ( _MainTex , IN ) ;
albedo *= _Color ;
...
float3 normal = normalize ( UnpackScaleNormal ( readTexture ( _BumpMap , IN ) , _BumpScale ) ) ;
#line 384
float3 emission = readTexture ( _EmissionMap , IN ) . rgb ;
#line 389
;
...
float4 color : COLOR0 ;
float2 custompack0 : TEXCOORD3 ;
float4 custompack1 : TEXCOORD4 ;
...
o . pos = UnityObjectToClipPosInstanced ( v . vertex ) ;
float3 worldPos = mul ( unity_Builtins0Array [ unity_InstanceID ] . unity_ObjectToWorldArray , v . vertex ) . xyz ;
...
{ UnitySetupInstanceID ( IN . instanceID ) ; UnitySetupCompoundMatrices ( ) ; } ;
;
...
surf ( surfIN , o ) ;
#line 344
float atten = UnityComputeForwardShadows ( 0 , worldPos , IN . _ShadowCoord ) ;
float4 c = 0 ;
float3 worldN ;
