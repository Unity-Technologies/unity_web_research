...
void main()
{
    ...
    u_xlat18.x = texture(sampler2D(_Noise, sampler_Noise), u_xlat4.xy).x;
    u_xlat5.y = u_xlat4.w;
    u_xlat26 = texture(sampler2D(_Noise, sampler_Noise), u_xlat5.xy).x;
    u_xlat18.x = dot(u_xlat18.xx, vec2(u_xlat26));
    ...
    u_xlat18.xy = vs_TEXCOORD4.yy * unity_WorldToLight[1].xy;
    u_xlat18.xy = unity_WorldToLight[0].xy * vs_TEXCOORD4.xx + u_xlat18.xy;
    u_xlat18.xy = unity_WorldToLight[2].xy * vs_TEXCOORD4.zz + u_xlat18.xy;
    u_xlat18.xy = u_xlat18.xy + unity_WorldToLight[3].xy;
    ...
    if(u_xlatb25){
        ...
        u_xlat11.xyz = (bool(u_xlatb25)) ? u_xlat11.xyz : vs_TEXCOORD4.xyz;
        ...
        u_xlat7.x = max(u_xlat25, u_xlat11.x);
    ...
    u_xlat25 = clamp(u_xlat25, 0.0, 1.0);
    u_xlat18.x = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat18.xy).w;
    ...
    u_xlat11.xyz = u_xlat18.xxx * u_xlat7.xyz;
