...
void main()
{
    ...
    if(u_xlatb49){
        ...
        u_xlat4.xyz = (bool(u_xlatb49)) ? u_xlat4.xyz : u_xlat0.xyz;
        u_xlat4.xyz = u_xlat4.xyz + (-unity_ProbeVolumeMin.xyz);
        u_xlat4.yzw = u_xlat4.xyz * unity_ProbeVolumeSizeInv.xyz;
        u_xlat49 = u_xlat4.y * 0.25 + 0.75;
        u_xlat50 = unity_ProbeVolumeParams.z * 0.5 + 0.75;
        u_xlat4.x = max(u_xlat49, u_xlat50);
    ...
    u_xlat49 = dot(u_xlat4, unity_OcclusionMaskSelector);
    u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
