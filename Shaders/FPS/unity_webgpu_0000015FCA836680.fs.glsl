...
layout(set = 0, binding = 3) uniform mediump texture2D _DepthOfFieldTex;
...
layout(set = 0, binding = 5) uniform mediump  sampler sampler_CoCTex;
layout(set = 0, binding = 6) uniform mediump  sampler sampler_DepthOfFieldTex;
void main()
{
