...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat3.x = u_xlat3.x * _MainLightShadowParams.x + u_xlat46;
    ...
    u_xlat3.x = u_xlat46 * u_xlat47 + u_xlat3.x;
    ...
    u_xlat46 = dot((-u_xlat7.xyz), u_xlat1.xyz);
    u_xlat46 = u_xlat46 + u_xlat46;
    u_xlat8.xyz = u_xlat1.xyz * (-vec3(u_xlat46)) + (-u_xlat7.xyz);
    ...
    u_xlat9.xyz = (-u_xlat5.xyz) + vec3(u_xlat17);
    ...
    u_xlat0.xyz = u_xlat2.xyz * vec3(u_xlat14) + u_xlat6.xyz;
