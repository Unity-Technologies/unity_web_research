...
layout(location = 1) out highp vec4 vs_INTERP1;
void main()
{
vec4 u_xlat0;
vec4 u_xlat1;
...
float u_xlat12;
    ...
    u_xlat5.y = dot(u_xlat0.xyz, vec3(u_xlat12));
    u_xlat5.xz = in_COLOR0.xy * vec2(0.100000001, 3.29999995);
    u_xlat2 = u_xlat5.yyzz + _TimeParameters.xxxx;
    ...
    u_xlat2.xz = u_xlat5.xx * u_xlat2.xy;
