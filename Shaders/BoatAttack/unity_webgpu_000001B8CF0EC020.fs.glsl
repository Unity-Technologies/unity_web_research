...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.xyz = vec3(u_xlat28) * u_xlat9.xyz;
        ...
        u_xlat73 = dot(_AdditionalLightsSpotDir[u_xlati69].xyz, u_xlat10.xyz);
        u_xlat73 = u_xlat73 * _AdditionalLightsAttenuation[u_xlati69].z + _AdditionalLightsAttenuation[u_xlati69].w;
        u_xlat73 = clamp(u_xlat73, 0.0, 1.0);
        u_xlat73 = u_xlat73 * u_xlat73;
        u_xlat70 = u_xlat70 * u_xlat73;
        u_xlat11.xyz = vec3(u_xlat50) * _AdditionalLightsColor[u_xlati69].xyz;
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat28) + u_xlat4.xyz;
        ...
        u_xlat9.xyz = vec3(u_xlat69) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat7.xyz;
