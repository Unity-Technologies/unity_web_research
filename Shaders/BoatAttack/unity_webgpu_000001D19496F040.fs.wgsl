...
fn main_1() {
  ...
  let x_1269 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1273 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_1287 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1283.x, x_1283.y), x_1286);
  u_xlat18 = x_1287.w;
  let x_1289 : f32 = u_xlat18;
  u_xlat18 = ((x_1289 * 2.0f) + -1.0f);
  let x_1292 : f32 = u_xlat18;
  u_xlatb1.x = (x_1292 >= 0.0f);
  let x_1296 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1296);
  let x_1299 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1299)) + 1.0f);
  let x_1303 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1303);
  let x_1305 : f32 = u_xlat18;
  u_xlat18 = (-(x_1305) + 1.0f);
  let x_1308 : f32 = u_xlat18;
  let x_1310 : f32 = u_xlat1.x;
  u_xlat18 = (x_1308 * x_1310);
  let x_1312 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1312.x, x_1312.y, x_1312.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1315 : vec4<f32> = u_xlat0;
  let x_1318 : vec3<f32> = log2(abs(vec3<f32>(x_1315.x, x_1315.y, x_1315.z)));
  let x_1319 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1318.x, x_1318.y, x_1318.z, x_1319.w);
  let x_1321 : vec4<f32> = u_xlat2;
  let x_1323 : vec3<f32> = (vec3<f32>(x_1321.x, x_1321.y, x_1321.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1334 : vec3<f32> = ((vec3<f32>(x_1331.x, x_1331.y, x_1331.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1335 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1334.x, x_1334.y, x_1334.z, x_1335.w);
  let x_1337 : vec4<f32> = u_xlat0;
  let x_1339 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1337.x, x_1337.y, x_1337.z, x_1337.x));
  ...
  let x_1384 : vec3<f32> = ((vec3<f32>(x_1377, x_1377, x_1377) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1382.x, x_1382.y, x_1382.z));
  let x_1385 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1384.x, x_1384.y, x_1384.z, x_1385.w);
  let x_1387 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1387.x, x_1387.y, x_1387.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1390 : vec4<f32> = u_xlat0;
  let x_1392 : vec3<f32> = (vec3<f32>(x_1390.x, x_1390.y, x_1390.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1393 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1392.x, x_1392.y, x_1392.z, x_1393.w);
  let x_1395 : vec4<f32> = u_xlat2;
  let x_1397 : vec3<f32> = (vec3<f32>(x_1395.x, x_1395.y, x_1395.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1398 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1397.x, x_1397.y, x_1397.z, x_1398.w);
  let x_1400 : vec4<f32> = u_xlat2;
  let x_1403 : vec3<f32> = log2(abs(vec3<f32>(x_1400.x, x_1400.y, x_1400.z)));
  let x_1404 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1403.x, x_1403.y, x_1403.z, x_1404.w);
  let x_1406 : vec4<f32> = u_xlat2;
  let x_1408 : vec3<f32> = (vec3<f32>(x_1406.x, x_1406.y, x_1406.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1409 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1408.x, x_1408.y, x_1408.z, x_1409.w);
  let x_1411 : vec4<f32> = u_xlat2;
  let x_1413 : vec3<f32> = exp2(vec3<f32>(x_1411.x, x_1411.y, x_1411.z));
  let x_1414 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1413.x, x_1413.y, x_1413.z, x_1414.w);
  let x_1416 : vec4<f32> = u_xlat0;
  let x_1418 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1416.x, x_1416.y, x_1416.z, x_1416.x));
  u_xlatb0 = vec3<bool>(x_1418.x, x_1418.y, x_1418.z);
  ...
  let x_1461 : vec3<f32> = max(vec3<f32>(x_1458.x, x_1458.y, x_1458.z), vec3<f32>(0.0f, 0.0f, 0.0f));
