...
fn main_1() {
  ...
  SV_Target0.x = x_1560;
  let x_1564 : bool = u_xlatb0.y;
  if (x_1564) {
    let x_1569 : f32 = u_xlat1.y;
    x_1565 = x_1569;
  } else {
    let x_1572 : f32 = u_xlat2.y;
    x_1565 = x_1572;
  }
  let x_1573 : f32 = x_1565;
  SV_Target0.y = x_1573;
  let x_1576 : bool = u_xlatb0.z;
  if (x_1576) {
    let x_1581 : f32 = u_xlat1.z;
    x_1577 = x_1581;
  } else {
