...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat24 = min(u_xlat2.z, u_xlat36);
    ...
    u_xlat36 = u_xlat36 * _MainLightShadowParams.x + u_xlat5.x;
    u_xlatb5 = 0.0>=vs_INTERP8.z;
    u_xlatb16 = vs_INTERP8.z>=1.0;
    ...
    u_xlat16 = (-u_xlat36) + 1.0;
    u_xlat36 = u_xlat5.x * u_xlat16 + u_xlat36;
    u_xlat5.xyz = vec3(u_xlat37) * _MainLightColor.xyz;
    u_xlat38 = dot((-u_xlat4.xyz), u_xlat1.xyz);
    u_xlat38 = u_xlat38 + u_xlat38;
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat38)) + (-u_xlat4.xyz);
    ...
    u_xlat33 = u_xlat36 * unity_LightData.z;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat2.x = dot(unity_LightIndices[int(u_xlatu2)], uintBitsToFloat(ImmCB_0[u_xlati36]));
        u_xlati2 = int(u_xlat2.x);
        u_xlat19.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati2].www + _AdditionalLightsPosition[u_xlati2].xyz;
        ...
        u_xlat36 = u_xlat36 * _AdditionalLightsAttenuation[u_xlati2].x;
        u_xlat36 = (-u_xlat36) * u_xlat36 + 1.0;
        u_xlat36 = max(u_xlat36, 0.0);
        u_xlat36 = u_xlat36 * u_xlat36;
        u_xlat36 = u_xlat36 * u_xlat39;
        u_xlat39 = dot(_AdditionalLightsSpotDir[u_xlati2].xyz, u_xlat9.xyz);
        u_xlat39 = u_xlat39 * _AdditionalLightsAttenuation[u_xlati2].z + _AdditionalLightsAttenuation[u_xlati2].w;
        u_xlat39 = clamp(u_xlat39, 0.0, 1.0);
        u_xlat39 = u_xlat39 * u_xlat39;
        u_xlat36 = u_xlat36 * u_xlat39;
        u_xlat10.xyz = vec3(u_xlat37) * _AdditionalLightsColor[u_xlati2].xyz;
        ...
        u_xlat2.x = dot(u_xlat1.xyz, u_xlat19.xyz);
        u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
        ...
        u_xlat19.xyz = u_xlat0.xyz * u_xlat2.xxx + u_xlat6.xyz;
        u_xlat7.xyz = u_xlat19.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat24) + u_xlat5.xyz;
