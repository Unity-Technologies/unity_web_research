...
fn main_1() {
  ...
  u_xlat0 = sqrt(x_1598);
  let x_1600 : vec2<f32> = vs_TEXCOORD0;
  let x_1603 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1607 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1609 : vec2<f32> = ((x_1600 * vec2<f32>(x_1603.x, x_1603.y)) + vec2<f32>(x_1607.z, x_1607.w));
  let x_1610 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1609.x, x_1609.y, x_1610.z, x_1610.w);
  let x_1617 : vec4<f32> = u_xlat1;
  let x_1620 : f32 = x_27.x_GlobalMipBias.x;
  let x_1621 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1617.x, x_1617.y), x_1620);
  u_xlat18 = x_1621.w;
  let x_1623 : f32 = u_xlat18;
  u_xlat18 = ((x_1623 * 2.0f) + -1.0f);
  let x_1626 : f32 = u_xlat18;
  u_xlatb1 = (x_1626 >= 0.0f);
  let x_1628 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1628);
  let x_1631 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1631)) + 1.0f);
  let x_1635 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1635);
  let x_1637 : f32 = u_xlat18;
  u_xlat18 = (-(x_1637) + 1.0f);
  let x_1640 : f32 = u_xlat18;
  let x_1642 : f32 = u_xlat1.x;
  u_xlat18 = (x_1640 * x_1642);
  let x_1644 : vec3<f32> = u_xlat0;
  let x_1645 : vec3<f32> = (x_1644 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1646 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1645.x, x_1645.y, x_1645.z, x_1646.w);
  let x_1648 : vec3<f32> = u_xlat0;
  let x_1649 : vec3<f32> = log2(x_1648);
