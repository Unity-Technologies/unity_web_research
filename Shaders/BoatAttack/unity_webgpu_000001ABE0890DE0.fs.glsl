...
;
    ...
    u_xlat1.xyw = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati36 + 1) / 4][(u_xlati36 + 1) % 4].xyz;
    u_xlat1.xyw = _MainLightWorldToShadow[u_xlati36 / 4][u_xlati36 % 4].xyz * vs_INTERP0.xxx + u_xlat1.xyw;
    u_xlat1.xyw = _MainLightWorldToShadow[(u_xlati36 + 2) / 4][(u_xlati36 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat1.xyw;
    u_xlat1.xyw = u_xlat1.xyw + _MainLightWorldToShadow[(u_xlati36 + 3) / 4][(u_xlati36 + 3) % 4].xyz;
    u_xlat4.w = 1.0;
    ...
    u_xlat1.x = u_xlat1.x * _MainLightShadowParams.x + u_xlat13;
    u_xlatb13 = 0.0>=u_xlat1.w;
    u_xlatb37 = u_xlat1.w>=1.0;
    u_xlatb13 = u_xlatb37 || u_xlatb13;
    ...
    u_xlat1.x = u_xlat13 * u_xlat37 + u_xlat1.x;
    u_xlat7.xyz = vec3(u_xlat41) * _MainLightColor.xyz;
    u_xlat13 = dot((-u_xlat5.xyz), u_xlat4.xyz);
    u_xlat13 = u_xlat13 + u_xlat13;
    u_xlat9.xyz = u_xlat4.xyz * (-vec3(u_xlat13)) + (-u_xlat5.xyz);
    ...
    u_xlat9 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat9.xyz, u_xlat36);
    ...
    u_xlat22.xyz = (-u_xlat0.xyz) + vec3(u_xlat38);
    u_xlat22.xyz = vec3(u_xlat13) * u_xlat22.xyz + u_xlat0.xyz;
    u_xlat22.xyz = vec3(u_xlat36) * u_xlat22.xyz;
    u_xlat9.xyz = u_xlat9.xyz * u_xlat22.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat8.xyz + u_xlat9.xyz;
    u_xlat36 = u_xlat1.x * unity_LightData.z;
    u_xlat1.x = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat36 = u_xlat36 * u_xlat1.x;
    u_xlat1.xyw = vec3(u_xlat36) * u_xlat7.xyz;
    ...
    u_xlat36 = u_xlat36 * u_xlat10.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat22.xyz = vec3(u_xlat42) * u_xlat9.xyz;
        ...
        u_xlat43 = dot(_AdditionalLightsSpotDir[u_xlati3].xyz, u_xlat22.xyz);
        ...
        u_xlat3.x = dot(u_xlat4.xyz, u_xlat22.xyz);
        ...
        u_xlat3.x = dot(u_xlat4.xyz, u_xlat9.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        ...
        u_xlat9.xyz = u_xlat0.xyz * u_xlat3.xxx + u_xlat8.xyz;
        u_xlat7.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat6.xyz * vec3(u_xlat27) + u_xlat1.xyw;
