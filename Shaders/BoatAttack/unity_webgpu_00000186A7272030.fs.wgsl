...
fn main_1() {
  ...
  let x_1522 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1526 : vec4<f32> = x_26.x_Dithering_Params;
  ...
  let x_1540 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1536.x, x_1536.y), x_1539);
  u_xlat15 = x_1540.w;
  let x_1542 : f32 = u_xlat15;
  u_xlat15 = ((x_1542 * 2.0f) + -1.0f);
  let x_1545 : f32 = u_xlat15;
  u_xlatb1 = (x_1545 >= 0.0f);
  let x_1547 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1547);
  let x_1550 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1550)) + 1.0f);
  let x_1554 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1554);
  let x_1556 : f32 = u_xlat15;
  u_xlat15 = (-(x_1556) + 1.0f);
  let x_1559 : f32 = u_xlat15;
  let x_1561 : f32 = u_xlat1.x;
  u_xlat15 = (x_1559 * x_1561);
  let x_1563 : vec3<f32> = u_xlat0;
  let x_1564 : vec3<f32> = (x_1563 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1565 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1564.x, x_1564.y, x_1564.z, x_1565.w);
  let x_1567 : vec3<f32> = u_xlat0;
  let x_1569 : vec3<f32> = log2(abs(x_1567));
  let x_1570 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1569.x, x_1569.y, x_1569.z, x_1570.w);
  let x_1572 : vec4<f32> = u_xlat2;
  let x_1574 : vec3<f32> = (vec3<f32>(x_1572.x, x_1572.y, x_1572.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1575 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1574.x, x_1574.y, x_1574.z, x_1575.w);
  let x_1577 : vec4<f32> = u_xlat2;
  let x_1579 : vec3<f32> = exp2(vec3<f32>(x_1577.x, x_1577.y, x_1577.z));
  let x_1580 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1579.x, x_1579.y, x_1579.z, x_1580.w);
  let x_1582 : vec4<f32> = u_xlat2;
  let x_1585 : vec3<f32> = ((vec3<f32>(x_1582.x, x_1582.y, x_1582.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1586 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1585.x, x_1585.y, x_1585.z, x_1586.w);
  let x_1588 : vec3<f32> = u_xlat0;
  let x_1590 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1588.x, x_1588.y, x_1588.z, x_1588.x));
  ...
  u_xlat0 = ((vec3<f32>(x_1628, x_1628, x_1628) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1633);
  let x_1635 : vec3<f32> = u_xlat0;
  let x_1636 : vec3<f32> = (x_1635 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1637 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1636.x, x_1636.y, x_1636.z, x_1637.w);
  let x_1639 : vec3<f32> = u_xlat0;
  let x_1640 : vec3<f32> = (x_1639 + vec3<f32>(0.055f, 0.055f, 0.055f));
  ...
  let x_1656 : vec3<f32> = (vec3<f32>(x_1654.x, x_1654.y, x_1654.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1666 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1664.x, x_1664.y, x_1664.z, x_1664.x));
  ...
  let x_1707 : vec3<f32> = max(x_1706, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1708 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1707.x, x_1707.y, x_1707.z, x_1708.w);
  SV_Target0.w = 1.0f;
  return;
}
