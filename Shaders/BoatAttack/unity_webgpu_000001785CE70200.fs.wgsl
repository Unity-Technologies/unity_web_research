...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1168.x, x_1168.y, x_1168.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1171 : vec4<f32> = u_xlat0;
  let x_1174 : vec3<f32> = log2(abs(vec3<f32>(x_1171.x, x_1171.y, x_1171.z)));
  let x_1175 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1174.x, x_1174.y, x_1174.z, x_1175.w);
  let x_1177 : vec4<f32> = u_xlat2;
  let x_1179 : vec3<f32> = (vec3<f32>(x_1177.x, x_1177.y, x_1177.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1180 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1179.x, x_1179.y, x_1179.z, x_1180.w);
  let x_1182 : vec4<f32> = u_xlat2;
  let x_1184 : vec3<f32> = exp2(vec3<f32>(x_1182.x, x_1182.y, x_1182.z));
  let x_1185 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1184.x, x_1184.y, x_1184.z, x_1185.w);
  let x_1187 : vec4<f32> = u_xlat2;
  let x_1190 : vec3<f32> = ((vec3<f32>(x_1187.x, x_1187.y, x_1187.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1191 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1190.x, x_1190.y, x_1190.z, x_1191.w);
  let x_1193 : vec4<f32> = u_xlat0;
  let x_1195 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1193.x, x_1193.y, x_1193.z, x_1193.x));
  u_xlatb0 = vec3<bool>(x_1195.x, x_1195.y, x_1195.z);
  ...
  SV_Target0.x = x_1209;
  let x_1213 : bool = u_xlatb0.y;
  if (x_1213) {
    let x_1218 : f32 = u_xlat1.y;
    x_1214 = x_1218;
  } else {
    let x_1221 : f32 = u_xlat2.y;
    x_1214 = x_1221;
  }
  let x_1222 : f32 = x_1214;
  SV_Target0.y = x_1222;
  let x_1225 : bool = u_xlatb0.z;
  if (x_1225) {
    let x_1230 : f32 = u_xlat1.z;
    x_1226 = x_1230;
  } else {
    let x_1233 : f32 = u_xlat2.z;
    x_1226 = x_1233;
  }
  let x_1234 : f32 = x_1226;
  SV_Target0.z = x_1234;
  SV_Target0.w = 1.0f;
  return;
}
