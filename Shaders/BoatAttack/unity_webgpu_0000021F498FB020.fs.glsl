...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu54 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati57].www + _AdditionalLightsPosition[u_xlati57].xyz;
        ...
        u_xlat59 = dot(_AdditionalLightsSpotDir[u_xlati57].xyz, u_xlat6.xyz);
        u_xlat59 = u_xlat59 * _AdditionalLightsAttenuation[u_xlati57].z + _AdditionalLightsAttenuation[u_xlati57].w;
        u_xlat59 = clamp(u_xlat59, 0.0, 1.0);
        u_xlat59 = u_xlat59 * u_xlat59;
        u_xlat58 = u_xlat58 * u_xlat59;
        u_xlat7.xyz = u_xlat1.xxx * _AdditionalLightsColor[u_xlati57].xyz;
