...
fn main_1() {
  ...
  let x_1535 : vec3<f32> = (x_1534 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1536 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1535.x, x_1535.y, x_1535.z, x_1536.w);
  let x_1538 : vec3<f32> = u_xlat0;
  let x_1540 : vec3<f32> = log2(abs(x_1538));
  let x_1541 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1540.x, x_1540.y, x_1540.z, x_1541.w);
  let x_1543 : vec4<f32> = u_xlat2;
  let x_1545 : vec3<f32> = (vec3<f32>(x_1543.x, x_1543.y, x_1543.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1556 : vec3<f32> = ((vec3<f32>(x_1553.x, x_1553.y, x_1553.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1557 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1556.x, x_1556.y, x_1556.z, x_1557.w);
  let x_1559 : vec3<f32> = u_xlat0;
  let x_1561 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1559.x, x_1559.y, x_1559.z, x_1559.x));
  ...
  u_xlat0.z = x_1597;
  let x_1599 : vec2<f32> = vs_TEXCOORD0;
  let x_1602 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1606 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1608 : vec2<f32> = ((x_1599 * vec2<f32>(x_1602.x, x_1602.y)) + vec2<f32>(x_1606.z, x_1606.w));
  let x_1609 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1608.x, x_1608.y, x_1609.z, x_1609.w);
  let x_1616 : vec4<f32> = u_xlat1;
  let x_1619 : f32 = x_27.x_GlobalMipBias.x;
  let x_1620 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1616.x, x_1616.y), x_1619);
  u_xlat18 = x_1620.w;
  let x_1622 : f32 = u_xlat18;
  u_xlat18 = ((x_1622 * 2.0f) + -1.0f);
  let x_1625 : f32 = u_xlat18;
  u_xlatb1 = (x_1625 >= 0.0f);
  let x_1627 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1627);
  let x_1630 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1630)) + 1.0f);
  let x_1634 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1634);
  let x_1636 : f32 = u_xlat18;
  u_xlat18 = (-(x_1636) + 1.0f);
  let x_1639 : f32 = u_xlat18;
  let x_1641 : f32 = u_xlat1.x;
  u_xlat18 = (x_1639 * x_1641);
  let x_1643 : vec3<f32> = u_xlat0;
  let x_1644 : vec3<f32> = (x_1643 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1645 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1644.x, x_1644.y, x_1644.z, x_1645.w);
  let x_1647 : vec3<f32> = u_xlat0;
  let x_1649 : vec3<f32> = log2(abs(x_1647));
  let x_1650 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1649.x, x_1649.y, x_1649.z, x_1650.w);
  let x_1652 : vec4<f32> = u_xlat2;
  let x_1654 : vec3<f32> = (vec3<f32>(x_1652.x, x_1652.y, x_1652.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1655 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1654.x, x_1654.y, x_1654.z, x_1655.w);
  let x_1657 : vec4<f32> = u_xlat2;
  let x_1659 : vec3<f32> = exp2(vec3<f32>(x_1657.x, x_1657.y, x_1657.z));
  let x_1660 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1659.x, x_1659.y, x_1659.z, x_1660.w);
  let x_1662 : vec4<f32> = u_xlat2;
  let x_1665 : vec3<f32> = ((vec3<f32>(x_1662.x, x_1662.y, x_1662.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1666 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1666.w);
  let x_1668 : vec3<f32> = u_xlat0;
  let x_1670 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1668.x, x_1668.y, x_1668.z, x_1668.x));
  ...
  u_xlat0.z = x_1706;
  let x_1708 : f32 = u_xlat18;
  let x_1713 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1708, x_1708, x_1708) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1713);
  let x_1715 : vec3<f32> = u_xlat0;
  let x_1716 : vec3<f32> = (x_1715 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1717 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1716.x, x_1716.y, x_1716.z, x_1717.w);
  let x_1719 : vec3<f32> = u_xlat0;
  let x_1720 : vec3<f32> = (x_1719 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1721 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1720.x, x_1720.y, x_1720.z, x_1721.w);
  let x_1723 : vec4<f32> = u_xlat2;
  let x_1725 : vec3<f32> = (vec3<f32>(x_1723.x, x_1723.y, x_1723.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1726 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1725.x, x_1725.y, x_1725.z, x_1726.w);
  let x_1728 : vec4<f32> = u_xlat2;
  let x_1731 : vec3<f32> = log2(abs(vec3<f32>(x_1728.x, x_1728.y, x_1728.z)));
  let x_1732 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1731.x, x_1731.y, x_1731.z, x_1732.w);
  let x_1734 : vec4<f32> = u_xlat2;
  let x_1736 : vec3<f32> = (vec3<f32>(x_1734.x, x_1734.y, x_1734.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1737 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1736.x, x_1736.y, x_1736.z, x_1737.w);
  let x_1739 : vec4<f32> = u_xlat2;
  let x_1741 : vec3<f32> = exp2(vec3<f32>(x_1739.x, x_1739.y, x_1739.z));
  let x_1742 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1741.x, x_1741.y, x_1741.z, x_1742.w);
  let x_1744 : vec3<f32> = u_xlat0;
  let x_1746 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1744.x, x_1744.y, x_1744.z, x_1744.x));
  u_xlatb0 = vec3<bool>(x_1746.x, x_1746.y, x_1746.z);
  let x_1749 : bool = u_xlatb0.x;
  if (x_1749) {
  ...
  u_xlat0.x = x_1758;
  let x_1761 : bool = u_xlatb0.y;
  if (x_1761) {
    let x_1766 : f32 = u_xlat1.y;
    x_1762 = x_1766;
  } else {
    let x_1769 : f32 = u_xlat2.y;
    x_1762 = x_1769;
  }
  let x_1770 : f32 = x_1762;
  u_xlat0.y = x_1770;
  let x_1773 : bool = u_xlatb0.z;
  if (x_1773) {
    let x_1778 : f32 = u_xlat1.z;
    x_1774 = x_1778;
  } else {
  ...
  let x_1787 : vec3<f32> = max(x_1786, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1788 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1787.x, x_1787.y, x_1787.z, x_1788.w);
  SV_Target0.w = 1.0f;
  return;
}
