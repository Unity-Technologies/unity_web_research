...
;
    ...
    u_xlat62 = dot(u_xlat21.xyz, u_xlat3.xyz);
    u_xlat62 = u_xlat62 + 0.5;
    u_xlat3.xyz = vec3(u_xlat62) * u_xlat4.xyz;
    u_xlat62 = max(u_xlat3.w, 9.99999975e-05);
    ...
    u_xlatb22.x = 0.0>=u_xlat2.z;
    u_xlatb42 = u_xlat2.z>=1.0;
    u_xlatb22.x = u_xlatb42 || u_xlatb22.x;
    u_xlat2.x = (u_xlatb22.x) ? 1.0 : u_xlat2.x;
    ...
    u_xlat42.x = (-u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat22.x * u_xlat42.x + u_xlat2.x;
    u_xlatb22.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb22.x){
        u_xlat22.xy = vs_TEXCOORD7.yy * _MainLightWorldToLight[1].xy;
        u_xlat22.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD7.xx + u_xlat22.xy;
        u_xlat22.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD7.zz + u_xlat22.xy;
        u_xlat22.xy = u_xlat22.xy + _MainLightWorldToLight[3].xy;
        u_xlat22.xy = u_xlat22.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat6 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat22.xy, _GlobalMipBias.x);
        ...
        u_xlat42.x = (u_xlatb22.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb22.x) ? u_xlat6.xyz : u_xlat42.xxx;
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat22.x = u_xlat22.x * u_xlat22.x;
    u_xlat22.x = u_xlat22.x * u_xlat22.x;
    u_xlat42.x = (-u_xlat1) * 0.699999988 + 1.70000005;
    u_xlat1 = u_xlat1 * u_xlat42.x;
    u_xlat1 = u_xlat1 * 6.0;
    ...
    u_xlat42.xy = vec2(u_xlat62) * vec2(u_xlat62) + vec2(-1.0, 1.0);
    u_xlat1 = float(1.0) / u_xlat42.y;
    u_xlat9.xyz = (-u_xlat0.xyz) + vec3(u_xlat60);
    u_xlat9.xyz = u_xlat22.xxx * u_xlat9.xyz + u_xlat0.xyz;
    ...
    u_xlat2.xyw = vec3(u_xlat60) * u_xlat6.xyz;
    ...
    u_xlat60 = u_xlat60 * u_xlat42.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat64 = dot(u_xlat21.xyz, u_xlat10.xyz);
        ...
        u_xlat64 = dot(u_xlat21.xyz, u_xlat9.xyz);
        u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
        u_xlat65 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
        u_xlat64 = u_xlat64 * u_xlat64;
        u_xlat64 = u_xlat64 * u_xlat42.x + 1.00001001;
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat64 = u_xlat64 * u_xlat64;
