...
;
    ...
    u_xlat3.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati14 + 1) / 4][(u_xlati14 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati14 / 4][u_xlati14 % 4].xyz * vs_INTERP0.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati14 + 2) / 4][(u_xlati14 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati14 + 3) / 4][(u_xlati14 + 3) % 4].xyz;
    ...
    u_xlat14.x = dot(u_xlat15.xyz, u_xlat5.xyz);
    u_xlat14.x = u_xlat14.x + 0.5;
    u_xlat5.xyz = u_xlat14.xxx * u_xlat6.xyz;
    u_xlat14.x = max(u_xlat5.w, 9.99999975e-05);
    ...
    u_xlat6.xyz = u_xlat15.xyz * (-vec3(u_xlat47)) + (-u_xlat4.xyz);
    ...
    u_xlat14.x = dot(u_xlat15.xyz, u_xlat6.xyz);
    ...
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat42) + u_xlat3.xyz;
