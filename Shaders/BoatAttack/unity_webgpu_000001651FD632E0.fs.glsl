...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat2.xzw = (-vs_INTERP0.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat28 = dot(u_xlat2.xzw, u_xlat2.xzw);
    u_xlat28 = inversesqrt(u_xlat28);
    u_xlat2.xzw = vec3(u_xlat28) * u_xlat2.xzw;
    u_xlat4.x = (u_xlatb14.x) ? u_xlat2.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb14.x) ? u_xlat2.z : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb14.x) ? u_xlat2.w : unity_MatrixV[2].z;
    u_xlat3.w = 1.0;
    ...
    u_xlat7.xy = u_xlat2.xz * hlslcc_FragCoord.xy;
    u_xlat2.x = u_xlat7.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat7.z = (-u_xlat2.x) + 1.0;
    u_xlat6.x = u_xlat6.x;
    ...
    u_xlat14.xyz = u_xlat14.xyz * u_xlat2.xzw + u_xlat7.xyz;
    ...
    u_xlat7.xyz = vec3(u_xlat43) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xzw;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu43 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat46 = dot(unity_LightIndices[int(u_xlatu46)], uintBitsToFloat(ImmCB_0[u_xlati19]));
        ...
        u_xlat35 = inversesqrt(u_xlat19);
        u_xlat10.xyz = vec3(u_xlat35) * u_xlat9.xyz;
        u_xlat49 = float(1.0) / float(u_xlat19);
        u_xlat19 = u_xlat19 * _AdditionalLightsAttenuation[int(u_xlatu46)].x;
        ...
        u_xlat9.xyz = vec3(u_xlat46) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xzw;
        u_xlat22.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat22.xyz;
    }
    u_xlat14.xyz = u_xlat14.xyz * vec3(u_xlat47) + u_xlat20.xyz;
