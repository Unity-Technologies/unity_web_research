...
bool u_xlatb19;
    ...
    u_xlat0 = u_xlat14.xxxx * u_xlat3 + u_xlat0;
    u_xlat0 = u_xlat0 * u_xlat2.yyyy;
    u_xlat0 = u_xlat14.yyyy * u_xlat4 + u_xlat0;
    u_xlatb19 = 0.0<_Bloom_RGBM;
    if(u_xlatb19){
    ...
    u_xlat1.xyz = textureLod(sampler2D(_InternalLut, sampler_LinearClamp), u_xlat12.xy, 0.0).xyz;
