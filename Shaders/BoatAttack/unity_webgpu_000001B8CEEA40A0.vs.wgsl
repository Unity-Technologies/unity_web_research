...
@group(0) @binding(18) var<storage, read> x_766 : x_WaveDataBuffer;
...
fn main_1() {
  ...
  let x_647 : vec2<f32> = ((vec2<f32>(x_642.x, x_642.z) * vec2<f32>(0.002f, 0.002f)) + vec2<f32>(0.5f, 0.5f));
  ...
  u_xlat11 = ((x_705 * 0.100000001f) + 0.050000001f);
  ...
  let x_1141 : vec2<f32> = (vec2<f32>(x_1137.x, x_1137.z) * vec2<f32>(0.005f, 0.005f));
