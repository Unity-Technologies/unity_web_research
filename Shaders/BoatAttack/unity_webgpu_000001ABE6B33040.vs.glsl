...
float u_xlat44;
    ...
    u_xlat38 = max(u_xlat12, 1.17549435e-37);
    u_xlat38 = inversesqrt(u_xlat38);
    vs_TEXCOORD2.xyz = vec3(u_xlat38) * u_xlat3.xyz;
    u_xlat38 = u_xlat4.z / _ProjectionParams.y;
    u_xlat38 = (-u_xlat38) + 1.0;
    u_xlat38 = u_xlat38 * _ProjectionParams.z;
    u_xlat38 = max(u_xlat38, 0.0);
    vs_TEXCOORD4.x = u_xlat38 * unity_FogParams.x;
