...
fn main_1() {
  ...
  let x_1453 : vec2<f32> = vs_TEXCOORD0;
  let x_1456 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1460 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1462 : vec2<f32> = ((x_1453 * vec2<f32>(x_1456.x, x_1456.y)) + vec2<f32>(x_1460.z, x_1460.w));
  let x_1463 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1462.x, x_1462.y, x_1463.z);
  let x_1470 : vec3<f32> = u_xlat1;
  let x_1473 : f32 = x_25.x_GlobalMipBias.x;
  let x_1474 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1470.x, x_1470.y), x_1473);
  u_xlat21 = x_1474.w;
  let x_1476 : f32 = u_xlat21;
  u_xlat21 = (x_1476 + -0.5f);
  let x_1478 : f32 = u_xlat21;
  let x_1479 : f32 = u_xlat21;
  u_xlat21 = (x_1478 + x_1479);
  let x_1481 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1481.x, x_1481.y, x_1481.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1490 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1490);
  let x_1495 : f32 = x_25.x_Grain_Params.y;
  let x_1497 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1495 * -(x_1497)) + 1.0f);
  let x_1503 : f32 = u_xlat21;
  let x_1505 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_1503, x_1503, x_1503) * vec3<f32>(x_1505.x, x_1505.y, x_1505.z));
  let x_1508 : vec3<f32> = u_xlat8;
  let x_1511 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_1508 * vec3<f32>(x_1511.x, x_1511.x, x_1511.x));
  let x_1514 : vec3<f32> = u_xlat8;
  let x_1515 : vec3<f32> = u_xlat1;
  let x_1518 : vec4<f32> = u_xlat0;
  let x_1520 : vec3<f32> = ((x_1514 * vec3<f32>(x_1515.x, x_1515.x, x_1515.x)) + vec3<f32>(x_1518.x, x_1518.y, x_1518.z));
  let x_1521 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1520.x, x_1520.y, x_1520.z, x_1521.w);
  let x_1523 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1523.x, x_1523.y, x_1523.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1534 : vec3<f32> = (vec3<f32>(x_1532.x, x_1532.y, x_1532.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1545 : vec3<f32> = ((vec3<f32>(x_1542.x, x_1542.y, x_1542.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1546 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1545.x, x_1545.y, x_1545.z, x_1546.w);
  let x_1548 : vec4<f32> = u_xlat0;
  let x_1550 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1548.x, x_1548.y, x_1548.z, x_1548.x));
  u_xlatb0 = vec3<bool>(x_1550.x, x_1550.y, x_1550.z);
  let x_1555 : bool = u_xlatb0.x;
  if (x_1555) {
