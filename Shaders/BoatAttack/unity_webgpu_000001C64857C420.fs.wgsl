...
fn main_1() {
  ...
  u_xlatb0 = (x_502 < x_504);
  let x_506 : bool = u_xlatb1;
  let x_507 : bool = u_xlatb0;
  u_xlatb0 = (x_506 | x_507);
  let x_509 : bool = u_xlatb0;
  if (x_509) {
  ...
  let x_516 : vec3<f32> = x_510;
  let x_517 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_516.x, x_516.y, x_516.z, x_517.w);
  let x_519 : vec2<f32> = vs_TEXCOORD0;
  let x_522 : vec4<f32> = x_17.x_Grain_TilingParams;
  let x_526 : vec4<f32> = x_17.x_Grain_TilingParams;
  let x_528 : vec2<f32> = ((x_519 * vec2<f32>(x_522.x, x_522.y)) + vec2<f32>(x_526.z, x_526.w));
  let x_529 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_528.x, x_528.y, x_529.z, x_529.w);
  let x_536 : vec4<f32> = u_xlat1;
  let x_539 : f32 = x_17.x_GlobalMipBias.x;
  let x_540 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_536.x, x_536.y), x_539);
  u_xlat15 = x_540.w;
  let x_542 : f32 = u_xlat15;
  u_xlat15 = (x_542 + -0.5f);
  let x_544 : f32 = u_xlat15;
  let x_545 : f32 = u_xlat15;
  u_xlat15 = (x_544 + x_545);
  ...
  let x_559 : vec2<f32> = x_17.x_Grain_Params;
  let x_561 : vec3<f32> = (vec3<f32>(x_554.x, x_554.y, x_554.z) * vec3<f32>(x_559.x, x_559.x, x_559.x));
  let x_562 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_561.x, x_561.y, x_561.z, x_562.w);
  let x_564 : vec4<f32> = u_xlat0;
  u_xlat15 = dot(vec3<f32>(x_564.x, x_564.y, x_564.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_567 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_567);
  let x_571 : f32 = x_17.x_Grain_Params.y;
  let x_572 : f32 = u_xlat15;
  u_xlat15 = ((x_571 * -(x_572)) + 1.0f);
  let x_578 : vec4<f32> = u_xlat1;
  let x_580 : f32 = u_xlat15;
  let x_583 : vec4<f32> = u_xlat0;
  let x_585 : vec3<f32> = ((vec3<f32>(x_578.x, x_578.y, x_578.z) * vec3<f32>(x_580, x_580, x_580)) + vec3<f32>(x_583.x, x_583.y, x_583.z));
