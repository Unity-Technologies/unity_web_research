...
@group(1) @binding(0) var<uniform> x_19 : VGlobals;
...
fn main_1() {
  ...
  let x_257 : vec2<f32> = (vec2<f32>(0.25f, 0.25f) / vec2<f32>(x_255.x, x_255.y));
  let x_258 : vec4<f32> = vs_TEXCOORD2;
  vs_TEXCOORD2 = vec4<f32>(x_258.x, x_258.y, x_257.x, x_257.y);
  let x_260 : f32 = u_xlat12;
  u_xlat12 = inverseSqrt(x_260);
  let x_266 : f32 = in_TEXCOORD1.y;
  let x_270 : f32 = x_19.x_GradientScale;
  u_xlat1.x = (abs(x_266) * x_270);
  let x_276 : f32 = x_19.x_Sharpness;
  ...
  u_xlat5.x = (x_286 * x_288);
  let x_294 : f32 = x_19.x_PerspectiveFilter;
  u_xlat9 = (-(x_294) + 1.0f);
  let x_297 : f32 = u_xlat9;
  let x_299 : f32 = u_xlat5.x;
  u_xlat9 = (x_297 * abs(x_299));
  let x_302 : f32 = u_xlat12;
  let x_304 : f32 = u_xlat1.x;
  let x_306 : f32 = u_xlat9;
  u_xlat12 = ((x_302 * x_304) + -(x_306));
  let x_309 : f32 = u_xlat8;
  let x_311 : f32 = u_xlat12;
  let x_313 : f32 = u_xlat9;
  u_xlat8 = ((abs(x_309) * x_311) + x_313);
  let x_320 : f32 = x_19.glstate_matrix_projection[3i].w;
  u_xlatb12 = (x_320 == 0.0f);
  let x_323 : bool = u_xlatb12;
  if (x_323) {
...
fn main(@location(0) in_POSITION0_param : vec4<f32>, @location(2) in_COLOR0_param : vec4<f32>, @location(1) in_NORMAL0_param : vec3<f32>, @location(4) in_TEXCOORD1_param : vec2<f32>, @location(3) in_TEXCOORD0_param : vec2<f32>) -> main_out {
  ...
  main_1();
  return main_out(gl_Position, vs_COLOR0, vs_COLOR1, vs_TEXCOORD0, vs_TEXCOORD1);
}
