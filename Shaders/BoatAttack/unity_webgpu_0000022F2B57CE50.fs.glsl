...
;
    ...
    u_xlat34 = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat6.z = (-u_xlat34) + 1.0;
    ...
    u_xlat37 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat6.xz, _GlobalMipBias.x).x;
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat34);
    ...
    u_xlat6.xyz = u_xlat8.xyz * vec3(u_xlat34);
    ...
    u_xlat4.xyz = vec3(u_xlat34) * u_xlat15.xyz;
    ...
    u_xlat6.xyz = u_xlat0.xyz * vec3(u_xlat34) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu34 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat13 = dot(unity_LightIndices[int(u_xlatu13)], uintBitsToFloat(ImmCB_0[u_xlati37]));
        u_xlati13 = int(u_xlat13);
        u_xlat19.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati13].www + _AdditionalLightsPosition[u_xlati13].xyz;
        ...
        u_xlat40 = dot(_AdditionalLightsSpotDir[u_xlati13].xyz, u_xlat9.xyz);
        u_xlat40 = u_xlat40 * _AdditionalLightsAttenuation[u_xlati13].z + _AdditionalLightsAttenuation[u_xlati13].w;
        u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
        u_xlat40 = u_xlat40 * u_xlat40;
        u_xlat37 = u_xlat37 * u_xlat40;
        u_xlat10.xyz = vec3(u_xlat38) * _AdditionalLightsColor[u_xlati13].xyz;
        u_xlat13 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat13 = clamp(u_xlat13, 0.0, 1.0);
        u_xlat13 = u_xlat13 * u_xlat37;
        u_xlat10.xyz = vec3(u_xlat13) * u_xlat10.xyz;
        u_xlat19.xyz = u_xlat19.xyz * vec3(u_xlat39) + u_xlat3.xyz;
        u_xlat13 = dot(u_xlat19.xyz, u_xlat19.xyz);
        u_xlat13 = max(u_xlat13, 1.17549435e-37);
        u_xlat13 = inversesqrt(u_xlat13);
        u_xlat19.xyz = vec3(u_xlat13) * u_xlat19.xyz;
        u_xlat13 = dot(u_xlat1.xyz, u_xlat19.xyz);
        u_xlat13 = clamp(u_xlat13, 0.0, 1.0);
        u_xlat37 = dot(u_xlat9.xyz, u_xlat19.xyz);
        u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
        u_xlat13 = u_xlat13 * u_xlat13;
        u_xlat13 = u_xlat13 * u_xlat8.x + 1.00001001;
        u_xlat37 = u_xlat37 * u_xlat37;
        u_xlat13 = u_xlat13 * u_xlat13;
        ...
        u_xlat19.xyz = u_xlat0.xyz * vec3(u_xlat13) + u_xlat7.xyz;
        u_xlat6.xyz = u_xlat19.xyz * u_xlat10.xyz + u_xlat6.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat24) + u_xlat4.xyz;
