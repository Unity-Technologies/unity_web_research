...
fn main_1() {
  ...
  loop {
    ...
    let x_1168 : u32 = u_xlatu36;
    let x_1171 : vec4<f32> = x_281.unity_LightIndices[bitcast<i32>(x_1168)];
    let x_1181 : i32 = u_xlati38;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1186 : vec4<u32> = indexable[x_1181];
    u_xlat36 = dot(x_1171, bitcast<vec4<f32>>(x_1186));
    let x_1190 : f32 = u_xlat36;
    u_xlati36 = i32(x_1190);
    let x_1192 : vec3<f32> = vs_INTERP0;
    let x_1204 : i32 = u_xlati36;
    let x_1206 : vec4<f32> = x_1203.x_AdditionalLightsPosition[x_1204];
    let x_1209 : i32 = u_xlati36;
    let x_1211 : vec4<f32> = x_1203.x_AdditionalLightsPosition[x_1209];
    let x_1213 : vec3<f32> = ((-(x_1192) * vec3<f32>(x_1206.w, x_1206.w, x_1206.w)) + vec3<f32>(x_1211.x, x_1211.y, x_1211.z));
    ...
    u_xlat38 = dot(vec3<f32>(x_1217.x, x_1217.y, x_1217.z), vec3<f32>(x_1219.x, x_1219.y, x_1219.z));
    let x_1222 : f32 = u_xlat38;
    u_xlat38 = max(x_1222, 6.10351562e-05f);
    let x_1226 : f32 = u_xlat38;
    u_xlat39 = inverseSqrt(x_1226);
    let x_1228 : f32 = u_xlat39;
    let x_1230 : vec4<f32> = u_xlat8;
    u_xlat9 = (vec3<f32>(x_1228, x_1228, x_1228) * vec3<f32>(x_1230.x, x_1230.y, x_1230.z));
    let x_1234 : f32 = u_xlat38;
    u_xlat40 = (1.0f / x_1234);
    let x_1236 : f32 = u_xlat38;
    let x_1237 : i32 = u_xlati36;
    let x_1239 : f32 = x_1203.x_AdditionalLightsAttenuation[x_1237].x;
    u_xlat38 = (x_1236 * x_1239);
    let x_1241 : f32 = u_xlat38;
    let x_1243 : f32 = u_xlat38;
    u_xlat38 = ((-(x_1241) * x_1243) + 1.0f);
    let x_1246 : f32 = u_xlat38;
    u_xlat38 = max(x_1246, 0.0f);
    let x_1248 : f32 = u_xlat38;
    let x_1249 : f32 = u_xlat38;
    u_xlat38 = (x_1248 * x_1249);
    let x_1251 : f32 = u_xlat38;
    let x_1252 : f32 = u_xlat40;
    u_xlat38 = (x_1251 * x_1252);
    let x_1254 : i32 = u_xlati36;
    let x_1256 : vec4<f32> = x_1203.x_AdditionalLightsSpotDir[x_1254];
    let x_1258 : vec3<f32> = u_xlat9;
    u_xlat40 = dot(vec3<f32>(x_1256.x, x_1256.y, x_1256.z), x_1258);
    let x_1260 : f32 = u_xlat40;
    let x_1261 : i32 = u_xlati36;
    let x_1263 : f32 = x_1203.x_AdditionalLightsAttenuation[x_1261].z;
    let x_1265 : i32 = u_xlati36;
    let x_1267 : f32 = x_1203.x_AdditionalLightsAttenuation[x_1265].w;
    u_xlat40 = ((x_1260 * x_1263) + x_1267);
    let x_1269 : f32 = u_xlat40;
    u_xlat40 = clamp(x_1269, 0.0f, 1.0f);
    let x_1271 : f32 = u_xlat40;
    let x_1272 : f32 = u_xlat40;
    u_xlat40 = (x_1271 * x_1272);
    let x_1274 : f32 = u_xlat38;
    let x_1275 : f32 = u_xlat40;
    u_xlat38 = (x_1274 * x_1275);
    let x_1278 : f32 = u_xlat37;
    let x_1280 : i32 = u_xlati36;
    let x_1282 : vec4<f32> = x_1203.x_AdditionalLightsColor[x_1280];
    u_xlat10 = (vec3<f32>(x_1278, x_1278, x_1278) * vec3<f32>(x_1282.x, x_1282.y, x_1282.z));
    let x_1285 : vec4<f32> = u_xlat3;
    let x_1287 : vec3<f32> = u_xlat9;
    u_xlat36 = dot(vec3<f32>(x_1285.x, x_1285.y, x_1285.z), x_1287);
    let x_1289 : f32 = u_xlat36;
    u_xlat36 = clamp(x_1289, 0.0f, 1.0f);
    let x_1291 : f32 = u_xlat36;
    let x_1292 : f32 = u_xlat38;
    u_xlat36 = (x_1291 * x_1292);
    let x_1294 : f32 = u_xlat36;
    let x_1296 : vec3<f32> = u_xlat10;
    u_xlat10 = (vec3<f32>(x_1294, x_1294, x_1294) * x_1296);
    let x_1298 : vec4<f32> = u_xlat8;
    let x_1300 : f32 = u_xlat39;
    let x_1303 : vec3<f32> = u_xlat4;
    ...
    u_xlat36 = dot(vec3<f32>(x_1307.x, x_1307.y, x_1307.z), vec3<f32>(x_1309.x, x_1309.y, x_1309.z));
    let x_1312 : f32 = u_xlat36;
    u_xlat36 = max(x_1312, 1.17549435e-37f);
    let x_1314 : f32 = u_xlat36;
    u_xlat36 = inverseSqrt(x_1314);
    ...
    let x_1376 : vec3<f32> = ((vec3<f32>(x_1370.x, x_1370.y, x_1370.z) * x_1372) + vec3<f32>(x_1374.x, x_1374.y, x_1374.z));
    let x_1377 : vec4<f32> = u_xlat6;
    u_xlat6 = vec4<f32>(x_1376.x, x_1376.y, x_1376.z, x_1377.w);
  ...
  let x_1386 : vec3<f32> = ((x_1381 * vec3<f32>(x_1382, x_1382, x_1382)) + x_1385);
  ...
  let x_1396 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1395.x, x_1395.y, x_1395.z, x_1396.w);
  let x_1401 : u32 = x_44.x_RenderingLayerMaxInt;
  let x_1403 : f32 = x_281.unity_RenderingLayer.x;
  u_xlatu0 = (x_1401 & bitcast<u32>(x_1403));
  let x_1406 : u32 = u_xlatu0;
  u_xlat0.x = f32(x_1406);
  let x_1411 : f32 = u_xlat0.x;
  let x_1414 : f32 = x_44.x_RenderingLayerRcpMaxInt;
  SV_Target1.x = (x_1411 * x_1414);
  let x_1419 : f32 = SV_Target1.x;
  SV_Target1.x = clamp(x_1419, 0.0f, 1.0f);
  SV_Target0.w = 1.0f;
  let x_1423 : vec4<f32> = SV_Target1;
  SV_Target1 = vec4<f32>(x_1423.x, vec3<f32>(0.0f, 0.0f, 0.0f).x, vec3<f32>(0.0f, 0.0f, 0.0f).y, vec3<f32>(0.0f, 0.0f, 0.0f).z);
  return;
}
