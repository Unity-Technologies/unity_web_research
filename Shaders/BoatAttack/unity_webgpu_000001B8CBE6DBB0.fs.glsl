...
layout(set = 0, binding = 2) uniform mediump texture2D _MainLightCookieTexture;
layout(set = 0, binding = 3) uniform mediump texture2D _AdditionalLightsCookieAtlasTexture;
...
layout(set = 0, binding = 7) uniform mediump  sampler sampler_MainLightCookieTexture;
layout(set = 0, binding = 8) uniform mediump  sampler sampler_AdditionalLightsCookieAtlasTexture;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat19.xz = hlslcc_FragCoord.xy * vec2(_DitheringTextureInvSize);
    u_xlat19.x = texture(sampler2D(_DitheringTexture, sampler_DitheringTexture), u_xlat19.xz, _GlobalMipBias.x).w;
...
;
    ...
    u_xlati19 = int(u_xlatu19) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD1.yyy * _MainLightWorldToShadow[(u_xlati19 + 1) / 4][(u_xlati19 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati19 / 4][u_xlati19 % 4].xyz * vs_TEXCOORD1.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati19 + 2) / 4][(u_xlati19 + 2) % 4].xyz * vs_TEXCOORD1.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati19 + 3) / 4][(u_xlati19 + 3) % 4].xyz;
    u_xlat2.w = 1.0;
    ...
    u_xlat19.x = u_xlat2.y * u_xlat2.y;
    u_xlat19.x = u_xlat2.x * u_xlat2.x + (-u_xlat19.x);
    u_xlat5.xyz = unity_SHC.xyz * u_xlat19.xxx + u_xlat6.xyz;
    ...
    if(u_xlatb19){
        ...
        if(u_xlatb19){
            ...
            u_xlat19.x = dot(u_xlat6, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb57){
                ...
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec5, 0.0);
                u_xlat59 = u_xlat59 * u_xlat12.y;
                u_xlat1.x = u_xlat12.x * u_xlat1.x + u_xlat59;
                vec3 txVec6 = vec3(u_xlat43.xy,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec6, 0.0);
                u_xlat1.x = u_xlat12.z * u_xlat59 + u_xlat1.x;
                vec3 txVec7 = vec3(u_xlat8.xy,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec7, 0.0);
                u_xlat1.x = u_xlat12.w * u_xlat59 + u_xlat1.x;
                vec3 txVec8 = vec3(u_xlat10.xy,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec8, 0.0);
                u_xlat1.x = u_xlat13.x * u_xlat59 + u_xlat1.x;
                vec3 txVec9 = vec3(u_xlat10.zw,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec9, 0.0);
                u_xlat1.x = u_xlat13.y * u_xlat59 + u_xlat1.x;
                vec3 txVec10 = vec3(u_xlat8.zw,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec10, 0.0);
                u_xlat1.x = u_xlat13.z * u_xlat59 + u_xlat1.x;
                vec3 txVec11 = vec3(u_xlat7.xy,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec11, 0.0);
                u_xlat1.x = u_xlat13.w * u_xlat59 + u_xlat1.x;
                vec3 txVec12 = vec3(u_xlat7.zw,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec12, 0.0);
                u_xlat19.x = u_xlat57 * u_xlat59 + u_xlat1.x;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat43.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat57 = u_xlat16.x * u_xlat57 + u_xlat1.x;
                ...
                u_xlat57 = u_xlat16.z * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat16.w * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat17.x * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat17.y * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat17.z * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat17.w * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat18.x * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat18.y * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat18.z * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat18.w * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat6.x * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat6.y * u_xlat1.x + u_xlat57;
                ...
                u_xlat57 = u_xlat6.z * u_xlat1.x + u_xlat57;
                ...
                u_xlat19.x = u_xlat6.w * u_xlat1.x + u_xlat57;
            }
        }
    } else {
        vec3 txVec29 = vec3(u_xlat3.xy,u_xlat3.z);
        u_xlat19.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat57 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat19.x = u_xlat19.x * _MainLightShadowParams.x + u_xlat57;
    u_xlatb57 = 0.0>=u_xlat3.z;
    u_xlatb1 = u_xlat3.z>=1.0;
    u_xlatb57 = u_xlatb57 || u_xlatb1;
    u_xlat19.x = (u_xlatb57) ? 1.0 : u_xlat19.x;
    ...
    u_xlat19.x = u_xlat57 * u_xlat1.x + u_xlat19.x;
    ...
    if(u_xlatb57){
        ...
        u_xlat57 = (u_xlatb5.y) ? u_xlat3.w : u_xlat3.x;
        u_xlat3.xyz = (u_xlatb5.x) ? u_xlat3.xyz : vec3(u_xlat57);
    } else {
        u_xlat3.x = float(1.0);
        u_xlat3.y = float(1.0);
        u_xlat3.z = float(1.0);
    ...
    u_xlat19.x = u_xlat19.x * unity_LightData.z;
    u_xlat3.xyz = u_xlat19.xxx * u_xlat3.xyz;
    u_xlat19.x = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat19.x = clamp(u_xlat19.x, 0.0, 1.0);
    u_xlat3.xyz = u_xlat19.xxx * u_xlat3.xyz;
    u_xlat3.xyz = u_xlat1.yzw * u_xlat3.xyz;
    u_xlat3.xyz = u_xlat0.xxx * u_xlat3.xyz;
    u_xlat19.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    ...
    u_xlat6.y = float(0.0);
    u_xlat6.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu19 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat59 = u_xlat59 * _AdditionalLightsAttenuation[int(u_xlatu1)].x;
        u_xlat59 = (-u_xlat59) * u_xlat59 + 1.0;
        u_xlat59 = max(u_xlat59, 0.0);
        u_xlat59 = u_xlat59 * u_xlat59;
        u_xlat59 = u_xlat59 * u_xlat60;
        u_xlat60 = dot(_AdditionalLightsSpotDir[int(u_xlatu1)].xyz, u_xlat7.xyz);
        u_xlat60 = u_xlat60 * _AdditionalLightsAttenuation[int(u_xlatu1)].z + _AdditionalLightsAttenuation[int(u_xlatu1)].w;
        u_xlat60 = clamp(u_xlat60, 0.0, 1.0);
        u_xlat60 = u_xlat60 * u_xlat60;
        u_xlat59 = u_xlat59 * u_xlat60;
        u_xlatu60 = u_xlatu1 >> (5u & uint(0x1F));
        u_xlati61 = 1 << (int(u_xlatu1) & int(0x1F));
        u_xlati60 = int(uint(u_xlati61) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu60)]));
        if(u_xlati60 != 0) {
            u_xlati60 = int(_AdditionalLightsLightTypes[int(u_xlatu1)]);
            u_xlati61 = (u_xlati60 != 0) ? 0 : 1;
            u_xlati43 = int(u_xlatu1) << (2 & int(0x1F));
            if(u_xlati61 != 0) {
                u_xlat8.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati43 + 1) / 4][(u_xlati43 + 1) % 4].xyw;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[u_xlati43 / 4][u_xlati43 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat8.xyz;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[(u_xlati43 + 2) / 4][(u_xlati43 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat8.xyz;
                u_xlat8.xyz = u_xlat8.xyz + _AdditionalLightsWorldToLights[(u_xlati43 + 3) / 4][(u_xlati43 + 3) % 4].xyw;
                ...
                if(u_xlati60 != 0) {
                    u_xlat46.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati43 + 1) / 4][(u_xlati43 + 1) % 4].xy;
                    u_xlat46.xy = _AdditionalLightsWorldToLights[u_xlati43 / 4][u_xlati43 % 4].xy * vs_TEXCOORD1.xx + u_xlat46.xy;
                    u_xlat46.xy = _AdditionalLightsWorldToLights[(u_xlati43 + 2) / 4][(u_xlati43 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat46.xy;
                    u_xlat46.xy = u_xlat46.xy + _AdditionalLightsWorldToLights[(u_xlati43 + 3) / 4][(u_xlati43 + 3) % 4].xy;
                    u_xlat46.xy = u_xlat46.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat46.xy = fract(u_xlat46.xy);
                    u_xlat8.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu1)].xy * u_xlat46.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu1)].zw;
                } else {
                    u_xlat9 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati43 + 1) / 4][(u_xlati43 + 1) % 4];
                    u_xlat9 = _AdditionalLightsWorldToLights[u_xlati43 / 4][u_xlati43 % 4] * vs_TEXCOORD1.xxxx + u_xlat9;
                    u_xlat9 = _AdditionalLightsWorldToLights[(u_xlati43 + 2) / 4][(u_xlati43 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat9;
                    u_xlat9 = u_xlat9 + _AdditionalLightsWorldToLights[(u_xlati43 + 3) / 4][(u_xlati43 + 3) % 4];
                    u_xlat9.xyz = u_xlat9.xyz / u_xlat9.www;
                    u_xlat60 = dot(u_xlat9.xyz, u_xlat9.xyz);
                    u_xlat60 = inversesqrt(u_xlat60);
                    u_xlat9.xyz = vec3(u_xlat60) * u_xlat9.xyz;
                    u_xlat60 = dot(abs(u_xlat9.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat60 = max(u_xlat60, 9.99999997e-07);
                    u_xlat60 = float(1.0) / float(u_xlat60);
                    u_xlat10.xyz = vec3(u_xlat60) * u_xlat9.zxy;
                    ...
                    u_xlat43.xy = u_xlat9.xy * vec2(u_xlat60) + u_xlat43.xy;
                    u_xlat43.xy = u_xlat43.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat43.xy = clamp(u_xlat43.xy, 0.0, 1.0);
                    u_xlat8.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu1)].xy * u_xlat43.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu1)].zw;
                }
            }
            ...
            u_xlat8.xyz = (u_xlatb5.x) ? u_xlat8.xyz : vec3(u_xlat60);
        } else {
            u_xlat8.x = float(1.0);
            u_xlat8.y = float(1.0);
            u_xlat8.z = float(1.0);
