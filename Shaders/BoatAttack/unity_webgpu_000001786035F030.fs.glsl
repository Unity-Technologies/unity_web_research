...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat32.x = dot((-u_xlat2.xyz), u_xlat1.xyz);
    u_xlat32.x = u_xlat32.x + u_xlat32.x;
    u_xlat8.xyz = u_xlat1.xyz * (-u_xlat32.xxx) + (-u_xlat2.xyz);
    u_xlat32.x = dot(u_xlat1.xyz, u_xlat2.xyz);
    u_xlat32.x = clamp(u_xlat32.x, 0.0, 1.0);
    ...
    u_xlat9.xyz = u_xlat32.xxx * u_xlat9.xyz + u_xlat5.xyz;
    ...
    u_xlat4.xzw = vec3(u_xlat28) * u_xlat7.xyz;
    ...
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat14) + u_xlat4.xzw;
