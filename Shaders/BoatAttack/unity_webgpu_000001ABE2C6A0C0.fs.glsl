...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat26 = u_xlat67 * u_xlat67;
    u_xlat66 = u_xlat66 + 1.0;
    u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
    u_xlat68 = u_xlat67 * 4.0 + 2.0;
    ...
    u_xlat47 = _AmbientOcclusionParam.w * u_xlat47 + 1.0;
    ...
    if(u_xlatb6){
        ...
        if(u_xlatb6){
            ...
            if(u_xlatb27.x){
                ...
                u_xlat6.x = u_xlat27.x * u_xlat69 + u_xlat48;
            } else {
                u_xlat27.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat27.xy = floor(u_xlat27.xy);
                u_xlat7.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat27.xy);
        ...
        u_xlat6.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat27.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat6.x = u_xlat6.x * _MainLightShadowParams.x + u_xlat27.x;
    ...
    u_xlat6.x = u_xlat27.x * u_xlat48 + u_xlat6.x;
    ...
    u_xlat27.xyz = vec3(u_xlat47) * u_xlat27.xyz;
    ...
    u_xlat70 = u_xlat70 * u_xlat70;
    u_xlat8.x = (-u_xlat65) * 0.699999988 + 1.70000005;
    u_xlat65 = u_xlat65 * u_xlat8.x;
    u_xlat65 = u_xlat65 * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat65);
    ...
    u_xlat7.xyz = u_xlat8.xyz * vec3(u_xlat65);
    u_xlat8.xy = vec2(u_xlat67) * vec2(u_xlat67) + vec2(-1.0, 1.0);
    u_xlat65 = float(1.0) / u_xlat8.y;
    u_xlat29.xyz = (-u_xlat0.xyz) + vec3(u_xlat66);
    ...
    u_xlat65 = u_xlat6.x * unity_LightData.z;
    u_xlat66 = dot(u_xlat3.xyz, _MainLightPosition.xyz);
    u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
    u_xlat65 = u_xlat65 * u_xlat66;
    u_xlat6.xyz = vec3(u_xlat65) * u_xlat27.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu65 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu67)].www + _AdditionalLightsPosition[int(u_xlatu67)].xyz;
        ...
        u_xlati72 = 1 << (int(u_xlatu67) & int(0x1F));
        u_xlati70 = int(uint(u_xlati72) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu70)]));
        if(u_xlati70 != 0) {
            u_xlati70 = int(_AdditionalLightsLightTypes[int(u_xlatu67)]);
            u_xlati72 = (u_xlati70 != 0) ? 0 : 1;
        ...
        u_xlat9.xyz = u_xlat9.xyz * u_xlat49.xxx + u_xlat2.xyz;
        ...
        u_xlat67 = u_xlat67 * u_xlat8.x + 1.00001001;
        u_xlat69 = u_xlat69 * u_xlat69;
        u_xlat67 = u_xlat67 * u_xlat67;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat67) + u_xlat22.xyz;
