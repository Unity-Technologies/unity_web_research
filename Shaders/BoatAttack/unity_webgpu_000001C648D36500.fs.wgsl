...
@group(1) @binding(1) var<uniform> x_815 : AdditionalLights;
...
fn main_1() {
  ...
  loop {
    ...
    let x_778 : u32 = u_xlatu3;
    let x_781 : vec4<f32> = x_122.unity_LightIndices[bitcast<i32>(x_778)];
    let x_791 : i32 = u_xlati40;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_796 : vec4<u32> = indexable[x_791];
    u_xlat3.x = dot(x_781, bitcast<vec4<f32>>(x_796));
    let x_802 : f32 = u_xlat3.x;
    u_xlati3 = i32(x_802);
    let x_804 : vec3<f32> = vs_INTERP0;
    let x_816 : i32 = u_xlati3;
    let x_818 : vec4<f32> = x_815.x_AdditionalLightsPosition[x_816];
    let x_821 : i32 = u_xlati3;
    let x_823 : vec4<f32> = x_815.x_AdditionalLightsPosition[x_821];
    u_xlat21 = ((-(x_804) * vec3<f32>(x_818.w, x_818.w, x_818.w)) + vec3<f32>(x_823.x, x_823.y, x_823.z));
    let x_826 : vec3<f32> = u_xlat21;
    let x_827 : vec3<f32> = u_xlat21;
    u_xlat40 = dot(x_826, x_827);
    let x_829 : f32 = u_xlat40;
    u_xlat40 = max(x_829, 6.10351562e-05f);
    let x_832 : f32 = u_xlat40;
    u_xlat42 = inverseSqrt(x_832);
    let x_835 : f32 = u_xlat42;
    let x_837 : vec3<f32> = u_xlat21;
    u_xlat10 = (vec3<f32>(x_835, x_835, x_835) * x_837);
    let x_839 : f32 = u_xlat40;
    u_xlat43 = (1.0f / x_839);
    let x_841 : f32 = u_xlat40;
    let x_842 : i32 = u_xlati3;
    let x_844 : f32 = x_815.x_AdditionalLightsAttenuation[x_842].x;
    u_xlat40 = (x_841 * x_844);
    let x_846 : f32 = u_xlat40;
    let x_848 : f32 = u_xlat40;
    u_xlat40 = ((-(x_846) * x_848) + 1.0f);
    let x_851 : f32 = u_xlat40;
    u_xlat40 = max(x_851, 0.0f);
    let x_853 : f32 = u_xlat40;
    let x_854 : f32 = u_xlat40;
    u_xlat40 = (x_853 * x_854);
    let x_856 : f32 = u_xlat40;
    let x_857 : f32 = u_xlat43;
    u_xlat40 = (x_856 * x_857);
    let x_859 : i32 = u_xlati3;
    let x_861 : vec4<f32> = x_815.x_AdditionalLightsSpotDir[x_859];
    let x_863 : vec3<f32> = u_xlat10;
    u_xlat43 = dot(vec3<f32>(x_861.x, x_861.y, x_861.z), x_863);
    let x_865 : f32 = u_xlat43;
    let x_866 : i32 = u_xlati3;
    let x_868 : f32 = x_815.x_AdditionalLightsAttenuation[x_866].z;
    let x_870 : i32 = u_xlati3;
    let x_872 : f32 = x_815.x_AdditionalLightsAttenuation[x_870].w;
    u_xlat43 = ((x_865 * x_868) + x_872);
    let x_874 : f32 = u_xlat43;
    u_xlat43 = clamp(x_874, 0.0f, 1.0f);
    let x_876 : f32 = u_xlat43;
    let x_877 : f32 = u_xlat43;
    u_xlat43 = (x_876 * x_877);
    let x_879 : f32 = u_xlat40;
    let x_880 : f32 = u_xlat43;
    u_xlat40 = (x_879 * x_880);
    let x_883 : f32 = u_xlat41;
    let x_885 : i32 = u_xlati3;
    let x_887 : vec4<f32> = x_815.x_AdditionalLightsColor[x_885];
    u_xlat11 = (vec3<f32>(x_883, x_883, x_883) * vec3<f32>(x_887.x, x_887.y, x_887.z));
    let x_890 : vec4<f32> = u_xlat1;
    let x_892 : vec3<f32> = u_xlat10;
    u_xlat3.x = dot(vec3<f32>(x_890.x, x_890.y, x_890.w), x_892);
    let x_896 : f32 = u_xlat3.x;
    u_xlat3.x = clamp(x_896, 0.0f, 1.0f);
    let x_900 : f32 = u_xlat3.x;
    let x_901 : f32 = u_xlat40;
    u_xlat3.x = (x_900 * x_901);
    let x_904 : vec3<f32> = u_xlat3;
    let x_906 : vec3<f32> = u_xlat11;
    u_xlat11 = (vec3<f32>(x_904.x, x_904.x, x_904.x) * x_906);
    let x_908 : vec3<f32> = u_xlat21;
    let x_909 : f32 = u_xlat42;
    let x_912 : vec3<f32> = u_xlat5;
    u_xlat21 = ((x_908 * vec3<f32>(x_909, x_909, x_909)) + x_912);
    let x_914 : vec3<f32> = u_xlat21;
    let x_915 : vec3<f32> = u_xlat21;
    u_xlat3.x = dot(x_914, x_915);
    let x_919 : f32 = u_xlat3.x;
    u_xlat3.x = max(x_919, 1.17549435e-37f);
    let x_923 : f32 = u_xlat3.x;
    u_xlat3.x = inverseSqrt(x_923);
    let x_926 : vec3<f32> = u_xlat3;
    let x_928 : vec3<f32> = u_xlat21;
    u_xlat21 = (vec3<f32>(x_926.x, x_926.x, x_926.x) * x_928);
    let x_930 : vec4<f32> = u_xlat1;
    let x_932 : vec3<f32> = u_xlat21;
    u_xlat3.x = dot(vec3<f32>(x_930.x, x_930.y, x_930.w), x_932);
    let x_936 : f32 = u_xlat3.x;
    u_xlat3.x = clamp(x_936, 0.0f, 1.0f);
    let x_939 : vec3<f32> = u_xlat10;
    let x_940 : vec3<f32> = u_xlat21;
    u_xlat40 = dot(x_939, x_940);
    let x_942 : f32 = u_xlat40;
    u_xlat40 = clamp(x_942, 0.0f, 1.0f);
    let x_945 : f32 = u_xlat3.x;
    let x_947 : f32 = u_xlat3.x;
    u_xlat3.x = (x_945 * x_947);
    let x_951 : f32 = u_xlat3.x;
    let x_953 : f32 = u_xlat9.x;
    u_xlat3.x = ((x_951 * x_953) + 1.000010014f);
    let x_957 : f32 = u_xlat40;
    let x_958 : f32 = u_xlat40;
    u_xlat40 = (x_957 * x_958);
    let x_961 : f32 = u_xlat3.x;
    let x_963 : f32 = u_xlat3.x;
    u_xlat3.x = (x_961 * x_963);
    let x_966 : f32 = u_xlat40;
    u_xlat40 = max(x_966, 0.100000001f);
    let x_969 : f32 = u_xlat3.x;
    let x_970 : f32 = u_xlat40;
    u_xlat3.x = (x_969 * x_970);
    let x_973 : f32 = u_xlat39;
    let x_975 : f32 = u_xlat3.x;
    u_xlat3.x = (x_973 * x_975);
    let x_978 : f32 = u_xlat15;
    let x_980 : f32 = u_xlat3.x;
    u_xlat3.x = (x_978 / x_980);
    let x_983 : vec3<f32> = u_xlat0;
    let x_984 : vec3<f32> = u_xlat3;
    let x_987 : vec3<f32> = u_xlat7;
    u_xlat21 = ((x_983 * vec3<f32>(x_984.x, x_984.x, x_984.x)) + x_987);
    let x_989 : vec3<f32> = u_xlat21;
    let x_990 : vec3<f32> = u_xlat11;
    let x_992 : vec4<f32> = u_xlat8;
    let x_994 : vec3<f32> = ((x_989 * x_990) + vec3<f32>(x_992.x, x_992.y, x_992.z));
    let x_995 : vec4<f32> = u_xlat8;
    u_xlat8 = vec4<f32>(x_994.x, x_994.y, x_994.z, x_995.w);

    continuing {
      let x_997 : u32 = u_xlatu_loop_1;
      u_xlatu_loop_1 = (x_997 + bitcast<u32>(1i));
    }
  }
  let x_999 : vec3<f32> = u_xlat4;
  let x_1000 : f32 = u_xlat27;
  let x_1003 : vec3<f32> = u_xlat6;
  u_xlat0 = ((x_999 * vec3<f32>(x_1000, x_1000, x_1000)) + x_1003);
  let x_1005 : vec4<f32> = u_xlat8;
  let x_1007 : vec3<f32> = u_xlat0;
  u_xlat0 = (vec3<f32>(x_1005.x, x_1005.y, x_1005.z) + x_1007);
  let x_1011 : vec3<f32> = u_xlat2;
  let x_1012 : f32 = u_xlat25;
  let x_1015 : vec3<f32> = u_xlat0;
  let x_1016 : vec3<f32> = ((x_1011 * vec3<f32>(x_1012, x_1012, x_1012)) + x_1015);
