...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat7.xyz = (-vs_TEXCOORD2.xyz) * _AdditionalLightsPosition[int(u_xlatu56)].www + _AdditionalLightsPosition[int(u_xlatu56)].xyz;
        ...
        if(u_xlati58 != 0) {
            ...
            if(u_xlati41 != 0) {
                u_xlat8.xyz = vs_TEXCOORD2.yyy * _AdditionalLightsWorldToLights[(u_xlati59 + 1) / 4][(u_xlati59 + 1) % 4].xyw;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[u_xlati59 / 4][u_xlati59 % 4].xyw * vs_TEXCOORD2.xxx + u_xlat8.xyz;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[(u_xlati59 + 2) / 4][(u_xlati59 + 2) % 4].xyw * vs_TEXCOORD2.zzz + u_xlat8.xyz;
                ...
                if(u_xlati58 != 0) {
                    u_xlat44.xy = vs_TEXCOORD2.yy * _AdditionalLightsWorldToLights[(u_xlati59 + 1) / 4][(u_xlati59 + 1) % 4].xy;
                    u_xlat44.xy = _AdditionalLightsWorldToLights[u_xlati59 / 4][u_xlati59 % 4].xy * vs_TEXCOORD2.xx + u_xlat44.xy;
                    u_xlat44.xy = _AdditionalLightsWorldToLights[(u_xlati59 + 2) / 4][(u_xlati59 + 2) % 4].xy * vs_TEXCOORD2.zz + u_xlat44.xy;
                    ...
                    u_xlat9 = vs_TEXCOORD2.yyyy * _AdditionalLightsWorldToLights[(u_xlati59 + 1) / 4][(u_xlati59 + 1) % 4];
                    u_xlat9 = _AdditionalLightsWorldToLights[u_xlati59 / 4][u_xlati59 % 4] * vs_TEXCOORD2.xxxx + u_xlat9;
                    u_xlat9 = _AdditionalLightsWorldToLights[(u_xlati59 + 2) / 4][(u_xlati59 + 2) % 4] * vs_TEXCOORD2.zzzz + u_xlat9;
