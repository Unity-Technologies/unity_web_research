...
fn main_1() {
  ...
  loop {
    ...
    let x_1007 : u32 = u_xlatu2;
    let x_1010 : vec4<f32> = x_359.unity_LightIndices[bitcast<i32>(x_1007)];
    let x_1020 : i32 = u_xlati36;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1025 : vec4<u32> = indexable[x_1020];
    u_xlat2.x = dot(x_1010, bitcast<vec4<f32>>(x_1025));
    let x_1031 : f32 = u_xlat2.x;
    u_xlati2 = i32(x_1031);
    let x_1033 : vec3<f32> = vs_INTERP0;
    let x_1045 : i32 = u_xlati2;
    let x_1047 : vec4<f32> = x_1044.x_AdditionalLightsPosition[x_1045];
    let x_1050 : i32 = u_xlati2;
    let x_1052 : vec4<f32> = x_1044.x_AdditionalLightsPosition[x_1050];
    u_xlat19 = ((-(x_1033) * vec3<f32>(x_1047.w, x_1047.w, x_1047.w)) + vec3<f32>(x_1052.x, x_1052.y, x_1052.z));
    let x_1055 : vec3<f32> = u_xlat19;
    let x_1056 : vec3<f32> = u_xlat19;
    u_xlat36 = dot(x_1055, x_1056);
    let x_1058 : f32 = u_xlat36;
    u_xlat36 = max(x_1058, 6.10351562e-05f);
    let x_1061 : f32 = u_xlat36;
    u_xlat38 = inverseSqrt(x_1061);
    let x_1064 : f32 = u_xlat38;
    let x_1066 : vec3<f32> = u_xlat19;
    u_xlat9 = (vec3<f32>(x_1064, x_1064, x_1064) * x_1066);
    let x_1068 : f32 = u_xlat36;
    u_xlat39 = (1.0f / x_1068);
    let x_1070 : f32 = u_xlat36;
    let x_1071 : i32 = u_xlati2;
    let x_1073 : f32 = x_1044.x_AdditionalLightsAttenuation[x_1071].x;
    u_xlat36 = (x_1070 * x_1073);
    let x_1075 : f32 = u_xlat36;
    let x_1077 : f32 = u_xlat36;
    u_xlat36 = ((-(x_1075) * x_1077) + 1.0f);
    let x_1080 : f32 = u_xlat36;
    u_xlat36 = max(x_1080, 0.0f);
    ...
    let x_1090 : vec4<f32> = x_1044.x_AdditionalLightsSpotDir[x_1088];
    let x_1092 : vec3<f32> = u_xlat9;
    u_xlat39 = dot(vec3<f32>(x_1090.x, x_1090.y, x_1090.z), x_1092);
    let x_1094 : f32 = u_xlat39;
    let x_1095 : i32 = u_xlati2;
    let x_1097 : f32 = x_1044.x_AdditionalLightsAttenuation[x_1095].z;
    let x_1099 : i32 = u_xlati2;
    let x_1101 : f32 = x_1044.x_AdditionalLightsAttenuation[x_1099].w;
    u_xlat39 = ((x_1094 * x_1097) + x_1101);
    let x_1103 : f32 = u_xlat39;
    u_xlat39 = clamp(x_1103, 0.0f, 1.0f);
    let x_1105 : f32 = u_xlat39;
    let x_1106 : f32 = u_xlat39;
    u_xlat39 = (x_1105 * x_1106);
    let x_1108 : f32 = u_xlat36;
    let x_1109 : f32 = u_xlat39;
    u_xlat36 = (x_1108 * x_1109);
    let x_1112 : f32 = u_xlat37;
    let x_1114 : i32 = u_xlati2;
    let x_1116 : vec4<f32> = x_1044.x_AdditionalLightsColor[x_1114];
    ...
    u_xlat2.x = dot(vec3<f32>(x_1119.x, x_1119.y, x_1119.z), x_1121);
    let x_1125 : f32 = u_xlat2.x;
    u_xlat2.x = clamp(x_1125, 0.0f, 1.0f);
    let x_1129 : f32 = u_xlat2.x;
    let x_1130 : f32 = u_xlat36;
    u_xlat2.x = (x_1129 * x_1130);
    let x_1133 : vec4<f32> = u_xlat2;
    let x_1135 : vec3<f32> = u_xlat10;
    u_xlat10 = (vec3<f32>(x_1133.x, x_1133.x, x_1133.x) * x_1135);
    let x_1137 : vec3<f32> = u_xlat19;
    let x_1138 : f32 = u_xlat38;
    let x_1141 : vec3<f32> = u_xlat4;
    u_xlat19 = ((x_1137 * vec3<f32>(x_1138, x_1138, x_1138)) + x_1141);
    let x_1143 : vec3<f32> = u_xlat19;
    let x_1144 : vec3<f32> = u_xlat19;
    u_xlat2.x = dot(x_1143, x_1144);
    let x_1148 : f32 = u_xlat2.x;
    u_xlat2.x = max(x_1148, 1.17549435e-37f);
    let x_1152 : f32 = u_xlat2.x;
    u_xlat2.x = inverseSqrt(x_1152);
    let x_1155 : vec4<f32> = u_xlat2;
    let x_1157 : vec3<f32> = u_xlat19;
    u_xlat19 = (vec3<f32>(x_1155.x, x_1155.x, x_1155.x) * x_1157);
    let x_1159 : vec4<f32> = u_xlat1;
    let x_1161 : vec3<f32> = u_xlat19;
    u_xlat2.x = dot(vec3<f32>(x_1159.x, x_1159.y, x_1159.z), x_1161);
    let x_1165 : f32 = u_xlat2.x;
    u_xlat2.x = clamp(x_1165, 0.0f, 1.0f);
    let x_1168 : vec3<f32> = u_xlat9;
    let x_1169 : vec3<f32> = u_xlat19;
    u_xlat36 = dot(x_1168, x_1169);
    let x_1171 : f32 = u_xlat36;
    u_xlat36 = clamp(x_1171, 0.0f, 1.0f);
    let x_1174 : f32 = u_xlat2.x;
    let x_1176 : f32 = u_xlat2.x;
    u_xlat2.x = (x_1174 * x_1176);
    let x_1180 : f32 = u_xlat2.x;
    let x_1182 : f32 = u_xlat8.x;
    u_xlat2.x = ((x_1180 * x_1182) + 1.000010014f);
    ...
    u_xlat36 = max(x_1195, 0.100000001f);
    let x_1198 : f32 = u_xlat2.x;
    let x_1199 : f32 = u_xlat36;
    u_xlat2.x = (x_1198 * x_1199);
    let x_1202 : f32 = u_xlat35;
    let x_1204 : f32 = u_xlat2.x;
    u_xlat2.x = (x_1202 * x_1204);
    let x_1207 : f32 = u_xlat13;
    let x_1209 : f32 = u_xlat2.x;
    u_xlat2.x = (x_1207 / x_1209);
    let x_1212 : vec4<f32> = u_xlat0;
    let x_1214 : vec4<f32> = u_xlat2;
    let x_1217 : vec3<f32> = u_xlat6;
    u_xlat19 = ((vec3<f32>(x_1212.x, x_1212.y, x_1212.z) * vec3<f32>(x_1214.x, x_1214.x, x_1214.x)) + x_1217);
    let x_1219 : vec3<f32> = u_xlat19;
    let x_1220 : vec3<f32> = u_xlat10;
    let x_1222 : vec4<f32> = u_xlat7;
    let x_1224 : vec3<f32> = ((x_1219 * x_1220) + vec3<f32>(x_1222.x, x_1222.y, x_1222.z));
    let x_1225 : vec4<f32> = u_xlat7;
    u_xlat7 = vec4<f32>(x_1224.x, x_1224.y, x_1224.z, x_1225.w);

    continuing {
      let x_1227 : u32 = u_xlatu_loop_1;
      u_xlatu_loop_1 = (x_1227 + bitcast<u32>(1i));
    }
  }
  let x_1229 : vec4<f32> = u_xlat3;
  let x_1231 : f32 = u_xlat24;
