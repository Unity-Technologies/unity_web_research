...
;
    ...
    u_xlat32 = u_xlat4.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat4.z = (-u_xlat32) + 1.0;
    u_xlat32 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat4.xz, _GlobalMipBias.x).x;
    ...
    u_xlat12.xyz = vec3(u_xlat32) * u_xlat3.xyz;
    ...
    u_xlat10.xyz = u_xlat12.xyz * u_xlat0.yzw + u_xlat3.xyz;
