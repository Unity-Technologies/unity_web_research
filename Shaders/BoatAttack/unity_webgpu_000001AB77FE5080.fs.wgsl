...
fn main_1() {
  ...
  let x_1389 : vec3<f32> = (vec3<f32>(x_1387.x, x_1387.y, x_1387.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1400 : vec3<f32> = (vec3<f32>(x_1398.x, x_1398.y, x_1398.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1411 : vec3<f32> = ((vec3<f32>(x_1408.x, x_1408.y, x_1408.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1412 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1411.x, x_1411.y, x_1411.z, x_1412.w);
  let x_1414 : vec4<f32> = u_xlat0;
  let x_1416 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1414.x, x_1414.y, x_1414.z, x_1414.x));
  ...
  u_xlat0.z = x_1452;
  let x_1454 : vec2<f32> = vs_TEXCOORD0;
  let x_1457 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1461 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1463 : vec2<f32> = ((x_1454 * vec2<f32>(x_1457.x, x_1457.y)) + vec2<f32>(x_1461.z, x_1461.w));
  let x_1464 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1463.x, x_1463.y, x_1464.z, x_1464.w);
  let x_1471 : vec4<f32> = u_xlat1;
  let x_1474 : f32 = x_38.x_GlobalMipBias.x;
  let x_1475 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1471.x, x_1471.y), x_1474);
  u_xlat15 = x_1475.w;
  let x_1477 : f32 = u_xlat15;
  u_xlat15 = ((x_1477 * 2.0f) + -1.0f);
  let x_1480 : f32 = u_xlat15;
  u_xlatb1 = (x_1480 >= 0.0f);
  let x_1482 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1482);
  let x_1485 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1485)) + 1.0f);
  let x_1489 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1489);
  let x_1491 : f32 = u_xlat15;
  u_xlat15 = (-(x_1491) + 1.0f);
  let x_1494 : f32 = u_xlat15;
  let x_1496 : f32 = u_xlat1.x;
  u_xlat15 = (x_1494 * x_1496);
  let x_1498 : vec4<f32> = u_xlat0;
  let x_1500 : vec3<f32> = (vec3<f32>(x_1498.x, x_1498.y, x_1498.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1511 : vec3<f32> = (vec3<f32>(x_1509.x, x_1509.y, x_1509.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1522 : vec3<f32> = ((vec3<f32>(x_1519.x, x_1519.y, x_1519.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1523 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1522.x, x_1522.y, x_1522.z, x_1523.w);
  let x_1525 : vec4<f32> = u_xlat0;
  let x_1527 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1525.x, x_1525.y, x_1525.z, x_1525.x));
  u_xlatb0 = vec3<bool>(x_1527.x, x_1527.y, x_1527.z);
  let x_1530 : bool = u_xlatb0.x;
  if (x_1530) {
  ...
  u_xlat0.z = x_1563;
  let x_1565 : f32 = u_xlat15;
  let x_1570 : vec4<f32> = u_xlat0;
  let x_1572 : vec3<f32> = ((vec3<f32>(x_1565, x_1565, x_1565) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1570.x, x_1570.y, x_1570.z));
  let x_1573 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1572.x, x_1572.y, x_1572.z, x_1573.w);
  let x_1575 : vec4<f32> = u_xlat0;
  let x_1577 : vec3<f32> = (vec3<f32>(x_1575.x, x_1575.y, x_1575.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1578 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1577.x, x_1577.y, x_1577.z, x_1578.w);
  let x_1580 : vec4<f32> = u_xlat0;
  let x_1582 : vec3<f32> = (vec3<f32>(x_1580.x, x_1580.y, x_1580.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1583 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1582.x, x_1582.y, x_1582.z, x_1583.w);
  let x_1585 : vec4<f32> = u_xlat2;
  let x_1587 : vec3<f32> = (vec3<f32>(x_1585.x, x_1585.y, x_1585.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1588 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1587.x, x_1587.y, x_1587.z, x_1588.w);
  let x_1590 : vec4<f32> = u_xlat2;
  let x_1593 : vec3<f32> = log2(abs(vec3<f32>(x_1590.x, x_1590.y, x_1590.z)));
  let x_1594 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1593.x, x_1593.y, x_1593.z, x_1594.w);
  let x_1596 : vec4<f32> = u_xlat2;
  let x_1598 : vec3<f32> = (vec3<f32>(x_1596.x, x_1596.y, x_1596.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1599 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1598.x, x_1598.y, x_1598.z, x_1599.w);
  let x_1601 : vec4<f32> = u_xlat2;
  let x_1603 : vec3<f32> = exp2(vec3<f32>(x_1601.x, x_1601.y, x_1601.z));
  let x_1604 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1603.x, x_1603.y, x_1603.z, x_1604.w);
  let x_1606 : vec4<f32> = u_xlat0;
  let x_1608 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1606.x, x_1606.y, x_1606.z, x_1606.x));
  u_xlatb0 = vec3<bool>(x_1608.x, x_1608.y, x_1608.z);
  let x_1611 : bool = u_xlatb0.x;
  if (x_1611) {
    let x_1616 : f32 = u_xlat1.x;
    x_1612 = x_1616;
  } else {
    let x_1619 : f32 = u_xlat2.x;
    x_1612 = x_1619;
  }
  let x_1620 : f32 = x_1612;
  u_xlat0.x = x_1620;
  let x_1623 : bool = u_xlatb0.y;
  if (x_1623) {
    let x_1628 : f32 = u_xlat1.y;
    x_1624 = x_1628;
  } else {
    let x_1631 : f32 = u_xlat2.y;
    x_1624 = x_1631;
  }
  let x_1632 : f32 = x_1624;
  u_xlat0.y = x_1632;
  let x_1635 : bool = u_xlatb0.z;
  if (x_1635) {
    let x_1640 : f32 = u_xlat1.z;
    x_1636 = x_1640;
  } else {
  ...
  let x_1650 : vec3<f32> = max(vec3<f32>(x_1648.x, x_1648.y, x_1648.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1651 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1650.x, x_1650.y, x_1650.z, x_1651.w);
  SV_Target0.w = 1.0f;
  return;
}
