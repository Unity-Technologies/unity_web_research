...
;
    ...
    u_xlat19 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat19 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat19;
    u_xlat19 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat19;
    u_xlat19 = u_xlat19 + unity_MatrixV[3].z;
    ...
    SV_Target0.xyz = vec3(u_xlat19) * u_xlat1.xyz + unity_FogColor.xyz;
