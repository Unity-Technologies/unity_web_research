...
;
    ...
    u_xlat4.xyz = u_xlat22.xyz * vec3(u_xlat25);
    ...
    u_xlat22.xyz = (u_xlatb22.x) ? u_xlat28.xyz : u_xlat7.xyz;
    ...
    u_xlat69 = u_xlat4.y * u_xlat4.y;
    u_xlat69 = u_xlat4.x * u_xlat4.x + (-u_xlat69);
    u_xlat28.xyz = unity_SHC.xyz * vec3(u_xlat69) + u_xlat9.xyz;
    ...
    u_xlat8.xyz = u_xlat4.xyz * (-vec3(u_xlat68)) + (-u_xlat22.xyz);
    ...
    u_xlat8.xyz = u_xlat22.xyz + _MainLightPosition.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat72) + u_xlat22.xyz;
