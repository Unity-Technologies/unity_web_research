...
;
    ...
    u_xlat5.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati36 + 1) / 4][(u_xlati36 + 1) % 4].xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[u_xlati36 / 4][u_xlati36 % 4].xyz * vs_INTERP0.xxx + u_xlat5.xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[(u_xlati36 + 2) / 4][(u_xlati36 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat5.xyz;
    ...
    u_xlat41 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat7.xz, _GlobalMipBias.x).x;
    ...
    u_xlat5.x = u_xlat17.x * u_xlat29 + u_xlat5.x;
    u_xlat17.xyz = vec3(u_xlat42) * _MainLightColor.xyz;
    ...
    u_xlat5.xyz = vec3(u_xlat38) * u_xlat17.xyz;
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat38) + u_xlat8.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu38 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat15 = dot(unity_LightIndices[int(u_xlatu15)], uintBitsToFloat(ImmCB_0[u_xlati41]));
        u_xlati15 = int(u_xlat15);
        u_xlat21.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati15].www + _AdditionalLightsPosition[u_xlati15].xyz;
        ...
        u_xlat41 = u_xlat41 * _AdditionalLightsAttenuation[u_xlati15].x;
        u_xlat41 = (-u_xlat41) * u_xlat41 + 1.0;
        u_xlat41 = max(u_xlat41, 0.0);
        u_xlat41 = u_xlat41 * u_xlat41;
        u_xlat41 = u_xlat41 * u_xlat44;
        u_xlat44 = dot(_AdditionalLightsSpotDir[u_xlati15].xyz, u_xlat10.xyz);
        ...
        u_xlat11.xyz = vec3(u_xlat15) * u_xlat11.xyz;
        u_xlat21.xyz = u_xlat21.xyz * vec3(u_xlat43) + u_xlat1.xyw;
        u_xlat15 = dot(u_xlat21.xyz, u_xlat21.xyz);
        u_xlat15 = max(u_xlat15, 1.17549435e-37);
        u_xlat15 = inversesqrt(u_xlat15);
        u_xlat21.xyz = vec3(u_xlat15) * u_xlat21.xyz;
        u_xlat15 = dot(u_xlat4.xyz, u_xlat21.xyz);
        u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
        ...
        u_xlat21.xyz = u_xlat0.xyz * vec3(u_xlat15) + u_xlat8.xyz;
        u_xlat7.xyz = u_xlat21.xyz * u_xlat11.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat6.xyz * vec3(u_xlat27) + u_xlat5.xyz;
