...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    if(u_xlatb7){
        ...
        u_xlat70 = (u_xlatb8.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb8.x) ? u_xlat7.xyz : vec3(u_xlat70);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu65 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu67)].www + _AdditionalLightsPosition[int(u_xlatu67)].xyz;
        ...
        u_xlat50.x = float(1.0) / float(u_xlat69);
        u_xlat69 = u_xlat69 * _AdditionalLightsAttenuation[int(u_xlatu67)].x;
        u_xlat69 = (-u_xlat69) * u_xlat69 + 1.0;
        u_xlat69 = max(u_xlat69, 0.0);
        u_xlat69 = u_xlat69 * u_xlat69;
        u_xlat69 = u_xlat69 * u_xlat50.x;
        u_xlat50.x = dot(_AdditionalLightsSpotDir[int(u_xlatu67)].xyz, u_xlat11.xyz);
        u_xlat50.x = u_xlat50.x * _AdditionalLightsAttenuation[int(u_xlatu67)].z + _AdditionalLightsAttenuation[int(u_xlatu67)].w;
        u_xlat50.x = clamp(u_xlat50.x, 0.0, 1.0);
        u_xlat50.x = u_xlat50.x * u_xlat50.x;
        u_xlat69 = u_xlat69 * u_xlat50.x;
        u_xlatu50 = u_xlatu67 >> (5u & uint(0x1F));
        u_xlati71 = 1 << (int(u_xlatu67) & int(0x1F));
        u_xlati50 = int(uint(u_xlati71) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu50)]));
        if(u_xlati50 != 0) {
            u_xlati50 = int(_AdditionalLightsLightTypes[int(u_xlatu67)]);
            u_xlati71 = (u_xlati50 != 0) ? 0 : 1;
            u_xlati73 = int(u_xlatu67) << (2 & int(0x1F));
            if(u_xlati71 != 0) {
                u_xlat12.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati73 + 1) / 4][(u_xlati73 + 1) % 4].xyw;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[u_xlati73 / 4][u_xlati73 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat12.xyz;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[(u_xlati73 + 2) / 4][(u_xlati73 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat12.xyz;
                u_xlat12.xyz = u_xlat12.xyz + _AdditionalLightsWorldToLights[(u_xlati73 + 3) / 4][(u_xlati73 + 3) % 4].xyw;
                u_xlat12.xy = u_xlat12.xy / u_xlat12.zz;
                u_xlat12.xy = u_xlat12.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat12.xy = clamp(u_xlat12.xy, 0.0, 1.0);
                u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu67)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu67)].zw;
            } else {
                u_xlatb50 = u_xlati50==1;
                u_xlati50 = u_xlatb50 ? 1 : int(0);
                if(u_xlati50 != 0) {
                    u_xlat50.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati73 + 1) / 4][(u_xlati73 + 1) % 4].xy;
                    u_xlat50.xy = _AdditionalLightsWorldToLights[u_xlati73 / 4][u_xlati73 % 4].xy * vs_TEXCOORD1.xx + u_xlat50.xy;
                    u_xlat50.xy = _AdditionalLightsWorldToLights[(u_xlati73 + 2) / 4][(u_xlati73 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat50.xy;
                    u_xlat50.xy = u_xlat50.xy + _AdditionalLightsWorldToLights[(u_xlati73 + 3) / 4][(u_xlati73 + 3) % 4].xy;
                    u_xlat50.xy = u_xlat50.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat50.xy = fract(u_xlat50.xy);
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu67)].xy * u_xlat50.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu67)].zw;
                } else {
                    u_xlat13 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati73 + 1) / 4][(u_xlati73 + 1) % 4];
                    u_xlat13 = _AdditionalLightsWorldToLights[u_xlati73 / 4][u_xlati73 % 4] * vs_TEXCOORD1.xxxx + u_xlat13;
                    u_xlat13 = _AdditionalLightsWorldToLights[(u_xlati73 + 2) / 4][(u_xlati73 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat13;
                    u_xlat13 = u_xlat13 + _AdditionalLightsWorldToLights[(u_xlati73 + 3) / 4][(u_xlati73 + 3) % 4];
                    u_xlat13.xyz = u_xlat13.xyz / u_xlat13.www;
                    u_xlat50.x = dot(u_xlat13.xyz, u_xlat13.xyz);
                    u_xlat50.x = inversesqrt(u_xlat50.x);
                    u_xlat13.xyz = u_xlat50.xxx * u_xlat13.xyz;
                    u_xlat50.x = dot(abs(u_xlat13.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat50.x = max(u_xlat50.x, 9.99999997e-07);
                    u_xlat50.x = float(1.0) / float(u_xlat50.x);
                    u_xlat14.xyz = u_xlat50.xxx * u_xlat13.zxy;
                    u_xlat14.x = (-u_xlat14.x);
                    u_xlat14.x = clamp(u_xlat14.x, 0.0, 1.0);
                    u_xlatb54.xy = greaterThanEqual(u_xlat14.yzyz, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    u_xlat54.x = (u_xlatb54.x) ? u_xlat14.x : (-u_xlat14.x);
                    u_xlat54.y = (u_xlatb54.y) ? u_xlat14.x : (-u_xlat14.x);
                    u_xlat50.xy = u_xlat13.xy * u_xlat50.xx + u_xlat54.xy;
                    u_xlat50.xy = u_xlat50.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat50.x = (u_xlatb8.y) ? u_xlat12.w : u_xlat12.x;
            u_xlat12.xyz = (u_xlatb8.x) ? u_xlat12.xyz : u_xlat50.xxx;
        } else {
            u_xlat12.x = float(1.0);
            u_xlat12.y = float(1.0);
            u_xlat12.z = float(1.0);
        }
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[int(u_xlatu67)].xyz;
        u_xlat12.xyz = vec3(u_xlat48) * u_xlat12.xyz;
        u_xlat67 = dot(u_xlat4.xyz, u_xlat11.xyz);
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat67 = u_xlat67 * u_xlat69;
        u_xlat12.xyz = vec3(u_xlat67) * u_xlat12.xyz;
        u_xlat10.xyz = u_xlat10.xyz * vec3(u_xlat70) + u_xlat3.xyz;
        ...
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat69 = dot(u_xlat11.xyz, u_xlat10.xyz);
        ...
        u_xlat10.xyz = u_xlat0.xyz * vec3(u_xlat67) + u_xlat22.xyz;
