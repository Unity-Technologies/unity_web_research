...
;
    ...
    u_xlat4.x = u_xlat25 * u_xlat46 + u_xlat4.x;
    u_xlat7.xyz = vec3(u_xlat27) * _MainLightColor.xyz;
    u_xlat25 = dot((-u_xlat3.xyz), u_xlat2.xyz);
    u_xlat25 = u_xlat25 + u_xlat25;
    u_xlat8.xyz = u_xlat2.xyz * (-vec3(u_xlat25)) + (-u_xlat3.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat71 = dot(_AdditionalLightsSpotDir[u_xlati66].xyz, u_xlat9.xyz);
        u_xlat71 = u_xlat71 * _AdditionalLightsAttenuation[u_xlati66].z + _AdditionalLightsAttenuation[u_xlati66].w;
        u_xlat71 = clamp(u_xlat71, 0.0, 1.0);
        u_xlat71 = u_xlat71 * u_xlat71;
        u_xlat69 = u_xlat69 * u_xlat71;
        u_xlat10.xyz = vec3(u_xlat27) * _AdditionalLightsColor[u_xlati66].xyz;
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat66) + u_xlat22.xyz;
