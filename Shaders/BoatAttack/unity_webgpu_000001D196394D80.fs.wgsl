...
fn main_1() {
  ...
  let x_2098 : vec3<f32> = sqrt(vec3<f32>(x_2096.x, x_2096.y, x_2096.z));
  let x_2099 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2098.x, x_2098.y, x_2098.z, x_2099.w);
  let x_2101 : vec2<f32> = vs_TEXCOORD0;
  let x_2104 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2108 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2110 : vec2<f32> = ((x_2101 * vec2<f32>(x_2104.x, x_2104.y)) + vec2<f32>(x_2108.z, x_2108.w));
  let x_2111 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2110.x, x_2110.y, x_2111.z, x_2111.w);
  let x_2118 : vec4<f32> = u_xlat1;
  let x_2121 : f32 = x_25.x_GlobalMipBias.x;
  let x_2122 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2118.x, x_2118.y), x_2121);
  u_xlat18 = x_2122.w;
  let x_2124 : f32 = u_xlat18;
  u_xlat18 = ((x_2124 * 2.0f) + -1.0f);
  let x_2127 : f32 = u_xlat18;
  u_xlatb1 = (x_2127 >= 0.0f);
  let x_2129 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2129);
  let x_2132 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2132)) + 1.0f);
  let x_2136 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2136);
  let x_2138 : f32 = u_xlat18;
  u_xlat18 = (-(x_2138) + 1.0f);
  let x_2141 : f32 = u_xlat18;
  let x_2143 : f32 = u_xlat1.x;
  u_xlat18 = (x_2141 * x_2143);
  let x_2145 : vec4<f32> = u_xlat0;
  let x_2147 : vec3<f32> = (vec3<f32>(x_2145.x, x_2145.y, x_2145.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2148 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2147.x, x_2147.y, x_2147.z, x_2148.w);
  let x_2150 : vec4<f32> = u_xlat0;
  let x_2152 : vec3<f32> = log2(vec3<f32>(x_2150.x, x_2150.y, x_2150.z));
  let x_2153 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2152.x, x_2152.y, x_2152.z, x_2153.w);
  let x_2155 : vec4<f32> = u_xlat2;
  let x_2157 : vec3<f32> = (vec3<f32>(x_2155.x, x_2155.y, x_2155.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2158 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2157.x, x_2157.y, x_2157.z, x_2158.w);
  let x_2160 : vec4<f32> = u_xlat2;
  let x_2162 : vec3<f32> = exp2(vec3<f32>(x_2160.x, x_2160.y, x_2160.z));
  let x_2163 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2162.x, x_2162.y, x_2162.z, x_2163.w);
  let x_2165 : vec4<f32> = u_xlat2;
  let x_2168 : vec3<f32> = ((vec3<f32>(x_2165.x, x_2165.y, x_2165.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2169 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2168.x, x_2168.y, x_2168.z, x_2169.w);
  let x_2171 : vec4<f32> = u_xlat0;
  let x_2173 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2171.x, x_2171.y, x_2171.z, x_2171.x));
  u_xlatb0 = vec3<bool>(x_2173.x, x_2173.y, x_2173.z);
  let x_2176 : bool = u_xlatb0.x;
  if (x_2176) {
  ...
  let x_2185 : f32 = x_2177;
  u_xlat0.x = x_2185;
  let x_2188 : bool = u_xlatb0.y;
  if (x_2188) {
    let x_2193 : f32 = u_xlat1.y;
    x_2189 = x_2193;
  } else {
    let x_2196 : f32 = u_xlat2.y;
    x_2189 = x_2196;
  }
  let x_2197 : f32 = x_2189;
  u_xlat0.y = x_2197;
  let x_2200 : bool = u_xlatb0.z;
  if (x_2200) {
    let x_2205 : f32 = u_xlat1.z;
    x_2201 = x_2205;
  } else {
  ...
  u_xlat0.z = x_2209;
  let x_2211 : f32 = u_xlat18;
  let x_2216 : vec4<f32> = u_xlat0;
  let x_2218 : vec3<f32> = ((vec3<f32>(x_2211, x_2211, x_2211) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2216.x, x_2216.y, x_2216.z));
  let x_2219 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2218.x, x_2218.y, x_2218.z, x_2219.w);
  let x_2221 : vec4<f32> = u_xlat0;
  let x_2223 : vec3<f32> = (vec3<f32>(x_2221.x, x_2221.y, x_2221.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2224 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2223.x, x_2223.y, x_2223.z, x_2224.w);
  let x_2226 : vec4<f32> = u_xlat0;
  let x_2228 : vec3<f32> = (vec3<f32>(x_2226.x, x_2226.y, x_2226.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2229 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2228.x, x_2228.y, x_2228.z, x_2229.w);
  let x_2231 : vec4<f32> = u_xlat2;
  let x_2233 : vec3<f32> = (vec3<f32>(x_2231.x, x_2231.y, x_2231.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2234 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2233.x, x_2233.y, x_2233.z, x_2234.w);
  let x_2236 : vec4<f32> = u_xlat2;
  let x_2239 : vec3<f32> = log2(abs(vec3<f32>(x_2236.x, x_2236.y, x_2236.z)));
  let x_2240 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2239.x, x_2239.y, x_2239.z, x_2240.w);
  let x_2242 : vec4<f32> = u_xlat2;
  let x_2244 : vec3<f32> = (vec3<f32>(x_2242.x, x_2242.y, x_2242.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2245 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2244.x, x_2244.y, x_2244.z, x_2245.w);
  let x_2247 : vec4<f32> = u_xlat2;
  let x_2249 : vec3<f32> = exp2(vec3<f32>(x_2247.x, x_2247.y, x_2247.z));
  let x_2250 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2249.x, x_2249.y, x_2249.z, x_2250.w);
  let x_2252 : vec4<f32> = u_xlat0;
  let x_2254 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2252.x, x_2252.y, x_2252.z, x_2252.x));
  u_xlatb0 = vec3<bool>(x_2254.x, x_2254.y, x_2254.z);
  let x_2257 : bool = u_xlatb0.x;
  if (x_2257) {
    let x_2262 : f32 = u_xlat1.x;
    x_2258 = x_2262;
  } else {
    let x_2265 : f32 = u_xlat2.x;
    x_2258 = x_2265;
  }
  let x_2266 : f32 = x_2258;
  u_xlat0.x = x_2266;
  let x_2269 : bool = u_xlatb0.y;
  if (x_2269) {
    let x_2274 : f32 = u_xlat1.y;
    x_2270 = x_2274;
  } else {
    let x_2277 : f32 = u_xlat2.y;
    x_2270 = x_2277;
  }
  let x_2278 : f32 = x_2270;
  u_xlat0.y = x_2278;
  let x_2281 : bool = u_xlatb0.z;
  if (x_2281) {
    let x_2286 : f32 = u_xlat1.z;
    x_2282 = x_2286;
  } else {
  ...
  let x_2296 : vec3<f32> = max(vec3<f32>(x_2294.x, x_2294.y, x_2294.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2297 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2296.x, x_2296.y, x_2296.z, x_2297.w);
  SV_Target0.w = 1.0f;
  return;
}
