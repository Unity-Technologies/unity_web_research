...
fn main_1() {
  ...
  let x_1533 : vec3<f32> = u_xlat6;
  let x_1534 : vec4<f32> = u_xlat1;
  let x_1537 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1533 * vec3<f32>(x_1534.x, x_1534.x, x_1534.x)) + x_1537);
  let x_1539 : vec3<f32> = u_xlat0;
  u_xlat0 = sqrt(x_1539);
  let x_1541 : vec2<f32> = vs_TEXCOORD0;
  let x_1544 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1548 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1550 : vec2<f32> = ((x_1541 * vec2<f32>(x_1544.x, x_1544.y)) + vec2<f32>(x_1548.z, x_1548.w));
  let x_1551 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1550.x, x_1550.y, x_1551.z, x_1551.w);
  let x_1558 : vec4<f32> = u_xlat1;
  let x_1561 : f32 = x_26.x_GlobalMipBias.x;
  let x_1562 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1558.x, x_1558.y), x_1561);
  u_xlat15 = x_1562.w;
  let x_1564 : f32 = u_xlat15;
  u_xlat15 = ((x_1564 * 2.0f) + -1.0f);
  let x_1567 : f32 = u_xlat15;
  u_xlatb1 = (x_1567 >= 0.0f);
  let x_1569 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1569);
  let x_1572 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1572)) + 1.0f);
  let x_1576 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1576);
  let x_1578 : f32 = u_xlat15;
  u_xlat15 = (-(x_1578) + 1.0f);
  let x_1581 : f32 = u_xlat15;
  let x_1583 : f32 = u_xlat1.x;
  u_xlat15 = (x_1581 * x_1583);
  let x_1585 : vec3<f32> = u_xlat0;
  let x_1586 : vec3<f32> = (x_1585 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1587 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1586.x, x_1586.y, x_1586.z, x_1587.w);
  let x_1589 : vec3<f32> = u_xlat0;
  let x_1590 : vec3<f32> = log2(x_1589);
  ...
  let x_1654 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1649, x_1649, x_1649) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1654);
  let x_1656 : vec3<f32> = u_xlat0;
  let x_1657 : vec3<f32> = (x_1656 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1658 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1657.x, x_1657.y, x_1657.z, x_1658.w);
  let x_1660 : vec3<f32> = u_xlat0;
  let x_1661 : vec3<f32> = (x_1660 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1662 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1661.x, x_1661.y, x_1661.z, x_1662.w);
  let x_1664 : vec4<f32> = u_xlat2;
  let x_1666 : vec3<f32> = (vec3<f32>(x_1664.x, x_1664.y, x_1664.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1667 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1666.x, x_1666.y, x_1666.z, x_1667.w);
  let x_1669 : vec4<f32> = u_xlat2;
  let x_1672 : vec3<f32> = log2(abs(vec3<f32>(x_1669.x, x_1669.y, x_1669.z)));
  let x_1673 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1672.x, x_1672.y, x_1672.z, x_1673.w);
  let x_1675 : vec4<f32> = u_xlat2;
  let x_1677 : vec3<f32> = (vec3<f32>(x_1675.x, x_1675.y, x_1675.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1678 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1677.x, x_1677.y, x_1677.z, x_1678.w);
  let x_1680 : vec4<f32> = u_xlat2;
  let x_1682 : vec3<f32> = exp2(vec3<f32>(x_1680.x, x_1680.y, x_1680.z));
  let x_1683 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1682.x, x_1682.y, x_1682.z, x_1683.w);
  let x_1685 : vec3<f32> = u_xlat0;
  let x_1687 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1685.x, x_1685.y, x_1685.z, x_1685.x));
  u_xlatb0 = vec3<bool>(x_1687.x, x_1687.y, x_1687.z);
  let x_1690 : bool = u_xlatb0.x;
  if (x_1690) {
  ...
  u_xlat0.x = x_1699;
  let x_1702 : bool = u_xlatb0.y;
  if (x_1702) {
    let x_1707 : f32 = u_xlat1.y;
    x_1703 = x_1707;
  } else {
  ...
  u_xlat0.y = x_1711;
  let x_1714 : bool = u_xlatb0.z;
  if (x_1714) {
    let x_1719 : f32 = u_xlat1.z;
    x_1715 = x_1719;
  } else {
  ...
  let x_1728 : vec3<f32> = max(x_1727, vec3<f32>(0.0f, 0.0f, 0.0f));
