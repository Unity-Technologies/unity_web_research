...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat22.xyz = (bool(u_xlatb22)) ? u_xlat2.xyz : u_xlat3.xyz;
...
;
    ...
    u_xlat66 = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat66) + 1.0;
    u_xlat66 = (-u_xlat1) * 0.959999979 + 0.959999979;
    u_xlat67 = (-u_xlat66) + 1.0;
    u_xlat6.xyz = u_xlat0.xyz * vec3(u_xlat66);
    ...
    u_xlat63 = u_xlat0.w + u_xlat67;
    u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
    u_xlat67 = u_xlat66 * 4.0 + 2.0;
    ...
    if(u_xlatb68){
        ...
        if(u_xlatb68){
            ...
            if(u_xlatb69){
                ...
                u_xlat49.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
    ...
    if(u_xlatb24.x){
        ...
        u_xlat7 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat24.xy, _GlobalMipBias.x);
    ...
    u_xlat24.x = dot((-u_xlat22.xyz), u_xlat2.xyz);
    u_xlat24.x = u_xlat24.x + u_xlat24.x;
    u_xlat8.xyz = u_xlat2.xyz * (-u_xlat24.xxx) + (-u_xlat22.xyz);
    u_xlat24.x = dot(u_xlat2.xyz, u_xlat22.xyz);
    u_xlat24.x = clamp(u_xlat24.x, 0.0, 1.0);
    u_xlat24.x = (-u_xlat24.x) + 1.0;
    u_xlat24.x = u_xlat24.x * u_xlat24.x;
    u_xlat24.x = u_xlat24.x * u_xlat24.x;
    u_xlat45.x = (-u_xlat1) * 0.699999988 + 1.70000005;
    u_xlat1 = u_xlat1 * u_xlat45.x;
    u_xlat1 = u_xlat1 * 6.0;
    ...
    u_xlat45.xy = vec2(u_xlat66) * vec2(u_xlat66) + vec2(-1.0, 1.0);
    u_xlat1 = float(1.0) / u_xlat45.y;
    u_xlat9.xyz = (-u_xlat0.xyz) + vec3(u_xlat63);
    u_xlat9.xyz = u_xlat24.xxx * u_xlat9.xyz + u_xlat0.xyz;
    ...
    u_xlat3.xyw = vec3(u_xlat63) * u_xlat7.xyz;
    u_xlat7.xyz = u_xlat22.xyz + _MainLightPosition.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat70 = dot(_AdditionalLightsSpotDir[int(u_xlatu68)].xyz, u_xlat10.xyz);
        u_xlat70 = u_xlat70 * _AdditionalLightsAttenuation[int(u_xlatu68)].z + _AdditionalLightsAttenuation[int(u_xlatu68)].w;
        u_xlat70 = clamp(u_xlat70, 0.0, 1.0);
        u_xlat70 = u_xlat70 * u_xlat70;
        u_xlat69 = u_xlat69 * u_xlat70;
        u_xlatu70 = u_xlatu68 >> (5u & uint(0x1F));
        u_xlati71 = 1 << (int(u_xlatu68) & int(0x1F));
        u_xlati70 = int(uint(u_xlati71) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu70)]));
        if(u_xlati70 != 0) {
            u_xlati70 = int(_AdditionalLightsLightTypes[int(u_xlatu68)]);
            u_xlati71 = (u_xlati70 != 0) ? 0 : 1;
            u_xlati72 = int(u_xlatu68) << (2 & int(0x1F));
            if(u_xlati71 != 0) {
        ...
        u_xlat9.xyz = u_xlat9.xyz * u_xlat49.xxx + u_xlat22.xyz;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat68) + u_xlat6.xyz;
