...
float u_xlat15;
    ...
    u_xlat4 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat3.xy, _GlobalMipBias.x);
    ...
    u_xlat3 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), vs_TEXCOORD0.xy, _GlobalMipBias.x);
    u_xlat3.xyz = u_xlat3.www * u_xlat3.xyz;
    u_xlat1.xyz = u_xlat3.xyz * vec3(1.81621623, 1.81621623, 1.81621623) + u_xlat1.xyz;
    u_xlat3 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat2.xy, _GlobalMipBias.x);
    u_xlat2 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat2.zw, _GlobalMipBias.x);
    u_xlat2.xyz = u_xlat2.www * u_xlat2.xyz;
    u_xlat3.xyz = u_xlat3.www * u_xlat3.xyz;
    u_xlat1.xyz = u_xlat3.xyz * vec3(1.55675673, 1.55675673, 1.55675673) + u_xlat1.xyz;
