...
layout(set = 0, binding = 10) uniform mediump  sampler samplerTexture2D_52571568;
layout(set = 0, binding = 11) uniform mediump  sampler samplerTexture2D_F0A81025;
layout(set = 0, binding = 12) uniform mediump  sampler samplerTexture2D_8BA53EED;
layout(set = 0, binding = 13) uniform mediump  sampler samplerTexture2D_AB84E4D0;
void main()
{
vec3 u_xlat0;
vec4 u_xlat1;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat3.x = dot(u_xlat4.xyz, u_xlat30.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
