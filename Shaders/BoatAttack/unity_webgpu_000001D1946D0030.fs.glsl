...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    if(u_xlatb21){
        ...
        if(u_xlatb21){
            ...
            u_xlatb39.x = _MainLightShadowParams.y==2.0;
            if(u_xlatb39.x){
                ...
                u_xlat5.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec13, 0.0);
                vec3 txVec14 = vec3(u_xlat9.zw,vs_TEXCOORD6.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec14, 0.0);
                u_xlat59 = u_xlat59 * u_xlat15.y;
                u_xlat5.x = u_xlat15.x * u_xlat5.x + u_xlat59;
                vec3 txVec15 = vec3(u_xlat10.xy,vs_TEXCOORD6.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec15, 0.0);
                u_xlat5.x = u_xlat15.z * u_xlat59 + u_xlat5.x;
                vec3 txVec16 = vec3(u_xlat12.xy,vs_TEXCOORD6.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec16, 0.0);
                u_xlat5.x = u_xlat15.w * u_xlat59 + u_xlat5.x;
                vec3 txVec17 = vec3(u_xlat11.xy,vs_TEXCOORD6.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec17, 0.0);
                u_xlat5.x = u_xlat16.x * u_xlat59 + u_xlat5.x;
                vec3 txVec18 = vec3(u_xlat11.zw,vs_TEXCOORD6.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec18, 0.0);
                u_xlat5.x = u_xlat16.y * u_xlat59 + u_xlat5.x;
                vec3 txVec19 = vec3(u_xlat46.xy,vs_TEXCOORD6.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec19, 0.0);
                u_xlat5.x = u_xlat16.z * u_xlat59 + u_xlat5.x;
                vec3 txVec20 = vec3(u_xlat12.zw,vs_TEXCOORD6.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec20, 0.0);
                u_xlat5.x = u_xlat16.w * u_xlat59 + u_xlat5.x;
                vec3 txVec21 = vec3(u_xlat13.xy,vs_TEXCOORD6.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec21, 0.0);
                u_xlat5.x = u_xlat17.x * u_xlat59 + u_xlat5.x;
                vec3 txVec22 = vec3(u_xlat13.zw,vs_TEXCOORD6.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec22, 0.0);
                u_xlat5.x = u_xlat17.y * u_xlat59 + u_xlat5.x;
                vec3 txVec23 = vec3(u_xlat23.xy,vs_TEXCOORD6.z);
                u_xlat23.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat5.x = u_xlat17.z * u_xlat23.x + u_xlat5.x;
                vec3 txVec24 = vec3(u_xlat14.xy,vs_TEXCOORD6.z);
                u_xlat23.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec24, 0.0);
                u_xlat5.x = u_xlat17.w * u_xlat23.x + u_xlat5.x;
                vec3 txVec25 = vec3(u_xlat8.xy,vs_TEXCOORD6.z);
                u_xlat23.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec25, 0.0);
                ...
                u_xlat22 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
                u_xlat4.x = u_xlat4.z * u_xlat22 + u_xlat4.x;
                vec3 txVec28 = vec3(u_xlat39.xy,vs_TEXCOORD6.z);
                u_xlat39.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec28, 0.0);
                u_xlat21.x = u_xlat4.w * u_xlat39.x + u_xlat4.x;
            }
        }
    } else {
        vec3 txVec29 = vec3(vs_TEXCOORD6.xy,vs_TEXCOORD6.z);
        u_xlat21.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat39.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat21.x = u_xlat21.x * _MainLightShadowParams.x + u_xlat39.x;
    u_xlatb39.x = 0.0>=vs_TEXCOORD6.z;
    u_xlatb57 = vs_TEXCOORD6.z>=1.0;
    u_xlatb39.x = u_xlatb57 || u_xlatb39.x;
    u_xlat21.x = (u_xlatb39.x) ? 1.0 : u_xlat21.x;
    ...
    if(u_xlatb39.x){
        u_xlat39.xy = vs_TEXCOORD1.yy * _MainLightWorldToLight[1].xy;
        u_xlat39.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD1.xx + u_xlat39.xy;
        u_xlat39.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD1.zz + u_xlat39.xy;
        u_xlat39.xy = u_xlat39.xy + _MainLightWorldToLight[3].xy;
        u_xlat39.xy = u_xlat39.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat4 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat39.xy, _GlobalMipBias.x);
        ...
        u_xlat4.xyz = (u_xlatb39.x) ? u_xlat4.xyz : vec3(u_xlat57);
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.y = float(1.0);
        u_xlat4.z = float(1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu55 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat58 = dot(unity_LightIndices[int(u_xlatu58)], uintBitsToFloat(ImmCB_0[u_xlati59]));
        u_xlatu58 =  uint(int(u_xlat58));
        u_xlat6.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu58)].www + _AdditionalLightsPosition[int(u_xlatu58)].xyz;
        ...
        u_xlat59 = u_xlat59 * _AdditionalLightsAttenuation[int(u_xlatu58)].x;
        u_xlat59 = (-u_xlat59) * u_xlat59 + 1.0;
        u_xlat59 = max(u_xlat59, 0.0);
        u_xlat59 = u_xlat59 * u_xlat59;
        u_xlat59 = u_xlat59 * u_xlat60;
        u_xlat60 = dot(_AdditionalLightsSpotDir[int(u_xlatu58)].xyz, u_xlat6.xyz);
        u_xlat60 = u_xlat60 * _AdditionalLightsAttenuation[int(u_xlatu58)].z + _AdditionalLightsAttenuation[int(u_xlatu58)].w;
        u_xlat60 = clamp(u_xlat60, 0.0, 1.0);
        u_xlat60 = u_xlat60 * u_xlat60;
        u_xlat59 = u_xlat59 * u_xlat60;
        u_xlatu60 = u_xlatu58 >> (5u & uint(0x1F));
        u_xlati7 = 1 << (int(u_xlatu58) & int(0x1F));
        u_xlati60 = int(uint(u_xlati7) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu60)]));
        if(u_xlati60 != 0) {
            u_xlati60 = int(_AdditionalLightsLightTypes[int(u_xlatu58)]);
            u_xlati7 = (u_xlati60 != 0) ? 0 : 1;
            u_xlati25 = int(u_xlatu58) << (2 & int(0x1F));
            if(u_xlati7 != 0) {
                u_xlat7.xzw = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati25 + 1) / 4][(u_xlati25 + 1) % 4].xyw;
                u_xlat7.xzw = _AdditionalLightsWorldToLights[u_xlati25 / 4][u_xlati25 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat7.xzw;
                u_xlat7.xzw = _AdditionalLightsWorldToLights[(u_xlati25 + 2) / 4][(u_xlati25 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat7.xzw;
                u_xlat7.xzw = u_xlat7.xzw + _AdditionalLightsWorldToLights[(u_xlati25 + 3) / 4][(u_xlati25 + 3) % 4].xyw;
                u_xlat7.xz = u_xlat7.xz / u_xlat7.ww;
                u_xlat7.xz = u_xlat7.xz * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat7.xz = clamp(u_xlat7.xz, 0.0, 1.0);
                u_xlat7.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu58)].xy * u_xlat7.xz + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu58)].zw;
            } else {
                u_xlatb60 = u_xlati60==1;
                u_xlati60 = u_xlatb60 ? 1 : int(0);
                if(u_xlati60 != 0) {
                    u_xlat8.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati25 + 1) / 4][(u_xlati25 + 1) % 4].xy;
                    u_xlat8.xy = _AdditionalLightsWorldToLights[u_xlati25 / 4][u_xlati25 % 4].xy * vs_TEXCOORD1.xx + u_xlat8.xy;
                    u_xlat8.xy = _AdditionalLightsWorldToLights[(u_xlati25 + 2) / 4][(u_xlati25 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat8.xy;
                    u_xlat8.xy = u_xlat8.xy + _AdditionalLightsWorldToLights[(u_xlati25 + 3) / 4][(u_xlati25 + 3) % 4].xy;
                    u_xlat8.xy = u_xlat8.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat8.xy = fract(u_xlat8.xy);
                    u_xlat7.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu58)].xy * u_xlat8.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu58)].zw;
                } else {
                    u_xlat8 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati25 + 1) / 4][(u_xlati25 + 1) % 4];
                    u_xlat8 = _AdditionalLightsWorldToLights[u_xlati25 / 4][u_xlati25 % 4] * vs_TEXCOORD1.xxxx + u_xlat8;
                    u_xlat8 = _AdditionalLightsWorldToLights[(u_xlati25 + 2) / 4][(u_xlati25 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat8;
                    u_xlat8 = u_xlat8 + _AdditionalLightsWorldToLights[(u_xlati25 + 3) / 4][(u_xlati25 + 3) % 4];
                    u_xlat8.xyz = u_xlat8.xyz / u_xlat8.www;
                    u_xlat60 = dot(u_xlat8.xyz, u_xlat8.xyz);
                    u_xlat60 = inversesqrt(u_xlat60);
                    u_xlat8.xyz = vec3(u_xlat60) * u_xlat8.xyz;
                    u_xlat60 = dot(abs(u_xlat8.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat60 = max(u_xlat60, 9.99999997e-07);
                    u_xlat60 = float(1.0) / float(u_xlat60);
                    u_xlat9.xyz = vec3(u_xlat60) * u_xlat8.zxy;
                    u_xlat9.x = (-u_xlat9.x);
                    u_xlat9.x = clamp(u_xlat9.x, 0.0, 1.0);
                    u_xlatb25.xz = greaterThanEqual(u_xlat9.yyzz, vec4(0.0, 0.0, 0.0, 0.0)).xz;
                    u_xlat25.x = (u_xlatb25.x) ? u_xlat9.x : (-u_xlat9.x);
                    u_xlat25.z = (u_xlatb25.z) ? u_xlat9.x : (-u_xlat9.x);
                    u_xlat25.xz = u_xlat8.xy * vec2(u_xlat60) + u_xlat25.xz;
                    u_xlat25.xz = u_xlat25.xz * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat25.xz = clamp(u_xlat25.xz, 0.0, 1.0);
                    u_xlat7.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu58)].xy * u_xlat25.xz + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu58)].zw;
                }
            }
            ...
            u_xlat60 = (u_xlatb4.y) ? u_xlat7.w : u_xlat7.x;
            u_xlat7.xyz = (u_xlatb4.x) ? u_xlat7.xyz : vec3(u_xlat60);
        } else {
            u_xlat7.x = float(1.0);
            u_xlat7.y = float(1.0);
            u_xlat7.z = float(1.0);
        }
        u_xlat7.xyz = u_xlat7.xyz * _AdditionalLightsColor[int(u_xlatu58)].xyz;
