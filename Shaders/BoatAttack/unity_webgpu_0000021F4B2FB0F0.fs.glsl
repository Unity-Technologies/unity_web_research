...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat18.x = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat18.x = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat18.x;
    u_xlat18.x = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat18.x;
    u_xlat18.x = u_xlat18.x + unity_MatrixV[3].z;
    u_xlat18.x = (-u_xlat18.x) + (-_ProjectionParams.y);
    u_xlat18.x = max(u_xlat18.x, 0.0);
    u_xlat18.x = u_xlat18.x * unity_FogParams.x;
    ...
    SV_Target0.xyz = u_xlat18.xxx * u_xlat1.xyz + unity_FogColor.xyz;
