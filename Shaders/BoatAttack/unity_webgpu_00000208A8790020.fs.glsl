...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat22.xyz = vs_TEXCOORD7.xyz + (-_CascadeShadowSplitSpheres0.xyz);
...
;
    ...
    u_xlat4.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati22 + 1) / 4][(u_xlati22 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati22 / 4][u_xlati22 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati22 + 2) / 4][(u_xlati22 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat4.xyz;
    ...
    u_xlat5.xyz = unity_SHC.xyz * vec3(u_xlat65) + u_xlat6.xyz;
    ...
    u_xlatb47 = 0.0<_MainLightShadowParams.y;
    if(u_xlatb47){
        u_xlatb47 = _MainLightShadowParams.y==1.0;
        if(u_xlatb47){
            u_xlat7 = u_xlat22.xyxy + _MainLightShadowOffset0;
            vec3 txVec0 = vec3(u_xlat7.xy,u_xlat22.z);
            u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec0, 0.0);
            vec3 txVec1 = vec3(u_xlat7.zw,u_xlat22.z);
            u_xlat8.y = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec1, 0.0);
            u_xlat7 = u_xlat22.xyxy + _MainLightShadowOffset1;
            vec3 txVec2 = vec3(u_xlat7.xy,u_xlat22.z);
            u_xlat8.z = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec2, 0.0);
            vec3 txVec3 = vec3(u_xlat7.zw,u_xlat22.z);
            u_xlat8.w = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec3, 0.0);
            u_xlat47.x = dot(u_xlat8, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            u_xlatb68 = _MainLightShadowParams.y==2.0;
            if(u_xlatb68){
                u_xlat7.xy = u_xlat22.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat49.xy = u_xlat22.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                vec3 txVec6 = vec3(u_xlat49.xy,u_xlat22.z);
                ...
                vec3 txVec7 = vec3(u_xlat10.xy,u_xlat22.z);
                ...
                vec3 txVec8 = vec3(u_xlat12.xy,u_xlat22.z);
                ...
                vec3 txVec9 = vec3(u_xlat12.zw,u_xlat22.z);
                ...
                vec3 txVec10 = vec3(u_xlat10.zw,u_xlat22.z);
                ...
                vec3 txVec11 = vec3(u_xlat9.xy,u_xlat22.z);
                ...
                vec3 txVec15 = vec3(u_xlat49.xy,u_xlat22.z);
                ...
                vec3 txVec16 = vec3(u_xlat16.xy,u_xlat22.z);
                ...
                vec3 txVec17 = vec3(u_xlat14.xy,u_xlat22.z);
                ...
                vec3 txVec18 = vec3(u_xlat14.zw,u_xlat22.z);
                ...
                vec3 txVec19 = vec3(u_xlat15.xy,u_xlat22.z);
                ...
                vec3 txVec20 = vec3(u_xlat16.zw,u_xlat22.z);
                ...
                vec3 txVec21 = vec3(u_xlat17.xy,u_xlat22.z);
                ...
                vec3 txVec22 = vec3(u_xlat17.zw,u_xlat22.z);
                ...
                vec3 txVec23 = vec3(u_xlat30.xy,u_xlat22.z);
                ...
                vec3 txVec24 = vec3(u_xlat57.xy,u_xlat22.z);
                ...
                vec3 txVec25 = vec3(u_xlat12.xy,u_xlat22.z);
                ...
                vec3 txVec26 = vec3(u_xlat12.zw,u_xlat22.z);
                ...
                vec3 txVec27 = vec3(u_xlat52.xy,u_xlat22.z);
                ...
                vec3 txVec28 = vec3(u_xlat7.xy,u_xlat22.z);
                u_xlat69 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec28, 0.0);
                u_xlat47.x = u_xlat8.w * u_xlat69 + u_xlat68;
            }
        }
    } else {
        vec3 txVec29 = vec3(u_xlat22.xy,u_xlat22.z);
        u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat22.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat22.x = u_xlat47.x * _MainLightShadowParams.x + u_xlat22.x;
    u_xlatb43 = 0.0>=u_xlat22.z;
    u_xlatb64 = u_xlat22.z>=1.0;
    u_xlatb43 = u_xlatb64 || u_xlatb43;
    u_xlat22.x = (u_xlatb43) ? 1.0 : u_xlat22.x;
    ...
    u_xlat64 = (-u_xlat22.x) + 1.0;
    u_xlat22.x = u_xlat43 * u_xlat64 + u_xlat22.x;
    u_xlat7.xyz = vec3(u_xlat26) * _MainLightColor.xyz;
    u_xlat43 = dot((-u_xlat3.xyz), u_xlat2.xyz);
    u_xlat43 = u_xlat43 + u_xlat43;
    u_xlat8.xyz = u_xlat2.xyz * (-vec3(u_xlat43)) + (-u_xlat3.xyz);
    u_xlat43 = dot(u_xlat2.xyz, u_xlat3.xyz);
    u_xlat43 = clamp(u_xlat43, 0.0, 1.0);
    u_xlat43 = (-u_xlat43) + 1.0;
    u_xlat1.z = u_xlat43 * u_xlat43;
    ...
    u_xlat1.xw = vec2(u_xlat65) * vec2(u_xlat65) + vec2(-1.0, 1.0);
    u_xlat64 = float(1.0) / u_xlat1.w;
    ...
    u_xlat63 = u_xlat22.x * unity_LightData.z;
    u_xlat22.x = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat22.x = clamp(u_xlat22.x, 0.0, 1.0);
    u_xlat63 = u_xlat63 * u_xlat22.x;
    u_xlat22.xyz = vec3(u_xlat63) * u_xlat7.xyz;
    ...
    u_xlat63 = u_xlat63 * u_xlat1.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat47.x = dot(unity_LightIndices[int(u_xlatu47)], uintBitsToFloat(ImmCB_0[u_xlati68]));
        ...
        u_xlat70 = dot(_AdditionalLightsSpotDir[u_xlati47].xyz, u_xlat9.xyz);
        ...
        u_xlat68 = u_xlat68 * u_xlat70;
        u_xlat10.xyz = vec3(u_xlat26) * _AdditionalLightsColor[u_xlati47].xyz;
        u_xlat47.x = dot(u_xlat2.xyz, u_xlat9.xyz);
        u_xlat47.x = clamp(u_xlat47.x, 0.0, 1.0);
        u_xlat47.x = u_xlat47.x * u_xlat68;
        u_xlat10.xyz = u_xlat47.xxx * u_xlat10.xyz;
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat69) + u_xlat3.xyz;
        u_xlat47.x = dot(u_xlat8.xyz, u_xlat8.xyz);
        u_xlat47.x = max(u_xlat47.x, 1.17549435e-37);
        u_xlat47.x = inversesqrt(u_xlat47.x);
        u_xlat8.xyz = u_xlat47.xxx * u_xlat8.xyz;
        u_xlat47.x = dot(u_xlat2.xyz, u_xlat8.xyz);
        u_xlat47.x = clamp(u_xlat47.x, 0.0, 1.0);
        u_xlat47.y = dot(u_xlat9.xyz, u_xlat8.xyz);
        u_xlat47.y = clamp(u_xlat47.y, 0.0, 1.0);
        u_xlat47.xy = u_xlat47.xy * u_xlat47.xy;
        u_xlat47.x = u_xlat47.x * u_xlat1.x + 1.00001001;
        ...
        u_xlat8.xyz = u_xlat0.xyz * u_xlat47.xxx + u_xlat6.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * u_xlat5.xxx + u_xlat22.xyz;
