...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat28.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati63].www + _AdditionalLightsPosition[u_xlati63].xyz;
        ...
        u_xlat28.xyz = u_xlat0.xyz * vec3(u_xlat63) + u_xlat5.xyz;
