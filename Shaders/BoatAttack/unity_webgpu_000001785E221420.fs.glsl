...
;
    ...
    u_xlat2.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati64 + 1) / 4][(u_xlati64 + 1) % 4].xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[u_xlati64 / 4][u_xlati64 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat2.xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[(u_xlati64 + 2) / 4][(u_xlati64 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat2.xyz;
    ...
    if(u_xlatb23.x){
        ...
        u_xlat44 = (u_xlatb23.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb23.x) ? u_xlat7.xyz : vec3(u_xlat44);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat23.x = dot((-u_xlat8.xyz), u_xlat1.xyz);
    u_xlat23.x = u_xlat23.x + u_xlat23.x;
    u_xlat9.xyz = u_xlat1.xyz * (-u_xlat23.xxx) + (-u_xlat8.xyz);
    u_xlat23.x = dot(u_xlat1.xyz, u_xlat8.xyz);
    u_xlat23.x = clamp(u_xlat23.x, 0.0, 1.0);
    ...
    u_xlat10.xyz = (-u_xlat5.xyz) + vec3(u_xlat66);
    u_xlat10.xyz = u_xlat23.xxx * u_xlat10.xyz + u_xlat5.xyz;
    u_xlat10.xyz = vec3(u_xlat42) * u_xlat10.xyz;
    u_xlat9.xyz = u_xlat9.xyz * u_xlat10.xyz;
    u_xlat3.xyz = u_xlat3.xyz * u_xlat6.xyz + u_xlat9.xyz;
    u_xlat42 = u_xlat2.x * unity_LightData.z;
    u_xlat2.x = dot(u_xlat1.xyz, _MainLightPosition.xyz);
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat42 = u_xlat42 * u_xlat2.x;
    u_xlat2.xyz = vec3(u_xlat42) * u_xlat7.xyz;
    u_xlat7.xyz = u_xlat8.xyz + _MainLightPosition.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu68)].www + _AdditionalLightsPosition[int(u_xlatu68)].xyz;
        ...
        if(u_xlati71 != 0) {
            ...
            if(u_xlati72 != 0) {
                u_xlat11.xyz = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati73 + 1) / 4][(u_xlati73 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati73 / 4][u_xlati73 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati73 + 2) / 4][(u_xlati73 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat11.xyz;
                ...
                if(u_xlati71 != 0) {
                    u_xlat53.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati73 + 1) / 4][(u_xlati73 + 1) % 4].xy;
                    u_xlat53.xy = _AdditionalLightsWorldToLights[u_xlati73 / 4][u_xlati73 % 4].xy * vs_TEXCOORD7.xx + u_xlat53.xy;
                    u_xlat53.xy = _AdditionalLightsWorldToLights[(u_xlati73 + 2) / 4][(u_xlati73 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat53.xy;
                    ...
                    u_xlat12 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToLights[(u_xlati73 + 1) / 4][(u_xlati73 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati73 / 4][u_xlati73 % 4] * vs_TEXCOORD7.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati73 + 2) / 4][(u_xlati73 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat12;
            ...
            u_xlat71 = (u_xlatb4.w) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb4.x) ? u_xlat11.xyz : vec3(u_xlat71);
        } else {
        ...
        u_xlat68 = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
        u_xlat68 = u_xlat68 * u_xlat69;
        u_xlat11.xyz = vec3(u_xlat68) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat70) + u_xlat8.xyz;
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat68) + u_xlat6.xyz;
        u_xlat7.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat7.xyz;
    }
