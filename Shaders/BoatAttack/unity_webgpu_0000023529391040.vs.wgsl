...
@group(1) @binding(7) var<uniform> x_59 : VGlobals;
...
fn main_1() {
  ...
  let x_181 : vec4<f32> = x_21.unity_LightmapST;
  let x_185 : vec4<f32> = x_21.unity_LightmapST;
  vs_INTERP4 = ((vec2<f32>(x_177.x, x_177.y) * vec2<f32>(x_181.x, x_181.y)) + vec2<f32>(x_185.z, x_185.w));
