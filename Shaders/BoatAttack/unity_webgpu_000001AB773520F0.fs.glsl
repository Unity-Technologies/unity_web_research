...
;
    ...
    u_xlat8.xyz = vec3(u_xlat29) * _MainLightColor.xyz;
    u_xlat27 = dot((-u_xlat3.xyz), u_xlat4.xyz);
    u_xlat27 = u_xlat27 + u_xlat27;
    u_xlat9.xyz = u_xlat4.xyz * (-vec3(u_xlat27)) + (-u_xlat3.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu68 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat73 = u_xlat73 * _AdditionalLightsAttenuation[u_xlati70].x;
        u_xlat73 = (-u_xlat73) * u_xlat73 + 1.0;
        u_xlat73 = max(u_xlat73, 0.0);
        u_xlat73 = u_xlat73 * u_xlat73;
        u_xlat73 = u_xlat73 * u_xlat75;
        u_xlat75 = dot(_AdditionalLightsSpotDir[u_xlati70].xyz, u_xlat10.xyz);
        u_xlat75 = u_xlat75 * _AdditionalLightsAttenuation[u_xlati70].z + _AdditionalLightsAttenuation[u_xlati70].w;
        u_xlat75 = clamp(u_xlat75, 0.0, 1.0);
        u_xlat75 = u_xlat75 * u_xlat75;
        u_xlat73 = u_xlat73 * u_xlat75;
        u_xlat11.xyz = vec3(u_xlat29) * _AdditionalLightsColor[u_xlati70].xyz;
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat74) + u_xlat3.xyz;
        ...
        u_xlat70 = dot(u_xlat4.xyz, u_xlat9.xyz);
        u_xlat70 = clamp(u_xlat70, 0.0, 1.0);
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat70) + u_xlat23.xyz;
