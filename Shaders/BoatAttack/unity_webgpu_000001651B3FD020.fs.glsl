...
;
    ...
    u_xlat25.xyz = u_xlat23.xxx * u_xlat25.xyz;
    u_xlatb23.x = unity_OrthoParams.w==0.0;
    u_xlat27.xyz = (-vs_INTERP0.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat67 = dot(u_xlat27.xyz, u_xlat27.xyz);
    u_xlat67 = inversesqrt(u_xlat67);
    u_xlat27.xyz = vec3(u_xlat67) * u_xlat27.xyz;
    u_xlat6.x = (u_xlatb23.x) ? u_xlat27.x : unity_MatrixV[0].z;
    u_xlat6.y = (u_xlatb23.x) ? u_xlat27.y : unity_MatrixV[1].z;
    u_xlat6.z = (u_xlatb23.x) ? u_xlat27.z : unity_MatrixV[2].z;
    u_xlat7 = texture(sampler2D(unity_LightmapInd, samplerunity_Lightmap), vs_INTERP5.xy, _GlobalMipBias.x);
    ...
    u_xlat23.x = dot(u_xlat25.xyz, u_xlat7.xyz);
    u_xlat23.x = u_xlat23.x + 0.5;
    u_xlat27.xyz = u_xlat23.xxx * u_xlat27.xyz;
    u_xlat23.x = max(u_xlat7.w, 9.99999975e-05);
    u_xlat27.xyz = u_xlat27.xyz / u_xlat23.xxx;
    ...
    if(u_xlatb66){
        ...
        if(u_xlatb66){
            ...
            u_xlatb51.x = _MainLightShadowParams.y==2.0;
            if(u_xlatb51.x){
                u_xlat51.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat51.xy = floor(u_xlat51.xy);
                u_xlat8.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat51.xy);
                ...
                u_xlat66 = u_xlat51.x * u_xlat8.x + u_xlat73;
            } else {
                u_xlat51.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat51.xy = floor(u_xlat51.xy);
                u_xlat8.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat51.xy);
                ...
                u_xlat9.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec43, 0.0);
                vec3 txVec44 = vec3(u_xlat13.zw,u_xlat4.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec44, 0.0);
                u_xlat75 = u_xlat75 * u_xlat19.y;
                u_xlat9.x = u_xlat19.x * u_xlat9.x + u_xlat75;
                vec3 txVec45 = vec3(u_xlat14.xy,u_xlat4.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec45, 0.0);
                u_xlat9.x = u_xlat19.z * u_xlat75 + u_xlat9.x;
                vec3 txVec46 = vec3(u_xlat16.xy,u_xlat4.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec46, 0.0);
                u_xlat9.x = u_xlat19.w * u_xlat75 + u_xlat9.x;
                vec3 txVec47 = vec3(u_xlat15.xy,u_xlat4.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec47, 0.0);
                u_xlat9.x = u_xlat20.x * u_xlat75 + u_xlat9.x;
                vec3 txVec48 = vec3(u_xlat15.zw,u_xlat4.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec48, 0.0);
                u_xlat9.x = u_xlat20.y * u_xlat75 + u_xlat9.x;
                vec3 txVec49 = vec3(u_xlat58.xy,u_xlat4.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec49, 0.0);
                u_xlat9.x = u_xlat20.z * u_xlat75 + u_xlat9.x;
                vec3 txVec50 = vec3(u_xlat16.zw,u_xlat4.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec50, 0.0);
                u_xlat9.x = u_xlat20.w * u_xlat75 + u_xlat9.x;
                vec3 txVec51 = vec3(u_xlat17.xy,u_xlat4.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec51, 0.0);
                u_xlat9.x = u_xlat21.x * u_xlat75 + u_xlat9.x;
                vec3 txVec52 = vec3(u_xlat17.zw,u_xlat4.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec52, 0.0);
                u_xlat9.x = u_xlat21.y * u_xlat75 + u_xlat9.x;
                vec3 txVec53 = vec3(u_xlat31.xy,u_xlat4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec53, 0.0);
                u_xlat9.x = u_xlat21.z * u_xlat31.x + u_xlat9.x;
                vec3 txVec54 = vec3(u_xlat18.xy,u_xlat4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec54, 0.0);
                u_xlat9.x = u_xlat21.w * u_xlat31.x + u_xlat9.x;
                vec3 txVec55 = vec3(u_xlat12.xy,u_xlat4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec55, 0.0);
                u_xlat8.x = u_xlat8.x * u_xlat31.x + u_xlat9.x;
                vec3 txVec56 = vec3(u_xlat12.zw,u_xlat4.z);
                u_xlat9.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec56, 0.0);
                u_xlat8.x = u_xlat8.y * u_xlat9.x + u_xlat8.x;
                vec3 txVec57 = vec3(u_xlat55.xy,u_xlat4.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec57, 0.0);
                u_xlat8.x = u_xlat8.z * u_xlat30 + u_xlat8.x;
                vec3 txVec58 = vec3(u_xlat51.xy,u_xlat4.z);
                u_xlat51.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec58, 0.0);
                u_xlat66 = u_xlat8.w * u_xlat51.x + u_xlat8.x;
            }
        }
    } else {
    ...
    if(u_xlatb4.x){
        ...
        u_xlatb51.xy = equal(vec4(vec4(_MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat)), vec4(0.0, 1.0, 0.0, 1.0)).xy;
        u_xlat70 = (u_xlatb51.y) ? u_xlat4.w : u_xlat4.x;
        u_xlat4.xyz = (u_xlatb51.x) ? u_xlat4.xyz : vec3(u_xlat70);
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.y = float(1.0);
        u_xlat4.z = float(1.0);
    ...
    u_xlat70 = dot((-u_xlat6.xyz), u_xlat25.xyz);
    u_xlat70 = u_xlat70 + u_xlat70;
    u_xlat8.xyz = u_xlat25.xyz * (-vec3(u_xlat70)) + (-u_xlat6.xyz);
    u_xlat70 = dot(u_xlat25.xyz, u_xlat6.xyz);
    ...
    u_xlat5.xyz = u_xlat27.xyz * u_xlat2.xyz + u_xlat8.xyz;
    u_xlat66 = u_xlat66 * unity_LightData.z;
    u_xlat67 = dot(u_xlat25.xyz, _MainLightPosition.xyz);
    ...
    u_xlat66 = dot(u_xlat25.xyz, u_xlat8.xyz);
    ...
    u_xlatb51.xy = equal(vec4(vec4(_AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat)), vec4(0.0, 1.0, 0.0, 1.0)).xy;
    u_xlat8.x = float(0.0);
    u_xlat8.y = float(0.0);
    u_xlat8.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat74 = dot(_AdditionalLightsSpotDir[int(u_xlatu3)].xyz, u_xlat10.xyz);
        u_xlat74 = u_xlat74 * _AdditionalLightsAttenuation[int(u_xlatu3)].z + _AdditionalLightsAttenuation[int(u_xlatu3)].w;
        u_xlat74 = clamp(u_xlat74, 0.0, 1.0);
        u_xlat74 = u_xlat74 * u_xlat74;
        u_xlat70 = u_xlat70 * u_xlat74;
        u_xlatu74 = u_xlatu3 >> (5u & uint(0x1F));
        u_xlati75 = 1 << (int(u_xlatu3) & int(0x1F));
        u_xlati74 = int(uint(u_xlati75) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu74)]));
        if(u_xlati74 != 0) {
            u_xlati74 = int(_AdditionalLightsLightTypes[int(u_xlatu3)]);
            u_xlati75 = (u_xlati74 != 0) ? 0 : 1;
            u_xlati76 = int(u_xlatu3) << (2 & int(0x1F));
            if(u_xlati75 != 0) {
                ...
                if(u_xlati74 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu3)].xy * u_xlat55.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu3)].zw;
                } else {
            ...
            u_xlat74 = (u_xlatb51.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb51.x) ? u_xlat11.xyz : vec3(u_xlat74);
        } else {
