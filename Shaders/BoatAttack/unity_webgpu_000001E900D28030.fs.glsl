...
float u_xlat14;
    ...
    u_xlat12 = inversesqrt(u_xlat12);
    u_xlat3.xyw = u_xlat3.xyw * vec3(u_xlat12) + u_xlat2.xyz;
    ...
    u_xlat4 = (-_FaceShininess) + _OutlineShininess;
    u_xlat4 = u_xlat11 * u_xlat4 + _FaceShininess;
    ...
    u_xlat8 = texture(samplerCube(_LightTexture0, sampler_LightTexture0), u_xlat2.xyz).w;
    u_xlat4 = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), vec2(u_xlat4)).x;
    u_xlat4 = u_xlat8 * u_xlat4;
    u_xlat2.xyz = vec3(u_xlat4) * _LightColor0.xyz;
