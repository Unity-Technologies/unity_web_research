...
fn main_1() {
  ...
  let x_1166 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1170 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_1184 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1180.x, x_1180.y), x_1183);
  u_xlat18 = x_1184.w;
  let x_1186 : f32 = u_xlat18;
  u_xlat18 = ((x_1186 * 2.0f) + -1.0f);
  let x_1189 : f32 = u_xlat18;
  u_xlatb1.x = (x_1189 >= 0.0f);
  let x_1193 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1193);
  let x_1196 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1196)) + 1.0f);
  let x_1200 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1200);
  let x_1202 : f32 = u_xlat18;
  u_xlat18 = (-(x_1202) + 1.0f);
  let x_1205 : f32 = u_xlat18;
  let x_1207 : f32 = u_xlat1.x;
  u_xlat18 = (x_1205 * x_1207);
  let x_1209 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1209.x, x_1209.y, x_1209.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1212 : vec4<f32> = u_xlat0;
  let x_1215 : vec3<f32> = log2(abs(vec3<f32>(x_1212.x, x_1212.y, x_1212.z)));
  let x_1216 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1215.x, x_1215.y, x_1215.z, x_1216.w);
  let x_1218 : vec4<f32> = u_xlat2;
  let x_1220 : vec3<f32> = (vec3<f32>(x_1218.x, x_1218.y, x_1218.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1221 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1220.x, x_1220.y, x_1220.z, x_1221.w);
  let x_1223 : vec4<f32> = u_xlat2;
  let x_1225 : vec3<f32> = exp2(vec3<f32>(x_1223.x, x_1223.y, x_1223.z));
  let x_1226 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1225.x, x_1225.y, x_1225.z, x_1226.w);
  let x_1228 : vec4<f32> = u_xlat2;
  let x_1231 : vec3<f32> = ((vec3<f32>(x_1228.x, x_1228.y, x_1228.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1232 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1231.x, x_1231.y, x_1231.z, x_1232.w);
  let x_1234 : vec4<f32> = u_xlat0;
  let x_1236 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1234.x, x_1234.y, x_1234.z, x_1234.x));
  u_xlatb0 = vec3<bool>(x_1236.x, x_1236.y, x_1236.z);
  let x_1239 : bool = u_xlatb0.x;
  if (x_1239) {
  ...
  u_xlat0.x = x_1248;
  let x_1251 : bool = u_xlatb0.y;
  if (x_1251) {
    let x_1256 : f32 = u_xlat1.y;
    x_1252 = x_1256;
  } else {
  ...
  u_xlat0.y = x_1260;
  let x_1263 : bool = u_xlatb0.z;
  if (x_1263) {
    let x_1268 : f32 = u_xlat1.z;
    x_1264 = x_1268;
  } else {
    let x_1271 : f32 = u_xlat2.z;
    x_1264 = x_1271;
  }
  let x_1272 : f32 = x_1264;
  u_xlat0.z = x_1272;
  let x_1274 : f32 = u_xlat18;
  let x_1279 : vec4<f32> = u_xlat0;
  let x_1281 : vec3<f32> = ((vec3<f32>(x_1274, x_1274, x_1274) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1279.x, x_1279.y, x_1279.z));
  let x_1282 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1281.x, x_1281.y, x_1281.z, x_1282.w);
  let x_1284 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1284.x, x_1284.y, x_1284.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1287 : vec4<f32> = u_xlat0;
  let x_1289 : vec3<f32> = (vec3<f32>(x_1287.x, x_1287.y, x_1287.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1290 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1289.x, x_1289.y, x_1289.z, x_1290.w);
  let x_1292 : vec4<f32> = u_xlat2;
  let x_1294 : vec3<f32> = (vec3<f32>(x_1292.x, x_1292.y, x_1292.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1295 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1294.x, x_1294.y, x_1294.z, x_1295.w);
  let x_1297 : vec4<f32> = u_xlat2;
  let x_1300 : vec3<f32> = log2(abs(vec3<f32>(x_1297.x, x_1297.y, x_1297.z)));
  let x_1301 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1300.x, x_1300.y, x_1300.z, x_1301.w);
  let x_1303 : vec4<f32> = u_xlat2;
  let x_1305 : vec3<f32> = (vec3<f32>(x_1303.x, x_1303.y, x_1303.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1315 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1313.x, x_1313.y, x_1313.z, x_1313.x));
  ...
  let x_1358 : vec3<f32> = max(vec3<f32>(x_1355.x, x_1355.y, x_1355.z), vec3<f32>(0.0f, 0.0f, 0.0f));
