...
fn main_1() {
  ...
  let x_1554 : vec2<f32> = vs_TEXCOORD0;
  let x_1557 : vec4<f32> = x_26.x_Grain_TilingParams;
  let x_1561 : vec4<f32> = x_26.x_Grain_TilingParams;
  let x_1563 : vec2<f32> = ((x_1554 * vec2<f32>(x_1557.x, x_1557.y)) + vec2<f32>(x_1561.z, x_1561.w));
  let x_1564 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1563.x, x_1563.y, x_1564.z, x_1564.w);
  let x_1571 : vec4<f32> = u_xlat1;
  let x_1574 : f32 = x_26.x_GlobalMipBias.x;
  let x_1575 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1571.x, x_1571.y), x_1574);
  u_xlat15 = x_1575.w;
  let x_1577 : f32 = u_xlat15;
  u_xlat15 = (x_1577 + -0.5f);
  let x_1579 : f32 = u_xlat15;
  let x_1580 : f32 = u_xlat15;
  u_xlat15 = (x_1579 + x_1580);
  let x_1582 : vec3<f32> = u_xlat0;
  u_xlat1.x = dot(x_1582, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1590 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1590);
  let x_1595 : f32 = x_26.x_Grain_Params.y;
  let x_1597 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1595 * -(x_1597)) + 1.0f);
  let x_1602 : f32 = u_xlat15;
  let x_1604 : vec3<f32> = u_xlat0;
  u_xlat6 = (vec3<f32>(x_1602, x_1602, x_1602) * x_1604);
  let x_1606 : vec3<f32> = u_xlat6;
  let x_1609 : vec2<f32> = x_26.x_Grain_Params;
  u_xlat6 = (x_1606 * vec3<f32>(x_1609.x, x_1609.x, x_1609.x));
  let x_1612 : vec3<f32> = u_xlat6;
  let x_1613 : vec4<f32> = u_xlat1;
  let x_1616 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1612 * vec3<f32>(x_1613.x, x_1613.x, x_1613.x)) + x_1616);
  let x_1618 : vec3<f32> = u_xlat0;
  let x_1619 : vec3<f32> = (x_1618 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1620 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1619.x, x_1619.y, x_1619.z, x_1620.w);
  let x_1622 : vec3<f32> = u_xlat0;
  let x_1624 : vec3<f32> = log2(abs(x_1622));
  let x_1625 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1624.x, x_1624.y, x_1624.z, x_1625.w);
  let x_1627 : vec4<f32> = u_xlat2;
  let x_1629 : vec3<f32> = (vec3<f32>(x_1627.x, x_1627.y, x_1627.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1640 : vec3<f32> = ((vec3<f32>(x_1637.x, x_1637.y, x_1637.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1641 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1640.x, x_1640.y, x_1640.z, x_1641.w);
  let x_1643 : vec3<f32> = u_xlat0;
  let x_1645 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1643.x, x_1643.y, x_1643.z, x_1643.x));
  u_xlatb0 = vec3<bool>(x_1645.x, x_1645.y, x_1645.z);
  let x_1648 : bool = u_xlatb0.x;
  if (x_1648) {
  ...
  u_xlat0.z = x_1681;
  let x_1683 : vec2<f32> = vs_TEXCOORD0;
  let x_1686 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1690 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1692 : vec2<f32> = ((x_1683 * vec2<f32>(x_1686.x, x_1686.y)) + vec2<f32>(x_1690.z, x_1690.w));
  let x_1693 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1692.x, x_1692.y, x_1693.z, x_1693.w);
  let x_1700 : vec4<f32> = u_xlat1;
  let x_1703 : f32 = x_26.x_GlobalMipBias.x;
  let x_1704 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1700.x, x_1700.y), x_1703);
  u_xlat15 = x_1704.w;
  let x_1706 : f32 = u_xlat15;
  u_xlat15 = ((x_1706 * 2.0f) + -1.0f);
  let x_1709 : f32 = u_xlat15;
  u_xlatb1 = (x_1709 >= 0.0f);
  let x_1711 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1711);
  let x_1714 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1714)) + 1.0f);
  let x_1718 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1718);
  let x_1720 : f32 = u_xlat15;
  u_xlat15 = (-(x_1720) + 1.0f);
  let x_1723 : f32 = u_xlat15;
  let x_1725 : f32 = u_xlat1.x;
  u_xlat15 = (x_1723 * x_1725);
  let x_1727 : vec3<f32> = u_xlat0;
  let x_1728 : vec3<f32> = (x_1727 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1729 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1728.x, x_1728.y, x_1728.z, x_1729.w);
  let x_1731 : vec3<f32> = u_xlat0;
  let x_1733 : vec3<f32> = log2(abs(x_1731));
  let x_1734 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1733.x, x_1733.y, x_1733.z, x_1734.w);
  let x_1736 : vec4<f32> = u_xlat2;
  let x_1738 : vec3<f32> = (vec3<f32>(x_1736.x, x_1736.y, x_1736.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1749 : vec3<f32> = ((vec3<f32>(x_1746.x, x_1746.y, x_1746.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1750 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1749.x, x_1749.y, x_1749.z, x_1750.w);
  let x_1752 : vec3<f32> = u_xlat0;
  let x_1754 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1752.x, x_1752.y, x_1752.z, x_1752.x));
  u_xlatb0 = vec3<bool>(x_1754.x, x_1754.y, x_1754.z);
  let x_1757 : bool = u_xlatb0.x;
  if (x_1757) {
  ...
  u_xlat0.x = x_1766;
  let x_1769 : bool = u_xlatb0.y;
  if (x_1769) {
    let x_1774 : f32 = u_xlat1.y;
    x_1770 = x_1774;
  } else {
  ...
  u_xlat0.y = x_1778;
  let x_1781 : bool = u_xlatb0.z;
  if (x_1781) {
    let x_1786 : f32 = u_xlat1.z;
    x_1782 = x_1786;
  } else {
  ...
  u_xlat0.z = x_1790;
  let x_1792 : f32 = u_xlat15;
  let x_1797 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1792, x_1792, x_1792) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1797);
  let x_1799 : vec3<f32> = u_xlat0;
  let x_1800 : vec3<f32> = (x_1799 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1801 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1800.x, x_1800.y, x_1800.z, x_1801.w);
  let x_1803 : vec3<f32> = u_xlat0;
  let x_1804 : vec3<f32> = (x_1803 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1805 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1804.x, x_1804.y, x_1804.z, x_1805.w);
  let x_1807 : vec4<f32> = u_xlat2;
  let x_1809 : vec3<f32> = (vec3<f32>(x_1807.x, x_1807.y, x_1807.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1810 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1809.x, x_1809.y, x_1809.z, x_1810.w);
  let x_1812 : vec4<f32> = u_xlat2;
  let x_1815 : vec3<f32> = log2(abs(vec3<f32>(x_1812.x, x_1812.y, x_1812.z)));
  let x_1816 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1815.x, x_1815.y, x_1815.z, x_1816.w);
  let x_1818 : vec4<f32> = u_xlat2;
  let x_1820 : vec3<f32> = (vec3<f32>(x_1818.x, x_1818.y, x_1818.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1821 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1820.x, x_1820.y, x_1820.z, x_1821.w);
  let x_1823 : vec4<f32> = u_xlat2;
  let x_1825 : vec3<f32> = exp2(vec3<f32>(x_1823.x, x_1823.y, x_1823.z));
  let x_1826 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1825.x, x_1825.y, x_1825.z, x_1826.w);
  let x_1828 : vec3<f32> = u_xlat0;
  let x_1830 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1828.x, x_1828.y, x_1828.z, x_1828.x));
  u_xlatb0 = vec3<bool>(x_1830.x, x_1830.y, x_1830.z);
  let x_1833 : bool = u_xlatb0.x;
  if (x_1833) {
    let x_1838 : f32 = u_xlat1.x;
    x_1834 = x_1838;
  } else {
    let x_1841 : f32 = u_xlat2.x;
    x_1834 = x_1841;
  }
  let x_1842 : f32 = x_1834;
  u_xlat0.x = x_1842;
  let x_1845 : bool = u_xlatb0.y;
  if (x_1845) {
    let x_1850 : f32 = u_xlat1.y;
    x_1846 = x_1850;
  } else {
    let x_1853 : f32 = u_xlat2.y;
    x_1846 = x_1853;
  }
  let x_1854 : f32 = x_1846;
  u_xlat0.y = x_1854;
  let x_1857 : bool = u_xlatb0.z;
  if (x_1857) {
    let x_1862 : f32 = u_xlat1.z;
    x_1858 = x_1862;
  } else {
    let x_1865 : f32 = u_xlat2.z;
    x_1858 = x_1865;
  }
  let x_1866 : f32 = x_1858;
  u_xlat0.z = x_1866;
  let x_1870 : vec3<f32> = u_xlat0;
  let x_1871 : vec3<f32> = max(x_1870, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1872 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1871.x, x_1871.y, x_1871.z, x_1872.w);
  SV_Target0.w = 1.0f;
  return;
}
