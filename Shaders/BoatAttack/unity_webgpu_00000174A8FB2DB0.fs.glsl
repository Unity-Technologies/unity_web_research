...
bool u_xlatb24;
    ...
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.106250003, 0.106250003, 0.106250003) + u_xlat2.xyz;
...
;
    ...
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.125, 0.125, 0.125) + u_xlat2.xyz;
    u_xlat10.xz = u_xlat3.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat3.xx + u_xlat10.xz;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat3.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.200000003, 0.200000003, 0.200000003) + u_xlat2.xyz;
    u_xlat10.xz = u_xlat3.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat3.xx + u_xlat10.xz;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat3.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat4.xyz = vec3(u_xlat23) * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz * _SSAOParams.yyy;
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.256250024, 0.256250024, 0.256250024) + u_xlat2.xyz;
    u_xlat3.xy = u_xlat4.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat4.xx + u_xlat3.xy;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat4.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat4.xyz = vec3(u_xlat23) * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz * _SSAOParams.yyy;
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.40625003, 0.40625003, 0.40625003) + u_xlat2.xyz;
    u_xlat3.xy = u_xlat4.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat4.xx + u_xlat3.xy;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat4.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat4.xyz = vec3(u_xlat23) * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz * _SSAOParams.yyy;
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.606249988, 0.606249988, 0.606249988) + u_xlat2.xyz;
    u_xlat3.xy = u_xlat4.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat4.xx + u_xlat3.xy;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat4.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat3.xyz = vec3(u_xlat23) * u_xlat4.xyz;
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.725000083, 0.725000083, 0.725000083) + u_xlat2.xyz;
    u_xlat10.xz = u_xlat3.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat3.xx + u_xlat10.xz;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat3.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.856249988, 0.856249988, 0.856249988) + u_xlat2.xyz;
