...
fn main_1() {
  ...
  let x_361 : vec4<f32> = x_291.unity_FogColor;
  let x_364 : vec3<f32> = ((vec3<f32>(x_355.x, x_355.y, x_355.z) * vec3<f32>(x_357.x, x_357.y, x_357.z)) + -(vec3<f32>(x_361.x, x_361.y, x_361.z)));
  let x_365 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_364.x, x_364.y, x_364.z, x_365.w);
  let x_370 : f32 = u_xlat1.w;
  SV_Target0.w = x_370;
  let x_376 : f32 = vs_TEXCOORD3.w;
  let x_378 : f32 = vs_TEXCOORD3.w;
  u_xlat6 = (x_376 * -(x_378));
  let x_381 : f32 = u_xlat6;
  u_xlat6 = exp2(x_381);
  let x_383 : f32 = u_xlat6;
  let x_385 : vec4<f32> = u_xlat0;
  let x_389 : vec4<f32> = x_291.unity_FogColor;
  let x_391 : vec3<f32> = ((vec3<f32>(x_383, x_383, x_383) * vec3<f32>(x_385.x, x_385.y, x_385.z)) + vec3<f32>(x_389.x, x_389.y, x_389.z));
