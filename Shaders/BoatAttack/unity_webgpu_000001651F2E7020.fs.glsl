...
;
    ...
    u_xlat27.xyz = (u_xlatb23.x) ? u_xlat27.xyz : u_xlat6.xyz;
    ...
    u_xlat7.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP5.xy, _GlobalMipBias.x).xyz;
    u_xlat6.xyz = u_xlat6.xyz + vec3(-0.5, -0.5, -0.5);
    u_xlat67 = dot(u_xlat25.xyz, u_xlat6.xyz);
    u_xlat67 = u_xlat67 + 0.5;
    u_xlat6.xyz = vec3(u_xlat67) * u_xlat7.xyz;
    u_xlat67 = max(u_xlat6.w, 9.99999975e-05);
    u_xlat6.xyz = u_xlat6.xyz / vec3(u_xlat67);
    u_xlat7.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat7.xy = u_xlat7.xy * hlslcc_FragCoord.xy;
    u_xlat67 = u_xlat7.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat7.z = (-u_xlat67) + 1.0;
    u_xlat3.x = u_xlat3.x;
    ...
    u_xlat72 = u_xlat68 * u_xlat68;
    u_xlat3.x = u_xlat3.x + 0.0400000215;
    u_xlat3.x = min(u_xlat3.x, 1.0);
    u_xlat29.x = u_xlat68 * 4.0 + 2.0;
    ...
    if(u_xlatb66){
        ...
        if(u_xlatb66){
            ...
            if(u_xlatb73){
                ...
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec35, 0.0);
                u_xlat30 = u_xlat30 * u_xlat15.y;
                u_xlat8.x = u_xlat15.x * u_xlat8.x + u_xlat30;
                vec3 txVec36 = vec3(u_xlat52.xy,u_xlat4.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec36, 0.0);
                u_xlat8.x = u_xlat15.z * u_xlat30 + u_xlat8.x;
                vec3 txVec37 = vec3(u_xlat11.xy,u_xlat4.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec37, 0.0);
                u_xlat8.x = u_xlat15.w * u_xlat30 + u_xlat8.x;
                vec3 txVec38 = vec3(u_xlat13.xy,u_xlat4.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec38, 0.0);
                u_xlat8.x = u_xlat16.x * u_xlat30 + u_xlat8.x;
                vec3 txVec39 = vec3(u_xlat13.zw,u_xlat4.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec39, 0.0);
                u_xlat8.x = u_xlat16.y * u_xlat30 + u_xlat8.x;
                vec3 txVec40 = vec3(u_xlat11.zw,u_xlat4.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec40, 0.0);
                u_xlat8.x = u_xlat16.z * u_xlat30 + u_xlat8.x;
                vec3 txVec41 = vec3(u_xlat10.xy,u_xlat4.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec41, 0.0);
                u_xlat8.x = u_xlat16.w * u_xlat30 + u_xlat8.x;
                vec3 txVec42 = vec3(u_xlat10.zw,u_xlat4.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec42, 0.0);
                u_xlat66 = u_xlat73 * u_xlat30 + u_xlat8.x;
            } else {
                u_xlat8.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat8.xy = floor(u_xlat8.xy);
                u_xlat52.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat8.xy);
    ...
    u_xlat4.xyz = u_xlat51.xxx * u_xlat4.xyz;
    u_xlat70 = dot((-u_xlat27.xyz), u_xlat25.xyz);
    u_xlat70 = u_xlat70 + u_xlat70;
    u_xlat8.xyz = u_xlat25.xyz * (-vec3(u_xlat70)) + (-u_xlat27.xyz);
    u_xlat70 = dot(u_xlat25.xyz, u_xlat27.xyz);
    u_xlat70 = clamp(u_xlat70, 0.0, 1.0);
    u_xlat70 = (-u_xlat70) + 1.0;
    u_xlat70 = u_xlat70 * u_xlat70;
    u_xlat70 = u_xlat70 * u_xlat70;
    u_xlat5.x = (-u_xlat67) * 0.699999988 + 1.70000005;
    u_xlat67 = u_xlat67 * u_xlat5.x;
    u_xlat67 = u_xlat67 * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat67);
    ...
    u_xlat9.xy = vec2(u_xlat68) * vec2(u_xlat68) + vec2(-1.0, 1.0);
    u_xlat67 = float(1.0) / u_xlat9.y;
    u_xlat68 = u_xlat3.x + -0.0399999991;
    u_xlat68 = u_xlat70 * u_xlat68 + 0.0399999991;
    ...
    u_xlat8.xyz = u_xlat27.xyz + _MainLightPosition.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat68 = dot(unity_LightIndices[int(u_xlatu68)], uintBitsToFloat(ImmCB_0[u_xlati3]));
        u_xlatu68 =  uint(int(u_xlat68));
        u_xlat10.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu68)].www + _AdditionalLightsPosition[int(u_xlatu68)].xyz;
        u_xlat3.x = dot(u_xlat10.xyz, u_xlat10.xyz);
        u_xlat3.x = max(u_xlat3.x, 6.10351562e-05);
        u_xlat70 = inversesqrt(u_xlat3.x);
        u_xlat11.xyz = vec3(u_xlat70) * u_xlat10.xyz;
        u_xlat5.x = float(1.0) / float(u_xlat3.x);
        u_xlat3.x = u_xlat3.x * _AdditionalLightsAttenuation[int(u_xlatu68)].x;
        u_xlat3.x = (-u_xlat3.x) * u_xlat3.x + 1.0;
        u_xlat3.x = max(u_xlat3.x, 0.0);
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat3.x = u_xlat3.x * u_xlat5.x;
        u_xlat5.x = dot(_AdditionalLightsSpotDir[int(u_xlatu68)].xyz, u_xlat11.xyz);
        u_xlat5.x = u_xlat5.x * _AdditionalLightsAttenuation[int(u_xlatu68)].z + _AdditionalLightsAttenuation[int(u_xlatu68)].w;
        u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
        u_xlat5.x = u_xlat5.x * u_xlat5.x;
        u_xlat3.x = u_xlat3.x * u_xlat5.x;
        u_xlatu5 = u_xlatu68 >> (5u & uint(0x1F));
        u_xlati73 = 1 << (int(u_xlatu68) & int(0x1F));
        u_xlati5 = int(uint(u_xlati73) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu5)]));
        if(u_xlati5 != 0) {
            u_xlati5 = int(_AdditionalLightsLightTypes[int(u_xlatu68)]);
            u_xlati73 = (u_xlati5 != 0) ? 0 : 1;
            u_xlati52 = int(u_xlatu68) << (2 & int(0x1F));
            if(u_xlati73 != 0) {
                ...
                u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].zw;
            } else {
                u_xlatb5 = u_xlati5==1;
                u_xlati5 = u_xlatb5 ? 1 : int(0);
                if(u_xlati5 != 0) {
                    ...
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].xy * u_xlat56.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].zw;
                } else {
                    ...
                    u_xlat5.x = dot(abs(u_xlat13.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat5.x = max(u_xlat5.x, 9.99999997e-07);
                    u_xlat5.x = float(1.0) / float(u_xlat5.x);
                    u_xlat14.xyz = u_xlat5.xxx * u_xlat13.zxy;
                    ...
                    u_xlat52.xy = u_xlat13.xy * u_xlat5.xx + u_xlat52.xy;
                    u_xlat52.xy = u_xlat52.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat52.xy = clamp(u_xlat52.xy, 0.0, 1.0);
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].xy * u_xlat52.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].zw;
                }
            }
            ...
            u_xlat5.x = (u_xlatb8.y) ? u_xlat12.w : u_xlat12.x;
            u_xlat12.xyz = (u_xlatb8.x) ? u_xlat12.xyz : u_xlat5.xxx;
        } else {
            u_xlat12.x = float(1.0);
            u_xlat12.y = float(1.0);
            u_xlat12.z = float(1.0);
        }
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[int(u_xlatu68)].xyz;
        u_xlat12.xyz = u_xlat51.xxx * u_xlat12.xyz;
        u_xlat68 = dot(u_xlat25.xyz, u_xlat11.xyz);
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
        u_xlat68 = u_xlat68 * u_xlat3.x;
        u_xlat12.xyz = vec3(u_xlat68) * u_xlat12.xyz;
        u_xlat10.xyz = u_xlat10.xyz * vec3(u_xlat70) + u_xlat27.xyz;
        ...
        u_xlat68 = dot(u_xlat25.xyz, u_xlat10.xyz);
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
        ...
        u_xlat68 = u_xlat68 * u_xlat3.x;
        u_xlat68 = u_xlat29.x * u_xlat68;
        u_xlat68 = u_xlat72 / u_xlat68;
        u_xlat10.xyz = vec3(u_xlat68) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat31.xyz = u_xlat10.xyz * u_xlat12.xyz + u_xlat31.xyz;
    }
    u_xlat2.xyz = u_xlat6.xyz * u_xlat7.xxx + u_xlat4.xyz;
    u_xlat2.xyz = u_xlat31.xyz + u_xlat2.xyz;
    u_xlat0.xyz = vs_INTERP4.www * u_xlat0.xyz + u_xlat2.xyz;
    u_xlat66 = u_xlat23.x * (-u_xlat23.x);
