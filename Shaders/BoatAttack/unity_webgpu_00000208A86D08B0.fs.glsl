...
;
    ...
    u_xlat5.yzw = max(u_xlat12.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat12.x = dot(u_xlat5, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat12.x = (-u_xlat12.x) + 4.0;
    u_xlatu12 = uint(u_xlat12.x);
    u_xlati12 = int(u_xlatu12) << (2 & int(0x1F));
    u_xlat4.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati12 + 1) / 4][(u_xlati12 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati12 / 4][u_xlati12 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati12 + 2) / 4][(u_xlati12 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat4.xyz;
    u_xlat12.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati12 + 3) / 4][(u_xlati12 + 3) % 4].xyz;
    u_xlat2.w = 1.0;
    ...
    u_xlat8.xyz = u_xlat2.xyz * (-vec3(u_xlat23)) + (-u_xlat3.xyz);
    ...
    u_xlat12.xyz = vec3(u_xlat33) * u_xlat7.xyz;
    ...
    u_xlat0.xyz = u_xlat4.xyz * u_xlat5.xxx + u_xlat12.xyz;
