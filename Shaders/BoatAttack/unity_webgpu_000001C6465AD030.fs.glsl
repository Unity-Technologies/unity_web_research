...
;
    ...
    u_xlat8.xyz = u_xlat3.xyz * (-vec3(u_xlat25)) + (-u_xlat2.xyz);
    ...
    u_xlat9.xyz = vec3(u_xlat25) * u_xlat9.xyz + u_xlat0.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu65 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati69].www + _AdditionalLightsPosition[u_xlati69].xyz;
        ...
        u_xlat72 = dot(_AdditionalLightsSpotDir[u_xlati69].xyz, u_xlat9.xyz);
        ...
        u_xlat70 = u_xlat70 * u_xlat72;
        u_xlat10.xyz = vec3(u_xlat48) * _AdditionalLightsColor[u_xlati69].xyz;
        ...
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat71) + u_xlat2.xyz;
        ...
        u_xlat69 = dot(u_xlat3.xyz, u_xlat8.xyz);
        u_xlat69 = clamp(u_xlat69, 0.0, 1.0);
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat69) + u_xlat22.xyz;
