...
fn main_1() {
  ...
  let x_99 : vec2<f32> = (vec2<f32>(x_94.y, x_94.x) + vec2<f32>(-0.872539997f, 0.531369984f));
  let x_100 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_99.x, x_99.y, x_100.z);
  let x_102 : vec3<f32> = u_xlat1;
  u_xlat0 = ((x_102 * vec3<f32>(0.305306017f, 0.305306017f, 0.305306017f)) + vec3<f32>(0.682171106f, 0.682171106f, 0.682171106f));
  let x_109 : vec3<f32> = u_xlat1;
  let x_110 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_109 * x_110) + vec3<f32>(0.012522878f, 0.012522878f, 0.012522878f));
