...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat45 = dot(u_xlat4, vec4(1.0, 1.0, 1.0, 1.0));
    ...
    u_xlat46 = dot(u_xlat4, vec4(1.0, 1.0, 1.0, 1.0));
    ...
    u_xlat7.z = max(u_xlat46, 1.00000002e-16);
    ...
    u_xlat46 = (-u_xlat46) + 1.0;
    u_xlat46 = sqrt(u_xlat46);
    u_xlat8.z = max(u_xlat46, 1.00000002e-16);
    ...
    u_xlat46 = dot(u_xlat6.xyw, u_xlat6.xyw);
    u_xlat46 = inversesqrt(u_xlat46);
    u_xlat6.xyz = vec3(u_xlat46) * u_xlat6.xyw;
...
;
    ...
    u_xlat17.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati2 + 1) / 4][(u_xlati2 + 1) % 4].xyz;
    u_xlat17.xyz = _MainLightWorldToShadow[u_xlati2 / 4][u_xlati2 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat17.xyz;
    u_xlat17.xyz = _MainLightWorldToShadow[(u_xlati2 + 2) / 4][(u_xlati2 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat17.xyz;
    u_xlat2.xyz = u_xlat17.xyz + _MainLightWorldToShadow[(u_xlati2 + 3) / 4][(u_xlati2 + 3) % 4].xyz;
    u_xlat47 = vs_TEXCOORD7.y * unity_MatrixV[1].z;
    u_xlat47 = unity_MatrixV[0].z * vs_TEXCOORD7.x + u_xlat47;
    u_xlat47 = unity_MatrixV[2].z * vs_TEXCOORD7.z + u_xlat47;
    u_xlat47 = u_xlat47 + unity_MatrixV[3].z;
    ...
    u_xlat46 = u_xlat1.x * u_xlat1.x + (-u_xlat46);
    u_xlat4.xyz = unity_SHC.xyz * vec3(u_xlat46) + u_xlat6.xyz;
    u_xlat3.xyz = u_xlat3.xyz + u_xlat4.xyz;
    u_xlat3.xyz = max(u_xlat3.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat4.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat4.xy = u_xlat4.xy * hlslcc_FragCoord.xy;
    u_xlat46 = u_xlat4.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat4.z = (-u_xlat46) + 1.0;
    u_xlat46 = (-u_xlat0.x) * 0.959999979 + 0.959999979;
    ...
    u_xlat15 = min(u_xlat15, u_xlat4.x);
    ...
    u_xlatb17.x = 0.0>=u_xlat2.z;
    u_xlatb32 = u_xlat2.z>=1.0;
    u_xlatb17.x = u_xlatb32 || u_xlatb17.x;
    u_xlat2.x = (u_xlatb17.x) ? 1.0 : u_xlat2.x;
    ...
    u_xlat2.x = u_xlat17.x * u_xlat32 + u_xlat2.x;
    ...
    if(u_xlatb17.x){
        ...
        u_xlat32 = (u_xlatb17.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb17.x) ? u_xlat7.xyz : vec3(u_xlat32);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat17.x = dot((-u_xlat8.xyz), u_xlat1.xyz);
    u_xlat17.x = u_xlat17.x + u_xlat17.x;
    u_xlat9.xyz = u_xlat1.xyz * (-u_xlat17.xxx) + (-u_xlat8.xyz);
    u_xlat17.x = dot(u_xlat1.xyz, u_xlat8.xyz);
    u_xlat17.x = clamp(u_xlat17.x, 0.0, 1.0);
    u_xlat17.x = (-u_xlat17.x) + 1.0;
    u_xlat17.x = u_xlat17.x * u_xlat17.x;
    u_xlat17.x = u_xlat17.x * u_xlat17.x;
    u_xlat32 = (-u_xlat0.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat4.xw = vec2(u_xlat46) * vec2(u_xlat46) + vec2(-1.0, 1.0);
    u_xlat0.x = float(1.0) / u_xlat4.w;
    u_xlat10.xyz = (-u_xlat5.xyz) + vec3(u_xlat30);
    u_xlat10.xyz = u_xlat17.xxx * u_xlat10.xyz + u_xlat5.xyz;
    ...
    u_xlat30 = max(u_xlat0.z, 0.100000001);
    u_xlat0.x = u_xlat30 * u_xlat0.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu46)].www + _AdditionalLightsPosition[int(u_xlatu46)].xyz;
        ...
        u_xlat51 = dot(_AdditionalLightsSpotDir[int(u_xlatu46)].xyz, u_xlat11.xyz);
        ...
        u_xlati37 = 1 << (int(u_xlatu46) & int(0x1F));
        u_xlati51 = int(uint(u_xlati37) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu51)]));
        if(u_xlati51 != 0) {
            u_xlati51 = int(_AdditionalLightsLightTypes[int(u_xlatu46)]);
            u_xlati37 = (u_xlati51 != 0) ? 0 : 1;
            u_xlati52 = int(u_xlatu46) << (2 & int(0x1F));
            if(u_xlati37 != 0) {
                u_xlat12.xyz = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati52 + 1) / 4][(u_xlati52 + 1) % 4].xyw;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[u_xlati52 / 4][u_xlati52 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat12.xyz;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[(u_xlati52 + 2) / 4][(u_xlati52 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat12.xyz;
                u_xlat12.xyz = u_xlat12.xyz + _AdditionalLightsWorldToLights[(u_xlati52 + 3) / 4][(u_xlati52 + 3) % 4].xyw;
                u_xlat12.xy = u_xlat12.xy / u_xlat12.zz;
                u_xlat12.xy = u_xlat12.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat12.xy = clamp(u_xlat12.xy, 0.0, 1.0);
                u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu46)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu46)].zw;
            } else {
                u_xlatb51 = u_xlati51==1;
                u_xlati51 = u_xlatb51 ? 1 : int(0);
                if(u_xlati51 != 0) {
                    u_xlat42.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati52 + 1) / 4][(u_xlati52 + 1) % 4].xy;
                    u_xlat42.xy = _AdditionalLightsWorldToLights[u_xlati52 / 4][u_xlati52 % 4].xy * vs_TEXCOORD7.xx + u_xlat42.xy;
                    u_xlat42.xy = _AdditionalLightsWorldToLights[(u_xlati52 + 2) / 4][(u_xlati52 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat42.xy;
                    u_xlat42.xy = u_xlat42.xy + _AdditionalLightsWorldToLights[(u_xlati52 + 3) / 4][(u_xlati52 + 3) % 4].xy;
                    u_xlat42.xy = u_xlat42.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat42.xy = fract(u_xlat42.xy);
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu46)].xy * u_xlat42.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu46)].zw;
                } else {
                    u_xlat13 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToLights[(u_xlati52 + 1) / 4][(u_xlati52 + 1) % 4];
                    u_xlat13 = _AdditionalLightsWorldToLights[u_xlati52 / 4][u_xlati52 % 4] * vs_TEXCOORD7.xxxx + u_xlat13;
                    u_xlat13 = _AdditionalLightsWorldToLights[(u_xlati52 + 2) / 4][(u_xlati52 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat13;
                    ...
                    u_xlatb37.xy = greaterThanEqual(u_xlat14.yzyz, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    u_xlat37.x = (u_xlatb37.x) ? u_xlat14.x : (-u_xlat14.x);
                    u_xlat37.y = (u_xlatb37.y) ? u_xlat14.x : (-u_xlat14.x);
                    u_xlat37.xy = u_xlat13.xy * vec2(u_xlat51) + u_xlat37.xy;
                    u_xlat37.xy = u_xlat37.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat37.xy = clamp(u_xlat37.xy, 0.0, 1.0);
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu46)].xy * u_xlat37.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu46)].zw;
                }
            }
            ...
            u_xlat51 = (u_xlatb7.y) ? u_xlat12.w : u_xlat12.x;
            u_xlat12.xyz = (u_xlatb7.x) ? u_xlat12.xyz : vec3(u_xlat51);
        } else {
            u_xlat12.x = float(1.0);
            u_xlat12.y = float(1.0);
            u_xlat12.z = float(1.0);
        }
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[int(u_xlatu46)].xyz;
        u_xlat12.xyz = vec3(u_xlat34) * u_xlat12.xyz;
        u_xlat46 = dot(u_xlat1.xyz, u_xlat11.xyz);
        u_xlat46 = clamp(u_xlat46, 0.0, 1.0);
        u_xlat46 = u_xlat46 * u_xlat49;
        u_xlat12.xyz = vec3(u_xlat46) * u_xlat12.xyz;
        u_xlat10.xyz = u_xlat10.xyz * vec3(u_xlat50) + u_xlat8.xyz;
        ...
        u_xlat10.xyz = u_xlat5.xyz * vec3(u_xlat46) + u_xlat6.xyz;
        u_xlat9.xyz = u_xlat10.xyz * u_xlat12.xyz + u_xlat9.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat15) + u_xlat2.xyz;
    u_xlat0.xyz = u_xlat9.xyz + u_xlat0.xyz;
    u_xlat1.x = u_xlat47 * (-u_xlat47);
    u_xlat1.x = exp2(u_xlat1.x);
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat45) + (-unity_FogColor.xyz);
