...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlatb62 = 0.00499999989>=u_xlat61;
    if(((int(u_xlatb62) * int(0xffffffffu)))!=0){discard;}
    ...
    u_xlat22.xyz = unity_SHC.xyz * vec3(u_xlat61) + u_xlat6.xyz;
    ...
    u_xlat61 = u_xlat3.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat3.z = (-u_xlat61) + 1.0;
    u_xlat61 = (-u_xlat0.x) * 0.959999979 + 0.959999979;
    u_xlat23 = (-u_xlat61) + 1.0;
    ...
    u_xlat40 = u_xlat40 + u_xlat23;
    u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
    u_xlat23 = u_xlat61 * 4.0 + 2.0;
    ...
    u_xlatb64 = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb64){
        ...
        u_xlat64 = (u_xlatb7.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb7.x) ? u_xlat6.xyz : vec3(u_xlat64);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat9.xy = vec2(u_xlat61) * vec2(u_xlat61) + vec2(-1.0, 1.0);
    u_xlat0.x = float(1.0) / u_xlat9.y;
    u_xlat29.xyz = (-u_xlat5.xyz) + vec3(u_xlat40);
    u_xlat29.xyz = vec3(u_xlat64) * u_xlat29.xyz + u_xlat5.xyz;
    u_xlat29.xyz = u_xlat0.xxx * u_xlat29.xyz;
    u_xlat8.xyz = u_xlat8.xyz * u_xlat29.xyz;
    u_xlat22.xyz = u_xlat22.xyz * u_xlat4.xyz + u_xlat8.xyz;
    ...
    u_xlat40 = max(u_xlat0.z, 0.100000001);
    u_xlat0.x = u_xlat40 * u_xlat0.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat61 = dot(unity_LightIndices[int(u_xlatu61)], uintBitsToFloat(ImmCB_0[u_xlati3]));
        u_xlatu61 =  uint(int(u_xlat61));
        u_xlat10.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu61)].www + _AdditionalLightsPosition[int(u_xlatu61)].xyz;
        u_xlat3.x = dot(u_xlat10.xyz, u_xlat10.xyz);
        u_xlat3.x = max(u_xlat3.x, 6.10351562e-05);
        u_xlat64 = inversesqrt(u_xlat3.x);
        u_xlat11.xyz = vec3(u_xlat64) * u_xlat10.xyz;
        u_xlat65 = float(1.0) / float(u_xlat3.x);
        u_xlat3.x = u_xlat3.x * _AdditionalLightsAttenuation[int(u_xlatu61)].x;
        u_xlat3.x = (-u_xlat3.x) * u_xlat3.x + 1.0;
        u_xlat3.x = max(u_xlat3.x, 0.0);
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat3.x = u_xlat3.x * u_xlat65;
        u_xlat65 = dot(_AdditionalLightsSpotDir[int(u_xlatu61)].xyz, u_xlat11.xyz);
        u_xlat65 = u_xlat65 * _AdditionalLightsAttenuation[int(u_xlatu61)].z + _AdditionalLightsAttenuation[int(u_xlatu61)].w;
        u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat3.x = u_xlat3.x * u_xlat65;
        u_xlatu65 = u_xlatu61 >> (5u & uint(0x1F));
        u_xlati66 = 1 << (int(u_xlatu61) & int(0x1F));
        u_xlati65 = int(uint(u_xlati66) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu65)]));
        if(u_xlati65 != 0) {
            u_xlati65 = int(_AdditionalLightsLightTypes[int(u_xlatu61)]);
            u_xlati66 = (u_xlati65 != 0) ? 0 : 1;
            u_xlati67 = int(u_xlatu61) << (2 & int(0x1F));
            if(u_xlati66 != 0) {
                u_xlat12.xyz = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati67 + 1) / 4][(u_xlati67 + 1) % 4].xyw;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[u_xlati67 / 4][u_xlati67 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat12.xyz;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[(u_xlati67 + 2) / 4][(u_xlati67 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat12.xyz;
                u_xlat12.xyz = u_xlat12.xyz + _AdditionalLightsWorldToLights[(u_xlati67 + 3) / 4][(u_xlati67 + 3) % 4].xyw;
                u_xlat48.xy = u_xlat12.xy / u_xlat12.zz;
                u_xlat48.xy = u_xlat48.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat48.xy = clamp(u_xlat48.xy, 0.0, 1.0);
                u_xlat48.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu61)].xy * u_xlat48.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu61)].zw;
            } else {
                u_xlatb65 = u_xlati65==1;
                u_xlati65 = u_xlatb65 ? 1 : int(0);
                if(u_xlati65 != 0) {
                    u_xlat12.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati67 + 1) / 4][(u_xlati67 + 1) % 4].xy;
                    u_xlat12.xy = _AdditionalLightsWorldToLights[u_xlati67 / 4][u_xlati67 % 4].xy * vs_TEXCOORD7.xx + u_xlat12.xy;
                    u_xlat12.xy = _AdditionalLightsWorldToLights[(u_xlati67 + 2) / 4][(u_xlati67 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat12.xy;
                    u_xlat12.xy = u_xlat12.xy + _AdditionalLightsWorldToLights[(u_xlati67 + 3) / 4][(u_xlati67 + 3) % 4].xy;
                    u_xlat12.xy = u_xlat12.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat12.xy = fract(u_xlat12.xy);
                    u_xlat48.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu61)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu61)].zw;
                } else {
                    u_xlat12 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToLights[(u_xlati67 + 1) / 4][(u_xlati67 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati67 / 4][u_xlati67 % 4] * vs_TEXCOORD7.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati67 + 2) / 4][(u_xlati67 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat12;
                    ...
                    u_xlat65 = dot(abs(u_xlat12.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat65 = max(u_xlat65, 9.99999997e-07);
                    u_xlat65 = float(1.0) / float(u_xlat65);
                    u_xlat13.xyz = vec3(u_xlat65) * u_xlat12.zxy;
                    u_xlat13.x = (-u_xlat13.x);
                    u_xlat13.x = clamp(u_xlat13.x, 0.0, 1.0);
                    u_xlatb52.xy = greaterThanEqual(u_xlat13.yzyz, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    u_xlat52.x = (u_xlatb52.x) ? u_xlat13.x : (-u_xlat13.x);
                    u_xlat52.y = (u_xlatb52.y) ? u_xlat13.x : (-u_xlat13.x);
                    u_xlat12.xy = u_xlat12.xy * vec2(u_xlat65) + u_xlat52.xy;
                    u_xlat12.xy = u_xlat12.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat12.xy = clamp(u_xlat12.xy, 0.0, 1.0);
                    u_xlat48.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu61)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu61)].zw;
                }
            }
            u_xlat12 = texture(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_AdditionalLightsCookieAtlasTexture), u_xlat48.xy, _GlobalMipBias.x);
            u_xlat65 = (u_xlatb8.y) ? u_xlat12.w : u_xlat12.x;
            u_xlat12.xyz = (u_xlatb8.x) ? u_xlat12.xyz : vec3(u_xlat65);
        } else {
            u_xlat12.x = float(1.0);
            u_xlat12.y = float(1.0);
            u_xlat12.z = float(1.0);
        }
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[int(u_xlatu61)].xyz;
        u_xlat12.xyz = vec3(u_xlat43) * u_xlat12.xyz;
        u_xlat61 = dot(u_xlat1.xyz, u_xlat11.xyz);
        u_xlat61 = clamp(u_xlat61, 0.0, 1.0);
        u_xlat61 = u_xlat61 * u_xlat3.x;
        u_xlat12.xyz = vec3(u_xlat61) * u_xlat12.xyz;
        u_xlat10.xyz = u_xlat10.xyz * vec3(u_xlat64) + u_xlat7.xyz;
        u_xlat61 = dot(u_xlat10.xyz, u_xlat10.xyz);
        u_xlat61 = max(u_xlat61, 1.17549435e-37);
        u_xlat61 = inversesqrt(u_xlat61);
        u_xlat10.xyz = vec3(u_xlat61) * u_xlat10.xyz;
        u_xlat61 = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat61 = clamp(u_xlat61, 0.0, 1.0);
        u_xlat3.x = dot(u_xlat11.xyz, u_xlat10.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        u_xlat61 = u_xlat61 * u_xlat61;
        u_xlat61 = u_xlat61 * u_xlat9.x + 1.00001001;
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat61 = u_xlat61 * u_xlat61;
        u_xlat3.x = max(u_xlat3.x, 0.100000001);
        u_xlat61 = u_xlat61 * u_xlat3.x;
        u_xlat61 = u_xlat23 * u_xlat61;
        u_xlat61 = u_xlat63 / u_xlat61;
        u_xlat10.xyz = u_xlat5.xyz * vec3(u_xlat61) + u_xlat4.xyz;
        u_xlat29.xyz = u_xlat10.xyz * u_xlat12.xyz + u_xlat29.xyz;
    }
    u_xlat0.xyz = u_xlat22.xyz * vec3(u_xlat20) + u_xlat6.xyz;
    u_xlat0.xyz = u_xlat29.xyz + u_xlat0.xyz;
    u_xlat0.xyz = vec3(u_xlat60) * u_xlat0.xyz;
    u_xlat60 = u_xlat2.x * (-u_xlat2.x);
    u_xlat60 = exp2(u_xlat60);
    SV_Target0.xyz = u_xlat0.xyz * vec3(u_xlat60);
    SV_Target0.w = 1.0;
    return;
}
