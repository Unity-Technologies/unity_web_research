...
fn main_1() {
  ...
  let x_2276 : vec3<f32> = u_xlat8;
  let x_2277 : vec4<f32> = u_xlat1;
  let x_2280 : vec4<f32> = u_xlat0;
  let x_2282 : vec3<f32> = ((x_2276 * vec3<f32>(x_2277.x, x_2277.x, x_2277.x)) + vec3<f32>(x_2280.x, x_2280.y, x_2280.z));
  let x_2283 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2282.x, x_2282.y, x_2282.z, x_2283.w);
  SV_Target0.w = 1.0f;
  return;
}
