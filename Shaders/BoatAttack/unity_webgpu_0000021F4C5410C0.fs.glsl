...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat23.xy = hlslcc_FragCoord.xy * vec2(_DitheringTextureInvSize);
    u_xlat23.x = texture(sampler2D(_DitheringTexture, sampler_DitheringTexture), u_xlat23.xy, _GlobalMipBias.x).w;
    u_xlatb43 = unity_LODFade.x>=0.0;
    u_xlat23.x = (u_xlatb43) ? abs(u_xlat23.x) : -abs(u_xlat23.x);
    ...
    u_xlat60 = dot(u_xlat23.xyz, u_xlat4.xyz);
