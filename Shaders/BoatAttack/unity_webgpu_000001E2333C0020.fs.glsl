...
;
    ...
    u_xlat4.xw = vec2(u_xlat43) * vec2(u_xlat43) + vec2(-1.0, 1.0);
    u_xlat0.x = float(1.0) / u_xlat4.w;
    u_xlat10.xyz = (-u_xlat5.xyz) + vec3(u_xlat28);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati43].www + _AdditionalLightsPosition[u_xlati43].xyz;
        ...
        u_xlat48 = dot(_AdditionalLightsSpotDir[u_xlati43].xyz, u_xlat10.xyz);
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[u_xlati43].z + _AdditionalLightsAttenuation[u_xlati43].w;
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        u_xlat48 = u_xlat48 * u_xlat48;
        u_xlat46 = u_xlat46 * u_xlat48;
        u_xlat11.xyz = vec3(u_xlat32) * _AdditionalLightsColor[u_xlati43].xyz;
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat43) + u_xlat6.xyz;
