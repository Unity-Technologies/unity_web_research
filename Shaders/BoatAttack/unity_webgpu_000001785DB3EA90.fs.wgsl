...
fn main_1() {
  ...
  let x_1191 : vec3<f32> = ((x_1185 * vec3<f32>(x_1186.x, x_1186.x, x_1186.x)) + vec3<f32>(x_1189.x, x_1189.y, x_1189.z));
  let x_1192 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1191.x, x_1191.y, x_1191.z, x_1192.w);
  let x_1196 : vec4<f32> = u_xlat0;
  let x_1198 : vec3<f32> = sqrt(vec3<f32>(x_1196.x, x_1196.y, x_1196.z));
