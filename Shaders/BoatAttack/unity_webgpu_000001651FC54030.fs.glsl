...
;
    ...
    u_xlat4.xyz = u_xlat15.xxx * vs_INTERP2.xyz + u_xlat4.xyz;
    u_xlat15.xyz = u_xlat15.zzz * vs_INTERP1.xyz + u_xlat4.xyz;
    ...
    u_xlat13.x = vs_INTERP0.y * unity_MatrixV[1].z;
    u_xlat13.x = unity_MatrixV[0].z * vs_INTERP0.x + u_xlat13.x;
    u_xlat13.x = unity_MatrixV[2].z * vs_INTERP0.z + u_xlat13.x;
    ...
    u_xlat37 = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat6.z = (-u_xlat37) + 1.0;
    u_xlat3.x = u_xlat3.x;
    ...
    u_xlat8.xyz = u_xlat15.xyz * (-vec3(u_xlat30)) + (-u_xlat4.xyz);
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat37);
    ...
    u_xlat9.xy = vec2(u_xlat38) * vec2(u_xlat38) + vec2(-1.0, 1.0);
    ...
    u_xlat36 = dot(u_xlat15.xyz, u_xlat8.xyz);
    ...
    u_xlat8.xyz = vec3(u_xlat36) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat38 = dot(unity_LightIndices[int(u_xlatu38)], uintBitsToFloat(ImmCB_0[u_xlati3]));
        u_xlati38 = int(u_xlat38);
        u_xlat21.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati38].www + _AdditionalLightsPosition[u_xlati38].xyz;
        u_xlat3.x = dot(u_xlat21.xyz, u_xlat21.xyz);
        u_xlat3.x = max(u_xlat3.x, 6.10351562e-05);
        u_xlat30 = inversesqrt(u_xlat3.x);
        u_xlat10.xyz = vec3(u_xlat30) * u_xlat21.xyz;
        u_xlat42 = float(1.0) / float(u_xlat3.x);
        u_xlat3.x = u_xlat3.x * _AdditionalLightsAttenuation[u_xlati38].x;
        u_xlat3.x = (-u_xlat3.x) * u_xlat3.x + 1.0;
        u_xlat3.x = max(u_xlat3.x, 0.0);
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat3.x = u_xlat3.x * u_xlat42;
        u_xlat42 = dot(_AdditionalLightsSpotDir[u_xlati38].xyz, u_xlat10.xyz);
        u_xlat42 = u_xlat42 * _AdditionalLightsAttenuation[u_xlati38].z + _AdditionalLightsAttenuation[u_xlati38].w;
        u_xlat42 = clamp(u_xlat42, 0.0, 1.0);
        u_xlat42 = u_xlat42 * u_xlat42;
        u_xlat3.x = u_xlat3.x * u_xlat42;
        u_xlat11.xyz = vec3(u_xlat18) * _AdditionalLightsColor[u_xlati38].xyz;
        u_xlat38 = dot(u_xlat15.xyz, u_xlat10.xyz);
        u_xlat38 = clamp(u_xlat38, 0.0, 1.0);
        u_xlat38 = u_xlat38 * u_xlat3.x;
        u_xlat11.xyz = vec3(u_xlat38) * u_xlat11.xyz;
        u_xlat21.xyz = u_xlat21.xyz * vec3(u_xlat30) + u_xlat4.xyz;
        u_xlat38 = dot(u_xlat21.xyz, u_xlat21.xyz);
        u_xlat38 = max(u_xlat38, 1.17549435e-37);
        u_xlat38 = inversesqrt(u_xlat38);
        u_xlat21.xyz = vec3(u_xlat38) * u_xlat21.xyz;
        u_xlat38 = dot(u_xlat15.xyz, u_xlat21.xyz);
        u_xlat38 = clamp(u_xlat38, 0.0, 1.0);
        ...
        u_xlat21.xyz = vec3(u_xlat38) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
