...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat6.x = (u_xlatb27) ? 1.0 : u_xlat6.x;
    ...
    u_xlat27.xyz = vec3(u_xlat47) * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu65 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat29.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati67].www + _AdditionalLightsPosition[u_xlati67].xyz;
        ...
        u_xlat72 = dot(_AdditionalLightsSpotDir[u_xlati67].xyz, u_xlat9.xyz);
        u_xlat72 = u_xlat72 * _AdditionalLightsAttenuation[u_xlati67].z + _AdditionalLightsAttenuation[u_xlati67].w;
        u_xlat72 = clamp(u_xlat72, 0.0, 1.0);
        u_xlat72 = u_xlat72 * u_xlat72;
        u_xlat69 = u_xlat69 * u_xlat72;
        u_xlat10.xyz = vec3(u_xlat47) * _AdditionalLightsColor[u_xlati67].xyz;
        u_xlat67 = dot(u_xlat3.xyz, u_xlat9.xyz);
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat67 = u_xlat67 * u_xlat69;
        u_xlat10.xyz = vec3(u_xlat67) * u_xlat10.xyz;
        u_xlat29.xyz = u_xlat29.xyz * vec3(u_xlat70) + u_xlat2.xyz;
        u_xlat67 = dot(u_xlat29.xyz, u_xlat29.xyz);
        u_xlat67 = max(u_xlat67, 1.17549435e-37);
        u_xlat67 = inversesqrt(u_xlat67);
        u_xlat29.xyz = vec3(u_xlat67) * u_xlat29.xyz;
        u_xlat67 = dot(u_xlat3.xyz, u_xlat29.xyz);
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        ...
        u_xlat29.xyz = u_xlat0.xyz * vec3(u_xlat67) + u_xlat22.xyz;
