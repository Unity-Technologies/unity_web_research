...
@group(1) @binding(1) var<uniform> x_995 : AdditionalLights;
...
fn main_1() {
  ...
  loop {
    ...
    let x_960 : u32 = u_xlatu37;
    let x_963 : vec4<f32> = x_274.unity_LightIndices[bitcast<i32>(x_960)];
    let x_973 : i32 = u_xlati39;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_978 : vec4<u32> = indexable[x_973];
    u_xlat37 = dot(x_963, bitcast<vec4<f32>>(x_978));
    let x_982 : f32 = u_xlat37;
    u_xlati37 = i32(x_982);
    let x_984 : vec3<f32> = vs_INTERP0;
    let x_996 : i32 = u_xlati37;
    let x_998 : vec4<f32> = x_995.x_AdditionalLightsPosition[x_996];
    let x_1001 : i32 = u_xlati37;
    let x_1003 : vec4<f32> = x_995.x_AdditionalLightsPosition[x_1001];
    u_xlat8 = ((-(x_984) * vec3<f32>(x_998.w, x_998.w, x_998.w)) + vec3<f32>(x_1003.x, x_1003.y, x_1003.z));
    let x_1006 : vec3<f32> = u_xlat8;
    let x_1007 : vec3<f32> = u_xlat8;
    u_xlat39 = dot(x_1006, x_1007);
    let x_1009 : f32 = u_xlat39;
    u_xlat39 = max(x_1009, 6.10351562e-05f);
    let x_1012 : f32 = u_xlat39;
    u_xlat40 = inverseSqrt(x_1012);
    let x_1015 : f32 = u_xlat40;
    let x_1017 : vec3<f32> = u_xlat8;
    u_xlat9 = (vec3<f32>(x_1015, x_1015, x_1015) * x_1017);
    let x_1020 : f32 = u_xlat39;
    u_xlat41 = (1.0f / x_1020);
    let x_1022 : f32 = u_xlat39;
    let x_1023 : i32 = u_xlati37;
    let x_1025 : f32 = x_995.x_AdditionalLightsAttenuation[x_1023].x;
    u_xlat39 = (x_1022 * x_1025);
    let x_1027 : f32 = u_xlat39;
    let x_1029 : f32 = u_xlat39;
    u_xlat39 = ((-(x_1027) * x_1029) + 1.0f);
    let x_1032 : f32 = u_xlat39;
    u_xlat39 = max(x_1032, 0.0f);
    let x_1034 : f32 = u_xlat39;
    let x_1035 : f32 = u_xlat39;
    u_xlat39 = (x_1034 * x_1035);
    let x_1037 : f32 = u_xlat39;
    let x_1038 : f32 = u_xlat41;
    u_xlat39 = (x_1037 * x_1038);
    let x_1040 : i32 = u_xlati37;
    let x_1042 : vec4<f32> = x_995.x_AdditionalLightsSpotDir[x_1040];
    let x_1044 : vec3<f32> = u_xlat9;
    u_xlat41 = dot(vec3<f32>(x_1042.x, x_1042.y, x_1042.z), x_1044);
    let x_1046 : f32 = u_xlat41;
    let x_1047 : i32 = u_xlati37;
    let x_1049 : f32 = x_995.x_AdditionalLightsAttenuation[x_1047].z;
    let x_1051 : i32 = u_xlati37;
    let x_1053 : f32 = x_995.x_AdditionalLightsAttenuation[x_1051].w;
    u_xlat41 = ((x_1046 * x_1049) + x_1053);
    let x_1055 : f32 = u_xlat41;
    u_xlat41 = clamp(x_1055, 0.0f, 1.0f);
    let x_1057 : f32 = u_xlat41;
    let x_1058 : f32 = u_xlat41;
    u_xlat41 = (x_1057 * x_1058);
    let x_1060 : f32 = u_xlat39;
    let x_1061 : f32 = u_xlat41;
    u_xlat39 = (x_1060 * x_1061);
    let x_1064 : vec3<f32> = u_xlat5;
    let x_1066 : i32 = u_xlati37;
    let x_1068 : vec4<f32> = x_995.x_AdditionalLightsColor[x_1066];
    u_xlat10 = (vec3<f32>(x_1064.x, x_1064.x, x_1064.x) * vec3<f32>(x_1068.x, x_1068.y, x_1068.z));
    let x_1071 : vec3<f32> = u_xlat12;
    let x_1072 : vec3<f32> = u_xlat9;
    u_xlat37 = dot(x_1071, x_1072);
    let x_1074 : f32 = u_xlat37;
    u_xlat37 = clamp(x_1074, 0.0f, 1.0f);
    let x_1076 : f32 = u_xlat37;
    let x_1077 : f32 = u_xlat39;
    u_xlat37 = (x_1076 * x_1077);
    ...
    u_xlat8 = ((x_1136 * vec3<f32>(x_1137, x_1137, x_1137)) + x_1140);
    let x_1142 : vec3<f32> = u_xlat8;
    let x_1143 : vec3<f32> = u_xlat10;
    let x_1145 : vec4<f32> = u_xlat7;
    let x_1147 : vec3<f32> = ((x_1142 * x_1143) + vec3<f32>(x_1145.x, x_1145.y, x_1145.z));
    let x_1148 : vec4<f32> = u_xlat7;
    u_xlat7 = vec4<f32>(x_1147.x, x_1147.y, x_1147.z, x_1148.w);

    continuing {
      let x_1150 : u32 = u_xlatu_loop_1;
      u_xlatu_loop_1 = (x_1150 + bitcast<u32>(1i));
    }
  }
  let x_1152 : vec4<f32> = u_xlat4;
  let x_1154 : f32 = u_xlat33;
  let x_1157 : vec3<f32> = u_xlat16;
  let x_1158 : vec3<f32> = ((vec3<f32>(x_1152.x, x_1152.y, x_1152.z) * vec3<f32>(x_1154, x_1154, x_1154)) + x_1157);
  let x_1159 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1158.x, x_1159.y, x_1158.y, x_1158.z);
  let x_1161 : vec4<f32> = u_xlat7;
  let x_1163 : vec4<f32> = u_xlat0;
  let x_1165 : vec3<f32> = (vec3<f32>(x_1161.x, x_1161.y, x_1161.z) + vec3<f32>(x_1163.x, x_1163.z, x_1163.w));
  let x_1166 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1165.x, x_1166.y, x_1165.y, x_1165.z);
  let x_1169 : f32 = u_xlat11.x;
  let x_1171 : f32 = u_xlat11.x;
  u_xlat11.x = (x_1169 * -(x_1171));
  let x_1176 : f32 = u_xlat11.x;
  u_xlat11.x = exp2(x_1176);
  let x_1179 : vec4<f32> = u_xlat0;
  let x_1183 : vec4<f32> = x_44.unity_FogColor;
  let x_1186 : vec3<f32> = (vec3<f32>(x_1179.x, x_1179.z, x_1179.w) + -(vec3<f32>(x_1183.x, x_1183.y, x_1183.z)));
  let x_1187 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1186.x, x_1187.y, x_1186.y, x_1186.z);
  let x_1191 : vec2<f32> = u_xlat11;
  let x_1193 : vec4<f32> = u_xlat0;
  let x_1197 : vec4<f32> = x_44.unity_FogColor;
  let x_1199 : vec3<f32> = ((vec3<f32>(x_1191.x, x_1191.x, x_1191.x) * vec3<f32>(x_1193.x, x_1193.z, x_1193.w)) + vec3<f32>(x_1197.x, x_1197.y, x_1197.z));
