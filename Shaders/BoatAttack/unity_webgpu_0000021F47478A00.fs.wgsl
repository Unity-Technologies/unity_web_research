...
fn main_1() {
  ...
  u_xlat0 = vec4<f32>(x_782.x, x_782.y, x_782.z, x_783.w);
  let x_786 : f32 = vs_TEXCOORD9;
  let x_789 : f32 = x_21.x_ProjectionParams.y;
  u_xlat12 = (x_786 / x_789);
  let x_791 : f32 = u_xlat12;
  u_xlat12 = (-(x_791) + 1.0f);
  let x_794 : f32 = u_xlat12;
  let x_796 : f32 = x_21.x_ProjectionParams.z;
  u_xlat12 = (x_794 * x_796);
  let x_798 : f32 = u_xlat12;
  u_xlat12 = max(x_798, 0.0f);
  let x_800 : f32 = u_xlat12;
  let x_803 : f32 = x_21.unity_FogParams.x;
  u_xlat12 = (x_800 * x_803);
  let x_805 : f32 = u_xlat12;
  let x_806 : f32 = u_xlat12;
  u_xlat12 = (x_805 * -(x_806));
  let x_809 : f32 = u_xlat12;
  u_xlat12 = exp2(x_809);
  let x_811 : vec4<f32> = u_xlat0;
  let x_813 : f32 = u_xlat12;
  let x_815 : vec3<f32> = (vec3<f32>(x_811.x, x_811.y, x_811.z) * vec3<f32>(x_813, x_813, x_813));
