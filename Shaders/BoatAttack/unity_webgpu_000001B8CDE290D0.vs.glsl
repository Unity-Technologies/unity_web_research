...
layout(set = 0, binding = 19, std430) readonly buffer _WaveDataBuffer {
...
float u_xlat41;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<_WaveCount ; u_xlatu_loop_1++)
    {
        ...
        u_xlat37 = 6.28318024 / u_xlat7.z;
        u_xlat38 = u_xlat37 * u_xlat7.x;
        u_xlat39 = u_xlat11 * u_xlat38;
        u_xlat39 = 1.5 / u_xlat39;
        u_xlat18.xy = u_xlat7.xy * vec2(10000.0, 0.0174532924);
        u_xlat9.x = sin(u_xlat18.y);
        u_xlat10.x = cos(u_xlat18.y);
        u_xlat29.x = (-u_xlat8.y) + 1.0;
        u_xlat9.z = u_xlat10.x;
        u_xlat8.z = u_xlat7.w;
        u_xlat20.xz = u_xlat0.xz + (-u_xlat8.zx);
        u_xlat20.xz = u_xlat8.yy * u_xlat20.xz;
        u_xlat29.xy = u_xlat9.xz * u_xlat29.xx + u_xlat20.xz;
        u_xlat41 = dot(u_xlat29.xy, u_xlat29.xy);
        u_xlat41 = inversesqrt(u_xlat41);
        u_xlat29.xy = u_xlat29.xy * vec2(u_xlat41);
        u_xlat8.xy = (-u_xlat8.zx) * u_xlat8.yy + u_xlat0.xz;
        u_xlat8.x = dot(u_xlat29.xy, u_xlat8.xy);
        u_xlat37 = u_xlat37 * u_xlat8.x;
        u_xlat8.x = sin(u_xlat37);
        u_xlat9.x = cos(u_xlat37);
        u_xlat37 = u_xlat7.x * u_xlat39;
        u_xlat19.xy = u_xlat29.xy * vec2(u_xlat37);
        u_xlat10.xz = u_xlat9.xx * u_xlat19.xy;
        u_xlat37 = u_xlat7.x * u_xlat8.x;
        u_xlat10.y = u_xlat35 * u_xlat37;
        u_xlat7.xz = vec2(u_xlat38) * u_xlat29.xy;
        u_xlat7.xz = u_xlat9.xx * u_xlat7.xz;
        u_xlat9.xz = (-u_xlat7.xz);
        u_xlat37 = u_xlat38 * u_xlat39;
        u_xlat9.y = (-u_xlat37) * u_xlat8.x + 1.0;
        u_xlat18.x = u_xlat18.x;
        u_xlat18.x = clamp(u_xlat18.x, 0.0, 1.0);
        u_xlat5.xyz = u_xlat10.xyz * u_xlat18.xxx + u_xlat5.xyz;
