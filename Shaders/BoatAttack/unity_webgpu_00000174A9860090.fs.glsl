...
bool u_xlatb28;
    ...
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.106250003, 0.106250003, 0.106250003) + u_xlat1.xyz;
...
;
    ...
    u_xlat5.xyz = u_xlat5.xyz * _SSAOParams.yyy;
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.15625, 0.15625, 0.15625) + u_xlat1.xyz;
...
;
    ...
    u_xlat5.xyz = u_xlat18.xxx * u_xlat5.xyz;
    u_xlat5.xyz = u_xlat5.xyz * _SSAOParams.yyy;
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.256250024, 0.256250024, 0.256250024) + u_xlat1.xyz;
    u_xlat18.xy = u_xlat5.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat18.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat5.xx + u_xlat18.xy;
    u_xlat18.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat5.zz + u_xlat18.xy;
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat5.xyz);
...
;
    ...
    u_xlat5.xyz = u_xlat18.xxx * u_xlat5.xyz;
    u_xlat5.xyz = u_xlat5.xyz * _SSAOParams.yyy;
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.40625003, 0.40625003, 0.40625003) + u_xlat1.xyz;
    u_xlat18.xy = u_xlat5.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat18.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat5.xx + u_xlat18.xy;
    u_xlat18.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat5.zz + u_xlat18.xy;
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat5.xyz);
...
;
    ...
    u_xlat5.xyz = u_xlat18.xxx * u_xlat5.xyz;
    u_xlat5.xyz = u_xlat5.xyz * _SSAOParams.yyy;
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.606249988, 0.606249988, 0.606249988) + u_xlat1.xyz;
    u_xlat18.xy = u_xlat5.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat18.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat5.xx + u_xlat18.xy;
    u_xlat18.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat5.zz + u_xlat18.xy;
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat5.xyz);
...
;
    ...
    u_xlat2.xyz = u_xlat2.xyz * vec3(0.856249988, 0.856249988, 0.856249988) + u_xlat1.xyz;
