...
fn main_1() {
  ...
  u_xlat0 = sqrt(x_1354);
  let x_1356 : vec2<f32> = vs_TEXCOORD0;
  let x_1359 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1363 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1365 : vec2<f32> = ((x_1356 * vec2<f32>(x_1359.x, x_1359.y)) + vec2<f32>(x_1363.z, x_1363.w));
  let x_1366 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1365.x, x_1365.y, x_1366.z, x_1366.w);
  let x_1373 : vec4<f32> = u_xlat1;
  let x_1376 : f32 = x_27.x_GlobalMipBias.x;
  let x_1377 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1373.x, x_1373.y), x_1376);
  u_xlat15 = x_1377.w;
  let x_1379 : f32 = u_xlat15;
  u_xlat15 = ((x_1379 * 2.0f) + -1.0f);
  let x_1382 : f32 = u_xlat15;
  u_xlatb1 = (x_1382 >= 0.0f);
  let x_1384 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1384);
  let x_1387 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1387)) + 1.0f);
  let x_1391 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1391);
  let x_1393 : f32 = u_xlat15;
  u_xlat15 = (-(x_1393) + 1.0f);
  let x_1396 : f32 = u_xlat15;
  let x_1398 : f32 = u_xlat1.x;
  u_xlat15 = (x_1396 * x_1398);
  let x_1400 : vec3<f32> = u_xlat0;
  let x_1401 : vec3<f32> = (x_1400 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1402 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1401.x, x_1401.y, x_1401.z, x_1402.w);
  let x_1404 : vec3<f32> = u_xlat0;
  let x_1405 : vec3<f32> = log2(x_1404);
  let x_1406 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1405.x, x_1405.y, x_1405.z, x_1406.w);
  let x_1408 : vec4<f32> = u_xlat2;
  let x_1410 : vec3<f32> = (vec3<f32>(x_1408.x, x_1408.y, x_1408.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1421 : vec3<f32> = ((vec3<f32>(x_1418.x, x_1418.y, x_1418.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1422 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1421.x, x_1421.y, x_1421.z, x_1422.w);
  let x_1424 : vec3<f32> = u_xlat0;
  let x_1426 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1424.x, x_1424.y, x_1424.z, x_1424.x));
  ...
  u_xlat0 = ((vec3<f32>(x_1464, x_1464, x_1464) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1469);
  let x_1471 : vec3<f32> = u_xlat0;
  let x_1472 : vec3<f32> = (x_1471 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1473 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1472.x, x_1472.y, x_1472.z, x_1473.w);
  let x_1475 : vec3<f32> = u_xlat0;
  let x_1476 : vec3<f32> = (x_1475 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1477 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1476.x, x_1476.y, x_1476.z, x_1477.w);
  let x_1479 : vec4<f32> = u_xlat2;
  let x_1481 : vec3<f32> = (vec3<f32>(x_1479.x, x_1479.y, x_1479.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1492 : vec3<f32> = (vec3<f32>(x_1490.x, x_1490.y, x_1490.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
