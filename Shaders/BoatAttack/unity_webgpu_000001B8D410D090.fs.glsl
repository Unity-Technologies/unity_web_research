...
;
    ...
    u_xlat60 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat60 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat60;
    u_xlat60 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat60;
    u_xlat60 = u_xlat60 + unity_MatrixV[3].z;
    ...
    if(u_xlatb4.x){
        ...
        u_xlat64 = (u_xlatb6.y) ? u_xlat4.w : u_xlat4.x;
        u_xlat4.xyz = (u_xlatb6.x) ? u_xlat4.xyz : vec3(u_xlat64);
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.y = float(1.0);
        u_xlat4.z = float(1.0);
    ...
    u_xlat1.x = u_xlat63 * unity_LightData.z;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu65)].www + _AdditionalLightsPosition[int(u_xlatu65)].xyz;
        u_xlat46.x = dot(u_xlat8.xyz, u_xlat8.xyz);
        ...
        u_xlat66 = dot(_AdditionalLightsSpotDir[int(u_xlatu65)].xyz, u_xlat8.xyz);
        u_xlat66 = u_xlat66 * _AdditionalLightsAttenuation[int(u_xlatu65)].z + _AdditionalLightsAttenuation[int(u_xlatu65)].w;
        u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
        u_xlat66 = u_xlat66 * u_xlat66;
        u_xlat46.x = u_xlat66 * u_xlat46.x;
        u_xlatu66 = u_xlatu65 >> (5u & uint(0x1F));
        u_xlati67 = 1 << (int(u_xlatu65) & int(0x1F));
        u_xlati66 = int(uint(u_xlati67) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu66)]));
        if(u_xlati66 != 0) {
            u_xlati66 = int(_AdditionalLightsLightTypes[int(u_xlatu65)]);
            u_xlati67 = (u_xlati66 != 0) ? 0 : 1;
            u_xlati68 = int(u_xlatu65) << (2 & int(0x1F));
            if(u_xlati67 != 0) {
                u_xlat9.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati68 + 1) / 4][(u_xlati68 + 1) % 4].xyw;
                u_xlat9.xyz = _AdditionalLightsWorldToLights[u_xlati68 / 4][u_xlati68 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat9.xyz;
                u_xlat9.xyz = _AdditionalLightsWorldToLights[(u_xlati68 + 2) / 4][(u_xlati68 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat9.xyz;
                u_xlat9.xyz = u_xlat9.xyz + _AdditionalLightsWorldToLights[(u_xlati68 + 3) / 4][(u_xlati68 + 3) % 4].xyw;
                u_xlat9.xy = u_xlat9.xy / u_xlat9.zz;
                u_xlat9.xy = u_xlat9.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat9.xy = clamp(u_xlat9.xy, 0.0, 1.0);
                u_xlat9.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu65)].xy * u_xlat9.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu65)].zw;
            } else {
                u_xlatb66 = u_xlati66==1;
                u_xlati66 = u_xlatb66 ? 1 : int(0);
                if(u_xlati66 != 0) {
                    u_xlat49.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati68 + 1) / 4][(u_xlati68 + 1) % 4].xy;
                    u_xlat49.xy = _AdditionalLightsWorldToLights[u_xlati68 / 4][u_xlati68 % 4].xy * vs_TEXCOORD1.xx + u_xlat49.xy;
                    u_xlat49.xy = _AdditionalLightsWorldToLights[(u_xlati68 + 2) / 4][(u_xlati68 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat49.xy;
                    u_xlat49.xy = u_xlat49.xy + _AdditionalLightsWorldToLights[(u_xlati68 + 3) / 4][(u_xlati68 + 3) % 4].xy;
                    u_xlat49.xy = u_xlat49.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat49.xy = fract(u_xlat49.xy);
                    u_xlat9.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu65)].xy * u_xlat49.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu65)].zw;
                } else {
                    u_xlat10 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati68 + 1) / 4][(u_xlati68 + 1) % 4];
                    u_xlat10 = _AdditionalLightsWorldToLights[u_xlati68 / 4][u_xlati68 % 4] * vs_TEXCOORD1.xxxx + u_xlat10;
                    u_xlat10 = _AdditionalLightsWorldToLights[(u_xlati68 + 2) / 4][(u_xlati68 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat10;
                    u_xlat10 = u_xlat10 + _AdditionalLightsWorldToLights[(u_xlati68 + 3) / 4][(u_xlati68 + 3) % 4];
                    ...
                    u_xlat11.xyz = vec3(u_xlat66) * u_xlat10.zxy;
                    ...
                    u_xlat49.xy = u_xlat10.xy * vec2(u_xlat66) + u_xlat49.xy;
                    u_xlat49.xy = u_xlat49.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat66 = (u_xlatb6.y) ? u_xlat9.w : u_xlat9.x;
            u_xlat9.xyz = (u_xlatb6.x) ? u_xlat9.xyz : vec3(u_xlat66);
        } else {
            u_xlat9.x = float(1.0);
            u_xlat9.y = float(1.0);
            u_xlat9.z = float(1.0);
        }
        u_xlat9.xyz = u_xlat9.xyz * _AdditionalLightsColor[int(u_xlatu65)].xyz;
        ...
        u_xlat65 = u_xlat1.x * u_xlat65;
        u_xlat65 = exp2(u_xlat65);
        u_xlat8.xyz = vec3(u_xlat65) * _SpecColor.xyz;
    ...
    u_xlat20.x = u_xlat60 * (-u_xlat60);
    u_xlat20.x = exp2(u_xlat20.x);
    u_xlat1.xyz = u_xlat1.xyz + (-unity_FogColor.xyz);
    SV_Target0.xyz = u_xlat20.xxx * u_xlat1.xyz + unity_FogColor.xyz;
