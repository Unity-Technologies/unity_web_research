...
;
    ...
    u_xlat5.x = (u_xlatb15.x) ? u_xlat17.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb15.x) ? u_xlat17.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb15.x) ? u_xlat17.z : unity_MatrixV[2].z;
    u_xlat4.w = 1.0;
    ...
    u_xlat17.xyz = unity_SHC.xyz * u_xlat15.xxx + u_xlat8.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat45 = dot(u_xlat4.xyz, u_xlat10.xyz);
        ...
        u_xlat9.xyz = vec3(u_xlat45) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat2.xyz = u_xlat3.xyz * vec3(u_xlat47) + u_xlat20.xyz;
