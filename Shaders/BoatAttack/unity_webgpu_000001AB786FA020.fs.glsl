...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    if(u_xlatb3.x){
        ...
        if(u_xlatb3.x){
            ...
            if(u_xlatb63){
                ...
                u_xlat3.x = u_xlat63 * u_xlat65 + u_xlat64;
            } else {
                u_xlat6.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat6.xy = floor(u_xlat6.xy);
                u_xlat46.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                ...
                u_xlat3.x = u_xlat7.w * u_xlat64 + u_xlat63;
            }
        }
    } else {
    ...
    u_xlat3.x = u_xlat3.x * _MainLightShadowParams.x + u_xlat63;
    u_xlatb63 = 0.0>=vs_TEXCOORD8.z;
    u_xlatb64 = vs_TEXCOORD8.z>=1.0;
    u_xlatb63 = u_xlatb63 || u_xlatb64;
    u_xlat3.x = (u_xlatb63) ? 1.0 : u_xlat3.x;
    ...
    u_xlat3.x = u_xlat63 * u_xlat64 + u_xlat3.x;
    ...
    if(u_xlatb63){
        ...
        u_xlat63 = (u_xlatb7.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb7.x) ? u_xlat6.xyz : vec3(u_xlat63);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat63 = dot((-u_xlat7.xyz), u_xlat1.xyz);
    u_xlat63 = u_xlat63 + u_xlat63;
    u_xlat8.xyz = u_xlat1.xyz * (-vec3(u_xlat63)) + (-u_xlat7.xyz);
    u_xlat63 = dot(u_xlat1.xyz, u_xlat7.xyz);
    u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
    u_xlat63 = (-u_xlat63) + 1.0;
    u_xlat63 = u_xlat63 * u_xlat63;
    u_xlat63 = u_xlat63 * u_xlat63;
    u_xlat64 = (-u_xlat0.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat9.xyz = (-u_xlat5.xyz) + vec3(u_xlat62);
    u_xlat9.xyz = vec3(u_xlat63) * u_xlat9.xyz + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu40 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat67 = dot(_AdditionalLightsSpotDir[int(u_xlatu64)].xyz, u_xlat10.xyz);
        u_xlat67 = u_xlat67 * _AdditionalLightsAttenuation[int(u_xlatu64)].z + _AdditionalLightsAttenuation[int(u_xlatu64)].w;
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat65 = u_xlat65 * u_xlat67;
        u_xlatu67 = u_xlatu64 >> (5u & uint(0x1F));
        u_xlati68 = 1 << (int(u_xlatu64) & int(0x1F));
        u_xlati67 = int(uint(u_xlati68) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu67)]));
        if(u_xlati67 != 0) {
            u_xlati67 = int(_AdditionalLightsLightTypes[int(u_xlatu64)]);
            u_xlati68 = (u_xlati67 != 0) ? 0 : 1;
            u_xlati69 = int(u_xlatu64) << (2 & int(0x1F));
            if(u_xlati68 != 0) {
            ...
            u_xlat67 = (u_xlatb3.w) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat67);
        } else {
        ...
        u_xlat64 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
        u_xlat65 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
        u_xlat64 = u_xlat64 * u_xlat64;
        u_xlat64 = u_xlat64 * u_xlat0.x + 1.00001001;
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat64 = u_xlat64 * u_xlat64;
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat64) + u_xlat4.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat2.xyz * vec3(u_xlat20) + u_xlat6.xyz;
    u_xlat0.xyz = u_xlat8.xyz + u_xlat0.xyz;
    SV_Target0.xyz = vec3(u_xlat60) * u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
