...
;
    ...
    u_xlat68 = dot(u_xlat1.xyw, u_xlat6.xyz);
    u_xlat68 = u_xlat68 + 0.5;
    u_xlat6.xyz = vec3(u_xlat68) * u_xlat7.xyz;
    u_xlat68 = max(u_xlat6.w, 9.99999975e-05);
    u_xlat6.xyz = u_xlat6.xyz / vec3(u_xlat68);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu68 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat71 = u_xlat71 * u_xlat74;
        u_xlat11.xyz = vec3(u_xlat72) * _AdditionalLightsColor[u_xlati69].xyz;
        ...
        u_xlat31.xyz = u_xlat0.xyz * vec3(u_xlat69) + u_xlat8.xyz;
