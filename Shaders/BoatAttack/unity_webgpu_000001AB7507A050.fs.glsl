...
;
    ...
    u_xlat25 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec0, 0.0);
    ...
    u_xlat25 = u_xlat26 * u_xlat3.x + u_xlat25;
    u_xlat3.xyz = vec3(u_xlat24) * _MainLightColor.xyz;
    u_xlat4.xyz = u_xlat0.xxx * u_xlat4.xyz;
    u_xlat0.x = u_xlat25 * unity_LightData.z;
