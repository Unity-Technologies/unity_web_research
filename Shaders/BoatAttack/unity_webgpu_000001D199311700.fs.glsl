...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat0 = inversesqrt(u_xlat0);
    u_xlat19.xyz = vec3(u_xlat0) * u_xlat9.xyz;
    ...
    u_xlat2.x = (u_xlatb2) ? u_xlat13.x : u_xlat24;
    ...
    u_xlat0 = (u_xlatb2) ? u_xlat0 : u_xlat13.x;
    u_xlat13.x = u_xlat0 + -9.99999975e-05;
    ...
    u_xlat3.xyz = u_xlat11.xyz * u_xlat13.xxx;
    u_xlat3.w = 1.0;
    ...
    u_xlat4.xy = u_xlat13.xy * hlslcc_FragCoord.xy;
    u_xlat13.x = u_xlat4.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat4.z = (-u_xlat13.x) + 1.0;
    u_xlat8.x = u_xlat8.x;
    u_xlat8.x = clamp(u_xlat8.x, 0.0, 1.0);
    u_xlat0 = u_xlat0;
    u_xlat0 = clamp(u_xlat0, 0.0, 1.0);
    u_xlat13.xyz = u_xlat7.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat36 = (-u_xlat8.x) + 1.0;
    ...
    u_xlat8.xy = vec2(u_xlat15) * vec2(u_xlat15) + vec2(-1.0, 1.0);
    u_xlat36 = float(1.0) / u_xlat8.y;
    u_xlat15 = u_xlat38 + -0.0399999991;
    u_xlat15 = u_xlat40 * u_xlat15 + 0.0399999991;
    u_xlat36 = u_xlat36 * u_xlat15;
    u_xlat7.xyz = vec3(u_xlat36) * u_xlat7.xyz;
    u_xlat11.xyz = u_xlat11.xyz * u_xlat13.xyz + u_xlat7.xyz;
    ...
    u_xlat7.xyz = vec3(u_xlat34) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat13.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu34 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat15 = dot(unity_LightIndices[int(u_xlatu15)], uintBitsToFloat(ImmCB_0[u_xlati38]));
        u_xlati15 = int(u_xlat15);
        u_xlat19.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati15].www + _AdditionalLightsPosition[u_xlati15].xyz;
        ...
        u_xlat42 = dot(_AdditionalLightsSpotDir[u_xlati15].xyz, u_xlat9.xyz);
        u_xlat42 = u_xlat42 * _AdditionalLightsAttenuation[u_xlati15].z + _AdditionalLightsAttenuation[u_xlati15].w;
        u_xlat42 = clamp(u_xlat42, 0.0, 1.0);
        u_xlat42 = u_xlat42 * u_xlat42;
        u_xlat38 = u_xlat38 * u_xlat42;
        u_xlat10.xyz = vec3(u_xlat26) * _AdditionalLightsColor[u_xlati15].xyz;
        u_xlat15 = dot(u_xlat3.xyz, u_xlat9.xyz);
        u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
        u_xlat15 = u_xlat15 * u_xlat38;
        u_xlat10.xyz = vec3(u_xlat15) * u_xlat10.xyz;
        u_xlat19.xyz = u_xlat19.xyz * vec3(u_xlat40) + u_xlat5.xyz;
        u_xlat15 = dot(u_xlat19.xyz, u_xlat19.xyz);
        u_xlat15 = max(u_xlat15, 1.17549435e-37);
        u_xlat15 = inversesqrt(u_xlat15);
        u_xlat19.xyz = vec3(u_xlat15) * u_xlat19.xyz;
        u_xlat15 = dot(u_xlat3.xyz, u_xlat19.xyz);
        u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
        u_xlat38 = dot(u_xlat9.xyz, u_xlat19.xyz);
        u_xlat38 = clamp(u_xlat38, 0.0, 1.0);
        u_xlat15 = u_xlat15 * u_xlat15;
        u_xlat15 = u_xlat15 * u_xlat8.x + 1.00001001;
        u_xlat38 = u_xlat38 * u_xlat38;
        u_xlat15 = u_xlat15 * u_xlat15;
        ...
        u_xlat19.xyz = vec3(u_xlat15) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat13.xyz;
        u_xlat7.xyz = u_xlat19.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat11.xyz = u_xlat11.xyz * u_xlat4.xxx + u_xlat17.xyz;
