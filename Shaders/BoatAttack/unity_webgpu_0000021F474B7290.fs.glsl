...
float u_xlat57;
    ...
    if(u_xlatb18){
        ...
        if(u_xlatb18){
            ...
            if(u_xlatb54){
                ...
                u_xlat18 = u_xlat54 * u_xlat56 + u_xlat1.x;
            } else {
                u_xlat4.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat4.xy = floor(u_xlat4.xy);
                u_xlat40.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat4.xy);
                ...
                u_xlat18 = u_xlat5.w * u_xlat1.x + u_xlat54;
            }
        }
    } else {
        vec3 txVec29 = vec3(vs_TEXCOORD6.xy,vs_TEXCOORD6.z);
        u_xlat18 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    ...
    u_xlat18 = u_xlat54 * u_xlat1.x + u_xlat18;
