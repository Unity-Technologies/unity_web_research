...
fn main_1() {
  ...
  let x_848 : vec4<f32> = x_26.x_Dithering_Params;
  let x_852 : vec4<f32> = x_26.x_Dithering_Params;
  ...
  let x_865 : f32 = x_26.x_GlobalMipBias.x;
  ...
  u_xlat18 = (-(abs(x_879)) + 1.0f);
  let x_883 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_883);
  let x_885 : f32 = u_xlat18;
  u_xlat18 = (-(x_885) + 1.0f);
  let x_888 : f32 = u_xlat18;
  let x_890 : f32 = u_xlat1.x;
  u_xlat18 = (x_888 * x_890);
  let x_892 : vec4<f32> = u_xlat0;
  let x_894 : vec3<f32> = (vec3<f32>(x_892.x, x_892.y, x_892.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_904 : vec3<f32> = (vec3<f32>(x_902.x, x_902.y, x_902.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_915 : vec3<f32> = ((vec3<f32>(x_912.x, x_912.y, x_912.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_916 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_915.x, x_915.y, x_915.z, x_916.w);
  let x_919 : vec4<f32> = u_xlat0;
  let x_921 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_919.x, x_919.y, x_919.z, x_919.x));
  ...
  let x_971 : vec3<f32> = (vec3<f32>(x_969.x, x_969.y, x_969.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
