...
fn main_1() {
  ...
  let x_1984 : vec2<f32> = vs_TEXCOORD0;
  let x_1987 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1991 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1993 : vec2<f32> = ((x_1984 * vec2<f32>(x_1987.x, x_1987.y)) + vec2<f32>(x_1991.z, x_1991.w));
  let x_1994 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1993.x, x_1993.y, x_1994.z, x_1994.w);
  let x_2001 : vec4<f32> = u_xlat1;
  let x_2004 : f32 = x_25.x_GlobalMipBias.x;
  let x_2005 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_2001.x, x_2001.y), x_2004);
  u_xlat18 = x_2005.w;
  let x_2007 : f32 = u_xlat18;
  u_xlat18 = (x_2007 + -0.5f);
  let x_2009 : f32 = u_xlat18;
  let x_2010 : f32 = u_xlat18;
  u_xlat18 = (x_2009 + x_2010);
  let x_2012 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_2012.x, x_2012.y, x_2012.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_2021 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_2021);
  let x_2026 : f32 = x_25.x_Grain_Params.y;
  let x_2028 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_2026 * -(x_2028)) + 1.0f);
  let x_2033 : f32 = u_xlat18;
  let x_2035 : vec4<f32> = u_xlat0;
  u_xlat7 = (vec3<f32>(x_2033, x_2033, x_2033) * vec3<f32>(x_2035.x, x_2035.y, x_2035.z));
  let x_2038 : vec3<f32> = u_xlat7;
  let x_2041 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat7 = (x_2038 * vec3<f32>(x_2041.x, x_2041.x, x_2041.x));
  let x_2044 : vec3<f32> = u_xlat7;
  ...
  u_xlat0 = vec4<f32>(x_2050.x, x_2050.y, x_2050.z, x_2051.w);
  let x_2053 : vec2<f32> = vs_TEXCOORD0;
  let x_2056 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2060 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2062 : vec2<f32> = ((x_2053 * vec2<f32>(x_2056.x, x_2056.y)) + vec2<f32>(x_2060.z, x_2060.w));
  let x_2063 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2062.x, x_2062.y, x_2063.z, x_2063.w);
  let x_2070 : vec4<f32> = u_xlat1;
  let x_2073 : f32 = x_25.x_GlobalMipBias.x;
  let x_2074 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2070.x, x_2070.y), x_2073);
  u_xlat18 = x_2074.w;
  let x_2076 : f32 = u_xlat18;
  u_xlat18 = ((x_2076 * 2.0f) + -1.0f);
  let x_2079 : f32 = u_xlat18;
  u_xlatb1 = (x_2079 >= 0.0f);
  let x_2081 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2081);
  let x_2084 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2084)) + 1.0f);
  let x_2088 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2088);
  let x_2090 : f32 = u_xlat18;
  u_xlat18 = (-(x_2090) + 1.0f);
  let x_2093 : f32 = u_xlat18;
  let x_2095 : f32 = u_xlat1.x;
  u_xlat18 = (x_2093 * x_2095);
  let x_2097 : vec4<f32> = u_xlat0;
  let x_2099 : vec3<f32> = (vec3<f32>(x_2097.x, x_2097.y, x_2097.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_2110 : vec3<f32> = (vec3<f32>(x_2108.x, x_2108.y, x_2108.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_2121 : vec3<f32> = ((vec3<f32>(x_2118.x, x_2118.y, x_2118.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2122 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2121.x, x_2121.y, x_2121.z, x_2122.w);
  let x_2124 : vec4<f32> = u_xlat0;
  let x_2126 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2124.x, x_2124.y, x_2124.z, x_2124.x));
  ...
  u_xlat0.z = x_2162;
  let x_2164 : f32 = u_xlat18;
  let x_2169 : vec4<f32> = u_xlat0;
  let x_2171 : vec3<f32> = ((vec3<f32>(x_2164, x_2164, x_2164) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2169.x, x_2169.y, x_2169.z));
  let x_2172 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2171.x, x_2171.y, x_2171.z, x_2172.w);
  let x_2174 : vec4<f32> = u_xlat0;
  let x_2176 : vec3<f32> = (vec3<f32>(x_2174.x, x_2174.y, x_2174.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2177 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2176.x, x_2176.y, x_2176.z, x_2177.w);
  let x_2179 : vec4<f32> = u_xlat0;
  let x_2181 : vec3<f32> = (vec3<f32>(x_2179.x, x_2179.y, x_2179.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2182 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2181.x, x_2181.y, x_2181.z, x_2182.w);
  let x_2184 : vec4<f32> = u_xlat2;
  let x_2186 : vec3<f32> = (vec3<f32>(x_2184.x, x_2184.y, x_2184.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2187 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2186.x, x_2186.y, x_2186.z, x_2187.w);
  let x_2189 : vec4<f32> = u_xlat2;
  let x_2192 : vec3<f32> = log2(abs(vec3<f32>(x_2189.x, x_2189.y, x_2189.z)));
  let x_2193 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2192.x, x_2192.y, x_2192.z, x_2193.w);
  let x_2195 : vec4<f32> = u_xlat2;
  let x_2197 : vec3<f32> = (vec3<f32>(x_2195.x, x_2195.y, x_2195.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2198 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2197.x, x_2197.y, x_2197.z, x_2198.w);
  let x_2200 : vec4<f32> = u_xlat2;
  let x_2202 : vec3<f32> = exp2(vec3<f32>(x_2200.x, x_2200.y, x_2200.z));
  let x_2203 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2202.x, x_2202.y, x_2202.z, x_2203.w);
  let x_2205 : vec4<f32> = u_xlat0;
  let x_2207 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2205.x, x_2205.y, x_2205.z, x_2205.x));
  ...
  let x_2250 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2249.x, x_2249.y, x_2249.z, x_2250.w);
  SV_Target0.w = 1.0f;
  return;
}
