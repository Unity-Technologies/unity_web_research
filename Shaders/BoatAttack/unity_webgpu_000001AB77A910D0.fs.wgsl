...
fn main_1() {
  ...
  let x_1426 : vec2<f32> = vs_TEXCOORD0;
  let x_1429 : vec4<f32> = x_38.x_Grain_TilingParams;
  let x_1433 : vec4<f32> = x_38.x_Grain_TilingParams;
  let x_1435 : vec2<f32> = ((x_1426 * vec2<f32>(x_1429.x, x_1429.y)) + vec2<f32>(x_1433.z, x_1433.w));
  let x_1436 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1435.x, x_1435.y, x_1436.z, x_1436.w);
  let x_1443 : vec4<f32> = u_xlat1;
  let x_1446 : f32 = x_38.x_GlobalMipBias.x;
  let x_1447 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1443.x, x_1443.y), x_1446);
  u_xlat15 = x_1447.w;
  let x_1449 : f32 = u_xlat15;
  u_xlat15 = (x_1449 + -0.5f);
  let x_1451 : f32 = u_xlat15;
  let x_1452 : f32 = u_xlat15;
  u_xlat15 = (x_1451 + x_1452);
  let x_1454 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1454.x, x_1454.y, x_1454.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1463 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1463);
  let x_1468 : f32 = x_38.x_Grain_Params.y;
  let x_1470 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1468 * -(x_1470)) + 1.0f);
  let x_1475 : f32 = u_xlat15;
  let x_1477 : vec4<f32> = u_xlat0;
  u_xlat6 = (vec3<f32>(x_1475, x_1475, x_1475) * vec3<f32>(x_1477.x, x_1477.y, x_1477.z));
  let x_1480 : vec3<f32> = u_xlat6;
  let x_1483 : vec2<f32> = x_38.x_Grain_Params;
  u_xlat6 = (x_1480 * vec3<f32>(x_1483.x, x_1483.x, x_1483.x));
  let x_1486 : vec3<f32> = u_xlat6;
  let x_1487 : vec4<f32> = u_xlat1;
  let x_1490 : vec4<f32> = u_xlat0;
  let x_1492 : vec3<f32> = ((x_1486 * vec3<f32>(x_1487.x, x_1487.x, x_1487.x)) + vec3<f32>(x_1490.x, x_1490.y, x_1490.z));
  let x_1493 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1492.x, x_1492.y, x_1492.z, x_1493.w);
  let x_1495 : vec4<f32> = u_xlat0;
  let x_1497 : vec3<f32> = (vec3<f32>(x_1495.x, x_1495.y, x_1495.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1498 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1497.x, x_1497.y, x_1497.z, x_1498.w);
  let x_1500 : vec4<f32> = u_xlat0;
  let x_1503 : vec3<f32> = log2(abs(vec3<f32>(x_1500.x, x_1500.y, x_1500.z)));
  let x_1504 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1503.x, x_1503.y, x_1503.z, x_1504.w);
  let x_1506 : vec4<f32> = u_xlat2;
  let x_1508 : vec3<f32> = (vec3<f32>(x_1506.x, x_1506.y, x_1506.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1519 : vec3<f32> = ((vec3<f32>(x_1516.x, x_1516.y, x_1516.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1520 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1519.x, x_1519.y, x_1519.z, x_1520.w);
  let x_1522 : vec4<f32> = u_xlat0;
  let x_1524 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1522.x, x_1522.y, x_1522.z, x_1522.x));
  u_xlatb0 = vec3<bool>(x_1524.x, x_1524.y, x_1524.z);
  let x_1527 : bool = u_xlatb0.x;
  if (x_1527) {
    let x_1532 : f32 = u_xlat1.x;
    x_1528 = x_1532;
  } else {
    let x_1535 : f32 = u_xlat2.x;
    x_1528 = x_1535;
  }
  let x_1536 : f32 = x_1528;
  u_xlat0.x = x_1536;
  let x_1539 : bool = u_xlatb0.y;
  if (x_1539) {
  ...
  u_xlat0.z = x_1560;
  let x_1562 : vec2<f32> = vs_TEXCOORD0;
  let x_1565 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1569 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1571 : vec2<f32> = ((x_1562 * vec2<f32>(x_1565.x, x_1565.y)) + vec2<f32>(x_1569.z, x_1569.w));
  let x_1572 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1571.x, x_1571.y, x_1572.z, x_1572.w);
  let x_1579 : vec4<f32> = u_xlat1;
  let x_1582 : f32 = x_38.x_GlobalMipBias.x;
  let x_1583 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1579.x, x_1579.y), x_1582);
  u_xlat15 = x_1583.w;
  let x_1585 : f32 = u_xlat15;
  u_xlat15 = ((x_1585 * 2.0f) + -1.0f);
  let x_1588 : f32 = u_xlat15;
  u_xlatb1 = (x_1588 >= 0.0f);
  let x_1590 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1590);
  let x_1593 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1593)) + 1.0f);
  let x_1597 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1597);
  let x_1599 : f32 = u_xlat15;
  u_xlat15 = (-(x_1599) + 1.0f);
  let x_1602 : f32 = u_xlat15;
  let x_1604 : f32 = u_xlat1.x;
  u_xlat15 = (x_1602 * x_1604);
  let x_1606 : vec4<f32> = u_xlat0;
  let x_1608 : vec3<f32> = (vec3<f32>(x_1606.x, x_1606.y, x_1606.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1609 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1608.x, x_1608.y, x_1608.z, x_1609.w);
  let x_1611 : vec4<f32> = u_xlat0;
  let x_1614 : vec3<f32> = log2(abs(vec3<f32>(x_1611.x, x_1611.y, x_1611.z)));
  ...
  u_xlat0.z = x_1671;
  let x_1673 : f32 = u_xlat15;
  let x_1678 : vec4<f32> = u_xlat0;
  let x_1680 : vec3<f32> = ((vec3<f32>(x_1673, x_1673, x_1673) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1678.x, x_1678.y, x_1678.z));
  ...
  let x_1701 : vec3<f32> = log2(abs(vec3<f32>(x_1698.x, x_1698.y, x_1698.z)));
  let x_1702 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1701.x, x_1701.y, x_1701.z, x_1702.w);
  let x_1704 : vec4<f32> = u_xlat2;
  let x_1706 : vec3<f32> = (vec3<f32>(x_1704.x, x_1704.y, x_1704.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  u_xlat0.x = x_1728;
  let x_1731 : bool = u_xlatb0.y;
  if (x_1731) {
    let x_1736 : f32 = u_xlat1.y;
    x_1732 = x_1736;
  } else {
    let x_1739 : f32 = u_xlat2.y;
    x_1732 = x_1739;
  }
  let x_1740 : f32 = x_1732;
  u_xlat0.y = x_1740;
  let x_1743 : bool = u_xlatb0.z;
  if (x_1743) {
    let x_1748 : f32 = u_xlat1.z;
    x_1744 = x_1748;
  } else {
  ...
  let x_1758 : vec3<f32> = max(vec3<f32>(x_1756.x, x_1756.y, x_1756.z), vec3<f32>(0.0f, 0.0f, 0.0f));
