...
;
    ...
    u_xlati55 = int(u_xlatu55) << (2 & int(0x1F));
    u_xlat2.xyz = vs_TEXCOORD1.yyy * _MainLightWorldToShadow[(u_xlati55 + 1) / 4][(u_xlati55 + 1) % 4].xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[u_xlati55 / 4][u_xlati55 % 4].xyz * vs_TEXCOORD1.xxx + u_xlat2.xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[(u_xlati55 + 2) / 4][(u_xlati55 + 2) % 4].xyz * vs_TEXCOORD1.zzz + u_xlat2.xyz;
    u_xlat2.xyz = u_xlat2.xyz + _MainLightWorldToShadow[(u_xlati55 + 3) / 4][(u_xlati55 + 3) % 4].xyz;
