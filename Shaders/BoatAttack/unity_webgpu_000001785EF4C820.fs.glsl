...
;
    ...
    u_xlat3.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati33 + 1) / 4][(u_xlati33 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati33 / 4][u_xlati33 % 4].xyz * vs_INTERP0.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati33 + 2) / 4][(u_xlati33 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat3.xyz;
    ...
    u_xlat7.xyz = vec3(u_xlat33) * u_xlat0.xyz;
    ...
    u_xlat14.xyz = vec3(u_xlat37) * _MainLightColor.xyz;
    ...
    u_xlat3.xyz = vec3(u_xlat33) * u_xlat14.xyz;
    ...
    u_xlat6.xyz = u_xlat0.xyz * vec3(u_xlat33) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat19.xyz = u_xlat0.xyz * u_xlat2.xxx + u_xlat7.xyz;
        u_xlat6.xyz = u_xlat19.xyz * u_xlat10.xyz + u_xlat6.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat24) + u_xlat3.xyz;
