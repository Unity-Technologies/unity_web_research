...
fn main_1() {
  ...
  let x_1520 : vec3<f32> = (x_1519 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1530 : vec3<f32> = (vec3<f32>(x_1528.x, x_1528.y, x_1528.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1531 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1530.x, x_1530.y, x_1530.z, x_1531.w);
  let x_1533 : vec4<f32> = u_xlat2;
  let x_1535 : vec3<f32> = exp2(vec3<f32>(x_1533.x, x_1533.y, x_1533.z));
  let x_1536 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1535.x, x_1535.y, x_1535.z, x_1536.w);
  let x_1538 : vec4<f32> = u_xlat2;
  let x_1541 : vec3<f32> = ((vec3<f32>(x_1538.x, x_1538.y, x_1538.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1542 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1541.x, x_1541.y, x_1541.z, x_1542.w);
  let x_1544 : vec3<f32> = u_xlat0;
  let x_1546 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1544.x, x_1544.y, x_1544.z, x_1544.x));
  ...
  u_xlat0.z = x_1582;
  let x_1584 : vec2<f32> = vs_TEXCOORD0;
  let x_1587 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1591 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1593 : vec2<f32> = ((x_1584 * vec2<f32>(x_1587.x, x_1587.y)) + vec2<f32>(x_1591.z, x_1591.w));
  let x_1594 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1593.x, x_1593.y, x_1594.z, x_1594.w);
  let x_1601 : vec4<f32> = u_xlat1;
  let x_1604 : f32 = x_26.x_GlobalMipBias.x;
  let x_1605 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1601.x, x_1601.y), x_1604);
  u_xlat15 = x_1605.w;
  let x_1607 : f32 = u_xlat15;
  u_xlat15 = ((x_1607 * 2.0f) + -1.0f);
  let x_1610 : f32 = u_xlat15;
  u_xlatb1 = (x_1610 >= 0.0f);
  let x_1612 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1612);
  let x_1615 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1615)) + 1.0f);
  let x_1619 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1619);
  let x_1621 : f32 = u_xlat15;
  u_xlat15 = (-(x_1621) + 1.0f);
  let x_1624 : f32 = u_xlat15;
  let x_1626 : f32 = u_xlat1.x;
  u_xlat15 = (x_1624 * x_1626);
  let x_1628 : vec3<f32> = u_xlat0;
  let x_1629 : vec3<f32> = (x_1628 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1630 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1629.x, x_1629.y, x_1629.z, x_1630.w);
  let x_1632 : vec3<f32> = u_xlat0;
  let x_1634 : vec3<f32> = log2(abs(x_1632));
  let x_1635 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1634.x, x_1634.y, x_1634.z, x_1635.w);
  let x_1637 : vec4<f32> = u_xlat2;
  let x_1639 : vec3<f32> = (vec3<f32>(x_1637.x, x_1637.y, x_1637.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1650 : vec3<f32> = ((vec3<f32>(x_1647.x, x_1647.y, x_1647.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1651 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1650.x, x_1650.y, x_1650.z, x_1651.w);
  let x_1653 : vec3<f32> = u_xlat0;
  let x_1655 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1653.x, x_1653.y, x_1653.z, x_1653.x));
  ...
  u_xlat0.z = x_1691;
  let x_1693 : f32 = u_xlat15;
  let x_1698 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1693, x_1693, x_1693) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1698);
  let x_1700 : vec3<f32> = u_xlat0;
  let x_1701 : vec3<f32> = (x_1700 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1702 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1701.x, x_1701.y, x_1701.z, x_1702.w);
  let x_1704 : vec3<f32> = u_xlat0;
  let x_1705 : vec3<f32> = (x_1704 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1706 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1705.x, x_1705.y, x_1705.z, x_1706.w);
  let x_1708 : vec4<f32> = u_xlat2;
  let x_1710 : vec3<f32> = (vec3<f32>(x_1708.x, x_1708.y, x_1708.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1711 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1710.x, x_1710.y, x_1710.z, x_1711.w);
  let x_1713 : vec4<f32> = u_xlat2;
  let x_1716 : vec3<f32> = log2(abs(vec3<f32>(x_1713.x, x_1713.y, x_1713.z)));
  let x_1717 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1716.x, x_1716.y, x_1716.z, x_1717.w);
  let x_1719 : vec4<f32> = u_xlat2;
  let x_1721 : vec3<f32> = (vec3<f32>(x_1719.x, x_1719.y, x_1719.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1772 : vec3<f32> = max(x_1771, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1773 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1772.x, x_1772.y, x_1772.z, x_1773.w);
  SV_Target0.w = 1.0f;
  return;
}
