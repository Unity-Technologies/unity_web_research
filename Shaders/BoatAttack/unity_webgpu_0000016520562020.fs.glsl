...
;
    ...
    u_xlat3.x = u_xlat24 * u_xlat45 + u_xlat3.x;
    u_xlat6.xyz = vec3(u_xlat68) * _MainLightColor.xyz;
    u_xlat24 = dot((-u_xlat2.xyz), u_xlat1.xyz);
    u_xlat24 = u_xlat24 + u_xlat24;
    u_xlat8.xyz = u_xlat1.xyz * (-vec3(u_xlat24)) + (-u_xlat2.xyz);
    ...
    u_xlat9.xyz = vec3(u_xlat24) * u_xlat9.xyz + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati67].www + _AdditionalLightsPosition[u_xlati67].xyz;
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat67) + u_xlat7.xyz;
