...
layout(set = 1, binding = 8, std140) uniform TerrainGrass {
	vec4 _WavingTint;
...
float u_xlat10;
    ...
    u_xlat3.xyz = unity_ObjectToWorld[0].xyz * u_xlat1.xxx + u_xlat3.xyz;
    u_xlat3.xyz = unity_ObjectToWorld[2].xyz * u_xlat1.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + unity_ObjectToWorld[3].xyz;
    ...
    u_xlat10 = max(u_xlat10, 1.17549435e-37);
    ...
    u_xlat2.xyz = u_xlat3.yyy * _MainLightWorldToShadow[1 / 4][1 % 4].xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[0 / 4][0 % 4].xyz * u_xlat3.xxx + u_xlat2.xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[2 / 4][2 % 4].xyz * u_xlat3.zzz + u_xlat2.xyz;
    vs_TEXCOORD6.xyz = u_xlat2.xyz + _MainLightWorldToShadow[3 / 4][3 % 4].xyz;
    vs_TEXCOORD6.w = 0.0;
