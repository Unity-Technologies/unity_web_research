...
float u_xlat13;
    ...
    u_xlat9 = dot(u_xlat2.xyz, (-_LightDir.xyz));
    ...
    u_xlat13 = texture(sampler2D(unity_NHxRoughness, samplerunity_NHxRoughness), u_xlat2.xy).x;
    u_xlat13 = u_xlat13 * 16.0;
    u_xlat1.xyz = vec3(u_xlat13) * u_xlat3.xyz + u_xlat1.xyz;
