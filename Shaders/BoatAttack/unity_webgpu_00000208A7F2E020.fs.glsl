...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat4 = texture(sampler2D(unity_LightmapInd, samplerunity_Lightmap), vs_INTERP5.xy, _GlobalMipBias.x);
    ...
    u_xlat49 = dot(u_xlat1.xzw, u_xlat5.xyz);
    u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
    u_xlat49 = (-u_xlat49) + 1.0;
    u_xlat49 = u_xlat49 * u_xlat49;
    u_xlat49 = u_xlat49 * u_xlat49;
    u_xlat8.x = (-u_xlat18.x) * 0.699999988 + 1.70000005;
    u_xlat18.x = u_xlat18.x * u_xlat8.x;
    u_xlat18.x = u_xlat18.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat18.x);
    ...
    u_xlat3.xyz = u_xlat17.xyz * u_xlat2.xyz + u_xlat7.xyz;
    u_xlat44 = u_xlat44 * unity_LightData.z;
    u_xlat45 = dot(u_xlat1.xzw, _MainLightPosition.xyz);
    ...
    u_xlat44 = dot(u_xlat1.xzw, u_xlat7.xyz);
    u_xlat44 = clamp(u_xlat44, 0.0, 1.0);
    u_xlat45 = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
    u_xlat44 = u_xlat44 * u_xlat44;
    u_xlat44 = u_xlat44 * u_xlat18.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu44 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat46 = dot(unity_LightIndices[int(u_xlatu46)], uintBitsToFloat(ImmCB_0[u_xlati35]));
        ...
        u_xlat35 = u_xlat35 * _AdditionalLightsAttenuation[int(u_xlatu46)].x;
        u_xlat35 = (-u_xlat35) * u_xlat35 + 1.0;
        u_xlat35 = max(u_xlat35, 0.0);
        u_xlat35 = u_xlat35 * u_xlat35;
        u_xlat35 = u_xlat35 * u_xlat50;
        u_xlat50 = dot(_AdditionalLightsSpotDir[int(u_xlatu46)].xyz, u_xlat10.xyz);
        u_xlat50 = u_xlat50 * _AdditionalLightsAttenuation[int(u_xlatu46)].z + _AdditionalLightsAttenuation[int(u_xlatu46)].w;
        u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
        u_xlat50 = u_xlat50 * u_xlat50;
        u_xlat35 = u_xlat35 * u_xlat50;
        u_xlatu50 = u_xlatu46 >> (5u & uint(0x1F));
        u_xlati51 = 1 << (int(u_xlatu46) & int(0x1F));
        u_xlati50 = int(uint(u_xlati51) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu50)]));
        if(u_xlati50 != 0) {
            u_xlati50 = int(_AdditionalLightsLightTypes[int(u_xlatu46)]);
            u_xlati51 = (u_xlati50 != 0) ? 0 : 1;
            u_xlati52 = int(u_xlatu46) << (2 & int(0x1F));
            if(u_xlati51 != 0) {
        ...
        u_xlat46 = dot(u_xlat1.xzw, u_xlat10.xyz);
        u_xlat46 = clamp(u_xlat46, 0.0, 1.0);
        u_xlat46 = u_xlat46 * u_xlat35;
        ...
        u_xlat46 = dot(u_xlat1.xzw, u_xlat9.xyz);
        u_xlat46 = clamp(u_xlat46, 0.0, 1.0);
        u_xlat35 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat35 = clamp(u_xlat35, 0.0, 1.0);
        u_xlat46 = u_xlat46 * u_xlat46;
        u_xlat46 = u_xlat46 * u_xlat18.x + 1.00001001;
        u_xlat35 = u_xlat35 * u_xlat35;
        u_xlat46 = u_xlat46 * u_xlat46;
        ...
        u_xlat9.xyz = vec3(u_xlat46) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat1.xzw = u_xlat3.xyz * u_xlat4.xxx + u_xlat20.xyz;
