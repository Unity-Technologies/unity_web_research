...
;
    ...
    if(u_xlatb71){
        ...
        if(u_xlatb71){
            ...
            u_xlatb28 = _MainLightShadowParams.y==2.0;
            if(u_xlatb28){
    ...
    u_xlat28.xyz = u_xlat6.xxx * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu44 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat71 = dot(unity_LightIndices[int(u_xlatu71)], uintBitsToFloat(ImmCB_0[u_xlati73]));
        u_xlati71 = int(u_xlat71);
        u_xlat8.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati71].www + _AdditionalLightsPosition[u_xlati71].xyz;
        ...
        u_xlat73 = u_xlat73 * _AdditionalLightsAttenuation[u_xlati71].x;
        u_xlat73 = (-u_xlat73) * u_xlat73 + 1.0;
        u_xlat73 = max(u_xlat73, 0.0);
        u_xlat73 = u_xlat73 * u_xlat73;
        u_xlat73 = u_xlat73 * u_xlat75;
        u_xlat75 = dot(_AdditionalLightsSpotDir[u_xlati71].xyz, u_xlat9.xyz);
        u_xlat75 = u_xlat75 * _AdditionalLightsAttenuation[u_xlati71].z + _AdditionalLightsAttenuation[u_xlati71].w;
        u_xlat75 = clamp(u_xlat75, 0.0, 1.0);
        u_xlat75 = u_xlat75 * u_xlat75;
        u_xlat73 = u_xlat73 * u_xlat75;
        u_xlat10.xyz = u_xlat6.xxx * _AdditionalLightsColor[u_xlati71].xyz;
        ...
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat74) + u_xlat1.xyz;
        ...
        u_xlat71 = clamp(u_xlat71, 0.0, 1.0);
        u_xlat73 = dot(u_xlat9.xyz, u_xlat8.xyz);
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat71) + u_xlat7.xyz;
        u_xlat28.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat28.xyz;
    }
