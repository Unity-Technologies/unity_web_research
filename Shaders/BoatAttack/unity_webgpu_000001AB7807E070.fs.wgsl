...
fn main_1() {
  ...
  let x_1717 : vec3<f32> = sqrt(vec3<f32>(x_1715.x, x_1715.y, x_1715.z));
  let x_1718 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1717.x, x_1717.y, x_1717.z, x_1718.w);
  let x_1720 : vec2<f32> = vs_TEXCOORD0;
  let x_1723 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1727 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1729 : vec2<f32> = ((x_1720 * vec2<f32>(x_1723.x, x_1723.y)) + vec2<f32>(x_1727.z, x_1727.w));
  let x_1730 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1729.x, x_1729.y, x_1730.z, x_1730.w);
  let x_1737 : vec4<f32> = u_xlat1;
  let x_1740 : f32 = x_38.x_GlobalMipBias.x;
  let x_1741 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1737.x, x_1737.y), x_1740);
  u_xlat18 = x_1741.w;
  let x_1743 : f32 = u_xlat18;
  u_xlat18 = ((x_1743 * 2.0f) + -1.0f);
  let x_1746 : f32 = u_xlat18;
  u_xlatb1 = (x_1746 >= 0.0f);
  let x_1748 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1748);
  let x_1751 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1751)) + 1.0f);
  let x_1755 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1755);
  let x_1757 : f32 = u_xlat18;
  u_xlat18 = (-(x_1757) + 1.0f);
  let x_1760 : f32 = u_xlat18;
  let x_1762 : f32 = u_xlat1.x;
  u_xlat18 = (x_1760 * x_1762);
  let x_1764 : vec4<f32> = u_xlat0;
  let x_1766 : vec3<f32> = (vec3<f32>(x_1764.x, x_1764.y, x_1764.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1776 : vec3<f32> = (vec3<f32>(x_1774.x, x_1774.y, x_1774.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1787 : vec3<f32> = ((vec3<f32>(x_1784.x, x_1784.y, x_1784.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1788 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1787.x, x_1787.y, x_1787.z, x_1788.w);
  let x_1790 : vec4<f32> = u_xlat0;
  let x_1792 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1790.x, x_1790.y, x_1790.z, x_1790.x));
  u_xlatb0 = vec3<bool>(x_1792.x, x_1792.y, x_1792.z);
  let x_1795 : bool = u_xlatb0.x;
  if (x_1795) {
    let x_1800 : f32 = u_xlat1.x;
    x_1796 = x_1800;
  } else {
    let x_1803 : f32 = u_xlat2.x;
    x_1796 = x_1803;
  }
  let x_1804 : f32 = x_1796;
  u_xlat0.x = x_1804;
  let x_1807 : bool = u_xlatb0.y;
  if (x_1807) {
    let x_1812 : f32 = u_xlat1.y;
    x_1808 = x_1812;
  } else {
    let x_1815 : f32 = u_xlat2.y;
    x_1808 = x_1815;
  }
  let x_1816 : f32 = x_1808;
  u_xlat0.y = x_1816;
  let x_1819 : bool = u_xlatb0.z;
  if (x_1819) {
    let x_1824 : f32 = u_xlat1.z;
    x_1820 = x_1824;
  } else {
    let x_1827 : f32 = u_xlat2.z;
    x_1820 = x_1827;
  }
  let x_1828 : f32 = x_1820;
  u_xlat0.z = x_1828;
  let x_1830 : f32 = u_xlat18;
  let x_1835 : vec4<f32> = u_xlat0;
  let x_1837 : vec3<f32> = ((vec3<f32>(x_1830, x_1830, x_1830) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1835.x, x_1835.y, x_1835.z));
  let x_1838 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1837.x, x_1837.y, x_1837.z, x_1838.w);
  let x_1840 : vec4<f32> = u_xlat0;
  let x_1842 : vec3<f32> = (vec3<f32>(x_1840.x, x_1840.y, x_1840.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1843 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1842.x, x_1842.y, x_1842.z, x_1843.w);
  let x_1845 : vec4<f32> = u_xlat0;
  let x_1847 : vec3<f32> = (vec3<f32>(x_1845.x, x_1845.y, x_1845.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1848 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1847.x, x_1847.y, x_1847.z, x_1848.w);
  let x_1850 : vec4<f32> = u_xlat2;
  let x_1852 : vec3<f32> = (vec3<f32>(x_1850.x, x_1850.y, x_1850.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1853 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1852.x, x_1852.y, x_1852.z, x_1853.w);
  let x_1855 : vec4<f32> = u_xlat2;
  let x_1858 : vec3<f32> = log2(abs(vec3<f32>(x_1855.x, x_1855.y, x_1855.z)));
  let x_1859 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1858.x, x_1858.y, x_1858.z, x_1859.w);
  let x_1861 : vec4<f32> = u_xlat2;
  let x_1863 : vec3<f32> = (vec3<f32>(x_1861.x, x_1861.y, x_1861.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1864 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1863.x, x_1863.y, x_1863.z, x_1864.w);
  let x_1866 : vec4<f32> = u_xlat2;
  let x_1868 : vec3<f32> = exp2(vec3<f32>(x_1866.x, x_1866.y, x_1866.z));
  let x_1869 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1868.x, x_1868.y, x_1868.z, x_1869.w);
  let x_1871 : vec4<f32> = u_xlat0;
  let x_1873 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1871.x, x_1871.y, x_1871.z, x_1871.x));
  u_xlatb0 = vec3<bool>(x_1873.x, x_1873.y, x_1873.z);
  let x_1876 : bool = u_xlatb0.x;
  if (x_1876) {
    let x_1881 : f32 = u_xlat1.x;
    x_1877 = x_1881;
  } else {
    let x_1884 : f32 = u_xlat2.x;
    x_1877 = x_1884;
  }
  ...
  let x_1915 : vec3<f32> = max(vec3<f32>(x_1913.x, x_1913.y, x_1913.z), vec3<f32>(0.0f, 0.0f, 0.0f));
