...
fn main_1() {
  ...
  let x_1392 : vec3<f32> = log2(vec3<f32>(x_1390.x, x_1390.y, x_1390.z));
  let x_1393 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1392.x, x_1392.y, x_1392.z, x_1393.w);
  let x_1395 : vec4<f32> = u_xlat2;
  let x_1397 : vec3<f32> = (vec3<f32>(x_1395.x, x_1395.y, x_1395.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1398 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1397.x, x_1397.y, x_1397.z, x_1398.w);
  let x_1400 : vec4<f32> = u_xlat2;
  let x_1402 : vec3<f32> = exp2(vec3<f32>(x_1400.x, x_1400.y, x_1400.z));
  let x_1403 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1402.x, x_1402.y, x_1402.z, x_1403.w);
  let x_1405 : vec4<f32> = u_xlat2;
  let x_1408 : vec3<f32> = ((vec3<f32>(x_1405.x, x_1405.y, x_1405.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1409 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1408.x, x_1408.y, x_1408.z, x_1409.w);
  let x_1411 : vec4<f32> = u_xlat0;
  let x_1413 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1411.x, x_1411.y, x_1411.z, x_1411.x));
  ...
  u_xlat0.z = x_1449;
  let x_1451 : f32 = u_xlat18;
  let x_1456 : vec4<f32> = u_xlat0;
  let x_1458 : vec3<f32> = ((vec3<f32>(x_1451, x_1451, x_1451) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1456.x, x_1456.y, x_1456.z));
  let x_1459 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1458.x, x_1458.y, x_1458.z, x_1459.w);
  let x_1461 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1461.x, x_1461.y, x_1461.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1464 : vec4<f32> = u_xlat0;
  let x_1466 : vec3<f32> = (vec3<f32>(x_1464.x, x_1464.y, x_1464.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1467 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1466.x, x_1466.y, x_1466.z, x_1467.w);
  let x_1469 : vec4<f32> = u_xlat2;
  let x_1471 : vec3<f32> = (vec3<f32>(x_1469.x, x_1469.y, x_1469.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1482 : vec3<f32> = (vec3<f32>(x_1480.x, x_1480.y, x_1480.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1492 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1490.x, x_1490.y, x_1490.z, x_1490.x));
  u_xlatb0 = vec3<bool>(x_1492.x, x_1492.y, x_1492.z);
  let x_1495 : bool = u_xlatb0.x;
  if (x_1495) {
    let x_1500 : f32 = u_xlat1.x;
    x_1496 = x_1500;
  } else {
    let x_1503 : f32 = u_xlat2.x;
    x_1496 = x_1503;
  }
  let x_1504 : f32 = x_1496;
  u_xlat0.x = x_1504;
  let x_1507 : bool = u_xlatb0.y;
  if (x_1507) {
    let x_1512 : f32 = u_xlat1.y;
    x_1508 = x_1512;
  } else {
    let x_1515 : f32 = u_xlat2.y;
    x_1508 = x_1515;
  }
  let x_1516 : f32 = x_1508;
  u_xlat0.y = x_1516;
  let x_1519 : bool = u_xlatb0.z;
  if (x_1519) {
  ...
  let x_1535 : vec3<f32> = max(vec3<f32>(x_1532.x, x_1532.y, x_1532.z), vec3<f32>(0.0f, 0.0f, 0.0f));
