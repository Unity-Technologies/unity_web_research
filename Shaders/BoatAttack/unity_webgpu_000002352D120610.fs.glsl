...
bool u_xlatb24;
    ...
    u_xlat3.z = (-u_xlat7.x) * u_xlat14.x + _ProjectionParams.z;
    u_xlat11.x = 0.0;
    u_xlat11.y = _SourceSize.w * 2.0;
    u_xlat11.xy = u_xlat11.xy + vs_TEXCOORD0.xy;
    u_xlat14.x = texture(sampler2D(_CameraDepthTexture, sampler_CameraDepthTexture), u_xlat11.xy, _GlobalMipBias.x).x;
    u_xlat11.z = (-u_xlat7.x) * u_xlat14.x + _ProjectionParams.z;
    u_xlat12.x = 0.0;
