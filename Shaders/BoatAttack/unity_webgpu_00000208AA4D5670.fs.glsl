...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat33 = (u_xlatb33) ? u_xlat35 : unity_LODFade.x;
    ...
    u_xlat1.x = (u_xlatb35) ? u_xlat1.x : u_xlat12.x;
    u_xlat33 = u_xlat33 * 2.0 + (-u_xlat1.x);
    u_xlat1.x = u_xlat33 * u_xlat3.w;
    u_xlatb12.x = u_xlat1.x>=0.400000006;
    u_xlat12.x = u_xlatb12.x ? u_xlat1.x : float(0.0);
    u_xlat33 = u_xlat3.w * u_xlat33 + -0.400000006;
    u_xlat23.x = dFdxCoarse(u_xlat1.x);
    u_xlat1.x = dFdyCoarse(u_xlat1.x);
    u_xlat1.x = abs(u_xlat1.x) + abs(u_xlat23.x);
    u_xlat1.x = max(u_xlat1.x, 9.99999975e-05);
    u_xlat33 = u_xlat33 / u_xlat1.x;
    u_xlat33 = u_xlat33 + 0.5;
    u_xlat33 = clamp(u_xlat33, 0.0, 1.0);
    u_xlatb1 = _AlphaToMaskAvailable!=0.0;
    u_xlat33 = (u_xlatb1) ? u_xlat33 : u_xlat12.x;
    u_xlat12.x = u_xlat33 + -9.99999975e-05;
    ...
    u_xlat12.xy = u_xlat23.xx * u_xlat23.xx + vec2(-1.0, 1.0);
    ...
    u_xlat12.xyz = u_xlat16.xyz * u_xlat5.xxx + u_xlat17.xyz;
    u_xlat12.xyz = u_xlat7.xyz + u_xlat12.xyz;
    SV_Target0.xyz = vs_INTERP4.www * u_xlat0.xyz + u_xlat12.xyz;
    SV_Target0.w = (u_xlatb1) ? u_xlat33 : 1.0;
    return;
}
