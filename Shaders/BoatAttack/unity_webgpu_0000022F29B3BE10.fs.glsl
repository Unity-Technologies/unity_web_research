...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat29.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati2].www + _AdditionalLightsPosition[u_xlati2].xyz;
        u_xlat66 = dot(u_xlat29.xyz, u_xlat29.xyz);
        u_xlat66 = max(u_xlat66, 6.10351562e-05);
        u_xlat68 = inversesqrt(u_xlat66);
        u_xlat9.xyz = vec3(u_xlat68) * u_xlat29.xyz;
        u_xlat69 = float(1.0) / float(u_xlat66);
        u_xlat66 = u_xlat66 * _AdditionalLightsAttenuation[u_xlati2].x;
        u_xlat66 = (-u_xlat66) * u_xlat66 + 1.0;
        u_xlat66 = max(u_xlat66, 0.0);
        u_xlat66 = u_xlat66 * u_xlat66;
        u_xlat66 = u_xlat66 * u_xlat69;
        u_xlat69 = dot(_AdditionalLightsSpotDir[u_xlati2].xyz, u_xlat9.xyz);
        u_xlat69 = u_xlat69 * _AdditionalLightsAttenuation[u_xlati2].z + _AdditionalLightsAttenuation[u_xlati2].w;
        u_xlat69 = clamp(u_xlat69, 0.0, 1.0);
        u_xlat69 = u_xlat69 * u_xlat69;
        u_xlat66 = u_xlat66 * u_xlat69;
        u_xlat10.xyz = vec3(u_xlat67) * _AdditionalLightsColor[u_xlati2].xyz;
        u_xlat2.x = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
        u_xlat2.x = u_xlat2.x * u_xlat66;
        u_xlat10.xyz = u_xlat2.xxx * u_xlat10.xyz;
        u_xlat29.xyz = u_xlat29.xyz * vec3(u_xlat68) + u_xlat4.xyz;
        u_xlat2.x = dot(u_xlat29.xyz, u_xlat29.xyz);
        u_xlat2.x = max(u_xlat2.x, 1.17549435e-37);
        u_xlat2.x = inversesqrt(u_xlat2.x);
        u_xlat29.xyz = u_xlat2.xxx * u_xlat29.xyz;
        u_xlat2.x = dot(u_xlat1.xyz, u_xlat29.xyz);
        u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
        u_xlat66 = dot(u_xlat9.xyz, u_xlat29.xyz);
        ...
        u_xlat29.xyz = u_xlat0.xyz * u_xlat2.xxx + u_xlat7.xyz;
