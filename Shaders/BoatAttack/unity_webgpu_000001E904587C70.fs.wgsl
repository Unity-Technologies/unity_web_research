...
fn main_1() {
  ...
  let x_2029 : vec3<f32> = sqrt(vec3<f32>(x_2027.x, x_2027.y, x_2027.z));
  let x_2030 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2029.x, x_2029.y, x_2029.z, x_2030.w);
  let x_2032 : vec2<f32> = vs_TEXCOORD0;
  let x_2035 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2039 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2041 : vec2<f32> = ((x_2032 * vec2<f32>(x_2035.x, x_2035.y)) + vec2<f32>(x_2039.z, x_2039.w));
  let x_2042 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2041.x, x_2041.y, x_2042.z, x_2042.w);
  let x_2049 : vec4<f32> = u_xlat1;
  let x_2052 : f32 = x_25.x_GlobalMipBias.x;
  let x_2053 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2049.x, x_2049.y), x_2052);
  u_xlat18 = x_2053.w;
  let x_2055 : f32 = u_xlat18;
  u_xlat18 = ((x_2055 * 2.0f) + -1.0f);
  let x_2058 : f32 = u_xlat18;
  u_xlatb1 = (x_2058 >= 0.0f);
  let x_2060 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2060);
  let x_2063 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2063)) + 1.0f);
  let x_2067 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2067);
  let x_2069 : f32 = u_xlat18;
  u_xlat18 = (-(x_2069) + 1.0f);
  let x_2072 : f32 = u_xlat18;
  let x_2074 : f32 = u_xlat1.x;
  u_xlat18 = (x_2072 * x_2074);
  let x_2076 : vec4<f32> = u_xlat0;
  let x_2078 : vec3<f32> = (vec3<f32>(x_2076.x, x_2076.y, x_2076.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2079 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2078.x, x_2078.y, x_2078.z, x_2079.w);
  let x_2081 : vec4<f32> = u_xlat0;
  let x_2083 : vec3<f32> = log2(vec3<f32>(x_2081.x, x_2081.y, x_2081.z));
  let x_2084 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2083.x, x_2083.y, x_2083.z, x_2084.w);
  let x_2086 : vec4<f32> = u_xlat2;
  let x_2088 : vec3<f32> = (vec3<f32>(x_2086.x, x_2086.y, x_2086.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2089 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2088.x, x_2088.y, x_2088.z, x_2089.w);
  let x_2091 : vec4<f32> = u_xlat2;
  let x_2093 : vec3<f32> = exp2(vec3<f32>(x_2091.x, x_2091.y, x_2091.z));
  let x_2094 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2093.x, x_2093.y, x_2093.z, x_2094.w);
  let x_2096 : vec4<f32> = u_xlat2;
  let x_2099 : vec3<f32> = ((vec3<f32>(x_2096.x, x_2096.y, x_2096.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2100 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2099.x, x_2099.y, x_2099.z, x_2100.w);
  let x_2102 : vec4<f32> = u_xlat0;
  let x_2104 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2102.x, x_2102.y, x_2102.z, x_2102.x));
  u_xlatb0 = vec3<bool>(x_2104.x, x_2104.y, x_2104.z);
  let x_2107 : bool = u_xlatb0.x;
  if (x_2107) {
  ...
  u_xlat0.x = x_2116;
  let x_2119 : bool = u_xlatb0.y;
  if (x_2119) {
    let x_2124 : f32 = u_xlat1.y;
    x_2120 = x_2124;
  } else {
    let x_2127 : f32 = u_xlat2.y;
    x_2120 = x_2127;
  }
  let x_2128 : f32 = x_2120;
  u_xlat0.y = x_2128;
  let x_2131 : bool = u_xlatb0.z;
  if (x_2131) {
    let x_2136 : f32 = u_xlat1.z;
    x_2132 = x_2136;
  } else {
  ...
  u_xlat0.z = x_2140;
  let x_2142 : f32 = u_xlat18;
  let x_2147 : vec4<f32> = u_xlat0;
  let x_2149 : vec3<f32> = ((vec3<f32>(x_2142, x_2142, x_2142) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2147.x, x_2147.y, x_2147.z));
  let x_2150 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2149.x, x_2149.y, x_2149.z, x_2150.w);
  let x_2152 : vec4<f32> = u_xlat0;
  let x_2154 : vec3<f32> = (vec3<f32>(x_2152.x, x_2152.y, x_2152.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2155 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2154.x, x_2154.y, x_2154.z, x_2155.w);
  let x_2157 : vec4<f32> = u_xlat0;
  let x_2159 : vec3<f32> = (vec3<f32>(x_2157.x, x_2157.y, x_2157.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2160 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2159.x, x_2159.y, x_2159.z, x_2160.w);
  let x_2162 : vec4<f32> = u_xlat2;
  let x_2164 : vec3<f32> = (vec3<f32>(x_2162.x, x_2162.y, x_2162.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2165 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2164.x, x_2164.y, x_2164.z, x_2165.w);
  let x_2167 : vec4<f32> = u_xlat2;
  let x_2170 : vec3<f32> = log2(abs(vec3<f32>(x_2167.x, x_2167.y, x_2167.z)));
  let x_2171 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2170.x, x_2170.y, x_2170.z, x_2171.w);
  let x_2173 : vec4<f32> = u_xlat2;
  let x_2175 : vec3<f32> = (vec3<f32>(x_2173.x, x_2173.y, x_2173.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2176 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2175.x, x_2175.y, x_2175.z, x_2176.w);
  let x_2178 : vec4<f32> = u_xlat2;
  let x_2180 : vec3<f32> = exp2(vec3<f32>(x_2178.x, x_2178.y, x_2178.z));
  let x_2181 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2180.x, x_2180.y, x_2180.z, x_2181.w);
  let x_2183 : vec4<f32> = u_xlat0;
  let x_2185 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2183.x, x_2183.y, x_2183.z, x_2183.x));
  u_xlatb0 = vec3<bool>(x_2185.x, x_2185.y, x_2185.z);
  let x_2188 : bool = u_xlatb0.x;
  if (x_2188) {
    let x_2193 : f32 = u_xlat1.x;
    x_2189 = x_2193;
  } else {
    let x_2196 : f32 = u_xlat2.x;
    x_2189 = x_2196;
  }
  let x_2197 : f32 = x_2189;
  u_xlat0.x = x_2197;
  let x_2200 : bool = u_xlatb0.y;
  if (x_2200) {
    let x_2205 : f32 = u_xlat1.y;
    x_2201 = x_2205;
  } else {
    let x_2208 : f32 = u_xlat2.y;
    x_2201 = x_2208;
  }
  let x_2209 : f32 = x_2201;
  u_xlat0.y = x_2209;
  let x_2212 : bool = u_xlatb0.z;
  if (x_2212) {
    let x_2217 : f32 = u_xlat1.z;
    x_2213 = x_2217;
  } else {
  ...
  let x_2227 : vec3<f32> = max(vec3<f32>(x_2225.x, x_2225.y, x_2225.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2228 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2227.x, x_2227.y, x_2227.z, x_2228.w);
  SV_Target0.w = 1.0f;
  return;
}
