...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat39 = dot((-u_xlat5.xyz), u_xlat14.xyz);
    u_xlat39 = u_xlat39 + u_xlat39;
    u_xlat7.xyz = u_xlat14.xyz * (-vec3(u_xlat39)) + (-u_xlat5.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat23.x = dot(unity_LightIndices[int(u_xlatu23)], uintBitsToFloat(ImmCB_0[u_xlati37]));
        u_xlati23 = int(u_xlat23.x);
        u_xlat19.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati23].www + _AdditionalLightsPosition[u_xlati23].xyz;
        ...
        u_xlat37 = u_xlat37 * _AdditionalLightsAttenuation[u_xlati23].x;
        ...
        u_xlat37 = u_xlat37 * u_xlat40;
        u_xlat10.xyz = vec3(u_xlat38) * _AdditionalLightsColor[u_xlati23].xyz;
        u_xlat23.x = dot(u_xlat14.xyz, u_xlat9.xyz);
        u_xlat23.x = clamp(u_xlat23.x, 0.0, 1.0);
        ...
        u_xlat23.x = dot(u_xlat14.xyz, u_xlat19.xyz);
        u_xlat23.x = clamp(u_xlat23.x, 0.0, 1.0);
