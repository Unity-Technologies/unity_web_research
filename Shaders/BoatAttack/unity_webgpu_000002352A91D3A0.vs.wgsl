...
fn main_1() {
  ...
  let x_316 : vec4<f32> = x_143.unity_MatrixVP[1i];
  u_xlat1 = (vec4<f32>(x_313.y, x_313.y, x_313.y, x_313.y) * x_316);
  let x_319 : vec4<f32> = x_143.unity_MatrixVP[0i];
  let x_320 : vec4<f32> = u_xlat0;
  let x_323 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_319 * vec4<f32>(x_320.x, x_320.x, x_320.x, x_320.x)) + x_323);
  let x_326 : vec4<f32> = x_143.unity_MatrixVP[2i];
  ...
  let x_338 : vec4<f32> = x_143.unity_MatrixVP[3i];
