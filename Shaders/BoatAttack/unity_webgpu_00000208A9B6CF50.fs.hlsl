...
half coc = ( depth - _CoCParams . x ) / ( _CoCParams . y - _CoCParams . x ) ;
return saturate ( coc ) ;
}
...
half3 tapColor = _BlitTexture . SampleBias ( sampler_LinearClamp , tapCoord , _GlobalMipBias . x ) . xyz ;
half coc = _FullCoCTexture . SampleBias ( sampler_LinearClamp , tapCoord , _GlobalMipBias . x ) . x ;
#line 112
...
half samp0CoC = _HalfCoCTexture . Load ( int3 ( positionSS , 0 ) ) . x ;

float2 offset = _SourceSize . zw * _DownSampleScaleFactor . zw * dir * samp0CoC * _CoCParams . z ;
half4 acc = 0.0 ;
...
half sampCoC = _HalfCoCTexture . SampleBias ( sampler_LinearClamp , sampCoord , _GlobalMipBias . x ) . x ;
half3 sampColor = _BlitTexture . SampleBias ( sampler_LinearClamp , sampCoord , _GlobalMipBias . x ) . xyz ;
#line 157
...
half3 baseColor = _BlitTexture . Load ( int3 ( _SourceSize . xy * uv , 0 ) ) . xyz ;
half coc = _FullCoCTexture . Load ( int3 ( _SourceSize . xy * uv , 0 ) ) . x ;
#line 184
half3 farColor = SampleTexture2DBicubic ( _ColorTexture , sampler_LinearClamp , uv , _SourceSize * _DownSampleScaleFactor , 1.0 , unity_StereoEyeIndex ) . xyz ;
#line 189
half3 dstColor = 0.0 ;
half dstAlpha = 1.0 ;
...
{
#line 197
half blend = sqrt ( coc * 6.28318530717958647693 ) ;
