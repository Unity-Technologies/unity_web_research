...
@group(0) @binding(1) var x_InputDepthTexture : texture_2d<f32>;
...
fn main_1() {
  ...
  let x_42 : f32 = x_26.x_BlitMipLevel;
  let x_43 : vec4<f32> = textureSampleLevel(x_InputDepthTexture, sampler_PointClamp, x_40, x_42);
  u_xlat0 = x_43.x;
