...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat66 = dot(u_xlat4, u_xlat4);
    u_xlat66 = inversesqrt(u_xlat66);
    u_xlat25.xyz = vec3(u_xlat66) * u_xlat4.xyz;
...
;
    ...
    if(u_xlatb66){
        ...
        if(u_xlatb68){
            ...
            u_xlat68 = dot(u_xlat6, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            u_xlatb70 = _MainLightShadowParams.y==2.0;
            if(u_xlatb70){
                u_xlat5.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat49.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec5, 0.0);
                u_xlat27.x = u_xlat27.x * u_xlat12.y;
                u_xlat5.x = u_xlat12.x * u_xlat5.x + u_xlat27.x;
                vec3 txVec6 = vec3(u_xlat49.xy,u_xlat4.z);
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec6, 0.0);
                u_xlat5.x = u_xlat12.z * u_xlat27.x + u_xlat5.x;
                vec3 txVec7 = vec3(u_xlat8.xy,u_xlat4.z);
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec7, 0.0);
                u_xlat5.x = u_xlat12.w * u_xlat27.x + u_xlat5.x;
                vec3 txVec8 = vec3(u_xlat10.xy,u_xlat4.z);
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec8, 0.0);
                u_xlat5.x = u_xlat13.x * u_xlat27.x + u_xlat5.x;
                vec3 txVec9 = vec3(u_xlat10.zw,u_xlat4.z);
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec9, 0.0);
                u_xlat5.x = u_xlat13.y * u_xlat27.x + u_xlat5.x;
                vec3 txVec10 = vec3(u_xlat8.zw,u_xlat4.z);
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec10, 0.0);
                u_xlat5.x = u_xlat13.z * u_xlat27.x + u_xlat5.x;
                vec3 txVec11 = vec3(u_xlat7.xy,u_xlat4.z);
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec11, 0.0);
                u_xlat5.x = u_xlat13.w * u_xlat27.x + u_xlat5.x;
                vec3 txVec12 = vec3(u_xlat7.zw,u_xlat4.z);
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec12, 0.0);
                u_xlat68 = u_xlat70 * u_xlat27.x + u_xlat5.x;
            } else {
                u_xlat5.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat49.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat70 = u_xlat16.x * u_xlat70 + u_xlat7.x;
                ...
                u_xlat70 = u_xlat16.z * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat16.w * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat17.x * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat17.y * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat17.z * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat17.w * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat18.x * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat18.y * u_xlat49.x + u_xlat70;
                vec3 txVec23 = vec3(u_xlat29.xy,u_xlat4.z);
                u_xlat49.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat70 = u_xlat18.z * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat18.w * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat6.x * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat6.y * u_xlat49.x + u_xlat70;
                ...
                u_xlat70 = u_xlat6.z * u_xlat49.x + u_xlat70;
                ...
                u_xlat68 = u_xlat6.w * u_xlat5.x + u_xlat70;
            }
        }
    } else {
    ...
    u_xlat70 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat68 = u_xlat68 * _MainLightShadowParams.x + u_xlat70;
    u_xlatb5 = 0.0>=u_xlat4.z;
    u_xlatb27 = u_xlat4.z>=1.0;
    u_xlatb5 = u_xlatb27 || u_xlatb5;
    u_xlat68 = (u_xlatb5) ? 1.0 : u_xlat68;
    u_xlat0.x = dot(u_xlat0.xyz, (-_MainLightPosition.xyz));
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat27.xyz = vec3(u_xlat68) * _MainLightColor.xyz;
    u_xlat0.xyz = u_xlat0.xxx * u_xlat27.xyz;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat1.xyz;
    u_xlatb1 = u_xlat1.w>=0.400000006;
    u_xlat1.x = u_xlatb1 ? u_xlat1.w : float(0.0);
    u_xlat23.x = u_xlat1.w + -0.400000006;
    u_xlat45 = dFdxCoarse(u_xlat1.w);
    u_xlat67 = dFdyCoarse(u_xlat1.w);
    u_xlat45 = abs(u_xlat67) + abs(u_xlat45);
    u_xlat45 = max(u_xlat45, 9.99999975e-05);
    u_xlat23.x = u_xlat23.x / u_xlat45;
    u_xlat23.x = u_xlat23.x + 0.5;
    u_xlat23.x = clamp(u_xlat23.x, 0.0, 1.0);
    u_xlatb45 = _AlphaToMaskAvailable!=0.0;
    u_xlat1.x = (u_xlatb45) ? u_xlat23.x : u_xlat1.x;
    ...
    u_xlatb23.z = unity_WorldTransformParams.w>=0.0;
    u_xlat23.x = (u_xlatb23.x) ? float(1.0) : float(-1.0);
    u_xlat23.z = (u_xlatb23.z) ? float(1.0) : float(-1.0);
    u_xlat23.x = u_xlat23.z * u_xlat23.x;
    u_xlat27.xyz = vs_INTERP1.zxy * vs_INTERP2.yzx;
    u_xlat27.xyz = vs_INTERP1.yzx * vs_INTERP2.zxy + (-u_xlat27.xyz);
    u_xlat27.xyz = u_xlat23.xxx * u_xlat27.xyz;
    u_xlat27.xyz = u_xlat25.yyy * u_xlat27.xyz;
    u_xlat27.xyz = u_xlat25.xxx * vs_INTERP2.xyz + u_xlat27.xyz;
    u_xlat25.xyz = u_xlat25.zzz * vs_INTERP1.xyz + u_xlat27.xyz;
    u_xlat23.x = dot(u_xlat25.xyz, u_xlat25.xyz);
    u_xlat23.x = inversesqrt(u_xlat23.x);
    u_xlat6.xyz = u_xlat23.xxx * u_xlat25.xyz;
    u_xlatb23.x = unity_OrthoParams.w==0.0;
    u_xlat25.xyz = (-vs_INTERP0.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat67 = dot(u_xlat25.xyz, u_xlat25.xyz);
    u_xlat67 = inversesqrt(u_xlat67);
    u_xlat25.xyz = vec3(u_xlat67) * u_xlat25.xyz;
    u_xlat7.x = (u_xlatb23.x) ? u_xlat25.x : unity_MatrixV[0].z;
    u_xlat7.y = (u_xlatb23.x) ? u_xlat25.y : unity_MatrixV[1].z;
    u_xlat7.z = (u_xlatb23.x) ? u_xlat25.z : unity_MatrixV[2].z;
    u_xlat6.w = 1.0;
    ...
    u_xlat23.x = u_xlat6.y * u_xlat6.y;
    u_xlat23.x = u_xlat6.x * u_xlat6.x + (-u_xlat23.x);
    u_xlat25.xyz = unity_SHC.xyz * u_xlat23.xxx + u_xlat10.xyz;
    ...
    u_xlat8.xy = u_xlat23.xz * hlslcc_FragCoord.xy;
    u_xlat23.x = u_xlat8.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat8.z = (-u_xlat23.x) + 1.0;
    u_xlat3.x = u_xlat3.x;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat1.x = min(u_xlat1.x, 1.0);
    u_xlat2.xyz = u_xlat2.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat23.x = (-u_xlat3.x) + 1.0;
    u_xlat67 = u_xlat23.x * u_xlat23.x;
    u_xlat67 = max(u_xlat67, 0.0078125);
    u_xlat68 = u_xlat67 * u_xlat67;
    u_xlat3.x = u_xlat3.x + 0.0400000215;
    u_xlat3.x = min(u_xlat3.x, 1.0);
    u_xlat27.x = u_xlat67 * 4.0 + 2.0;
    u_xlat49.x = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat8.xz, _GlobalMipBias.x).x;
    u_xlat71 = u_xlat49.x + -1.0;
    u_xlat71 = _AmbientOcclusionParam.w * u_xlat71 + 1.0;
    u_xlat49.x = min(u_xlat49.x, vs_INTERP4.w);
    if(u_xlatb66){
        ...
        if(u_xlatb66){
            ...
            if(u_xlatb72){
                ...
                u_xlat52.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat8.xy);
                ...
                vec3 txVec36 = vec3(u_xlat52.xy,u_xlat4.z);
                ...
                u_xlat66 = u_xlat72 * u_xlat8.x + u_xlat73;
            } else {
                u_xlat8.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat8.xy = floor(u_xlat8.xy);
                u_xlat52.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat8.xy);
                ...
                vec3 txVec45 = vec3(u_xlat52.xy,u_xlat4.z);
                ...
                vec3 txVec53 = vec3(u_xlat32.xy,u_xlat4.z);
                ...
                vec3 txVec54 = vec3(u_xlat60.xy,u_xlat4.z);
                ...
                vec3 txVec57 = vec3(u_xlat55.xy,u_xlat4.z);
                ...
                u_xlat66 = u_xlat9.w * u_xlat73 + u_xlat72;
            }
        }
    } else {
    ...
    u_xlat66 = u_xlat66 * _MainLightShadowParams.x + u_xlat70;
    u_xlat66 = (u_xlatb5) ? 1.0 : u_xlat66;
    ...
    u_xlat66 = u_xlat4.x * u_xlat26 + u_xlat66;
    u_xlatb4.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb4.x){
        u_xlat4.xy = vs_INTERP0.yy * _MainLightWorldToLight[1].xy;
        u_xlat4.xy = _MainLightWorldToLight[0].xy * vs_INTERP0.xx + u_xlat4.xy;
        u_xlat4.xy = _MainLightWorldToLight[2].xy * vs_INTERP0.zz + u_xlat4.xy;
        ...
        u_xlat70 = (u_xlatb8.y) ? u_xlat4.w : u_xlat4.x;
        u_xlat4.xyz = (u_xlatb8.x) ? u_xlat4.xyz : vec3(u_xlat70);
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.y = float(1.0);
        u_xlat4.z = float(1.0);
    ...
    u_xlat70 = dot((-u_xlat7.xyz), u_xlat6.xyz);
    u_xlat70 = u_xlat70 + u_xlat70;
    u_xlat8.xyz = u_xlat6.xyz * (-vec3(u_xlat70)) + (-u_xlat7.xyz);
    u_xlat70 = dot(u_xlat6.xyz, u_xlat7.xyz);
    u_xlat70 = clamp(u_xlat70, 0.0, 1.0);
    u_xlat70 = (-u_xlat70) + 1.0;
    u_xlat70 = u_xlat70 * u_xlat70;
    u_xlat70 = u_xlat70 * u_xlat70;
    u_xlat5.x = (-u_xlat23.x) * 0.699999988 + 1.70000005;
    u_xlat23.x = u_xlat23.x * u_xlat5.x;
    ...
    u_xlat23.xz = vec2(u_xlat67) * vec2(u_xlat67) + vec2(-1.0, 1.0);
    u_xlat67 = float(1.0) / u_xlat23.z;
    u_xlat3.x = u_xlat3.x + -0.0399999991;
    u_xlat3.x = u_xlat70 * u_xlat3.x + 0.0399999991;
    u_xlat67 = u_xlat67 * u_xlat3.x;
    u_xlat8.xyz = vec3(u_xlat67) * u_xlat8.xyz;
    u_xlat3.xyz = u_xlat25.xyz * u_xlat2.xyz + u_xlat8.xyz;
    u_xlat66 = u_xlat66 * unity_LightData.z;
    u_xlat67 = dot(u_xlat6.xyz, _MainLightPosition.xyz);
    ...
    u_xlat66 = dot(u_xlat6.xyz, u_xlat8.xyz);
    u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
    u_xlat67 = dot(_MainLightPosition.xyz, u_xlat8.xyz);
    u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
    u_xlat66 = u_xlat66 * u_xlat66;
    u_xlat66 = u_xlat66 * u_xlat23.x + 1.00001001;
    u_xlat67 = u_xlat67 * u_xlat67;
    u_xlat66 = u_xlat66 * u_xlat66;
    u_xlat67 = max(u_xlat67, 0.100000001);
    u_xlat66 = u_xlat66 * u_xlat67;
    u_xlat66 = u_xlat27.x * u_xlat66;
    u_xlat66 = u_xlat68 / u_xlat66;
    u_xlat8.xyz = vec3(u_xlat66) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu69)].www + _AdditionalLightsPosition[int(u_xlatu69)].xyz;
        u_xlat70 = dot(u_xlat10.xyz, u_xlat10.xyz);
        u_xlat70 = max(u_xlat70, 6.10351562e-05);
        u_xlat5.x = inversesqrt(u_xlat70);
        u_xlat11.xyz = u_xlat5.xxx * u_xlat10.xyz;
        u_xlat72 = float(1.0) / float(u_xlat70);
        ...
        u_xlat72 = dot(_AdditionalLightsSpotDir[int(u_xlatu69)].xyz, u_xlat11.xyz);
        u_xlat72 = u_xlat72 * _AdditionalLightsAttenuation[int(u_xlatu69)].z + _AdditionalLightsAttenuation[int(u_xlatu69)].w;
        u_xlat72 = clamp(u_xlat72, 0.0, 1.0);
        u_xlat72 = u_xlat72 * u_xlat72;
        u_xlat70 = u_xlat70 * u_xlat72;
        u_xlatu72 = u_xlatu69 >> (5u & uint(0x1F));
        u_xlati73 = 1 << (int(u_xlatu69) & int(0x1F));
        u_xlati72 = int(uint(u_xlati73) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu72)]));
        if(u_xlati72 != 0) {
            u_xlati72 = int(_AdditionalLightsLightTypes[int(u_xlatu69)]);
            u_xlati73 = (u_xlati72 != 0) ? 0 : 1;
            u_xlati52 = int(u_xlatu69) << (2 & int(0x1F));
            if(u_xlati73 != 0) {
                u_xlat12.xyz = vs_INTERP0.yyy * _AdditionalLightsWorldToLights[(u_xlati52 + 1) / 4][(u_xlati52 + 1) % 4].xyw;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[u_xlati52 / 4][u_xlati52 % 4].xyw * vs_INTERP0.xxx + u_xlat12.xyz;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[(u_xlati52 + 2) / 4][(u_xlati52 + 2) % 4].xyw * vs_INTERP0.zzz + u_xlat12.xyz;
                u_xlat12.xyz = u_xlat12.xyz + _AdditionalLightsWorldToLights[(u_xlati52 + 3) / 4][(u_xlati52 + 3) % 4].xyw;
                u_xlat12.xy = u_xlat12.xy / u_xlat12.zz;
                u_xlat12.xy = u_xlat12.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat12.xy = clamp(u_xlat12.xy, 0.0, 1.0);
                u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].zw;
            } else {
                u_xlatb72 = u_xlati72==1;
                u_xlati72 = u_xlatb72 ? 1 : int(0);
                if(u_xlati72 != 0) {
                    u_xlat56.xy = vs_INTERP0.yy * _AdditionalLightsWorldToLights[(u_xlati52 + 1) / 4][(u_xlati52 + 1) % 4].xy;
                    u_xlat56.xy = _AdditionalLightsWorldToLights[u_xlati52 / 4][u_xlati52 % 4].xy * vs_INTERP0.xx + u_xlat56.xy;
                    u_xlat56.xy = _AdditionalLightsWorldToLights[(u_xlati52 + 2) / 4][(u_xlati52 + 2) % 4].xy * vs_INTERP0.zz + u_xlat56.xy;
                    u_xlat56.xy = u_xlat56.xy + _AdditionalLightsWorldToLights[(u_xlati52 + 3) / 4][(u_xlati52 + 3) % 4].xy;
                    u_xlat56.xy = u_xlat56.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat56.xy = fract(u_xlat56.xy);
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].xy * u_xlat56.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].zw;
                } else {
                    u_xlat13 = vs_INTERP0.yyyy * _AdditionalLightsWorldToLights[(u_xlati52 + 1) / 4][(u_xlati52 + 1) % 4];
                    u_xlat13 = _AdditionalLightsWorldToLights[u_xlati52 / 4][u_xlati52 % 4] * vs_INTERP0.xxxx + u_xlat13;
                    u_xlat13 = _AdditionalLightsWorldToLights[(u_xlati52 + 2) / 4][(u_xlati52 + 2) % 4] * vs_INTERP0.zzzz + u_xlat13;
                    u_xlat13 = u_xlat13 + _AdditionalLightsWorldToLights[(u_xlati52 + 3) / 4][(u_xlati52 + 3) % 4];
                    u_xlat13.xyz = u_xlat13.xyz / u_xlat13.www;
                    u_xlat72 = dot(u_xlat13.xyz, u_xlat13.xyz);
                    u_xlat72 = inversesqrt(u_xlat72);
                    u_xlat13.xyz = vec3(u_xlat72) * u_xlat13.xyz;
                    u_xlat72 = dot(abs(u_xlat13.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat72 = max(u_xlat72, 9.99999997e-07);
                    u_xlat72 = float(1.0) / float(u_xlat72);
                    u_xlat14.xyz = vec3(u_xlat72) * u_xlat13.zxy;
                    u_xlat14.x = (-u_xlat14.x);
                    u_xlat14.x = clamp(u_xlat14.x, 0.0, 1.0);
                    u_xlatb52.xy = greaterThanEqual(u_xlat14.yzyz, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    u_xlat52.x = (u_xlatb52.x) ? u_xlat14.x : (-u_xlat14.x);
                    u_xlat52.y = (u_xlatb52.y) ? u_xlat14.x : (-u_xlat14.x);
                    u_xlat52.xy = u_xlat13.xy * vec2(u_xlat72) + u_xlat52.xy;
                    u_xlat52.xy = u_xlat52.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat52.xy = clamp(u_xlat52.xy, 0.0, 1.0);
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].xy * u_xlat52.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].zw;
                }
            }
            ...
            u_xlat72 = (u_xlatb8.y) ? u_xlat12.w : u_xlat12.x;
            u_xlat12.xyz = (u_xlatb8.x) ? u_xlat12.xyz : vec3(u_xlat72);
        } else {
            u_xlat12.x = float(1.0);
            u_xlat12.y = float(1.0);
            u_xlat12.z = float(1.0);
        }
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[int(u_xlatu69)].xyz;
        u_xlat12.xyz = vec3(u_xlat71) * u_xlat12.xyz;
        u_xlat69 = dot(u_xlat6.xyz, u_xlat11.xyz);
        u_xlat69 = clamp(u_xlat69, 0.0, 1.0);
        u_xlat69 = u_xlat69 * u_xlat70;
        u_xlat12.xyz = vec3(u_xlat69) * u_xlat12.xyz;
        u_xlat10.xyz = u_xlat10.xyz * u_xlat5.xxx + u_xlat7.xyz;
        ...
        u_xlat69 = dot(u_xlat6.xyz, u_xlat10.xyz);
        u_xlat69 = clamp(u_xlat69, 0.0, 1.0);
        u_xlat70 = dot(u_xlat11.xyz, u_xlat10.xyz);
        u_xlat70 = clamp(u_xlat70, 0.0, 1.0);
        u_xlat69 = u_xlat69 * u_xlat69;
        u_xlat69 = u_xlat69 * u_xlat23.x + 1.00001001;
        u_xlat70 = u_xlat70 * u_xlat70;
        u_xlat69 = u_xlat69 * u_xlat69;
        u_xlat70 = max(u_xlat70, 0.100000001);
        u_xlat69 = u_xlat69 * u_xlat70;
        u_xlat69 = u_xlat27.x * u_xlat69;
        u_xlat69 = u_xlat68 / u_xlat69;
        u_xlat10.xyz = vec3(u_xlat69) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat9.xyz = u_xlat10.xyz * u_xlat12.xyz + u_xlat9.xyz;
    }
    u_xlat2.xyz = u_xlat3.xyz * u_xlat49.xxx + u_xlat4.xyz;
    u_xlat2.xyz = u_xlat9.xyz + u_xlat2.xyz;
    SV_Target0.xyz = vs_INTERP4.www * u_xlat0.xyz + u_xlat2.xyz;
    SV_Target0.w = (u_xlatb45) ? u_xlat1.x : 1.0;
