...
;
    ...
    u_xlat4.xyz = (u_xlatb15.x) ? u_xlat4.xyz : u_xlat5.xyz;
    ...
    u_xlat43 = dot(u_xlat17.xyz, u_xlat5.xyz);
    ...
    u_xlat43 = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    ...
    u_xlat34.x = dot((-u_xlat4.xyz), u_xlat17.xyz);
    u_xlat34.x = u_xlat34.x + u_xlat34.x;
    u_xlat8.xyz = u_xlat17.xyz * (-u_xlat34.xxx) + (-u_xlat4.xyz);
    u_xlat34.x = dot(u_xlat17.xyz, u_xlat4.xyz);
    u_xlat34.x = clamp(u_xlat34.x, 0.0, 1.0);
    ...
    u_xlat44 = u_xlat3.x + -0.0399999991;
    u_xlat44 = u_xlat34.x * u_xlat44 + 0.0399999991;
    ...
    u_xlat42 = dot(u_xlat17.xyz, u_xlat8.xyz);
    ...
    u_xlat8.xyz = vec3(u_xlat42) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat44 = dot(unity_LightIndices[int(u_xlatu44)], uintBitsToFloat(ImmCB_0[u_xlati3]));
        u_xlatu44 =  uint(int(u_xlat44));
        u_xlat23.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu44)].www + _AdditionalLightsPosition[int(u_xlatu44)].xyz;
        u_xlat3.x = dot(u_xlat23.xyz, u_xlat23.xyz);
        u_xlat3.x = max(u_xlat3.x, 6.10351562e-05);
        u_xlat49 = inversesqrt(u_xlat3.x);
        u_xlat10.xyz = vec3(u_xlat49) * u_xlat23.xyz;
        u_xlat50 = float(1.0) / float(u_xlat3.x);
        u_xlat3.x = u_xlat3.x * _AdditionalLightsAttenuation[int(u_xlatu44)].x;
        u_xlat3.x = (-u_xlat3.x) * u_xlat3.x + 1.0;
        u_xlat3.x = max(u_xlat3.x, 0.0);
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat3.x = u_xlat3.x * u_xlat50;
        u_xlat50 = dot(_AdditionalLightsSpotDir[int(u_xlatu44)].xyz, u_xlat10.xyz);
        u_xlat50 = u_xlat50 * _AdditionalLightsAttenuation[int(u_xlatu44)].z + _AdditionalLightsAttenuation[int(u_xlatu44)].w;
        u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
        u_xlat50 = u_xlat50 * u_xlat50;
        u_xlat3.x = u_xlat3.x * u_xlat50;
        u_xlatu50 = u_xlatu44 >> (5u & uint(0x1F));
        u_xlati52 = 1 << (int(u_xlatu44) & int(0x1F));
        u_xlati50 = int(uint(u_xlati52) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu50)]));
        if(u_xlati50 != 0) {
            u_xlati50 = int(_AdditionalLightsLightTypes[int(u_xlatu44)]);
            u_xlati52 = (u_xlati50 != 0) ? 0 : 1;
            u_xlati11 = int(u_xlatu44) << (2 & int(0x1F));
            if(u_xlati52 != 0) {
                ...
                u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu44)].xy * u_xlat25.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu44)].zw;
            } else {
                ...
                if(u_xlati50 != 0) {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu44)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu44)].zw;
                } else {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu44)].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu44)].zw;
                }
            }
            ...
            u_xlat50 = (u_xlatb34.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb34.x) ? u_xlat11.xyz : vec3(u_xlat50);
        } else {
        ...
        u_xlat23.xyz = vec3(u_xlat44) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    ...
    u_xlat42 = u_xlat15.x * (-u_xlat15.x);
