...
@group(0) @binding(14) var x_TerrainNormalmapTexture : texture_2d<f32>;

@group(0) @binding(13) var x_TerrainHeightmapTexture : texture_2d<f32>;
...
@group(1) @binding(5) var<uniform> x_450 : VGlobals;
