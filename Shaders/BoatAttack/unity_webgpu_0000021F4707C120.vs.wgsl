...
@group(1) @binding(1) var<uniform> x_41 : x_Terrain;
...
@group(1) @binding(2) var<uniform> x_189 : VGlobals;
...
fn main_1() {
  ...
  let x_360 : vec4<f32> = x_189.unity_MatrixVP[3i];
