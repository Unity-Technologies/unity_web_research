...
;
    ...
    u_xlat3.xyz = u_xlat11.xyz * u_xlat2.xxx;
    ...
    u_xlat2.xzw = vec3(u_xlat22) * u_xlat2.xzw;
    u_xlat4.x = (u_xlatb11.x) ? u_xlat2.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb11.x) ? u_xlat2.z : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb11.x) ? u_xlat2.w : unity_MatrixV[2].z;
    u_xlat3.w = 1.0;
    ...
    u_xlat11.xyz = unity_SHC.xyz * u_xlat11.xxx + u_xlat9.xyz;
    ...
    u_xlat16 = u_xlat6.x + 0.0400000215;
    u_xlat16 = min(u_xlat16, 1.0);
    u_xlat27 = u_xlat37 * 4.0 + 2.0;
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat36);
    ...
    u_xlat37 = u_xlat16 + -0.0399999991;
    u_xlat37 = u_xlat40 * u_xlat37 + 0.0399999991;
    u_xlat36 = u_xlat36 * u_xlat37;
    u_xlat7.xyz = vec3(u_xlat36) * u_xlat7.xyz;
    u_xlat11.xyz = u_xlat11.xyz * u_xlat2.xzw + u_xlat7.xyz;
    ...
    u_xlat7.xyz = u_xlat0.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xzw;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat37 = dot(unity_LightIndices[int(u_xlatu37)], uintBitsToFloat(ImmCB_0[u_xlati16]));
        u_xlati37 = int(u_xlat37);
        u_xlat19.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati37].www + _AdditionalLightsPosition[u_xlati37].xyz;
        u_xlat16 = dot(u_xlat19.xyz, u_xlat19.xyz);
        u_xlat16 = max(u_xlat16, 6.10351562e-05);
        u_xlat40 = inversesqrt(u_xlat16);
        u_xlat9.xyz = vec3(u_xlat40) * u_xlat19.xyz;
        u_xlat42 = float(1.0) / float(u_xlat16);
        u_xlat16 = u_xlat16 * _AdditionalLightsAttenuation[u_xlati37].x;
        ...
        u_xlat16 = u_xlat16 * u_xlat42;
        u_xlat10.xyz = u_xlat6.xxx * _AdditionalLightsColor[u_xlati37].xyz;
        u_xlat37 = dot(u_xlat3.xyz, u_xlat9.xyz);
        u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
        u_xlat37 = u_xlat37 * u_xlat16;
        u_xlat10.xyz = vec3(u_xlat37) * u_xlat10.xyz;
        u_xlat19.xyz = u_xlat19.xyz * vec3(u_xlat40) + u_xlat4.xyz;
        ...
        u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
        u_xlat16 = dot(u_xlat9.xyz, u_xlat19.xyz);
        ...
        u_xlat19.xyz = vec3(u_xlat37) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xzw;
        u_xlat7.xyz = u_xlat19.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat11.xyz * vec3(u_xlat38) + u_xlat17.xyz;
