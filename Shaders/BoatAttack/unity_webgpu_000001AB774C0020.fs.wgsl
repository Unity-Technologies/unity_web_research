...
fn main_1() {
  ...
  u_xlat0.x = x_1497;
  let x_1500 : bool = u_xlatb0.y;
  if (x_1500) {
    let x_1505 : f32 = u_xlat1.y;
    x_1501 = x_1505;
  } else {
    let x_1508 : f32 = u_xlat2.y;
    x_1501 = x_1508;
  }
  let x_1509 : f32 = x_1501;
  u_xlat0.y = x_1509;
  let x_1512 : bool = u_xlatb0.z;
  if (x_1512) {
    let x_1517 : f32 = u_xlat1.z;
    x_1513 = x_1517;
  } else {
  ...
  u_xlat0.z = x_1521;
  let x_1523 : vec2<f32> = vs_TEXCOORD0;
  let x_1526 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1530 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1532 : vec2<f32> = ((x_1523 * vec2<f32>(x_1526.x, x_1526.y)) + vec2<f32>(x_1530.z, x_1530.w));
  let x_1533 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1532.x, x_1532.y, x_1533.z, x_1533.w);
  let x_1540 : vec4<f32> = u_xlat1;
  let x_1543 : f32 = x_38.x_GlobalMipBias.x;
  let x_1544 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1540.x, x_1540.y), x_1543);
  u_xlat15 = x_1544.w;
  let x_1546 : f32 = u_xlat15;
  u_xlat15 = ((x_1546 * 2.0f) + -1.0f);
  let x_1549 : f32 = u_xlat15;
  u_xlatb1 = (x_1549 >= 0.0f);
  let x_1551 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1551);
  let x_1554 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1554)) + 1.0f);
  let x_1558 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1558);
  let x_1560 : f32 = u_xlat15;
  u_xlat15 = (-(x_1560) + 1.0f);
  let x_1563 : f32 = u_xlat15;
  let x_1565 : f32 = u_xlat1.x;
  u_xlat15 = (x_1563 * x_1565);
  let x_1567 : vec4<f32> = u_xlat0;
  let x_1569 : vec3<f32> = (vec3<f32>(x_1567.x, x_1567.y, x_1567.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1580 : vec3<f32> = (vec3<f32>(x_1578.x, x_1578.y, x_1578.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1591 : vec3<f32> = ((vec3<f32>(x_1588.x, x_1588.y, x_1588.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1592 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1591.x, x_1591.y, x_1591.z, x_1592.w);
  let x_1594 : vec4<f32> = u_xlat0;
  let x_1596 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1594.x, x_1594.y, x_1594.z, x_1594.x));
  u_xlatb0 = vec3<bool>(x_1596.x, x_1596.y, x_1596.z);
  let x_1599 : bool = u_xlatb0.x;
  if (x_1599) {
    let x_1604 : f32 = u_xlat1.x;
    x_1600 = x_1604;
  } else {
    let x_1607 : f32 = u_xlat2.x;
    x_1600 = x_1607;
  }
  let x_1608 : f32 = x_1600;
  u_xlat0.x = x_1608;
  let x_1611 : bool = u_xlatb0.y;
  if (x_1611) {
    let x_1616 : f32 = u_xlat1.y;
    x_1612 = x_1616;
  } else {
    let x_1619 : f32 = u_xlat2.y;
    x_1612 = x_1619;
  }
  let x_1620 : f32 = x_1612;
  u_xlat0.y = x_1620;
  let x_1623 : bool = u_xlatb0.z;
  if (x_1623) {
    let x_1628 : f32 = u_xlat1.z;
    x_1624 = x_1628;
  } else {
  ...
  let x_1641 : vec3<f32> = ((vec3<f32>(x_1634, x_1634, x_1634) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1639.x, x_1639.y, x_1639.z));
  let x_1642 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1641.x, x_1641.y, x_1641.z, x_1642.w);
  let x_1644 : vec4<f32> = u_xlat0;
  let x_1646 : vec3<f32> = (vec3<f32>(x_1644.x, x_1644.y, x_1644.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1647 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1646.x, x_1646.y, x_1646.z, x_1647.w);
  let x_1649 : vec4<f32> = u_xlat0;
  let x_1651 : vec3<f32> = (vec3<f32>(x_1649.x, x_1649.y, x_1649.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1652 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1651.x, x_1651.y, x_1651.z, x_1652.w);
  let x_1654 : vec4<f32> = u_xlat2;
  let x_1656 : vec3<f32> = (vec3<f32>(x_1654.x, x_1654.y, x_1654.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1657 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1656.x, x_1656.y, x_1656.z, x_1657.w);
  let x_1659 : vec4<f32> = u_xlat2;
  let x_1662 : vec3<f32> = log2(abs(vec3<f32>(x_1659.x, x_1659.y, x_1659.z)));
  let x_1663 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1662.x, x_1662.y, x_1662.z, x_1663.w);
  let x_1665 : vec4<f32> = u_xlat2;
  let x_1667 : vec3<f32> = (vec3<f32>(x_1665.x, x_1665.y, x_1665.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1668 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1667.x, x_1667.y, x_1667.z, x_1668.w);
  let x_1670 : vec4<f32> = u_xlat2;
  let x_1672 : vec3<f32> = exp2(vec3<f32>(x_1670.x, x_1670.y, x_1670.z));
  let x_1673 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1672.x, x_1672.y, x_1672.z, x_1673.w);
  let x_1675 : vec4<f32> = u_xlat0;
  let x_1677 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1675.x, x_1675.y, x_1675.z, x_1675.x));
  u_xlatb0 = vec3<bool>(x_1677.x, x_1677.y, x_1677.z);
  let x_1680 : bool = u_xlatb0.x;
  if (x_1680) {
  ...
  u_xlat0.x = x_1689;
  let x_1692 : bool = u_xlatb0.y;
  if (x_1692) {
    let x_1697 : f32 = u_xlat1.y;
    x_1693 = x_1697;
  } else {
  ...
  u_xlat0.y = x_1701;
  let x_1704 : bool = u_xlatb0.z;
  if (x_1704) {
    let x_1709 : f32 = u_xlat1.z;
    x_1705 = x_1709;
  } else {
    let x_1712 : f32 = u_xlat2.z;
    x_1705 = x_1712;
  }
  let x_1713 : f32 = x_1705;
  u_xlat0.z = x_1713;
  let x_1717 : vec4<f32> = u_xlat0;
  let x_1719 : vec3<f32> = max(vec3<f32>(x_1717.x, x_1717.y, x_1717.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1720 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1719.x, x_1719.y, x_1719.z, x_1720.w);
  SV_Target0.w = 1.0f;
  return;
}
