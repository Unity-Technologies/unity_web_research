...
@group(1) @binding(1) var<uniform> x_1032 : AdditionalLights;
...
fn main_1() {
  ...
  loop {
    ...
    let x_995 : u32 = u_xlatu3;
    let x_998 : vec4<f32> = x_122.unity_LightIndices[bitcast<i32>(x_995)];
    let x_1008 : i32 = u_xlati40;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1013 : vec4<u32> = indexable[x_1008];
    u_xlat3.x = dot(x_998, bitcast<vec4<f32>>(x_1013));
    let x_1019 : f32 = u_xlat3.x;
    u_xlati3 = i32(x_1019);
    let x_1021 : vec3<f32> = vs_INTERP0;
    let x_1033 : i32 = u_xlati3;
    let x_1035 : vec4<f32> = x_1032.x_AdditionalLightsPosition[x_1033];
    let x_1038 : i32 = u_xlati3;
    let x_1040 : vec4<f32> = x_1032.x_AdditionalLightsPosition[x_1038];
    u_xlat21 = ((-(x_1021) * vec3<f32>(x_1035.w, x_1035.w, x_1035.w)) + vec3<f32>(x_1040.x, x_1040.y, x_1040.z));
    let x_1043 : vec3<f32> = u_xlat21;
    let x_1044 : vec3<f32> = u_xlat21;
    u_xlat40 = dot(x_1043, x_1044);
    let x_1046 : f32 = u_xlat40;
    u_xlat40 = max(x_1046, 6.10351562e-05f);
    let x_1049 : f32 = u_xlat40;
    u_xlat42 = inverseSqrt(x_1049);
    let x_1052 : f32 = u_xlat42;
    let x_1054 : vec3<f32> = u_xlat21;
    u_xlat10 = (vec3<f32>(x_1052, x_1052, x_1052) * x_1054);
    let x_1056 : f32 = u_xlat40;
    u_xlat43 = (1.0f / x_1056);
    let x_1058 : f32 = u_xlat40;
    let x_1059 : i32 = u_xlati3;
    let x_1061 : f32 = x_1032.x_AdditionalLightsAttenuation[x_1059].x;
    u_xlat40 = (x_1058 * x_1061);
    let x_1063 : f32 = u_xlat40;
    let x_1065 : f32 = u_xlat40;
    u_xlat40 = ((-(x_1063) * x_1065) + 1.0f);
    let x_1068 : f32 = u_xlat40;
    u_xlat40 = max(x_1068, 0.0f);
    let x_1070 : f32 = u_xlat40;
    let x_1071 : f32 = u_xlat40;
    u_xlat40 = (x_1070 * x_1071);
    let x_1073 : f32 = u_xlat40;
    let x_1074 : f32 = u_xlat43;
    u_xlat40 = (x_1073 * x_1074);
    let x_1076 : i32 = u_xlati3;
    let x_1078 : vec4<f32> = x_1032.x_AdditionalLightsSpotDir[x_1076];
    let x_1080 : vec3<f32> = u_xlat10;
    u_xlat43 = dot(vec3<f32>(x_1078.x, x_1078.y, x_1078.z), x_1080);
    let x_1082 : f32 = u_xlat43;
    let x_1083 : i32 = u_xlati3;
    let x_1085 : f32 = x_1032.x_AdditionalLightsAttenuation[x_1083].z;
    let x_1087 : i32 = u_xlati3;
    let x_1089 : f32 = x_1032.x_AdditionalLightsAttenuation[x_1087].w;
    u_xlat43 = ((x_1082 * x_1085) + x_1089);
    let x_1091 : f32 = u_xlat43;
    u_xlat43 = clamp(x_1091, 0.0f, 1.0f);
    ...
    let x_1102 : i32 = u_xlati3;
    let x_1104 : vec4<f32> = x_1032.x_AdditionalLightsColor[x_1102];
    u_xlat11 = (vec3<f32>(x_1100, x_1100, x_1100) * vec3<f32>(x_1104.x, x_1104.y, x_1104.z));
    let x_1107 : vec4<f32> = u_xlat1;
    let x_1109 : vec3<f32> = u_xlat10;
    u_xlat3.x = dot(vec3<f32>(x_1107.x, x_1107.y, x_1107.w), x_1109);
    let x_1113 : f32 = u_xlat3.x;
    u_xlat3.x = clamp(x_1113, 0.0f, 1.0f);
    let x_1117 : f32 = u_xlat3.x;
    let x_1118 : f32 = u_xlat40;
    u_xlat3.x = (x_1117 * x_1118);
    let x_1121 : vec3<f32> = u_xlat3;
    let x_1123 : vec3<f32> = u_xlat11;
    u_xlat11 = (vec3<f32>(x_1121.x, x_1121.x, x_1121.x) * x_1123);
    let x_1125 : vec3<f32> = u_xlat21;
    let x_1126 : f32 = u_xlat42;
    let x_1129 : vec3<f32> = u_xlat5;
    u_xlat21 = ((x_1125 * vec3<f32>(x_1126, x_1126, x_1126)) + x_1129);
    let x_1131 : vec3<f32> = u_xlat21;
    let x_1132 : vec3<f32> = u_xlat21;
    u_xlat3.x = dot(x_1131, x_1132);
    let x_1136 : f32 = u_xlat3.x;
    u_xlat3.x = max(x_1136, 1.17549435e-37f);
    let x_1140 : f32 = u_xlat3.x;
    u_xlat3.x = inverseSqrt(x_1140);
    let x_1143 : vec3<f32> = u_xlat3;
    let x_1145 : vec3<f32> = u_xlat21;
    u_xlat21 = (vec3<f32>(x_1143.x, x_1143.x, x_1143.x) * x_1145);
    let x_1147 : vec4<f32> = u_xlat1;
    let x_1149 : vec3<f32> = u_xlat21;
    ...
    u_xlat3.x = ((x_1168 * x_1170) + 1.000010014f);
    let x_1174 : f32 = u_xlat40;
    let x_1175 : f32 = u_xlat40;
    u_xlat40 = (x_1174 * x_1175);
    let x_1178 : f32 = u_xlat3.x;
    let x_1180 : f32 = u_xlat3.x;
    u_xlat3.x = (x_1178 * x_1180);
    let x_1183 : f32 = u_xlat40;
    u_xlat40 = max(x_1183, 0.100000001f);
    let x_1186 : f32 = u_xlat3.x;
    let x_1187 : f32 = u_xlat40;
    u_xlat3.x = (x_1186 * x_1187);
    let x_1190 : f32 = u_xlat39;
    let x_1192 : f32 = u_xlat3.x;
    u_xlat3.x = (x_1190 * x_1192);
    let x_1195 : f32 = u_xlat15;
    let x_1197 : f32 = u_xlat3.x;
    u_xlat3.x = (x_1195 / x_1197);
    let x_1200 : vec3<f32> = u_xlat0;
    let x_1201 : vec3<f32> = u_xlat3;
    let x_1204 : vec3<f32> = u_xlat8;
    u_xlat21 = ((x_1200 * vec3<f32>(x_1201.x, x_1201.x, x_1201.x)) + x_1204);
    let x_1206 : vec3<f32> = u_xlat21;
    let x_1207 : vec3<f32> = u_xlat11;
    let x_1209 : vec4<f32> = u_xlat7;
    let x_1211 : vec3<f32> = ((x_1206 * x_1207) + vec3<f32>(x_1209.x, x_1209.y, x_1209.z));
    let x_1212 : vec4<f32> = u_xlat7;
    u_xlat7 = vec4<f32>(x_1211.x, x_1211.y, x_1211.z, x_1212.w);

    continuing {
      let x_1214 : u32 = u_xlatu_loop_1;
      u_xlatu_loop_1 = (x_1214 + bitcast<u32>(1i));
    }
  }
  let x_1216 : vec4<f32> = u_xlat6;
  let x_1218 : f32 = u_xlat27;
  let x_1221 : vec4<f32> = u_xlat4;
  u_xlat0 = ((vec3<f32>(x_1216.x, x_1216.y, x_1216.z) * vec3<f32>(x_1218, x_1218, x_1218)) + vec3<f32>(x_1221.x, x_1221.y, x_1221.z));
  let x_1224 : vec4<f32> = u_xlat7;
  let x_1226 : vec3<f32> = u_xlat0;
  u_xlat0 = (vec3<f32>(x_1224.x, x_1224.y, x_1224.z) + x_1226);
  let x_1230 : vec3<f32> = u_xlat2;
  let x_1231 : f32 = u_xlat25;
  let x_1234 : vec3<f32> = u_xlat0;
  let x_1235 : vec3<f32> = ((x_1230 * vec3<f32>(x_1231, x_1231, x_1231)) + x_1234);
  let x_1236 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1235.x, x_1235.y, x_1235.z, x_1236.w);
  let x_1241 : u32 = x_45.x_RenderingLayerMaxInt;
  let x_1243 : f32 = x_122.unity_RenderingLayer.x;
  u_xlatu0 = (x_1241 & bitcast<u32>(x_1243));
  let x_1246 : u32 = u_xlatu0;
  u_xlat0.x = f32(x_1246);
  let x_1251 : f32 = u_xlat0.x;
  let x_1254 : f32 = x_45.x_RenderingLayerRcpMaxInt;
  SV_Target1.x = (x_1251 * x_1254);
  let x_1259 : f32 = SV_Target1.x;
  SV_Target1.x = clamp(x_1259, 0.0f, 1.0f);
  SV_Target0.w = 1.0f;
  let x_1263 : vec4<f32> = SV_Target1;
  SV_Target1 = vec4<f32>(x_1263.x, vec3<f32>(0.0f, 0.0f, 0.0f).x, vec3<f32>(0.0f, 0.0f, 0.0f).y, vec3<f32>(0.0f, 0.0f, 0.0f).z);
  return;
}
