...
;
    ...
    if(u_xlatb22.x){
        ...
        u_xlat42 = (u_xlatb22.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb22.x) ? u_xlat6.xyz : vec3(u_xlat42);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat29.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu63)].www + _AdditionalLightsPosition[int(u_xlatu63)].xyz;
        u_xlat65 = dot(u_xlat29.xyz, u_xlat29.xyz);
        u_xlat65 = max(u_xlat65, 6.10351562e-05);
        u_xlat46.x = inversesqrt(u_xlat65);
        u_xlat10.xyz = u_xlat46.xxx * u_xlat29.xyz;
        ...
        u_xlat66 = dot(_AdditionalLightsSpotDir[int(u_xlatu63)].xyz, u_xlat10.xyz);
        u_xlat66 = u_xlat66 * _AdditionalLightsAttenuation[int(u_xlatu63)].z + _AdditionalLightsAttenuation[int(u_xlatu63)].w;
        u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
        u_xlat66 = u_xlat66 * u_xlat66;
        u_xlat65 = u_xlat65 * u_xlat66;
        u_xlatu66 = u_xlatu63 >> (5u & uint(0x1F));
        ...
        if(u_xlati66 != 0) {
            u_xlati66 = int(_AdditionalLightsLightTypes[int(u_xlatu63)]);
            ...
            if(u_xlati67 != 0) {
                ...
                if(u_xlati66 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu63)].xy * u_xlat51.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu63)].zw;
                } else {
        ...
        u_xlat29.xyz = u_xlat29.xyz * u_xlat46.xxx + u_xlat7.xyz;
        ...
        u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
        u_xlat65 = dot(u_xlat10.xyz, u_xlat29.xyz);
        ...
        u_xlat29.xyz = u_xlat0.xyz * vec3(u_xlat63) + u_xlat5.xyz;
        u_xlat8.xyz = u_xlat29.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
