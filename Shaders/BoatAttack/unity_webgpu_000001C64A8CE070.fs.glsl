...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat1.xyw = (bool(u_xlatb66)) ? u_xlat1.xyw : u_xlat5.xyz;
...
;
    ...
    u_xlat70 = u_xlat3.x * u_xlat3.x;
    u_xlat25 = u_xlat69 + u_xlat3.y;
    ...
    u_xlat27.xyz = vec3(u_xlat72) * _MainLightColor.xyz;
    ...
    u_xlat31.xyz = (-u_xlat0.xyz) + vec3(u_xlat25);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu68 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat25 = dot(unity_LightIndices[int(u_xlatu25)], uintBitsToFloat(ImmCB_0[u_xlati71]));
        u_xlati25 = int(u_xlat25);
        u_xlat31.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati25].www + _AdditionalLightsPosition[u_xlati25].xyz;
        ...
        u_xlat71 = u_xlat71 * _AdditionalLightsAttenuation[u_xlati25].x;
        u_xlat71 = (-u_xlat71) * u_xlat71 + 1.0;
        u_xlat71 = max(u_xlat71, 0.0);
        u_xlat71 = u_xlat71 * u_xlat71;
        u_xlat71 = u_xlat71 * u_xlat74;
        u_xlat74 = dot(_AdditionalLightsSpotDir[u_xlati25].xyz, u_xlat10.xyz);
        u_xlat74 = u_xlat74 * _AdditionalLightsAttenuation[u_xlati25].z + _AdditionalLightsAttenuation[u_xlati25].w;
        u_xlat74 = clamp(u_xlat74, 0.0, 1.0);
        u_xlat74 = u_xlat74 * u_xlat74;
        u_xlat71 = u_xlat71 * u_xlat74;
        u_xlat11.xyz = vec3(u_xlat72) * _AdditionalLightsColor[u_xlati25].xyz;
        u_xlat25 = dot(u_xlat4.xyz, u_xlat10.xyz);
        u_xlat25 = clamp(u_xlat25, 0.0, 1.0);
        u_xlat25 = u_xlat25 * u_xlat71;
        u_xlat11.xyz = vec3(u_xlat25) * u_xlat11.xyz;
        u_xlat31.xyz = u_xlat31.xyz * vec3(u_xlat73) + u_xlat1.xyw;
        u_xlat25 = dot(u_xlat31.xyz, u_xlat31.xyz);
        u_xlat25 = max(u_xlat25, 1.17549435e-37);
        u_xlat25 = inversesqrt(u_xlat25);
        u_xlat31.xyz = vec3(u_xlat25) * u_xlat31.xyz;
        u_xlat25 = dot(u_xlat4.xyz, u_xlat31.xyz);
        u_xlat25 = clamp(u_xlat25, 0.0, 1.0);
        ...
        u_xlat25 = u_xlat25 * u_xlat71;
        u_xlat25 = u_xlat69 * u_xlat25;
        u_xlat25 = u_xlat70 / u_xlat25;
        u_xlat31.xyz = u_xlat0.xyz * vec3(u_xlat25) + u_xlat8.xyz;
