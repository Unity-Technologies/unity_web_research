        ...
        if(u_xlatb21){
            ...
            if(u_xlatb7.x){
                ...
                if(u_xlatb7.x){
                    ...
                    u_xlat7 = u_xlat7 + -1.0;
                    u_xlat2.x = dFdxCoarse(u_xlat7);
                    u_xlat2.y = dFdyCoarse(u_xlat7);
            ...
            if(u_xlatb21){
                ...
                if(u_xlatb16){
                    ...
                    u_xlat4 = u_xlat4 * _TextureInfo[int(u_xlatu7)].wwww;
                    ...
                    u_xlat21 = dFdxCoarse(vs_TEXCOORD0.y);
                    ...
                    if(u_xlatb0.x){
                        ...
                        u_xlat4 = textureLod(sampler2D(_ShaderInfoTex, sampler_ShaderInfoTex), u_xlat0.xw, 0.0);
                ...
                u_xlat3 = textureLod(sampler2D(_GradientSettingsTex, sampler_GradientSettingsTex), u_xlat0.xw, 0.0);
                ...
                u_xlat2 = textureLod(sampler2D(_GradientSettingsTex, sampler_GradientSettingsTex), u_xlat0.xw, 0.0);
