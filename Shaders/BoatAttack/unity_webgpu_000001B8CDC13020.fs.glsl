...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat43.x = u_xlat1.w + u_xlat1.z;
...
;
    ...
    u_xlat2.xyz = (-u_xlat0.xyz) + u_xlat2.xyz;
    u_xlat2.xyz = u_xlat43.xxx * u_xlat2.xyz + u_xlat0.xyz;
    ...
    u_xlat22.xyz = u_xlat43.xxx * vs_INTERP1.xyz + u_xlat3.xyz;
    ...
    u_xlat4.x = (u_xlatb21) ? u_xlat22.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb21) ? u_xlat22.y : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb21) ? u_xlat22.z : unity_MatrixV[2].z;
    u_xlat22.xyz = vs_INTERP0.xyz + (-_CascadeShadowSplitSpheres0.xyz);
...
;
    u_xlat22.x = (u_xlatb5.x) ? float(-1.0) : float(-0.0);
    u_xlat22.y = (u_xlatb5.y) ? float(-1.0) : float(-0.0);
    u_xlat22.z = (u_xlatb5.z) ? float(-1.0) : float(-0.0);
    u_xlat22.xyz = u_xlat22.xyz + u_xlat6.yzw;
    u_xlat6.yzw = max(u_xlat22.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat21.x = dot(u_xlat6, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat21.x = (-u_xlat21.x) + 4.0;
    u_xlatu21 = uint(u_xlat21.x);
    u_xlati21 = int(u_xlatu21) << (2 & int(0x1F));
    u_xlat22.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati21 + 1) / 4][(u_xlati21 + 1) % 4].xyz;
    u_xlat22.xyz = _MainLightWorldToShadow[u_xlati21 / 4][u_xlati21 % 4].xyz * vs_INTERP0.xxx + u_xlat22.xyz;
    u_xlat22.xyz = _MainLightWorldToShadow[(u_xlati21 + 2) / 4][(u_xlati21 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat22.xyz;
    u_xlat22.xyz = u_xlat22.xyz + _MainLightWorldToShadow[(u_xlati21 + 3) / 4][(u_xlati21 + 3) % 4].xyz;
    u_xlat3.w = 1.0;
    ...
    u_xlat6.xyz = unity_SHC.xyz * u_xlat21.xxx + u_xlat7.xyz;
    ...
    u_xlat65 = u_xlat21.x * u_xlat21.x;
    u_xlat42 = u_xlat42 + u_xlat1.x;
    u_xlat42 = min(u_xlat42, 1.0);
    u_xlat1.x = u_xlat21.x * 4.0 + 2.0;
    ...
    if(u_xlatb66){
        ...
        if(u_xlatb66){
            ...
            if(u_xlatb68){
                u_xlat6.xy = u_xlat22.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat6.xy = floor(u_xlat6.xy);
                u_xlat48.xy = u_xlat22.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                ...
                vec3 txVec6 = vec3(u_xlat48.xy,u_xlat22.z);
                ...
                vec3 txVec15 = vec3(u_xlat48.xy,u_xlat22.z);
                ...
                vec3 txVec28 = vec3(u_xlat6.xy,u_xlat22.z);
    ...
    u_xlat22.x = u_xlat66 * _MainLightShadowParams.x + u_xlat22.x;
    u_xlatb43.x = 0.0>=u_xlat22.z;
    u_xlatb64 = u_xlat22.z>=1.0;
    u_xlatb43.x = u_xlatb64 || u_xlatb43.x;
    u_xlat22.x = (u_xlatb43.x) ? 1.0 : u_xlat22.x;
    u_xlat6.xyz = vs_INTERP0.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat43.x = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat43.x = u_xlat43.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat43.x = clamp(u_xlat43.x, 0.0, 1.0);
    u_xlat64 = (-u_xlat22.x) + 1.0;
    u_xlat22.x = u_xlat43.x * u_xlat64 + u_xlat22.x;
    u_xlatb43.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb43.x){
        u_xlat43.xy = vs_INTERP0.yy * _MainLightWorldToLight[1].xy;
        u_xlat43.xy = _MainLightWorldToLight[0].xy * vs_INTERP0.xx + u_xlat43.xy;
        u_xlat43.xy = _MainLightWorldToLight[2].xy * vs_INTERP0.zz + u_xlat43.xy;
        u_xlat43.xy = u_xlat43.xy + _MainLightWorldToLight[3].xy;
        u_xlat43.xy = u_xlat43.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat6 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat43.xy, _GlobalMipBias.x);
        u_xlatb43.xy = equal(vec4(vec4(_MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat)), vec4(0.0, 1.0, 0.0, 1.0)).xy;
        u_xlat64 = (u_xlatb43.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb43.x) ? u_xlat6.xyz : vec3(u_xlat64);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat6.xyz = vec3(u_xlat67) * u_xlat6.xyz;
    u_xlat43.x = dot((-u_xlat4.xyz), u_xlat3.xyz);
    u_xlat43.x = u_xlat43.x + u_xlat43.x;
    u_xlat8.xyz = u_xlat3.xyz * (-u_xlat43.xxx) + (-u_xlat4.xyz);
    u_xlat43.x = dot(u_xlat3.xyz, u_xlat4.xyz);
    u_xlat43.x = clamp(u_xlat43.x, 0.0, 1.0);
    u_xlat43.x = (-u_xlat43.x) + 1.0;
    u_xlat43.x = u_xlat43.x * u_xlat43.x;
    u_xlat43.x = u_xlat43.x * u_xlat43.x;
    ...
    u_xlat21.x = dot(u_xlat3.xyz, u_xlat6.xyz);
    ...
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat63) + u_xlat22.xyz;
