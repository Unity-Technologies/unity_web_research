...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat42 = texture(sampler2D(_DitheringTexture, sampler_DitheringTexture), u_xlat3.xy, _GlobalMipBias.x).w;
    ...
    u_xlat42 = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    ...
    if(u_xlatb48){
        ...
        u_xlat48 = (u_xlatb8.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb8.x) ? u_xlat7.xyz : vec3(u_xlat48);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat8.xyz = u_xlat3.xyz * (-vec3(u_xlat48)) + (-u_xlat4.xyz);
    ...
    u_xlat23.xyz = vec3(u_xlat48) * u_xlat23.xyz + u_xlat0.xyz;
    ...
    u_xlat42 = u_xlat34 * unity_LightData.z;
    ...
    u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat42) + u_xlat15.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlati52 != 0) {
            ...
            u_xlat52 = (u_xlatb34.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb34.x) ? u_xlat11.xyz : vec3(u_xlat52);
        } else {
