...
fn main_1() {
  ...
  let x_1269 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1273 : vec4<f32> = x_25.x_Grain_TilingParams;
  ...
  let x_1286 : f32 = x_25.x_GlobalMipBias.x;
  let x_1287 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1283.x, x_1283.y), x_1286);
  u_xlat18 = x_1287.w;
  let x_1289 : f32 = u_xlat18;
  u_xlat18 = (x_1289 + -0.5f);
  let x_1291 : f32 = u_xlat18;
  let x_1292 : f32 = u_xlat18;
  u_xlat18 = (x_1291 + x_1292);
  let x_1294 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1294.x, x_1294.y, x_1294.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1303 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1303);
  let x_1308 : f32 = x_25.x_Grain_Params.y;
  let x_1310 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1308 * -(x_1310)) + 1.0f);
  let x_1316 : f32 = u_xlat18;
  let x_1318 : vec4<f32> = u_xlat0;
  u_xlat7 = (vec3<f32>(x_1316, x_1316, x_1316) * vec3<f32>(x_1318.x, x_1318.y, x_1318.z));
  let x_1321 : vec3<f32> = u_xlat7;
  let x_1324 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat7 = (x_1321 * vec3<f32>(x_1324.x, x_1324.x, x_1324.x));
  let x_1327 : vec3<f32> = u_xlat7;
  let x_1328 : vec3<f32> = u_xlat1;
  let x_1331 : vec4<f32> = u_xlat0;
  let x_1333 : vec3<f32> = ((x_1327 * vec3<f32>(x_1328.x, x_1328.x, x_1328.x)) + vec3<f32>(x_1331.x, x_1331.y, x_1331.z));
  let x_1334 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1333.x, x_1333.y, x_1333.z, x_1334.w);
  let x_1336 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1336.x, x_1336.y, x_1336.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1339 : vec4<f32> = u_xlat0;
  let x_1342 : vec3<f32> = log2(abs(vec3<f32>(x_1339.x, x_1339.y, x_1339.z)));
  let x_1343 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1342.x, x_1342.y, x_1342.z, x_1343.w);
  let x_1345 : vec4<f32> = u_xlat2;
  let x_1347 : vec3<f32> = (vec3<f32>(x_1345.x, x_1345.y, x_1345.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1348 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1347.x, x_1347.y, x_1347.z, x_1348.w);
  let x_1350 : vec4<f32> = u_xlat2;
  let x_1352 : vec3<f32> = exp2(vec3<f32>(x_1350.x, x_1350.y, x_1350.z));
  let x_1353 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1352.x, x_1352.y, x_1352.z, x_1353.w);
  let x_1355 : vec4<f32> = u_xlat2;
  let x_1358 : vec3<f32> = ((vec3<f32>(x_1355.x, x_1355.y, x_1355.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  ...
  let x_1404 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1408 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_1421 : f32 = x_25.x_GlobalMipBias.x;
  let x_1422 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1418.x, x_1418.y), x_1421);
  u_xlat18 = x_1422.w;
  let x_1424 : f32 = u_xlat18;
  u_xlat18 = ((x_1424 * 2.0f) + -1.0f);
  let x_1427 : f32 = u_xlat18;
  u_xlatb1.x = (x_1427 >= 0.0f);
  let x_1431 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1431);
  let x_1434 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1434)) + 1.0f);
  let x_1438 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1438);
  let x_1440 : f32 = u_xlat18;
  u_xlat18 = (-(x_1440) + 1.0f);
  let x_1443 : f32 = u_xlat18;
  let x_1445 : f32 = u_xlat1.x;
  u_xlat18 = (x_1443 * x_1445);
  let x_1447 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1447.x, x_1447.y, x_1447.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1450 : vec4<f32> = u_xlat0;
  let x_1453 : vec3<f32> = log2(abs(vec3<f32>(x_1450.x, x_1450.y, x_1450.z)));
  let x_1454 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1453.x, x_1453.y, x_1453.z, x_1454.w);
  let x_1456 : vec4<f32> = u_xlat2;
  let x_1458 : vec3<f32> = (vec3<f32>(x_1456.x, x_1456.y, x_1456.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1459 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1458.x, x_1458.y, x_1458.z, x_1459.w);
  let x_1461 : vec4<f32> = u_xlat2;
  let x_1463 : vec3<f32> = exp2(vec3<f32>(x_1461.x, x_1461.y, x_1461.z));
  let x_1464 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1463.x, x_1463.y, x_1463.z, x_1464.w);
  let x_1466 : vec4<f32> = u_xlat2;
  let x_1469 : vec3<f32> = ((vec3<f32>(x_1466.x, x_1466.y, x_1466.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1470 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1469.x, x_1469.y, x_1469.z, x_1470.w);
  let x_1472 : vec4<f32> = u_xlat0;
  let x_1474 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1472.x, x_1472.y, x_1472.z, x_1472.x));
  u_xlatb0 = vec3<bool>(x_1474.x, x_1474.y, x_1474.z);
  let x_1477 : bool = u_xlatb0.x;
  if (x_1477) {
  ...
  u_xlat0.x = x_1486;
  let x_1489 : bool = u_xlatb0.y;
  if (x_1489) {
    let x_1494 : f32 = u_xlat1.y;
    x_1490 = x_1494;
  } else {
    let x_1497 : f32 = u_xlat2.y;
    x_1490 = x_1497;
  }
  let x_1498 : f32 = x_1490;
  u_xlat0.y = x_1498;
  let x_1501 : bool = u_xlatb0.z;
  if (x_1501) {
  ...
  let x_1519 : vec3<f32> = ((vec3<f32>(x_1512, x_1512, x_1512) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1517.x, x_1517.y, x_1517.z));
  let x_1520 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1519.x, x_1519.y, x_1519.z, x_1520.w);
  let x_1522 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1522.x, x_1522.y, x_1522.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1525 : vec4<f32> = u_xlat0;
  let x_1527 : vec3<f32> = (vec3<f32>(x_1525.x, x_1525.y, x_1525.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1528 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1527.x, x_1527.y, x_1527.z, x_1528.w);
  let x_1530 : vec4<f32> = u_xlat2;
  let x_1532 : vec3<f32> = (vec3<f32>(x_1530.x, x_1530.y, x_1530.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1543 : vec3<f32> = (vec3<f32>(x_1541.x, x_1541.y, x_1541.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1544 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1543.x, x_1543.y, x_1543.z, x_1544.w);
  let x_1546 : vec4<f32> = u_xlat2;
  let x_1548 : vec3<f32> = exp2(vec3<f32>(x_1546.x, x_1546.y, x_1546.z));
  let x_1549 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1548.x, x_1548.y, x_1548.z, x_1549.w);
  let x_1551 : vec4<f32> = u_xlat0;
  let x_1553 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1551.x, x_1551.y, x_1551.z, x_1551.x));
  u_xlatb0 = vec3<bool>(x_1553.x, x_1553.y, x_1553.z);
  let x_1556 : bool = u_xlatb0.x;
  if (x_1556) {
  ...
  u_xlat0.x = x_1565;
  let x_1568 : bool = u_xlatb0.y;
  if (x_1568) {
    let x_1573 : f32 = u_xlat1.y;
    x_1569 = x_1573;
  } else {
    let x_1576 : f32 = u_xlat2.y;
    x_1569 = x_1576;
  }
  let x_1577 : f32 = x_1569;
  u_xlat0.y = x_1577;
  let x_1580 : bool = u_xlatb0.z;
  if (x_1580) {
    let x_1585 : f32 = u_xlat1.z;
    x_1581 = x_1585;
  } else {
  ...
  let x_1596 : vec3<f32> = max(vec3<f32>(x_1593.x, x_1593.y, x_1593.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1597 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1596.x, x_1596.y, x_1596.z, x_1597.w);
  SV_Target0.w = 1.0f;
  return;
}
