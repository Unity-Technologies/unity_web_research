...
;
    ...
    u_xlat45 = u_xlat4.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    ...
    if(u_xlatb16.x){
        ...
        u_xlat6 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat16.xy, _GlobalMipBias.x);
        ...
        u_xlat30 = (u_xlatb16.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb16.x) ? u_xlat6.xyz : vec3(u_xlat30);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat16.x = dot((-u_xlat7.xyz), u_xlat15.xyz);
    u_xlat16.x = u_xlat16.x + u_xlat16.x;
    u_xlat8.xyz = u_xlat15.xyz * (-u_xlat16.xxx) + (-u_xlat7.xyz);
    u_xlat16.x = dot(u_xlat15.xyz, u_xlat7.xyz);
    u_xlat16.x = clamp(u_xlat16.x, 0.0, 1.0);
    u_xlat16.x = (-u_xlat16.x) + 1.0;
    u_xlat16.x = u_xlat16.x * u_xlat16.x;
    u_xlat16.x = u_xlat16.x * u_xlat16.x;
    u_xlat30 = (-u_xlat1) * 0.699999988 + 1.70000005;
    ...
    u_xlat23.xyz = u_xlat16.xxx * u_xlat23.xyz + u_xlat0.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat23.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu45)].www + _AdditionalLightsPosition[int(u_xlatu45)].xyz;
        u_xlat47 = dot(u_xlat23.xyz, u_xlat23.xyz);
        u_xlat47 = max(u_xlat47, 6.10351562e-05);
        u_xlat34 = inversesqrt(u_xlat47);
        u_xlat10.xyz = vec3(u_xlat34) * u_xlat23.xyz;
        ...
        u_xlat23.xyz = u_xlat0.xyz * vec3(u_xlat45) + u_xlat5.xyz;
