...
layout(set = 0, binding = 15) uniform mediump  sampler samplerTexture2D_B222E8F;
layout(set = 0, binding = 16) uniform mediump  sampler samplerTexture2D_D9BFD5F1;
void main()
{
vec3 u_xlat0;
uint u_xlatu0;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat1.xzw = u_xlat1.xzw * u_xlat17.xxx;
    ...
    u_xlat18.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP5.xy, _GlobalMipBias.x).xyz;
    ...
    u_xlat19.x = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat19.x) + 1.0;
    u_xlat3.x = u_xlat3.x;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat42 = min(u_xlat42, 1.0);
    u_xlat2.xyz = u_xlat2.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat19.x = (-u_xlat3.x) + 1.0;
    u_xlat47 = u_xlat19.x * u_xlat19.x;
    u_xlat47 = max(u_xlat47, 0.0078125);
    u_xlat6 = u_xlat47 * u_xlat47;
    ...
    u_xlat48 = (-u_xlat44) + 1.0;
    u_xlat44 = u_xlat34.x * u_xlat48 + u_xlat44;
    ...
    u_xlat34.x = dot((-u_xlat17.xyz), u_xlat1.xzw);
    u_xlat34.x = u_xlat34.x + u_xlat34.x;
    u_xlat8.xyz = u_xlat1.xzw * (-u_xlat34.xxx) + (-u_xlat17.xyz);
    u_xlat34.x = dot(u_xlat1.xzw, u_xlat17.xyz);
    u_xlat34.x = clamp(u_xlat34.x, 0.0, 1.0);
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat19.x);
    ...
    u_xlat8.xyz = u_xlat8.xyz * u_xlat19.xxx;
    u_xlat19.xz = vec2(u_xlat47) * vec2(u_xlat47) + vec2(-1.0, 1.0);
    u_xlat47 = float(1.0) / u_xlat19.z;
    u_xlat3.x = u_xlat3.x + -0.0399999991;
    u_xlat3.x = u_xlat34.x * u_xlat3.x + 0.0399999991;
    u_xlat3.x = u_xlat3.x * u_xlat47;
    u_xlat8.xyz = u_xlat3.xxx * u_xlat8.xyz;
    u_xlat18.xyz = u_xlat18.xyz * u_xlat2.xyz + u_xlat8.xyz;
    ...
    u_xlat44 = dot(u_xlat1.xzw, u_xlat8.xyz);
    ...
    u_xlat44 = u_xlat6 / u_xlat44;
    u_xlat8.xyz = vec3(u_xlat44) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu44 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat47 = dot(unity_LightIndices[int(u_xlatu47)], uintBitsToFloat(ImmCB_0[u_xlati49]));
        ...
        u_xlat49 = u_xlat49 * _AdditionalLightsAttenuation[int(u_xlatu47)].x;
        u_xlat49 = (-u_xlat49) * u_xlat49 + 1.0;
        u_xlat49 = max(u_xlat49, 0.0);
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat49 = u_xlat49 * u_xlat51;
        u_xlat51 = dot(_AdditionalLightsSpotDir[int(u_xlatu47)].xyz, u_xlat10.xyz);
        u_xlat51 = u_xlat51 * _AdditionalLightsAttenuation[int(u_xlatu47)].z + _AdditionalLightsAttenuation[int(u_xlatu47)].w;
        u_xlat51 = clamp(u_xlat51, 0.0, 1.0);
        u_xlat51 = u_xlat51 * u_xlat51;
        u_xlat49 = u_xlat49 * u_xlat51;
        u_xlatu51 = u_xlatu47 >> (5u & uint(0x1F));
        u_xlati52 = 1 << (int(u_xlatu47) & int(0x1F));
        u_xlati51 = int(uint(u_xlati52) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu51)]));
        if(u_xlati51 != 0) {
            u_xlati51 = int(_AdditionalLightsLightTypes[int(u_xlatu47)]);
            u_xlati52 = (u_xlati51 != 0) ? 0 : 1;
            u_xlati11 = int(u_xlatu47) << (2 & int(0x1F));
            if(u_xlati52 != 0) {
                ...
                u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu47)].xy * u_xlat25.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu47)].zw;
            } else {
                ...
                if(u_xlati51 != 0) {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu47)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu47)].zw;
                } else {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu47)].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu47)].zw;
                }
            }
        ...
        u_xlat47 = dot(u_xlat1.xzw, u_xlat10.xyz);
        u_xlat47 = clamp(u_xlat47, 0.0, 1.0);
        u_xlat47 = u_xlat47 * u_xlat49;
        u_xlat11.xyz = vec3(u_xlat47) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat50) + u_xlat17.xyz;
        u_xlat47 = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat47 = max(u_xlat47, 1.17549435e-37);
        u_xlat47 = inversesqrt(u_xlat47);
        u_xlat9.xyz = vec3(u_xlat47) * u_xlat9.xyz;
        u_xlat47 = dot(u_xlat1.xzw, u_xlat9.xyz);
        u_xlat47 = clamp(u_xlat47, 0.0, 1.0);
        u_xlat49 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        u_xlat47 = u_xlat47 * u_xlat47;
        u_xlat47 = u_xlat47 * u_xlat19.x + 1.00001001;
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat47 = u_xlat47 * u_xlat47;
        u_xlat49 = max(u_xlat49, 0.100000001);
        u_xlat47 = u_xlat47 * u_xlat49;
        u_xlat47 = u_xlat20 * u_xlat47;
        u_xlat47 = u_xlat6 / u_xlat47;
        u_xlat9.xyz = vec3(u_xlat47) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat1.xzw = u_xlat18.xyz * u_xlat5.xxx + u_xlat7.xyz;
