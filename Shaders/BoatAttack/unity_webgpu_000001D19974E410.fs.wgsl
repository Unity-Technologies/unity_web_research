...
fn main_1() {
  ...
  u_xlat0.x = x_403;
  let x_409 : f32 = x_62.x_LightShadowData.x;
  u_xlat4 = (-(x_409) + 1.0f);
  let x_414 : vec4<f32> = u_xlat0;
  let x_416 : f32 = u_xlat4;
  let x_420 : vec4<f32> = x_62.x_LightShadowData;
  SV_Target0 = ((vec4<f32>(x_414.x, x_414.x, x_414.x, x_414.x) * vec4<f32>(x_416, x_416, x_416, x_416)) + vec4<f32>(x_420.x, x_420.x, x_420.x, x_420.x));
  return;
}
