...
fn main_1() {
  ...
  let x_135 : vec4<f32> = x_102.unity_FogColor;
  u_xlat0 = ((vec3<f32>(x_128.x, x_128.y, x_128.z) * x_130) + -(vec3<f32>(x_135.x, x_135.y, x_135.z)));
  let x_143 : f32 = u_xlat1.w;
  SV_Target0.w = x_143;
  let x_148 : f32 = vs_TEXCOORD3.w;
  let x_150 : f32 = vs_TEXCOORD3.w;
  u_xlat6 = (x_148 * -(x_150));
  let x_153 : f32 = u_xlat6;
  u_xlat6 = exp2(x_153);
  let x_155 : f32 = u_xlat6;
  let x_157 : vec3<f32> = u_xlat0;
  let x_160 : vec4<f32> = x_102.unity_FogColor;
  let x_162 : vec3<f32> = ((vec3<f32>(x_155, x_155, x_155) * x_157) + vec3<f32>(x_160.x, x_160.y, x_160.z));
