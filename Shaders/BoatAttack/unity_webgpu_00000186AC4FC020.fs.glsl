...
;
    ...
    u_xlatb22 = u_xlatb43 || u_xlatb22;
    u_xlat1.x = (u_xlatb22) ? 1.0 : u_xlat1.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat7.x = dot(unity_LightIndices[int(u_xlatu7)], uintBitsToFloat(ImmCB_0[u_xlati28]));
        u_xlati7 = int(u_xlat7.x);
        u_xlat28.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati7].www + _AdditionalLightsPosition[u_xlati7].xyz;
        u_xlat8.x = dot(u_xlat28.xyz, u_xlat28.xyz);
        u_xlat8.x = max(u_xlat8.x, 6.10351562e-05);
        u_xlat29.x = inversesqrt(u_xlat8.x);
        u_xlat9.xyz = u_xlat28.xyz * u_xlat29.xxx;
        u_xlat50 = float(1.0) / float(u_xlat8.x);
        ...
        u_xlat50 = dot(_AdditionalLightsSpotDir[u_xlati7].xyz, u_xlat9.xyz);
        u_xlat50 = u_xlat50 * _AdditionalLightsAttenuation[u_xlati7].z + _AdditionalLightsAttenuation[u_xlati7].w;
        u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
        u_xlat50 = u_xlat50 * u_xlat50;
        u_xlat8.x = u_xlat50 * u_xlat8.x;
        u_xlat10.xyz = u_xlat6.xxx * _AdditionalLightsColor[u_xlati7].xyz;
        u_xlat7.x = dot(u_xlat21.xyz, u_xlat9.xyz);
        u_xlat7.x = clamp(u_xlat7.x, 0.0, 1.0);
        u_xlat7.x = u_xlat7.x * u_xlat8.x;
        u_xlat8.xzw = u_xlat7.xxx * u_xlat10.xyz;
        u_xlat7.xyz = u_xlat28.xyz * u_xlat29.xxx + u_xlat5.xyz;
