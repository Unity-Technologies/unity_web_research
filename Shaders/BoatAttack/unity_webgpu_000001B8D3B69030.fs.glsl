...
;
    ...
    u_xlati44 = int(u_xlatu44) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati44 + 1) / 4][(u_xlati44 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati44 / 4][u_xlati44 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati44 + 2) / 4][(u_xlati44 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati44 + 3) / 4][(u_xlati44 + 3) % 4].xyz;
    ...
    u_xlat45 = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat45) + 1.0;
    ...
    if(u_xlatb17.x){
        ...
        u_xlat31.x = (u_xlatb17.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb17.x) ? u_xlat7.xyz : u_xlat31.xxx;
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat17.x = u_xlat17.x * u_xlat17.x;
    u_xlat17.x = u_xlat17.x * u_xlat17.x;
    u_xlat31.x = (-u_xlat1) * 0.699999988 + 1.70000005;
    u_xlat1 = u_xlat1 * u_xlat31.x;
    u_xlat1 = u_xlat1 * 6.0;
    ...
    u_xlat1 = float(1.0) / u_xlat31.y;
    u_xlat9.xyz = (-u_xlat0.xyz) + vec3(u_xlat42);
    u_xlat9.xyz = u_xlat17.xxx * u_xlat9.xyz + u_xlat0.xyz;
    ...
    u_xlat3.xyw = vec3(u_xlat42) * u_xlat7.xyz;
    ...
    u_xlat42 = u_xlat42 * u_xlat31.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat47 = u_xlat19 / u_xlat47;
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat47) + u_xlat6.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * u_xlat5.xxx + u_xlat3.xyw;
