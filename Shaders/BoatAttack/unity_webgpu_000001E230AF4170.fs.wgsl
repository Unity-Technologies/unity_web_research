...
fn main_1() {
  ...
  let x_1389 : vec3<f32> = sqrt(vec3<f32>(x_1387.x, x_1387.y, x_1387.z));
  let x_1390 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1389.x, x_1389.y, x_1389.z, x_1390.w);
  let x_1392 : vec2<f32> = vs_TEXCOORD0;
  let x_1395 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1399 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1401 : vec2<f32> = ((x_1392 * vec2<f32>(x_1395.x, x_1395.y)) + vec2<f32>(x_1399.z, x_1399.w));
  let x_1402 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1401.x, x_1401.y, x_1402.z, x_1402.w);
  let x_1409 : vec4<f32> = u_xlat1;
  let x_1412 : f32 = x_38.x_GlobalMipBias.x;
  let x_1413 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1409.x, x_1409.y), x_1412);
  u_xlat15 = x_1413.w;
  let x_1415 : f32 = u_xlat15;
  u_xlat15 = ((x_1415 * 2.0f) + -1.0f);
  let x_1418 : f32 = u_xlat15;
  u_xlatb1 = (x_1418 >= 0.0f);
  let x_1420 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1420);
  let x_1423 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1423)) + 1.0f);
  let x_1427 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1427);
  let x_1429 : f32 = u_xlat15;
  u_xlat15 = (-(x_1429) + 1.0f);
  let x_1432 : f32 = u_xlat15;
  let x_1434 : f32 = u_xlat1.x;
  u_xlat15 = (x_1432 * x_1434);
  let x_1436 : vec4<f32> = u_xlat0;
  let x_1438 : vec3<f32> = (vec3<f32>(x_1436.x, x_1436.y, x_1436.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1439 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1438.x, x_1438.y, x_1438.z, x_1439.w);
  let x_1441 : vec4<f32> = u_xlat0;
  let x_1443 : vec3<f32> = log2(vec3<f32>(x_1441.x, x_1441.y, x_1441.z));
  let x_1444 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1443.x, x_1443.y, x_1443.z, x_1444.w);
  let x_1446 : vec4<f32> = u_xlat2;
  let x_1448 : vec3<f32> = (vec3<f32>(x_1446.x, x_1446.y, x_1446.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1449 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1448.x, x_1448.y, x_1448.z, x_1449.w);
  let x_1451 : vec4<f32> = u_xlat2;
  let x_1453 : vec3<f32> = exp2(vec3<f32>(x_1451.x, x_1451.y, x_1451.z));
  let x_1454 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1453.x, x_1453.y, x_1453.z, x_1454.w);
  let x_1456 : vec4<f32> = u_xlat2;
  let x_1459 : vec3<f32> = ((vec3<f32>(x_1456.x, x_1456.y, x_1456.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1460 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1459.x, x_1459.y, x_1459.z, x_1460.w);
  let x_1462 : vec4<f32> = u_xlat0;
  let x_1464 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1462.x, x_1462.y, x_1462.z, x_1462.x));
  u_xlatb0 = vec3<bool>(x_1464.x, x_1464.y, x_1464.z);
  let x_1467 : bool = u_xlatb0.x;
  if (x_1467) {
    let x_1472 : f32 = u_xlat1.x;
    x_1468 = x_1472;
  } else {
    let x_1475 : f32 = u_xlat2.x;
    x_1468 = x_1475;
  }
  let x_1476 : f32 = x_1468;
  u_xlat0.x = x_1476;
  let x_1479 : bool = u_xlatb0.y;
  if (x_1479) {
    let x_1484 : f32 = u_xlat1.y;
    x_1480 = x_1484;
  } else {
  ...
  u_xlat0.y = x_1488;
  let x_1491 : bool = u_xlatb0.z;
  if (x_1491) {
    let x_1496 : f32 = u_xlat1.z;
    x_1492 = x_1496;
  } else {
    let x_1499 : f32 = u_xlat2.z;
    x_1492 = x_1499;
  }
  let x_1500 : f32 = x_1492;
  u_xlat0.z = x_1500;
  let x_1502 : f32 = u_xlat15;
  let x_1507 : vec4<f32> = u_xlat0;
  let x_1509 : vec3<f32> = ((vec3<f32>(x_1502, x_1502, x_1502) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1507.x, x_1507.y, x_1507.z));
  let x_1510 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1509.x, x_1509.y, x_1509.z, x_1510.w);
  let x_1512 : vec4<f32> = u_xlat0;
  let x_1514 : vec3<f32> = (vec3<f32>(x_1512.x, x_1512.y, x_1512.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1515 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1514.x, x_1514.y, x_1514.z, x_1515.w);
  let x_1517 : vec4<f32> = u_xlat0;
  let x_1519 : vec3<f32> = (vec3<f32>(x_1517.x, x_1517.y, x_1517.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1520 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1519.x, x_1519.y, x_1519.z, x_1520.w);
  let x_1522 : vec4<f32> = u_xlat2;
  let x_1524 : vec3<f32> = (vec3<f32>(x_1522.x, x_1522.y, x_1522.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1535 : vec3<f32> = (vec3<f32>(x_1533.x, x_1533.y, x_1533.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1545 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1543.x, x_1543.y, x_1543.z, x_1543.x));
  u_xlatb0 = vec3<bool>(x_1545.x, x_1545.y, x_1545.z);
  let x_1548 : bool = u_xlatb0.x;
  if (x_1548) {
  ...
  u_xlat0.x = x_1557;
  let x_1560 : bool = u_xlatb0.y;
  if (x_1560) {
    let x_1565 : f32 = u_xlat1.y;
    x_1561 = x_1565;
  } else {
    let x_1568 : f32 = u_xlat2.y;
    x_1561 = x_1568;
  }
  let x_1569 : f32 = x_1561;
  u_xlat0.y = x_1569;
  let x_1572 : bool = u_xlatb0.z;
  if (x_1572) {
    let x_1577 : f32 = u_xlat1.z;
    x_1573 = x_1577;
  } else {
    let x_1580 : f32 = u_xlat2.z;
    x_1573 = x_1580;
  }
  let x_1581 : f32 = x_1573;
  u_xlat0.z = x_1581;
  let x_1585 : vec4<f32> = u_xlat0;
  let x_1587 : vec3<f32> = max(vec3<f32>(x_1585.x, x_1585.y, x_1585.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1588 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1587.x, x_1587.y, x_1587.z, x_1588.w);
  SV_Target0.w = 1.0f;
  return;
}
