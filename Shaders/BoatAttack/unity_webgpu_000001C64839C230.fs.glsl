...
int u_xlati59;
    ...
    if(u_xlatb54){
        ...
        if(u_xlatb54){
            ...
            if(u_xlatb1){
                ...
                u_xlat1.x = u_xlat5.z * u_xlat10.y;
                vec3 txVec4 = vec3(u_xlat8.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec4, 0.0);
                ...
                u_xlat54 = u_xlat1.x * u_xlat57 + u_xlat56;
            } else {
                u_xlat4.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat4.xy = floor(u_xlat4.xy);
                u_xlat40.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat4.xy);
                ...
                u_xlat1.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec13, 0.0);
                vec3 txVec14 = vec3(u_xlat10.zw,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec14, 0.0);
                u_xlat56 = u_xlat56 * u_xlat15.y;
                u_xlat1.x = u_xlat15.x * u_xlat1.x + u_xlat56;
                vec3 txVec15 = vec3(u_xlat40.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec15, 0.0);
                u_xlat1.x = u_xlat15.z * u_xlat56 + u_xlat1.x;
                vec3 txVec16 = vec3(u_xlat13.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec16, 0.0);
                u_xlat1.x = u_xlat15.w * u_xlat56 + u_xlat1.x;
                vec3 txVec17 = vec3(u_xlat11.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec17, 0.0);
                u_xlat1.x = u_xlat16.x * u_xlat56 + u_xlat1.x;
                vec3 txVec18 = vec3(u_xlat11.zw,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec18, 0.0);
                u_xlat1.x = u_xlat16.y * u_xlat56 + u_xlat1.x;
                vec3 txVec19 = vec3(u_xlat12.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec19, 0.0);
                u_xlat1.x = u_xlat16.z * u_xlat56 + u_xlat1.x;
                vec3 txVec20 = vec3(u_xlat13.zw,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec20, 0.0);
                u_xlat1.x = u_xlat16.w * u_xlat56 + u_xlat1.x;
                vec3 txVec21 = vec3(u_xlat14.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec21, 0.0);
                u_xlat1.x = u_xlat17.x * u_xlat56 + u_xlat1.x;
                vec3 txVec22 = vec3(u_xlat14.zw,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec22, 0.0);
                u_xlat1.x = u_xlat17.y * u_xlat56 + u_xlat1.x;
                vec3 txVec23 = vec3(u_xlat24.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat1.x = u_xlat17.z * u_xlat56 + u_xlat1.x;
                vec3 txVec24 = vec3(u_xlat48.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec24, 0.0);
                u_xlat1.x = u_xlat17.w * u_xlat56 + u_xlat1.x;
                vec3 txVec25 = vec3(u_xlat9.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec25, 0.0);
                u_xlat1.x = u_xlat5.x * u_xlat56 + u_xlat1.x;
                vec3 txVec26 = vec3(u_xlat9.zw,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec26, 0.0);
                u_xlat1.x = u_xlat5.y * u_xlat56 + u_xlat1.x;
                vec3 txVec27 = vec3(u_xlat43.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
                u_xlat1.x = u_xlat5.z * u_xlat56 + u_xlat1.x;
                vec3 txVec28 = vec3(u_xlat4.xy,vs_TEXCOORD6.z);
                u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec28, 0.0);
                u_xlat54 = u_xlat5.w * u_xlat56 + u_xlat1.x;
            }
        }
    } else {
        vec3 txVec29 = vec3(vs_TEXCOORD6.xy,vs_TEXCOORD6.z);
        u_xlat54 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    ...
    u_xlatb1 = u_xlatb1 || u_xlatb56;
    u_xlat54 = (u_xlatb1) ? 1.0 : u_xlat54;
    u_xlat4.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat1.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat1.x = u_xlat1.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat56 = (-u_xlat54) + 1.0;
    u_xlat54 = u_xlat1.x * u_xlat56 + u_xlat54;
    ...
    if(u_xlatb1){
        ...
        u_xlat1.x = (u_xlatb5.y) ? u_xlat4.w : u_xlat4.x;
        u_xlat4.xyz = (u_xlatb5.x) ? u_xlat4.xyz : u_xlat1.xxx;
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.y = float(1.0);
        u_xlat4.z = float(1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu54 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat7.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu56)].www + _AdditionalLightsPosition[int(u_xlatu56)].xyz;
        ...
        u_xlat57 = u_xlat57 * _AdditionalLightsAttenuation[int(u_xlatu56)].x;
        u_xlat57 = (-u_xlat57) * u_xlat57 + 1.0;
        u_xlat57 = max(u_xlat57, 0.0);
        u_xlat57 = u_xlat57 * u_xlat57;
        u_xlat57 = u_xlat57 * u_xlat58;
        u_xlat58 = dot(_AdditionalLightsSpotDir[int(u_xlatu56)].xyz, u_xlat7.xyz);
        u_xlat58 = u_xlat58 * _AdditionalLightsAttenuation[int(u_xlatu56)].z + _AdditionalLightsAttenuation[int(u_xlatu56)].w;
        u_xlat58 = clamp(u_xlat58, 0.0, 1.0);
        u_xlat58 = u_xlat58 * u_xlat58;
        u_xlat57 = u_xlat57 * u_xlat58;
        u_xlatu58 = u_xlatu56 >> (5u & uint(0x1F));
        u_xlati41 = 1 << (int(u_xlatu56) & int(0x1F));
        u_xlati58 = int(uint(u_xlati41) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu58)]));
        if(u_xlati58 != 0) {
            u_xlati58 = int(_AdditionalLightsLightTypes[int(u_xlatu56)]);
            u_xlati41 = (u_xlati58 != 0) ? 0 : 1;
            u_xlati59 = int(u_xlatu56) << (2 & int(0x1F));
            if(u_xlati41 != 0) {
                u_xlat8.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati59 + 1) / 4][(u_xlati59 + 1) % 4].xyw;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[u_xlati59 / 4][u_xlati59 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat8.xyz;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[(u_xlati59 + 2) / 4][(u_xlati59 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat8.xyz;
                u_xlat8.xyz = u_xlat8.xyz + _AdditionalLightsWorldToLights[(u_xlati59 + 3) / 4][(u_xlati59 + 3) % 4].xyw;
                u_xlat8.xy = u_xlat8.xy / u_xlat8.zz;
                u_xlat8.xy = u_xlat8.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat8.xy = clamp(u_xlat8.xy, 0.0, 1.0);
                u_xlat8.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu56)].xy * u_xlat8.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu56)].zw;
            } else {
                u_xlatb58 = u_xlati58==1;
                u_xlati58 = u_xlatb58 ? 1 : int(0);
                if(u_xlati58 != 0) {
                    u_xlat44.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati59 + 1) / 4][(u_xlati59 + 1) % 4].xy;
                    u_xlat44.xy = _AdditionalLightsWorldToLights[u_xlati59 / 4][u_xlati59 % 4].xy * vs_TEXCOORD1.xx + u_xlat44.xy;
                    u_xlat44.xy = _AdditionalLightsWorldToLights[(u_xlati59 + 2) / 4][(u_xlati59 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat44.xy;
                    u_xlat44.xy = u_xlat44.xy + _AdditionalLightsWorldToLights[(u_xlati59 + 3) / 4][(u_xlati59 + 3) % 4].xy;
                    u_xlat44.xy = u_xlat44.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat44.xy = fract(u_xlat44.xy);
                    u_xlat8.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu56)].xy * u_xlat44.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu56)].zw;
                } else {
                    u_xlat9 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati59 + 1) / 4][(u_xlati59 + 1) % 4];
                    u_xlat9 = _AdditionalLightsWorldToLights[u_xlati59 / 4][u_xlati59 % 4] * vs_TEXCOORD1.xxxx + u_xlat9;
                    u_xlat9 = _AdditionalLightsWorldToLights[(u_xlati59 + 2) / 4][(u_xlati59 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat9;
                    u_xlat9 = u_xlat9 + _AdditionalLightsWorldToLights[(u_xlati59 + 3) / 4][(u_xlati59 + 3) % 4];
                    ...
                    u_xlat8.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu56)].xy * u_xlat41.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu56)].zw;
                }
            }
        ...
        u_xlat8.xyz = u_xlat8.xyz * _AdditionalLightsColor[int(u_xlatu56)].xyz;
