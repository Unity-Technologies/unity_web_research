...
fn main_1() {
  ...
  vs_INTERP0 = vec3<f32>(x_427.x, x_427.y, x_427.z);
  ...
  let x_506 : vec4<f32> = phase0_Output0_6;
  vs_INTERP5 = vec2<f32>(x_506.x, x_506.y);
  let x_509 : vec4<f32> = phase0_Output0_6;
  vs_INTERP6 = vec2<f32>(x_509.z, x_509.w);
  return;
}
