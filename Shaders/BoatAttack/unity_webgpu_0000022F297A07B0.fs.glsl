...
;
    ...
    u_xlat24 = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat24) + 1.0;
    u_xlat24 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat5.xz, _GlobalMipBias.x).x;
    ...
    u_xlat11 = (-u_xlat26) + 1.0;
    u_xlat26 = u_xlat3.x * u_xlat11 + u_xlat26;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu24 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat28 = u_xlat28 * u_xlat29;
        u_xlat7.xyz = vec3(u_xlat25) * _AdditionalLightsColor[u_xlati27].xyz;
