...
;
    ...
    u_xlat21.x = u_xlat65 * _MainLightShadowParams.x + u_xlat21.x;
    ...
    u_xlat23.xyz = u_xlat23.xyz * u_xlat5.xyz + u_xlat8.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati65].www + _AdditionalLightsPosition[u_xlati65].xyz;
        ...
        u_xlat66 = u_xlat66 * u_xlat68;
        u_xlat10.xyz = vec3(u_xlat44) * _AdditionalLightsColor[u_xlati65].xyz;
        u_xlat65 = dot(u_xlat2.xyz, u_xlat9.xyz);
        u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
        u_xlat65 = u_xlat65 * u_xlat66;
        u_xlat10.xyz = vec3(u_xlat65) * u_xlat10.xyz;
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat67) + u_xlat7.xyz;
        ...
        u_xlat65 = u_xlat65 * u_xlat66;
        u_xlat65 = u_xlat24 * u_xlat65;
        u_xlat65 = u_xlat64 / u_xlat65;
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat65) + u_xlat5.xyz;
        u_xlat6.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat6.xyz;
    }
    u_xlat0.xyz = u_xlat23.xyz * u_xlat4.xxx + u_xlat21.xyz;
