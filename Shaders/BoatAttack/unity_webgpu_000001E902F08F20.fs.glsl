...
;
    ...
    u_xlat12.xyz = (bool(u_xlatb11)) ? u_xlat12.xyz : u_xlat4.xyz;
...
;
    ...
    u_xlat4.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati11 + 1) / 4][(u_xlati11 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati11 / 4][u_xlati11 % 4].xyz * vs_INTERP0.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati11 + 2) / 4][(u_xlati11 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati11 + 3) / 4][(u_xlati11 + 3) % 4].xyz;
    ...
    u_xlat22 = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat6.z = (-u_xlat22) + 1.0;
    u_xlat22 = (-u_xlat0.x) * 0.959999979 + 0.959999979;
    u_xlat35 = (-u_xlat22) + 1.0;
    u_xlat7.xyz = vec3(u_xlat22) * u_xlat2.xyz;
    ...
    u_xlat36 = u_xlat22 * u_xlat22;
    u_xlat1.x = u_xlat1.x + u_xlat35;
    u_xlat1.x = min(u_xlat1.x, 1.0);
    u_xlat35 = u_xlat22 * 4.0 + 2.0;
    ...
    u_xlat6.x = dot((-u_xlat12.xyz), u_xlat3.xyz);
    u_xlat6.x = u_xlat6.x + u_xlat6.x;
    u_xlat6.xyz = u_xlat3.xyz * (-u_xlat6.xxx) + (-u_xlat12.xyz);
    ...
    u_xlat22 = u_xlat4.x * unity_LightData.z;
    u_xlat1.x = dot(u_xlat3.xyz, _MainLightPosition.xyz);
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat22 = u_xlat22 * u_xlat1.x;
    u_xlat4.xyz = vec3(u_xlat22) * u_xlat15.xyz;
    u_xlat6.xyz = u_xlat12.xyz + _MainLightPosition.xyz;
    ...
    u_xlat6.xyz = u_xlat2.xyz * vec3(u_xlat22) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu22 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat40) + u_xlat12.xyz;
        ...
        u_xlat8.xyz = u_xlat2.xyz * vec3(u_xlat37) + u_xlat7.xyz;
        u_xlat6.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat6.xyz;
    }
    u_xlat0.xzw = u_xlat5.xyz * vec3(u_xlat33) + u_xlat4.xyz;
