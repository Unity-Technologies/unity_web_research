...
fn main_1() {
  ...
  let x_657 : vec3<f32> = ((x_651 * vec3<f32>(x_652.x, x_652.x, x_652.x)) + vec3<f32>(x_655.x, x_655.y, x_655.z));
  let x_658 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_657.x, x_657.y, x_657.z, x_658.w);
  SV_Target0.w = 1.0f;
  return;
}
