...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat25.xyz = vec3(u_xlat43) * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat28.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati23].www + _AdditionalLightsPosition[u_xlati23].xyz;
        ...
        u_xlat65 = u_xlat65 * _AdditionalLightsAttenuation[u_xlati23].x;
        u_xlat65 = (-u_xlat65) * u_xlat65 + 1.0;
        u_xlat65 = max(u_xlat65, 0.0);
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat65 = u_xlat65 * u_xlat67;
        u_xlat67 = dot(_AdditionalLightsSpotDir[u_xlati23].xyz, u_xlat9.xyz);
        u_xlat67 = u_xlat67 * _AdditionalLightsAttenuation[u_xlati23].z + _AdditionalLightsAttenuation[u_xlati23].w;
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat65 = u_xlat65 * u_xlat67;
        u_xlat10.xyz = vec3(u_xlat43) * _AdditionalLightsColor[u_xlati23].xyz;
        u_xlat23 = dot(u_xlat21.xyz, u_xlat9.xyz);
        u_xlat23 = clamp(u_xlat23, 0.0, 1.0);
        u_xlat23 = u_xlat23 * u_xlat65;
        u_xlat10.xyz = vec3(u_xlat23) * u_xlat10.xyz;
        u_xlat28.xyz = u_xlat28.xyz * vec3(u_xlat66) + u_xlat6.xyz;
        u_xlat23 = dot(u_xlat28.xyz, u_xlat28.xyz);
        u_xlat23 = max(u_xlat23, 1.17549435e-37);
        u_xlat23 = inversesqrt(u_xlat23);
        u_xlat28.xyz = vec3(u_xlat23) * u_xlat28.xyz;
        u_xlat23 = dot(u_xlat21.xyz, u_xlat28.xyz);
        u_xlat23 = clamp(u_xlat23, 0.0, 1.0);
        ...
        u_xlat28.xyz = u_xlat0.xyz * vec3(u_xlat23) + u_xlat4.xyz;
