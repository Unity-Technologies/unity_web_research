...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu59 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat63 = dot(_AdditionalLightsSpotDir[u_xlati61].xyz, u_xlat7.xyz);
        u_xlat63 = u_xlat63 * _AdditionalLightsAttenuation[u_xlati61].z + _AdditionalLightsAttenuation[u_xlati61].w;
        u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
        u_xlat63 = u_xlat63 * u_xlat63;
        u_xlat62 = u_xlat62 * u_xlat63;
        u_xlat8.xyz = u_xlat1.xxx * _AdditionalLightsColor[u_xlati61].xyz;
        u_xlat8.xyz = vec3(u_xlat62) * u_xlat8.xyz;
        u_xlat61 = dot(u_xlat2.xyz, u_xlat7.xyz);
        u_xlat61 = clamp(u_xlat61, 0.0, 1.0);
        u_xlat9.xyz = vec3(u_xlat61) * u_xlat8.xyz;
        u_xlat7.xyz = u_xlat3.xyz * u_xlat19.xxx + u_xlat7.xyz;
        ...
        u_xlat7.xyz = vec3(u_xlat61) * _SpecColor.xyz;
