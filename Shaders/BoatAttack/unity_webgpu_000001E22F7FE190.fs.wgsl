...
fn main_1() {
  ...
  let x_1589 : vec3<f32> = (vec3<f32>(x_1587.x, x_1587.y, x_1587.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1599 : vec3<f32> = (vec3<f32>(x_1597.x, x_1597.y, x_1597.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1610 : vec3<f32> = ((vec3<f32>(x_1607.x, x_1607.y, x_1607.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1611 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1610.x, x_1610.y, x_1610.z, x_1611.w);
  let x_1613 : vec4<f32> = u_xlat0;
  let x_1615 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1613.x, x_1613.y, x_1613.z, x_1613.x));
  ...
  let x_1660 : vec3<f32> = ((vec3<f32>(x_1653, x_1653, x_1653) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1658.x, x_1658.y, x_1658.z));
  let x_1661 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1660.x, x_1660.y, x_1660.z, x_1661.w);
  let x_1663 : vec4<f32> = u_xlat0;
  let x_1665 : vec3<f32> = (vec3<f32>(x_1663.x, x_1663.y, x_1663.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1666 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1666.w);
  let x_1668 : vec4<f32> = u_xlat0;
  let x_1670 : vec3<f32> = (vec3<f32>(x_1668.x, x_1668.y, x_1668.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1671 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1670.x, x_1670.y, x_1670.z, x_1671.w);
  let x_1673 : vec4<f32> = u_xlat2;
  let x_1675 : vec3<f32> = (vec3<f32>(x_1673.x, x_1673.y, x_1673.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1686 : vec3<f32> = (vec3<f32>(x_1684.x, x_1684.y, x_1684.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1696 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1694.x, x_1694.y, x_1694.z, x_1694.x));
