...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat39 = dot((-u_xlat12.xyz), u_xlat2.xyz);
    u_xlat39 = u_xlat39 + u_xlat39;
    u_xlat7.xyz = u_xlat2.xyz * (-vec3(u_xlat39)) + (-u_xlat12.xyz);
    u_xlat39 = dot(u_xlat2.xyz, u_xlat12.xyz);
    ...
    u_xlat14.xyz = u_xlat14.xyz * u_xlat5.xyz + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat35 = dot(u_xlat2.xyz, u_xlat9.xyz);
        u_xlat35 = clamp(u_xlat35, 0.0, 1.0);
        u_xlat35 = u_xlat35 * u_xlat38;
        u_xlat10.xyz = vec3(u_xlat35) * u_xlat10.xyz;
        u_xlat19.xyz = u_xlat19.xyz * vec3(u_xlat39) + u_xlat12.xyz;
    ...
    u_xlat0.xyz = u_xlat14.xyz * u_xlat4.xxx + u_xlat6.xyz;
