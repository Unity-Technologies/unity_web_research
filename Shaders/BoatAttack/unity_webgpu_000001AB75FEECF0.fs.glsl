...
;
    ...
    u_xlat5.xyz = unity_SHC.xyz * vec3(u_xlat11) + u_xlat6.xyz;
    u_xlat4.xyz = u_xlat4.xyz + u_xlat5.xyz;
    u_xlat4.xyz = max(u_xlat4.xyz, vec3(0.0, 0.0, 0.0));
    vec3 txVec0 = vec3(u_xlat3.xy,u_xlat3.z);
    u_xlat11 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec0, 0.0);
    ...
    u_xlat1.x = (-u_xlat11) + 1.0;
    u_xlat11 = u_xlat33 * u_xlat1.x + u_xlat11;
