...
@group(1) @binding(2) var<uniform> x_225 : UnityPerMaterial;
...
fn main_1() {
  ...
  let x_213 : f32 = x_112.x_WorldSpaceCameraPos.y;
  let x_216 : f32 = u_xlat6.x;
  let x_220 : f32 = vs_INTERP0.y;
  u_xlat6.x = ((-(x_213) * x_216) + x_220);
  let x_227 : f32 = x_225.Vector1_10DA9AB3;
  let x_230 : f32 = x_112.x_BA_SkyboxRatio;
  let x_233 : f32 = u_xlat6.x;
  u_xlat6.x = ((-(x_227) * x_230) + x_233);
  let x_238 : f32 = x_112.x_BA_SkyboxRatio;
  let x_240 : f32 = x_225.Vector1_33982692;
  u_xlat12 = (x_238 * x_240);
  ...
  let x_650 : f32 = x_225.Vector1_5f4b185241524942830132fc71554a33;
  let x_652 : f32 = x_225.Vector1_5f4b185241524942830132fc71554a33;
  let x_654 : f32 = x_225.Vector1_5f4b185241524942830132fc71554a33;
  ...
  let x_752 : f32 = x_225.Vector1_2a375228e8d3437382814520b0cd8644;
  ...
  let x_792 : f32 = x_112.unity_OrthoParams.w;
  u_xlatb2 = (x_792 == 0.0f);
  let x_795 : f32 = x_112.unity_MatrixV[0i].z;
  u_xlat4.x = x_795;
  let x_798 : f32 = x_112.unity_MatrixV[1i].z;
  u_xlat4.y = x_798;
  let x_801 : f32 = x_112.unity_MatrixV[2i].z;
  u_xlat4.z = x_801;
  let x_803 : bool = u_xlatb2;
  if (x_803) {
  ...
  let x_810 : vec3<f32> = x_804;
  u_xlat7 = x_810;
  let x_811 : vec3<f32> = u_xlat7;
  let x_812 : vec3<f32> = u_xlat7;
  u_xlat2.x = dot(x_811, x_812);
  let x_816 : f32 = u_xlat2.x;
  u_xlat2.x = inverseSqrt(x_816);
  let x_819 : vec3<f32> = u_xlat7;
  let x_820 : vec4<f32> = u_xlat2;
  u_xlat7 = (x_819 * vec3<f32>(x_820.x, x_820.x, x_820.x));
  let x_823 : vec3<f32> = u_xlat7;
  let x_825 : vec4<f32> = x_112.x_MainLightPosition;
  u_xlat7.x = dot(x_823, -(vec3<f32>(x_825.x, x_825.y, x_825.z)));
  let x_831 : f32 = u_xlat7.x;
  u_xlat7.x = clamp(x_831, 0.0f, 1.0f);
  let x_835 : f32 = u_xlat7.x;
  u_xlat7.x = log2(x_835);
  let x_839 : f32 = u_xlat7.x;
  u_xlat7.x = (x_839 * 150.0f);
  let x_844 : f32 = u_xlat7.x;
  u_xlat7.x = exp2(x_844);
  let x_848 : f32 = u_xlat7.x;
  u_xlat7.x = (x_848 + 1.0f);
  let x_852 : f32 = u_xlat1.x;
  let x_854 : f32 = u_xlat7.x;
  u_xlat1.x = (x_852 * x_854);
  let x_858 : vec4<f32> = x_112.x_MainLightColor;
  let x_860 : vec4<f32> = u_xlat1;
  let x_863 : vec3<f32> = u_xlat6;
  u_xlat6 = ((vec3<f32>(x_858.x, x_858.y, x_858.z) * vec3<f32>(x_860.x, x_860.x, x_860.x)) + x_863);
  let x_866 : vec4<f32> = x_225.Color_7eff2e7fc27440719d0a871a39dabdd3;
  let x_868 : vec3<f32> = u_xlat6;
  let x_872 : vec4<f32> = x_112.unity_FogColor;
  u_xlat6 = ((vec3<f32>(x_866.x, x_866.y, x_866.z) * x_868) + -(vec3<f32>(x_872.x, x_872.y, x_872.z)));
  let x_878 : vec4<f32> = u_xlat0;
  let x_880 : vec3<f32> = u_xlat6;
  let x_883 : vec4<f32> = x_112.unity_FogColor;
  let x_885 : vec3<f32> = ((vec3<f32>(x_878.x, x_878.x, x_878.x) * x_880) + vec3<f32>(x_883.x, x_883.y, x_883.z));
  let x_886 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_885.x, x_885.y, x_885.z, x_886.w);
  let x_890 : f32 = x_112.x_BA_CloudData.w;
  u_xlat0.x = (-(x_890) + 1.0f);
  let x_895 : f32 = u_xlat0.x;
  let x_898 : f32 = u_xlat3.z;
  u_xlat0.x = (-(x_895) + x_898);
  let x_902 : f32 = u_xlat3.w;
  u_xlat6.x = (-(x_902) + 1.0f);
  let x_907 : f32 = u_xlat6.x;
  u_xlat6.x = log2(x_907);
  let x_911 : f32 = u_xlat6.x;
  let x_913 : f32 = x_225.Vector1_2a375228e8d3437382814520b0cd8644;
  u_xlat6.x = (x_911 * x_913);
  let x_917 : f32 = u_xlat6.x;
  u_xlat6.x = exp2(x_917);
  let x_921 : f32 = u_xlat6.x;
  u_xlat6.x = (-(x_921) + 1.0f);
  let x_926 : f32 = u_xlat0.x;
  u_xlat0.x = (x_926 * 10.0f);
  let x_931 : f32 = u_xlat0.x;
  u_xlat0.x = clamp(x_931, 0.0f, 1.0f);
  let x_935 : f32 = u_xlat0.x;
  u_xlat12 = ((x_935 * -2.0f) + 3.0f);
  let x_941 : f32 = u_xlat0.x;
  let x_943 : f32 = u_xlat0.x;
  u_xlat0.x = (x_941 * x_943);
  let x_947 : f32 = u_xlat0.x;
  let x_948 : f32 = u_xlat12;
  u_xlat0.x = (x_947 * x_948);
  let x_952 : f32 = u_xlat0.x;
  let x_954 : f32 = u_xlat6.x;
  SV_Target0.w = min(x_952, x_954);
  let x_962 : u32 = x_112.x_RenderingLayerMaxInt;
  let x_965 : f32 = x_21.unity_RenderingLayer.x;
  u_xlatu0 = (x_962 & bitcast<u32>(x_965));
  let x_968 : u32 = u_xlatu0;
  u_xlat0.x = f32(x_968);
  let x_973 : f32 = u_xlat0.x;
  let x_975 : f32 = x_112.x_RenderingLayerRcpMaxInt;
  SV_Target1.x = (x_973 * x_975);
  let x_979 : f32 = SV_Target1.x;
  SV_Target1.x = clamp(x_979, 0.0f, 1.0f);
  let x_982 : vec4<f32> = SV_Target1;
  SV_Target1 = vec4<f32>(x_982.x, vec3<f32>(0.0f, 0.0f, 0.0f).x, vec3<f32>(0.0f, 0.0f, 0.0f).y, vec3<f32>(0.0f, 0.0f, 0.0f).z);
  return;
}
