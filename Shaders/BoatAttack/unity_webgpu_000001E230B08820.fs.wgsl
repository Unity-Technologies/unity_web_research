...
fn main_1() {
  ...
  let x_1471 : vec3<f32> = (vec3<f32>(x_1469.x, x_1469.y, x_1469.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1472 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1471.x, x_1471.y, x_1471.z, x_1472.w);
  let x_1474 : vec4<f32> = u_xlat0;
  let x_1477 : vec3<f32> = log2(abs(vec3<f32>(x_1474.x, x_1474.y, x_1474.z)));
  let x_1478 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1477.x, x_1477.y, x_1477.z, x_1478.w);
  let x_1480 : vec4<f32> = u_xlat2;
  let x_1482 : vec3<f32> = (vec3<f32>(x_1480.x, x_1480.y, x_1480.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1483 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1482.x, x_1482.y, x_1482.z, x_1483.w);
  let x_1485 : vec4<f32> = u_xlat2;
  let x_1487 : vec3<f32> = exp2(vec3<f32>(x_1485.x, x_1485.y, x_1485.z));
  let x_1488 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1487.x, x_1487.y, x_1487.z, x_1488.w);
  let x_1490 : vec4<f32> = u_xlat2;
  let x_1493 : vec3<f32> = ((vec3<f32>(x_1490.x, x_1490.y, x_1490.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1494 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1493.x, x_1493.y, x_1493.z, x_1494.w);
  let x_1496 : vec4<f32> = u_xlat0;
  let x_1498 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1496.x, x_1496.y, x_1496.z, x_1496.x));
  u_xlatb0 = vec3<bool>(x_1498.x, x_1498.y, x_1498.z);
  let x_1501 : bool = u_xlatb0.x;
  if (x_1501) {
  ...
  u_xlat0.x = x_1510;
  let x_1513 : bool = u_xlatb0.y;
  if (x_1513) {
    let x_1518 : f32 = u_xlat1.y;
    x_1514 = x_1518;
  } else {
    let x_1521 : f32 = u_xlat2.y;
    x_1514 = x_1521;
  }
  let x_1522 : f32 = x_1514;
  u_xlat0.y = x_1522;
  let x_1525 : bool = u_xlatb0.z;
  if (x_1525) {
    let x_1530 : f32 = u_xlat1.z;
    x_1526 = x_1530;
  } else {
  ...
  u_xlat0.z = x_1534;
  let x_1536 : vec2<f32> = vs_TEXCOORD0;
  let x_1539 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1543 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1545 : vec2<f32> = ((x_1536 * vec2<f32>(x_1539.x, x_1539.y)) + vec2<f32>(x_1543.z, x_1543.w));
  let x_1546 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1545.x, x_1545.y, x_1546.z, x_1546.w);
  let x_1553 : vec4<f32> = u_xlat1;
  let x_1556 : f32 = x_38.x_GlobalMipBias.x;
  let x_1557 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1553.x, x_1553.y), x_1556);
  u_xlat15 = x_1557.w;
  let x_1559 : f32 = u_xlat15;
  u_xlat15 = ((x_1559 * 2.0f) + -1.0f);
  let x_1562 : f32 = u_xlat15;
  u_xlatb1 = (x_1562 >= 0.0f);
  let x_1564 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1564);
  let x_1567 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1567)) + 1.0f);
  let x_1571 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1571);
  let x_1573 : f32 = u_xlat15;
  u_xlat15 = (-(x_1573) + 1.0f);
  let x_1576 : f32 = u_xlat15;
  let x_1578 : f32 = u_xlat1.x;
  u_xlat15 = (x_1576 * x_1578);
  let x_1580 : vec4<f32> = u_xlat0;
  let x_1582 : vec3<f32> = (vec3<f32>(x_1580.x, x_1580.y, x_1580.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1583 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1582.x, x_1582.y, x_1582.z, x_1583.w);
  let x_1585 : vec4<f32> = u_xlat0;
  let x_1588 : vec3<f32> = log2(abs(vec3<f32>(x_1585.x, x_1585.y, x_1585.z)));
  let x_1589 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1588.x, x_1588.y, x_1588.z, x_1589.w);
  let x_1591 : vec4<f32> = u_xlat2;
  let x_1593 : vec3<f32> = (vec3<f32>(x_1591.x, x_1591.y, x_1591.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1594 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1593.x, x_1593.y, x_1593.z, x_1594.w);
  let x_1596 : vec4<f32> = u_xlat2;
  let x_1598 : vec3<f32> = exp2(vec3<f32>(x_1596.x, x_1596.y, x_1596.z));
  let x_1599 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1598.x, x_1598.y, x_1598.z, x_1599.w);
  let x_1601 : vec4<f32> = u_xlat2;
  let x_1604 : vec3<f32> = ((vec3<f32>(x_1601.x, x_1601.y, x_1601.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1605 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1604.x, x_1604.y, x_1604.z, x_1605.w);
  let x_1607 : vec4<f32> = u_xlat0;
  let x_1609 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1607.x, x_1607.y, x_1607.z, x_1607.x));
  u_xlatb0 = vec3<bool>(x_1609.x, x_1609.y, x_1609.z);
  let x_1612 : bool = u_xlatb0.x;
  if (x_1612) {
    let x_1617 : f32 = u_xlat1.x;
    x_1613 = x_1617;
  } else {
    let x_1620 : f32 = u_xlat2.x;
    x_1613 = x_1620;
  }
  let x_1621 : f32 = x_1613;
  u_xlat0.x = x_1621;
  let x_1624 : bool = u_xlatb0.y;
  if (x_1624) {
    let x_1629 : f32 = u_xlat1.y;
    x_1625 = x_1629;
  } else {
    let x_1632 : f32 = u_xlat2.y;
    x_1625 = x_1632;
  }
  let x_1633 : f32 = x_1625;
  u_xlat0.y = x_1633;
  let x_1636 : bool = u_xlatb0.z;
  if (x_1636) {
    let x_1641 : f32 = u_xlat1.z;
    x_1637 = x_1641;
  } else {
  ...
  u_xlat0.z = x_1645;
  let x_1647 : f32 = u_xlat15;
  let x_1652 : vec4<f32> = u_xlat0;
  let x_1654 : vec3<f32> = ((vec3<f32>(x_1647, x_1647, x_1647) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1652.x, x_1652.y, x_1652.z));
  let x_1655 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1654.x, x_1654.y, x_1654.z, x_1655.w);
  let x_1657 : vec4<f32> = u_xlat0;
  let x_1659 : vec3<f32> = (vec3<f32>(x_1657.x, x_1657.y, x_1657.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1660 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1659.x, x_1659.y, x_1659.z, x_1660.w);
  let x_1662 : vec4<f32> = u_xlat0;
  let x_1664 : vec3<f32> = (vec3<f32>(x_1662.x, x_1662.y, x_1662.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1665 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1664.x, x_1664.y, x_1664.z, x_1665.w);
  let x_1667 : vec4<f32> = u_xlat2;
  let x_1669 : vec3<f32> = (vec3<f32>(x_1667.x, x_1667.y, x_1667.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1670 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1669.x, x_1669.y, x_1669.z, x_1670.w);
  let x_1672 : vec4<f32> = u_xlat2;
  let x_1675 : vec3<f32> = log2(abs(vec3<f32>(x_1672.x, x_1672.y, x_1672.z)));
  let x_1676 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1675.x, x_1675.y, x_1675.z, x_1676.w);
  let x_1678 : vec4<f32> = u_xlat2;
  let x_1680 : vec3<f32> = (vec3<f32>(x_1678.x, x_1678.y, x_1678.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1690 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1688.x, x_1688.y, x_1688.z, x_1688.x));
  ...
  let x_1732 : vec3<f32> = max(vec3<f32>(x_1730.x, x_1730.y, x_1730.z), vec3<f32>(0.0f, 0.0f, 0.0f));
