...
fn main_1() {
  ...
  let x_1495 : vec2<f32> = vs_TEXCOORD0;
  let x_1498 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1502 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1504 : vec2<f32> = ((x_1495 * vec2<f32>(x_1498.x, x_1498.y)) + vec2<f32>(x_1502.z, x_1502.w));
  let x_1505 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1504.x, x_1504.y, x_1505.z, x_1505.w);
  let x_1512 : vec4<f32> = u_xlat1;
  let x_1515 : f32 = x_38.x_GlobalMipBias.x;
  let x_1516 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1512.x, x_1512.y), x_1515);
  u_xlat15 = x_1516.w;
  let x_1518 : f32 = u_xlat15;
  u_xlat15 = ((x_1518 * 2.0f) + -1.0f);
  let x_1521 : f32 = u_xlat15;
  u_xlatb1 = (x_1521 >= 0.0f);
  let x_1523 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1523);
  let x_1526 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1526)) + 1.0f);
  let x_1530 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1530);
  let x_1532 : f32 = u_xlat15;
  u_xlat15 = (-(x_1532) + 1.0f);
  let x_1535 : f32 = u_xlat15;
  let x_1537 : f32 = u_xlat1.x;
  u_xlat15 = (x_1535 * x_1537);
  let x_1539 : vec4<f32> = u_xlat0;
  let x_1541 : vec3<f32> = (vec3<f32>(x_1539.x, x_1539.y, x_1539.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1542 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1541.x, x_1541.y, x_1541.z, x_1542.w);
  let x_1544 : vec4<f32> = u_xlat0;
  let x_1547 : vec3<f32> = log2(abs(vec3<f32>(x_1544.x, x_1544.y, x_1544.z)));
  let x_1548 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1547.x, x_1547.y, x_1547.z, x_1548.w);
  let x_1550 : vec4<f32> = u_xlat2;
  let x_1552 : vec3<f32> = (vec3<f32>(x_1550.x, x_1550.y, x_1550.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1553 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1552.x, x_1552.y, x_1552.z, x_1553.w);
  let x_1555 : vec4<f32> = u_xlat2;
  let x_1557 : vec3<f32> = exp2(vec3<f32>(x_1555.x, x_1555.y, x_1555.z));
  let x_1558 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1557.x, x_1557.y, x_1557.z, x_1558.w);
  let x_1560 : vec4<f32> = u_xlat2;
  let x_1563 : vec3<f32> = ((vec3<f32>(x_1560.x, x_1560.y, x_1560.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1564 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1563.x, x_1563.y, x_1563.z, x_1564.w);
  let x_1566 : vec4<f32> = u_xlat0;
  let x_1568 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1566.x, x_1566.y, x_1566.z, x_1566.x));
  u_xlatb0 = vec3<bool>(x_1568.x, x_1568.y, x_1568.z);
  let x_1571 : bool = u_xlatb0.x;
  if (x_1571) {
    let x_1576 : f32 = u_xlat1.x;
    x_1572 = x_1576;
  } else {
    let x_1579 : f32 = u_xlat2.x;
    x_1572 = x_1579;
  }
  let x_1580 : f32 = x_1572;
  u_xlat0.x = x_1580;
  let x_1583 : bool = u_xlatb0.y;
  if (x_1583) {
    let x_1588 : f32 = u_xlat1.y;
    x_1584 = x_1588;
  } else {
    let x_1591 : f32 = u_xlat2.y;
    x_1584 = x_1591;
  }
  let x_1592 : f32 = x_1584;
  u_xlat0.y = x_1592;
  let x_1595 : bool = u_xlatb0.z;
  if (x_1595) {
    let x_1600 : f32 = u_xlat1.z;
    x_1596 = x_1600;
  } else {
  ...
  u_xlat0.z = x_1604;
  let x_1606 : f32 = u_xlat15;
  let x_1611 : vec4<f32> = u_xlat0;
  let x_1613 : vec3<f32> = ((vec3<f32>(x_1606, x_1606, x_1606) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1611.x, x_1611.y, x_1611.z));
  let x_1614 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1613.x, x_1613.y, x_1613.z, x_1614.w);
  let x_1616 : vec4<f32> = u_xlat0;
  let x_1618 : vec3<f32> = (vec3<f32>(x_1616.x, x_1616.y, x_1616.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1619 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1618.x, x_1618.y, x_1618.z, x_1619.w);
  let x_1621 : vec4<f32> = u_xlat0;
  let x_1623 : vec3<f32> = (vec3<f32>(x_1621.x, x_1621.y, x_1621.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1624 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1623.x, x_1623.y, x_1623.z, x_1624.w);
  let x_1626 : vec4<f32> = u_xlat2;
  let x_1628 : vec3<f32> = (vec3<f32>(x_1626.x, x_1626.y, x_1626.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1629 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1628.x, x_1628.y, x_1628.z, x_1629.w);
  let x_1631 : vec4<f32> = u_xlat2;
  let x_1634 : vec3<f32> = log2(abs(vec3<f32>(x_1631.x, x_1631.y, x_1631.z)));
  let x_1635 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1634.x, x_1634.y, x_1634.z, x_1635.w);
  let x_1637 : vec4<f32> = u_xlat2;
  let x_1639 : vec3<f32> = (vec3<f32>(x_1637.x, x_1637.y, x_1637.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1640 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1639.x, x_1639.y, x_1639.z, x_1640.w);
  let x_1642 : vec4<f32> = u_xlat2;
  let x_1644 : vec3<f32> = exp2(vec3<f32>(x_1642.x, x_1642.y, x_1642.z));
  let x_1645 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1644.x, x_1644.y, x_1644.z, x_1645.w);
  let x_1647 : vec4<f32> = u_xlat0;
  let x_1649 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1647.x, x_1647.y, x_1647.z, x_1647.x));
  u_xlatb0 = vec3<bool>(x_1649.x, x_1649.y, x_1649.z);
  let x_1652 : bool = u_xlatb0.x;
  if (x_1652) {
  ...
  u_xlat0.x = x_1661;
  let x_1664 : bool = u_xlatb0.y;
  if (x_1664) {
    let x_1669 : f32 = u_xlat1.y;
    x_1665 = x_1669;
  } else {
    let x_1672 : f32 = u_xlat2.y;
    x_1665 = x_1672;
  }
  let x_1673 : f32 = x_1665;
  u_xlat0.y = x_1673;
  let x_1676 : bool = u_xlatb0.z;
  if (x_1676) {
    let x_1681 : f32 = u_xlat1.z;
    x_1677 = x_1681;
  } else {
  ...
  let x_1691 : vec3<f32> = max(vec3<f32>(x_1689.x, x_1689.y, x_1689.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1692 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1691.x, x_1691.y, x_1691.z, x_1692.w);
  SV_Target0.w = 1.0f;
  return;
}
