...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1206.x, x_1206.y, x_1206.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1209 : vec4<f32> = u_xlat0;
  let x_1212 : vec3<f32> = log2(abs(vec3<f32>(x_1209.x, x_1209.y, x_1209.z)));
  let x_1213 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1212.x, x_1212.y, x_1212.z, x_1213.w);
  let x_1215 : vec4<f32> = u_xlat2;
  let x_1217 : vec3<f32> = (vec3<f32>(x_1215.x, x_1215.y, x_1215.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1218 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1217.x, x_1217.y, x_1217.z, x_1218.w);
  let x_1220 : vec4<f32> = u_xlat2;
  let x_1222 : vec3<f32> = exp2(vec3<f32>(x_1220.x, x_1220.y, x_1220.z));
  let x_1223 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1222.x, x_1222.y, x_1222.z, x_1223.w);
  let x_1225 : vec4<f32> = u_xlat2;
  let x_1228 : vec3<f32> = ((vec3<f32>(x_1225.x, x_1225.y, x_1225.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1229 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1228.x, x_1228.y, x_1228.z, x_1229.w);
  let x_1231 : vec4<f32> = u_xlat0;
  let x_1233 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1231.x, x_1231.y, x_1231.z, x_1231.x));
  u_xlatb0 = vec3<bool>(x_1233.x, x_1233.y, x_1233.z);
  let x_1238 : bool = u_xlatb0.x;
  if (x_1238) {
