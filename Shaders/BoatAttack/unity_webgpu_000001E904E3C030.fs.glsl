...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat6.xzw = vec3(u_xlat43) * u_xlat7.xyz;
    ...
    u_xlat43 = u_xlat43 * u_xlat18.x + 1.00001001;
    ...
    u_xlat7.xyz = vec3(u_xlat43) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat5.xyz;
    ...
    u_xlat14.xyz = u_xlat17.xyz * u_xlat4.xxx + u_xlat6.xzw;
    u_xlat14.xyz = u_xlat8.xyz + u_xlat14.xyz;
    u_xlat14.xyz = vs_INTERP4.www * u_xlat1.xyz + u_xlat14.xyz;
