...
;
    ...
    u_xlat2.x = u_xlat23 * u_xlat44 + u_xlat2.x;
    u_xlat7.xyz = vec3(u_xlat46) * _MainLightColor.xyz;
    u_xlat8.x = vs_TEXCOORD3.w;
    u_xlat8.y = vs_TEXCOORD4.w;
    u_xlat8.z = vs_TEXCOORD5.w;
    u_xlat23 = dot((-u_xlat8.xyz), u_xlat1.xyz);
    u_xlat23 = u_xlat23 + u_xlat23;
    u_xlat9.xyz = u_xlat1.xyz * (-vec3(u_xlat23)) + (-u_xlat8.xyz);
    ...
    u_xlat10.xyz = vec3(u_xlat23) * u_xlat10.xyz + u_xlat5.xyz;
