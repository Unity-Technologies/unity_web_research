...
fn main_1() {
  ...
  let x_1336 : vec2<f32> = vs_TEXCOORD0;
  let x_1339 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1343 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1345 : vec2<f32> = ((x_1336 * vec2<f32>(x_1339.x, x_1339.y)) + vec2<f32>(x_1343.z, x_1343.w));
  let x_1346 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1345.x, x_1345.y, x_1346.z);
  let x_1353 : vec3<f32> = u_xlat1;
  let x_1356 : f32 = x_25.x_GlobalMipBias.x;
  let x_1357 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1353.x, x_1353.y), x_1356);
  u_xlat18 = x_1357.w;
  let x_1359 : f32 = u_xlat18;
  u_xlat18 = ((x_1359 * 2.0f) + -1.0f);
  let x_1362 : f32 = u_xlat18;
  u_xlatb1.x = (x_1362 >= 0.0f);
  let x_1366 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1366);
  let x_1369 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1369)) + 1.0f);
  let x_1373 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1373);
  let x_1375 : f32 = u_xlat18;
  u_xlat18 = (-(x_1375) + 1.0f);
  let x_1378 : f32 = u_xlat18;
  let x_1380 : f32 = u_xlat1.x;
  u_xlat18 = (x_1378 * x_1380);
  let x_1382 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1382.x, x_1382.y, x_1382.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1385 : vec4<f32> = u_xlat0;
  let x_1388 : vec3<f32> = log2(abs(vec3<f32>(x_1385.x, x_1385.y, x_1385.z)));
  let x_1389 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1388.x, x_1388.y, x_1388.z, x_1389.w);
  let x_1391 : vec4<f32> = u_xlat2;
  let x_1393 : vec3<f32> = (vec3<f32>(x_1391.x, x_1391.y, x_1391.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1394 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1393.x, x_1393.y, x_1393.z, x_1394.w);
  let x_1396 : vec4<f32> = u_xlat2;
  let x_1398 : vec3<f32> = exp2(vec3<f32>(x_1396.x, x_1396.y, x_1396.z));
  let x_1399 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1398.x, x_1398.y, x_1398.z, x_1399.w);
  let x_1401 : vec4<f32> = u_xlat2;
  let x_1404 : vec3<f32> = ((vec3<f32>(x_1401.x, x_1401.y, x_1401.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1405 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1404.x, x_1404.y, x_1404.z, x_1405.w);
  let x_1407 : vec4<f32> = u_xlat0;
  let x_1409 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1407.x, x_1407.y, x_1407.z, x_1407.x));
  u_xlatb0 = vec3<bool>(x_1409.x, x_1409.y, x_1409.z);
  let x_1412 : bool = u_xlatb0.x;
  if (x_1412) {
    let x_1417 : f32 = u_xlat1.x;
    x_1413 = x_1417;
  } else {
    let x_1420 : f32 = u_xlat2.x;
    x_1413 = x_1420;
  }
  let x_1421 : f32 = x_1413;
  u_xlat0.x = x_1421;
  let x_1424 : bool = u_xlatb0.y;
  if (x_1424) {
    let x_1429 : f32 = u_xlat1.y;
    x_1425 = x_1429;
  } else {
    let x_1432 : f32 = u_xlat2.y;
    x_1425 = x_1432;
  }
  let x_1433 : f32 = x_1425;
  u_xlat0.y = x_1433;
  let x_1436 : bool = u_xlatb0.z;
  if (x_1436) {
    let x_1441 : f32 = u_xlat1.z;
    x_1437 = x_1441;
  } else {
  ...
  let x_1454 : vec3<f32> = ((vec3<f32>(x_1447, x_1447, x_1447) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1452.x, x_1452.y, x_1452.z));
  let x_1455 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1454.x, x_1454.y, x_1454.z, x_1455.w);
  let x_1457 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1457.x, x_1457.y, x_1457.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1460 : vec4<f32> = u_xlat0;
  let x_1462 : vec3<f32> = (vec3<f32>(x_1460.x, x_1460.y, x_1460.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1463 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1462.x, x_1462.y, x_1462.z, x_1463.w);
  let x_1465 : vec4<f32> = u_xlat2;
  let x_1467 : vec3<f32> = (vec3<f32>(x_1465.x, x_1465.y, x_1465.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1468 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1467.x, x_1467.y, x_1467.z, x_1468.w);
  let x_1470 : vec4<f32> = u_xlat2;
  let x_1473 : vec3<f32> = log2(abs(vec3<f32>(x_1470.x, x_1470.y, x_1470.z)));
  let x_1474 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1473.x, x_1473.y, x_1473.z, x_1474.w);
  let x_1476 : vec4<f32> = u_xlat2;
  let x_1478 : vec3<f32> = (vec3<f32>(x_1476.x, x_1476.y, x_1476.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1479 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1478.x, x_1478.y, x_1478.z, x_1479.w);
  let x_1481 : vec4<f32> = u_xlat2;
  let x_1483 : vec3<f32> = exp2(vec3<f32>(x_1481.x, x_1481.y, x_1481.z));
  let x_1484 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1483.x, x_1483.y, x_1483.z, x_1484.w);
  let x_1486 : vec4<f32> = u_xlat0;
  let x_1488 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1486.x, x_1486.y, x_1486.z, x_1486.x));
  u_xlatb0 = vec3<bool>(x_1488.x, x_1488.y, x_1488.z);
  let x_1491 : bool = u_xlatb0.x;
  if (x_1491) {
    let x_1496 : f32 = u_xlat1.x;
    x_1492 = x_1496;
  } else {
    let x_1499 : f32 = u_xlat2.x;
    x_1492 = x_1499;
  }
  ...
  let x_1531 : vec3<f32> = max(vec3<f32>(x_1528.x, x_1528.y, x_1528.z), vec3<f32>(0.0f, 0.0f, 0.0f));
