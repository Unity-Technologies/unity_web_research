...
fn main_1() {
  ...
  let x_636 : vec4<f32> = x_408.Color_7eff2e7fc27440719d0a871a39dabdd3;
  ...
  let x_666 : f32 = x_408.Vector1_2a375228e8d3437382814520b0cd8644;
  ...
  let x_716 : u32 = x_152.x_RenderingLayerMaxInt;
  let x_719 : f32 = x_29.unity_RenderingLayer.x;
  u_xlatu0 = (x_716 & bitcast<u32>(x_719));
  let x_722 : u32 = u_xlatu0;
  u_xlat0.x = f32(x_722);
  let x_727 : f32 = u_xlat0.x;
  let x_729 : f32 = x_152.x_RenderingLayerRcpMaxInt;
  SV_Target1.x = (x_727 * x_729);
  let x_733 : f32 = SV_Target1.x;
  SV_Target1.x = clamp(x_733, 0.0f, 1.0f);
  let x_736 : vec4<f32> = SV_Target1;
  SV_Target1 = vec4<f32>(x_736.x, vec3<f32>(0.0f, 0.0f, 0.0f).x, vec3<f32>(0.0f, 0.0f, 0.0f).y, vec3<f32>(0.0f, 0.0f, 0.0f).z);
  return;
}
