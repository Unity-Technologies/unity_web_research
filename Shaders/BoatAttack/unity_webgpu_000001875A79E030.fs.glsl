...
;
    ...
    u_xlat30 = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat6.z = (-u_xlat30) + 1.0;
    u_xlat30 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat6.xz, _GlobalMipBias.x).x;
    ...
    u_xlat32 = u_xlat33 * u_xlat4.x + u_xlat32;
