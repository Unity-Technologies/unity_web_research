...
;
    u_xlat15.x = (u_xlatb3.x) ? float(-1.0) : float(-0.0);
    u_xlat15.y = (u_xlatb3.y) ? float(-1.0) : float(-0.0);
    u_xlat15.z = (u_xlatb3.z) ? float(-1.0) : float(-0.0);
    u_xlat15.xyz = u_xlat15.xyz + u_xlat4.yzw;
    u_xlat4.yzw = max(u_xlat15.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat15.x = dot(u_xlat4, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat15.x = (-u_xlat15.x) + 4.0;
    u_xlatu15 = uint(u_xlat15.x);
    u_xlati15 = int(u_xlatu15) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati15 + 1) / 4][(u_xlati15 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati15 / 4][u_xlati15 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati15 + 2) / 4][(u_xlati15 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat15.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati15 + 3) / 4][(u_xlati15 + 3) % 4].xyz;
    ...
    u_xlat17.xyz = unity_SHC.xyz * vec3(u_xlat44) + u_xlat6.xyz;
    ...
    u_xlat42 = u_xlat0.w + u_xlat18;
    u_xlat42 = clamp(u_xlat42, 0.0, 1.0);
    u_xlat18 = u_xlat44 * 4.0 + 2.0;
    ...
    if(u_xlatb29.x){
        u_xlat29.xy = vs_TEXCOORD7.yy * _MainLightWorldToLight[1].xy;
        u_xlat29.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD7.xx + u_xlat29.xy;
        u_xlat29.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD7.zz + u_xlat29.xy;
    ...
    u_xlat29.x = dot((-u_xlat7.xyz), u_xlat2.xyz);
    u_xlat29.x = u_xlat29.x + u_xlat29.x;
    u_xlat8.xyz = u_xlat2.xyz * (-u_xlat29.xxx) + (-u_xlat7.xyz);
    u_xlat29.x = dot(u_xlat2.xyz, u_xlat7.xyz);
    u_xlat29.x = clamp(u_xlat29.x, 0.0, 1.0);
    u_xlat29.x = (-u_xlat29.x) + 1.0;
    u_xlat1.z = u_xlat29.x * u_xlat29.x;
    ...
    u_xlat1.xw = vec2(u_xlat44) * vec2(u_xlat44) + vec2(-1.0, 1.0);
    u_xlat43 = float(1.0) / u_xlat1.w;
    ...
    u_xlat17.xyz = u_xlat17.xyz * u_xlat5.xyz + u_xlat8.xyz;
    u_xlat42 = u_xlat15.x * unity_LightData.z;
    u_xlat15.x = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat15.x = clamp(u_xlat15.x, 0.0, 1.0);
    u_xlat42 = u_xlat42 * u_xlat15.x;
    u_xlat15.xyz = vec3(u_xlat42) * u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat47 = dot(unity_LightIndices[int(u_xlatu47)], uintBitsToFloat(ImmCB_0[u_xlati34]));
        ...
        u_xlat49 = float(1.0) / float(u_xlat34);
        u_xlat34 = u_xlat34 * _AdditionalLightsAttenuation[int(u_xlatu47)].x;
        u_xlat34 = (-u_xlat34) * u_xlat34 + 1.0;
        u_xlat34 = max(u_xlat34, 0.0);
        u_xlat34 = u_xlat34 * u_xlat34;
        u_xlat34 = u_xlat34 * u_xlat49;
        u_xlat49 = dot(_AdditionalLightsSpotDir[int(u_xlatu47)].xyz, u_xlat10.xyz);
        u_xlat49 = u_xlat49 * _AdditionalLightsAttenuation[int(u_xlatu47)].z + _AdditionalLightsAttenuation[int(u_xlatu47)].w;
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat34 = u_xlat34 * u_xlat49;
        u_xlatu49 = u_xlatu47 >> (5u & uint(0x1F));
        u_xlati50 = 1 << (int(u_xlatu47) & int(0x1F));
        u_xlati49 = int(uint(u_xlati50) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu49)]));
        if(u_xlati49 != 0) {
            u_xlati49 = int(_AdditionalLightsLightTypes[int(u_xlatu47)]);
            u_xlati50 = (u_xlati49 != 0) ? 0 : 1;
            u_xlati51 = int(u_xlatu47) << (2 & int(0x1F));
            if(u_xlati50 != 0) {
            ...
            u_xlat49 = (u_xlatb6.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb6.x) ? u_xlat11.xyz : vec3(u_xlat49);
        } else {
    ...
    u_xlat0.xyz = u_xlat17.xyz * u_xlat4.xxx + u_xlat15.xyz;
