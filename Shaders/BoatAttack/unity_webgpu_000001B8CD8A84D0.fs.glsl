...
layout(set = 0, binding = 0) uniform mediump texture2D _SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1;
...
layout(set = 0, binding = 3) uniform mediump  sampler sampler_SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1;
...
float u_xlat16;
    ...
    u_xlat2.xyz = texture(sampler2D(Texture2D_DE8BF47E, samplerTexture2D_DE8BF47E), vs_INTERP3.xy, _GlobalMipBias.x).yzw;
    u_xlat2.xyz = u_xlat2.zxy * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat6.xyz = u_xlat6.xyz * u_xlat2.yyy;
    u_xlat3.xyz = u_xlat1.xxx * vs_INTERP2.xyz;
    u_xlat4.xyz = u_xlat1.xxx * vs_INTERP1.xyz;
    ...
    u_xlat1.xy = u_xlat1.xx * vs_INTERP3.xy;
    u_xlat1.xyz = texture(sampler2D(_SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1, sampler_SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1), u_xlat1.xy, _GlobalMipBias.x).xyw;
    ...
    u_xlat1.x = max(u_xlat1.x, 1.17549435e-37);
    u_xlat1.x = inversesqrt(u_xlat1.x);
    u_xlat6.xy = vs_INTERP3.xy * vec2(4.0, 4.0);
