...
layout(set = 0, binding = 20) uniform mediump  sampler sampler_ScreenSpaceOcclusionTexture;
layout(set = 0, binding = 21) uniform mediump  samplerShadow sampler_MainLightShadowmapTexture;
layout(set = 0, binding = 22) uniform mediump  sampler sampler_MainLightCookieTexture;
layout(set = 0, binding = 23) uniform mediump  sampler sampler_AdditionalLightsCookieAtlasTexture;
void main()
{
vec3 u_xlat0;
vec4 u_xlat1;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu40 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.xyz = vec3(u_xlat67) * u_xlat9.xyz;
        u_xlat68 = float(1.0) / float(u_xlat66);
        u_xlat66 = u_xlat66 * _AdditionalLightsAttenuation[int(u_xlatu65)].x;
        u_xlat66 = (-u_xlat66) * u_xlat66 + 1.0;
        u_xlat66 = max(u_xlat66, 0.0);
        u_xlat66 = u_xlat66 * u_xlat66;
        u_xlat66 = u_xlat66 * u_xlat68;
        u_xlat68 = dot(_AdditionalLightsSpotDir[int(u_xlatu65)].xyz, u_xlat10.xyz);
        u_xlat68 = u_xlat68 * _AdditionalLightsAttenuation[int(u_xlatu65)].z + _AdditionalLightsAttenuation[int(u_xlatu65)].w;
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
        u_xlat68 = u_xlat68 * u_xlat68;
        u_xlat66 = u_xlat66 * u_xlat68;
        u_xlatu68 = u_xlatu65 >> (5u & uint(0x1F));
        u_xlati69 = 1 << (int(u_xlatu65) & int(0x1F));
        u_xlati68 = int(uint(u_xlati69) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu68)]));
        if(u_xlati68 != 0) {
            u_xlati68 = int(_AdditionalLightsLightTypes[int(u_xlatu65)]);
            u_xlati69 = (u_xlati68 != 0) ? 0 : 1;
            u_xlati70 = int(u_xlatu65) << (2 & int(0x1F));
            if(u_xlati69 != 0) {
                u_xlat11.xyz = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati70 / 4][u_xlati70 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat11.xyz;
                u_xlat11.xyz = u_xlat11.xyz + _AdditionalLightsWorldToLights[(u_xlati70 + 3) / 4][(u_xlati70 + 3) % 4].xyw;
                ...
                if(u_xlati68 != 0) {
                    u_xlat51.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4].xy;
                    u_xlat51.xy = _AdditionalLightsWorldToLights[u_xlati70 / 4][u_xlati70 % 4].xy * vs_TEXCOORD7.xx + u_xlat51.xy;
                    u_xlat51.xy = _AdditionalLightsWorldToLights[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat51.xy;
                    u_xlat51.xy = u_xlat51.xy + _AdditionalLightsWorldToLights[(u_xlati70 + 3) / 4][(u_xlati70 + 3) % 4].xy;
                    ...
                    u_xlat12 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToLights[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati70 / 4][u_xlati70 % 4] * vs_TEXCOORD7.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat12;
                    u_xlat12 = u_xlat12 + _AdditionalLightsWorldToLights[(u_xlati70 + 3) / 4][(u_xlati70 + 3) % 4];
                    u_xlat12.xyz = u_xlat12.xyz / u_xlat12.www;
                    u_xlat68 = dot(u_xlat12.xyz, u_xlat12.xyz);
                    u_xlat68 = inversesqrt(u_xlat68);
                    u_xlat12.xyz = vec3(u_xlat68) * u_xlat12.xyz;
                    u_xlat68 = dot(abs(u_xlat12.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat68 = max(u_xlat68, 9.99999997e-07);
                    u_xlat68 = float(1.0) / float(u_xlat68);
                    u_xlat13.xyz = vec3(u_xlat68) * u_xlat12.zxy;
                    ...
                    u_xlat51.xy = u_xlat12.xy * vec2(u_xlat68) + u_xlat51.xy;
                    u_xlat51.xy = u_xlat51.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat68 = (u_xlatb3.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat68);
        } else {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat67) + u_xlat7.xyz;
        ...
        u_xlat65 = u_xlat65 * u_xlat0.x + 1.00001001;
        u_xlat66 = u_xlat66 * u_xlat66;
        u_xlat65 = u_xlat65 * u_xlat65;
