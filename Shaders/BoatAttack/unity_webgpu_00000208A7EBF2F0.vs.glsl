...
layout(set = 1, binding = 7, std140) uniform VGlobals {
...
layout(set = 1, binding = 8, std140) uniform UnityDrawCallInfo {
...
layout(set = 0, binding = 24) uniform mediump texture2D _TerrainHeightmapTexture;
layout(set = 0, binding = 25) uniform mediump texture2D _TerrainNormalmapTexture;
