...
fn main_1() {
  ...
  let x_299 : vec2<f32> = (vec2<f32>(0.25f, 0.25f) / vec2<f32>(x_297.x, x_297.y));
  let x_300 : vec4<f32> = vs_TEXCOORD2;
  vs_TEXCOORD2 = vec4<f32>(x_300.x, x_300.y, x_299.x, x_299.y);
  let x_302 : f32 = u_xlat21;
  u_xlat21 = inverseSqrt(x_302);
  let x_308 : f32 = in_TEXCOORD1.y;
  let x_312 : f32 = x_19.x_GradientScale;
  u_xlat1.x = (abs(x_308) * x_312);
  let x_318 : f32 = x_19.x_Sharpness;
  u_xlat8.x = (x_318 + 1.0f);
  let x_322 : f32 = u_xlat8.x;
  let x_324 : f32 = u_xlat1.x;
  u_xlat1.x = (x_322 * x_324);
  let x_327 : f32 = u_xlat21;
  let x_329 : f32 = u_xlat1.x;
  u_xlat8.x = (x_327 * x_329);
  let x_335 : f32 = x_19.x_PerspectiveFilter;
  u_xlat15 = (-(x_335) + 1.0f);
  let x_338 : f32 = u_xlat15;
  let x_340 : f32 = u_xlat8.x;
  u_xlat15 = (x_338 * abs(x_340));
  let x_343 : f32 = u_xlat21;
  let x_345 : f32 = u_xlat1.x;
  let x_347 : f32 = u_xlat15;
  u_xlat21 = ((x_343 * x_345) + -(x_347));
  let x_350 : f32 = u_xlat14;
  let x_352 : f32 = u_xlat21;
  let x_354 : f32 = u_xlat15;
  u_xlat14 = ((abs(x_350) * x_352) + x_354);
  let x_360 : f32 = x_19.glstate_matrix_projection[3i].w;
  u_xlatb21 = (x_360 == 0.0f);
  let x_363 : bool = u_xlatb21;
  if (x_363) {
...
fn main(@location(0) in_POSITION0_param : vec4<f32>, @location(2) in_COLOR0_param : vec4<f32>, @location(1) in_NORMAL0_param : vec3<f32>, @location(4) in_TEXCOORD1_param : vec2<f32>, @location(3) in_TEXCOORD0_param : vec2<f32>) -> main_out {
  ...
  main_1();
  return main_out(gl_Position, vs_COLOR0, vs_TEXCOORD0, vs_TEXCOORD1, vs_TEXCOORD3, vs_TEXCOORD4);
}
