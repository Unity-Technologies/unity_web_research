...
fn main_1() {
  ...
  let x_812 : vec4<f32> = textureSample(x_LightTexture0, sampler_LightTexture0, vec3<f32>(x_810.x, x_810.y, x_810.z));
  u_xlat8 = x_812.w;
  let x_819 : f32 = u_xlat4;
  let x_821 : vec4<f32> = textureSample(x_LightTextureB0, sampler_LightTextureB0, vec2<f32>(x_819, x_819));
  u_xlat4 = x_821.x;
  let x_823 : f32 = u_xlat8;
  let x_824 : f32 = u_xlat4;
  u_xlat4 = (x_823 * x_824);
  let x_826 : f32 = u_xlat4;
  let x_829 : vec4<f32> = x_22.x_LightColor0;
  let x_831 : vec3<f32> = (vec3<f32>(x_826, x_826, x_826) * vec3<f32>(x_829.x, x_829.y, x_829.z));
  let x_832 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_831.x, x_831.y, x_831.z, x_832.w);
  let x_834 : vec4<f32> = u_xlat2;
  let x_838 : vec4<f32> = x_22.x_SpecColor;
  let x_840 : vec3<f32> = (vec3<f32>(x_834.x, x_834.y, x_834.z) * vec3<f32>(x_838.x, x_838.y, x_838.z));
  ...
  let x_851 : f32 = u_xlat1.w;
  u_xlat14 = max(x_851, 0.0001f);
  ...
  let x_871 : vec3<f32> = (vec3<f32>(x_867.x, x_867.y, x_867.z) * vec3<f32>(x_869.x, x_869.y, x_869.z));
  ...
  let x_881 : vec3<f32> = ((vec3<f32>(x_874.x, x_874.y, x_874.z) * vec3<f32>(x_876.w, x_876.w, x_876.w)) + vec3<f32>(x_879.x, x_879.y, x_879.z));
