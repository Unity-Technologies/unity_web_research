...
;
    ...
    u_xlat4.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati35 + 1) / 4][(u_xlati35 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati35 / 4][u_xlati35 % 4].xyz * vs_INTERP0.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati35 + 2) / 4][(u_xlati35 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati35 + 3) / 4][(u_xlati35 + 3) % 4].xyz;
    u_xlat35 = vs_INTERP0.y * unity_MatrixV[1].z;
    u_xlat35 = unity_MatrixV[0].z * vs_INTERP0.x + u_xlat35;
    u_xlat35 = unity_MatrixV[2].z * vs_INTERP0.z + u_xlat35;
    ...
    u_xlat15.x = dot((-u_xlat1.xyz), u_xlat11.xyz);
    u_xlat15.x = u_xlat15.x + u_xlat15.x;
    u_xlat8.xyz = u_xlat11.xyz * (-u_xlat15.xxx) + (-u_xlat1.xyz);
    u_xlat15.x = dot(u_xlat11.xyz, u_xlat1.xyz);
    u_xlat15.x = clamp(u_xlat15.x, 0.0, 1.0);
    u_xlat15.x = (-u_xlat15.x) + 1.0;
    u_xlat15.x = u_xlat15.x * u_xlat15.x;
    u_xlat15.x = u_xlat15.x * u_xlat15.x;
    u_xlat26 = (-u_xlat34) * 0.699999988 + 1.70000005;
    u_xlat34 = u_xlat34 * u_xlat26;
    u_xlat34 = u_xlat34 * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat34);
    ...
    u_xlat34 = float(1.0) / u_xlat28.y;
    u_xlat9.xyz = (-u_xlat2.xyz) + u_xlat0.xxx;
    u_xlat9.xyz = u_xlat15.xxx * u_xlat9.xyz + u_xlat2.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat36 = dot(u_xlat11.xyz, u_xlat9.xyz);
        u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
