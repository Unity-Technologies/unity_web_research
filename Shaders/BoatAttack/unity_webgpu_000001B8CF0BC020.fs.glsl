...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat8.xyz = u_xlat4.xyz * (-vec3(u_xlat73)) + (-u_xlat1.xyw);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu68 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat73 = dot(u_xlat4.xyz, u_xlat32.xyz);
        u_xlat73 = clamp(u_xlat73, 0.0, 1.0);
        u_xlat73 = u_xlat73 * u_xlat74;
        u_xlat11.xyz = vec3(u_xlat73) * u_xlat11.xyz;
        u_xlat31.xyz = u_xlat31.xyz * u_xlat10.xxx + u_xlat1.xyw;
        ...
        u_xlat73 = dot(u_xlat4.xyz, u_xlat31.xyz);
        u_xlat73 = clamp(u_xlat73, 0.0, 1.0);
