...
fn main_1() {
  ...
  let x_1332 : vec3<f32> = u_xlat0;
  let x_1333 : vec3<f32> = (x_1332 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1334 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1333.x, x_1333.y, x_1333.z, x_1334.w);
  let x_1336 : vec3<f32> = u_xlat0;
  let x_1338 : vec3<f32> = log2(abs(x_1336));
  let x_1339 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1338.x, x_1338.y, x_1338.z, x_1339.w);
  let x_1341 : vec4<f32> = u_xlat2;
  let x_1343 : vec3<f32> = (vec3<f32>(x_1341.x, x_1341.y, x_1341.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1344 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1343.x, x_1343.y, x_1343.z, x_1344.w);
  let x_1346 : vec4<f32> = u_xlat2;
  let x_1348 : vec3<f32> = exp2(vec3<f32>(x_1346.x, x_1346.y, x_1346.z));
  let x_1349 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1348.x, x_1348.y, x_1348.z, x_1349.w);
  let x_1351 : vec4<f32> = u_xlat2;
  let x_1354 : vec3<f32> = ((vec3<f32>(x_1351.x, x_1351.y, x_1351.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1355 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1354.x, x_1354.y, x_1354.z, x_1355.w);
  let x_1357 : vec3<f32> = u_xlat0;
  let x_1359 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1357.x, x_1357.y, x_1357.z, x_1357.x));
  u_xlatb0 = vec3<bool>(x_1359.x, x_1359.y, x_1359.z);
  let x_1362 : bool = u_xlatb0.x;
  if (x_1362) {
  ...
  u_xlat0.x = x_1371;
  let x_1374 : bool = u_xlatb0.y;
  if (x_1374) {
    let x_1379 : f32 = u_xlat1.y;
    x_1375 = x_1379;
  } else {
    let x_1382 : f32 = u_xlat2.y;
    x_1375 = x_1382;
  }
  let x_1383 : f32 = x_1375;
  u_xlat0.y = x_1383;
  let x_1386 : bool = u_xlatb0.z;
  if (x_1386) {
    let x_1391 : f32 = u_xlat1.z;
    x_1387 = x_1391;
  } else {
    let x_1394 : f32 = u_xlat2.z;
    x_1387 = x_1394;
  }
  let x_1395 : f32 = x_1387;
  u_xlat0.z = x_1395;
  let x_1397 : vec2<f32> = vs_TEXCOORD0;
  let x_1400 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1404 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1406 : vec2<f32> = ((x_1397 * vec2<f32>(x_1400.x, x_1400.y)) + vec2<f32>(x_1404.z, x_1404.w));
  let x_1407 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1406.x, x_1406.y, x_1407.z, x_1407.w);
  let x_1414 : vec4<f32> = u_xlat1;
  let x_1417 : f32 = x_27.x_GlobalMipBias.x;
  let x_1418 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1414.x, x_1414.y), x_1417);
  u_xlat15 = x_1418.w;
  let x_1420 : f32 = u_xlat15;
  u_xlat15 = ((x_1420 * 2.0f) + -1.0f);
  let x_1423 : f32 = u_xlat15;
  u_xlatb1 = (x_1423 >= 0.0f);
  let x_1425 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1425);
  let x_1428 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1428)) + 1.0f);
  let x_1432 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1432);
  let x_1434 : f32 = u_xlat15;
  u_xlat15 = (-(x_1434) + 1.0f);
  let x_1437 : f32 = u_xlat15;
  let x_1439 : f32 = u_xlat1.x;
  u_xlat15 = (x_1437 * x_1439);
  let x_1441 : vec3<f32> = u_xlat0;
  let x_1442 : vec3<f32> = (x_1441 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1443 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1442.x, x_1442.y, x_1442.z, x_1443.w);
  let x_1445 : vec3<f32> = u_xlat0;
  let x_1447 : vec3<f32> = log2(abs(x_1445));
  let x_1448 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1447.x, x_1447.y, x_1447.z, x_1448.w);
  let x_1450 : vec4<f32> = u_xlat2;
  let x_1452 : vec3<f32> = (vec3<f32>(x_1450.x, x_1450.y, x_1450.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1453 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1452.x, x_1452.y, x_1452.z, x_1453.w);
  let x_1455 : vec4<f32> = u_xlat2;
  let x_1457 : vec3<f32> = exp2(vec3<f32>(x_1455.x, x_1455.y, x_1455.z));
  let x_1458 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1457.x, x_1457.y, x_1457.z, x_1458.w);
  let x_1460 : vec4<f32> = u_xlat2;
  let x_1463 : vec3<f32> = ((vec3<f32>(x_1460.x, x_1460.y, x_1460.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1464 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1463.x, x_1463.y, x_1463.z, x_1464.w);
  let x_1466 : vec3<f32> = u_xlat0;
  let x_1468 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1466.x, x_1466.y, x_1466.z, x_1466.x));
  u_xlatb0 = vec3<bool>(x_1468.x, x_1468.y, x_1468.z);
  let x_1471 : bool = u_xlatb0.x;
  if (x_1471) {
  ...
  u_xlat0 = ((vec3<f32>(x_1506, x_1506, x_1506) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1511);
  let x_1513 : vec3<f32> = u_xlat0;
  let x_1514 : vec3<f32> = (x_1513 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1515 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1514.x, x_1514.y, x_1514.z, x_1515.w);
  let x_1517 : vec3<f32> = u_xlat0;
  let x_1518 : vec3<f32> = (x_1517 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1519 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1518.x, x_1518.y, x_1518.z, x_1519.w);
  let x_1521 : vec4<f32> = u_xlat2;
  let x_1523 : vec3<f32> = (vec3<f32>(x_1521.x, x_1521.y, x_1521.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1524 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1523.x, x_1523.y, x_1523.z, x_1524.w);
  let x_1526 : vec4<f32> = u_xlat2;
  let x_1529 : vec3<f32> = log2(abs(vec3<f32>(x_1526.x, x_1526.y, x_1526.z)));
  let x_1530 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1529.x, x_1529.y, x_1529.z, x_1530.w);
  let x_1532 : vec4<f32> = u_xlat2;
  let x_1534 : vec3<f32> = (vec3<f32>(x_1532.x, x_1532.y, x_1532.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1535 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1534.x, x_1534.y, x_1534.z, x_1535.w);
  let x_1537 : vec4<f32> = u_xlat2;
  let x_1539 : vec3<f32> = exp2(vec3<f32>(x_1537.x, x_1537.y, x_1537.z));
  ...
  if (x_1547) {
    let x_1552 : f32 = u_xlat1.x;
    x_1548 = x_1552;
  } else {
    let x_1555 : f32 = u_xlat2.x;
    x_1548 = x_1555;
  }
  let x_1556 : f32 = x_1548;
  u_xlat0.x = x_1556;
  let x_1559 : bool = u_xlatb0.y;
  if (x_1559) {
    let x_1564 : f32 = u_xlat1.y;
    x_1560 = x_1564;
  } else {
    let x_1567 : f32 = u_xlat2.y;
    x_1560 = x_1567;
  }
  let x_1568 : f32 = x_1560;
  u_xlat0.y = x_1568;
  let x_1571 : bool = u_xlatb0.z;
  if (x_1571) {
    let x_1576 : f32 = u_xlat1.z;
    x_1572 = x_1576;
  } else {
  ...
  let x_1585 : vec3<f32> = max(x_1584, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1586 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1585.x, x_1585.y, x_1585.z, x_1586.w);
  SV_Target0.w = 1.0f;
  return;
}
