...
fn main_1() {
  ...
  if (x_550) {
    ...
    if (x_558) {
      ...
      let x_564 : vec4<f32> = x_364.x_MainLightShadowOffset0;
      u_xlat4 = (vec4<f32>(x_561.x, x_561.y, x_561.x, x_561.y) + x_564);
      let x_567 : vec4<f32> = u_xlat4;
      let x_568 : vec2<f32> = vec2<f32>(x_567.x, x_567.y);
      let x_570 : f32 = u_xlat22.z;
      ...
      let x_588 : vec2<f32> = vec2<f32>(x_587.z, x_587.w);
      let x_590 : f32 = u_xlat22.z;
      txVec1 = vec3<f32>(x_588.x, x_588.y, x_590);
      let x_597 : vec3<f32> = txVec1;
      let x_599 : f32 = textureSampleCompareLevel(x_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture, x_597.xy, x_597.z);
      u_xlat5.y = x_599;
      let x_601 : vec3<f32> = u_xlat22;
      let x_604 : vec4<f32> = x_364.x_MainLightShadowOffset1;
      u_xlat4 = (vec4<f32>(x_601.x, x_601.y, x_601.x, x_601.y) + x_604);
      ...
      let x_643 : f32 = x_364.x_MainLightShadowParams.y;
      u_xlatb23 = (x_643 == 2.0f);
      let x_645 : bool = u_xlatb23;
      if (x_645) {
        let x_649 : vec3<f32> = u_xlat22;
        let x_653 : vec4<f32> = x_364.x_MainLightShadowmapSize;
        u_xlat23 = ((vec2<f32>(x_649.x, x_649.y) * vec2<f32>(x_653.z, x_653.w)) + vec2<f32>(0.5f, 0.5f));
  ...
  let x_3053 : f32 = u_xlat19;
  let x_3055 : vec3<f32> = u_xlat1;
  let x_3057 : vec4<f32> = u_xlat0;
  let x_3059 : vec3<f32> = ((vec3<f32>(x_3053, x_3053, x_3053) * x_3055) + vec3<f32>(x_3057.x, x_3057.z, x_3057.w));
  let x_3060 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_3059.x, x_3059.y, x_3059.z, x_3060.w);
  SV_Target0.w = 1.0f;
  return;
}
