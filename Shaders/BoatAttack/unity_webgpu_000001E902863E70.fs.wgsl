...
fn main_1() {
  ...
  let x_1638 : f32 = vs_TEXCOORD3.w;
  let x_1640 : f32 = vs_TEXCOORD3.w;
  u_xlat51 = (x_1638 * -(x_1640));
  let x_1643 : f32 = u_xlat51;
  u_xlat51 = exp2(x_1643);
  let x_1645 : vec4<f32> = u_xlat2;
  let x_1647 : vec4<f32> = u_xlat0;
  let x_1651 : vec4<f32> = x_328.unity_FogColor;
  let x_1654 : vec3<f32> = ((vec3<f32>(x_1645.x, x_1645.y, x_1645.z) * vec3<f32>(x_1647.x, x_1647.y, x_1647.z)) + -(vec3<f32>(x_1651.x, x_1651.y, x_1651.z)));
  ...
  let x_1665 : vec4<f32> = x_328.unity_FogColor;
  let x_1667 : vec3<f32> = ((vec3<f32>(x_1659, x_1659, x_1659) * vec3<f32>(x_1661.x, x_1661.y, x_1661.z)) + vec3<f32>(x_1665.x, x_1665.y, x_1665.z));
  let x_1668 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1667.x, x_1667.y, x_1667.z, x_1668.w);
  let x_1671 : f32 = u_xlat2.w;
  SV_Target0.w = x_1671;
  return;
}
