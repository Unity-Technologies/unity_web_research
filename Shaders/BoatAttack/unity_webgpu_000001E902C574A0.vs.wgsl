...
fn main_1() {
  ...
  let x_330 : f32 = x_323;
  u_xlat8 = x_330;
  let x_333 : f32 = x_19.x_OutlineSoftness;
  let x_336 : f32 = x_19.x_ScaleRatioA;
  u_xlat12 = (x_333 * x_336);
  let x_338 : f32 = u_xlat12;
  let x_339 : f32 = u_xlat8;
  u_xlat12 = ((x_338 * x_339) + 1.0f);
  let x_342 : f32 = u_xlat8;
  let x_343 : f32 = u_xlat12;
  u_xlat1.x = (x_342 / x_343);
  let x_348 : f32 = x_19.x_OutlineWidth;
  let x_350 : f32 = x_19.x_ScaleRatioA;
  u_xlat8 = (x_348 * x_350);
  let x_353 : f32 = u_xlat1.x;
  let x_354 : f32 = u_xlat8;
  u_xlat8 = (x_353 * x_354);
  let x_356 : f32 = u_xlat8;
  u_xlat12 = min(x_356, 1.0f);
  let x_358 : f32 = u_xlat12;
  u_xlat12 = sqrt(x_358);
  let x_361 : f32 = in_COLOR0.w;
  let x_364 : f32 = x_19.x_OutlineColor.w;
  u_xlat2.w = (x_361 * x_364);
  let x_367 : vec4<f32> = u_xlat2;
  let x_370 : vec4<f32> = x_19.x_OutlineColor;
  let x_372 : vec3<f32> = (vec3<f32>(x_367.w, x_367.w, x_367.w) * vec3<f32>(x_370.x, x_370.y, x_370.z));
