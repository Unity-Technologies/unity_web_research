...
@group(0) @binding(18) var<storage, read> x_798 : x_WaveDataBuffer;
...
fn main_1() {
  ...
  loop {
    ...
    u_xlat40 = (6.283180237f / x_832);
    let x_835 : f32 = u_xlat40;
    u_xlat41 = (x_835 * 9.800000191f);
    ...
    u_xlat9 = (vec2<f32>(x_852.x, x_852.y) * vec2<f32>(10000.0f, 0.017453292f));
  ...
  u_xlat38 = max(x_1117, 1.17549435e-37f);
  ...
  let x_1212 : vec2<f32> = (vec2<f32>(x_1208.x, x_1208.z) * vec2<f32>(0.005f, 0.005f));
