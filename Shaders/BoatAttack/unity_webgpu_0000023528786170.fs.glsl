...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat32.x = dot(u_xlat15.xyz, u_xlat3.xyz);
    u_xlat32.x = u_xlat32.x + 0.5;
    u_xlat3.xyz = u_xlat32.xxx * u_xlat5.xyz;
    u_xlat32.x = max(u_xlat3.w, 9.99999975e-05);
    u_xlat3.xyz = u_xlat3.xyz / u_xlat32.xxx;
