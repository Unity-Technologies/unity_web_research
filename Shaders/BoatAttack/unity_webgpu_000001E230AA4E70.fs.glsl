...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat35 = max(u_xlat2.w, 9.99999975e-05);
    u_xlat2.xyz = u_xlat2.xyz / vec3(u_xlat35);
    u_xlat3.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat3.xy = u_xlat3.xy * hlslcc_FragCoord.xy;
    u_xlat35 = u_xlat3.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat3.z = (-u_xlat35) + 1.0;
    ...
    u_xlat33 = u_xlat0.w + u_xlat14;
    u_xlat33 = clamp(u_xlat33, 0.0, 1.0);
    u_xlat14 = u_xlat35 * 4.0 + 2.0;
    ...
    u_xlat37 = u_xlat5.x * u_xlat16 + u_xlat37;
    u_xlat5.xyz = vec3(u_xlat25) * _MainLightColor.xyz;
    u_xlat6.x = vs_TEXCOORD3.w;
    u_xlat6.y = vs_TEXCOORD4.w;
    u_xlat6.z = vs_TEXCOORD5.w;
    u_xlat38 = dot((-u_xlat6.xyz), u_xlat12.xyz);
    u_xlat38 = u_xlat38 + u_xlat38;
    u_xlat7.xyz = u_xlat12.xyz * (-vec3(u_xlat38)) + (-u_xlat6.xyz);
    u_xlat38 = dot(u_xlat12.xyz, u_xlat6.xyz);
    ...
    u_xlat2.xyz = u_xlat2.xyz * u_xlat4.xyz + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat19.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati35].www + _AdditionalLightsPosition[u_xlati35].xyz;
        ...
        u_xlat37 = u_xlat37 * u_xlat39;
        u_xlat10.xyz = vec3(u_xlat25) * _AdditionalLightsColor[u_xlati35].xyz;
        u_xlat35 = dot(u_xlat12.xyz, u_xlat9.xyz);
        u_xlat35 = clamp(u_xlat35, 0.0, 1.0);
        u_xlat35 = u_xlat35 * u_xlat37;
        u_xlat10.xyz = vec3(u_xlat35) * u_xlat10.xyz;
        u_xlat19.xyz = u_xlat19.xyz * vec3(u_xlat38) + u_xlat6.xyz;
        ...
        u_xlat19.xyz = u_xlat0.xyz * vec3(u_xlat35) + u_xlat4.xyz;
        u_xlat7.xyz = u_xlat19.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat2.xyz * u_xlat3.xxx + u_xlat5.xyz;
