...
fn main_1() {
  ...
  let x_1355 : vec3<f32> = (x_1354 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1356 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1355.x, x_1355.y, x_1355.z, x_1356.w);
  let x_1358 : vec3<f32> = u_xlat0;
  let x_1360 : vec3<f32> = log2(abs(x_1358));
  let x_1361 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1360.x, x_1360.y, x_1360.z, x_1361.w);
  let x_1363 : vec4<f32> = u_xlat2;
  let x_1365 : vec3<f32> = (vec3<f32>(x_1363.x, x_1363.y, x_1363.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1376 : vec3<f32> = ((vec3<f32>(x_1373.x, x_1373.y, x_1373.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1377 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1376.x, x_1376.y, x_1376.z, x_1377.w);
  let x_1379 : vec3<f32> = u_xlat0;
  let x_1381 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1379.x, x_1379.y, x_1379.z, x_1379.x));
  u_xlatb0 = vec3<bool>(x_1381.x, x_1381.y, x_1381.z);
  let x_1384 : bool = u_xlatb0.x;
  if (x_1384) {
    let x_1389 : f32 = u_xlat1.x;
    x_1385 = x_1389;
  } else {
    let x_1392 : f32 = u_xlat2.x;
    x_1385 = x_1392;
  }
  let x_1393 : f32 = x_1385;
  u_xlat0.x = x_1393;
  let x_1396 : bool = u_xlatb0.y;
  if (x_1396) {
    let x_1401 : f32 = u_xlat1.y;
    x_1397 = x_1401;
  } else {
    let x_1404 : f32 = u_xlat2.y;
    x_1397 = x_1404;
  }
  let x_1405 : f32 = x_1397;
  u_xlat0.y = x_1405;
  let x_1408 : bool = u_xlatb0.z;
  if (x_1408) {
    let x_1413 : f32 = u_xlat1.z;
    x_1409 = x_1413;
  } else {
    let x_1416 : f32 = u_xlat2.z;
    x_1409 = x_1416;
  }
  let x_1417 : f32 = x_1409;
  u_xlat0.z = x_1417;
  let x_1419 : vec2<f32> = vs_TEXCOORD0;
  let x_1422 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1426 : vec4<f32> = x_27.x_Dithering_Params;
  ...
  let x_1439 : f32 = x_27.x_GlobalMipBias.x;
  ...
  let x_1464 : vec3<f32> = (x_1463 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1474 : vec3<f32> = (vec3<f32>(x_1472.x, x_1472.y, x_1472.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1485 : vec3<f32> = ((vec3<f32>(x_1482.x, x_1482.y, x_1482.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1486 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1485.x, x_1485.y, x_1485.z, x_1486.w);
  let x_1488 : vec3<f32> = u_xlat0;
  let x_1490 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1488.x, x_1488.y, x_1488.z, x_1488.x));
  ...
  u_xlat0 = ((vec3<f32>(x_1528, x_1528, x_1528) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1533);
  let x_1535 : vec3<f32> = u_xlat0;
  let x_1536 : vec3<f32> = (x_1535 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1537 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1536.x, x_1536.y, x_1536.z, x_1537.w);
  let x_1539 : vec3<f32> = u_xlat0;
  let x_1540 : vec3<f32> = (x_1539 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1541 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1540.x, x_1540.y, x_1540.z, x_1541.w);
  let x_1543 : vec4<f32> = u_xlat2;
  let x_1545 : vec3<f32> = (vec3<f32>(x_1543.x, x_1543.y, x_1543.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1556 : vec3<f32> = (vec3<f32>(x_1554.x, x_1554.y, x_1554.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1566 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1564.x, x_1564.y, x_1564.z, x_1564.x));
