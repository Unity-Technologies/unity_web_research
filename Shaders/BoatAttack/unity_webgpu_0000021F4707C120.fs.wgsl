...
fn main_1() {
  ...
  u_xlat1.z = max(x_91, 1.00000002e-16f);
  ...
  u_xlat2.z = max(x_152, 1.00000002e-16f);
  ...
  u_xlat2.z = max(x_258, 1.00000002e-16f);
  ...
  u_xlat2.z = max(x_324, 1.00000002e-16f);
