...
fn main_1() {
  ...
  u_xlat0 = ((vec3<f32>(x_1347.x, x_1347.x, x_1347.x) * vec3<f32>(x_1349.x, x_1349.y, x_1349.z)) + x_1352);
  let x_1354 : vec2<f32> = vs_TEXCOORD0;
  let x_1357 : vec4<f32> = x_27.x_Grain_TilingParams;
  let x_1361 : vec4<f32> = x_27.x_Grain_TilingParams;
  ...
  let x_1374 : f32 = x_27.x_GlobalMipBias.x;
  let x_1375 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1371.x, x_1371.y), x_1374);
  u_xlat15 = x_1375.w;
  let x_1377 : f32 = u_xlat15;
  u_xlat15 = (x_1377 + -0.5f);
  let x_1379 : f32 = u_xlat15;
  let x_1380 : f32 = u_xlat15;
  u_xlat15 = (x_1379 + x_1380);
  let x_1382 : vec3<f32> = u_xlat0;
  u_xlat1.x = dot(x_1382, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1390 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1390);
  let x_1395 : f32 = x_27.x_Grain_Params.y;
  let x_1397 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1395 * -(x_1397)) + 1.0f);
  let x_1402 : f32 = u_xlat15;
  let x_1404 : vec3<f32> = u_xlat0;
  u_xlat6 = (vec3<f32>(x_1402, x_1402, x_1402) * x_1404);
  let x_1406 : vec3<f32> = u_xlat6;
  let x_1409 : vec2<f32> = x_27.x_Grain_Params;
  u_xlat6 = (x_1406 * vec3<f32>(x_1409.x, x_1409.x, x_1409.x));
  let x_1412 : vec3<f32> = u_xlat6;
  let x_1413 : vec4<f32> = u_xlat1;
  let x_1416 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1412 * vec3<f32>(x_1413.x, x_1413.x, x_1413.x)) + x_1416);
  let x_1418 : vec3<f32> = u_xlat0;
  let x_1419 : vec3<f32> = (x_1418 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1420 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1419.x, x_1419.y, x_1419.z, x_1420.w);
  let x_1422 : vec3<f32> = u_xlat0;
  let x_1424 : vec3<f32> = log2(abs(x_1422));
  let x_1425 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1424.x, x_1424.y, x_1424.z, x_1425.w);
  let x_1427 : vec4<f32> = u_xlat2;
  let x_1429 : vec3<f32> = (vec3<f32>(x_1427.x, x_1427.y, x_1427.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1430 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1429.x, x_1429.y, x_1429.z, x_1430.w);
  let x_1432 : vec4<f32> = u_xlat2;
  let x_1434 : vec3<f32> = exp2(vec3<f32>(x_1432.x, x_1432.y, x_1432.z));
  let x_1435 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1434.x, x_1434.y, x_1434.z, x_1435.w);
  let x_1437 : vec4<f32> = u_xlat2;
  let x_1440 : vec3<f32> = ((vec3<f32>(x_1437.x, x_1437.y, x_1437.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1441 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1440.x, x_1440.y, x_1440.z, x_1441.w);
  let x_1443 : vec3<f32> = u_xlat0;
  let x_1445 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1443.x, x_1443.y, x_1443.z, x_1443.x));
  ...
  let x_1486 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1490 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1492 : vec2<f32> = ((x_1483 * vec2<f32>(x_1486.x, x_1486.y)) + vec2<f32>(x_1490.z, x_1490.w));
  let x_1493 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1492.x, x_1492.y, x_1493.z, x_1493.w);
  let x_1500 : vec4<f32> = u_xlat1;
  let x_1503 : f32 = x_27.x_GlobalMipBias.x;
  let x_1504 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1500.x, x_1500.y), x_1503);
  u_xlat15 = x_1504.w;
  let x_1506 : f32 = u_xlat15;
  u_xlat15 = ((x_1506 * 2.0f) + -1.0f);
  let x_1509 : f32 = u_xlat15;
  u_xlatb1 = (x_1509 >= 0.0f);
  let x_1511 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1511);
  let x_1514 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1514)) + 1.0f);
  let x_1518 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1518);
  let x_1520 : f32 = u_xlat15;
  u_xlat15 = (-(x_1520) + 1.0f);
  let x_1523 : f32 = u_xlat15;
  let x_1525 : f32 = u_xlat1.x;
  u_xlat15 = (x_1523 * x_1525);
  let x_1527 : vec3<f32> = u_xlat0;
  let x_1528 : vec3<f32> = (x_1527 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1529 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1528.x, x_1528.y, x_1528.z, x_1529.w);
  let x_1531 : vec3<f32> = u_xlat0;
  let x_1533 : vec3<f32> = log2(abs(x_1531));
  let x_1534 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1533.x, x_1533.y, x_1533.z, x_1534.w);
  let x_1536 : vec4<f32> = u_xlat2;
  let x_1538 : vec3<f32> = (vec3<f32>(x_1536.x, x_1536.y, x_1536.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1539 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1538.x, x_1538.y, x_1538.z, x_1539.w);
  let x_1541 : vec4<f32> = u_xlat2;
  let x_1543 : vec3<f32> = exp2(vec3<f32>(x_1541.x, x_1541.y, x_1541.z));
  let x_1544 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1543.x, x_1543.y, x_1543.z, x_1544.w);
  let x_1546 : vec4<f32> = u_xlat2;
  let x_1549 : vec3<f32> = ((vec3<f32>(x_1546.x, x_1546.y, x_1546.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1550 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1549.x, x_1549.y, x_1549.z, x_1550.w);
  let x_1552 : vec3<f32> = u_xlat0;
  let x_1554 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1552.x, x_1552.y, x_1552.z, x_1552.x));
  u_xlatb0 = vec3<bool>(x_1554.x, x_1554.y, x_1554.z);
  let x_1557 : bool = u_xlatb0.x;
  if (x_1557) {
  ...
  u_xlat0.x = x_1566;
  let x_1569 : bool = u_xlatb0.y;
  if (x_1569) {
    let x_1574 : f32 = u_xlat1.y;
    x_1570 = x_1574;
  } else {
  ...
  u_xlat0.y = x_1578;
  let x_1581 : bool = u_xlatb0.z;
  if (x_1581) {
    let x_1586 : f32 = u_xlat1.z;
    x_1582 = x_1586;
  } else {
  ...
  let x_1597 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1592, x_1592, x_1592) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1597);
  let x_1599 : vec3<f32> = u_xlat0;
  let x_1600 : vec3<f32> = (x_1599 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1601 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1600.x, x_1600.y, x_1600.z, x_1601.w);
  let x_1603 : vec3<f32> = u_xlat0;
  let x_1604 : vec3<f32> = (x_1603 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1605 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1604.x, x_1604.y, x_1604.z, x_1605.w);
  let x_1607 : vec4<f32> = u_xlat2;
  let x_1609 : vec3<f32> = (vec3<f32>(x_1607.x, x_1607.y, x_1607.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1610 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1609.x, x_1609.y, x_1609.z, x_1610.w);
  let x_1612 : vec4<f32> = u_xlat2;
  let x_1615 : vec3<f32> = log2(abs(vec3<f32>(x_1612.x, x_1612.y, x_1612.z)));
  let x_1616 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1615.x, x_1615.y, x_1615.z, x_1616.w);
  let x_1618 : vec4<f32> = u_xlat2;
  let x_1620 : vec3<f32> = (vec3<f32>(x_1618.x, x_1618.y, x_1618.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1621 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1620.x, x_1620.y, x_1620.z, x_1621.w);
  let x_1623 : vec4<f32> = u_xlat2;
  let x_1625 : vec3<f32> = exp2(vec3<f32>(x_1623.x, x_1623.y, x_1623.z));
  let x_1626 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1625.x, x_1625.y, x_1625.z, x_1626.w);
  let x_1628 : vec3<f32> = u_xlat0;
  let x_1630 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1628.x, x_1628.y, x_1628.z, x_1628.x));
  u_xlatb0 = vec3<bool>(x_1630.x, x_1630.y, x_1630.z);
  let x_1633 : bool = u_xlatb0.x;
  if (x_1633) {
    let x_1638 : f32 = u_xlat1.x;
    x_1634 = x_1638;
  } else {
    let x_1641 : f32 = u_xlat2.x;
    x_1634 = x_1641;
  }
  let x_1642 : f32 = x_1634;
  u_xlat0.x = x_1642;
  let x_1645 : bool = u_xlatb0.y;
  if (x_1645) {
    let x_1650 : f32 = u_xlat1.y;
    x_1646 = x_1650;
  } else {
    let x_1653 : f32 = u_xlat2.y;
    x_1646 = x_1653;
  }
  let x_1654 : f32 = x_1646;
  u_xlat0.y = x_1654;
  let x_1657 : bool = u_xlatb0.z;
  if (x_1657) {
  ...
  let x_1671 : vec3<f32> = max(x_1670, vec3<f32>(0.0f, 0.0f, 0.0f));
