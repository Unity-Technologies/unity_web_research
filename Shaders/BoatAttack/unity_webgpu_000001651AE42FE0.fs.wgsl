...
fn main_1() {
  ...
  let x_793 : vec3<f32> = (vec3<f32>(x_788.x, x_788.y, x_788.z) + vec3<f32>(x_791.x, x_791.y, x_791.z));
  ...
  let x_814 : vec4<f32> = x_22.x_LightColor0;
  let x_816 : vec3<f32> = (vec3<f32>(x_810, x_810, x_810) * vec3<f32>(x_814.x, x_814.y, x_814.z));
  let x_817 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_816.x, x_816.y, x_816.z, x_817.w);
  let x_819 : vec4<f32> = u_xlat2;
  let x_823 : vec4<f32> = x_22.x_SpecColor;
  let x_825 : vec3<f32> = (vec3<f32>(x_819.x, x_819.y, x_819.z) * vec3<f32>(x_823.x, x_823.y, x_823.z));
  ...
  let x_836 : f32 = u_xlat1.w;
  u_xlat14 = max(x_836, 0.0001f);
  ...
  let x_856 : vec3<f32> = (vec3<f32>(x_852.x, x_852.y, x_852.z) * vec3<f32>(x_854.x, x_854.y, x_854.z));
  ...
  let x_866 : vec3<f32> = ((vec3<f32>(x_859.x, x_859.y, x_859.z) * vec3<f32>(x_861.w, x_861.w, x_861.w)) + vec3<f32>(x_864.x, x_864.y, x_864.z));
  let x_867 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_866.x, x_866.y, x_866.z, x_867.w);
  let x_870 : f32 = vs_TEXCOORD9;
  let x_872 : f32 = x_22.x_ProjectionParams.y;
  u_xlat12 = (x_870 / x_872);
  let x_874 : f32 = u_xlat12;
  u_xlat12 = (-(x_874) + 1.0f);
  let x_877 : f32 = u_xlat12;
  let x_879 : f32 = x_22.x_ProjectionParams.z;
  u_xlat12 = (x_877 * x_879);
  let x_881 : f32 = u_xlat12;
  u_xlat12 = max(x_881, 0.0f);
  let x_883 : f32 = u_xlat12;
  let x_886 : f32 = x_22.unity_FogParams.x;
  u_xlat12 = (x_883 * x_886);
  let x_888 : f32 = u_xlat12;
  let x_889 : f32 = u_xlat12;
  u_xlat12 = (x_888 * -(x_889));
  let x_892 : f32 = u_xlat12;
  u_xlat12 = exp2(x_892);
  let x_894 : vec4<f32> = u_xlat0;
  let x_896 : f32 = u_xlat12;
  let x_898 : vec3<f32> = (vec3<f32>(x_894.x, x_894.y, x_894.z) * vec3<f32>(x_896, x_896, x_896));
