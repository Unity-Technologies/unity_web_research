...
@group(1) @binding(1) var<uniform> x_1298 : AdditionalLights;
...
fn main_1() {
  ...
  loop {
    ...
    let x_1263 : u32 = u_xlatu35;
    let x_1266 : vec4<f32> = x_359.unity_LightIndices[bitcast<i32>(x_1263)];
    let x_1276 : i32 = u_xlati37;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1281 : vec4<u32> = indexable[x_1276];
    u_xlat35 = dot(x_1266, bitcast<vec4<f32>>(x_1281));
    let x_1285 : f32 = u_xlat35;
    u_xlati35 = i32(x_1285);
    let x_1287 : vec3<f32> = vs_INTERP0;
    let x_1299 : i32 = u_xlati35;
    let x_1301 : vec4<f32> = x_1298.x_AdditionalLightsPosition[x_1299];
    let x_1304 : i32 = u_xlati35;
    let x_1306 : vec4<f32> = x_1298.x_AdditionalLightsPosition[x_1304];
    u_xlat19 = ((-(x_1287) * vec3<f32>(x_1301.w, x_1301.w, x_1301.w)) + vec3<f32>(x_1306.x, x_1306.y, x_1306.z));
    let x_1309 : vec3<f32> = u_xlat19;
    let x_1310 : vec3<f32> = u_xlat19;
    u_xlat37 = dot(x_1309, x_1310);
    let x_1312 : f32 = u_xlat37;
    u_xlat37 = max(x_1312, 6.10351562e-05f);
    let x_1315 : f32 = u_xlat37;
    u_xlat39 = inverseSqrt(x_1315);
    let x_1318 : f32 = u_xlat39;
    let x_1320 : vec3<f32> = u_xlat19;
    u_xlat9 = (vec3<f32>(x_1318, x_1318, x_1318) * x_1320);
    let x_1322 : f32 = u_xlat37;
    u_xlat40 = (1.0f / x_1322);
    let x_1324 : f32 = u_xlat37;
    let x_1325 : i32 = u_xlati35;
    let x_1327 : f32 = x_1298.x_AdditionalLightsAttenuation[x_1325].x;
    u_xlat37 = (x_1324 * x_1327);
    let x_1329 : f32 = u_xlat37;
    let x_1331 : f32 = u_xlat37;
    u_xlat37 = ((-(x_1329) * x_1331) + 1.0f);
    let x_1334 : f32 = u_xlat37;
    u_xlat37 = max(x_1334, 0.0f);
    let x_1336 : f32 = u_xlat37;
    let x_1337 : f32 = u_xlat37;
    u_xlat37 = (x_1336 * x_1337);
    let x_1339 : f32 = u_xlat37;
    let x_1340 : f32 = u_xlat40;
    u_xlat37 = (x_1339 * x_1340);
    let x_1342 : i32 = u_xlati35;
    let x_1344 : vec4<f32> = x_1298.x_AdditionalLightsSpotDir[x_1342];
    let x_1346 : vec3<f32> = u_xlat9;
    u_xlat40 = dot(vec3<f32>(x_1344.x, x_1344.y, x_1344.z), x_1346);
    let x_1348 : f32 = u_xlat40;
    let x_1349 : i32 = u_xlati35;
    let x_1351 : f32 = x_1298.x_AdditionalLightsAttenuation[x_1349].z;
    let x_1353 : i32 = u_xlati35;
    let x_1355 : f32 = x_1298.x_AdditionalLightsAttenuation[x_1353].w;
    u_xlat40 = ((x_1348 * x_1351) + x_1355);
    let x_1357 : f32 = u_xlat40;
    u_xlat40 = clamp(x_1357, 0.0f, 1.0f);
    let x_1359 : f32 = u_xlat40;
    let x_1360 : f32 = u_xlat40;
    u_xlat40 = (x_1359 * x_1360);
    let x_1362 : f32 = u_xlat37;
    let x_1363 : f32 = u_xlat40;
    u_xlat37 = (x_1362 * x_1363);
    let x_1366 : f32 = u_xlat38;
    let x_1368 : i32 = u_xlati35;
    let x_1370 : vec4<f32> = x_1298.x_AdditionalLightsColor[x_1368];
    u_xlat10 = (vec3<f32>(x_1366, x_1366, x_1366) * vec3<f32>(x_1370.x, x_1370.y, x_1370.z));
    let x_1373 : vec4<f32> = u_xlat1;
    let x_1375 : vec3<f32> = u_xlat9;
    u_xlat35 = dot(vec3<f32>(x_1373.x, x_1373.y, x_1373.z), x_1375);
    let x_1377 : f32 = u_xlat35;
    u_xlat35 = clamp(x_1377, 0.0f, 1.0f);
    let x_1379 : f32 = u_xlat35;
    let x_1380 : f32 = u_xlat37;
    u_xlat35 = (x_1379 * x_1380);
    let x_1382 : f32 = u_xlat35;
    let x_1384 : vec3<f32> = u_xlat10;
    u_xlat10 = (vec3<f32>(x_1382, x_1382, x_1382) * x_1384);
    let x_1386 : vec3<f32> = u_xlat19;
    let x_1387 : f32 = u_xlat39;
    let x_1390 : vec4<f32> = u_xlat3;
    u_xlat19 = ((x_1386 * vec3<f32>(x_1387, x_1387, x_1387)) + vec3<f32>(x_1390.x, x_1390.y, x_1390.z));
    let x_1393 : vec3<f32> = u_xlat19;
    let x_1394 : vec3<f32> = u_xlat19;
    u_xlat35 = dot(x_1393, x_1394);
    let x_1396 : f32 = u_xlat35;
    u_xlat35 = max(x_1396, 1.17549435e-37f);
    let x_1398 : f32 = u_xlat35;
    u_xlat35 = inverseSqrt(x_1398);
    let x_1400 : f32 = u_xlat35;
    let x_1402 : vec3<f32> = u_xlat19;
    u_xlat19 = (vec3<f32>(x_1400, x_1400, x_1400) * x_1402);
    let x_1404 : vec4<f32> = u_xlat1;
    let x_1406 : vec3<f32> = u_xlat19;
    u_xlat35 = dot(vec3<f32>(x_1404.x, x_1404.y, x_1404.z), x_1406);
    let x_1408 : f32 = u_xlat35;
    u_xlat35 = clamp(x_1408, 0.0f, 1.0f);
    let x_1410 : vec3<f32> = u_xlat9;
    let x_1411 : vec3<f32> = u_xlat19;
    u_xlat37 = dot(x_1410, x_1411);
    let x_1413 : f32 = u_xlat37;
    u_xlat37 = clamp(x_1413, 0.0f, 1.0f);
    let x_1415 : f32 = u_xlat35;
    let x_1416 : f32 = u_xlat35;
    u_xlat35 = (x_1415 * x_1416);
    let x_1418 : f32 = u_xlat35;
    let x_1420 : f32 = u_xlat8.x;
    u_xlat35 = ((x_1418 * x_1420) + 1.000010014f);
    let x_1423 : f32 = u_xlat37;
    let x_1424 : f32 = u_xlat37;
    u_xlat37 = (x_1423 * x_1424);
    let x_1426 : f32 = u_xlat35;
    let x_1427 : f32 = u_xlat35;
    u_xlat35 = (x_1426 * x_1427);
    let x_1429 : f32 = u_xlat37;
    u_xlat37 = max(x_1429, 0.100000001f);
    let x_1431 : f32 = u_xlat35;
    let x_1432 : f32 = u_xlat37;
    u_xlat35 = (x_1431 * x_1432);
    let x_1434 : f32 = u_xlat36;
    let x_1435 : f32 = u_xlat35;
    u_xlat35 = (x_1434 * x_1435);
    let x_1437 : f32 = u_xlat13;
    ...
    u_xlat19 = ((vec3<f32>(x_1440.x, x_1440.y, x_1440.z) * vec3<f32>(x_1442, x_1442, x_1442)) + x_1445);
    let x_1447 : vec3<f32> = u_xlat19;
    let x_1448 : vec3<f32> = u_xlat10;
    let x_1450 : vec3<f32> = u_xlat6;
    u_xlat6 = ((x_1447 * x_1448) + x_1450);
  ...
  let x_1464 : vec3<f32> = u_xlat6;
  let x_1465 : vec4<f32> = u_xlat0;
  let x_1467 : vec3<f32> = (x_1464 + vec3<f32>(x_1465.x, x_1465.y, x_1465.z));
  let x_1468 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1467.x, x_1467.y, x_1467.z, x_1468.w);
  let x_1470 : f32 = u_xlat33;
  let x_1471 : f32 = u_xlat33;
  u_xlat33 = (x_1470 * -(x_1471));
  let x_1474 : f32 = u_xlat33;
  u_xlat33 = exp2(x_1474);
  let x_1476 : vec4<f32> = u_xlat0;
  let x_1480 : vec4<f32> = x_44.unity_FogColor;
  let x_1483 : vec3<f32> = (vec3<f32>(x_1476.x, x_1476.y, x_1476.z) + -(vec3<f32>(x_1480.x, x_1480.y, x_1480.z)));
  ...
  let x_1494 : vec4<f32> = x_44.unity_FogColor;
  let x_1496 : vec3<f32> = ((vec3<f32>(x_1488, x_1488, x_1488) * vec3<f32>(x_1490.x, x_1490.y, x_1490.z)) + vec3<f32>(x_1494.x, x_1494.y, x_1494.z));
  let x_1497 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1496.x, x_1496.y, x_1496.z, x_1497.w);
  let x_1502 : u32 = x_44.x_RenderingLayerMaxInt;
  let x_1504 : f32 = x_359.unity_RenderingLayer.x;
  u_xlatu0 = (x_1502 & bitcast<u32>(x_1504));
  let x_1507 : u32 = u_xlatu0;
  u_xlat0.x = f32(x_1507);
  let x_1512 : f32 = u_xlat0.x;
  let x_1515 : f32 = x_44.x_RenderingLayerRcpMaxInt;
  SV_Target1.x = (x_1512 * x_1515);
  let x_1520 : f32 = SV_Target1.x;
  SV_Target1.x = clamp(x_1520, 0.0f, 1.0f);
  SV_Target0.w = 1.0f;
  let x_1524 : vec4<f32> = SV_Target1;
  SV_Target1 = vec4<f32>(x_1524.x, vec3<f32>(0.0f, 0.0f, 0.0f).x, vec3<f32>(0.0f, 0.0f, 0.0f).y, vec3<f32>(0.0f, 0.0f, 0.0f).z);
  return;
}
