...
;
    ...
    u_xlat45 = dot(u_xlat7, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat45 = (-u_xlat45) + 4.0;
    u_xlatu45 = uint(u_xlat45);
    u_xlati45 = int(u_xlatu45) << (2 & int(0x1F));
    u_xlat1.xyw = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati45 + 1) / 4][(u_xlati45 + 1) % 4].xyz;
    u_xlat1.xyw = _MainLightWorldToShadow[u_xlati45 / 4][u_xlati45 % 4].xyz * vs_INTERP0.xxx + u_xlat1.xyw;
    u_xlat1.xyw = _MainLightWorldToShadow[(u_xlati45 + 2) / 4][(u_xlati45 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat1.xyw;
    u_xlat1.xyw = u_xlat1.xyw + _MainLightWorldToShadow[(u_xlati45 + 3) / 4][(u_xlati45 + 3) % 4].xyz;
    u_xlat4.w = 1.0;
    ...
    u_xlat1.x = u_xlat1.x * _MainLightShadowParams.x + u_xlat16.x;
    u_xlatb16.x = 0.0>=u_xlat1.w;
    u_xlatb46 = u_xlat1.w>=1.0;
    u_xlatb16.x = u_xlatb46 || u_xlatb16.x;
    u_xlat1.x = (u_xlatb16.x) ? 1.0 : u_xlat1.x;
    ...
    u_xlat1.x = u_xlat16.x * u_xlat46 + u_xlat1.x;
    u_xlatb16.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb16.x){
        u_xlat16.xz = vs_INTERP0.yy * _MainLightWorldToLight[1].xy;
        u_xlat16.xz = _MainLightWorldToLight[0].xy * vs_INTERP0.xx + u_xlat16.xz;
        u_xlat16.xz = _MainLightWorldToLight[2].xy * vs_INTERP0.zz + u_xlat16.xz;
        u_xlat16.xz = u_xlat16.xz + _MainLightWorldToLight[3].xy;
        u_xlat16.xz = u_xlat16.xz * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat7 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat16.xz, _GlobalMipBias.x);
        u_xlatb16.xz = equal(vec4(vec4(_MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat)), vec4(0.0, 0.0, 1.0, 1.0)).xz;
        u_xlat46 = (u_xlatb16.z) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb16.x) ? u_xlat7.xyz : vec3(u_xlat46);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat9.xyz = u_xlat4.xyz * (-u_xlat16.xxx) + (-u_xlat5.xyz);
    ...
    u_xlat25.xyz = u_xlat16.xxx * u_xlat25.xyz + u_xlat0.xyz;
    ...
    u_xlat45 = u_xlat1.x * unity_LightData.z;
    u_xlat1.x = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat45 = u_xlat45 * u_xlat1.x;
    u_xlat1.xyw = vec3(u_xlat45) * u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu45 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat25.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu3)].www + _AdditionalLightsPosition[int(u_xlatu3)].xyz;
        u_xlat49 = dot(u_xlat25.xyz, u_xlat25.xyz);
        ...
        u_xlat25.xyz = u_xlat3.xxx * u_xlat25.xyz;
        u_xlat3.x = dot(u_xlat4.xyz, u_xlat25.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        u_xlat49 = dot(u_xlat11.xyz, u_xlat25.xyz);
        ...
        u_xlat25.xyz = u_xlat0.xyz * u_xlat3.xxx + u_xlat8.xyz;
        u_xlat9.xyz = u_xlat25.xyz * u_xlat12.xyz + u_xlat9.xyz;
    }
    u_xlat0.xyz = u_xlat6.xyz * vec3(u_xlat33) + u_xlat1.xyw;
