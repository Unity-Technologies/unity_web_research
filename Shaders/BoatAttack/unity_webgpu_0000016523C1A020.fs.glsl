...
layout(set = 0, binding = 8) uniform mediump texture2D _MRLL;
layout(set = 0, binding = 9) uniform mediump texture2D _BumpMap;
...
layout(set = 0, binding = 16) uniform mediump  sampler samplerSamplerState_Trilinear_Clamp;
void main()
{
vec4 u_xlat0;
uint u_xlatu0;
...
;
    ...
    u_xlat3 = texture(sampler2D(unity_LightmapInd, samplerunity_Lightmap), vs_INTERP4.xy, _GlobalMipBias.x);
    u_xlat5.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP4.xy, _GlobalMipBias.x).xyz;
    u_xlat3.xyz = u_xlat3.xyz + vec3(-0.5, -0.5, -0.5);
    u_xlat14.x = dot(u_xlat15.xyz, u_xlat3.xyz);
    u_xlat14.x = u_xlat14.x + 0.5;
    u_xlat3.xyz = u_xlat14.xxx * u_xlat5.xyz;
    u_xlat14.x = max(u_xlat3.w, 9.99999975e-05);
