...
;
    ...
    u_xlat3.xyz = (bool(u_xlatb14)) ? u_xlat3.xyz : u_xlat4.xyz;
    u_xlat14.x = vs_INTERP0.y * unity_MatrixV[1].z;
    u_xlat14.x = unity_MatrixV[0].z * vs_INTERP0.x + u_xlat14.x;
    u_xlat14.x = unity_MatrixV[2].z * vs_INTERP0.z + u_xlat14.x;
    ...
    u_xlat44 = (-u_xlat28) + u_xlat1.x;
    u_xlat6.xyz = vec3(u_xlat28) * u_xlat2.xyz;
    ...
    u_xlat46 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat5.xz, _GlobalMipBias.x).x;
    u_xlat5.x = u_xlat46 + -1.0;
    u_xlat5.x = _AmbientOcclusionParam.w * u_xlat5.x + 1.0;
    u_xlat42 = min(u_xlat0.w, u_xlat46);
    ...
    u_xlat46 = u_xlat46 * _MainLightShadowParams.x + u_xlat19.x;
    u_xlatb19.x = 0.0>=vs_INTERP8.z;
    u_xlatb33 = vs_INTERP8.z>=1.0;
    u_xlatb19.x = u_xlatb33 || u_xlatb19.x;
    u_xlat46 = (u_xlatb19.x) ? 1.0 : u_xlat46;
    ...
    u_xlat19.xyz = u_xlat5.xxx * u_xlat19.xyz;
    u_xlat48 = dot((-u_xlat3.xyz), u_xlat15.xyz);
    u_xlat48 = u_xlat48 + u_xlat48;
    u_xlat7.xyz = u_xlat15.xyz * (-vec3(u_xlat48)) + (-u_xlat3.xyz);
    u_xlat48 = dot(u_xlat15.xyz, u_xlat3.xyz);
    u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
    u_xlat48 = (-u_xlat48) + 1.0;
    u_xlat48 = u_xlat48 * u_xlat48;
    u_xlat48 = u_xlat48 * u_xlat48;
    u_xlat49 = (-u_xlat0.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat8.xyz = (-u_xlat2.xyz) + vec3(u_xlat44);
    u_xlat8.xyz = vec3(u_xlat48) * u_xlat8.xyz + u_xlat2.xyz;
    ...
    u_xlat44 = dot(u_xlat15.xyz, _MainLightPosition.xyz);
    u_xlat44 = clamp(u_xlat44, 0.0, 1.0);
    u_xlat28 = u_xlat28 * u_xlat44;
    u_xlat19.xyz = vec3(u_xlat28) * u_xlat19.xyz;
    ...
    u_xlat28 = dot(u_xlat15.xyz, u_xlat7.xyz);
    ...
    u_xlat7.xyz = u_xlat2.xyz * vec3(u_xlat28) + u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat46 = dot(unity_LightIndices[int(u_xlatu46)], uintBitsToFloat(ImmCB_0[u_xlati48]));
        ...
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[int(u_xlatu46)].x;
        ...
        if(u_xlati49 != 0) {
            ...
            if(u_xlati50 != 0) {
                u_xlat11.xyz = vs_INTERP0.yyy * _AdditionalLightsWorldToLights[(u_xlati51 + 1) / 4][(u_xlati51 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati51 / 4][u_xlati51 % 4].xyw * vs_INTERP0.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati51 + 2) / 4][(u_xlati51 + 2) % 4].xyw * vs_INTERP0.zzz + u_xlat11.xyz;
                ...
                if(u_xlati49 != 0) {
                    u_xlat39.xy = vs_INTERP0.yy * _AdditionalLightsWorldToLights[(u_xlati51 + 1) / 4][(u_xlati51 + 1) % 4].xy;
                    u_xlat39.xy = _AdditionalLightsWorldToLights[u_xlati51 / 4][u_xlati51 % 4].xy * vs_INTERP0.xx + u_xlat39.xy;
                    u_xlat39.xy = _AdditionalLightsWorldToLights[(u_xlati51 + 2) / 4][(u_xlati51 + 2) % 4].xy * vs_INTERP0.zz + u_xlat39.xy;
                    ...
                    u_xlat12 = vs_INTERP0.yyyy * _AdditionalLightsWorldToLights[(u_xlati51 + 1) / 4][(u_xlati51 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati51 / 4][u_xlati51 % 4] * vs_INTERP0.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati51 + 2) / 4][(u_xlati51 + 2) % 4] * vs_INTERP0.zzzz + u_xlat12;
        ...
        u_xlat46 = dot(u_xlat15.xyz, u_xlat10.xyz);
        ...
        u_xlat9.xyz = u_xlat2.xyz * vec3(u_xlat46) + u_xlat6.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xzw = u_xlat4.xyz * vec3(u_xlat42) + u_xlat19.xyz;
