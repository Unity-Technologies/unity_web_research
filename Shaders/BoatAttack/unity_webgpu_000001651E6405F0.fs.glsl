...
float u_xlat16;
    ...
    u_xlat3.xyz = u_xlat2.yyy * unity_WorldToLight[1].xyz;
    u_xlat3.xyz = unity_WorldToLight[0].xyz * u_xlat2.xxx + u_xlat3.xyz;
    u_xlat3.xyz = unity_WorldToLight[2].xyz * u_xlat2.www + u_xlat3.xyz;
    u_xlat2.xyz = u_xlat2.xyw + (-_WorldSpaceCameraPos.xyz);
    u_xlat3.xyz = u_xlat3.xyz + unity_WorldToLight[3].xyz;
    u_xlat11 = texture(samplerCube(_LightTexture0, sampler_LightTexture0), u_xlat3.xyz, -8.0).w;
    u_xlat0.x = u_xlat0.x * u_xlat11;
