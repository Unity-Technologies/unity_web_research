...
fn main_1() {
  ...
  let x_1947 : vec3<f32> = (vec3<f32>(x_1945.x, x_1945.y, x_1945.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1948 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1947.x, x_1947.y, x_1947.z, x_1948.w);
  let x_1950 : vec4<f32> = u_xlat0;
  let x_1953 : vec3<f32> = log2(abs(vec3<f32>(x_1950.x, x_1950.y, x_1950.z)));
  let x_1954 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1953.x, x_1953.y, x_1953.z, x_1954.w);
  let x_1956 : vec4<f32> = u_xlat2;
  let x_1958 : vec3<f32> = (vec3<f32>(x_1956.x, x_1956.y, x_1956.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1959 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1958.x, x_1958.y, x_1958.z, x_1959.w);
  let x_1961 : vec4<f32> = u_xlat2;
  let x_1963 : vec3<f32> = exp2(vec3<f32>(x_1961.x, x_1961.y, x_1961.z));
  let x_1964 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1963.x, x_1963.y, x_1963.z, x_1964.w);
  let x_1966 : vec4<f32> = u_xlat2;
  let x_1969 : vec3<f32> = ((vec3<f32>(x_1966.x, x_1966.y, x_1966.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1970 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1969.x, x_1969.y, x_1969.z, x_1970.w);
  let x_1972 : vec4<f32> = u_xlat0;
  let x_1974 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1972.x, x_1972.y, x_1972.z, x_1972.x));
  u_xlatb0 = vec3<bool>(x_1974.x, x_1974.y, x_1974.z);
  let x_1979 : bool = u_xlatb0.x;
  if (x_1979) {
