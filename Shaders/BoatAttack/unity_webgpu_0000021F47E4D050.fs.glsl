...
layout(set = 0, binding = 2) uniform mediump texture2D _DitheringTexture;
...
layout(set = 0, binding = 4) uniform mediump  samplerShadow sampler_MainLightShadowmapTexture;
layout(set = 0, binding = 5) uniform mediump  sampler sampler_DitheringTexture;
void main()
{
vec4 u_xlat0;
bool u_xlatb0;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat18.x = u_xlat2.y * u_xlat2.y;
    u_xlat18.x = u_xlat2.x * u_xlat2.x + (-u_xlat18.x);
    ...
    u_xlat4.xyz = u_xlat18.xxx * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu18 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat57 = dot(_AdditionalLightsSpotDir[u_xlati1].xyz, u_xlat6.xyz);
        u_xlat57 = u_xlat57 * _AdditionalLightsAttenuation[u_xlati1].z + _AdditionalLightsAttenuation[u_xlati1].w;
        u_xlat57 = clamp(u_xlat57, 0.0, 1.0);
        u_xlat57 = u_xlat57 * u_xlat57;
        u_xlat56 = u_xlat56 * u_xlat57;
        u_xlat7.xyz = vec3(u_xlat56) * _AdditionalLightsColor[u_xlati1].xyz;
