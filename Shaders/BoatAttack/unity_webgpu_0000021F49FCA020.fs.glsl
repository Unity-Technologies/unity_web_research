...
;
    ...
    u_xlat3.xyz = u_xlat21.xxx * u_xlat22.xyz;
    u_xlatb21 = unity_OrthoParams.w==0.0;
    u_xlat22.xyz = (-vs_INTERP0.xyz) + _WorldSpaceCameraPos.xyz;
    ...
    u_xlat22.xyz = (bool(u_xlatb21)) ? u_xlat22.xyz : u_xlat4.xyz;
...
;
    ...
    u_xlat4.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati21 + 1) / 4][(u_xlati21 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati21 / 4][u_xlati21 % 4].xyz * vs_INTERP0.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati21 + 2) / 4][(u_xlati21 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati21 + 3) / 4][(u_xlati21 + 3) % 4].xyz;
    ...
    u_xlat65 = (-u_xlat42) + 1.0;
    u_xlat7.xyz = vec3(u_xlat42) * u_xlat2.xyz;
    ...
    u_xlat66 = u_xlat42 * u_xlat42;
    u_xlat1.x = u_xlat1.x + u_xlat65;
    u_xlat1.x = min(u_xlat1.x, 1.0);
    u_xlat65 = u_xlat42 * 4.0 + 2.0;
    ...
    u_xlat6.x = dot((-u_xlat22.xyz), u_xlat3.xyz);
    u_xlat6.x = u_xlat6.x + u_xlat6.x;
    u_xlat6.xyz = u_xlat3.xyz * (-u_xlat6.xxx) + (-u_xlat22.xyz);
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat0.x);
    ...
    u_xlat8.xyz = (-u_xlat2.xyz) + u_xlat1.xxx;
    ...
    u_xlat4.xyz = vec3(u_xlat42) * u_xlat25.xyz;
    ...
    u_xlat6.xyz = u_xlat2.xyz * vec3(u_xlat42) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat67 = dot(unity_LightIndices[int(u_xlatu67)], uintBitsToFloat(ImmCB_0[u_xlati48]));
        u_xlatu67 =  uint(int(u_xlat67));
        u_xlat9.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu67)].www + _AdditionalLightsPosition[int(u_xlatu67)].xyz;
        u_xlat48.x = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat48.x = max(u_xlat48.x, 6.10351562e-05);
        u_xlat69 = inversesqrt(u_xlat48.x);
        u_xlat10.xyz = vec3(u_xlat69) * u_xlat9.xyz;
        u_xlat70 = float(1.0) / float(u_xlat48.x);
        u_xlat48.x = u_xlat48.x * _AdditionalLightsAttenuation[int(u_xlatu67)].x;
        ...
        u_xlat70 = dot(_AdditionalLightsSpotDir[int(u_xlatu67)].xyz, u_xlat10.xyz);
        u_xlat70 = u_xlat70 * _AdditionalLightsAttenuation[int(u_xlatu67)].z + _AdditionalLightsAttenuation[int(u_xlatu67)].w;
        u_xlat70 = clamp(u_xlat70, 0.0, 1.0);
        u_xlat70 = u_xlat70 * u_xlat70;
        u_xlat48.x = u_xlat48.x * u_xlat70;
        u_xlatu70 = u_xlatu67 >> (5u & uint(0x1F));
        ...
        if(u_xlati70 != 0) {
            u_xlati70 = int(_AdditionalLightsLightTypes[int(u_xlatu67)]);
            u_xlati71 = (u_xlati70 != 0) ? 0 : 1;
            u_xlati72 = int(u_xlatu67) << (2 & int(0x1F));
            if(u_xlati71 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu67)].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu67)].zw;
            } else {
                ...
                if(u_xlati70 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu67)].xy * u_xlat53.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu67)].zw;
                } else {
            ...
            u_xlat70 = (u_xlatb6.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb6.x) ? u_xlat11.xyz : vec3(u_xlat70);
        } else {
            u_xlat11.x = float(1.0);
            u_xlat11.y = float(1.0);
            u_xlat11.z = float(1.0);
        }
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[int(u_xlatu67)].xyz;
        u_xlat11.xyz = vec3(u_xlat68) * u_xlat11.xyz;
        u_xlat67 = dot(u_xlat3.xyz, u_xlat10.xyz);
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat67 = u_xlat67 * u_xlat48.x;
        u_xlat11.xyz = vec3(u_xlat67) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat69) + u_xlat22.xyz;
        ...
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat48.x = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat48.x = clamp(u_xlat48.x, 0.0, 1.0);
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat67 = u_xlat67 * u_xlat0.x + 1.00001001;
        u_xlat48.x = u_xlat48.x * u_xlat48.x;
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat48.x = max(u_xlat48.x, 0.100000001);
        u_xlat67 = u_xlat67 * u_xlat48.x;
        u_xlat67 = u_xlat65 * u_xlat67;
        u_xlat67 = u_xlat66 / u_xlat67;
        u_xlat9.xyz = u_xlat2.xyz * vec3(u_xlat67) + u_xlat7.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xzw = u_xlat5.xyz * vec3(u_xlat63) + u_xlat4.xyz;
