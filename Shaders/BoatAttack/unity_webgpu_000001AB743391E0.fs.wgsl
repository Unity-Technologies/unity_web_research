...
fn main_1() {
  ...
  let x_983 : f32 = x_975;
  u_xlat0.z = x_983;
  let x_985 : vec2<f32> = vs_TEXCOORD0;
  let x_988 : vec4<f32> = x_40.x_Dithering_Params;
  let x_992 : vec4<f32> = x_40.x_Dithering_Params;
  let x_994 : vec2<f32> = ((x_985 * vec2<f32>(x_988.x, x_988.y)) + vec2<f32>(x_992.z, x_992.w));
  let x_995 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_994.x, x_994.y, x_995.z);
  let x_1002 : vec3<f32> = u_xlat1;
  let x_1005 : f32 = x_40.x_GlobalMipBias.x;
  let x_1006 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1002.x, x_1002.y), x_1005);
  u_xlat18 = x_1006.w;
  let x_1008 : f32 = u_xlat18;
  u_xlat18 = ((x_1008 * 2.0f) + -1.0f);
  let x_1011 : f32 = u_xlat18;
  u_xlatb1.x = (x_1011 >= 0.0f);
  let x_1015 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1015);
  let x_1018 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1018)) + 1.0f);
  let x_1022 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1022);
  let x_1024 : f32 = u_xlat18;
  u_xlat18 = (-(x_1024) + 1.0f);
  let x_1027 : f32 = u_xlat18;
  let x_1029 : f32 = u_xlat1.x;
  u_xlat18 = (x_1027 * x_1029);
  let x_1031 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1031.x, x_1031.y, x_1031.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1034 : vec4<f32> = u_xlat0;
  let x_1037 : vec3<f32> = log2(abs(vec3<f32>(x_1034.x, x_1034.y, x_1034.z)));
  let x_1038 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1037.x, x_1037.y, x_1037.z, x_1038.w);
  let x_1040 : vec4<f32> = u_xlat2;
  let x_1042 : vec3<f32> = (vec3<f32>(x_1040.x, x_1040.y, x_1040.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1043 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1042.x, x_1042.y, x_1042.z, x_1043.w);
  let x_1045 : vec4<f32> = u_xlat2;
  let x_1047 : vec3<f32> = exp2(vec3<f32>(x_1045.x, x_1045.y, x_1045.z));
  let x_1048 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1047.x, x_1047.y, x_1047.z, x_1048.w);
  let x_1050 : vec4<f32> = u_xlat2;
  let x_1053 : vec3<f32> = ((vec3<f32>(x_1050.x, x_1050.y, x_1050.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1054 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1053.x, x_1053.y, x_1053.z, x_1054.w);
  let x_1056 : vec4<f32> = u_xlat0;
  let x_1058 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1056.x, x_1056.y, x_1056.z, x_1056.x));
  u_xlatb0 = vec3<bool>(x_1058.x, x_1058.y, x_1058.z);
  ...
  let x_1103 : vec3<f32> = ((vec3<f32>(x_1096, x_1096, x_1096) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1101.x, x_1101.y, x_1101.z));
  let x_1104 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1103.x, x_1103.y, x_1103.z, x_1104.w);
  let x_1106 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1106.x, x_1106.y, x_1106.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1109 : vec4<f32> = u_xlat0;
  let x_1111 : vec3<f32> = (vec3<f32>(x_1109.x, x_1109.y, x_1109.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1112 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1111.x, x_1111.y, x_1111.z, x_1112.w);
  let x_1114 : vec4<f32> = u_xlat2;
  let x_1116 : vec3<f32> = (vec3<f32>(x_1114.x, x_1114.y, x_1114.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1127 : vec3<f32> = (vec3<f32>(x_1125.x, x_1125.y, x_1125.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1179 : vec3<f32> = max(vec3<f32>(x_1177.x, x_1177.y, x_1177.z), vec3<f32>(0.0f, 0.0f, 0.0f));
