...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat14.xyz = u_xlat22.xxx * vs_INTERP2.xyz + u_xlat14.xyz;
    u_xlat14.xyz = u_xlat22.zzz * vs_INTERP1.xyz + u_xlat14.xyz;
    ...
    u_xlat16.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat4.xy = u_xlat16.xy * hlslcc_FragCoord.xy;
    u_xlat16.x = u_xlat4.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat4.z = (-u_xlat16.x) + 1.0;
    u_xlat8.x = u_xlat8.x;
    u_xlat8.x = clamp(u_xlat8.x, 0.0, 1.0);
    u_xlat0 = u_xlat0;
    u_xlat0 = clamp(u_xlat0, 0.0, 1.0);
    u_xlat16.xyz = u_xlat7.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat45 = (-u_xlat8.x) + 1.0;
    u_xlat18 = u_xlat45 * u_xlat45;
    u_xlat18 = max(u_xlat18, 0.0078125);
    u_xlat46 = u_xlat18 * u_xlat18;
    u_xlat47 = u_xlat8.x + 0.0400000215;
    u_xlat47 = min(u_xlat47, 1.0);
    u_xlat6.x = u_xlat18 * 4.0 + 2.0;
    ...
    u_xlat43 = (u_xlatb20.x) ? 1.0 : u_xlat43;
    ...
    u_xlat20.xyz = vec3(u_xlat32) * u_xlat20.xyz;
    u_xlat7.x = dot((-u_xlat5.xyz), u_xlat3.xyz);
    u_xlat7.x = u_xlat7.x + u_xlat7.x;
    u_xlat7.xyz = u_xlat3.xyz * (-u_xlat7.xxx) + (-u_xlat5.xyz);
    ...
    u_xlat8.xy = vec2(u_xlat18) * vec2(u_xlat18) + vec2(-1.0, 1.0);
    u_xlat45 = float(1.0) / u_xlat8.y;
    u_xlat18 = u_xlat47 + -0.0399999991;
    u_xlat18 = u_xlat49 * u_xlat18 + 0.0399999991;
    u_xlat45 = u_xlat45 * u_xlat18;
    u_xlat7.xyz = vec3(u_xlat45) * u_xlat7.xyz;
    u_xlat14.xyz = u_xlat14.xyz * u_xlat16.xyz + u_xlat7.xyz;
    ...
    u_xlat7.xyz = vec3(u_xlat43) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat16.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu43 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat18 = dot(unity_LightIndices[int(u_xlatu18)], uintBitsToFloat(ImmCB_0[u_xlati47]));
        u_xlatu18 =  uint(int(u_xlat18));
        u_xlat9.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu18)].www + _AdditionalLightsPosition[int(u_xlatu18)].xyz;
        ...
        u_xlat47 = u_xlat47 * _AdditionalLightsAttenuation[int(u_xlatu18)].x;
        u_xlat47 = (-u_xlat47) * u_xlat47 + 1.0;
        u_xlat47 = max(u_xlat47, 0.0);
        u_xlat47 = u_xlat47 * u_xlat47;
        u_xlat47 = u_xlat47 * u_xlat49;
        u_xlat49 = dot(_AdditionalLightsSpotDir[int(u_xlatu18)].xyz, u_xlat10.xyz);
        u_xlat49 = u_xlat49 * _AdditionalLightsAttenuation[int(u_xlatu18)].z + _AdditionalLightsAttenuation[int(u_xlatu18)].w;
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat47 = u_xlat47 * u_xlat49;
        u_xlatu49 = u_xlatu18 >> (5u & uint(0x1F));
        u_xlati51 = 1 << (int(u_xlatu18) & int(0x1F));
        u_xlati49 = int(uint(u_xlati51) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu49)]));
        if(u_xlati49 != 0) {
            u_xlati49 = int(_AdditionalLightsLightTypes[int(u_xlatu18)]);
            u_xlati51 = (u_xlati49 != 0) ? 0 : 1;
            u_xlati52 = int(u_xlatu18) << (2 & int(0x1F));
            if(u_xlati51 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu18)].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu18)].zw;
            } else {
                ...
                if(u_xlati49 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu18)].xy * u_xlat39.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu18)].zw;
                } else {
        ...
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[int(u_xlatu18)].xyz;
        u_xlat11.xyz = vec3(u_xlat32) * u_xlat11.xyz;
        u_xlat18 = dot(u_xlat3.xyz, u_xlat10.xyz);
        u_xlat18 = clamp(u_xlat18, 0.0, 1.0);
        u_xlat18 = u_xlat18 * u_xlat47;
        u_xlat11.xyz = vec3(u_xlat18) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat35) + u_xlat5.xyz;
        ...
        u_xlat18 = u_xlat18 * u_xlat8.x + 1.00001001;
        u_xlat47 = u_xlat47 * u_xlat47;
        u_xlat18 = u_xlat18 * u_xlat18;
        ...
        u_xlat9.xyz = vec3(u_xlat18) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat16.xyz;
        u_xlat22.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat22.xyz;
    }
    u_xlat14.xyz = u_xlat14.xyz * u_xlat4.xxx + u_xlat20.xyz;
    u_xlat14.xyz = u_xlat22.xyz + u_xlat14.xyz;
    SV_Target0.xyz = vs_INTERP4.www * u_xlat1.xyz + u_xlat14.xyz;
