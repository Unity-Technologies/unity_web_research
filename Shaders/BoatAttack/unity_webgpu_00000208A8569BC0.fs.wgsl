...
fn main_1() {
  ...
  let x_1982 : vec3<f32> = u_xlat6;
  let x_1983 : vec3<f32> = ((vec3<f32>(x_1977.x, x_1977.x, x_1977.x) * vec3<f32>(x_1979.x, x_1979.y, x_1979.z)) + x_1982);
  let x_1984 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1983.x, x_1983.y, x_1983.z, x_1984.w);
  SV_Target0.w = 1.0f;
  return;
}
