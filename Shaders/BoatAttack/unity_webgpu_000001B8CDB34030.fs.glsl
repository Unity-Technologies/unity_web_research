...
;
    ...
    {
        u_xlat62 = float(u_xlatu_loop_1);
        u_xlat6.xy = vec2(u_xlat62) * _ScreenParams.xy;
        u_xlat6.xy = u_xlat41.xy * _DitherPattern_TexelSize.xy + u_xlat6.xy;
        ...
        u_xlat6.xyw = vec3(u_xlat62) * u_xlat6.xyw;
        u_xlat6.xyw = u_xlat6.xyw * vec3(0.100000001, 0.100000001, 0.100000001) + vs_TEXCOORD1.xyz;
        u_xlat62 = u_xlat62 + u_xlat6.z;
        u_xlat6.xyz = u_xlat5.xyz * vec3(u_xlat62) + u_xlat6.xyw;
...
;
        ...
        u_xlat62 = dot(u_xlat8, vec4(4.0, 3.0, 2.0, 1.0));
        u_xlat62 = (-u_xlat62) + 4.0;
        u_xlatu62 = uint(u_xlat62);
        u_xlati62 = int(u_xlatu62) << (2 & int(0x1F));
        u_xlat7.xyz = u_xlat6.yyy * _MainLightWorldToShadow[(u_xlati62 + 1) / 4][(u_xlati62 + 1) % 4].xyz;
        u_xlat6.xyw = _MainLightWorldToShadow[u_xlati62 / 4][u_xlati62 % 4].xyz * u_xlat6.xxx + u_xlat7.xyz;
        u_xlat6.xyz = _MainLightWorldToShadow[(u_xlati62 + 2) / 4][(u_xlati62 + 2) % 4].xyz * u_xlat6.zzz + u_xlat6.xyw;
        u_xlat6.xyz = u_xlat6.xyz + _MainLightWorldToShadow[(u_xlati62 + 3) / 4][(u_xlati62 + 3) % 4].xyz;
        vec3 txVec30 = vec3(u_xlat6.xy,u_xlat6.z);
        u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec30, 0.0);
