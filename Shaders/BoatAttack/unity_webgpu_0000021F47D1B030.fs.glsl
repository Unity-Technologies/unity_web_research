...
layout(set = 0, binding = 12) uniform mediump  sampler sampler_MetallicTex;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat16.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_TEXCOORD0.zw, _GlobalMipBias.x).xyz;
    ...
    u_xlat17 = u_xlat3.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat3.z = (-u_xlat17) + 1.0;
    u_xlat17 = (-u_xlat1) * 0.959999979 + 0.959999979;
    ...
    u_xlatb19.x = 0.0>=vs_TEXCOORD8.z;
    ...
    if(u_xlatb19.x){
        ...
        u_xlat19.xyz = (u_xlatb19.x) ? u_xlat6.xyz : vec3(u_xlat33);
    } else {
    ...
    u_xlat48 = dot((-u_xlat6.xyz), u_xlat15.xyz);
    u_xlat48 = u_xlat48 + u_xlat48;
    u_xlat7.xyz = u_xlat15.xyz * (-vec3(u_xlat48)) + (-u_xlat6.xyz);
    ...
    u_xlat8.xy = vec2(u_xlat17) * vec2(u_xlat17) + vec2(-1.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat17 = dot(unity_LightIndices[int(u_xlatu17)], uintBitsToFloat(ImmCB_0[u_xlati47]));
        u_xlatu17 =  uint(int(u_xlat17));
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu17)].www + _AdditionalLightsPosition[int(u_xlatu17)].xyz;
        ...
        u_xlat47 = u_xlat47 * _AdditionalLightsAttenuation[int(u_xlatu17)].x;
        u_xlat47 = (-u_xlat47) * u_xlat47 + 1.0;
        u_xlat47 = max(u_xlat47, 0.0);
        u_xlat47 = u_xlat47 * u_xlat47;
        u_xlat47 = u_xlat47 * u_xlat35.x;
        u_xlat35.x = dot(_AdditionalLightsSpotDir[int(u_xlatu17)].xyz, u_xlat10.xyz);
        u_xlat35.x = u_xlat35.x * _AdditionalLightsAttenuation[int(u_xlatu17)].z + _AdditionalLightsAttenuation[int(u_xlatu17)].w;
        u_xlat35.x = clamp(u_xlat35.x, 0.0, 1.0);
        u_xlat35.x = u_xlat35.x * u_xlat35.x;
        u_xlat47 = u_xlat47 * u_xlat35.x;
        u_xlatu35 = u_xlatu17 >> (5u & uint(0x1F));
        u_xlati49 = 1 << (int(u_xlatu17) & int(0x1F));
        u_xlati35 = int(uint(u_xlati49) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu35)]));
        if(u_xlati35 != 0) {
            u_xlati35 = int(_AdditionalLightsLightTypes[int(u_xlatu17)]);
            u_xlati49 = (u_xlati35 != 0) ? 0 : 1;
            u_xlati51 = int(u_xlatu17) << (2 & int(0x1F));
            if(u_xlati49 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu17)].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu17)].zw;
            } else {
                u_xlatb35 = u_xlati35==1;
                u_xlati35 = u_xlatb35 ? 1 : int(0);
                if(u_xlati35 != 0) {
                    u_xlat35.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati51 + 1) / 4][(u_xlati51 + 1) % 4].xy;
                    u_xlat35.xy = _AdditionalLightsWorldToLights[u_xlati51 / 4][u_xlati51 % 4].xy * vs_TEXCOORD7.xx + u_xlat35.xy;
                    u_xlat35.xy = _AdditionalLightsWorldToLights[(u_xlati51 + 2) / 4][(u_xlati51 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat35.xy;
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu17)].xy * u_xlat35.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu17)].zw;
                } else {
        ...
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[int(u_xlatu17)].xyz;
        u_xlat11.xyz = vec3(u_xlat31) * u_xlat11.xyz;
        u_xlat17 = dot(u_xlat15.xyz, u_xlat10.xyz);
        u_xlat17 = clamp(u_xlat17, 0.0, 1.0);
        u_xlat17 = u_xlat17 * u_xlat47;
        u_xlat11.xyz = vec3(u_xlat17) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat48) + u_xlat6.xyz;
        u_xlat17 = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat17 = max(u_xlat17, 1.17549435e-37);
        u_xlat17 = inversesqrt(u_xlat17);
        u_xlat9.xyz = vec3(u_xlat17) * u_xlat9.xyz;
        u_xlat17 = dot(u_xlat15.xyz, u_xlat9.xyz);
        u_xlat17 = clamp(u_xlat17, 0.0, 1.0);
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat17) + u_xlat4.xyz;
        u_xlat22.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat22.xyz;
    }
    u_xlat0.xyz = u_xlat16.xyz * u_xlat3.xxx + u_xlat5.xyz;
