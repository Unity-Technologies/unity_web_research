...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat2.x = (u_xlatb63) ? u_xlat1.x : unity_MatrixV[0].z;
    u_xlat2.y = (u_xlatb63) ? u_xlat1.y : unity_MatrixV[1].z;
    u_xlat2.z = (u_xlatb63) ? u_xlat1.z : unity_MatrixV[2].z;
    ...
    u_xlatu43 = u_xlatu1.z * 1025u;
    u_xlatu24 = u_xlatu43 >> (6u & uint(0x1F));
    u_xlati43 = int(u_xlatu43 ^ u_xlatu24);
    u_xlatu43 = uint(u_xlati43) * 9u;
    u_xlatu24 = u_xlatu43 >> (11u & uint(0x1F));
    u_xlati43 = int(u_xlatu43 ^ u_xlatu24);
    u_xlati43 = u_xlati43 * 32769;
    u_xlati22 = int(uint(u_xlati43) ^ u_xlatu1.y);
    u_xlatu22 = uint(u_xlati22) * 1025u;
    u_xlatu43 = u_xlatu22 >> (6u & uint(0x1F));
    u_xlati22 = int(u_xlatu43 ^ u_xlatu22);
    u_xlatu22 = uint(u_xlati22) * 9u;
    u_xlatu43 = u_xlatu22 >> (11u & uint(0x1F));
    u_xlati22 = int(u_xlatu43 ^ u_xlatu22);
    u_xlati22 = u_xlati22 * 32769;
    u_xlati1 = int(uint(u_xlati22) ^ u_xlatu1.x);
    u_xlatu1.x = uint(u_xlati1) * 1025u;
    u_xlatu22 = u_xlatu1.x >> (6u & uint(0x1F));
    u_xlati1 = int(u_xlatu22 ^ u_xlatu1.x);
    u_xlatu1.x = uint(u_xlati1) * 9u;
    u_xlatu22 = u_xlatu1.x >> (11u & uint(0x1F));
    u_xlati1 = int(u_xlatu22 ^ u_xlatu1.x);
    ...
    u_xlat1.x = (u_xlatb3) ? u_xlat1.x : u_xlat22;
    u_xlat1.x = u_xlat64 * 2.0 + (-u_xlat1.x);
    u_xlat22 = u_xlat1.x * u_xlat3.w;
    u_xlatb43.x = u_xlat22>=0.400000006;
    u_xlat43.x = u_xlatb43.x ? u_xlat22 : float(0.0);
    u_xlat1.x = u_xlat3.w * u_xlat1.x + -0.400000006;
    u_xlat64 = dFdxCoarse(u_xlat22);
    u_xlat22 = dFdyCoarse(u_xlat22);
    u_xlat22 = abs(u_xlat22) + abs(u_xlat64);
    u_xlat22 = max(u_xlat22, 9.99999975e-05);
    u_xlat1.x = u_xlat1.x / u_xlat22;
    u_xlat1.x = u_xlat1.x + 0.5;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlatb22 = _AlphaToMaskAvailable!=0.0;
    u_xlat1.x = (u_xlatb22) ? u_xlat1.x : u_xlat43.x;
    u_xlat43.x = u_xlat1.x + -9.99999975e-05;
    u_xlatb43.x = u_xlat43.x<0.0;
    if(((int(u_xlatb43.x) * int(0xffffffffu)))!=0){discard;}
    ...
    u_xlat43.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    ...
    u_xlat26.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP5.xy, _GlobalMipBias.x).xyz;
    u_xlat6.xyz = u_xlat6.xyz + vec3(-0.5, -0.5, -0.5);
    u_xlat43.x = dot(u_xlat3.xyz, u_xlat6.xyz);
    u_xlat43.x = u_xlat43.x + 0.5;
    u_xlat26.xyz = u_xlat43.xxx * u_xlat26.xyz;
    u_xlat43.x = max(u_xlat6.w, 9.99999975e-05);
    u_xlat26.xyz = u_xlat26.xyz / u_xlat43.xxx;
    u_xlat43.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat6.xy = u_xlat43.xy * hlslcc_FragCoord.xy;
    u_xlat43.x = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat6.z = (-u_xlat43.x) + 1.0;
    u_xlat5.x = u_xlat5.x;
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
    u_xlat1.x = u_xlat1.x;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat43.x = (-u_xlat5.x) + 1.0;
    u_xlat64 = u_xlat43.x * u_xlat43.x;
    u_xlat64 = max(u_xlat64, 0.0078125);
    u_xlat66 = u_xlat64 * u_xlat64;
    u_xlat67 = u_xlat5.x + 0.0400000215;
    u_xlat67 = min(u_xlat67, 1.0);
    u_xlat5.x = u_xlat64 * 4.0 + 2.0;
    ...
    if(u_xlatb63){
        ...
        if(u_xlatb63){
            ...
            if(u_xlatb48.x){
                ...
                u_xlat28 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec57, 0.0);
                u_xlat7.x = u_xlat7.z * u_xlat28 + u_xlat7.x;
    ...
    u_xlatb65 = u_xlatb65 || u_xlatb48.x;
    ...
    u_xlat63 = u_xlat65 * u_xlat48.x + u_xlat63;
    ...
    if(u_xlatb65){
        ...
        u_xlat65 = (u_xlatb48.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb48.x) ? u_xlat7.xyz : vec3(u_xlat65);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat8.xyz = u_xlat3.xyz * (-vec3(u_xlat65)) + (-u_xlat2.xyz);
    u_xlat65 = dot(u_xlat3.xyz, u_xlat2.xyz);
    u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
    u_xlat65 = (-u_xlat65) + 1.0;
    u_xlat65 = u_xlat65 * u_xlat65;
    u_xlat65 = u_xlat65 * u_xlat65;
    u_xlat48.x = (-u_xlat43.x) * 0.699999988 + 1.70000005;
    u_xlat43.x = u_xlat43.x * u_xlat48.x;
    u_xlat43.x = u_xlat43.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat43.x);
    u_xlat43.x = u_xlat8.w + -1.0;
    u_xlat43.x = unity_SpecCube0_HDR.w * u_xlat43.x + 1.0;
    u_xlat43.x = max(u_xlat43.x, 0.0);
    u_xlat43.x = log2(u_xlat43.x);
    u_xlat43.x = u_xlat43.x * unity_SpecCube0_HDR.y;
    u_xlat43.x = exp2(u_xlat43.x);
    u_xlat43.x = u_xlat43.x * unity_SpecCube0_HDR.x;
    u_xlat8.xyz = u_xlat8.xyz * u_xlat43.xxx;
    u_xlat43.xy = vec2(u_xlat64) * vec2(u_xlat64) + vec2(-1.0, 1.0);
    u_xlat64 = float(1.0) / u_xlat43.y;
    u_xlat67 = u_xlat67 + -0.0399999991;
    u_xlat65 = u_xlat65 * u_xlat67 + 0.0399999991;
    u_xlat64 = u_xlat64 * u_xlat65;
    u_xlat8.xyz = vec3(u_xlat64) * u_xlat8.xyz;
    u_xlat26.xyz = u_xlat26.xyz * u_xlat4.xyz + u_xlat8.xyz;
    u_xlat63 = u_xlat63 * unity_LightData.z;
    u_xlat64 = dot(u_xlat3.xyz, _MainLightPosition.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu65)].www + _AdditionalLightsPosition[int(u_xlatu65)].xyz;
        ...
        u_xlat67 = u_xlat67 * _AdditionalLightsAttenuation[int(u_xlatu65)].x;
        u_xlat67 = (-u_xlat67) * u_xlat67 + 1.0;
        u_xlat67 = max(u_xlat67, 0.0);
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat67 = u_xlat67 * u_xlat71;
        u_xlat71 = dot(_AdditionalLightsSpotDir[int(u_xlatu65)].xyz, u_xlat10.xyz);
        u_xlat71 = u_xlat71 * _AdditionalLightsAttenuation[int(u_xlatu65)].z + _AdditionalLightsAttenuation[int(u_xlatu65)].w;
        u_xlat71 = clamp(u_xlat71, 0.0, 1.0);
        u_xlat71 = u_xlat71 * u_xlat71;
        u_xlat67 = u_xlat67 * u_xlat71;
        u_xlatu71 = u_xlatu65 >> (5u & uint(0x1F));
        u_xlati72 = 1 << (int(u_xlatu65) & int(0x1F));
        u_xlati71 = int(uint(u_xlati72) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu71)]));
        if(u_xlati71 != 0) {
            u_xlati71 = int(_AdditionalLightsLightTypes[int(u_xlatu65)]);
            u_xlati72 = (u_xlati71 != 0) ? 0 : 1;
            u_xlati73 = int(u_xlatu65) << (2 & int(0x1F));
            if(u_xlati72 != 0) {
                ...
                if(u_xlati71 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu65)].xy * u_xlat53.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu65)].zw;
                } else {
        ...
        u_xlat65 = dot(u_xlat3.xyz, u_xlat10.xyz);
        u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
        u_xlat65 = u_xlat65 * u_xlat67;
        u_xlat11.xyz = vec3(u_xlat65) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat70) + u_xlat2.xyz;
        ...
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat65 = u_xlat65 * u_xlat43.x + 1.00001001;
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat67 = max(u_xlat67, 0.100000001);
        u_xlat65 = u_xlat65 * u_xlat67;
        u_xlat65 = u_xlat5.x * u_xlat65;
        u_xlat65 = u_xlat66 / u_xlat65;
        u_xlat9.xyz = vec3(u_xlat65) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat2.xyz = u_xlat26.xyz * u_xlat6.xxx + u_xlat7.xyz;
    u_xlat2.xyz = u_xlat8.xyz + u_xlat2.xyz;
    SV_Target0.xyz = vs_INTERP4.www * u_xlat0.xyz + u_xlat2.xyz;
    SV_Target0.w = (u_xlatb22) ? u_xlat1.x : 1.0;
