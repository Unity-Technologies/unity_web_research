...
fn main_1() {
  ...
  let x_1497 : vec3<f32> = sqrt(vec3<f32>(x_1495.x, x_1495.y, x_1495.z));
  let x_1498 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1497.x, x_1497.y, x_1497.z, x_1498.w);
  let x_1500 : vec2<f32> = vs_TEXCOORD0;
  let x_1503 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1507 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1509 : vec2<f32> = ((x_1500 * vec2<f32>(x_1503.x, x_1503.y)) + vec2<f32>(x_1507.z, x_1507.w));
  let x_1510 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1509.x, x_1509.y, x_1510.z, x_1510.w);
  let x_1517 : vec4<f32> = u_xlat1;
  let x_1520 : f32 = x_38.x_GlobalMipBias.x;
  let x_1521 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1517.x, x_1517.y), x_1520);
  u_xlat15 = x_1521.w;
  let x_1523 : f32 = u_xlat15;
  u_xlat15 = ((x_1523 * 2.0f) + -1.0f);
  let x_1526 : f32 = u_xlat15;
  u_xlatb1 = (x_1526 >= 0.0f);
  let x_1528 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1528);
  let x_1531 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1531)) + 1.0f);
  let x_1535 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1535);
  let x_1537 : f32 = u_xlat15;
  u_xlat15 = (-(x_1537) + 1.0f);
  let x_1540 : f32 = u_xlat15;
  let x_1542 : f32 = u_xlat1.x;
  u_xlat15 = (x_1540 * x_1542);
  let x_1544 : vec4<f32> = u_xlat0;
  let x_1546 : vec3<f32> = (vec3<f32>(x_1544.x, x_1544.y, x_1544.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1547 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1546.x, x_1546.y, x_1546.z, x_1547.w);
  let x_1549 : vec4<f32> = u_xlat0;
  let x_1551 : vec3<f32> = log2(vec3<f32>(x_1549.x, x_1549.y, x_1549.z));
  let x_1552 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1551.x, x_1551.y, x_1551.z, x_1552.w);
  let x_1554 : vec4<f32> = u_xlat2;
  let x_1556 : vec3<f32> = (vec3<f32>(x_1554.x, x_1554.y, x_1554.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1557 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1556.x, x_1556.y, x_1556.z, x_1557.w);
  let x_1559 : vec4<f32> = u_xlat2;
  let x_1561 : vec3<f32> = exp2(vec3<f32>(x_1559.x, x_1559.y, x_1559.z));
  let x_1562 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1561.x, x_1561.y, x_1561.z, x_1562.w);
  let x_1564 : vec4<f32> = u_xlat2;
  let x_1567 : vec3<f32> = ((vec3<f32>(x_1564.x, x_1564.y, x_1564.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1568 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1567.x, x_1567.y, x_1567.z, x_1568.w);
  let x_1570 : vec4<f32> = u_xlat0;
  let x_1572 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1570.x, x_1570.y, x_1570.z, x_1570.x));
  u_xlatb0 = vec3<bool>(x_1572.x, x_1572.y, x_1572.z);
  let x_1575 : bool = u_xlatb0.x;
  if (x_1575) {
    let x_1580 : f32 = u_xlat1.x;
    x_1576 = x_1580;
  } else {
    let x_1583 : f32 = u_xlat2.x;
    x_1576 = x_1583;
  }
  let x_1584 : f32 = x_1576;
  u_xlat0.x = x_1584;
  let x_1587 : bool = u_xlatb0.y;
  if (x_1587) {
    let x_1592 : f32 = u_xlat1.y;
    x_1588 = x_1592;
  } else {
    let x_1595 : f32 = u_xlat2.y;
    x_1588 = x_1595;
  }
  let x_1596 : f32 = x_1588;
  u_xlat0.y = x_1596;
  let x_1599 : bool = u_xlatb0.z;
  if (x_1599) {
    let x_1604 : f32 = u_xlat1.z;
    x_1600 = x_1604;
  } else {
    let x_1607 : f32 = u_xlat2.z;
    x_1600 = x_1607;
  }
  ...
  let x_1617 : vec3<f32> = ((vec3<f32>(x_1610, x_1610, x_1610) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1615.x, x_1615.y, x_1615.z));
  let x_1618 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1617.x, x_1617.y, x_1617.z, x_1618.w);
  let x_1620 : vec4<f32> = u_xlat0;
  let x_1622 : vec3<f32> = (vec3<f32>(x_1620.x, x_1620.y, x_1620.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1623 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1622.x, x_1622.y, x_1622.z, x_1623.w);
  let x_1625 : vec4<f32> = u_xlat0;
  let x_1627 : vec3<f32> = (vec3<f32>(x_1625.x, x_1625.y, x_1625.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1628 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1627.x, x_1627.y, x_1627.z, x_1628.w);
  let x_1630 : vec4<f32> = u_xlat2;
  let x_1632 : vec3<f32> = (vec3<f32>(x_1630.x, x_1630.y, x_1630.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1633 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1632.x, x_1632.y, x_1632.z, x_1633.w);
  let x_1635 : vec4<f32> = u_xlat2;
  let x_1638 : vec3<f32> = log2(abs(vec3<f32>(x_1635.x, x_1635.y, x_1635.z)));
  let x_1639 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1638.x, x_1638.y, x_1638.z, x_1639.w);
  let x_1641 : vec4<f32> = u_xlat2;
  let x_1643 : vec3<f32> = (vec3<f32>(x_1641.x, x_1641.y, x_1641.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1653 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1651.x, x_1651.y, x_1651.z, x_1651.x));
  u_xlatb0 = vec3<bool>(x_1653.x, x_1653.y, x_1653.z);
  let x_1656 : bool = u_xlatb0.x;
  if (x_1656) {
    let x_1661 : f32 = u_xlat1.x;
    x_1657 = x_1661;
  } else {
    let x_1664 : f32 = u_xlat2.x;
    x_1657 = x_1664;
  }
  let x_1665 : f32 = x_1657;
  u_xlat0.x = x_1665;
  let x_1668 : bool = u_xlatb0.y;
  if (x_1668) {
    let x_1673 : f32 = u_xlat1.y;
    x_1669 = x_1673;
  } else {
    let x_1676 : f32 = u_xlat2.y;
    x_1669 = x_1676;
  }
  let x_1677 : f32 = x_1669;
  u_xlat0.y = x_1677;
  let x_1680 : bool = u_xlatb0.z;
  if (x_1680) {
    let x_1685 : f32 = u_xlat1.z;
    x_1681 = x_1685;
  } else {
  ...
  let x_1695 : vec3<f32> = max(vec3<f32>(x_1693.x, x_1693.y, x_1693.z), vec3<f32>(0.0f, 0.0f, 0.0f));
