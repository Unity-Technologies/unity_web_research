...
bool u_xlatb9;
    ...
    vs_TEXCOORD2.w = (u_xlatb9) ? u_xlat0.x : unity_MatrixV[0].z;
    ...
    vs_TEXCOORD3.w = (u_xlatb9) ? u_xlat0.y : unity_MatrixV[1].z;
    vs_TEXCOORD4.w = (u_xlatb9) ? u_xlat0.z : unity_MatrixV[2].z;
