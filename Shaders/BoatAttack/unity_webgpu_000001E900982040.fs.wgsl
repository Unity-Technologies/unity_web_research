...
fn main_1() {
  ...
  let x_1393 : vec2<f32> = vs_TEXCOORD0;
  let x_1396 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1400 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1402 : vec2<f32> = ((x_1393 * vec2<f32>(x_1396.x, x_1396.y)) + vec2<f32>(x_1400.z, x_1400.w));
  let x_1403 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1402.x, x_1402.y, x_1403.z);
  let x_1410 : vec3<f32> = u_xlat1;
  let x_1413 : f32 = x_25.x_GlobalMipBias.x;
  let x_1414 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1410.x, x_1410.y), x_1413);
  u_xlat21 = x_1414.w;
  let x_1416 : f32 = u_xlat21;
  u_xlat21 = ((x_1416 * 2.0f) + -1.0f);
  let x_1419 : f32 = u_xlat21;
  u_xlatb1.x = (x_1419 >= 0.0f);
  let x_1423 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1423);
  let x_1426 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1426)) + 1.0f);
  let x_1430 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1430);
  let x_1432 : f32 = u_xlat21;
  u_xlat21 = (-(x_1432) + 1.0f);
  let x_1435 : f32 = u_xlat21;
  let x_1437 : f32 = u_xlat1.x;
  u_xlat21 = (x_1435 * x_1437);
  let x_1439 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1439.x, x_1439.y, x_1439.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1450 : vec3<f32> = (vec3<f32>(x_1448.x, x_1448.y, x_1448.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1461 : vec3<f32> = ((vec3<f32>(x_1458.x, x_1458.y, x_1458.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1462 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1461.x, x_1461.y, x_1461.z, x_1462.w);
  let x_1464 : vec4<f32> = u_xlat0;
  let x_1466 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1464.x, x_1464.y, x_1464.z, x_1464.x));
  ...
  let x_1511 : vec3<f32> = ((vec3<f32>(x_1504, x_1504, x_1504) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1509.x, x_1509.y, x_1509.z));
  let x_1512 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1511.x, x_1511.y, x_1511.z, x_1512.w);
  let x_1514 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1514.x, x_1514.y, x_1514.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  ...
  let x_1588 : vec3<f32> = max(vec3<f32>(x_1585.x, x_1585.y, x_1585.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1589 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1588.x, x_1588.y, x_1588.z, x_1589.w);
  SV_Target0.w = 1.0f;
  return;
}
