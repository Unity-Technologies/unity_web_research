...
fn main_1() {
  ...
  let x_802 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_819 : f32 = x_25.x_GlobalMipBias.x;
  ...
  u_xlatb1.x = (x_826 >= 0.0f);
  let x_830 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_830);
  let x_833 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_833)) + 1.0f);
