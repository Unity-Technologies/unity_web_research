...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati69].www + _AdditionalLightsPosition[u_xlati69].xyz;
        ...
        u_xlat72 = dot(_AdditionalLightsSpotDir[u_xlati69].xyz, u_xlat10.xyz);
        u_xlat72 = u_xlat72 * _AdditionalLightsAttenuation[u_xlati69].z + _AdditionalLightsAttenuation[u_xlati69].w;
        u_xlat72 = clamp(u_xlat72, 0.0, 1.0);
        u_xlat72 = u_xlat72 * u_xlat72;
        u_xlat70 = u_xlat70 * u_xlat72;
        u_xlat11.xyz = vec3(u_xlat71) * _AdditionalLightsColor[u_xlati69].xyz;
        ...
        u_xlat9.xyz = u_xlat9.xyz * u_xlat5.xxx + u_xlat7.xyz;
        ...
        u_xlat69 = dot(u_xlat6.xyz, u_xlat9.xyz);
        u_xlat69 = clamp(u_xlat69, 0.0, 1.0);
        ...
        u_xlat9.xyz = vec3(u_xlat69) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
