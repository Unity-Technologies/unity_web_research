...
fn main_1() {
  ...
  u_xlat2.x = ((x_119 * 0.00389105058f) + x_122);
  let x_126 : f32 = u_xlat0.x;
  let x_129 : f32 = u_xlat1;
  u_xlat0.x = ((-(x_126) * 0.00389105058f) + x_129);
  ...
  if (x_150) {
    let x_154 : vec2<f32> = u_xlat2;
    x_151 = vec4<f32>(x_154.x, x_154.x, x_154.x, x_154.x);
  } else {
    let x_157 : vec4<f32> = u_xlat0;
    x_151 = vec4<f32>(x_157.x, x_157.x, x_157.x, x_157.x);
  }
  let x_159 : vec4<f32> = x_151;
  SV_Target0 = x_159;
  return;
}
