...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat39 = dot((-u_xlat1.xyz), u_xlat11.xyz);
    u_xlat39 = u_xlat39 + u_xlat39;
    u_xlat7.xyz = u_xlat11.xyz * (-vec3(u_xlat39)) + (-u_xlat1.xyz);
    u_xlat39 = dot(u_xlat11.xyz, u_xlat1.xyz);
    ...
    u_xlat19.xyz = vec3(u_xlat39) * u_xlat19.xyz + u_xlat2.xyz;
    ...
    u_xlat0.x = u_xlat38 * unity_LightData.z;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat19.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati36].www + _AdditionalLightsPosition[u_xlati36].xyz;
        ...
        u_xlat19.xyz = u_xlat2.xyz * vec3(u_xlat36) + u_xlat3.xyz;
