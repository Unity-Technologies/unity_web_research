...
fn main_1() {
  ...
  let x_741 : vec4<f32> = x_26.x_Grain_TilingParams;
  let x_745 : vec4<f32> = x_26.x_Grain_TilingParams;
  ...
  let x_758 : f32 = x_26.x_GlobalMipBias.x;
  let x_759 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_755.x, x_755.y), x_758);
  u_xlat30 = x_759.w;
  let x_761 : f32 = u_xlat30;
  u_xlat30 = (x_761 + -0.5f);
  let x_763 : f32 = u_xlat30;
  let x_764 : f32 = u_xlat30;
  u_xlat30 = (x_763 + x_764);
  ...
  let x_777 : vec2<f32> = x_26.x_Grain_Params;
  let x_779 : vec3<f32> = (vec3<f32>(x_772.x, x_772.y, x_772.z) * vec3<f32>(x_777.x, x_777.x, x_777.x));
  let x_780 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_779.x, x_779.y, x_779.z, x_780.w);
  let x_782 : vec3<f32> = u_xlat0;
  u_xlat30 = dot(x_782, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_784 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_784);
  let x_787 : f32 = x_26.x_Grain_Params.y;
  let x_788 : f32 = u_xlat30;
  u_xlat30 = ((x_787 * -(x_788)) + 1.0f);
  let x_794 : vec4<f32> = u_xlat1;
  let x_796 : f32 = u_xlat30;
  let x_799 : vec3<f32> = u_xlat0;
  let x_800 : vec3<f32> = ((vec3<f32>(x_794.x, x_794.y, x_794.z) * vec3<f32>(x_796, x_796, x_796)) + x_799);
