...
;
    ...
    u_xlat38 = dot(u_xlat1.xyw, u_xlat6.xyz);
    ...
    u_xlat38 = dot(u_xlat1.xyw, u_xlat7.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu38 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat41 = u_xlat41 * u_xlat44;
        u_xlat11.xyz = vec3(u_xlat42) * _AdditionalLightsColor[u_xlati39].xyz;
        ...
        u_xlat21.xyz = u_xlat0.xyz * vec3(u_xlat39) + u_xlat8.xyz;
