...
layout(set = 1, binding = 4, std140) uniform VGlobals {
...
layout(set = 1, binding = 5, std140) uniform UnityDrawCallInfo {
	int unity_BaseInstanceID;
	int unity_InstanceCount;
};
layout(set = 1, binding = 6, std140) uniform _Terrain {
	float _NormalScale0;
	float _NormalScale1;
	float _NormalScale2;
	float _NormalScale3;
...
layout(set = 0, binding = 10) uniform mediump texture2D _TerrainHeightmapTexture;
layout(set = 0, binding = 11) uniform mediump texture2D _TerrainNormalmapTexture;
