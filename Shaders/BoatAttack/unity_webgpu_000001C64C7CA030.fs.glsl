...
;
    ...
    u_xlat14 = min(u_xlat14, u_xlat47);
    ...
    u_xlat20.xyz = vs_TEXCOORD7.xyz + (-_WorldSpaceCameraPos.xyz);
    ...
    if(u_xlatb17.x){
        ...
        u_xlat8 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat17.xy, _GlobalMipBias.x);
        ...
        u_xlat31 = (u_xlatb17.y) ? u_xlat8.w : u_xlat8.x;
        u_xlat20.xyz = (u_xlatb17.x) ? u_xlat8.xyz : vec3(u_xlat31);
    } else {
    ...
    u_xlat8.xyz = u_xlat2.xyz * (-u_xlat17.xxx) + (-u_xlat1.xyz);
    ...
    u_xlat20.xyz = vec3(u_xlat28) * u_xlat20.xyz;
    u_xlat28 = dot(u_xlat2.xyz, u_xlat20.xyz);
    u_xlat28 = clamp(u_xlat28, 0.0, 1.0);
    u_xlat3.x = dot(_MainLightPosition.xyz, u_xlat20.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    ...
    u_xlat20.xyz = u_xlat5.xyz * vec3(u_xlat28) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlati50 != 0) {
            ...
            u_xlat50 = (u_xlatb20.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb20.x) ? u_xlat11.xyz : vec3(u_xlat50);
        } else {
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat47) + u_xlat7.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat17.xyz * vec3(u_xlat14) + u_xlat4.xyz;
