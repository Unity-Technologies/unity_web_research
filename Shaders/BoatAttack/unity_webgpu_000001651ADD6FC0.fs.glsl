...
;
    ...
    if(u_xlatb23.x){
        ...
        u_xlat4.xzw = (u_xlatb23.x) ? u_xlat7.xyz : vec3(u_xlat44);
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.z = float(1.0);
        u_xlat4.w = float(1.0);
    ...
    u_xlat42 = dot(u_xlat1.xyz, u_xlat4.xzw);
    ...
    u_xlat4.xzw = u_xlat5.xyz * vec3(u_xlat42) + u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat67 = dot(unity_LightIndices[int(u_xlatu67)], uintBitsToFloat(ImmCB_0[u_xlati68]));
        ...
        u_xlat68 = u_xlat68 * _AdditionalLightsAttenuation[int(u_xlatu67)].x;
        ...
        if(u_xlati70 != 0) {
            ...
            u_xlat70 = (u_xlatb4.z) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb4.x) ? u_xlat11.xyz : vec3(u_xlat70);
        } else {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat69) + u_xlat7.xyz;
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat67) + u_xlat6.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat23.xyz * vec3(u_xlat21) + u_xlat3.xyz;
