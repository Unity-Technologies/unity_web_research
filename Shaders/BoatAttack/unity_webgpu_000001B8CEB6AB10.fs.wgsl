...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1163.x, x_1163.y, x_1163.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1166 : vec4<f32> = u_xlat0;
  let x_1169 : vec3<f32> = log2(abs(vec3<f32>(x_1166.x, x_1166.y, x_1166.z)));
  let x_1170 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1169.x, x_1169.y, x_1169.z, x_1170.w);
  let x_1172 : vec4<f32> = u_xlat2;
  let x_1174 : vec3<f32> = (vec3<f32>(x_1172.x, x_1172.y, x_1172.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1175 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1174.x, x_1174.y, x_1174.z, x_1175.w);
  let x_1177 : vec4<f32> = u_xlat2;
  let x_1179 : vec3<f32> = exp2(vec3<f32>(x_1177.x, x_1177.y, x_1177.z));
  let x_1180 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1179.x, x_1179.y, x_1179.z, x_1180.w);
  let x_1182 : vec4<f32> = u_xlat2;
  let x_1185 : vec3<f32> = ((vec3<f32>(x_1182.x, x_1182.y, x_1182.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1186 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1185.x, x_1185.y, x_1185.z, x_1186.w);
  let x_1188 : vec4<f32> = u_xlat0;
  let x_1190 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1188.x, x_1188.y, x_1188.z, x_1188.x));
  u_xlatb0 = vec3<bool>(x_1190.x, x_1190.y, x_1190.z);
  ...
  SV_Target0.x = x_1204;
  let x_1208 : bool = u_xlatb0.y;
  if (x_1208) {
    let x_1213 : f32 = u_xlat1.y;
    x_1209 = x_1213;
  } else {
    let x_1216 : f32 = u_xlat2.y;
    x_1209 = x_1216;
  }
  let x_1217 : f32 = x_1209;
  SV_Target0.y = x_1217;
  let x_1220 : bool = u_xlatb0.z;
  if (x_1220) {
