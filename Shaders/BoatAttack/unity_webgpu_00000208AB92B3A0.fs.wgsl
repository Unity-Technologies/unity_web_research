...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1203.x, x_1203.y, x_1203.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1206 : vec4<f32> = u_xlat0;
  let x_1209 : vec3<f32> = log2(abs(vec3<f32>(x_1206.x, x_1206.y, x_1206.z)));
  let x_1210 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1209.x, x_1209.y, x_1209.z, x_1210.w);
  let x_1212 : vec4<f32> = u_xlat2;
  let x_1214 : vec3<f32> = (vec3<f32>(x_1212.x, x_1212.y, x_1212.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1215 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1214.x, x_1214.y, x_1214.z, x_1215.w);
  let x_1217 : vec4<f32> = u_xlat2;
  let x_1219 : vec3<f32> = exp2(vec3<f32>(x_1217.x, x_1217.y, x_1217.z));
  let x_1220 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1219.x, x_1219.y, x_1219.z, x_1220.w);
  let x_1222 : vec4<f32> = u_xlat2;
  let x_1225 : vec3<f32> = ((vec3<f32>(x_1222.x, x_1222.y, x_1222.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1226 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1225.x, x_1225.y, x_1225.z, x_1226.w);
  let x_1228 : vec4<f32> = u_xlat0;
  let x_1230 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1228.x, x_1228.y, x_1228.z, x_1228.x));
  u_xlatb0 = vec3<bool>(x_1230.x, x_1230.y, x_1230.z);
  ...
  u_xlat0.x = x_1242;
  let x_1245 : bool = u_xlatb0.y;
  if (x_1245) {
    let x_1250 : f32 = u_xlat1.y;
    x_1246 = x_1250;
  } else {
    let x_1253 : f32 = u_xlat2.y;
    x_1246 = x_1253;
  }
  let x_1254 : f32 = x_1246;
  u_xlat0.y = x_1254;
  let x_1257 : bool = u_xlatb0.z;
  if (x_1257) {
    let x_1262 : f32 = u_xlat1.z;
    x_1258 = x_1262;
  } else {
  ...
  let x_1271 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1275 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1277 : vec2<f32> = ((x_1268 * vec2<f32>(x_1271.x, x_1271.y)) + vec2<f32>(x_1275.z, x_1275.w));
  let x_1278 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1277.x, x_1277.y, x_1278.z);
  let x_1285 : vec3<f32> = u_xlat1;
  let x_1288 : f32 = x_25.x_GlobalMipBias.x;
  let x_1289 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1285.x, x_1285.y), x_1288);
  u_xlat18 = x_1289.w;
  let x_1291 : f32 = u_xlat18;
  u_xlat18 = ((x_1291 * 2.0f) + -1.0f);
  let x_1294 : f32 = u_xlat18;
  u_xlatb1.x = (x_1294 >= 0.0f);
  let x_1298 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1298);
  let x_1301 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1301)) + 1.0f);
  let x_1305 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1305);
  let x_1307 : f32 = u_xlat18;
  u_xlat18 = (-(x_1307) + 1.0f);
  let x_1310 : f32 = u_xlat18;
  let x_1312 : f32 = u_xlat1.x;
  u_xlat18 = (x_1310 * x_1312);
  let x_1314 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1314.x, x_1314.y, x_1314.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1325 : vec3<f32> = (vec3<f32>(x_1323.x, x_1323.y, x_1323.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1336 : vec3<f32> = ((vec3<f32>(x_1333.x, x_1333.y, x_1333.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1337 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1336.x, x_1336.y, x_1336.z, x_1337.w);
  let x_1339 : vec4<f32> = u_xlat0;
  let x_1341 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1339.x, x_1339.y, x_1339.z, x_1339.x));
  ...
  u_xlat0.z = x_1377;
  let x_1379 : f32 = u_xlat18;
  let x_1384 : vec4<f32> = u_xlat0;
  let x_1386 : vec3<f32> = ((vec3<f32>(x_1379, x_1379, x_1379) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1384.x, x_1384.y, x_1384.z));
  let x_1387 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1386.x, x_1386.y, x_1386.z, x_1387.w);
  let x_1389 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1389.x, x_1389.y, x_1389.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1392 : vec4<f32> = u_xlat0;
  let x_1394 : vec3<f32> = (vec3<f32>(x_1392.x, x_1392.y, x_1392.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1395 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1394.x, x_1394.y, x_1394.z, x_1395.w);
  let x_1397 : vec4<f32> = u_xlat2;
  let x_1399 : vec3<f32> = (vec3<f32>(x_1397.x, x_1397.y, x_1397.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1400 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1399.x, x_1399.y, x_1399.z, x_1400.w);
  let x_1402 : vec4<f32> = u_xlat2;
  let x_1405 : vec3<f32> = log2(abs(vec3<f32>(x_1402.x, x_1402.y, x_1402.z)));
  let x_1406 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1405.x, x_1405.y, x_1405.z, x_1406.w);
  let x_1408 : vec4<f32> = u_xlat2;
  let x_1410 : vec3<f32> = (vec3<f32>(x_1408.x, x_1408.y, x_1408.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1420 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1418.x, x_1418.y, x_1418.z, x_1418.x));
  ...
  let x_1462 : vec3<f32> = max(vec3<f32>(x_1460.x, x_1460.y, x_1460.z), vec3<f32>(0.0f, 0.0f, 0.0f));
