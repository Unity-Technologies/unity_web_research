...
;
    ...
    u_xlatb3.x = u_xlatb25 || u_xlatb3.x;
    u_xlat67 = (u_xlatb3.x) ? 1.0 : u_xlat67;
    ...
    u_xlati47 = int(uint(u_xlati47) ^ u_xlatu5.y);
    ...
    u_xlati47 = int(u_xlatu69 ^ u_xlatu47);
    u_xlati47 = u_xlati47 * 32769;
    u_xlati47 = int(uint(u_xlati47) ^ u_xlatu5.x);
    u_xlatu47 = uint(u_xlati47) * 1025u;
    u_xlatu69 = u_xlatu47 >> (6u & uint(0x1F));
    u_xlati47 = int(u_xlatu69 ^ u_xlatu47);
    u_xlatu47 = uint(u_xlati47) * 9u;
    ...
    u_xlat5.xyz = u_xlat22.xyz * u_xlat47.xxx;
    ...
    u_xlat44.x = u_xlat5.y * u_xlat5.y;
    u_xlat44.x = u_xlat5.x * u_xlat5.x + (-u_xlat44.x);
    u_xlat30.xyz = unity_SHC.xyz * u_xlat44.xxx + u_xlat10.xyz;
    u_xlat6.xyz = u_xlat6.xyz + u_xlat30.xyz;
    u_xlat6.xyz = max(u_xlat6.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat44.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat9.xy = u_xlat44.xy * hlslcc_FragCoord.xy;
    u_xlat44.x = u_xlat9.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat9.z = (-u_xlat44.x) + 1.0;
    u_xlat8.x = u_xlat8.x;
    ...
    u_xlat47.x = u_xlat66 * u_xlat66;
    u_xlat69 = u_xlat8.x + 0.0400000215;
    u_xlat69 = min(u_xlat69, 1.0);
    u_xlat70 = u_xlat66 * 4.0 + 2.0;
    u_xlat71 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat9.xz, _GlobalMipBias.x).x;
    u_xlat72 = u_xlat71 + -1.0;
    u_xlat72 = _AmbientOcclusionParam.w * u_xlat72 + 1.0;
    u_xlat71 = min(u_xlat71, vs_INTERP4.w);
    if(u_xlatb0){
        ...
        if(u_xlatb0){
            ...
            if(u_xlatb73){
                ...
                u_xlat0.x = u_xlat73 * u_xlat30.x + u_xlat8.x;
            } else {
                u_xlat8.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat8.xy = floor(u_xlat8.xy);
                u_xlat52.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat8.xy);
                ...
                u_xlat0.x = u_xlat9.w * u_xlat8.x + u_xlat73;
            }
        }
    } else {
    ...
    u_xlat8.xyz = u_xlat5.xyz * (-vec3(u_xlat68)) + (-u_xlat4.xyz);
    u_xlat68 = dot(u_xlat5.xyz, u_xlat4.xyz);
    u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
    u_xlat68 = (-u_xlat68) + 1.0;
    u_xlat68 = u_xlat68 * u_xlat68;
    u_xlat68 = u_xlat68 * u_xlat68;
    u_xlat3.x = (-u_xlat44.x) * 0.699999988 + 1.70000005;
    u_xlat44.x = u_xlat44.x * u_xlat3.x;
    ...
    u_xlat3.x = u_xlat69 + -0.0399999991;
    u_xlat68 = u_xlat68 * u_xlat3.x + 0.0399999991;
    ...
    u_xlat66 = dot(u_xlat5.xyz, _MainLightPosition.xyz);
    ...
    u_xlat0.x = u_xlat47.x / u_xlat0.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat68 = dot(unity_LightIndices[int(u_xlatu68)], uintBitsToFloat(ImmCB_0[u_xlati73]));
        u_xlatu68 =  uint(int(u_xlat68));
        u_xlat9.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu68)].www + _AdditionalLightsPosition[int(u_xlatu68)].xyz;
        ...
        u_xlat73 = u_xlat73 * _AdditionalLightsAttenuation[int(u_xlatu68)].x;
        u_xlat73 = (-u_xlat73) * u_xlat73 + 1.0;
        u_xlat73 = max(u_xlat73, 0.0);
        u_xlat73 = u_xlat73 * u_xlat73;
        u_xlat73 = u_xlat73 * u_xlat75;
        u_xlat75 = dot(_AdditionalLightsSpotDir[int(u_xlatu68)].xyz, u_xlat10.xyz);
        u_xlat75 = u_xlat75 * _AdditionalLightsAttenuation[int(u_xlatu68)].z + _AdditionalLightsAttenuation[int(u_xlatu68)].w;
        u_xlat75 = clamp(u_xlat75, 0.0, 1.0);
        u_xlat75 = u_xlat75 * u_xlat75;
        u_xlat73 = u_xlat73 * u_xlat75;
        u_xlatu75 = u_xlatu68 >> (5u & uint(0x1F));
        u_xlati76 = 1 << (int(u_xlatu68) & int(0x1F));
        u_xlati75 = int(uint(u_xlati76) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu75)]));
        if(u_xlati75 != 0) {
            u_xlati75 = int(_AdditionalLightsLightTypes[int(u_xlatu68)]);
            ...
            if(u_xlati76 != 0) {
                ...
                u_xlat33.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].xy * u_xlat33.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].zw;
            } else {
                ...
                if(u_xlati75 != 0) {
                    ...
                    u_xlat33.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].zw;
                } else {
                    ...
                    u_xlat33.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].zw;
                }
            }
            ...
            u_xlat75 = (u_xlatb3.w) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat75);
        } else {
        ...
        u_xlat68 = u_xlat68 * u_xlat68;
        u_xlat68 = u_xlat68 * u_xlat44.x + 1.00001001;
        u_xlat73 = u_xlat73 * u_xlat73;
        u_xlat68 = u_xlat68 * u_xlat68;
        u_xlat73 = max(u_xlat73, 0.100000001);
        u_xlat68 = u_xlat68 * u_xlat73;
        u_xlat68 = u_xlat70 * u_xlat68;
        u_xlat68 = u_xlat47.x / u_xlat68;
        u_xlat9.xyz = vec3(u_xlat68) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat7.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xzw = u_xlat6.xyz * vec3(u_xlat71) + u_xlat2.xyz;
