...
fn main_1() {
  ...
  let x_1426 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1430 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_1444 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1440.x, x_1440.y), x_1443);
  u_xlat21 = x_1444.w;
  let x_1446 : f32 = u_xlat21;
  u_xlat21 = ((x_1446 * 2.0f) + -1.0f);
  let x_1449 : f32 = u_xlat21;
  u_xlatb1.x = (x_1449 >= 0.0f);
  let x_1453 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1453);
  let x_1456 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1456)) + 1.0f);
  let x_1460 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1460);
  let x_1462 : f32 = u_xlat21;
  u_xlat21 = (-(x_1462) + 1.0f);
  let x_1465 : f32 = u_xlat21;
  let x_1467 : f32 = u_xlat1.x;
  u_xlat21 = (x_1465 * x_1467);
  let x_1469 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1469.x, x_1469.y, x_1469.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  ...
  let x_1480 : vec3<f32> = (vec3<f32>(x_1478.x, x_1478.y, x_1478.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1491 : vec3<f32> = ((vec3<f32>(x_1488.x, x_1488.y, x_1488.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1492 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1491.x, x_1491.y, x_1491.z, x_1492.w);
  let x_1494 : vec4<f32> = u_xlat0;
  let x_1496 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1494.x, x_1494.y, x_1494.z, x_1494.x));
  u_xlatb0 = vec3<bool>(x_1496.x, x_1496.y, x_1496.z);
  let x_1499 : bool = u_xlatb0.x;
  if (x_1499) {
    let x_1504 : f32 = u_xlat1.x;
    x_1500 = x_1504;
  } else {
  ...
  u_xlat0.z = x_1532;
  let x_1534 : f32 = u_xlat21;
  let x_1539 : vec4<f32> = u_xlat0;
  let x_1541 : vec3<f32> = ((vec3<f32>(x_1534, x_1534, x_1534) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1539.x, x_1539.y, x_1539.z));
  let x_1542 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1541.x, x_1541.y, x_1541.z, x_1542.w);
  let x_1544 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1544.x, x_1544.y, x_1544.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1547 : vec4<f32> = u_xlat0;
  let x_1549 : vec3<f32> = (vec3<f32>(x_1547.x, x_1547.y, x_1547.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1550 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1549.x, x_1549.y, x_1549.z, x_1550.w);
  let x_1552 : vec4<f32> = u_xlat2;
  let x_1554 : vec3<f32> = (vec3<f32>(x_1552.x, x_1552.y, x_1552.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1555 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1554.x, x_1554.y, x_1554.z, x_1555.w);
  let x_1557 : vec4<f32> = u_xlat2;
  let x_1560 : vec3<f32> = log2(abs(vec3<f32>(x_1557.x, x_1557.y, x_1557.z)));
  let x_1561 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1560.x, x_1560.y, x_1560.z, x_1561.w);
  let x_1563 : vec4<f32> = u_xlat2;
  let x_1565 : vec3<f32> = (vec3<f32>(x_1563.x, x_1563.y, x_1563.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1575 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1573.x, x_1573.y, x_1573.z, x_1573.x));
  u_xlatb0 = vec3<bool>(x_1575.x, x_1575.y, x_1575.z);
  ...
  let x_1618 : vec3<f32> = max(vec3<f32>(x_1615.x, x_1615.y, x_1615.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1619 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1618.x, x_1618.y, x_1618.z, x_1619.w);
  SV_Target0.w = 1.0f;
  return;
}
