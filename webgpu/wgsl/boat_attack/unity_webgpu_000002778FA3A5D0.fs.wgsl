...
fn main_1() {
  ...
  let x_1306 : vec3<f32> = sqrt(vec3<f32>(x_1304.x, x_1304.y, x_1304.z));
  ...
  let x_1360 : vec3<f32> = log2(vec3<f32>(x_1358.x, x_1358.y, x_1358.z));
  let x_1361 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1360.x, x_1360.y, x_1360.z, x_1361.w);
  let x_1363 : vec4<f32> = u_xlat2;
  let x_1365 : vec3<f32> = (vec3<f32>(x_1363.x, x_1363.y, x_1363.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1376 : vec3<f32> = ((vec3<f32>(x_1373.x, x_1373.y, x_1373.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1377 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1376.x, x_1376.y, x_1376.z, x_1377.w);
  let x_1379 : vec4<f32> = u_xlat0;
  let x_1381 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1379.x, x_1379.y, x_1379.z, x_1379.x));
  ...
  u_xlat0.z = x_1417;
  let x_1419 : f32 = u_xlat21;
  let x_1424 : vec4<f32> = u_xlat0;
  let x_1426 : vec3<f32> = ((vec3<f32>(x_1419, x_1419, x_1419) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1424.x, x_1424.y, x_1424.z));
  let x_1427 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1426.x, x_1426.y, x_1426.z, x_1427.w);
  let x_1429 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1429.x, x_1429.y, x_1429.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1432 : vec4<f32> = u_xlat0;
  let x_1434 : vec3<f32> = (vec3<f32>(x_1432.x, x_1432.y, x_1432.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1435 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1434.x, x_1434.y, x_1434.z, x_1435.w);
  let x_1437 : vec4<f32> = u_xlat2;
  let x_1439 : vec3<f32> = (vec3<f32>(x_1437.x, x_1437.y, x_1437.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1440 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1439.x, x_1439.y, x_1439.z, x_1440.w);
  let x_1442 : vec4<f32> = u_xlat2;
  let x_1445 : vec3<f32> = log2(abs(vec3<f32>(x_1442.x, x_1442.y, x_1442.z)));
  let x_1446 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1445.x, x_1445.y, x_1445.z, x_1446.w);
  let x_1448 : vec4<f32> = u_xlat2;
  let x_1450 : vec3<f32> = (vec3<f32>(x_1448.x, x_1448.y, x_1448.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1460 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1458.x, x_1458.y, x_1458.z, x_1458.x));
  u_xlatb0 = vec3<bool>(x_1460.x, x_1460.y, x_1460.z);
  let x_1463 : bool = u_xlatb0.x;
  if (x_1463) {
    let x_1468 : f32 = u_xlat1.x;
    x_1464 = x_1468;
  } else {
    let x_1471 : f32 = u_xlat2.x;
    x_1464 = x_1471;
  }
  let x_1472 : f32 = x_1464;
  u_xlat0.x = x_1472;
  let x_1475 : bool = u_xlatb0.y;
  if (x_1475) {
    let x_1480 : f32 = u_xlat1.y;
    x_1476 = x_1480;
  } else {
    let x_1483 : f32 = u_xlat2.y;
    x_1476 = x_1483;
  }
  let x_1484 : f32 = x_1476;
  u_xlat0.y = x_1484;
  let x_1487 : bool = u_xlatb0.z;
  if (x_1487) {
    let x_1492 : f32 = u_xlat1.z;
    x_1488 = x_1492;
  } else {
  ...
  let x_1503 : vec3<f32> = max(vec3<f32>(x_1500.x, x_1500.y, x_1500.z), vec3<f32>(0.0f, 0.0f, 0.0f));
