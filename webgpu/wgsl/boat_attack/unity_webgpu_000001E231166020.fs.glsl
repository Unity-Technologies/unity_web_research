...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu40 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat3.x = dot(unity_LightIndices[int(u_xlatu3)], uintBitsToFloat(ImmCB_0[u_xlati63]));
        ...
        u_xlat63 = u_xlat63 * _AdditionalLightsAttenuation[u_xlati3].x;
        u_xlat63 = (-u_xlat63) * u_xlat63 + 1.0;
        u_xlat63 = max(u_xlat63, 0.0);
        u_xlat63 = u_xlat63 * u_xlat63;
        u_xlat63 = u_xlat63 * u_xlat65;
        u_xlat65 = dot(_AdditionalLightsSpotDir[u_xlati3].xyz, u_xlat10.xyz);
        u_xlat65 = u_xlat65 * _AdditionalLightsAttenuation[u_xlati3].z + _AdditionalLightsAttenuation[u_xlati3].w;
        u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat63 = u_xlat63 * u_xlat65;
        u_xlat11.xyz = vec3(u_xlat43) * _AdditionalLightsColor[u_xlati3].xyz;
        u_xlat3.x = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        u_xlat3.x = u_xlat3.x * u_xlat63;
        u_xlat11.xyz = u_xlat3.xxx * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat64) + u_xlat7.xyz;
        ...
        u_xlat63 = max(u_xlat3.w, 0.100000001);
        u_xlat3.x = u_xlat63 * u_xlat3.x;
        u_xlat3.x = u_xlat23 * u_xlat3.x;
        u_xlat3.x = u_xlat61 / u_xlat3.x;
        u_xlat9.xyz = u_xlat5.xyz * u_xlat3.xxx + u_xlat4.xyz;
