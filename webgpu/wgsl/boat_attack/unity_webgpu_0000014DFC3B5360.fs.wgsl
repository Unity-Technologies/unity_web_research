...
fn main_1() {
  ...
  let x_1398 : vec4<f32> = x_14.x_Grain_TilingParams;
  let x_1402 : vec4<f32> = x_14.x_Grain_TilingParams;
  ...
  let x_1416 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1412.x, x_1412.y), x_1415);
  u_xlat15 = x_1416.w;
  let x_1418 : f32 = u_xlat15;
  u_xlat15 = (x_1418 + -0.5f);
  let x_1420 : f32 = u_xlat15;
  let x_1421 : f32 = u_xlat15;
  u_xlat15 = (x_1420 + x_1421);
  let x_1423 : vec3<f32> = u_xlat0;
  u_xlat1.x = dot(x_1423, vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1431 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1431);
  let x_1436 : f32 = x_14.x_Grain_Params.y;
  let x_1438 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1436 * -(x_1438)) + 1.0f);
  let x_1443 : f32 = u_xlat15;
  let x_1445 : vec3<f32> = u_xlat0;
  u_xlat6 = (vec3<f32>(x_1443, x_1443, x_1443) * x_1445);
  let x_1447 : vec3<f32> = u_xlat6;
  let x_1450 : vec2<f32> = x_14.x_Grain_Params;
  u_xlat6 = (x_1447 * vec3<f32>(x_1450.x, x_1450.x, x_1450.x));
  let x_1453 : vec3<f32> = u_xlat6;
  let x_1454 : vec4<f32> = u_xlat1;
  let x_1457 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1453 * vec3<f32>(x_1454.x, x_1454.x, x_1454.x)) + x_1457);
  let x_1459 : vec3<f32> = u_xlat0;
  let x_1460 : vec3<f32> = (x_1459 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1461 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1460.x, x_1460.y, x_1460.z, x_1461.w);
  let x_1463 : vec3<f32> = u_xlat0;
  let x_1465 : vec3<f32> = log2(abs(x_1463));
  let x_1466 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1465.x, x_1465.y, x_1465.z, x_1466.w);
  let x_1468 : vec4<f32> = u_xlat2;
  let x_1470 : vec3<f32> = (vec3<f32>(x_1468.x, x_1468.y, x_1468.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1471 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1470.x, x_1470.y, x_1470.z, x_1471.w);
  let x_1473 : vec4<f32> = u_xlat2;
  let x_1475 : vec3<f32> = exp2(vec3<f32>(x_1473.x, x_1473.y, x_1473.z));
  let x_1476 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1475.x, x_1475.y, x_1475.z, x_1476.w);
  let x_1478 : vec4<f32> = u_xlat2;
  let x_1481 : vec3<f32> = ((vec3<f32>(x_1478.x, x_1478.y, x_1478.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1482 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1481.x, x_1481.y, x_1481.z, x_1482.w);
  let x_1484 : vec3<f32> = u_xlat0;
  let x_1486 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1484.x, x_1484.y, x_1484.z, x_1484.x));
  u_xlatb0 = vec3<bool>(x_1486.x, x_1486.y, x_1486.z);
  let x_1489 : bool = u_xlatb0.x;
  if (x_1489) {
    let x_1494 : f32 = u_xlat1.x;
    x_1490 = x_1494;
  } else {
    let x_1497 : f32 = u_xlat2.x;
    x_1490 = x_1497;
  }
  let x_1498 : f32 = x_1490;
  u_xlat0.x = x_1498;
  let x_1501 : bool = u_xlatb0.y;
  if (x_1501) {
    let x_1506 : f32 = u_xlat1.y;
    x_1502 = x_1506;
  } else {
    let x_1509 : f32 = u_xlat2.y;
    x_1502 = x_1509;
  }
  let x_1510 : f32 = x_1502;
  u_xlat0.y = x_1510;
  let x_1513 : bool = u_xlatb0.z;
  if (x_1513) {
    let x_1518 : f32 = u_xlat1.z;
    x_1514 = x_1518;
  } else {
  ...
  u_xlat0.z = x_1522;
  let x_1524 : vec2<f32> = vs_TEXCOORD0;
  let x_1527 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1531 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1533 : vec2<f32> = ((x_1524 * vec2<f32>(x_1527.x, x_1527.y)) + vec2<f32>(x_1531.z, x_1531.w));
  let x_1534 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1533.x, x_1533.y, x_1534.z, x_1534.w);
  let x_1541 : vec4<f32> = u_xlat1;
  let x_1544 : f32 = x_14.x_GlobalMipBias.x;
  let x_1545 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1541.x, x_1541.y), x_1544);
  u_xlat15 = x_1545.w;
  let x_1547 : f32 = u_xlat15;
  u_xlat15 = ((x_1547 * 2.0f) + -1.0f);
  let x_1550 : f32 = u_xlat15;
  u_xlatb1 = (x_1550 >= 0.0f);
  let x_1552 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1552);
  let x_1555 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1555)) + 1.0f);
  let x_1559 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1559);
  let x_1561 : f32 = u_xlat15;
  u_xlat15 = (-(x_1561) + 1.0f);
  let x_1564 : f32 = u_xlat15;
  let x_1566 : f32 = u_xlat1.x;
  u_xlat15 = (x_1564 * x_1566);
  let x_1568 : vec3<f32> = u_xlat0;
  let x_1569 : vec3<f32> = (x_1568 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1570 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1569.x, x_1569.y, x_1569.z, x_1570.w);
  let x_1572 : vec3<f32> = u_xlat0;
  let x_1574 : vec3<f32> = log2(abs(x_1572));
  let x_1575 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1574.x, x_1574.y, x_1574.z, x_1575.w);
  let x_1577 : vec4<f32> = u_xlat2;
  let x_1579 : vec3<f32> = (vec3<f32>(x_1577.x, x_1577.y, x_1577.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1590 : vec3<f32> = ((vec3<f32>(x_1587.x, x_1587.y, x_1587.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1591 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1590.x, x_1590.y, x_1590.z, x_1591.w);
  let x_1593 : vec3<f32> = u_xlat0;
  let x_1595 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1593.x, x_1593.y, x_1593.z, x_1593.x));
  u_xlatb0 = vec3<bool>(x_1595.x, x_1595.y, x_1595.z);
  let x_1598 : bool = u_xlatb0.x;
  if (x_1598) {
  ...
  let x_1607 : f32 = x_1599;
  u_xlat0.x = x_1607;
  let x_1610 : bool = u_xlatb0.y;
  if (x_1610) {
    let x_1615 : f32 = u_xlat1.y;
    x_1611 = x_1615;
  } else {
    let x_1618 : f32 = u_xlat2.y;
    x_1611 = x_1618;
  }
  let x_1619 : f32 = x_1611;
  u_xlat0.y = x_1619;
  let x_1622 : bool = u_xlatb0.z;
  if (x_1622) {
    let x_1627 : f32 = u_xlat1.z;
    x_1623 = x_1627;
  } else {
  ...
  u_xlat0.z = x_1631;
  let x_1633 : f32 = u_xlat15;
  let x_1638 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1633, x_1633, x_1633) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1638);
  let x_1640 : vec3<f32> = u_xlat0;
  let x_1641 : vec3<f32> = (x_1640 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1642 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1641.x, x_1641.y, x_1641.z, x_1642.w);
  let x_1644 : vec3<f32> = u_xlat0;
  let x_1645 : vec3<f32> = (x_1644 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1646 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1645.x, x_1645.y, x_1645.z, x_1646.w);
  let x_1648 : vec4<f32> = u_xlat2;
  let x_1650 : vec3<f32> = (vec3<f32>(x_1648.x, x_1648.y, x_1648.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1651 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1650.x, x_1650.y, x_1650.z, x_1651.w);
  let x_1653 : vec4<f32> = u_xlat2;
  let x_1656 : vec3<f32> = log2(abs(vec3<f32>(x_1653.x, x_1653.y, x_1653.z)));
  let x_1657 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1656.x, x_1656.y, x_1656.z, x_1657.w);
  let x_1659 : vec4<f32> = u_xlat2;
  let x_1661 : vec3<f32> = (vec3<f32>(x_1659.x, x_1659.y, x_1659.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1671 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1669.x, x_1669.y, x_1669.z, x_1669.x));
  u_xlatb0 = vec3<bool>(x_1671.x, x_1671.y, x_1671.z);
  let x_1674 : bool = u_xlatb0.x;
  if (x_1674) {
  ...
  u_xlat0.x = x_1683;
  let x_1686 : bool = u_xlatb0.y;
  if (x_1686) {
    let x_1691 : f32 = u_xlat1.y;
    x_1687 = x_1691;
  } else {
    let x_1694 : f32 = u_xlat2.y;
    x_1687 = x_1694;
  }
  let x_1695 : f32 = x_1687;
  u_xlat0.y = x_1695;
  let x_1698 : bool = u_xlatb0.z;
  if (x_1698) {
    let x_1703 : f32 = u_xlat1.z;
    x_1699 = x_1703;
  } else {
  ...
  let x_1712 : vec3<f32> = max(x_1711, vec3<f32>(0.0f, 0.0f, 0.0f));
