...
fn main_1() {
  ...
  u_xlat2 = (x_104 + vec3<f32>(-0.87253999710083007812f, 0.53136998414993286133f, -1.06861996650695800781f));
  let x_110 : vec3<f32> = u_xlat2;
  u_xlat0 = ((x_110 * vec3<f32>(0.30530601739883422852f, 0.30530601739883422852f, 0.30530601739883422852f)) + vec3<f32>(0.68217110633850097656f, 0.68217110633850097656f, 0.68217110633850097656f));
  let x_117 : vec3<f32> = u_xlat2;
  let x_118 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_117 * x_118) + vec3<f32>(0.01252287812530994415f, 0.01252287812530994415f, 0.01252287812530994415f));
  ...
  u_xlat0.x = (x_146 + -0.06274499744176864624f);
  let x_151 : f32 = u_xlat0.x;
  SV_Target0.w = (x_151 * 1.15625f);
  return;
}
