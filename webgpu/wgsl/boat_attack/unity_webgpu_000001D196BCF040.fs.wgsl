...
fn main_1() {
  ...
  let x_2098 : vec3<f32> = (vec3<f32>(x_2096.x, x_2096.y, x_2096.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2099 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2098.x, x_2098.y, x_2098.z, x_2099.w);
  let x_2101 : vec4<f32> = u_xlat0;
  let x_2104 : vec3<f32> = log2(abs(vec3<f32>(x_2101.x, x_2101.y, x_2101.z)));
  let x_2105 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2104.x, x_2104.y, x_2104.z, x_2105.w);
  let x_2107 : vec4<f32> = u_xlat2;
  let x_2109 : vec3<f32> = (vec3<f32>(x_2107.x, x_2107.y, x_2107.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2110 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2109.x, x_2109.y, x_2109.z, x_2110.w);
  let x_2112 : vec4<f32> = u_xlat2;
  let x_2114 : vec3<f32> = exp2(vec3<f32>(x_2112.x, x_2112.y, x_2112.z));
  let x_2115 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2114.x, x_2114.y, x_2114.z, x_2115.w);
  let x_2117 : vec4<f32> = u_xlat2;
  let x_2120 : vec3<f32> = ((vec3<f32>(x_2117.x, x_2117.y, x_2117.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2121 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2120.x, x_2120.y, x_2120.z, x_2121.w);
  let x_2123 : vec4<f32> = u_xlat0;
  let x_2125 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2123.x, x_2123.y, x_2123.z, x_2123.x));
  u_xlatb0 = vec3<bool>(x_2125.x, x_2125.y, x_2125.z);
  let x_2128 : bool = u_xlatb0.x;
  if (x_2128) {
    let x_2133 : f32 = u_xlat1.x;
    x_2129 = x_2133;
  } else {
    let x_2136 : f32 = u_xlat2.x;
    x_2129 = x_2136;
  }
  let x_2137 : f32 = x_2129;
  u_xlat0.x = x_2137;
  let x_2140 : bool = u_xlatb0.y;
  if (x_2140) {
    let x_2145 : f32 = u_xlat1.y;
    x_2141 = x_2145;
  } else {
    let x_2148 : f32 = u_xlat2.y;
    x_2141 = x_2148;
  }
  let x_2149 : f32 = x_2141;
  u_xlat0.y = x_2149;
  let x_2152 : bool = u_xlatb0.z;
  if (x_2152) {
    let x_2157 : f32 = u_xlat1.z;
    x_2153 = x_2157;
  } else {
    let x_2160 : f32 = u_xlat2.z;
    x_2153 = x_2160;
  }
  let x_2161 : f32 = x_2153;
  u_xlat0.z = x_2161;
  let x_2163 : vec2<f32> = vs_TEXCOORD0;
  let x_2166 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2170 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2172 : vec2<f32> = ((x_2163 * vec2<f32>(x_2166.x, x_2166.y)) + vec2<f32>(x_2170.z, x_2170.w));
  let x_2173 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2172.x, x_2172.y, x_2173.z, x_2173.w);
  let x_2180 : vec4<f32> = u_xlat1;
  let x_2183 : f32 = x_25.x_GlobalMipBias.x;
  let x_2184 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2180.x, x_2180.y), x_2183);
  u_xlat18 = x_2184.w;
  let x_2186 : f32 = u_xlat18;
  u_xlat18 = ((x_2186 * 2.0f) + -1.0f);
  let x_2189 : f32 = u_xlat18;
  u_xlatb1 = (x_2189 >= 0.0f);
  let x_2191 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2191);
  let x_2194 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2194)) + 1.0f);
  let x_2198 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2198);
  let x_2200 : f32 = u_xlat18;
  u_xlat18 = (-(x_2200) + 1.0f);
  let x_2203 : f32 = u_xlat18;
  let x_2205 : f32 = u_xlat1.x;
  u_xlat18 = (x_2203 * x_2205);
  let x_2207 : vec4<f32> = u_xlat0;
  let x_2209 : vec3<f32> = (vec3<f32>(x_2207.x, x_2207.y, x_2207.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2210 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2209.x, x_2209.y, x_2209.z, x_2210.w);
  let x_2212 : vec4<f32> = u_xlat0;
  let x_2215 : vec3<f32> = log2(abs(vec3<f32>(x_2212.x, x_2212.y, x_2212.z)));
  let x_2216 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2215.x, x_2215.y, x_2215.z, x_2216.w);
  let x_2218 : vec4<f32> = u_xlat2;
  let x_2220 : vec3<f32> = (vec3<f32>(x_2218.x, x_2218.y, x_2218.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2221 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2220.x, x_2220.y, x_2220.z, x_2221.w);
  let x_2223 : vec4<f32> = u_xlat2;
  let x_2225 : vec3<f32> = exp2(vec3<f32>(x_2223.x, x_2223.y, x_2223.z));
  let x_2226 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2225.x, x_2225.y, x_2225.z, x_2226.w);
  let x_2228 : vec4<f32> = u_xlat2;
  let x_2231 : vec3<f32> = ((vec3<f32>(x_2228.x, x_2228.y, x_2228.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2232 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2231.x, x_2231.y, x_2231.z, x_2232.w);
  let x_2234 : vec4<f32> = u_xlat0;
  let x_2236 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2234.x, x_2234.y, x_2234.z, x_2234.x));
  u_xlatb0 = vec3<bool>(x_2236.x, x_2236.y, x_2236.z);
  let x_2239 : bool = u_xlatb0.x;
  if (x_2239) {
    let x_2244 : f32 = u_xlat1.x;
    x_2240 = x_2244;
  } else {
    let x_2247 : f32 = u_xlat2.x;
    x_2240 = x_2247;
  }
  let x_2248 : f32 = x_2240;
  u_xlat0.x = x_2248;
  let x_2251 : bool = u_xlatb0.y;
  if (x_2251) {
    let x_2256 : f32 = u_xlat1.y;
    x_2252 = x_2256;
  } else {
    let x_2259 : f32 = u_xlat2.y;
    x_2252 = x_2259;
  }
  let x_2260 : f32 = x_2252;
  u_xlat0.y = x_2260;
  let x_2263 : bool = u_xlatb0.z;
  if (x_2263) {
    let x_2268 : f32 = u_xlat1.z;
    x_2264 = x_2268;
  } else {
  ...
  u_xlat0.z = x_2272;
  let x_2274 : f32 = u_xlat18;
  let x_2279 : vec4<f32> = u_xlat0;
  let x_2281 : vec3<f32> = ((vec3<f32>(x_2274, x_2274, x_2274) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2279.x, x_2279.y, x_2279.z));
  let x_2282 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2281.x, x_2281.y, x_2281.z, x_2282.w);
  let x_2284 : vec4<f32> = u_xlat0;
  let x_2286 : vec3<f32> = (vec3<f32>(x_2284.x, x_2284.y, x_2284.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2287 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2286.x, x_2286.y, x_2286.z, x_2287.w);
  let x_2289 : vec4<f32> = u_xlat0;
  let x_2291 : vec3<f32> = (vec3<f32>(x_2289.x, x_2289.y, x_2289.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2292 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2291.x, x_2291.y, x_2291.z, x_2292.w);
  let x_2294 : vec4<f32> = u_xlat2;
  let x_2296 : vec3<f32> = (vec3<f32>(x_2294.x, x_2294.y, x_2294.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2297 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2296.x, x_2296.y, x_2296.z, x_2297.w);
  let x_2299 : vec4<f32> = u_xlat2;
  let x_2302 : vec3<f32> = log2(abs(vec3<f32>(x_2299.x, x_2299.y, x_2299.z)));
  let x_2303 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2302.x, x_2302.y, x_2302.z, x_2303.w);
  let x_2305 : vec4<f32> = u_xlat2;
  let x_2307 : vec3<f32> = (vec3<f32>(x_2305.x, x_2305.y, x_2305.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2308 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2307.x, x_2307.y, x_2307.z, x_2308.w);
  let x_2310 : vec4<f32> = u_xlat2;
  let x_2312 : vec3<f32> = exp2(vec3<f32>(x_2310.x, x_2310.y, x_2310.z));
  let x_2313 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2312.x, x_2312.y, x_2312.z, x_2313.w);
  let x_2315 : vec4<f32> = u_xlat0;
  let x_2317 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2315.x, x_2315.y, x_2315.z, x_2315.x));
  ...
  let x_2359 : vec3<f32> = max(vec3<f32>(x_2357.x, x_2357.y, x_2357.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2360 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2359.x, x_2359.y, x_2359.z, x_2360.w);
  SV_Target0.w = 1.0f;
  return;
}
