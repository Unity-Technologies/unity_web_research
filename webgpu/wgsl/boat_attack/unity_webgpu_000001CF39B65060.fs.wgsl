...
fn main_1() {
  ...
  let x_1758 : vec3<f32> = sqrt(vec3<f32>(x_1756.x, x_1756.y, x_1756.z));
  let x_1759 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1758.x, x_1758.y, x_1758.z, x_1759.w);
  let x_1761 : vec2<f32> = vs_TEXCOORD0;
  let x_1764 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1768 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1770 : vec2<f32> = ((x_1761 * vec2<f32>(x_1764.x, x_1764.y)) + vec2<f32>(x_1768.z, x_1768.w));
  let x_1771 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1770.x, x_1770.y, x_1771.z, x_1771.w);
  let x_1778 : vec4<f32> = u_xlat1;
  let x_1781 : f32 = x_38.x_GlobalMipBias.x;
  let x_1782 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1778.x, x_1778.y), x_1781);
  u_xlat18 = x_1782.w;
  let x_1784 : f32 = u_xlat18;
  u_xlat18 = ((x_1784 * 2.0f) + -1.0f);
  let x_1787 : f32 = u_xlat18;
  u_xlatb1 = (x_1787 >= 0.0f);
  let x_1789 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1789);
  let x_1792 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1792)) + 1.0f);
  let x_1796 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1796);
  let x_1798 : f32 = u_xlat18;
  u_xlat18 = (-(x_1798) + 1.0f);
  let x_1801 : f32 = u_xlat18;
  let x_1803 : f32 = u_xlat1.x;
  u_xlat18 = (x_1801 * x_1803);
  let x_1805 : vec4<f32> = u_xlat0;
  let x_1807 : vec3<f32> = (vec3<f32>(x_1805.x, x_1805.y, x_1805.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1808 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1807.x, x_1807.y, x_1807.z, x_1808.w);
  let x_1810 : vec4<f32> = u_xlat0;
  let x_1812 : vec3<f32> = log2(vec3<f32>(x_1810.x, x_1810.y, x_1810.z));
  let x_1813 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1812.x, x_1812.y, x_1812.z, x_1813.w);
  let x_1815 : vec4<f32> = u_xlat2;
  let x_1817 : vec3<f32> = (vec3<f32>(x_1815.x, x_1815.y, x_1815.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1818 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1817.x, x_1817.y, x_1817.z, x_1818.w);
  let x_1820 : vec4<f32> = u_xlat2;
  let x_1822 : vec3<f32> = exp2(vec3<f32>(x_1820.x, x_1820.y, x_1820.z));
  let x_1823 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1822.x, x_1822.y, x_1822.z, x_1823.w);
  let x_1825 : vec4<f32> = u_xlat2;
  let x_1828 : vec3<f32> = ((vec3<f32>(x_1825.x, x_1825.y, x_1825.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1829 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1828.x, x_1828.y, x_1828.z, x_1829.w);
  let x_1831 : vec4<f32> = u_xlat0;
  let x_1833 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1831.x, x_1831.y, x_1831.z, x_1831.x));
  u_xlatb0 = vec3<bool>(x_1833.x, x_1833.y, x_1833.z);
  let x_1836 : bool = u_xlatb0.x;
  if (x_1836) {
    let x_1841 : f32 = u_xlat1.x;
    x_1837 = x_1841;
  } else {
    let x_1844 : f32 = u_xlat2.x;
    x_1837 = x_1844;
  }
  let x_1845 : f32 = x_1837;
  u_xlat0.x = x_1845;
  let x_1848 : bool = u_xlatb0.y;
  if (x_1848) {
    let x_1853 : f32 = u_xlat1.y;
    x_1849 = x_1853;
  } else {
    let x_1856 : f32 = u_xlat2.y;
    x_1849 = x_1856;
  }
  let x_1857 : f32 = x_1849;
  u_xlat0.y = x_1857;
  let x_1860 : bool = u_xlatb0.z;
  if (x_1860) {
    let x_1865 : f32 = u_xlat1.z;
    x_1861 = x_1865;
  } else {
    let x_1868 : f32 = u_xlat2.z;
    x_1861 = x_1868;
  }
  let x_1869 : f32 = x_1861;
  u_xlat0.z = x_1869;
  let x_1871 : f32 = u_xlat18;
  let x_1876 : vec4<f32> = u_xlat0;
  let x_1878 : vec3<f32> = ((vec3<f32>(x_1871, x_1871, x_1871) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1876.x, x_1876.y, x_1876.z));
  let x_1879 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1878.x, x_1878.y, x_1878.z, x_1879.w);
  let x_1881 : vec4<f32> = u_xlat0;
  let x_1883 : vec3<f32> = (vec3<f32>(x_1881.x, x_1881.y, x_1881.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1884 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1883.x, x_1883.y, x_1883.z, x_1884.w);
  let x_1886 : vec4<f32> = u_xlat0;
  let x_1888 : vec3<f32> = (vec3<f32>(x_1886.x, x_1886.y, x_1886.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1889 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1888.x, x_1888.y, x_1888.z, x_1889.w);
  let x_1891 : vec4<f32> = u_xlat2;
  let x_1893 : vec3<f32> = (vec3<f32>(x_1891.x, x_1891.y, x_1891.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1894 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1893.x, x_1893.y, x_1893.z, x_1894.w);
  let x_1896 : vec4<f32> = u_xlat2;
  let x_1899 : vec3<f32> = log2(abs(vec3<f32>(x_1896.x, x_1896.y, x_1896.z)));
  let x_1900 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1899.x, x_1899.y, x_1899.z, x_1900.w);
  let x_1902 : vec4<f32> = u_xlat2;
  let x_1904 : vec3<f32> = (vec3<f32>(x_1902.x, x_1902.y, x_1902.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1905 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1904.x, x_1904.y, x_1904.z, x_1905.w);
  let x_1907 : vec4<f32> = u_xlat2;
  let x_1909 : vec3<f32> = exp2(vec3<f32>(x_1907.x, x_1907.y, x_1907.z));
  let x_1910 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1909.x, x_1909.y, x_1909.z, x_1910.w);
  let x_1912 : vec4<f32> = u_xlat0;
  let x_1914 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1912.x, x_1912.y, x_1912.z, x_1912.x));
  ...
  let x_1956 : vec3<f32> = max(vec3<f32>(x_1954.x, x_1954.y, x_1954.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1957 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1956.x, x_1956.y, x_1956.z, x_1957.w);
  SV_Target0.w = 1.0f;
  return;
}
