...
fn main_1() {
  ...
  let x_2127 : vec3<f32> = u_xlat8;
  let x_2128 : vec4<f32> = u_xlat1;
  let x_2131 : vec4<f32> = u_xlat0;
  let x_2133 : vec3<f32> = ((x_2127 * vec3<f32>(x_2128.x, x_2128.x, x_2128.x)) + vec3<f32>(x_2131.x, x_2131.y, x_2131.z));
  let x_2134 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2133.x, x_2133.y, x_2133.z, x_2134.w);
  SV_Target0.w = 1.0f;
  return;
}
