...
void main()
{
    ...
    u_xlat1.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP0.xy, _GlobalMipBias.x).xyz;
    ...
    u_xlat29.x = min(u_xlat7.x, 1.0);
    u_xlatb54.x = 0.0<_MainLightShadowParams.y;
    if(u_xlatb54.x){
        u_xlatb54.x = _MainLightShadowParams.y==1.0;
        if(u_xlatb54.x){
            ...
            u_xlat54 = dot(u_xlat7, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb79){
                ...
                u_xlat54 = u_xlat79 * u_xlat6.x + u_xlat80;
            } else {
                u_xlat6.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat6.xy = floor(u_xlat6.xy);
                u_xlat56.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                ...
                u_xlat54 = u_xlat7.w * u_xlat80 + u_xlat79;
            }
        }
    } else {
    ...
    u_xlat6.x = (-u_xlat54) + 1.0;
    u_xlat54 = u_xlat80 * u_xlat6.x + u_xlat54;
    u_xlatb80 = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb80){
        ...
        u_xlat80 = (u_xlatb7.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb7.x) ? u_xlat6.xyz : vec3(u_xlat80);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat80 = dot((-u_xlat5.xyz), u_xlat25.xyz);
    u_xlat80 = u_xlat80 + u_xlat80;
    u_xlat7.xyz = u_xlat25.xyz * (-vec3(u_xlat80)) + (-u_xlat5.xyz);
    u_xlat80 = dot(u_xlat25.xyz, u_xlat5.xyz);
    u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
    ...
    u_xlat33.xyz = vec3(u_xlat80) * u_xlat33.xyz + u_xlat2.xyz;
    ...
    u_xlat0.x = u_xlat54 * unity_LightData.z;
    ...
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
    u_xlatb54.xy = equal(vec4(vec4(_AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat)), vec4(0.0, 1.0, 0.0, 1.0)).xy;
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat33.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati80].www + _AdditionalLightsPosition[u_xlati80].xyz;
        ...
        u_xlati10 = 1 << (u_xlati80 & int(0x1F));
        u_xlati10 = int(uint(u_xlati10) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati10 != 0) {
            u_xlati10 = int(_AdditionalLightsLightTypes[u_xlati80]);
            u_xlati35 = (u_xlati10 != 0) ? 0 : 1;
            u_xlati60 = u_xlati80 << (2 & int(0x1F));
            if(u_xlati35 != 0) {
                ...
                u_xlat35.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati80].xy * u_xlat35.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati80].zw;
            } else {
                ...
                if(u_xlati10 != 0) {
                    ...
                    u_xlat35.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati80].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati80].zw;
                } else {
                    ...
                    u_xlat35.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati80].xy * u_xlat10.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati80].zw;
                }
            }
            u_xlat10 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat35.xz, 0.0);
            u_xlat85 = (u_xlatb54.y) ? u_xlat10.w : u_xlat10.x;
            u_xlat10.xyz = (u_xlatb54.x) ? u_xlat10.xyz : vec3(u_xlat85);
        } else {
            u_xlat10.x = float(1.0);
            u_xlat10.y = float(1.0);
            u_xlat10.z = float(1.0);
        }
        u_xlat10.xyz = u_xlat10.xyz * _AdditionalLightsColor[u_xlati80].xyz;
        u_xlat80 = u_xlat81 * u_xlat84;
        u_xlat81 = dot(u_xlat25.xyz, u_xlat9.xyz);
        u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
        u_xlat80 = u_xlat80 * u_xlat81;
        u_xlat10.xyz = vec3(u_xlat80) * u_xlat10.xyz;
        ...
        u_xlat80 = dot(u_xlat25.xyz, u_xlat33.xyz);
        u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
        ...
        u_xlat33.xyz = u_xlat2.xyz * vec3(u_xlat80) + u_xlat3.xyz;
        u_xlat7.xyz = u_xlat33.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat1.xyz * u_xlat29.xxx + u_xlat6.xyz;
