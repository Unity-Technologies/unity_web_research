...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat22.xyz = unity_SHC.xyz * vec3(u_xlat59) + u_xlat6.xyz;
    u_xlat22.xyz = u_xlat22.xyz + u_xlat4.xyz;
    u_xlat22.xyz = max(u_xlat22.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat4.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat4.xy = u_xlat4.xy * hlslcc_FragCoord.xy;
    u_xlat59 = u_xlat4.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat4.z = (-u_xlat59) + 1.0;
    u_xlat59 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat4.xz, _GlobalMipBias.x).x;
    ...
    u_xlat59 = u_xlat23.x * unity_LightData.z;
    u_xlat23.xyz = vec3(u_xlat59) * u_xlat5.xyz;
    u_xlat59 = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat59 = clamp(u_xlat59, 0.0, 1.0);
    u_xlat5.xyz = vec3(u_xlat59) * u_xlat23.xyz;
    ...
    u_xlat19.xyz = u_xlat22.xyz * u_xlat0.yzw + u_xlat23.xyz;
