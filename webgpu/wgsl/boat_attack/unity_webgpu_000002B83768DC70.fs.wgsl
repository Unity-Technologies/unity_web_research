...
fn main_1() {
  ...
  SV_Target0.x = x_1901;
  let x_1905 : bool = u_xlatb0.y;
  if (x_1905) {
    let x_1910 : f32 = u_xlat1.y;
    x_1906 = x_1910;
  } else {
    let x_1913 : f32 = u_xlat2.y;
    x_1906 = x_1913;
  }
  let x_1914 : f32 = x_1906;
  SV_Target0.y = x_1914;
  let x_1917 : bool = u_xlatb0.z;
  if (x_1917) {
    let x_1922 : f32 = u_xlat1.z;
    x_1918 = x_1922;
  } else {
    let x_1925 : f32 = u_xlat2.z;
    x_1918 = x_1925;
  }
