...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat27.xyz = vec3(u_xlat71) * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu5 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat29.x = dot(unity_LightIndices[int(u_xlatu29)], uintBitsToFloat(ImmCB_0[u_xlati52]));
        u_xlati29 = int(u_xlat29.x);
        u_xlat7.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati29].www + _AdditionalLightsPosition[u_xlati29].xyz;
        u_xlat52.x = dot(u_xlat7.xyz, u_xlat7.xyz);
        u_xlat52.x = max(u_xlat52.x, 6.10351562e-05);
        u_xlat75 = inversesqrt(u_xlat52.x);
        u_xlat7.xyz = vec3(u_xlat75) * u_xlat7.xyz;
        u_xlat75 = float(1.0) / float(u_xlat52.x);
        u_xlat52.x = u_xlat52.x * _AdditionalLightsAttenuation[u_xlati29].x;
        u_xlat52.x = (-u_xlat52.x) * u_xlat52.x + 1.0;
        u_xlat52.x = max(u_xlat52.x, 0.0);
        u_xlat52.x = u_xlat52.x * u_xlat52.x;
        u_xlat52.x = u_xlat52.x * u_xlat75;
        u_xlat75 = dot(_AdditionalLightsSpotDir[u_xlati29].xyz, u_xlat7.xyz);
        u_xlat75 = u_xlat75 * _AdditionalLightsAttenuation[u_xlati29].z + _AdditionalLightsAttenuation[u_xlati29].w;
        u_xlat75 = clamp(u_xlat75, 0.0, 1.0);
        u_xlat75 = u_xlat75 * u_xlat75;
        u_xlat52.x = u_xlat75 * u_xlat52.x;
        u_xlati75 = int(_AdditionalShadowParams[u_xlati29].w);
        u_xlatb76 = u_xlati75>=0;
        if(u_xlatb76){
            u_xlatb76 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati29].z);
            if(u_xlatb76){
                ...
                u_xlat31 = (u_xlatb8.z) ? u_xlat8.y : u_xlat77;
                u_xlat76 = (u_xlatb76) ? u_xlat8.x : u_xlat31;
                u_xlat8.x = trunc(_AdditionalShadowParams[u_xlati29].w);
            ...
            u_xlatb75 = 0.0<_AdditionalShadowParams[u_xlati29].y;
            if(u_xlatb75){
                u_xlatb75 = 1.0==_AdditionalShadowParams[u_xlati29].y;
                if(u_xlatb75){
                    ...
                    u_xlatb76 = 2.0==_AdditionalShadowParams[u_xlati29].y;
                    if(u_xlatb76){
            ...
            u_xlat76 = 1.0 + (-_AdditionalShadowParams[u_xlati29].x);
            u_xlat75 = u_xlat75 * _AdditionalShadowParams[u_xlati29].x + u_xlat76;
        ...
        u_xlat75 = u_xlat4.x * u_xlat76 + u_xlat75;
        u_xlat52.x = u_xlat75 * u_xlat52.x;
        u_xlat29.xyz = u_xlat52.xxx * _AdditionalLightsColor[u_xlati29].xyz;
        u_xlat76 = dot(u_xlat2.xyz, u_xlat7.xyz);
        u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
        u_xlat8.xyz = u_xlat29.xyz * vec3(u_xlat76);
