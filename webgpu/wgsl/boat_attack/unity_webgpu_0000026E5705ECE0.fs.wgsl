...
fn main_1() {
  ...
  let x_201 : vec4<f32> = x_190.unity_FogColor;
  u_xlat0 = ((vec3<f32>(x_195.x, x_195.y, x_195.z) * x_197) + -(vec3<f32>(x_201.x, x_201.y, x_201.z)));
  let x_208 : f32 = u_xlat1.w;
  SV_Target0.w = x_208;
  let x_212 : f32 = vs_TEXCOORD3.w;
  let x_214 : f32 = vs_TEXCOORD3.w;
  u_xlat9 = (x_212 * -(x_214));
  let x_217 : f32 = u_xlat9;
  u_xlat9 = exp2(x_217);
  let x_219 : f32 = u_xlat9;
  let x_221 : vec3<f32> = u_xlat0;
  let x_224 : vec4<f32> = x_190.unity_FogColor;
  let x_226 : vec3<f32> = ((vec3<f32>(x_219, x_219, x_219) * x_221) + vec3<f32>(x_224.x, x_224.y, x_224.z));
  let x_227 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_226.x, x_226.y, x_226.z, x_227.w);
  return;
}
