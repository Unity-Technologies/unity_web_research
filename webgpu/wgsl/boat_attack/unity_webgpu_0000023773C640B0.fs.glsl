...
void main()
{
    ...
    u_xlat1.x = (u_xlatb38) ? u_xlat1.x : u_xlat13.x;
    u_xlat36 = u_xlat36 * 2.0 + (-u_xlat1.x);
    u_xlat1.x = u_xlat36 * u_xlat3.w;
    u_xlatb13.x = u_xlat1.x>=0.400000006;
    u_xlat13.x = u_xlatb13.x ? u_xlat1.x : float(0.0);
    u_xlat36 = u_xlat3.w * u_xlat36 + -0.400000006;
    u_xlat25.x = dFdxCoarse(u_xlat1.x);
    u_xlat1.x = dFdyCoarse(u_xlat1.x);
    u_xlat1.x = abs(u_xlat1.x) + abs(u_xlat25.x);
    u_xlat1.x = max(u_xlat1.x, 9.99999975e-05);
    u_xlat36 = u_xlat36 / u_xlat1.x;
    u_xlat36 = u_xlat36 + 0.5;
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    u_xlatb1 = _AlphaToMaskAvailable!=0.0;
    u_xlat36 = (u_xlatb1) ? u_xlat36 : u_xlat13.x;
    ...
    u_xlat25.x = u_xlat25.x * u_xlat13.x + 1.00001001;
    u_xlat25.x = u_xlat25.x * u_xlat25.x;
    u_xlat37 = max(u_xlat25.y, 0.100000001);
    u_xlat25.x = u_xlat37 * u_xlat25.x;
    u_xlat25.x = u_xlat40 * u_xlat25.x;
    u_xlat25.x = u_xlat38 / u_xlat25.x;
    u_xlat7.xyz = u_xlat25.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
    ...
    u_xlat13.xyz = u_xlat17.xyz * u_xlat5.xxx + u_xlat18.xyz;
    u_xlat13.xyz = u_xlat7.xyz + u_xlat13.xyz;
    SV_Target0.xyz = vs_INTERP6.www * u_xlat0.xyz + u_xlat13.xyz;
    SV_Target0.w = (u_xlatb1) ? u_xlat36 : 1.0;
    return;
}
