...
void main()
{
    ...
    u_xlat45 = dot(u_xlat1.xyw, u_xlat4.xyz);
    ...
    u_xlat6.xyz = vec3(u_xlat45) * u_xlat0.xyz;
    ...
    u_xlat49 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec0, 0.0);
    u_xlat50 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat49 = u_xlat49 * _MainLightShadowParams.x + u_xlat50;
    u_xlatb50 = 0.0>=vs_INTERP3.z;
    u_xlatb51 = vs_INTERP3.z>=1.0;
    ...
    u_xlat51 = u_xlat50 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat51 = clamp(u_xlat51, 0.0, 1.0);
    u_xlat7.x = (-u_xlat49) + 1.0;
    u_xlat49 = u_xlat51 * u_xlat7.x + u_xlat49;
    ...
    if(u_xlatb51){
        ...
        u_xlat51 = (u_xlatb8.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb8.x) ? u_xlat7.xyz : vec3(u_xlat51);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat8.xyz = u_xlat1.xyw * (-vec3(u_xlat51)) + (-u_xlat5.xyz);
    ...
    u_xlat47 = u_xlat50 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat47 = clamp(u_xlat47, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu45 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati49].www + _AdditionalLightsPosition[u_xlati49].xyz;
        ...
        if(u_xlati38 != 0) {
            ...
            u_xlati55 = u_xlati49 << (2 & int(0x1F));
            if(u_xlati53 != 0) {
                u_xlat12.xyz = vs_INTERP7.yyy * _AdditionalLightsWorldToLights[(u_xlati55 + 1) / 4][(u_xlati55 + 1) % 4].xyw;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[u_xlati55 / 4][u_xlati55 % 4].xyw * vs_INTERP7.xxx + u_xlat12.xyz;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[(u_xlati55 + 2) / 4][(u_xlati55 + 2) % 4].xyw * vs_INTERP7.zzz + u_xlat12.xyz;
                ...
                if(u_xlati38 != 0) {
                    u_xlat38.xy = vs_INTERP7.yy * _AdditionalLightsWorldToLights[(u_xlati55 + 1) / 4][(u_xlati55 + 1) % 4].xy;
                    u_xlat38.xy = _AdditionalLightsWorldToLights[u_xlati55 / 4][u_xlati55 % 4].xy * vs_INTERP7.xx + u_xlat38.xy;
                    u_xlat38.xy = _AdditionalLightsWorldToLights[(u_xlati55 + 2) / 4][(u_xlati55 + 2) % 4].xy * vs_INTERP7.zz + u_xlat38.xy;
                    ...
                    u_xlat13 = vs_INTERP7.yyyy * _AdditionalLightsWorldToLights[(u_xlati55 + 1) / 4][(u_xlati55 + 1) % 4];
                    u_xlat13 = _AdditionalLightsWorldToLights[u_xlati55 / 4][u_xlati55 % 4] * vs_INTERP7.xxxx + u_xlat13;
                    u_xlat13 = _AdditionalLightsWorldToLights[(u_xlati55 + 2) / 4][(u_xlati55 + 2) % 4] * vs_INTERP7.zzzz + u_xlat13;
        ...
        u_xlat49 = dot(u_xlat1.xyw, u_xlat10.xyz);
        ...
        u_xlat10.xyz = u_xlat0.xyz * vec3(u_xlat49) + u_xlat6.xyz;
        u_xlat24.xyz = u_xlat10.xyz * u_xlat12.xyz + u_xlat24.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat33) + u_xlat7.xyz;
