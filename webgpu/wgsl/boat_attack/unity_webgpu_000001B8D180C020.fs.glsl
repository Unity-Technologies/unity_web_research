...
;
    ...
    u_xlat4.x = (u_xlatb11) ? u_xlat3.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb11) ? u_xlat3.y : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb11) ? u_xlat3.z : unity_MatrixV[2].z;
...
;
    ...
    u_xlat11.x = dot(u_xlat5, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat11.x = (-u_xlat11.x) + 4.0;
    u_xlatu11 = uint(u_xlat11.x);
    u_xlati11 = int(u_xlatu11) << (2 & int(0x1F));
    u_xlat3.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati11 + 1) / 4][(u_xlati11 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati11 / 4][u_xlati11 % 4].xyz * vs_INTERP0.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati11 + 2) / 4][(u_xlati11 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat3.xyz;
    ...
    u_xlat11.x = dot(u_xlat12.xyz, u_xlat5.xyz);
    u_xlat11.x = u_xlat11.x + 0.5;
    u_xlat5.xyz = u_xlat11.xxx * u_xlat6.xyz;
    u_xlat11.x = max(u_xlat5.w, 9.99999975e-05);
    ...
    u_xlat38 = dot((-u_xlat4.xyz), u_xlat12.xyz);
    u_xlat38 = u_xlat38 + u_xlat38;
    u_xlat6.xyz = u_xlat12.xyz * (-vec3(u_xlat38)) + (-u_xlat4.xyz);
    ...
    u_xlat8.xyz = (-u_xlat2.xyz) + vec3(u_xlat22);
    u_xlat8.xyz = vec3(u_xlat38) * u_xlat8.xyz + u_xlat2.xyz;
    u_xlat8.xyz = u_xlat11.xxx * u_xlat8.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat8.xyz;
    u_xlat5.xyz = u_xlat5.xyz * u_xlat7.xyz + u_xlat6.xyz;
    u_xlat11.x = u_xlat3.x * unity_LightData.z;
    u_xlat22 = dot(u_xlat12.xyz, _MainLightPosition.xyz);
    u_xlat22 = clamp(u_xlat22, 0.0, 1.0);
    u_xlat11.x = u_xlat22 * u_xlat11.x;
    u_xlat3.xyz = u_xlat11.xxx * u_xlat14.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu11 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat36 = dot(u_xlat12.xyz, u_xlat9.xyz);
        ...
        u_xlat36 = dot(u_xlat12.xyz, u_xlat8.xyz);
        u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    ...
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat33) + u_xlat3.xyz;
