...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlatb67 = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb67){
        ...
        u_xlat67 = (u_xlatb8.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb8.x) ? u_xlat7.xyz : vec3(u_xlat67);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat70) + u_xlat1.xyz;
    ...
    u_xlat1.x = u_xlat64 * (-u_xlat64);
    u_xlat1.x = exp2(u_xlat1.x);
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat63) + (-unity_FogColor.xyz);
