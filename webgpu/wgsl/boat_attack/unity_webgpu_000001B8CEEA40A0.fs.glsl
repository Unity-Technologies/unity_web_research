...
float u_xlat27;
    ...
    u_xlat9.x = _ZBufferParams.x * u_xlat0.x + _ZBufferParams.y;
    u_xlat9.x = float(1.0) / u_xlat9.x;
    u_xlat18 = (-u_xlat9.x) + u_xlat0.x;
    u_xlat9.x = unity_OrthoParams.w * u_xlat18 + u_xlat9.x;
    u_xlat0.x = (-u_xlat0.x) + 1.0;
    u_xlat1.xyz = (-vs_TEXCOORD2.xyz) + vs_TEXCOORD3.xyz;
    u_xlat0.xzw = u_xlat0.xxx * u_xlat1.xyz + vs_TEXCOORD2.xyz;
    u_xlat0.xzw = (-vs_TEXCOORD1.xyz) * u_xlat9.xxx + u_xlat0.xzw;
...
;
    ...
    u_xlat0 = unity_CameraToWorld[2] * u_xlat0.zzzz + u_xlat2;
    ...
    u_xlat7.y = u_xlat2.x;
    u_xlat8 = u_xlat1.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat7.xyzy;
    ...
    u_xlat9.xz = u_xlat1.xy * _ShadowMapTexture_TexelSize.xy + u_xlat7.wy;
    u_xlat3.y = u_xlat7.y;
    u_xlat19.xy = u_xlat1.xy * _ShadowMapTexture_TexelSize.xy + u_xlat3.xy;
    vec3 txVec2 = vec3(u_xlat19.xy,u_xlat18);
    u_xlat19.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec2, 0.0);
    ...
    u_xlat9.xz = u_xlat1.xy * _ShadowMapTexture_TexelSize.xy + u_xlat7.wy;
    u_xlat3.z = u_xlat7.y;
    u_xlat19.xy = u_xlat1.xy * _ShadowMapTexture_TexelSize.xy + u_xlat3.xz;
    vec3 txVec6 = vec3(u_xlat19.xy,u_xlat18);
    u_xlat19.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec6, 0.0);
    ...
    u_xlat7.y = u_xlat2.w;
    u_xlat5 = u_xlat1.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat7.xyzy;
    ...
    u_xlat3.w = u_xlat7.y;
    u_xlat19.xy = u_xlat1.xy * _ShadowMapTexture_TexelSize.xy + u_xlat3.xw;
    vec3 txVec10 = vec3(u_xlat19.xy,u_xlat18);
    u_xlat19.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec10, 0.0);
    ...
    u_xlat9.xz = u_xlat1.xy * _ShadowMapTexture_TexelSize.xy + u_xlat2.wy;
    u_xlat3.y = u_xlat2.y;
