...
fn main_1() {
  ...
  let x_1615 : bool = u_xlatb0.x;
  if (x_1615) {
    let x_1620 : f32 = u_xlat1.x;
    x_1616 = x_1620;
  } else {
    let x_1623 : f32 = u_xlat2.x;
    x_1616 = x_1623;
  }
  let x_1624 : f32 = x_1616;
  SV_Target0.x = x_1624;
  let x_1628 : bool = u_xlatb0.y;
  if (x_1628) {
    let x_1633 : f32 = u_xlat1.y;
    x_1629 = x_1633;
  } else {
    let x_1636 : f32 = u_xlat2.y;
    x_1629 = x_1636;
  }
  let x_1637 : f32 = x_1629;
  SV_Target0.y = x_1637;
  let x_1640 : bool = u_xlatb0.z;
  if (x_1640) {
    let x_1645 : f32 = u_xlat1.z;
    x_1641 = x_1645;
  } else {
