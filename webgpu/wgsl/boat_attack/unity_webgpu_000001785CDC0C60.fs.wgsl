...
fn main_1() {
  ...
  let x_2016 : vec3<f32> = sqrt(vec3<f32>(x_2014.x, x_2014.y, x_2014.z));
  let x_2017 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2016.x, x_2016.y, x_2016.z, x_2017.w);
  let x_2019 : vec2<f32> = vs_TEXCOORD0;
  let x_2022 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2026 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2028 : vec2<f32> = ((x_2019 * vec2<f32>(x_2022.x, x_2022.y)) + vec2<f32>(x_2026.z, x_2026.w));
  let x_2029 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2028.x, x_2028.y, x_2029.z, x_2029.w);
  let x_2036 : vec4<f32> = u_xlat1;
  let x_2039 : f32 = x_25.x_GlobalMipBias.x;
  let x_2040 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2036.x, x_2036.y), x_2039);
  u_xlat18 = x_2040.w;
  let x_2042 : f32 = u_xlat18;
  u_xlat18 = ((x_2042 * 2.0f) + -1.0f);
  let x_2045 : f32 = u_xlat18;
  u_xlatb1 = (x_2045 >= 0.0f);
  let x_2047 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2047);
  let x_2050 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2050)) + 1.0f);
  let x_2054 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2054);
  let x_2056 : f32 = u_xlat18;
  u_xlat18 = (-(x_2056) + 1.0f);
  let x_2059 : f32 = u_xlat18;
  let x_2061 : f32 = u_xlat1.x;
  u_xlat18 = (x_2059 * x_2061);
  let x_2063 : vec4<f32> = u_xlat0;
  let x_2065 : vec3<f32> = (vec3<f32>(x_2063.x, x_2063.y, x_2063.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2066 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2065.x, x_2065.y, x_2065.z, x_2066.w);
  let x_2068 : vec4<f32> = u_xlat0;
  let x_2070 : vec3<f32> = log2(vec3<f32>(x_2068.x, x_2068.y, x_2068.z));
  let x_2071 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2070.x, x_2070.y, x_2070.z, x_2071.w);
  let x_2073 : vec4<f32> = u_xlat2;
  let x_2075 : vec3<f32> = (vec3<f32>(x_2073.x, x_2073.y, x_2073.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2076 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2075.x, x_2075.y, x_2075.z, x_2076.w);
  let x_2078 : vec4<f32> = u_xlat2;
  let x_2080 : vec3<f32> = exp2(vec3<f32>(x_2078.x, x_2078.y, x_2078.z));
  let x_2081 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2080.x, x_2080.y, x_2080.z, x_2081.w);
  let x_2083 : vec4<f32> = u_xlat2;
  let x_2086 : vec3<f32> = ((vec3<f32>(x_2083.x, x_2083.y, x_2083.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2087 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2086.x, x_2086.y, x_2086.z, x_2087.w);
  let x_2089 : vec4<f32> = u_xlat0;
  let x_2091 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2089.x, x_2089.y, x_2089.z, x_2089.x));
  u_xlatb0 = vec3<bool>(x_2091.x, x_2091.y, x_2091.z);
  let x_2094 : bool = u_xlatb0.x;
  if (x_2094) {
  ...
  let x_2103 : f32 = x_2095;
  u_xlat0.x = x_2103;
  let x_2106 : bool = u_xlatb0.y;
  if (x_2106) {
    let x_2111 : f32 = u_xlat1.y;
    x_2107 = x_2111;
  } else {
    let x_2114 : f32 = u_xlat2.y;
    x_2107 = x_2114;
  }
  let x_2115 : f32 = x_2107;
  u_xlat0.y = x_2115;
  let x_2118 : bool = u_xlatb0.z;
  if (x_2118) {
    let x_2123 : f32 = u_xlat1.z;
    x_2119 = x_2123;
  } else {
    let x_2126 : f32 = u_xlat2.z;
    x_2119 = x_2126;
  }
  let x_2127 : f32 = x_2119;
  u_xlat0.z = x_2127;
  let x_2129 : f32 = u_xlat18;
  let x_2134 : vec4<f32> = u_xlat0;
  let x_2136 : vec3<f32> = ((vec3<f32>(x_2129, x_2129, x_2129) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2134.x, x_2134.y, x_2134.z));
  let x_2137 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2136.x, x_2136.y, x_2136.z, x_2137.w);
  let x_2139 : vec4<f32> = u_xlat0;
  let x_2141 : vec3<f32> = (vec3<f32>(x_2139.x, x_2139.y, x_2139.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2142 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2141.x, x_2141.y, x_2141.z, x_2142.w);
  let x_2144 : vec4<f32> = u_xlat0;
  let x_2146 : vec3<f32> = (vec3<f32>(x_2144.x, x_2144.y, x_2144.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2147 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2146.x, x_2146.y, x_2146.z, x_2147.w);
  let x_2149 : vec4<f32> = u_xlat2;
  let x_2151 : vec3<f32> = (vec3<f32>(x_2149.x, x_2149.y, x_2149.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2152 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2151.x, x_2151.y, x_2151.z, x_2152.w);
  let x_2154 : vec4<f32> = u_xlat2;
  let x_2157 : vec3<f32> = log2(abs(vec3<f32>(x_2154.x, x_2154.y, x_2154.z)));
  let x_2158 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2157.x, x_2157.y, x_2157.z, x_2158.w);
  let x_2160 : vec4<f32> = u_xlat2;
  let x_2162 : vec3<f32> = (vec3<f32>(x_2160.x, x_2160.y, x_2160.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2163 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2162.x, x_2162.y, x_2162.z, x_2163.w);
  let x_2165 : vec4<f32> = u_xlat2;
  let x_2167 : vec3<f32> = exp2(vec3<f32>(x_2165.x, x_2165.y, x_2165.z));
  let x_2168 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2167.x, x_2167.y, x_2167.z, x_2168.w);
  let x_2170 : vec4<f32> = u_xlat0;
  let x_2172 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2170.x, x_2170.y, x_2170.z, x_2170.x));
  u_xlatb0 = vec3<bool>(x_2172.x, x_2172.y, x_2172.z);
  let x_2175 : bool = u_xlatb0.x;
  if (x_2175) {
    let x_2180 : f32 = u_xlat1.x;
    x_2176 = x_2180;
  } else {
    let x_2183 : f32 = u_xlat2.x;
    x_2176 = x_2183;
  }
  let x_2184 : f32 = x_2176;
  u_xlat0.x = x_2184;
  let x_2187 : bool = u_xlatb0.y;
  if (x_2187) {
    let x_2192 : f32 = u_xlat1.y;
    x_2188 = x_2192;
  } else {
    let x_2195 : f32 = u_xlat2.y;
    x_2188 = x_2195;
  }
  let x_2196 : f32 = x_2188;
  u_xlat0.y = x_2196;
  let x_2199 : bool = u_xlatb0.z;
  if (x_2199) {
    let x_2204 : f32 = u_xlat1.z;
    x_2200 = x_2204;
  } else {
    let x_2207 : f32 = u_xlat2.z;
    x_2200 = x_2207;
  }
  let x_2208 : f32 = x_2200;
  u_xlat0.z = x_2208;
  let x_2212 : vec4<f32> = u_xlat0;
  let x_2214 : vec3<f32> = max(vec3<f32>(x_2212.x, x_2212.y, x_2212.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2215 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2214.x, x_2214.y, x_2214.z, x_2215.w);
  SV_Target0.w = 1.0f;
  return;
}
