...
fn main_1() {
  ...
  u_xlat1 = (x_42 * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_46 : vec3<f32> = u_xlat1;
  u_xlat1 = exp2(x_46);
  let x_48 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_48 * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_56 : vec4<f32> = u_xlat0;
  u_xlat2 = (vec3<f32>(x_56.x, x_56.y, x_56.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_68 : vec4<f32> = u_xlat0;
  let x_71 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_68.x, x_68.y, x_68.z, x_68.x));
