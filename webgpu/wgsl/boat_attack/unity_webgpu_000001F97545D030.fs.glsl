...
;
    ...
    u_xlat75 = dot(u_xlat28.xyz, u_xlat6.xyz);
    u_xlat75 = u_xlat75 + 0.5;
    u_xlat6.xyz = vec3(u_xlat75) * u_xlat7.xyz;
    u_xlat75 = max(u_xlat6.w, 9.99999975e-05);
    ...
    u_xlat54 = dot((-u_xlat5.xyz), u_xlat28.xyz);
    u_xlat54 = u_xlat54 + u_xlat54;
    u_xlat7.xyz = u_xlat28.xyz * (-vec3(u_xlat54)) + (-u_xlat5.xyz);
    u_xlat54 = dot(u_xlat28.xyz, u_xlat5.xyz);
    u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
    ...
    u_xlat33.xyz = (-u_xlat0.xyz) + u_xlat51.xxx;
    ...
    u_xlat4.xzw = vec3(u_xlat75) * _MainLightColor.xyz;
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat75) + u_xlat27.xyz;
    u_xlat4.xzw = u_xlat4.xzw * u_xlat7.xyz;
    u_xlat75 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu75 =  uint(int(u_xlat75));
    u_xlat1.x = u_xlat29.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat33.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati29].www + _AdditionalLightsPosition[u_xlati29].xyz;
        ...
        u_xlat80 = u_xlat80 * u_xlat82;
        u_xlat82 = dot(u_xlat28.xyz, u_xlat9.xyz);
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        u_xlat80 = u_xlat80 * u_xlat82;
        ...
        u_xlat29.x = dot(u_xlat28.xyz, u_xlat33.xyz);
        ...
        u_xlat29.x = u_xlat76 * u_xlat29.x;
        u_xlat29.x = u_xlat26 / u_xlat29.x;
        u_xlat33.xyz = u_xlat0.xyz * u_xlat29.xxx + u_xlat27.xyz;
