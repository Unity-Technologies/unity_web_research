...
#line 6 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.universal@16.0.1/ShaderLibrary/DeclareNormalsTexture.hlsl"
Texture2D_float _CameraNormalsTexture ;
...
#line 11 "Packages/com.unity.render-pipelines.universal/Shaders/Debug/ProbeVolumeSamplingDebugPositionNormal.compute"
RWStructuredBuffer < float4 > _ResultBuffer ;
uniform float4 _positionSS ;

[ numthreads ( 1 , 1 , 1 ) ]
void ComputePositionNormal ( uint3 id : SV_DispatchThreadID )
{
float deviceDepth = _CameraDepthTexture . Load ( int3 ( _positionSS . xy , 0 ) ) . r ;

float2 positionNDC = _positionSS . xy * _ScreenSize . zw + ( 0.5 * _ScreenSize . zw ) ;
float3 positionWS = ComputeWorldSpacePosition ( positionNDC , deviceDepth , unity_MatrixInvVP ) ;
