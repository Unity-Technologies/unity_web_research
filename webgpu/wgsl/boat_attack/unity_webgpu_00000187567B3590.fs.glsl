...
;
    ...
    u_xlat4.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati14 + 1) / 4][(u_xlati14 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati14 / 4][u_xlati14 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati14 + 2) / 4][(u_xlati14 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat4.xyz;
    ...
    if(u_xlatb27.x){
        u_xlat27.xy = vs_TEXCOORD7.yy * _MainLightWorldToLight[1].xy;
        u_xlat27.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD7.xx + u_xlat27.xy;
        u_xlat27.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD7.zz + u_xlat27.xy;
