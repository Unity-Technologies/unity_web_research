...
void main()
{
    ...
    u_xlat8.x = u_xlat11 * u_xlat8.x + _FaceShininess;
    u_xlat8.x = u_xlat8.x * 128.0;
    u_xlat4.x = u_xlat4.x * u_xlat8.x;
    u_xlat4.x = exp2(u_xlat4.x);
    u_xlat8.xy = vs_TEXCOORD5.yy * unity_WorldToLight[1].xy;
    u_xlat8.xy = unity_WorldToLight[0].xy * vs_TEXCOORD5.xx + u_xlat8.xy;
    u_xlat8.xy = unity_WorldToLight[2].xy * vs_TEXCOORD5.zz + u_xlat8.xy;
    u_xlat8.xy = u_xlat8.xy + unity_WorldToLight[3].xy;
    u_xlat8.x = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat8.xy).w;
    ...
    SV_Target0.xyz = u_xlat1.xyz * u_xlat0.xxx + u_xlat4.xyz;
    return;
}
