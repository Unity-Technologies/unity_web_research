...
;
    ...
    u_xlat3.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati75 + 1) / 4][(u_xlati75 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati75 / 4][u_xlati75 % 4].xyz * vs_INTERP7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati75 + 2) / 4][(u_xlati75 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati75 + 3) / 4][(u_xlati75 + 3) % 4].xyz;
    ...
    u_xlat75 = dot(u_xlat1.xyz, u_xlat5.xyz);
    ...
    u_xlat6.xyz = vec3(u_xlat75) * u_xlat0.xyz;
    ...
    if(u_xlatb78){
        ...
        if(u_xlatb78){
            ...
            if(u_xlatb79){
                ...
                u_xlat57.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                u_xlat80 = u_xlat14.x * u_xlat80 + u_xlat81;
                vec3 txVec6 = vec3(u_xlat57.xy,u_xlat3.z);
                u_xlat81 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat80 = u_xlat14.z * u_xlat81 + u_xlat80;
                ...
                u_xlat80 = u_xlat14.w * u_xlat81 + u_xlat80;
                ...
                u_xlat80 = u_xlat15.x * u_xlat81 + u_xlat80;
                ...
                u_xlat80 = u_xlat15.y * u_xlat81 + u_xlat80;
                ...
                u_xlat80 = u_xlat15.z * u_xlat81 + u_xlat80;
                ...
                u_xlat80 = u_xlat15.w * u_xlat81 + u_xlat80;
                ...
                u_xlat78 = u_xlat79 * u_xlat81 + u_xlat80;
            } else {
                u_xlat7.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat57.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                u_xlat79 = u_xlat18.x * u_xlat79 + u_xlat80;
                vec3 txVec15 = vec3(u_xlat57.xy,u_xlat3.z);
                ...
                u_xlat79 = u_xlat20.x * u_xlat80 + u_xlat79;
                ...
                u_xlat79 = u_xlat20.y * u_xlat80 + u_xlat79;
                ...
                u_xlat79 = u_xlat20.z * u_xlat80 + u_xlat79;
                vec3 txVec24 = vec3(u_xlat65.xy,u_xlat3.z);
                u_xlat80 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat79 = u_xlat20.w * u_xlat80 + u_xlat79;
                ...
                u_xlat79 = u_xlat8.x * u_xlat80 + u_xlat79;
                ...
                u_xlat79 = u_xlat8.y * u_xlat80 + u_xlat79;
                ...
                u_xlat79 = u_xlat8.z * u_xlat80 + u_xlat79;
                ...
                u_xlat78 = u_xlat8.w * u_xlat80 + u_xlat79;
            }
        }
    } else {
    ...
    u_xlat3.x = u_xlat78 * _MainLightShadowParams.x + u_xlat3.x;
    u_xlatb28 = 0.0>=u_xlat3.z;
    u_xlatb53 = u_xlat3.z>=1.0;
    u_xlatb28 = u_xlatb53 || u_xlatb28;
    u_xlat3.x = (u_xlatb28) ? 1.0 : u_xlat3.x;
    u_xlat28.xyz = vs_INTERP7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat28.x = dot(u_xlat28.xyz, u_xlat28.xyz);
    u_xlat53 = u_xlat28.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat53 = clamp(u_xlat53, 0.0, 1.0);
    u_xlat78 = (-u_xlat3.x) + 1.0;
    u_xlat3.x = u_xlat53 * u_xlat78 + u_xlat3.x;
    u_xlat53 = dot((-u_xlat4.xyz), u_xlat1.xyz);
    u_xlat53 = u_xlat53 + u_xlat53;
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat53)) + (-u_xlat4.xyz);
    u_xlat53 = dot(u_xlat1.xyz, u_xlat4.xyz);
    u_xlat53 = clamp(u_xlat53, 0.0, 1.0);
    u_xlat53 = (-u_xlat53) + 1.0;
    u_xlat53 = u_xlat53 * u_xlat53;
    u_xlat53 = u_xlat53 * u_xlat53;
    u_xlat78 = (-u_xlat75) * 0.699999988 + 1.70000005;
    ...
    u_xlat33.xyz = (-u_xlat0.xyz) + vec3(u_xlat76);
    u_xlat33.xyz = vec3(u_xlat53) * u_xlat33.xyz + u_xlat0.xyz;
    ...
    u_xlat75 = dot(u_xlat1.xyz, u_xlat7.xyz);
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat75) + u_xlat6.xyz;
    u_xlat3.xzw = u_xlat3.xzw * u_xlat7.xyz;
    u_xlat75 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu75 =  uint(int(u_xlat75));
    u_xlat76 = u_xlat28.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat28.x = dot(unity_LightIndices[int(u_xlatu28)], uintBitsToFloat(ImmCB_0[u_xlati79]));
        u_xlati28 = int(u_xlat28.x);
        u_xlat33.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati28].www + _AdditionalLightsPosition[u_xlati28].xyz;
        u_xlat79 = dot(u_xlat33.xyz, u_xlat33.xyz);
        u_xlat79 = max(u_xlat79, 6.10351562e-05);
        u_xlat80 = inversesqrt(u_xlat79);
        u_xlat9.xyz = vec3(u_xlat80) * u_xlat33.xyz;
        u_xlat81 = float(1.0) / float(u_xlat79);
        u_xlat79 = u_xlat79 * _AdditionalLightsAttenuation[u_xlati28].x;
        u_xlat79 = (-u_xlat79) * u_xlat79 + 1.0;
        u_xlat79 = max(u_xlat79, 0.0);
        u_xlat79 = u_xlat79 * u_xlat79;
        u_xlat79 = u_xlat79 * u_xlat81;
        u_xlat81 = dot(_AdditionalLightsSpotDir[u_xlati28].xyz, u_xlat9.xyz);
        u_xlat81 = u_xlat81 * _AdditionalLightsAttenuation[u_xlati28].z + _AdditionalLightsAttenuation[u_xlati28].w;
        u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
        u_xlat81 = u_xlat81 * u_xlat81;
        u_xlat79 = u_xlat79 * u_xlat81;
        u_xlati81 = int(_AdditionalShadowParams[u_xlati28].w);
        u_xlatb82 = u_xlati81>=0;
        if(u_xlatb82){
            u_xlatb82 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati28].z);
            if(u_xlatb82){
                u_xlatb10.xyz = greaterThanEqual(abs(u_xlat9.zzyz), abs(u_xlat9.xyxx)).xyz;
                u_xlatb82 = u_xlatb10.y && u_xlatb10.x;
                ...
                u_xlat82 = (u_xlatb82) ? u_xlat10.x : u_xlat84;
                u_xlat84 = trunc(_AdditionalShadowParams[u_xlati28].w);
                u_xlat82 = u_xlat82 + u_xlat84;
                u_xlati81 = int(u_xlat82);
            }
            ...
            u_xlatb81 = 0.0<_AdditionalShadowParams[u_xlati28].y;
            if(u_xlatb81){
                u_xlatb81 = 1.0==_AdditionalShadowParams[u_xlati28].y;
                if(u_xlatb81){
                    ...
                    u_xlatb82 = 2.0==_AdditionalShadowParams[u_xlati28].y;
                    if(u_xlatb82){
                        ...
                        u_xlat82 = u_xlat12.z * u_xlat17.y;
                        ...
                        u_xlat81 = u_xlat82 * u_xlat85 + u_xlat84;
                    } else {
                        u_xlat11.xy = u_xlat10.xy * _AdditionalShadowmapSize.zw + vec2(0.5, 0.5);
                        u_xlat11.xy = floor(u_xlat11.xy);
                        u_xlat61.xy = u_xlat10.xy * _AdditionalShadowmapSize.zw + (-u_xlat11.xy);
                        ...
                        u_xlat82 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec43, 0.0);
                        ...
                        u_xlat82 = u_xlat22.x * u_xlat82 + u_xlat84;
                        ...
                        u_xlat82 = u_xlat22.z * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat22.w * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat23.x * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat23.y * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat23.z * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat23.w * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat24.x * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat24.y * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat24.z * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat24.w * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat12.x * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat12.y * u_xlat84 + u_xlat82;
                        ...
                        u_xlat82 = u_xlat12.z * u_xlat84 + u_xlat82;
                        ...
                        u_xlat81 = u_xlat12.w * u_xlat84 + u_xlat82;
                    }
                }
            } else {
            ...
            u_xlat82 = 1.0 + (-_AdditionalShadowParams[u_xlati28].x);
            u_xlat81 = u_xlat81 * _AdditionalShadowParams[u_xlati28].x + u_xlat82;
            u_xlatb82 = 0.0>=u_xlat10.z;
        ...
        u_xlat81 = u_xlat76 * u_xlat82 + u_xlat81;
        u_xlat79 = u_xlat79 * u_xlat81;
        u_xlat81 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
        u_xlat79 = u_xlat79 * u_xlat81;
        u_xlat10.xyz = vec3(u_xlat79) * _AdditionalLightsColor[u_xlati28].xyz;
        u_xlat33.xyz = u_xlat33.xyz * vec3(u_xlat80) + u_xlat4.xyz;
        u_xlat28.x = dot(u_xlat33.xyz, u_xlat33.xyz);
        u_xlat28.x = max(u_xlat28.x, 1.17549435e-38);
        u_xlat28.x = inversesqrt(u_xlat28.x);
        u_xlat33.xyz = u_xlat28.xxx * u_xlat33.xyz;
        u_xlat28.x = dot(u_xlat1.xyz, u_xlat33.xyz);
        u_xlat28.x = clamp(u_xlat28.x, 0.0, 1.0);
        u_xlat79 = dot(u_xlat9.xyz, u_xlat33.xyz);
        ...
        u_xlat28.x = u_xlat28.x * u_xlat79;
        u_xlat28.x = u_xlat77 * u_xlat28.x;
        u_xlat28.x = u_xlat27 / u_xlat28.x;
        u_xlat33.xyz = u_xlat0.xyz * u_xlat28.xxx + u_xlat6.xyz;
        u_xlat7.xyz = u_xlat33.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat52) + u_xlat3.xzw;
