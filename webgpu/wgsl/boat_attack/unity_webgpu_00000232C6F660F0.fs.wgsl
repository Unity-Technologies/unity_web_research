...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1483.x, x_1483.y, x_1483.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1486 : vec4<f32> = u_xlat0;
  let x_1489 : vec3<f32> = log2(abs(vec3<f32>(x_1486.x, x_1486.y, x_1486.z)));
  let x_1490 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1489.x, x_1489.y, x_1489.z, x_1490.w);
  let x_1492 : vec4<f32> = u_xlat2;
  let x_1494 : vec3<f32> = (vec3<f32>(x_1492.x, x_1492.y, x_1492.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1505 : vec3<f32> = ((vec3<f32>(x_1502.x, x_1502.y, x_1502.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1506 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1505.x, x_1505.y, x_1505.z, x_1506.w);
  let x_1508 : vec4<f32> = u_xlat0;
  let x_1510 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1508.x, x_1508.y, x_1508.z, x_1508.x));
  u_xlatb0 = vec3<bool>(x_1510.x, x_1510.y, x_1510.z);
  ...
  SV_Target0.x = x_1524;
  let x_1528 : bool = u_xlatb0.y;
  if (x_1528) {
    let x_1533 : f32 = u_xlat1.y;
    x_1529 = x_1533;
  } else {
