...
void main()
{
    ...
    u_xlat8 = u_xlat2.x * u_xlat2.x + (-u_xlat8);
    u_xlat4.xyz = unity_SHC.xyz * vec3(u_xlat8) + u_xlat5.xyz;
    u_xlat3.xyz = u_xlat3.xyz + u_xlat4.xyz;
    u_xlat3.xyz = max(u_xlat3.xyz, vec3(0.0, 0.0, 0.0));
    vec3 txVec0 = vec3(vs_TEXCOORD6.xy,vs_TEXCOORD6.z);
    u_xlat8 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec0, 0.0);
    ...
    u_xlat26 = (-u_xlat8) + 1.0;
    u_xlat8 = u_xlat1.x * u_xlat26 + u_xlat8;
    u_xlat8 = u_xlat8 * unity_LightData.z;
    u_xlat4.xyz = vec3(u_xlat8) * _MainLightColor.xyz;
