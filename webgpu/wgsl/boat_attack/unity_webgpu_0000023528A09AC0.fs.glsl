...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat62 = vs_INTERP0.y * unity_MatrixV[1].z;
    u_xlat62 = unity_MatrixV[0].z * vs_INTERP0.x + u_xlat62;
    u_xlat62 = unity_MatrixV[2].z * vs_INTERP0.z + u_xlat62;
    ...
    u_xlat63 = dot(u_xlat20.xyz, u_xlat4.xyz);
    ...
    u_xlat63 = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat63) + 1.0;
    ...
    u_xlat5.x = min(u_xlat7.x, u_xlat5.x);
    ...
    u_xlat66 = dot((-u_xlat1.xyz), u_xlat20.xyz);
    u_xlat66 = u_xlat66 + u_xlat66;
    u_xlat7.xyz = u_xlat20.xyz * (-vec3(u_xlat66)) + (-u_xlat1.xyz);
    u_xlat66 = dot(u_xlat20.xyz, u_xlat1.xyz);
    u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
    u_xlat66 = (-u_xlat66) + 1.0;
    u_xlat66 = u_xlat66 * u_xlat66;
    u_xlat66 = u_xlat66 * u_xlat66;
    u_xlat67 = (-u_xlat61) * 0.699999988 + 1.70000005;
    ...
    u_xlat28.xyz = vec3(u_xlat66) * u_xlat28.xyz + u_xlat2.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlati47 != 0) {
            ...
            if(u_xlati67 != 0) {
                u_xlat11.xyz = vs_INTERP0.yyy * _AdditionalLightsWorldToLights[(u_xlati69 + 1) / 4][(u_xlati69 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati69 / 4][u_xlati69 % 4].xyw * vs_INTERP0.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati69 + 2) / 4][(u_xlati69 + 2) % 4].xyw * vs_INTERP0.zzz + u_xlat11.xyz;
                ...
                if(u_xlati47 != 0) {
                    u_xlat47.xy = vs_INTERP0.yy * _AdditionalLightsWorldToLights[(u_xlati69 + 1) / 4][(u_xlati69 + 1) % 4].xy;
                    u_xlat47.xy = _AdditionalLightsWorldToLights[u_xlati69 / 4][u_xlati69 % 4].xy * vs_INTERP0.xx + u_xlat47.xy;
                    u_xlat47.xy = _AdditionalLightsWorldToLights[(u_xlati69 + 2) / 4][(u_xlati69 + 2) % 4].xy * vs_INTERP0.zz + u_xlat47.xy;
                    ...
                    u_xlat12 = vs_INTERP0.yyyy * _AdditionalLightsWorldToLights[(u_xlati69 + 1) / 4][(u_xlati69 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati69 / 4][u_xlati69 % 4] * vs_INTERP0.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati69 + 2) / 4][(u_xlati69 + 2) % 4] * vs_INTERP0.zzzz + u_xlat12;
        ...
        u_xlat9.xyz = u_xlat2.xyz * vec3(u_xlat63) + u_xlat3.xyz;
