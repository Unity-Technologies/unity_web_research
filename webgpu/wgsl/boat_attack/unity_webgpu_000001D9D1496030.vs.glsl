...
void main()
{
    ...
    u_xlat12.xy = floor(u_xlat0.xz);
    u_xlat2.xy = fract(u_xlat0.xz);
    u_xlat24.xy = u_xlat2.xy * u_xlat2.xy;
    u_xlat3.xy = (-u_xlat2.xy) * vec2(2.0, 2.0) + vec2(3.0, 3.0);
    u_xlat24.xy = u_xlat24.xy * u_xlat3.xy;
    u_xlat34 = dot(u_xlat12.xy, vec2(127.099998, 311.700012));
    u_xlat3.x = dot(u_xlat12.xy, vec2(269.5, 183.300003));
    u_xlat4.x = sin(u_xlat34);
    u_xlat4.y = sin(u_xlat3.x);
    u_xlat3.xy = u_xlat4.xy * vec2(43758.5469, 43758.5469);
    u_xlat3.xy = fract(u_xlat3.xy);
    u_xlat3.xy = u_xlat3.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat34 = dot(u_xlat3.xy, u_xlat2.xy);
    ...
    u_xlat14 = dot(u_xlat12.xy, vec2(127.099998, 311.700012));
    u_xlat12.x = dot(u_xlat12.xy, vec2(269.5, 183.300003));
    u_xlat4.x = sin(u_xlat14);
    u_xlat4.y = sin(u_xlat12.x);
    u_xlat12.xy = u_xlat4.xy * vec2(43758.5469, 43758.5469);
    ...
    u_xlat12.xy = u_xlat1.xx * vec2(0.100000001, 0.200000003);
    vs_TEXCOORD0.zw = u_xlat0.xz * vec2(0.100000001, 0.100000001) + u_xlat12.xx;
    vs_TEXCOORD0.xy = u_xlat0.xz * vec2(0.400000006, 0.400000006) + u_xlat12.yy;
    ...
    while(true){
        ...
        u_xlat38 = u_xlat37 * waveData[int(u_xlatu36)].x;
        u_xlat39 = u_xlat11 * u_xlat38;
        u_xlat39 = 1.5 / u_xlat39;
        u_xlat29.xy = vec2(10000.0, 0.0174532924) * waveData[int(u_xlatu36)].xy;
        u_xlat8.x = sin(u_xlat29.y);
        u_xlat9 = cos(u_xlat29.y);
        u_xlat40 = 1.0 + (-waveData[int(u_xlatu36)].w);
        u_xlat8.z = u_xlat9;
        u_xlat19.xz = u_xlat0.xz + (-waveData[int(u_xlatu7.x)].xy);
        u_xlat19.xz = u_xlat19.xz * waveData[int(u_xlatu36)].ww;
        u_xlat8.xy = u_xlat8.xz * vec2(u_xlat40) + u_xlat19.xz;
        u_xlat40 = dot(u_xlat8.xy, u_xlat8.xy);
        u_xlat40 = inversesqrt(u_xlat40);
        u_xlat8.xy = vec2(u_xlat40) * u_xlat8.xy;
        u_xlat7.xw = (-waveData[int(u_xlatu7.x)].xy) * waveData[int(u_xlatu36)].ww + u_xlat0.xz;
        u_xlat7.x = dot(u_xlat8.xy, u_xlat7.xw);
        u_xlat37 = u_xlat37 * u_xlat7.x;
        u_xlat7.x = sin(u_xlat37);
        u_xlat9 = cos(u_xlat37);
        u_xlat37 = u_xlat39 * waveData[int(u_xlatu36)].x;
        u_xlat30.xy = u_xlat8.xy * vec2(u_xlat37);
        u_xlat10.xz = vec2(u_xlat9) * u_xlat30.xy;
        u_xlat37 = u_xlat7.x * waveData[int(u_xlatu36)].x;
        u_xlat10.y = u_xlat35 * u_xlat37;
        u_xlat8.xy = vec2(u_xlat38) * u_xlat8.xy;
        u_xlat8.xy = vec2(u_xlat9) * u_xlat8.xy;
        u_xlat8.xz = (-u_xlat8.xy);
        u_xlat37 = u_xlat38 * u_xlat39;
        u_xlat8.y = (-u_xlat37) * u_xlat7.x + 1.0;
        u_xlat29.x = u_xlat29.x;
        u_xlat29.x = clamp(u_xlat29.x, 0.0, 1.0);
        u_xlat5.xyz = u_xlat10.xyz * u_xlat29.xxx + u_xlat5.xyz;
        u_xlat6.xyz = u_xlat8.xyz * vec3(u_xlat35) + u_xlat6.xyz;
    ...
    u_xlat35 = u_xlat4.z / _ProjectionParams.y;
    u_xlat35 = (-u_xlat35) + 1.0;
    u_xlat35 = u_xlat35 * _ProjectionParams.z;
    u_xlat35 = max(u_xlat35, 0.0);
    vs_TEXCOORD4.x = u_xlat35 * unity_FogParams.x;
