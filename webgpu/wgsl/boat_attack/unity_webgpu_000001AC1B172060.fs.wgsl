...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1337.x, x_1337.y, x_1337.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1340 : vec4<f32> = u_xlat0;
  let x_1343 : vec3<f32> = log2(abs(vec3<f32>(x_1340.x, x_1340.y, x_1340.z)));
  let x_1344 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1343.x, x_1343.y, x_1343.z, x_1344.w);
  let x_1346 : vec4<f32> = u_xlat2;
  let x_1348 : vec3<f32> = (vec3<f32>(x_1346.x, x_1346.y, x_1346.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1349 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1348.x, x_1348.y, x_1348.z, x_1349.w);
  let x_1351 : vec4<f32> = u_xlat2;
  let x_1353 : vec3<f32> = exp2(vec3<f32>(x_1351.x, x_1351.y, x_1351.z));
  let x_1354 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1353.x, x_1353.y, x_1353.z, x_1354.w);
  let x_1356 : vec4<f32> = u_xlat2;
  let x_1359 : vec3<f32> = ((vec3<f32>(x_1356.x, x_1356.y, x_1356.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1360 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1359.x, x_1359.y, x_1359.z, x_1360.w);
  let x_1362 : vec4<f32> = u_xlat0;
  let x_1364 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1362.x, x_1362.y, x_1362.z, x_1362.x));
  u_xlatb0 = vec3<bool>(x_1364.x, x_1364.y, x_1364.z);
  let x_1367 : bool = u_xlatb0.x;
  if (x_1367) {
  ...
  u_xlat0.x = x_1376;
  let x_1379 : bool = u_xlatb0.y;
  if (x_1379) {
    let x_1384 : f32 = u_xlat1.y;
    x_1380 = x_1384;
  } else {
  ...
  u_xlat0.y = x_1388;
  let x_1391 : bool = u_xlatb0.z;
  if (x_1391) {
    let x_1396 : f32 = u_xlat1.z;
    x_1392 = x_1396;
  } else {
  ...
  let x_1405 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1409 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1411 : vec2<f32> = ((x_1402 * vec2<f32>(x_1405.x, x_1405.y)) + vec2<f32>(x_1409.z, x_1409.w));
  let x_1412 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1411.x, x_1411.y, x_1412.z);
  let x_1419 : vec3<f32> = u_xlat1;
  let x_1422 : f32 = x_25.x_GlobalMipBias.x;
  let x_1423 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1419.x, x_1419.y), x_1422);
  u_xlat21 = x_1423.w;
  let x_1425 : f32 = u_xlat21;
  u_xlat21 = ((x_1425 * 2.0f) + -1.0f);
  let x_1428 : f32 = u_xlat21;
  u_xlatb1.x = (x_1428 >= 0.0f);
  let x_1432 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1432);
  let x_1435 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1435)) + 1.0f);
  let x_1439 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1439);
  let x_1441 : f32 = u_xlat21;
  u_xlat21 = (-(x_1441) + 1.0f);
  let x_1444 : f32 = u_xlat21;
  let x_1446 : f32 = u_xlat1.x;
  u_xlat21 = (x_1444 * x_1446);
  let x_1448 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1448.x, x_1448.y, x_1448.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1451 : vec4<f32> = u_xlat0;
  let x_1454 : vec3<f32> = log2(abs(vec3<f32>(x_1451.x, x_1451.y, x_1451.z)));
  let x_1455 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1454.x, x_1454.y, x_1454.z, x_1455.w);
  let x_1457 : vec4<f32> = u_xlat2;
  let x_1459 : vec3<f32> = (vec3<f32>(x_1457.x, x_1457.y, x_1457.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1460 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1459.x, x_1459.y, x_1459.z, x_1460.w);
  let x_1462 : vec4<f32> = u_xlat2;
  let x_1464 : vec3<f32> = exp2(vec3<f32>(x_1462.x, x_1462.y, x_1462.z));
  let x_1465 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1464.x, x_1464.y, x_1464.z, x_1465.w);
  let x_1467 : vec4<f32> = u_xlat2;
  let x_1470 : vec3<f32> = ((vec3<f32>(x_1467.x, x_1467.y, x_1467.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1471 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1470.x, x_1470.y, x_1470.z, x_1471.w);
  let x_1473 : vec4<f32> = u_xlat0;
  let x_1475 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1473.x, x_1473.y, x_1473.z, x_1473.x));
  u_xlatb0 = vec3<bool>(x_1475.x, x_1475.y, x_1475.z);
  let x_1478 : bool = u_xlatb0.x;
  if (x_1478) {
    let x_1483 : f32 = u_xlat1.x;
    x_1479 = x_1483;
  } else {
    let x_1486 : f32 = u_xlat2.x;
    x_1479 = x_1486;
  }
  let x_1487 : f32 = x_1479;
  u_xlat0.x = x_1487;
  let x_1490 : bool = u_xlatb0.y;
  if (x_1490) {
    let x_1495 : f32 = u_xlat1.y;
    x_1491 = x_1495;
  } else {
    let x_1498 : f32 = u_xlat2.y;
    x_1491 = x_1498;
  }
  let x_1499 : f32 = x_1491;
  u_xlat0.y = x_1499;
  let x_1502 : bool = u_xlatb0.z;
  if (x_1502) {
    let x_1507 : f32 = u_xlat1.z;
    x_1503 = x_1507;
  } else {
  ...
  let x_1520 : vec3<f32> = ((vec3<f32>(x_1513, x_1513, x_1513) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1518.x, x_1518.y, x_1518.z));
  let x_1521 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1520.x, x_1520.y, x_1520.z, x_1521.w);
  let x_1523 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1523.x, x_1523.y, x_1523.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1526 : vec4<f32> = u_xlat0;
  let x_1528 : vec3<f32> = (vec3<f32>(x_1526.x, x_1526.y, x_1526.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1529 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1528.x, x_1528.y, x_1528.z, x_1529.w);
  let x_1531 : vec4<f32> = u_xlat2;
  let x_1533 : vec3<f32> = (vec3<f32>(x_1531.x, x_1531.y, x_1531.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1534 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1533.x, x_1533.y, x_1533.z, x_1534.w);
  let x_1536 : vec4<f32> = u_xlat2;
  let x_1539 : vec3<f32> = log2(abs(vec3<f32>(x_1536.x, x_1536.y, x_1536.z)));
  let x_1540 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1539.x, x_1539.y, x_1539.z, x_1540.w);
  let x_1542 : vec4<f32> = u_xlat2;
  let x_1544 : vec3<f32> = (vec3<f32>(x_1542.x, x_1542.y, x_1542.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1545 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1544.x, x_1544.y, x_1544.z, x_1545.w);
  let x_1547 : vec4<f32> = u_xlat2;
  let x_1549 : vec3<f32> = exp2(vec3<f32>(x_1547.x, x_1547.y, x_1547.z));
  let x_1550 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1549.x, x_1549.y, x_1549.z, x_1550.w);
  let x_1552 : vec4<f32> = u_xlat0;
  let x_1554 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1552.x, x_1552.y, x_1552.z, x_1552.x));
  ...
  let x_1597 : vec3<f32> = max(vec3<f32>(x_1594.x, x_1594.y, x_1594.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1598 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1597.x, x_1597.y, x_1597.z, x_1598.w);
  SV_Target0.w = 1.0f;
  return;
}
