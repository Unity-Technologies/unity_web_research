...
void main()
{
    ...
    u_xlat1.xyw = unity_SHC.xyz * vec3(u_xlat81) + u_xlat8.xyz;
    ...
    u_xlat83 = (-u_xlat81) + u_xlat3.y;
    u_xlat6.xyz = vec3(u_xlat81) * u_xlat0.xyz;
    ...
    if(u_xlatb85){
        ...
        if(u_xlatb85){
            ...
            u_xlat85 = dot(u_xlat8, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb86){
                ...
                u_xlat87 = u_xlat14.x * u_xlat87 + u_xlat7.x;
                ...
                u_xlat87 = u_xlat14.z * u_xlat7.x + u_xlat87;
                ...
                u_xlat87 = u_xlat14.w * u_xlat7.x + u_xlat87;
                ...
                u_xlat87 = u_xlat15.x * u_xlat7.x + u_xlat87;
                ...
                u_xlat87 = u_xlat15.y * u_xlat7.x + u_xlat87;
                ...
                u_xlat87 = u_xlat15.z * u_xlat7.x + u_xlat87;
                ...
                u_xlat87 = u_xlat15.w * u_xlat7.x + u_xlat87;
                ...
                u_xlat85 = u_xlat86 * u_xlat7.x + u_xlat87;
            } else {
                u_xlat7.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat61.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                u_xlat87 = u_xlat87 * u_xlat18.y;
                u_xlat86 = u_xlat18.x * u_xlat86 + u_xlat87;
                ...
                u_xlat86 = u_xlat18.z * u_xlat87 + u_xlat86;
                ...
                u_xlat86 = u_xlat18.w * u_xlat87 + u_xlat86;
                ...
                u_xlat86 = u_xlat19.x * u_xlat87 + u_xlat86;
                ...
                u_xlat86 = u_xlat19.y * u_xlat87 + u_xlat86;
                ...
                u_xlat86 = u_xlat8.x * u_xlat87 + u_xlat86;
                ...
                u_xlat86 = u_xlat8.y * u_xlat87 + u_xlat86;
                ...
                u_xlat86 = u_xlat8.z * u_xlat87 + u_xlat86;
                ...
                u_xlat85 = u_xlat8.w * u_xlat87 + u_xlat86;
            }
        }
    } else {
    ...
    u_xlat86 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat85 = u_xlat85 * _MainLightShadowParams.x + u_xlat86;
    u_xlatb86 = 0.0>=vs_INTERP3.z;
    u_xlatb87 = vs_INTERP3.z>=1.0;
    u_xlatb86 = u_xlatb86 || u_xlatb87;
    u_xlat85 = (u_xlatb86) ? 1.0 : u_xlat85;
    u_xlat7.xyz = vs_INTERP7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat86 = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat87 = u_xlat86 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat87 = clamp(u_xlat87, 0.0, 1.0);
    u_xlat7.x = (-u_xlat85) + 1.0;
    u_xlat85 = u_xlat87 * u_xlat7.x + u_xlat85;
    u_xlatb87 = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb87){
        ...
        u_xlat87 = (u_xlatb8.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb8.x) ? u_xlat7.xyz : vec3(u_xlat87);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat87 = dot((-u_xlat5.xyz), u_xlat4.xyz);
    u_xlat87 = u_xlat87 + u_xlat87;
    u_xlat8.xyz = u_xlat4.xyz * (-vec3(u_xlat87)) + (-u_xlat5.xyz);
    u_xlat87 = dot(u_xlat4.xyz, u_xlat5.xyz);
    u_xlat87 = clamp(u_xlat87, 0.0, 1.0);
    u_xlat87 = (-u_xlat87) + 1.0;
    u_xlat87 = u_xlat87 * u_xlat87;
    u_xlat87 = u_xlat87 * u_xlat87;
    u_xlat88 = (-u_xlat81) * 0.699999988 + 1.70000005;
    u_xlat81 = u_xlat81 * u_xlat88;
    ...
    u_xlat36.xyz = vec3(u_xlat87) * u_xlat36.xyz + u_xlat0.xyz;
    u_xlat36.xyz = vec3(u_xlat81) * u_xlat36.xyz;
    u_xlat8.xyz = u_xlat8.xyz * u_xlat36.xyz;
    u_xlat1.xyw = u_xlat1.xyw * u_xlat6.xyz + u_xlat8.xyz;
    u_xlat81 = u_xlat85 * unity_LightData.z;
    u_xlat83 = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    ...
    u_xlat81 = dot(u_xlat4.xyz, u_xlat8.xyz);
    u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
    u_xlat83 = dot(_MainLightPosition.xyz, u_xlat8.xyz);
    u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
    ...
    u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat81) + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat81 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu81 =  uint(int(u_xlat81));
    u_xlat83 = u_xlat86 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu81 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati85].www + _AdditionalLightsPosition[u_xlati85].xyz;
        ...
        if(u_xlatb62){
            ...
            u_xlat12 = vs_INTERP7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati88 + 1) / 4][(u_xlati88 + 1) % 4];
            u_xlat12 = _AdditionalLightsWorldToShadow[u_xlati88 / 4][u_xlati88 % 4] * vs_INTERP7.xxxx + u_xlat12;
            u_xlat12 = _AdditionalLightsWorldToShadow[(u_xlati88 + 2) / 4][(u_xlati88 + 2) % 4] * vs_INTERP7.zzzz + u_xlat12;
            ...
            if(u_xlatb88){
                ...
                if(u_xlatb88){
                    ...
                    if(u_xlatb62){
                        ...
                        u_xlat91 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec35, 0.0);
                        u_xlat91 = u_xlat91 * u_xlat20.y;
                        u_xlat89 = u_xlat20.x * u_xlat89 + u_xlat91;
                        vec3 txVec36 = vec3(u_xlat18.xy,u_xlat12.z);
                        u_xlat91 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec36, 0.0);
                        u_xlat89 = u_xlat20.z * u_xlat91 + u_xlat89;
                        vec3 txVec37 = vec3(u_xlat16.xy,u_xlat12.z);
                        u_xlat91 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec37, 0.0);
                        u_xlat89 = u_xlat20.w * u_xlat91 + u_xlat89;
                        vec3 txVec38 = vec3(u_xlat19.xy,u_xlat12.z);
                        u_xlat91 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec38, 0.0);
                        u_xlat89 = u_xlat21.x * u_xlat91 + u_xlat89;
                        vec3 txVec39 = vec3(u_xlat19.zw,u_xlat12.z);
                        u_xlat91 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec39, 0.0);
                        u_xlat89 = u_xlat21.y * u_xlat91 + u_xlat89;
                        vec3 txVec40 = vec3(u_xlat16.zw,u_xlat12.z);
                        u_xlat91 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec40, 0.0);
                        u_xlat89 = u_xlat21.z * u_xlat91 + u_xlat89;
                        vec3 txVec41 = vec3(u_xlat15.xy,u_xlat12.z);
                        u_xlat91 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec41, 0.0);
                        u_xlat89 = u_xlat21.w * u_xlat91 + u_xlat89;
                        vec3 txVec42 = vec3(u_xlat15.zw,u_xlat12.z);
                        u_xlat91 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec42, 0.0);
                        u_xlat88 = u_xlat62.x * u_xlat91 + u_xlat89;
                    } else {
                        u_xlat62.xy = u_xlat12.xy * _AdditionalShadowmapSize.zw + vec2(0.5, 0.5);
                        u_xlat62.xy = floor(u_xlat62.xy);
                        u_xlat13.xy = u_xlat12.xy * _AdditionalShadowmapSize.zw + (-u_xlat62.xy);
                        ...
                        u_xlat91 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec43, 0.0);
                        vec3 txVec44 = vec3(u_xlat18.zw,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec44, 0.0);
                        u_xlat92 = u_xlat92 * u_xlat24.y;
                        u_xlat91 = u_xlat24.x * u_xlat91 + u_xlat92;
                        vec3 txVec45 = vec3(u_xlat19.xy,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec45, 0.0);
                        u_xlat91 = u_xlat24.z * u_xlat92 + u_xlat91;
                        vec3 txVec46 = vec3(u_xlat21.xy,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec46, 0.0);
                        u_xlat91 = u_xlat24.w * u_xlat92 + u_xlat91;
                        vec3 txVec47 = vec3(u_xlat20.xy,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec47, 0.0);
                        u_xlat91 = u_xlat25.x * u_xlat92 + u_xlat91;
                        vec3 txVec48 = vec3(u_xlat20.zw,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec48, 0.0);
                        u_xlat91 = u_xlat25.y * u_xlat92 + u_xlat91;
                        vec3 txVec49 = vec3(u_xlat73.xy,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec49, 0.0);
                        u_xlat91 = u_xlat25.z * u_xlat92 + u_xlat91;
                        vec3 txVec50 = vec3(u_xlat21.zw,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec50, 0.0);
                        u_xlat91 = u_xlat25.w * u_xlat92 + u_xlat91;
                        vec3 txVec51 = vec3(u_xlat22.xy,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec51, 0.0);
                        u_xlat91 = u_xlat26.x * u_xlat92 + u_xlat91;
                        vec3 txVec52 = vec3(u_xlat22.zw,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec52, 0.0);
                        u_xlat91 = u_xlat26.y * u_xlat92 + u_xlat91;
                        vec3 txVec53 = vec3(u_xlat41.xy,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec53, 0.0);
                        u_xlat91 = u_xlat26.z * u_xlat92 + u_xlat91;
                        vec3 txVec54 = vec3(u_xlat23.xy,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec54, 0.0);
                        u_xlat91 = u_xlat26.w * u_xlat92 + u_xlat91;
                        vec3 txVec55 = vec3(u_xlat17.xy,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec55, 0.0);
                        u_xlat91 = u_xlat13.x * u_xlat92 + u_xlat91;
                        vec3 txVec56 = vec3(u_xlat17.zw,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec56, 0.0);
                        u_xlat91 = u_xlat13.y * u_xlat92 + u_xlat91;
                        vec3 txVec57 = vec3(u_xlat70.xy,u_xlat12.z);
                        u_xlat92 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec57, 0.0);
                        u_xlat91 = u_xlat13.z * u_xlat92 + u_xlat91;
                        ...
                        u_xlat88 = u_xlat13.w * u_xlat62.x + u_xlat91;
                    }
                }
            } else {
        ...
        u_xlat88 = u_xlat83 * u_xlat62.x + u_xlat88;
        ...
        if(u_xlati62 != 0) {
            ...
            u_xlati91 = u_xlati85 << (2 & int(0x1F));
            if(u_xlati89 != 0) {
                u_xlat12.xyz = vs_INTERP7.yyy * _AdditionalLightsWorldToLights[(u_xlati91 + 1) / 4][(u_xlati91 + 1) % 4].xyw;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[u_xlati91 / 4][u_xlati91 % 4].xyw * vs_INTERP7.xxx + u_xlat12.xyz;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[(u_xlati91 + 2) / 4][(u_xlati91 + 2) % 4].xyw * vs_INTERP7.zzz + u_xlat12.xyz;
                u_xlat12.xyz = u_xlat12.xyz + _AdditionalLightsWorldToLights[(u_xlati91 + 3) / 4][(u_xlati91 + 3) % 4].xyw;
                ...
                if(u_xlati62 != 0) {
                    u_xlat62.xy = vs_INTERP7.yy * _AdditionalLightsWorldToLights[(u_xlati91 + 1) / 4][(u_xlati91 + 1) % 4].xy;
                    u_xlat62.xy = _AdditionalLightsWorldToLights[u_xlati91 / 4][u_xlati91 % 4].xy * vs_INTERP7.xx + u_xlat62.xy;
                    u_xlat62.xy = _AdditionalLightsWorldToLights[(u_xlati91 + 2) / 4][(u_xlati91 + 2) % 4].xy * vs_INTERP7.zz + u_xlat62.xy;
                    u_xlat62.xy = u_xlat62.xy + _AdditionalLightsWorldToLights[(u_xlati91 + 3) / 4][(u_xlati91 + 3) % 4].xy;
                    ...
                    u_xlat13 = vs_INTERP7.yyyy * _AdditionalLightsWorldToLights[(u_xlati91 + 1) / 4][(u_xlati91 + 1) % 4];
                    u_xlat13 = _AdditionalLightsWorldToLights[u_xlati91 / 4][u_xlati91 % 4] * vs_INTERP7.xxxx + u_xlat13;
                    u_xlat13 = _AdditionalLightsWorldToLights[(u_xlati91 + 2) / 4][(u_xlati91 + 2) % 4] * vs_INTERP7.zzzz + u_xlat13;
                    u_xlat13 = u_xlat13 + _AdditionalLightsWorldToLights[(u_xlati91 + 3) / 4][(u_xlati91 + 3) % 4];
        ...
        u_xlat85 = u_xlat85 * u_xlat9.x + 1.00001001;
        u_xlat86 = u_xlat86 * u_xlat86;
        u_xlat85 = u_xlat85 * u_xlat85;
        u_xlat86 = max(u_xlat86, 0.100000001);
        u_xlat85 = u_xlat85 * u_xlat86;
        u_xlat85 = u_xlat84 * u_xlat85;
        u_xlat85 = u_xlat30 / u_xlat85;
        u_xlat10.xyz = u_xlat0.xyz * vec3(u_xlat85) + u_xlat6.xyz;
        u_xlat36.xyz = u_xlat10.xyz * u_xlat12.xyz + u_xlat36.xyz;
    }
    u_xlat0.xyz = u_xlat1.xyw * vec3(u_xlat57) + u_xlat7.xyz;
