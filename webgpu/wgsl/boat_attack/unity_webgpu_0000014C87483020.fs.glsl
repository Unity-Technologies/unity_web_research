...
void main()
{
    ...
    u_xlat5.x = (u_xlatb78) ? u_xlat4.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb78) ? u_xlat4.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb78) ? u_xlat4.z : unity_MatrixV[2].z;
    ...
    u_xlat78 = dot(u_xlat1.xyw, u_xlat4.xyz);
    ...
    u_xlat84 = dot((-u_xlat5.xyz), u_xlat1.xyw);
    u_xlat84 = u_xlat84 + u_xlat84;
    u_xlat7.xyz = u_xlat1.xyw * (-vec3(u_xlat84)) + (-u_xlat5.xyz);
    u_xlat84 = dot(u_xlat1.xyw, u_xlat5.xyz);
    u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
    ...
    u_xlat80 = dot(u_xlat1.xyw, _MainLightPosition.xyz);
    ...
    u_xlat78 = inversesqrt(u_xlat78);
    u_xlat34.xyz = vec3(u_xlat78) * u_xlat34.xyz;
    u_xlat78 = dot(u_xlat1.xyw, u_xlat34.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat83 = u_xlat83 * u_xlat85;
        u_xlat85 = dot(u_xlat1.xyw, u_xlat10.xyz);
        u_xlat85 = clamp(u_xlat85, 0.0, 1.0);
        u_xlat83 = u_xlat83 * u_xlat85;
        ...
        u_xlat82 = dot(u_xlat1.xyw, u_xlat9.xyz);
    ...
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat55) + u_xlat7.xyz;
