...
void main()
{
    ...
    u_xlat25.xyz = (u_xlatb25.x) ? u_xlat1.xyz : u_xlat5.xyz;
...
;
    ...
    u_xlat5.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati1 + 1) / 4][(u_xlati1 + 1) % 4].xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[u_xlati1 / 4][u_xlati1 % 4].xyz * vs_INTERP7.xxx + u_xlat5.xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[(u_xlati1 + 2) / 4][(u_xlati1 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat5.xyz;
    u_xlat1.xyz = u_xlat5.xyz + _MainLightWorldToShadow[(u_xlati1 + 3) / 4][(u_xlati1 + 3) % 4].xyz;
    u_xlat77 = vs_INTERP7.y * unity_MatrixV[1].z;
    u_xlat77 = unity_MatrixV[0].z * vs_INTERP7.x + u_xlat77;
    u_xlat77 = unity_MatrixV[2].z * vs_INTERP7.z + u_xlat77;
    ...
    u_xlat78 = u_xlat4.y * u_xlat4.y;
    u_xlat78 = u_xlat4.x * u_xlat4.x + (-u_xlat78);
    u_xlat6.xyz = unity_SHC.xyz * vec3(u_xlat78) + u_xlat8.xyz;
    ...
    u_xlat80 = u_xlat78 * 4.0 + 2.0;
    u_xlat6.x = min(u_xlat7.x, 1.0);
    ...
    if(u_xlatb31.x){
        ...
        if(u_xlatb31.x){
            ...
            vec3 txVec2 = vec3(u_xlat7.xy,u_xlat1.z);
            u_xlat8.z = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec2, 0.0);
            vec3 txVec3 = vec3(u_xlat7.zw,u_xlat1.z);
            u_xlat8.w = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec3, 0.0);
            u_xlat31.x = dot(u_xlat8, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            u_xlatb56 = _MainLightShadowParams.y==2.0;
            if(u_xlatb56){
                u_xlat56.xy = u_xlat1.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat56.xy = floor(u_xlat56.xy);
                u_xlat7.xy = u_xlat1.xy * _MainLightShadowmapSize.zw + (-u_xlat56.xy);
                ...
                u_xlat11 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.ywxw;
                u_xlat12.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat9.zw;
                u_xlat10.w = u_xlat9.y;
                u_xlat9.yw = u_xlat10.yz;
                u_xlat13 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xyzy;
                u_xlat10 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat10.wywz;
                u_xlat9 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xwzw;
                u_xlat14 = u_xlat7.xxxy * u_xlat8.zwyz;
                u_xlat15 = u_xlat7.yyzz * u_xlat8;
                u_xlat56.x = u_xlat7.z * u_xlat8.y;
                ...
                u_xlat31.x = u_xlat56.x * u_xlat7.x + u_xlat81;
            } else {
                u_xlat56.xy = u_xlat1.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat56.xy = floor(u_xlat56.xy);
                u_xlat7.xy = u_xlat1.xy * _MainLightShadowmapSize.zw + (-u_xlat56.xy);
                ...
                u_xlat12 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat11.xyzy;
                u_xlat13.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat11.wy;
                u_xlat8.y = u_xlat11.y;
                u_xlat11.y = u_xlat10.z;
                u_xlat14 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat11.xyzy;
                u_xlat63.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat11.wy;
                u_xlat8.z = u_xlat11.y;
                u_xlat15 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat8.xyxz;
                u_xlat11.y = u_xlat10.w;
                u_xlat16 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat11.xyzy;
                u_xlat33.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat11.wy;
                u_xlat8.w = u_xlat11.y;
                u_xlat17.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat8.xw;
                u_xlat10.xzw = u_xlat11.xzw;
                u_xlat11 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat10.xyzy;
                u_xlat60.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat10.wy;
                u_xlat10.x = u_xlat8.x;
                u_xlat56.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat10.xy;
                ...
                u_xlat8.x = u_xlat18.x * u_xlat8.x + u_xlat83;
                ...
                u_xlat8.x = u_xlat18.z * u_xlat83 + u_xlat8.x;
                ...
                u_xlat8.x = u_xlat18.w * u_xlat83 + u_xlat8.x;
                ...
                u_xlat8.x = u_xlat19.x * u_xlat83 + u_xlat8.x;
                ...
                u_xlat8.x = u_xlat19.y * u_xlat83 + u_xlat8.x;
                ...
                u_xlat8.x = u_xlat19.z * u_xlat83 + u_xlat8.x;
                ...
                u_xlat8.x = u_xlat19.w * u_xlat83 + u_xlat8.x;
                ...
                u_xlat8.x = u_xlat20.x * u_xlat83 + u_xlat8.x;
                ...
                u_xlat8.x = u_xlat20.y * u_xlat83 + u_xlat8.x;
                ...
                u_xlat8.x = u_xlat20.z * u_xlat33.x + u_xlat8.x;
                ...
                u_xlat8.x = u_xlat20.w * u_xlat33.x + u_xlat8.x;
                ...
                u_xlat7.x = u_xlat7.x * u_xlat33.x + u_xlat8.x;
                ...
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
                u_xlat7.x = u_xlat7.z * u_xlat32.x + u_xlat7.x;
                vec3 txVec28 = vec3(u_xlat56.xy,u_xlat1.z);
                u_xlat56.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec28, 0.0);
                u_xlat31.x = u_xlat7.w * u_xlat56.x + u_xlat7.x;
            }
        }
    } else {
    ...
    u_xlat1.x = u_xlat31.x * _MainLightShadowParams.x + u_xlat1.x;
    ...
    if(u_xlatb51){
        ...
        u_xlat51 = (u_xlatb31.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat31.xyz = (u_xlatb31.x) ? u_xlat7.xyz : vec3(u_xlat51);
    } else {
    ...
    u_xlat51 = dot((-u_xlat25.xyz), u_xlat4.xyz);
    u_xlat51 = u_xlat51 + u_xlat51;
    u_xlat7.xyz = u_xlat4.xyz * (-vec3(u_xlat51)) + (-u_xlat25.xyz);
    u_xlat51 = dot(u_xlat4.xyz, u_xlat25.xyz);
    u_xlat51 = clamp(u_xlat51, 0.0, 1.0);
    u_xlat51 = (-u_xlat51) + 1.0;
    u_xlat51 = u_xlat51 * u_xlat51;
    u_xlat51 = u_xlat51 * u_xlat51;
    u_xlat82 = (-u_xlat76) * 0.699999988 + 1.70000005;
    u_xlat76 = u_xlat76 * u_xlat82;
    u_xlat76 = u_xlat76 * 6.0;
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat76);
    u_xlat76 = u_xlat7.w + -1.0;
    ...
    u_xlat7.xyz = u_xlat7.xyz * vec3(u_xlat76);
    u_xlat8.xy = vec2(u_xlat78) * vec2(u_xlat78) + vec2(-1.0, 1.0);
    u_xlat76 = float(1.0) / u_xlat8.y;
    u_xlat33.xyz = (-u_xlat2.xyz) + u_xlat0.xxx;
    u_xlat33.xyz = vec3(u_xlat51) * u_xlat33.xyz + u_xlat2.xyz;
    ...
    u_xlat1.xzw = u_xlat0.xxx * u_xlat31.xyz;
    u_xlat31.xyz = u_xlat25.xyz + _MainLightPosition.xyz;
    u_xlat0.x = dot(u_xlat31.xyz, u_xlat31.xyz);
    u_xlat0.x = max(u_xlat0.x, 1.17549435e-38);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat31.xyz = u_xlat0.xxx * u_xlat31.xyz;
    u_xlat0.x = dot(u_xlat4.xyz, u_xlat31.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat78 = dot(_MainLightPosition.xyz, u_xlat31.xyz);
    u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat8.x + 1.00001001;
    u_xlat78 = u_xlat78 * u_xlat78;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat78 = max(u_xlat78, 0.100000001);
    u_xlat0.x = u_xlat0.x * u_xlat78;
    u_xlat0.x = u_xlat80 * u_xlat0.x;
    u_xlat0.x = u_xlat79 / u_xlat0.x;
    u_xlat31.xyz = u_xlat2.xyz * u_xlat0.xxx + u_xlat3.xyz;
    u_xlat1.xzw = u_xlat1.xzw * u_xlat31.xyz;
    ...
    u_xlatb31.xy = equal(vec4(vec4(_AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat)), vec4(0.0, 1.0, 0.0, 0.0)).xy;
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat33.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati81].www + _AdditionalLightsPosition[u_xlati81].xyz;
        u_xlat82 = dot(u_xlat33.xyz, u_xlat33.xyz);
        u_xlat82 = max(u_xlat82, 6.10351562e-05);
        u_xlat9.x = inversesqrt(u_xlat82);
        u_xlat34.xyz = u_xlat33.xyz * u_xlat9.xxx;
        u_xlat10.x = float(1.0) / float(u_xlat82);
        ...
        if(u_xlatb35.x){
            ...
            if(u_xlatb35.x){
                ...
                u_xlat60.x = u_xlatb11.z ? 1.0 : float(0.0);
                u_xlat60.x = (u_xlatb35.z) ? u_xlat11.y : u_xlat60.x;
                u_xlat35.x = (u_xlatb35.x) ? u_xlat11.x : u_xlat60.x;
                u_xlat60.x = trunc(_AdditionalShadowParams[u_xlati81].w);
                u_xlat35.x = u_xlat35.x + u_xlat60.x;
                u_xlati10 = int(u_xlat35.x);
            }
        ...
        u_xlat10.x = u_xlat26.x * u_xlat35.x + u_xlat10.x;
        u_xlati35 = 1 << (u_xlati81 & int(0x1F));
        u_xlati35 = int(uint(u_xlati35) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati35 != 0) {
            u_xlati35 = int(_AdditionalLightsLightTypes[u_xlati81]);
            u_xlati60 = (u_xlati35 != 0) ? 0 : 1;
            u_xlati85 = u_xlati81 << (2 & int(0x1F));
            if(u_xlati60 != 0) {
                u_xlat11.xyz = vs_INTERP7.yyy * _AdditionalLightsWorldToLights[(u_xlati85 + 1) / 4][(u_xlati85 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati85 / 4][u_xlati85 % 4].xyw * vs_INTERP7.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati85 + 2) / 4][(u_xlati85 + 2) % 4].xyw * vs_INTERP7.zzz + u_xlat11.xyz;
                u_xlat11.xyz = u_xlat11.xyz + _AdditionalLightsWorldToLights[(u_xlati85 + 3) / 4][(u_xlati85 + 3) % 4].xyw;
                ...
                u_xlatb35.x = u_xlati35==1;
                u_xlati35 = u_xlatb35.x ? 1 : int(0);
                if(u_xlati35 != 0) {
                    u_xlat35.xy = vs_INTERP7.yy * _AdditionalLightsWorldToLights[(u_xlati85 + 1) / 4][(u_xlati85 + 1) % 4].xy;
                    u_xlat35.xy = _AdditionalLightsWorldToLights[u_xlati85 / 4][u_xlati85 % 4].xy * vs_INTERP7.xx + u_xlat35.xy;
                    u_xlat35.xy = _AdditionalLightsWorldToLights[(u_xlati85 + 2) / 4][(u_xlati85 + 2) % 4].xy * vs_INTERP7.zz + u_xlat35.xy;
                    u_xlat35.xy = u_xlat35.xy + _AdditionalLightsWorldToLights[(u_xlati85 + 3) / 4][(u_xlati85 + 3) % 4].xy;
                    u_xlat35.xy = u_xlat35.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat35.xy = fract(u_xlat35.xy);
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati81].xy * u_xlat35.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati81].zw;
                } else {
                    u_xlat12 = vs_INTERP7.yyyy * _AdditionalLightsWorldToLights[(u_xlati85 + 1) / 4][(u_xlati85 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati85 / 4][u_xlati85 % 4] * vs_INTERP7.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati85 + 2) / 4][(u_xlati85 + 2) % 4] * vs_INTERP7.zzzz + u_xlat12;
                    u_xlat12 = u_xlat12 + _AdditionalLightsWorldToLights[(u_xlati85 + 3) / 4][(u_xlati85 + 3) % 4];
                    u_xlat35.xyz = u_xlat12.xyz / u_xlat12.www;
                    u_xlat61.x = dot(u_xlat35.xyz, u_xlat35.xyz);
                    u_xlat61.x = inversesqrt(u_xlat61.x);
                    u_xlat35.xyz = u_xlat35.xyz * u_xlat61.xxx;
                    u_xlat61.x = dot(abs(u_xlat35.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat61.x = max(u_xlat61.x, 9.99999997e-07);
                    u_xlat61.x = float(1.0) / float(u_xlat61.x);
                    u_xlat12.xyz = u_xlat35.zxy * u_xlat61.xxx;
                    u_xlat12.x = (-u_xlat12.x);
                    u_xlat12.x = clamp(u_xlat12.x, 0.0, 1.0);
                    u_xlatb37.xy = greaterThanEqual(u_xlat12.yzyy, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    {
                        vec4 hlslcc_movcTemp = u_xlat12;
                        hlslcc_movcTemp.x = (u_xlatb37.x) ? u_xlat12.x : (-u_xlat12.x);
                        hlslcc_movcTemp.y = (u_xlatb37.y) ? u_xlat12.x : (-u_xlat12.x);
                        u_xlat12 = hlslcc_movcTemp;
                    }
                    u_xlat35.xy = u_xlat35.xy * u_xlat61.xx + u_xlat12.xy;
                    u_xlat35.xy = u_xlat35.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat35.x = (u_xlatb31.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat35.xyz = (u_xlatb31.x) ? u_xlat11.xyz : u_xlat35.xxx;
        } else {
            u_xlat35.x = float(1.0);
            u_xlat35.y = float(1.0);
            u_xlat35.z = float(1.0);
        }
        u_xlat35.xyz = u_xlat35.xyz * _AdditionalLightsColor[u_xlati81].xyz;
        u_xlat81 = u_xlat82 * u_xlat10.x;
        u_xlat82 = dot(u_xlat4.xyz, u_xlat34.xyz);
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        u_xlat81 = u_xlat81 * u_xlat82;
        u_xlat10.xyz = vec3(u_xlat81) * u_xlat35.xyz;
        u_xlat33.xyz = u_xlat33.xyz * u_xlat9.xxx + u_xlat25.xyz;
        u_xlat81 = dot(u_xlat33.xyz, u_xlat33.xyz);
        u_xlat81 = max(u_xlat81, 1.17549435e-38);
        u_xlat81 = inversesqrt(u_xlat81);
        u_xlat33.xyz = vec3(u_xlat81) * u_xlat33.xyz;
        u_xlat81 = dot(u_xlat4.xyz, u_xlat33.xyz);
        u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
        u_xlat82 = dot(u_xlat34.xyz, u_xlat33.xyz);
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        ...
        u_xlat33.xyz = u_xlat2.xyz * vec3(u_xlat81) + u_xlat3.xyz;
        u_xlat7.xyz = u_xlat33.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * u_xlat6.xxx + u_xlat1.xzw;
