...
fn main_1() {
  ...
  let x_1537 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1541 : vec4<f32> = x_27.x_Dithering_Params;
  ...
  let x_1555 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1551.x, x_1551.y), x_1554);
  u_xlat18 = x_1555.w;
  let x_1557 : f32 = u_xlat18;
  u_xlat18 = ((x_1557 * 2.0f) + -1.0f);
  let x_1560 : f32 = u_xlat18;
  u_xlatb1 = (x_1560 >= 0.0f);
  let x_1562 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1562);
  let x_1565 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1565)) + 1.0f);
  let x_1569 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1569);
  let x_1571 : f32 = u_xlat18;
  u_xlat18 = (-(x_1571) + 1.0f);
  let x_1574 : f32 = u_xlat18;
  let x_1576 : f32 = u_xlat1.x;
  u_xlat18 = (x_1574 * x_1576);
  let x_1578 : vec3<f32> = u_xlat0;
  let x_1579 : vec3<f32> = (x_1578 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1580 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1579.x, x_1579.y, x_1579.z, x_1580.w);
  let x_1582 : vec3<f32> = u_xlat0;
  let x_1584 : vec3<f32> = log2(abs(x_1582));
  let x_1585 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1584.x, x_1584.y, x_1584.z, x_1585.w);
  let x_1587 : vec4<f32> = u_xlat2;
  let x_1589 : vec3<f32> = (vec3<f32>(x_1587.x, x_1587.y, x_1587.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1590 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1589.x, x_1589.y, x_1589.z, x_1590.w);
  let x_1592 : vec4<f32> = u_xlat2;
  let x_1594 : vec3<f32> = exp2(vec3<f32>(x_1592.x, x_1592.y, x_1592.z));
  let x_1595 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1594.x, x_1594.y, x_1594.z, x_1595.w);
  let x_1597 : vec4<f32> = u_xlat2;
  let x_1600 : vec3<f32> = ((vec3<f32>(x_1597.x, x_1597.y, x_1597.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1601 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1600.x, x_1600.y, x_1600.z, x_1601.w);
  let x_1603 : vec3<f32> = u_xlat0;
  let x_1605 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1603.x, x_1603.y, x_1603.z, x_1603.x));
  u_xlatb0 = vec3<bool>(x_1605.x, x_1605.y, x_1605.z);
  let x_1608 : bool = u_xlatb0.x;
  if (x_1608) {
    let x_1613 : f32 = u_xlat1.x;
    x_1609 = x_1613;
  } else {
    let x_1616 : f32 = u_xlat2.x;
    x_1609 = x_1616;
  }
  let x_1617 : f32 = x_1609;
  u_xlat0.x = x_1617;
  let x_1620 : bool = u_xlatb0.y;
  if (x_1620) {
    let x_1625 : f32 = u_xlat1.y;
    x_1621 = x_1625;
  } else {
    let x_1628 : f32 = u_xlat2.y;
    x_1621 = x_1628;
  }
  let x_1629 : f32 = x_1621;
  u_xlat0.y = x_1629;
  let x_1632 : bool = u_xlatb0.z;
  if (x_1632) {
    let x_1637 : f32 = u_xlat1.z;
    x_1633 = x_1637;
  } else {
  ...
  u_xlat0.z = x_1641;
  let x_1643 : f32 = u_xlat18;
  let x_1648 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1643, x_1643, x_1643) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1648);
  let x_1650 : vec3<f32> = u_xlat0;
  let x_1651 : vec3<f32> = (x_1650 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1652 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1651.x, x_1651.y, x_1651.z, x_1652.w);
  let x_1654 : vec3<f32> = u_xlat0;
  let x_1655 : vec3<f32> = (x_1654 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1656 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1655.x, x_1655.y, x_1655.z, x_1656.w);
  let x_1658 : vec4<f32> = u_xlat2;
  let x_1660 : vec3<f32> = (vec3<f32>(x_1658.x, x_1658.y, x_1658.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1661 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1660.x, x_1660.y, x_1660.z, x_1661.w);
  let x_1663 : vec4<f32> = u_xlat2;
  let x_1666 : vec3<f32> = log2(abs(vec3<f32>(x_1663.x, x_1663.y, x_1663.z)));
  let x_1667 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1666.x, x_1666.y, x_1666.z, x_1667.w);
  let x_1669 : vec4<f32> = u_xlat2;
  let x_1671 : vec3<f32> = (vec3<f32>(x_1669.x, x_1669.y, x_1669.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1672 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1671.x, x_1671.y, x_1671.z, x_1672.w);
  let x_1674 : vec4<f32> = u_xlat2;
  let x_1676 : vec3<f32> = exp2(vec3<f32>(x_1674.x, x_1674.y, x_1674.z));
  let x_1677 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1676.x, x_1676.y, x_1676.z, x_1677.w);
  let x_1679 : vec3<f32> = u_xlat0;
  let x_1681 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1679.x, x_1679.y, x_1679.z, x_1679.x));
  u_xlatb0 = vec3<bool>(x_1681.x, x_1681.y, x_1681.z);
  let x_1684 : bool = u_xlatb0.x;
  if (x_1684) {
  ...
  u_xlat0.x = x_1693;
  let x_1696 : bool = u_xlatb0.y;
  if (x_1696) {
    let x_1701 : f32 = u_xlat1.y;
    x_1697 = x_1701;
  } else {
    let x_1704 : f32 = u_xlat2.y;
    x_1697 = x_1704;
  }
  let x_1705 : f32 = x_1697;
  u_xlat0.y = x_1705;
  let x_1708 : bool = u_xlatb0.z;
  if (x_1708) {
    let x_1713 : f32 = u_xlat1.z;
    x_1709 = x_1713;
  } else {
  ...
  let x_1722 : vec3<f32> = max(x_1721, vec3<f32>(0.0f, 0.0f, 0.0f));
