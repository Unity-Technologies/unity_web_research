...
fn main_1() {
  ...
  let x_1390 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1394 : vec4<f32> = x_38.x_Dithering_Params;
  ...
  let x_1408 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1404.x, x_1404.y), x_1407);
  u_xlat15 = x_1408.w;
  let x_1410 : f32 = u_xlat15;
  u_xlat15 = ((x_1410 * 2.0f) + -1.0f);
  let x_1413 : f32 = u_xlat15;
  u_xlatb1 = (x_1413 >= 0.0f);
  let x_1415 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1415);
  let x_1418 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1418)) + 1.0f);
  let x_1422 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1422);
  let x_1424 : f32 = u_xlat15;
  u_xlat15 = (-(x_1424) + 1.0f);
  let x_1427 : f32 = u_xlat15;
  let x_1429 : f32 = u_xlat1.x;
  u_xlat15 = (x_1427 * x_1429);
  let x_1431 : vec4<f32> = u_xlat0;
  let x_1433 : vec3<f32> = (vec3<f32>(x_1431.x, x_1431.y, x_1431.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1434 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1433.x, x_1433.y, x_1433.z, x_1434.w);
  let x_1436 : vec4<f32> = u_xlat0;
  let x_1439 : vec3<f32> = log2(abs(vec3<f32>(x_1436.x, x_1436.y, x_1436.z)));
  let x_1440 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1439.x, x_1439.y, x_1439.z, x_1440.w);
  let x_1442 : vec4<f32> = u_xlat2;
  let x_1444 : vec3<f32> = (vec3<f32>(x_1442.x, x_1442.y, x_1442.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1445 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1444.x, x_1444.y, x_1444.z, x_1445.w);
  let x_1447 : vec4<f32> = u_xlat2;
  let x_1449 : vec3<f32> = exp2(vec3<f32>(x_1447.x, x_1447.y, x_1447.z));
  let x_1450 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1449.x, x_1449.y, x_1449.z, x_1450.w);
  let x_1452 : vec4<f32> = u_xlat2;
  let x_1455 : vec3<f32> = ((vec3<f32>(x_1452.x, x_1452.y, x_1452.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1456 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1455.x, x_1455.y, x_1455.z, x_1456.w);
  let x_1458 : vec4<f32> = u_xlat0;
  let x_1460 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1458.x, x_1458.y, x_1458.z, x_1458.x));
  ...
  let x_1505 : vec3<f32> = ((vec3<f32>(x_1498, x_1498, x_1498) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1503.x, x_1503.y, x_1503.z));
  let x_1506 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1505.x, x_1505.y, x_1505.z, x_1506.w);
  let x_1508 : vec4<f32> = u_xlat0;
  let x_1510 : vec3<f32> = (vec3<f32>(x_1508.x, x_1508.y, x_1508.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1511 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1510.x, x_1510.y, x_1510.z, x_1511.w);
  let x_1513 : vec4<f32> = u_xlat0;
  let x_1515 : vec3<f32> = (vec3<f32>(x_1513.x, x_1513.y, x_1513.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1516 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1515.x, x_1515.y, x_1515.z, x_1516.w);
  let x_1518 : vec4<f32> = u_xlat2;
  let x_1520 : vec3<f32> = (vec3<f32>(x_1518.x, x_1518.y, x_1518.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1521 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1520.x, x_1520.y, x_1520.z, x_1521.w);
  let x_1523 : vec4<f32> = u_xlat2;
  let x_1526 : vec3<f32> = log2(abs(vec3<f32>(x_1523.x, x_1523.y, x_1523.z)));
  let x_1527 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1526.x, x_1526.y, x_1526.z, x_1527.w);
  let x_1529 : vec4<f32> = u_xlat2;
  let x_1531 : vec3<f32> = (vec3<f32>(x_1529.x, x_1529.y, x_1529.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1541 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1539.x, x_1539.y, x_1539.z, x_1539.x));
