...
fn main_1() {
  ...
  let x_1500 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1504 : vec4<f32> = x_26.x_Dithering_Params;
  ...
  let x_1518 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1514.x, x_1514.y), x_1517);
  u_xlat15 = x_1518.w;
  let x_1520 : f32 = u_xlat15;
  u_xlat15 = ((x_1520 * 2.0f) + -1.0f);
  let x_1523 : f32 = u_xlat15;
  u_xlatb1 = (x_1523 >= 0.0f);
  let x_1525 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1525);
  let x_1528 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1528)) + 1.0f);
  let x_1532 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1532);
  let x_1534 : f32 = u_xlat15;
  u_xlat15 = (-(x_1534) + 1.0f);
  let x_1537 : f32 = u_xlat15;
  let x_1539 : f32 = u_xlat1.x;
  u_xlat15 = (x_1537 * x_1539);
  let x_1541 : vec3<f32> = u_xlat0;
  let x_1542 : vec3<f32> = (x_1541 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1543 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1542.x, x_1542.y, x_1542.z, x_1543.w);
  let x_1545 : vec3<f32> = u_xlat0;
  let x_1547 : vec3<f32> = log2(abs(x_1545));
  let x_1548 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1547.x, x_1547.y, x_1547.z, x_1548.w);
  let x_1550 : vec4<f32> = u_xlat2;
  let x_1552 : vec3<f32> = (vec3<f32>(x_1550.x, x_1550.y, x_1550.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1563 : vec3<f32> = ((vec3<f32>(x_1560.x, x_1560.y, x_1560.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1564 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1563.x, x_1563.y, x_1563.z, x_1564.w);
  let x_1566 : vec3<f32> = u_xlat0;
  let x_1568 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1566.x, x_1566.y, x_1566.z, x_1566.x));
  ...
  u_xlat0 = ((vec3<f32>(x_1606, x_1606, x_1606) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1611);
  let x_1613 : vec3<f32> = u_xlat0;
  let x_1614 : vec3<f32> = (x_1613 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1615 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1614.x, x_1614.y, x_1614.z, x_1615.w);
  let x_1617 : vec3<f32> = u_xlat0;
  let x_1618 : vec3<f32> = (x_1617 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1619 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1618.x, x_1618.y, x_1618.z, x_1619.w);
  let x_1621 : vec4<f32> = u_xlat2;
  let x_1623 : vec3<f32> = (vec3<f32>(x_1621.x, x_1621.y, x_1621.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1624 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1623.x, x_1623.y, x_1623.z, x_1624.w);
  let x_1626 : vec4<f32> = u_xlat2;
  let x_1629 : vec3<f32> = log2(abs(vec3<f32>(x_1626.x, x_1626.y, x_1626.z)));
  let x_1630 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1629.x, x_1629.y, x_1629.z, x_1630.w);
  let x_1632 : vec4<f32> = u_xlat2;
  let x_1634 : vec3<f32> = (vec3<f32>(x_1632.x, x_1632.y, x_1632.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1635 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1634.x, x_1634.y, x_1634.z, x_1635.w);
  let x_1637 : vec4<f32> = u_xlat2;
  let x_1639 : vec3<f32> = exp2(vec3<f32>(x_1637.x, x_1637.y, x_1637.z));
  let x_1640 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1639.x, x_1639.y, x_1639.z, x_1640.w);
  let x_1642 : vec3<f32> = u_xlat0;
  let x_1644 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1642.x, x_1642.y, x_1642.z, x_1642.x));
  ...
  let x_1685 : vec3<f32> = max(x_1684, vec3<f32>(0.0f, 0.0f, 0.0f));
