...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat68 = dot(u_xlat1.xyw, u_xlat5.xyz);
    u_xlat68 = u_xlat68 + 0.5;
    u_xlat5.xyz = vec3(u_xlat68) * u_xlat6.xyz;
    u_xlat68 = max(u_xlat5.w, 9.99999975e-05);
    u_xlat5.xyz = u_xlat5.xyz / vec3(u_xlat68);
    ...
    u_xlatb28 = u_xlatb50 || u_xlatb28;
    u_xlat71 = (u_xlatb28) ? 1.0 : u_xlat71;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu68 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat69 = dot(unity_LightIndices[int(u_xlatu69)], uintBitsToFloat(ImmCB_0[u_xlati71]));
        u_xlati69 = int(u_xlat69);
        u_xlat31.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati69].www + _AdditionalLightsPosition[u_xlati69].xyz;
        ...
        u_xlat71 = u_xlat71 * _AdditionalLightsAttenuation[u_xlati69].x;
        ...
        u_xlat71 = u_xlat71 * u_xlat74;
        u_xlat11.xyz = u_xlat6.xxx * _AdditionalLightsColor[u_xlati69].xyz;
        u_xlat69 = dot(u_xlat1.xyw, u_xlat10.xyz);
        ...
        u_xlat69 = dot(u_xlat1.xyw, u_xlat31.xyz);
        u_xlat69 = clamp(u_xlat69, 0.0, 1.0);
        ...
        u_xlat31.xyz = u_xlat0.xyz * vec3(u_xlat69) + u_xlat7.xyz;
