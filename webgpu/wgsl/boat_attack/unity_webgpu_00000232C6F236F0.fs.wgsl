...
fn main_1() {
  ...
  let x_1799 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1803 : vec4<f32> = x_26.x_Dithering_Params;
  ...
  let x_1817 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1813.x, x_1813.y), x_1816);
  u_xlat21 = x_1817.w;
  let x_1819 : f32 = u_xlat21;
  u_xlat21 = ((x_1819 * 2.0f) + -1.0f);
  let x_1822 : f32 = u_xlat21;
  u_xlatb1 = (x_1822 >= 0.0f);
  let x_1824 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1824);
  let x_1827 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1827)) + 1.0f);
  let x_1831 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1831);
  let x_1833 : f32 = u_xlat21;
  u_xlat21 = (-(x_1833) + 1.0f);
  let x_1836 : f32 = u_xlat21;
  let x_1838 : f32 = u_xlat1.x;
  u_xlat21 = (x_1836 * x_1838);
  let x_1840 : vec3<f32> = u_xlat0;
  let x_1841 : vec3<f32> = (x_1840 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1842 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1841.x, x_1841.y, x_1841.z, x_1842.w);
  let x_1844 : vec3<f32> = u_xlat0;
  let x_1846 : vec3<f32> = log2(abs(x_1844));
  let x_1847 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1846.x, x_1846.y, x_1846.z, x_1847.w);
  let x_1849 : vec4<f32> = u_xlat2;
  let x_1851 : vec3<f32> = (vec3<f32>(x_1849.x, x_1849.y, x_1849.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1852 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1851.x, x_1851.y, x_1851.z, x_1852.w);
  let x_1854 : vec4<f32> = u_xlat2;
  let x_1856 : vec3<f32> = exp2(vec3<f32>(x_1854.x, x_1854.y, x_1854.z));
  let x_1857 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1856.x, x_1856.y, x_1856.z, x_1857.w);
  let x_1859 : vec4<f32> = u_xlat2;
  let x_1862 : vec3<f32> = ((vec3<f32>(x_1859.x, x_1859.y, x_1859.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1863 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1862.x, x_1862.y, x_1862.z, x_1863.w);
  let x_1865 : vec3<f32> = u_xlat0;
  let x_1867 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1865.x, x_1865.y, x_1865.z, x_1865.x));
  u_xlatb0 = vec3<bool>(x_1867.x, x_1867.y, x_1867.z);
  let x_1870 : bool = u_xlatb0.x;
  if (x_1870) {
    let x_1875 : f32 = u_xlat1.x;
    x_1871 = x_1875;
  } else {
    let x_1878 : f32 = u_xlat2.x;
    x_1871 = x_1878;
  }
  let x_1879 : f32 = x_1871;
  u_xlat0.x = x_1879;
  let x_1882 : bool = u_xlatb0.y;
  if (x_1882) {
    let x_1887 : f32 = u_xlat1.y;
    x_1883 = x_1887;
  } else {
    let x_1890 : f32 = u_xlat2.y;
    x_1883 = x_1890;
  }
  let x_1891 : f32 = x_1883;
  u_xlat0.y = x_1891;
  let x_1894 : bool = u_xlatb0.z;
  if (x_1894) {
    let x_1899 : f32 = u_xlat1.z;
    x_1895 = x_1899;
  } else {
    let x_1902 : f32 = u_xlat2.z;
    x_1895 = x_1902;
  }
  let x_1903 : f32 = x_1895;
  u_xlat0.z = x_1903;
  let x_1905 : f32 = u_xlat21;
  let x_1910 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1905, x_1905, x_1905) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1910);
  let x_1912 : vec3<f32> = u_xlat0;
  let x_1913 : vec3<f32> = (x_1912 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1914 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1913.x, x_1913.y, x_1913.z, x_1914.w);
  let x_1916 : vec3<f32> = u_xlat0;
  let x_1917 : vec3<f32> = (x_1916 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1918 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1917.x, x_1917.y, x_1917.z, x_1918.w);
  let x_1920 : vec4<f32> = u_xlat2;
  let x_1922 : vec3<f32> = (vec3<f32>(x_1920.x, x_1920.y, x_1920.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1923 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1922.x, x_1922.y, x_1922.z, x_1923.w);
  let x_1925 : vec4<f32> = u_xlat2;
  let x_1928 : vec3<f32> = log2(abs(vec3<f32>(x_1925.x, x_1925.y, x_1925.z)));
  let x_1929 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1928.x, x_1928.y, x_1928.z, x_1929.w);
  let x_1931 : vec4<f32> = u_xlat2;
  let x_1933 : vec3<f32> = (vec3<f32>(x_1931.x, x_1931.y, x_1931.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1934 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1933.x, x_1933.y, x_1933.z, x_1934.w);
  let x_1936 : vec4<f32> = u_xlat2;
  let x_1938 : vec3<f32> = exp2(vec3<f32>(x_1936.x, x_1936.y, x_1936.z));
  let x_1939 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1938.x, x_1938.y, x_1938.z, x_1939.w);
  let x_1941 : vec3<f32> = u_xlat0;
  let x_1943 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1941.x, x_1941.y, x_1941.z, x_1941.x));
  u_xlatb0 = vec3<bool>(x_1943.x, x_1943.y, x_1943.z);
  let x_1946 : bool = u_xlatb0.x;
  if (x_1946) {
  ...
  u_xlat0.x = x_1955;
  let x_1958 : bool = u_xlatb0.y;
  if (x_1958) {
    let x_1963 : f32 = u_xlat1.y;
    x_1959 = x_1963;
  } else {
    let x_1966 : f32 = u_xlat2.y;
    x_1959 = x_1966;
  }
  let x_1967 : f32 = x_1959;
  u_xlat0.y = x_1967;
  let x_1970 : bool = u_xlatb0.z;
  if (x_1970) {
    let x_1975 : f32 = u_xlat1.z;
    x_1971 = x_1975;
  } else {
    let x_1978 : f32 = u_xlat2.z;
    x_1971 = x_1978;
  }
  let x_1979 : f32 = x_1971;
  u_xlat0.z = x_1979;
  let x_1983 : vec3<f32> = u_xlat0;
  let x_1984 : vec3<f32> = max(x_1983, vec3<f32>(0.0f, 0.0f, 0.0f));
