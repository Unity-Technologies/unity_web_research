...
void main()
{
    ...
    u_xlat12.x = u_xlat4.x * u_xlat4.x + (-u_xlat12.x);
    u_xlat6.xyz = unity_SHC.xyz * u_xlat12.xxx + u_xlat8.xyz;
    u_xlat5.xyz = u_xlat5.xyz + u_xlat6.xyz;
    u_xlat5.xyz = max(u_xlat5.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.863999963, 0.863999963, 0.863999963);
    u_xlat12.xyz = u_xlat1.www * u_xlat2.xyz + vec3(-0.0399999991, -0.0399999991, -0.0399999991);
    u_xlat12.xyz = u_xlat12.xyz * vec3(0.100000001, 0.100000001, 0.100000001) + vec3(0.0399999991, 0.0399999991, 0.0399999991);
    ...
    u_xlat35 = u_xlat13 * 4.0 + 2.0;
    u_xlat36 = min(u_xlat7.x, 1.0);
    ...
    u_xlat6.x = dot((-u_xlat11.xyz), u_xlat4.xyz);
    u_xlat6.x = u_xlat6.x + u_xlat6.x;
    u_xlat6.xyz = u_xlat4.xyz * (-u_xlat6.xxx) + (-u_xlat11.xyz);
    ...
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat2.x);
    ...
    u_xlat6.xyz = u_xlat7.xyz * u_xlat2.xxx;
    u_xlat2.xy = vec2(u_xlat13) * vec2(u_xlat13) + vec2(-1.0, 1.0);
    u_xlat13 = float(1.0) / u_xlat2.y;
    u_xlat7.xyz = (-u_xlat12.xyz) + u_xlat0.xxx;
    u_xlat7.xyz = vec3(u_xlat39) * u_xlat7.xyz + u_xlat12.xyz;
    u_xlat7.xyz = vec3(u_xlat13) * u_xlat7.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat7.xyz;
    u_xlat5.xyz = u_xlat5.xyz * u_xlat3.xyz + u_xlat6.xyz;
    u_xlat0.x = u_xlat37 * unity_LightData.z;
    u_xlat13 = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    u_xlat13 = clamp(u_xlat13, 0.0, 1.0);
    u_xlat0.x = u_xlat0.x * u_xlat13;
    u_xlat6.xyz = u_xlat0.xxx * _MainLightColor.xyz;
    u_xlat7.xyz = u_xlat11.xyz + _MainLightPosition.xyz;
    ...
    u_xlat7.xyz = u_xlat12.xyz * u_xlat0.xxx + u_xlat3.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat7.xyz;
    u_xlat0.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu0 =  uint(int(u_xlat0.x));
    u_xlat13 = u_xlat38 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat13 = clamp(u_xlat13, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat38 = u_xlat24 / u_xlat38;
        u_xlat8.xyz = u_xlat12.xyz * vec3(u_xlat38) + u_xlat3.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat36) + u_xlat6.xyz;
