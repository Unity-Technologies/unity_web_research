#line 1 "Hidden/Universal Render Pipeline/CopyDepth"
static const int _DEPTH_MSAA_2 = 0 ;
static const int _DEPTH_MSAA_8 = 0 ;
static const int _OUTPUT_DEPTH = 0 ;
...
#line 33 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.universal@16.0.1/Shaders/Utils/CopyDepthPass.hlsl"
Texture2DMS < float , 4 > _CameraDepthAttachment ;
...
[ unroll ]
for ( int i = 0 ; i < 4 ; ++ i )
outDepth = min ( _CameraDepthAttachment . Load ( coord , i ) , outDepth ) ;
return outDepth ;
