...
void main()
{
    ...
    u_xlat6.xyz = u_xlat0.xyz * vec3(u_xlat80);
    ...
    if(u_xlatb83){
        ...
        if(u_xlatb83){
            ...
            if(u_xlatb84){
                ...
                vec3 txVec6 = vec3(u_xlat59.xy,vs_INTERP3.z);
                ...
                vec3 txVec15 = vec3(u_xlat59.xy,vs_INTERP3.z);
                ...
                vec3 txVec23 = vec3(u_xlat35.xy,vs_INTERP3.z);
                ...
                vec3 txVec24 = vec3(u_xlat67.xy,vs_INTERP3.z);
                ...
                vec3 txVec27 = vec3(u_xlat62.xy,vs_INTERP3.z);
    ...
    u_xlat84 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat83 = u_xlat83 * _MainLightShadowParams.x + u_xlat84;
    u_xlatb84 = 0.0>=vs_INTERP3.z;
    u_xlatb7 = vs_INTERP3.z>=1.0;
    u_xlatb84 = u_xlatb84 || u_xlatb7;
    u_xlat83 = (u_xlatb84) ? 1.0 : u_xlat83;
    u_xlat7.xyz = vs_INTERP7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat84 = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat7.x = u_xlat84 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat7.x = clamp(u_xlat7.x, 0.0, 1.0);
    u_xlat33 = (-u_xlat83) + 1.0;
    u_xlat83 = u_xlat7.x * u_xlat33 + u_xlat83;
    u_xlat7.x = dot((-u_xlat1.xyw), u_xlat4.xyz);
    u_xlat7.x = u_xlat7.x + u_xlat7.x;
    u_xlat7.xyz = u_xlat4.xyz * (-u_xlat7.xxx) + (-u_xlat1.xyw);
    u_xlat85 = dot(u_xlat4.xyz, u_xlat1.xyw);
    u_xlat85 = clamp(u_xlat85, 0.0, 1.0);
    u_xlat85 = (-u_xlat85) + 1.0;
    u_xlat85 = u_xlat85 * u_xlat85;
    u_xlat85 = u_xlat85 * u_xlat85;
    u_xlat8.x = (-u_xlat80) * 0.699999988 + 1.70000005;
    u_xlat2.w = u_xlat80 * u_xlat8.x;
    u_xlat2 = u_xlat2 * vec4(14.0, 14.0, 14.0, 6.0);
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat2.w);
    ...
    u_xlat80 = u_xlat83 * unity_LightData.z;
    u_xlat3.x = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat80 = u_xlat80 * u_xlat3.x;
    u_xlat7.xyz = vec3(u_xlat80) * _MainLightColor.xyz;
    u_xlat34.xyz = u_xlat1.xyw + _MainLightPosition.xyz;
    u_xlat80 = dot(u_xlat34.xyz, u_xlat34.xyz);
    u_xlat80 = max(u_xlat80, 1.17549435e-38);
    u_xlat80 = inversesqrt(u_xlat80);
    u_xlat34.xyz = vec3(u_xlat80) * u_xlat34.xyz;
    u_xlat80 = dot(u_xlat4.xyz, u_xlat34.xyz);
    u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
    u_xlat3.x = dot(_MainLightPosition.xyz, u_xlat34.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    ...
    u_xlat34.xyz = u_xlat0.xyz * vec3(u_xlat80) + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat34.xyz;
    u_xlat80 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu80 =  uint(int(u_xlat80));
    u_xlat3.x = u_xlat84 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu80 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlatb88){
            ...
            u_xlat11 = vs_INTERP7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati87 + 1) / 4][(u_xlati87 + 1) % 4];
            u_xlat11 = _AdditionalLightsWorldToShadow[u_xlati87 / 4][u_xlati87 % 4] * vs_INTERP7.xxxx + u_xlat11;
            u_xlat11 = _AdditionalLightsWorldToShadow[(u_xlati87 + 2) / 4][(u_xlati87 + 2) % 4] * vs_INTERP7.zzzz + u_xlat11;
        ...
        u_xlat87 = u_xlat3.x * u_xlat88 + u_xlat87;
        u_xlat84 = u_xlat84 * u_xlat87;
        u_xlat87 = dot(u_xlat4.xyz, u_xlat10.xyz);
        u_xlat87 = clamp(u_xlat87, 0.0, 1.0);
        u_xlat84 = u_xlat84 * u_xlat87;
        u_xlat11.xyz = vec3(u_xlat84) * _AdditionalLightsColor[u_xlati83].xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat85) + u_xlat1.xyw;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat83) + u_xlat6.xyz;
        u_xlat34.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat34.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat55) + u_xlat7.xyz;
