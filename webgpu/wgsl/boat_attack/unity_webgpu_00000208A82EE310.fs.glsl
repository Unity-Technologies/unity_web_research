...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat48 = dot((-u_xlat15.xyz), u_xlat2.xyz);
    u_xlat48 = u_xlat48 + u_xlat48;
    u_xlat7.xyz = u_xlat2.xyz * (-vec3(u_xlat48)) + (-u_xlat15.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu45)].www + _AdditionalLightsPosition[int(u_xlatu45)].xyz;
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat48) + u_xlat15.xyz;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat45) + u_xlat5.xyz;
        u_xlat22.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat22.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * u_xlat4.xxx + u_xlat6.xyz;
