...
fn main_1() {
  ...
  u_xlat0.z = x_1049;
  let x_1051 : vec2<f32> = vs_TEXCOORD0;
  let x_1054 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1058 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1060 : vec2<f32> = ((x_1051 * vec2<f32>(x_1054.x, x_1054.y)) + vec2<f32>(x_1058.z, x_1058.w));
  let x_1061 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1060.x, x_1060.y, x_1061.z, x_1061.w);
  let x_1068 : vec4<f32> = u_xlat1;
  let x_1071 : f32 = x_25.x_GlobalMipBias.x;
  let x_1072 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1068.x, x_1068.y), x_1071);
  u_xlat15 = x_1072.w;
  let x_1074 : f32 = u_xlat15;
  u_xlat15 = ((x_1074 * 2.0f) + -1.0f);
  let x_1078 : f32 = u_xlat15;
  u_xlatb1.x = (x_1078 >= 0.0f);
  let x_1082 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1082);
  let x_1085 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1085)) + 1.0f);
  let x_1089 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1089);
  let x_1091 : f32 = u_xlat15;
  u_xlat15 = (-(x_1091) + 1.0f);
  let x_1094 : f32 = u_xlat15;
  let x_1096 : f32 = u_xlat1.x;
  u_xlat15 = (x_1094 * x_1096);
  let x_1098 : vec4<f32> = u_xlat0;
  let x_1100 : vec3<f32> = (vec3<f32>(x_1098.x, x_1098.y, x_1098.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1101 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1100.x, x_1100.y, x_1100.z, x_1101.w);
  let x_1103 : vec4<f32> = u_xlat0;
  let x_1106 : vec3<f32> = log2(abs(vec3<f32>(x_1103.x, x_1103.y, x_1103.z)));
  let x_1107 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1106.x, x_1106.y, x_1106.z, x_1107.w);
  let x_1109 : vec4<f32> = u_xlat2;
  let x_1111 : vec3<f32> = (vec3<f32>(x_1109.x, x_1109.y, x_1109.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1122 : vec3<f32> = ((vec3<f32>(x_1119.x, x_1119.y, x_1119.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1123 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1122.x, x_1122.y, x_1122.z, x_1123.w);
  let x_1125 : vec4<f32> = u_xlat0;
  let x_1127 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1125.x, x_1125.y, x_1125.z, x_1125.x));
  u_xlatb0 = vec3<bool>(x_1127.x, x_1127.y, x_1127.z);
  let x_1130 : bool = u_xlatb0.x;
  if (x_1130) {
  ...
  u_xlat0.z = x_1163;
  let x_1165 : f32 = u_xlat15;
  let x_1170 : vec4<f32> = u_xlat0;
  let x_1172 : vec3<f32> = ((vec3<f32>(x_1165, x_1165, x_1165) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1170.x, x_1170.y, x_1170.z));
  let x_1173 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1172.x, x_1172.y, x_1172.z, x_1173.w);
  let x_1175 : vec4<f32> = u_xlat0;
  let x_1177 : vec3<f32> = (vec3<f32>(x_1175.x, x_1175.y, x_1175.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1178 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1177.x, x_1177.y, x_1177.z, x_1178.w);
  let x_1180 : vec4<f32> = u_xlat0;
  let x_1182 : vec3<f32> = (vec3<f32>(x_1180.x, x_1180.y, x_1180.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1183 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1182.x, x_1182.y, x_1182.z, x_1183.w);
  let x_1185 : vec4<f32> = u_xlat2;
  let x_1187 : vec3<f32> = (vec3<f32>(x_1185.x, x_1185.y, x_1185.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1188 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1187.x, x_1187.y, x_1187.z, x_1188.w);
  let x_1190 : vec4<f32> = u_xlat2;
  let x_1193 : vec3<f32> = log2(abs(vec3<f32>(x_1190.x, x_1190.y, x_1190.z)));
  let x_1194 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1193.x, x_1193.y, x_1193.z, x_1194.w);
  let x_1196 : vec4<f32> = u_xlat2;
  let x_1198 : vec3<f32> = (vec3<f32>(x_1196.x, x_1196.y, x_1196.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1199 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1198.x, x_1198.y, x_1198.z, x_1199.w);
  let x_1201 : vec4<f32> = u_xlat2;
  let x_1203 : vec3<f32> = exp2(vec3<f32>(x_1201.x, x_1201.y, x_1201.z));
  let x_1204 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1203.x, x_1203.y, x_1203.z, x_1204.w);
  let x_1206 : vec4<f32> = u_xlat0;
  let x_1208 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1206.x, x_1206.y, x_1206.z, x_1206.x));
  u_xlatb0 = vec3<bool>(x_1208.x, x_1208.y, x_1208.z);
  let x_1211 : bool = u_xlatb0.x;
  if (x_1211) {
  ...
  let x_1251 : vec3<f32> = max(vec3<f32>(x_1248.x, x_1248.y, x_1248.z), vec3<f32>(0.0f, 0.0f, 0.0f));
