...
fn main_1() {
  ...
  let x_1804 : f32 = u_xlat36;
  let x_1806 : vec3<f32> = u_xlat1;
  let x_1808 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1804, x_1804, x_1804) * x_1806) + x_1808);
  let x_1813 : f32 = vs_TEXCOORD4.x;
  let x_1815 : f32 = vs_TEXCOORD4.x;
  u_xlat36 = (x_1813 * -(x_1815));
  let x_1818 : f32 = u_xlat36;
  u_xlat36 = exp2(x_1818);
  let x_1820 : vec3<f32> = u_xlat0;
  let x_1823 : vec4<f32> = x_39.unity_FogColor;
  u_xlat0 = (x_1820 + -(vec3<f32>(x_1823.x, x_1823.y, x_1823.z)));
  let x_1829 : f32 = u_xlat36;
  let x_1831 : vec3<f32> = u_xlat0;
  let x_1834 : vec4<f32> = x_39.unity_FogColor;
  let x_1836 : vec3<f32> = ((vec3<f32>(x_1829, x_1829, x_1829) * x_1831) + vec3<f32>(x_1834.x, x_1834.y, x_1834.z));
