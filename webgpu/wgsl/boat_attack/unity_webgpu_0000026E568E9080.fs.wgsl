...
fn main_1() {
  ...
  let x_2067 : vec3<f32> = (vec3<f32>(x_2065.x, x_2065.y, x_2065.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2068 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2067.x, x_2067.y, x_2067.z, x_2068.w);
  let x_2070 : vec4<f32> = u_xlat0;
  let x_2073 : vec3<f32> = log2(abs(vec3<f32>(x_2070.x, x_2070.y, x_2070.z)));
  let x_2074 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2073.x, x_2073.y, x_2073.z, x_2074.w);
  let x_2076 : vec4<f32> = u_xlat2;
  let x_2078 : vec3<f32> = (vec3<f32>(x_2076.x, x_2076.y, x_2076.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2079 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2078.x, x_2078.y, x_2078.z, x_2079.w);
  let x_2081 : vec4<f32> = u_xlat2;
  let x_2083 : vec3<f32> = exp2(vec3<f32>(x_2081.x, x_2081.y, x_2081.z));
  let x_2084 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2083.x, x_2083.y, x_2083.z, x_2084.w);
  let x_2086 : vec4<f32> = u_xlat2;
  let x_2089 : vec3<f32> = ((vec3<f32>(x_2086.x, x_2086.y, x_2086.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2090 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2089.x, x_2089.y, x_2089.z, x_2090.w);
  let x_2092 : vec4<f32> = u_xlat0;
  let x_2094 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2092.x, x_2092.y, x_2092.z, x_2092.x));
  u_xlatb0 = vec3<bool>(x_2094.x, x_2094.y, x_2094.z);
  let x_2097 : bool = u_xlatb0.x;
  if (x_2097) {
    let x_2102 : f32 = u_xlat1.x;
    x_2098 = x_2102;
  } else {
    let x_2105 : f32 = u_xlat2.x;
    x_2098 = x_2105;
  }
  let x_2106 : f32 = x_2098;
  u_xlat0.x = x_2106;
  let x_2109 : bool = u_xlatb0.y;
  if (x_2109) {
    let x_2114 : f32 = u_xlat1.y;
    x_2110 = x_2114;
  } else {
    let x_2117 : f32 = u_xlat2.y;
    x_2110 = x_2117;
  }
  let x_2118 : f32 = x_2110;
  u_xlat0.y = x_2118;
  let x_2121 : bool = u_xlatb0.z;
  if (x_2121) {
  ...
  let x_2130 : f32 = x_2122;
  u_xlat0.z = x_2130;
  let x_2132 : vec2<f32> = vs_TEXCOORD0;
  let x_2135 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2139 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2141 : vec2<f32> = ((x_2132 * vec2<f32>(x_2135.x, x_2135.y)) + vec2<f32>(x_2139.z, x_2139.w));
  let x_2142 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2141.x, x_2141.y, x_2142.z, x_2142.w);
  let x_2149 : vec4<f32> = u_xlat1;
  let x_2152 : f32 = x_25.x_GlobalMipBias.x;
  let x_2153 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2149.x, x_2149.y), x_2152);
  u_xlat21 = x_2153.w;
  let x_2155 : f32 = u_xlat21;
  u_xlat21 = ((x_2155 * 2.0f) + -1.0f);
  let x_2158 : f32 = u_xlat21;
  u_xlatb1 = (x_2158 >= 0.0f);
  let x_2160 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2160);
  let x_2163 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2163)) + 1.0f);
  let x_2167 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2167);
  let x_2169 : f32 = u_xlat21;
  u_xlat21 = (-(x_2169) + 1.0f);
  let x_2172 : f32 = u_xlat21;
  let x_2174 : f32 = u_xlat1.x;
  u_xlat21 = (x_2172 * x_2174);
  let x_2176 : vec4<f32> = u_xlat0;
  let x_2178 : vec3<f32> = (vec3<f32>(x_2176.x, x_2176.y, x_2176.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2179 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2178.x, x_2178.y, x_2178.z, x_2179.w);
  let x_2181 : vec4<f32> = u_xlat0;
  let x_2184 : vec3<f32> = log2(abs(vec3<f32>(x_2181.x, x_2181.y, x_2181.z)));
  let x_2185 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2184.x, x_2184.y, x_2184.z, x_2185.w);
  let x_2187 : vec4<f32> = u_xlat2;
  let x_2189 : vec3<f32> = (vec3<f32>(x_2187.x, x_2187.y, x_2187.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2190 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2189.x, x_2189.y, x_2189.z, x_2190.w);
  let x_2192 : vec4<f32> = u_xlat2;
  let x_2194 : vec3<f32> = exp2(vec3<f32>(x_2192.x, x_2192.y, x_2192.z));
  let x_2195 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2194.x, x_2194.y, x_2194.z, x_2195.w);
  let x_2197 : vec4<f32> = u_xlat2;
  let x_2200 : vec3<f32> = ((vec3<f32>(x_2197.x, x_2197.y, x_2197.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2201 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2200.x, x_2200.y, x_2200.z, x_2201.w);
  let x_2203 : vec4<f32> = u_xlat0;
  let x_2205 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2203.x, x_2203.y, x_2203.z, x_2203.x));
  u_xlatb0 = vec3<bool>(x_2205.x, x_2205.y, x_2205.z);
  let x_2208 : bool = u_xlatb0.x;
  if (x_2208) {
    let x_2213 : f32 = u_xlat1.x;
    x_2209 = x_2213;
  } else {
    let x_2216 : f32 = u_xlat2.x;
    x_2209 = x_2216;
  }
  let x_2217 : f32 = x_2209;
  u_xlat0.x = x_2217;
  let x_2220 : bool = u_xlatb0.y;
  if (x_2220) {
    let x_2225 : f32 = u_xlat1.y;
    x_2221 = x_2225;
  } else {
    let x_2228 : f32 = u_xlat2.y;
    x_2221 = x_2228;
  }
  let x_2229 : f32 = x_2221;
  u_xlat0.y = x_2229;
  let x_2232 : bool = u_xlatb0.z;
  if (x_2232) {
    let x_2237 : f32 = u_xlat1.z;
    x_2233 = x_2237;
  } else {
    let x_2240 : f32 = u_xlat2.z;
    x_2233 = x_2240;
  }
  let x_2241 : f32 = x_2233;
  u_xlat0.z = x_2241;
  let x_2243 : f32 = u_xlat21;
  let x_2248 : vec4<f32> = u_xlat0;
  let x_2250 : vec3<f32> = ((vec3<f32>(x_2243, x_2243, x_2243) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2248.x, x_2248.y, x_2248.z));
  let x_2251 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2250.x, x_2250.y, x_2250.z, x_2251.w);
  let x_2253 : vec4<f32> = u_xlat0;
  let x_2255 : vec3<f32> = (vec3<f32>(x_2253.x, x_2253.y, x_2253.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2256 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2255.x, x_2255.y, x_2255.z, x_2256.w);
  let x_2258 : vec4<f32> = u_xlat0;
  let x_2260 : vec3<f32> = (vec3<f32>(x_2258.x, x_2258.y, x_2258.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2261 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2260.x, x_2260.y, x_2260.z, x_2261.w);
  let x_2263 : vec4<f32> = u_xlat2;
  let x_2265 : vec3<f32> = (vec3<f32>(x_2263.x, x_2263.y, x_2263.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2266 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2265.x, x_2265.y, x_2265.z, x_2266.w);
  let x_2268 : vec4<f32> = u_xlat2;
  let x_2271 : vec3<f32> = log2(abs(vec3<f32>(x_2268.x, x_2268.y, x_2268.z)));
  let x_2272 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2271.x, x_2271.y, x_2271.z, x_2272.w);
  let x_2274 : vec4<f32> = u_xlat2;
  let x_2276 : vec3<f32> = (vec3<f32>(x_2274.x, x_2274.y, x_2274.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2277 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2276.x, x_2276.y, x_2276.z, x_2277.w);
  let x_2279 : vec4<f32> = u_xlat2;
  let x_2281 : vec3<f32> = exp2(vec3<f32>(x_2279.x, x_2279.y, x_2279.z));
  let x_2282 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2281.x, x_2281.y, x_2281.z, x_2282.w);
  let x_2284 : vec4<f32> = u_xlat0;
  let x_2286 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2284.x, x_2284.y, x_2284.z, x_2284.x));
  u_xlatb0 = vec3<bool>(x_2286.x, x_2286.y, x_2286.z);
  let x_2289 : bool = u_xlatb0.x;
  if (x_2289) {
    let x_2294 : f32 = u_xlat1.x;
    x_2290 = x_2294;
  } else {
  ...
  u_xlat0.x = x_2298;
  let x_2301 : bool = u_xlatb0.y;
  if (x_2301) {
    let x_2306 : f32 = u_xlat1.y;
    x_2302 = x_2306;
  } else {
    let x_2309 : f32 = u_xlat2.y;
    x_2302 = x_2309;
  }
  let x_2310 : f32 = x_2302;
  u_xlat0.y = x_2310;
  let x_2313 : bool = u_xlatb0.z;
  if (x_2313) {
    let x_2318 : f32 = u_xlat1.z;
    x_2314 = x_2318;
  } else {
    let x_2321 : f32 = u_xlat2.z;
    x_2314 = x_2321;
  }
  let x_2322 : f32 = x_2314;
  u_xlat0.z = x_2322;
  let x_2326 : vec4<f32> = u_xlat0;
  let x_2328 : vec3<f32> = max(vec3<f32>(x_2326.x, x_2326.y, x_2326.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2329 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2328.x, x_2328.y, x_2328.z, x_2329.w);
  SV_Target0.w = 1.0f;
  return;
}
