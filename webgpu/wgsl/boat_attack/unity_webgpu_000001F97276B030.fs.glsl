...
;
    ...
    u_xlat19.x = (-u_xlat15.x) + 1.0;
    u_xlat15.x = u_xlat43 * u_xlat19.x + u_xlat15.x;
    ...
    if(u_xlatb43){
        ...
        u_xlat43 = (u_xlatb19.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat19.xyz = (u_xlatb19.x) ? u_xlat6.xyz : vec3(u_xlat43);
    } else {
    ...
    u_xlat7.xyz = u_xlat2.xyz * (-vec3(u_xlat43)) + (-u_xlat6.xyz);
    ...
    u_xlat42 = dot(u_xlat2.xyz, u_xlat19.xyz);
    u_xlat42 = clamp(u_xlat42, 0.0, 1.0);
    u_xlat44 = dot(_MainLightPosition.xyz, u_xlat19.xyz);
    ...
    u_xlat19.xyz = u_xlat0.xyz * vec3(u_xlat42) + u_xlat18.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat35 = u_xlat35 * _AdditionalLightsAttenuation[u_xlati48].x;
        ...
        u_xlat51 = u_xlat29 * u_xlat52 + u_xlat51;
        ...
        if(u_xlati52 != 0) {
            ...
            u_xlat52 = (u_xlatb7.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb7.x) ? u_xlat11.xyz : vec3(u_xlat52);
        } else {
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat48) + u_xlat18.xyz;
        u_xlat22.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat22.xyz;
    }
    u_xlat0.xyz = u_xlat19.xyz * u_xlat1.xyw + u_xlat17.xyz;
