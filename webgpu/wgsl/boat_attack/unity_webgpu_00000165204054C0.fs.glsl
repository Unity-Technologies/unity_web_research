...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat22 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat22 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat22;
    u_xlat22 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat22;
    u_xlat22 = u_xlat22 + unity_MatrixV[3].z;
    u_xlat22 = (-u_xlat22) + (-_ProjectionParams.y);
    u_xlat22 = max(u_xlat22, 0.0);
    u_xlat22 = u_xlat22 * unity_FogParams.x;
    ...
    u_xlat23 = u_xlat3.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat3.z = (-u_xlat23) + 1.0;
    u_xlat23 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat3.xz, _GlobalMipBias.x).x;
    ...
    u_xlat23 = u_xlat10.x * unity_LightData.z;
    ...
    u_xlat7.xyz = u_xlat2.xyz * u_xlat0.yzw + u_xlat10.xyz;
