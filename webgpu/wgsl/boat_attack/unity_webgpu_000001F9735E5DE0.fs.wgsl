...
fn main_1() {
  ...
  let x_1965 : vec3<f32> = u_xlat7;
  let x_1966 : vec3<f32> = ((vec3<f32>(x_1960.x, x_1960.x, x_1960.x) * vec3<f32>(x_1962.x, x_1962.y, x_1962.z)) + x_1965);
  let x_1967 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1966.x, x_1966.y, x_1966.z, x_1967.w);
  SV_Target0.w = 1.0f;
  return;
}
