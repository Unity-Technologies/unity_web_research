...
fn main_1() {
  ...
  let x_1717 : vec3<f32> = (vec3<f32>(x_1715.x, x_1715.y, x_1715.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1718 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1717.x, x_1717.y, x_1717.z, x_1718.w);
  let x_1720 : vec4<f32> = u_xlat0;
  let x_1723 : vec3<f32> = log2(abs(vec3<f32>(x_1720.x, x_1720.y, x_1720.z)));
  let x_1724 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1723.x, x_1723.y, x_1723.z, x_1724.w);
  let x_1726 : vec4<f32> = u_xlat2;
  let x_1728 : vec3<f32> = (vec3<f32>(x_1726.x, x_1726.y, x_1726.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1729 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1728.x, x_1728.y, x_1728.z, x_1729.w);
  let x_1731 : vec4<f32> = u_xlat2;
  let x_1733 : vec3<f32> = exp2(vec3<f32>(x_1731.x, x_1731.y, x_1731.z));
  let x_1734 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1733.x, x_1733.y, x_1733.z, x_1734.w);
  let x_1736 : vec4<f32> = u_xlat2;
  let x_1739 : vec3<f32> = ((vec3<f32>(x_1736.x, x_1736.y, x_1736.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1740 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1739.x, x_1739.y, x_1739.z, x_1740.w);
  let x_1742 : vec4<f32> = u_xlat0;
  let x_1744 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1742.x, x_1742.y, x_1742.z, x_1742.x));
  u_xlatb0 = vec3<bool>(x_1744.x, x_1744.y, x_1744.z);
  let x_1747 : bool = u_xlatb0.x;
  if (x_1747) {
  ...
  u_xlat0.x = x_1756;
  let x_1759 : bool = u_xlatb0.y;
  if (x_1759) {
    let x_1764 : f32 = u_xlat1.y;
    x_1760 = x_1764;
  } else {
    let x_1767 : f32 = u_xlat2.y;
    x_1760 = x_1767;
  }
  let x_1768 : f32 = x_1760;
  u_xlat0.y = x_1768;
  let x_1771 : bool = u_xlatb0.z;
  if (x_1771) {
    let x_1776 : f32 = u_xlat1.z;
    x_1772 = x_1776;
  } else {
  ...
  u_xlat0.z = x_1780;
  let x_1782 : vec2<f32> = vs_TEXCOORD0;
  let x_1785 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1789 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1791 : vec2<f32> = ((x_1782 * vec2<f32>(x_1785.x, x_1785.y)) + vec2<f32>(x_1789.z, x_1789.w));
  let x_1792 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1791.x, x_1791.y, x_1792.z, x_1792.w);
  let x_1799 : vec4<f32> = u_xlat1;
  let x_1802 : f32 = x_38.x_GlobalMipBias.x;
  let x_1803 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1799.x, x_1799.y), x_1802);
  u_xlat18 = x_1803.w;
  let x_1805 : f32 = u_xlat18;
  u_xlat18 = ((x_1805 * 2.0f) + -1.0f);
  let x_1808 : f32 = u_xlat18;
  u_xlatb1 = (x_1808 >= 0.0f);
  let x_1810 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1810);
  let x_1813 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1813)) + 1.0f);
  let x_1817 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1817);
  let x_1819 : f32 = u_xlat18;
  u_xlat18 = (-(x_1819) + 1.0f);
  let x_1822 : f32 = u_xlat18;
  let x_1824 : f32 = u_xlat1.x;
  u_xlat18 = (x_1822 * x_1824);
  let x_1826 : vec4<f32> = u_xlat0;
  let x_1828 : vec3<f32> = (vec3<f32>(x_1826.x, x_1826.y, x_1826.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1829 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1828.x, x_1828.y, x_1828.z, x_1829.w);
  let x_1831 : vec4<f32> = u_xlat0;
  let x_1834 : vec3<f32> = log2(abs(vec3<f32>(x_1831.x, x_1831.y, x_1831.z)));
  let x_1835 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1834.x, x_1834.y, x_1834.z, x_1835.w);
  let x_1837 : vec4<f32> = u_xlat2;
  let x_1839 : vec3<f32> = (vec3<f32>(x_1837.x, x_1837.y, x_1837.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1840 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1839.x, x_1839.y, x_1839.z, x_1840.w);
  let x_1842 : vec4<f32> = u_xlat2;
  let x_1844 : vec3<f32> = exp2(vec3<f32>(x_1842.x, x_1842.y, x_1842.z));
  let x_1845 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1844.x, x_1844.y, x_1844.z, x_1845.w);
  let x_1847 : vec4<f32> = u_xlat2;
  let x_1850 : vec3<f32> = ((vec3<f32>(x_1847.x, x_1847.y, x_1847.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1851 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1850.x, x_1850.y, x_1850.z, x_1851.w);
  let x_1853 : vec4<f32> = u_xlat0;
  let x_1855 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1853.x, x_1853.y, x_1853.z, x_1853.x));
  u_xlatb0 = vec3<bool>(x_1855.x, x_1855.y, x_1855.z);
  let x_1858 : bool = u_xlatb0.x;
  if (x_1858) {
  ...
  u_xlat0.x = x_1867;
  let x_1870 : bool = u_xlatb0.y;
  if (x_1870) {
    let x_1875 : f32 = u_xlat1.y;
    x_1871 = x_1875;
  } else {
    let x_1878 : f32 = u_xlat2.y;
    x_1871 = x_1878;
  }
  let x_1879 : f32 = x_1871;
  u_xlat0.y = x_1879;
  let x_1882 : bool = u_xlatb0.z;
  if (x_1882) {
    let x_1887 : f32 = u_xlat1.z;
    x_1883 = x_1887;
  } else {
    let x_1890 : f32 = u_xlat2.z;
    x_1883 = x_1890;
  }
  let x_1891 : f32 = x_1883;
  u_xlat0.z = x_1891;
  let x_1893 : f32 = u_xlat18;
  let x_1898 : vec4<f32> = u_xlat0;
  let x_1900 : vec3<f32> = ((vec3<f32>(x_1893, x_1893, x_1893) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1898.x, x_1898.y, x_1898.z));
  let x_1901 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1900.x, x_1900.y, x_1900.z, x_1901.w);
  let x_1903 : vec4<f32> = u_xlat0;
  let x_1905 : vec3<f32> = (vec3<f32>(x_1903.x, x_1903.y, x_1903.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1906 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1905.x, x_1905.y, x_1905.z, x_1906.w);
  let x_1908 : vec4<f32> = u_xlat0;
  let x_1910 : vec3<f32> = (vec3<f32>(x_1908.x, x_1908.y, x_1908.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1911 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1910.x, x_1910.y, x_1910.z, x_1911.w);
  let x_1913 : vec4<f32> = u_xlat2;
  let x_1915 : vec3<f32> = (vec3<f32>(x_1913.x, x_1913.y, x_1913.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1916 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1915.x, x_1915.y, x_1915.z, x_1916.w);
  let x_1918 : vec4<f32> = u_xlat2;
  let x_1921 : vec3<f32> = log2(abs(vec3<f32>(x_1918.x, x_1918.y, x_1918.z)));
  let x_1922 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1921.x, x_1921.y, x_1921.z, x_1922.w);
  let x_1924 : vec4<f32> = u_xlat2;
  let x_1926 : vec3<f32> = (vec3<f32>(x_1924.x, x_1924.y, x_1924.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1927 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1926.x, x_1926.y, x_1926.z, x_1927.w);
  let x_1929 : vec4<f32> = u_xlat2;
  let x_1931 : vec3<f32> = exp2(vec3<f32>(x_1929.x, x_1929.y, x_1929.z));
  let x_1932 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1931.x, x_1931.y, x_1931.z, x_1932.w);
  let x_1934 : vec4<f32> = u_xlat0;
  let x_1936 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1934.x, x_1934.y, x_1934.z, x_1934.x));
  u_xlatb0 = vec3<bool>(x_1936.x, x_1936.y, x_1936.z);
  let x_1939 : bool = u_xlatb0.x;
  if (x_1939) {
    let x_1944 : f32 = u_xlat1.x;
    x_1940 = x_1944;
  } else {
    let x_1947 : f32 = u_xlat2.x;
    x_1940 = x_1947;
  }
  let x_1948 : f32 = x_1940;
  u_xlat0.x = x_1948;
  let x_1951 : bool = u_xlatb0.y;
  if (x_1951) {
    let x_1956 : f32 = u_xlat1.y;
    x_1952 = x_1956;
  } else {
    let x_1959 : f32 = u_xlat2.y;
    x_1952 = x_1959;
  }
  let x_1960 : f32 = x_1952;
  u_xlat0.y = x_1960;
  let x_1963 : bool = u_xlatb0.z;
  if (x_1963) {
    let x_1968 : f32 = u_xlat1.z;
    x_1964 = x_1968;
  } else {
    let x_1971 : f32 = u_xlat2.z;
    x_1964 = x_1971;
  }
  let x_1972 : f32 = x_1964;
  u_xlat0.z = x_1972;
  let x_1976 : vec4<f32> = u_xlat0;
  let x_1978 : vec3<f32> = max(vec3<f32>(x_1976.x, x_1976.y, x_1976.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1979 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1978.x, x_1978.y, x_1978.z, x_1979.w);
  SV_Target0.w = 1.0f;
  return;
}
