...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat14.xyz = (u_xlatb14.x) ? u_xlat1.xyz : u_xlat5.xyz;
    ...
    u_xlat6.xyz = unity_SHC.xyz * u_xlat15.xxx + u_xlat8.xyz;
    ...
    u_xlat15.xyz = u_xlat1.www * u_xlat2.xyz + vec3(-0.0399999991, -0.0399999991, -0.0399999991);
    u_xlat15.xyz = u_xlat15.xyz * vec3(0.100000001, 0.100000001, 0.100000001) + vec3(0.0399999991, 0.0399999991, 0.0399999991);
    ...
    u_xlat45 = min(u_xlat7.x, u_xlat45);
    ...
    u_xlat48 = dot((-u_xlat14.xyz), u_xlat4.xyz);
    u_xlat48 = u_xlat48 + u_xlat48;
    u_xlat7.xyz = u_xlat4.xyz * (-vec3(u_xlat48)) + (-u_xlat14.xyz);
    u_xlat48 = dot(u_xlat4.xyz, u_xlat14.xyz);
    u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
    u_xlat48 = (-u_xlat48) + 1.0;
    u_xlat48 = u_xlat48 * u_xlat48;
    u_xlat48 = u_xlat48 * u_xlat48;
    u_xlat49 = (-u_xlat2.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat8.xyz = (-u_xlat15.xyz) + u_xlat0.xxx;
    u_xlat8.xyz = vec3(u_xlat48) * u_xlat8.xyz + u_xlat15.xyz;
    u_xlat8.xyz = vec3(u_xlat16) * u_xlat8.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat5.xyz = u_xlat5.xyz * u_xlat3.xyz + u_xlat7.xyz;
    u_xlat0.x = u_xlat47 * unity_LightData.z;
    u_xlat16 = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    ...
    u_xlat7.xyz = u_xlat15.xyz * u_xlat0.xxx + u_xlat3.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat35) + u_xlat14.xyz;
        ...
        u_xlat9.xyz = u_xlat15.xyz * vec3(u_xlat47) + u_xlat3.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat45) + u_xlat6.xyz;
