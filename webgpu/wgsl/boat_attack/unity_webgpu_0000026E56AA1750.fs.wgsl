...
fn main_1() {
  ...
  let x_2099 : bool = u_xlatb0.x;
  if (x_2099) {
    let x_2104 : f32 = u_xlat1.x;
    x_2100 = x_2104;
  } else {
    let x_2107 : f32 = u_xlat2.x;
    x_2100 = x_2107;
  }
  let x_2108 : f32 = x_2100;
  SV_Target0.x = x_2108;
  let x_2112 : bool = u_xlatb0.y;
  if (x_2112) {
    let x_2117 : f32 = u_xlat1.y;
    x_2113 = x_2117;
  } else {
    let x_2120 : f32 = u_xlat2.y;
    x_2113 = x_2120;
  }
  let x_2121 : f32 = x_2113;
  SV_Target0.y = x_2121;
  let x_2124 : bool = u_xlatb0.z;
  if (x_2124) {
    let x_2129 : f32 = u_xlat1.z;
    x_2125 = x_2129;
  } else {
