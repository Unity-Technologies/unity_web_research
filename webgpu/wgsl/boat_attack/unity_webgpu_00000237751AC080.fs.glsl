...
;
    ...
    u_xlat7.xyz = u_xlat2.xyz * (-vec3(u_xlat31)) + (-u_xlat1.xyz);
    ...
    u_xlat22.xyz = vec3(u_xlat31) * u_xlat22.xyz + u_xlat5.xyz;
    ...
    u_xlat22.xyz = u_xlat1.xyz + _MainLightPosition.xyz;
    u_xlat0.x = dot(u_xlat22.xyz, u_xlat22.xyz);
    u_xlat0.x = max(u_xlat0.x, 1.17549435e-38);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat22.xyz = u_xlat0.xxx * u_xlat22.xyz;
    u_xlat0.x = dot(u_xlat2.xyz, u_xlat22.xyz);
    ...
    u_xlat22.xyz = u_xlat5.xyz * u_xlat0.xxx + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat22.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat22.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati47].www + _AdditionalLightsPosition[u_xlati47].xyz;
        u_xlat48 = dot(u_xlat22.xyz, u_xlat22.xyz);
        u_xlat48 = max(u_xlat48, 6.10351562e-05);
        u_xlat49 = inversesqrt(u_xlat48);
        u_xlat9.xyz = vec3(u_xlat49) * u_xlat22.xyz;
        ...
        if(u_xlatb10.x){
            u_xlatb10.x = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati47].z);
            if(u_xlatb10.x){
                ...
                u_xlat24.x = trunc(_AdditionalShadowParams[u_xlati47].w);
            ...
            u_xlat10.x = 1.0 + (-_AdditionalShadowParams[u_xlati47].x);
            u_xlat51 = u_xlat51 * _AdditionalShadowParams[u_xlati47].x + u_xlat10.x;
        ...
        u_xlat22.xyz = u_xlat5.xyz * vec3(u_xlat47) + u_xlat6.xyz;
        u_xlat3.xyz = u_xlat22.xyz * u_xlat10.xyz + u_xlat3.xyz;
    }
