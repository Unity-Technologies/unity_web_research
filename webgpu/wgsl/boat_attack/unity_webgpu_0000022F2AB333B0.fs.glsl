...
;
    ...
    u_xlat1.x = u_xlat23 * u_xlat67 + u_xlat1.x;
    u_xlat7.xyz = vec3(u_xlat71) * _MainLightColor.xyz;
    u_xlat23 = dot((-u_xlat5.xyz), u_xlat4.xyz);
    u_xlat23 = u_xlat23 + u_xlat23;
    u_xlat9.xyz = u_xlat4.xyz * (-vec3(u_xlat23)) + (-u_xlat5.xyz);
    ...
    u_xlat32.xyz = vec3(u_xlat23) * u_xlat32.xyz + u_xlat0.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat32.xyz = vec3(u_xlat72) * u_xlat9.xyz;
        ...
        u_xlat73 = dot(_AdditionalLightsSpotDir[u_xlati3].xyz, u_xlat32.xyz);
        ...
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        u_xlat70 = dot(u_xlat32.xyz, u_xlat9.xyz);
