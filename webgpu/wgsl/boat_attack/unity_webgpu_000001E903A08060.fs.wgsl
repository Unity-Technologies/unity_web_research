...
fn main_1() {
  ...
  let x_1246 : vec2<f32> = vs_TEXCOORD0;
  let x_1249 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1253 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1255 : vec2<f32> = ((x_1246 * vec2<f32>(x_1249.x, x_1249.y)) + vec2<f32>(x_1253.z, x_1253.w));
  let x_1256 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1255.x, x_1255.y, x_1256.z);
  let x_1263 : vec3<f32> = u_xlat1;
  let x_1266 : f32 = x_25.x_GlobalMipBias.x;
  let x_1267 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1263.x, x_1263.y), x_1266);
  u_xlat18 = x_1267.w;
  let x_1269 : f32 = u_xlat18;
  u_xlat18 = (x_1269 + -0.5f);
  let x_1271 : f32 = u_xlat18;
  let x_1272 : f32 = u_xlat18;
  u_xlat18 = (x_1271 + x_1272);
  let x_1274 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1274.x, x_1274.y, x_1274.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1283 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1283);
  let x_1288 : f32 = x_25.x_Grain_Params.y;
  let x_1290 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1288 * -(x_1290)) + 1.0f);
  let x_1296 : f32 = u_xlat18;
  ...
  let x_1304 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat7 = (x_1301 * vec3<f32>(x_1304.x, x_1304.x, x_1304.x));
  let x_1307 : vec3<f32> = u_xlat7;
  let x_1308 : vec3<f32> = u_xlat1;
  let x_1311 : vec4<f32> = u_xlat0;
  let x_1313 : vec3<f32> = ((x_1307 * vec3<f32>(x_1308.x, x_1308.x, x_1308.x)) + vec3<f32>(x_1311.x, x_1311.y, x_1311.z));
  let x_1314 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1313.x, x_1313.y, x_1313.z, x_1314.w);
  let x_1316 : vec4<f32> = u_xlat0;
  let x_1318 : vec3<f32> = sqrt(vec3<f32>(x_1316.x, x_1316.y, x_1316.z));
  let x_1319 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1318.x, x_1318.y, x_1318.z, x_1319.w);
  let x_1321 : vec2<f32> = vs_TEXCOORD0;
  let x_1324 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1328 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1330 : vec2<f32> = ((x_1321 * vec2<f32>(x_1324.x, x_1324.y)) + vec2<f32>(x_1328.z, x_1328.w));
  let x_1331 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1330.x, x_1330.y, x_1331.z);
  let x_1338 : vec3<f32> = u_xlat1;
  let x_1341 : f32 = x_25.x_GlobalMipBias.x;
  let x_1342 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1338.x, x_1338.y), x_1341);
  u_xlat18 = x_1342.w;
  let x_1344 : f32 = u_xlat18;
  u_xlat18 = ((x_1344 * 2.0f) + -1.0f);
  let x_1347 : f32 = u_xlat18;
  u_xlatb1.x = (x_1347 >= 0.0f);
  let x_1351 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1351);
  let x_1354 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1354)) + 1.0f);
  let x_1358 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1358);
  let x_1360 : f32 = u_xlat18;
  u_xlat18 = (-(x_1360) + 1.0f);
  let x_1363 : f32 = u_xlat18;
  let x_1365 : f32 = u_xlat1.x;
  u_xlat18 = (x_1363 * x_1365);
  let x_1367 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1367.x, x_1367.y, x_1367.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1370 : vec4<f32> = u_xlat0;
  let x_1372 : vec3<f32> = log2(vec3<f32>(x_1370.x, x_1370.y, x_1370.z));
  let x_1373 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1372.x, x_1372.y, x_1372.z, x_1373.w);
  let x_1375 : vec4<f32> = u_xlat2;
  let x_1377 : vec3<f32> = (vec3<f32>(x_1375.x, x_1375.y, x_1375.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1378 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1377.x, x_1377.y, x_1377.z, x_1378.w);
  let x_1380 : vec4<f32> = u_xlat2;
  let x_1382 : vec3<f32> = exp2(vec3<f32>(x_1380.x, x_1380.y, x_1380.z));
  let x_1383 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1382.x, x_1382.y, x_1382.z, x_1383.w);
  let x_1385 : vec4<f32> = u_xlat2;
  let x_1388 : vec3<f32> = ((vec3<f32>(x_1385.x, x_1385.y, x_1385.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1389 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1388.x, x_1388.y, x_1388.z, x_1389.w);
  let x_1391 : vec4<f32> = u_xlat0;
  let x_1393 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1391.x, x_1391.y, x_1391.z, x_1391.x));
  ...
  if (x_1408) {
    let x_1413 : f32 = u_xlat1.y;
    x_1409 = x_1413;
  } else {
    let x_1416 : f32 = u_xlat2.y;
    x_1409 = x_1416;
  }
  ...
  let x_1438 : vec3<f32> = ((vec3<f32>(x_1431, x_1431, x_1431) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1436.x, x_1436.y, x_1436.z));
  let x_1439 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1438.x, x_1438.y, x_1438.z, x_1439.w);
  let x_1441 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1441.x, x_1441.y, x_1441.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1444 : vec4<f32> = u_xlat0;
  let x_1446 : vec3<f32> = (vec3<f32>(x_1444.x, x_1444.y, x_1444.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1447 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1446.x, x_1446.y, x_1446.z, x_1447.w);
  let x_1449 : vec4<f32> = u_xlat2;
  let x_1451 : vec3<f32> = (vec3<f32>(x_1449.x, x_1449.y, x_1449.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1452 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1451.x, x_1451.y, x_1451.z, x_1452.w);
  let x_1454 : vec4<f32> = u_xlat2;
  let x_1457 : vec3<f32> = log2(abs(vec3<f32>(x_1454.x, x_1454.y, x_1454.z)));
  let x_1458 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1457.x, x_1457.y, x_1457.z, x_1458.w);
  let x_1460 : vec4<f32> = u_xlat2;
  let x_1462 : vec3<f32> = (vec3<f32>(x_1460.x, x_1460.y, x_1460.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1472 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1470.x, x_1470.y, x_1470.z, x_1470.x));
  ...
  let x_1514 : vec3<f32> = max(vec3<f32>(x_1512.x, x_1512.y, x_1512.z), vec3<f32>(0.0f, 0.0f, 0.0f));
