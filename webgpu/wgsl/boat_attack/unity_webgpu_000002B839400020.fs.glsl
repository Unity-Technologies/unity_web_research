...
void main()
{
    ...
    u_xlat14.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_TEXCOORD0.zw, _GlobalMipBias.x).xyz;
    ...
    u_xlat36 = u_xlat0.w + u_xlat15;
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    u_xlat15 = u_xlat4.x * 4.0 + 2.0;
    ...
    u_xlat28 = u_xlat28 * _MainLightShadowParams.x + u_xlat40;
    ...
    u_xlat17 = (-u_xlat28) + 1.0;
    u_xlat28 = u_xlat5.x * u_xlat17 + u_xlat28;
    u_xlat5.x = vs_TEXCOORD3.w;
    u_xlat5.y = vs_TEXCOORD4.w;
    u_xlat5.z = vs_TEXCOORD5.w;
    u_xlat41 = dot((-u_xlat5.xyz), u_xlat13.xyz);
    u_xlat41 = u_xlat41 + u_xlat41;
    u_xlat6.xyz = u_xlat13.xyz * (-vec3(u_xlat41)) + (-u_xlat5.xyz);
    ...
    u_xlat14.xyz = u_xlat14.xyz * u_xlat3.xzw + u_xlat6.xyz;
    u_xlat36 = u_xlat28 * unity_LightData.z;
    ...
    u_xlat19.xyz = u_xlat0.xyz * vec3(u_xlat36) + u_xlat3.xzw;
    u_xlat36 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu36 =  uint(int(u_xlat36));
    u_xlat1 = u_xlat40 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat4.x = float(0.0);
    u_xlat4.z = float(0.0);
    u_xlat4.w = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat9) + u_xlat5.xyz;
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat42) + u_xlat3.xzw;
        u_xlat4.xzw = u_xlat8.xyz * u_xlat10.xyz + u_xlat4.xzw;
    }
    u_xlat0.xyz = u_xlat19.xyz * u_xlat6.xyz + u_xlat14.xyz;
    u_xlat0.xyz = u_xlat4.xzw + u_xlat0.xyz;
    u_xlat36 = u_xlat2 * (-u_xlat2);
