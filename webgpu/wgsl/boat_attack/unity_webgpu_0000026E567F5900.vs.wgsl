...
fn main_1() {
  ...
  let x_84 : vec4<f32> = in_TEXCOORD0;
  vs_TEXCOORD0 = vec2<f32>(x_84.x, x_84.y);
  let x_90 : vec4<f32> = in_COLOR0;
  vs_TEXCOORD1 = vec3<f32>(x_90.w, x_90.w, x_90.w);
...
@vertex
fn main(@location(0) in_POSITION0_param : vec4<f32>, @location(2) in_TEXCOORD0_param : vec4<f32>, @location(3) in_COLOR0_param : vec4<f32>, @location(1) in_NORMAL0_param : vec3<f32>) -> main_out {
