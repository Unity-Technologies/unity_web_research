...
fn main_1() {
  ...
  let x_1276 : vec2<f32> = vs_TEXCOORD0;
  let x_1279 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1283 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1285 : vec2<f32> = ((x_1276 * vec2<f32>(x_1279.x, x_1279.y)) + vec2<f32>(x_1283.z, x_1283.w));
  let x_1286 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1285.x, x_1285.y, x_1286.z);
  let x_1293 : vec3<f32> = u_xlat1;
  let x_1296 : f32 = x_25.x_GlobalMipBias.x;
  let x_1297 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1293.x, x_1293.y), x_1296);
  u_xlat18 = x_1297.w;
  let x_1299 : f32 = u_xlat18;
  u_xlat18 = ((x_1299 * 2.0f) + -1.0f);
  let x_1302 : f32 = u_xlat18;
  u_xlatb1.x = (x_1302 >= 0.0f);
  let x_1306 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1306);
  let x_1309 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1309)) + 1.0f);
  let x_1313 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1313);
  let x_1315 : f32 = u_xlat18;
  u_xlat18 = (-(x_1315) + 1.0f);
  let x_1318 : f32 = u_xlat18;
  let x_1320 : f32 = u_xlat1.x;
  u_xlat18 = (x_1318 * x_1320);
  let x_1322 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1322.x, x_1322.y, x_1322.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1333 : vec3<f32> = (vec3<f32>(x_1331.x, x_1331.y, x_1331.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1344 : vec3<f32> = ((vec3<f32>(x_1341.x, x_1341.y, x_1341.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1345 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1344.x, x_1344.y, x_1344.z, x_1345.w);
  let x_1347 : vec4<f32> = u_xlat0;
  let x_1349 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1347.x, x_1347.y, x_1347.z, x_1347.x));
  ...
  if (x_1376) {
    ...
    let x_1384 : f32 = u_xlat2.z;
    x_1377 = x_1384;
  }
  let x_1385 : f32 = x_1377;
  u_xlat0.z = x_1385;
  let x_1387 : f32 = u_xlat18;
  let x_1392 : vec4<f32> = u_xlat0;
  let x_1394 : vec3<f32> = ((vec3<f32>(x_1387, x_1387, x_1387) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1392.x, x_1392.y, x_1392.z));
  let x_1395 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1394.x, x_1394.y, x_1394.z, x_1395.w);
  let x_1397 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1397.x, x_1397.y, x_1397.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1400 : vec4<f32> = u_xlat0;
  let x_1402 : vec3<f32> = (vec3<f32>(x_1400.x, x_1400.y, x_1400.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1403 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1402.x, x_1402.y, x_1402.z, x_1403.w);
  let x_1405 : vec4<f32> = u_xlat2;
  let x_1407 : vec3<f32> = (vec3<f32>(x_1405.x, x_1405.y, x_1405.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1408 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1407.x, x_1407.y, x_1407.z, x_1408.w);
  let x_1410 : vec4<f32> = u_xlat2;
  let x_1413 : vec3<f32> = log2(abs(vec3<f32>(x_1410.x, x_1410.y, x_1410.z)));
  let x_1414 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1413.x, x_1413.y, x_1413.z, x_1414.w);
  let x_1416 : vec4<f32> = u_xlat2;
  let x_1418 : vec3<f32> = (vec3<f32>(x_1416.x, x_1416.y, x_1416.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1419 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1418.x, x_1418.y, x_1418.z, x_1419.w);
  let x_1421 : vec4<f32> = u_xlat2;
  let x_1423 : vec3<f32> = exp2(vec3<f32>(x_1421.x, x_1421.y, x_1421.z));
  ...
  let x_1471 : vec3<f32> = max(vec3<f32>(x_1468.x, x_1468.y, x_1468.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1472 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1471.x, x_1471.y, x_1471.z, x_1472.w);
  SV_Target0.w = 1.0f;
  return;
}
