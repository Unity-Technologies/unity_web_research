...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat30 = dot(unity_LightIndices[int(u_xlatu30)], uintBitsToFloat(ImmCB_0[u_xlati45]));
        u_xlati30 = int(u_xlat30);
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati30].www + _AdditionalLightsPosition[u_xlati30].xyz;
        ...
        u_xlat48 = u_xlat2.x * u_xlat49 + u_xlat48;
        u_xlat45 = u_xlat45 * u_xlat48;
        u_xlat48 = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        u_xlat45 = u_xlat45 * u_xlat48;
        u_xlat11.xyz = vec3(u_xlat45) * _AdditionalLightsColor[u_xlati30].xyz;
        ...
        u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
        u_xlat30 = u_xlat30 * u_xlat30;
        u_xlat30 = u_xlat30 * u_xlat0.x + 1.00001001;
        u_xlat45 = u_xlat45 * u_xlat45;
        u_xlat30 = u_xlat30 * u_xlat30;
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat30) + u_xlat4.xyz;
