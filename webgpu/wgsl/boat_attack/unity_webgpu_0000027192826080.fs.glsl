...
void main()
{
    ...
    u_xlat4.x = (u_xlatb33) ? u_xlat3.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb33) ? u_xlat3.y : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb33) ? u_xlat3.z : unity_MatrixV[2].z;
...
;
    ...
    u_xlat3.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati33 + 1) / 4][(u_xlati33 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati33 / 4][u_xlati33 % 4].xyz * vs_INTERP7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati33 + 2) / 4][(u_xlati33 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati33 + 3) / 4][(u_xlati33 + 3) % 4].xyz;
    ...
    u_xlat25 = u_xlat14.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat25 = clamp(u_xlat25, 0.0, 1.0);
    u_xlat36 = (-u_xlat3.x) + 1.0;
    u_xlat3.x = u_xlat25 * u_xlat36 + u_xlat3.x;
    u_xlat25 = dot((-u_xlat4.xyz), u_xlat1.xyz);
    u_xlat25 = u_xlat25 + u_xlat25;
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat25)) + (-u_xlat4.xyz);
    ...
    u_xlat19.xyz = (-u_xlat0.xyz) + vec3(u_xlat34);
    u_xlat19.xyz = vec3(u_xlat25) * u_xlat19.xyz + u_xlat0.xyz;
    ...
    u_xlat3.xzw = vec3(u_xlat33) * _MainLightColor.xyz;
    ...
    u_xlat34 = u_xlat14.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat34 = clamp(u_xlat34, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat14.x = dot(unity_LightIndices[int(u_xlatu14)], uintBitsToFloat(ImmCB_0[u_xlati37]));
        u_xlati14 = int(u_xlat14.x);
        u_xlat19.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati14].www + _AdditionalLightsPosition[u_xlati14].xyz;
        ...
        u_xlat37 = u_xlat37 * _AdditionalLightsAttenuation[u_xlati14].x;
        ...
        if(u_xlatb40){
            u_xlatb40 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati14].z);
            if(u_xlatb40){
                ...
                u_xlat40 = (u_xlatb40) ? u_xlat10.x : u_xlat42;
                u_xlat42 = trunc(_AdditionalShadowParams[u_xlati14].w);
                u_xlat40 = u_xlat40 + u_xlat42;
                u_xlati39 = int(u_xlat40);
            }
            u_xlati39 = u_xlati39 << (2 & int(0x1F));
            u_xlat10 = vs_INTERP7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati39 + 1) / 4][(u_xlati39 + 1) % 4];
            u_xlat10 = _AdditionalLightsWorldToShadow[u_xlati39 / 4][u_xlati39 % 4] * vs_INTERP7.xxxx + u_xlat10;
            u_xlat10 = _AdditionalLightsWorldToShadow[(u_xlati39 + 2) / 4][(u_xlati39 + 2) % 4] * vs_INTERP7.zzzz + u_xlat10;
            u_xlat10 = u_xlat10 + _AdditionalLightsWorldToShadow[(u_xlati39 + 3) / 4][(u_xlati39 + 3) % 4];
            u_xlat10.xyz = u_xlat10.xyz / u_xlat10.www;
            vec3 txVec1 = vec3(u_xlat10.xy,u_xlat10.z);
            u_xlat39 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec1, 0.0);
            u_xlat40 = 1.0 + (-_AdditionalShadowParams[u_xlati14].x);
            u_xlat39 = u_xlat39 * _AdditionalShadowParams[u_xlati14].x + u_xlat40;
        ...
        u_xlat39 = u_xlat34 * u_xlat40 + u_xlat39;
        u_xlat37 = u_xlat37 * u_xlat39;
        u_xlat39 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat39 = clamp(u_xlat39, 0.0, 1.0);
        u_xlat37 = u_xlat37 * u_xlat39;
        u_xlat10.xyz = vec3(u_xlat37) * _AdditionalLightsColor[u_xlati14].xyz;
        u_xlat19.xyz = u_xlat19.xyz * vec3(u_xlat38) + u_xlat4.xyz;
        ...
        u_xlat14.x = dot(u_xlat1.xyz, u_xlat19.xyz);
        u_xlat14.x = clamp(u_xlat14.x, 0.0, 1.0);
        u_xlat37 = dot(u_xlat9.xyz, u_xlat19.xyz);
        u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
        u_xlat14.x = u_xlat14.x * u_xlat14.x;
        u_xlat14.x = u_xlat14.x * u_xlat8.x + 1.00001001;
        u_xlat37 = u_xlat37 * u_xlat37;
        u_xlat14.x = u_xlat14.x * u_xlat14.x;
        u_xlat37 = max(u_xlat37, 0.100000001);
        u_xlat14.x = u_xlat14.x * u_xlat37;
        u_xlat14.x = u_xlat35 * u_xlat14.x;
        u_xlat14.x = u_xlat13 / u_xlat14.x;
        u_xlat19.xyz = u_xlat0.xyz * u_xlat14.xxx + u_xlat6.xyz;
        u_xlat7.xyz = u_xlat19.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat24) + u_xlat3.xzw;
