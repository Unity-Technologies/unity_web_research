#line 1 "Hidden/HDRP/ProbeVolumeOffsetDebug"
...
#line 151 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.core@16.0.1/Runtime/Debug/ProbeVolumeDebugFunctions.hlsl"
v2f vert ( appdata v )
{
v2f o ;
...
{
float4 wsPos = mul ( unity_ObjectToWorld , float4 ( v . vertex . x * _OffsetSize , v . vertex . y * _OffsetSize , v . vertex . z , 1.f ) ) ;
