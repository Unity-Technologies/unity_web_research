...
;
    ...
    u_xlat7.xyz = u_xlat0.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat3.xyz;
    ...
    u_xlat0.xyz = u_xlat2.xzw * vec3(u_xlat47) + u_xlat20.xyz;
    u_xlat0.xyz = u_xlat22.xyz + u_xlat0.xyz;
    SV_Target0.xyz = vs_INTERP6.www * u_xlat1.xyz + u_xlat0.xyz;
