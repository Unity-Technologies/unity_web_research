...
fn main_1() {
  ...
  let x_12 : vec3<f32> = vs_TEXCOORD3;
  let x_13 : vec3<f32> = vs_TEXCOORD3;
  u_xlat0 = dot(x_12, x_13);
  let x_15 : f32 = u_xlat0;
  u_xlat0 = inverseSqrt(x_15);
  let x_20 : f32 = u_xlat0;
  let x_22 : vec3<f32> = vs_TEXCOORD3;
...
@fragment
fn main(@location(0) vs_TEXCOORD3_param : vec3<f32>, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
