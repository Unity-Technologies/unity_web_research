...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat65 = u_xlat65 * _AdditionalLightsAttenuation[int(u_xlatu62)].x;
        u_xlat65 = (-u_xlat65) * u_xlat65 + 1.0;
        u_xlat65 = max(u_xlat65, 0.0);
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat65 = u_xlat65 * u_xlat47.x;
        u_xlat47.x = dot(_AdditionalLightsSpotDir[int(u_xlatu62)].xyz, u_xlat10.xyz);
        u_xlat47.x = u_xlat47.x * _AdditionalLightsAttenuation[int(u_xlatu62)].z + _AdditionalLightsAttenuation[int(u_xlatu62)].w;
        u_xlat47.x = clamp(u_xlat47.x, 0.0, 1.0);
        u_xlat47.x = u_xlat47.x * u_xlat47.x;
        u_xlat65 = u_xlat65 * u_xlat47.x;
        u_xlatu47 = u_xlatu62 >> (5u & uint(0x1F));
        u_xlati67 = 1 << (int(u_xlatu62) & int(0x1F));
        u_xlati47 = int(uint(u_xlati67) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu47)]));
        if(u_xlati47 != 0) {
            u_xlati47 = int(_AdditionalLightsLightTypes[int(u_xlatu62)]);
            u_xlati67 = (u_xlati47 != 0) ? 0 : 1;
            u_xlati69 = int(u_xlatu62) << (2 & int(0x1F));
            if(u_xlati67 != 0) {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat66) + u_xlat21.xyz;
