...
@group(0) @binding(7) var x_TerrainHeightmapTexture : texture_2d<f32>;

@group(0) @binding(8) var x_TerrainNormalmapTexture : texture_2d<f32>;
...
fn main_1() {
  ...
  let x_469 : vec4<f32> = x_262.unity_MatrixVP[3i];
