...
fn main_1() {
  ...
  u_xlat1 = ((vec4<f32>(-0.0f, -1.384615421f, -0.0f, -3.230769157f) * vec4<f32>(x_44.y, x_44.x, x_44.z, x_44.x)) + vec4<f32>(x_49.x, x_49.y, x_49.x, x_49.y));
  let x_54 : vec4<f32> = u_xlat0;
  let x_57 : vec2<f32> = vs_TEXCOORD0;
  u_xlat0 = ((vec4<f32>(0.0f, 1.384615421f, 0.0f, 3.230769157f) * vec4<f32>(x_54.y, x_54.x, x_54.z, x_54.x)) + vec4<f32>(x_57.x, x_57.y, x_57.x, x_57.y));
  ...
  u_xlat7.x = (x_114 + -0.800000012f);
  let x_119 : f32 = u_xlat7.x;
  u_xlat7.x = (x_119 * 5.000000477f);
  ...
  u_xlat12 = (x_189 + -0.800000012f);
  let x_191 : f32 = u_xlat12;
  u_xlat12 = (x_191 * 5.000000477f);
  ...
  u_xlat17 = (x_205 * 0.31621623f);
  let x_207 : f32 = u_xlat12;
  let x_210 : f32 = u_xlat7.x;
  u_xlat7.x = ((x_207 * 0.31621623f) + x_210);
  ...
  u_xlat6.x = (x_231 + -0.800000012f);
  let x_235 : f32 = u_xlat6.x;
  u_xlat6.x = (x_235 * 5.000000477f);
  ...
  u_xlat11 = (x_259 * 0.07027027f);
  let x_263 : f32 = u_xlat6.x;
  let x_266 : f32 = u_xlat7.x;
  u_xlat6.x = ((x_263 * 0.07027027f) + x_266);
  ...
  u_xlat5.x = (x_296 + -0.800000012f);
  let x_300 : f32 = u_xlat5.x;
  u_xlat5.x = (x_300 * 5.000000477f);
  ...
  u_xlat10 = (x_324 * 0.07027027f);
  let x_327 : f32 = u_xlat5.x;
  let x_330 : f32 = u_xlat6.x;
  u_xlat5.x = ((x_327 * 0.07027027f) + x_330);
  let x_334 : f32 = u_xlat5.x;
  u_xlat5.x = (x_334 + 0.227027029f);
