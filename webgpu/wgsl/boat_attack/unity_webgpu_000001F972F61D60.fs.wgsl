...
fn main_1() {
  ...
  u_xlat0.z = x_1011;
  let x_1013 : vec2<f32> = vs_TEXCOORD0;
  let x_1016 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1020 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1022 : vec2<f32> = ((x_1013 * vec2<f32>(x_1016.x, x_1016.y)) + vec2<f32>(x_1020.z, x_1020.w));
  let x_1023 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1022.x, x_1022.y, x_1023.z, x_1023.w);
  let x_1030 : vec4<f32> = u_xlat1;
  let x_1033 : f32 = x_25.x_GlobalMipBias.x;
  let x_1034 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1030.x, x_1030.y), x_1033);
  u_xlat15 = x_1034.w;
  let x_1036 : f32 = u_xlat15;
  u_xlat15 = ((x_1036 * 2.0f) + -1.0f);
  let x_1040 : f32 = u_xlat15;
  u_xlatb1.x = (x_1040 >= 0.0f);
  let x_1044 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1044);
  let x_1047 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1047)) + 1.0f);
  let x_1051 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1051);
  let x_1053 : f32 = u_xlat15;
  u_xlat15 = (-(x_1053) + 1.0f);
  let x_1056 : f32 = u_xlat15;
  let x_1058 : f32 = u_xlat1.x;
  u_xlat15 = (x_1056 * x_1058);
  let x_1060 : vec4<f32> = u_xlat0;
  let x_1062 : vec3<f32> = (vec3<f32>(x_1060.x, x_1060.y, x_1060.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1063 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1062.x, x_1062.y, x_1062.z, x_1063.w);
  let x_1065 : vec4<f32> = u_xlat0;
  let x_1068 : vec3<f32> = log2(abs(vec3<f32>(x_1065.x, x_1065.y, x_1065.z)));
  let x_1069 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1068.x, x_1068.y, x_1068.z, x_1069.w);
  let x_1071 : vec4<f32> = u_xlat2;
  let x_1073 : vec3<f32> = (vec3<f32>(x_1071.x, x_1071.y, x_1071.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1074 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1073.x, x_1073.y, x_1073.z, x_1074.w);
  let x_1076 : vec4<f32> = u_xlat2;
  let x_1078 : vec3<f32> = exp2(vec3<f32>(x_1076.x, x_1076.y, x_1076.z));
  let x_1079 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1078.x, x_1078.y, x_1078.z, x_1079.w);
  let x_1081 : vec4<f32> = u_xlat2;
  let x_1084 : vec3<f32> = ((vec3<f32>(x_1081.x, x_1081.y, x_1081.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1085 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1084.x, x_1084.y, x_1084.z, x_1085.w);
  let x_1087 : vec4<f32> = u_xlat0;
  let x_1089 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1087.x, x_1087.y, x_1087.z, x_1087.x));
  u_xlatb0 = vec3<bool>(x_1089.x, x_1089.y, x_1089.z);
  let x_1092 : bool = u_xlatb0.x;
  if (x_1092) {
  ...
  u_xlat0.y = x_1113;
  let x_1116 : bool = u_xlatb0.z;
  if (x_1116) {
    let x_1121 : f32 = u_xlat1.z;
    x_1117 = x_1121;
  } else {
    let x_1124 : f32 = u_xlat2.z;
    x_1117 = x_1124;
  }
  ...
  let x_1134 : vec3<f32> = ((vec3<f32>(x_1127, x_1127, x_1127) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1132.x, x_1132.y, x_1132.z));
  let x_1135 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1134.x, x_1134.y, x_1134.z, x_1135.w);
  let x_1137 : vec4<f32> = u_xlat0;
  let x_1139 : vec3<f32> = (vec3<f32>(x_1137.x, x_1137.y, x_1137.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1140 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1139.x, x_1139.y, x_1139.z, x_1140.w);
  let x_1142 : vec4<f32> = u_xlat0;
  let x_1144 : vec3<f32> = (vec3<f32>(x_1142.x, x_1142.y, x_1142.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1145 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1144.x, x_1144.y, x_1144.z, x_1145.w);
  let x_1147 : vec4<f32> = u_xlat2;
  let x_1149 : vec3<f32> = (vec3<f32>(x_1147.x, x_1147.y, x_1147.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1150 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1149.x, x_1149.y, x_1149.z, x_1150.w);
  let x_1152 : vec4<f32> = u_xlat2;
  let x_1155 : vec3<f32> = log2(abs(vec3<f32>(x_1152.x, x_1152.y, x_1152.z)));
  let x_1156 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1155.x, x_1155.y, x_1155.z, x_1156.w);
  let x_1158 : vec4<f32> = u_xlat2;
  let x_1160 : vec3<f32> = (vec3<f32>(x_1158.x, x_1158.y, x_1158.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1161 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1160.x, x_1160.y, x_1160.z, x_1161.w);
  let x_1163 : vec4<f32> = u_xlat2;
  let x_1165 : vec3<f32> = exp2(vec3<f32>(x_1163.x, x_1163.y, x_1163.z));
  let x_1166 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1165.x, x_1165.y, x_1165.z, x_1166.w);
  let x_1168 : vec4<f32> = u_xlat0;
  let x_1170 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1168.x, x_1168.y, x_1168.z, x_1168.x));
  ...
  let x_1213 : vec3<f32> = max(vec3<f32>(x_1210.x, x_1210.y, x_1210.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1214 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1213.x, x_1213.y, x_1213.z, x_1214.w);
  SV_Target0.w = 1.0f;
  return;
}
