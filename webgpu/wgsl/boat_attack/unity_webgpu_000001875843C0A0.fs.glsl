...
;
    ...
    if(u_xlatb16.x){
        ...
        u_xlat7.xyz = (u_xlatb16.x) ? u_xlat7.xyz : vec3(u_xlat30);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat16.x = dot((-u_xlat8.xyz), u_xlat1.xyz);
    u_xlat16.x = u_xlat16.x + u_xlat16.x;
    u_xlat9.xyz = u_xlat1.xyz * (-u_xlat16.xxx) + (-u_xlat8.xyz);
    ...
    u_xlat10.xyz = (-u_xlat5.xyz) + vec3(u_xlat45);
    u_xlat10.xyz = u_xlat16.xxx * u_xlat10.xyz + u_xlat5.xyz;
    ...
    u_xlat2.xyz = vec3(u_xlat28) * u_xlat7.xyz;
    ...
    u_xlat7.xyz = u_xlat5.xyz * vec3(u_xlat28) + u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat49) + u_xlat8.xyz;
    ...
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat14) + u_xlat2.xyz;
    u_xlat0.xyz = u_xlat7.xyz + u_xlat0.xyz;
    u_xlat1.x = u_xlat43 * (-u_xlat43);
    u_xlat1.x = exp2(u_xlat1.x);
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat42) + (-unity_FogColor.xyz);
