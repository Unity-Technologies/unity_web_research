...
fn main_1() {
  ...
  let x_854 : vec4<f32> = x_36.unity_ObjectToWorld[2i];
  let x_856 : vec4<f32> = u_xlat1;
  let x_859 : vec4<f32> = u_xlat1;
  let x_861 : vec3<f32> = ((vec3<f32>(x_854.x, x_854.y, x_854.z) * vec3<f32>(x_856.z, x_856.z, x_856.z)) + vec3<f32>(x_859.x, x_859.y, x_859.w));
  let x_862 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_861.x, x_861.y, x_861.z, x_862.w);
  let x_865 : vec3<f32> = vs_TEXCOORD6;
  let x_866 : vec4<f32> = u_xlat1;
  u_xlat18 = dot(x_865, vec3<f32>(x_866.x, x_866.y, x_866.z));
  let x_869 : f32 = u_xlat18;
  let x_870 : f32 = u_xlat18;
  u_xlat18 = (x_869 + x_870);
  let x_872 : vec4<f32> = u_xlat1;
  let x_874 : f32 = u_xlat18;
  let x_878 : vec3<f32> = vs_TEXCOORD6;
  let x_879 : vec3<f32> = ((vec3<f32>(x_872.x, x_872.y, x_872.z) * -(vec3<f32>(x_874, x_874, x_874))) + x_878);
  let x_880 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_879.x, x_879.y, x_879.z, x_880.w);
  let x_890 : vec4<f32> = u_xlat1;
  let x_892 : vec4<f32> = textureSample(x_Cube, sampler_Cube, vec3<f32>(x_890.x, x_890.y, x_890.z));
  ...
  u_xlat0 = ((vec3<f32>(x_903.x, x_903.y, x_903.z) * vec3<f32>(x_905.w, x_905.w, x_905.w)) + x_908);
  let x_913 : f32 = u_xlat2.w;
  SV_Target0.w = x_913;
  let x_916 : vec3<f32> = u_xlat0;
  let x_919 : vec4<f32> = x_36.unity_FogColor;
  u_xlat0 = (x_916 + -(vec3<f32>(x_919.x, x_919.y, x_919.z)));
  let x_924 : f32 = vs_TEXCOORD8;
  let x_926 : f32 = x_36.x_ProjectionParams.y;
  u_xlat18 = (x_924 / x_926);
  let x_928 : f32 = u_xlat18;
  u_xlat18 = (-(x_928) + 1.0f);
  let x_931 : f32 = u_xlat18;
  let x_933 : f32 = x_36.x_ProjectionParams.z;
  u_xlat18 = (x_931 * x_933);
  let x_935 : f32 = u_xlat18;
  u_xlat18 = max(x_935, 0.0f);
  let x_937 : f32 = u_xlat18;
  let x_940 : f32 = x_36.unity_FogParams.x;
  u_xlat18 = (x_937 * x_940);
  let x_942 : f32 = u_xlat18;
  let x_943 : f32 = u_xlat18;
  u_xlat18 = (x_942 * -(x_943));
  let x_946 : f32 = u_xlat18;
  u_xlat18 = exp2(x_946);
  let x_948 : f32 = u_xlat18;
  let x_950 : vec3<f32> = u_xlat0;
  let x_953 : vec4<f32> = x_36.unity_FogColor;
  let x_955 : vec3<f32> = ((vec3<f32>(x_948, x_948, x_948) * x_950) + vec3<f32>(x_953.x, x_953.y, x_953.z));
