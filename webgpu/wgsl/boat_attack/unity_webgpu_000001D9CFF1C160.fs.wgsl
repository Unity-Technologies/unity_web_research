...
fn main_1() {
  ...
  let x_1295 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1299 : vec4<f32> = x_14.x_Dithering_Params;
  ...
  let x_1312 : f32 = x_14.x_GlobalMipBias.x;
  let x_1313 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1309.x, x_1309.y), x_1312);
  u_xlat15 = x_1313.w;
  let x_1315 : f32 = u_xlat15;
  u_xlat15 = ((x_1315 * 2.0f) + -1.0f);
  let x_1318 : f32 = u_xlat15;
  u_xlatb1 = (x_1318 >= 0.0f);
  let x_1320 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1320);
  let x_1323 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1323)) + 1.0f);
  let x_1327 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1327);
  let x_1329 : f32 = u_xlat15;
  u_xlat15 = (-(x_1329) + 1.0f);
  let x_1332 : f32 = u_xlat15;
  let x_1334 : f32 = u_xlat1.x;
  u_xlat15 = (x_1332 * x_1334);
  let x_1336 : vec3<f32> = u_xlat0;
  let x_1337 : vec3<f32> = (x_1336 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1338 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1337.x, x_1337.y, x_1337.z, x_1338.w);
  let x_1340 : vec3<f32> = u_xlat0;
  let x_1341 : vec3<f32> = log2(x_1340);
  let x_1342 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1341.x, x_1341.y, x_1341.z, x_1342.w);
  let x_1344 : vec4<f32> = u_xlat2;
  let x_1346 : vec3<f32> = (vec3<f32>(x_1344.x, x_1344.y, x_1344.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1347 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1346.x, x_1346.y, x_1346.z, x_1347.w);
  let x_1349 : vec4<f32> = u_xlat2;
  let x_1351 : vec3<f32> = exp2(vec3<f32>(x_1349.x, x_1349.y, x_1349.z));
  let x_1352 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1351.x, x_1351.y, x_1351.z, x_1352.w);
  let x_1354 : vec4<f32> = u_xlat2;
  let x_1357 : vec3<f32> = ((vec3<f32>(x_1354.x, x_1354.y, x_1354.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1358 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1357.x, x_1357.y, x_1357.z, x_1358.w);
  let x_1360 : vec3<f32> = u_xlat0;
  let x_1362 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1360.x, x_1360.y, x_1360.z, x_1360.x));
  u_xlatb0 = vec3<bool>(x_1362.x, x_1362.y, x_1362.z);
  let x_1365 : bool = u_xlatb0.x;
  if (x_1365) {
    let x_1370 : f32 = u_xlat1.x;
    x_1366 = x_1370;
  } else {
    let x_1373 : f32 = u_xlat2.x;
    x_1366 = x_1373;
  }
  let x_1374 : f32 = x_1366;
  u_xlat0.x = x_1374;
  let x_1377 : bool = u_xlatb0.y;
  if (x_1377) {
    let x_1382 : f32 = u_xlat1.y;
    x_1378 = x_1382;
  } else {
    let x_1385 : f32 = u_xlat2.y;
    x_1378 = x_1385;
  }
  let x_1386 : f32 = x_1378;
  u_xlat0.y = x_1386;
  let x_1389 : bool = u_xlatb0.z;
  if (x_1389) {
    let x_1394 : f32 = u_xlat1.z;
    x_1390 = x_1394;
  } else {
  ...
  u_xlat0.z = x_1398;
  let x_1400 : f32 = u_xlat15;
  let x_1405 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1400, x_1400, x_1400) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1405);
  let x_1407 : vec3<f32> = u_xlat0;
  let x_1408 : vec3<f32> = (x_1407 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1409 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1408.x, x_1408.y, x_1408.z, x_1409.w);
  let x_1411 : vec3<f32> = u_xlat0;
  let x_1412 : vec3<f32> = (x_1411 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1413 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1412.x, x_1412.y, x_1412.z, x_1413.w);
  let x_1415 : vec4<f32> = u_xlat2;
  let x_1417 : vec3<f32> = (vec3<f32>(x_1415.x, x_1415.y, x_1415.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1418 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1417.x, x_1417.y, x_1417.z, x_1418.w);
  let x_1420 : vec4<f32> = u_xlat2;
  let x_1423 : vec3<f32> = log2(abs(vec3<f32>(x_1420.x, x_1420.y, x_1420.z)));
  let x_1424 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1423.x, x_1423.y, x_1423.z, x_1424.w);
  let x_1426 : vec4<f32> = u_xlat2;
  let x_1428 : vec3<f32> = (vec3<f32>(x_1426.x, x_1426.y, x_1426.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1429 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1428.x, x_1428.y, x_1428.z, x_1429.w);
  let x_1431 : vec4<f32> = u_xlat2;
  let x_1433 : vec3<f32> = exp2(vec3<f32>(x_1431.x, x_1431.y, x_1431.z));
  let x_1434 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1433.x, x_1433.y, x_1433.z, x_1434.w);
  let x_1436 : vec3<f32> = u_xlat0;
  let x_1438 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1436.x, x_1436.y, x_1436.z, x_1436.x));
  u_xlatb0 = vec3<bool>(x_1438.x, x_1438.y, x_1438.z);
  let x_1441 : bool = u_xlatb0.x;
  if (x_1441) {
    let x_1446 : f32 = u_xlat1.x;
    x_1442 = x_1446;
  } else {
    let x_1449 : f32 = u_xlat2.x;
    x_1442 = x_1449;
  }
  let x_1450 : f32 = x_1442;
  u_xlat0.x = x_1450;
  let x_1453 : bool = u_xlatb0.y;
  if (x_1453) {
    let x_1458 : f32 = u_xlat1.y;
    x_1454 = x_1458;
  } else {
    let x_1461 : f32 = u_xlat2.y;
    x_1454 = x_1461;
  }
  let x_1462 : f32 = x_1454;
  u_xlat0.y = x_1462;
  let x_1465 : bool = u_xlatb0.z;
  if (x_1465) {
    let x_1470 : f32 = u_xlat1.z;
    x_1466 = x_1470;
  } else {
  ...
  u_xlat0.z = x_1474;
  let x_1478 : vec3<f32> = u_xlat0;
  let x_1479 : vec3<f32> = max(x_1478, vec3<f32>(0.0f, 0.0f, 0.0f));
