...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat55 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat55 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat55;
    u_xlat55 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat55;
    u_xlat55 = u_xlat55 + unity_MatrixV[3].z;
    ...
    u_xlat56 = u_xlat3.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat3.z = (-u_xlat56) + 1.0;
    u_xlat56 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat3.xz, _GlobalMipBias.x).x;
    ...
    u_xlat56 = u_xlat21.x * unity_LightData.z;
    u_xlat21.xyz = vec3(u_xlat56) * u_xlat4.xyz;
    ...
    for(uint u_xlatu_loop_1 = uint(0u) ; u_xlatu_loop_1<u_xlatu56 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat5.x = dot(unity_LightIndices[int(u_xlatu5)], uintBitsToFloat(ImmCB_0[u_xlati23]));
    ...
    u_xlat18.xyz = u_xlat2.xyz * u_xlat0.yzw + u_xlat21.xyz;
