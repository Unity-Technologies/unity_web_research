...
;
    ...
    u_xlat4.x = u_xlat4.x * _MainLightShadowParams.x + u_xlat16;
    ...
    u_xlat28 = u_xlat16 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat28 = clamp(u_xlat28, 0.0, 1.0);
    u_xlat6.x = (-u_xlat4.x) + 1.0;
    u_xlat4.x = u_xlat28 * u_xlat6.x + u_xlat4.x;
    u_xlat28 = dot((-u_xlat3.xyz), u_xlat2.xyz);
    u_xlat28 = u_xlat28 + u_xlat28;
    u_xlat6.xyz = u_xlat2.xyz * (-vec3(u_xlat28)) + (-u_xlat3.xyz);
    ...
    u_xlat19.xyz = vec3(u_xlat28) * u_xlat19.xyz + u_xlat0.xyz;
    u_xlat19.xyz = vec3(u_xlat36) * u_xlat19.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat19.xyz;
    u_xlat5.xyz = u_xlat5.xyz * u_xlat13.xyz + u_xlat6.xyz;
    ...
    u_xlat38 = u_xlat16 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat38 = clamp(u_xlat38, 0.0, 1.0);
    u_xlat4.x = float(0.0);
    u_xlat4.y = float(0.0);
    u_xlat4.z = float(0.0);
