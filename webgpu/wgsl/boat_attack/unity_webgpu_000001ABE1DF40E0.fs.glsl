...
;
    ...
    u_xlat6.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati36 + 1) / 4][(u_xlati36 + 1) % 4].xyz;
    u_xlat6.xyz = _MainLightWorldToShadow[u_xlati36 / 4][u_xlati36 % 4].xyz * vs_INTERP0.xxx + u_xlat6.xyz;
    u_xlat6.xyz = _MainLightWorldToShadow[(u_xlati36 + 2) / 4][(u_xlati36 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat6.xyz;
    ...
    u_xlat3.xyz = u_xlat14.xyz * u_xlat3.xxx;
    ...
    u_xlat17.xyz = unity_SHC.xyz * u_xlat26.xxx + u_xlat8.xyz;
    ...
    u_xlat6.xy = u_xlat26.xy * hlslcc_FragCoord.xy;
    u_xlat26.x = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat6.z = (-u_xlat26.x) + 1.0;
    u_xlat5.x = u_xlat5.x;
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
    u_xlat37 = u_xlat37;
    u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat26.x = (-u_xlat5.x) + 1.0;
    u_xlat38 = u_xlat26.x * u_xlat26.x;
    u_xlat38 = max(u_xlat38, 0.0078125);
    u_xlat39 = u_xlat38 * u_xlat38;
    u_xlat40 = u_xlat5.x + 0.0400000215;
    u_xlat40 = min(u_xlat40, 1.0);
    u_xlat5.x = u_xlat38 * 4.0 + 2.0;
    ...
    u_xlat8.xyz = u_xlat3.xyz * (-vec3(u_xlat30)) + (-u_xlat1.xyz);
    ...
    u_xlat36 = u_xlat36 * u_xlat26.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat30 = u_xlat30 * u_xlat43;
        u_xlat11.xyz = vec3(u_xlat18) * _AdditionalLightsColor[u_xlati40].xyz;
        u_xlat40 = dot(u_xlat3.xyz, u_xlat10.xyz);
        u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
        u_xlat40 = u_xlat40 * u_xlat30;
        u_xlat11.xyz = vec3(u_xlat40) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat42) + u_xlat1.xyz;
        ...
        u_xlat9.xyz = vec3(u_xlat40) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
