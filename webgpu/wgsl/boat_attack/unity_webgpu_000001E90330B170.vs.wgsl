...
@group(0) @binding(25) var x_TerrainHeightmapTexture : texture_2d<f32>;

@group(0) @binding(26) var x_TerrainNormalmapTexture : texture_2d<f32>;

@group(1) @binding(7) var<uniform> x_262 : VGlobals;
