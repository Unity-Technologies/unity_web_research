...
;
    ...
    u_xlat3.xyz = vec3(u_xlat68) * u_xlat4.xyz;
    ...
    if(u_xlatb68){
        ...
        if(u_xlatb68){
            ...
            u_xlat68 = dot(u_xlat5, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb69){
                ...
                u_xlat26 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec5, 0.0);
                u_xlat26 = u_xlat26 * u_xlat11.y;
                u_xlat4.x = u_xlat11.x * u_xlat4.x + u_xlat26;
                vec3 txVec6 = vec3(u_xlat48.xy,u_xlat2.z);
                u_xlat26 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat4.x = u_xlat11.z * u_xlat26 + u_xlat4.x;
                vec3 txVec7 = vec3(u_xlat7.xy,u_xlat2.z);
                u_xlat26 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat4.x = u_xlat11.w * u_xlat26 + u_xlat4.x;
                vec3 txVec8 = vec3(u_xlat9.xy,u_xlat2.z);
                u_xlat26 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat4.x = u_xlat12.x * u_xlat26 + u_xlat4.x;
                vec3 txVec9 = vec3(u_xlat9.zw,u_xlat2.z);
                u_xlat26 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat4.x = u_xlat12.y * u_xlat26 + u_xlat4.x;
                vec3 txVec10 = vec3(u_xlat7.zw,u_xlat2.z);
                u_xlat26 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat4.x = u_xlat12.z * u_xlat26 + u_xlat4.x;
                vec3 txVec11 = vec3(u_xlat6.xy,u_xlat2.z);
                u_xlat26 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat4.x = u_xlat12.w * u_xlat26 + u_xlat4.x;
                vec3 txVec12 = vec3(u_xlat6.zw,u_xlat2.z);
                u_xlat26 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                u_xlat68 = u_xlat69 * u_xlat26 + u_xlat4.x;
            } else {
                u_xlat4.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat4.xy = floor(u_xlat4.xy);
                u_xlat48.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat4.xy);
                ...
                u_xlat69 = u_xlat15.x * u_xlat69 + u_xlat6.x;
                vec3 txVec15 = vec3(u_xlat48.xy,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec15, 0.0);
                u_xlat69 = u_xlat15.z * u_xlat48.x + u_xlat69;
                vec3 txVec16 = vec3(u_xlat13.xy,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec16, 0.0);
                u_xlat69 = u_xlat15.w * u_xlat48.x + u_xlat69;
                vec3 txVec17 = vec3(u_xlat11.xy,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec17, 0.0);
                u_xlat69 = u_xlat16.x * u_xlat48.x + u_xlat69;
                vec3 txVec18 = vec3(u_xlat11.zw,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec18, 0.0);
                u_xlat69 = u_xlat16.y * u_xlat48.x + u_xlat69;
                vec3 txVec19 = vec3(u_xlat12.xy,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec19, 0.0);
                u_xlat69 = u_xlat16.z * u_xlat48.x + u_xlat69;
                vec3 txVec20 = vec3(u_xlat13.zw,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec20, 0.0);
                u_xlat69 = u_xlat16.w * u_xlat48.x + u_xlat69;
                vec3 txVec21 = vec3(u_xlat14.xy,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec21, 0.0);
                u_xlat69 = u_xlat17.x * u_xlat48.x + u_xlat69;
                vec3 txVec22 = vec3(u_xlat14.zw,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec22, 0.0);
                u_xlat69 = u_xlat17.y * u_xlat48.x + u_xlat69;
                vec3 txVec23 = vec3(u_xlat28.xy,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec23, 0.0);
                u_xlat69 = u_xlat17.z * u_xlat48.x + u_xlat69;
                vec3 txVec24 = vec3(u_xlat56.xy,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat69 = u_xlat17.w * u_xlat48.x + u_xlat69;
                vec3 txVec25 = vec3(u_xlat9.xy,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec25, 0.0);
                u_xlat69 = u_xlat5.x * u_xlat48.x + u_xlat69;
                vec3 txVec26 = vec3(u_xlat9.zw,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec26, 0.0);
                u_xlat69 = u_xlat5.y * u_xlat48.x + u_xlat69;
                vec3 txVec27 = vec3(u_xlat51.xy,u_xlat2.z);
                u_xlat48.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
                u_xlat69 = u_xlat5.z * u_xlat48.x + u_xlat69;
                ...
                u_xlat68 = u_xlat5.w * u_xlat4.x + u_xlat69;
            }
        }
    } else {
    ...
    for(uint u_xlatu_loop_1 = uint(0u) ; u_xlatu_loop_1<u_xlatu69 ; u_xlatu_loop_1++)
    {
            ...
            if(u_xlatb7.x){
                ...
                if(u_xlatb7.x){
                    ...
                    if(u_xlatb29){
                        ...
                        u_xlat51.x = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec34, 0.0);
        ...
        u_xlat28.x = u_xlat24.x * u_xlat50.x + u_xlat28.x;
        u_xlat6.x = u_xlat28.x * u_xlat6.x;
    ...
    u_xlat22.xyz = u_xlat3.xyz * u_xlat0.yzw + u_xlat2.xzw;
