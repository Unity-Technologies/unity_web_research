...
void main()
{
    ...
    u_xlat1.xyz = texture(sampler2D(Texture2D_DE8BF47E, samplerTexture2D_DE8BF47E), vs_INTERP1.xy, _GlobalMipBias.x).yzw;
    u_xlat1.xyz = u_xlat1.zxy * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat0.xyz = u_xlat0.xyz * u_xlat1.yyy;
    u_xlat2.xyz = vec3(u_xlat12) * vs_INTERP0.xyz;
    u_xlat3.xyz = vec3(u_xlat12) * vs_INTERP3.xyz;
    ...
    u_xlat4.x = (-u_xlat4.x) + vs_INTERP2.y;
