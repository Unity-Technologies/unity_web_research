...
layout(set = 0, binding = 1) uniform mediump  sampler samplerSamplerState_Trilinear_Clamp;
void main()
{
vec3 u_xlat0;
bvec2 u_xlatb0;
...
float u_xlat6;
    ...
    u_xlat1.xyz = texture(sampler2D(_BumpMap, samplerSamplerState_Trilinear_Clamp), vs_INTERP2.xy, _GlobalMipBias.x).xyw;
