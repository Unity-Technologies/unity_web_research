...
fn main_1() {
  ...
  u_xlat0.x = x_2025;
  let x_2028 : bool = u_xlatb0.y;
  if (x_2028) {
    let x_2033 : f32 = u_xlat1.y;
    x_2029 = x_2033;
  } else {
    let x_2036 : f32 = u_xlat2.y;
    x_2029 = x_2036;
  }
  let x_2037 : f32 = x_2029;
  u_xlat0.y = x_2037;
  let x_2040 : bool = u_xlatb0.z;
  if (x_2040) {
    let x_2045 : f32 = u_xlat1.z;
    x_2041 = x_2045;
  } else {
  ...
  u_xlat0.z = x_2049;
  let x_2051 : vec2<f32> = vs_TEXCOORD0;
  let x_2054 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2058 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2060 : vec2<f32> = ((x_2051 * vec2<f32>(x_2054.x, x_2054.y)) + vec2<f32>(x_2058.z, x_2058.w));
  let x_2061 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2060.x, x_2060.y, x_2061.z, x_2061.w);
  let x_2068 : vec4<f32> = u_xlat1;
  let x_2071 : f32 = x_25.x_GlobalMipBias.x;
  let x_2072 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2068.x, x_2068.y), x_2071);
  u_xlat18 = x_2072.w;
  let x_2074 : f32 = u_xlat18;
  u_xlat18 = ((x_2074 * 2.0f) + -1.0f);
  let x_2077 : f32 = u_xlat18;
  u_xlatb1 = (x_2077 >= 0.0f);
  let x_2079 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2079);
  let x_2082 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2082)) + 1.0f);
  let x_2086 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2086);
  let x_2088 : f32 = u_xlat18;
  u_xlat18 = (-(x_2088) + 1.0f);
  let x_2091 : f32 = u_xlat18;
  let x_2093 : f32 = u_xlat1.x;
  u_xlat18 = (x_2091 * x_2093);
  let x_2095 : vec4<f32> = u_xlat0;
  let x_2097 : vec3<f32> = (vec3<f32>(x_2095.x, x_2095.y, x_2095.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2098 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2097.x, x_2097.y, x_2097.z, x_2098.w);
  let x_2100 : vec4<f32> = u_xlat0;
  let x_2103 : vec3<f32> = log2(abs(vec3<f32>(x_2100.x, x_2100.y, x_2100.z)));
  let x_2104 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2103.x, x_2103.y, x_2103.z, x_2104.w);
  let x_2106 : vec4<f32> = u_xlat2;
  let x_2108 : vec3<f32> = (vec3<f32>(x_2106.x, x_2106.y, x_2106.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2109 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2108.x, x_2108.y, x_2108.z, x_2109.w);
  let x_2111 : vec4<f32> = u_xlat2;
  let x_2113 : vec3<f32> = exp2(vec3<f32>(x_2111.x, x_2111.y, x_2111.z));
  let x_2114 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2113.x, x_2113.y, x_2113.z, x_2114.w);
  let x_2116 : vec4<f32> = u_xlat2;
  let x_2119 : vec3<f32> = ((vec3<f32>(x_2116.x, x_2116.y, x_2116.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2120 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2119.x, x_2119.y, x_2119.z, x_2120.w);
  let x_2122 : vec4<f32> = u_xlat0;
  let x_2124 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2122.x, x_2122.y, x_2122.z, x_2122.x));
  u_xlatb0 = vec3<bool>(x_2124.x, x_2124.y, x_2124.z);
  let x_2127 : bool = u_xlatb0.x;
  if (x_2127) {
    let x_2132 : f32 = u_xlat1.x;
    x_2128 = x_2132;
  } else {
    let x_2135 : f32 = u_xlat2.x;
    x_2128 = x_2135;
  }
  let x_2136 : f32 = x_2128;
  u_xlat0.x = x_2136;
  let x_2139 : bool = u_xlatb0.y;
  if (x_2139) {
    let x_2144 : f32 = u_xlat1.y;
    x_2140 = x_2144;
  } else {
    let x_2147 : f32 = u_xlat2.y;
    x_2140 = x_2147;
  }
  let x_2148 : f32 = x_2140;
  u_xlat0.y = x_2148;
  let x_2151 : bool = u_xlatb0.z;
  if (x_2151) {
  ...
  u_xlat0.z = x_2160;
  let x_2162 : f32 = u_xlat18;
  let x_2167 : vec4<f32> = u_xlat0;
  let x_2169 : vec3<f32> = ((vec3<f32>(x_2162, x_2162, x_2162) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2167.x, x_2167.y, x_2167.z));
  let x_2170 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2169.x, x_2169.y, x_2169.z, x_2170.w);
  let x_2172 : vec4<f32> = u_xlat0;
  let x_2174 : vec3<f32> = (vec3<f32>(x_2172.x, x_2172.y, x_2172.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2175 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2174.x, x_2174.y, x_2174.z, x_2175.w);
  let x_2177 : vec4<f32> = u_xlat0;
  let x_2179 : vec3<f32> = (vec3<f32>(x_2177.x, x_2177.y, x_2177.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2180 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2179.x, x_2179.y, x_2179.z, x_2180.w);
  let x_2182 : vec4<f32> = u_xlat2;
  let x_2184 : vec3<f32> = (vec3<f32>(x_2182.x, x_2182.y, x_2182.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2185 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2184.x, x_2184.y, x_2184.z, x_2185.w);
  let x_2187 : vec4<f32> = u_xlat2;
  let x_2190 : vec3<f32> = log2(abs(vec3<f32>(x_2187.x, x_2187.y, x_2187.z)));
  let x_2191 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2190.x, x_2190.y, x_2190.z, x_2191.w);
  let x_2193 : vec4<f32> = u_xlat2;
  let x_2195 : vec3<f32> = (vec3<f32>(x_2193.x, x_2193.y, x_2193.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_2205 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2203.x, x_2203.y, x_2203.z, x_2203.x));
  ...
  let x_2248 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2247.x, x_2247.y, x_2247.z, x_2248.w);
  SV_Target0.w = 1.0f;
  return;
}
