...
fn main_1() {
  ...
  let x_17 : f32 = vs_TEXCOORD0.z;
  u_xlat0.x = (x_17 + 1.0f);
  let x_23 : vec4<f32> = vs_TEXCOORD0;
  let x_25 : vec2<f32> = u_xlat0;
  u_xlat0 = (vec2<f32>(x_23.x, x_23.y) / vec2<f32>(x_25.x, x_25.x));
  let x_30 : vec2<f32> = u_xlat0;
  let x_36 : vec2<f32> = ((x_30 * vec2<f32>(0.28126230835914611816f, 0.28126230835914611816f)) + vec2<f32>(0.5f, 0.5f));
  ...
  SV_Target0.z = ((-(x_48) * 0.0039215688593685627f) + x_53);
