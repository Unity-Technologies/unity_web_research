...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat1.xzw = (u_xlatb1.x) ? u_xlat17.xyz : u_xlat5.xyz;
    ...
    u_xlat31.x = u_xlat4.y * u_xlat4.y;
    u_xlat31.x = u_xlat4.x * u_xlat4.x + (-u_xlat31.x);
    u_xlat6.xyz = unity_SHC.xyz * u_xlat31.xxx + u_xlat7.xyz;
    u_xlat5.xyz = u_xlat5.xyz + u_xlat6.xyz;
    u_xlat5.xyz = max(u_xlat5.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat31.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat6.xy = u_xlat31.xy * hlslcc_FragCoord.xy;
    u_xlat31.x = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat6.z = (-u_xlat31.x) + 1.0;
    u_xlat3.x = u_xlat3.x;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat42 = min(u_xlat42, 1.0);
    u_xlat2.xyz = u_xlat2.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat31.x = (-u_xlat3.x) + 1.0;
    u_xlat45 = u_xlat31.x * u_xlat31.x;
    ...
    u_xlat34.x = dot((-u_xlat1.xzw), u_xlat4.xyz);
    u_xlat34.x = u_xlat34.x + u_xlat34.x;
    u_xlat8.xyz = u_xlat4.xyz * (-u_xlat34.xxx) + (-u_xlat1.xzw);
    u_xlat34.x = dot(u_xlat4.xyz, u_xlat1.xzw);
    u_xlat34.x = clamp(u_xlat34.x, 0.0, 1.0);
    u_xlat34.x = (-u_xlat34.x) + 1.0;
    u_xlat34.x = u_xlat34.x * u_xlat34.x;
    u_xlat34.x = u_xlat34.x * u_xlat34.x;
    u_xlat48 = (-u_xlat31.x) * 0.699999988 + 1.70000005;
    u_xlat31.x = u_xlat31.x * u_xlat48;
    u_xlat31.x = u_xlat31.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat31.x);
    ...
    u_xlat8.xyz = u_xlat1.xzw + _MainLightPosition.xyz;
    ...
    u_xlat44 = u_xlat44 * u_xlat31.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu44 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu48)].www + _AdditionalLightsPosition[int(u_xlatu48)].xyz;
        ...
        u_xlat49 = u_xlat49 * _AdditionalLightsAttenuation[int(u_xlatu48)].x;
        u_xlat49 = (-u_xlat49) * u_xlat49 + 1.0;
        u_xlat49 = max(u_xlat49, 0.0);
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat49 = u_xlat49 * u_xlat51;
        u_xlat51 = dot(_AdditionalLightsSpotDir[int(u_xlatu48)].xyz, u_xlat10.xyz);
        u_xlat51 = u_xlat51 * _AdditionalLightsAttenuation[int(u_xlatu48)].z + _AdditionalLightsAttenuation[int(u_xlatu48)].w;
        u_xlat51 = clamp(u_xlat51, 0.0, 1.0);
        u_xlat51 = u_xlat51 * u_xlat51;
        u_xlat49 = u_xlat49 * u_xlat51;
        u_xlatu51 = u_xlatu48 >> (5u & uint(0x1F));
        u_xlati52 = 1 << (int(u_xlatu48) & int(0x1F));
        u_xlati51 = int(uint(u_xlati52) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu51)]));
        if(u_xlati51 != 0) {
            u_xlati51 = int(_AdditionalLightsLightTypes[int(u_xlatu48)]);
            u_xlati52 = (u_xlati51 != 0) ? 0 : 1;
            u_xlati11 = int(u_xlatu48) << (2 & int(0x1F));
            if(u_xlati52 != 0) {
                ...
                u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu48)].xy * u_xlat25.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu48)].zw;
            } else {
                ...
                if(u_xlati51 != 0) {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu48)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu48)].zw;
                } else {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu48)].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu48)].zw;
                }
            }
            ...
            u_xlat51 = (u_xlatb3.w) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat51);
        } else {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat50) + u_xlat1.xzw;
        ...
        u_xlat48 = u_xlat48 * u_xlat31.x + 1.00001001;
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat48 = u_xlat48 * u_xlat48;
        ...
        u_xlat9.xyz = vec3(u_xlat48) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat1.xzw = u_xlat5.xyz * u_xlat6.xxx + u_xlat7.xyz;
