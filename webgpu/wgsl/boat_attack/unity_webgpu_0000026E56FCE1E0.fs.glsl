...
vec2 u_xlat8;
vec2 u_xlat9;
layout(set = 0, binding = 1) uniform mediump  sampler sampler_PointRepeat;
void main()
{
    ...
    u_xlat0.xyz = textureLod(samplerCube(_BlitCubeTexture, sampler_PointRepeat), u_xlat0.xyz, _BlitMipLevel).xyz;
