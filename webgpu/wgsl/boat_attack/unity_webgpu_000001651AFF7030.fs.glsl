...
;
    ...
    u_xlat5.xy = u_xlat8.xz * hlslcc_FragCoord.xy;
    u_xlat8.x = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat8.x) + 1.0;
    u_xlat8.x = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat5.xz, _GlobalMipBias.x).x;
