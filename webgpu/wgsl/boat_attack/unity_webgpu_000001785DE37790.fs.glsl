...
;
    ...
    u_xlat2.x = u_xlat16 * u_xlat30 + u_xlat2.x;
    u_xlat7.xyz = vec3(u_xlat32) * _MainLightColor.xyz;
    u_xlat8.x = vs_TEXCOORD3.w;
    u_xlat8.y = vs_TEXCOORD4.w;
    u_xlat8.z = vs_TEXCOORD5.w;
    u_xlat16 = dot((-u_xlat8.xyz), u_xlat1.xyz);
    u_xlat16 = u_xlat16 + u_xlat16;
    u_xlat9.xyz = u_xlat1.xyz * (-vec3(u_xlat16)) + (-u_xlat8.xyz);
    ...
    u_xlat10.xyz = vec3(u_xlat16) * u_xlat10.xyz + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat4.x = dot(unity_LightIndices[int(u_xlatu4)], uintBitsToFloat(ImmCB_0[u_xlati46]));
        ...
        u_xlat46 = u_xlat46 * _AdditionalLightsAttenuation[u_xlati4].x;
        u_xlat46 = (-u_xlat46) * u_xlat46 + 1.0;
        u_xlat46 = max(u_xlat46, 0.0);
        u_xlat46 = u_xlat46 * u_xlat46;
        u_xlat46 = u_xlat46 * u_xlat48;
        u_xlat48 = dot(_AdditionalLightsSpotDir[u_xlati4].xyz, u_xlat10.xyz);
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[u_xlati4].z + _AdditionalLightsAttenuation[u_xlati4].w;
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        u_xlat48 = u_xlat48 * u_xlat48;
        u_xlat46 = u_xlat46 * u_xlat48;
        u_xlat11.xyz = vec3(u_xlat32) * _AdditionalLightsColor[u_xlati4].xyz;
        u_xlat4.x = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat4.x = clamp(u_xlat4.x, 0.0, 1.0);
        u_xlat4.x = u_xlat4.x * u_xlat46;
        u_xlat11.xyz = u_xlat4.xxx * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat47) + u_xlat8.xyz;
        u_xlat4.x = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat4.x = max(u_xlat4.x, 1.17549435e-37);
        u_xlat4.x = inversesqrt(u_xlat4.x);
        u_xlat9.xyz = u_xlat4.xxx * u_xlat9.xyz;
        u_xlat4.x = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat4.x = clamp(u_xlat4.x, 0.0, 1.0);
        ...
        u_xlat46 = max(u_xlat4.w, 0.100000001);
