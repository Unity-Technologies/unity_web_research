...
fn main_1() {
  ...
  let x_1478 : vec3<f32> = ((vec3<f32>(x_1472.x, x_1472.x, x_1472.x) * x_1474) + vec3<f32>(x_1476.x, x_1476.y, x_1476.z));
  let x_1479 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1478.x, x_1478.y, x_1478.z, x_1479.w);
  let x_1481 : vec2<f32> = vs_TEXCOORD0;
  let x_1484 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1488 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1490 : vec2<f32> = ((x_1481 * vec2<f32>(x_1484.x, x_1484.y)) + vec2<f32>(x_1488.z, x_1488.w));
  let x_1491 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1490.x, x_1490.y, x_1491.z);
  let x_1498 : vec3<f32> = u_xlat1;
  let x_1501 : f32 = x_25.x_GlobalMipBias.x;
  let x_1502 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1498.x, x_1498.y), x_1501);
  u_xlat21 = x_1502.w;
  let x_1504 : f32 = u_xlat21;
  u_xlat21 = (x_1504 + -0.5f);
  let x_1506 : f32 = u_xlat21;
  let x_1507 : f32 = u_xlat21;
  u_xlat21 = (x_1506 + x_1507);
  let x_1509 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1509.x, x_1509.y, x_1509.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1518 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1518);
  let x_1523 : f32 = x_25.x_Grain_Params.y;
  let x_1525 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1523 * -(x_1525)) + 1.0f);
  let x_1531 : f32 = u_xlat21;
  let x_1533 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_1531, x_1531, x_1531) * vec3<f32>(x_1533.x, x_1533.y, x_1533.z));
  let x_1536 : vec3<f32> = u_xlat8;
  let x_1539 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_1536 * vec3<f32>(x_1539.x, x_1539.x, x_1539.x));
