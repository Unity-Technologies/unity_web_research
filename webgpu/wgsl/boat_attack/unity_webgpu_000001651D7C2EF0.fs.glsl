...
;
    ...
    u_xlat5.xyz = vs_TEXCOORD1.yyy * _MainLightWorldToShadow[(u_xlati42 + 1) / 4][(u_xlati42 + 1) % 4].xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[u_xlati42 / 4][u_xlati42 % 4].xyz * vs_TEXCOORD1.xxx + u_xlat5.xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[(u_xlati42 + 2) / 4][(u_xlati42 + 2) % 4].xyz * vs_TEXCOORD1.zzz + u_xlat5.xyz;
    ...
    u_xlat42 = u_xlat7.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    ...
    u_xlat48 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat7.xz, _GlobalMipBias.x).x;
    ...
    if(u_xlatb19.x){
        u_xlat19.xy = vs_TEXCOORD1.yy * _MainLightWorldToLight[1].xy;
        u_xlat19.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD1.xx + u_xlat19.xy;
        u_xlat19.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD1.zz + u_xlat19.xy;
        u_xlat19.xy = u_xlat19.xy + _MainLightWorldToLight[3].xy;
        u_xlat19.xy = u_xlat19.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat8 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat19.xy, _GlobalMipBias.x);
        ...
        u_xlat33 = (u_xlatb19.y) ? u_xlat8.w : u_xlat8.x;
        u_xlat21.xyz = (u_xlatb19.x) ? u_xlat8.xyz : vec3(u_xlat33);
    } else {
    ...
    u_xlat8.xyz = u_xlat3.xyz * (-u_xlat19.xxx) + (-u_xlat4.xyz);
    u_xlat19.x = dot(u_xlat3.xyz, u_xlat4.xyz);
    u_xlat19.x = clamp(u_xlat19.x, 0.0, 1.0);
    ...
    u_xlat9.xy = vec2(u_xlat45) * vec2(u_xlat45) + vec2(-1.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat45 = dot(unity_LightIndices[int(u_xlatu45)], uintBitsToFloat(ImmCB_0[u_xlati49]));
        u_xlatu45 =  uint(int(u_xlat45));
        u_xlat23.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu45)].www + _AdditionalLightsPosition[int(u_xlatu45)].xyz;
        u_xlat49 = dot(u_xlat23.xyz, u_xlat23.xyz);
        u_xlat49 = max(u_xlat49, 6.10351562e-05);
        u_xlat50 = inversesqrt(u_xlat49);
        u_xlat10.xyz = vec3(u_xlat50) * u_xlat23.xyz;
        u_xlat52 = float(1.0) / float(u_xlat49);
        u_xlat49 = u_xlat49 * _AdditionalLightsAttenuation[int(u_xlatu45)].x;
        u_xlat49 = (-u_xlat49) * u_xlat49 + 1.0;
        u_xlat49 = max(u_xlat49, 0.0);
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat49 = u_xlat49 * u_xlat52;
        u_xlat52 = dot(_AdditionalLightsSpotDir[int(u_xlatu45)].xyz, u_xlat10.xyz);
        u_xlat52 = u_xlat52 * _AdditionalLightsAttenuation[int(u_xlatu45)].z + _AdditionalLightsAttenuation[int(u_xlatu45)].w;
        u_xlat52 = clamp(u_xlat52, 0.0, 1.0);
        u_xlat52 = u_xlat52 * u_xlat52;
        u_xlat49 = u_xlat49 * u_xlat52;
        u_xlatu52 = u_xlatu45 >> (5u & uint(0x1F));
        u_xlati11 = 1 << (int(u_xlatu45) & int(0x1F));
        u_xlati52 = int(uint(u_xlati11) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu52)]));
        if(u_xlati52 != 0) {
            u_xlati52 = int(_AdditionalLightsLightTypes[int(u_xlatu45)]);
            u_xlati11 = (u_xlati52 != 0) ? 0 : 1;
            u_xlati25 = int(u_xlatu45) << (2 & int(0x1F));
            if(u_xlati11 != 0) {
                ...
                u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu45)].xy * u_xlat11.xz + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu45)].zw;
            } else {
                ...
                if(u_xlati52 != 0) {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu45)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu45)].zw;
                } else {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu45)].xy * u_xlat25.xz + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu45)].zw;
                }
            }
        ...
        u_xlat23.xyz = u_xlat23.xyz * vec3(u_xlat50) + u_xlat4.xyz;
        ...
        u_xlat23.xyz = u_xlat0.xyz * vec3(u_xlat45) + u_xlat15.xyz;
        u_xlat8.xyz = u_xlat23.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat6.xyz * vec3(u_xlat48) + u_xlat5.xyz;
