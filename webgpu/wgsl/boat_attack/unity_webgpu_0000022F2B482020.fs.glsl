...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat18 = u_xlat0.w * _BaseColor.w + (-_Cutoff);
    ...
    u_xlat18 = u_xlat0.x + -9.99999975e-05;
    u_xlatb18 = u_xlat18<0.0;
    if(((int(u_xlatb18) * int(0xffffffffu)))!=0){discard;}
    u_xlat18 = dot(vs_TEXCOORD2.xyz, vs_TEXCOORD2.xyz);
    u_xlat18 = inversesqrt(u_xlat18);
    u_xlat2.xyz = vec3(u_xlat18) * vs_TEXCOORD2.xyz;
    u_xlat18 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat18 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat18;
    u_xlat18 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat18;
    u_xlat18 = u_xlat18 + unity_MatrixV[3].z;
    ...
    u_xlat3.xyz = vec3(u_xlat54) * u_xlat4.xyz;
    u_xlat54 = max(u_xlat3.w, 9.99999975e-05);
    u_xlat3.xyz = u_xlat3.xyz / vec3(u_xlat54);
    u_xlat4.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat4.xy = u_xlat4.xy * hlslcc_FragCoord.xy;
    u_xlat54 = u_xlat4.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat4.z = (-u_xlat54) + 1.0;
    u_xlat54 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat4.xz, _GlobalMipBias.x).x;
    ...
    if(u_xlatb56){
        ...
        if(u_xlatb56){
            ...
            if(u_xlatb57){
                ...
                u_xlat4.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec4, 0.0);
                vec3 txVec5 = vec3(u_xlat8.zw,vs_TEXCOORD6.z);
                u_xlat22 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec5, 0.0);
                u_xlat22 = u_xlat22 * u_xlat11.y;
                u_xlat4.x = u_xlat11.x * u_xlat4.x + u_xlat22;
                vec3 txVec6 = vec3(u_xlat40.xy,vs_TEXCOORD6.z);
                u_xlat22 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec6, 0.0);
                u_xlat4.x = u_xlat11.z * u_xlat22 + u_xlat4.x;
                vec3 txVec7 = vec3(u_xlat7.xy,vs_TEXCOORD6.z);
                u_xlat22 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec7, 0.0);
                u_xlat4.x = u_xlat11.w * u_xlat22 + u_xlat4.x;
                vec3 txVec8 = vec3(u_xlat9.xy,vs_TEXCOORD6.z);
                u_xlat22 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec8, 0.0);
                u_xlat4.x = u_xlat12.x * u_xlat22 + u_xlat4.x;
                vec3 txVec9 = vec3(u_xlat9.zw,vs_TEXCOORD6.z);
                u_xlat22 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec9, 0.0);
                u_xlat4.x = u_xlat12.y * u_xlat22 + u_xlat4.x;
                vec3 txVec10 = vec3(u_xlat7.zw,vs_TEXCOORD6.z);
                u_xlat22 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec10, 0.0);
                u_xlat4.x = u_xlat12.z * u_xlat22 + u_xlat4.x;
                vec3 txVec11 = vec3(u_xlat6.xy,vs_TEXCOORD6.z);
                u_xlat22 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec11, 0.0);
                u_xlat4.x = u_xlat12.w * u_xlat22 + u_xlat4.x;
                vec3 txVec12 = vec3(u_xlat6.zw,vs_TEXCOORD6.z);
                u_xlat22 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec12, 0.0);
                ...
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec16, 0.0);
                u_xlat57 = u_xlat15.w * u_xlat40.x + u_xlat57;
                vec3 txVec17 = vec3(u_xlat11.xy,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec17, 0.0);
                u_xlat57 = u_xlat16.x * u_xlat40.x + u_xlat57;
                vec3 txVec18 = vec3(u_xlat11.zw,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec18, 0.0);
                u_xlat57 = u_xlat16.y * u_xlat40.x + u_xlat57;
                vec3 txVec19 = vec3(u_xlat12.xy,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec19, 0.0);
                u_xlat57 = u_xlat16.z * u_xlat40.x + u_xlat57;
                vec3 txVec20 = vec3(u_xlat13.zw,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec20, 0.0);
                u_xlat57 = u_xlat16.w * u_xlat40.x + u_xlat57;
                vec3 txVec21 = vec3(u_xlat14.xy,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec21, 0.0);
                u_xlat57 = u_xlat17.x * u_xlat40.x + u_xlat57;
                vec3 txVec22 = vec3(u_xlat14.zw,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec22, 0.0);
                u_xlat57 = u_xlat17.y * u_xlat40.x + u_xlat57;
                vec3 txVec23 = vec3(u_xlat24.xy,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat57 = u_xlat17.z * u_xlat40.x + u_xlat57;
                vec3 txVec24 = vec3(u_xlat48.xy,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec24, 0.0);
                u_xlat57 = u_xlat17.w * u_xlat40.x + u_xlat57;
                vec3 txVec25 = vec3(u_xlat9.xy,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec25, 0.0);
                u_xlat57 = u_xlat5.x * u_xlat40.x + u_xlat57;
                vec3 txVec26 = vec3(u_xlat9.zw,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec26, 0.0);
                u_xlat57 = u_xlat5.y * u_xlat40.x + u_xlat57;
                vec3 txVec27 = vec3(u_xlat43.xy,vs_TEXCOORD6.z);
                u_xlat40.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
        ...
        u_xlat56 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    ...
    u_xlat4.x = (-u_xlat56) + 1.0;
    u_xlat56 = u_xlat57 * u_xlat4.x + u_xlat56;
    ...
    if(u_xlatb57){
        ...
        u_xlat57 = (u_xlatb5.y) ? u_xlat4.w : u_xlat4.x;
        u_xlat4.xyz = (u_xlatb5.x) ? u_xlat4.xyz : vec3(u_xlat57);
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.y = float(1.0);
        u_xlat4.z = float(1.0);
    ...
    u_xlat54 = u_xlat56 * unity_LightData.z;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu54 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat57 = dot(unity_LightIndices[int(u_xlatu57)], uintBitsToFloat(ImmCB_0[u_xlati58]));
        u_xlatu57 =  uint(int(u_xlat57));
        u_xlat7.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu57)].www + _AdditionalLightsPosition[int(u_xlatu57)].xyz;
        ...
        u_xlat58 = u_xlat58 * _AdditionalLightsAttenuation[int(u_xlatu57)].x;
        u_xlat58 = (-u_xlat58) * u_xlat58 + 1.0;
        u_xlat58 = max(u_xlat58, 0.0);
        u_xlat58 = u_xlat58 * u_xlat58;
        u_xlat58 = u_xlat58 * u_xlat41.x;
        u_xlat41.x = dot(_AdditionalLightsSpotDir[int(u_xlatu57)].xyz, u_xlat7.xyz);
        u_xlat41.x = u_xlat41.x * _AdditionalLightsAttenuation[int(u_xlatu57)].z + _AdditionalLightsAttenuation[int(u_xlatu57)].w;
        u_xlat41.x = clamp(u_xlat41.x, 0.0, 1.0);
        u_xlat41.x = u_xlat41.x * u_xlat41.x;
        u_xlat58 = u_xlat58 * u_xlat41.x;
        u_xlatu41 = u_xlatu57 >> (5u & uint(0x1F));
        u_xlati59 = 1 << (int(u_xlatu57) & int(0x1F));
        u_xlati41 = int(uint(u_xlati59) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu41)]));
        if(u_xlati41 != 0) {
            u_xlati41 = int(_AdditionalLightsLightTypes[int(u_xlatu57)]);
            u_xlati59 = (u_xlati41 != 0) ? 0 : 1;
            u_xlati60 = int(u_xlatu57) << (2 & int(0x1F));
            if(u_xlati59 != 0) {
                u_xlat8.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati60 + 1) / 4][(u_xlati60 + 1) % 4].xyw;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[u_xlati60 / 4][u_xlati60 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat8.xyz;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[(u_xlati60 + 2) / 4][(u_xlati60 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat8.xyz;
                u_xlat8.xyz = u_xlat8.xyz + _AdditionalLightsWorldToLights[(u_xlati60 + 3) / 4][(u_xlati60 + 3) % 4].xyw;
                u_xlat8.xy = u_xlat8.xy / u_xlat8.zz;
                u_xlat8.xy = u_xlat8.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat8.xy = clamp(u_xlat8.xy, 0.0, 1.0);
                u_xlat8.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu57)].xy * u_xlat8.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu57)].zw;
            } else {
                u_xlatb41 = u_xlati41==1;
                u_xlati41 = u_xlatb41 ? 1 : int(0);
                if(u_xlati41 != 0) {
                    u_xlat41.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati60 + 1) / 4][(u_xlati60 + 1) % 4].xy;
                    u_xlat41.xy = _AdditionalLightsWorldToLights[u_xlati60 / 4][u_xlati60 % 4].xy * vs_TEXCOORD1.xx + u_xlat41.xy;
                    u_xlat41.xy = _AdditionalLightsWorldToLights[(u_xlati60 + 2) / 4][(u_xlati60 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat41.xy;
                    u_xlat41.xy = u_xlat41.xy + _AdditionalLightsWorldToLights[(u_xlati60 + 3) / 4][(u_xlati60 + 3) % 4].xy;
                    u_xlat41.xy = u_xlat41.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat41.xy = fract(u_xlat41.xy);
                    u_xlat8.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu57)].xy * u_xlat41.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu57)].zw;
                } else {
                    u_xlat9 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati60 + 1) / 4][(u_xlati60 + 1) % 4];
                    u_xlat9 = _AdditionalLightsWorldToLights[u_xlati60 / 4][u_xlati60 % 4] * vs_TEXCOORD1.xxxx + u_xlat9;
                    u_xlat9 = _AdditionalLightsWorldToLights[(u_xlati60 + 2) / 4][(u_xlati60 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat9;
                    u_xlat9 = u_xlat9 + _AdditionalLightsWorldToLights[(u_xlati60 + 3) / 4][(u_xlati60 + 3) % 4];
                    u_xlat9.xyz = u_xlat9.xyz / u_xlat9.www;
                    u_xlat41.x = dot(u_xlat9.xyz, u_xlat9.xyz);
                    u_xlat41.x = inversesqrt(u_xlat41.x);
                    u_xlat9.xyz = u_xlat41.xxx * u_xlat9.xyz;
                    u_xlat41.x = dot(abs(u_xlat9.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat41.x = max(u_xlat41.x, 9.99999997e-07);
                    u_xlat41.x = float(1.0) / float(u_xlat41.x);
                    u_xlat10.xyz = u_xlat41.xxx * u_xlat9.zxy;
                    ...
                    u_xlat41.xy = u_xlat9.xy * u_xlat41.xx + u_xlat44.xy;
                    u_xlat41.xy = u_xlat41.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat41.x = (u_xlatb5.y) ? u_xlat8.w : u_xlat8.x;
            u_xlat8.xyz = (u_xlatb5.x) ? u_xlat8.xyz : u_xlat41.xxx;
        } else {
            u_xlat8.x = float(1.0);
            u_xlat8.y = float(1.0);
            u_xlat8.z = float(1.0);
        }
        u_xlat8.xyz = u_xlat8.xyz * _AdditionalLightsColor[int(u_xlatu57)].xyz;
    ...
    SV_Target0.xyz = vec3(u_xlat18) * u_xlat1.xyz + unity_FogColor.xyz;
