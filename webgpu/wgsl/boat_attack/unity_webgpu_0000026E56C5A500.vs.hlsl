...
float depth = _CameraDepthTexture . Load ( int3 ( _SourceSize . xy * uv , 0 ) ) . x ;
float linearEyeDepth = LinearEyeDepth ( depth , _ZBufferParams ) ;

half coc = ( 1.0 - _CoCParams . x / linearEyeDepth ) * _CoCParams . y ;
...
#line 81
half3 c0 = _BlitTexture . SampleBias ( sampler_LinearClamp , uv0 , _GlobalMipBias . x ) . xyz ;
half3 c1 = _BlitTexture . SampleBias ( sampler_LinearClamp , uv1 , _GlobalMipBias . x ) . xyz ;
half3 c2 = _BlitTexture . SampleBias ( sampler_LinearClamp , uv2 , _GlobalMipBias . x ) . xyz ;
half3 c3 = _BlitTexture . SampleBias ( sampler_LinearClamp , uv3 , _GlobalMipBias . x ) . xyz ;
#line 87
half coc0 = _FullCoCTexture . SampleBias ( sampler_LinearClamp , uv0 , _GlobalMipBias . x ) . x * 2.0 - 1.0 ;
half coc1 = _FullCoCTexture . SampleBias ( sampler_LinearClamp , uv1 , _GlobalMipBias . x ) . x * 2.0 - 1.0 ;
half coc2 = _FullCoCTexture . SampleBias ( sampler_LinearClamp , uv2 , _GlobalMipBias . x ) . x * 2.0 - 1.0 ;
half coc3 = _FullCoCTexture . SampleBias ( sampler_LinearClamp , uv3 , _GlobalMipBias . x ) . x * 2.0 - 1.0 ;
#line 108
half3 avg = ( c0 + c1 + c2 + c3 ) / 4.0 ;
#line 113
half cocMin = min ( coc0 , Min3 ( coc1 , coc2 , coc3 ) ) ;
half cocMax = max ( coc0 , Max3 ( coc1 , coc2 , coc3 ) ) ;
half coc = ( - cocMin > cocMax ? cocMin : cocMax ) * _CoCParams . z ;
#line 118
...
{
half4 samp = _BlitTexture . SampleBias ( sampler_LinearClamp , ClampAndScaleUVForBilinear ( uv + disp . wy , _BlitTexture_TexelSize . xy ) , _GlobalMipBias . x ) ;
#line 132
...
half4 samp0 = _BlitTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) ;
...
#line 171
nearAcc . a *= 3.14159265358979323846 / ( 42 + 1 ) ;
#line 174
...
half4 acc ;
acc = _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv - duv . xy , _BlitTexture_TexelSize . xy ) , _GlobalMipBias . x ) ;
acc += _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv - duv . zy , _BlitTexture_TexelSize . xy ) , _GlobalMipBias . x ) ;
acc += _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv + duv . zy , _BlitTexture_TexelSize . xy ) , _GlobalMipBias . x ) ;
acc += _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv + duv . xy , _BlitTexture_TexelSize . xy ) , _GlobalMipBias . x ) ;
return acc * 0.25 ;
}
...
half4 dof = _DofTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv , _BlitTexture_TexelSize . xy * dofDownSample ) , _GlobalMipBias . x ) ;
half coc = _FullCoCTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv , _BlitTexture_TexelSize . xy ) , _GlobalMipBias . x ) . r ;
coc = ( coc - 0.5 ) * 2.0 * _CoCParams . z ;
#line 206
float ffa = smoothstep ( _SourceSize . w * 2.0 , _SourceSize . w * 4.0 , coc ) ;

half4 color = _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv , _BlitTexture_TexelSize . xy ) , _GlobalMipBias . x ) ;
#line 214
