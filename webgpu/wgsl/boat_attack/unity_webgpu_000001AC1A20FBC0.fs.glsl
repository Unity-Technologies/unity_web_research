...
void main()
{
    ...
    u_xlat6.x = texture(sampler2D(_SecondTex, sampler_SecondTex), u_xlat0.xy).w;
    u_xlat6.xy = u_xlat6.xx * vec2(0.390625, 1.984375);
    ...
    u_xlat3 = u_xlat1 * 1.15625 + (-u_xlat6.x);
    u_xlat0.z = u_xlat1 * 1.15625 + u_xlat6.y;
    u_xlat0.y = (-u_xlat0.x) * 0.8125 + u_xlat3;
    u_xlat0.x = u_xlat0.x * 1.59375;
    u_xlat0.x = u_xlat1 * 1.15625 + u_xlat0.x;
    u_xlat2.xyz = u_xlat0.xyz + vec3(-0.872539997, 0.531369984, -1.06861997);
