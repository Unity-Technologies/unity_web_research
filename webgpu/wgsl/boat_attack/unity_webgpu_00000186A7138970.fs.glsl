...
;
    ...
    if(u_xlatb57){
        ...
        if(u_xlatb57){
            ...
            u_xlat57 = dot(u_xlat6, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb1){
                ...
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec4, 0.0);
                vec3 txVec5 = vec3(u_xlat9.zw,u_xlat3.z);
                u_xlat60 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec5, 0.0);
                u_xlat60 = u_xlat60 * u_xlat12.y;
                u_xlat59 = u_xlat12.x * u_xlat59 + u_xlat60;
                vec3 txVec6 = vec3(u_xlat43.xy,u_xlat3.z);
                u_xlat60 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec6, 0.0);
                u_xlat59 = u_xlat12.z * u_xlat60 + u_xlat59;
                vec3 txVec7 = vec3(u_xlat8.xy,u_xlat3.z);
                u_xlat60 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec7, 0.0);
                u_xlat59 = u_xlat12.w * u_xlat60 + u_xlat59;
                vec3 txVec8 = vec3(u_xlat10.xy,u_xlat3.z);
                u_xlat60 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec8, 0.0);
                u_xlat59 = u_xlat13.x * u_xlat60 + u_xlat59;
                vec3 txVec9 = vec3(u_xlat10.zw,u_xlat3.z);
                u_xlat60 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec9, 0.0);
                u_xlat59 = u_xlat13.y * u_xlat60 + u_xlat59;
                vec3 txVec10 = vec3(u_xlat8.zw,u_xlat3.z);
                u_xlat60 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec10, 0.0);
                u_xlat59 = u_xlat13.z * u_xlat60 + u_xlat59;
                vec3 txVec11 = vec3(u_xlat7.xy,u_xlat3.z);
                u_xlat60 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec11, 0.0);
                u_xlat59 = u_xlat13.w * u_xlat60 + u_xlat59;
                vec3 txVec12 = vec3(u_xlat7.zw,u_xlat3.z);
                u_xlat60 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec12, 0.0);
                u_xlat57 = u_xlat1.x * u_xlat60 + u_xlat59;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat43.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat1.x = u_xlat16.x * u_xlat1.x + u_xlat59;
                ...
                u_xlat1.x = u_xlat16.z * u_xlat59 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat16.w * u_xlat59 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat17.x * u_xlat59 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat17.y * u_xlat59 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat17.z * u_xlat59 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat17.w * u_xlat59 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat18.x * u_xlat59 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat18.y * u_xlat59 + u_xlat1.x;
                vec3 txVec23 = vec3(u_xlat26.xy,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat1.x = u_xlat18.z * u_xlat59 + u_xlat1.x;
                vec3 txVec24 = vec3(u_xlat51.xy,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec24, 0.0);
                u_xlat1.x = u_xlat18.w * u_xlat59 + u_xlat1.x;
                vec3 txVec25 = vec3(u_xlat10.xy,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec25, 0.0);
                u_xlat1.x = u_xlat6.x * u_xlat59 + u_xlat1.x;
                vec3 txVec26 = vec3(u_xlat10.zw,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec26, 0.0);
                u_xlat1.x = u_xlat6.y * u_xlat59 + u_xlat1.x;
                vec3 txVec27 = vec3(u_xlat46.xy,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
                u_xlat1.x = u_xlat6.z * u_xlat59 + u_xlat1.x;
                vec3 txVec28 = vec3(u_xlat5.xy,u_xlat3.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec28, 0.0);
                u_xlat57 = u_xlat6.w * u_xlat59 + u_xlat1.x;
            }
        }
    } else {
    ...
    u_xlat57 = u_xlat57 * _MainLightShadowParams.x + u_xlat1.x;
    u_xlatb1 = 0.0>=u_xlat3.z;
    u_xlatb59 = u_xlat3.z>=1.0;
    u_xlatb1 = u_xlatb1 || u_xlatb59;
    u_xlat57 = (u_xlatb1) ? 1.0 : u_xlat57;
    u_xlat3.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat1.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat1.x = u_xlat1.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat59 = (-u_xlat57) + 1.0;
    u_xlat57 = u_xlat1.x * u_xlat59 + u_xlat57;
    u_xlat57 = u_xlat57 * unity_LightData.z;
    u_xlat3.xyz = vec3(u_xlat57) * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu57 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati59].www + _AdditionalLightsPosition[u_xlati59].xyz;
        ...
        u_xlat61 = dot(_AdditionalLightsSpotDir[u_xlati59].xyz, u_xlat6.xyz);
        u_xlat61 = u_xlat61 * _AdditionalLightsAttenuation[u_xlati59].z + _AdditionalLightsAttenuation[u_xlati59].w;
        u_xlat61 = clamp(u_xlat61, 0.0, 1.0);
        u_xlat61 = u_xlat61 * u_xlat61;
        u_xlat60 = u_xlat60 * u_xlat61;
        u_xlat7.xyz = vec3(u_xlat60) * _AdditionalLightsColor[u_xlati59].xyz;
        u_xlat59 = dot(u_xlat2.xyz, u_xlat6.xyz);
