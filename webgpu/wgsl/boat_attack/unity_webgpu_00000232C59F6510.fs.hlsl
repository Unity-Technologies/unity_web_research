...
#line 12 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.universal@16.0.1/ShaderLibrary/SSAO.hlsl"
Texture2D_half _BlueNoiseTexture ;
Texture2D_half _ScreenSpaceOcclusionTexture ;
...
uv . y = 1.0 - uv . y ;
#line 252
float zScale = linearDepth * _ProjectionParams2 . x ;
...
#line 394
zDist = half ( - dot ( unity_MatrixV [ 2 ] . xyz , vpos_s1 ) ) ;
