...
void main()
{
    ...
    u_xlat17 = u_xlat4 * 4.0 + 2.0;
    vec3 txVec0 = vec3(vs_TEXCOORD8.xy,vs_TEXCOORD8.z);
    u_xlat32 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec0, 0.0);
    u_xlat46 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat32 = u_xlat32 * _MainLightShadowParams.x + u_xlat46;
    u_xlatb46 = 0.0>=vs_TEXCOORD8.z;
    u_xlatb5 = vs_TEXCOORD8.z>=1.0;
    u_xlatb46 = u_xlatb46 || u_xlatb5;
    u_xlat32 = (u_xlatb46) ? 1.0 : u_xlat32;
    u_xlat5.xyz = vs_TEXCOORD7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat46 = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat5.x = u_xlat46 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
    u_xlat19 = (-u_xlat32) + 1.0;
    u_xlat32 = u_xlat5.x * u_xlat19 + u_xlat32;
    ...
    u_xlat47 = dot((-u_xlat6.xyz), u_xlat15.xyz);
    u_xlat47 = u_xlat47 + u_xlat47;
    u_xlat7.xyz = u_xlat15.xyz * (-vec3(u_xlat47)) + (-u_xlat6.xyz);
    ...
    u_xlat8.xy = vec2(u_xlat4) * vec2(u_xlat4) + vec2(-1.0, 1.0);
    ...
    u_xlat16.xyz = u_xlat16.xyz * u_xlat3.xzw + u_xlat7.xyz;
    u_xlat42 = u_xlat32 * unity_LightData.z;
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat42) + u_xlat3.xzw;
    u_xlat42 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu42 =  uint(int(u_xlat42));
    u_xlat1 = u_xlat46 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlati52 = 1 << (u_xlati47 & int(0x1F));
        ...
        if(u_xlati52 != 0) {
            ...
            u_xlati25 = u_xlati47 << (2 & int(0x1F));
            if(u_xlati11 != 0) {
            ...
            u_xlat52 = (u_xlatb4.z) ? u_xlat11.w : u_xlat11.x;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat47) + u_xlat3.xzw;
        u_xlat22.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat22.xyz;
    }
    u_xlat0.xyz = u_xlat7.xyz * u_xlat5.xyz + u_xlat16.xyz;
