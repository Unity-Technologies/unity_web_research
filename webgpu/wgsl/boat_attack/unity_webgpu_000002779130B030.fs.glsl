...
void main()
{
    ...
    u_xlat4.w = dot(u_xlat32.xyz, u_xlat32.xyz);
...
;
    ...
    u_xlat77 = dot(u_xlat5, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat77 = (-u_xlat77) + 4.0;
    u_xlatu77 = uint(u_xlat77);
    u_xlati77 = int(u_xlatu77) << (2 & int(0x1F));
    u_xlat4.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati77 + 1) / 4][(u_xlati77 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati77 / 4][u_xlati77 % 4].xyz * vs_INTERP7.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati77 + 2) / 4][(u_xlati77 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati77 + 3) / 4][(u_xlati77 + 3) % 4].xyz;
    ...
    u_xlat78 = dot(u_xlat25.xyz, u_xlat5.xyz);
    ...
    if(u_xlatb31.x){
        ...
        if(u_xlatb31.x){
            ...
            if(u_xlatb56){
                u_xlat56.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat56.xy = floor(u_xlat56.xy);
                u_xlat7.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat56.xy);
                ...
                vec3 txVec19 = vec3(u_xlat63.xy,u_xlat4.z);
                ...
                vec3 txVec28 = vec3(u_xlat56.xy,u_xlat4.z);
    ...
    u_xlat4.x = u_xlat31.x * _MainLightShadowParams.x + u_xlat4.x;
    u_xlatb29 = 0.0>=u_xlat4.z;
    u_xlatb54 = u_xlat4.z>=1.0;
    u_xlatb29 = u_xlatb54 || u_xlatb29;
    u_xlat4.x = (u_xlatb29) ? 1.0 : u_xlat4.x;
    u_xlat31.xyz = vs_INTERP7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat29.x = dot(u_xlat31.xyz, u_xlat31.xyz);
    u_xlat54 = u_xlat29.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
    u_xlat31.x = (-u_xlat4.x) + 1.0;
    u_xlat4.x = u_xlat54 * u_xlat31.x + u_xlat4.x;
    ...
    if(u_xlatb54){
        ...
        u_xlat54 = (u_xlatb31.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat31.xyz = (u_xlatb31.x) ? u_xlat7.xyz : vec3(u_xlat54);
    } else {
    ...
    u_xlat7.xyz = u_xlat25.xyz * (-vec3(u_xlat54)) + (-u_xlat1.xyz);
    u_xlat54 = dot(u_xlat25.xyz, u_xlat1.xyz);
    u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
    ...
    u_xlat33.xyz = vec3(u_xlat54) * u_xlat33.xyz + u_xlat2.xyz;
    ...
    u_xlat76 = dot(u_xlat25.xyz, _MainLightPosition.xyz);
    ...
    u_xlat76 = u_xlat29.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
    ...
    {
        u_xlatu54 = u_xlatu_loop_1 >> (2u & uint(0x1F));
        u_xlati82 = int(u_xlatu_loop_1 & 3u);
        u_xlat54 = dot(unity_LightIndices[int(u_xlatu54)], uintBitsToFloat(ImmCB_0[u_xlati82]));
        u_xlati54 = int(u_xlat54);
        u_xlat33.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati54].www + _AdditionalLightsPosition[u_xlati54].xyz;
        ...
        u_xlat82 = u_xlat82 * _AdditionalLightsAttenuation[u_xlati54].x;
        u_xlat82 = (-u_xlat82) * u_xlat82 + 1.0;
        u_xlat82 = max(u_xlat82, 0.0);
        u_xlat82 = u_xlat82 * u_xlat82;
        u_xlat82 = u_xlat82 * u_xlat10.x;
        u_xlat10.x = dot(_AdditionalLightsSpotDir[u_xlati54].xyz, u_xlat34.xyz);
        u_xlat10.x = u_xlat10.x * _AdditionalLightsAttenuation[u_xlati54].z + _AdditionalLightsAttenuation[u_xlati54].w;
        u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
        u_xlat10.x = u_xlat10.x * u_xlat10.x;
        u_xlat82 = u_xlat82 * u_xlat10.x;
        u_xlati10 = int(_AdditionalShadowParams[u_xlati54].w);
        u_xlatb35.x = u_xlati10>=0;
        if(u_xlatb35.x){
            u_xlatb35.x = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati54].z);
            if(u_xlatb35.x){
                ...
                u_xlat60.x = trunc(_AdditionalShadowParams[u_xlati54].w);
            ...
            u_xlatb85 = 0.0<_AdditionalShadowParams[u_xlati54].y;
            if(u_xlatb85){
                u_xlatb85 = 1.0==_AdditionalShadowParams[u_xlati54].y;
                if(u_xlatb85){
                    ...
                    u_xlatb11.x = 2.0==_AdditionalShadowParams[u_xlati54].y;
                    if(u_xlatb11.x){
            ...
            u_xlat10.x = 1.0 + (-_AdditionalShadowParams[u_xlati54].x);
            u_xlat10.x = u_xlat85 * _AdditionalShadowParams[u_xlati54].x + u_xlat10.x;
        ...
        u_xlat10.x = u_xlat76 * u_xlat35.x + u_xlat10.x;
        u_xlati35 = 1 << (u_xlati54 & int(0x1F));
        u_xlati35 = int(uint(u_xlati35) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati35 != 0) {
            u_xlati35 = int(_AdditionalLightsLightTypes[u_xlati54]);
            u_xlati60 = (u_xlati35 != 0) ? 0 : 1;
            u_xlati85 = u_xlati54 << (2 & int(0x1F));
            if(u_xlati60 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati54].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati54].zw;
            } else {
                ...
                if(u_xlati35 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati54].xy * u_xlat35.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati54].zw;
                } else {
            ...
            u_xlat35.x = (u_xlatb4.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat35.xyz = (u_xlatb4.x) ? u_xlat11.xyz : u_xlat35.xxx;
        } else {
            u_xlat35.x = float(1.0);
            u_xlat35.y = float(1.0);
            u_xlat35.z = float(1.0);
        }
        u_xlat35.xyz = u_xlat35.xyz * _AdditionalLightsColor[u_xlati54].xyz;
        u_xlat54 = u_xlat82 * u_xlat10.x;
        u_xlat82 = dot(u_xlat25.xyz, u_xlat34.xyz);
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        u_xlat54 = u_xlat54 * u_xlat82;
        u_xlat10.xyz = vec3(u_xlat54) * u_xlat35.xyz;
        u_xlat33.xyz = u_xlat33.xyz * u_xlat9.xxx + u_xlat1.xyz;
        u_xlat54 = dot(u_xlat33.xyz, u_xlat33.xyz);
        u_xlat54 = max(u_xlat54, 1.17549435e-38);
        u_xlat54 = inversesqrt(u_xlat54);
        u_xlat33.xyz = vec3(u_xlat54) * u_xlat33.xyz;
        u_xlat54 = dot(u_xlat25.xyz, u_xlat33.xyz);
        u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
        ...
        u_xlat33.xyz = u_xlat2.xyz * vec3(u_xlat54) + u_xlat3.xyz;
        u_xlat7.xyz = u_xlat33.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * u_xlat6.xxx + u_xlat31.xyz;
