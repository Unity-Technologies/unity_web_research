...
fn main_1() {
  ...
  let x_843 : vec4<f32> = x_25.x_Dithering_Params;
  let x_847 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_860 : f32 = x_25.x_GlobalMipBias.x;
  ...
  u_xlatb1.x = (x_867 >= 0.0f);
  let x_871 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_871);
  let x_874 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_874)) + 1.0f);
