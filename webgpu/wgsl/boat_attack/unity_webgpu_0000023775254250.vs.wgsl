...
fn main_1() {
  ...
  u_xlat0 = (x_68 * vec4<f32>(1.97500002384185791016f, 0.79299998283386230469f, 0.375f, 0.19300000369548797607f));
  ...
  u_xlat4 = (x_142 * 0.10000000149011611938f);
  ...
  u_xlat0.z = 0.30000001192092895508f;
