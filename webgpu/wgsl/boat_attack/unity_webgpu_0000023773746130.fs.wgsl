...
fn main_1() {
  ...
  let x_985 : vec3<f32> = sqrt(vec3<f32>(x_983.x, x_983.y, x_983.z));
  let x_986 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_985.x, x_985.y, x_985.z, x_986.w);
  let x_988 : vec2<f32> = vs_TEXCOORD0;
  let x_991 : vec4<f32> = x_25.x_Dithering_Params;
  let x_995 : vec4<f32> = x_25.x_Dithering_Params;
  let x_997 : vec2<f32> = ((x_988 * vec2<f32>(x_991.x, x_991.y)) + vec2<f32>(x_995.z, x_995.w));
  let x_998 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_997.x, x_997.y, x_998.z, x_998.w);
  let x_1005 : vec4<f32> = u_xlat1;
  let x_1008 : f32 = x_25.x_GlobalMipBias.x;
  let x_1009 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1005.x, x_1005.y), x_1008);
  u_xlat15 = x_1009.w;
  let x_1011 : f32 = u_xlat15;
  u_xlat15 = ((x_1011 * 2.0f) + -1.0f);
  let x_1015 : f32 = u_xlat15;
  u_xlatb1.x = (x_1015 >= 0.0f);
  let x_1019 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1019);
  let x_1022 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1022)) + 1.0f);
  let x_1026 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1026);
  let x_1028 : f32 = u_xlat15;
  u_xlat15 = (-(x_1028) + 1.0f);
  let x_1031 : f32 = u_xlat15;
  let x_1033 : f32 = u_xlat1.x;
  u_xlat15 = (x_1031 * x_1033);
  let x_1035 : vec4<f32> = u_xlat0;
  let x_1037 : vec3<f32> = (vec3<f32>(x_1035.x, x_1035.y, x_1035.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  ...
  let x_1064 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1062.x, x_1062.y, x_1062.z, x_1062.x));
  ...
  let x_1109 : vec3<f32> = ((vec3<f32>(x_1102, x_1102, x_1102) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1107.x, x_1107.y, x_1107.z));
  let x_1110 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1109.x, x_1109.y, x_1109.z, x_1110.w);
  let x_1112 : vec4<f32> = u_xlat0;
  let x_1114 : vec3<f32> = (vec3<f32>(x_1112.x, x_1112.y, x_1112.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1115 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1114.x, x_1114.y, x_1114.z, x_1115.w);
  let x_1117 : vec4<f32> = u_xlat0;
  let x_1119 : vec3<f32> = (vec3<f32>(x_1117.x, x_1117.y, x_1117.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1120 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1119.x, x_1119.y, x_1119.z, x_1120.w);
  let x_1122 : vec4<f32> = u_xlat2;
  let x_1124 : vec3<f32> = (vec3<f32>(x_1122.x, x_1122.y, x_1122.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1125 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1124.x, x_1124.y, x_1124.z, x_1125.w);
  let x_1127 : vec4<f32> = u_xlat2;
  let x_1130 : vec3<f32> = log2(abs(vec3<f32>(x_1127.x, x_1127.y, x_1127.z)));
  let x_1131 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1130.x, x_1130.y, x_1130.z, x_1131.w);
  let x_1133 : vec4<f32> = u_xlat2;
  let x_1135 : vec3<f32> = (vec3<f32>(x_1133.x, x_1133.y, x_1133.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1136 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1135.x, x_1135.y, x_1135.z, x_1136.w);
  let x_1138 : vec4<f32> = u_xlat2;
  let x_1140 : vec3<f32> = exp2(vec3<f32>(x_1138.x, x_1138.y, x_1138.z));
  let x_1141 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1140.x, x_1140.y, x_1140.z, x_1141.w);
  let x_1143 : vec4<f32> = u_xlat0;
  let x_1145 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1143.x, x_1143.y, x_1143.z, x_1143.x));
  u_xlatb0 = vec3<bool>(x_1145.x, x_1145.y, x_1145.z);
  let x_1148 : bool = u_xlatb0.x;
  if (x_1148) {
    let x_1153 : f32 = u_xlat1.x;
    x_1149 = x_1153;
  } else {
  ...
  u_xlat0.x = x_1157;
  let x_1160 : bool = u_xlatb0.y;
  if (x_1160) {
    let x_1165 : f32 = u_xlat1.y;
    x_1161 = x_1165;
  } else {
    let x_1168 : f32 = u_xlat2.y;
    x_1161 = x_1168;
  }
  let x_1169 : f32 = x_1161;
  u_xlat0.y = x_1169;
  let x_1172 : bool = u_xlatb0.z;
  if (x_1172) {
    let x_1177 : f32 = u_xlat1.z;
    x_1173 = x_1177;
  } else {
  ...
  let x_1188 : vec3<f32> = max(vec3<f32>(x_1185.x, x_1185.y, x_1185.z), vec3<f32>(0.0f, 0.0f, 0.0f));
