...
;
    ...
    u_xlat0.x = u_xlat18.x * u_xlat30 + u_xlat0.x;
    ...
    u_xlat18.xyz = u_xlat0.xxx * _MainLightColor.xyz;
    u_xlat7.xzw = u_xlat4.xyz + _MainLightPosition.xyz;
    u_xlat0.x = dot(u_xlat7.xzw, u_xlat7.xzw);
    u_xlat0.x = max(u_xlat0.x, 1.17549435e-38);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat7.xzw = u_xlat0.xxx * u_xlat7.xzw;
    u_xlat0.x = dot(u_xlat3.xyz, u_xlat7.xzw);
    ...
    u_xlat7.xzw = u_xlat0.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xzw;
    ...
    u_xlat0.xyz = u_xlat12.xyz * vec3(u_xlat41) + u_xlat18.xyz;
