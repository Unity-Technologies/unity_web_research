...
layout(set = 0, binding = 15) uniform mediump  sampler sampler_TerrainHolesTexture;
...
void main()
{
    ...
    u_xlat2.x = dot(u_xlat26.xyz, u_xlat26.xyz);
    u_xlat2.x = inversesqrt(u_xlat2.x);
    u_xlat26.xyz = u_xlat26.xyz * u_xlat2.xxx;
    ...
    u_xlat76 = dot(vs_TEXCOORD3.xyz, vs_TEXCOORD3.xyz);
    u_xlat76 = inversesqrt(u_xlat76);
    u_xlat2.xyz = vec3(u_xlat76) * vs_TEXCOORD3.xyz;
...
;
    ...
    u_xlat76 = dot(u_xlat4, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat76 = (-u_xlat76) + 4.0;
    u_xlatu76 = uint(u_xlat76);
    u_xlati76 = int(u_xlatu76) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati76 + 1) / 4][(u_xlati76 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati76 / 4][u_xlati76 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati76 + 2) / 4][(u_xlati76 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati76 + 3) / 4][(u_xlati76 + 3) % 4].xyz;
    ...
    u_xlat77 = dot(u_xlat2.xyz, u_xlat4.xyz);
    ...
    u_xlat78 = u_xlat50 + (-u_xlat77);
    u_xlat6.xyz = vec3(u_xlat77) * u_xlat5.xyz;
    ...
    if(u_xlatb80){
        ...
        if(u_xlatb80){
            ...
            u_xlat80 = dot(u_xlat8, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            u_xlatb81 = _MainLightShadowParams.y==2.0;
            if(u_xlatb81){
                ...
                u_xlat32 = u_xlat32 * u_xlat14.y;
                u_xlat7.x = u_xlat14.x * u_xlat7.x + u_xlat32;
                ...
                u_xlat7.x = u_xlat14.z * u_xlat32 + u_xlat7.x;
                ...
                u_xlat7.x = u_xlat14.w * u_xlat32 + u_xlat7.x;
                ...
                u_xlat7.x = u_xlat15.x * u_xlat32 + u_xlat7.x;
                ...
                u_xlat7.x = u_xlat15.y * u_xlat32 + u_xlat7.x;
                ...
                u_xlat7.x = u_xlat15.z * u_xlat32 + u_xlat7.x;
                ...
                u_xlat7.x = u_xlat15.w * u_xlat32 + u_xlat7.x;
                ...
                u_xlat80 = u_xlat81 * u_xlat32 + u_xlat7.x;
            } else {
                u_xlat7.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat57.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                u_xlat81 = u_xlat18.x * u_xlat81 + u_xlat9.x;
                ...
                u_xlat81 = u_xlat18.z * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat18.w * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat19.x * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat19.y * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat19.z * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat19.w * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat20.x * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat20.y * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat20.z * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat20.w * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat8.x * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat8.y * u_xlat57.x + u_xlat81;
                ...
                u_xlat81 = u_xlat8.z * u_xlat57.x + u_xlat81;
                ...
                u_xlat80 = u_xlat8.w * u_xlat7.x + u_xlat81;
            }
        }
    } else {
    ...
    u_xlat3.x = u_xlat80 * _MainLightShadowParams.x + u_xlat3.x;
    ...
    u_xlat80 = (-u_xlat3.x) + 1.0;
    u_xlat3.x = u_xlat53 * u_xlat80 + u_xlat3.x;
    u_xlat53 = dot((-u_xlat1.xyz), u_xlat2.xyz);
    u_xlat53 = u_xlat53 + u_xlat53;
    u_xlat7.xyz = u_xlat2.xyz * (-vec3(u_xlat53)) + (-u_xlat1.xyz);
    ...
    u_xlat50 = u_xlat50 * u_xlat80;
    u_xlat50 = u_xlat79 * u_xlat50;
    u_xlat50 = u_xlat77 / u_xlat50;
    u_xlat7.xyz = u_xlat5.xyz * vec3(u_xlat50) + u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu50 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat81) + u_xlat6.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat25) + u_xlat3.xzw;
