...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat11.x = texture(sampler2D(_DitheringTexture, sampler_PointRepeat), u_xlat11.xz, _GlobalMipBias.x).w;
    ...
    u_xlat11.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec0, 0.0);
    ...
    u_xlat1.x = u_xlat33 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat35 = (-u_xlat11.x) + 1.0;
    u_xlat11.x = u_xlat1.x * u_xlat35 + u_xlat11.x;
