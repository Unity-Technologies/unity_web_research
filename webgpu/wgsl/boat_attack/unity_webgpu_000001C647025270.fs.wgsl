...
fn main_1() {
  ...
  u_xlat0.x = log2(x_308);
  let x_312 : f32 = u_xlat0.x;
  let x_314 : f32 = x_161.x_FlareData3.z;
  u_xlat0.x = (x_312 * x_314);
  let x_318 : f32 = u_xlat0.x;
  u_xlat0.x = exp2(x_318);
  let x_322 : f32 = u_xlat0.x;
  u_xlat0.x = min(x_322, 1.0f);
  let x_325 : vec4<f32> = u_xlat0;
  let x_329 : vec4<f32> = x_161.x_FlareColorValue;
  u_xlat0 = (vec4<f32>(x_325.x, x_325.x, x_325.x, x_325.x) * x_329);
  let x_333 : vec4<f32> = u_xlat0;
  let x_336 : f32 = vs_TEXCOORD1;
  SV_Target0 = (x_333 * vec4<f32>(x_336, x_336, x_336, x_336));
  return;
}
