...
;
    u_xlat21.x = (u_xlatb3.x) ? float(-1.0) : float(-0.0);
    u_xlat21.y = (u_xlatb3.y) ? float(-1.0) : float(-0.0);
    u_xlat21.z = (u_xlatb3.z) ? float(-1.0) : float(-0.0);
    u_xlat21.xyz = u_xlat21.xyz + u_xlat4.yzw;
    u_xlat4.yzw = max(u_xlat21.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat21.x = dot(u_xlat4, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat21.x = (-u_xlat21.x) + 4.0;
    u_xlatu21 = uint(u_xlat21.x);
    u_xlati21 = int(u_xlatu21) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati21 + 1) / 4][(u_xlati21 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati21 / 4][u_xlati21 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati21 + 2) / 4][(u_xlati21 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat21.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati21 + 3) / 4][(u_xlati21 + 3) % 4].xyz;
    u_xlat2.w = 1.0;
    ...
    u_xlat4.xyz = unity_SHC.xyz * vec3(u_xlat62) + u_xlat5.xyz;
    ...
    if(u_xlatb64){
        ...
        if(u_xlatb64){
            ...
            if(u_xlatb65){
                u_xlat6.xy = u_xlat21.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat6.xy = floor(u_xlat6.xy);
                u_xlat46.xy = u_xlat21.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                ...
                vec3 txVec6 = vec3(u_xlat46.xy,u_xlat21.z);
                ...
                vec3 txVec7 = vec3(u_xlat9.xy,u_xlat21.z);
                ...
                vec3 txVec8 = vec3(u_xlat11.xy,u_xlat21.z);
                ...
                vec3 txVec9 = vec3(u_xlat11.zw,u_xlat21.z);
                ...
                vec3 txVec10 = vec3(u_xlat9.zw,u_xlat21.z);
                ...
                vec3 txVec11 = vec3(u_xlat8.xy,u_xlat21.z);
                ...
                vec3 txVec12 = vec3(u_xlat8.zw,u_xlat21.z);
                ...
                vec3 txVec15 = vec3(u_xlat46.xy,u_xlat21.z);
                ...
                vec3 txVec17 = vec3(u_xlat13.xy,u_xlat21.z);
                ...
                vec3 txVec18 = vec3(u_xlat13.zw,u_xlat21.z);
                ...
                vec3 txVec19 = vec3(u_xlat14.xy,u_xlat21.z);
                ...
                vec3 txVec23 = vec3(u_xlat28.xy,u_xlat21.z);
                ...
                vec3 txVec24 = vec3(u_xlat54.xy,u_xlat21.z);
                ...
                vec3 txVec27 = vec3(u_xlat49.xy,u_xlat21.z);
                ...
                vec3 txVec28 = vec3(u_xlat6.xy,u_xlat21.z);
    ...
    u_xlat21.x = u_xlat64 * _MainLightShadowParams.x + u_xlat21.x;
    u_xlatb41.x = 0.0>=u_xlat21.z;
    u_xlatb61 = u_xlat21.z>=1.0;
    u_xlatb41.x = u_xlatb61 || u_xlatb41.x;
    u_xlat21.x = (u_xlatb41.x) ? 1.0 : u_xlat21.x;
    u_xlat6.xyz = vs_TEXCOORD7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat41.x = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat41.x = u_xlat41.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat41.x = clamp(u_xlat41.x, 0.0, 1.0);
    u_xlat61 = (-u_xlat21.x) + 1.0;
    u_xlat21.x = u_xlat41.x * u_xlat61 + u_xlat21.x;
    u_xlatb41.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb41.x){
        u_xlat41.xy = vs_TEXCOORD7.yy * _MainLightWorldToLight[1].xy;
        u_xlat41.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD7.xx + u_xlat41.xy;
        u_xlat41.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD7.zz + u_xlat41.xy;
        u_xlat41.xy = u_xlat41.xy + _MainLightWorldToLight[3].xy;
        u_xlat41.xy = u_xlat41.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat6 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat41.xy, _GlobalMipBias.x);
        u_xlatb41.xy = equal(vec4(vec4(_MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat)), vec4(0.0, 1.0, 0.0, 1.0)).xy;
        u_xlat61 = (u_xlatb41.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb41.x) ? u_xlat6.xyz : vec3(u_xlat61);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat41.x = dot((-u_xlat7.xyz), u_xlat2.xyz);
    u_xlat41.x = u_xlat41.x + u_xlat41.x;
    u_xlat8.xyz = u_xlat2.xyz * (-u_xlat41.xxx) + (-u_xlat7.xyz);
    u_xlat41.x = dot(u_xlat2.xyz, u_xlat7.xyz);
    u_xlat41.x = clamp(u_xlat41.x, 0.0, 1.0);
    u_xlat41.x = (-u_xlat41.x) + 1.0;
    u_xlat1.z = u_xlat41.x * u_xlat41.x;
    ...
    u_xlat1.xw = vec2(u_xlat62) * vec2(u_xlat62) + vec2(-1.0, 1.0);
    ...
    u_xlat60 = u_xlat21.x * unity_LightData.z;
    u_xlat21.x = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat21.x = clamp(u_xlat21.x, 0.0, 1.0);
    u_xlat60 = u_xlat60 * u_xlat21.x;
    u_xlat21.xyz = vec3(u_xlat60) * u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu64)].www + _AdditionalLightsPosition[int(u_xlatu64)].xyz;
        u_xlat65 = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat65 = max(u_xlat65, 6.10351562e-05);
        u_xlat46.x = inversesqrt(u_xlat65);
        u_xlat10.xyz = u_xlat46.xxx * u_xlat9.xyz;
        u_xlat66 = float(1.0) / float(u_xlat65);
        ...
        u_xlat66 = dot(_AdditionalLightsSpotDir[int(u_xlatu64)].xyz, u_xlat10.xyz);
        u_xlat66 = u_xlat66 * _AdditionalLightsAttenuation[int(u_xlatu64)].z + _AdditionalLightsAttenuation[int(u_xlatu64)].w;
        u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
        u_xlat66 = u_xlat66 * u_xlat66;
        u_xlat65 = u_xlat65 * u_xlat66;
        u_xlatu66 = u_xlatu64 >> (5u & uint(0x1F));
        u_xlati67 = 1 << (int(u_xlatu64) & int(0x1F));
        u_xlati66 = int(uint(u_xlati67) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu66)]));
        if(u_xlati66 != 0) {
            u_xlati66 = int(_AdditionalLightsLightTypes[int(u_xlatu64)]);
            u_xlati67 = (u_xlati66 != 0) ? 0 : 1;
            u_xlati68 = int(u_xlatu64) << (2 & int(0x1F));
            if(u_xlati67 != 0) {
                u_xlat11.xyz = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati68 + 1) / 4][(u_xlati68 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati68 / 4][u_xlati68 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati68 + 2) / 4][(u_xlati68 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat11.xyz;
                ...
                if(u_xlati66 != 0) {
                    u_xlat51.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati68 + 1) / 4][(u_xlati68 + 1) % 4].xy;
                    u_xlat51.xy = _AdditionalLightsWorldToLights[u_xlati68 / 4][u_xlati68 % 4].xy * vs_TEXCOORD7.xx + u_xlat51.xy;
                    u_xlat51.xy = _AdditionalLightsWorldToLights[(u_xlati68 + 2) / 4][(u_xlati68 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat51.xy;
                    u_xlat51.xy = u_xlat51.xy + _AdditionalLightsWorldToLights[(u_xlati68 + 3) / 4][(u_xlati68 + 3) % 4].xy;
                    u_xlat51.xy = u_xlat51.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat51.xy = fract(u_xlat51.xy);
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu64)].xy * u_xlat51.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu64)].zw;
                } else {
                    u_xlat12 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToLights[(u_xlati68 + 1) / 4][(u_xlati68 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati68 / 4][u_xlati68 % 4] * vs_TEXCOORD7.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati68 + 2) / 4][(u_xlati68 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat12;
                    ...
                    u_xlat51.xy = u_xlat12.xy * vec2(u_xlat66) + u_xlat51.xy;
                    u_xlat51.xy = u_xlat51.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat66 = (u_xlatb6.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb6.x) ? u_xlat11.xyz : vec3(u_xlat66);
        } else {
        ...
        u_xlat64 = dot(u_xlat2.xyz, u_xlat10.xyz);
        u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
        u_xlat64 = u_xlat64 * u_xlat65;
        u_xlat11.xyz = vec3(u_xlat64) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * u_xlat46.xxx + u_xlat7.xyz;
        ...
        u_xlat64 = dot(u_xlat2.xyz, u_xlat9.xyz);
        u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat64) + u_xlat5.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * u_xlat4.xxx + u_xlat21.xyz;
