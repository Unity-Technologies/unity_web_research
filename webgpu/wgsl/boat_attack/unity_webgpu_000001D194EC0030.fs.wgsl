...
fn main_1() {
  ...
  let x_2130 : bool = u_xlatb0.x;
  if (x_2130) {
    let x_2135 : f32 = u_xlat1.x;
    x_2131 = x_2135;
  } else {
    let x_2138 : f32 = u_xlat2.x;
    x_2131 = x_2138;
  }
  let x_2139 : f32 = x_2131;
  SV_Target0.x = x_2139;
  let x_2143 : bool = u_xlatb0.y;
  if (x_2143) {
    let x_2148 : f32 = u_xlat1.y;
    x_2144 = x_2148;
  } else {
    let x_2151 : f32 = u_xlat2.y;
    x_2144 = x_2151;
  }
  let x_2152 : f32 = x_2144;
  SV_Target0.y = x_2152;
  let x_2155 : bool = u_xlatb0.z;
  if (x_2155) {
    let x_2160 : f32 = u_xlat1.z;
    x_2156 = x_2160;
  } else {
    let x_2163 : f32 = u_xlat2.z;
    x_2156 = x_2163;
  }
  let x_2164 : f32 = x_2156;
  SV_Target0.z = x_2164;
  SV_Target0.w = 1.0f;
  return;
}
