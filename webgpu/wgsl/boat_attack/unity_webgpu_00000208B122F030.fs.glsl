...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlati69 != 0) {
            ...
            u_xlat69 = (u_xlatb4.z) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb4.x) ? u_xlat11.xyz : vec3(u_xlat69);
        } else {
        ...
        u_xlat30.xyz = u_xlat30.xyz * vec3(u_xlat68) + u_xlat7.xyz;
        ...
        u_xlat30.xyz = u_xlat5.xyz * vec3(u_xlat64) + u_xlat6.xyz;
