...
fn main_1() {
  ...
  let x_1436 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1440 : vec4<f32> = x_25.x_Grain_TilingParams;
  ...
  let x_1454 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1450.x, x_1450.y), x_1453);
  u_xlat21 = x_1454.w;
  let x_1456 : f32 = u_xlat21;
  u_xlat21 = (x_1456 + -0.5f);
  let x_1458 : f32 = u_xlat21;
  let x_1459 : f32 = u_xlat21;
  u_xlat21 = (x_1458 + x_1459);
  let x_1461 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1461.x, x_1461.y, x_1461.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1470 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1470);
  let x_1475 : f32 = x_25.x_Grain_Params.y;
  let x_1477 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1475 * -(x_1477)) + 1.0f);
  let x_1483 : f32 = u_xlat21;
  let x_1485 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_1483, x_1483, x_1483) * vec3<f32>(x_1485.x, x_1485.y, x_1485.z));
  let x_1488 : vec3<f32> = u_xlat8;
  let x_1491 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_1488 * vec3<f32>(x_1491.x, x_1491.x, x_1491.x));
  let x_1494 : vec3<f32> = u_xlat8;
  let x_1495 : vec3<f32> = u_xlat1;
  let x_1498 : vec4<f32> = u_xlat0;
  let x_1500 : vec3<f32> = ((x_1494 * vec3<f32>(x_1495.x, x_1495.x, x_1495.x)) + vec3<f32>(x_1498.x, x_1498.y, x_1498.z));
  let x_1501 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1500.x, x_1500.y, x_1500.z, x_1501.w);
  let x_1503 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1503.x, x_1503.y, x_1503.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1506 : vec4<f32> = u_xlat0;
  let x_1509 : vec3<f32> = log2(abs(vec3<f32>(x_1506.x, x_1506.y, x_1506.z)));
  let x_1510 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1509.x, x_1509.y, x_1509.z, x_1510.w);
  let x_1512 : vec4<f32> = u_xlat2;
  let x_1514 : vec3<f32> = (vec3<f32>(x_1512.x, x_1512.y, x_1512.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1515 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1514.x, x_1514.y, x_1514.z, x_1515.w);
  let x_1517 : vec4<f32> = u_xlat2;
  let x_1519 : vec3<f32> = exp2(vec3<f32>(x_1517.x, x_1517.y, x_1517.z));
  let x_1520 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1519.x, x_1519.y, x_1519.z, x_1520.w);
  let x_1522 : vec4<f32> = u_xlat2;
  let x_1525 : vec3<f32> = ((vec3<f32>(x_1522.x, x_1522.y, x_1522.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1526 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1525.x, x_1525.y, x_1525.z, x_1526.w);
  let x_1528 : vec4<f32> = u_xlat0;
  let x_1530 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1528.x, x_1528.y, x_1528.z, x_1528.x));
  ...
  u_xlat0.z = x_1566;
  let x_1568 : vec2<f32> = vs_TEXCOORD0;
  let x_1571 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1575 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1577 : vec2<f32> = ((x_1568 * vec2<f32>(x_1571.x, x_1571.y)) + vec2<f32>(x_1575.z, x_1575.w));
  let x_1578 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1577.x, x_1577.y, x_1578.z);
  let x_1585 : vec3<f32> = u_xlat1;
  let x_1588 : f32 = x_25.x_GlobalMipBias.x;
  let x_1589 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1585.x, x_1585.y), x_1588);
  u_xlat21 = x_1589.w;
  let x_1591 : f32 = u_xlat21;
  u_xlat21 = ((x_1591 * 2.0f) + -1.0f);
  let x_1594 : f32 = u_xlat21;
  u_xlatb1.x = (x_1594 >= 0.0f);
  let x_1598 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1598);
  let x_1601 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1601)) + 1.0f);
  let x_1605 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1605);
  let x_1607 : f32 = u_xlat21;
  u_xlat21 = (-(x_1607) + 1.0f);
  let x_1610 : f32 = u_xlat21;
  let x_1612 : f32 = u_xlat1.x;
  u_xlat21 = (x_1610 * x_1612);
  let x_1614 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1614.x, x_1614.y, x_1614.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1617 : vec4<f32> = u_xlat0;
  let x_1620 : vec3<f32> = log2(abs(vec3<f32>(x_1617.x, x_1617.y, x_1617.z)));
  let x_1621 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1620.x, x_1620.y, x_1620.z, x_1621.w);
  let x_1623 : vec4<f32> = u_xlat2;
  let x_1625 : vec3<f32> = (vec3<f32>(x_1623.x, x_1623.y, x_1623.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1636 : vec3<f32> = ((vec3<f32>(x_1633.x, x_1633.y, x_1633.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1637 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1636.x, x_1636.y, x_1636.z, x_1637.w);
  let x_1639 : vec4<f32> = u_xlat0;
  let x_1641 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1639.x, x_1639.y, x_1639.z, x_1639.x));
  u_xlatb0 = vec3<bool>(x_1641.x, x_1641.y, x_1641.z);
  let x_1644 : bool = u_xlatb0.x;
  if (x_1644) {
    let x_1649 : f32 = u_xlat1.x;
    x_1645 = x_1649;
  } else {
    let x_1652 : f32 = u_xlat2.x;
    x_1645 = x_1652;
  }
  let x_1653 : f32 = x_1645;
  u_xlat0.x = x_1653;
  let x_1656 : bool = u_xlatb0.y;
  if (x_1656) {
    let x_1661 : f32 = u_xlat1.y;
    x_1657 = x_1661;
  } else {
    let x_1664 : f32 = u_xlat2.y;
    x_1657 = x_1664;
  }
  let x_1665 : f32 = x_1657;
  u_xlat0.y = x_1665;
  let x_1668 : bool = u_xlatb0.z;
  if (x_1668) {
    let x_1673 : f32 = u_xlat1.z;
    x_1669 = x_1673;
  } else {
  ...
  u_xlat0.z = x_1677;
  let x_1679 : f32 = u_xlat21;
  let x_1684 : vec4<f32> = u_xlat0;
  let x_1686 : vec3<f32> = ((vec3<f32>(x_1679, x_1679, x_1679) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1684.x, x_1684.y, x_1684.z));
  let x_1687 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1686.x, x_1686.y, x_1686.z, x_1687.w);
  let x_1689 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1689.x, x_1689.y, x_1689.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1692 : vec4<f32> = u_xlat0;
  let x_1694 : vec3<f32> = (vec3<f32>(x_1692.x, x_1692.y, x_1692.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1695 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1694.x, x_1694.y, x_1694.z, x_1695.w);
  let x_1697 : vec4<f32> = u_xlat2;
  let x_1699 : vec3<f32> = (vec3<f32>(x_1697.x, x_1697.y, x_1697.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1700 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1699.x, x_1699.y, x_1699.z, x_1700.w);
  let x_1702 : vec4<f32> = u_xlat2;
  let x_1705 : vec3<f32> = log2(abs(vec3<f32>(x_1702.x, x_1702.y, x_1702.z)));
  let x_1706 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1705.x, x_1705.y, x_1705.z, x_1706.w);
  let x_1708 : vec4<f32> = u_xlat2;
  let x_1710 : vec3<f32> = (vec3<f32>(x_1708.x, x_1708.y, x_1708.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1711 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1710.x, x_1710.y, x_1710.z, x_1711.w);
  let x_1713 : vec4<f32> = u_xlat2;
  let x_1715 : vec3<f32> = exp2(vec3<f32>(x_1713.x, x_1713.y, x_1713.z));
  let x_1716 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1715.x, x_1715.y, x_1715.z, x_1716.w);
  let x_1718 : vec4<f32> = u_xlat0;
  let x_1720 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1718.x, x_1718.y, x_1718.z, x_1718.x));
  u_xlatb0 = vec3<bool>(x_1720.x, x_1720.y, x_1720.z);
  let x_1723 : bool = u_xlatb0.x;
  if (x_1723) {
  ...
  let x_1762 : vec3<f32> = max(vec3<f32>(x_1760.x, x_1760.y, x_1760.z), vec3<f32>(0.0f, 0.0f, 0.0f));
