...
fn main_1() {
  ...
  let x_1247 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1251 : vec4<f32> = x_25.x_Grain_TilingParams;
  ...
  let x_1265 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1261.x, x_1261.y), x_1264);
  u_xlat21 = x_1265.w;
  let x_1267 : f32 = u_xlat21;
  u_xlat21 = (x_1267 + -0.5f);
  let x_1269 : f32 = u_xlat21;
  let x_1270 : f32 = u_xlat21;
  u_xlat21 = (x_1269 + x_1270);
  let x_1272 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1272.x, x_1272.y, x_1272.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1281 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1281);
  let x_1286 : f32 = x_25.x_Grain_Params.y;
  let x_1288 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1286 * -(x_1288)) + 1.0f);
  let x_1294 : f32 = u_xlat21;
  let x_1296 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_1294, x_1294, x_1294) * vec3<f32>(x_1296.x, x_1296.y, x_1296.z));
  let x_1299 : vec3<f32> = u_xlat8;
  let x_1302 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_1299 * vec3<f32>(x_1302.x, x_1302.x, x_1302.x));
  let x_1305 : vec3<f32> = u_xlat8;
  let x_1306 : vec3<f32> = u_xlat1;
  let x_1309 : vec4<f32> = u_xlat0;
  let x_1311 : vec3<f32> = ((x_1305 * vec3<f32>(x_1306.x, x_1306.x, x_1306.x)) + vec3<f32>(x_1309.x, x_1309.y, x_1309.z));
  let x_1312 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1311.x, x_1311.y, x_1311.z, x_1312.w);
  let x_1314 : vec4<f32> = u_xlat0;
  let x_1316 : vec3<f32> = sqrt(vec3<f32>(x_1314.x, x_1314.y, x_1314.z));
  let x_1317 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1316.x, x_1316.y, x_1316.z, x_1317.w);
  let x_1319 : vec2<f32> = vs_TEXCOORD0;
  let x_1322 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1326 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1328 : vec2<f32> = ((x_1319 * vec2<f32>(x_1322.x, x_1322.y)) + vec2<f32>(x_1326.z, x_1326.w));
  let x_1329 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1328.x, x_1328.y, x_1329.z);
  let x_1336 : vec3<f32> = u_xlat1;
  let x_1339 : f32 = x_25.x_GlobalMipBias.x;
  let x_1340 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1336.x, x_1336.y), x_1339);
  u_xlat21 = x_1340.w;
  let x_1342 : f32 = u_xlat21;
  u_xlat21 = ((x_1342 * 2.0f) + -1.0f);
  let x_1345 : f32 = u_xlat21;
  u_xlatb1.x = (x_1345 >= 0.0f);
  let x_1349 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1349);
  let x_1352 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1352)) + 1.0f);
  let x_1356 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1356);
  let x_1358 : f32 = u_xlat21;
  u_xlat21 = (-(x_1358) + 1.0f);
  let x_1361 : f32 = u_xlat21;
  let x_1363 : f32 = u_xlat1.x;
  u_xlat21 = (x_1361 * x_1363);
  let x_1365 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1365.x, x_1365.y, x_1365.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1368 : vec4<f32> = u_xlat0;
  let x_1370 : vec3<f32> = log2(vec3<f32>(x_1368.x, x_1368.y, x_1368.z));
  let x_1371 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1370.x, x_1370.y, x_1370.z, x_1371.w);
  let x_1373 : vec4<f32> = u_xlat2;
  let x_1375 : vec3<f32> = (vec3<f32>(x_1373.x, x_1373.y, x_1373.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1376 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1375.x, x_1375.y, x_1375.z, x_1376.w);
  let x_1378 : vec4<f32> = u_xlat2;
  let x_1380 : vec3<f32> = exp2(vec3<f32>(x_1378.x, x_1378.y, x_1378.z));
  let x_1381 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1380.x, x_1380.y, x_1380.z, x_1381.w);
  let x_1383 : vec4<f32> = u_xlat2;
  let x_1386 : vec3<f32> = ((vec3<f32>(x_1383.x, x_1383.y, x_1383.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1387 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1386.x, x_1386.y, x_1386.z, x_1387.w);
  let x_1389 : vec4<f32> = u_xlat0;
  let x_1391 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1389.x, x_1389.y, x_1389.z, x_1389.x));
  u_xlatb0 = vec3<bool>(x_1391.x, x_1391.y, x_1391.z);
  let x_1394 : bool = u_xlatb0.x;
  if (x_1394) {
    let x_1399 : f32 = u_xlat1.x;
    x_1395 = x_1399;
  } else {
    let x_1402 : f32 = u_xlat2.x;
    x_1395 = x_1402;
  }
  let x_1403 : f32 = x_1395;
  u_xlat0.x = x_1403;
  ...
  let x_1436 : vec3<f32> = ((vec3<f32>(x_1429, x_1429, x_1429) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1434.x, x_1434.y, x_1434.z));
  let x_1437 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1436.x, x_1436.y, x_1436.z, x_1437.w);
  let x_1439 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1439.x, x_1439.y, x_1439.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1442 : vec4<f32> = u_xlat0;
  let x_1444 : vec3<f32> = (vec3<f32>(x_1442.x, x_1442.y, x_1442.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1445 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1444.x, x_1444.y, x_1444.z, x_1445.w);
  let x_1447 : vec4<f32> = u_xlat2;
  let x_1449 : vec3<f32> = (vec3<f32>(x_1447.x, x_1447.y, x_1447.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1450 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1449.x, x_1449.y, x_1449.z, x_1450.w);
  let x_1452 : vec4<f32> = u_xlat2;
  let x_1455 : vec3<f32> = log2(abs(vec3<f32>(x_1452.x, x_1452.y, x_1452.z)));
  let x_1456 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1455.x, x_1455.y, x_1455.z, x_1456.w);
  let x_1458 : vec4<f32> = u_xlat2;
  let x_1460 : vec3<f32> = (vec3<f32>(x_1458.x, x_1458.y, x_1458.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1461 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1460.x, x_1460.y, x_1460.z, x_1461.w);
  let x_1463 : vec4<f32> = u_xlat2;
  let x_1465 : vec3<f32> = exp2(vec3<f32>(x_1463.x, x_1463.y, x_1463.z));
  let x_1466 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1465.x, x_1465.y, x_1465.z, x_1466.w);
  let x_1468 : vec4<f32> = u_xlat0;
  let x_1470 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1468.x, x_1468.y, x_1468.z, x_1468.x));
  u_xlatb0 = vec3<bool>(x_1470.x, x_1470.y, x_1470.z);
  let x_1473 : bool = u_xlatb0.x;
  if (x_1473) {
    let x_1478 : f32 = u_xlat1.x;
    x_1474 = x_1478;
  } else {
    let x_1481 : f32 = u_xlat2.x;
    x_1474 = x_1481;
  }
  let x_1482 : f32 = x_1474;
  u_xlat0.x = x_1482;
  let x_1485 : bool = u_xlatb0.y;
  if (x_1485) {
    let x_1490 : f32 = u_xlat1.y;
    x_1486 = x_1490;
  } else {
    let x_1493 : f32 = u_xlat2.y;
    x_1486 = x_1493;
  }
  let x_1494 : f32 = x_1486;
  u_xlat0.y = x_1494;
  let x_1497 : bool = u_xlatb0.z;
  if (x_1497) {
  ...
  let x_1513 : vec3<f32> = max(vec3<f32>(x_1510.x, x_1510.y, x_1510.z), vec3<f32>(0.0f, 0.0f, 0.0f));
