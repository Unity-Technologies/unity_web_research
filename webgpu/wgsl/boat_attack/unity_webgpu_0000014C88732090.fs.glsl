...
;
    ...
    u_xlat4.xyz = vec3(u_xlat76) * u_xlat6.xyz;
    ...
    u_xlat6.xyz = vec3(u_xlat76) * u_xlat5.xyz;
    ...
    u_xlat3.x = u_xlat79 * _MainLightShadowParams.x + u_xlat3.x;
    ...
    u_xlat3.x = u_xlat53 * u_xlat79 + u_xlat3.x;
    u_xlat53 = dot((-u_xlat2.xyz), u_xlat1.xyz);
    u_xlat53 = u_xlat53 + u_xlat53;
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat53)) + (-u_xlat2.xyz);
    ...
    u_xlat77 = dot(_MainLightPosition.xyz, u_xlat8.xyz);
    u_xlat77 = clamp(u_xlat77, 0.0, 1.0);
    ...
    u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat50) + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat50 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu50 =  uint(int(u_xlat50));
    u_xlat77 = u_xlat28 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat77 = clamp(u_xlat77, 0.0, 1.0);
    u_xlat3.x = float(0.0);
    u_xlat3.y = float(0.0);
    u_xlat3.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu50 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat80) + u_xlat6.xyz;
