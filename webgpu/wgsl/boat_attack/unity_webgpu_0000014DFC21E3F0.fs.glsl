...
layout(set = 0, binding = 0) uniform mediump texture2D _Texture2DAsset_36aff2641eb842bfb8ac1025d9bb12f9_Out_0_Texture2D;
...
float u_xlat19;
bool u_xlatb19;
layout(set = 0, binding = 3) uniform mediump  sampler sampler_Texture2DAsset_36aff2641eb842bfb8ac1025d9bb12f9_Out_0_Texture2D;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat4 = texture(sampler2D(Texture2D_3DC46A50, samplerTexture2D_3DC46A50), vs_INTERP1.xy, _GlobalMipBias.x);
    ...
    u_xlat0.x = texture(sampler2D(_Texture2DAsset_36aff2641eb842bfb8ac1025d9bb12f9_Out_0_Texture2D, sampler_Texture2DAsset_36aff2641eb842bfb8ac1025d9bb12f9_Out_0_Texture2D), u_xlat0.xy, _GlobalMipBias.x).y;
