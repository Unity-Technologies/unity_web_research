...
fn main_1() {
  ...
  let x_1004 : vec2<f32> = vs_TEXCOORD0;
  let x_1007 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1011 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1013 : vec2<f32> = ((x_1004 * vec2<f32>(x_1007.x, x_1007.y)) + vec2<f32>(x_1011.z, x_1011.w));
  let x_1014 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1013.x, x_1013.y, x_1014.z, x_1014.w);
  let x_1021 : vec4<f32> = u_xlat1;
  let x_1024 : f32 = x_38.x_GlobalMipBias.x;
  let x_1025 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1021.x, x_1021.y), x_1024);
  u_xlat18 = x_1025.w;
  let x_1027 : f32 = u_xlat18;
  u_xlat18 = ((x_1027 * 2.0f) + -1.0f);
  let x_1030 : f32 = u_xlat18;
  u_xlatb1.x = (x_1030 >= 0.0f);
  let x_1034 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1034);
  let x_1037 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1037)) + 1.0f);
  let x_1041 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1041);
  let x_1043 : f32 = u_xlat18;
  u_xlat18 = (-(x_1043) + 1.0f);
  let x_1046 : f32 = u_xlat18;
  let x_1048 : f32 = u_xlat1.x;
  u_xlat18 = (x_1046 * x_1048);
  let x_1050 : vec4<f32> = u_xlat0;
  let x_1052 : vec3<f32> = (vec3<f32>(x_1050.x, x_1050.y, x_1050.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1053 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1052.x, x_1052.y, x_1052.z, x_1053.w);
  let x_1055 : vec4<f32> = u_xlat0;
  let x_1058 : vec3<f32> = log2(abs(vec3<f32>(x_1055.x, x_1055.y, x_1055.z)));
  let x_1059 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1058.x, x_1058.y, x_1058.z, x_1059.w);
  let x_1061 : vec4<f32> = u_xlat2;
  let x_1063 : vec3<f32> = (vec3<f32>(x_1061.x, x_1061.y, x_1061.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1064 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1063.x, x_1063.y, x_1063.z, x_1064.w);
  let x_1066 : vec4<f32> = u_xlat2;
  let x_1068 : vec3<f32> = exp2(vec3<f32>(x_1066.x, x_1066.y, x_1066.z));
  let x_1069 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1068.x, x_1068.y, x_1068.z, x_1069.w);
  let x_1071 : vec4<f32> = u_xlat2;
  let x_1074 : vec3<f32> = ((vec3<f32>(x_1071.x, x_1071.y, x_1071.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1075 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1074.x, x_1074.y, x_1074.z, x_1075.w);
  let x_1078 : vec4<f32> = u_xlat0;
  let x_1080 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1078.x, x_1078.y, x_1078.z, x_1078.x));
  u_xlatb0 = vec3<bool>(x_1080.x, x_1080.y, x_1080.z);
  let x_1083 : bool = u_xlatb0.x;
  if (x_1083) {
  ...
  u_xlat0.x = x_1092;
  let x_1095 : bool = u_xlatb0.y;
  if (x_1095) {
    let x_1100 : f32 = u_xlat1.y;
    x_1096 = x_1100;
  } else {
  ...
  let x_1125 : vec3<f32> = ((vec3<f32>(x_1118, x_1118, x_1118) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1123.x, x_1123.y, x_1123.z));
  let x_1126 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1125.x, x_1125.y, x_1125.z, x_1126.w);
  let x_1128 : vec4<f32> = u_xlat0;
  let x_1130 : vec3<f32> = (vec3<f32>(x_1128.x, x_1128.y, x_1128.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1131 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1130.x, x_1130.y, x_1130.z, x_1131.w);
  let x_1133 : vec4<f32> = u_xlat0;
  let x_1135 : vec3<f32> = (vec3<f32>(x_1133.x, x_1133.y, x_1133.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1136 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1135.x, x_1135.y, x_1135.z, x_1136.w);
  let x_1138 : vec4<f32> = u_xlat2;
  let x_1140 : vec3<f32> = (vec3<f32>(x_1138.x, x_1138.y, x_1138.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  ...
  let x_1151 : vec3<f32> = (vec3<f32>(x_1149.x, x_1149.y, x_1149.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1161 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1159.x, x_1159.y, x_1159.z, x_1159.x));
  u_xlatb0 = vec3<bool>(x_1161.x, x_1161.y, x_1161.z);
  let x_1164 : bool = u_xlatb0.x;
  if (x_1164) {
  ...
  u_xlat0.y = x_1185;
  let x_1188 : bool = u_xlatb0.z;
  if (x_1188) {
    let x_1193 : f32 = u_xlat1.z;
    x_1189 = x_1193;
  } else {
  ...
  let x_1204 : vec3<f32> = max(vec3<f32>(x_1201.x, x_1201.y, x_1201.z), vec3<f32>(0.0f, 0.0f, 0.0f));
