...
;
    ...
    u_xlat18 = (u_xlatb18) ? u_xlat7.y : u_xlat6.x;
    u_xlatb6 = u_xlat6.x<0.0;
    u_xlat6.x = (u_xlatb6) ? u_xlat7.x : u_xlat18;
    ...
    u_xlat0.w = 0.0;
    u_xlat0.x = texture(sampler2D(_CurveRed, sampler_LinearClamp), u_xlat0.xw, _GlobalMipBias.x).x;
    SV_Target0.x = u_xlat0.x;
    SV_Target0.x = clamp(SV_Target0.x, 0.0, 1.0);
    u_xlat0.x = texture(sampler2D(_CurveGreen, sampler_LinearClamp), u_xlat0.yw, _GlobalMipBias.x).x;
    u_xlat0.y = texture(sampler2D(_CurveBlue, sampler_LinearClamp), u_xlat0.zw, _GlobalMipBias.x).x;
