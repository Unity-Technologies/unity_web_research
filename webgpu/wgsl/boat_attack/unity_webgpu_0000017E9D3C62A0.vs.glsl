...
layout(set = 0, binding = 1) uniform mediump texture2D _TerrainNormalmapTexture;
...
void main()
{
    ...
    u_xlat8.xy = u_xlat0.xy * _TerrainHeightmapScale.xz;
    vs_TEXCOORD0.xy = u_xlat0.xy * _TerrainHeightmapRecipSize.zw;
    u_xlat0.xyz = unity_ObjectToWorld[0].xyz * u_xlat8.xxx + u_xlat2.xyz;
    u_xlat0.xyz = unity_ObjectToWorld[2].xyz * u_xlat8.yyy + u_xlat0.xyz;
    u_xlat0.xyz = u_xlat0.xyz + unity_ObjectToWorld[3].xyz;
    u_xlat2.xyz = (-u_xlat0.xyz) + _LightPosition.xyz;
    ...
    u_xlat0.xyz = u_xlat2.xyz * _ShadowBias.xxx + u_xlat0.xyz;
