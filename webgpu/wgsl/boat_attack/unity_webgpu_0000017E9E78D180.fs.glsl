...
;
    ...
    u_xlat23.xyz = vec3(u_xlat30) * u_xlat23.xyz + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat30 = dot(unity_LightIndices[int(u_xlatu30)], uintBitsToFloat(ImmCB_0[u_xlati46]));
        u_xlati30 = int(u_xlat30);
        u_xlat23.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati30].www + _AdditionalLightsPosition[u_xlati30].xyz;
        ...
        u_xlat46 = u_xlat46 * _AdditionalLightsAttenuation[u_xlati30].x;
        u_xlat46 = (-u_xlat46) * u_xlat46 + 1.0;
        u_xlat46 = max(u_xlat46, 0.0);
        u_xlat46 = u_xlat46 * u_xlat46;
        u_xlat46 = u_xlat46 * u_xlat48;
        u_xlat48 = dot(_AdditionalLightsSpotDir[u_xlati30].xyz, u_xlat10.xyz);
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[u_xlati30].z + _AdditionalLightsAttenuation[u_xlati30].w;
        ...
        if(u_xlatb49){
            u_xlatb49 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati30].z);
            if(u_xlatb49){
                ...
                u_xlat50 = trunc(_AdditionalShadowParams[u_xlati30].w);
            ...
            u_xlat49 = 1.0 + (-_AdditionalShadowParams[u_xlati30].x);
            u_xlat48 = u_xlat48 * _AdditionalShadowParams[u_xlati30].x + u_xlat49;
        ...
        u_xlati49 = 1 << (u_xlati30 & int(0x1F));
        u_xlati49 = int(uint(u_xlati49) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati49 != 0) {
            u_xlati49 = int(_AdditionalLightsLightTypes[u_xlati30]);
            u_xlati50 = (u_xlati49 != 0) ? 0 : 1;
            u_xlati52 = u_xlati30 << (2 & int(0x1F));
            if(u_xlati50 != 0) {
                ...
                if(u_xlati49 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati30].xy * u_xlat39.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati30].zw;
                } else {
            ...
            u_xlat49 = (u_xlatb2.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb2.x) ? u_xlat11.xyz : vec3(u_xlat49);
        } else {
        ...
        u_xlat30 = u_xlat46 * u_xlat48;
        u_xlat46 = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat46 = clamp(u_xlat46, 0.0, 1.0);
        u_xlat30 = u_xlat30 * u_xlat46;
        u_xlat11.xyz = vec3(u_xlat30) * u_xlat11.xyz;
        u_xlat23.xyz = u_xlat23.xyz * vec3(u_xlat47) + u_xlat7.xyz;
        u_xlat30 = dot(u_xlat23.xyz, u_xlat23.xyz);
        u_xlat30 = max(u_xlat30, 1.17549435e-38);
        u_xlat30 = inversesqrt(u_xlat30);
        u_xlat23.xyz = vec3(u_xlat30) * u_xlat23.xyz;
        u_xlat30 = dot(u_xlat1.xyz, u_xlat23.xyz);
        u_xlat30 = clamp(u_xlat30, 0.0, 1.0);
        u_xlat46 = dot(u_xlat10.xyz, u_xlat23.xyz);
        u_xlat46 = clamp(u_xlat46, 0.0, 1.0);
        u_xlat30 = u_xlat30 * u_xlat30;
        u_xlat30 = u_xlat30 * u_xlat9.x + 1.00001001;
        u_xlat46 = u_xlat46 * u_xlat46;
        u_xlat30 = u_xlat30 * u_xlat30;
        ...
        u_xlat23.xyz = u_xlat5.xyz * vec3(u_xlat30) + u_xlat4.xyz;
