...
fn main_1() {
  ...
  if (x_555) {
    ...
    if (x_563) {
      ...
      let x_569 : vec4<f32> = x_369.x_MainLightShadowOffset0;
      u_xlat4 = (vec4<f32>(x_566.x, x_566.y, x_566.x, x_566.y) + x_569);
      let x_573 : vec4<f32> = u_xlat4;
      let x_574 : vec2<f32> = vec2<f32>(x_573.x, x_573.y);
      let x_576 : f32 = u_xlat22.z;
      ...
      u_xlat5.y = x_605;
      let x_607 : vec3<f32> = u_xlat22;
      let x_610 : vec4<f32> = x_369.x_MainLightShadowOffset1;
      u_xlat4 = (vec4<f32>(x_607.x, x_607.y, x_607.x, x_607.y) + x_610);
      ...
      let x_649 : f32 = x_369.x_MainLightShadowParams.y;
      u_xlatb23 = (x_649 == 2.0f);
      let x_651 : bool = u_xlatb23;
      if (x_651) {
        let x_655 : vec3<f32> = u_xlat22;
        let x_659 : vec4<f32> = x_369.x_MainLightShadowmapSize;
        u_xlat23 = ((vec2<f32>(x_655.x, x_655.y) * vec2<f32>(x_659.z, x_659.w)) + vec2<f32>(0.5f, 0.5f));
  ...
  let x_3019 : f32 = u_xlat57;
  let x_3021 : vec3<f32> = u_xlat1;
  let x_3023 : vec3<f32> = u_xlat0;
  let x_3024 : vec3<f32> = ((vec3<f32>(x_3019, x_3019, x_3019) * x_3021) + x_3023);
  let x_3025 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_3024.x, x_3024.y, x_3024.z, x_3025.w);
  SV_Target0.w = 1.0f;
  return;
}
