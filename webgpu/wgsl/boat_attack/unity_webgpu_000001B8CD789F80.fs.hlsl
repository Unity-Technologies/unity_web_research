...
{
half4 samp = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + disp . wy , _GlobalMipBias . x ) ;
#line 134
...
half4 acc ;
acc = _BlitTexture . SampleBias ( sampler_LinearClamp , uv - duv . xy , _GlobalMipBias . x ) ;
acc += _BlitTexture . SampleBias ( sampler_LinearClamp , uv - duv . zy , _GlobalMipBias . x ) ;
acc += _BlitTexture . SampleBias ( sampler_LinearClamp , uv + duv . zy , _GlobalMipBias . x ) ;
acc += _BlitTexture . SampleBias ( sampler_LinearClamp , uv + duv . xy , _GlobalMipBias . x ) ;
return acc * 0.25 ;
}
...
half4 dof = _DofTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) ;
half coc = _FullCoCTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) . r ;
coc = ( coc - 0.5 ) * 2.0 * _CoCParams . z ;
#line 207
float ffa = smoothstep ( _SourceSize . w * 2.0 , _SourceSize . w * 4.0 , coc ) ;

half4 color = _BlitTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) ;
#line 215
