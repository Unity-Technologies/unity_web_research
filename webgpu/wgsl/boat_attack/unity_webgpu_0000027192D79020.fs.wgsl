...
fn main_1() {
  ...
  let x_1581 : vec2<f32> = vs_TEXCOORD0;
  let x_1584 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1588 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1590 : vec2<f32> = ((x_1581 * vec2<f32>(x_1584.x, x_1584.y)) + vec2<f32>(x_1588.z, x_1588.w));
  let x_1591 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1590.x, x_1590.y, x_1591.z, x_1591.w);
  let x_1598 : vec4<f32> = u_xlat1;
  let x_1601 : f32 = x_38.x_GlobalMipBias.x;
  let x_1602 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1598.x, x_1598.y), x_1601);
  u_xlat15 = x_1602.w;
  let x_1604 : f32 = u_xlat15;
  u_xlat15 = ((x_1604 * 2.0f) + -1.0f);
  let x_1607 : f32 = u_xlat15;
  u_xlatb1 = (x_1607 >= 0.0f);
  let x_1609 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1609);
  let x_1612 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1612)) + 1.0f);
  let x_1616 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1616);
  let x_1618 : f32 = u_xlat15;
  u_xlat15 = (-(x_1618) + 1.0f);
  let x_1621 : f32 = u_xlat15;
  let x_1623 : f32 = u_xlat1.x;
  u_xlat15 = (x_1621 * x_1623);
  let x_1625 : vec4<f32> = u_xlat0;
  let x_1627 : vec3<f32> = (vec3<f32>(x_1625.x, x_1625.y, x_1625.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1628 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1627.x, x_1627.y, x_1627.z, x_1628.w);
  let x_1630 : vec4<f32> = u_xlat0;
  let x_1633 : vec3<f32> = log2(abs(vec3<f32>(x_1630.x, x_1630.y, x_1630.z)));
  let x_1634 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1633.x, x_1633.y, x_1633.z, x_1634.w);
  let x_1636 : vec4<f32> = u_xlat2;
  let x_1638 : vec3<f32> = (vec3<f32>(x_1636.x, x_1636.y, x_1636.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1649 : vec3<f32> = ((vec3<f32>(x_1646.x, x_1646.y, x_1646.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1650 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1649.x, x_1649.y, x_1649.z, x_1650.w);
  let x_1652 : vec4<f32> = u_xlat0;
  let x_1654 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1652.x, x_1652.y, x_1652.z, x_1652.x));
  u_xlatb0 = vec3<bool>(x_1654.x, x_1654.y, x_1654.z);
  let x_1657 : bool = u_xlatb0.x;
  if (x_1657) {
  ...
  u_xlat0.x = x_1666;
  let x_1669 : bool = u_xlatb0.y;
  if (x_1669) {
    let x_1674 : f32 = u_xlat1.y;
    x_1670 = x_1674;
  } else {
    let x_1677 : f32 = u_xlat2.y;
    x_1670 = x_1677;
  }
  let x_1678 : f32 = x_1670;
  u_xlat0.y = x_1678;
  let x_1681 : bool = u_xlatb0.z;
  if (x_1681) {
    let x_1686 : f32 = u_xlat1.z;
    x_1682 = x_1686;
  } else {
    let x_1689 : f32 = u_xlat2.z;
    x_1682 = x_1689;
  }
  let x_1690 : f32 = x_1682;
  u_xlat0.z = x_1690;
  let x_1692 : f32 = u_xlat15;
  let x_1697 : vec4<f32> = u_xlat0;
  let x_1699 : vec3<f32> = ((vec3<f32>(x_1692, x_1692, x_1692) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1697.x, x_1697.y, x_1697.z));
  let x_1700 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1699.x, x_1699.y, x_1699.z, x_1700.w);
  let x_1702 : vec4<f32> = u_xlat0;
  let x_1704 : vec3<f32> = (vec3<f32>(x_1702.x, x_1702.y, x_1702.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1705 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1704.x, x_1704.y, x_1704.z, x_1705.w);
  let x_1707 : vec4<f32> = u_xlat0;
  let x_1709 : vec3<f32> = (vec3<f32>(x_1707.x, x_1707.y, x_1707.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1710 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1709.x, x_1709.y, x_1709.z, x_1710.w);
  let x_1712 : vec4<f32> = u_xlat2;
  let x_1714 : vec3<f32> = (vec3<f32>(x_1712.x, x_1712.y, x_1712.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1715 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1714.x, x_1714.y, x_1714.z, x_1715.w);
  let x_1717 : vec4<f32> = u_xlat2;
  let x_1720 : vec3<f32> = log2(abs(vec3<f32>(x_1717.x, x_1717.y, x_1717.z)));
  let x_1721 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1720.x, x_1720.y, x_1720.z, x_1721.w);
  let x_1723 : vec4<f32> = u_xlat2;
  let x_1725 : vec3<f32> = (vec3<f32>(x_1723.x, x_1723.y, x_1723.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1726 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1725.x, x_1725.y, x_1725.z, x_1726.w);
  let x_1728 : vec4<f32> = u_xlat2;
  let x_1730 : vec3<f32> = exp2(vec3<f32>(x_1728.x, x_1728.y, x_1728.z));
  let x_1731 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1730.x, x_1730.y, x_1730.z, x_1731.w);
  let x_1733 : vec4<f32> = u_xlat0;
  let x_1735 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1733.x, x_1733.y, x_1733.z, x_1733.x));
  u_xlatb0 = vec3<bool>(x_1735.x, x_1735.y, x_1735.z);
  let x_1738 : bool = u_xlatb0.x;
  if (x_1738) {
  ...
  let x_1777 : vec3<f32> = max(vec3<f32>(x_1775.x, x_1775.y, x_1775.z), vec3<f32>(0.0f, 0.0f, 0.0f));
