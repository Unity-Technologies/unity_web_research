...
fn main_1() {
  ...
  loop {
    ...
    let x_1244 : u32 = u_xlatu37;
    let x_1247 : vec4<f32> = x_289.unity_LightIndices[bitcast<i32>(x_1244)];
    let x_1257 : i32 = u_xlati39;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1262 : vec4<u32> = indexable[x_1257];
    u_xlat37 = dot(x_1247, bitcast<vec4<f32>>(x_1262));
    let x_1266 : f32 = u_xlat37;
    u_xlati37 = i32(x_1266);
    let x_1268 : vec3<f32> = vs_INTERP0;
    let x_1280 : i32 = u_xlati37;
    let x_1282 : vec4<f32> = x_1279.x_AdditionalLightsPosition[x_1280];
    let x_1285 : i32 = u_xlati37;
    let x_1287 : vec4<f32> = x_1279.x_AdditionalLightsPosition[x_1285];
    let x_1289 : vec3<f32> = ((-(x_1268) * vec3<f32>(x_1282.w, x_1282.w, x_1282.w)) + vec3<f32>(x_1287.x, x_1287.y, x_1287.z));
    ...
    u_xlat39 = dot(vec3<f32>(x_1292.x, x_1292.y, x_1292.z), vec3<f32>(x_1294.x, x_1294.y, x_1294.z));
    let x_1297 : f32 = u_xlat39;
    u_xlat39 = max(x_1297, 6.10351562e-05f);
    let x_1300 : f32 = u_xlat39;
    u_xlat40 = inverseSqrt(x_1300);
    let x_1303 : f32 = u_xlat40;
    let x_1305 : vec4<f32> = u_xlat8;
    u_xlat9 = (vec3<f32>(x_1303, x_1303, x_1303) * vec3<f32>(x_1305.x, x_1305.y, x_1305.z));
    let x_1309 : f32 = u_xlat39;
    u_xlat41 = (1.0f / x_1309);
    let x_1311 : f32 = u_xlat39;
    let x_1312 : i32 = u_xlati37;
    let x_1314 : f32 = x_1279.x_AdditionalLightsAttenuation[x_1312].x;
    u_xlat39 = (x_1311 * x_1314);
    let x_1316 : f32 = u_xlat39;
    let x_1318 : f32 = u_xlat39;
    u_xlat39 = ((-(x_1316) * x_1318) + 1.0f);
    let x_1321 : f32 = u_xlat39;
    u_xlat39 = max(x_1321, 0.0f);
    let x_1323 : f32 = u_xlat39;
    let x_1324 : f32 = u_xlat39;
    u_xlat39 = (x_1323 * x_1324);
    let x_1326 : f32 = u_xlat39;
    let x_1327 : f32 = u_xlat41;
    u_xlat39 = (x_1326 * x_1327);
    let x_1329 : i32 = u_xlati37;
    let x_1331 : vec4<f32> = x_1279.x_AdditionalLightsSpotDir[x_1329];
    let x_1333 : vec3<f32> = u_xlat9;
    u_xlat41 = dot(vec3<f32>(x_1331.x, x_1331.y, x_1331.z), x_1333);
    let x_1335 : f32 = u_xlat41;
    let x_1336 : i32 = u_xlati37;
    let x_1338 : f32 = x_1279.x_AdditionalLightsAttenuation[x_1336].z;
    let x_1340 : i32 = u_xlati37;
    let x_1342 : f32 = x_1279.x_AdditionalLightsAttenuation[x_1340].w;
    u_xlat41 = ((x_1335 * x_1338) + x_1342);
    let x_1344 : f32 = u_xlat41;
    u_xlat41 = clamp(x_1344, 0.0f, 1.0f);
    let x_1346 : f32 = u_xlat41;
    let x_1347 : f32 = u_xlat41;
    u_xlat41 = (x_1346 * x_1347);
    let x_1349 : f32 = u_xlat39;
    let x_1350 : f32 = u_xlat41;
    u_xlat39 = (x_1349 * x_1350);
    let x_1353 : f32 = u_xlat38;
    let x_1355 : i32 = u_xlati37;
    let x_1357 : vec4<f32> = x_1279.x_AdditionalLightsColor[x_1355];
    u_xlat10 = (vec3<f32>(x_1353, x_1353, x_1353) * vec3<f32>(x_1357.x, x_1357.y, x_1357.z));
    let x_1360 : vec4<f32> = u_xlat3;
    let x_1362 : vec3<f32> = u_xlat9;
    u_xlat37 = dot(vec3<f32>(x_1360.x, x_1360.y, x_1360.z), x_1362);
    let x_1364 : f32 = u_xlat37;
    u_xlat37 = clamp(x_1364, 0.0f, 1.0f);
    let x_1366 : f32 = u_xlat37;
    let x_1367 : f32 = u_xlat39;
    u_xlat37 = (x_1366 * x_1367);
    ...
    let x_1378 : vec3<f32> = u_xlat12;
    let x_1379 : vec3<f32> = ((vec3<f32>(x_1373.x, x_1373.y, x_1373.z) * vec3<f32>(x_1375, x_1375, x_1375)) + x_1378);
    ...
    u_xlat37 = dot(vec3<f32>(x_1382.x, x_1382.y, x_1382.z), vec3<f32>(x_1384.x, x_1384.y, x_1384.z));
    let x_1387 : f32 = u_xlat37;
    u_xlat37 = max(x_1387, 1.17549435e-37f);
    let x_1389 : f32 = u_xlat37;
    u_xlat37 = inverseSqrt(x_1389);
    ...
    u_xlat37 = dot(vec3<f32>(x_1398.x, x_1398.y, x_1398.z), vec3<f32>(x_1400.x, x_1400.y, x_1400.z));
    let x_1403 : f32 = u_xlat37;
    u_xlat37 = clamp(x_1403, 0.0f, 1.0f);
    let x_1405 : vec3<f32> = u_xlat9;
    let x_1406 : vec4<f32> = u_xlat8;
    u_xlat39 = dot(x_1405, vec3<f32>(x_1406.x, x_1406.y, x_1406.z));
    let x_1409 : f32 = u_xlat39;
    u_xlat39 = clamp(x_1409, 0.0f, 1.0f);
    let x_1411 : f32 = u_xlat37;
    let x_1412 : f32 = u_xlat37;
    u_xlat37 = (x_1411 * x_1412);
    let x_1414 : f32 = u_xlat37;
    let x_1416 : f32 = u_xlat0.x;
    u_xlat37 = ((x_1414 * x_1416) + 1.000010014f);
    let x_1419 : f32 = u_xlat39;
    let x_1420 : f32 = u_xlat39;
    u_xlat39 = (x_1419 * x_1420);
    let x_1422 : f32 = u_xlat37;
    let x_1423 : f32 = u_xlat37;
    u_xlat37 = (x_1422 * x_1423);
    let x_1425 : f32 = u_xlat39;
    u_xlat39 = max(x_1425, 0.100000001f);
    let x_1427 : f32 = u_xlat37;
    let x_1428 : f32 = u_xlat39;
    u_xlat37 = (x_1427 * x_1428);
    let x_1430 : f32 = u_xlat35;
    let x_1431 : f32 = u_xlat37;
    u_xlat37 = (x_1430 * x_1431);
    let x_1433 : f32 = u_xlat36;
    let x_1434 : f32 = u_xlat37;
    u_xlat37 = (x_1433 / x_1434);
    let x_1436 : vec3<f32> = u_xlat2;
    let x_1437 : f32 = u_xlat37;
    let x_1440 : vec3<f32> = u_xlat7;
    let x_1441 : vec3<f32> = ((x_1436 * vec3<f32>(x_1437, x_1437, x_1437)) + x_1440);
    ...
    let x_1450 : vec3<f32> = ((vec3<f32>(x_1444.x, x_1444.y, x_1444.z) * x_1446) + vec3<f32>(x_1448.x, x_1448.y, x_1448.z));
    let x_1451 : vec4<f32> = u_xlat6;
    u_xlat6 = vec4<f32>(x_1450.x, x_1450.y, x_1450.z, x_1451.w);
  ...
  let x_1462 : vec3<f32> = ((vec3<f32>(x_1455.x, x_1455.y, x_1455.z) * vec3<f32>(x_1457, x_1457, x_1457)) + vec3<f32>(x_1460.x, x_1460.y, x_1460.z));
  let x_1463 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1462.x, x_1463.y, x_1462.y, x_1462.z);
  let x_1465 : vec4<f32> = u_xlat6;
  let x_1467 : vec4<f32> = u_xlat0;
  let x_1469 : vec3<f32> = (vec3<f32>(x_1465.x, x_1465.y, x_1465.z) + vec3<f32>(x_1467.x, x_1467.z, x_1467.w));
  let x_1470 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1469.x, x_1470.y, x_1469.y, x_1469.z);
  let x_1473 : f32 = u_xlat11.x;
  let x_1475 : f32 = u_xlat11.x;
  u_xlat11.x = (x_1473 * -(x_1475));
  let x_1480 : f32 = u_xlat11.x;
  u_xlat11.x = exp2(x_1480);
  let x_1483 : vec4<f32> = u_xlat0;
  let x_1487 : vec4<f32> = x_44.unity_FogColor;
  let x_1490 : vec3<f32> = (vec3<f32>(x_1483.x, x_1483.z, x_1483.w) + -(vec3<f32>(x_1487.x, x_1487.y, x_1487.z)));
  let x_1491 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1490.x, x_1491.y, x_1490.y, x_1490.z);
  let x_1495 : vec2<f32> = u_xlat11;
  let x_1497 : vec4<f32> = u_xlat0;
  let x_1501 : vec4<f32> = x_44.unity_FogColor;
  let x_1503 : vec3<f32> = ((vec3<f32>(x_1495.x, x_1495.x, x_1495.x) * vec3<f32>(x_1497.x, x_1497.z, x_1497.w)) + vec3<f32>(x_1501.x, x_1501.y, x_1501.z));
  let x_1504 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1503.x, x_1503.y, x_1503.z, x_1504.w);
  let x_1509 : u32 = x_44.x_RenderingLayerMaxInt;
  let x_1511 : f32 = x_289.unity_RenderingLayer.x;
  u_xlatu0 = (x_1509 & bitcast<u32>(x_1511));
  let x_1514 : u32 = u_xlatu0;
  u_xlat0.x = f32(x_1514);
  let x_1519 : f32 = u_xlat0.x;
  let x_1522 : f32 = x_44.x_RenderingLayerRcpMaxInt;
  SV_Target1.x = (x_1519 * x_1522);
  let x_1527 : f32 = SV_Target1.x;
  SV_Target1.x = clamp(x_1527, 0.0f, 1.0f);
  SV_Target0.w = 1.0f;
  let x_1531 : vec4<f32> = SV_Target1;
  SV_Target1 = vec4<f32>(x_1531.x, vec3<f32>(0.0f, 0.0f, 0.0f).x, vec3<f32>(0.0f, 0.0f, 0.0f).y, vec3<f32>(0.0f, 0.0f, 0.0f).z);
  return;
}
