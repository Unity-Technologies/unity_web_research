...
;
    ...
    u_xlat12.x = vs_INTERP8.y * unity_MatrixV[1].z;
    u_xlat12.x = unity_MatrixV[0].z * vs_INTERP8.x + u_xlat12.x;
    u_xlat12.x = unity_MatrixV[2].z * vs_INTERP8.z + u_xlat12.x;
    ...
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat24.x);
    u_xlat24.x = u_xlat7.w + -1.0;
    ...
    u_xlat7.xyz = u_xlat7.xyz * u_xlat24.xxx;
    ...
    u_xlat36 = u_xlat18.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.x = u_xlat36 * u_xlat22 + u_xlat10.x;
        u_xlat44 = u_xlat44 * u_xlat10.x;
        ...
        u_xlat43 = u_xlat43 * u_xlat24.x + 1.00001001;
    ...
    u_xlat0.xzw = u_xlat14.xyz * u_xlat6.xxx + u_xlat7.xyz;
    u_xlat0.xzw = u_xlat18.xyz + u_xlat0.xzw;
