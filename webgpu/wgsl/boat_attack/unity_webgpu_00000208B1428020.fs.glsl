...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat2.x = (u_xlatb1) ? u_xlat20.x : unity_MatrixV[0].z;
    u_xlat2.y = (u_xlatb1) ? u_xlat20.y : unity_MatrixV[1].z;
    u_xlat2.z = (u_xlatb1) ? u_xlat20.z : unity_MatrixV[2].z;
    ...
    u_xlat3.xyz = vec3(u_xlat59) * u_xlat4.xyz;
    ...
    if(u_xlatb4){
        ...
        if(u_xlatb4){
            ...
            u_xlatb23.x = _MainLightShadowParams.y==2.0;
            if(u_xlatb23.x){
                u_xlat23.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat23.xy = floor(u_xlat23.xy);
                u_xlat5.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat23.xy);
                ...
                vec3 txVec28 = vec3(u_xlat23.xy,vs_TEXCOORD6.z);
    ...
    u_xlat4.x = u_xlat4.x * _MainLightShadowParams.x + u_xlat23.x;
    u_xlatb23.x = 0.0>=vs_TEXCOORD6.z;
    u_xlatb42 = vs_TEXCOORD6.z>=1.0;
    u_xlatb23.x = u_xlatb42 || u_xlatb23.x;
    u_xlat4.x = (u_xlatb23.x) ? 1.0 : u_xlat4.x;
    ...
    u_xlat4.x = u_xlat23.x * u_xlat42 + u_xlat4.x;
    ...
    if(u_xlatb23.x){
        ...
        u_xlat5 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat23.xy, _GlobalMipBias.x);
        ...
        u_xlat42 = (u_xlatb23.y) ? u_xlat5.w : u_xlat5.x;
        u_xlat23.xyz = (u_xlatb23.x) ? u_xlat5.xyz : vec3(u_xlat42);
    } else {
        u_xlat23.x = float(1.0);
        u_xlat23.y = float(1.0);
        u_xlat23.z = float(1.0);
    }
    u_xlat23.xyz = u_xlat23.xyz * _MainLightColor.xyz;
    u_xlat23.xyz = vec3(u_xlat60) * u_xlat23.xyz;
    u_xlat3.xyz = vec3(u_xlat59) * u_xlat3.xyz;
    u_xlat59 = u_xlat4.x * unity_LightData.z;
    u_xlat4.xyz = vec3(u_xlat59) * u_xlat23.xyz;
    u_xlat59 = dot(u_xlat1.xyz, _MainLightPosition.xyz);
    u_xlat59 = clamp(u_xlat59, 0.0, 1.0);
    u_xlat5.xyz = vec3(u_xlat59) * u_xlat4.xyz;
    u_xlat59 = u_xlat0.x * 10.0 + 1.0;
    u_xlat59 = exp2(u_xlat59);
    u_xlat6.xyz = u_xlat2.xyz * vec3(u_xlat58) + _MainLightPosition.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu61 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat7.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu62)].www + _AdditionalLightsPosition[int(u_xlatu62)].xyz;
        ...
        u_xlat64 = float(1.0) / float(u_xlat63);
        u_xlat63 = u_xlat63 * _AdditionalLightsAttenuation[int(u_xlatu62)].x;
        u_xlat63 = (-u_xlat63) * u_xlat63 + 1.0;
        u_xlat63 = max(u_xlat63, 0.0);
        u_xlat63 = u_xlat63 * u_xlat63;
        u_xlat63 = u_xlat63 * u_xlat64;
        u_xlat64 = dot(_AdditionalLightsSpotDir[int(u_xlatu62)].xyz, u_xlat7.xyz);
        u_xlat64 = u_xlat64 * _AdditionalLightsAttenuation[int(u_xlatu62)].z + _AdditionalLightsAttenuation[int(u_xlatu62)].w;
        u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
        u_xlat64 = u_xlat64 * u_xlat64;
        u_xlat63 = u_xlat63 * u_xlat64;
        u_xlatu64 = u_xlatu62 >> (5u & uint(0x1F));
        u_xlati8 = 1 << (int(u_xlatu62) & int(0x1F));
        u_xlati64 = int(uint(u_xlati8) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu64)]));
        if(u_xlati64 != 0) {
            u_xlati64 = int(_AdditionalLightsLightTypes[int(u_xlatu62)]);
            u_xlati8 = (u_xlati64 != 0) ? 0 : 1;
            u_xlati27 = int(u_xlatu62) << (2 & int(0x1F));
            if(u_xlati8 != 0) {
                u_xlat8.xzw = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati27 + 1) / 4][(u_xlati27 + 1) % 4].xyw;
                u_xlat8.xzw = _AdditionalLightsWorldToLights[u_xlati27 / 4][u_xlati27 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat8.xzw;
                u_xlat8.xzw = _AdditionalLightsWorldToLights[(u_xlati27 + 2) / 4][(u_xlati27 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat8.xzw;
                u_xlat8.xzw = u_xlat8.xzw + _AdditionalLightsWorldToLights[(u_xlati27 + 3) / 4][(u_xlati27 + 3) % 4].xyw;
                u_xlat8.xz = u_xlat8.xz / u_xlat8.ww;
                u_xlat8.xz = u_xlat8.xz * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat8.xz = clamp(u_xlat8.xz, 0.0, 1.0);
                u_xlat8.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].xy * u_xlat8.xz + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].zw;
            } else {
                u_xlatb64 = u_xlati64==1;
                u_xlati64 = u_xlatb64 ? 1 : int(0);
                if(u_xlati64 != 0) {
                    u_xlat9.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati27 + 1) / 4][(u_xlati27 + 1) % 4].xy;
                    u_xlat9.xy = _AdditionalLightsWorldToLights[u_xlati27 / 4][u_xlati27 % 4].xy * vs_TEXCOORD1.xx + u_xlat9.xy;
                    u_xlat9.xy = _AdditionalLightsWorldToLights[(u_xlati27 + 2) / 4][(u_xlati27 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat9.xy;
                    u_xlat9.xy = u_xlat9.xy + _AdditionalLightsWorldToLights[(u_xlati27 + 3) / 4][(u_xlati27 + 3) % 4].xy;
                    u_xlat9.xy = u_xlat9.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat9.xy = fract(u_xlat9.xy);
                    u_xlat8.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].xy * u_xlat9.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].zw;
                } else {
                    ...
                    u_xlat10.xyz = vec3(u_xlat64) * u_xlat9.zxy;
                    u_xlat10.x = (-u_xlat10.x);
                    u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
                    u_xlatb27.xz = greaterThanEqual(u_xlat10.yyzz, vec4(0.0, 0.0, 0.0, 0.0)).xz;
                    u_xlat27.x = (u_xlatb27.x) ? u_xlat10.x : (-u_xlat10.x);
                    u_xlat27.z = (u_xlatb27.z) ? u_xlat10.x : (-u_xlat10.x);
                    u_xlat27.xz = u_xlat9.xy * vec2(u_xlat64) + u_xlat27.xz;
                    u_xlat27.xz = u_xlat27.xz * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat27.xz = clamp(u_xlat27.xz, 0.0, 1.0);
                    u_xlat8.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].xy * u_xlat27.xz + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].zw;
                }
            }
            ...
            u_xlat64 = (u_xlatb5.y) ? u_xlat8.w : u_xlat8.x;
            u_xlat8.xyz = (u_xlatb5.x) ? u_xlat8.xyz : vec3(u_xlat64);
        } else {
            u_xlat8.x = float(1.0);
            u_xlat8.y = float(1.0);
            u_xlat8.z = float(1.0);
        }
        u_xlat8.xyz = u_xlat8.xyz * _AdditionalLightsColor[int(u_xlatu62)].xyz;
        u_xlat8.xyz = vec3(u_xlat60) * u_xlat8.xyz;
        u_xlat8.xyz = vec3(u_xlat63) * u_xlat8.xyz;
        u_xlat62 = dot(u_xlat1.xyz, u_xlat7.xyz);
        u_xlat62 = clamp(u_xlat62, 0.0, 1.0);
        u_xlat9.xyz = vec3(u_xlat62) * u_xlat8.xyz;
        u_xlat7.xyz = u_xlat2.xyz * vec3(u_xlat58) + u_xlat7.xyz;
    ...
    u_xlat19.xyz = u_xlat3.xyz * u_xlat0.yzw + u_xlat4.xyz;
    SV_Target0.xyz = u_xlat6.xyz + u_xlat19.xyz;
