...
float2 uv = input . texcoord ;
#line 56
half4 cr = _BlitTexture . GatherRed ( sampler_LinearClamp , uv ) ;
half4 cg = _BlitTexture . GatherGreen ( sampler_LinearClamp , uv ) ;
half4 cb = _BlitTexture . GatherBlue ( sampler_LinearClamp , uv ) ;
...
#line 66
half4 cocs = _FullCoCTexture . Gather ( sampler_LinearClamp , uv ) * 2.0 - 1.0 ;
half coc0 = cocs . x ;
half coc1 = cocs . y ;
half coc2 = cocs . z ;
half coc3 = cocs . w ;
