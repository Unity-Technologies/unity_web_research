...
void main()
{
    ...
    u_xlat81 = dot(u_xlat4, u_xlat4);
    u_xlat81 = inversesqrt(u_xlat81);
    u_xlat30.xyz = vec3(u_xlat81) * u_xlat4.xyz;
    u_xlat81 = vs_INTERP6.y * 200.0;
    u_xlat81 = min(u_xlat81, 1.0);
    u_xlat1.xyz = vec3(u_xlat81) * u_xlat1.xyz;
...
;
    ...
    u_xlat81 = dot(u_xlat5, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat81 = (-u_xlat81) + 4.0;
    u_xlatu81 = uint(u_xlat81);
    u_xlati81 = int(u_xlatu81) << (2 & int(0x1F));
    u_xlat4.xyz = vs_INTERP8.yyy * _MainLightWorldToShadow[(u_xlati81 + 1) / 4][(u_xlati81 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati81 / 4][u_xlati81 % 4].xyz * vs_INTERP8.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati81 + 2) / 4][(u_xlati81 + 2) % 4].xyz * vs_INTERP8.zzz + u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati81 + 3) / 4][(u_xlati81 + 3) % 4].xyz;
    ...
    if(u_xlatb81){
        ...
        if(u_xlatb83){
            ...
            u_xlat83 = dot(u_xlat6, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            u_xlatb85 = _MainLightShadowParams.y==2.0;
            if(u_xlatb85){
                u_xlat5.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat59.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec5, 0.0);
                u_xlat32.x = u_xlat32.x * u_xlat12.y;
                u_xlat5.x = u_xlat12.x * u_xlat5.x + u_xlat32.x;
                vec3 txVec6 = vec3(u_xlat59.xy,u_xlat4.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat5.x = u_xlat12.z * u_xlat32.x + u_xlat5.x;
                vec3 txVec7 = vec3(u_xlat8.xy,u_xlat4.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat5.x = u_xlat12.w * u_xlat32.x + u_xlat5.x;
                vec3 txVec8 = vec3(u_xlat10.xy,u_xlat4.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat5.x = u_xlat13.x * u_xlat32.x + u_xlat5.x;
                vec3 txVec9 = vec3(u_xlat10.zw,u_xlat4.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat5.x = u_xlat13.y * u_xlat32.x + u_xlat5.x;
                vec3 txVec10 = vec3(u_xlat8.zw,u_xlat4.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat5.x = u_xlat13.z * u_xlat32.x + u_xlat5.x;
                vec3 txVec11 = vec3(u_xlat7.xy,u_xlat4.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat5.x = u_xlat13.w * u_xlat32.x + u_xlat5.x;
                vec3 txVec12 = vec3(u_xlat7.zw,u_xlat4.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                u_xlat83 = u_xlat85 * u_xlat32.x + u_xlat5.x;
            } else {
                u_xlat5.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat59.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                vec3 txVec15 = vec3(u_xlat59.xy,u_xlat4.z);
                ...
                vec3 txVec24 = vec3(u_xlat67.xy,u_xlat4.z);
                ...
                u_xlat83 = u_xlat6.w * u_xlat5.x + u_xlat85;
            }
        }
    } else {
    ...
    u_xlat83 = u_xlat83 * _MainLightShadowParams.x + u_xlat85;
    u_xlatb5 = 0.0>=u_xlat4.z;
    u_xlatb32 = u_xlat4.z>=1.0;
    u_xlatb5 = u_xlatb32 || u_xlatb5;
    u_xlat83 = (u_xlatb5) ? 1.0 : u_xlat83;
    u_xlat0.x = dot(u_xlat0.xyz, (-_MainLightPosition.xyz));
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat32.xyz = vec3(u_xlat83) * _MainLightColor.xyz;
    u_xlat0.xyz = u_xlat0.xxx * u_xlat32.xyz;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat1.xyz;
    u_xlatb1 = u_xlat1.w>=0.400000006;
    u_xlat1.x = u_xlatb1 ? u_xlat1.w : float(0.0);
    u_xlat28.x = u_xlat1.w + -0.400000006;
    u_xlat55 = dFdxCoarse(u_xlat1.w);
    u_xlat82 = dFdyCoarse(u_xlat1.w);
    u_xlat55 = abs(u_xlat82) + abs(u_xlat55);
    u_xlat55 = max(u_xlat55, 9.99999975e-05);
    u_xlat28.x = u_xlat28.x / u_xlat55;
    u_xlat28.x = u_xlat28.x + 0.5;
    u_xlat28.x = clamp(u_xlat28.x, 0.0, 1.0);
    u_xlatb55 = _AlphaToMaskAvailable!=0.0;
    u_xlat1.x = (u_xlatb55) ? u_xlat28.x : u_xlat1.x;
    u_xlat28.x = u_xlat1.x + -9.99999975e-05;
    u_xlatb28.x = u_xlat28.x<0.0;
    if(((int(u_xlatb28.x) * int(0xffffffffu)))!=0){discard;}
    u_xlatb28.x = 0.0<vs_INTERP4.w;
    u_xlatb28.z = unity_WorldTransformParams.w>=0.0;
    u_xlat28.x = (u_xlatb28.x) ? float(1.0) : float(-1.0);
    u_xlat28.z = (u_xlatb28.z) ? float(1.0) : float(-1.0);
    u_xlat28.x = u_xlat28.z * u_xlat28.x;
    u_xlat32.xyz = vs_INTERP4.yzx * vs_INTERP9.zxy;
    u_xlat32.xyz = vs_INTERP9.yzx * vs_INTERP4.zxy + (-u_xlat32.xyz);
    u_xlat32.xyz = u_xlat28.xxx * u_xlat32.xyz;
    u_xlat32.xyz = u_xlat30.yyy * u_xlat32.xyz;
    u_xlat32.xyz = u_xlat30.xxx * vs_INTERP4.xyz + u_xlat32.xyz;
    u_xlat30.xyz = u_xlat30.zzz * vs_INTERP9.xyz + u_xlat32.xyz;
    u_xlat28.x = dot(u_xlat30.xyz, u_xlat30.xyz);
    u_xlat28.x = inversesqrt(u_xlat28.x);
    u_xlat6.xyz = u_xlat28.xxx * u_xlat30.xyz;
    u_xlatb28.x = unity_OrthoParams.w==0.0;
    u_xlat30.xyz = (-vs_INTERP8.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat82 = dot(u_xlat30.xyz, u_xlat30.xyz);
    u_xlat82 = inversesqrt(u_xlat82);
    u_xlat30.xyz = vec3(u_xlat82) * u_xlat30.xyz;
    u_xlat7.x = unity_MatrixV[0].z;
    u_xlat7.y = unity_MatrixV[1].z;
    u_xlat7.z = unity_MatrixV[2].z;
    u_xlat30.xyz = (u_xlatb28.x) ? u_xlat30.xyz : u_xlat7.xyz;
    u_xlat28.x = vs_INTERP8.y * unity_MatrixV[1].z;
    u_xlat28.x = unity_MatrixV[0].z * vs_INTERP8.x + u_xlat28.x;
    u_xlat28.x = unity_MatrixV[2].z * vs_INTERP8.z + u_xlat28.x;
    u_xlat28.x = u_xlat28.x + unity_MatrixV[3].z;
    u_xlat28.x = (-u_xlat28.x) + (-_ProjectionParams.y);
    u_xlat28.x = max(u_xlat28.x, 0.0);
    u_xlat28.x = u_xlat28.x * unity_FogParams.x;
    u_xlat6.w = 1.0;
    ...
    u_xlat82 = u_xlat6.y * u_xlat6.y;
    u_xlat82 = u_xlat6.x * u_xlat6.x + (-u_xlat82);
    u_xlat32.xyz = unity_SHC.xyz * vec3(u_xlat82) + u_xlat9.xyz;
    ...
    u_xlat82 = (-u_xlat3.x) + 1.0;
    u_xlat83 = u_xlat82 * u_xlat82;
    u_xlat83 = max(u_xlat83, 0.0078125);
    u_xlat87 = u_xlat83 * u_xlat83;
    u_xlat3.x = u_xlat3.x + 0.0400000215;
    u_xlat3.x = min(u_xlat3.x, 1.0);
    u_xlat7.x = u_xlat83 * 4.0 + 2.0;
    u_xlat34.x = min(vs_INTERP6.w, 1.0);
    if(u_xlatb81){
        ...
        if(u_xlatb81){
            ...
            if(u_xlatb61){
                u_xlat61.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat61.xy = floor(u_xlat61.xy);
                u_xlat8.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat61.xy);
                ...
                vec3 txVec49 = vec3(u_xlat68.xy,u_xlat4.z);
                ...
                vec3 txVec57 = vec3(u_xlat65.xy,u_xlat4.z);
                u_xlat35 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec57, 0.0);
                u_xlat8.x = u_xlat8.z * u_xlat35 + u_xlat8.x;
                vec3 txVec58 = vec3(u_xlat61.xy,u_xlat4.z);
    ...
    u_xlat81 = u_xlat81 * _MainLightShadowParams.x + u_xlat85;
    u_xlat81 = (u_xlatb5) ? 1.0 : u_xlat81;
    u_xlat4.xyz = vs_INTERP8.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat4.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat31.x = u_xlat4.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat31.x = clamp(u_xlat31.x, 0.0, 1.0);
    u_xlat58 = (-u_xlat81) + 1.0;
    u_xlat81 = u_xlat31.x * u_xlat58 + u_xlat81;
    u_xlatb31.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb31.x){
        u_xlat31.xy = vs_INTERP8.yy * _MainLightWorldToLight[1].xy;
        u_xlat31.xy = _MainLightWorldToLight[0].xy * vs_INTERP8.xx + u_xlat31.xy;
        u_xlat31.xy = _MainLightWorldToLight[2].xy * vs_INTERP8.zz + u_xlat31.xy;
        u_xlat31.xy = u_xlat31.xy + _MainLightWorldToLight[3].xy;
        u_xlat31.xy = u_xlat31.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat8 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat31.xy, _GlobalMipBias.x);
        ...
        u_xlat58 = (u_xlatb31.y) ? u_xlat8.w : u_xlat8.x;
        u_xlat31.xyz = (u_xlatb31.x) ? u_xlat8.xyz : vec3(u_xlat58);
    } else {
        u_xlat31.x = float(1.0);
        u_xlat31.y = float(1.0);
        u_xlat31.z = float(1.0);
    }
    u_xlat31.xyz = u_xlat31.xyz * _MainLightColor.xyz;
    u_xlat5.x = dot((-u_xlat30.xyz), u_xlat6.xyz);
    u_xlat5.x = u_xlat5.x + u_xlat5.x;
    u_xlat8.xyz = u_xlat6.xyz * (-u_xlat5.xxx) + (-u_xlat30.xyz);
    u_xlat5.x = dot(u_xlat6.xyz, u_xlat30.xyz);
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
    u_xlat5.x = (-u_xlat5.x) + 1.0;
    u_xlat5.x = u_xlat5.x * u_xlat5.x;
    u_xlat5.x = u_xlat5.x * u_xlat5.x;
    u_xlat61.x = (-u_xlat82) * 0.699999988 + 1.70000005;
    u_xlat82 = u_xlat82 * u_xlat61.x;
    u_xlat82 = u_xlat82 * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat82);
    u_xlat82 = u_xlat8.w + -1.0;
    u_xlat82 = unity_SpecCube0_HDR.w * u_xlat82 + 1.0;
    u_xlat82 = max(u_xlat82, 0.0);
    u_xlat82 = log2(u_xlat82);
    u_xlat82 = u_xlat82 * unity_SpecCube0_HDR.y;
    u_xlat82 = exp2(u_xlat82);
    u_xlat82 = u_xlat82 * unity_SpecCube0_HDR.x;
    u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat82);
    u_xlat61.xy = vec2(u_xlat83) * vec2(u_xlat83) + vec2(-1.0, 1.0);
    u_xlat82 = float(1.0) / u_xlat61.y;
    u_xlat83 = u_xlat3.x + -0.0399999991;
    u_xlat83 = u_xlat5.x * u_xlat83 + 0.0399999991;
    u_xlat82 = u_xlat82 * u_xlat83;
    u_xlat8.xyz = vec3(u_xlat82) * u_xlat8.xyz;
    u_xlat5.xyz = u_xlat32.xyz * u_xlat2.xyz + u_xlat8.xyz;
    u_xlat81 = u_xlat81 * unity_LightData.z;
    u_xlat82 = dot(u_xlat6.xyz, _MainLightPosition.xyz);
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    u_xlat81 = u_xlat81 * u_xlat82;
    u_xlat31.xyz = vec3(u_xlat81) * u_xlat31.xyz;
    ...
    u_xlat82 = dot(_MainLightPosition.xyz, u_xlat8.xyz);
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    ...
    u_xlat8.xyz = vec3(u_xlat81) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    u_xlat31.xyz = u_xlat31.xyz * u_xlat8.xyz;
    u_xlat81 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu81 =  uint(int(u_xlat81));
    u_xlat82 = u_xlat4.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu81 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.xyz = (-vs_INTERP8.xyz) * _AdditionalLightsPosition[u_xlati3].www + _AdditionalLightsPosition[u_xlati3].xyz;
        u_xlat4.x = dot(u_xlat10.xyz, u_xlat10.xyz);
        u_xlat4.x = max(u_xlat4.x, 6.10351562e-05);
        u_xlat86 = inversesqrt(u_xlat4.x);
        u_xlat11.xyz = vec3(u_xlat86) * u_xlat10.xyz;
        u_xlat88 = float(1.0) / float(u_xlat4.x);
        u_xlat4.x = u_xlat4.x * _AdditionalLightsAttenuation[u_xlati3].x;
        u_xlat4.x = (-u_xlat4.x) * u_xlat4.x + 1.0;
        u_xlat4.x = max(u_xlat4.x, 0.0);
        u_xlat4.x = u_xlat4.x * u_xlat4.x;
        u_xlat4.x = u_xlat4.x * u_xlat88;
        u_xlat88 = dot(_AdditionalLightsSpotDir[u_xlati3].xyz, u_xlat11.xyz);
        u_xlat88 = u_xlat88 * _AdditionalLightsAttenuation[u_xlati3].z + _AdditionalLightsAttenuation[u_xlati3].w;
        u_xlat88 = clamp(u_xlat88, 0.0, 1.0);
        u_xlat88 = u_xlat88 * u_xlat88;
        u_xlat4.x = u_xlat4.x * u_xlat88;
        u_xlati88 = int(_AdditionalShadowParams[u_xlati3].w);
        u_xlatb62 = u_xlati88>=0;
        if(u_xlatb62){
            u_xlatb62 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati3].z);
            if(u_xlatb62){
                ...
                u_xlat89 = trunc(_AdditionalShadowParams[u_xlati3].w);
            ...
            u_xlatb88 = 0.0<_AdditionalShadowParams[u_xlati3].y;
            if(u_xlatb88){
                u_xlatb88 = 1.0==_AdditionalShadowParams[u_xlati3].y;
                if(u_xlatb88){
                    ...
                    u_xlatb62 = 2.0==_AdditionalShadowParams[u_xlati3].y;
                    if(u_xlatb62){
            ...
            u_xlat62.x = 1.0 + (-_AdditionalShadowParams[u_xlati3].x);
            u_xlat88 = u_xlat88 * _AdditionalShadowParams[u_xlati3].x + u_xlat62.x;
        ...
        u_xlat88 = u_xlat82 * u_xlat62.x + u_xlat88;
        u_xlati62 = 1 << (u_xlati3 & int(0x1F));
        u_xlati62 = int(uint(u_xlati62) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati62 != 0) {
            u_xlati62 = int(_AdditionalLightsLightTypes[u_xlati3]);
            u_xlati89 = (u_xlati62 != 0) ? 0 : 1;
            u_xlati90 = u_xlati3 << (2 & int(0x1F));
            if(u_xlati89 != 0) {
                ...
                if(u_xlati62 != 0) {
                    ...
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati3].xy * u_xlat62.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati3].zw;
                } else {
        ...
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[u_xlati3].xyz;
        u_xlat3.x = u_xlat4.x * u_xlat88;
        u_xlat4.x = dot(u_xlat6.xyz, u_xlat11.xyz);
        u_xlat4.x = clamp(u_xlat4.x, 0.0, 1.0);
        u_xlat3.x = u_xlat3.x * u_xlat4.x;
        u_xlat12.xyz = u_xlat3.xxx * u_xlat12.xyz;
        u_xlat10.xyz = u_xlat10.xyz * vec3(u_xlat86) + u_xlat30.xyz;
        u_xlat3.x = dot(u_xlat10.xyz, u_xlat10.xyz);
        u_xlat3.x = max(u_xlat3.x, 1.17549435e-38);
        u_xlat3.x = inversesqrt(u_xlat3.x);
        u_xlat10.xyz = u_xlat3.xxx * u_xlat10.xyz;
        u_xlat3.x = dot(u_xlat6.xyz, u_xlat10.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        u_xlat4.x = dot(u_xlat11.xyz, u_xlat10.xyz);
        u_xlat4.x = clamp(u_xlat4.x, 0.0, 1.0);
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat3.x = u_xlat3.x * u_xlat61.x + 1.00001001;
        u_xlat4.x = u_xlat4.x * u_xlat4.x;
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat4.x = max(u_xlat4.x, 0.100000001);
        u_xlat3.x = u_xlat3.x * u_xlat4.x;
        u_xlat3.x = u_xlat7.x * u_xlat3.x;
        u_xlat3.x = u_xlat87 / u_xlat3.x;
        u_xlat10.xyz = u_xlat3.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat9.xyz = u_xlat10.xyz * u_xlat12.xyz + u_xlat9.xyz;
    }
    u_xlat2.xyz = u_xlat5.xyz * u_xlat34.xxx + u_xlat31.xyz;
    u_xlat2.xyz = u_xlat9.xyz + u_xlat2.xyz;
    u_xlat0.xyz = vs_INTERP6.www * u_xlat0.xyz + u_xlat2.xyz;
    u_xlat81 = u_xlat28.x * (-u_xlat28.x);
    u_xlat81 = exp2(u_xlat81);
    u_xlat0.xyz = u_xlat0.xyz + (-unity_FogColor.xyz);
    SV_Target0.xyz = vec3(u_xlat81) * u_xlat0.xyz + unity_FogColor.xyz;
    SV_Target0.w = (u_xlatb55) ? u_xlat1.x : 1.0;
    return;
}
