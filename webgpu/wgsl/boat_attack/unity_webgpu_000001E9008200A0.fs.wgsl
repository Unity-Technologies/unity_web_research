...
fn main_1() {
  ...
  let x_2029 : vec3<f32> = (vec3<f32>(x_2027.x, x_2027.y, x_2027.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2030 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2029.x, x_2029.y, x_2029.z, x_2030.w);
  let x_2032 : vec4<f32> = u_xlat0;
  let x_2035 : vec3<f32> = log2(abs(vec3<f32>(x_2032.x, x_2032.y, x_2032.z)));
  let x_2036 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2035.x, x_2035.y, x_2035.z, x_2036.w);
  let x_2038 : vec4<f32> = u_xlat2;
  let x_2040 : vec3<f32> = (vec3<f32>(x_2038.x, x_2038.y, x_2038.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2041 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2040.x, x_2040.y, x_2040.z, x_2041.w);
  let x_2043 : vec4<f32> = u_xlat2;
  let x_2045 : vec3<f32> = exp2(vec3<f32>(x_2043.x, x_2043.y, x_2043.z));
  let x_2046 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2045.x, x_2045.y, x_2045.z, x_2046.w);
  let x_2048 : vec4<f32> = u_xlat2;
  let x_2051 : vec3<f32> = ((vec3<f32>(x_2048.x, x_2048.y, x_2048.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2052 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2051.x, x_2051.y, x_2051.z, x_2052.w);
  let x_2054 : vec4<f32> = u_xlat0;
  let x_2056 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2054.x, x_2054.y, x_2054.z, x_2054.x));
  u_xlatb0 = vec3<bool>(x_2056.x, x_2056.y, x_2056.z);
  let x_2059 : bool = u_xlatb0.x;
  if (x_2059) {
  ...
  u_xlat0.x = x_2068;
  let x_2071 : bool = u_xlatb0.y;
  if (x_2071) {
    let x_2076 : f32 = u_xlat1.y;
    x_2072 = x_2076;
  } else {
    let x_2079 : f32 = u_xlat2.y;
    x_2072 = x_2079;
  }
  let x_2080 : f32 = x_2072;
  u_xlat0.y = x_2080;
  let x_2083 : bool = u_xlatb0.z;
  if (x_2083) {
    let x_2088 : f32 = u_xlat1.z;
    x_2084 = x_2088;
  } else {
    let x_2091 : f32 = u_xlat2.z;
    x_2084 = x_2091;
  }
  let x_2092 : f32 = x_2084;
  u_xlat0.z = x_2092;
  let x_2094 : vec2<f32> = vs_TEXCOORD0;
  let x_2097 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2101 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2103 : vec2<f32> = ((x_2094 * vec2<f32>(x_2097.x, x_2097.y)) + vec2<f32>(x_2101.z, x_2101.w));
  let x_2104 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2103.x, x_2103.y, x_2104.z, x_2104.w);
  let x_2111 : vec4<f32> = u_xlat1;
  let x_2114 : f32 = x_25.x_GlobalMipBias.x;
  let x_2115 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2111.x, x_2111.y), x_2114);
  u_xlat18 = x_2115.w;
  let x_2117 : f32 = u_xlat18;
  u_xlat18 = ((x_2117 * 2.0f) + -1.0f);
  let x_2120 : f32 = u_xlat18;
  u_xlatb1 = (x_2120 >= 0.0f);
  let x_2122 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2122);
  let x_2125 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2125)) + 1.0f);
  let x_2129 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2129);
  let x_2131 : f32 = u_xlat18;
  u_xlat18 = (-(x_2131) + 1.0f);
  let x_2134 : f32 = u_xlat18;
  let x_2136 : f32 = u_xlat1.x;
  u_xlat18 = (x_2134 * x_2136);
  let x_2138 : vec4<f32> = u_xlat0;
  let x_2140 : vec3<f32> = (vec3<f32>(x_2138.x, x_2138.y, x_2138.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2141 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2140.x, x_2140.y, x_2140.z, x_2141.w);
  let x_2143 : vec4<f32> = u_xlat0;
  let x_2146 : vec3<f32> = log2(abs(vec3<f32>(x_2143.x, x_2143.y, x_2143.z)));
  let x_2147 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2146.x, x_2146.y, x_2146.z, x_2147.w);
  let x_2149 : vec4<f32> = u_xlat2;
  let x_2151 : vec3<f32> = (vec3<f32>(x_2149.x, x_2149.y, x_2149.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2152 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2151.x, x_2151.y, x_2151.z, x_2152.w);
  let x_2154 : vec4<f32> = u_xlat2;
  let x_2156 : vec3<f32> = exp2(vec3<f32>(x_2154.x, x_2154.y, x_2154.z));
  let x_2157 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2156.x, x_2156.y, x_2156.z, x_2157.w);
  let x_2159 : vec4<f32> = u_xlat2;
  let x_2162 : vec3<f32> = ((vec3<f32>(x_2159.x, x_2159.y, x_2159.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2163 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2162.x, x_2162.y, x_2162.z, x_2163.w);
  let x_2165 : vec4<f32> = u_xlat0;
  let x_2167 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2165.x, x_2165.y, x_2165.z, x_2165.x));
  u_xlatb0 = vec3<bool>(x_2167.x, x_2167.y, x_2167.z);
  let x_2170 : bool = u_xlatb0.x;
  if (x_2170) {
    let x_2175 : f32 = u_xlat1.x;
    x_2171 = x_2175;
  } else {
    let x_2178 : f32 = u_xlat2.x;
    x_2171 = x_2178;
  }
  let x_2179 : f32 = x_2171;
  u_xlat0.x = x_2179;
  let x_2182 : bool = u_xlatb0.y;
  if (x_2182) {
    let x_2187 : f32 = u_xlat1.y;
    x_2183 = x_2187;
  } else {
    let x_2190 : f32 = u_xlat2.y;
    x_2183 = x_2190;
  }
  let x_2191 : f32 = x_2183;
  u_xlat0.y = x_2191;
  let x_2194 : bool = u_xlatb0.z;
  if (x_2194) {
    let x_2199 : f32 = u_xlat1.z;
    x_2195 = x_2199;
  } else {
  ...
  u_xlat0.z = x_2203;
  let x_2205 : f32 = u_xlat18;
  let x_2210 : vec4<f32> = u_xlat0;
  let x_2212 : vec3<f32> = ((vec3<f32>(x_2205, x_2205, x_2205) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2210.x, x_2210.y, x_2210.z));
  let x_2213 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2212.x, x_2212.y, x_2212.z, x_2213.w);
  let x_2215 : vec4<f32> = u_xlat0;
  let x_2217 : vec3<f32> = (vec3<f32>(x_2215.x, x_2215.y, x_2215.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2218 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2217.x, x_2217.y, x_2217.z, x_2218.w);
  let x_2220 : vec4<f32> = u_xlat0;
  let x_2222 : vec3<f32> = (vec3<f32>(x_2220.x, x_2220.y, x_2220.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2223 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2222.x, x_2222.y, x_2222.z, x_2223.w);
  let x_2225 : vec4<f32> = u_xlat2;
  let x_2227 : vec3<f32> = (vec3<f32>(x_2225.x, x_2225.y, x_2225.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2228 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2227.x, x_2227.y, x_2227.z, x_2228.w);
  let x_2230 : vec4<f32> = u_xlat2;
  let x_2233 : vec3<f32> = log2(abs(vec3<f32>(x_2230.x, x_2230.y, x_2230.z)));
  let x_2234 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2233.x, x_2233.y, x_2233.z, x_2234.w);
  let x_2236 : vec4<f32> = u_xlat2;
  let x_2238 : vec3<f32> = (vec3<f32>(x_2236.x, x_2236.y, x_2236.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2239 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2238.x, x_2238.y, x_2238.z, x_2239.w);
  let x_2241 : vec4<f32> = u_xlat2;
  let x_2243 : vec3<f32> = exp2(vec3<f32>(x_2241.x, x_2241.y, x_2241.z));
  let x_2244 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2243.x, x_2243.y, x_2243.z, x_2244.w);
  let x_2246 : vec4<f32> = u_xlat0;
  let x_2248 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2246.x, x_2246.y, x_2246.z, x_2246.x));
  u_xlatb0 = vec3<bool>(x_2248.x, x_2248.y, x_2248.z);
  let x_2251 : bool = u_xlatb0.x;
  if (x_2251) {
    let x_2256 : f32 = u_xlat1.x;
    x_2252 = x_2256;
  } else {
    let x_2259 : f32 = u_xlat2.x;
    x_2252 = x_2259;
  }
  let x_2260 : f32 = x_2252;
  u_xlat0.x = x_2260;
  let x_2263 : bool = u_xlatb0.y;
  if (x_2263) {
    let x_2268 : f32 = u_xlat1.y;
    x_2264 = x_2268;
  } else {
    let x_2271 : f32 = u_xlat2.y;
    x_2264 = x_2271;
  }
  let x_2272 : f32 = x_2264;
  u_xlat0.y = x_2272;
  let x_2275 : bool = u_xlatb0.z;
  if (x_2275) {
    let x_2280 : f32 = u_xlat1.z;
    x_2276 = x_2280;
  } else {
  ...
  let x_2290 : vec3<f32> = max(vec3<f32>(x_2288.x, x_2288.y, x_2288.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2291 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2290.x, x_2290.y, x_2290.z, x_2291.w);
  SV_Target0.w = 1.0f;
  return;
}
