...
void main()
{
    ...
    u_xlat1.xzw = u_xlat17.xxx * vs_INTERP4.xyz + u_xlat1.xzw;
    u_xlat1.xzw = u_xlat17.zzz * vs_INTERP9.xyz + u_xlat1.xzw;
    ...
    u_xlat4.x = vs_INTERP8.y * unity_MatrixV[1].z;
    u_xlat4.x = unity_MatrixV[0].z * vs_INTERP8.x + u_xlat4.x;
    u_xlat4.x = unity_MatrixV[2].z * vs_INTERP8.z + u_xlat4.x;
    ...
    u_xlat18.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP0.xy, _GlobalMipBias.x).xyz;
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat5.x);
    ...
    u_xlat3.x = u_xlat20.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu44 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat51 = u_xlat3.x * u_xlat52 + u_xlat51;
        ...
        u_xlat49 = dot(u_xlat1.xzw, u_xlat10.xyz);
        ...
        u_xlat48 = dot(u_xlat1.xzw, u_xlat9.xyz);
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        u_xlat49 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        u_xlat48 = u_xlat48 * u_xlat48;
        u_xlat48 = u_xlat48 * u_xlat5.x + 1.00001001;
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat48 = u_xlat48 * u_xlat48;
    ...
    u_xlat1.xzw = u_xlat18.xyz * vec3(u_xlat6) + u_xlat7.xyz;
    u_xlat1.xzw = u_xlat8.xyz + u_xlat1.xzw;
    u_xlat0.xyz = vs_INTERP6.www * u_xlat0.xyz + u_xlat1.xzw;
