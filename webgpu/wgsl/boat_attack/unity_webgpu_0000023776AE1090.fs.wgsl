...
fn main_1() {
  ...
  let x_1800 : f32 = u_xlat12;
  let x_1802 : vec3<f32> = u_xlat1;
  let x_1804 : vec4<f32> = u_xlat0;
  let x_1806 : vec3<f32> = ((vec3<f32>(x_1800, x_1800, x_1800) * x_1802) + vec3<f32>(x_1804.x, x_1804.z, x_1804.w));
  let x_1807 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1806.x, x_1806.y, x_1806.z, x_1807.w);
  let x_1812 : f32 = vs_TEXCOORD4.x;
  let x_1814 : f32 = vs_TEXCOORD4.x;
  u_xlat36 = (x_1812 * -(x_1814));
  let x_1817 : f32 = u_xlat36;
  u_xlat36 = exp2(x_1817);
  let x_1819 : vec4<f32> = u_xlat0;
  let x_1823 : vec4<f32> = x_40.unity_FogColor;
  ...
  let x_1831 : f32 = u_xlat36;
  let x_1833 : vec4<f32> = u_xlat0;
  let x_1837 : vec4<f32> = x_40.unity_FogColor;
