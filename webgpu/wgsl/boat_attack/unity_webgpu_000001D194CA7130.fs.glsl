...
;
    ...
    u_xlat4.xyz = u_xlat12.xxx * u_xlat14.xyz;
    ...
    u_xlat5.x = (u_xlatb12.x) ? u_xlat14.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb12.x) ? u_xlat14.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb12.x) ? u_xlat14.z : unity_MatrixV[2].z;
    u_xlat4.w = 1.0;
    ...
    u_xlat14.xyz = unity_SHC.xyz * u_xlat12.xxx + u_xlat8.xyz;
    ...
    u_xlat2.xyz = u_xlat3.xyz * vec3(u_xlat38) + u_xlat17.xyz;
