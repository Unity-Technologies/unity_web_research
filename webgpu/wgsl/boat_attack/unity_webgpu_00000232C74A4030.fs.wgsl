...
fn main_1() {
  ...
  let x_2246 : vec3<f32> = sqrt(vec3<f32>(x_2244.x, x_2244.y, x_2244.z));
  let x_2247 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2246.x, x_2246.y, x_2246.z, x_2247.w);
  let x_2249 : vec2<f32> = vs_TEXCOORD0;
  let x_2252 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2256 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2258 : vec2<f32> = ((x_2249 * vec2<f32>(x_2252.x, x_2252.y)) + vec2<f32>(x_2256.z, x_2256.w));
  let x_2259 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2258.x, x_2258.y, x_2259.z, x_2259.w);
  let x_2266 : vec4<f32> = u_xlat1;
  let x_2269 : f32 = x_25.x_GlobalMipBias.x;
  let x_2270 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2266.x, x_2266.y), x_2269);
  u_xlat21 = x_2270.w;
  let x_2272 : f32 = u_xlat21;
  u_xlat21 = ((x_2272 * 2.0f) + -1.0f);
  let x_2275 : f32 = u_xlat21;
  u_xlatb1 = (x_2275 >= 0.0f);
  let x_2277 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2277);
  let x_2280 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2280)) + 1.0f);
  let x_2284 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2284);
  let x_2286 : f32 = u_xlat21;
  u_xlat21 = (-(x_2286) + 1.0f);
  let x_2289 : f32 = u_xlat21;
  let x_2291 : f32 = u_xlat1.x;
  u_xlat21 = (x_2289 * x_2291);
  let x_2293 : vec4<f32> = u_xlat0;
  let x_2295 : vec3<f32> = (vec3<f32>(x_2293.x, x_2293.y, x_2293.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2296 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2295.x, x_2295.y, x_2295.z, x_2296.w);
  let x_2298 : vec4<f32> = u_xlat0;
  let x_2300 : vec3<f32> = log2(vec3<f32>(x_2298.x, x_2298.y, x_2298.z));
  let x_2301 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2300.x, x_2300.y, x_2300.z, x_2301.w);
  let x_2303 : vec4<f32> = u_xlat2;
  let x_2305 : vec3<f32> = (vec3<f32>(x_2303.x, x_2303.y, x_2303.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2306 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2305.x, x_2305.y, x_2305.z, x_2306.w);
  let x_2308 : vec4<f32> = u_xlat2;
  let x_2310 : vec3<f32> = exp2(vec3<f32>(x_2308.x, x_2308.y, x_2308.z));
  let x_2311 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2310.x, x_2310.y, x_2310.z, x_2311.w);
  let x_2313 : vec4<f32> = u_xlat2;
  let x_2316 : vec3<f32> = ((vec3<f32>(x_2313.x, x_2313.y, x_2313.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2317 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2316.x, x_2316.y, x_2316.z, x_2317.w);
  let x_2319 : vec4<f32> = u_xlat0;
  let x_2321 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2319.x, x_2319.y, x_2319.z, x_2319.x));
  u_xlatb0 = vec3<bool>(x_2321.x, x_2321.y, x_2321.z);
  let x_2324 : bool = u_xlatb0.x;
  if (x_2324) {
    let x_2329 : f32 = u_xlat1.x;
    x_2325 = x_2329;
  } else {
    let x_2332 : f32 = u_xlat2.x;
    x_2325 = x_2332;
  }
  let x_2333 : f32 = x_2325;
  u_xlat0.x = x_2333;
  let x_2336 : bool = u_xlatb0.y;
  if (x_2336) {
    let x_2341 : f32 = u_xlat1.y;
    x_2337 = x_2341;
  } else {
    let x_2344 : f32 = u_xlat2.y;
    x_2337 = x_2344;
  }
  let x_2345 : f32 = x_2337;
  u_xlat0.y = x_2345;
  let x_2348 : bool = u_xlatb0.z;
  if (x_2348) {
    let x_2353 : f32 = u_xlat1.z;
    x_2349 = x_2353;
  } else {
    let x_2356 : f32 = u_xlat2.z;
    x_2349 = x_2356;
  }
  let x_2357 : f32 = x_2349;
  u_xlat0.z = x_2357;
  let x_2359 : f32 = u_xlat21;
  let x_2364 : vec4<f32> = u_xlat0;
  let x_2366 : vec3<f32> = ((vec3<f32>(x_2359, x_2359, x_2359) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2364.x, x_2364.y, x_2364.z));
  let x_2367 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2366.x, x_2366.y, x_2366.z, x_2367.w);
  let x_2369 : vec4<f32> = u_xlat0;
  let x_2371 : vec3<f32> = (vec3<f32>(x_2369.x, x_2369.y, x_2369.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2372 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2371.x, x_2371.y, x_2371.z, x_2372.w);
  let x_2374 : vec4<f32> = u_xlat0;
  let x_2376 : vec3<f32> = (vec3<f32>(x_2374.x, x_2374.y, x_2374.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2377 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2376.x, x_2376.y, x_2376.z, x_2377.w);
  let x_2379 : vec4<f32> = u_xlat2;
  let x_2381 : vec3<f32> = (vec3<f32>(x_2379.x, x_2379.y, x_2379.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2382 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2381.x, x_2381.y, x_2381.z, x_2382.w);
  let x_2384 : vec4<f32> = u_xlat2;
  let x_2387 : vec3<f32> = log2(abs(vec3<f32>(x_2384.x, x_2384.y, x_2384.z)));
  let x_2388 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2387.x, x_2387.y, x_2387.z, x_2388.w);
  let x_2390 : vec4<f32> = u_xlat2;
  let x_2392 : vec3<f32> = (vec3<f32>(x_2390.x, x_2390.y, x_2390.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2393 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2392.x, x_2392.y, x_2392.z, x_2393.w);
  let x_2395 : vec4<f32> = u_xlat2;
  let x_2397 : vec3<f32> = exp2(vec3<f32>(x_2395.x, x_2395.y, x_2395.z));
  let x_2398 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2397.x, x_2397.y, x_2397.z, x_2398.w);
  let x_2400 : vec4<f32> = u_xlat0;
  let x_2402 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2400.x, x_2400.y, x_2400.z, x_2400.x));
  u_xlatb0 = vec3<bool>(x_2402.x, x_2402.y, x_2402.z);
  let x_2405 : bool = u_xlatb0.x;
  if (x_2405) {
  ...
  u_xlat0.x = x_2414;
  let x_2417 : bool = u_xlatb0.y;
  if (x_2417) {
    let x_2422 : f32 = u_xlat1.y;
    x_2418 = x_2422;
  } else {
    let x_2425 : f32 = u_xlat2.y;
    x_2418 = x_2425;
  }
  let x_2426 : f32 = x_2418;
  u_xlat0.y = x_2426;
  let x_2429 : bool = u_xlatb0.z;
  if (x_2429) {
    let x_2434 : f32 = u_xlat1.z;
    x_2430 = x_2434;
  } else {
    let x_2437 : f32 = u_xlat2.z;
    x_2430 = x_2437;
  }
  let x_2438 : f32 = x_2430;
  u_xlat0.z = x_2438;
  let x_2442 : vec4<f32> = u_xlat0;
  let x_2444 : vec3<f32> = max(vec3<f32>(x_2442.x, x_2442.y, x_2442.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2445 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2444.x, x_2444.y, x_2444.z, x_2445.w);
  SV_Target0.w = 1.0f;
  return;
}
