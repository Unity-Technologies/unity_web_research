...
fn main_1() {
  ...
  SV_Target0.x = x_1522;
  let x_1526 : bool = u_xlatb0.y;
  if (x_1526) {
    let x_1531 : f32 = u_xlat1.y;
    x_1527 = x_1531;
  } else {
    let x_1534 : f32 = u_xlat2.y;
    x_1527 = x_1534;
  }
  let x_1535 : f32 = x_1527;
  SV_Target0.y = x_1535;
  let x_1538 : bool = u_xlatb0.z;
  if (x_1538) {
    let x_1543 : f32 = u_xlat1.z;
    x_1539 = x_1543;
  } else {
