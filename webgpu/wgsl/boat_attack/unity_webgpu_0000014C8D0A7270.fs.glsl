...
void main()
{
    ...
    u_xlat27.xyz = unity_SHC.xyz * u_xlat27.xxx + u_xlat5.xyz;
    ...
    u_xlat82 = dot((-u_xlat6.xyz), u_xlat2.xyz);
    u_xlat82 = u_xlat82 + u_xlat82;
    u_xlat7.xyz = u_xlat2.xyz * (-vec3(u_xlat82)) + (-u_xlat6.xyz);
    u_xlat82 = dot(u_xlat2.xyz, u_xlat6.xyz);
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    ...
    u_xlat1.xyz = u_xlat27.xyz * u_xlat29.xyz + u_xlat7.xyz;
    ...
    u_xlat79 = u_xlat56.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
