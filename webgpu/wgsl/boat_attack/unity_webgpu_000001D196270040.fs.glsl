...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat3.x = (u_xlatb22) ? u_xlat2.x : unity_MatrixV[0].z;
    u_xlat3.y = (u_xlatb22) ? u_xlat2.y : unity_MatrixV[1].z;
    u_xlat3.z = (u_xlatb22) ? u_xlat2.z : unity_MatrixV[2].z;
...
;
    ...
    u_xlat65 = dot(u_xlat22.xyz, u_xlat4.xyz);
    u_xlat65 = u_xlat65 + 0.5;
    u_xlat4.xyz = vec3(u_xlat65) * u_xlat5.xyz;
    u_xlat65 = max(u_xlat4.w, 9.99999975e-05);
    u_xlat4.xyz = u_xlat4.xyz / vec3(u_xlat65);
    u_xlat5.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat5.xy = u_xlat5.xy * hlslcc_FragCoord.xy;
    u_xlat65 = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat65) + 1.0;
    u_xlat65 = (-u_xlat1) * 0.959999979 + 0.959999979;
    ...
    u_xlatb47.x = 0.0<_MainLightShadowParams.y;
    if(u_xlatb47.x){
        u_xlatb47.x = _MainLightShadowParams.y==1.0;
        if(u_xlatb47.x){
            ...
            u_xlat47 = dot(u_xlat8, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            u_xlatb68 = _MainLightShadowParams.y==2.0;
            if(u_xlatb68){
                u_xlat7.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat49.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                vec3 txVec6 = vec3(u_xlat49.xy,u_xlat2.z);
                ...
                u_xlat47 = u_xlat68 * u_xlat7.x + u_xlat69;
            } else {
                u_xlat7.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat49.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                vec3 txVec15 = vec3(u_xlat49.xy,u_xlat2.z);
                ...
                vec3 txVec16 = vec3(u_xlat16.xy,u_xlat2.z);
                ...
                vec3 txVec19 = vec3(u_xlat15.xy,u_xlat2.z);
                ...
                vec3 txVec20 = vec3(u_xlat16.zw,u_xlat2.z);
                ...
                vec3 txVec21 = vec3(u_xlat17.xy,u_xlat2.z);
                ...
                vec3 txVec22 = vec3(u_xlat17.zw,u_xlat2.z);
                ...
                vec3 txVec24 = vec3(u_xlat57.xy,u_xlat2.z);
                ...
                vec3 txVec25 = vec3(u_xlat12.xy,u_xlat2.z);
                ...
                vec3 txVec26 = vec3(u_xlat12.zw,u_xlat2.z);
                ...
                vec3 txVec28 = vec3(u_xlat7.xy,u_xlat2.z);
                u_xlat69 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec28, 0.0);
                u_xlat47 = u_xlat8.w * u_xlat69 + u_xlat68;
            }
        }
    } else {
        vec3 txVec29 = vec3(u_xlat2.xy,u_xlat2.z);
        u_xlat47 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat2.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat2.x = u_xlat47 * _MainLightShadowParams.x + u_xlat2.x;
    u_xlatb23.x = 0.0>=u_xlat2.z;
    u_xlatb44 = u_xlat2.z>=1.0;
    u_xlatb23.x = u_xlatb44 || u_xlatb23.x;
    u_xlat2.x = (u_xlatb23.x) ? 1.0 : u_xlat2.x;
    ...
    u_xlat2.x = u_xlat23.x * u_xlat44.x + u_xlat2.x;
    u_xlatb23.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb23.x){
        u_xlat23.xy = vs_TEXCOORD7.yy * _MainLightWorldToLight[1].xy;
        u_xlat23.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD7.xx + u_xlat23.xy;
        u_xlat23.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD7.zz + u_xlat23.xy;
        u_xlat23.xy = u_xlat23.xy + _MainLightWorldToLight[3].xy;
        u_xlat23.xy = u_xlat23.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat7 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat23.xy, _GlobalMipBias.x);
        ...
        u_xlat44.x = (u_xlatb23.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb23.x) ? u_xlat7.xyz : u_xlat44.xxx;
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat23.x = dot((-u_xlat3.xyz), u_xlat22.xyz);
    u_xlat23.x = u_xlat23.x + u_xlat23.x;
    u_xlat8.xyz = u_xlat22.xyz * (-u_xlat23.xxx) + (-u_xlat3.xyz);
    u_xlat23.x = dot(u_xlat22.xyz, u_xlat3.xyz);
    u_xlat23.x = clamp(u_xlat23.x, 0.0, 1.0);
    u_xlat23.x = (-u_xlat23.x) + 1.0;
    u_xlat23.x = u_xlat23.x * u_xlat23.x;
    u_xlat23.x = u_xlat23.x * u_xlat23.x;
    u_xlat44.x = (-u_xlat1) * 0.699999988 + 1.70000005;
    u_xlat1 = u_xlat1 * u_xlat44.x;
    u_xlat1 = u_xlat1 * 6.0;
    ...
    u_xlat44.xy = vec2(u_xlat65) * vec2(u_xlat65) + vec2(-1.0, 1.0);
    u_xlat1 = float(1.0) / u_xlat44.y;
    u_xlat9.xyz = (-u_xlat0.xyz) + vec3(u_xlat63);
    u_xlat9.xyz = u_xlat23.xxx * u_xlat9.xyz + u_xlat0.xyz;
    u_xlat9.xyz = vec3(u_xlat1) * u_xlat9.xyz;
    u_xlat8.xyz = u_xlat8.xyz * u_xlat9.xyz;
    u_xlat4.xyz = u_xlat4.xyz * u_xlat6.xyz + u_xlat8.xyz;
    u_xlat63 = u_xlat2.x * unity_LightData.z;
    u_xlat1 = dot(u_xlat22.xyz, _MainLightPosition.xyz);
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat63 = u_xlat63 * u_xlat1;
    u_xlat2.xyw = vec3(u_xlat63) * u_xlat7.xyz;
    ...
    u_xlat63 = dot(u_xlat22.xyz, u_xlat7.xyz);
    u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
    u_xlat1 = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat63 = u_xlat63 * u_xlat63;
    u_xlat63 = u_xlat63 * u_xlat44.x + 1.00001001;
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat63) + u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu69)].www + _AdditionalLightsPosition[int(u_xlatu69)].xyz;
        ...
        if(u_xlati72 != 0) {
            ...
            if(u_xlati10 != 0) {
                u_xlat10.xzw = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati31 + 1) / 4][(u_xlati31 + 1) % 4].xyw;
                u_xlat10.xzw = _AdditionalLightsWorldToLights[u_xlati31 / 4][u_xlati31 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat10.xzw;
                u_xlat10.xzw = _AdditionalLightsWorldToLights[(u_xlati31 + 2) / 4][(u_xlati31 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat10.xzw;
                ...
                if(u_xlati72 != 0) {
                    u_xlat11.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati31 + 1) / 4][(u_xlati31 + 1) % 4].xy;
                    u_xlat11.xy = _AdditionalLightsWorldToLights[u_xlati31 / 4][u_xlati31 % 4].xy * vs_TEXCOORD7.xx + u_xlat11.xy;
                    u_xlat11.xy = _AdditionalLightsWorldToLights[(u_xlati31 + 2) / 4][(u_xlati31 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat11.xy;
                    ...
                    u_xlat11 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToLights[(u_xlati31 + 1) / 4][(u_xlati31 + 1) % 4];
                    u_xlat11 = _AdditionalLightsWorldToLights[u_xlati31 / 4][u_xlati31 % 4] * vs_TEXCOORD7.xxxx + u_xlat11;
                    u_xlat11 = _AdditionalLightsWorldToLights[(u_xlati31 + 2) / 4][(u_xlati31 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat11;
            ...
            u_xlat72 = (u_xlatb47.y) ? u_xlat10.w : u_xlat10.x;
            u_xlat10.xyz = (u_xlatb47.x) ? u_xlat10.xyz : vec3(u_xlat72);
        } else {
        ...
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat71) + u_xlat3.xyz;
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat69) + u_xlat6.xyz;
