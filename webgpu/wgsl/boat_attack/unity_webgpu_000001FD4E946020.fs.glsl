...
void main()
{
    ...
    u_xlatb4.x = 0.0>=vs_INTERP3.z;
    u_xlatb82 = vs_INTERP3.z>=1.0;
    u_xlatb4.x = u_xlatb82 || u_xlatb4.x;
    u_xlat78 = (u_xlatb4.x) ? 1.0 : u_xlat78;
    ...
    u_xlatb82 = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb82){
        ...
        u_xlat82 = (u_xlatb8.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb8.x) ? u_xlat7.xyz : vec3(u_xlat82);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat8.xyz = u_xlat5.xyz * (-vec3(u_xlat82)) + (-u_xlat6.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_INTERP8.xyz) * _AdditionalLightsPosition[u_xlati83].www + _AdditionalLightsPosition[u_xlati83].xyz;
        ...
        if(u_xlati87 != 0) {
            ...
            u_xlat87 = (u_xlatb4.w) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb4.x) ? u_xlat11.xyz : vec3(u_xlat87);
        } else {
        ...
        u_xlat83 = dot(u_xlat5.xyz, u_xlat9.xyz);
        u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
        u_xlat84 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
        u_xlat83 = u_xlat83 * u_xlat83;
        u_xlat83 = u_xlat83 * u_xlat27.x + 1.00001001;
        u_xlat84 = u_xlat84 * u_xlat84;
        u_xlat83 = u_xlat83 * u_xlat83;
        u_xlat84 = max(u_xlat84, 0.100000001);
        u_xlat83 = u_xlat83 * u_xlat84;
        u_xlat83 = u_xlat30.x * u_xlat83;
        u_xlat83 = u_xlat80 / u_xlat83;
        u_xlat9.xyz = vec3(u_xlat83) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
