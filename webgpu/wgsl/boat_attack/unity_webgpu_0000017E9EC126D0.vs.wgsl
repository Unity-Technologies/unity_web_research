...
fn main_1() {
  ...
  vs_TEXCOORD0 = x_85;
  let x_88 : vec2<f32> = in_TEXCOORD1;
  vs_TEXCOORD1 = x_88;
  return;
}
...
@vertex
fn main(@location(0) in_POSITION0_param : vec4<f32>, @location(1) in_TEXCOORD0_param : vec2<f32>, @location(2) in_TEXCOORD1_param : vec2<f32>) -> main_out {
