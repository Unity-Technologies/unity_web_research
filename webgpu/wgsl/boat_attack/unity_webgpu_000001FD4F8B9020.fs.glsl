...
void main()
{
    u_xlat0 = vs_INTERP0.xyxy * vec4(5.40999985, 5.40999985, 2.70499992, 2.70499992);
    ...
    u_xlat1 = vs_INTERP0.xyxy * vec4(1.35249996, 1.35249996, 21.2000008, 21.2000008);
    ...
    u_xlat1.y = u_xlat2.x;
    u_xlat6.xz = (-u_xlat6.xx) * u_xlat1.xy + vs_INTERP0.xy;
    u_xlat6.xz = u_xlat6.xz + u_xlat0.xx;
    u_xlat1.xy = u_xlat0.xx + vs_INTERP0.xy;
    ...
    u_xlat1 = vs_INTERP0.xyxy * vec4(10.6000004, 10.6000004, 5.30000019, 5.30000019);
    u_xlat2 = floor(u_xlat1);
    u_xlat1 = fract(u_xlat1);
    u_xlat3 = u_xlat2 + vec4(1.0, 1.0, 1.0, 0.0);
    ...
    u_xlat6.x = (-_WorldSpaceCameraPos.y) * 0.984375 + vs_INTERP1.y;
