...
fn main_1() {
  ...
  let x_1755 : vec2<f32> = vs_TEXCOORD0;
  let x_1758 : vec4<f32> = x_26.x_Grain_TilingParams;
  let x_1762 : vec4<f32> = x_26.x_Grain_TilingParams;
  let x_1764 : vec2<f32> = ((x_1755 * vec2<f32>(x_1758.x, x_1758.y)) + vec2<f32>(x_1762.z, x_1762.w));
  let x_1765 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1764.x, x_1764.y, x_1765.z, x_1765.w);
  let x_1772 : vec4<f32> = u_xlat1;
  let x_1775 : f32 = x_26.x_GlobalMipBias.x;
  let x_1776 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1772.x, x_1772.y), x_1775);
  u_xlat21 = x_1776.w;
  let x_1778 : f32 = u_xlat21;
  u_xlat21 = (x_1778 + -0.5f);
  let x_1780 : f32 = u_xlat21;
  let x_1781 : f32 = u_xlat21;
  u_xlat21 = (x_1780 + x_1781);
  let x_1783 : vec3<f32> = u_xlat0;
  u_xlat1.x = dot(x_1783, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1791 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1791);
  let x_1796 : f32 = x_26.x_Grain_Params.y;
  let x_1798 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1796 * -(x_1798)) + 1.0f);
  let x_1803 : f32 = u_xlat21;
  let x_1805 : vec3<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_1803, x_1803, x_1803) * x_1805);
  let x_1807 : vec3<f32> = u_xlat8;
  let x_1810 : vec2<f32> = x_26.x_Grain_Params;
  u_xlat8 = (x_1807 * vec3<f32>(x_1810.x, x_1810.x, x_1810.x));
  let x_1813 : vec3<f32> = u_xlat8;
  let x_1814 : vec4<f32> = u_xlat1;
  let x_1817 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1813 * vec3<f32>(x_1814.x, x_1814.x, x_1814.x)) + x_1817);
  let x_1819 : vec3<f32> = u_xlat0;
  let x_1820 : vec3<f32> = (x_1819 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1821 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1820.x, x_1820.y, x_1820.z, x_1821.w);
  let x_1823 : vec3<f32> = u_xlat0;
  let x_1825 : vec3<f32> = log2(abs(x_1823));
  let x_1826 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1825.x, x_1825.y, x_1825.z, x_1826.w);
  let x_1828 : vec4<f32> = u_xlat2;
  let x_1830 : vec3<f32> = (vec3<f32>(x_1828.x, x_1828.y, x_1828.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1831 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1830.x, x_1830.y, x_1830.z, x_1831.w);
  let x_1833 : vec4<f32> = u_xlat2;
  let x_1835 : vec3<f32> = exp2(vec3<f32>(x_1833.x, x_1833.y, x_1833.z));
  let x_1836 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1835.x, x_1835.y, x_1835.z, x_1836.w);
  let x_1838 : vec4<f32> = u_xlat2;
  let x_1841 : vec3<f32> = ((vec3<f32>(x_1838.x, x_1838.y, x_1838.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1842 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1841.x, x_1841.y, x_1841.z, x_1842.w);
  let x_1844 : vec3<f32> = u_xlat0;
  let x_1846 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1844.x, x_1844.y, x_1844.z, x_1844.x));
  u_xlatb0 = vec3<bool>(x_1846.x, x_1846.y, x_1846.z);
  let x_1849 : bool = u_xlatb0.x;
  if (x_1849) {
    let x_1854 : f32 = u_xlat1.x;
    x_1850 = x_1854;
  } else {
    let x_1857 : f32 = u_xlat2.x;
    x_1850 = x_1857;
  }
  let x_1858 : f32 = x_1850;
  u_xlat0.x = x_1858;
  let x_1861 : bool = u_xlatb0.y;
  if (x_1861) {
    let x_1866 : f32 = u_xlat1.y;
    x_1862 = x_1866;
  } else {
    let x_1869 : f32 = u_xlat2.y;
    x_1862 = x_1869;
  }
  let x_1870 : f32 = x_1862;
  u_xlat0.y = x_1870;
  let x_1873 : bool = u_xlatb0.z;
  if (x_1873) {
    let x_1878 : f32 = u_xlat1.z;
    x_1874 = x_1878;
  } else {
    let x_1881 : f32 = u_xlat2.z;
    x_1874 = x_1881;
  }
  let x_1882 : f32 = x_1874;
  u_xlat0.z = x_1882;
  let x_1884 : vec2<f32> = vs_TEXCOORD0;
  let x_1887 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1891 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1893 : vec2<f32> = ((x_1884 * vec2<f32>(x_1887.x, x_1887.y)) + vec2<f32>(x_1891.z, x_1891.w));
  let x_1894 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1893.x, x_1893.y, x_1894.z, x_1894.w);
  let x_1901 : vec4<f32> = u_xlat1;
  let x_1904 : f32 = x_26.x_GlobalMipBias.x;
  let x_1905 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1901.x, x_1901.y), x_1904);
  u_xlat21 = x_1905.w;
  let x_1907 : f32 = u_xlat21;
  u_xlat21 = ((x_1907 * 2.0f) + -1.0f);
  let x_1910 : f32 = u_xlat21;
  u_xlatb1 = (x_1910 >= 0.0f);
  let x_1912 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1912);
  let x_1915 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1915)) + 1.0f);
  let x_1919 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1919);
  let x_1921 : f32 = u_xlat21;
  u_xlat21 = (-(x_1921) + 1.0f);
  let x_1924 : f32 = u_xlat21;
  let x_1926 : f32 = u_xlat1.x;
  u_xlat21 = (x_1924 * x_1926);
  let x_1928 : vec3<f32> = u_xlat0;
  let x_1929 : vec3<f32> = (x_1928 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1930 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1929.x, x_1929.y, x_1929.z, x_1930.w);
  let x_1932 : vec3<f32> = u_xlat0;
  let x_1934 : vec3<f32> = log2(abs(x_1932));
  let x_1935 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1934.x, x_1934.y, x_1934.z, x_1935.w);
  let x_1937 : vec4<f32> = u_xlat2;
  let x_1939 : vec3<f32> = (vec3<f32>(x_1937.x, x_1937.y, x_1937.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1940 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1939.x, x_1939.y, x_1939.z, x_1940.w);
  let x_1942 : vec4<f32> = u_xlat2;
  let x_1944 : vec3<f32> = exp2(vec3<f32>(x_1942.x, x_1942.y, x_1942.z));
  let x_1945 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1944.x, x_1944.y, x_1944.z, x_1945.w);
  let x_1947 : vec4<f32> = u_xlat2;
  let x_1950 : vec3<f32> = ((vec3<f32>(x_1947.x, x_1947.y, x_1947.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1951 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1950.x, x_1950.y, x_1950.z, x_1951.w);
  let x_1953 : vec3<f32> = u_xlat0;
  let x_1955 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1953.x, x_1953.y, x_1953.z, x_1953.x));
  u_xlatb0 = vec3<bool>(x_1955.x, x_1955.y, x_1955.z);
  let x_1958 : bool = u_xlatb0.x;
  if (x_1958) {
    let x_1963 : f32 = u_xlat1.x;
    x_1959 = x_1963;
  } else {
    let x_1966 : f32 = u_xlat2.x;
    x_1959 = x_1966;
  }
  let x_1967 : f32 = x_1959;
  u_xlat0.x = x_1967;
  let x_1970 : bool = u_xlatb0.y;
  if (x_1970) {
    let x_1975 : f32 = u_xlat1.y;
    x_1971 = x_1975;
  } else {
  ...
  u_xlat0.y = x_1979;
  let x_1982 : bool = u_xlatb0.z;
  if (x_1982) {
    let x_1987 : f32 = u_xlat1.z;
    x_1983 = x_1987;
  } else {
    let x_1990 : f32 = u_xlat2.z;
    x_1983 = x_1990;
  }
  let x_1991 : f32 = x_1983;
  u_xlat0.z = x_1991;
  let x_1993 : f32 = u_xlat21;
  let x_1998 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1993, x_1993, x_1993) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1998);
  let x_2000 : vec3<f32> = u_xlat0;
  let x_2001 : vec3<f32> = (x_2000 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2002 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2001.x, x_2001.y, x_2001.z, x_2002.w);
  let x_2004 : vec3<f32> = u_xlat0;
  let x_2005 : vec3<f32> = (x_2004 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2006 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2005.x, x_2005.y, x_2005.z, x_2006.w);
  let x_2008 : vec4<f32> = u_xlat2;
  let x_2010 : vec3<f32> = (vec3<f32>(x_2008.x, x_2008.y, x_2008.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2011 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2010.x, x_2010.y, x_2010.z, x_2011.w);
  let x_2013 : vec4<f32> = u_xlat2;
  let x_2016 : vec3<f32> = log2(abs(vec3<f32>(x_2013.x, x_2013.y, x_2013.z)));
  let x_2017 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2016.x, x_2016.y, x_2016.z, x_2017.w);
  let x_2019 : vec4<f32> = u_xlat2;
  let x_2021 : vec3<f32> = (vec3<f32>(x_2019.x, x_2019.y, x_2019.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2022 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2021.x, x_2021.y, x_2021.z, x_2022.w);
  let x_2024 : vec4<f32> = u_xlat2;
  let x_2026 : vec3<f32> = exp2(vec3<f32>(x_2024.x, x_2024.y, x_2024.z));
  let x_2027 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2026.x, x_2026.y, x_2026.z, x_2027.w);
  let x_2029 : vec3<f32> = u_xlat0;
  let x_2031 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2029.x, x_2029.y, x_2029.z, x_2029.x));
  u_xlatb0 = vec3<bool>(x_2031.x, x_2031.y, x_2031.z);
  let x_2034 : bool = u_xlatb0.x;
  if (x_2034) {
    let x_2039 : f32 = u_xlat1.x;
    x_2035 = x_2039;
  } else {
    let x_2042 : f32 = u_xlat2.x;
    x_2035 = x_2042;
  }
  let x_2043 : f32 = x_2035;
  u_xlat0.x = x_2043;
  let x_2046 : bool = u_xlatb0.y;
  if (x_2046) {
    let x_2051 : f32 = u_xlat1.y;
    x_2047 = x_2051;
  } else {
    let x_2054 : f32 = u_xlat2.y;
    x_2047 = x_2054;
  }
  let x_2055 : f32 = x_2047;
  u_xlat0.y = x_2055;
  let x_2058 : bool = u_xlatb0.z;
  if (x_2058) {
    let x_2063 : f32 = u_xlat1.z;
    x_2059 = x_2063;
  } else {
  ...
  let x_2072 : vec3<f32> = max(x_2071, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2073 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2072.x, x_2072.y, x_2072.z, x_2073.w);
  SV_Target0.w = 1.0f;
  return;
}
