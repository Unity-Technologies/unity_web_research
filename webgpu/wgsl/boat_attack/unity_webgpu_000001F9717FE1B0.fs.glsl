...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat12.x = _BA_SkyboxRatio * Vector1_33982692;
    ...
    u_xlat12.x = (u_xlatb6.z) ? u_xlat3.y : u_xlat3.x;
    u_xlat1.y = u_xlat12.x * u_xlat1.z + u_xlat6.x;
    u_xlat1.x = float(1.0);
    u_xlat1.z = float(1.0);
    u_xlat1.w = float(1.0);
    ...
    u_xlat0.y = (u_xlatb0) ? u_xlat6.x : hlslcc_FragCoord.y;
