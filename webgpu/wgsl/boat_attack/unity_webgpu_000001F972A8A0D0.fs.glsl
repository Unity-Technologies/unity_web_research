...
;
    ...
    u_xlat31 = u_xlat17.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat31 = dot(unity_LightIndices[int(u_xlatu31)], uintBitsToFloat(ImmCB_0[u_xlati48]));
        u_xlati31 = int(u_xlat31);
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati31].www + _AdditionalLightsPosition[u_xlati31].xyz;
        ...
        u_xlat51 = dot(_AdditionalLightsSpotDir[u_xlati31].xyz, u_xlat10.xyz);
        u_xlat51 = u_xlat51 * _AdditionalLightsAttenuation[u_xlati31].z + _AdditionalLightsAttenuation[u_xlati31].w;
        u_xlat51 = clamp(u_xlat51, 0.0, 1.0);
        u_xlat51 = u_xlat51 * u_xlat51;
        u_xlat48 = u_xlat48 * u_xlat51;
        u_xlati51 = int(_AdditionalShadowParams[u_xlati31].w);
        u_xlatb52 = u_xlati51>=0;
        if(u_xlatb52){
            u_xlatb52 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati31].z);
            if(u_xlatb52){
            ...
            u_xlat52 = 1.0 + (-_AdditionalShadowParams[u_xlati31].x);
            u_xlat51 = u_xlat51 * _AdditionalShadowParams[u_xlati31].x + u_xlat52;
        ...
        u_xlati52 = 1 << (u_xlati31 & int(0x1F));
        u_xlati52 = int(uint(u_xlati52) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati52 != 0) {
            u_xlati52 = int(_AdditionalLightsLightTypes[u_xlati31]);
            u_xlati11 = (u_xlati52 != 0) ? 0 : 1;
            u_xlati25 = u_xlati31 << (2 & int(0x1F));
            if(u_xlati11 != 0) {
                ...
                u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati31].xy * u_xlat11.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati31].zw;
            } else {
                ...
                if(u_xlati52 != 0) {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati31].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati31].zw;
                } else {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati31].xy * u_xlat25.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati31].zw;
                }
            }
            u_xlat11 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat11.xz, 0.0);
            u_xlat52 = (u_xlatb3.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat52);
        } else {
            u_xlat11.x = float(1.0);
            u_xlat11.y = float(1.0);
            u_xlat11.z = float(1.0);
        }
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[u_xlati31].xyz;
        u_xlat31 = u_xlat48 * u_xlat51;
        u_xlat48 = dot(u_xlat2.xyz, u_xlat10.xyz);
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        u_xlat31 = u_xlat31 * u_xlat48;
        u_xlat11.xyz = vec3(u_xlat31) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat49) + u_xlat15.xyz;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat31) + u_xlat5.xyz;
