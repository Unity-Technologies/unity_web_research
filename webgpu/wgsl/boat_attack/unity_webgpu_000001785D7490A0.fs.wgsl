...
fn main_1() {
  ...
  let x_1623 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1627 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1629 : vec2<f32> = ((x_1620 * vec2<f32>(x_1623.x, x_1623.y)) + vec2<f32>(x_1627.z, x_1627.w));
  let x_1630 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1629.x, x_1629.y, x_1630.z, x_1630.w);
  let x_1637 : vec4<f32> = u_xlat1;
  let x_1640 : f32 = x_26.x_GlobalMipBias.x;
  let x_1641 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1637.x, x_1637.y), x_1640);
  u_xlat15 = x_1641.w;
  let x_1643 : f32 = u_xlat15;
  u_xlat15 = ((x_1643 * 2.0f) + -1.0f);
  let x_1646 : f32 = u_xlat15;
  u_xlatb1 = (x_1646 >= 0.0f);
  let x_1648 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1648);
  let x_1651 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1651)) + 1.0f);
  let x_1655 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1655);
  let x_1657 : f32 = u_xlat15;
  u_xlat15 = (-(x_1657) + 1.0f);
  let x_1660 : f32 = u_xlat15;
  let x_1662 : f32 = u_xlat1.x;
  u_xlat15 = (x_1660 * x_1662);
  let x_1664 : vec3<f32> = u_xlat0;
  let x_1665 : vec3<f32> = (x_1664 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1666 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1666.w);
  let x_1668 : vec3<f32> = u_xlat0;
  let x_1669 : vec3<f32> = log2(x_1668);
