...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat58 = u_xlat4.x * unity_LightData.z;
    u_xlat4.xyz = vec3(u_xlat58) * u_xlat23.xyz;
    u_xlat58 = dot(u_xlat1.xyz, _MainLightPosition.xyz);
    u_xlat58 = clamp(u_xlat58, 0.0, 1.0);
    u_xlat5.xyz = vec3(u_xlat58) * u_xlat4.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu61 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat7.xyz = u_xlat2.xyz * vec3(u_xlat59) + u_xlat7.xyz;
