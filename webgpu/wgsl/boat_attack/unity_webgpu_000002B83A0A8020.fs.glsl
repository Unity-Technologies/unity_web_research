...
;
    ...
    u_xlat75 = dot(u_xlat6, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat75 = (-u_xlat75) + 4.0;
    u_xlatu75 = uint(u_xlat75);
    u_xlati75 = int(u_xlatu75) << (2 & int(0x1F));
    u_xlat5.xyz = vs_TEXCOORD1.yyy * _MainLightWorldToShadow[(u_xlati75 + 1) / 4][(u_xlati75 + 1) % 4].xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[u_xlati75 / 4][u_xlati75 % 4].xyz * vs_TEXCOORD1.xxx + u_xlat5.xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[(u_xlati75 + 2) / 4][(u_xlati75 + 2) % 4].xyz * vs_TEXCOORD1.zzz + u_xlat5.xyz;
    u_xlat5.xyz = u_xlat5.xyz + _MainLightWorldToShadow[(u_xlati75 + 3) / 4][(u_xlati75 + 3) % 4].xyz;
    ...
    u_xlat51.x = dot(u_xlat4.xyz, u_xlat6.xyz);
    u_xlat51.x = u_xlat51.x + 0.5;
    u_xlat6.xyz = u_xlat51.xxx * u_xlat7.xyz;
    ...
    if(u_xlatb80){
        ...
        if(u_xlatb80){
            ...
            if(u_xlatb81){
                ...
                u_xlat57.xy = u_xlat5.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                vec3 txVec6 = vec3(u_xlat57.xy,u_xlat5.z);
                ...
                vec3 txVec15 = vec3(u_xlat57.xy,u_xlat5.z);
                ...
                vec3 txVec23 = vec3(u_xlat34.xy,u_xlat5.z);
                ...
                vec3 txVec24 = vec3(u_xlat65.xy,u_xlat5.z);
                ...
                vec3 txVec27 = vec3(u_xlat60.xy,u_xlat5.z);
    ...
    u_xlat5.x = u_xlat80 * _MainLightShadowParams.x + u_xlat5.x;
    ...
    u_xlat55 = dot((-u_xlat28.xyz), u_xlat4.xyz);
    u_xlat55 = u_xlat55 + u_xlat55;
    u_xlat7.xyz = u_xlat4.xyz * (-vec3(u_xlat55)) + (-u_xlat28.xyz);
    u_xlat55 = dot(u_xlat4.xyz, u_xlat28.xyz);
    u_xlat55 = clamp(u_xlat55, 0.0, 1.0);
    ...
    u_xlat8.xyz = (-u_xlat0.xyz) + vec3(u_xlat76);
    u_xlat8.xyz = vec3(u_xlat55) * u_xlat8.xyz + u_xlat0.xyz;
    u_xlat8.xyz = u_xlat26.xxx * u_xlat8.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat27.xyz + u_xlat7.xyz;
    u_xlat26.x = u_xlat5.x * unity_LightData.z;
    u_xlat76 = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
    u_xlat26.x = u_xlat76 * u_xlat26.x;
    u_xlat5.xzw = u_xlat26.xxx * _MainLightColor.xyz;
    ...
    u_xlat76 = u_xlat30.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu26 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat81 = u_xlat51.x / u_xlat81;
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat81) + u_xlat27.xyz;
