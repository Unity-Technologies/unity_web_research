...
fn main_1() {
  ...
  let x_1583 : vec3<f32> = sqrt(vec3<f32>(x_1581.x, x_1581.y, x_1581.z));
  let x_1584 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1583.x, x_1583.y, x_1583.z, x_1584.w);
  let x_1586 : vec2<f32> = vs_TEXCOORD0;
  let x_1589 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1593 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1595 : vec2<f32> = ((x_1586 * vec2<f32>(x_1589.x, x_1589.y)) + vec2<f32>(x_1593.z, x_1593.w));
  let x_1596 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1595.x, x_1595.y, x_1596.z, x_1596.w);
  let x_1603 : vec4<f32> = u_xlat1;
  let x_1606 : f32 = x_38.x_GlobalMipBias.x;
  let x_1607 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1603.x, x_1603.y), x_1606);
  u_xlat15 = x_1607.w;
  let x_1609 : f32 = u_xlat15;
  u_xlat15 = ((x_1609 * 2.0f) + -1.0f);
  let x_1612 : f32 = u_xlat15;
  u_xlatb1 = (x_1612 >= 0.0f);
  let x_1614 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1614);
  let x_1617 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1617)) + 1.0f);
  let x_1621 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1621);
  let x_1623 : f32 = u_xlat15;
  u_xlat15 = (-(x_1623) + 1.0f);
  let x_1626 : f32 = u_xlat15;
  let x_1628 : f32 = u_xlat1.x;
  u_xlat15 = (x_1626 * x_1628);
  let x_1630 : vec4<f32> = u_xlat0;
  let x_1632 : vec3<f32> = (vec3<f32>(x_1630.x, x_1630.y, x_1630.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1633 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1632.x, x_1632.y, x_1632.z, x_1633.w);
  ...
  let x_1642 : vec3<f32> = (vec3<f32>(x_1640.x, x_1640.y, x_1640.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1643 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1642.x, x_1642.y, x_1642.z, x_1643.w);
  let x_1645 : vec4<f32> = u_xlat2;
  let x_1647 : vec3<f32> = exp2(vec3<f32>(x_1645.x, x_1645.y, x_1645.z));
  let x_1648 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1647.x, x_1647.y, x_1647.z, x_1648.w);
  let x_1650 : vec4<f32> = u_xlat2;
  let x_1653 : vec3<f32> = ((vec3<f32>(x_1650.x, x_1650.y, x_1650.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1654 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1653.x, x_1653.y, x_1653.z, x_1654.w);
  let x_1656 : vec4<f32> = u_xlat0;
  let x_1658 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1656.x, x_1656.y, x_1656.z, x_1656.x));
  u_xlatb0 = vec3<bool>(x_1658.x, x_1658.y, x_1658.z);
  let x_1661 : bool = u_xlatb0.x;
  if (x_1661) {
  ...
  u_xlat0.x = x_1670;
  let x_1673 : bool = u_xlatb0.y;
  if (x_1673) {
    let x_1678 : f32 = u_xlat1.y;
    x_1674 = x_1678;
  } else {
    let x_1681 : f32 = u_xlat2.y;
    x_1674 = x_1681;
  }
  let x_1682 : f32 = x_1674;
  u_xlat0.y = x_1682;
  let x_1685 : bool = u_xlatb0.z;
  if (x_1685) {
    let x_1690 : f32 = u_xlat1.z;
    x_1686 = x_1690;
  } else {
  ...
  let x_1703 : vec3<f32> = ((vec3<f32>(x_1696, x_1696, x_1696) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1701.x, x_1701.y, x_1701.z));
  let x_1704 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1703.x, x_1703.y, x_1703.z, x_1704.w);
  let x_1706 : vec4<f32> = u_xlat0;
  let x_1708 : vec3<f32> = (vec3<f32>(x_1706.x, x_1706.y, x_1706.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1709 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1708.x, x_1708.y, x_1708.z, x_1709.w);
  let x_1711 : vec4<f32> = u_xlat0;
  let x_1713 : vec3<f32> = (vec3<f32>(x_1711.x, x_1711.y, x_1711.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1714 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1713.x, x_1713.y, x_1713.z, x_1714.w);
  let x_1716 : vec4<f32> = u_xlat2;
  let x_1718 : vec3<f32> = (vec3<f32>(x_1716.x, x_1716.y, x_1716.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1719 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1718.x, x_1718.y, x_1718.z, x_1719.w);
  let x_1721 : vec4<f32> = u_xlat2;
  let x_1724 : vec3<f32> = log2(abs(vec3<f32>(x_1721.x, x_1721.y, x_1721.z)));
  let x_1725 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1724.x, x_1724.y, x_1724.z, x_1725.w);
  let x_1727 : vec4<f32> = u_xlat2;
  let x_1729 : vec3<f32> = (vec3<f32>(x_1727.x, x_1727.y, x_1727.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1730 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1729.x, x_1729.y, x_1729.z, x_1730.w);
  let x_1732 : vec4<f32> = u_xlat2;
  let x_1734 : vec3<f32> = exp2(vec3<f32>(x_1732.x, x_1732.y, x_1732.z));
  let x_1735 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1734.x, x_1734.y, x_1734.z, x_1735.w);
  let x_1737 : vec4<f32> = u_xlat0;
  let x_1739 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1737.x, x_1737.y, x_1737.z, x_1737.x));
  u_xlatb0 = vec3<bool>(x_1739.x, x_1739.y, x_1739.z);
  ...
  u_xlat0.x = x_1751;
  let x_1754 : bool = u_xlatb0.y;
  if (x_1754) {
    let x_1759 : f32 = u_xlat1.y;
    x_1755 = x_1759;
  } else {
    let x_1762 : f32 = u_xlat2.y;
    x_1755 = x_1762;
  }
  let x_1763 : f32 = x_1755;
  u_xlat0.y = x_1763;
  let x_1766 : bool = u_xlatb0.z;
  if (x_1766) {
    let x_1771 : f32 = u_xlat1.z;
    x_1767 = x_1771;
  } else {
    let x_1774 : f32 = u_xlat2.z;
    x_1767 = x_1774;
  }
  let x_1775 : f32 = x_1767;
  u_xlat0.z = x_1775;
  let x_1779 : vec4<f32> = u_xlat0;
  let x_1781 : vec3<f32> = max(vec3<f32>(x_1779.x, x_1779.y, x_1779.z), vec3<f32>(0.0f, 0.0f, 0.0f));
