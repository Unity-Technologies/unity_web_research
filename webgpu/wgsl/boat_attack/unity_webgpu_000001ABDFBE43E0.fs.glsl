...
;
    ...
    u_xlat2.x = vs_INTERP0.y * unity_MatrixV[1].z;
    u_xlat2.x = unity_MatrixV[0].z * vs_INTERP0.x + u_xlat2.x;
    u_xlat2.x = unity_MatrixV[2].z * vs_INTERP0.z + u_xlat2.x;
    ...
    u_xlat7.xy = u_xlat30.xy * hlslcc_FragCoord.xy;
    u_xlat30.x = u_xlat7.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat7.z = (-u_xlat30.x) + 1.0;
    u_xlat6.x = u_xlat6.x;
    ...
    u_xlat6.x = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat7.xz, _GlobalMipBias.x).x;
    u_xlat20.x = u_xlat6.x + -1.0;
    u_xlat20.x = _AmbientOcclusionParam.w * u_xlat20.x + 1.0;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat11.xyz = u_xlat20.xxx * u_xlat11.xyz;
        ...
        u_xlat9.xyz = vec3(u_xlat46) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat5.xyz;
