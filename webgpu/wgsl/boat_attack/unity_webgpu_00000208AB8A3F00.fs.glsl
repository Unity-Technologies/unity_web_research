...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat65 = dot(u_xlat21.xyz, u_xlat4.xyz);
    u_xlat65 = u_xlat65 + 0.5;
    u_xlat4.xyz = vec3(u_xlat65) * u_xlat27.xyz;
    u_xlat65 = max(u_xlat4.w, 9.99999975e-05);
    u_xlat4.xyz = u_xlat4.xyz / vec3(u_xlat65);
    ...
    u_xlat8.xyz = u_xlat21.xyz * (-u_xlat2.xxx) + (-u_xlat3.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat68 = dot(u_xlat21.xyz, u_xlat10.xyz);
        ...
        u_xlat68 = dot(u_xlat21.xyz, u_xlat30.xyz);
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
