...
fn main_1() {
  ...
  let x_167 : f32 = u_xlat0.w;
  let x_170 : f32 = vs_TEXCOORD3.z;
  u_xlat1.x = ((x_167 * x_170) + -0.00100000004749745131f);
  let x_175 : vec4<f32> = u_xlat0;
  let x_176 : vec4<f32> = vs_TEXCOORD3;
  u_xlat0 = (x_175 * vec4<f32>(x_176.z, x_176.z, x_176.z, x_176.z));
