...
;
    u_xlat26.x = (u_xlatb4.x) ? float(-1.0) : float(-0.0);
    u_xlat26.y = (u_xlatb4.y) ? float(-1.0) : float(-0.0);
    u_xlat26.z = (u_xlatb4.z) ? float(-1.0) : float(-0.0);
    u_xlat26.xyz = u_xlat26.xyz + u_xlat5.yzw;
    u_xlat5.yzw = max(u_xlat26.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat26.x = dot(u_xlat5, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat26.x = (-u_xlat26.x) + 4.0;
    u_xlatu26 = uint(u_xlat26.x);
    u_xlati26 = int(u_xlatu26) << (2 & int(0x1F));
    u_xlat4.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati26 + 1) / 4][(u_xlati26 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati26 / 4][u_xlati26 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati26 + 2) / 4][(u_xlati26 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat4.xyz;
    u_xlat26.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati26 + 3) / 4][(u_xlati26 + 3) % 4].xyz;
    u_xlat2.w = 1.0;
    ...
    if(u_xlatb80){
        ...
        if(u_xlatb80){
            ...
            if(u_xlatb6){
                u_xlat6.xy = u_xlat26.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat6.xy = floor(u_xlat6.xy);
                u_xlat56.xy = u_xlat26.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                ...
                vec3 txVec6 = vec3(u_xlat56.xy,u_xlat26.z);
                ...
                vec3 txVec8 = vec3(u_xlat11.xy,u_xlat26.z);
                ...
                vec3 txVec9 = vec3(u_xlat11.zw,u_xlat26.z);
                ...
                vec3 txVec15 = vec3(u_xlat56.xy,u_xlat26.z);
                ...
                vec3 txVec16 = vec3(u_xlat15.xy,u_xlat26.z);
                ...
                vec3 txVec19 = vec3(u_xlat14.xy,u_xlat26.z);
                ...
                vec3 txVec20 = vec3(u_xlat15.zw,u_xlat26.z);
                ...
                vec3 txVec21 = vec3(u_xlat16.xy,u_xlat26.z);
                ...
                vec3 txVec22 = vec3(u_xlat16.zw,u_xlat26.z);
                ...
                vec3 txVec23 = vec3(u_xlat33.xy,u_xlat26.z);
                ...
                vec3 txVec24 = vec3(u_xlat64.xy,u_xlat26.z);
                ...
                vec3 txVec25 = vec3(u_xlat11.xy,u_xlat26.z);
                ...
                vec3 txVec26 = vec3(u_xlat11.zw,u_xlat26.z);
                ...
                vec3 txVec28 = vec3(u_xlat6.xy,u_xlat26.z);
    ...
    u_xlat26.x = u_xlat80 * _MainLightShadowParams.x + u_xlat26.x;
    ...
    u_xlat80 = (-u_xlat26.x) + 1.0;
    u_xlat26.x = u_xlat76 * u_xlat80 + u_xlat26.x;
    u_xlat76 = dot((-u_xlat3.xyz), u_xlat2.xyz);
    u_xlat76 = u_xlat76 + u_xlat76;
    u_xlat6.xyz = u_xlat2.xyz * (-vec3(u_xlat76)) + (-u_xlat3.xyz);
    u_xlat76 = dot(u_xlat2.xyz, u_xlat3.xyz);
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
