...
layout(set = 0, binding = 1) uniform mediump texture2D _FlareOcclusionRemapTex;
...
uint u_xlatu17;
bool u_xlatb17;
layout(set = 0, binding = 2) uniform mediump  sampler sampler_FlareOcclusionRemapTex;
    ...
    if(u_xlatb0){
        ...
        for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu5 ; u_xlatu_loop_1++)
        {
            ...
            if(u_xlatb12.x){
                ...
                u_xlatb1.x = u_xlatb1.x || u_xlatb6;
        ...
        u_xlat2.y = 0.0;
        u_xlat0 = textureLod(sampler2D(_FlareOcclusionRemapTex, sampler_FlareOcclusionRemapTex), u_xlat2.xy, 0.0).x;
        u_xlat0 = u_xlat0;
