...
fn main_1() {
  ...
  let x_545 : vec2<f32> = (vec2<f32>(x_541.x, x_541.w) * vec2<f32>(0.08163200318813323975f, 0.08163200318813323975f));
  ...
  u_xlat5.z = (x_584 * 0.08163200318813323975f);
  let x_589 : f32 = u_xlat1.w;
  u_xlat6.z = (x_589 * 0.08163200318813323975f);
  let x_592 : vec4<f32> = u_xlat0;
  let x_599 : vec2<f32> = ((vec2<f32>(x_592.x, x_592.x) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.16326400637626647949f, 0.08163200318813323975f));
  ...
  let x_615 : vec2<f32> = (vec2<f32>(x_611.y, x_611.w) * vec2<f32>(0.04081600159406661987f, 0.04081600159406661987f));
  let x_616 : vec4<f32> = u_xlat4;
  u_xlat4 = vec4<f32>(x_615.x, x_615.y, x_616.z, x_616.w);
  let x_618 : vec4<f32> = u_xlat1;
  let x_620 : vec2<f32> = (vec2<f32>(x_618.w, x_618.x) * vec2<f32>(0.08163200318813323975f, 0.08163200318813323975f));
  ...
  let x_630 : vec2<f32> = ((vec2<f32>(x_626.x, x_626.x) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.08163200318813323975f, 0.16326400637626647949f));
  ...
  let x_660 : vec2<f32> = ((vec2<f32>(x_657.y, x_657.y) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.16326400637626647949f, 0.08163200318813323975f));
  let x_661 : vec4<f32> = u_xlat6;
  u_xlat6 = vec4<f32>(x_661.x, x_660.x, x_661.z, x_660.y);
  let x_663 : vec4<f32> = u_xlat0;
  let x_666 : vec2<f32> = ((vec2<f32>(x_663.y, x_663.y) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.08163200318813323975f, 0.16326400637626647949f));
