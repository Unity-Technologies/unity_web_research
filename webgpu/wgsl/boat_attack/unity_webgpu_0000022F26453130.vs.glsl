...
layout(location = 5) out highp vec2 vs_TEXCOORD7;
void main()
{
vec4 u_xlat0;
vec4 u_xlat1;
...
float u_xlat13;
    ...
    vs_TEXCOORD2.w = (u_xlatb12) ? u_xlat2.x : unity_MatrixV[0].z;
    ...
    vs_TEXCOORD3.w = (u_xlatb12) ? u_xlat2.y : unity_MatrixV[1].z;
    vs_TEXCOORD4.w = (u_xlatb12) ? u_xlat2.z : unity_MatrixV[2].z;
