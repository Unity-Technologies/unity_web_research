...
fn main_1() {
  ...
  u_xlat1.x = dot(vec3<f32>(x_1497.x, x_1497.y, x_1497.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  ...
  let x_1540 : vec3<f32> = (vec3<f32>(x_1538.x, x_1538.y, x_1538.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1541 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1540.x, x_1540.y, x_1540.z, x_1541.w);
  let x_1543 : vec4<f32> = u_xlat0;
  let x_1546 : vec3<f32> = log2(abs(vec3<f32>(x_1543.x, x_1543.y, x_1543.z)));
  let x_1547 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1546.x, x_1546.y, x_1546.z, x_1547.w);
  let x_1549 : vec4<f32> = u_xlat2;
  let x_1551 : vec3<f32> = (vec3<f32>(x_1549.x, x_1549.y, x_1549.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1552 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1551.x, x_1551.y, x_1551.z, x_1552.w);
  let x_1554 : vec4<f32> = u_xlat2;
  let x_1556 : vec3<f32> = exp2(vec3<f32>(x_1554.x, x_1554.y, x_1554.z));
  let x_1557 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1556.x, x_1556.y, x_1556.z, x_1557.w);
  let x_1559 : vec4<f32> = u_xlat2;
  let x_1562 : vec3<f32> = ((vec3<f32>(x_1559.x, x_1559.y, x_1559.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1563 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1562.x, x_1562.y, x_1562.z, x_1563.w);
  let x_1565 : vec4<f32> = u_xlat0;
  let x_1567 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1565.x, x_1565.y, x_1565.z, x_1565.x));
  u_xlatb0 = vec3<bool>(x_1567.x, x_1567.y, x_1567.z);
  let x_1570 : bool = u_xlatb0.x;
  if (x_1570) {
  ...
  u_xlat0.x = x_1579;
  let x_1582 : bool = u_xlatb0.y;
  if (x_1582) {
    let x_1587 : f32 = u_xlat1.y;
    x_1583 = x_1587;
  } else {
    let x_1590 : f32 = u_xlat2.y;
    x_1583 = x_1590;
  }
  let x_1591 : f32 = x_1583;
  u_xlat0.y = x_1591;
  let x_1594 : bool = u_xlatb0.z;
  if (x_1594) {
    let x_1599 : f32 = u_xlat1.z;
    x_1595 = x_1599;
  } else {
  ...
  u_xlat0.z = x_1603;
  let x_1605 : vec2<f32> = vs_TEXCOORD0;
  let x_1608 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1612 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1614 : vec2<f32> = ((x_1605 * vec2<f32>(x_1608.x, x_1608.y)) + vec2<f32>(x_1612.z, x_1612.w));
  let x_1615 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1614.x, x_1614.y, x_1615.z, x_1615.w);
  let x_1622 : vec4<f32> = u_xlat1;
  let x_1625 : f32 = x_38.x_GlobalMipBias.x;
  let x_1626 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1622.x, x_1622.y), x_1625);
  u_xlat15 = x_1626.w;
  let x_1628 : f32 = u_xlat15;
  u_xlat15 = ((x_1628 * 2.0f) + -1.0f);
  let x_1631 : f32 = u_xlat15;
  u_xlatb1 = (x_1631 >= 0.0f);
  let x_1633 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1633);
  let x_1636 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1636)) + 1.0f);
  let x_1640 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1640);
  let x_1642 : f32 = u_xlat15;
  u_xlat15 = (-(x_1642) + 1.0f);
  let x_1645 : f32 = u_xlat15;
  let x_1647 : f32 = u_xlat1.x;
  u_xlat15 = (x_1645 * x_1647);
  let x_1649 : vec4<f32> = u_xlat0;
  let x_1651 : vec3<f32> = (vec3<f32>(x_1649.x, x_1649.y, x_1649.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1652 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1651.x, x_1651.y, x_1651.z, x_1652.w);
  let x_1654 : vec4<f32> = u_xlat0;
  let x_1657 : vec3<f32> = log2(abs(vec3<f32>(x_1654.x, x_1654.y, x_1654.z)));
  let x_1658 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1657.x, x_1657.y, x_1657.z, x_1658.w);
  let x_1660 : vec4<f32> = u_xlat2;
  let x_1662 : vec3<f32> = (vec3<f32>(x_1660.x, x_1660.y, x_1660.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1663 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1662.x, x_1662.y, x_1662.z, x_1663.w);
  let x_1665 : vec4<f32> = u_xlat2;
  let x_1667 : vec3<f32> = exp2(vec3<f32>(x_1665.x, x_1665.y, x_1665.z));
  let x_1668 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1667.x, x_1667.y, x_1667.z, x_1668.w);
  let x_1670 : vec4<f32> = u_xlat2;
  let x_1673 : vec3<f32> = ((vec3<f32>(x_1670.x, x_1670.y, x_1670.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1674 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1673.x, x_1673.y, x_1673.z, x_1674.w);
  let x_1676 : vec4<f32> = u_xlat0;
  let x_1678 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1676.x, x_1676.y, x_1676.z, x_1676.x));
  u_xlatb0 = vec3<bool>(x_1678.x, x_1678.y, x_1678.z);
  let x_1681 : bool = u_xlatb0.x;
  if (x_1681) {
  ...
  u_xlat0.x = x_1690;
  let x_1693 : bool = u_xlatb0.y;
  if (x_1693) {
    let x_1698 : f32 = u_xlat1.y;
    x_1694 = x_1698;
  } else {
    let x_1701 : f32 = u_xlat2.y;
    x_1694 = x_1701;
  }
  let x_1702 : f32 = x_1694;
  u_xlat0.y = x_1702;
  let x_1705 : bool = u_xlatb0.z;
  if (x_1705) {
    let x_1710 : f32 = u_xlat1.z;
    x_1706 = x_1710;
  } else {
  ...
  u_xlat0.z = x_1714;
  let x_1716 : f32 = u_xlat15;
  let x_1721 : vec4<f32> = u_xlat0;
  let x_1723 : vec3<f32> = ((vec3<f32>(x_1716, x_1716, x_1716) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1721.x, x_1721.y, x_1721.z));
  let x_1724 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1723.x, x_1723.y, x_1723.z, x_1724.w);
  let x_1726 : vec4<f32> = u_xlat0;
  let x_1728 : vec3<f32> = (vec3<f32>(x_1726.x, x_1726.y, x_1726.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1729 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1728.x, x_1728.y, x_1728.z, x_1729.w);
  let x_1731 : vec4<f32> = u_xlat0;
  let x_1733 : vec3<f32> = (vec3<f32>(x_1731.x, x_1731.y, x_1731.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1734 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1733.x, x_1733.y, x_1733.z, x_1734.w);
  let x_1736 : vec4<f32> = u_xlat2;
  let x_1738 : vec3<f32> = (vec3<f32>(x_1736.x, x_1736.y, x_1736.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1739 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1738.x, x_1738.y, x_1738.z, x_1739.w);
  let x_1741 : vec4<f32> = u_xlat2;
  let x_1744 : vec3<f32> = log2(abs(vec3<f32>(x_1741.x, x_1741.y, x_1741.z)));
  let x_1745 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1744.x, x_1744.y, x_1744.z, x_1745.w);
  let x_1747 : vec4<f32> = u_xlat2;
  let x_1749 : vec3<f32> = (vec3<f32>(x_1747.x, x_1747.y, x_1747.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1750 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1749.x, x_1749.y, x_1749.z, x_1750.w);
  let x_1752 : vec4<f32> = u_xlat2;
  let x_1754 : vec3<f32> = exp2(vec3<f32>(x_1752.x, x_1752.y, x_1752.z));
  let x_1755 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1754.x, x_1754.y, x_1754.z, x_1755.w);
  let x_1757 : vec4<f32> = u_xlat0;
  let x_1759 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1757.x, x_1757.y, x_1757.z, x_1757.x));
  u_xlatb0 = vec3<bool>(x_1759.x, x_1759.y, x_1759.z);
  let x_1762 : bool = u_xlatb0.x;
  if (x_1762) {
  ...
  u_xlat0.x = x_1771;
  let x_1774 : bool = u_xlatb0.y;
  if (x_1774) {
    let x_1779 : f32 = u_xlat1.y;
    x_1775 = x_1779;
  } else {
    let x_1782 : f32 = u_xlat2.y;
    x_1775 = x_1782;
  }
  let x_1783 : f32 = x_1775;
  u_xlat0.y = x_1783;
  let x_1786 : bool = u_xlatb0.z;
  if (x_1786) {
    let x_1791 : f32 = u_xlat1.z;
    x_1787 = x_1791;
  } else {
    let x_1794 : f32 = u_xlat2.z;
    x_1787 = x_1794;
  }
  let x_1795 : f32 = x_1787;
  u_xlat0.z = x_1795;
  let x_1799 : vec4<f32> = u_xlat0;
  let x_1801 : vec3<f32> = max(vec3<f32>(x_1799.x, x_1799.y, x_1799.z), vec3<f32>(0.0f, 0.0f, 0.0f));
