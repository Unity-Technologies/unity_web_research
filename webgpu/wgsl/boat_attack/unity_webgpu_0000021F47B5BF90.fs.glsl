...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    if(u_xlatb23){
        ...
        if(u_xlatb23){
            ...
            u_xlatb42.x = _MainLightShadowParams.y==2.0;
            if(u_xlatb42.x){
                ...
                u_xlat24 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
                u_xlat5.x = u_xlat5.z * u_xlat24 + u_xlat5.x;
    ...
    u_xlatb42.x = 0.0>=vs_TEXCOORD6.z;
    u_xlatb61 = vs_TEXCOORD6.z>=1.0;
    u_xlatb42.x = u_xlatb61 || u_xlatb42.x;
    u_xlat23.x = (u_xlatb42.x) ? 1.0 : u_xlat23.x;
    ...
    if(u_xlatb42.x){
        u_xlat42.xy = vs_TEXCOORD1.yy * _MainLightWorldToLight[1].xy;
        u_xlat42.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD1.xx + u_xlat42.xy;
        u_xlat42.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD1.zz + u_xlat42.xy;
        u_xlat42.xy = u_xlat42.xy + _MainLightWorldToLight[3].xy;
        u_xlat42.xy = u_xlat42.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat5 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat42.xy, _GlobalMipBias.x);
        ...
        u_xlat61 = (u_xlatb42.y) ? u_xlat5.w : u_xlat5.x;
        u_xlat5.xyz = (u_xlatb42.x) ? u_xlat5.xyz : vec3(u_xlat61);
    } else {
        u_xlat5.x = float(1.0);
        u_xlat5.y = float(1.0);
        u_xlat5.z = float(1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu5 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat63 = dot(unity_LightIndices[int(u_xlatu63)], uintBitsToFloat(ImmCB_0[u_xlati7]));
        u_xlatu63 =  uint(int(u_xlat63));
        u_xlat7.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu63)].www + _AdditionalLightsPosition[int(u_xlatu63)].xyz;
        ...
        u_xlat8.x = float(1.0) / float(u_xlat64);
        u_xlat64 = u_xlat64 * _AdditionalLightsAttenuation[int(u_xlatu63)].x;
        u_xlat64 = (-u_xlat64) * u_xlat64 + 1.0;
        u_xlat64 = max(u_xlat64, 0.0);
        u_xlat64 = u_xlat64 * u_xlat64;
        u_xlat64 = u_xlat64 * u_xlat8.x;
        u_xlat8.x = dot(_AdditionalLightsSpotDir[int(u_xlatu63)].xyz, u_xlat7.xyz);
        u_xlat8.x = u_xlat8.x * _AdditionalLightsAttenuation[int(u_xlatu63)].z + _AdditionalLightsAttenuation[int(u_xlatu63)].w;
        u_xlat8.x = clamp(u_xlat8.x, 0.0, 1.0);
        u_xlat8.x = u_xlat8.x * u_xlat8.x;
        u_xlat64 = u_xlat64 * u_xlat8.x;
        u_xlatu8 = u_xlatu63 >> (5u & uint(0x1F));
        u_xlati27 = 1 << (int(u_xlatu63) & int(0x1F));
        u_xlati8 = int(uint(u_xlati27) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu8)]));
        if(u_xlati8 != 0) {
            u_xlati8 = int(_AdditionalLightsLightTypes[int(u_xlatu63)]);
            u_xlati27 = (u_xlati8 != 0) ? 0 : 1;
            u_xlati46 = int(u_xlatu63) << (2 & int(0x1F));
            if(u_xlati27 != 0) {
                u_xlat9.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati46 + 1) / 4][(u_xlati46 + 1) % 4].xyw;
                u_xlat9.xyz = _AdditionalLightsWorldToLights[u_xlati46 / 4][u_xlati46 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat9.xyz;
                u_xlat9.xyz = _AdditionalLightsWorldToLights[(u_xlati46 + 2) / 4][(u_xlati46 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat9.xyz;
                u_xlat9.xyz = u_xlat9.xyz + _AdditionalLightsWorldToLights[(u_xlati46 + 3) / 4][(u_xlati46 + 3) % 4].xyw;
                u_xlat27.xz = u_xlat9.xy / u_xlat9.zz;
                u_xlat27.xz = u_xlat27.xz * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat27.xz = clamp(u_xlat27.xz, 0.0, 1.0);
                u_xlat27.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu63)].xy * u_xlat27.xz + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu63)].zw;
            } else {
                u_xlatb8 = u_xlati8==1;
                u_xlati8 = u_xlatb8 ? 1 : int(0);
                if(u_xlati8 != 0) {
                    u_xlat9.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati46 + 1) / 4][(u_xlati46 + 1) % 4].xy;
                    u_xlat9.xy = _AdditionalLightsWorldToLights[u_xlati46 / 4][u_xlati46 % 4].xy * vs_TEXCOORD1.xx + u_xlat9.xy;
                    u_xlat9.xy = _AdditionalLightsWorldToLights[(u_xlati46 + 2) / 4][(u_xlati46 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat9.xy;
                    u_xlat9.xy = u_xlat9.xy + _AdditionalLightsWorldToLights[(u_xlati46 + 3) / 4][(u_xlati46 + 3) % 4].xy;
                    u_xlat9.xy = u_xlat9.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat9.xy = fract(u_xlat9.xy);
                    u_xlat27.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu63)].xy * u_xlat9.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu63)].zw;
                } else {
                    u_xlat9 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati46 + 1) / 4][(u_xlati46 + 1) % 4];
                    u_xlat9 = _AdditionalLightsWorldToLights[u_xlati46 / 4][u_xlati46 % 4] * vs_TEXCOORD1.xxxx + u_xlat9;
                    u_xlat9 = _AdditionalLightsWorldToLights[(u_xlati46 + 2) / 4][(u_xlati46 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat9;
                    u_xlat9 = u_xlat9 + _AdditionalLightsWorldToLights[(u_xlati46 + 3) / 4][(u_xlati46 + 3) % 4];
                    ...
                    u_xlatb47.xy = greaterThanEqual(u_xlat10.yzyz, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    u_xlat47.x = (u_xlatb47.x) ? u_xlat10.x : (-u_xlat10.x);
                    u_xlat47.y = (u_xlatb47.y) ? u_xlat10.x : (-u_xlat10.x);
                    ...
                    u_xlat27.xz = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu63)].xy * u_xlat8.xz + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu63)].zw;
                }
            }
            u_xlat8 = texture(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_AdditionalLightsCookieAtlasTexture), u_xlat27.xz, _GlobalMipBias.x);
            u_xlat65 = (u_xlatb24.y) ? u_xlat8.w : u_xlat8.x;
            u_xlat8.xyz = (u_xlatb24.x) ? u_xlat8.xyz : vec3(u_xlat65);
        } else {
            u_xlat8.x = float(1.0);
            u_xlat8.y = float(1.0);
            u_xlat8.z = float(1.0);
        }
        u_xlat8.xyz = u_xlat8.xyz * _AdditionalLightsColor[int(u_xlatu63)].xyz;
        u_xlat8.xyz = u_xlat4.xxx * u_xlat8.xyz;
        u_xlat8.xyz = vec3(u_xlat64) * u_xlat8.xyz;
        u_xlat63 = dot(u_xlat2.xyz, u_xlat7.xyz);
        u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
        u_xlat9.xyz = vec3(u_xlat63) * u_xlat8.xyz;
        ...
        u_xlat7.xyz = vec3(u_xlat63) * _SpecColor.xyz;
