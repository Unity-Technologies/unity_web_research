...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat29.xyz = (bool(u_xlatb29)) ? u_xlat4.xyz : u_xlat5.xyz;
    ...
    u_xlat4.xyz = u_xlat53.yyy * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat53.xxx * vs_TEXCOORD3.xyz + u_xlat4.xyz;
    u_xlat4.xyz = vec3(u_xlat78) * vs_TEXCOORD2.xyz + u_xlat4.xyz;
    u_xlat78 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat78 = inversesqrt(u_xlat78);
    u_xlat4.xyz = vec3(u_xlat78) * u_xlat4.xyz;
    ...
    u_xlat53.x = dot(u_xlat4.xyz, u_xlat5.xyz);
    u_xlat53.x = u_xlat53.x + 0.5;
    u_xlat5.xyz = u_xlat53.xxx * u_xlat6.xyz;
    u_xlat53.x = max(u_xlat5.w, 9.99999975e-05);
    u_xlat5.xyz = u_xlat5.xyz / u_xlat53.xxx;
    u_xlat53.x = (-u_xlat1.x) * 0.959999979 + 0.959999979;
    u_xlat79 = u_xlat1.y * _Smoothness + (-u_xlat53.x);
    u_xlat28.xyz = u_xlat53.xxx * u_xlat2.yzw;
    ...
    u_xlat53.x = u_xlat27.x * u_xlat27.x;
    u_xlat79 = u_xlat79 + 1.0;
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    u_xlat82 = u_xlat27.x * 4.0 + 2.0;
    ...
    u_xlat7.x = dot((-u_xlat29.xyz), u_xlat4.xyz);
    u_xlat7.x = u_xlat7.x + u_xlat7.x;
    u_xlat7.xyz = u_xlat4.xyz * (-u_xlat7.xxx) + (-u_xlat29.xyz);
    u_xlat85 = dot(u_xlat4.xyz, u_xlat29.xyz);
    ...
    u_xlat1.xy = u_xlat27.xx * u_xlat27.xx + vec2(-1.0, 1.0);
    u_xlat27.x = float(1.0) / u_xlat1.y;
    u_xlat8.xyz = (-u_xlat0.xyz) + vec3(u_xlat79);
    u_xlat8.xyz = vec3(u_xlat85) * u_xlat8.xyz + u_xlat0.xyz;
    u_xlat8.xyz = u_xlat27.xxx * u_xlat8.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat5.xyz = u_xlat5.xyz * u_xlat28.xyz + u_xlat7.xyz;
    u_xlat27.x = u_xlat83 * unity_LightData.z;
    u_xlat79 = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    u_xlat27.x = u_xlat79 * u_xlat27.x;
    u_xlat32.xyz = u_xlat27.xxx * u_xlat32.xyz;
    u_xlat7.xyz = u_xlat29.xyz + _MainLightPosition.xyz;
    ...
    u_xlat27.x = dot(u_xlat4.xyz, u_xlat7.xyz);
    u_xlat27.x = clamp(u_xlat27.x, 0.0, 1.0);
    u_xlat27.z = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat27.z = clamp(u_xlat27.z, 0.0, 1.0);
    u_xlat27.xz = u_xlat27.xz * u_xlat27.xz;
    u_xlat27.x = u_xlat27.x * u_xlat1.x + 1.00001001;
    u_xlat27.x = u_xlat27.x * u_xlat27.x;
    u_xlat79 = max(u_xlat27.z, 0.100000001);
    u_xlat27.x = u_xlat79 * u_xlat27.x;
    u_xlat27.x = u_xlat82 * u_xlat27.x;
    u_xlat27.x = u_xlat53.x / u_xlat27.x;
    u_xlat7.xyz = u_xlat0.xyz * u_xlat27.xxx + u_xlat28.xyz;
    u_xlat32.xyz = u_xlat32.xyz * u_xlat7.xyz;
    u_xlat27.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu27 =  uint(int(u_xlat27.x));
    u_xlat79 = u_xlat6.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu27 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlatb87){
            ...
            u_xlat11 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToShadow[(u_xlati86 + 1) / 4][(u_xlati86 + 1) % 4];
            u_xlat11 = _AdditionalLightsWorldToShadow[u_xlati86 / 4][u_xlati86 % 4] * vs_TEXCOORD1.xxxx + u_xlat11;
            u_xlat11 = _AdditionalLightsWorldToShadow[(u_xlati86 + 2) / 4][(u_xlati86 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat11;
        ...
        if(u_xlati87 != 0) {
            ...
            if(u_xlati88 != 0) {
                u_xlat37.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati11 + 1) / 4][(u_xlati11 + 1) % 4].xyw;
                u_xlat37.xyz = _AdditionalLightsWorldToLights[u_xlati11 / 4][u_xlati11 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat37.xyz;
                u_xlat37.xyz = _AdditionalLightsWorldToLights[(u_xlati11 + 2) / 4][(u_xlati11 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat37.xyz;
        ...
        u_xlat59 = dot(u_xlat4.xyz, u_xlat10.xyz);
        u_xlat59 = clamp(u_xlat59, 0.0, 1.0);
        u_xlat6.x = u_xlat6.x * u_xlat59;
        u_xlat11.xyz = u_xlat6.xxx * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat85) + u_xlat29.xyz;
        ...
        u_xlat6.x = u_xlat53.x / u_xlat6.x;
        u_xlat9.xyz = u_xlat0.xyz * u_xlat6.xxx + u_xlat28.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * u_xlat3.xxx + u_xlat32.xyz;
