...
;
    ...
    u_xlat38 = dot(u_xlat13.xyz, u_xlat4.xyz);
    ...
    u_xlat41 = (-u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat26 * u_xlat41 + u_xlat2.x;
    u_xlat26 = dot((-u_xlat3.xyz), u_xlat13.xyz);
    u_xlat26 = u_xlat26 + u_xlat26;
    u_xlat6.xyz = u_xlat13.xyz * (-vec3(u_xlat26)) + (-u_xlat3.xyz);
    u_xlat26 = dot(u_xlat13.xyz, u_xlat3.xyz);
    u_xlat26 = clamp(u_xlat26, 0.0, 1.0);
