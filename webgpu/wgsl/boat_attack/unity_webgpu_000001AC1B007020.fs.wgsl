...
@group(1) @binding(1) var<uniform> x_1505 : AdditionalLights;
...
fn main_1() {
  ...
  loop {
    ...
    let x_1473 : u32 = u_xlatu38;
    let x_1476 : vec4<f32> = x_1095.unity_LightIndices[bitcast<i32>(x_1473)];
    let x_1485 : i32 = u_xlati39;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1490 : vec4<u32> = indexable[x_1485];
    u_xlat38 = dot(x_1476, bitcast<vec4<f32>>(x_1490));
    let x_1493 : f32 = u_xlat38;
    u_xlati38 = i32(x_1493);
    let x_1495 : vec3<f32> = vs_TEXCOORD1;
    let x_1506 : i32 = u_xlati38;
    let x_1508 : vec4<f32> = x_1505.x_AdditionalLightsPosition[x_1506];
    let x_1511 : i32 = u_xlati38;
    let x_1513 : vec4<f32> = x_1505.x_AdditionalLightsPosition[x_1511];
    let x_1515 : vec3<f32> = ((-(x_1495) * vec3<f32>(x_1508.w, x_1508.w, x_1508.w)) + vec3<f32>(x_1513.x, x_1513.y, x_1513.z));
    ...
    u_xlat39 = dot(vec3<f32>(x_1519.x, x_1519.y, x_1519.z), vec3<f32>(x_1521.x, x_1521.y, x_1521.z));
    let x_1524 : f32 = u_xlat39;
    u_xlat39 = max(x_1524, 0.00006103515625f);
    let x_1527 : f32 = u_xlat39;
    u_xlat40 = inverseSqrt(x_1527);
    let x_1529 : f32 = u_xlat40;
    let x_1531 : vec4<f32> = u_xlat8;
    u_xlat9 = (vec3<f32>(x_1529, x_1529, x_1529) * vec3<f32>(x_1531.x, x_1531.y, x_1531.z));
    let x_1535 : f32 = u_xlat39;
    u_xlat41 = (1.0f / x_1535);
    let x_1537 : f32 = u_xlat39;
    let x_1538 : i32 = u_xlati38;
    let x_1540 : f32 = x_1505.x_AdditionalLightsAttenuation[x_1538].x;
    u_xlat39 = (x_1537 * x_1540);
    let x_1542 : f32 = u_xlat39;
    let x_1544 : f32 = u_xlat39;
    u_xlat39 = ((-(x_1542) * x_1544) + 1.0f);
    let x_1547 : f32 = u_xlat39;
    u_xlat39 = max(x_1547, 0.0f);
    let x_1549 : f32 = u_xlat39;
    let x_1550 : f32 = u_xlat39;
    u_xlat39 = (x_1549 * x_1550);
    let x_1552 : f32 = u_xlat39;
    let x_1553 : f32 = u_xlat41;
    u_xlat39 = (x_1552 * x_1553);
    let x_1555 : i32 = u_xlati38;
    let x_1557 : vec4<f32> = x_1505.x_AdditionalLightsSpotDir[x_1555];
    let x_1559 : vec3<f32> = u_xlat9;
    u_xlat41 = dot(vec3<f32>(x_1557.x, x_1557.y, x_1557.z), x_1559);
    let x_1561 : f32 = u_xlat41;
    let x_1562 : i32 = u_xlati38;
    let x_1564 : f32 = x_1505.x_AdditionalLightsAttenuation[x_1562].z;
    let x_1566 : i32 = u_xlati38;
    let x_1568 : f32 = x_1505.x_AdditionalLightsAttenuation[x_1566].w;
    u_xlat41 = ((x_1561 * x_1564) + x_1568);
    let x_1570 : f32 = u_xlat41;
    u_xlat41 = clamp(x_1570, 0.0f, 1.0f);
    let x_1572 : f32 = u_xlat41;
    let x_1573 : f32 = u_xlat41;
    u_xlat41 = (x_1572 * x_1573);
    let x_1575 : f32 = u_xlat39;
    let x_1576 : f32 = u_xlat41;
    u_xlat39 = (x_1575 * x_1576);
    let x_1578 : vec4<f32> = u_xlat2;
    let x_1580 : vec3<f32> = u_xlat9;
    u_xlat41 = dot(vec3<f32>(x_1578.x, x_1578.y, x_1578.z), x_1580);
    let x_1582 : f32 = u_xlat41;
    u_xlat41 = clamp(x_1582, 0.0f, 1.0f);
    let x_1584 : f32 = u_xlat39;
    let x_1585 : f32 = u_xlat41;
    u_xlat41 = (x_1584 * x_1585);
    let x_1587 : f32 = u_xlat41;
    let x_1589 : i32 = u_xlati38;
    let x_1591 : vec4<f32> = x_1505.x_AdditionalLightsColor[x_1589];
    u_xlat10 = (vec3<f32>(x_1587, x_1587, x_1587) * vec3<f32>(x_1591.x, x_1591.y, x_1591.z));
    let x_1594 : vec4<f32> = u_xlat8;
    let x_1596 : f32 = u_xlat40;
    let x_1599 : vec3<f32> = vs_TEXCOORD2;
    let x_1600 : vec3<f32> = ((vec3<f32>(x_1594.x, x_1594.y, x_1594.z) * vec3<f32>(x_1596, x_1596, x_1596)) + x_1599);
    ...
    u_xlat40 = dot(vec3<f32>(x_1603.x, x_1603.y, x_1603.z), vec3<f32>(x_1605.x, x_1605.y, x_1605.z));
    let x_1608 : f32 = u_xlat40;
    u_xlat40 = max(x_1608, 1.17549435e-38f);
    let x_1610 : f32 = u_xlat40;
    u_xlat40 = inverseSqrt(x_1610);
    let x_1612 : f32 = u_xlat40;
    ...
    u_xlat40 = dot(vec3<f32>(x_1619.x, x_1619.y, x_1619.z), vec3<f32>(x_1621.x, x_1621.y, x_1621.z));
    let x_1624 : f32 = u_xlat40;
    u_xlat40 = clamp(x_1624, 0.0f, 1.0f);
    let x_1626 : vec3<f32> = u_xlat9;
    let x_1627 : vec4<f32> = u_xlat8;
    u_xlat8.x = dot(x_1626, vec3<f32>(x_1627.x, x_1627.y, x_1627.z));
    let x_1632 : f32 = u_xlat8.x;
    u_xlat8.x = clamp(x_1632, 0.0f, 1.0f);
    let x_1635 : f32 = u_xlat40;
    let x_1636 : f32 = u_xlat40;
    u_xlat40 = (x_1635 * x_1636);
    let x_1638 : f32 = u_xlat40;
    u_xlat40 = ((x_1638 * -0.99993896484375f) + 1.00001001358032226562f);
    let x_1642 : f32 = u_xlat8.x;
    let x_1644 : f32 = u_xlat8.x;
    u_xlat8.x = (x_1642 * x_1644);
    let x_1647 : f32 = u_xlat40;
    let x_1648 : f32 = u_xlat40;
    u_xlat40 = (x_1647 * x_1648);
    let x_1651 : f32 = u_xlat8.x;
    u_xlat8.x = max(x_1651, 0.10000000149011611938f);
    let x_1654 : f32 = u_xlat40;
    let x_1656 : f32 = u_xlat8.x;
    u_xlat40 = (x_1654 * x_1656);
    let x_1658 : f32 = u_xlat40;
    u_xlat40 = (x_1658 * 2.03125f);
    let x_1660 : f32 = u_xlat40;
    u_xlat40 = (0.00006103515625f / x_1660);
    let x_1662 : f32 = u_xlat40;
    u_xlat40 = (x_1662 * 0.03999999910593032837f);
    let x_1664 : f32 = u_xlat40;
    let x_1666 : vec3<f32> = u_xlat10;
    let x_1668 : vec4<f32> = u_xlat7;
    let x_1670 : vec3<f32> = ((vec3<f32>(x_1664, x_1664, x_1664) * x_1666) + vec3<f32>(x_1668.x, x_1668.y, x_1668.z));
    let x_1671 : vec4<f32> = u_xlat7;
    u_xlat7 = vec4<f32>(x_1670.x, x_1670.y, x_1670.z, x_1671.w);
    let x_1673 : f32 = u_xlat39;
    let x_1675 : i32 = u_xlati38;
    let x_1677 : vec4<f32> = x_1505.x_AdditionalLightsColor[x_1675];
    let x_1680 : vec4<f32> = u_xlat5;
    let x_1682 : vec3<f32> = ((vec3<f32>(x_1673, x_1673, x_1673) * vec3<f32>(x_1677.x, x_1677.y, x_1677.z)) + vec3<f32>(x_1680.x, x_1680.y, x_1680.z));
    let x_1683 : vec4<f32> = u_xlat5;
    u_xlat5 = vec4<f32>(x_1682.x, x_1682.y, x_1682.z, x_1683.w);

    continuing {
      let x_1685 : u32 = u_xlatu_loop_2;
      u_xlatu_loop_2 = (x_1685 + bitcast<u32>(1i));
    }
  }
  let x_1687 : f32 = u_xlat34;
  let x_1688 : f32 = u_xlat22;
  u_xlat6.x = (x_1687 * x_1688);
  u_xlat6.y = 0.375f;
  u_xlat6.z = 0.0f;
  let x_1697 : vec4<f32> = u_xlat6;
  let x_1700 : f32 = x_39.x_GlobalMipBias.x;
  let x_1701 : vec4<f32> = textureSampleBias(x_AbsorptionScatteringRamp, sampler_AbsorptionScatteringRamp, vec2<f32>(x_1697.x, x_1697.y), x_1700);
  u_xlat14 = vec3<f32>(x_1701.x, x_1701.y, x_1701.z);
  let x_1703 : vec4<f32> = u_xlat2;
  let x_1709 : vec3<f32> = u_xlat0;
  let x_1711 : vec2<f32> = ((vec2<f32>(x_1703.z, x_1703.x) * vec2<f32>(0.01999999955296516418f, 0.15000000596046447754f)) + vec2<f32>(x_1709.x, x_1709.y));
  let x_1712 : vec3<f32> = u_xlat0;
  u_xlat0 = vec3<f32>(x_1711.x, x_1711.y, x_1712.z);
  let x_1718 : vec3<f32> = u_xlat0;
  let x_1720 : vec4<f32> = textureSampleLevel(x_PlanarReflectionTexture, sampler_ScreenTextures_linear_clamp, vec2<f32>(x_1718.x, x_1718.y), 0.0f);
  u_xlat0 = vec3<f32>(x_1720.x, x_1720.y, x_1720.z);
  let x_1727 : vec2<f32> = u_xlat12;
  let x_1729 : f32 = u_xlat4.y;
  let x_1730 : vec4<f32> = textureSampleLevel(x_CameraOpaqueTexture, sampler_CameraOpaqueTexture_linear_clamp, x_1727, x_1729);
  u_xlat1 = vec3<f32>(x_1730.x, x_1730.y, x_1730.z);
  let x_1735 : vec4<f32> = u_xlat6;
  let x_1738 : f32 = x_39.x_GlobalMipBias.x;
  let x_1739 : vec4<f32> = textureSampleBias(x_AbsorptionScatteringRamp, sampler_AbsorptionScatteringRamp, vec2<f32>(x_1735.x, x_1735.z), x_1738);
  let x_1740 : vec3<f32> = vec3<f32>(x_1739.x, x_1739.y, x_1739.z);
  ...
  let x_1746 : vec3<f32> = (x_1743 * vec3<f32>(x_1744.x, x_1744.y, x_1744.z));
  ...
  let x_1754 : vec3<f32> = u_xlat0;
  u_xlat0 = ((-(x_1749) * vec3<f32>(x_1751.x, x_1751.y, x_1751.z)) + x_1754);
  let x_1756 : f32 = u_xlat3;
  let x_1758 : vec3<f32> = u_xlat0;
  let x_1760 : vec4<f32> = u_xlat6;
  u_xlat0 = ((vec3<f32>(x_1756, x_1756, x_1756) * x_1758) + vec3<f32>(x_1760.x, x_1760.y, x_1760.z));
  let x_1763 : vec4<f32> = u_xlat5;
  let x_1765 : vec3<f32> = u_xlat14;
  let x_1767 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1763.x, x_1763.y, x_1763.z) * x_1765) + x_1767);
  let x_1769 : vec4<f32> = u_xlat7;
  let x_1771 : vec3<f32> = u_xlat0;
  u_xlat0 = (vec3<f32>(x_1769.x, x_1769.y, x_1769.z) + x_1771);
  let x_1773 : f32 = u_xlat33;
  let x_1775 : vec4<f32> = u_xlat4;
  let x_1778 : vec3<f32> = u_xlat0;
  u_xlat1 = ((vec3<f32>(x_1773, x_1773, x_1773) * vec3<f32>(x_1775.x, x_1775.z, x_1775.w)) + -(x_1778));
  let x_1783 : f32 = u_xlat33;
  let x_1785 : vec3<f32> = u_xlat1;
  let x_1787 : vec3<f32> = u_xlat0;
  let x_1788 : vec3<f32> = ((vec3<f32>(x_1783, x_1783, x_1783) * x_1785) + x_1787);
  let x_1789 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1788.x, x_1788.y, x_1788.z, x_1789.w);
  SV_Target0.w = 1.0f;
  return;
}
