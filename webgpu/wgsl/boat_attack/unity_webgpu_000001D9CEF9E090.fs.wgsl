...
fn main_1() {
  ...
  let x_1242 : vec2<f32> = vs_TEXCOORD0;
  let x_1245 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1249 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1251 : vec2<f32> = ((x_1242 * vec2<f32>(x_1245.x, x_1245.y)) + vec2<f32>(x_1249.z, x_1249.w));
  let x_1252 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1251.x, x_1251.y, x_1252.z);
  let x_1259 : vec3<f32> = u_xlat1;
  let x_1262 : f32 = x_25.x_GlobalMipBias.x;
  let x_1263 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1259.x, x_1259.y), x_1262);
  u_xlat21 = x_1263.w;
  let x_1265 : f32 = u_xlat21;
  u_xlat21 = (x_1265 + -0.5f);
  let x_1267 : f32 = u_xlat21;
  let x_1268 : f32 = u_xlat21;
  u_xlat21 = (x_1267 + x_1268);
  let x_1270 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1270.x, x_1270.y, x_1270.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1279 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1279);
  let x_1284 : f32 = x_25.x_Grain_Params.y;
  let x_1286 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1284 * -(x_1286)) + 1.0f);
  let x_1292 : f32 = u_xlat21;
  let x_1294 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_1292, x_1292, x_1292) * vec3<f32>(x_1294.x, x_1294.y, x_1294.z));
  let x_1297 : vec3<f32> = u_xlat8;
  let x_1300 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_1297 * vec3<f32>(x_1300.x, x_1300.x, x_1300.x));
  ...
  let x_1312 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1311.x, x_1311.y, x_1311.z, x_1312.w);
  SV_Target0.w = 1.0f;
  return;
}
