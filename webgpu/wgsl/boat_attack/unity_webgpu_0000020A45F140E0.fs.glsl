...
void main()
{
    ...
    u_xlat44 = u_xlat6.x * _MainLightShadowParams.x + u_xlat44;
    ...
    u_xlat49 = u_xlat49 * u_xlat49;
    u_xlat8.x = (-u_xlat4.x) * 0.699999988 + 1.70000005;
    u_xlat4.x = u_xlat4.x * u_xlat8.x;
    u_xlat4.x = u_xlat4.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat4.x);
    ...
    u_xlat7.xyz = u_xlat8.xyz * u_xlat4.xxx;
    ...
    u_xlat44 = u_xlat44 * u_xlat4.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu44 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat50 = u_xlat45 * u_xlat51 + u_xlat50;
        ...
        u_xlat35 = dot(u_xlat1.xzw, u_xlat10.xyz);
        ...
        u_xlat6.x = dot(u_xlat1.xzw, u_xlat9.xyz);
    ...
    u_xlat1.xzw = u_xlat3.xyz * vec3(u_xlat47) + u_xlat20.xyz;
