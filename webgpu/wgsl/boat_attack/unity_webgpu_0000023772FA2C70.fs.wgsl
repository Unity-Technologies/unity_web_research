...
fn main_1() {
  ...
  let x_60 : vec4<f32> = textureSampleBias(x_CameraDepthTexture, sampler_PointClamp, x_54, x_59);
  u_xlat1.x = x_60.x;
  ...
  u_xlat0.x = x_299;
  let x_302 : bool = u_xlatb9;
  let x_304 : bool = u_xlatb1.x;
  u_xlatb3 = (x_302 | x_304);
  let x_309 : f32 = x_91.x_MainLightShadowParams.x;
  u_xlat6 = (-(x_309) + 1.0f);
  let x_313 : f32 = u_xlat0.x;
  let x_315 : f32 = x_91.x_MainLightShadowParams.x;
  let x_317 : f32 = u_xlat6;
  u_xlat0.x = ((x_313 * x_315) + x_317);
  let x_322 : bool = u_xlatb3;
  if (x_322) {
    x_324 = vec4<f32>(1.0f, 1.0f, 1.0f, 1.0f);
  } else {
    let x_329 : vec4<f32> = u_xlat0;
    x_324 = vec4<f32>(x_329.x, x_329.x, x_329.x, x_329.x);
  }
  let x_331 : vec4<f32> = x_324;
  SV_Target0 = x_331;
  return;
}
