...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat8.xyz = u_xlat1.xyz * (-vec3(u_xlat45)) + (-u_xlat7.xyz);
    u_xlat45 = dot(u_xlat1.xyz, u_xlat7.xyz);
    u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat3.x = dot(unity_LightIndices[int(u_xlatu3)], uintBitsToFloat(ImmCB_0[u_xlati45]));
        ...
        u_xlat45 = u_xlat45 * u_xlat47;
        u_xlat11.xyz = vec3(u_xlat31) * _AdditionalLightsColor[u_xlati3].xyz;
        u_xlat3.x = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        u_xlat3.x = u_xlat3.x * u_xlat45;
        u_xlat11.xyz = u_xlat3.xxx * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat46) + u_xlat7.xyz;
