...
static const int _SMAA_PRESET_HIGH = 0 ;
...
float4 ( - 2.0 , 2.0 , - 2.0 , 2.0 ) * float ( 4 ) ,
...
#line 714
float2 threshold = float2 ( 0.15 , 0.15 ) ;
#line 718
...
float2 edges = step ( ( 0.1 * 0.15 ) , delta ) ;
