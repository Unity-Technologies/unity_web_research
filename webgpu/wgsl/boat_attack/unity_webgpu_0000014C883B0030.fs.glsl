...
;
    ...
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati43 + 1) / 4][(u_xlati43 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati43 / 4][u_xlati43 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati43 + 2) / 4][(u_xlati43 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati43 + 3) / 4][(u_xlati43 + 3) % 4].xyz;
    ...
    u_xlat9.xyz = vec3(u_xlat31) * u_xlat9.xyz + u_xlat5.xyz;
    ...
    u_xlat44 = u_xlat17 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat44 = clamp(u_xlat44, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlatb50){
            u_xlatb50 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati46].z);
            if(u_xlatb50){
            ...
            u_xlat50 = 1.0 + (-_AdditionalShadowParams[u_xlati46].x);
            u_xlat49 = u_xlat49 * _AdditionalShadowParams[u_xlati46].x + u_xlat50;
        ...
        u_xlati50 = 1 << (u_xlati46 & int(0x1F));
        ...
        if(u_xlati50 != 0) {
            ...
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat50);
        } else {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat48) + u_xlat2.xyz;
