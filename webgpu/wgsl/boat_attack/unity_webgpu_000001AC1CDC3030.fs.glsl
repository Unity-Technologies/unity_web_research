...
layout(set = 0, binding = 13) uniform mediump  sampler sampler_LinearClamp;
...
;
    ...
    u_xlat4.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati45 + 1) / 4][(u_xlati45 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati45 / 4][u_xlati45 % 4].xyz * vs_INTERP7.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati45 + 2) / 4][(u_xlati45 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat4.xyz;
    ...
    u_xlat45 = dot(u_xlat1.xyw, u_xlat6.xyz);
    u_xlat45 = u_xlat45 + 0.5;
    u_xlat6.xyz = vec3(u_xlat45) * u_xlat7.xyz;
    u_xlat45 = max(u_xlat6.w, 9.99999975e-05);
    ...
    u_xlatb34.x = u_xlat4.z>=1.0;
    u_xlatb19 = u_xlatb34.x || u_xlatb19;
    u_xlat4.x = (u_xlatb19) ? 1.0 : u_xlat4.x;
    u_xlat19.xyz = vs_INTERP7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat19.x = dot(u_xlat19.xyz, u_xlat19.xyz);
    u_xlat34.x = u_xlat19.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat34.x = clamp(u_xlat34.x, 0.0, 1.0);
    u_xlat49 = (-u_xlat4.x) + 1.0;
    u_xlat4.x = u_xlat34.x * u_xlat49 + u_xlat4.x;
    u_xlatb34.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb34.x){
        u_xlat34.xy = vs_INTERP7.yy * _MainLightWorldToLight[1].xy;
        u_xlat34.xy = _MainLightWorldToLight[0].xy * vs_INTERP7.xx + u_xlat34.xy;
        u_xlat34.xy = _MainLightWorldToLight[2].xy * vs_INTERP7.zz + u_xlat34.xy;
        u_xlat34.xy = u_xlat34.xy + _MainLightWorldToLight[3].xy;
        u_xlat34.xy = u_xlat34.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat8 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat34.xy, _GlobalMipBias.x);
        ...
        u_xlat49 = (u_xlatb34.y) ? u_xlat8.w : u_xlat8.x;
        u_xlat8.xyz = (u_xlatb34.x) ? u_xlat8.xyz : vec3(u_xlat49);
    } else {
        u_xlat8.x = float(1.0);
        u_xlat8.y = float(1.0);
        u_xlat8.z = float(1.0);
    ...
    u_xlat34.x = dot((-u_xlat5.xyz), u_xlat1.xyw);
    u_xlat34.x = u_xlat34.x + u_xlat34.x;
    u_xlat9.xyz = u_xlat1.xyw * (-u_xlat34.xxx) + (-u_xlat5.xyz);
    u_xlat34.x = dot(u_xlat1.xyw, u_xlat5.xyz);
    u_xlat34.x = clamp(u_xlat34.x, 0.0, 1.0);
    u_xlat34.x = (-u_xlat34.x) + 1.0;
    u_xlat34.x = u_xlat34.x * u_xlat34.x;
    u_xlat34.x = u_xlat34.x * u_xlat34.x;
    u_xlat49 = (-u_xlat45) * 0.699999988 + 1.70000005;
    ...
    u_xlat45 = float(1.0) / u_xlat10.y;
    u_xlat25.xyz = (-u_xlat0.xyz) + vec3(u_xlat47);
    u_xlat25.xyz = u_xlat34.xxx * u_xlat25.xyz + u_xlat0.xyz;
    u_xlat25.xyz = vec3(u_xlat45) * u_xlat25.xyz;
    u_xlat9.xyz = u_xlat9.xyz * u_xlat25.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat7.xyz + u_xlat9.xyz;
    u_xlat45 = u_xlat4.x * unity_LightData.z;
    u_xlat47 = dot(u_xlat1.xyw, _MainLightPosition.xyz);
    u_xlat47 = clamp(u_xlat47, 0.0, 1.0);
    u_xlat45 = u_xlat45 * u_xlat47;
    u_xlat4.xzw = vec3(u_xlat45) * u_xlat8.xyz;
    ...
    u_xlat45 = dot(u_xlat1.xyw, u_xlat8.xyz);
    u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
    u_xlat47 = dot(_MainLightPosition.xyz, u_xlat8.xyz);
    u_xlat47 = clamp(u_xlat47, 0.0, 1.0);
    u_xlat45 = u_xlat45 * u_xlat45;
    u_xlat45 = u_xlat45 * u_xlat10.x + 1.00001001;
    ...
    u_xlat47 = u_xlat19.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat47 = clamp(u_xlat47, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu45 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat19.x = dot(unity_LightIndices[int(u_xlatu19)], uintBitsToFloat(ImmCB_0[u_xlati50]));
        u_xlati19 = int(u_xlat19.x);
        u_xlat25.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati19].www + _AdditionalLightsPosition[u_xlati19].xyz;
        u_xlat50 = dot(u_xlat25.xyz, u_xlat25.xyz);
        u_xlat50 = max(u_xlat50, 6.10351562e-05);
        u_xlat51 = inversesqrt(u_xlat50);
        u_xlat11.xyz = vec3(u_xlat51) * u_xlat25.xyz;
        u_xlat52 = float(1.0) / float(u_xlat50);
        u_xlat50 = u_xlat50 * _AdditionalLightsAttenuation[u_xlati19].x;
        u_xlat50 = (-u_xlat50) * u_xlat50 + 1.0;
        u_xlat50 = max(u_xlat50, 0.0);
        u_xlat50 = u_xlat50 * u_xlat50;
        u_xlat50 = u_xlat50 * u_xlat52;
        u_xlat52 = dot(_AdditionalLightsSpotDir[u_xlati19].xyz, u_xlat11.xyz);
        u_xlat52 = u_xlat52 * _AdditionalLightsAttenuation[u_xlati19].z + _AdditionalLightsAttenuation[u_xlati19].w;
        u_xlat52 = clamp(u_xlat52, 0.0, 1.0);
        u_xlat52 = u_xlat52 * u_xlat52;
        u_xlat50 = u_xlat50 * u_xlat52;
        u_xlati52 = int(_AdditionalShadowParams[u_xlati19].w);
        u_xlatb38 = u_xlati52>=0;
        if(u_xlatb38){
            u_xlatb38 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati19].z);
            if(u_xlatb38){
                ...
                u_xlat53 = trunc(_AdditionalShadowParams[u_xlati19].w);
                u_xlat38.x = u_xlat38.x + u_xlat53;
                u_xlati52 = int(u_xlat38.x);
            }
            u_xlati52 = u_xlati52 << (2 & int(0x1F));
            u_xlat12 = vs_INTERP7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati52 + 1) / 4][(u_xlati52 + 1) % 4];
            u_xlat12 = _AdditionalLightsWorldToShadow[u_xlati52 / 4][u_xlati52 % 4] * vs_INTERP7.xxxx + u_xlat12;
            u_xlat12 = _AdditionalLightsWorldToShadow[(u_xlati52 + 2) / 4][(u_xlati52 + 2) % 4] * vs_INTERP7.zzzz + u_xlat12;
            ...
            u_xlat38.x = 1.0 + (-_AdditionalShadowParams[u_xlati19].x);
            u_xlat52 = u_xlat52 * _AdditionalShadowParams[u_xlati19].x + u_xlat38.x;
        ...
        u_xlat52 = u_xlat47 * u_xlat38.x + u_xlat52;
        u_xlati38 = 1 << (u_xlati19 & int(0x1F));
        u_xlati38 = int(uint(u_xlati38) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati38 != 0) {
            u_xlati38 = int(_AdditionalLightsLightTypes[u_xlati19]);
            u_xlati53 = (u_xlati38 != 0) ? 0 : 1;
            u_xlati54 = u_xlati19 << (2 & int(0x1F));
            if(u_xlati53 != 0) {
                u_xlat12.xyz = vs_INTERP7.yyy * _AdditionalLightsWorldToLights[(u_xlati54 + 1) / 4][(u_xlati54 + 1) % 4].xyw;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[u_xlati54 / 4][u_xlati54 % 4].xyw * vs_INTERP7.xxx + u_xlat12.xyz;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[(u_xlati54 + 2) / 4][(u_xlati54 + 2) % 4].xyw * vs_INTERP7.zzz + u_xlat12.xyz;
                u_xlat12.xyz = u_xlat12.xyz + _AdditionalLightsWorldToLights[(u_xlati54 + 3) / 4][(u_xlati54 + 3) % 4].xyw;
                u_xlat12.xy = u_xlat12.xy / u_xlat12.zz;
                u_xlat12.xy = u_xlat12.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat12.xy = clamp(u_xlat12.xy, 0.0, 1.0);
                u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati19].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati19].zw;
            } else {
                u_xlatb38 = u_xlati38==1;
                u_xlati38 = u_xlatb38 ? 1 : int(0);
                if(u_xlati38 != 0) {
                    u_xlat38.xy = vs_INTERP7.yy * _AdditionalLightsWorldToLights[(u_xlati54 + 1) / 4][(u_xlati54 + 1) % 4].xy;
                    u_xlat38.xy = _AdditionalLightsWorldToLights[u_xlati54 / 4][u_xlati54 % 4].xy * vs_INTERP7.xx + u_xlat38.xy;
                    u_xlat38.xy = _AdditionalLightsWorldToLights[(u_xlati54 + 2) / 4][(u_xlati54 + 2) % 4].xy * vs_INTERP7.zz + u_xlat38.xy;
                    ...
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati19].xy * u_xlat38.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati19].zw;
                } else {
                    u_xlat13 = vs_INTERP7.yyyy * _AdditionalLightsWorldToLights[(u_xlati54 + 1) / 4][(u_xlati54 + 1) % 4];
                    u_xlat13 = _AdditionalLightsWorldToLights[u_xlati54 / 4][u_xlati54 % 4] * vs_INTERP7.xxxx + u_xlat13;
                    u_xlat13 = _AdditionalLightsWorldToLights[(u_xlati54 + 2) / 4][(u_xlati54 + 2) % 4] * vs_INTERP7.zzzz + u_xlat13;
        ...
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[u_xlati19].xyz;
        u_xlat19.x = u_xlat50 * u_xlat52;
        u_xlat50 = dot(u_xlat1.xyw, u_xlat11.xyz);
        u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
        u_xlat19.x = u_xlat19.x * u_xlat50;
        u_xlat12.xyz = u_xlat19.xxx * u_xlat12.xyz;
        u_xlat25.xyz = u_xlat25.xyz * vec3(u_xlat51) + u_xlat5.xyz;
        u_xlat19.x = dot(u_xlat25.xyz, u_xlat25.xyz);
        u_xlat19.x = max(u_xlat19.x, 1.17549435e-38);
        u_xlat19.x = inversesqrt(u_xlat19.x);
        u_xlat25.xyz = u_xlat19.xxx * u_xlat25.xyz;
        u_xlat19.x = dot(u_xlat1.xyw, u_xlat25.xyz);
        u_xlat19.x = clamp(u_xlat19.x, 0.0, 1.0);
        u_xlat50 = dot(u_xlat11.xyz, u_xlat25.xyz);
        u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
        u_xlat19.x = u_xlat19.x * u_xlat19.x;
        u_xlat19.x = u_xlat19.x * u_xlat10.x + 1.00001001;
        u_xlat50 = u_xlat50 * u_xlat50;
        u_xlat19.x = u_xlat19.x * u_xlat19.x;
        ...
        u_xlat25.xyz = u_xlat0.xyz * u_xlat19.xxx + u_xlat7.xyz;
        u_xlat9.xyz = u_xlat25.xyz * u_xlat12.xyz + u_xlat9.xyz;
    }
    u_xlat0.xyz = u_xlat6.xyz * vec3(u_xlat33) + u_xlat4.xzw;
