...
void main()
{
    ...
    u_xlat6.xyz = vec3(u_xlat76) * _MainLightColor.xyz;
    ...
    u_xlat51.x = dot(u_xlat3.xyz, u_xlat6.xyz);
    u_xlat51.x = u_xlat51.x + 0.5;
    u_xlat30.xyz = u_xlat51.xxx * u_xlat30.xyz;
    u_xlat51.x = max(u_xlat6.w, 9.99999975e-05);
    ...
    u_xlat79 = u_xlat5.x + 0.0400000215;
    u_xlat79 = min(u_xlat79, 1.0);
    u_xlat5.x = u_xlat76 * 4.0 + 2.0;
    ...
    u_xlatb77 = 0.0>=vs_INTERP3.z;
    u_xlatb31 = vs_INTERP3.z>=1.0;
    u_xlatb77 = u_xlatb77 || u_xlatb31;
    u_xlat75 = (u_xlatb77) ? 1.0 : u_xlat75;
    u_xlat31.xyz = vs_INTERP8.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat77 = dot(u_xlat31.xyz, u_xlat31.xyz);
    u_xlat31.x = u_xlat77 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    ...
    u_xlat31.xyz = u_xlat3.xyz * (-u_xlat31.xxx) + (-u_xlat2.xyz);
    u_xlat7.x = dot(u_xlat3.xyz, u_xlat2.xyz);
    u_xlat7.x = clamp(u_xlat7.x, 0.0, 1.0);
    u_xlat7.x = (-u_xlat7.x) + 1.0;
    u_xlat7.x = u_xlat7.x * u_xlat7.x;
    u_xlat7.x = u_xlat7.x * u_xlat7.x;
    u_xlat32 = (-u_xlat51.x) * 0.699999988 + 1.70000005;
    u_xlat51.x = u_xlat51.x * u_xlat32;
    u_xlat51.x = u_xlat51.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat31.xyz, u_xlat51.x);
    ...
    u_xlat31.xyz = u_xlat8.xyz * u_xlat51.xxx;
    ...
    u_xlat30.xyz = u_xlat30.xyz * u_xlat4.xyz + u_xlat31.xyz;
    ...
    u_xlat75 = u_xlat75 * u_xlat76;
    u_xlat75 = u_xlat5.x * u_xlat75;
    u_xlat75 = u_xlat78 / u_xlat75;
    u_xlat7.xyz = vec3(u_xlat75) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
