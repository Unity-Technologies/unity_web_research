...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati64].www + _AdditionalLightsPosition[u_xlati64].xyz;
        ...
        u_xlat69 = dot(_AdditionalLightsSpotDir[u_xlati64].xyz, u_xlat10.xyz);
        u_xlat69 = u_xlat69 * _AdditionalLightsAttenuation[u_xlati64].z + _AdditionalLightsAttenuation[u_xlati64].w;
        u_xlat69 = clamp(u_xlat69, 0.0, 1.0);
        u_xlat69 = u_xlat69 * u_xlat69;
        u_xlat67 = u_xlat67 * u_xlat69;
        u_xlat11.xyz = vec3(u_xlat46) * _AdditionalLightsColor[u_xlati64].xyz;
        u_xlat64 = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
        u_xlat64 = u_xlat64 * u_xlat67;
        u_xlat11.xyz = vec3(u_xlat64) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat68) + u_xlat8.xyz;
