...
;
    ...
    u_xlat25.xyz = (u_xlatb23.x) ? u_xlat25.xyz : u_xlat7.xyz;
    ...
    u_xlat67 = u_xlat6.y * u_xlat6.y;
    u_xlat67 = u_xlat6.x * u_xlat6.x + (-u_xlat67);
    u_xlat27.xyz = unity_SHC.xyz * vec3(u_xlat67) + u_xlat9.xyz;
    ...
    u_xlat8.xyz = u_xlat6.xyz * (-vec3(u_xlat70)) + (-u_xlat25.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat71 = float(1.0) / float(u_xlat3.x);
        u_xlat3.x = u_xlat3.x * _AdditionalLightsAttenuation[int(u_xlatu68)].x;
        u_xlat3.x = (-u_xlat3.x) * u_xlat3.x + 1.0;
        u_xlat3.x = max(u_xlat3.x, 0.0);
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat3.x = u_xlat3.x * u_xlat71;
        u_xlat71 = dot(_AdditionalLightsSpotDir[int(u_xlatu68)].xyz, u_xlat11.xyz);
        ...
        if(u_xlati71 != 0) {
            ...
            if(u_xlati73 != 0) {
                ...
                if(u_xlati71 != 0) {
                    ...
                    u_xlat13.xyz = vec3(u_xlat71) * u_xlat13.xyz;
                    u_xlat71 = dot(abs(u_xlat13.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat71 = max(u_xlat71, 9.99999997e-07);
                    u_xlat71 = float(1.0) / float(u_xlat71);
                    u_xlat14.xyz = vec3(u_xlat71) * u_xlat13.zxy;
                    ...
                    u_xlat52.xy = u_xlat13.xy * vec2(u_xlat71) + u_xlat52.xy;
            ...
            u_xlat71 = (u_xlatb8.y) ? u_xlat12.w : u_xlat12.x;
            u_xlat12.xyz = (u_xlatb8.x) ? u_xlat12.xyz : vec3(u_xlat71);
        } else {
        ...
        u_xlat68 = dot(u_xlat6.xyz, u_xlat11.xyz);
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
        u_xlat68 = u_xlat68 * u_xlat3.x;
        u_xlat12.xyz = vec3(u_xlat68) * u_xlat12.xyz;
        u_xlat10.xyz = u_xlat10.xyz * vec3(u_xlat70) + u_xlat25.xyz;
