...
fn main_1() {
  ...
  let x_1293 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1297 : vec4<f32> = x_14.x_Dithering_Params;
  ...
  let x_1311 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1307.x, x_1307.y), x_1310);
  u_xlat15 = x_1311.w;
  let x_1313 : f32 = u_xlat15;
  u_xlat15 = ((x_1313 * 2.0f) + -1.0f);
  let x_1316 : f32 = u_xlat15;
  u_xlatb1 = (x_1316 >= 0.0f);
  let x_1318 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1318);
  let x_1321 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1321)) + 1.0f);
  let x_1325 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1325);
  let x_1327 : f32 = u_xlat15;
  u_xlat15 = (-(x_1327) + 1.0f);
  let x_1330 : f32 = u_xlat15;
  let x_1332 : f32 = u_xlat1.x;
  u_xlat15 = (x_1330 * x_1332);
  let x_1334 : vec3<f32> = u_xlat0;
  let x_1335 : vec3<f32> = (x_1334 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1336 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1335.x, x_1335.y, x_1335.z, x_1336.w);
  let x_1338 : vec3<f32> = u_xlat0;
  let x_1340 : vec3<f32> = log2(abs(x_1338));
  let x_1341 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1340.x, x_1340.y, x_1340.z, x_1341.w);
  let x_1343 : vec4<f32> = u_xlat2;
  let x_1345 : vec3<f32> = (vec3<f32>(x_1343.x, x_1343.y, x_1343.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1346 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1345.x, x_1345.y, x_1345.z, x_1346.w);
  let x_1348 : vec4<f32> = u_xlat2;
  let x_1350 : vec3<f32> = exp2(vec3<f32>(x_1348.x, x_1348.y, x_1348.z));
  let x_1351 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1350.x, x_1350.y, x_1350.z, x_1351.w);
  let x_1353 : vec4<f32> = u_xlat2;
  let x_1356 : vec3<f32> = ((vec3<f32>(x_1353.x, x_1353.y, x_1353.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  ...
  u_xlatb0 = vec3<bool>(x_1361.x, x_1361.y, x_1361.z);
  let x_1364 : bool = u_xlatb0.x;
  if (x_1364) {
  ...
  u_xlat0.x = x_1373;
  let x_1376 : bool = u_xlatb0.y;
  if (x_1376) {
    let x_1381 : f32 = u_xlat1.y;
    x_1377 = x_1381;
  } else {
    let x_1384 : f32 = u_xlat2.y;
    x_1377 = x_1384;
  }
  let x_1385 : f32 = x_1377;
  u_xlat0.y = x_1385;
  let x_1388 : bool = u_xlatb0.z;
  if (x_1388) {
    let x_1393 : f32 = u_xlat1.z;
    x_1389 = x_1393;
  } else {
  ...
  u_xlat0 = ((vec3<f32>(x_1399, x_1399, x_1399) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1404);
  let x_1406 : vec3<f32> = u_xlat0;
  let x_1407 : vec3<f32> = (x_1406 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1408 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1407.x, x_1407.y, x_1407.z, x_1408.w);
  let x_1410 : vec3<f32> = u_xlat0;
  let x_1411 : vec3<f32> = (x_1410 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1412 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1411.x, x_1411.y, x_1411.z, x_1412.w);
  let x_1414 : vec4<f32> = u_xlat2;
  let x_1416 : vec3<f32> = (vec3<f32>(x_1414.x, x_1414.y, x_1414.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1417 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1416.x, x_1416.y, x_1416.z, x_1417.w);
  let x_1419 : vec4<f32> = u_xlat2;
  let x_1422 : vec3<f32> = log2(abs(vec3<f32>(x_1419.x, x_1419.y, x_1419.z)));
  let x_1423 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1422.x, x_1422.y, x_1422.z, x_1423.w);
  let x_1425 : vec4<f32> = u_xlat2;
  let x_1427 : vec3<f32> = (vec3<f32>(x_1425.x, x_1425.y, x_1425.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1428 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1427.x, x_1427.y, x_1427.z, x_1428.w);
  let x_1430 : vec4<f32> = u_xlat2;
  let x_1432 : vec3<f32> = exp2(vec3<f32>(x_1430.x, x_1430.y, x_1430.z));
  let x_1433 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1432.x, x_1432.y, x_1432.z, x_1433.w);
  let x_1435 : vec3<f32> = u_xlat0;
  let x_1437 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1435.x, x_1435.y, x_1435.z, x_1435.x));
  u_xlatb0 = vec3<bool>(x_1437.x, x_1437.y, x_1437.z);
  ...
  u_xlat0.x = x_1449;
  let x_1452 : bool = u_xlatb0.y;
  if (x_1452) {
    let x_1457 : f32 = u_xlat1.y;
    x_1453 = x_1457;
  } else {
    let x_1460 : f32 = u_xlat2.y;
    x_1453 = x_1460;
  }
  let x_1461 : f32 = x_1453;
  u_xlat0.y = x_1461;
  let x_1464 : bool = u_xlatb0.z;
  if (x_1464) {
    let x_1469 : f32 = u_xlat1.z;
    x_1465 = x_1469;
  } else {
  ...
  let x_1478 : vec3<f32> = max(x_1477, vec3<f32>(0.0f, 0.0f, 0.0f));
