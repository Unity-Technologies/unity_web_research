...
fn main_1() {
  ...
  let x_1600 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1604 : vec4<f32> = x_26.x_Dithering_Params;
  ...
  let x_1617 : f32 = x_26.x_GlobalMipBias.x;
  let x_1618 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1614.x, x_1614.y), x_1617);
  u_xlat15 = x_1618.w;
  let x_1620 : f32 = u_xlat15;
  u_xlat15 = ((x_1620 * 2.0f) + -1.0f);
  let x_1623 : f32 = u_xlat15;
  u_xlatb1 = (x_1623 >= 0.0f);
  let x_1625 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1625);
  let x_1628 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1628)) + 1.0f);
  let x_1632 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1632);
  let x_1634 : f32 = u_xlat15;
  u_xlat15 = (-(x_1634) + 1.0f);
  let x_1637 : f32 = u_xlat15;
  let x_1639 : f32 = u_xlat1.x;
  u_xlat15 = (x_1637 * x_1639);
  let x_1641 : vec3<f32> = u_xlat0;
  let x_1642 : vec3<f32> = (x_1641 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1643 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1642.x, x_1642.y, x_1642.z, x_1643.w);
  let x_1645 : vec3<f32> = u_xlat0;
  let x_1646 : vec3<f32> = log2(x_1645);
  let x_1647 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1646.x, x_1646.y, x_1646.z, x_1647.w);
  let x_1649 : vec4<f32> = u_xlat2;
  let x_1651 : vec3<f32> = (vec3<f32>(x_1649.x, x_1649.y, x_1649.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1652 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1651.x, x_1651.y, x_1651.z, x_1652.w);
  let x_1654 : vec4<f32> = u_xlat2;
  let x_1656 : vec3<f32> = exp2(vec3<f32>(x_1654.x, x_1654.y, x_1654.z));
  let x_1657 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1656.x, x_1656.y, x_1656.z, x_1657.w);
  let x_1659 : vec4<f32> = u_xlat2;
  let x_1662 : vec3<f32> = ((vec3<f32>(x_1659.x, x_1659.y, x_1659.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1663 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1662.x, x_1662.y, x_1662.z, x_1663.w);
  let x_1665 : vec3<f32> = u_xlat0;
  let x_1667 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1665.x));
  u_xlatb0 = vec3<bool>(x_1667.x, x_1667.y, x_1667.z);
  let x_1670 : bool = u_xlatb0.x;
  if (x_1670) {
  ...
  u_xlat0.x = x_1679;
  let x_1682 : bool = u_xlatb0.y;
  if (x_1682) {
    let x_1687 : f32 = u_xlat1.y;
    x_1683 = x_1687;
  } else {
  ...
  u_xlat0.y = x_1691;
  let x_1694 : bool = u_xlatb0.z;
  if (x_1694) {
    let x_1699 : f32 = u_xlat1.z;
    x_1695 = x_1699;
  } else {
  ...
  u_xlat0.z = x_1703;
  let x_1705 : f32 = u_xlat15;
  let x_1710 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1705, x_1705, x_1705) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1710);
  let x_1712 : vec3<f32> = u_xlat0;
  let x_1713 : vec3<f32> = (x_1712 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1714 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1713.x, x_1713.y, x_1713.z, x_1714.w);
  let x_1716 : vec3<f32> = u_xlat0;
  let x_1717 : vec3<f32> = (x_1716 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1718 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1717.x, x_1717.y, x_1717.z, x_1718.w);
  let x_1720 : vec4<f32> = u_xlat2;
  let x_1722 : vec3<f32> = (vec3<f32>(x_1720.x, x_1720.y, x_1720.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1723 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1722.x, x_1722.y, x_1722.z, x_1723.w);
  let x_1725 : vec4<f32> = u_xlat2;
  let x_1728 : vec3<f32> = log2(abs(vec3<f32>(x_1725.x, x_1725.y, x_1725.z)));
  let x_1729 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1728.x, x_1728.y, x_1728.z, x_1729.w);
  let x_1731 : vec4<f32> = u_xlat2;
  let x_1733 : vec3<f32> = (vec3<f32>(x_1731.x, x_1731.y, x_1731.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1734 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1733.x, x_1733.y, x_1733.z, x_1734.w);
  let x_1736 : vec4<f32> = u_xlat2;
  let x_1738 : vec3<f32> = exp2(vec3<f32>(x_1736.x, x_1736.y, x_1736.z));
  let x_1739 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1738.x, x_1738.y, x_1738.z, x_1739.w);
  let x_1741 : vec3<f32> = u_xlat0;
  let x_1743 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1741.x, x_1741.y, x_1741.z, x_1741.x));
  u_xlatb0 = vec3<bool>(x_1743.x, x_1743.y, x_1743.z);
  let x_1746 : bool = u_xlatb0.x;
  if (x_1746) {
  ...
  u_xlat0.x = x_1755;
  let x_1758 : bool = u_xlatb0.y;
  if (x_1758) {
    let x_1763 : f32 = u_xlat1.y;
    x_1759 = x_1763;
  } else {
    let x_1766 : f32 = u_xlat2.y;
    x_1759 = x_1766;
  }
  let x_1767 : f32 = x_1759;
  u_xlat0.y = x_1767;
  let x_1770 : bool = u_xlatb0.z;
  if (x_1770) {
    let x_1775 : f32 = u_xlat1.z;
    x_1771 = x_1775;
  } else {
    let x_1778 : f32 = u_xlat2.z;
    x_1771 = x_1778;
  }
  let x_1779 : f32 = x_1771;
  u_xlat0.z = x_1779;
  let x_1783 : vec3<f32> = u_xlat0;
  let x_1784 : vec3<f32> = max(x_1783, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1785 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1784.x, x_1784.y, x_1784.z, x_1785.w);
  SV_Target0.w = 1.0f;
  return;
}
