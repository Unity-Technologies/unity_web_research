...
;
    ...
    u_xlat68 = u_xlat2.x * u_xlat2.x + (-u_xlat68);
    u_xlat6.xyz = unity_SHC.xyz * vec3(u_xlat68) + u_xlat7.xyz;
    ...
    u_xlat31.xyz = (-u_xlat5.xyz) + vec3(u_xlat44);
    u_xlat31.xyz = u_xlat25.xxx * u_xlat31.xyz + u_xlat5.xyz;
    ...
    u_xlat3.xyz = u_xlat0.xxx * u_xlat28.xyz;
    ...
    u_xlat0.x = dot(u_xlat2.xyz, u_xlat28.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat0.z = dot(_MainLightPosition.xyz, u_xlat28.xyz);
    u_xlat0.z = clamp(u_xlat0.z, 0.0, 1.0);
    u_xlat0.xz = u_xlat0.xz * u_xlat0.xz;
    u_xlat0.x = u_xlat0.x * u_xlat9.x + 1.00001001;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat44 = max(u_xlat0.z, 0.100000001);
    u_xlat0.x = u_xlat44 * u_xlat0.x;
    u_xlat0.x = u_xlat69 * u_xlat0.x;
    u_xlat0.x = u_xlat70 / u_xlat0.x;
    u_xlat28.xyz = u_xlat5.xyz * u_xlat0.xxx + u_xlat7.xyz;
    u_xlat3.xyz = u_xlat3.xyz * u_xlat28.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat68 = dot(unity_LightIndices[int(u_xlatu68)], uintBitsToFloat(ImmCB_0[u_xlati71]));
        u_xlatu68 =  uint(int(u_xlat68));
        u_xlat31.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu68)].www + _AdditionalLightsPosition[int(u_xlatu68)].xyz;
        ...
        u_xlat71 = u_xlat71 * _AdditionalLightsAttenuation[int(u_xlatu68)].x;
        u_xlat71 = (-u_xlat71) * u_xlat71 + 1.0;
        u_xlat71 = max(u_xlat71, 0.0);
        u_xlat71 = u_xlat71 * u_xlat71;
        u_xlat71 = u_xlat71 * u_xlat73;
        u_xlat73 = dot(_AdditionalLightsSpotDir[int(u_xlatu68)].xyz, u_xlat10.xyz);
        u_xlat73 = u_xlat73 * _AdditionalLightsAttenuation[int(u_xlatu68)].z + _AdditionalLightsAttenuation[int(u_xlatu68)].w;
        u_xlat73 = clamp(u_xlat73, 0.0, 1.0);
        u_xlat73 = u_xlat73 * u_xlat73;
        u_xlat71 = u_xlat71 * u_xlat73;
        u_xlatu73 = u_xlatu68 >> (5u & uint(0x1F));
        u_xlati74 = 1 << (int(u_xlatu68) & int(0x1F));
        u_xlati73 = int(uint(u_xlati74) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu73)]));
        if(u_xlati73 != 0) {
            u_xlati73 = int(_AdditionalLightsLightTypes[int(u_xlatu68)]);
            ...
            if(u_xlati74 != 0) {
                ...
                if(u_xlati73 != 0) {
                    ...
                    u_xlat55.xy = u_xlat12.xy * vec2(u_xlat73) + u_xlat55.xy;
                    u_xlat55.xy = u_xlat55.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat73 = (u_xlatb28.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb28.x) ? u_xlat11.xyz : vec3(u_xlat73);
        } else {
        ...
        u_xlat68 = dot(u_xlat2.xyz, u_xlat10.xyz);
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
        u_xlat68 = u_xlat68 * u_xlat71;
        u_xlat11.xyz = vec3(u_xlat68) * u_xlat11.xyz;
        u_xlat31.xyz = u_xlat31.xyz * vec3(u_xlat72) + u_xlat1.xyz;
        ...
        u_xlat68 = dot(u_xlat2.xyz, u_xlat31.xyz);
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
        ...
        u_xlat31.xyz = u_xlat5.xyz * vec3(u_xlat68) + u_xlat7.xyz;
        u_xlat8.xyz = u_xlat31.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat22) + u_xlat3.xyz;
