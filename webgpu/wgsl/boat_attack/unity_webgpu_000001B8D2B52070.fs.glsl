...
;
    ...
    u_xlat36 = max(u_xlat3.w, 9.99999975e-05);
    u_xlat3.xyz = u_xlat3.xyz / vec3(u_xlat36);
    u_xlat4.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat4.xy = u_xlat4.xy * hlslcc_FragCoord.xy;
    u_xlat36 = u_xlat4.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    ...
    u_xlat2.x = u_xlat13.x * u_xlat24 + u_xlat2.x;
    ...
    u_xlat13.x = u_xlat13.x * u_xlat13.x;
    u_xlat13.x = u_xlat13.x * u_xlat13.x;
    u_xlat24 = (-u_xlat1) * 0.699999988 + 1.70000005;
    u_xlat1 = u_xlat1 * u_xlat24;
    u_xlat1 = u_xlat1 * 6.0;
    ...
    u_xlat9.xy = vec2(u_xlat36) * vec2(u_xlat36) + vec2(-1.0, 1.0);
    u_xlat1 = float(1.0) / u_xlat9.y;
    u_xlat20.xyz = (-u_xlat0.xyz) + vec3(u_xlat33);
    u_xlat20.xyz = u_xlat13.xxx * u_xlat20.xyz + u_xlat0.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati36].www + _AdditionalLightsPosition[u_xlati36].xyz;
        ...
        u_xlat40 = dot(_AdditionalLightsSpotDir[u_xlati36].xyz, u_xlat20.xyz);
        ...
        u_xlat36 = dot(u_xlat12.xyz, u_xlat20.xyz);
