...
fn main_1() {
  ...
  u_xlat8 = (x_766 + vec2<f32>(x_769.x, x_769.y));
  ...
  let x_786 : vec3<f32> = (vec3<f32>(x_781.x, x_781.x, x_781.x) * vec3<f32>(x_784.x, x_784.y, x_784.z));
  ...
  u_xlat14 = max(x_804, 0.00009999999747378752f);
