...
;
    ...
    u_xlat5.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati45 + 1) / 4][(u_xlati45 + 1) % 4].xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[u_xlati45 / 4][u_xlati45 % 4].xyz * vs_INTERP7.xxx + u_xlat5.xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[(u_xlati45 + 2) / 4][(u_xlati45 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat5.xyz;
    ...
    u_xlat47 = dot(u_xlat1.xyw, u_xlat6.xyz);
    ...
    u_xlatb35.x = u_xlat5.z>=1.0;
    u_xlatb20 = u_xlatb35.x || u_xlatb20;
    ...
    u_xlat35.x = u_xlat20.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat35.x = clamp(u_xlat35.x, 0.0, 1.0);
    u_xlat50 = (-u_xlat5.x) + 1.0;
    u_xlat5.x = u_xlat35.x * u_xlat50 + u_xlat5.x;
    u_xlatb35.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb35.x){
        u_xlat35.xy = vs_INTERP7.yy * _MainLightWorldToLight[1].xy;
        u_xlat35.xy = _MainLightWorldToLight[0].xy * vs_INTERP7.xx + u_xlat35.xy;
        u_xlat35.xy = _MainLightWorldToLight[2].xy * vs_INTERP7.zz + u_xlat35.xy;
        u_xlat35.xy = u_xlat35.xy + _MainLightWorldToLight[3].xy;
        u_xlat35.xy = u_xlat35.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat8 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat35.xy, _GlobalMipBias.x);
        u_xlatb35.xy = equal(vec4(vec4(_MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat)), vec4(0.0, 1.0, 0.0, 1.0)).xy;
        u_xlat50 = (u_xlatb35.y) ? u_xlat8.w : u_xlat8.x;
        u_xlat8.xyz = (u_xlatb35.x) ? u_xlat8.xyz : vec3(u_xlat50);
    } else {
        u_xlat8.x = float(1.0);
        u_xlat8.y = float(1.0);
        u_xlat8.z = float(1.0);
    ...
    u_xlat35.x = dot((-u_xlat4.xyz), u_xlat1.xyw);
    u_xlat35.x = u_xlat35.x + u_xlat35.x;
    u_xlat9.xyz = u_xlat1.xyw * (-u_xlat35.xxx) + (-u_xlat4.xyz);
    u_xlat35.x = dot(u_xlat1.xyw, u_xlat4.xyz);
    u_xlat35.x = clamp(u_xlat35.x, 0.0, 1.0);
    u_xlat35.x = (-u_xlat35.x) + 1.0;
    u_xlat35.x = u_xlat35.x * u_xlat35.x;
    u_xlat35.x = u_xlat35.x * u_xlat35.x;
    u_xlat50 = (-u_xlat47) * 0.699999988 + 1.70000005;
    u_xlat2.w = u_xlat47 * u_xlat50;
    ...
    u_xlat47 = float(1.0) / u_xlat10.y;
    u_xlat25.xyz = (-u_xlat0.xyz) + vec3(u_xlat48);
    u_xlat25.xyz = u_xlat35.xxx * u_xlat25.xyz + u_xlat0.xyz;
    u_xlat25.xyz = vec3(u_xlat47) * u_xlat25.xyz;
    ...
    u_xlat47 = dot(u_xlat1.xyw, u_xlat8.xyz);
    u_xlat47 = clamp(u_xlat47, 0.0, 1.0);
    u_xlat3.x = dot(_MainLightPosition.xyz, u_xlat8.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat47 = u_xlat47 * u_xlat47;
    u_xlat47 = u_xlat47 * u_xlat10.x + 1.00001001;
    ...
    u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat47) + u_xlat7.xyz;
    ...
    {
        u_xlatu20 = u_xlatu_loop_1 >> (2u & uint(0x1F));
        u_xlati51 = int(u_xlatu_loop_1 & 3u);
        u_xlat20.x = dot(unity_LightIndices[int(u_xlatu20)], uintBitsToFloat(ImmCB_0[u_xlati51]));
        u_xlati20 = int(u_xlat20.x);
        u_xlat25.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati20].www + _AdditionalLightsPosition[u_xlati20].xyz;
        ...
        u_xlat51 = u_xlat51 * _AdditionalLightsAttenuation[u_xlati20].x;
        u_xlat51 = (-u_xlat51) * u_xlat51 + 1.0;
        u_xlat51 = max(u_xlat51, 0.0);
        u_xlat51 = u_xlat51 * u_xlat51;
        u_xlat51 = u_xlat51 * u_xlat38;
        u_xlat38 = dot(_AdditionalLightsSpotDir[u_xlati20].xyz, u_xlat11.xyz);
        u_xlat38 = u_xlat38 * _AdditionalLightsAttenuation[u_xlati20].z + _AdditionalLightsAttenuation[u_xlati20].w;
        u_xlat38 = clamp(u_xlat38, 0.0, 1.0);
        u_xlat38 = u_xlat38 * u_xlat38;
        u_xlat51 = u_xlat51 * u_xlat38;
        u_xlati38 = int(_AdditionalShadowParams[u_xlati20].w);
        u_xlatb53 = u_xlati38>=0;
        if(u_xlatb53){
            u_xlatb53 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati20].z);
            if(u_xlatb53){
                ...
                u_xlat54 = trunc(_AdditionalShadowParams[u_xlati20].w);
            ...
            u_xlat53 = 1.0 + (-_AdditionalShadowParams[u_xlati20].x);
            u_xlat38 = u_xlat38 * _AdditionalShadowParams[u_xlati20].x + u_xlat53;
        ...
        u_xlati53 = 1 << (u_xlati20 & int(0x1F));
        u_xlati53 = int(uint(u_xlati53) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati53 != 0) {
            u_xlati53 = int(_AdditionalLightsLightTypes[u_xlati20]);
            u_xlati54 = (u_xlati53 != 0) ? 0 : 1;
            u_xlati56 = u_xlati20 << (2 & int(0x1F));
            if(u_xlati54 != 0) {
                ...
                u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati20].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati20].zw;
            } else {
                ...
                if(u_xlati53 != 0) {
                    ...
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati20].xy * u_xlat42.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati20].zw;
                } else {
        ...
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[u_xlati20].xyz;
        u_xlat20.x = u_xlat51 * u_xlat38;
        u_xlat51 = dot(u_xlat1.xyw, u_xlat11.xyz);
        u_xlat51 = clamp(u_xlat51, 0.0, 1.0);
        u_xlat20.x = u_xlat20.x * u_xlat51;
        u_xlat12.xyz = u_xlat20.xxx * u_xlat12.xyz;
        u_xlat25.xyz = u_xlat25.xyz * vec3(u_xlat52) + u_xlat4.xyz;
        u_xlat20.x = dot(u_xlat25.xyz, u_xlat25.xyz);
        u_xlat20.x = max(u_xlat20.x, 1.17549435e-38);
        u_xlat20.x = inversesqrt(u_xlat20.x);
        u_xlat25.xyz = u_xlat20.xxx * u_xlat25.xyz;
        u_xlat20.x = dot(u_xlat1.xyw, u_xlat25.xyz);
        u_xlat20.x = clamp(u_xlat20.x, 0.0, 1.0);
        u_xlat51 = dot(u_xlat11.xyz, u_xlat25.xyz);
        u_xlat51 = clamp(u_xlat51, 0.0, 1.0);
        u_xlat20.x = u_xlat20.x * u_xlat20.x;
        u_xlat20.x = u_xlat20.x * u_xlat10.x + 1.00001001;
        u_xlat51 = u_xlat51 * u_xlat51;
        u_xlat20.x = u_xlat20.x * u_xlat20.x;
        u_xlat51 = max(u_xlat51, 0.100000001);
        u_xlat20.x = u_xlat20.x * u_xlat51;
        u_xlat20.x = u_xlat49 * u_xlat20.x;
        u_xlat20.x = u_xlat18 / u_xlat20.x;
        u_xlat25.xyz = u_xlat0.xyz * u_xlat20.xxx + u_xlat7.xyz;
        u_xlat9.xyz = u_xlat25.xyz * u_xlat12.xyz + u_xlat9.xyz;
    }
    u_xlat0.xyz = u_xlat6.xyz * vec3(u_xlat33) + u_xlat5.xzw;
