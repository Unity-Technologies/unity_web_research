...
layout(set = 1, binding = 3, std140) uniform AdditionalLights {
...
layout(set = 1, binding = 4, std140) uniform UnityPerDraw {
...
layout(location = 3) in highp vec3 in_NORMAL0;
...
void main()
{
    ...
    vs_TEXCOORD4.xyz = u_xlat1.xyz + _MainLightWorldToShadow[3 / 4][3 % 4].xyz;
