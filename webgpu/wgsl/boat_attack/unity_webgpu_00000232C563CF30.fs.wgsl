...
fn main_1() {
  ...
  let x_2315 : vec3<f32> = (vec3<f32>(x_2313.x, x_2313.y, x_2313.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2316 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2315.x, x_2315.y, x_2315.z, x_2316.w);
  let x_2318 : vec4<f32> = u_xlat0;
  let x_2321 : vec3<f32> = log2(abs(vec3<f32>(x_2318.x, x_2318.y, x_2318.z)));
  let x_2322 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2321.x, x_2321.y, x_2321.z, x_2322.w);
  let x_2324 : vec4<f32> = u_xlat2;
  let x_2326 : vec3<f32> = (vec3<f32>(x_2324.x, x_2324.y, x_2324.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2327 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2326.x, x_2326.y, x_2326.z, x_2327.w);
  let x_2329 : vec4<f32> = u_xlat2;
  let x_2331 : vec3<f32> = exp2(vec3<f32>(x_2329.x, x_2329.y, x_2329.z));
  let x_2332 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2331.x, x_2331.y, x_2331.z, x_2332.w);
  let x_2334 : vec4<f32> = u_xlat2;
  let x_2337 : vec3<f32> = ((vec3<f32>(x_2334.x, x_2334.y, x_2334.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2338 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2337.x, x_2337.y, x_2337.z, x_2338.w);
  let x_2340 : vec4<f32> = u_xlat0;
  let x_2342 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2340.x, x_2340.y, x_2340.z, x_2340.x));
  u_xlatb0 = vec3<bool>(x_2342.x, x_2342.y, x_2342.z);
  let x_2345 : bool = u_xlatb0.x;
  if (x_2345) {
    let x_2350 : f32 = u_xlat1.x;
    x_2346 = x_2350;
  } else {
    let x_2353 : f32 = u_xlat2.x;
    x_2346 = x_2353;
  }
  let x_2354 : f32 = x_2346;
  u_xlat0.x = x_2354;
  let x_2357 : bool = u_xlatb0.y;
  if (x_2357) {
    let x_2362 : f32 = u_xlat1.y;
    x_2358 = x_2362;
  } else {
    let x_2365 : f32 = u_xlat2.y;
    x_2358 = x_2365;
  }
  let x_2366 : f32 = x_2358;
  u_xlat0.y = x_2366;
  let x_2369 : bool = u_xlatb0.z;
  if (x_2369) {
    let x_2374 : f32 = u_xlat1.z;
    x_2370 = x_2374;
  } else {
  ...
  u_xlat0.z = x_2378;
  let x_2380 : vec2<f32> = vs_TEXCOORD0;
  let x_2383 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2387 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2389 : vec2<f32> = ((x_2380 * vec2<f32>(x_2383.x, x_2383.y)) + vec2<f32>(x_2387.z, x_2387.w));
  let x_2390 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2389.x, x_2389.y, x_2390.z, x_2390.w);
  let x_2397 : vec4<f32> = u_xlat1;
  let x_2400 : f32 = x_25.x_GlobalMipBias.x;
  let x_2401 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2397.x, x_2397.y), x_2400);
  u_xlat21 = x_2401.w;
  let x_2403 : f32 = u_xlat21;
  u_xlat21 = ((x_2403 * 2.0f) + -1.0f);
  let x_2406 : f32 = u_xlat21;
  u_xlatb1 = (x_2406 >= 0.0f);
  let x_2408 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2408);
  let x_2411 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2411)) + 1.0f);
  let x_2415 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2415);
  let x_2417 : f32 = u_xlat21;
  u_xlat21 = (-(x_2417) + 1.0f);
  let x_2420 : f32 = u_xlat21;
  let x_2422 : f32 = u_xlat1.x;
  u_xlat21 = (x_2420 * x_2422);
  let x_2424 : vec4<f32> = u_xlat0;
  let x_2426 : vec3<f32> = (vec3<f32>(x_2424.x, x_2424.y, x_2424.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2427 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2426.x, x_2426.y, x_2426.z, x_2427.w);
  let x_2429 : vec4<f32> = u_xlat0;
  let x_2432 : vec3<f32> = log2(abs(vec3<f32>(x_2429.x, x_2429.y, x_2429.z)));
  let x_2433 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2432.x, x_2432.y, x_2432.z, x_2433.w);
  let x_2435 : vec4<f32> = u_xlat2;
  let x_2437 : vec3<f32> = (vec3<f32>(x_2435.x, x_2435.y, x_2435.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2438 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2437.x, x_2437.y, x_2437.z, x_2438.w);
  let x_2440 : vec4<f32> = u_xlat2;
  let x_2442 : vec3<f32> = exp2(vec3<f32>(x_2440.x, x_2440.y, x_2440.z));
  let x_2443 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2442.x, x_2442.y, x_2442.z, x_2443.w);
  let x_2445 : vec4<f32> = u_xlat2;
  let x_2448 : vec3<f32> = ((vec3<f32>(x_2445.x, x_2445.y, x_2445.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2449 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2448.x, x_2448.y, x_2448.z, x_2449.w);
  let x_2451 : vec4<f32> = u_xlat0;
  let x_2453 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2451.x, x_2451.y, x_2451.z, x_2451.x));
  u_xlatb0 = vec3<bool>(x_2453.x, x_2453.y, x_2453.z);
  let x_2456 : bool = u_xlatb0.x;
  if (x_2456) {
    let x_2461 : f32 = u_xlat1.x;
    x_2457 = x_2461;
  } else {
  ...
  u_xlat0.x = x_2465;
  let x_2468 : bool = u_xlatb0.y;
  if (x_2468) {
    let x_2473 : f32 = u_xlat1.y;
    x_2469 = x_2473;
  } else {
    let x_2476 : f32 = u_xlat2.y;
    x_2469 = x_2476;
  }
  let x_2477 : f32 = x_2469;
  u_xlat0.y = x_2477;
  let x_2480 : bool = u_xlatb0.z;
  if (x_2480) {
    let x_2485 : f32 = u_xlat1.z;
    x_2481 = x_2485;
  } else {
    let x_2488 : f32 = u_xlat2.z;
    x_2481 = x_2488;
  }
  let x_2489 : f32 = x_2481;
  u_xlat0.z = x_2489;
  let x_2491 : f32 = u_xlat21;
  let x_2496 : vec4<f32> = u_xlat0;
  let x_2498 : vec3<f32> = ((vec3<f32>(x_2491, x_2491, x_2491) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2496.x, x_2496.y, x_2496.z));
  let x_2499 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2498.x, x_2498.y, x_2498.z, x_2499.w);
  let x_2501 : vec4<f32> = u_xlat0;
  let x_2503 : vec3<f32> = (vec3<f32>(x_2501.x, x_2501.y, x_2501.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2504 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2503.x, x_2503.y, x_2503.z, x_2504.w);
  let x_2506 : vec4<f32> = u_xlat0;
  let x_2508 : vec3<f32> = (vec3<f32>(x_2506.x, x_2506.y, x_2506.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2509 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2508.x, x_2508.y, x_2508.z, x_2509.w);
  let x_2511 : vec4<f32> = u_xlat2;
  let x_2513 : vec3<f32> = (vec3<f32>(x_2511.x, x_2511.y, x_2511.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2514 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2513.x, x_2513.y, x_2513.z, x_2514.w);
  let x_2516 : vec4<f32> = u_xlat2;
  let x_2519 : vec3<f32> = log2(abs(vec3<f32>(x_2516.x, x_2516.y, x_2516.z)));
  let x_2520 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2519.x, x_2519.y, x_2519.z, x_2520.w);
  let x_2522 : vec4<f32> = u_xlat2;
  let x_2524 : vec3<f32> = (vec3<f32>(x_2522.x, x_2522.y, x_2522.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2525 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2524.x, x_2524.y, x_2524.z, x_2525.w);
  let x_2527 : vec4<f32> = u_xlat2;
  let x_2529 : vec3<f32> = exp2(vec3<f32>(x_2527.x, x_2527.y, x_2527.z));
  let x_2530 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2529.x, x_2529.y, x_2529.z, x_2530.w);
  let x_2532 : vec4<f32> = u_xlat0;
  let x_2534 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2532.x, x_2532.y, x_2532.z, x_2532.x));
  u_xlatb0 = vec3<bool>(x_2534.x, x_2534.y, x_2534.z);
  let x_2537 : bool = u_xlatb0.x;
  if (x_2537) {
    let x_2542 : f32 = u_xlat1.x;
    x_2538 = x_2542;
  } else {
    let x_2545 : f32 = u_xlat2.x;
    x_2538 = x_2545;
  }
  let x_2546 : f32 = x_2538;
  u_xlat0.x = x_2546;
  let x_2549 : bool = u_xlatb0.y;
  if (x_2549) {
    let x_2554 : f32 = u_xlat1.y;
    x_2550 = x_2554;
  } else {
    let x_2557 : f32 = u_xlat2.y;
    x_2550 = x_2557;
  }
  let x_2558 : f32 = x_2550;
  u_xlat0.y = x_2558;
  let x_2561 : bool = u_xlatb0.z;
  if (x_2561) {
    let x_2566 : f32 = u_xlat1.z;
    x_2562 = x_2566;
  } else {
  ...
  u_xlat0.z = x_2570;
  let x_2574 : vec4<f32> = u_xlat0;
  let x_2576 : vec3<f32> = max(vec3<f32>(x_2574.x, x_2574.y, x_2574.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2577 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2576.x, x_2576.y, x_2576.z, x_2577.w);
  SV_Target0.w = 1.0f;
  return;
}
