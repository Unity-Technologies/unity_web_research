...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat17.xyz = u_xlat17.xyz * u_xlat5.xyz + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlati35 != 0) {
            ...
            u_xlati51 = int(u_xlatu44) << (2 & int(0x1F));
            if(u_xlati49 != 0) {
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat44) + u_xlat5.xyz;
        u_xlat22.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat22.xyz;
    }
    u_xlat0.xyz = u_xlat17.xyz * u_xlat4.xxx + u_xlat6.xyz;
