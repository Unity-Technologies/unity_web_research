...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat3.xyz = unity_SHC.xyz * vec3(u_xlat67) + u_xlat4.xyz;
    ...
    if(u_xlatb67){
        ...
        if(u_xlatb67){
            ...
            if(u_xlatb68){
                ...
                u_xlat25 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec5, 0.0);
                u_xlat25 = u_xlat25 * u_xlat10.y;
                u_xlat3.x = u_xlat10.x * u_xlat3.x + u_xlat25;
                vec3 txVec6 = vec3(u_xlat47.xy,vs_TEXCOORD6.z);
                u_xlat25 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat3.x = u_xlat10.z * u_xlat25 + u_xlat3.x;
                vec3 txVec7 = vec3(u_xlat6.xy,vs_TEXCOORD6.z);
                u_xlat25 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat3.x = u_xlat10.w * u_xlat25 + u_xlat3.x;
                vec3 txVec8 = vec3(u_xlat8.xy,vs_TEXCOORD6.z);
                u_xlat25 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat3.x = u_xlat11.x * u_xlat25 + u_xlat3.x;
                vec3 txVec9 = vec3(u_xlat8.zw,vs_TEXCOORD6.z);
                u_xlat25 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat3.x = u_xlat11.y * u_xlat25 + u_xlat3.x;
                vec3 txVec10 = vec3(u_xlat6.zw,vs_TEXCOORD6.z);
                u_xlat25 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat3.x = u_xlat11.z * u_xlat25 + u_xlat3.x;
                vec3 txVec11 = vec3(u_xlat5.xy,vs_TEXCOORD6.z);
                u_xlat25 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat3.x = u_xlat11.w * u_xlat25 + u_xlat3.x;
                vec3 txVec12 = vec3(u_xlat5.zw,vs_TEXCOORD6.z);
                u_xlat25 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                ...
                u_xlat68 = u_xlat14.x * u_xlat68 + u_xlat5.x;
                ...
                u_xlat68 = u_xlat14.z * u_xlat47.x + u_xlat68;
                vec3 txVec16 = vec3(u_xlat12.xy,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec16, 0.0);
                u_xlat68 = u_xlat14.w * u_xlat47.x + u_xlat68;
                vec3 txVec17 = vec3(u_xlat10.xy,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec17, 0.0);
                u_xlat68 = u_xlat15.x * u_xlat47.x + u_xlat68;
                vec3 txVec18 = vec3(u_xlat10.zw,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec18, 0.0);
                u_xlat68 = u_xlat15.y * u_xlat47.x + u_xlat68;
                vec3 txVec19 = vec3(u_xlat11.xy,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec19, 0.0);
                u_xlat68 = u_xlat15.z * u_xlat47.x + u_xlat68;
                vec3 txVec20 = vec3(u_xlat12.zw,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec20, 0.0);
                u_xlat68 = u_xlat15.w * u_xlat47.x + u_xlat68;
                vec3 txVec21 = vec3(u_xlat13.xy,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec21, 0.0);
                u_xlat68 = u_xlat16.x * u_xlat47.x + u_xlat68;
                vec3 txVec22 = vec3(u_xlat13.zw,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec22, 0.0);
                u_xlat68 = u_xlat16.y * u_xlat47.x + u_xlat68;
                vec3 txVec23 = vec3(u_xlat27.xy,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec23, 0.0);
                u_xlat68 = u_xlat16.z * u_xlat47.x + u_xlat68;
                vec3 txVec24 = vec3(u_xlat55.xy,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat68 = u_xlat16.w * u_xlat47.x + u_xlat68;
                vec3 txVec25 = vec3(u_xlat8.xy,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec25, 0.0);
                u_xlat68 = u_xlat4.x * u_xlat47.x + u_xlat68;
                vec3 txVec26 = vec3(u_xlat8.zw,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec26, 0.0);
                u_xlat68 = u_xlat4.y * u_xlat47.x + u_xlat68;
                vec3 txVec27 = vec3(u_xlat50.xy,vs_TEXCOORD6.z);
                u_xlat47.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
                u_xlat68 = u_xlat4.z * u_xlat47.x + u_xlat68;
                ...
                u_xlat67 = u_xlat4.w * u_xlat3.x + u_xlat68;
            }
        }
    } else {
    ...
    u_xlatb68 = u_xlatb68 || u_xlatb3;
    u_xlat67 = (u_xlatb68) ? 1.0 : u_xlat67;
    u_xlat3.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat68 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat3.x = u_xlat68 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat25 = (-u_xlat67) + 1.0;
    u_xlat67 = u_xlat3.x * u_xlat25 + u_xlat67;
    ...
    if(u_xlatb3){
        ...
        u_xlat69 = (u_xlatb4.y) ? u_xlat3.w : u_xlat3.x;
        u_xlat3.xyz = (u_xlatb4.x) ? u_xlat3.xyz : vec3(u_xlat69);
    } else {
        u_xlat3.x = float(1.0);
        u_xlat3.y = float(1.0);
        u_xlat3.z = float(1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu67 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat48 = dot(unity_LightIndices[int(u_xlatu48)], uintBitsToFloat(ImmCB_0[u_xlati70]));
        ...
        u_xlat71 = u_xlat68 * u_xlat72 + u_xlat71;
    ...
    u_xlat22.xyz = u_xlat2.xyz * u_xlat0.yzw + u_xlat3.xyz;
