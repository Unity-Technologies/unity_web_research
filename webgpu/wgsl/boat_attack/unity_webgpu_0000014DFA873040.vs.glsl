...
layout(location = 0) out highp vec4 vs_POSITION_CS_NO_JITTER0;
layout(location = 1) out highp vec4 vs_PREV_POSITION_CS_NO_JITTER0;
...
void main()
{
    ...
    vs_POSITION_CS_NO_JITTER0 = _NonJitteredViewProjMatrix[3] * u_xlat0.wwww + u_xlat1;
    ...
    vs_PREV_POSITION_CS_NO_JITTER0 = _PrevViewProjMatrix[3] * u_xlat0.wwww + u_xlat1;
