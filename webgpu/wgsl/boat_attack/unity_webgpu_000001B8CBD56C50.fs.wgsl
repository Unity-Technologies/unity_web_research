...
fn main_1() {
  ...
  if (x_51) {
    ...
    u_xlat0.x = ((x_160 * -2.007874012f) + 3.25f);
    ...
    u_xlat12 = ((x_266 * -2.007874012f) + 3.25f);
    ...
    let x_350 : vec2<f32> = ((vec2<f32>(x_341.x, x_341.z) * vec2<f32>(0.00625f, 0.0017857143f)) + vec2<f32>(0.003125f, 0.000892857148f));
  ...
  if (x_374) {
    ...
    u_xlat0.x = ((x_451 * -2.007874012f) + 3.25f);
    ...
    u_xlat12 = ((x_546 * -2.007874012f) + 3.25f);
    ...
    let x_612 : vec2<f32> = ((vec2<f32>(x_609.x, x_609.y) * vec2<f32>(0.00625f, 0.0017857143f)) + vec2<f32>(0.003125f, 0.000892857148f));
