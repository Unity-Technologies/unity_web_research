...
void main()
{
    ...
    u_xlat0 = inversesqrt(u_xlat0);
    u_xlat22.xyz = vec3(u_xlat0) * u_xlat9.xyz;
    ...
    u_xlat16.xyz = abs(u_xlat4.xyz) * _ScreenParams.xyx;
    ...
    u_xlat2.x = (u_xlatb2) ? u_xlat16.x : u_xlat30;
    ...
    u_xlat0 = (u_xlatb2) ? u_xlat0 : u_xlat16.x;
    u_xlat16.x = u_xlat0 + -9.99999975e-05;
    ...
    u_xlat16.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP0.xy, _GlobalMipBias.x).xyz;
    ...
    u_xlat7.x = dot((-u_xlat5.xyz), u_xlat14.xyz);
    u_xlat7.x = u_xlat7.x + u_xlat7.x;
    u_xlat7.xyz = u_xlat14.xyz * (-u_xlat7.xxx) + (-u_xlat5.xyz);
    u_xlat49 = dot(u_xlat14.xyz, u_xlat5.xyz);
    ...
    u_xlat8.xy = u_xlat4.xx * u_xlat4.xx + vec2(-1.0, 1.0);
    u_xlat45 = float(1.0) / u_xlat8.y;
    u_xlat4.x = u_xlat32 + -0.0399999991;
    u_xlat4.x = u_xlat49 * u_xlat4.x + 0.0399999991;
    u_xlat45 = u_xlat45 * u_xlat4.x;
    u_xlat7.xyz = vec3(u_xlat45) * u_xlat7.xyz;
    u_xlat16.xyz = u_xlat16.xyz * u_xlat3.xyz + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu43 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat49 = dot(unity_LightIndices[int(u_xlatu49)], uintBitsToFloat(ImmCB_0[u_xlati22]));
        u_xlati49 = int(u_xlat49);
        u_xlat22.xyz = (-vs_INTERP8.xyz) * _AdditionalLightsPosition[u_xlati49].www + _AdditionalLightsPosition[u_xlati49].xyz;
        ...
        u_xlat37 = float(1.0) / float(u_xlat9.x);
        u_xlat9.x = u_xlat9.x * _AdditionalLightsAttenuation[u_xlati49].x;
        u_xlat9.x = (-u_xlat9.x) * u_xlat9.x + 1.0;
        u_xlat9.x = max(u_xlat9.x, 0.0);
        u_xlat9.x = u_xlat9.x * u_xlat9.x;
        u_xlat9.x = u_xlat9.x * u_xlat37;
        u_xlat37 = dot(_AdditionalLightsSpotDir[u_xlati49].xyz, u_xlat10.xyz);
        ...
        u_xlati37 = int(_AdditionalShadowParams[u_xlati49].w);
        u_xlatb51 = u_xlati37>=0;
        if(u_xlatb51){
            u_xlatb51 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati49].z);
            if(u_xlatb51){
                ...
                u_xlat52 = trunc(_AdditionalShadowParams[u_xlati49].w);
                u_xlat51 = u_xlat51 + u_xlat52;
                u_xlati37 = int(u_xlat51);
            }
            u_xlati37 = u_xlati37 << (2 & int(0x1F));
            u_xlat11 = vs_INTERP8.yyyy * _AdditionalLightsWorldToShadow[(u_xlati37 + 1) / 4][(u_xlati37 + 1) % 4];
            u_xlat11 = _AdditionalLightsWorldToShadow[u_xlati37 / 4][u_xlati37 % 4] * vs_INTERP8.xxxx + u_xlat11;
            u_xlat11 = _AdditionalLightsWorldToShadow[(u_xlati37 + 2) / 4][(u_xlati37 + 2) % 4] * vs_INTERP8.zzzz + u_xlat11;
            u_xlat11 = u_xlat11 + _AdditionalLightsWorldToShadow[(u_xlati37 + 3) / 4][(u_xlati37 + 3) % 4];
            u_xlat11.xyz = u_xlat11.xyz / u_xlat11.www;
            vec3 txVec2 = vec3(u_xlat11.xy,u_xlat11.z);
            u_xlat37 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec2, 0.0);
            u_xlat51 = 1.0 + (-_AdditionalShadowParams[u_xlati49].x);
            u_xlat37 = u_xlat37 * _AdditionalShadowParams[u_xlati49].x + u_xlat51;
            u_xlatb51 = 0.0>=u_xlat11.z;
            u_xlatb52 = u_xlat11.z>=1.0;
            u_xlatb51 = u_xlatb51 || u_xlatb52;
            u_xlat37 = (u_xlatb51) ? 1.0 : u_xlat37;
        } else {
            u_xlat37 = 1.0;
        }
        u_xlat51 = (-u_xlat37) + 1.0;
        u_xlat37 = u_xlat45 * u_xlat51 + u_xlat37;
        u_xlati51 = 1 << (u_xlati49 & int(0x1F));
        ...
        if(u_xlati51 != 0) {
            ...
            u_xlati11 = u_xlati49 << (2 & int(0x1F));
            if(u_xlati52 != 0) {
                ...
                u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati49].xy * u_xlat25.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati49].zw;
            } else {
                ...
                if(u_xlati51 != 0) {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati49].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati49].zw;
                } else {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati49].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati49].zw;
                }
            }
            u_xlat11 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat25.xy, 0.0);
            u_xlat51 = (u_xlatb4.z) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb4.x) ? u_xlat11.xyz : vec3(u_xlat51);
        } else {
            u_xlat11.x = float(1.0);
            u_xlat11.y = float(1.0);
            u_xlat11.z = float(1.0);
        }
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[u_xlati49].xyz;
        u_xlat49 = u_xlat37 * u_xlat9.x;
        u_xlat9.x = dot(u_xlat14.xyz, u_xlat10.xyz);
        u_xlat9.x = clamp(u_xlat9.x, 0.0, 1.0);
        u_xlat49 = u_xlat49 * u_xlat9.x;
        u_xlat9.xzw = vec3(u_xlat49) * u_xlat11.xyz;
        u_xlat22.xyz = u_xlat22.xyz * vec3(u_xlat23) + u_xlat5.xyz;
        u_xlat49 = dot(u_xlat22.xyz, u_xlat22.xyz);
        u_xlat49 = max(u_xlat49, 1.17549435e-38);
        u_xlat49 = inversesqrt(u_xlat49);
        u_xlat22.xyz = vec3(u_xlat49) * u_xlat22.xyz;
        u_xlat49 = dot(u_xlat14.xyz, u_xlat22.xyz);
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        ...
        u_xlat22.xyz = vec3(u_xlat49) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat3.xyz;
        u_xlat7.xyz = u_xlat22.xyz * u_xlat9.xzw + u_xlat7.xyz;
    }
    u_xlat14.xyz = u_xlat16.xyz * vec3(u_xlat47) + u_xlat20.xyz;
