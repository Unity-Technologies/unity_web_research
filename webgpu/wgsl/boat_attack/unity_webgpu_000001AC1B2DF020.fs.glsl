...
;
    ...
    u_xlat6.x = (u_xlatb27.x) ? u_xlat31.x : unity_MatrixV[0].z;
    u_xlat6.y = (u_xlatb27.x) ? u_xlat31.y : unity_MatrixV[1].z;
    u_xlat6.z = (u_xlatb27.x) ? u_xlat31.z : unity_MatrixV[2].z;
    u_xlat7 = texture(sampler2D(unity_LightmapInd, samplerunity_Lightmap), vs_INTERP0.xy, _GlobalMipBias.x);
    u_xlat31.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP0.xy, _GlobalMipBias.x).xyz;
    u_xlat7.xyz = u_xlat7.xyz + vec3(-0.5, -0.5, -0.5);
    u_xlat27.x = dot(u_xlat29.xyz, u_xlat7.xyz);
    u_xlat27.x = u_xlat27.x + 0.5;
    u_xlat31.xyz = u_xlat27.xxx * u_xlat31.xyz;
    u_xlat27.x = max(u_xlat7.w, 9.99999975e-05);
    u_xlat31.xyz = u_xlat31.xyz / u_xlat27.xxx;
    u_xlat3.x = u_xlat3.x;
    ...
    if(u_xlatb78){
        ...
        if(u_xlatb78){
            ...
            u_xlatb33.x = _MainLightShadowParams.y==2.0;
            if(u_xlatb33.x){
                u_xlat33.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat33.xy = floor(u_xlat33.xy);
                u_xlat8.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat33.xy);
                ...
                u_xlat59.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec34, 0.0);
                ...
                u_xlat59.x = u_xlat15.x * u_xlat59.x + u_xlat85;
                ...
                u_xlat59.x = u_xlat15.z * u_xlat85 + u_xlat59.x;
                ...
                u_xlat59.x = u_xlat15.w * u_xlat85 + u_xlat59.x;
                ...
                u_xlat59.x = u_xlat16.x * u_xlat85 + u_xlat59.x;
                ...
                u_xlat59.x = u_xlat16.y * u_xlat85 + u_xlat59.x;
                ...
                u_xlat59.x = u_xlat16.z * u_xlat85 + u_xlat59.x;
                ...
                u_xlat59.x = u_xlat16.w * u_xlat85 + u_xlat59.x;
                ...
                u_xlat78 = u_xlat33.x * u_xlat85 + u_xlat59.x;
            } else {
                u_xlat33.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat33.xy = floor(u_xlat33.xy);
                u_xlat8.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat33.xy);
    ...
    if(u_xlatb30.x){
        u_xlat30.xy = vs_INTERP8.yy * _MainLightWorldToLight[1].xy;
        u_xlat30.xy = _MainLightWorldToLight[0].xy * vs_INTERP8.xx + u_xlat30.xy;
        u_xlat30.xy = _MainLightWorldToLight[2].xy * vs_INTERP8.zz + u_xlat30.xy;
        u_xlat30.xy = u_xlat30.xy + _MainLightWorldToLight[3].xy;
        u_xlat30.xy = u_xlat30.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat8 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat30.xy, _GlobalMipBias.x);
        u_xlatb30.xy = equal(vec4(vec4(_MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat)), vec4(0.0, 1.0, 0.0, 0.0)).xy;
        u_xlat56 = (u_xlatb30.y) ? u_xlat8.w : u_xlat8.x;
        u_xlat30.xyz = (u_xlatb30.x) ? u_xlat8.xyz : vec3(u_xlat56);
    } else {
        u_xlat30.x = float(1.0);
        u_xlat30.y = float(1.0);
        u_xlat30.z = float(1.0);
    }
    u_xlat30.xyz = u_xlat30.xyz * _MainLightColor.xyz;
    u_xlat5.x = dot((-u_xlat6.xyz), u_xlat29.xyz);
    u_xlat5.x = u_xlat5.x + u_xlat5.x;
    u_xlat33.xyz = u_xlat29.xyz * (-u_xlat5.xxx) + (-u_xlat6.xyz);
    u_xlat5.x = dot(u_xlat29.xyz, u_xlat6.xyz);
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
    u_xlat5.x = (-u_xlat5.x) + 1.0;
    u_xlat5.x = u_xlat5.x * u_xlat5.x;
    u_xlat5.x = u_xlat5.x * u_xlat5.x;
    u_xlat8.x = (-u_xlat27.x) * 0.699999988 + 1.70000005;
    u_xlat27.x = u_xlat27.x * u_xlat8.x;
    u_xlat27.x = u_xlat27.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat33.xyz, u_xlat27.x);
    ...
    u_xlat33.xyz = u_xlat8.xyz * u_xlat27.xxx;
    ...
    u_xlat5.xyz = u_xlat31.xyz * u_xlat2.xyz + u_xlat33.xyz;
    ...
    u_xlat30.xyz = vec3(u_xlat78) * u_xlat30.xyz;
    u_xlat33.xyz = u_xlat6.xyz + _MainLightPosition.xyz;
    u_xlat78 = dot(u_xlat33.xyz, u_xlat33.xyz);
    u_xlat78 = max(u_xlat78, 1.17549435e-38);
    u_xlat78 = inversesqrt(u_xlat78);
    u_xlat33.xyz = vec3(u_xlat78) * u_xlat33.xyz;
    u_xlat78 = dot(u_xlat29.xyz, u_xlat33.xyz);
    u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
    u_xlat79 = dot(_MainLightPosition.xyz, u_xlat33.xyz);
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    ...
    u_xlat33.xyz = vec3(u_xlat78) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    u_xlat30.xyz = u_xlat30.xyz * u_xlat33.xyz;
    ...
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    u_xlatb33.xy = equal(vec4(vec4(_AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat)), vec4(0.0, 1.0, 0.0, 0.0)).xy;
    u_xlat8.x = float(0.0);
    u_xlat8.y = float(0.0);
    u_xlat8.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat4.x = dot(unity_LightIndices[int(u_xlatu4)], uintBitsToFloat(ImmCB_0[u_xlati83]));
        ...
        u_xlat83 = u_xlat83 * _AdditionalLightsAttenuation[u_xlati4].x;
        u_xlat83 = (-u_xlat83) * u_xlat83 + 1.0;
        u_xlat83 = max(u_xlat83, 0.0);
        u_xlat83 = u_xlat83 * u_xlat83;
        u_xlat83 = u_xlat83 * u_xlat86;
        u_xlat86 = dot(_AdditionalLightsSpotDir[u_xlati4].xyz, u_xlat10.xyz);
        u_xlat86 = u_xlat86 * _AdditionalLightsAttenuation[u_xlati4].z + _AdditionalLightsAttenuation[u_xlati4].w;
        u_xlat86 = clamp(u_xlat86, 0.0, 1.0);
        u_xlat86 = u_xlat86 * u_xlat86;
        u_xlat83 = u_xlat83 * u_xlat86;
        u_xlati86 = int(_AdditionalShadowParams[u_xlati4].w);
        u_xlatb87 = u_xlati86>=0;
        if(u_xlatb87){
            u_xlatb87 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati4].z);
            if(u_xlatb87){
                ...
                u_xlat88 = trunc(_AdditionalShadowParams[u_xlati4].w);
            ...
            u_xlatb86 = 0.0<_AdditionalShadowParams[u_xlati4].y;
            if(u_xlatb86){
                u_xlatb86 = 1.0==_AdditionalShadowParams[u_xlati4].y;
                if(u_xlatb86){
                    ...
                    u_xlatb87 = 2.0==_AdditionalShadowParams[u_xlati4].y;
                    if(u_xlatb87){
            ...
            u_xlat87 = 1.0 + (-_AdditionalShadowParams[u_xlati4].x);
            u_xlat86 = u_xlat86 * _AdditionalShadowParams[u_xlati4].x + u_xlat87;
        ...
        u_xlati87 = 1 << (u_xlati4 & int(0x1F));
        u_xlati87 = int(uint(u_xlati87) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati87 != 0) {
            u_xlati87 = int(_AdditionalLightsLightTypes[u_xlati4]);
            u_xlati88 = (u_xlati87 != 0) ? 0 : 1;
            u_xlati11 = u_xlati4 << (2 & int(0x1F));
            if(u_xlati88 != 0) {
                ...
                u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati4].xy * u_xlat37.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati4].zw;
            } else {
                ...
                if(u_xlati87 != 0) {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati4].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati4].zw;
                } else {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati4].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati4].zw;
                }
            }
            u_xlat11 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat37.xy, 0.0);
            u_xlat87 = (u_xlatb33.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb33.x) ? u_xlat11.xyz : vec3(u_xlat87);
        } else {
            u_xlat11.x = float(1.0);
            u_xlat11.y = float(1.0);
            u_xlat11.z = float(1.0);
        }
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[u_xlati4].xyz;
        u_xlat4.x = u_xlat83 * u_xlat86;
        u_xlat83 = dot(u_xlat29.xyz, u_xlat10.xyz);
        u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
        u_xlat4.x = u_xlat4.x * u_xlat83;
        u_xlat11.xyz = u_xlat4.xxx * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat85) + u_xlat6.xyz;
        u_xlat4.x = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat4.x = max(u_xlat4.x, 1.17549435e-38);
        u_xlat4.x = inversesqrt(u_xlat4.x);
        u_xlat9.xyz = u_xlat4.xxx * u_xlat9.xyz;
        u_xlat4.x = dot(u_xlat29.xyz, u_xlat9.xyz);
    ...
    u_xlat2.xyz = u_xlat5.xyz * u_xlat7.xxx + u_xlat30.xyz;
