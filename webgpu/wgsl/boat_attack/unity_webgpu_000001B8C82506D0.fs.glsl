...
float u_xlat2;
    ...
    u_xlat0.y = u_xlat0.x * _SourceSize.w;
    u_xlat0.x = 0.0;
    u_xlat1 = vec4(0.538049996, 0.538049996, 2.0627799, 2.0627799) * u_xlat0.xyxy + vs_TEXCOORD0.xyxy;
    u_xlat0 = vec4(-0.538049996, -0.538049996, -2.0627799, -2.0627799) * u_xlat0.xyxy + vs_TEXCOORD0.xyxy;
    ...
    u_xlat0.x = u_xlat0.x * 0.44907999 + u_xlat2;
    SV_Target0 = (-u_xlat0.x) + 1.0;
    return;
}
