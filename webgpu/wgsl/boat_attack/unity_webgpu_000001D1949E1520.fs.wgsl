...
fn main_1() {
  ...
  let x_1555 : vec3<f32> = (x_1554 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1556 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1555.x, x_1555.y, x_1555.z, x_1556.w);
  let x_1558 : vec3<f32> = u_xlat0;
  let x_1560 : vec3<f32> = log2(abs(x_1558));
  let x_1561 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1560.x, x_1560.y, x_1560.z, x_1561.w);
  let x_1563 : vec4<f32> = u_xlat2;
  let x_1565 : vec3<f32> = (vec3<f32>(x_1563.x, x_1563.y, x_1563.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1566 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1565.x, x_1565.y, x_1565.z, x_1566.w);
  let x_1568 : vec4<f32> = u_xlat2;
  let x_1570 : vec3<f32> = exp2(vec3<f32>(x_1568.x, x_1568.y, x_1568.z));
  let x_1571 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1570.x, x_1570.y, x_1570.z, x_1571.w);
  let x_1573 : vec4<f32> = u_xlat2;
  let x_1576 : vec3<f32> = ((vec3<f32>(x_1573.x, x_1573.y, x_1573.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1577 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1576.x, x_1576.y, x_1576.z, x_1577.w);
  let x_1579 : vec3<f32> = u_xlat0;
  let x_1581 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1579.x, x_1579.y, x_1579.z, x_1579.x));
  u_xlatb0 = vec3<bool>(x_1581.x, x_1581.y, x_1581.z);
  let x_1584 : bool = u_xlatb0.x;
  if (x_1584) {
  ...
  u_xlat0.x = x_1593;
  let x_1596 : bool = u_xlatb0.y;
  if (x_1596) {
    let x_1601 : f32 = u_xlat1.y;
    x_1597 = x_1601;
  } else {
    let x_1604 : f32 = u_xlat2.y;
    x_1597 = x_1604;
  }
  let x_1605 : f32 = x_1597;
  u_xlat0.y = x_1605;
  let x_1608 : bool = u_xlatb0.z;
  if (x_1608) {
    let x_1613 : f32 = u_xlat1.z;
    x_1609 = x_1613;
  } else {
    let x_1616 : f32 = u_xlat2.z;
    x_1609 = x_1616;
  }
  let x_1617 : f32 = x_1609;
  u_xlat0.z = x_1617;
  let x_1619 : vec2<f32> = vs_TEXCOORD0;
  let x_1622 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1626 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1628 : vec2<f32> = ((x_1619 * vec2<f32>(x_1622.x, x_1622.y)) + vec2<f32>(x_1626.z, x_1626.w));
  let x_1629 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1628.x, x_1628.y, x_1629.z, x_1629.w);
  let x_1636 : vec4<f32> = u_xlat1;
  let x_1639 : f32 = x_26.x_GlobalMipBias.x;
  let x_1640 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1636.x, x_1636.y), x_1639);
  u_xlat15 = x_1640.w;
  let x_1642 : f32 = u_xlat15;
  u_xlat15 = ((x_1642 * 2.0f) + -1.0f);
  let x_1645 : f32 = u_xlat15;
  u_xlatb1 = (x_1645 >= 0.0f);
  let x_1647 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1647);
  let x_1650 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1650)) + 1.0f);
  let x_1654 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1654);
  let x_1656 : f32 = u_xlat15;
  u_xlat15 = (-(x_1656) + 1.0f);
  let x_1659 : f32 = u_xlat15;
  let x_1661 : f32 = u_xlat1.x;
  u_xlat15 = (x_1659 * x_1661);
  let x_1663 : vec3<f32> = u_xlat0;
  let x_1664 : vec3<f32> = (x_1663 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1665 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1664.x, x_1664.y, x_1664.z, x_1665.w);
  let x_1667 : vec3<f32> = u_xlat0;
  let x_1669 : vec3<f32> = log2(abs(x_1667));
  let x_1670 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1669.x, x_1669.y, x_1669.z, x_1670.w);
  let x_1672 : vec4<f32> = u_xlat2;
  let x_1674 : vec3<f32> = (vec3<f32>(x_1672.x, x_1672.y, x_1672.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1675 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1674.x, x_1674.y, x_1674.z, x_1675.w);
  let x_1677 : vec4<f32> = u_xlat2;
  let x_1679 : vec3<f32> = exp2(vec3<f32>(x_1677.x, x_1677.y, x_1677.z));
  let x_1680 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1679.x, x_1679.y, x_1679.z, x_1680.w);
  let x_1682 : vec4<f32> = u_xlat2;
  let x_1685 : vec3<f32> = ((vec3<f32>(x_1682.x, x_1682.y, x_1682.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1686 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1685.x, x_1685.y, x_1685.z, x_1686.w);
  let x_1688 : vec3<f32> = u_xlat0;
  let x_1690 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1688.x, x_1688.y, x_1688.z, x_1688.x));
  u_xlatb0 = vec3<bool>(x_1690.x, x_1690.y, x_1690.z);
  let x_1693 : bool = u_xlatb0.x;
  if (x_1693) {
  ...
  u_xlat0.x = x_1702;
  let x_1705 : bool = u_xlatb0.y;
  if (x_1705) {
    let x_1710 : f32 = u_xlat1.y;
    x_1706 = x_1710;
  } else {
    let x_1713 : f32 = u_xlat2.y;
    x_1706 = x_1713;
  }
  let x_1714 : f32 = x_1706;
  u_xlat0.y = x_1714;
  let x_1717 : bool = u_xlatb0.z;
  if (x_1717) {
    let x_1722 : f32 = u_xlat1.z;
    x_1718 = x_1722;
  } else {
    let x_1725 : f32 = u_xlat2.z;
    x_1718 = x_1725;
  }
  let x_1726 : f32 = x_1718;
  u_xlat0.z = x_1726;
  let x_1728 : f32 = u_xlat15;
  let x_1733 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1728, x_1728, x_1728) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1733);
  let x_1735 : vec3<f32> = u_xlat0;
  let x_1736 : vec3<f32> = (x_1735 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1737 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1736.x, x_1736.y, x_1736.z, x_1737.w);
  let x_1739 : vec3<f32> = u_xlat0;
  let x_1740 : vec3<f32> = (x_1739 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1741 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1740.x, x_1740.y, x_1740.z, x_1741.w);
  let x_1743 : vec4<f32> = u_xlat2;
  let x_1745 : vec3<f32> = (vec3<f32>(x_1743.x, x_1743.y, x_1743.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1746 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1745.x, x_1745.y, x_1745.z, x_1746.w);
  let x_1748 : vec4<f32> = u_xlat2;
  let x_1751 : vec3<f32> = log2(abs(vec3<f32>(x_1748.x, x_1748.y, x_1748.z)));
  let x_1752 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1751.x, x_1751.y, x_1751.z, x_1752.w);
  let x_1754 : vec4<f32> = u_xlat2;
  let x_1756 : vec3<f32> = (vec3<f32>(x_1754.x, x_1754.y, x_1754.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1757 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1756.x, x_1756.y, x_1756.z, x_1757.w);
  let x_1759 : vec4<f32> = u_xlat2;
  let x_1761 : vec3<f32> = exp2(vec3<f32>(x_1759.x, x_1759.y, x_1759.z));
  let x_1762 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1761.x, x_1761.y, x_1761.z, x_1762.w);
  let x_1764 : vec3<f32> = u_xlat0;
  let x_1766 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1764.x, x_1764.y, x_1764.z, x_1764.x));
  u_xlatb0 = vec3<bool>(x_1766.x, x_1766.y, x_1766.z);
  let x_1769 : bool = u_xlatb0.x;
  if (x_1769) {
    let x_1774 : f32 = u_xlat1.x;
    x_1770 = x_1774;
  } else {
    let x_1777 : f32 = u_xlat2.x;
    x_1770 = x_1777;
  }
  let x_1778 : f32 = x_1770;
  u_xlat0.x = x_1778;
  let x_1781 : bool = u_xlatb0.y;
  if (x_1781) {
    let x_1786 : f32 = u_xlat1.y;
    x_1782 = x_1786;
  } else {
    let x_1789 : f32 = u_xlat2.y;
    x_1782 = x_1789;
  }
  let x_1790 : f32 = x_1782;
  u_xlat0.y = x_1790;
  let x_1793 : bool = u_xlatb0.z;
  if (x_1793) {
    let x_1798 : f32 = u_xlat1.z;
    x_1794 = x_1798;
  } else {
    let x_1801 : f32 = u_xlat2.z;
    x_1794 = x_1801;
  }
  let x_1802 : f32 = x_1794;
  u_xlat0.z = x_1802;
  let x_1806 : vec3<f32> = u_xlat0;
  let x_1807 : vec3<f32> = max(x_1806, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1808 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1807.x, x_1807.y, x_1807.z, x_1808.w);
  SV_Target0.w = 1.0f;
  return;
}
