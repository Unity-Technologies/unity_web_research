...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1374.x, x_1374.y, x_1374.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1377 : vec4<f32> = u_xlat0;
  let x_1380 : vec3<f32> = log2(abs(vec3<f32>(x_1377.x, x_1377.y, x_1377.z)));
  let x_1381 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1380.x, x_1380.y, x_1380.z, x_1381.w);
  let x_1383 : vec4<f32> = u_xlat2;
  let x_1385 : vec3<f32> = (vec3<f32>(x_1383.x, x_1383.y, x_1383.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1386 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1385.x, x_1385.y, x_1385.z, x_1386.w);
  let x_1388 : vec4<f32> = u_xlat2;
  let x_1390 : vec3<f32> = exp2(vec3<f32>(x_1388.x, x_1388.y, x_1388.z));
  let x_1391 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1390.x, x_1390.y, x_1390.z, x_1391.w);
  let x_1393 : vec4<f32> = u_xlat2;
  let x_1396 : vec3<f32> = ((vec3<f32>(x_1393.x, x_1393.y, x_1393.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1397 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1396.x, x_1396.y, x_1396.z, x_1397.w);
  let x_1399 : vec4<f32> = u_xlat0;
  let x_1401 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1399.x, x_1399.y, x_1399.z, x_1399.x));
  u_xlatb0 = vec3<bool>(x_1401.x, x_1401.y, x_1401.z);
  let x_1404 : bool = u_xlatb0.x;
  if (x_1404) {
  ...
  u_xlat0.x = x_1413;
  let x_1416 : bool = u_xlatb0.y;
  if (x_1416) {
    let x_1421 : f32 = u_xlat1.y;
    x_1417 = x_1421;
  } else {
    let x_1424 : f32 = u_xlat2.y;
    x_1417 = x_1424;
  }
  let x_1425 : f32 = x_1417;
  u_xlat0.y = x_1425;
  let x_1428 : bool = u_xlatb0.z;
  if (x_1428) {
    let x_1433 : f32 = u_xlat1.z;
    x_1429 = x_1433;
  } else {
  ...
  u_xlat0.z = x_1437;
  let x_1439 : vec2<f32> = vs_TEXCOORD0;
  let x_1442 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1446 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1448 : vec2<f32> = ((x_1439 * vec2<f32>(x_1442.x, x_1442.y)) + vec2<f32>(x_1446.z, x_1446.w));
  let x_1449 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1448.x, x_1448.y, x_1449.z);
  let x_1456 : vec3<f32> = u_xlat1;
  let x_1459 : f32 = x_25.x_GlobalMipBias.x;
  let x_1460 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1456.x, x_1456.y), x_1459);
  u_xlat21 = x_1460.w;
  let x_1462 : f32 = u_xlat21;
  u_xlat21 = ((x_1462 * 2.0f) + -1.0f);
  let x_1465 : f32 = u_xlat21;
  u_xlatb1.x = (x_1465 >= 0.0f);
  let x_1469 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1469);
  let x_1472 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1472)) + 1.0f);
  let x_1476 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1476);
  let x_1478 : f32 = u_xlat21;
  u_xlat21 = (-(x_1478) + 1.0f);
  let x_1481 : f32 = u_xlat21;
  let x_1483 : f32 = u_xlat1.x;
  u_xlat21 = (x_1481 * x_1483);
  let x_1485 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1485.x, x_1485.y, x_1485.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1488 : vec4<f32> = u_xlat0;
  let x_1491 : vec3<f32> = log2(abs(vec3<f32>(x_1488.x, x_1488.y, x_1488.z)));
  let x_1492 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1491.x, x_1491.y, x_1491.z, x_1492.w);
  let x_1494 : vec4<f32> = u_xlat2;
  let x_1496 : vec3<f32> = (vec3<f32>(x_1494.x, x_1494.y, x_1494.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1497 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1496.x, x_1496.y, x_1496.z, x_1497.w);
  let x_1499 : vec4<f32> = u_xlat2;
  let x_1501 : vec3<f32> = exp2(vec3<f32>(x_1499.x, x_1499.y, x_1499.z));
  let x_1502 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1501.x, x_1501.y, x_1501.z, x_1502.w);
  let x_1504 : vec4<f32> = u_xlat2;
  let x_1507 : vec3<f32> = ((vec3<f32>(x_1504.x, x_1504.y, x_1504.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1508 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1507.x, x_1507.y, x_1507.z, x_1508.w);
  let x_1510 : vec4<f32> = u_xlat0;
  let x_1512 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1510.x, x_1510.y, x_1510.z, x_1510.x));
  u_xlatb0 = vec3<bool>(x_1512.x, x_1512.y, x_1512.z);
  let x_1515 : bool = u_xlatb0.x;
  if (x_1515) {
  ...
  u_xlat0.x = x_1524;
  let x_1527 : bool = u_xlatb0.y;
  if (x_1527) {
    let x_1532 : f32 = u_xlat1.y;
    x_1528 = x_1532;
  } else {
    let x_1535 : f32 = u_xlat2.y;
    x_1528 = x_1535;
  }
  let x_1536 : f32 = x_1528;
  u_xlat0.y = x_1536;
  let x_1539 : bool = u_xlatb0.z;
  if (x_1539) {
  ...
  let x_1557 : vec3<f32> = ((vec3<f32>(x_1550, x_1550, x_1550) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1555.x, x_1555.y, x_1555.z));
  let x_1558 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1557.x, x_1557.y, x_1557.z, x_1558.w);
  let x_1560 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1560.x, x_1560.y, x_1560.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1563 : vec4<f32> = u_xlat0;
  let x_1565 : vec3<f32> = (vec3<f32>(x_1563.x, x_1563.y, x_1563.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1566 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1565.x, x_1565.y, x_1565.z, x_1566.w);
  let x_1568 : vec4<f32> = u_xlat2;
  let x_1570 : vec3<f32> = (vec3<f32>(x_1568.x, x_1568.y, x_1568.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1571 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1570.x, x_1570.y, x_1570.z, x_1571.w);
  let x_1573 : vec4<f32> = u_xlat2;
  let x_1576 : vec3<f32> = log2(abs(vec3<f32>(x_1573.x, x_1573.y, x_1573.z)));
  let x_1577 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1576.x, x_1576.y, x_1576.z, x_1577.w);
  let x_1579 : vec4<f32> = u_xlat2;
  let x_1581 : vec3<f32> = (vec3<f32>(x_1579.x, x_1579.y, x_1579.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1582 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1581.x, x_1581.y, x_1581.z, x_1582.w);
  let x_1584 : vec4<f32> = u_xlat2;
  let x_1586 : vec3<f32> = exp2(vec3<f32>(x_1584.x, x_1584.y, x_1584.z));
  let x_1587 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1586.x, x_1586.y, x_1586.z, x_1587.w);
  let x_1589 : vec4<f32> = u_xlat0;
  let x_1591 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1589.x, x_1589.y, x_1589.z, x_1589.x));
  ...
  let x_1634 : vec3<f32> = max(vec3<f32>(x_1631.x, x_1631.y, x_1631.z), vec3<f32>(0.0f, 0.0f, 0.0f));
