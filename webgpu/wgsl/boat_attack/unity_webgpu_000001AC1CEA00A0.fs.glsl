...
;
    ...
    u_xlat53.x = dot(u_xlat3.xyz, u_xlat7.xyz);
    u_xlat53.x = u_xlat53.x + 0.5;
    u_xlat31.xyz = u_xlat53.xxx * u_xlat31.xyz;
    u_xlat53.x = max(u_xlat7.w, 9.99999975e-05);
    u_xlat31.xyz = u_xlat31.xyz / u_xlat53.xxx;
    u_xlat5.x = u_xlat5.x;
    ...
    if(u_xlatb78){
        ...
        if(u_xlatb78){
            ...
            if(u_xlatb33.x){
                u_xlat33.xy = u_xlat6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat33.xy = floor(u_xlat33.xy);
                u_xlat8.xy = u_xlat6.xy * _MainLightShadowmapSize.zw + (-u_xlat33.xy);
                ...
                vec3 txVec58 = vec3(u_xlat33.xy,u_xlat6.z);
    ...
    if(u_xlatb82){
        ...
        u_xlat82 = (u_xlatb6.y) ? u_xlat8.w : u_xlat8.x;
        u_xlat6.xyz = (u_xlatb6.x) ? u_xlat8.xyz : vec3(u_xlat82);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat82 = dot((-u_xlat2.xyz), u_xlat3.xyz);
    u_xlat82 = u_xlat82 + u_xlat82;
    u_xlat33.xyz = u_xlat3.xyz * (-vec3(u_xlat82)) + (-u_xlat2.xyz);
    u_xlat82 = dot(u_xlat3.xyz, u_xlat2.xyz);
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat33.xyz, u_xlat53.x);
    ...
    u_xlat78 = dot(u_xlat3.xyz, u_xlat33.xyz);
    ...
    u_xlat33.xyz = vec3(u_xlat78) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
