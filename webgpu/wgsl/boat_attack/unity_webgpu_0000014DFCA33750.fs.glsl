...
void main()
{
    ...
    u_xlat7.xyz = u_xlat15.xyz * (-vec3(u_xlat46)) + (-u_xlat6.xyz);
    u_xlat46 = dot(u_xlat15.xyz, u_xlat6.xyz);
    u_xlat46 = clamp(u_xlat46, 0.0, 1.0);
    ...
    u_xlat1 = u_xlat32 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat47 = dot(u_xlat15.xyz, u_xlat10.xyz);
