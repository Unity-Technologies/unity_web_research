...
;
    ...
    u_xlat5.xyz = vs_TEXCOORD1.yyy * _MainLightWorldToShadow[(u_xlati78 + 1) / 4][(u_xlati78 + 1) % 4].xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[u_xlati78 / 4][u_xlati78 % 4].xyz * vs_TEXCOORD1.xxx + u_xlat5.xyz;
    u_xlat5.xyz = _MainLightWorldToShadow[(u_xlati78 + 2) / 4][(u_xlati78 + 2) % 4].xyz * vs_TEXCOORD1.zzz + u_xlat5.xyz;
    ...
    u_xlat7.xyz = unity_SHC.xyz * u_xlat53.xxx + u_xlat8.xyz;
    u_xlat6.xyz = u_xlat6.xyz + u_xlat7.xyz;
    u_xlat6.xyz = max(u_xlat6.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat53.x = (-u_xlat1.x) * 0.959999979 + 0.959999979;
    u_xlat79 = (-u_xlat53.x) + 1.0;
    u_xlat28.xyz = u_xlat53.xxx * u_xlat2.yzw;
    u_xlat0.xyz = u_xlat0.xyz * _BaseColor.xyz + vec3(-0.0399999991, -0.0399999991, -0.0399999991);
    u_xlat0.xyz = u_xlat1.xxx * u_xlat0.xyz + vec3(0.0399999991, 0.0399999991, 0.0399999991);
    u_xlat1.x = (-u_xlat1.y) * _Smoothness + 1.0;
    u_xlat53.x = u_xlat1.x * u_xlat1.x;
    u_xlat53.x = max(u_xlat53.x, 0.0078125);
    u_xlat82 = u_xlat53.x * u_xlat53.x;
    u_xlat27.x = u_xlat1.y * _Smoothness + u_xlat79;
    u_xlat27.x = clamp(u_xlat27.x, 0.0, 1.0);
    u_xlat79 = u_xlat53.x * 4.0 + 2.0;
    ...
    if(u_xlatb83){
        ...
        if(u_xlatb83){
            ...
            if(u_xlatb84){
                ...
                u_xlat59.xy = u_xlat5.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                vec3 txVec6 = vec3(u_xlat59.xy,u_xlat5.z);
                ...
                vec3 txVec15 = vec3(u_xlat59.xy,u_xlat5.z);
                ...
                vec3 txVec23 = vec3(u_xlat35.xy,u_xlat5.z);
                ...
                vec3 txVec24 = vec3(u_xlat67.xy,u_xlat5.z);
                ...
                vec3 txVec27 = vec3(u_xlat62.xy,u_xlat5.z);
    ...
    u_xlatb57.x = u_xlat5.z>=1.0;
    u_xlatb31 = u_xlatb57.x || u_xlatb31;
    u_xlat5.x = (u_xlatb31) ? 1.0 : u_xlat5.x;
    u_xlat31.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    ...
    if(u_xlatb57.x){
        u_xlat57.xy = vs_TEXCOORD1.yy * _MainLightWorldToLight[1].xy;
        u_xlat57.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD1.xx + u_xlat57.xy;
        u_xlat57.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD1.zz + u_xlat57.xy;
        u_xlat57.xy = u_xlat57.xy + _MainLightWorldToLight[3].xy;
        u_xlat57.xy = u_xlat57.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat7 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat57.xy, _GlobalMipBias.x);
        ...
        u_xlat83 = (u_xlatb57.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb57.x) ? u_xlat7.xyz : vec3(u_xlat83);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat57.x = dot((-u_xlat29.xyz), u_xlat4.xyz);
    u_xlat57.x = u_xlat57.x + u_xlat57.x;
    u_xlat8.xyz = u_xlat4.xyz * (-u_xlat57.xxx) + (-u_xlat29.xyz);
    u_xlat57.x = dot(u_xlat4.xyz, u_xlat29.xyz);
    u_xlat57.x = clamp(u_xlat57.x, 0.0, 1.0);
    ...
    u_xlat1.xz = u_xlat53.xx * u_xlat53.xx + vec2(-1.0, 1.0);
    u_xlat53.x = float(1.0) / u_xlat1.z;
    u_xlat9.xyz = (-u_xlat0.xyz) + u_xlat27.xxx;
    u_xlat9.xyz = u_xlat57.xxx * u_xlat9.xyz + u_xlat0.xyz;
    u_xlat9.xyz = u_xlat53.xxx * u_xlat9.xyz;
    u_xlat8.xyz = u_xlat8.xyz * u_xlat9.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat28.xyz + u_xlat8.xyz;
    u_xlat27.x = u_xlat5.x * unity_LightData.z;
    u_xlat53.x = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    u_xlat53.x = clamp(u_xlat53.x, 0.0, 1.0);
    u_xlat27.x = u_xlat53.x * u_xlat27.x;
    u_xlat5.xzw = u_xlat27.xxx * u_xlat7.xyz;
    ...
    u_xlat27.x = clamp(u_xlat27.x, 0.0, 1.0);
    u_xlat27.y = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    ...
    u_xlat53.x = max(u_xlat27.y, 0.100000001);
    u_xlat27.x = u_xlat53.x * u_xlat27.x;
    ...
    u_xlat53.x = u_xlat31.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat53.x = clamp(u_xlat53.x, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu27 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat86 = dot(_AdditionalLightsSpotDir[u_xlati84].xyz, u_xlat10.xyz);
        u_xlat86 = u_xlat86 * _AdditionalLightsAttenuation[u_xlati84].z + _AdditionalLightsAttenuation[u_xlati84].w;
        u_xlat86 = clamp(u_xlat86, 0.0, 1.0);
        u_xlat86 = u_xlat86 * u_xlat86;
        u_xlat59.x = u_xlat59.x * u_xlat86;
        u_xlati86 = int(_AdditionalShadowParams[u_xlati84].w);
        u_xlatb87 = u_xlati86>=0;
        if(u_xlatb87){
            u_xlatb87 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati84].z);
            if(u_xlatb87){
                ...
                u_xlat88 = trunc(_AdditionalShadowParams[u_xlati84].w);
            ...
            u_xlatb86 = 0.0<_AdditionalShadowParams[u_xlati84].y;
            if(u_xlatb86){
                u_xlatb86 = 1.0==_AdditionalShadowParams[u_xlati84].y;
                if(u_xlatb86){
                    ...
                    u_xlatb87 = 2.0==_AdditionalShadowParams[u_xlati84].y;
                    if(u_xlatb87){
            ...
            u_xlat87 = 1.0 + (-_AdditionalShadowParams[u_xlati84].x);
            u_xlat86 = u_xlat86 * _AdditionalShadowParams[u_xlati84].x + u_xlat87;
        ...
        u_xlat86 = u_xlat53.x * u_xlat87 + u_xlat86;
        u_xlati87 = 1 << (u_xlati84 & int(0x1F));
        u_xlati87 = int(uint(u_xlati87) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati87 != 0) {
            u_xlati87 = int(_AdditionalLightsLightTypes[u_xlati84]);
            u_xlati88 = (u_xlati87 != 0) ? 0 : 1;
            u_xlati11 = u_xlati84 << (2 & int(0x1F));
            if(u_xlati88 != 0) {
                ...
                u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati84].xy * u_xlat37.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati84].zw;
            } else {
                ...
                if(u_xlati87 != 0) {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati84].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati84].zw;
                } else {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati84].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati84].zw;
                }
            }
        ...
        u_xlat84 = u_xlat59.x * u_xlat86;
        u_xlat59.x = dot(u_xlat4.xyz, u_xlat10.xyz);
        ...
        u_xlat84 = u_xlat84 * u_xlat1.x + 1.00001001;
        u_xlat59.x = u_xlat59.x * u_xlat59.x;
        u_xlat84 = u_xlat84 * u_xlat84;
        u_xlat59.x = max(u_xlat59.x, 0.100000001);
        u_xlat84 = u_xlat84 * u_xlat59.x;
        u_xlat84 = u_xlat79 * u_xlat84;
        u_xlat84 = u_xlat82 / u_xlat84;
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat84) + u_xlat28.xyz;
