...
@group(1) @binding(6) var<uniform> x_251 : VGlobals;
...
fn main_1() {
  ...
  let x_210 : vec3<f32> = (vec3<f32>(x_197.y, x_197.y, x_197.y) * vec3<f32>(x_208.x, x_208.y, x_208.z));
  ...
  vs_TEXCOORD8 = vec4<f32>(x_241.x, x_241.y, x_241.z, x_242.w);
  vs_TEXCOORD8.w = 0.0f;
  ...
  let x_276 : vec4<f32> = x_251.unity_MatrixVP[3i];
  gl_Position = (x_274 + x_276);
  return;
}
