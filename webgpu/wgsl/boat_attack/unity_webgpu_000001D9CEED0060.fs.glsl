...
;
    ...
    u_xlat7.xyz = u_xlat0.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat16.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat49 = dot(u_xlat3.xyz, u_xlat22.xyz);
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        ...
        u_xlat22.xyz = vec3(u_xlat49) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat16.xyz;
        u_xlat7.xyz = u_xlat22.xyz * u_xlat9.xzw + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat14.xyz * vec3(u_xlat47) + u_xlat20.xyz;
