...
void main()
{
    ...
    u_xlat3.xyz = u_xlat19.xxx * vs_INTERP4.xyz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat19.zzz * vs_INTERP9.xyz + u_xlat3.xyz;
    ...
    u_xlat19.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP0.xy, _GlobalMipBias.x).xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu29 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlatb51){
            ...
            u_xlat50 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec2, 0.0);
        ...
        u_xlat9.xyz = u_xlat6.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat15.xyz = u_xlat19.xyz * u_xlat5.xxx + u_xlat20.xyz;
    u_xlat15.xyz = u_xlat8.xyz + u_xlat15.xyz;
    SV_Target0.xyz = vs_INTERP6.www * u_xlat0.xyz + u_xlat15.xyz;
