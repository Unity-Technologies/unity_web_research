...
fn main_1() {
  ...
  let x_801 : vec3<f32> = (vec3<f32>(x_799.x, x_799.y, x_799.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_812 : vec3<f32> = (vec3<f32>(x_810.x, x_810.y, x_810.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_823 : vec3<f32> = ((vec3<f32>(x_820.x, x_820.y, x_820.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
