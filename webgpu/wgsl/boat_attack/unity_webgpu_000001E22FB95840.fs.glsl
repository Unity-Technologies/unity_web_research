...
float u_xlat14;
    ...
    u_xlat4.x = u_xlat11 * u_xlat4.x + _FaceShininess;
    ...
    u_xlat4.x = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat4.xy).w;
    ...
    u_xlat2.xyz = u_xlat4.xxx * _LightColor0.xyz;
