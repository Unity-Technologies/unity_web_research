...
@group(1) @binding(1) var<uniform> x_387 : VGlobals;
...
fn main_1() {
  ...
  u_xlat6 = ((x_63 * 0.050000001f) + 1.0f);
  ...
  u_xlat9 = max(x_305, 1.17549435e-37f);
  ...
  u_xlat2.y = ((x_329 * -0.349999994f) + 0.349999994f);
  ...
  vs_INTERP0 = vec3<f32>(x_407.x, x_407.y, x_407.z);
