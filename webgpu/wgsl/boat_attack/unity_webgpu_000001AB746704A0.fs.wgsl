...
fn main_1() {
  ...
  let x_808 : vec3<f32> = ((vec3<f32>(x_802.x, x_802.x, x_802.x) * x_804) + vec3<f32>(x_806.x, x_806.y, x_806.z));
  let x_809 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_808.x, x_808.y, x_808.z, x_809.w);
  SV_Target0.w = 1.0f;
  return;
}
