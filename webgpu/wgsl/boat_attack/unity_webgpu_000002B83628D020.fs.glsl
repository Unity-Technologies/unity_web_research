...
void main()
{
    ...
    u_xlat2.x = (u_xlatb1) ? u_xlat26.x : unity_MatrixV[0].z;
    u_xlat2.y = (u_xlatb1) ? u_xlat26.y : unity_MatrixV[1].z;
    u_xlat2.z = (u_xlatb1) ? u_xlat26.z : unity_MatrixV[2].z;
    ...
    if(u_xlatb79){
        ...
        if(u_xlatb79){
            ...
            if(u_xlatb80){
                ...
                u_xlat56.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                ...
                vec3 txVec6 = vec3(u_xlat56.xy,vs_TEXCOORD8.z);
                ...
                vec3 txVec15 = vec3(u_xlat56.xy,vs_TEXCOORD8.z);
                ...
                vec3 txVec24 = vec3(u_xlat64.xy,vs_TEXCOORD8.z);
    ...
    u_xlat81 = dot(u_xlat1.xyz, u_xlat2.xyz);
    ...
    u_xlat7.xyz = (-u_xlat5.xyz) + vec3(u_xlat77);
    u_xlat7.xyz = vec3(u_xlat81) * u_xlat7.xyz + u_xlat5.xyz;
    ...
    u_xlat77 = u_xlat80 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat77 = clamp(u_xlat77, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu50 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat82) + u_xlat2.xyz;
    ...
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat25) + u_xlat6.xyz;
