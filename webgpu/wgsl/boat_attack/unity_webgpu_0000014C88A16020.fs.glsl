...
;
    ...
    if(u_xlatb0){
        ...
        if(u_xlatb0){
            ...
            if(u_xlatb66){
                ...
                u_xlat66 = u_xlat6.z * u_xlat11.y;
                vec3 txVec4 = vec3(u_xlat9.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec4, 0.0);
                ...
                u_xlat68 = u_xlat68 * u_xlat12.y;
                u_xlat67 = u_xlat12.x * u_xlat67 + u_xlat68;
                ...
                u_xlat67 = u_xlat12.z * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat12.w * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat13.x * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat13.y * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat13.z * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat13.w * u_xlat68 + u_xlat67;
                ...
                u_xlat0.x = u_xlat66 * u_xlat68 + u_xlat67;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat49.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec14, 0.0);
                u_xlat67 = u_xlat67 * u_xlat16.y;
                u_xlat66 = u_xlat16.x * u_xlat66 + u_xlat67;
                vec3 txVec15 = vec3(u_xlat49.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec15, 0.0);
                u_xlat66 = u_xlat16.z * u_xlat67 + u_xlat66;
                vec3 txVec16 = vec3(u_xlat14.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec16, 0.0);
                u_xlat66 = u_xlat16.w * u_xlat67 + u_xlat66;
                vec3 txVec17 = vec3(u_xlat12.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec17, 0.0);
                u_xlat66 = u_xlat17.x * u_xlat67 + u_xlat66;
                vec3 txVec18 = vec3(u_xlat12.zw,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec18, 0.0);
                u_xlat66 = u_xlat17.y * u_xlat67 + u_xlat66;
                vec3 txVec19 = vec3(u_xlat13.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec19, 0.0);
                u_xlat66 = u_xlat17.z * u_xlat67 + u_xlat66;
                vec3 txVec20 = vec3(u_xlat14.zw,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec20, 0.0);
                u_xlat66 = u_xlat17.w * u_xlat67 + u_xlat66;
                vec3 txVec21 = vec3(u_xlat15.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec21, 0.0);
                u_xlat66 = u_xlat18.x * u_xlat67 + u_xlat66;
                vec3 txVec22 = vec3(u_xlat15.zw,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec22, 0.0);
                u_xlat66 = u_xlat18.y * u_xlat67 + u_xlat66;
                vec3 txVec23 = vec3(u_xlat29.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec23, 0.0);
                u_xlat66 = u_xlat18.z * u_xlat67 + u_xlat66;
                vec3 txVec24 = vec3(u_xlat57.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat66 = u_xlat18.w * u_xlat67 + u_xlat66;
                vec3 txVec25 = vec3(u_xlat10.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec25, 0.0);
                u_xlat66 = u_xlat6.x * u_xlat67 + u_xlat66;
                vec3 txVec26 = vec3(u_xlat10.zw,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec26, 0.0);
                u_xlat66 = u_xlat6.y * u_xlat67 + u_xlat66;
                vec3 txVec27 = vec3(u_xlat52.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
                u_xlat66 = u_xlat6.z * u_xlat67 + u_xlat66;
                vec3 txVec28 = vec3(u_xlat5.xy,u_xlat3.z);
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec28, 0.0);
                u_xlat0.x = u_xlat6.w * u_xlat67 + u_xlat66;
            }
        }
    } else {
    ...
    u_xlat0.x = u_xlat0.x * _MainLightShadowParams.x + u_xlat66;
    u_xlatb66 = 0.0>=u_xlat3.z;
    u_xlatb67 = u_xlat3.z>=1.0;
    u_xlatb66 = u_xlatb66 || u_xlatb67;
    u_xlat0.x = (u_xlatb66) ? 1.0 : u_xlat0.x;
    u_xlat3.xyz = vs_TEXCOORD2.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat66 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat67 = u_xlat66 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
    u_xlat68 = (-u_xlat0.x) + 1.0;
    u_xlat0.x = u_xlat67 * u_xlat68 + u_xlat0.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.xyz = (-vs_TEXCOORD2.xyz) * _AdditionalLightsPosition[u_xlati68].www + _AdditionalLightsPosition[u_xlati68].xyz;
        ...
        if(u_xlatb71){
            ...
            u_xlat7 = vs_TEXCOORD2.yyyy * _AdditionalLightsWorldToShadow[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4];
            u_xlat7 = _AdditionalLightsWorldToShadow[u_xlati70 / 4][u_xlati70 % 4] * vs_TEXCOORD2.xxxx + u_xlat7;
            u_xlat7 = _AdditionalLightsWorldToShadow[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4] * vs_TEXCOORD2.zzzz + u_xlat7;
