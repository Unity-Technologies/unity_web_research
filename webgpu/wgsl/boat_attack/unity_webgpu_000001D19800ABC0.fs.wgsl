...
fn main_1() {
  ...
  let x_758 : vec3<f32> = ((vec3<f32>(x_752.x, x_752.x, x_752.x) * x_754) + vec3<f32>(x_756.x, x_756.y, x_756.z));
  let x_759 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_758.x, x_758.y, x_758.z, x_759.w);
  SV_Target0.w = 1.0f;
  return;
}
