...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat30 = dot(unity_LightIndices[int(u_xlatu30)], uintBitsToFloat(ImmCB_0[u_xlati47]));
        ...
        u_xlat47 = u_xlat47 * _AdditionalLightsAttenuation[u_xlati30].x;
        u_xlat47 = (-u_xlat47) * u_xlat47 + 1.0;
        u_xlat47 = max(u_xlat47, 0.0);
        u_xlat47 = u_xlat47 * u_xlat47;
        u_xlat47 = u_xlat47 * u_xlat49;
        u_xlat49 = dot(_AdditionalLightsSpotDir[u_xlati30].xyz, u_xlat10.xyz);
        u_xlat49 = u_xlat49 * _AdditionalLightsAttenuation[u_xlati30].z + _AdditionalLightsAttenuation[u_xlati30].w;
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat47 = u_xlat47 * u_xlat49;
        u_xlati49 = int(_AdditionalShadowParams[u_xlati30].w);
        u_xlatb50 = u_xlati49>=0;
        if(u_xlatb50){
            u_xlatb50 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati30].z);
            if(u_xlatb50){
                ...
                u_xlat52 = trunc(_AdditionalShadowParams[u_xlati30].w);
            ...
            u_xlat50 = 1.0 + (-_AdditionalShadowParams[u_xlati30].x);
            u_xlat49 = u_xlat49 * _AdditionalShadowParams[u_xlati30].x + u_xlat50;
        ...
        u_xlati50 = 1 << (u_xlati30 & int(0x1F));
        u_xlati50 = int(uint(u_xlati50) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati50 != 0) {
            u_xlati50 = int(_AdditionalLightsLightTypes[u_xlati30]);
            u_xlati52 = (u_xlati50 != 0) ? 0 : 1;
            u_xlati11 = u_xlati30 << (2 & int(0x1F));
            if(u_xlati52 != 0) {
                ...
                u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati30].xy * u_xlat25.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati30].zw;
            } else {
                ...
                if(u_xlati50 != 0) {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati30].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati30].zw;
                } else {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati30].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati30].zw;
                }
            }
            u_xlat11 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat25.xy, 0.0);
            u_xlat50 = (u_xlatb2.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb2.x) ? u_xlat11.xyz : vec3(u_xlat50);
        } else {
