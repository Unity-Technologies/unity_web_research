...
fn main_1() {
  ...
  u_xlat0 = (vec4<f32>(x_24.y, x_24.y, x_24.y, x_24.y) * vec4<f32>(0.006f, 0.02f, 0.02f, 0.050000001f));
  ...
  u_xlat1 = (vec4<f32>(x_39.y, x_39.y, x_39.y, x_39.y) * vec4<f32>(0.012f, 0.02f, 0.059999999f, 0.024f));
  ...
  u_xlat0 = ((vec4<f32>(x_53.x, x_53.x, x_53.x, x_53.x) * vec4<f32>(1.200000048f, 2.0f, 1.600000024f, 4.800000191f)) + x_61);
  let x_63 : vec4<f32> = u_xlat0;
  u_xlat0 = fract(x_63);
  let x_65 : vec4<f32> = u_xlat0;
  u_xlat0 = ((x_65 * vec4<f32>(6.408848763f, 6.408848763f, 6.408848763f, 6.408848763f)) + vec4<f32>(-3.141592741f, -3.141592741f, -3.141592741f, -3.141592741f));
  ...
  u_xlat0 = ((x_79 * vec4<f32>(-0.161616161f, -0.161616161f, -0.161616161f, -0.161616161f)) + x_83);
  ...
  u_xlat0 = ((x_91 * vec4<f32>(0.0083333f, 0.0083333f, 0.0083333f, 0.0083333f)) + x_95);
  let x_97 : vec4<f32> = u_xlat1;
  let x_101 : vec4<f32> = u_xlat0;
  u_xlat0 = ((x_97 * vec4<f32>(-0.00019841f, -0.00019841f, -0.00019841f, -0.00019841f)) + x_101);
  ...
  u_xlat1.x = dot(x_109, vec4<f32>(0.674199879f, 0.674199879f, 0.269679934f, 0.134839967f));
  let x_120 : f32 = u_xlat1.x;
  u_xlat1.x = (x_120 * 0.699999988f);
  ...
  u_xlat1.x = dot(x_173, vec4<f32>(0.024f, 0.039999999f, -0.119999997f, 0.096000001f));
  let x_180 : vec4<f32> = u_xlat0;
  u_xlat1.z = dot(x_180, vec4<f32>(0.006f, 0.02f, -0.02f, 0.100000001f));
