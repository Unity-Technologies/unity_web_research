...
layout(location = 0) out highp vec2 vs_INTERP0;
layout(location = 1) out highp vec4 vs_INTERP3;
layout(location = 2) out highp vec4 vs_INTERP4;
layout(location = 3) out highp vec4 vs_INTERP5;
layout(location = 4) out highp vec4 vs_INTERP6;
highp vec4 vs_INTERP7;
layout(location = 5) out highp vec3 vs_INTERP8;
layout(location = 6) out highp vec3 vs_INTERP9;
vec4 u_xlat0;
vec4 u_xlat1;
vec4 u_xlat2;
vec2 u_xlat3;
...
void main()
{
    ...
    vs_INTERP9.xyz = vec3(u_xlat13) * u_xlat2.xyz;
    ...
    vs_INTERP3.xyz = u_xlat1.xyz + _MainLightWorldToShadow[3 / 4][3 % 4].xyz;
    vs_INTERP3.w = 0.0;
