...
;
    ...
    u_xlatb31 = 0.0<_MainLightShadowParams.y;
    if(u_xlatb31){
        u_xlatb31 = _MainLightShadowParams.y==1.0;
        if(u_xlatb31){
    ...
    u_xlat31.xyz = u_xlat25.xyz * (-vec3(u_xlat54)) + (-u_xlat1.xyz);
    u_xlat54 = dot(u_xlat25.xyz, u_xlat1.xyz);
    u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
    u_xlat54 = (-u_xlat54) + 1.0;
    u_xlat54 = u_xlat54 * u_xlat54;
    u_xlat54 = u_xlat54 * u_xlat54;
    u_xlat7.x = (-u_xlat76) * 0.699999988 + 1.70000005;
    u_xlat76 = u_xlat76 * u_xlat7.x;
    u_xlat76 = u_xlat76 * 6.0;
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat31.xyz, u_xlat76);
    ...
    u_xlat31.xyz = u_xlat7.xyz * vec3(u_xlat76);
    u_xlat7.xy = vec2(u_xlat78) * vec2(u_xlat78) + vec2(-1.0, 1.0);
    u_xlat76 = float(1.0) / u_xlat7.y;
    u_xlat32.xyz = (-u_xlat2.xyz) + u_xlat0.xxx;
    u_xlat32.xyz = vec3(u_xlat54) * u_xlat32.xyz + u_xlat2.xyz;
    u_xlat32.xyz = vec3(u_xlat76) * u_xlat32.xyz;
    u_xlat31.xyz = u_xlat31.xyz * u_xlat32.xyz;
    u_xlat5.xyz = u_xlat5.xyz * u_xlat3.xyz + u_xlat31.xyz;
    ...
    u_xlat32.xyz = u_xlat1.xyz + _MainLightPosition.xyz;
    ...
    u_xlat32.xyz = u_xlat2.xyz * u_xlat0.xxx + u_xlat3.xyz;
    u_xlat31.xyz = u_xlat31.xyz * u_xlat32.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat32.x = dot(unity_LightIndices[int(u_xlatu32)], uintBitsToFloat(ImmCB_0[u_xlati57]));
        u_xlati32 = int(u_xlat32.x);
        u_xlat8.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati32].www + _AdditionalLightsPosition[u_xlati32].xyz;
        u_xlat57.x = dot(u_xlat8.xyz, u_xlat8.xyz);
        u_xlat57.x = max(u_xlat57.x, 6.10351562e-05);
        u_xlat82 = inversesqrt(u_xlat57.x);
        u_xlat9.xyz = vec3(u_xlat82) * u_xlat8.xyz;
        u_xlat83 = float(1.0) / float(u_xlat57.x);
        u_xlat57.x = u_xlat57.x * _AdditionalLightsAttenuation[u_xlati32].x;
        u_xlat57.x = (-u_xlat57.x) * u_xlat57.x + 1.0;
        u_xlat57.x = max(u_xlat57.x, 0.0);
        u_xlat57.x = u_xlat57.x * u_xlat57.x;
        u_xlat57.x = u_xlat57.x * u_xlat83;
        u_xlat83 = dot(_AdditionalLightsSpotDir[u_xlati32].xyz, u_xlat9.xyz);
        u_xlat83 = u_xlat83 * _AdditionalLightsAttenuation[u_xlati32].z + _AdditionalLightsAttenuation[u_xlati32].w;
        u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
        u_xlat83 = u_xlat83 * u_xlat83;
        u_xlat57.x = u_xlat57.x * u_xlat83;
        u_xlati83 = int(_AdditionalShadowParams[u_xlati32].w);
        u_xlatb84 = u_xlati83>=0;
        if(u_xlatb84){
            u_xlatb84 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati32].z);
            if(u_xlatb84){
                ...
                u_xlat10.x = trunc(_AdditionalShadowParams[u_xlati32].w);
                u_xlat84 = u_xlat84 + u_xlat10.x;
                u_xlati83 = int(u_xlat84);
            }
            u_xlati83 = u_xlati83 << (2 & int(0x1F));
            u_xlat10 = vs_INTERP7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati83 + 1) / 4][(u_xlati83 + 1) % 4];
            u_xlat10 = _AdditionalLightsWorldToShadow[u_xlati83 / 4][u_xlati83 % 4] * vs_INTERP7.xxxx + u_xlat10;
            u_xlat10 = _AdditionalLightsWorldToShadow[(u_xlati83 + 2) / 4][(u_xlati83 + 2) % 4] * vs_INTERP7.zzzz + u_xlat10;
            u_xlat10 = u_xlat10 + _AdditionalLightsWorldToShadow[(u_xlati83 + 3) / 4][(u_xlati83 + 3) % 4];
            u_xlat10.xyz = u_xlat10.xyz / u_xlat10.www;
            u_xlatb83 = 0.0<_AdditionalShadowParams[u_xlati32].y;
            if(u_xlatb83){
                u_xlatb83 = 1.0==_AdditionalShadowParams[u_xlati32].y;
                if(u_xlatb83){
                    ...
                    u_xlatb84 = 2.0==_AdditionalShadowParams[u_xlati32].y;
                    if(u_xlatb84){
            ...
            u_xlat84 = 1.0 + (-_AdditionalShadowParams[u_xlati32].x);
            u_xlat83 = u_xlat83 * _AdditionalShadowParams[u_xlati32].x + u_xlat84;
        ...
        u_xlat83 = u_xlat76 * u_xlat84 + u_xlat83;
        u_xlat57.x = u_xlat57.x * u_xlat83;
        u_xlat83 = dot(u_xlat25.xyz, u_xlat9.xyz);
        u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
        u_xlat57.x = u_xlat57.x * u_xlat83;
        u_xlat10.xyz = u_xlat57.xxx * _AdditionalLightsColor[u_xlati32].xyz;
        u_xlat32.xyz = u_xlat8.xyz * vec3(u_xlat82) + u_xlat1.xyz;
        u_xlat8.x = dot(u_xlat32.xyz, u_xlat32.xyz);
        u_xlat8.x = max(u_xlat8.x, 1.17549435e-38);
        u_xlat8.x = inversesqrt(u_xlat8.x);
        u_xlat32.xyz = u_xlat32.xyz * u_xlat8.xxx;
        u_xlat8.x = dot(u_xlat25.xyz, u_xlat32.xyz);
        u_xlat8.x = clamp(u_xlat8.x, 0.0, 1.0);
        u_xlat32.x = dot(u_xlat9.xyz, u_xlat32.xyz);
        u_xlat32.x = clamp(u_xlat32.x, 0.0, 1.0);
        u_xlat57.x = u_xlat8.x * u_xlat8.x;
        u_xlat57.x = u_xlat57.x * u_xlat7.x + 1.00001001;
        u_xlat32.x = u_xlat32.x * u_xlat32.x;
        u_xlat57.x = u_xlat57.x * u_xlat57.x;
        u_xlat32.x = max(u_xlat32.x, 0.100000001);
        u_xlat32.x = u_xlat32.x * u_xlat57.x;
        u_xlat32.x = u_xlat80 * u_xlat32.x;
        u_xlat32.x = u_xlat79 / u_xlat32.x;
        u_xlat32.xyz = u_xlat2.xyz * u_xlat32.xxx + u_xlat3.xyz;
        u_xlat4.xyz = u_xlat32.xyz * u_xlat10.xyz + u_xlat4.xyz;
    }
