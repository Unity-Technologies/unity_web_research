...
;
    ...
    u_xlat23.xyz = u_xlat16.xxx * u_xlat23.xyz + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat43 = dot(unity_LightIndices[int(u_xlatu43)], uintBitsToFloat(ImmCB_0[u_xlati46]));
        u_xlatu43 =  uint(int(u_xlat43));
        u_xlat23.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu43)].www + _AdditionalLightsPosition[int(u_xlatu43)].xyz;
        ...
        u_xlat46 = u_xlat46 * _AdditionalLightsAttenuation[int(u_xlatu43)].x;
        u_xlat46 = (-u_xlat46) * u_xlat46 + 1.0;
        u_xlat46 = max(u_xlat46, 0.0);
        u_xlat46 = u_xlat46 * u_xlat46;
        u_xlat46 = u_xlat46 * u_xlat48;
        u_xlat48 = dot(_AdditionalLightsSpotDir[int(u_xlatu43)].xyz, u_xlat10.xyz);
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[int(u_xlatu43)].z + _AdditionalLightsAttenuation[int(u_xlatu43)].w;
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        u_xlat48 = u_xlat48 * u_xlat48;
        u_xlat46 = u_xlat46 * u_xlat48;
        u_xlatu48 = u_xlatu43 >> (5u & uint(0x1F));
        u_xlati49 = 1 << (int(u_xlatu43) & int(0x1F));
        u_xlati48 = int(uint(u_xlati49) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu48)]));
        if(u_xlati48 != 0) {
            u_xlati48 = int(_AdditionalLightsLightTypes[int(u_xlatu43)]);
            u_xlati49 = (u_xlati48 != 0) ? 0 : 1;
            u_xlati50 = int(u_xlatu43) << (2 & int(0x1F));
            if(u_xlati49 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu43)].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu43)].zw;
            } else {
                ...
                if(u_xlati48 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu43)].xy * u_xlat39.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu43)].zw;
                } else {
            ...
            u_xlat48 = (u_xlatb4.z) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb4.x) ? u_xlat11.xyz : vec3(u_xlat48);
        } else {
            u_xlat11.x = float(1.0);
            u_xlat11.y = float(1.0);
            u_xlat11.z = float(1.0);
        }
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[int(u_xlatu43)].xyz;
        ...
        u_xlat43 = dot(u_xlat1.xyz, u_xlat23.xyz);
        u_xlat43 = clamp(u_xlat43, 0.0, 1.0);
        ...
        u_xlat23.xyz = u_xlat5.xyz * vec3(u_xlat43) + u_xlat6.xyz;
