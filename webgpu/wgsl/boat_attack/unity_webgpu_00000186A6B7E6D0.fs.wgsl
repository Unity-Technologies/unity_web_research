...
fn main_1() {
  ...
  let x_1750 : vec3<f32> = u_xlat0;
  let x_1752 : vec4<f32> = u_xlat1;
  let x_1755 : vec3<f32> = u_xlat7;
  let x_1756 : vec3<f32> = ((vec3<f32>(x_1750.x, x_1750.x, x_1750.x) * vec3<f32>(x_1752.x, x_1752.y, x_1752.z)) + x_1755);
  let x_1757 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1756.x, x_1756.y, x_1756.z, x_1757.w);
  SV_Target0.w = 1.0f;
  return;
}
