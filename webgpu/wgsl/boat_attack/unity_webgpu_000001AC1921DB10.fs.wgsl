...
fn main_1() {
  ...
  let x_1369 : bool = u_xlatb0.x;
  if (x_1369) {
    let x_1374 : f32 = u_xlat1.x;
    x_1370 = x_1374;
  } else {
    let x_1377 : f32 = u_xlat2.x;
    x_1370 = x_1377;
  }
  let x_1378 : f32 = x_1370;
  SV_Target0.x = x_1378;
  let x_1382 : bool = u_xlatb0.y;
  if (x_1382) {
    let x_1387 : f32 = u_xlat1.y;
    x_1383 = x_1387;
  } else {
    let x_1390 : f32 = u_xlat2.y;
    x_1383 = x_1390;
  }
  let x_1391 : f32 = x_1383;
  SV_Target0.y = x_1391;
  let x_1394 : bool = u_xlatb0.z;
  if (x_1394) {
    let x_1399 : f32 = u_xlat1.z;
    x_1395 = x_1399;
  } else {
