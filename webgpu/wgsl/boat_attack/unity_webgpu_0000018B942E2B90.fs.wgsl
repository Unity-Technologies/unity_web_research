...
fn main_1() {
  ...
  let x_1700 : vec3<f32> = ((x_1695 * vec3<f32>(x_1696.x, x_1696.x, x_1696.x)) + x_1699);
  let x_1701 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1700.x, x_1700.y, x_1700.z, x_1701.w);
  SV_Target0.w = 1.0f;
  return;
}
