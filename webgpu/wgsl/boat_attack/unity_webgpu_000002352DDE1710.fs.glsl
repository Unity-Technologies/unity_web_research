...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat43 = dot(unity_LightIndices[int(u_xlatu43)], uintBitsToFloat(ImmCB_0[u_xlati47]));
        ...
        u_xlat47 = u_xlat47 * u_xlat49;
        u_xlat10.xyz = vec3(u_xlat18) * _AdditionalLightsColor[u_xlati43].xyz;
        u_xlat43 = dot(u_xlat1.xyz, u_xlat23.xyz);
        u_xlat43 = clamp(u_xlat43, 0.0, 1.0);
        u_xlat43 = u_xlat43 * u_xlat47;
        u_xlat10.xyz = vec3(u_xlat43) * u_xlat10.xyz;
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat48) + u_xlat7.xyz;
        ...
        u_xlat43 = clamp(u_xlat43, 0.0, 1.0);
        u_xlat47 = dot(u_xlat23.xyz, u_xlat8.xyz);
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat43) + u_xlat6.xyz;
