...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat5.x = (u_xlatb11.x) ? u_xlat1.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb11.x) ? u_xlat1.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb11.x) ? u_xlat1.z : unity_MatrixV[2].z;
    u_xlat11.xyz = vs_INTERP0.xyz + (-_CascadeShadowSplitSpheres0.xyz);
...
;
    u_xlat11.x = (u_xlatb6.x) ? float(-1.0) : float(-0.0);
    u_xlat11.y = (u_xlatb6.y) ? float(-1.0) : float(-0.0);
    u_xlat11.z = (u_xlatb6.z) ? float(-1.0) : float(-0.0);
    u_xlat11.xyz = u_xlat11.xyz + u_xlat8.yzw;
    u_xlat8.yzw = max(u_xlat11.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat11.x = dot(u_xlat8, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat11.x = (-u_xlat11.x) + 4.0;
    u_xlatu11 = uint(u_xlat11.x);
    u_xlati11 = int(u_xlatu11) << (2 & int(0x1F));
    u_xlat1.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati11 + 1) / 4][(u_xlati11 + 1) % 4].xyz;
    u_xlat1.xyz = _MainLightWorldToShadow[u_xlati11 / 4][u_xlati11 % 4].xyz * vs_INTERP0.xxx + u_xlat1.xyz;
    u_xlat1.xyz = _MainLightWorldToShadow[(u_xlati11 + 2) / 4][(u_xlati11 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat1.xyz;
    u_xlat11.xyz = u_xlat1.xyz + _MainLightWorldToShadow[(u_xlati11 + 3) / 4][(u_xlati11 + 3) % 4].xyz;
    u_xlat4.w = 1.0;
    ...
    u_xlat6.xyz = unity_SHC.xyz * vec3(u_xlat35) + u_xlat8.xyz;
    ...
    u_xlat7.xyz = u_xlat4.xyz * (-vec3(u_xlat22)) + (-u_xlat5.xyz);
    ...
    u_xlat19.xyz = vec3(u_xlat22) * u_xlat19.xyz + u_xlat2.xyz;
    u_xlat0.xzw = vec3(u_xlat33) * u_xlat19.xyz;
    ...
    u_xlat1.xyz = u_xlat11.xxx * u_xlat17.xyz;
    ...
    u_xlat34 = dot(_MainLightPosition.xyz, u_xlat17.xyz);
    ...
    u_xlat17.xyz = u_xlat2.xyz * u_xlat11.xxx + u_xlat3.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu11 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat35 = dot(unity_LightIndices[int(u_xlatu35)], uintBitsToFloat(ImmCB_0[u_xlati7]));
        u_xlati35 = int(u_xlat35);
        u_xlat7.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati35].www + _AdditionalLightsPosition[u_xlati35].xyz;
        u_xlat40 = dot(u_xlat7.xyz, u_xlat7.xyz);
        u_xlat40 = max(u_xlat40, 6.10351562e-05);
        u_xlat19.x = inversesqrt(u_xlat40);
        u_xlat9.xyz = u_xlat7.xyz * u_xlat19.xxx;
        u_xlat30 = float(1.0) / float(u_xlat40);
        u_xlat40 = u_xlat40 * _AdditionalLightsAttenuation[u_xlati35].x;
        u_xlat40 = (-u_xlat40) * u_xlat40 + 1.0;
        u_xlat40 = max(u_xlat40, 0.0);
        u_xlat40 = u_xlat40 * u_xlat40;
        u_xlat40 = u_xlat40 * u_xlat30;
        u_xlat30 = dot(_AdditionalLightsSpotDir[u_xlati35].xyz, u_xlat9.xyz);
        u_xlat30 = u_xlat30 * _AdditionalLightsAttenuation[u_xlati35].z + _AdditionalLightsAttenuation[u_xlati35].w;
        u_xlat30 = clamp(u_xlat30, 0.0, 1.0);
        u_xlat30 = u_xlat30 * u_xlat30;
        u_xlat40 = u_xlat40 * u_xlat30;
        u_xlat10.xyz = u_xlat6.xxx * _AdditionalLightsColor[u_xlati35].xyz;
        u_xlat35 = dot(u_xlat4.xyz, u_xlat9.xyz);
        u_xlat35 = clamp(u_xlat35, 0.0, 1.0);
        u_xlat35 = u_xlat35 * u_xlat40;
        u_xlat10.xyz = vec3(u_xlat35) * u_xlat10.xyz;
        u_xlat7.xyz = u_xlat7.xyz * u_xlat19.xxx + u_xlat5.xyz;
        ...
        u_xlat7.xyz = u_xlat2.xyz * vec3(u_xlat35) + u_xlat3.xyz;
        u_xlat17.xyz = u_xlat7.xyz * u_xlat10.xyz + u_xlat17.xyz;
    }
    u_xlat0.xyz = u_xlat0.xzw * vec3(u_xlat38) + u_xlat1.xyz;
