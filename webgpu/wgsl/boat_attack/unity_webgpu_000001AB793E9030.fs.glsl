...
layout(set = 0, binding = 19) uniform mediump  sampler sampler_ScreenSpaceOcclusionTexture;
layout(set = 0, binding = 20) uniform mediump  samplerShadow sampler_MainLightShadowmapTexture;
void main()
{
vec3 u_xlat0;
vec4 u_xlat1;
