...
;
    ...
    u_xlat3.x = u_xlat31 * u_xlat46 + u_xlat3.x;
    ...
    u_xlat8.xyz = u_xlat1.xyz * (-vec3(u_xlat31)) + (-u_xlat2.xyz);
    ...
    u_xlat9.xy = vec2(u_xlat43) * vec2(u_xlat43) + vec2(-1.0, 1.0);
    u_xlat0.x = float(1.0) / u_xlat9.y;
    u_xlat23.xyz = (-u_xlat5.xyz) + vec3(u_xlat28);
    u_xlat23.xyz = vec3(u_xlat31) * u_xlat23.xyz + u_xlat5.xyz;
    ...
    u_xlat28 = u_xlat17 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat28 = clamp(u_xlat28, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat31 = dot(unity_LightIndices[int(u_xlatu31)], uintBitsToFloat(ImmCB_0[u_xlati46]));
        u_xlati31 = int(u_xlat31);
        u_xlat23.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati31].www + _AdditionalLightsPosition[u_xlati31].xyz;
        ...
        u_xlat48 = dot(_AdditionalLightsSpotDir[u_xlati31].xyz, u_xlat10.xyz);
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[u_xlati31].z + _AdditionalLightsAttenuation[u_xlati31].w;
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        u_xlat48 = u_xlat48 * u_xlat48;
        u_xlat46 = u_xlat46 * u_xlat48;
        u_xlati48 = int(_AdditionalShadowParams[u_xlati31].w);
        u_xlatb49 = u_xlati48>=0;
        if(u_xlatb49){
            u_xlatb49 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati31].z);
            if(u_xlatb49){
                ...
                u_xlat50 = trunc(_AdditionalShadowParams[u_xlati31].w);
                u_xlat49 = u_xlat49 + u_xlat50;
                u_xlati48 = int(u_xlat49);
            }
            u_xlati48 = u_xlati48 << (2 & int(0x1F));
            u_xlat11 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati48 + 1) / 4][(u_xlati48 + 1) % 4];
            u_xlat11 = _AdditionalLightsWorldToShadow[u_xlati48 / 4][u_xlati48 % 4] * vs_TEXCOORD7.xxxx + u_xlat11;
            u_xlat11 = _AdditionalLightsWorldToShadow[(u_xlati48 + 2) / 4][(u_xlati48 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat11;
            ...
            u_xlat49 = 1.0 + (-_AdditionalShadowParams[u_xlati31].x);
            u_xlat48 = u_xlat48 * _AdditionalShadowParams[u_xlati31].x + u_xlat49;
        ...
        u_xlat48 = u_xlat28 * u_xlat49 + u_xlat48;
        u_xlati49 = 1 << (u_xlati31 & int(0x1F));
        u_xlati49 = int(uint(u_xlati49) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati49 != 0) {
            u_xlati49 = int(_AdditionalLightsLightTypes[u_xlati31]);
            u_xlati50 = (u_xlati49 != 0) ? 0 : 1;
            u_xlati52 = u_xlati31 << (2 & int(0x1F));
            if(u_xlati50 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati31].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati31].zw;
            } else {
                ...
                if(u_xlati49 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati31].xy * u_xlat39.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati31].zw;
                } else {
            ...
            u_xlat49 = (u_xlatb3.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat49);
        } else {
        ...
        u_xlat23.xyz = u_xlat5.xyz * vec3(u_xlat31) + u_xlat6.xyz;
