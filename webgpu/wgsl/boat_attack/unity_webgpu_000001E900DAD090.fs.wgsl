...
fn main_1() {
  ...
  let x_2030 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2034 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_2048 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2044.x, x_2044.y), x_2047);
  u_xlat18 = x_2048.w;
  let x_2050 : f32 = u_xlat18;
  u_xlat18 = ((x_2050 * 2.0f) + -1.0f);
  let x_2053 : f32 = u_xlat18;
  u_xlatb1 = (x_2053 >= 0.0f);
  let x_2055 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2055);
  let x_2058 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2058)) + 1.0f);
  let x_2062 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2062);
  let x_2064 : f32 = u_xlat18;
  u_xlat18 = (-(x_2064) + 1.0f);
  let x_2067 : f32 = u_xlat18;
  let x_2069 : f32 = u_xlat1.x;
  u_xlat18 = (x_2067 * x_2069);
  let x_2071 : vec4<f32> = u_xlat0;
  let x_2073 : vec3<f32> = (vec3<f32>(x_2071.x, x_2071.y, x_2071.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2074 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2073.x, x_2073.y, x_2073.z, x_2074.w);
  let x_2076 : vec4<f32> = u_xlat0;
  let x_2079 : vec3<f32> = log2(abs(vec3<f32>(x_2076.x, x_2076.y, x_2076.z)));
  let x_2080 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2079.x, x_2079.y, x_2079.z, x_2080.w);
  let x_2082 : vec4<f32> = u_xlat2;
  let x_2084 : vec3<f32> = (vec3<f32>(x_2082.x, x_2082.y, x_2082.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2085 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2084.x, x_2084.y, x_2084.z, x_2085.w);
  let x_2087 : vec4<f32> = u_xlat2;
  let x_2089 : vec3<f32> = exp2(vec3<f32>(x_2087.x, x_2087.y, x_2087.z));
  let x_2090 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2089.x, x_2089.y, x_2089.z, x_2090.w);
  let x_2092 : vec4<f32> = u_xlat2;
  let x_2095 : vec3<f32> = ((vec3<f32>(x_2092.x, x_2092.y, x_2092.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2096 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2095.x, x_2095.y, x_2095.z, x_2096.w);
  let x_2098 : vec4<f32> = u_xlat0;
  let x_2100 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2098.x, x_2098.y, x_2098.z, x_2098.x));
  u_xlatb0 = vec3<bool>(x_2100.x, x_2100.y, x_2100.z);
  let x_2103 : bool = u_xlatb0.x;
  if (x_2103) {
    let x_2108 : f32 = u_xlat1.x;
    x_2104 = x_2108;
  } else {
    let x_2111 : f32 = u_xlat2.x;
    x_2104 = x_2111;
  }
  let x_2112 : f32 = x_2104;
  u_xlat0.x = x_2112;
  let x_2115 : bool = u_xlatb0.y;
  if (x_2115) {
    let x_2120 : f32 = u_xlat1.y;
    x_2116 = x_2120;
  } else {
    let x_2123 : f32 = u_xlat2.y;
    x_2116 = x_2123;
  }
  let x_2124 : f32 = x_2116;
  u_xlat0.y = x_2124;
  let x_2127 : bool = u_xlatb0.z;
  if (x_2127) {
  ...
  let x_2145 : vec3<f32> = ((vec3<f32>(x_2138, x_2138, x_2138) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2143.x, x_2143.y, x_2143.z));
  let x_2146 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2145.x, x_2145.y, x_2145.z, x_2146.w);
  let x_2148 : vec4<f32> = u_xlat0;
  let x_2150 : vec3<f32> = (vec3<f32>(x_2148.x, x_2148.y, x_2148.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2151 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2150.x, x_2150.y, x_2150.z, x_2151.w);
  let x_2153 : vec4<f32> = u_xlat0;
  let x_2155 : vec3<f32> = (vec3<f32>(x_2153.x, x_2153.y, x_2153.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2156 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2155.x, x_2155.y, x_2155.z, x_2156.w);
  let x_2158 : vec4<f32> = u_xlat2;
  let x_2160 : vec3<f32> = (vec3<f32>(x_2158.x, x_2158.y, x_2158.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2161 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2160.x, x_2160.y, x_2160.z, x_2161.w);
  let x_2163 : vec4<f32> = u_xlat2;
  let x_2166 : vec3<f32> = log2(abs(vec3<f32>(x_2163.x, x_2163.y, x_2163.z)));
  let x_2167 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2166.x, x_2166.y, x_2166.z, x_2167.w);
  let x_2169 : vec4<f32> = u_xlat2;
  let x_2171 : vec3<f32> = (vec3<f32>(x_2169.x, x_2169.y, x_2169.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2172 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2171.x, x_2171.y, x_2171.z, x_2172.w);
  let x_2174 : vec4<f32> = u_xlat2;
  let x_2176 : vec3<f32> = exp2(vec3<f32>(x_2174.x, x_2174.y, x_2174.z));
  let x_2177 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2176.x, x_2176.y, x_2176.z, x_2177.w);
  let x_2179 : vec4<f32> = u_xlat0;
  let x_2181 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2179.x, x_2179.y, x_2179.z, x_2179.x));
  u_xlatb0 = vec3<bool>(x_2181.x, x_2181.y, x_2181.z);
  let x_2184 : bool = u_xlatb0.x;
  if (x_2184) {
  ...
  u_xlat0.x = x_2193;
  let x_2196 : bool = u_xlatb0.y;
  if (x_2196) {
    let x_2201 : f32 = u_xlat1.y;
    x_2197 = x_2201;
  } else {
    let x_2204 : f32 = u_xlat2.y;
    x_2197 = x_2204;
  }
  let x_2205 : f32 = x_2197;
  u_xlat0.y = x_2205;
  let x_2208 : bool = u_xlatb0.z;
  if (x_2208) {
    let x_2213 : f32 = u_xlat1.z;
    x_2209 = x_2213;
  } else {
  ...
  let x_2223 : vec3<f32> = max(vec3<f32>(x_2221.x, x_2221.y, x_2221.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2224 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2223.x, x_2223.y, x_2223.z, x_2224.w);
  SV_Target0.w = 1.0f;
  return;
}
