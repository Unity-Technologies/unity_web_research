...
fn main_1() {
  ...
  let x_1515 : vec3<f32> = (vec3<f32>(x_1513.x, x_1513.y, x_1513.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1526 : vec3<f32> = (vec3<f32>(x_1524.x, x_1524.y, x_1524.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1537 : vec3<f32> = ((vec3<f32>(x_1534.x, x_1534.y, x_1534.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1538 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1537.x, x_1537.y, x_1537.z, x_1538.w);
  let x_1540 : vec4<f32> = u_xlat0;
  let x_1542 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1540.x, x_1540.y, x_1540.z, x_1540.x));
  ...
  let x_1587 : vec3<f32> = ((vec3<f32>(x_1580, x_1580, x_1580) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1585.x, x_1585.y, x_1585.z));
  let x_1588 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1587.x, x_1587.y, x_1587.z, x_1588.w);
  let x_1590 : vec4<f32> = u_xlat0;
  let x_1592 : vec3<f32> = (vec3<f32>(x_1590.x, x_1590.y, x_1590.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1593 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1592.x, x_1592.y, x_1592.z, x_1593.w);
  let x_1595 : vec4<f32> = u_xlat0;
  let x_1597 : vec3<f32> = (vec3<f32>(x_1595.x, x_1595.y, x_1595.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
