...
fn main_1() {
  ...
  let x_1756 : vec2<f32> = vs_TEXCOORD0;
  let x_1759 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1763 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1765 : vec2<f32> = ((x_1756 * vec2<f32>(x_1759.x, x_1759.y)) + vec2<f32>(x_1763.z, x_1763.w));
  let x_1766 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1765.x, x_1765.y, x_1766.z, x_1766.w);
  let x_1773 : vec4<f32> = u_xlat1;
  let x_1776 : f32 = x_38.x_GlobalMipBias.x;
  let x_1777 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1773.x, x_1773.y), x_1776);
  u_xlat18 = x_1777.w;
  let x_1779 : f32 = u_xlat18;
  u_xlat18 = ((x_1779 * 2.0f) + -1.0f);
  let x_1782 : f32 = u_xlat18;
  u_xlatb1 = (x_1782 >= 0.0f);
  let x_1784 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1784);
  let x_1787 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1787)) + 1.0f);
  let x_1791 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1791);
  let x_1793 : f32 = u_xlat18;
  u_xlat18 = (-(x_1793) + 1.0f);
  let x_1796 : f32 = u_xlat18;
  let x_1798 : f32 = u_xlat1.x;
  u_xlat18 = (x_1796 * x_1798);
  let x_1800 : vec4<f32> = u_xlat0;
  let x_1802 : vec3<f32> = (vec3<f32>(x_1800.x, x_1800.y, x_1800.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1803 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1802.x, x_1802.y, x_1802.z, x_1803.w);
  let x_1805 : vec4<f32> = u_xlat0;
  let x_1808 : vec3<f32> = log2(abs(vec3<f32>(x_1805.x, x_1805.y, x_1805.z)));
  let x_1809 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1808.x, x_1808.y, x_1808.z, x_1809.w);
  let x_1811 : vec4<f32> = u_xlat2;
  let x_1813 : vec3<f32> = (vec3<f32>(x_1811.x, x_1811.y, x_1811.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1814 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1813.x, x_1813.y, x_1813.z, x_1814.w);
  let x_1816 : vec4<f32> = u_xlat2;
  let x_1818 : vec3<f32> = exp2(vec3<f32>(x_1816.x, x_1816.y, x_1816.z));
  let x_1819 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1818.x, x_1818.y, x_1818.z, x_1819.w);
  let x_1821 : vec4<f32> = u_xlat2;
  let x_1824 : vec3<f32> = ((vec3<f32>(x_1821.x, x_1821.y, x_1821.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1825 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1824.x, x_1824.y, x_1824.z, x_1825.w);
  let x_1827 : vec4<f32> = u_xlat0;
  let x_1829 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1827.x, x_1827.y, x_1827.z, x_1827.x));
  u_xlatb0 = vec3<bool>(x_1829.x, x_1829.y, x_1829.z);
  let x_1832 : bool = u_xlatb0.x;
  if (x_1832) {
    let x_1837 : f32 = u_xlat1.x;
    x_1833 = x_1837;
  } else {
    let x_1840 : f32 = u_xlat2.x;
    x_1833 = x_1840;
  }
  let x_1841 : f32 = x_1833;
  u_xlat0.x = x_1841;
  let x_1844 : bool = u_xlatb0.y;
  if (x_1844) {
    let x_1849 : f32 = u_xlat1.y;
    x_1845 = x_1849;
  } else {
    let x_1852 : f32 = u_xlat2.y;
    x_1845 = x_1852;
  }
  let x_1853 : f32 = x_1845;
  u_xlat0.y = x_1853;
  let x_1856 : bool = u_xlatb0.z;
  if (x_1856) {
    let x_1861 : f32 = u_xlat1.z;
    x_1857 = x_1861;
  } else {
    let x_1864 : f32 = u_xlat2.z;
    x_1857 = x_1864;
  }
  let x_1865 : f32 = x_1857;
  u_xlat0.z = x_1865;
  let x_1867 : f32 = u_xlat18;
  let x_1872 : vec4<f32> = u_xlat0;
  let x_1874 : vec3<f32> = ((vec3<f32>(x_1867, x_1867, x_1867) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1872.x, x_1872.y, x_1872.z));
  let x_1875 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1874.x, x_1874.y, x_1874.z, x_1875.w);
  let x_1877 : vec4<f32> = u_xlat0;
  let x_1879 : vec3<f32> = (vec3<f32>(x_1877.x, x_1877.y, x_1877.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1880 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1879.x, x_1879.y, x_1879.z, x_1880.w);
  let x_1882 : vec4<f32> = u_xlat0;
  let x_1884 : vec3<f32> = (vec3<f32>(x_1882.x, x_1882.y, x_1882.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1885 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1884.x, x_1884.y, x_1884.z, x_1885.w);
  let x_1887 : vec4<f32> = u_xlat2;
  let x_1889 : vec3<f32> = (vec3<f32>(x_1887.x, x_1887.y, x_1887.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1890 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1889.x, x_1889.y, x_1889.z, x_1890.w);
  let x_1892 : vec4<f32> = u_xlat2;
  let x_1895 : vec3<f32> = log2(abs(vec3<f32>(x_1892.x, x_1892.y, x_1892.z)));
  let x_1896 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1895.x, x_1895.y, x_1895.z, x_1896.w);
  let x_1898 : vec4<f32> = u_xlat2;
  let x_1900 : vec3<f32> = (vec3<f32>(x_1898.x, x_1898.y, x_1898.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1901 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1900.x, x_1900.y, x_1900.z, x_1901.w);
  let x_1903 : vec4<f32> = u_xlat2;
  let x_1905 : vec3<f32> = exp2(vec3<f32>(x_1903.x, x_1903.y, x_1903.z));
  let x_1906 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1905.x, x_1905.y, x_1905.z, x_1906.w);
  let x_1908 : vec4<f32> = u_xlat0;
  let x_1910 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1908.x, x_1908.y, x_1908.z, x_1908.x));
  u_xlatb0 = vec3<bool>(x_1910.x, x_1910.y, x_1910.z);
  let x_1913 : bool = u_xlatb0.x;
  if (x_1913) {
    let x_1918 : f32 = u_xlat1.x;
    x_1914 = x_1918;
  } else {
    let x_1921 : f32 = u_xlat2.x;
    x_1914 = x_1921;
  }
  let x_1922 : f32 = x_1914;
  u_xlat0.x = x_1922;
  let x_1925 : bool = u_xlatb0.y;
  if (x_1925) {
    let x_1930 : f32 = u_xlat1.y;
    x_1926 = x_1930;
  } else {
    let x_1933 : f32 = u_xlat2.y;
    x_1926 = x_1933;
  }
  let x_1934 : f32 = x_1926;
  u_xlat0.y = x_1934;
  let x_1937 : bool = u_xlatb0.z;
  if (x_1937) {
    let x_1942 : f32 = u_xlat1.z;
    x_1938 = x_1942;
  } else {
    let x_1945 : f32 = u_xlat2.z;
    x_1938 = x_1945;
  }
  let x_1946 : f32 = x_1938;
  u_xlat0.z = x_1946;
  let x_1950 : vec4<f32> = u_xlat0;
  let x_1952 : vec3<f32> = max(vec3<f32>(x_1950.x, x_1950.y, x_1950.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1953 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1952.x, x_1952.y, x_1952.z, x_1953.w);
  SV_Target0.w = 1.0f;
  return;
}
