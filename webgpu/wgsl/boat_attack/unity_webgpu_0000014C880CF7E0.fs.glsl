...
void main()
{
    ...
    if(u_xlatb0){
        ...
        if(u_xlatb0){
            ...
            u_xlatb57.x = _MainLightShadowParams.y==2.0;
            if(u_xlatb57.x){
    ...
    u_xlatb57.x = vs_INTERP3.z>=1.0;
    u_xlatb2 = u_xlatb2 || u_xlatb57.x;
    ...
    if(u_xlatb57.x){
        u_xlat57.xy = vs_INTERP8.yy * _MainLightWorldToLight[1].xy;
        u_xlat57.xy = _MainLightWorldToLight[0].xy * vs_INTERP8.xx + u_xlat57.xy;
        u_xlat57.xy = _MainLightWorldToLight[2].xy * vs_INTERP8.zz + u_xlat57.xy;
    ...
    u_xlat8.xyz = u_xlat3.xyz * (-u_xlat57.xxx) + (-u_xlat7.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat82 = dot(unity_LightIndices[int(u_xlatu82)], uintBitsToFloat(ImmCB_0[u_xlati84]));
        ...
        u_xlat84 = u_xlat84 * _AdditionalLightsAttenuation[u_xlati82].x;
        ...
        if(u_xlati87 != 0) {
            ...
            u_xlat87 = (u_xlatb57.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb57.x) ? u_xlat11.xyz : vec3(u_xlat87);
        } else {
