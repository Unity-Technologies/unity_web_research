...
;
    ...
    u_xlat4.xyz = (u_xlatb13.x) ? u_xlat4.xyz : u_xlat5.xyz;
    u_xlat13.x = vs_INTERP8.y * unity_MatrixV[1].z;
    u_xlat13.x = unity_MatrixV[0].z * vs_INTERP8.x + u_xlat13.x;
    u_xlat13.x = unity_MatrixV[2].z * vs_INTERP8.z + u_xlat13.x;
    u_xlat13.x = u_xlat13.x + unity_MatrixV[3].z;
    u_xlat13.x = (-u_xlat13.x) + (-_ProjectionParams.y);
    u_xlat13.x = max(u_xlat13.x, 0.0);
    u_xlat13.x = u_xlat13.x * unity_FogParams.x;
    ...
    u_xlat37 = dot(u_xlat15.xyz, u_xlat5.xyz);
    ...
    u_xlat30 = dot((-u_xlat4.xyz), u_xlat15.xyz);
    u_xlat30 = u_xlat30 + u_xlat30;
    u_xlat7.xyz = u_xlat15.xyz * (-vec3(u_xlat30)) + (-u_xlat4.xyz);
    u_xlat30 = dot(u_xlat15.xyz, u_xlat4.xyz);
    u_xlat30 = clamp(u_xlat30, 0.0, 1.0);
    u_xlat30 = (-u_xlat30) + 1.0;
    u_xlat30 = u_xlat30 * u_xlat30;
    u_xlat30 = u_xlat30 * u_xlat30;
    u_xlat42 = (-u_xlat37) * 0.699999988 + 1.70000005;
    u_xlat37 = u_xlat37 * u_xlat42;
    u_xlat37 = u_xlat37 * 6.0;
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat37);
    ...
    u_xlat38 = u_xlat3.x + -0.0399999991;
    u_xlat38 = u_xlat30 * u_xlat38 + 0.0399999991;
    ...
    u_xlat20.xyz = u_xlat4.xyz + _MainLightPosition.xyz;
    u_xlat36 = dot(u_xlat20.xyz, u_xlat20.xyz);
    u_xlat36 = max(u_xlat36, 1.17549435e-38);
    u_xlat36 = inversesqrt(u_xlat36);
    u_xlat20.xyz = vec3(u_xlat36) * u_xlat20.xyz;
    u_xlat36 = dot(u_xlat15.xyz, u_xlat20.xyz);
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    u_xlat37 = dot(_MainLightPosition.xyz, u_xlat20.xyz);
    u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
    ...
    u_xlat20.xyz = vec3(u_xlat36) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat20.xyz;
    u_xlat36 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu36 =  uint(int(u_xlat36));
    u_xlat37 = u_xlat18.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat3.x = dot(unity_LightIndices[int(u_xlatu3)], uintBitsToFloat(ImmCB_0[u_xlati43]));
        u_xlati3 = int(u_xlat3.x);
        u_xlat20.xyz = (-vs_INTERP8.xyz) * _AdditionalLightsPosition[u_xlati3].www + _AdditionalLightsPosition[u_xlati3].xyz;
        u_xlat43 = dot(u_xlat20.xyz, u_xlat20.xyz);
        u_xlat43 = max(u_xlat43, 6.10351562e-05);
        u_xlat9 = inversesqrt(u_xlat43);
        u_xlat21.xyz = u_xlat20.xyz * vec3(u_xlat9);
        u_xlat10.x = float(1.0) / float(u_xlat43);
        u_xlat43 = u_xlat43 * _AdditionalLightsAttenuation[u_xlati3].x;
        u_xlat43 = (-u_xlat43) * u_xlat43 + 1.0;
        u_xlat43 = max(u_xlat43, 0.0);
        u_xlat43 = u_xlat43 * u_xlat43;
        u_xlat43 = u_xlat43 * u_xlat10.x;
        u_xlat10.x = dot(_AdditionalLightsSpotDir[u_xlati3].xyz, u_xlat21.xyz);
        u_xlat10.x = u_xlat10.x * _AdditionalLightsAttenuation[u_xlati3].z + _AdditionalLightsAttenuation[u_xlati3].w;
        u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
        u_xlat10.x = u_xlat10.x * u_xlat10.x;
        u_xlat43 = u_xlat43 * u_xlat10.x;
        u_xlati10 = int(_AdditionalShadowParams[u_xlati3].w);
        u_xlatb22.x = u_xlati10>=0;
        if(u_xlatb22.x){
            u_xlatb22.x = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati3].z);
            if(u_xlatb22.x){
                ...
                u_xlat34 = trunc(_AdditionalShadowParams[u_xlati3].w);
            ...
            u_xlat22 = 1.0 + (-_AdditionalShadowParams[u_xlati3].x);
            u_xlat10.x = u_xlat10.x * _AdditionalShadowParams[u_xlati3].x + u_xlat22;
        ...
        u_xlat10.x = u_xlat37 * u_xlat22 + u_xlat10.x;
        u_xlat43 = u_xlat43 * u_xlat10.x;
        u_xlat10.x = dot(u_xlat15.xyz, u_xlat21.xyz);
        u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
        u_xlat43 = u_xlat43 * u_xlat10.x;
        u_xlat10.xyz = vec3(u_xlat43) * _AdditionalLightsColor[u_xlati3].xyz;
        u_xlat20.xyz = u_xlat20.xyz * vec3(u_xlat9) + u_xlat4.xyz;
        u_xlat3.x = dot(u_xlat20.xyz, u_xlat20.xyz);
        u_xlat3.x = max(u_xlat3.x, 1.17549435e-38);
        u_xlat3.x = inversesqrt(u_xlat3.x);
        u_xlat20.xyz = u_xlat3.xxx * u_xlat20.xyz;
        u_xlat3.x = dot(u_xlat15.xyz, u_xlat20.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        ...
        u_xlat20.xyz = u_xlat3.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
