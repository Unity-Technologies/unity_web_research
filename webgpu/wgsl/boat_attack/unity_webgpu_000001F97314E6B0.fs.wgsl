...
fn main_1() {
  ...
  let x_1143 : vec3<f32> = ((vec3<f32>(x_1137.x, x_1137.x, x_1137.x) * x_1139) + vec3<f32>(x_1141.x, x_1141.y, x_1141.z));
  let x_1144 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1143.x, x_1143.y, x_1143.z, x_1144.w);
  let x_1146 : vec2<f32> = vs_TEXCOORD0;
  let x_1149 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1153 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1155 : vec2<f32> = ((x_1146 * vec2<f32>(x_1149.x, x_1149.y)) + vec2<f32>(x_1153.z, x_1153.w));
  let x_1156 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1155.x, x_1155.y, x_1156.z);
  let x_1163 : vec3<f32> = u_xlat1;
  let x_1166 : f32 = x_25.x_GlobalMipBias.x;
  let x_1167 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1163.x, x_1163.y), x_1166);
  u_xlat21 = x_1167.w;
  let x_1169 : f32 = u_xlat21;
  u_xlat21 = (x_1169 + -0.5f);
  let x_1171 : f32 = u_xlat21;
  let x_1172 : f32 = u_xlat21;
  u_xlat21 = (x_1171 + x_1172);
  let x_1174 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1174.x, x_1174.y, x_1174.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1183 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1183);
  let x_1188 : f32 = x_25.x_Grain_Params.y;
  let x_1190 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1188 * -(x_1190)) + 1.0f);
  let x_1196 : f32 = u_xlat21;
  let x_1198 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_1196, x_1196, x_1196) * vec3<f32>(x_1198.x, x_1198.y, x_1198.z));
  let x_1201 : vec3<f32> = u_xlat8;
  let x_1204 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_1201 * vec3<f32>(x_1204.x, x_1204.x, x_1204.x));
  let x_1207 : vec3<f32> = u_xlat8;
  let x_1208 : vec3<f32> = u_xlat1;
  let x_1211 : vec4<f32> = u_xlat0;
  let x_1213 : vec3<f32> = ((x_1207 * vec3<f32>(x_1208.x, x_1208.x, x_1208.x)) + vec3<f32>(x_1211.x, x_1211.y, x_1211.z));
  let x_1214 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1213.x, x_1213.y, x_1213.z, x_1214.w);
  let x_1218 : vec4<f32> = u_xlat0;
  let x_1220 : vec3<f32> = sqrt(vec3<f32>(x_1218.x, x_1218.y, x_1218.z));
  let x_1221 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1220.x, x_1220.y, x_1220.z, x_1221.w);
  SV_Target0.w = 1.0f;
  return;
}
