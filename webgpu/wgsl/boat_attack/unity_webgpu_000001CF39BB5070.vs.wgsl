...
fn main_1() {
  ...
  loop {
    ...
    u_xlat40 = (6.28318023681640625f / x_831);
    let x_834 : f32 = u_xlat40;
    u_xlat41 = (x_834 * 9.80000019073486328125f);
    ...
    u_xlat9 = (vec2<f32>(x_851.x, x_851.y) * vec2<f32>(10000.0f, 0.01745329238474369049f));
  ...
  u_xlat38 = max(x_1116, 1.17549435e-38f);
  ...
  let x_1190 : vec2<f32> = (vec2<f32>(x_1186.x, x_1186.z) * vec2<f32>(0.00499999988824129105f, 0.00499999988824129105f));
