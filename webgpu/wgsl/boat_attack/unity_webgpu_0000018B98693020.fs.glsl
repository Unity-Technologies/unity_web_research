...
;
    ...
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati38 + 1) / 4][(u_xlati38 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati38 / 4][u_xlati38 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati38 + 2) / 4][(u_xlati38 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati38 + 3) / 4][(u_xlati38 + 3) % 4].xyz;
    ...
    u_xlat6.xyz = u_xlat13.xyz + _MainLightPosition.xyz;
    ...
    u_xlat1 = u_xlat15 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
