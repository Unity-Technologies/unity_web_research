...
fn main_1() {
  ...
  u_xlatb0 = (x_503 < x_505);
  let x_507 : bool = u_xlatb1;
  let x_508 : bool = u_xlatb0;
  u_xlatb0 = (x_507 | x_508);
  let x_510 : bool = u_xlatb0;
  if (x_510) {
  ...
  let x_517 : vec3<f32> = x_511;
  let x_518 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_517.x, x_517.y, x_517.z, x_518.w);
  let x_520 : vec2<f32> = vs_TEXCOORD0;
  let x_523 : vec4<f32> = x_17.x_Grain_TilingParams;
  let x_527 : vec4<f32> = x_17.x_Grain_TilingParams;
  let x_529 : vec2<f32> = ((x_520 * vec2<f32>(x_523.x, x_523.y)) + vec2<f32>(x_527.z, x_527.w));
  let x_530 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_529.x, x_529.y, x_530.z, x_530.w);
  let x_537 : vec4<f32> = u_xlat1;
  let x_540 : f32 = x_17.x_GlobalMipBias.x;
  let x_541 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_537.x, x_537.y), x_540);
  u_xlat15 = x_541.w;
  let x_543 : f32 = u_xlat15;
  u_xlat15 = (x_543 + -0.5f);
  let x_545 : f32 = u_xlat15;
  let x_546 : f32 = u_xlat15;
  u_xlat15 = (x_545 + x_546);
  ...
  let x_560 : vec2<f32> = x_17.x_Grain_Params;
  let x_562 : vec3<f32> = (vec3<f32>(x_555.x, x_555.y, x_555.z) * vec3<f32>(x_560.x, x_560.x, x_560.x));
  let x_563 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_562.x, x_562.y, x_562.z, x_563.w);
  let x_565 : vec4<f32> = u_xlat0;
  u_xlat15 = dot(vec3<f32>(x_565.x, x_565.y, x_565.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_568 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_568);
  let x_572 : f32 = x_17.x_Grain_Params.y;
  let x_573 : f32 = u_xlat15;
  u_xlat15 = ((x_572 * -(x_573)) + 1.0f);
  let x_579 : vec4<f32> = u_xlat1;
  let x_581 : f32 = u_xlat15;
  let x_584 : vec4<f32> = u_xlat0;
  let x_586 : vec3<f32> = ((vec3<f32>(x_579.x, x_579.y, x_579.z) * vec3<f32>(x_581, x_581, x_581)) + vec3<f32>(x_584.x, x_584.y, x_584.z));
