...
;
    ...
    u_xlat30.xyz = vec3(u_xlat24) * u_xlat30.xyz + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat67 = u_xlat67 * _AdditionalLightsAttenuation[u_xlati64].x;
        ...
        u_xlat67 = u_xlat67 * u_xlat70;
        u_xlat10.xyz = vec3(u_xlat68) * _AdditionalLightsColor[u_xlati64].xyz;
        u_xlat64 = dot(u_xlat1.xyz, u_xlat30.xyz);
        u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
        u_xlat64 = u_xlat64 * u_xlat67;
        u_xlat10.xyz = vec3(u_xlat64) * u_xlat10.xyz;
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat69) + u_xlat2.xyz;
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat64) + u_xlat7.xyz;
