...
;
    ...
    u_xlat14.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP0.xy, _GlobalMipBias.x).xyz;
    ...
    u_xlat18.x = dot((-u_xlat5.xyz), u_xlat12.xyz);
    u_xlat18.x = u_xlat18.x + u_xlat18.x;
    u_xlat18.xyz = u_xlat12.xyz * (-u_xlat18.xxx) + (-u_xlat5.xyz);
    u_xlat7.x = dot(u_xlat12.xyz, u_xlat5.xyz);
    ...
    u_xlat14.xyz = u_xlat14.xyz * u_xlat3.xyz + u_xlat18.xyz;
    u_xlat0.x = u_xlat0.x * unity_LightData.z;
    u_xlat39 = dot(u_xlat12.xyz, _MainLightPosition.xyz);
    ...
    u_xlat0.x = dot(u_xlat12.xyz, u_xlat7.xzw);
    ...
    u_xlat7.xzw = u_xlat0.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat3.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.x = u_xlat6.x * u_xlat45;
        u_xlat45 = dot(u_xlat12.xyz, u_xlat9.xyz);
        u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
        u_xlat6.x = u_xlat6.x * u_xlat45;
        ...
        u_xlat28 = dot(u_xlat12.xyz, u_xlat8.xyz);
        ...
        u_xlat8.xyz = vec3(u_xlat28) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat3.xyz;
        u_xlat7.xzw = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xzw;
    }
    u_xlat0.xyz = u_xlat14.xyz * vec3(u_xlat41) + u_xlat18.xyz;
