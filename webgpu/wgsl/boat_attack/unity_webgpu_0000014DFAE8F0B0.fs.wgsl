...
fn main_1() {
  ...
  let x_636 : vec3<f32> = ((vec3<f32>(x_630.x, x_630.x, x_630.x) * x_632) + vec3<f32>(x_634.x, x_634.y, x_634.z));
  let x_637 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_636.x, x_636.y, x_636.z, x_637.w);
  SV_Target0.w = 1.0f;
  return;
}
