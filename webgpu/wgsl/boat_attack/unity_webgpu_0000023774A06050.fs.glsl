...
;
    ...
    u_xlat7.xyz = unity_SHC.xyz * vec3(u_xlat47) + u_xlat8.xyz;
    ...
    u_xlat49 = u_xlat3.x * u_xlat3.x;
    u_xlat18 = u_xlat48 + u_xlat3.y;
    ...
    u_xlat9.xyz = u_xlat4.xyz * (-u_xlat35.xxx) + (-u_xlat1.xyw);
    ...
    u_xlat25.xyz = (-u_xlat0.xyz) + vec3(u_xlat18);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu47 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat25.xyz = u_xlat25.xyz * vec3(u_xlat52) + u_xlat1.xyw;
        ...
        u_xlat20.x = dot(u_xlat4.xyz, u_xlat25.xyz);
