...
;
    ...
    u_xlat4.xyz = unity_SHC.xyz * vec3(u_xlat79) + u_xlat6.xyz;
    ...
    u_xlat9.xy = vec2(u_xlat79) * vec2(u_xlat79) + vec2(-1.0, 1.0);
    u_xlat0.x = float(1.0) / u_xlat9.y;
    u_xlat35.xyz = (-u_xlat5.xyz) + vec3(u_xlat52);
    u_xlat35.xyz = vec3(u_xlat54) * u_xlat35.xyz + u_xlat5.xyz;
    u_xlat35.xyz = u_xlat0.xxx * u_xlat35.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat35.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati54].www + _AdditionalLightsPosition[u_xlati54].xyz;
        ...
        u_xlat84 = dot(_AdditionalLightsSpotDir[u_xlati54].xyz, u_xlat10.xyz);
        u_xlat84 = u_xlat84 * _AdditionalLightsAttenuation[u_xlati54].z + _AdditionalLightsAttenuation[u_xlati54].w;
        u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
        u_xlat84 = u_xlat84 * u_xlat84;
        u_xlat82 = u_xlat82 * u_xlat84;
        u_xlati84 = int(_AdditionalShadowParams[u_xlati54].w);
        u_xlatb85 = u_xlati84>=0;
        if(u_xlatb85){
            u_xlatb85 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati54].z);
            if(u_xlatb85){
                ...
                u_xlat86 = trunc(_AdditionalShadowParams[u_xlati54].w);
                u_xlat85 = u_xlat85 + u_xlat86;
                u_xlati84 = int(u_xlat85);
            }
            u_xlati84 = u_xlati84 << (2 & int(0x1F));
            u_xlat11 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati84 + 1) / 4][(u_xlati84 + 1) % 4];
            u_xlat11 = _AdditionalLightsWorldToShadow[u_xlati84 / 4][u_xlati84 % 4] * vs_TEXCOORD7.xxxx + u_xlat11;
            u_xlat11 = _AdditionalLightsWorldToShadow[(u_xlati84 + 2) / 4][(u_xlati84 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat11;
            u_xlat11 = u_xlat11 + _AdditionalLightsWorldToShadow[(u_xlati84 + 3) / 4][(u_xlati84 + 3) % 4];
            u_xlat11.xyz = u_xlat11.xyz / u_xlat11.www;
            u_xlatb84 = 0.0<_AdditionalShadowParams[u_xlati54].y;
            if(u_xlatb84){
                u_xlatb84 = 1.0==_AdditionalShadowParams[u_xlati54].y;
                if(u_xlatb84){
                    ...
                    u_xlatb85 = 2.0==_AdditionalShadowParams[u_xlati54].y;
                    if(u_xlatb85){
            ...
            u_xlat85 = 1.0 + (-_AdditionalShadowParams[u_xlati54].x);
            u_xlat84 = u_xlat84 * _AdditionalShadowParams[u_xlati54].x + u_xlat85;
        ...
        u_xlati85 = 1 << (u_xlati54 & int(0x1F));
        u_xlati85 = int(uint(u_xlati85) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati85 != 0) {
            u_xlati85 = int(_AdditionalLightsLightTypes[u_xlati54]);
            u_xlati86 = (u_xlati85 != 0) ? 0 : 1;
            u_xlati88 = u_xlati54 << (2 & int(0x1F));
            if(u_xlati86 != 0) {
                ...
                if(u_xlati85 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati54].xy * u_xlat63.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati54].zw;
                } else {
            ...
            u_xlat85 = (u_xlatb2.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb2.x) ? u_xlat11.xyz : vec3(u_xlat85);
        } else {
        ...
        u_xlat35.xyz = u_xlat35.xyz * vec3(u_xlat83) + u_xlat7.xyz;
        u_xlat54 = dot(u_xlat35.xyz, u_xlat35.xyz);
        u_xlat54 = max(u_xlat54, 1.17549435e-38);
        u_xlat54 = inversesqrt(u_xlat54);
        u_xlat35.xyz = vec3(u_xlat54) * u_xlat35.xyz;
        u_xlat54 = dot(u_xlat1.xyz, u_xlat35.xyz);
        u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
        u_xlat82 = dot(u_xlat10.xyz, u_xlat35.xyz);
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        u_xlat54 = u_xlat54 * u_xlat54;
        u_xlat54 = u_xlat54 * u_xlat9.x + 1.00001001;
        u_xlat82 = u_xlat82 * u_xlat82;
        u_xlat54 = u_xlat54 * u_xlat54;
        u_xlat82 = max(u_xlat82, 0.100000001);
        u_xlat54 = u_xlat54 * u_xlat82;
        u_xlat54 = u_xlat80 * u_xlat54;
        u_xlat54 = u_xlat81 / u_xlat54;
        u_xlat35.xyz = u_xlat5.xyz * vec3(u_xlat54) + u_xlat4.xyz;
