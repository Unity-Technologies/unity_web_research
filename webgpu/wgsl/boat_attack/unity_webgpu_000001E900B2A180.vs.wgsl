...
fn main_1() {
  ...
  let x_650 : vec2<f32> = ((vec2<f32>(x_645.x, x_645.z) * vec2<f32>(0.002f, 0.002f)) + vec2<f32>(0.5f, 0.5f));
  ...
  u_xlat11 = ((x_708 * 0.100000001f) + 0.050000001f);
  ...
  loop {
    ...
    u_xlat29 = (vec2<f32>(10000.0f, 0.017453292f) * vec2<f32>(x_805.x, x_805.y));
  ...
  u_xlat35 = max(x_1080, 1.17549435e-37f);
  ...
  let x_1175 : vec2<f32> = (vec2<f32>(x_1171.x, x_1171.z) * vec2<f32>(0.005f, 0.005f));
