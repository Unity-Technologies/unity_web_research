...
;
    ...
    u_xlat7.x = (u_xlatb25) ? u_xlat4.x : unity_MatrixV[0].z;
    u_xlat7.y = (u_xlatb25) ? u_xlat4.y : unity_MatrixV[1].z;
    u_xlat7.z = (u_xlatb25) ? u_xlat4.z : unity_MatrixV[2].z;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat25.x = dot(unity_LightIndices[int(u_xlatu25)], uintBitsToFloat(ImmCB_0[u_xlati69]));
        u_xlati25 = int(u_xlat25.x);
        u_xlat9.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati25].www + _AdditionalLightsPosition[u_xlati25].xyz;
        ...
        u_xlat69 = u_xlat69 * _AdditionalLightsAttenuation[u_xlati25].x;
        u_xlat69 = (-u_xlat69) * u_xlat69 + 1.0;
        u_xlat69 = max(u_xlat69, 0.0);
        u_xlat69 = u_xlat69 * u_xlat69;
        u_xlat69 = u_xlat69 * u_xlat72;
        u_xlat72 = dot(_AdditionalLightsSpotDir[u_xlati25].xyz, u_xlat10.xyz);
        u_xlat72 = u_xlat72 * _AdditionalLightsAttenuation[u_xlati25].z + _AdditionalLightsAttenuation[u_xlati25].w;
        u_xlat72 = clamp(u_xlat72, 0.0, 1.0);
        u_xlat72 = u_xlat72 * u_xlat72;
        u_xlat69 = u_xlat69 * u_xlat72;
        u_xlat11.xyz = vec3(u_xlat50) * _AdditionalLightsColor[u_xlati25].xyz;
        u_xlat25.x = dot(u_xlat22.xyz, u_xlat10.xyz);
        u_xlat25.x = clamp(u_xlat25.x, 0.0, 1.0);
        u_xlat25.x = u_xlat25.x * u_xlat69;
        u_xlat11.xyz = u_xlat25.xxx * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat71) + u_xlat7.xyz;
        u_xlat25.x = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat25.x = max(u_xlat25.x, 1.17549435e-37);
        u_xlat25.x = inversesqrt(u_xlat25.x);
        u_xlat9.xyz = u_xlat25.xxx * u_xlat9.xyz;
        u_xlat25.x = dot(u_xlat22.xyz, u_xlat9.xyz);
        u_xlat25.x = clamp(u_xlat25.x, 0.0, 1.0);
        u_xlat25.z = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat25.z = clamp(u_xlat25.z, 0.0, 1.0);
        u_xlat25.xz = u_xlat25.xz * u_xlat25.xz;
        u_xlat25.x = u_xlat25.x * u_xlat3.x + 1.00001001;
        u_xlat25.x = u_xlat25.x * u_xlat25.x;
        u_xlat69 = max(u_xlat25.z, 0.100000001);
        u_xlat25.x = u_xlat69 * u_xlat25.x;
        u_xlat25.x = u_xlat6.x * u_xlat25.x;
        u_xlat25.x = u_xlat70 / u_xlat25.x;
        u_xlat9.xyz = u_xlat25.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat5.xyz;
