...
fn main_1() {
  ...
  let x_84 : vec4<f32> = x_17.x_TintColor;
  vs_COLOR0 = (x_82 * x_84);
  let x_91 : vec2<f32> = in_TEXCOORD0;
  let x_93 : vec4<f32> = x_17.x_MainTex_ST;
  let x_97 : vec4<f32> = x_17.x_MainTex_ST;
  vs_TEXCOORD0 = ((x_91 * vec2<f32>(x_93.x, x_93.y)) + vec2<f32>(x_97.z, x_97.w));
  return;
}
