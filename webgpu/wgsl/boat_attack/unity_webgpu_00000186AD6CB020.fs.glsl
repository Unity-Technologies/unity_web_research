...
;
    ...
    u_xlati35 = int(u_xlatu35) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD1.yyy * _MainLightWorldToShadow[(u_xlati35 + 1) / 4][(u_xlati35 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati35 / 4][u_xlati35 % 4].xyz * vs_TEXCOORD1.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati35 + 2) / 4][(u_xlati35 + 2) % 4].xyz * vs_TEXCOORD1.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati35 + 3) / 4][(u_xlati35 + 3) % 4].xyz;
    u_xlat35 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat35 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat35;
    u_xlat35 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat35;
    u_xlat35 = u_xlat35 + unity_MatrixV[3].z;
    ...
    u_xlat36 = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat36) + 1.0;
    u_xlat36 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat5.xz, _GlobalMipBias.x).x;
    ...
    u_xlat14.xyz = vec3(u_xlat36) * u_xlat4.xyz;
