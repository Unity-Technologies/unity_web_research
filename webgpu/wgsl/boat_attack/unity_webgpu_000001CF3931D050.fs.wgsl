...
fn main_1() {
  ...
  let x_1003 : vec3<f32> = ((x_997 * vec3<f32>(x_998.x, x_998.x, x_998.x)) + vec3<f32>(x_1001.x, x_1001.y, x_1001.z));
  let x_1004 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1003.x, x_1003.y, x_1003.z, x_1004.w);
  SV_Target0.w = 1.0f;
  return;
}
