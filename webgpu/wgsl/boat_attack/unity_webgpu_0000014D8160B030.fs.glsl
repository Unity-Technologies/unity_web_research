...
void main()
{
    ...
    u_xlat3.x = (-u_xlat77) + 1.0;
    u_xlat28.xyz = u_xlat0.xyz * vec3(u_xlat77);
    ...
    u_xlat4 = u_xlat77 * u_xlat77;
    u_xlat75 = u_xlat0.w + u_xlat3.x;
    u_xlat75 = clamp(u_xlat75, 0.0, 1.0);
    u_xlat3.x = u_xlat77 * 4.0 + 2.0;
    u_xlatb29 = 0.0<_MainLightShadowParams.y;
    if(u_xlatb29){
        u_xlatb29 = _MainLightShadowParams.y==1.0;
        if(u_xlatb29){
            ...
            u_xlat29.x = dot(u_xlat6, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            u_xlatb54 = _MainLightShadowParams.y==2.0;
            if(u_xlatb54){
                u_xlat54.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat54.xy = floor(u_xlat54.xy);
                u_xlat5.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat54.xy);
                u_xlat6 = u_xlat5.xxyy + vec4(0.5, 1.0, 0.5, 1.0);
                u_xlat7 = u_xlat6.xxzz * u_xlat6.xxzz;
                u_xlat55.xy = u_xlat7.yw * vec2(0.0799999982, 0.0799999982);
                u_xlat6.xz = u_xlat7.xz * vec2(0.5, 0.5) + (-u_xlat5.xy);
                u_xlat7.xy = (-u_xlat5.xy) + vec2(1.0, 1.0);
                u_xlat57.xy = min(u_xlat5.xy, vec2(0.0, 0.0));
                u_xlat57.xy = (-u_xlat57.xy) * u_xlat57.xy + u_xlat7.xy;
                ...
                u_xlat7.w = u_xlat8.x;
                u_xlat9 = u_xlat54.xyxy * _MainLightShadowmapSize.xyxy + u_xlat7.ywxw;
                u_xlat10.xy = u_xlat54.xy * _MainLightShadowmapSize.xy + u_xlat7.zw;
                u_xlat8.w = u_xlat7.y;
                u_xlat7.yw = u_xlat8.yz;
                u_xlat11 = u_xlat54.xyxy * _MainLightShadowmapSize.xyxy + u_xlat7.xyzy;
                u_xlat8 = u_xlat54.xyxy * _MainLightShadowmapSize.xyxy + u_xlat8.wywz;
                u_xlat7 = u_xlat54.xyxy * _MainLightShadowmapSize.xyxy + u_xlat7.xwzw;
                u_xlat12 = u_xlat5.xxxy * u_xlat6.zwyz;
                u_xlat13 = u_xlat5.yyzz * u_xlat6;
                u_xlat54.x = u_xlat5.z * u_xlat6.y;
                ...
                u_xlat79 = u_xlat12.x * u_xlat79 + u_xlat5.x;
                ...
                u_xlat79 = u_xlat12.z * u_xlat5.x + u_xlat79;
                ...
                u_xlat79 = u_xlat12.w * u_xlat5.x + u_xlat79;
                ...
                u_xlat79 = u_xlat13.x * u_xlat5.x + u_xlat79;
                ...
                u_xlat79 = u_xlat13.y * u_xlat5.x + u_xlat79;
                ...
                u_xlat79 = u_xlat13.z * u_xlat5.x + u_xlat79;
                ...
                u_xlat79 = u_xlat13.w * u_xlat5.x + u_xlat79;
                ...
                u_xlat29.x = u_xlat54.x * u_xlat5.x + u_xlat79;
            } else {
                u_xlat54.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat54.xy = floor(u_xlat54.xy);
                u_xlat5.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat54.xy);
                ...
                u_xlat55.xy = u_xlat7.xz * vec2(0.5, 0.5) + (-u_xlat5.xy);
                ...
                u_xlat9.xy = u_xlat55.yx * vec2(0.0816320032, 0.0816320032);
                u_xlat55.xy = u_xlat6.xz * vec2(0.0816320032, 0.0816320032);
                ...
                u_xlat9.y = u_xlat8.x;
                u_xlat10 = u_xlat54.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xyzy;
                u_xlat11.xy = u_xlat54.xy * _MainLightShadowmapSize.xy + u_xlat9.wy;
                u_xlat6.y = u_xlat9.y;
                u_xlat9.y = u_xlat8.z;
                u_xlat12 = u_xlat54.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xyzy;
                u_xlat61.xy = u_xlat54.xy * _MainLightShadowmapSize.xy + u_xlat9.wy;
                u_xlat6.z = u_xlat9.y;
                u_xlat13 = u_xlat54.xyxy * _MainLightShadowmapSize.xyxy + u_xlat6.xyxz;
                u_xlat9.y = u_xlat8.w;
                u_xlat14 = u_xlat54.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xyzy;
                u_xlat31.xy = u_xlat54.xy * _MainLightShadowmapSize.xy + u_xlat9.wy;
                u_xlat6.w = u_xlat9.y;
                u_xlat15.xy = u_xlat54.xy * _MainLightShadowmapSize.xy + u_xlat6.xw;
                u_xlat8.xzw = u_xlat9.xzw;
                u_xlat9 = u_xlat54.xyxy * _MainLightShadowmapSize.xyxy + u_xlat8.xyzy;
                u_xlat58.xy = u_xlat54.xy * _MainLightShadowmapSize.xy + u_xlat8.wy;
                u_xlat8.x = u_xlat6.x;
                u_xlat54.xy = u_xlat54.xy * _MainLightShadowmapSize.xy + u_xlat8.xy;
                ...
                u_xlat81 = u_xlat81 * u_xlat16.y;
                u_xlat6.x = u_xlat16.x * u_xlat6.x + u_xlat81;
                ...
                u_xlat6.x = u_xlat16.z * u_xlat81 + u_xlat6.x;
                ...
                u_xlat6.x = u_xlat16.w * u_xlat81 + u_xlat6.x;
                ...
                u_xlat6.x = u_xlat17.x * u_xlat81 + u_xlat6.x;
                ...
                u_xlat6.x = u_xlat17.y * u_xlat81 + u_xlat6.x;
                vec3 txVec19 = vec3(u_xlat61.xy,vs_TEXCOORD8.z);
                u_xlat81 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec19, 0.0);
                u_xlat6.x = u_xlat17.z * u_xlat81 + u_xlat6.x;
                ...
                u_xlat6.x = u_xlat17.w * u_xlat81 + u_xlat6.x;
                ...
                u_xlat6.x = u_xlat18.x * u_xlat81 + u_xlat6.x;
                ...
                u_xlat6.x = u_xlat18.y * u_xlat81 + u_xlat6.x;
                vec3 txVec23 = vec3(u_xlat31.xy,vs_TEXCOORD8.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec23, 0.0);
                u_xlat6.x = u_xlat18.z * u_xlat31.x + u_xlat6.x;
                vec3 txVec24 = vec3(u_xlat15.xy,vs_TEXCOORD8.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat6.x = u_xlat18.w * u_xlat31.x + u_xlat6.x;
                vec3 txVec25 = vec3(u_xlat9.xy,vs_TEXCOORD8.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec25, 0.0);
                u_xlat5.x = u_xlat5.x * u_xlat31.x + u_xlat6.x;
                ...
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
                u_xlat5.x = u_xlat5.z * u_xlat30 + u_xlat5.x;
                vec3 txVec28 = vec3(u_xlat54.xy,vs_TEXCOORD8.z);
                u_xlat54.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec28, 0.0);
                u_xlat29.x = u_xlat5.w * u_xlat54.x + u_xlat5.x;
            }
        }
    } else {
        vec3 txVec29 = vec3(vs_TEXCOORD8.xy,vs_TEXCOORD8.z);
        u_xlat29.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec29, 0.0);
    }
    u_xlat54.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat29.x = u_xlat29.x * _MainLightShadowParams.x + u_xlat54.x;
    u_xlatb54 = 0.0>=vs_TEXCOORD8.z;
    u_xlatb79 = vs_TEXCOORD8.z>=1.0;
    u_xlatb54 = u_xlatb79 || u_xlatb54;
    u_xlat29.x = (u_xlatb54) ? 1.0 : u_xlat29.x;
    u_xlat5.xyz = vs_TEXCOORD7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat54.x = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat79 = u_xlat54.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    u_xlat5.x = (-u_xlat29.x) + 1.0;
    u_xlat29.x = u_xlat79 * u_xlat5.x + u_xlat29.x;
    u_xlat5.x = vs_TEXCOORD3.w;
    u_xlat5.y = vs_TEXCOORD4.w;
    u_xlat5.z = vs_TEXCOORD5.w;
    u_xlat79 = dot((-u_xlat5.xyz), u_xlat26.xyz);
    u_xlat79 = u_xlat79 + u_xlat79;
    u_xlat6.xyz = u_xlat26.xyz * (-vec3(u_xlat79)) + (-u_xlat5.xyz);
    u_xlat79 = dot(u_xlat26.xyz, u_xlat5.xyz);
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    ...
    u_xlat32.xyz = vec3(u_xlat79) * u_xlat32.xyz + u_xlat0.xyz;
    u_xlat32.xyz = vec3(u_xlat1) * u_xlat32.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat32.xyz;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat28.xyz + u_xlat6.xyz;
    u_xlat75 = u_xlat29.x * unity_LightData.z;
    ...
    u_xlat75 = u_xlat4 / u_xlat75;
    u_xlat32.xyz = u_xlat0.xyz * vec3(u_xlat75) + u_xlat28.xyz;
    u_xlat75 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu75 =  uint(int(u_xlat75));
    u_xlat1 = u_xlat54.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat80 = u_xlat3.x * u_xlat80;
        u_xlat80 = u_xlat4 / u_xlat80;
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat80) + u_xlat28.xyz;
        u_xlat29.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat29.xyz;
    }
    u_xlat0.xyz = u_xlat32.xyz * u_xlat6.xyz + u_xlat2.xyz;
