...
void main()
{
    ...
    u_xlat1.xyz = (bool(u_xlatb78)) ? u_xlat1.xyz : u_xlat2.xyz;
    ...
    u_xlatu54 = u_xlatu2.z * 1025u;
    u_xlatu29 = u_xlatu54 >> (6u & uint(0x1F));
    u_xlati54 = int(u_xlatu54 ^ u_xlatu29);
    u_xlatu54 = uint(u_xlati54) * 9u;
    u_xlatu29 = u_xlatu54 >> (11u & uint(0x1F));
    u_xlati54 = int(u_xlatu54 ^ u_xlatu29);
    u_xlati54 = u_xlati54 * 32769;
    u_xlati28 = int(uint(u_xlati54) ^ u_xlatu2.y);
    u_xlatu28 = uint(u_xlati28) * 1025u;
    u_xlatu54 = u_xlatu28 >> (6u & uint(0x1F));
    u_xlati28 = int(u_xlatu54 ^ u_xlatu28);
    u_xlatu28 = uint(u_xlati28) * 9u;
    u_xlatu54 = u_xlatu28 >> (11u & uint(0x1F));
    u_xlati28 = int(u_xlatu54 ^ u_xlatu28);
    u_xlati28 = u_xlati28 * 32769;
    u_xlati2 = int(uint(u_xlati28) ^ u_xlatu2.x);
    u_xlatu2.x = uint(u_xlati2) * 1025u;
    u_xlatu28 = u_xlatu2.x >> (6u & uint(0x1F));
    u_xlati2 = int(u_xlatu28 ^ u_xlatu2.x);
    u_xlatu2.x = uint(u_xlati2) * 9u;
    u_xlatu28 = u_xlatu2.x >> (11u & uint(0x1F));
    u_xlati2 = int(u_xlatu28 ^ u_xlatu2.x);
    ...
    u_xlat2.x = (u_xlatb3) ? u_xlat2.x : u_xlat28.x;
    u_xlat79 = u_xlat79 * 2.0 + (-u_xlat2.x);
    u_xlat2.x = u_xlat79 * u_xlat3.w;
    u_xlatb28.x = u_xlat2.x>=0.400000006;
    u_xlat28.x = u_xlatb28.x ? u_xlat2.x : float(0.0);
    u_xlat79 = u_xlat3.w * u_xlat79 + -0.400000006;
    u_xlat54 = dFdxCoarse(u_xlat2.x);
    u_xlat2.x = dFdyCoarse(u_xlat2.x);
    u_xlat2.x = abs(u_xlat2.x) + abs(u_xlat54);
    u_xlat2.x = max(u_xlat2.x, 9.99999975e-05);
    u_xlat79 = u_xlat79 / u_xlat2.x;
    u_xlat79 = u_xlat79 + 0.5;
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    u_xlatb2 = _AlphaToMaskAvailable!=0.0;
    u_xlat79 = (u_xlatb2) ? u_xlat79 : u_xlat28.x;
    ...
    u_xlatb28.y = unity_WorldTransformParams.w>=0.0;
    u_xlat28.x = (u_xlatb28.x) ? float(1.0) : float(-1.0);
    u_xlat28.y = (u_xlatb28.y) ? float(1.0) : float(-1.0);
    ...
    u_xlat31.xyz = vec3(u_xlat54) * u_xlat31.xyz;
    u_xlat54 = max(u_xlat6.w, 9.99999975e-05);
    u_xlat31.xyz = u_xlat31.xyz / vec3(u_xlat54);
    u_xlat5.x = u_xlat5.x;
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
    u_xlat79 = u_xlat79;
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat54 = (-u_xlat5.x) + 1.0;
    u_xlat81 = u_xlat54 * u_xlat54;
    ...
    u_xlat58.x = dot((-u_xlat1.xyz), u_xlat3.xyz);
    u_xlat58.x = u_xlat58.x + u_xlat58.x;
    u_xlat8.xyz = u_xlat3.xyz * (-u_xlat58.xxx) + (-u_xlat1.xyz);
    u_xlat58.x = dot(u_xlat3.xyz, u_xlat1.xyz);
    u_xlat58.x = clamp(u_xlat58.x, 0.0, 1.0);
    u_xlat58.x = (-u_xlat58.x) + 1.0;
    u_xlat58.x = u_xlat58.x * u_xlat58.x;
    u_xlat58.x = u_xlat58.x * u_xlat58.x;
    u_xlat84 = (-u_xlat54) * 0.699999988 + 1.70000005;
    u_xlat54 = u_xlat54 * u_xlat84;
    u_xlat54 = u_xlat54 * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat54);
    ...
    u_xlat78 = dot(u_xlat3.xyz, u_xlat8.xyz);
    ...
    u_xlat8.xyz = vec3(u_xlat78) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat78 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu78 =  uint(int(u_xlat78));
    u_xlat54 = u_xlat80 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat86 = u_xlat54 * u_xlat88 + u_xlat86;
        ...
        u_xlat35.xyz = u_xlat35.xyz * vec3(u_xlat85) + u_xlat1.xyz;
