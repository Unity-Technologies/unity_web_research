...
fn main_1() {
  ...
  let x_1819 : vec2<f32> = vs_TEXCOORD0;
  let x_1822 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1826 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1828 : vec2<f32> = ((x_1819 * vec2<f32>(x_1822.x, x_1822.y)) + vec2<f32>(x_1826.z, x_1826.w));
  let x_1829 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1828.x, x_1828.y, x_1829.z, x_1829.w);
  let x_1836 : vec4<f32> = u_xlat1;
  let x_1839 : f32 = x_26.x_GlobalMipBias.x;
  let x_1840 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1836.x, x_1836.y), x_1839);
  u_xlat21 = x_1840.w;
  let x_1842 : f32 = u_xlat21;
  u_xlat21 = ((x_1842 * 2.0f) + -1.0f);
  let x_1845 : f32 = u_xlat21;
  u_xlatb1 = (x_1845 >= 0.0f);
  let x_1847 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1847);
  let x_1850 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1850)) + 1.0f);
  let x_1854 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1854);
  let x_1856 : f32 = u_xlat21;
  u_xlat21 = (-(x_1856) + 1.0f);
  let x_1859 : f32 = u_xlat21;
  let x_1861 : f32 = u_xlat1.x;
  u_xlat21 = (x_1859 * x_1861);
  let x_1863 : vec3<f32> = u_xlat0;
  let x_1864 : vec3<f32> = (x_1863 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1865 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1864.x, x_1864.y, x_1864.z, x_1865.w);
  let x_1867 : vec3<f32> = u_xlat0;
  let x_1869 : vec3<f32> = log2(abs(x_1867));
  let x_1870 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1869.x, x_1869.y, x_1869.z, x_1870.w);
  let x_1872 : vec4<f32> = u_xlat2;
  let x_1874 : vec3<f32> = (vec3<f32>(x_1872.x, x_1872.y, x_1872.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1875 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1874.x, x_1874.y, x_1874.z, x_1875.w);
  let x_1877 : vec4<f32> = u_xlat2;
  let x_1879 : vec3<f32> = exp2(vec3<f32>(x_1877.x, x_1877.y, x_1877.z));
  let x_1880 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1879.x, x_1879.y, x_1879.z, x_1880.w);
  let x_1882 : vec4<f32> = u_xlat2;
  let x_1885 : vec3<f32> = ((vec3<f32>(x_1882.x, x_1882.y, x_1882.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1886 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1885.x, x_1885.y, x_1885.z, x_1886.w);
  let x_1888 : vec3<f32> = u_xlat0;
  let x_1890 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1888.x, x_1888.y, x_1888.z, x_1888.x));
  u_xlatb0 = vec3<bool>(x_1890.x, x_1890.y, x_1890.z);
  let x_1893 : bool = u_xlatb0.x;
  if (x_1893) {
  ...
  u_xlat0.z = x_1926;
  let x_1928 : f32 = u_xlat21;
  let x_1933 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1928, x_1928, x_1928) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1933);
  let x_1935 : vec3<f32> = u_xlat0;
  let x_1936 : vec3<f32> = (x_1935 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1937 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1936.x, x_1936.y, x_1936.z, x_1937.w);
  let x_1939 : vec3<f32> = u_xlat0;
  let x_1940 : vec3<f32> = (x_1939 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1941 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1940.x, x_1940.y, x_1940.z, x_1941.w);
  let x_1943 : vec4<f32> = u_xlat2;
  let x_1945 : vec3<f32> = (vec3<f32>(x_1943.x, x_1943.y, x_1943.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1946 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1945.x, x_1945.y, x_1945.z, x_1946.w);
  let x_1948 : vec4<f32> = u_xlat2;
  let x_1951 : vec3<f32> = log2(abs(vec3<f32>(x_1948.x, x_1948.y, x_1948.z)));
  let x_1952 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1951.x, x_1951.y, x_1951.z, x_1952.w);
  let x_1954 : vec4<f32> = u_xlat2;
  let x_1956 : vec3<f32> = (vec3<f32>(x_1954.x, x_1954.y, x_1954.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1957 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1956.x, x_1956.y, x_1956.z, x_1957.w);
  let x_1959 : vec4<f32> = u_xlat2;
  let x_1961 : vec3<f32> = exp2(vec3<f32>(x_1959.x, x_1959.y, x_1959.z));
  let x_1962 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1961.x, x_1961.y, x_1961.z, x_1962.w);
  let x_1964 : vec3<f32> = u_xlat0;
  let x_1966 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1964.x, x_1964.y, x_1964.z, x_1964.x));
  u_xlatb0 = vec3<bool>(x_1966.x, x_1966.y, x_1966.z);
  let x_1969 : bool = u_xlatb0.x;
  if (x_1969) {
    let x_1974 : f32 = u_xlat1.x;
    x_1970 = x_1974;
  } else {
    let x_1977 : f32 = u_xlat2.x;
    x_1970 = x_1977;
  }
  let x_1978 : f32 = x_1970;
  u_xlat0.x = x_1978;
  let x_1981 : bool = u_xlatb0.y;
  if (x_1981) {
    let x_1986 : f32 = u_xlat1.y;
    x_1982 = x_1986;
  } else {
    let x_1989 : f32 = u_xlat2.y;
    x_1982 = x_1989;
  }
  let x_1990 : f32 = x_1982;
  u_xlat0.y = x_1990;
  let x_1993 : bool = u_xlatb0.z;
  if (x_1993) {
    let x_1998 : f32 = u_xlat1.z;
    x_1994 = x_1998;
  } else {
    let x_2001 : f32 = u_xlat2.z;
    x_1994 = x_2001;
  }
  let x_2002 : f32 = x_1994;
  u_xlat0.z = x_2002;
  let x_2006 : vec3<f32> = u_xlat0;
  let x_2007 : vec3<f32> = max(x_2006, vec3<f32>(0.0f, 0.0f, 0.0f));
