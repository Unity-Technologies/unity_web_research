...
@group(1) @binding(6) var<uniform> x_135 : VGlobals;
...
fn main_1() {
  ...
  let x_137 : vec4<f32> = x_135.unity_MatrixVP[1i];
  u_xlat1 = (vec4<f32>(x_131.y, x_131.y, x_131.y, x_131.y) * x_137);
  let x_140 : vec4<f32> = x_135.unity_MatrixVP[0i];
  let x_141 : vec4<f32> = u_xlat0;
  let x_144 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_140 * vec4<f32>(x_141.x, x_141.x, x_141.x, x_141.x)) + x_144);
  let x_147 : vec4<f32> = x_135.unity_MatrixVP[2i];
  let x_148 : vec4<f32> = u_xlat0;
  let x_151 : vec4<f32> = u_xlat1;
  u_xlat0 = ((x_147 * vec4<f32>(x_148.z, x_148.z, x_148.z, x_148.z)) + x_151);
  let x_157 : vec4<f32> = u_xlat0;
  let x_159 : vec4<f32> = x_135.unity_MatrixVP[3i];
