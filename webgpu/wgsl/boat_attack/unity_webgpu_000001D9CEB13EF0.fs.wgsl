...
fn main_1() {
  ...
  let x_1249 : vec2<f32> = vs_TEXCOORD0;
  let x_1252 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1256 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1258 : vec2<f32> = ((x_1249 * vec2<f32>(x_1252.x, x_1252.y)) + vec2<f32>(x_1256.z, x_1256.w));
  let x_1259 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1258.x, x_1258.y, x_1259.z);
  let x_1266 : vec3<f32> = u_xlat1;
  let x_1269 : f32 = x_25.x_GlobalMipBias.x;
  let x_1270 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1266.x, x_1266.y), x_1269);
  u_xlat21 = x_1270.w;
  let x_1272 : f32 = u_xlat21;
  u_xlat21 = ((x_1272 * 2.0f) + -1.0f);
  let x_1275 : f32 = u_xlat21;
  u_xlatb1.x = (x_1275 >= 0.0f);
  let x_1279 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1279);
  let x_1282 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1282)) + 1.0f);
  let x_1286 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1286);
  let x_1288 : f32 = u_xlat21;
  u_xlat21 = (-(x_1288) + 1.0f);
  let x_1291 : f32 = u_xlat21;
  let x_1293 : f32 = u_xlat1.x;
  u_xlat21 = (x_1291 * x_1293);
  let x_1295 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1295.x, x_1295.y, x_1295.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1298 : vec4<f32> = u_xlat0;
  let x_1300 : vec3<f32> = log2(vec3<f32>(x_1298.x, x_1298.y, x_1298.z));
  let x_1301 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1300.x, x_1300.y, x_1300.z, x_1301.w);
  let x_1303 : vec4<f32> = u_xlat2;
  let x_1305 : vec3<f32> = (vec3<f32>(x_1303.x, x_1303.y, x_1303.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1306 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1305.x, x_1305.y, x_1305.z, x_1306.w);
  let x_1308 : vec4<f32> = u_xlat2;
  let x_1310 : vec3<f32> = exp2(vec3<f32>(x_1308.x, x_1308.y, x_1308.z));
  let x_1311 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1310.x, x_1310.y, x_1310.z, x_1311.w);
  let x_1313 : vec4<f32> = u_xlat2;
  let x_1316 : vec3<f32> = ((vec3<f32>(x_1313.x, x_1313.y, x_1313.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1317 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1316.x, x_1316.y, x_1316.z, x_1317.w);
  let x_1319 : vec4<f32> = u_xlat0;
  let x_1321 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1319.x, x_1319.y, x_1319.z, x_1319.x));
  u_xlatb0 = vec3<bool>(x_1321.x, x_1321.y, x_1321.z);
  let x_1324 : bool = u_xlatb0.x;
  if (x_1324) {
  ...
  u_xlat0.x = x_1333;
  let x_1336 : bool = u_xlatb0.y;
  if (x_1336) {
    let x_1341 : f32 = u_xlat1.y;
    x_1337 = x_1341;
  } else {
    let x_1344 : f32 = u_xlat2.y;
    x_1337 = x_1344;
  }
  let x_1345 : f32 = x_1337;
  u_xlat0.y = x_1345;
  let x_1348 : bool = u_xlatb0.z;
  if (x_1348) {
    let x_1353 : f32 = u_xlat1.z;
    x_1349 = x_1353;
  } else {
    let x_1356 : f32 = u_xlat2.z;
    x_1349 = x_1356;
  }
  let x_1357 : f32 = x_1349;
  u_xlat0.z = x_1357;
  let x_1359 : f32 = u_xlat21;
  let x_1364 : vec4<f32> = u_xlat0;
  let x_1366 : vec3<f32> = ((vec3<f32>(x_1359, x_1359, x_1359) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1364.x, x_1364.y, x_1364.z));
  let x_1367 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1366.x, x_1366.y, x_1366.z, x_1367.w);
  let x_1369 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1369.x, x_1369.y, x_1369.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1372 : vec4<f32> = u_xlat0;
  let x_1374 : vec3<f32> = (vec3<f32>(x_1372.x, x_1372.y, x_1372.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1375 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1374.x, x_1374.y, x_1374.z, x_1375.w);
  let x_1377 : vec4<f32> = u_xlat2;
  let x_1379 : vec3<f32> = (vec3<f32>(x_1377.x, x_1377.y, x_1377.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1380 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1379.x, x_1379.y, x_1379.z, x_1380.w);
  let x_1382 : vec4<f32> = u_xlat2;
  let x_1385 : vec3<f32> = log2(abs(vec3<f32>(x_1382.x, x_1382.y, x_1382.z)));
  let x_1386 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1385.x, x_1385.y, x_1385.z, x_1386.w);
  let x_1388 : vec4<f32> = u_xlat2;
  let x_1390 : vec3<f32> = (vec3<f32>(x_1388.x, x_1388.y, x_1388.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1400 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1398.x, x_1398.y, x_1398.z, x_1398.x));
  u_xlatb0 = vec3<bool>(x_1400.x, x_1400.y, x_1400.z);
  let x_1403 : bool = u_xlatb0.x;
  if (x_1403) {
  ...
  u_xlat0.x = x_1412;
  let x_1415 : bool = u_xlatb0.y;
  if (x_1415) {
    let x_1420 : f32 = u_xlat1.y;
    x_1416 = x_1420;
  } else {
    let x_1423 : f32 = u_xlat2.y;
    x_1416 = x_1423;
  }
  let x_1424 : f32 = x_1416;
  u_xlat0.y = x_1424;
  let x_1427 : bool = u_xlatb0.z;
  if (x_1427) {
    let x_1432 : f32 = u_xlat1.z;
    x_1428 = x_1432;
  } else {
  ...
  let x_1443 : vec3<f32> = max(vec3<f32>(x_1440.x, x_1440.y, x_1440.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1444 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1443.x, x_1443.y, x_1443.z, x_1444.w);
  SV_Target0.w = 1.0f;
  return;
}
