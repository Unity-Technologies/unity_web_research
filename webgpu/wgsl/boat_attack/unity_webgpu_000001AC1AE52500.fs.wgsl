...
fn main_1() {
  ...
  let x_1796 : vec3<f32> = u_xlat0;
  u_xlat0 = sqrt(x_1796);
  let x_1798 : vec2<f32> = vs_TEXCOORD0;
  let x_1801 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1805 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1807 : vec2<f32> = ((x_1798 * vec2<f32>(x_1801.x, x_1801.y)) + vec2<f32>(x_1805.z, x_1805.w));
  let x_1808 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1807.x, x_1807.y, x_1808.z, x_1808.w);
  let x_1815 : vec4<f32> = u_xlat1;
  let x_1818 : f32 = x_26.x_GlobalMipBias.x;
  let x_1819 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1815.x, x_1815.y), x_1818);
  u_xlat21 = x_1819.w;
  let x_1821 : f32 = u_xlat21;
  u_xlat21 = ((x_1821 * 2.0f) + -1.0f);
  let x_1824 : f32 = u_xlat21;
  u_xlatb1 = (x_1824 >= 0.0f);
  let x_1826 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1826);
  let x_1829 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1829)) + 1.0f);
  let x_1833 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1833);
  let x_1835 : f32 = u_xlat21;
  u_xlat21 = (-(x_1835) + 1.0f);
  let x_1838 : f32 = u_xlat21;
  let x_1840 : f32 = u_xlat1.x;
  u_xlat21 = (x_1838 * x_1840);
  let x_1842 : vec3<f32> = u_xlat0;
  let x_1843 : vec3<f32> = (x_1842 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1844 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1843.x, x_1843.y, x_1843.z, x_1844.w);
  let x_1846 : vec3<f32> = u_xlat0;
  let x_1847 : vec3<f32> = log2(x_1846);
  let x_1848 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1847.x, x_1847.y, x_1847.z, x_1848.w);
  let x_1850 : vec4<f32> = u_xlat2;
  let x_1852 : vec3<f32> = (vec3<f32>(x_1850.x, x_1850.y, x_1850.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1863 : vec3<f32> = ((vec3<f32>(x_1860.x, x_1860.y, x_1860.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1864 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1863.x, x_1863.y, x_1863.z, x_1864.w);
  let x_1866 : vec3<f32> = u_xlat0;
  let x_1868 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1866.x, x_1866.y, x_1866.z, x_1866.x));
  u_xlatb0 = vec3<bool>(x_1868.x, x_1868.y, x_1868.z);
  let x_1871 : bool = u_xlatb0.x;
  if (x_1871) {
    let x_1876 : f32 = u_xlat1.x;
    x_1872 = x_1876;
  } else {
    let x_1879 : f32 = u_xlat2.x;
    x_1872 = x_1879;
  }
  let x_1880 : f32 = x_1872;
  u_xlat0.x = x_1880;
  let x_1883 : bool = u_xlatb0.y;
  if (x_1883) {
    let x_1888 : f32 = u_xlat1.y;
    x_1884 = x_1888;
  } else {
    let x_1891 : f32 = u_xlat2.y;
    x_1884 = x_1891;
  }
  let x_1892 : f32 = x_1884;
  u_xlat0.y = x_1892;
  let x_1895 : bool = u_xlatb0.z;
  if (x_1895) {
    let x_1900 : f32 = u_xlat1.z;
    x_1896 = x_1900;
  } else {
    let x_1903 : f32 = u_xlat2.z;
    x_1896 = x_1903;
  }
  let x_1904 : f32 = x_1896;
  u_xlat0.z = x_1904;
  let x_1906 : f32 = u_xlat21;
  let x_1911 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1906, x_1906, x_1906) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1911);
  let x_1913 : vec3<f32> = u_xlat0;
  let x_1914 : vec3<f32> = (x_1913 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1915 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1914.x, x_1914.y, x_1914.z, x_1915.w);
  let x_1917 : vec3<f32> = u_xlat0;
  let x_1918 : vec3<f32> = (x_1917 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1919 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1918.x, x_1918.y, x_1918.z, x_1919.w);
  let x_1921 : vec4<f32> = u_xlat2;
  let x_1923 : vec3<f32> = (vec3<f32>(x_1921.x, x_1921.y, x_1921.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1924 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1923.x, x_1923.y, x_1923.z, x_1924.w);
  let x_1926 : vec4<f32> = u_xlat2;
  let x_1929 : vec3<f32> = log2(abs(vec3<f32>(x_1926.x, x_1926.y, x_1926.z)));
  let x_1930 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1929.x, x_1929.y, x_1929.z, x_1930.w);
  let x_1932 : vec4<f32> = u_xlat2;
  let x_1934 : vec3<f32> = (vec3<f32>(x_1932.x, x_1932.y, x_1932.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1935 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1934.x, x_1934.y, x_1934.z, x_1935.w);
  let x_1937 : vec4<f32> = u_xlat2;
  let x_1939 : vec3<f32> = exp2(vec3<f32>(x_1937.x, x_1937.y, x_1937.z));
  let x_1940 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1939.x, x_1939.y, x_1939.z, x_1940.w);
  let x_1942 : vec3<f32> = u_xlat0;
  let x_1944 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1942.x, x_1942.y, x_1942.z, x_1942.x));
  u_xlatb0 = vec3<bool>(x_1944.x, x_1944.y, x_1944.z);
  let x_1947 : bool = u_xlatb0.x;
  if (x_1947) {
    let x_1952 : f32 = u_xlat1.x;
    x_1948 = x_1952;
  } else {
  ...
  u_xlat0.x = x_1956;
  let x_1959 : bool = u_xlatb0.y;
  if (x_1959) {
    let x_1964 : f32 = u_xlat1.y;
    x_1960 = x_1964;
  } else {
    let x_1967 : f32 = u_xlat2.y;
    x_1960 = x_1967;
  }
  let x_1968 : f32 = x_1960;
  u_xlat0.y = x_1968;
  let x_1971 : bool = u_xlatb0.z;
  if (x_1971) {
    let x_1976 : f32 = u_xlat1.z;
    x_1972 = x_1976;
  } else {
    let x_1979 : f32 = u_xlat2.z;
    x_1972 = x_1979;
  }
  let x_1980 : f32 = x_1972;
  u_xlat0.z = x_1980;
  let x_1984 : vec3<f32> = u_xlat0;
  let x_1985 : vec3<f32> = max(x_1984, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1986 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1985.x, x_1985.y, x_1985.z, x_1986.w);
  SV_Target0.w = 1.0f;
  return;
}
