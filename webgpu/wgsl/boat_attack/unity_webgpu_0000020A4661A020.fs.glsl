...
void main()
{
    ...
    u_xlat26.xyz = u_xlat26.xyz * u_xlat28.xxx;
    ...
    u_xlat4.x = (u_xlatb28) ? u_xlat3.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb28) ? u_xlat3.y : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb28) ? u_xlat3.z : unity_MatrixV[2].z;
    ...
    u_xlat28.x = dot(u_xlat26.xyz, u_xlat3.xyz);
    u_xlat28.x = u_xlat28.x + 0.5;
    u_xlat3.xyz = u_xlat28.xxx * u_xlat32.xyz;
    u_xlat28.x = max(u_xlat3.w, 9.99999975e-05);
    ...
    u_xlat7.x = dot((-u_xlat4.xyz), u_xlat26.xyz);
    u_xlat7.x = u_xlat7.x + u_xlat7.x;
    u_xlat7.xyz = u_xlat26.xyz * (-u_xlat7.xxx) + (-u_xlat4.xyz);
    u_xlat85 = dot(u_xlat26.xyz, u_xlat4.xyz);
    u_xlat85 = clamp(u_xlat85, 0.0, 1.0);
    u_xlat85 = (-u_xlat85) + 1.0;
    u_xlat85 = u_xlat85 * u_xlat85;
    u_xlat85 = u_xlat85 * u_xlat85;
    u_xlat8.x = (-u_xlat28.x) * 0.699999988 + 1.70000005;
    u_xlat28.x = u_xlat28.x * u_xlat8.x;
    u_xlat28.x = u_xlat28.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat28.x);
    ...
    u_xlat7.xyz = u_xlat8.xyz * u_xlat28.xxx;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = vec3(u_xlat82) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat5.xyz;
