...
struct VGlobals {
  ...
  /* @offset(128) */
  x_CameraNormalsTexture_ST : vec4<f32>,
}
...
fn main_1() {
  ...
  let x_87 : vec4<f32> = x_17.x_CameraNormalsTexture_ST;
  let x_91 : vec4<f32> = x_17.x_CameraNormalsTexture_ST;
  vs_TEXCOORD0 = ((x_85 * vec2<f32>(x_87.x, x_87.y)) + vec2<f32>(x_91.z, x_91.w));
  return;
}
