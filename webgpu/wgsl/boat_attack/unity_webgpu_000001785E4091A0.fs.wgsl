...
@group(1) @binding(1) var<uniform> x_1046 : AdditionalLights;
...
fn main_1() {
  ...
  loop {
    ...
    let x_1011 : u32 = u_xlatu37;
    let x_1014 : vec4<f32> = x_283.unity_LightIndices[bitcast<i32>(x_1011)];
    let x_1024 : i32 = u_xlati39;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1029 : vec4<u32> = indexable[x_1024];
    u_xlat37 = dot(x_1014, bitcast<vec4<f32>>(x_1029));
    let x_1033 : f32 = u_xlat37;
    u_xlati37 = i32(x_1033);
    let x_1035 : vec3<f32> = vs_INTERP0;
    let x_1047 : i32 = u_xlati37;
    let x_1049 : vec4<f32> = x_1046.x_AdditionalLightsPosition[x_1047];
    let x_1052 : i32 = u_xlati37;
    let x_1054 : vec4<f32> = x_1046.x_AdditionalLightsPosition[x_1052];
    u_xlat8 = ((-(x_1035) * vec3<f32>(x_1049.w, x_1049.w, x_1049.w)) + vec3<f32>(x_1054.x, x_1054.y, x_1054.z));
    let x_1057 : vec3<f32> = u_xlat8;
    let x_1058 : vec3<f32> = u_xlat8;
    u_xlat39 = dot(x_1057, x_1058);
    let x_1060 : f32 = u_xlat39;
    u_xlat39 = max(x_1060, 6.10351562e-05f);
    let x_1063 : f32 = u_xlat39;
    u_xlat40 = inverseSqrt(x_1063);
    let x_1066 : f32 = u_xlat40;
    let x_1068 : vec3<f32> = u_xlat8;
    u_xlat9 = (vec3<f32>(x_1066, x_1066, x_1066) * x_1068);
    let x_1071 : f32 = u_xlat39;
    u_xlat41 = (1.0f / x_1071);
    let x_1073 : f32 = u_xlat39;
    let x_1074 : i32 = u_xlati37;
    let x_1076 : f32 = x_1046.x_AdditionalLightsAttenuation[x_1074].x;
    u_xlat39 = (x_1073 * x_1076);
    let x_1078 : f32 = u_xlat39;
    let x_1080 : f32 = u_xlat39;
    u_xlat39 = ((-(x_1078) * x_1080) + 1.0f);
    let x_1083 : f32 = u_xlat39;
    u_xlat39 = max(x_1083, 0.0f);
    let x_1085 : f32 = u_xlat39;
    let x_1086 : f32 = u_xlat39;
    u_xlat39 = (x_1085 * x_1086);
    let x_1088 : f32 = u_xlat39;
    let x_1089 : f32 = u_xlat41;
    u_xlat39 = (x_1088 * x_1089);
    let x_1091 : i32 = u_xlati37;
    let x_1093 : vec4<f32> = x_1046.x_AdditionalLightsSpotDir[x_1091];
    let x_1095 : vec3<f32> = u_xlat9;
    u_xlat41 = dot(vec3<f32>(x_1093.x, x_1093.y, x_1093.z), x_1095);
    let x_1097 : f32 = u_xlat41;
    let x_1098 : i32 = u_xlati37;
    let x_1100 : f32 = x_1046.x_AdditionalLightsAttenuation[x_1098].z;
    let x_1102 : i32 = u_xlati37;
    let x_1104 : f32 = x_1046.x_AdditionalLightsAttenuation[x_1102].w;
    u_xlat41 = ((x_1097 * x_1100) + x_1104);
    let x_1106 : f32 = u_xlat41;
    u_xlat41 = clamp(x_1106, 0.0f, 1.0f);
    let x_1108 : f32 = u_xlat41;
    let x_1109 : f32 = u_xlat41;
    u_xlat41 = (x_1108 * x_1109);
    let x_1111 : f32 = u_xlat39;
    let x_1112 : f32 = u_xlat41;
    u_xlat39 = (x_1111 * x_1112);
    let x_1115 : vec4<f32> = u_xlat5;
    let x_1117 : i32 = u_xlati37;
    let x_1119 : vec4<f32> = x_1046.x_AdditionalLightsColor[x_1117];
    u_xlat10 = (vec3<f32>(x_1115.x, x_1115.x, x_1115.x) * vec3<f32>(x_1119.x, x_1119.y, x_1119.z));
    let x_1122 : vec4<f32> = u_xlat3;
    let x_1124 : vec3<f32> = u_xlat9;
    u_xlat37 = dot(vec3<f32>(x_1122.x, x_1122.y, x_1122.z), x_1124);
    ...
    u_xlat8 = ((x_1135 * vec3<f32>(x_1136, x_1136, x_1136)) + x_1139);
    let x_1141 : vec3<f32> = u_xlat8;
    let x_1142 : vec3<f32> = u_xlat8;
    u_xlat37 = dot(x_1141, x_1142);
    let x_1144 : f32 = u_xlat37;
    u_xlat37 = max(x_1144, 1.17549435e-37f);
    let x_1146 : f32 = u_xlat37;
    u_xlat37 = inverseSqrt(x_1146);
    let x_1148 : f32 = u_xlat37;
    let x_1150 : vec3<f32> = u_xlat8;
    u_xlat8 = (vec3<f32>(x_1148, x_1148, x_1148) * x_1150);
    let x_1152 : vec4<f32> = u_xlat3;
    let x_1154 : vec3<f32> = u_xlat8;
    u_xlat37 = dot(vec3<f32>(x_1152.x, x_1152.y, x_1152.z), x_1154);
    let x_1156 : f32 = u_xlat37;
    u_xlat37 = clamp(x_1156, 0.0f, 1.0f);
    let x_1158 : vec3<f32> = u_xlat9;
    let x_1159 : vec3<f32> = u_xlat8;
    u_xlat39 = dot(x_1158, x_1159);
    let x_1161 : f32 = u_xlat39;
    u_xlat39 = clamp(x_1161, 0.0f, 1.0f);
    let x_1163 : f32 = u_xlat37;
    let x_1164 : f32 = u_xlat37;
    u_xlat37 = (x_1163 * x_1164);
    let x_1166 : f32 = u_xlat37;
    let x_1168 : f32 = u_xlat0.x;
    u_xlat37 = ((x_1166 * x_1168) + 1.000010014f);
    let x_1171 : f32 = u_xlat39;
    let x_1172 : f32 = u_xlat39;
    u_xlat39 = (x_1171 * x_1172);
    let x_1174 : f32 = u_xlat37;
    let x_1175 : f32 = u_xlat37;
    u_xlat37 = (x_1174 * x_1175);
    let x_1177 : f32 = u_xlat39;
    u_xlat39 = max(x_1177, 0.100000001f);
    ...
    u_xlat37 = (x_1186 / x_1187);
    let x_1189 : vec3<f32> = u_xlat2;
    let x_1190 : f32 = u_xlat37;
    let x_1193 : vec3<f32> = u_xlat6;
    u_xlat8 = ((x_1189 * vec3<f32>(x_1190, x_1190, x_1190)) + x_1193);
    let x_1195 : vec3<f32> = u_xlat8;
    let x_1196 : vec3<f32> = u_xlat10;
    let x_1198 : vec4<f32> = u_xlat7;
    let x_1200 : vec3<f32> = ((x_1195 * x_1196) + vec3<f32>(x_1198.x, x_1198.y, x_1198.z));
    let x_1201 : vec4<f32> = u_xlat7;
    u_xlat7 = vec4<f32>(x_1200.x, x_1200.y, x_1200.z, x_1201.w);

    continuing {
      let x_1203 : u32 = u_xlatu_loop_1;
      u_xlatu_loop_1 = (x_1203 + bitcast<u32>(1i));
    }
  }
  let x_1205 : vec3<f32> = u_xlat4;
  let x_1206 : f32 = u_xlat33;
  let x_1209 : vec3<f32> = u_xlat16;
  let x_1210 : vec3<f32> = ((x_1205 * vec3<f32>(x_1206, x_1206, x_1206)) + x_1209);
  let x_1211 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1210.x, x_1211.y, x_1210.y, x_1210.z);
  let x_1213 : vec4<f32> = u_xlat7;
  let x_1215 : vec4<f32> = u_xlat0;
  let x_1217 : vec3<f32> = (vec3<f32>(x_1213.x, x_1213.y, x_1213.z) + vec3<f32>(x_1215.x, x_1215.z, x_1215.w));
  let x_1218 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1217.x, x_1218.y, x_1217.y, x_1217.z);
  let x_1221 : f32 = u_xlat11.x;
  let x_1223 : f32 = u_xlat11.x;
  u_xlat11.x = (x_1221 * -(x_1223));
  let x_1228 : f32 = u_xlat11.x;
  u_xlat11.x = exp2(x_1228);
  let x_1231 : vec4<f32> = u_xlat0;
  let x_1235 : vec4<f32> = x_44.unity_FogColor;
  let x_1238 : vec3<f32> = (vec3<f32>(x_1231.x, x_1231.z, x_1231.w) + -(vec3<f32>(x_1235.x, x_1235.y, x_1235.z)));
  let x_1239 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1238.x, x_1239.y, x_1238.y, x_1238.z);
  let x_1243 : vec2<f32> = u_xlat11;
  let x_1245 : vec4<f32> = u_xlat0;
  let x_1249 : vec4<f32> = x_44.unity_FogColor;
  let x_1251 : vec3<f32> = ((vec3<f32>(x_1243.x, x_1243.x, x_1243.x) * vec3<f32>(x_1245.x, x_1245.z, x_1245.w)) + vec3<f32>(x_1249.x, x_1249.y, x_1249.z));
  let x_1252 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1251.x, x_1251.y, x_1251.z, x_1252.w);
  let x_1257 : u32 = x_44.x_RenderingLayerMaxInt;
  let x_1259 : f32 = x_283.unity_RenderingLayer.x;
  u_xlatu0 = (x_1257 & bitcast<u32>(x_1259));
  let x_1262 : u32 = u_xlatu0;
  u_xlat0.x = f32(x_1262);
  let x_1267 : f32 = u_xlat0.x;
  let x_1270 : f32 = x_44.x_RenderingLayerRcpMaxInt;
  SV_Target1.x = (x_1267 * x_1270);
  let x_1275 : f32 = SV_Target1.x;
  SV_Target1.x = clamp(x_1275, 0.0f, 1.0f);
  SV_Target0.w = 1.0f;
  let x_1279 : vec4<f32> = SV_Target1;
  SV_Target1 = vec4<f32>(x_1279.x, vec3<f32>(0.0f, 0.0f, 0.0f).x, vec3<f32>(0.0f, 0.0f, 0.0f).y, vec3<f32>(0.0f, 0.0f, 0.0f).z);
  return;
}
