...
fn main_1() {
  ...
  let x_1860 : vec2<f32> = vs_TEXCOORD0;
  let x_1863 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1867 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1869 : vec2<f32> = ((x_1860 * vec2<f32>(x_1863.x, x_1863.y)) + vec2<f32>(x_1867.z, x_1867.w));
  let x_1870 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1869.x, x_1869.y, x_1870.z, x_1870.w);
  let x_1877 : vec4<f32> = u_xlat1;
  let x_1880 : f32 = x_26.x_GlobalMipBias.x;
  let x_1881 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1877.x, x_1877.y), x_1880);
  u_xlat21 = x_1881.w;
  let x_1883 : f32 = u_xlat21;
  u_xlat21 = ((x_1883 * 2.0f) + -1.0f);
  let x_1886 : f32 = u_xlat21;
  u_xlatb1 = (x_1886 >= 0.0f);
  let x_1888 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1888);
  let x_1891 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1891)) + 1.0f);
  let x_1895 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1895);
  let x_1897 : f32 = u_xlat21;
  u_xlat21 = (-(x_1897) + 1.0f);
  let x_1900 : f32 = u_xlat21;
  let x_1902 : f32 = u_xlat1.x;
  u_xlat21 = (x_1900 * x_1902);
  let x_1904 : vec3<f32> = u_xlat0;
  let x_1905 : vec3<f32> = (x_1904 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1906 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1905.x, x_1905.y, x_1905.z, x_1906.w);
  let x_1908 : vec3<f32> = u_xlat0;
  let x_1910 : vec3<f32> = log2(abs(x_1908));
  let x_1911 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1910.x, x_1910.y, x_1910.z, x_1911.w);
  let x_1913 : vec4<f32> = u_xlat2;
  let x_1915 : vec3<f32> = (vec3<f32>(x_1913.x, x_1913.y, x_1913.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1916 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1915.x, x_1915.y, x_1915.z, x_1916.w);
  let x_1918 : vec4<f32> = u_xlat2;
  let x_1920 : vec3<f32> = exp2(vec3<f32>(x_1918.x, x_1918.y, x_1918.z));
  let x_1921 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1920.x, x_1920.y, x_1920.z, x_1921.w);
  let x_1923 : vec4<f32> = u_xlat2;
  let x_1926 : vec3<f32> = ((vec3<f32>(x_1923.x, x_1923.y, x_1923.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1927 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1926.x, x_1926.y, x_1926.z, x_1927.w);
  let x_1929 : vec3<f32> = u_xlat0;
  let x_1931 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1929.x, x_1929.y, x_1929.z, x_1929.x));
  u_xlatb0 = vec3<bool>(x_1931.x, x_1931.y, x_1931.z);
  let x_1934 : bool = u_xlatb0.x;
  if (x_1934) {
  ...
  u_xlat0.x = x_1943;
  let x_1946 : bool = u_xlatb0.y;
  if (x_1946) {
    let x_1951 : f32 = u_xlat1.y;
    x_1947 = x_1951;
  } else {
    let x_1954 : f32 = u_xlat2.y;
    x_1947 = x_1954;
  }
  let x_1955 : f32 = x_1947;
  u_xlat0.y = x_1955;
  let x_1958 : bool = u_xlatb0.z;
  if (x_1958) {
    let x_1963 : f32 = u_xlat1.z;
    x_1959 = x_1963;
  } else {
    let x_1966 : f32 = u_xlat2.z;
    x_1959 = x_1966;
  }
  let x_1967 : f32 = x_1959;
  u_xlat0.z = x_1967;
  let x_1969 : f32 = u_xlat21;
  let x_1974 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1969, x_1969, x_1969) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1974);
  let x_1976 : vec3<f32> = u_xlat0;
  let x_1977 : vec3<f32> = (x_1976 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1978 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1977.x, x_1977.y, x_1977.z, x_1978.w);
  let x_1980 : vec3<f32> = u_xlat0;
  let x_1981 : vec3<f32> = (x_1980 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1982 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1981.x, x_1981.y, x_1981.z, x_1982.w);
  let x_1984 : vec4<f32> = u_xlat2;
  let x_1986 : vec3<f32> = (vec3<f32>(x_1984.x, x_1984.y, x_1984.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  ...
  let x_1997 : vec3<f32> = (vec3<f32>(x_1995.x, x_1995.y, x_1995.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_2007 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2005.x, x_2005.y, x_2005.z, x_2005.x));
  u_xlatb0 = vec3<bool>(x_2007.x, x_2007.y, x_2007.z);
  let x_2010 : bool = u_xlatb0.x;
  if (x_2010) {
  ...
  let x_2019 : f32 = x_2011;
  u_xlat0.x = x_2019;
  let x_2022 : bool = u_xlatb0.y;
  if (x_2022) {
    let x_2027 : f32 = u_xlat1.y;
    x_2023 = x_2027;
  } else {
    let x_2030 : f32 = u_xlat2.y;
    x_2023 = x_2030;
  }
  let x_2031 : f32 = x_2023;
  u_xlat0.y = x_2031;
  let x_2034 : bool = u_xlatb0.z;
  if (x_2034) {
    let x_2039 : f32 = u_xlat1.z;
    x_2035 = x_2039;
  } else {
    let x_2042 : f32 = u_xlat2.z;
    x_2035 = x_2042;
  }
  let x_2043 : f32 = x_2035;
  u_xlat0.z = x_2043;
  let x_2047 : vec3<f32> = u_xlat0;
  let x_2048 : vec3<f32> = max(x_2047, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2049 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2048.x, x_2048.y, x_2048.z, x_2049.w);
  SV_Target0.w = 1.0f;
  return;
}
