...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat71 = u_xlat2.y * u_xlat2.y;
    u_xlat71 = u_xlat2.x * u_xlat2.x + (-u_xlat71);
    u_xlat26.xyz = unity_SHC.xyz * vec3(u_xlat71) + u_xlat6.xyz;
    ...
    if(u_xlatb71){
        ...
        if(u_xlatb71){
            ...
            if(u_xlatb4){
                ...
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec4, 0.0);
                ...
                u_xlat27.x = u_xlat11.x * u_xlat27.x + u_xlat5.x;
                vec3 txVec6 = vec3(u_xlat50.xy,vs_TEXCOORD6.z);
                u_xlat50.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat27.x = u_xlat11.z * u_xlat50.x + u_xlat27.x;
                vec3 txVec7 = vec3(u_xlat7.xy,vs_TEXCOORD6.z);
                u_xlat50.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat27.x = u_xlat11.w * u_xlat50.x + u_xlat27.x;
                vec3 txVec8 = vec3(u_xlat9.xy,vs_TEXCOORD6.z);
                u_xlat50.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat27.x = u_xlat12.x * u_xlat50.x + u_xlat27.x;
                vec3 txVec9 = vec3(u_xlat9.zw,vs_TEXCOORD6.z);
                u_xlat50.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat27.x = u_xlat12.y * u_xlat50.x + u_xlat27.x;
                vec3 txVec10 = vec3(u_xlat7.zw,vs_TEXCOORD6.z);
                u_xlat50.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat27.x = u_xlat12.z * u_xlat50.x + u_xlat27.x;
                vec3 txVec11 = vec3(u_xlat6.xy,vs_TEXCOORD6.z);
                u_xlat50.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat27.x = u_xlat12.w * u_xlat50.x + u_xlat27.x;
                vec3 txVec12 = vec3(u_xlat6.zw,vs_TEXCOORD6.z);
                u_xlat50.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                u_xlat71 = u_xlat4.x * u_xlat50.x + u_xlat27.x;
            } else {
                u_xlat4.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat4.xy = floor(u_xlat4.xy);
                u_xlat50.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat4.xy);
                ...
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec14, 0.0);
                u_xlat75 = u_xlat75 * u_xlat15.y;
                u_xlat6.x = u_xlat15.x * u_xlat6.x + u_xlat75;
                ...
                u_xlat50.x = u_xlat15.z * u_xlat50.x + u_xlat6.x;
                ...
                u_xlat50.x = u_xlat15.w * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat16.x * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat16.y * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat16.z * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat16.w * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat17.x * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat17.y * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat17.z * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat17.w * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat5.x * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat5.y * u_xlat73 + u_xlat50.x;
                ...
                u_xlat50.x = u_xlat5.z * u_xlat73 + u_xlat50.x;
                ...
                u_xlat71 = u_xlat5.w * u_xlat4.x + u_xlat50.x;
            }
        }
    } else {
    ...
    u_xlat71 = u_xlat71 * _MainLightShadowParams.x + u_xlat4.x;
    u_xlatb4 = 0.0>=vs_TEXCOORD6.z;
    u_xlatb27.x = vs_TEXCOORD6.z>=1.0;
    u_xlatb4 = u_xlatb27.x || u_xlatb4;
    u_xlat71 = (u_xlatb4) ? 1.0 : u_xlat71;
    u_xlat4.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat4.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat27.x = u_xlat4.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat27.x = clamp(u_xlat27.x, 0.0, 1.0);
    u_xlat50.x = (-u_xlat71) + 1.0;
    u_xlat71 = u_xlat27.x * u_xlat50.x + u_xlat71;
    ...
    if(u_xlatb27.x){
        ...
        u_xlat5 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat27.xy, _GlobalMipBias.x);
        ...
        u_xlat50.x = (u_xlatb27.y) ? u_xlat5.w : u_xlat5.x;
        u_xlat27.xyz = (u_xlatb27.x) ? u_xlat5.xyz : u_xlat50.xxx;
    } else {
    ...
    u_xlat27.xyz = vec3(u_xlat71) * u_xlat27.xyz;
    u_xlat71 = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat71 = clamp(u_xlat71, 0.0, 1.0);
    u_xlat5.xyz = vec3(u_xlat71) * u_xlat27.xyz;
    ...
    u_xlat27.xyz = u_xlat27.xyz * u_xlat6.xyz;
    u_xlat27.xyz = u_xlat5.xyz * u_xlat0.yzw + u_xlat27.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu5 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlatb31.x){
            ...
            if(u_xlatb31.x){
                ...
                u_xlat54 = u_xlatb9.z ? 1.0 : float(0.0);
                u_xlat54 = (u_xlatb31.z) ? u_xlat9.y : u_xlat54;
                u_xlat31.x = (u_xlatb31.x) ? u_xlat9.x : u_xlat54;
                u_xlat54 = trunc(_AdditionalShadowParams[u_xlati75].w);
                u_xlat31.x = u_xlat31.x + u_xlat54;
        ...
        u_xlat8.x = u_xlat4.x * u_xlat31.x + u_xlat8.x;
    ...
    u_xlat23.xyz = u_xlat26.xyz * u_xlat0.yzw + u_xlat27.xyz;
