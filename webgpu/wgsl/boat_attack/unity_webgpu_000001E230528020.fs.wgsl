...
@group(1) @binding(1) var<uniform> x_1144 : AdditionalLights;
...
fn main_1() {
  ...
  loop {
    ...
    let x_1109 : u32 = u_xlatu15;
    let x_1112 : vec4<f32> = x_120.unity_LightIndices[bitcast<i32>(x_1109)];
    let x_1122 : i32 = u_xlati41;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1127 : vec4<u32> = indexable[x_1122];
    u_xlat15 = dot(x_1112, bitcast<vec4<f32>>(x_1127));
    let x_1131 : f32 = u_xlat15;
    u_xlati15 = i32(x_1131);
    let x_1133 : vec3<f32> = vs_INTERP0;
    let x_1145 : i32 = u_xlati15;
    let x_1147 : vec4<f32> = x_1144.x_AdditionalLightsPosition[x_1145];
    let x_1150 : i32 = u_xlati15;
    let x_1152 : vec4<f32> = x_1144.x_AdditionalLightsPosition[x_1150];
    u_xlat21 = ((-(x_1133) * vec3<f32>(x_1147.w, x_1147.w, x_1147.w)) + vec3<f32>(x_1152.x, x_1152.y, x_1152.z));
    let x_1155 : vec3<f32> = u_xlat21;
    let x_1156 : vec3<f32> = u_xlat21;
    u_xlat41 = dot(x_1155, x_1156);
    let x_1158 : f32 = u_xlat41;
    u_xlat41 = max(x_1158, 6.10351562e-05f);
    let x_1161 : f32 = u_xlat41;
    u_xlat43 = inverseSqrt(x_1161);
    let x_1164 : f32 = u_xlat43;
    let x_1166 : vec3<f32> = u_xlat21;
    u_xlat10 = (vec3<f32>(x_1164, x_1164, x_1164) * x_1166);
    let x_1168 : f32 = u_xlat41;
    u_xlat44 = (1.0f / x_1168);
    let x_1170 : f32 = u_xlat41;
    let x_1171 : i32 = u_xlati15;
    let x_1173 : f32 = x_1144.x_AdditionalLightsAttenuation[x_1171].x;
    u_xlat41 = (x_1170 * x_1173);
    let x_1175 : f32 = u_xlat41;
    let x_1177 : f32 = u_xlat41;
    u_xlat41 = ((-(x_1175) * x_1177) + 1.0f);
    let x_1180 : f32 = u_xlat41;
    u_xlat41 = max(x_1180, 0.0f);
    let x_1182 : f32 = u_xlat41;
    let x_1183 : f32 = u_xlat41;
    u_xlat41 = (x_1182 * x_1183);
    let x_1185 : f32 = u_xlat41;
    let x_1186 : f32 = u_xlat44;
    u_xlat41 = (x_1185 * x_1186);
    let x_1188 : i32 = u_xlati15;
    let x_1190 : vec4<f32> = x_1144.x_AdditionalLightsSpotDir[x_1188];
    let x_1192 : vec3<f32> = u_xlat10;
    u_xlat44 = dot(vec3<f32>(x_1190.x, x_1190.y, x_1190.z), x_1192);
    let x_1194 : f32 = u_xlat44;
    let x_1195 : i32 = u_xlati15;
    let x_1197 : f32 = x_1144.x_AdditionalLightsAttenuation[x_1195].z;
    let x_1199 : i32 = u_xlati15;
    let x_1201 : f32 = x_1144.x_AdditionalLightsAttenuation[x_1199].w;
    u_xlat44 = ((x_1194 * x_1197) + x_1201);
    ...
    u_xlat41 = (x_1208 * x_1209);
    let x_1212 : f32 = u_xlat42;
    let x_1214 : i32 = u_xlati15;
    let x_1216 : vec4<f32> = x_1144.x_AdditionalLightsColor[x_1214];
    u_xlat11 = (vec3<f32>(x_1212, x_1212, x_1212) * vec3<f32>(x_1216.x, x_1216.y, x_1216.z));
    let x_1219 : vec4<f32> = u_xlat4;
    let x_1221 : vec3<f32> = u_xlat10;
    u_xlat15 = dot(vec3<f32>(x_1219.x, x_1219.y, x_1219.z), x_1221);
    let x_1223 : f32 = u_xlat15;
    u_xlat15 = clamp(x_1223, 0.0f, 1.0f);
    let x_1225 : f32 = u_xlat15;
    let x_1226 : f32 = u_xlat41;
    u_xlat15 = (x_1225 * x_1226);
    let x_1228 : f32 = u_xlat15;
    let x_1230 : vec3<f32> = u_xlat11;
    u_xlat11 = (vec3<f32>(x_1228, x_1228, x_1228) * x_1230);
    let x_1232 : vec3<f32> = u_xlat21;
    let x_1233 : f32 = u_xlat43;
    let x_1236 : vec4<f32> = u_xlat1;
    u_xlat21 = ((x_1232 * vec3<f32>(x_1233, x_1233, x_1233)) + vec3<f32>(x_1236.x, x_1236.y, x_1236.w));
    let x_1239 : vec3<f32> = u_xlat21;
    let x_1240 : vec3<f32> = u_xlat21;
    u_xlat15 = dot(x_1239, x_1240);
    let x_1242 : f32 = u_xlat15;
    u_xlat15 = max(x_1242, 1.17549435e-37f);
    let x_1244 : f32 = u_xlat15;
    u_xlat15 = inverseSqrt(x_1244);
    let x_1246 : f32 = u_xlat15;
    let x_1248 : vec3<f32> = u_xlat21;
    u_xlat21 = (vec3<f32>(x_1246, x_1246, x_1246) * x_1248);
    let x_1250 : vec4<f32> = u_xlat4;
    let x_1252 : vec3<f32> = u_xlat21;
    u_xlat15 = dot(vec3<f32>(x_1250.x, x_1250.y, x_1250.z), x_1252);
    let x_1254 : f32 = u_xlat15;
    u_xlat15 = clamp(x_1254, 0.0f, 1.0f);
    let x_1256 : vec3<f32> = u_xlat10;
    let x_1257 : vec3<f32> = u_xlat21;
    u_xlat41 = dot(x_1256, x_1257);
    let x_1259 : f32 = u_xlat41;
    u_xlat41 = clamp(x_1259, 0.0f, 1.0f);
    let x_1261 : f32 = u_xlat15;
    let x_1262 : f32 = u_xlat15;
    u_xlat15 = (x_1261 * x_1262);
    let x_1264 : f32 = u_xlat15;
    let x_1266 : f32 = u_xlat9.x;
    u_xlat15 = ((x_1264 * x_1266) + 1.000010014f);
    let x_1269 : f32 = u_xlat41;
    let x_1270 : f32 = u_xlat41;
    u_xlat41 = (x_1269 * x_1270);
    let x_1272 : f32 = u_xlat15;
    let x_1273 : f32 = u_xlat15;
    u_xlat15 = (x_1272 * x_1273);
    let x_1275 : f32 = u_xlat41;
    u_xlat41 = max(x_1275, 0.100000001f);
    let x_1277 : f32 = u_xlat15;
    let x_1278 : f32 = u_xlat41;
    u_xlat15 = (x_1277 * x_1278);
    let x_1280 : f32 = u_xlat39;
    let x_1281 : f32 = u_xlat15;
    u_xlat15 = (x_1280 * x_1281);
    let x_1283 : f32 = u_xlat40;
    let x_1284 : f32 = u_xlat15;
    u_xlat15 = (x_1283 / x_1284);
    let x_1286 : vec3<f32> = u_xlat0;
    let x_1287 : f32 = u_xlat15;
    let x_1290 : vec3<f32> = u_xlat8;
    u_xlat21 = ((x_1286 * vec3<f32>(x_1287, x_1287, x_1287)) + x_1290);
    let x_1292 : vec3<f32> = u_xlat21;
  ...
  u_xlat0 = ((vec3<f32>(x_1302.x, x_1302.y, x_1302.z) * vec3<f32>(x_1304, x_1304, x_1304)) + vec3<f32>(x_1307.x, x_1307.y, x_1307.z));
  let x_1310 : vec4<f32> = u_xlat7;
  let x_1312 : vec3<f32> = u_xlat0;
  u_xlat0 = (vec3<f32>(x_1310.x, x_1310.y, x_1310.z) + x_1312);
  let x_1314 : vec4<f32> = u_xlat2;
  let x_1316 : f32 = u_xlat25;
  let x_1319 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1314.x, x_1314.y, x_1314.z) * vec3<f32>(x_1316, x_1316, x_1316)) + x_1319);
  let x_1321 : f32 = u_xlat36;
  let x_1322 : f32 = u_xlat36;
  u_xlat36 = (x_1321 * -(x_1322));
  let x_1325 : f32 = u_xlat36;
  u_xlat36 = exp2(x_1325);
  let x_1327 : vec3<f32> = u_xlat0;
  let x_1330 : vec4<f32> = x_45.unity_FogColor;
  u_xlat0 = (x_1327 + -(vec3<f32>(x_1330.x, x_1330.y, x_1330.z)));
  let x_1336 : f32 = u_xlat36;
  let x_1338 : vec3<f32> = u_xlat0;
  let x_1341 : vec4<f32> = x_45.unity_FogColor;
  let x_1343 : vec3<f32> = ((vec3<f32>(x_1336, x_1336, x_1336) * x_1338) + vec3<f32>(x_1341.x, x_1341.y, x_1341.z));
