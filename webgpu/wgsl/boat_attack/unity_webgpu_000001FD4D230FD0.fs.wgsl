...
fn main_1() {
  ...
  let x_1470 : vec2<f32> = vs_TEXCOORD0;
  let x_1473 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1477 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1479 : vec2<f32> = ((x_1470 * vec2<f32>(x_1473.x, x_1473.y)) + vec2<f32>(x_1477.z, x_1477.w));
  let x_1480 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1479.x, x_1479.y, x_1480.z, x_1480.w);
  let x_1487 : vec4<f32> = u_xlat1;
  let x_1490 : f32 = x_27.x_GlobalMipBias.x;
  let x_1491 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1487.x, x_1487.y), x_1490);
  u_xlat21 = x_1491.w;
  let x_1493 : f32 = u_xlat21;
  u_xlat21 = ((x_1493 * 2.0f) + -1.0f);
  let x_1496 : f32 = u_xlat21;
  u_xlatb1.x = (x_1496 >= 0.0f);
  let x_1500 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1500);
  let x_1503 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1503)) + 1.0f);
  let x_1507 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1507);
  let x_1509 : f32 = u_xlat21;
  u_xlat21 = (-(x_1509) + 1.0f);
  let x_1512 : f32 = u_xlat21;
  let x_1514 : f32 = u_xlat1.x;
  u_xlat21 = (x_1512 * x_1514);
  let x_1516 : vec3<f32> = u_xlat0;
  let x_1519 : vec3<f32> = (x_1516 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1520 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1519.x, x_1519.y, x_1519.z, x_1520.w);
  let x_1522 : vec3<f32> = u_xlat0;
  let x_1524 : vec3<f32> = log2(abs(x_1522));
  let x_1525 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1524.x, x_1524.y, x_1524.z, x_1525.w);
  let x_1527 : vec4<f32> = u_xlat2;
  let x_1531 : vec3<f32> = (vec3<f32>(x_1527.x, x_1527.y, x_1527.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1546 : vec3<f32> = ((vec3<f32>(x_1539.x, x_1539.y, x_1539.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1547 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1546.x, x_1546.y, x_1546.z, x_1547.w);
  let x_1552 : vec3<f32> = u_xlat0;
  let x_1554 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1552.x, x_1552.y, x_1552.z, x_1552.x));
  ...
  u_xlat0.z = x_1590;
  let x_1592 : f32 = u_xlat21;
  let x_1597 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1592, x_1592, x_1592) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1597);
  let x_1599 : vec3<f32> = u_xlat0;
  let x_1602 : vec3<f32> = (x_1599 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1603 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1602.x, x_1602.y, x_1602.z, x_1603.w);
  let x_1605 : vec3<f32> = u_xlat0;
  let x_1608 : vec3<f32> = (x_1605 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1609 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1608.x, x_1608.y, x_1608.z, x_1609.w);
  let x_1611 : vec4<f32> = u_xlat2;
  let x_1615 : vec3<f32> = (vec3<f32>(x_1611.x, x_1611.y, x_1611.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1616 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1615.x, x_1615.y, x_1615.z, x_1616.w);
  let x_1618 : vec4<f32> = u_xlat2;
  let x_1621 : vec3<f32> = log2(abs(vec3<f32>(x_1618.x, x_1618.y, x_1618.z)));
  let x_1622 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1621.x, x_1621.y, x_1621.z, x_1622.w);
  let x_1624 : vec4<f32> = u_xlat2;
  let x_1628 : vec3<f32> = (vec3<f32>(x_1624.x, x_1624.y, x_1624.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1640 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1638.x, x_1638.y, x_1638.z, x_1638.x));
  u_xlatb0 = vec3<bool>(x_1640.x, x_1640.y, x_1640.z);
