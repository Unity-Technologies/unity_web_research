#line 1 "Hidden/Universal Render Pipeline/GaussianDepthOfField"
static const int _HIGH_QUALITY_SAMPLING = 0 ;
...
float2 uv = input . texcoord ;
#line 121
half farCoC = _FullCoCTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) . x ;
#line 125
...
#line 185
half3 farColor = _ColorTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) . xyz ;
#line 188
half3 dstColor = 0.0 ;
half dstAlpha = 1.0 ;
