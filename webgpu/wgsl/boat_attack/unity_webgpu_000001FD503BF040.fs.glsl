...
void main()
{
    ...
    u_xlatb20.x = 0.0>=vs_INTERP3.z;
    u_xlatb34.x = vs_INTERP3.z>=1.0;
    u_xlatb20.x = u_xlatb34.x || u_xlatb20.x;
    ...
    u_xlat42 = u_xlat43 * unity_LightData.z;
    ...
    u_xlat42 = u_xlat42 * u_xlat28.x + 1.00001001;
    ...
    u_xlat8.xyz = vec3(u_xlat42) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat5.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat42 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu42 =  uint(int(u_xlat42));
    u_xlat43 = u_xlat20.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat43 = clamp(u_xlat43, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat51 = u_xlat43 * u_xlat52 + u_xlat51;
    ...
    u_xlat16.xyz = u_xlat16.xyz * u_xlat6.xxx + u_xlat7.xyz;
    u_xlat16.xyz = u_xlat8.xyz + u_xlat16.xyz;
    u_xlat1.xyz = vs_INTERP6.www * u_xlat1.xyz + u_xlat16.xyz;
    u_xlat14.x = u_xlat14.x * (-u_xlat14.x);
    u_xlat14.x = exp2(u_xlat14.x);
    u_xlat1.xyz = u_xlat1.xyz + (-unity_FogColor.xyz);
    SV_Target0.xyz = u_xlat14.xxx * u_xlat1.xyz + unity_FogColor.xyz;
