...
fn main_1() {
  ...
  u_xlat0.z = x_1105;
  let x_1107 : vec2<f32> = vs_TEXCOORD0;
  let x_1110 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1114 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1116 : vec2<f32> = ((x_1107 * vec2<f32>(x_1110.x, x_1110.y)) + vec2<f32>(x_1114.z, x_1114.w));
  let x_1117 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1116.x, x_1116.y, x_1117.z, x_1117.w);
  let x_1124 : vec4<f32> = u_xlat1;
  let x_1127 : f32 = x_25.x_GlobalMipBias.x;
  let x_1128 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1124.x, x_1124.y), x_1127);
  u_xlat21 = x_1128.w;
  let x_1130 : f32 = u_xlat21;
  u_xlat21 = ((x_1130 * 2.0f) + -1.0f);
  let x_1134 : f32 = u_xlat21;
  u_xlatb1.x = (x_1134 >= 0.0f);
  let x_1138 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1138);
  let x_1141 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1141)) + 1.0f);
  let x_1145 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1145);
  let x_1147 : f32 = u_xlat21;
  u_xlat21 = (-(x_1147) + 1.0f);
  let x_1150 : f32 = u_xlat21;
  let x_1152 : f32 = u_xlat1.x;
  u_xlat21 = (x_1150 * x_1152);
  let x_1154 : vec4<f32> = u_xlat0;
  let x_1156 : vec3<f32> = (vec3<f32>(x_1154.x, x_1154.y, x_1154.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1157 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1156.x, x_1156.y, x_1156.z, x_1157.w);
  let x_1159 : vec4<f32> = u_xlat0;
  let x_1162 : vec3<f32> = log2(abs(vec3<f32>(x_1159.x, x_1159.y, x_1159.z)));
  let x_1163 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1162.x, x_1162.y, x_1162.z, x_1163.w);
  let x_1165 : vec4<f32> = u_xlat2;
  let x_1167 : vec3<f32> = (vec3<f32>(x_1165.x, x_1165.y, x_1165.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1168 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1167.x, x_1167.y, x_1167.z, x_1168.w);
  let x_1170 : vec4<f32> = u_xlat2;
  let x_1172 : vec3<f32> = exp2(vec3<f32>(x_1170.x, x_1170.y, x_1170.z));
  let x_1173 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1172.x, x_1172.y, x_1172.z, x_1173.w);
  let x_1175 : vec4<f32> = u_xlat2;
  let x_1178 : vec3<f32> = ((vec3<f32>(x_1175.x, x_1175.y, x_1175.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1179 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1178.x, x_1178.y, x_1178.z, x_1179.w);
  let x_1181 : vec4<f32> = u_xlat0;
  let x_1183 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1181.x, x_1181.y, x_1181.z, x_1181.x));
  u_xlatb0 = vec3<bool>(x_1183.x, x_1183.y, x_1183.z);
  let x_1186 : bool = u_xlatb0.x;
  if (x_1186) {
  ...
  u_xlat0.z = x_1219;
  let x_1221 : f32 = u_xlat21;
  let x_1226 : vec4<f32> = u_xlat0;
  let x_1228 : vec3<f32> = ((vec3<f32>(x_1221, x_1221, x_1221) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1226.x, x_1226.y, x_1226.z));
  let x_1229 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1228.x, x_1228.y, x_1228.z, x_1229.w);
  let x_1231 : vec4<f32> = u_xlat0;
  let x_1233 : vec3<f32> = (vec3<f32>(x_1231.x, x_1231.y, x_1231.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1234 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1233.x, x_1233.y, x_1233.z, x_1234.w);
  let x_1236 : vec4<f32> = u_xlat0;
  let x_1238 : vec3<f32> = (vec3<f32>(x_1236.x, x_1236.y, x_1236.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1239 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1238.x, x_1238.y, x_1238.z, x_1239.w);
  let x_1241 : vec4<f32> = u_xlat2;
  let x_1243 : vec3<f32> = (vec3<f32>(x_1241.x, x_1241.y, x_1241.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  ...
  let x_1254 : vec3<f32> = (vec3<f32>(x_1252.x, x_1252.y, x_1252.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1264 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1262.x, x_1262.y, x_1262.z, x_1262.x));
  u_xlatb0 = vec3<bool>(x_1264.x, x_1264.y, x_1264.z);
  let x_1267 : bool = u_xlatb0.x;
  if (x_1267) {
  ...
  u_xlat0.x = x_1276;
  let x_1279 : bool = u_xlatb0.y;
  if (x_1279) {
    let x_1284 : f32 = u_xlat1.y;
    x_1280 = x_1284;
  } else {
    let x_1287 : f32 = u_xlat2.y;
    x_1280 = x_1287;
  }
  let x_1288 : f32 = x_1280;
  u_xlat0.y = x_1288;
  let x_1291 : bool = u_xlatb0.z;
  if (x_1291) {
    let x_1296 : f32 = u_xlat1.z;
    x_1292 = x_1296;
  } else {
  ...
  let x_1307 : vec3<f32> = max(vec3<f32>(x_1304.x, x_1304.y, x_1304.z), vec3<f32>(0.0f, 0.0f, 0.0f));
