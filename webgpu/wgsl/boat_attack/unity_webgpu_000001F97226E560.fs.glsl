...
;
    ...
    u_xlat15.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati3 + 1) / 4][(u_xlati3 + 1) % 4].xyz;
    u_xlat15.xyz = _MainLightWorldToShadow[u_xlati3 / 4][u_xlati3 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat15.xyz;
    u_xlat15.xyz = _MainLightWorldToShadow[(u_xlati3 + 2) / 4][(u_xlati3 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat15.xyz;
    u_xlat3.xyz = u_xlat15.xyz + _MainLightWorldToShadow[(u_xlati3 + 3) / 4][(u_xlati3 + 3) % 4].xyz;
    u_xlat39 = vs_TEXCOORD7.y * unity_MatrixV[1].z;
    u_xlat39 = unity_MatrixV[0].z * vs_TEXCOORD7.x + u_xlat39;
    u_xlat39 = unity_MatrixV[2].z * vs_TEXCOORD7.z + u_xlat39;
    ...
    u_xlat41 = u_xlat38 * u_xlat38;
    u_xlat36 = u_xlat0.w + u_xlat40;
    ...
    u_xlat27 = u_xlat15.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat27 = clamp(u_xlat27, 0.0, 1.0);
    u_xlat6.x = (-u_xlat3.x) + 1.0;
    u_xlat3.x = u_xlat27 * u_xlat6.x + u_xlat3.x;
    u_xlat27 = dot((-u_xlat13.xyz), u_xlat2.xyz);
    u_xlat27 = u_xlat27 + u_xlat27;
    u_xlat6.xyz = u_xlat2.xyz * (-vec3(u_xlat27)) + (-u_xlat13.xyz);
    u_xlat27 = dot(u_xlat2.xyz, u_xlat13.xyz);
    u_xlat27 = clamp(u_xlat27, 0.0, 1.0);
    ...
    u_xlat1 = u_xlat15.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat3.x = float(0.0);
    u_xlat3.y = float(0.0);
    u_xlat3.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat42) + u_xlat5.xyz;
