...
;
    ...
    u_xlat3.x = dot((-u_xlat7.xyz), u_xlat26.xyz);
    u_xlat3.x = u_xlat3.x + u_xlat3.x;
    u_xlat8.xyz = u_xlat26.xyz * (-u_xlat3.xxx) + (-u_xlat7.xyz);
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat29.x);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_INTERP8.xyz) * _AdditionalLightsPosition[u_xlati58].www + _AdditionalLightsPosition[u_xlati58].xyz;
        ...
        u_xlat86 = u_xlat2.x * u_xlat87 + u_xlat86;
        ...
        u_xlat58.x = dot(u_xlat26.xyz, u_xlat9.xyz);
        ...
        u_xlat58.x = u_xlat58.x * u_xlat29.x + 1.00001001;
        u_xlat58.x = u_xlat58.x * u_xlat58.x;
        u_xlat84 = max(u_xlat58.y, 0.100000001);
        u_xlat58.x = u_xlat84 * u_xlat58.x;
        u_xlat58.x = u_xlat6.x * u_xlat58.x;
        u_xlat58.x = u_xlat82 / u_xlat58.x;
        u_xlat9.xyz = u_xlat58.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat5.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * u_xlat32.xxx + u_xlat28.xyz;
