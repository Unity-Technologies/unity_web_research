...
;
    ...
    u_xlat29 = u_xlat6.x + 0.0400000215;
    u_xlat29 = min(u_xlat29, 1.0);
    u_xlat41 = u_xlat5.x * 4.0 + 2.0;
    ...
    u_xlat30 = dot((-u_xlat2.xzw), u_xlat12.xyz);
    u_xlat30 = u_xlat30 + u_xlat30;
    u_xlat7.xyz = u_xlat12.xyz * (-vec3(u_xlat30)) + (-u_xlat2.xzw);
    u_xlat30 = dot(u_xlat12.xyz, u_xlat2.xzw);
    u_xlat30 = clamp(u_xlat30, 0.0, 1.0);
    ...
    u_xlat5.x = u_xlat29 + -0.0399999991;
    ...
    u_xlat20.xyz = u_xlat0.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat29 = dot(unity_LightIndices[int(u_xlatu29)], uintBitsToFloat(ImmCB_0[u_xlati43]));
        u_xlati29 = int(u_xlat29);
        u_xlat20.xyz = (-vs_INTERP8.xyz) * _AdditionalLightsPosition[u_xlati29].www + _AdditionalLightsPosition[u_xlati29].xyz;
        ...
        if(u_xlatb22.x){
            ...
            u_xlat22 = 1.0 + (-_AdditionalShadowParams[u_xlati29].x);
            u_xlat10.x = u_xlat10.x * _AdditionalShadowParams[u_xlati29].x + u_xlat22;
        ...
        u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
        u_xlat43 = u_xlat43 * u_xlat10.x;
        u_xlat10.xyz = vec3(u_xlat43) * _AdditionalLightsColor[u_xlati29].xyz;
        u_xlat20.xyz = u_xlat20.xyz * vec3(u_xlat9) + u_xlat2.xzw;
        u_xlat29 = dot(u_xlat20.xyz, u_xlat20.xyz);
        u_xlat29 = max(u_xlat29, 1.17549435e-38);
        u_xlat29 = inversesqrt(u_xlat29);
        u_xlat20.xyz = vec3(u_xlat29) * u_xlat20.xyz;
        u_xlat29 = dot(u_xlat12.xyz, u_xlat20.xyz);
        ...
        u_xlat29 = u_xlat17 / u_xlat29;
        u_xlat20.xyz = vec3(u_xlat29) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
        u_xlat18.xyz = u_xlat20.xyz * u_xlat10.xyz + u_xlat18.xyz;
    }
    u_xlat0.xyz = u_xlat15.xyz * u_xlat6.xxx + u_xlat7.xyz;
