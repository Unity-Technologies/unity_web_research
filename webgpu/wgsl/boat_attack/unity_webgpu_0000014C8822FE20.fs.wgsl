...
fn main_1() {
  ...
  let x_1797 : vec3<f32> = (x_1796 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1798 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1797.x, x_1797.y, x_1797.z, x_1798.w);
  let x_1800 : vec3<f32> = u_xlat0;
  let x_1802 : vec3<f32> = log2(abs(x_1800));
  let x_1803 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1802.x, x_1802.y, x_1802.z, x_1803.w);
  let x_1805 : vec4<f32> = u_xlat2;
  let x_1807 : vec3<f32> = (vec3<f32>(x_1805.x, x_1805.y, x_1805.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1808 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1807.x, x_1807.y, x_1807.z, x_1808.w);
  let x_1810 : vec4<f32> = u_xlat2;
  let x_1812 : vec3<f32> = exp2(vec3<f32>(x_1810.x, x_1810.y, x_1810.z));
  let x_1813 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1812.x, x_1812.y, x_1812.z, x_1813.w);
  let x_1815 : vec4<f32> = u_xlat2;
  let x_1818 : vec3<f32> = ((vec3<f32>(x_1815.x, x_1815.y, x_1815.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1819 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1818.x, x_1818.y, x_1818.z, x_1819.w);
  let x_1821 : vec3<f32> = u_xlat0;
  let x_1823 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1821.x, x_1821.y, x_1821.z, x_1821.x));
  u_xlatb0 = vec3<bool>(x_1823.x, x_1823.y, x_1823.z);
  let x_1826 : bool = u_xlatb0.x;
  if (x_1826) {
  ...
  u_xlat0.x = x_1835;
  let x_1838 : bool = u_xlatb0.y;
  if (x_1838) {
    let x_1843 : f32 = u_xlat1.y;
    x_1839 = x_1843;
  } else {
    let x_1846 : f32 = u_xlat2.y;
    x_1839 = x_1846;
  }
  let x_1847 : f32 = x_1839;
  u_xlat0.y = x_1847;
  let x_1850 : bool = u_xlatb0.z;
  if (x_1850) {
    let x_1855 : f32 = u_xlat1.z;
    x_1851 = x_1855;
  } else {
  ...
  u_xlat0.z = x_1859;
  let x_1861 : vec2<f32> = vs_TEXCOORD0;
  let x_1864 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1868 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1870 : vec2<f32> = ((x_1861 * vec2<f32>(x_1864.x, x_1864.y)) + vec2<f32>(x_1868.z, x_1868.w));
  let x_1871 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1870.x, x_1870.y, x_1871.z, x_1871.w);
  let x_1878 : vec4<f32> = u_xlat1;
  let x_1881 : f32 = x_26.x_GlobalMipBias.x;
  let x_1882 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1878.x, x_1878.y), x_1881);
  u_xlat21 = x_1882.w;
  let x_1884 : f32 = u_xlat21;
  u_xlat21 = ((x_1884 * 2.0f) + -1.0f);
  let x_1887 : f32 = u_xlat21;
  u_xlatb1 = (x_1887 >= 0.0f);
  let x_1889 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1889);
  let x_1892 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1892)) + 1.0f);
  let x_1896 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1896);
  let x_1898 : f32 = u_xlat21;
  u_xlat21 = (-(x_1898) + 1.0f);
  let x_1901 : f32 = u_xlat21;
  let x_1903 : f32 = u_xlat1.x;
  u_xlat21 = (x_1901 * x_1903);
  let x_1905 : vec3<f32> = u_xlat0;
  let x_1906 : vec3<f32> = (x_1905 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1907 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1906.x, x_1906.y, x_1906.z, x_1907.w);
  let x_1909 : vec3<f32> = u_xlat0;
  let x_1911 : vec3<f32> = log2(abs(x_1909));
