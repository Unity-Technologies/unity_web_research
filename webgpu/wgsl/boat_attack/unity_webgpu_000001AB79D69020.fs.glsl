...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat43 = u_xlat0.x * 4.0 + vs_INTERP0.y;
    u_xlat43 = u_xlat43 * 0.330000013;
    u_xlat44 = vs_INTERP0.y + 1.0;
    ...
    u_xlat45 = (-u_xlat45) + vs_INTERP0.y;
    ...
    u_xlat15.xy = u_xlat15.xx * vs_INTERP3.xy;
    u_xlat18.xyz = texture(sampler2D(_SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1, sampler_SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1), u_xlat15.xy, _GlobalMipBias.x).xyw;
    u_xlat18.x = u_xlat18.x * u_xlat18.z;
    ...
    u_xlat14.xyz = u_xlat4.yyy * vs_INTERP2.xyz + u_xlat0.yzw;
    u_xlat14.xyz = u_xlat4.www * vs_INTERP1.xyz + u_xlat14.xyz;
    ...
    u_xlat21.xyz = vs_INTERP0.xyz + (-_CascadeShadowSplitSpheres3.xyz);
    u_xlat4.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat4.y = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat4.z = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat4.w = dot(u_xlat21.xyz, u_xlat21.xyz);
...
;
    ...
    u_xlat4.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati44 + 1) / 4][(u_xlati44 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati44 / 4][u_xlati44 % 4].xyz * vs_INTERP0.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati44 + 2) / 4][(u_xlati44 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati44 + 3) / 4][(u_xlati44 + 3) % 4].xyz;
    u_xlat44 = vs_INTERP0.y * unity_MatrixV[1].z;
    u_xlat44 = unity_MatrixV[0].z * vs_INTERP0.x + u_xlat44;
    u_xlat44 = unity_MatrixV[2].z * vs_INTERP0.z + u_xlat44;
    ...
    if(u_xlatb18.x){
        u_xlat18.xy = vs_INTERP0.yy * _MainLightWorldToLight[1].xy;
        u_xlat18.xy = _MainLightWorldToLight[0].xy * vs_INTERP0.xx + u_xlat18.xy;
        u_xlat18.xy = _MainLightWorldToLight[2].xy * vs_INTERP0.zz + u_xlat18.xy;
    ...
    u_xlat18.x = dot((-u_xlat1.xyz), u_xlat14.xyz);
    u_xlat18.x = u_xlat18.x + u_xlat18.x;
    u_xlat8.xyz = u_xlat14.xyz * (-u_xlat18.xxx) + (-u_xlat1.xyz);
    u_xlat18.x = dot(u_xlat14.xyz, u_xlat1.xyz);
    u_xlat18.x = clamp(u_xlat18.x, 0.0, 1.0);
    u_xlat18.x = (-u_xlat18.x) + 1.0;
    u_xlat18.x = u_xlat18.x * u_xlat18.x;
    u_xlat18.x = u_xlat18.x * u_xlat18.x;
    u_xlat32 = (-u_xlat43) * 0.699999988 + 1.70000005;
    ...
    u_xlat43 = float(1.0) / u_xlat34.y;
    u_xlat9.xyz = (-u_xlat2.xyz) + u_xlat0.xxx;
    u_xlat9.xyz = u_xlat18.xxx * u_xlat9.xyz + u_xlat2.xyz;
    ...
    u_xlat43 = dot(u_xlat14.xyz, _MainLightPosition.xyz);
    ...
    u_xlat0.x = u_xlat0.x * u_xlat34.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat45 = dot(u_xlat14.xyz, u_xlat10.xyz);
        u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
        u_xlat45 = u_xlat45 * u_xlat48;
        u_xlat11.xyz = vec3(u_xlat45) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat35) + u_xlat1.xyz;
        ...
        u_xlat9.xyz = u_xlat2.xyz * vec3(u_xlat45) + u_xlat3.xyz;
