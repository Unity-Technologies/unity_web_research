...
;
    ...
    u_xlat6.xyz = vs_INTERP8.yyy * _MainLightWorldToShadow[(u_xlati42 + 1) / 4][(u_xlati42 + 1) % 4].xyz;
    u_xlat6.xyz = _MainLightWorldToShadow[u_xlati42 / 4][u_xlati42 % 4].xyz * vs_INTERP8.xxx + u_xlat6.xyz;
    u_xlat6.xyz = _MainLightWorldToShadow[(u_xlati42 + 2) / 4][(u_xlati42 + 2) % 4].xyz * vs_INTERP8.zzz + u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.x = u_xlat6.x * u_xlat29.x + 1.00001001;
        u_xlat35 = u_xlat35 * u_xlat35;
        u_xlat6.x = u_xlat6.x * u_xlat6.x;
