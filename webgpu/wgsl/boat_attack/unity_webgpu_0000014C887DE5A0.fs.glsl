...
;
    ...
    u_xlat15.xyz = vs_INTERP7.xyz + (-_CascadeShadowSplitSpheres0.xyz);
...
;
    ...
    u_xlat15.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati14 + 1) / 4][(u_xlati14 + 1) % 4].xyz;
    u_xlat15.xyz = _MainLightWorldToShadow[u_xlati14 / 4][u_xlati14 % 4].xyz * vs_INTERP7.xxx + u_xlat15.xyz;
    u_xlat15.xyz = _MainLightWorldToShadow[(u_xlati14 + 2) / 4][(u_xlati14 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat15.xyz;
    ...
    u_xlat15.x = u_xlat43 * u_xlat45 + u_xlat15.x;
    ...
    u_xlat14.x = dot(u_xlat3.xyz, u_xlat8.xyz);
    ...
    u_xlat8.xyz = u_xlat2.xyz * u_xlat14.xxx + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat14.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu14 =  uint(int(u_xlat14.x));
    u_xlat28 = u_xlat29 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat28 = clamp(u_xlat28, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu14 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlati49 != 0) {
            ...
            u_xlat49 = (u_xlatb15.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb15.x) ? u_xlat11.xyz : vec3(u_xlat49);
        } else {
    ...
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat42) + u_xlat7.xyz;
