...
fn main_1() {
  ...
  let x_2134 : vec2<f32> = vs_TEXCOORD0;
  let x_2137 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2141 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2143 : vec2<f32> = ((x_2134 * vec2<f32>(x_2137.x, x_2137.y)) + vec2<f32>(x_2141.z, x_2141.w));
  let x_2144 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2143.x, x_2143.y, x_2144.z, x_2144.w);
  let x_2151 : vec4<f32> = u_xlat1;
  let x_2154 : f32 = x_25.x_GlobalMipBias.x;
  let x_2155 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2151.x, x_2151.y), x_2154);
  u_xlat21 = x_2155.w;
  let x_2157 : f32 = u_xlat21;
  u_xlat21 = ((x_2157 * 2.0f) + -1.0f);
  let x_2160 : f32 = u_xlat21;
  u_xlatb1 = (x_2160 >= 0.0f);
  let x_2162 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2162);
  let x_2165 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2165)) + 1.0f);
  let x_2169 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2169);
  let x_2171 : f32 = u_xlat21;
  u_xlat21 = (-(x_2171) + 1.0f);
  let x_2174 : f32 = u_xlat21;
  let x_2176 : f32 = u_xlat1.x;
  u_xlat21 = (x_2174 * x_2176);
  let x_2178 : vec4<f32> = u_xlat0;
  let x_2180 : vec3<f32> = (vec3<f32>(x_2178.x, x_2178.y, x_2178.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2181 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2180.x, x_2180.y, x_2180.z, x_2181.w);
  let x_2183 : vec4<f32> = u_xlat0;
  let x_2186 : vec3<f32> = log2(abs(vec3<f32>(x_2183.x, x_2183.y, x_2183.z)));
  let x_2187 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2186.x, x_2186.y, x_2186.z, x_2187.w);
  let x_2189 : vec4<f32> = u_xlat2;
  let x_2191 : vec3<f32> = (vec3<f32>(x_2189.x, x_2189.y, x_2189.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2192 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2191.x, x_2191.y, x_2191.z, x_2192.w);
  let x_2194 : vec4<f32> = u_xlat2;
  let x_2196 : vec3<f32> = exp2(vec3<f32>(x_2194.x, x_2194.y, x_2194.z));
  let x_2197 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2196.x, x_2196.y, x_2196.z, x_2197.w);
  let x_2199 : vec4<f32> = u_xlat2;
  let x_2202 : vec3<f32> = ((vec3<f32>(x_2199.x, x_2199.y, x_2199.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2203 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2202.x, x_2202.y, x_2202.z, x_2203.w);
  let x_2205 : vec4<f32> = u_xlat0;
  let x_2207 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2205.x, x_2205.y, x_2205.z, x_2205.x));
  u_xlatb0 = vec3<bool>(x_2207.x, x_2207.y, x_2207.z);
  let x_2210 : bool = u_xlatb0.x;
  if (x_2210) {
  ...
  let x_2219 : f32 = x_2211;
  u_xlat0.x = x_2219;
  let x_2222 : bool = u_xlatb0.y;
  if (x_2222) {
    let x_2227 : f32 = u_xlat1.y;
    x_2223 = x_2227;
  } else {
    let x_2230 : f32 = u_xlat2.y;
    x_2223 = x_2230;
  }
  let x_2231 : f32 = x_2223;
  u_xlat0.y = x_2231;
  let x_2234 : bool = u_xlatb0.z;
  if (x_2234) {
    let x_2239 : f32 = u_xlat1.z;
    x_2235 = x_2239;
  } else {
    let x_2242 : f32 = u_xlat2.z;
    x_2235 = x_2242;
  }
  let x_2243 : f32 = x_2235;
  u_xlat0.z = x_2243;
  let x_2245 : f32 = u_xlat21;
  let x_2250 : vec4<f32> = u_xlat0;
  let x_2252 : vec3<f32> = ((vec3<f32>(x_2245, x_2245, x_2245) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2250.x, x_2250.y, x_2250.z));
  let x_2253 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2252.x, x_2252.y, x_2252.z, x_2253.w);
  let x_2255 : vec4<f32> = u_xlat0;
  let x_2257 : vec3<f32> = (vec3<f32>(x_2255.x, x_2255.y, x_2255.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2258 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2257.x, x_2257.y, x_2257.z, x_2258.w);
  let x_2260 : vec4<f32> = u_xlat0;
  let x_2262 : vec3<f32> = (vec3<f32>(x_2260.x, x_2260.y, x_2260.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2263 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2262.x, x_2262.y, x_2262.z, x_2263.w);
  let x_2265 : vec4<f32> = u_xlat2;
  let x_2267 : vec3<f32> = (vec3<f32>(x_2265.x, x_2265.y, x_2265.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2268 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2267.x, x_2267.y, x_2267.z, x_2268.w);
  let x_2270 : vec4<f32> = u_xlat2;
  let x_2273 : vec3<f32> = log2(abs(vec3<f32>(x_2270.x, x_2270.y, x_2270.z)));
  let x_2274 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2273.x, x_2273.y, x_2273.z, x_2274.w);
  let x_2276 : vec4<f32> = u_xlat2;
  let x_2278 : vec3<f32> = (vec3<f32>(x_2276.x, x_2276.y, x_2276.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2279 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2278.x, x_2278.y, x_2278.z, x_2279.w);
  let x_2281 : vec4<f32> = u_xlat2;
  let x_2283 : vec3<f32> = exp2(vec3<f32>(x_2281.x, x_2281.y, x_2281.z));
  let x_2284 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2283.x, x_2283.y, x_2283.z, x_2284.w);
  let x_2286 : vec4<f32> = u_xlat0;
  let x_2288 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2286.x, x_2286.y, x_2286.z, x_2286.x));
  u_xlatb0 = vec3<bool>(x_2288.x, x_2288.y, x_2288.z);
  let x_2291 : bool = u_xlatb0.x;
  if (x_2291) {
    let x_2296 : f32 = u_xlat1.x;
    x_2292 = x_2296;
  } else {
    let x_2299 : f32 = u_xlat2.x;
    x_2292 = x_2299;
  }
  let x_2300 : f32 = x_2292;
  u_xlat0.x = x_2300;
  let x_2303 : bool = u_xlatb0.y;
  if (x_2303) {
    let x_2308 : f32 = u_xlat1.y;
    x_2304 = x_2308;
  } else {
    let x_2311 : f32 = u_xlat2.y;
    x_2304 = x_2311;
  }
  let x_2312 : f32 = x_2304;
  u_xlat0.y = x_2312;
  let x_2315 : bool = u_xlatb0.z;
  if (x_2315) {
    let x_2320 : f32 = u_xlat1.z;
    x_2316 = x_2320;
  } else {
    let x_2323 : f32 = u_xlat2.z;
    x_2316 = x_2323;
  }
  let x_2324 : f32 = x_2316;
  u_xlat0.z = x_2324;
  let x_2328 : vec4<f32> = u_xlat0;
  let x_2330 : vec3<f32> = max(vec3<f32>(x_2328.x, x_2328.y, x_2328.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2331 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2330.x, x_2330.y, x_2330.z, x_2331.w);
  SV_Target0.w = 1.0f;
  return;
}
