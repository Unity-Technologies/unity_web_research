...
;
    ...
    u_xlat65 = vs_TEXCOORD7.y * unity_MatrixV[1].z;
    u_xlat65 = unity_MatrixV[0].z * vs_TEXCOORD7.x + u_xlat65;
    u_xlat65 = unity_MatrixV[2].z * vs_TEXCOORD7.z + u_xlat65;
    ...
    u_xlat25 = u_xlat64 * u_xlat64;
    u_xlat42 = u_xlat42 + u_xlat66;
    u_xlat42 = clamp(u_xlat42, 0.0, 1.0);
    u_xlat66 = u_xlat64 * 4.0 + 2.0;
    ...
    u_xlat4.xw = vec2(u_xlat64) * vec2(u_xlat64) + vec2(-1.0, 1.0);
    u_xlat0.x = float(1.0) / u_xlat4.w;
    u_xlat10.xyz = (-u_xlat5.xyz) + vec3(u_xlat42);
    ...
    u_xlat0.z = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    ...
    u_xlat7.xyz = u_xlat5.xyz * u_xlat0.xxx + u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu64)].www + _AdditionalLightsPosition[int(u_xlatu64)].xyz;
        ...
        u_xlat69 = dot(_AdditionalLightsSpotDir[int(u_xlatu64)].xyz, u_xlat11.xyz);
        ...
        u_xlati49 = 1 << (int(u_xlatu64) & int(0x1F));
        u_xlati69 = int(uint(u_xlati49) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu69)]));
        if(u_xlati69 != 0) {
            u_xlati69 = int(_AdditionalLightsLightTypes[int(u_xlatu64)]);
            u_xlati49 = (u_xlati69 != 0) ? 0 : 1;
            u_xlati70 = int(u_xlatu64) << (2 & int(0x1F));
            if(u_xlati49 != 0) {
                u_xlat12.xyz = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4].xyw;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[u_xlati70 / 4][u_xlati70 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat12.xyz;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat12.xyz;
                u_xlat12.xyz = u_xlat12.xyz + _AdditionalLightsWorldToLights[(u_xlati70 + 3) / 4][(u_xlati70 + 3) % 4].xyw;
                u_xlat12.xy = u_xlat12.xy / u_xlat12.zz;
                u_xlat12.xy = u_xlat12.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat12.xy = clamp(u_xlat12.xy, 0.0, 1.0);
                u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu64)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu64)].zw;
            } else {
                u_xlatb69 = u_xlati69==1;
                u_xlati69 = u_xlatb69 ? 1 : int(0);
                if(u_xlati69 != 0) {
                    u_xlat54.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4].xy;
                    u_xlat54.xy = _AdditionalLightsWorldToLights[u_xlati70 / 4][u_xlati70 % 4].xy * vs_TEXCOORD7.xx + u_xlat54.xy;
                    u_xlat54.xy = _AdditionalLightsWorldToLights[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat54.xy;
                    u_xlat54.xy = u_xlat54.xy + _AdditionalLightsWorldToLights[(u_xlati70 + 3) / 4][(u_xlati70 + 3) % 4].xy;
                    u_xlat54.xy = u_xlat54.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat54.xy = fract(u_xlat54.xy);
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu64)].xy * u_xlat54.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu64)].zw;
                } else {
                    u_xlat13 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToLights[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4];
                    u_xlat13 = _AdditionalLightsWorldToLights[u_xlati70 / 4][u_xlati70 % 4] * vs_TEXCOORD7.xxxx + u_xlat13;
                    u_xlat13 = _AdditionalLightsWorldToLights[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat13;
                    u_xlat13 = u_xlat13 + _AdditionalLightsWorldToLights[(u_xlati70 + 3) / 4][(u_xlati70 + 3) % 4];
                    ...
                    u_xlatb49.xy = greaterThanEqual(u_xlat14.yzyz, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    u_xlat49.x = (u_xlatb49.x) ? u_xlat14.x : (-u_xlat14.x);
                    u_xlat49.y = (u_xlatb49.y) ? u_xlat14.x : (-u_xlat14.x);
                    u_xlat49.xy = u_xlat13.xy * vec2(u_xlat69) + u_xlat49.xy;
                    u_xlat49.xy = u_xlat49.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat49.xy = clamp(u_xlat49.xy, 0.0, 1.0);
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu64)].xy * u_xlat49.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu64)].zw;
                }
            }
            ...
            u_xlat69 = (u_xlatb7.y) ? u_xlat12.w : u_xlat12.x;
            u_xlat12.xyz = (u_xlatb7.x) ? u_xlat12.xyz : vec3(u_xlat69);
        } else {
            u_xlat12.x = float(1.0);
            u_xlat12.y = float(1.0);
            u_xlat12.z = float(1.0);
        }
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[int(u_xlatu64)].xyz;
        u_xlat12.xyz = vec3(u_xlat46) * u_xlat12.xyz;
        u_xlat64 = dot(u_xlat1.xyz, u_xlat11.xyz);
        u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
        u_xlat64 = u_xlat64 * u_xlat67;
        u_xlat12.xyz = vec3(u_xlat64) * u_xlat12.xyz;
        u_xlat10.xyz = u_xlat10.xyz * vec3(u_xlat68) + u_xlat8.xyz;
        ...
        u_xlat64 = u_xlat64 * u_xlat4.x + 1.00001001;
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat64 = u_xlat64 * u_xlat64;
        ...
        u_xlat10.xyz = u_xlat5.xyz * vec3(u_xlat64) + u_xlat6.xyz;
