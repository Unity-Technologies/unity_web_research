...
;
    ...
    u_xlat26.xyz = vs_INTERP7.xyz + (-_CascadeShadowSplitSpheres0.xyz);
    ...
    u_xlat8.x = dot(u_xlat26.xyz, u_xlat26.xyz);
...
;
    u_xlat26.x = (u_xlatb5.x) ? float(-1.0) : float(-0.0);
    u_xlat26.y = (u_xlatb5.y) ? float(-1.0) : float(-0.0);
    u_xlat26.z = (u_xlatb5.z) ? float(-1.0) : float(-0.0);
    u_xlat26.xyz = u_xlat26.xyz + u_xlat6.yzw;
    u_xlat6.yzw = max(u_xlat26.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat25.x = dot(u_xlat6, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat25.x = (-u_xlat25.x) + 4.0;
    u_xlatu25 = uint(u_xlat25.x);
    u_xlati25 = int(u_xlatu25) << (2 & int(0x1F));
    u_xlat26.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati25 + 1) / 4][(u_xlati25 + 1) % 4].xyz;
    u_xlat26.xyz = _MainLightWorldToShadow[u_xlati25 / 4][u_xlati25 % 4].xyz * vs_INTERP7.xxx + u_xlat26.xyz;
    u_xlat26.xyz = _MainLightWorldToShadow[(u_xlati25 + 2) / 4][(u_xlati25 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat26.xyz;
    u_xlat26.xyz = u_xlat26.xyz + _MainLightWorldToShadow[(u_xlati25 + 3) / 4][(u_xlati25 + 3) % 4].xyz;
    u_xlat3.w = 1.0;
    ...
    u_xlat50 = (-u_xlat25.x) + 1.0;
    u_xlat6.xyz = u_xlat25.xxx * u_xlat2.xyz;
    ...
    if(u_xlatb78){
        ...
        if(u_xlatb78){
            ...
            if(u_xlatb79){
                u_xlat7.xy = u_xlat26.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat57.xy = u_xlat26.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                vec3 txVec6 = vec3(u_xlat57.xy,u_xlat26.z);
                ...
                vec3 txVec7 = vec3(u_xlat10.xy,u_xlat26.z);
                ...
                vec3 txVec10 = vec3(u_xlat10.zw,u_xlat26.z);
                ...
                vec3 txVec11 = vec3(u_xlat9.xy,u_xlat26.z);
                ...
                vec3 txVec12 = vec3(u_xlat9.zw,u_xlat26.z);
                ...
                vec3 txVec15 = vec3(u_xlat57.xy,u_xlat26.z);
                ...
                vec3 txVec16 = vec3(u_xlat16.xy,u_xlat26.z);
                ...
                vec3 txVec17 = vec3(u_xlat14.xy,u_xlat26.z);
                ...
                vec3 txVec18 = vec3(u_xlat14.zw,u_xlat26.z);
                ...
                vec3 txVec19 = vec3(u_xlat15.xy,u_xlat26.z);
                ...
                vec3 txVec20 = vec3(u_xlat16.zw,u_xlat26.z);
                ...
                vec3 txVec21 = vec3(u_xlat17.xy,u_xlat26.z);
                ...
                vec3 txVec22 = vec3(u_xlat17.zw,u_xlat26.z);
                ...
                vec3 txVec23 = vec3(u_xlat34.xy,u_xlat26.z);
                ...
                vec3 txVec24 = vec3(u_xlat65.xy,u_xlat26.z);
                ...
                vec3 txVec25 = vec3(u_xlat12.xy,u_xlat26.z);
                ...
                vec3 txVec26 = vec3(u_xlat12.zw,u_xlat26.z);
                ...
                vec3 txVec27 = vec3(u_xlat60.xy,u_xlat26.z);
                ...
                vec3 txVec28 = vec3(u_xlat7.xy,u_xlat26.z);
    ...
    u_xlat26.x = u_xlat78 * _MainLightShadowParams.x + u_xlat26.x;
    ...
    u_xlat78 = (-u_xlat26.x) + 1.0;
    u_xlat26.x = u_xlat76 * u_xlat78 + u_xlat26.x;
    u_xlat76 = dot((-u_xlat4.xyz), u_xlat3.xyz);
    u_xlat76 = u_xlat76 + u_xlat76;
    u_xlat7.xyz = u_xlat3.xyz * (-vec3(u_xlat76)) + (-u_xlat4.xyz);
    u_xlat76 = dot(u_xlat3.xyz, u_xlat4.xyz);
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
    u_xlat76 = (-u_xlat76) + 1.0;
    u_xlat76 = u_xlat76 * u_xlat76;
    u_xlat76 = u_xlat76 * u_xlat76;
    u_xlat78 = (-u_xlat0.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat25.x = inversesqrt(u_xlat25.x);
    u_xlat8.xyz = u_xlat25.xxx * u_xlat8.xyz;
    u_xlat25.x = dot(u_xlat3.xyz, u_xlat8.xyz);
    u_xlat25.x = clamp(u_xlat25.x, 0.0, 1.0);
    u_xlat25.y = dot(_MainLightPosition.xyz, u_xlat8.xyz);
    ...
    u_xlat8.xyz = u_xlat2.xyz * u_xlat25.xxx + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat25.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu25 =  uint(int(u_xlat25.x));
    u_xlat50 = u_xlat51 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu25 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat2.xyz * vec3(u_xlat79) + u_xlat6.xyz;
        u_xlat26.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat26.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat75) + u_xlat7.xyz;
    SV_Target0.xyz = u_xlat26.xyz + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
