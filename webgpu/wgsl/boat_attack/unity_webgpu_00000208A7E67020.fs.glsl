...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat1.x = (u_xlatb44) ? u_xlat1.x : u_xlat15.x;
    u_xlat42 = u_xlat42 * 2.0 + (-u_xlat1.x);
    u_xlat1.x = u_xlat42 * u_xlat3.w;
    u_xlatb15.x = u_xlat1.x>=0.400000006;
    u_xlat15.x = u_xlatb15.x ? u_xlat1.x : float(0.0);
    u_xlat42 = u_xlat3.w * u_xlat42 + -0.400000006;
    u_xlat29.x = dFdxCoarse(u_xlat1.x);
    u_xlat1.x = dFdyCoarse(u_xlat1.x);
    u_xlat1.x = abs(u_xlat1.x) + abs(u_xlat29.x);
    u_xlat1.x = max(u_xlat1.x, 9.99999975e-05);
    u_xlat42 = u_xlat42 / u_xlat1.x;
    u_xlat42 = u_xlat42 + 0.5;
    u_xlat42 = clamp(u_xlat42, 0.0, 1.0);
    u_xlatb1 = _AlphaToMaskAvailable!=0.0;
    u_xlat42 = (u_xlatb1) ? u_xlat42 : u_xlat15.x;
    u_xlat15.x = u_xlat42 + -9.99999975e-05;
    ...
    u_xlat19.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_INTERP5.xy, _GlobalMipBias.x).xyz;
    u_xlat6.xyz = u_xlat6.xyz + vec3(-0.5, -0.5, -0.5);
    u_xlat15.x = dot(u_xlat3.xyz, u_xlat6.xyz);
    u_xlat15.x = u_xlat15.x + 0.5;
    u_xlat19.xyz = u_xlat15.xxx * u_xlat19.xyz;
    u_xlat15.x = max(u_xlat6.w, 9.99999975e-05);
    u_xlat19.xyz = u_xlat19.xyz / u_xlat15.xxx;
    u_xlat15.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat6.xy = u_xlat15.xy * hlslcc_FragCoord.xy;
    ...
    u_xlat15.xy = u_xlat29.xx * u_xlat29.xx + vec2(-1.0, 1.0);
    u_xlat29.x = float(1.0) / u_xlat15.y;
    ...
    u_xlat29.x = u_xlat43 * unity_LightData.z;
    u_xlat43 = dot(u_xlat3.xyz, _MainLightPosition.xyz);
    u_xlat43 = clamp(u_xlat43, 0.0, 1.0);
    u_xlat29.x = u_xlat43 * u_xlat29.x;
    u_xlat20.xyz = u_xlat29.xxx * u_xlat20.xyz;
    u_xlat7.xyz = u_xlat2.xyz + _MainLightPosition.xyz;
    u_xlat29.x = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat29.x = max(u_xlat29.x, 1.17549435e-37);
    u_xlat29.x = inversesqrt(u_xlat29.x);
    u_xlat7.xyz = u_xlat29.xxx * u_xlat7.xyz;
    u_xlat29.x = dot(u_xlat3.xyz, u_xlat7.xyz);
    u_xlat29.x = clamp(u_xlat29.x, 0.0, 1.0);
    u_xlat29.y = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat29.y = clamp(u_xlat29.y, 0.0, 1.0);
    u_xlat29.xy = u_xlat29.xy * u_xlat29.xy;
    u_xlat29.x = u_xlat29.x * u_xlat15.x + 1.00001001;
    u_xlat29.x = u_xlat29.x * u_xlat29.x;
    u_xlat43 = max(u_xlat29.y, 0.100000001);
    u_xlat29.x = u_xlat43 * u_xlat29.x;
    u_xlat29.x = u_xlat46 * u_xlat29.x;
    u_xlat29.x = u_xlat44 / u_xlat29.x;
    u_xlat7.xyz = u_xlat29.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
    u_xlat20.xyz = u_xlat20.xyz * u_xlat7.xyz;
    u_xlat29.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu29 =  uint(int(u_xlat29.x));
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu29 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat45 = u_xlat45 * u_xlat15.x + 1.00001001;
        u_xlat35 = u_xlat35 * u_xlat35;
        u_xlat45 = u_xlat45 * u_xlat45;
    ...
    u_xlat15.xyz = u_xlat19.xyz * u_xlat5.xxx + u_xlat20.xyz;
    u_xlat15.xyz = u_xlat8.xyz + u_xlat15.xyz;
    SV_Target0.xyz = vs_INTERP4.www * u_xlat0.xyz + u_xlat15.xyz;
    SV_Target0.w = (u_xlatb1) ? u_xlat42 : 1.0;
    return;
}
