...
fn main_1() {
  ...
  let x_219 : vec2<f32> = (x_216 * vec2<f32>(0.08163200318813323975f, 0.08163200318813323975f));
  ...
  u_xlat5.z = (x_251 * 0.08163200318813323975f);
  let x_256 : f32 = u_xlat17.y;
  u_xlat6.z = (x_256 * 0.08163200318813323975f);
  let x_259 : vec4<f32> = u_xlat4;
  let x_262 : vec4<f32> = u_xlat0;
  u_xlat17 = ((vec2<f32>(x_259.x, x_259.z) * vec2<f32>(0.5f, 0.5f)) + -(vec2<f32>(x_262.x, x_262.y)));
  let x_266 : vec4<f32> = u_xlat4;
  let x_270 : vec2<f32> = (vec2<f32>(x_266.w, x_266.y) * vec2<f32>(0.04081600159406661987f, 0.04081600159406661987f));
  let x_271 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_271.x, x_271.y, x_270.x, x_270.y);
  let x_273 : vec2<f32> = u_xlat17;
  let x_275 : vec2<f32> = (vec2<f32>(x_273.y, x_273.x) * vec2<f32>(0.08163200318813323975f, 0.08163200318813323975f));
  ...
  let x_292 : vec2<f32> = ((vec2<f32>(x_285.x, x_285.x) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.16326400637626647949f, 0.08163200318813323975f));
  let x_293 : vec4<f32> = u_xlat5;
  u_xlat5 = vec4<f32>(x_293.x, x_292.x, x_293.z, x_292.y);
  let x_295 : vec4<f32> = u_xlat0;
  let x_299 : vec2<f32> = ((vec2<f32>(x_295.x, x_295.x) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.08163200318813323975f, 0.16326400637626647949f));
  ...
  let x_327 : vec2<f32> = ((vec2<f32>(x_324.y, x_324.y) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.16326400637626647949f, 0.08163200318813323975f));
  let x_328 : vec4<f32> = u_xlat6;
  u_xlat6 = vec4<f32>(x_328.x, x_327.x, x_328.z, x_327.y);
  let x_330 : vec4<f32> = u_xlat0;
  let x_333 : vec2<f32> = ((vec2<f32>(x_330.y, x_330.y) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.08163200318813323975f, 0.16326400637626647949f));
