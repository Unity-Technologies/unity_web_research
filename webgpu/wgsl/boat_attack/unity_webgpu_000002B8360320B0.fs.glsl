...
;
    ...
    if(u_xlatb27){
        u_xlat19.xy = vs_INTERP7.yy * _MainLightWorldToLight[1].xy;
        u_xlat19.xy = _MainLightWorldToLight[0].xy * vs_INTERP7.xx + u_xlat19.xy;
        u_xlat19.xy = _MainLightWorldToLight[2].xy * vs_INTERP7.zz + u_xlat19.xy;
        ...
        u_xlat27 = (u_xlatb19.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat19.xyz = (u_xlatb19.x) ? u_xlat7.xyz : vec3(u_xlat27);
    } else {
    ...
    u_xlat27 = dot((-u_xlat13.xyz), u_xlat4.xyz);
    u_xlat27 = u_xlat27 + u_xlat27;
    u_xlat7.xyz = u_xlat4.xyz * (-vec3(u_xlat27)) + (-u_xlat13.xyz);
    ...
    u_xlat1.xzw = u_xlat0.xxx * u_xlat19.xyz;
    ...
    u_xlat0.x = dot(u_xlat4.xyz, u_xlat19.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    ...
    u_xlat1.xzw = u_xlat1.xzw * u_xlat19.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.x = u_xlat14.x * u_xlat23.x + u_xlat10.x;
        ...
        if(u_xlati23 != 0) {
            ...
            u_xlat23.x = (u_xlatb19.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat23.xyz = (u_xlatb19.x) ? u_xlat11.xyz : u_xlat23.xxx;
        } else {
