...
fn main_1() {
  ...
  let x_648 : vec2<f32> = ((vec2<f32>(x_643.x, x_643.z) * vec2<f32>(0.00200000009499490261f, 0.00200000009499490261f)) + vec2<f32>(0.5f, 0.5f));
  ...
  u_xlat13 = (x_693 * 0.40000000596046447754f);
  ...
  u_xlat11 = ((x_706 * 0.10000000149011611938f) + 0.05000000074505805969f);
  ...
  let x_1163 : vec2<f32> = (vec2<f32>(x_1159.x, x_1159.z) * vec2<f32>(0.00499999988824129105f, 0.00499999988824129105f));
