...
uniform float4 _TerrainNormalmapGenSize ;
uniform float4 _TerrainTilesScaleOffsets [ 9 ] ;
...
float4 CalculateNormalSobel ( v2f i ) : COLOR
{
...
float2 d ;
#line 63
d . x = ( UnpackHeightmap ( tex2D ( _MainTex , ( i . blbr . xy . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetBL . x + scaleOffsetBL . y ) * - 1.0F ;
d . x += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . lr . xy . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetL . x + scaleOffsetL . y ) * - 2.0F ;
d . x += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . tltr . xy . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetTL . x + scaleOffsetTL . y ) * - 1.0F ;
d . x += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . blbr . zw . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetBR . x + scaleOffsetBR . y ) * 1.0F ;
d . x += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . lr . zw . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetR . x + scaleOffsetR . y ) * 2.0F ;
d . x += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . tltr . zw . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetTR . x + scaleOffsetTR . y ) * 1.0F ;
#line 71
d . y = ( UnpackHeightmap ( tex2D ( _MainTex , ( i . blbr . xy . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetBL . x + scaleOffsetBL . y ) * - 1.0F ;
d . y += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . bt . xy . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetB . x + scaleOffsetB . y ) * - 2.0F ;
d . y += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . blbr . zw . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetBR . x + scaleOffsetBR . y ) * - 1.0F ;
d . y += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . tltr . xy . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetTL . x + scaleOffsetTL . y ) * 1.0F ;
d . y += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . bt . zw . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetT . x + scaleOffsetT . y ) * 2.0F ;
d . y += ( UnpackHeightmap ( tex2D ( _MainTex , ( i . tltr . zw . xy * _MainTex_ST . xy + _MainTex_ST . zw ) ) ) * scaleOffsetTR . x + scaleOffsetTR . y ) * 1.0F ;
