...
;
    ...
    u_xlat2.xzw = vec3(u_xlat28) * u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat34 = u_xlat34 * _AdditionalLightsAttenuation[u_xlati47].x;
        ...
        u_xlati50 = 1 << (u_xlati47 & int(0x1F));
        ...
        if(u_xlati50 != 0) {
            ...
            u_xlati52 = u_xlati47 << (2 & int(0x1F));
            if(u_xlati51 != 0) {
            ...
            u_xlat50 = (u_xlatb6.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb6.x) ? u_xlat11.xyz : vec3(u_xlat50);
        } else {
        ...
        u_xlat47 = u_xlat34 * u_xlat49;
        u_xlat34 = dot(u_xlat1.xyz, u_xlat10.xyz);
