...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat72 = max(u_xlat3.w, 9.99999975e-05);
    ...
    if(u_xlatb72){
        ...
        if(u_xlatb72){
            ...
            u_xlat72 = dot(u_xlat5, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb4){
                ...
                u_xlat72 = u_xlat4.x * u_xlat50.x + u_xlat27.x;
            } else {
                u_xlat4.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat4.xy = floor(u_xlat4.xy);
                u_xlat50.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat4.xy);
                ...
                u_xlat72 = u_xlat5.w * u_xlat4.x + u_xlat50.x;
            }
        }
    } else {
    ...
    u_xlat50.x = (-u_xlat72) + 1.0;
    u_xlat72 = u_xlat27.x * u_xlat50.x + u_xlat72;
    ...
    u_xlat5.xyz = vec3(u_xlat72) * u_xlat27.xyz;
    u_xlat72 = u_xlat0.x * 10.0 + 1.0;
    ...
    u_xlat23.xyz = u_xlat3.xyz * u_xlat0.yzw + u_xlat27.xyz;
