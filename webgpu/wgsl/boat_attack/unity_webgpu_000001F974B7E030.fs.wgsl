...
@group(0) @binding(0) var Texture2D_8BA53EED : texture_2d<f32>;

@group(0) @binding(1) var samplerTexture2D_8BA53EED : sampler;
...
fn main_1() {
  ...
  let x_99 : vec4<f32> = textureSampleBias(Texture2D_8BA53EED, samplerTexture2D_8BA53EED, vec2<f32>(x_91.x, x_91.y), x_98);
