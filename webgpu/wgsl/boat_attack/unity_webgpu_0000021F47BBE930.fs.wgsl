...
fn main_1() {
  ...
  let x_1221 : vec2<f32> = vs_TEXCOORD0;
  let x_1224 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1228 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1230 : vec2<f32> = ((x_1221 * vec2<f32>(x_1224.x, x_1224.y)) + vec2<f32>(x_1228.z, x_1228.w));
  let x_1231 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1230.x, x_1230.y, x_1231.z);
  let x_1238 : vec3<f32> = u_xlat1;
  let x_1241 : f32 = x_25.x_GlobalMipBias.x;
  let x_1242 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1238.x, x_1238.y), x_1241);
  u_xlat18 = x_1242.w;
  let x_1244 : f32 = u_xlat18;
  u_xlat18 = (x_1244 + -0.5f);
  let x_1246 : f32 = u_xlat18;
  let x_1247 : f32 = u_xlat18;
  u_xlat18 = (x_1246 + x_1247);
  let x_1249 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1249.x, x_1249.y, x_1249.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1258 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1258);
  let x_1263 : f32 = x_25.x_Grain_Params.y;
  let x_1265 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1263 * -(x_1265)) + 1.0f);
  let x_1271 : f32 = u_xlat18;
  let x_1273 : vec4<f32> = u_xlat0;
  u_xlat7 = (vec3<f32>(x_1271, x_1271, x_1271) * vec3<f32>(x_1273.x, x_1273.y, x_1273.z));
  let x_1276 : vec3<f32> = u_xlat7;
  let x_1279 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat7 = (x_1276 * vec3<f32>(x_1279.x, x_1279.x, x_1279.x));
  let x_1282 : vec3<f32> = u_xlat7;
  let x_1283 : vec3<f32> = u_xlat1;
  let x_1286 : vec4<f32> = u_xlat0;
  let x_1288 : vec3<f32> = ((x_1282 * vec3<f32>(x_1283.x, x_1283.x, x_1283.x)) + vec3<f32>(x_1286.x, x_1286.y, x_1286.z));
  let x_1289 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1288.x, x_1288.y, x_1288.z, x_1289.w);
  let x_1293 : vec4<f32> = u_xlat0;
  let x_1295 : vec3<f32> = sqrt(vec3<f32>(x_1293.x, x_1293.y, x_1293.z));
