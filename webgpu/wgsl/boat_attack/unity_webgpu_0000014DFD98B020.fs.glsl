...
void main()
{
    ...
    u_xlat15.xyz = u_xlat0.xyz * vec3(u_xlat38);
    ...
    u_xlat3.x = u_xlat38 * 4.0 + 2.0;
    vec3 txVec0 = vec3(vs_TEXCOORD8.xy,vs_TEXCOORD8.z);
    u_xlat16.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec0, 0.0);
    ...
    u_xlat40 = dot((-u_xlat5.xyz), u_xlat13.xyz);
    u_xlat40 = u_xlat40 + u_xlat40;
    u_xlat6.xyz = u_xlat13.xyz * (-vec3(u_xlat40)) + (-u_xlat5.xyz);
    u_xlat40 = dot(u_xlat13.xyz, u_xlat5.xyz);
    u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
    ...
    u_xlat19.xyz = vec3(u_xlat40) * u_xlat19.xyz + u_xlat0.xyz;
    u_xlat19.xyz = vec3(u_xlat1) * u_xlat19.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat19.xyz;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat15.xyz + u_xlat6.xyz;
    ...
    u_xlat19.xyz = u_xlat0.xyz * vec3(u_xlat36) + u_xlat15.xyz;
    u_xlat36 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu36 =  uint(int(u_xlat36));
    u_xlat1 = u_xlat28 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat41) + u_xlat15.xyz;
        u_xlat16.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat16.xyz;
    }
    u_xlat0.xyz = u_xlat19.xyz * u_xlat6.xyz + u_xlat2.xyz;
