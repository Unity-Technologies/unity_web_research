...
fn main_1() {
  ...
  let x_1006 : vec3<f32> = sqrt(vec3<f32>(x_1004.x, x_1004.y, x_1004.z));
  let x_1007 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1006.x, x_1006.y, x_1006.z, x_1007.w);
  let x_1009 : vec2<f32> = vs_TEXCOORD0;
  let x_1012 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1016 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1018 : vec2<f32> = ((x_1009 * vec2<f32>(x_1012.x, x_1012.y)) + vec2<f32>(x_1016.z, x_1016.w));
  let x_1019 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1018.x, x_1018.y, x_1019.z, x_1019.w);
  let x_1026 : vec4<f32> = u_xlat1;
  let x_1029 : f32 = x_38.x_GlobalMipBias.x;
  let x_1030 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1026.x, x_1026.y), x_1029);
  u_xlat18 = x_1030.w;
  let x_1032 : f32 = u_xlat18;
  u_xlat18 = ((x_1032 * 2.0f) + -1.0f);
  let x_1035 : f32 = u_xlat18;
  u_xlatb1.x = (x_1035 >= 0.0f);
  let x_1039 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1039);
  let x_1042 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1042)) + 1.0f);
  let x_1046 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1046);
  let x_1048 : f32 = u_xlat18;
  u_xlat18 = (-(x_1048) + 1.0f);
  let x_1051 : f32 = u_xlat18;
  let x_1053 : f32 = u_xlat1.x;
  u_xlat18 = (x_1051 * x_1053);
  let x_1055 : vec4<f32> = u_xlat0;
  let x_1057 : vec3<f32> = (vec3<f32>(x_1055.x, x_1055.y, x_1055.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1058 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1057.x, x_1057.y, x_1057.z, x_1058.w);
  ...
  let x_1067 : vec3<f32> = (vec3<f32>(x_1065.x, x_1065.y, x_1065.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1078 : vec3<f32> = ((vec3<f32>(x_1075.x, x_1075.y, x_1075.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1079 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1078.x, x_1078.y, x_1078.z, x_1079.w);
  let x_1082 : vec4<f32> = u_xlat0;
  let x_1084 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1082.x, x_1082.y, x_1082.z, x_1082.x));
  ...
  let x_1129 : vec3<f32> = ((vec3<f32>(x_1122, x_1122, x_1122) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1127.x, x_1127.y, x_1127.z));
  let x_1130 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1129.x, x_1129.y, x_1129.z, x_1130.w);
  let x_1132 : vec4<f32> = u_xlat0;
  let x_1134 : vec3<f32> = (vec3<f32>(x_1132.x, x_1132.y, x_1132.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1135 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1134.x, x_1134.y, x_1134.z, x_1135.w);
  let x_1137 : vec4<f32> = u_xlat0;
  let x_1139 : vec3<f32> = (vec3<f32>(x_1137.x, x_1137.y, x_1137.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1140 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1139.x, x_1139.y, x_1139.z, x_1140.w);
  let x_1142 : vec4<f32> = u_xlat2;
  let x_1144 : vec3<f32> = (vec3<f32>(x_1142.x, x_1142.y, x_1142.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1145 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1144.x, x_1144.y, x_1144.z, x_1145.w);
  let x_1147 : vec4<f32> = u_xlat2;
  let x_1150 : vec3<f32> = log2(abs(vec3<f32>(x_1147.x, x_1147.y, x_1147.z)));
  let x_1151 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1150.x, x_1150.y, x_1150.z, x_1151.w);
  let x_1153 : vec4<f32> = u_xlat2;
  let x_1155 : vec3<f32> = (vec3<f32>(x_1153.x, x_1153.y, x_1153.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1165 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1163.x, x_1163.y, x_1163.z, x_1163.x));
  u_xlatb0 = vec3<bool>(x_1165.x, x_1165.y, x_1165.z);
  ...
  let x_1208 : vec3<f32> = max(vec3<f32>(x_1205.x, x_1205.y, x_1205.z), vec3<f32>(0.0f, 0.0f, 0.0f));
