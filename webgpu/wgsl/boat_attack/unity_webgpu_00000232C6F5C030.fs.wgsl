...
fn main_1() {
  ...
  let x_2246 : vec3<f32> = (vec3<f32>(x_2244.x, x_2244.y, x_2244.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2247 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2246.x, x_2246.y, x_2246.z, x_2247.w);
  let x_2249 : vec4<f32> = u_xlat0;
  let x_2252 : vec3<f32> = log2(abs(vec3<f32>(x_2249.x, x_2249.y, x_2249.z)));
  let x_2253 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2252.x, x_2252.y, x_2252.z, x_2253.w);
  let x_2255 : vec4<f32> = u_xlat2;
  let x_2257 : vec3<f32> = (vec3<f32>(x_2255.x, x_2255.y, x_2255.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2258 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2257.x, x_2257.y, x_2257.z, x_2258.w);
  let x_2260 : vec4<f32> = u_xlat2;
  let x_2262 : vec3<f32> = exp2(vec3<f32>(x_2260.x, x_2260.y, x_2260.z));
  let x_2263 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2262.x, x_2262.y, x_2262.z, x_2263.w);
  let x_2265 : vec4<f32> = u_xlat2;
  let x_2268 : vec3<f32> = ((vec3<f32>(x_2265.x, x_2265.y, x_2265.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2269 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2268.x, x_2268.y, x_2268.z, x_2269.w);
  let x_2271 : vec4<f32> = u_xlat0;
  let x_2273 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2271.x, x_2271.y, x_2271.z, x_2271.x));
  u_xlatb0 = vec3<bool>(x_2273.x, x_2273.y, x_2273.z);
  let x_2276 : bool = u_xlatb0.x;
  if (x_2276) {
  ...
  let x_2285 : f32 = x_2277;
  u_xlat0.x = x_2285;
  let x_2288 : bool = u_xlatb0.y;
  if (x_2288) {
    let x_2293 : f32 = u_xlat1.y;
    x_2289 = x_2293;
  } else {
    let x_2296 : f32 = u_xlat2.y;
    x_2289 = x_2296;
  }
  let x_2297 : f32 = x_2289;
  u_xlat0.y = x_2297;
  let x_2300 : bool = u_xlatb0.z;
  if (x_2300) {
    let x_2305 : f32 = u_xlat1.z;
    x_2301 = x_2305;
  } else {
    let x_2308 : f32 = u_xlat2.z;
    x_2301 = x_2308;
  }
  let x_2309 : f32 = x_2301;
  u_xlat0.z = x_2309;
  let x_2311 : vec2<f32> = vs_TEXCOORD0;
  let x_2314 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2318 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2320 : vec2<f32> = ((x_2311 * vec2<f32>(x_2314.x, x_2314.y)) + vec2<f32>(x_2318.z, x_2318.w));
  let x_2321 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2320.x, x_2320.y, x_2321.z, x_2321.w);
  let x_2328 : vec4<f32> = u_xlat1;
  let x_2331 : f32 = x_25.x_GlobalMipBias.x;
  let x_2332 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2328.x, x_2328.y), x_2331);
  u_xlat21 = x_2332.w;
  let x_2334 : f32 = u_xlat21;
  u_xlat21 = ((x_2334 * 2.0f) + -1.0f);
  let x_2337 : f32 = u_xlat21;
  u_xlatb1 = (x_2337 >= 0.0f);
  let x_2339 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2339);
  let x_2342 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2342)) + 1.0f);
  let x_2346 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2346);
  let x_2348 : f32 = u_xlat21;
  u_xlat21 = (-(x_2348) + 1.0f);
  let x_2351 : f32 = u_xlat21;
  let x_2353 : f32 = u_xlat1.x;
  u_xlat21 = (x_2351 * x_2353);
  let x_2355 : vec4<f32> = u_xlat0;
  let x_2357 : vec3<f32> = (vec3<f32>(x_2355.x, x_2355.y, x_2355.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2358 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2357.x, x_2357.y, x_2357.z, x_2358.w);
  let x_2360 : vec4<f32> = u_xlat0;
  let x_2363 : vec3<f32> = log2(abs(vec3<f32>(x_2360.x, x_2360.y, x_2360.z)));
  let x_2364 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2363.x, x_2363.y, x_2363.z, x_2364.w);
  let x_2366 : vec4<f32> = u_xlat2;
  let x_2368 : vec3<f32> = (vec3<f32>(x_2366.x, x_2366.y, x_2366.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2369 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2368.x, x_2368.y, x_2368.z, x_2369.w);
  let x_2371 : vec4<f32> = u_xlat2;
  let x_2373 : vec3<f32> = exp2(vec3<f32>(x_2371.x, x_2371.y, x_2371.z));
  let x_2374 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2373.x, x_2373.y, x_2373.z, x_2374.w);
  let x_2376 : vec4<f32> = u_xlat2;
  let x_2379 : vec3<f32> = ((vec3<f32>(x_2376.x, x_2376.y, x_2376.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2380 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2379.x, x_2379.y, x_2379.z, x_2380.w);
  let x_2382 : vec4<f32> = u_xlat0;
  let x_2384 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2382.x, x_2382.y, x_2382.z, x_2382.x));
  u_xlatb0 = vec3<bool>(x_2384.x, x_2384.y, x_2384.z);
  let x_2387 : bool = u_xlatb0.x;
  if (x_2387) {
    let x_2392 : f32 = u_xlat1.x;
    x_2388 = x_2392;
  } else {
  ...
  u_xlat0.x = x_2396;
  let x_2399 : bool = u_xlatb0.y;
  if (x_2399) {
    let x_2404 : f32 = u_xlat1.y;
    x_2400 = x_2404;
  } else {
    let x_2407 : f32 = u_xlat2.y;
    x_2400 = x_2407;
  }
  let x_2408 : f32 = x_2400;
  u_xlat0.y = x_2408;
  let x_2411 : bool = u_xlatb0.z;
  if (x_2411) {
    let x_2416 : f32 = u_xlat1.z;
    x_2412 = x_2416;
  } else {
    let x_2419 : f32 = u_xlat2.z;
    x_2412 = x_2419;
  }
  let x_2420 : f32 = x_2412;
  u_xlat0.z = x_2420;
  let x_2422 : f32 = u_xlat21;
  let x_2427 : vec4<f32> = u_xlat0;
  let x_2429 : vec3<f32> = ((vec3<f32>(x_2422, x_2422, x_2422) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2427.x, x_2427.y, x_2427.z));
  let x_2430 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2429.x, x_2429.y, x_2429.z, x_2430.w);
  let x_2432 : vec4<f32> = u_xlat0;
  let x_2434 : vec3<f32> = (vec3<f32>(x_2432.x, x_2432.y, x_2432.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2435 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2434.x, x_2434.y, x_2434.z, x_2435.w);
  let x_2437 : vec4<f32> = u_xlat0;
  let x_2439 : vec3<f32> = (vec3<f32>(x_2437.x, x_2437.y, x_2437.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2440 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2439.x, x_2439.y, x_2439.z, x_2440.w);
  let x_2442 : vec4<f32> = u_xlat2;
  let x_2444 : vec3<f32> = (vec3<f32>(x_2442.x, x_2442.y, x_2442.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2445 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2444.x, x_2444.y, x_2444.z, x_2445.w);
  let x_2447 : vec4<f32> = u_xlat2;
  let x_2450 : vec3<f32> = log2(abs(vec3<f32>(x_2447.x, x_2447.y, x_2447.z)));
  let x_2451 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2450.x, x_2450.y, x_2450.z, x_2451.w);
  let x_2453 : vec4<f32> = u_xlat2;
  let x_2455 : vec3<f32> = (vec3<f32>(x_2453.x, x_2453.y, x_2453.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2456 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2455.x, x_2455.y, x_2455.z, x_2456.w);
  let x_2458 : vec4<f32> = u_xlat2;
  let x_2460 : vec3<f32> = exp2(vec3<f32>(x_2458.x, x_2458.y, x_2458.z));
  let x_2461 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2460.x, x_2460.y, x_2460.z, x_2461.w);
  let x_2463 : vec4<f32> = u_xlat0;
  let x_2465 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2463.x, x_2463.y, x_2463.z, x_2463.x));
  u_xlatb0 = vec3<bool>(x_2465.x, x_2465.y, x_2465.z);
  let x_2468 : bool = u_xlatb0.x;
  if (x_2468) {
    let x_2473 : f32 = u_xlat1.x;
    x_2469 = x_2473;
  } else {
  ...
  u_xlat0.x = x_2477;
  let x_2480 : bool = u_xlatb0.y;
  if (x_2480) {
    let x_2485 : f32 = u_xlat1.y;
    x_2481 = x_2485;
  } else {
    let x_2488 : f32 = u_xlat2.y;
    x_2481 = x_2488;
  }
  let x_2489 : f32 = x_2481;
  u_xlat0.y = x_2489;
  let x_2492 : bool = u_xlatb0.z;
  if (x_2492) {
    let x_2497 : f32 = u_xlat1.z;
    x_2493 = x_2497;
  } else {
    let x_2500 : f32 = u_xlat2.z;
    x_2493 = x_2500;
  }
  let x_2501 : f32 = x_2493;
  u_xlat0.z = x_2501;
  let x_2505 : vec4<f32> = u_xlat0;
  let x_2507 : vec3<f32> = max(vec3<f32>(x_2505.x, x_2505.y, x_2505.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2508 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2507.x, x_2507.y, x_2507.z, x_2508.w);
  SV_Target0.w = 1.0f;
  return;
}
