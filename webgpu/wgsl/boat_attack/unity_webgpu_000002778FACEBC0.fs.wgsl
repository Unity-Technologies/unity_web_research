...
fn main_1() {
  ...
  u_xlat1 = ((x_36 * vec3<f32>(0.30530601739883422852f, 0.30530601739883422852f, 0.30530601739883422852f)) + vec3<f32>(0.68217110633850097656f, 0.68217110633850097656f, 0.68217110633850097656f));
  let x_43 : vec3<f32> = u_xlat0;
  let x_44 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_43 * x_44) + vec3<f32>(0.01252287812530994415f, 0.01252287812530994415f, 0.01252287812530994415f));
