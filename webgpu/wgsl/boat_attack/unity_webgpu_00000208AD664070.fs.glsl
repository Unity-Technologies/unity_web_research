...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat4.xyz = vec3(u_xlat63) * u_xlat24.xyz;
    u_xlat24.xyz = vs_TEXCOORD1.xyz + (-_CascadeShadowSplitSpheres0.xyz);
...
;
    u_xlat24.x = (u_xlatb6.x) ? float(-1.0) : float(-0.0);
    u_xlat24.y = (u_xlatb6.y) ? float(-1.0) : float(-0.0);
    u_xlat24.z = (u_xlatb6.z) ? float(-1.0) : float(-0.0);
    u_xlat24.xyz = u_xlat24.xyz + u_xlat7.yzw;
    u_xlat7.yzw = max(u_xlat24.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat63 = dot(u_xlat7, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat63 = (-u_xlat63) + 4.0;
    u_xlatu63 = uint(u_xlat63);
    u_xlati63 = int(u_xlatu63) << (2 & int(0x1F));
    u_xlat24.xyz = vs_TEXCOORD1.yyy * _MainLightWorldToShadow[(u_xlati63 + 1) / 4][(u_xlati63 + 1) % 4].xyz;
    u_xlat24.xyz = _MainLightWorldToShadow[u_xlati63 / 4][u_xlati63 % 4].xyz * vs_TEXCOORD1.xxx + u_xlat24.xyz;
    u_xlat24.xyz = _MainLightWorldToShadow[(u_xlati63 + 2) / 4][(u_xlati63 + 2) % 4].xyz * vs_TEXCOORD1.zzz + u_xlat24.xyz;
    u_xlat24.xyz = u_xlat24.xyz + _MainLightWorldToShadow[(u_xlati63 + 3) / 4][(u_xlati63 + 3) % 4].xyz;
    u_xlat4.w = 1.0;
    ...
    u_xlat7.xyz = unity_SHC.xyz * vec3(u_xlat63) + u_xlat8.xyz;
    ...
    u_xlat22 = u_xlat1.y * _Smoothness + u_xlat43.x;
    u_xlat22 = clamp(u_xlat22, 0.0, 1.0);
    u_xlat43.x = u_xlat1.x * 4.0 + 2.0;
    ...
    if(u_xlatb67){
        ...
        if(u_xlatb67){
            ...
            if(u_xlatb69){
                u_xlat7.xy = u_xlat24.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat49.xy = u_xlat24.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                vec3 txVec6 = vec3(u_xlat49.xy,u_xlat24.z);
                ...
                vec3 txVec7 = vec3(u_xlat10.xy,u_xlat24.z);
                ...
                vec3 txVec8 = vec3(u_xlat12.xy,u_xlat24.z);
                ...
                vec3 txVec9 = vec3(u_xlat12.zw,u_xlat24.z);
                ...
                vec3 txVec10 = vec3(u_xlat10.zw,u_xlat24.z);
                ...
                vec3 txVec11 = vec3(u_xlat9.xy,u_xlat24.z);
                ...
                vec3 txVec12 = vec3(u_xlat9.zw,u_xlat24.z);
                ...
                vec3 txVec15 = vec3(u_xlat49.xy,u_xlat24.z);
                ...
                vec3 txVec16 = vec3(u_xlat16.xy,u_xlat24.z);
                ...
                vec3 txVec17 = vec3(u_xlat14.xy,u_xlat24.z);
                ...
                vec3 txVec18 = vec3(u_xlat14.zw,u_xlat24.z);
                ...
                vec3 txVec19 = vec3(u_xlat15.xy,u_xlat24.z);
                ...
                vec3 txVec20 = vec3(u_xlat16.zw,u_xlat24.z);
                ...
                vec3 txVec21 = vec3(u_xlat17.xy,u_xlat24.z);
                ...
                vec3 txVec22 = vec3(u_xlat17.zw,u_xlat24.z);
                ...
                vec3 txVec23 = vec3(u_xlat30.xy,u_xlat24.z);
                ...
                vec3 txVec24 = vec3(u_xlat57.xy,u_xlat24.z);
                ...
                vec3 txVec25 = vec3(u_xlat12.xy,u_xlat24.z);
                ...
                vec3 txVec26 = vec3(u_xlat12.zw,u_xlat24.z);
                ...
                vec3 txVec27 = vec3(u_xlat52.xy,u_xlat24.z);
                ...
                vec3 txVec28 = vec3(u_xlat7.xy,u_xlat24.z);
        ...
        vec3 txVec29 = vec3(u_xlat24.xy,u_xlat24.z);
        u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat24.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat24.x = u_xlat67 * _MainLightShadowParams.x + u_xlat24.x;
    u_xlatb45 = 0.0>=u_xlat24.z;
    u_xlatb66 = u_xlat24.z>=1.0;
    u_xlatb45 = u_xlatb66 || u_xlatb45;
    u_xlat24.x = (u_xlatb45) ? 1.0 : u_xlat24.x;
    u_xlat7.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat45 = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat45 = u_xlat45 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
    u_xlat66 = (-u_xlat24.x) + 1.0;
    u_xlat24.x = u_xlat45 * u_xlat66 + u_xlat24.x;
    ...
    u_xlat45 = u_xlat45 * u_xlat45;
    u_xlat45 = u_xlat45 * u_xlat45;
    u_xlat66 = (-u_xlat63) * 0.699999988 + 1.70000005;
    ...
    u_xlat30.xyz = (-u_xlat0.xyz) + vec3(u_xlat22);
    u_xlat30.xyz = vec3(u_xlat45) * u_xlat30.xyz + u_xlat0.xyz;
    ...
    u_xlat63 = dot(u_xlat4.xyz, u_xlat7.xyz);
    ...
    {
        u_xlatu22 = u_xlatu_loop_1 >> (2u & uint(0x1F));
        u_xlati67 = int(u_xlatu_loop_1 & 3u);
        u_xlat22 = dot(unity_LightIndices[int(u_xlatu22)], uintBitsToFloat(ImmCB_0[u_xlati67]));
        u_xlati22 = int(u_xlat22);
        u_xlat8.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati22].www + _AdditionalLightsPosition[u_xlati22].xyz;
        ...
        u_xlat67 = u_xlat67 * _AdditionalLightsAttenuation[u_xlati22].x;
        u_xlat67 = (-u_xlat67) * u_xlat67 + 1.0;
        u_xlat67 = max(u_xlat67, 0.0);
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat67 = u_xlat67 * u_xlat70;
        u_xlat70 = dot(_AdditionalLightsSpotDir[u_xlati22].xyz, u_xlat30.xyz);
        u_xlat70 = u_xlat70 * _AdditionalLightsAttenuation[u_xlati22].z + _AdditionalLightsAttenuation[u_xlati22].w;
        u_xlat70 = clamp(u_xlat70, 0.0, 1.0);
        u_xlat70 = u_xlat70 * u_xlat70;
        u_xlat67 = u_xlat67 * u_xlat70;
        u_xlat10.xyz = vec3(u_xlat68) * _AdditionalLightsColor[u_xlati22].xyz;
        u_xlat22 = dot(u_xlat4.xyz, u_xlat30.xyz);
        u_xlat22 = clamp(u_xlat22, 0.0, 1.0);
        u_xlat22 = u_xlat22 * u_xlat67;
        u_xlat10.xyz = vec3(u_xlat22) * u_xlat10.xyz;
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat69) + u_xlat5.xyz;
        u_xlat22 = dot(u_xlat8.xyz, u_xlat8.xyz);
        u_xlat22 = max(u_xlat22, 1.17549435e-37);
        u_xlat22 = inversesqrt(u_xlat22);
        u_xlat8.xyz = vec3(u_xlat22) * u_xlat8.xyz;
        u_xlat22 = dot(u_xlat4.xyz, u_xlat8.xyz);
        u_xlat22 = clamp(u_xlat22, 0.0, 1.0);
        u_xlat67 = dot(u_xlat30.xyz, u_xlat8.xyz);
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat22 = u_xlat22 * u_xlat22;
        u_xlat22 = u_xlat22 * u_xlat9.x + 1.00001001;
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat22 = u_xlat22 * u_xlat22;
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat22) + u_xlat23.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat6.xyz * u_xlat3.xxx + u_xlat24.xyz;
