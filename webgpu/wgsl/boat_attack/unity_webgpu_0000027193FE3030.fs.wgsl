...
fn main_1() {
  ...
  let x_1514 : vec3<f32> = sqrt(vec3<f32>(x_1512.x, x_1512.y, x_1512.z));
  let x_1515 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1514.x, x_1514.y, x_1514.z, x_1515.w);
  let x_1517 : vec2<f32> = vs_TEXCOORD0;
  let x_1520 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1524 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1526 : vec2<f32> = ((x_1517 * vec2<f32>(x_1520.x, x_1520.y)) + vec2<f32>(x_1524.z, x_1524.w));
  let x_1527 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1526.x, x_1526.y, x_1527.z, x_1527.w);
  let x_1534 : vec4<f32> = u_xlat1;
  let x_1537 : f32 = x_38.x_GlobalMipBias.x;
  let x_1538 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1534.x, x_1534.y), x_1537);
  u_xlat15 = x_1538.w;
  let x_1540 : f32 = u_xlat15;
  u_xlat15 = ((x_1540 * 2.0f) + -1.0f);
  let x_1543 : f32 = u_xlat15;
  u_xlatb1 = (x_1543 >= 0.0f);
  let x_1545 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1545);
  let x_1548 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1548)) + 1.0f);
  let x_1552 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1552);
  let x_1554 : f32 = u_xlat15;
  u_xlat15 = (-(x_1554) + 1.0f);
  let x_1557 : f32 = u_xlat15;
  let x_1559 : f32 = u_xlat1.x;
  u_xlat15 = (x_1557 * x_1559);
  let x_1561 : vec4<f32> = u_xlat0;
  let x_1563 : vec3<f32> = (vec3<f32>(x_1561.x, x_1561.y, x_1561.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1564 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1563.x, x_1563.y, x_1563.z, x_1564.w);
  let x_1566 : vec4<f32> = u_xlat0;
  let x_1568 : vec3<f32> = log2(vec3<f32>(x_1566.x, x_1566.y, x_1566.z));
  let x_1569 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1568.x, x_1568.y, x_1568.z, x_1569.w);
  let x_1571 : vec4<f32> = u_xlat2;
  let x_1573 : vec3<f32> = (vec3<f32>(x_1571.x, x_1571.y, x_1571.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1574 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1573.x, x_1573.y, x_1573.z, x_1574.w);
  let x_1576 : vec4<f32> = u_xlat2;
  let x_1578 : vec3<f32> = exp2(vec3<f32>(x_1576.x, x_1576.y, x_1576.z));
  let x_1579 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1578.x, x_1578.y, x_1578.z, x_1579.w);
  let x_1581 : vec4<f32> = u_xlat2;
  let x_1584 : vec3<f32> = ((vec3<f32>(x_1581.x, x_1581.y, x_1581.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1585 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1584.x, x_1584.y, x_1584.z, x_1585.w);
  let x_1587 : vec4<f32> = u_xlat0;
  let x_1589 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1587.x, x_1587.y, x_1587.z, x_1587.x));
  u_xlatb0 = vec3<bool>(x_1589.x, x_1589.y, x_1589.z);
  let x_1592 : bool = u_xlatb0.x;
  if (x_1592) {
  ...
  u_xlat0.x = x_1601;
  let x_1604 : bool = u_xlatb0.y;
  if (x_1604) {
    let x_1609 : f32 = u_xlat1.y;
    x_1605 = x_1609;
  } else {
    let x_1612 : f32 = u_xlat2.y;
    x_1605 = x_1612;
  }
  let x_1613 : f32 = x_1605;
  u_xlat0.y = x_1613;
  let x_1616 : bool = u_xlatb0.z;
  if (x_1616) {
  ...
  u_xlat0.z = x_1625;
  let x_1627 : f32 = u_xlat15;
  let x_1632 : vec4<f32> = u_xlat0;
  let x_1634 : vec3<f32> = ((vec3<f32>(x_1627, x_1627, x_1627) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1632.x, x_1632.y, x_1632.z));
  let x_1635 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1634.x, x_1634.y, x_1634.z, x_1635.w);
  let x_1637 : vec4<f32> = u_xlat0;
  let x_1639 : vec3<f32> = (vec3<f32>(x_1637.x, x_1637.y, x_1637.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1640 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1639.x, x_1639.y, x_1639.z, x_1640.w);
  let x_1642 : vec4<f32> = u_xlat0;
  let x_1644 : vec3<f32> = (vec3<f32>(x_1642.x, x_1642.y, x_1642.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1645 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1644.x, x_1644.y, x_1644.z, x_1645.w);
  let x_1647 : vec4<f32> = u_xlat2;
  let x_1649 : vec3<f32> = (vec3<f32>(x_1647.x, x_1647.y, x_1647.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  ...
  let x_1660 : vec3<f32> = (vec3<f32>(x_1658.x, x_1658.y, x_1658.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1712 : vec3<f32> = max(vec3<f32>(x_1710.x, x_1710.y, x_1710.z), vec3<f32>(0.0f, 0.0f, 0.0f));
