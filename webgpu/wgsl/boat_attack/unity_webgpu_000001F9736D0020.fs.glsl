...
void main()
{
    ...
    u_xlat1.xyz = (bool(u_xlatb1)) ? u_xlat27.xyz : u_xlat2.xyz;
    u_xlat79 = dot(vs_TEXCOORD3.xyz, vs_TEXCOORD3.xyz);
    u_xlat79 = inversesqrt(u_xlat79);
    u_xlat2.xyz = vec3(u_xlat79) * vs_TEXCOORD3.xyz;
    ...
    u_xlat80 = dot(u_xlat2.xyz, u_xlat3.xyz);
    ...
    if(u_xlatb83){
        ...
        if(u_xlatb83){
            ...
            if(u_xlatb6){
                ...
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec4, 0.0);
                ...
                u_xlat32.x = u_xlat13.x * u_xlat32.x + u_xlat7.x;
                ...
                u_xlat32.x = u_xlat13.z * u_xlat58.x + u_xlat32.x;
                ...
                u_xlat32.x = u_xlat13.w * u_xlat58.x + u_xlat32.x;
                ...
                u_xlat32.x = u_xlat14.x * u_xlat58.x + u_xlat32.x;
                ...
                u_xlat32.x = u_xlat14.y * u_xlat58.x + u_xlat32.x;
                ...
                u_xlat32.x = u_xlat14.z * u_xlat58.x + u_xlat32.x;
                ...
                u_xlat32.x = u_xlat14.w * u_xlat58.x + u_xlat32.x;
                ...
                u_xlat83 = u_xlat6.x * u_xlat58.x + u_xlat32.x;
            } else {
                u_xlat6.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat6.xy = floor(u_xlat6.xy);
                u_xlat58.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
    ...
    u_xlat83 = u_xlat83 * _MainLightShadowParams.x + u_xlat6.x;
    u_xlatb6 = 0.0>=vs_TEXCOORD8.z;
    u_xlatb32.x = vs_TEXCOORD8.z>=1.0;
    u_xlatb6 = u_xlatb32.x || u_xlatb6;
    u_xlat83 = (u_xlatb6) ? 1.0 : u_xlat83;
    u_xlat6.xyz = vs_TEXCOORD7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat6.x = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat32.x = u_xlat6.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat32.x = clamp(u_xlat32.x, 0.0, 1.0);
    u_xlat58.x = (-u_xlat83) + 1.0;
    u_xlat83 = u_xlat32.x * u_xlat58.x + u_xlat83;
    ...
    if(u_xlatb32.x){
        ...
        u_xlat58.x = (u_xlatb32.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat32.xyz = (u_xlatb32.x) ? u_xlat7.xyz : u_xlat58.xxx;
    } else {
    ...
    u_xlat7.x = dot((-u_xlat1.xyz), u_xlat2.xyz);
    u_xlat7.x = u_xlat7.x + u_xlat7.x;
    u_xlat7.xyz = u_xlat2.xyz * (-u_xlat7.xxx) + (-u_xlat1.xyz);
    u_xlat85 = dot(u_xlat2.xyz, u_xlat1.xyz);
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat0.x);
    ...
    u_xlat52 = dot(u_xlat2.xyz, u_xlat7.xyz);
    ...
    u_xlat81 = u_xlat6.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu52 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.x = dot(unity_LightIndices[int(u_xlatu6)], uintBitsToFloat(ImmCB_0[u_xlati59]));
        u_xlati6 = int(u_xlat6.x);
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati6].www + _AdditionalLightsPosition[u_xlati6].xyz;
        ...
        u_xlat86 = float(1.0) / float(u_xlat59);
        u_xlat59 = u_xlat59 * _AdditionalLightsAttenuation[u_xlati6].x;
        u_xlat59 = (-u_xlat59) * u_xlat59 + 1.0;
        u_xlat59 = max(u_xlat59, 0.0);
        u_xlat59 = u_xlat59 * u_xlat59;
        u_xlat59 = u_xlat59 * u_xlat86;
        u_xlat86 = dot(_AdditionalLightsSpotDir[u_xlati6].xyz, u_xlat10.xyz);
        u_xlat86 = u_xlat86 * _AdditionalLightsAttenuation[u_xlati6].z + _AdditionalLightsAttenuation[u_xlati6].w;
        u_xlat86 = clamp(u_xlat86, 0.0, 1.0);
        u_xlat86 = u_xlat86 * u_xlat86;
        u_xlat59 = u_xlat59 * u_xlat86;
        u_xlati86 = int(_AdditionalShadowParams[u_xlati6].w);
        u_xlatb87 = u_xlati86>=0;
        if(u_xlatb87){
            u_xlatb87 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati6].z);
            if(u_xlatb87){
                ...
                u_xlat88 = trunc(_AdditionalShadowParams[u_xlati6].w);
            ...
            u_xlatb86 = 0.0<_AdditionalShadowParams[u_xlati6].y;
            if(u_xlatb86){
                u_xlatb86 = 1.0==_AdditionalShadowParams[u_xlati6].y;
                if(u_xlatb86){
                    ...
                    u_xlatb87 = 2.0==_AdditionalShadowParams[u_xlati6].y;
                    if(u_xlatb87){
            ...
            u_xlat87 = 1.0 + (-_AdditionalShadowParams[u_xlati6].x);
            u_xlat86 = u_xlat86 * _AdditionalShadowParams[u_xlati6].x + u_xlat87;
        ...
        u_xlat86 = u_xlat81 * u_xlat87 + u_xlat86;
        u_xlati87 = 1 << (u_xlati6 & int(0x1F));
        u_xlati87 = int(uint(u_xlati87) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati87 != 0) {
            u_xlati87 = int(_AdditionalLightsLightTypes[u_xlati6]);
            ...
            if(u_xlati88 != 0) {
                ...
                u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati6].xy * u_xlat37.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati6].zw;
            } else {
                ...
                if(u_xlati87 != 0) {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati6].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati6].zw;
                } else {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati6].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati6].zw;
                }
            }
        ...
        u_xlat6.x = u_xlat59 * u_xlat86;
        u_xlat59 = dot(u_xlat2.xyz, u_xlat10.xyz);
        u_xlat59 = clamp(u_xlat59, 0.0, 1.0);
        u_xlat6.x = u_xlat6.x * u_xlat59;
        u_xlat11.xyz = u_xlat6.xxx * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat85) + u_xlat1.xyz;
        ...
        u_xlat6.x = u_xlat6.x * u_xlat59;
        u_xlat6.x = u_xlat82 * u_xlat6.x;
        u_xlat6.x = u_xlat80 / u_xlat6.x;
        u_xlat9.xyz = u_xlat5.xyz * u_xlat6.xxx + u_xlat4.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat26) + u_xlat32.xyz;
