...
fn main_1() {
  ...
  let x_781 : vec3<f32> = vs_TEXCOORD5;
  let x_784 : vec4<f32> = u_xlat2;
  let x_786 : vec3<f32> = ((vec3<f32>(x_779.x, x_779.y, x_779.z) * vec3<f32>(x_781.z, x_781.z, x_781.z)) + vec3<f32>(x_784.x, x_784.y, x_784.z));
  ...
  let x_794 : vec3<f32> = (vec3<f32>(x_789.x, x_789.y, x_789.z) + vec3<f32>(x_792.x, x_792.y, x_792.z));
  ...
  let x_807 : f32 = u_xlat4;
  let x_809 : vec4<f32> = textureSample(x_LightTexture0, sampler_LightTexture0, vec2<f32>(x_807, x_807));
  u_xlat4 = x_809.x;
  let x_811 : f32 = u_xlat4;
  let x_815 : vec4<f32> = x_22.x_LightColor0;
  let x_817 : vec3<f32> = (vec3<f32>(x_811, x_811, x_811) * vec3<f32>(x_815.x, x_815.y, x_815.z));
  let x_818 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_817.x, x_817.y, x_817.z, x_818.w);
  let x_820 : vec4<f32> = u_xlat2;
  let x_824 : vec4<f32> = x_22.x_SpecColor;
  let x_826 : vec3<f32> = (vec3<f32>(x_820.x, x_820.y, x_820.z) * vec3<f32>(x_824.x, x_824.y, x_824.z));
  ...
  let x_833 : vec3<f32> = (vec3<f32>(x_829.x, x_829.x, x_829.x) * vec3<f32>(x_831.x, x_831.y, x_831.z));
  let x_834 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_833.x, x_833.y, x_833.z, x_834.w);
  let x_837 : f32 = u_xlat1.w;
  u_xlat14 = max(x_837, 0.00009999999747378752f);
  ...
  let x_867 : vec3<f32> = ((vec3<f32>(x_860.x, x_860.y, x_860.z) * vec3<f32>(x_862.w, x_862.w, x_862.w)) + vec3<f32>(x_865.x, x_865.y, x_865.z));
  let x_868 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_867.x, x_867.y, x_867.z, x_868.w);
  let x_871 : f32 = vs_TEXCOORD9;
  let x_873 : f32 = x_22.x_ProjectionParams.y;
  u_xlat12 = (x_871 / x_873);
  let x_875 : f32 = u_xlat12;
  u_xlat12 = (-(x_875) + 1.0f);
  let x_878 : f32 = u_xlat12;
  let x_880 : f32 = x_22.x_ProjectionParams.z;
  u_xlat12 = (x_878 * x_880);
  let x_882 : f32 = u_xlat12;
  u_xlat12 = max(x_882, 0.0f);
  let x_884 : f32 = u_xlat12;
  let x_887 : f32 = x_22.unity_FogParams.x;
  u_xlat12 = (x_884 * x_887);
  let x_889 : f32 = u_xlat12;
  let x_890 : f32 = u_xlat12;
  u_xlat12 = (x_889 * -(x_890));
  let x_893 : f32 = u_xlat12;
  u_xlat12 = exp2(x_893);
  let x_895 : vec4<f32> = u_xlat0;
  let x_897 : f32 = u_xlat12;
  let x_899 : vec3<f32> = (vec3<f32>(x_895.x, x_895.y, x_895.z) * vec3<f32>(x_897, x_897, x_897));
