...
fn main_1() {
  ...
  let x_1557 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1561 : vec4<f32> = x_26.x_Dithering_Params;
  ...
  let x_1575 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1571.x, x_1571.y), x_1574);
  u_xlat15 = x_1575.w;
  let x_1577 : f32 = u_xlat15;
  u_xlat15 = ((x_1577 * 2.0f) + -1.0f);
  let x_1580 : f32 = u_xlat15;
  u_xlatb1 = (x_1580 >= 0.0f);
  let x_1582 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1582);
  let x_1585 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1585)) + 1.0f);
  let x_1589 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1589);
  let x_1591 : f32 = u_xlat15;
  u_xlat15 = (-(x_1591) + 1.0f);
  let x_1594 : f32 = u_xlat15;
  let x_1596 : f32 = u_xlat1.x;
  u_xlat15 = (x_1594 * x_1596);
  ...
  u_xlat0 = ((vec3<f32>(x_1663, x_1663, x_1663) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1668);
  let x_1670 : vec3<f32> = u_xlat0;
  let x_1671 : vec3<f32> = (x_1670 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1672 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1671.x, x_1671.y, x_1671.z, x_1672.w);
  let x_1674 : vec3<f32> = u_xlat0;
  let x_1675 : vec3<f32> = (x_1674 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1676 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1675.x, x_1675.y, x_1675.z, x_1676.w);
  let x_1678 : vec4<f32> = u_xlat2;
  let x_1680 : vec3<f32> = (vec3<f32>(x_1678.x, x_1678.y, x_1678.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1691 : vec3<f32> = (vec3<f32>(x_1689.x, x_1689.y, x_1689.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1701 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1699.x, x_1699.y, x_1699.z, x_1699.x));
  ...
  let x_1742 : vec3<f32> = max(x_1741, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1743 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1742.x, x_1742.y, x_1742.z, x_1743.w);
  SV_Target0.w = 1.0f;
  return;
}
