...
fn main_1() {
  ...
  let x_1290 : vec2<f32> = vs_TEXCOORD0;
  let x_1293 : vec4<f32> = x_14.x_Grain_TilingParams;
  let x_1297 : vec4<f32> = x_14.x_Grain_TilingParams;
  let x_1299 : vec2<f32> = ((x_1290 * vec2<f32>(x_1293.x, x_1293.y)) + vec2<f32>(x_1297.z, x_1297.w));
  let x_1300 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1299.x, x_1299.y, x_1300.z, x_1300.w);
  let x_1307 : vec4<f32> = u_xlat1;
  let x_1310 : f32 = x_14.x_GlobalMipBias.x;
  let x_1311 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1307.x, x_1307.y), x_1310);
  u_xlat15 = x_1311.w;
  let x_1313 : f32 = u_xlat15;
  u_xlat15 = (x_1313 + -0.5f);
  let x_1315 : f32 = u_xlat15;
  let x_1316 : f32 = u_xlat15;
  u_xlat15 = (x_1315 + x_1316);
  let x_1318 : vec3<f32> = u_xlat0;
  u_xlat1.x = dot(x_1318, vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1326 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1326);
  let x_1331 : f32 = x_14.x_Grain_Params.y;
  let x_1333 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1331 * -(x_1333)) + 1.0f);
  let x_1338 : f32 = u_xlat15;
  let x_1340 : vec3<f32> = u_xlat0;
  u_xlat6 = (vec3<f32>(x_1338, x_1338, x_1338) * x_1340);
  let x_1342 : vec3<f32> = u_xlat6;
  let x_1345 : vec2<f32> = x_14.x_Grain_Params;
  u_xlat6 = (x_1342 * vec3<f32>(x_1345.x, x_1345.x, x_1345.x));
  let x_1348 : vec3<f32> = u_xlat6;
  let x_1349 : vec4<f32> = u_xlat1;
  let x_1352 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1348 * vec3<f32>(x_1349.x, x_1349.x, x_1349.x)) + x_1352);
  let x_1354 : vec2<f32> = vs_TEXCOORD0;
  let x_1357 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1361 : vec4<f32> = x_14.x_Dithering_Params;
  ...
  let x_1374 : f32 = x_14.x_GlobalMipBias.x;
  let x_1375 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1371.x, x_1371.y), x_1374);
  u_xlat15 = x_1375.w;
  let x_1377 : f32 = u_xlat15;
  u_xlat15 = ((x_1377 * 2.0f) + -1.0f);
  let x_1380 : f32 = u_xlat15;
  u_xlatb1 = (x_1380 >= 0.0f);
  let x_1382 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1382);
  let x_1385 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1385)) + 1.0f);
  let x_1389 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1389);
  let x_1391 : f32 = u_xlat15;
  u_xlat15 = (-(x_1391) + 1.0f);
  let x_1394 : f32 = u_xlat15;
  let x_1396 : f32 = u_xlat1.x;
  u_xlat15 = (x_1394 * x_1396);
  let x_1398 : vec3<f32> = u_xlat0;
  let x_1399 : vec3<f32> = (x_1398 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1400 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1399.x, x_1399.y, x_1399.z, x_1400.w);
  let x_1402 : vec3<f32> = u_xlat0;
  let x_1404 : vec3<f32> = log2(abs(x_1402));
  let x_1405 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1404.x, x_1404.y, x_1404.z, x_1405.w);
  let x_1407 : vec4<f32> = u_xlat2;
  let x_1409 : vec3<f32> = (vec3<f32>(x_1407.x, x_1407.y, x_1407.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1410 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1409.x, x_1409.y, x_1409.z, x_1410.w);
  let x_1412 : vec4<f32> = u_xlat2;
  let x_1414 : vec3<f32> = exp2(vec3<f32>(x_1412.x, x_1412.y, x_1412.z));
  let x_1415 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1414.x, x_1414.y, x_1414.z, x_1415.w);
  let x_1417 : vec4<f32> = u_xlat2;
  let x_1420 : vec3<f32> = ((vec3<f32>(x_1417.x, x_1417.y, x_1417.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1421 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1420.x, x_1420.y, x_1420.z, x_1421.w);
  let x_1423 : vec3<f32> = u_xlat0;
  let x_1425 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1423.x, x_1423.y, x_1423.z, x_1423.x));
  u_xlatb0 = vec3<bool>(x_1425.x, x_1425.y, x_1425.z);
  let x_1428 : bool = u_xlatb0.x;
  if (x_1428) {
  ...
  u_xlat0.x = x_1437;
  let x_1440 : bool = u_xlatb0.y;
  if (x_1440) {
    let x_1445 : f32 = u_xlat1.y;
    x_1441 = x_1445;
  } else {
  ...
  u_xlat0.z = x_1461;
  let x_1463 : f32 = u_xlat15;
  let x_1468 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1463, x_1463, x_1463) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1468);
  let x_1470 : vec3<f32> = u_xlat0;
  let x_1471 : vec3<f32> = (x_1470 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1472 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1471.x, x_1471.y, x_1471.z, x_1472.w);
  let x_1474 : vec3<f32> = u_xlat0;
  let x_1475 : vec3<f32> = (x_1474 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1476 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1475.x, x_1475.y, x_1475.z, x_1476.w);
  let x_1478 : vec4<f32> = u_xlat2;
  let x_1480 : vec3<f32> = (vec3<f32>(x_1478.x, x_1478.y, x_1478.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1481 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1480.x, x_1480.y, x_1480.z, x_1481.w);
  let x_1483 : vec4<f32> = u_xlat2;
  let x_1486 : vec3<f32> = log2(abs(vec3<f32>(x_1483.x, x_1483.y, x_1483.z)));
  let x_1487 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1486.x, x_1486.y, x_1486.z, x_1487.w);
  let x_1489 : vec4<f32> = u_xlat2;
  let x_1491 : vec3<f32> = (vec3<f32>(x_1489.x, x_1489.y, x_1489.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1499 : vec3<f32> = u_xlat0;
  let x_1501 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1499.x, x_1499.y, x_1499.z, x_1499.x));
  u_xlatb0 = vec3<bool>(x_1501.x, x_1501.y, x_1501.z);
  let x_1504 : bool = u_xlatb0.x;
  if (x_1504) {
    let x_1509 : f32 = u_xlat1.x;
    x_1505 = x_1509;
  } else {
    let x_1512 : f32 = u_xlat2.x;
    x_1505 = x_1512;
  }
  let x_1513 : f32 = x_1505;
  u_xlat0.x = x_1513;
  let x_1516 : bool = u_xlatb0.y;
  if (x_1516) {
    let x_1521 : f32 = u_xlat1.y;
    x_1517 = x_1521;
  } else {
    let x_1524 : f32 = u_xlat2.y;
    x_1517 = x_1524;
  }
  let x_1525 : f32 = x_1517;
  u_xlat0.y = x_1525;
  let x_1528 : bool = u_xlatb0.z;
  if (x_1528) {
    let x_1533 : f32 = u_xlat1.z;
    x_1529 = x_1533;
  } else {
  ...
  let x_1542 : vec3<f32> = max(x_1541, vec3<f32>(0.0f, 0.0f, 0.0f));
