...
void main()
{
    ...
    u_xlat2.x = dot(u_xlat26.xyz, u_xlat2.xyz);
    ...
    u_xlat55 = dot((-u_xlat3.xyz), u_xlat26.xyz);
    u_xlat55 = u_xlat55 + u_xlat55;
    u_xlat6.xyz = u_xlat26.xyz * (-vec3(u_xlat55)) + (-u_xlat3.xyz);
    u_xlat55 = dot(u_xlat26.xyz, u_xlat3.xyz);
    u_xlat55 = clamp(u_xlat55, 0.0, 1.0);
    ...
    u_xlat1 = u_xlat30.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat30.x = dot(u_xlat26.xyz, u_xlat8.xyz);
