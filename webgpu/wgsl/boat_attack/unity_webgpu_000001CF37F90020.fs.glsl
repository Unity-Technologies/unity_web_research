...
;
    ...
    u_xlat4.xyz = u_xlat15.xxx * u_xlat17.xyz;
    u_xlatb15.x = unity_OrthoParams.w==0.0;
    u_xlat17.xyz = (-vs_INTERP8.xyz) + _WorldSpaceCameraPos.xyz;
    ...
    u_xlat17.xyz = (u_xlatb15.x) ? u_xlat17.xyz : u_xlat5.xyz;
    u_xlat15.x = vs_INTERP8.y * unity_MatrixV[1].z;
    u_xlat15.x = unity_MatrixV[0].z * vs_INTERP8.x + u_xlat15.x;
    u_xlat15.x = unity_MatrixV[2].z * vs_INTERP8.z + u_xlat15.x;
    ...
    u_xlat8.xyz = u_xlat4.xyz * (-u_xlat34.xxx) + (-u_xlat17.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat3.x = dot(unity_LightIndices[int(u_xlatu3)], uintBitsToFloat(ImmCB_0[u_xlati48]));
        u_xlati3 = int(u_xlat3.x);
        u_xlat23.xyz = (-vs_INTERP8.xyz) * _AdditionalLightsPosition[u_xlati3].www + _AdditionalLightsPosition[u_xlati3].xyz;
        ...
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[u_xlati3].x;
        u_xlat48 = (-u_xlat48) * u_xlat48 + 1.0;
        u_xlat48 = max(u_xlat48, 0.0);
        u_xlat48 = u_xlat48 * u_xlat48;
        u_xlat48 = u_xlat48 * u_xlat50;
        u_xlat50 = dot(_AdditionalLightsSpotDir[u_xlati3].xyz, u_xlat10.xyz);
        u_xlat50 = u_xlat50 * _AdditionalLightsAttenuation[u_xlati3].z + _AdditionalLightsAttenuation[u_xlati3].w;
        u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
        u_xlat50 = u_xlat50 * u_xlat50;
        u_xlat48 = u_xlat48 * u_xlat50;
        u_xlati50 = int(_AdditionalShadowParams[u_xlati3].w);
        u_xlatb52 = u_xlati50>=0;
        if(u_xlatb52){
            u_xlatb52 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati3].z);
            if(u_xlatb52){
                ...
                u_xlat11.x = trunc(_AdditionalShadowParams[u_xlati3].w);
                u_xlat52 = u_xlat52 + u_xlat11.x;
                u_xlati50 = int(u_xlat52);
            }
            ...
            u_xlat52 = 1.0 + (-_AdditionalShadowParams[u_xlati3].x);
            u_xlat50 = u_xlat50 * _AdditionalShadowParams[u_xlati3].x + u_xlat52;
            u_xlatb52 = 0.0>=u_xlat11.z;
            u_xlatb11.x = u_xlat11.z>=1.0;
            u_xlatb52 = u_xlatb52 || u_xlatb11.x;
            u_xlat50 = (u_xlatb52) ? 1.0 : u_xlat50;
        } else {
            u_xlat50 = 1.0;
        }
        u_xlat52 = (-u_xlat50) + 1.0;
        u_xlat50 = u_xlat43 * u_xlat52 + u_xlat50;
        u_xlati52 = 1 << (u_xlati3 & int(0x1F));
        u_xlati52 = int(uint(u_xlati52) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati52 != 0) {
            u_xlati52 = int(_AdditionalLightsLightTypes[u_xlati3]);
            u_xlati11 = (u_xlati52 != 0) ? 0 : 1;
            u_xlati25 = u_xlati3 << (2 & int(0x1F));
            if(u_xlati11 != 0) {
                ...
                u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati3].xy * u_xlat11.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati3].zw;
            } else {
                ...
                if(u_xlati52 != 0) {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati3].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati3].zw;
                } else {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati3].xy * u_xlat25.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati3].zw;
                }
            }
        ...
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[u_xlati3].xyz;
        u_xlat3.x = u_xlat48 * u_xlat50;
        u_xlat48 = dot(u_xlat4.xyz, u_xlat10.xyz);
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        u_xlat3.x = u_xlat3.x * u_xlat48;
        u_xlat11.xyz = u_xlat3.xxx * u_xlat11.xyz;
        u_xlat23.xyz = u_xlat23.xyz * vec3(u_xlat49) + u_xlat17.xyz;
        u_xlat3.x = dot(u_xlat23.xyz, u_xlat23.xyz);
        u_xlat3.x = max(u_xlat3.x, 1.17549435e-38);
        u_xlat3.x = inversesqrt(u_xlat3.x);
        u_xlat23.xyz = u_xlat3.xxx * u_xlat23.xyz;
        u_xlat3.x = dot(u_xlat4.xyz, u_xlat23.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        u_xlat48 = dot(u_xlat10.xyz, u_xlat23.xyz);
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        ...
        u_xlat23.xyz = u_xlat3.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    ...
    u_xlat0.xyz = vs_INTERP6.www * u_xlat0.xyz + u_xlat2.xyz;
