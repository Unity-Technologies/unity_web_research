...
void main()
{
    ...
    u_xlat3 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat1.zw, _GlobalMipBias.x);
    u_xlat1 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat1.xy, _GlobalMipBias.x);
    u_xlat1.xyz = u_xlat1.www * u_xlat1.xyz;
    u_xlat3.xyz = u_xlat3.www * u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.432432413, 0.432432413, 0.432432413);
    u_xlat1.xyz = u_xlat1.xyz * vec3(0.129729763, 0.129729763, 0.129729763) + u_xlat3.xyz;
    ...
    u_xlat5 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat4.xy, _GlobalMipBias.x);
    u_xlat4 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat4.zw, _GlobalMipBias.x);
    u_xlat4.xyz = u_xlat4.www * u_xlat4.xyz;
    u_xlat5.xyz = u_xlat5.www * u_xlat5.xyz;
    u_xlat1.xyz = u_xlat5.xyz * vec3(0.972972989, 0.972972989, 0.972972989) + u_xlat1.xyz;
    u_xlat1.xyz = u_xlat4.xyz * vec3(1.55675673, 1.55675673, 1.55675673) + u_xlat1.xyz;
    u_xlat14.xy = min(u_xlat2.xy, vs_TEXCOORD0.xy);
    u_xlat0 = min(u_xlat0, u_xlat2.xyxy);
    u_xlat2 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat14.xy, _GlobalMipBias.x);
    u_xlat2.xyz = u_xlat2.www * u_xlat2.xyz;
    u_xlat1.xyz = u_xlat2.xyz * vec3(1.81621623, 1.81621623, 1.81621623) + u_xlat1.xyz;
    u_xlat2 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat3.xy, _GlobalMipBias.x);
    u_xlat3 = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat3.zw, _GlobalMipBias.x);
    u_xlat3.xyz = u_xlat3.www * u_xlat3.xyz;
    u_xlat2.xyz = u_xlat2.www * u_xlat2.xyz;
    u_xlat1.xyz = u_xlat2.xyz * vec3(1.55675673, 1.55675673, 1.55675673) + u_xlat1.xyz;
    u_xlat1.xyz = u_xlat3.xyz * vec3(0.972972989, 0.972972989, 0.972972989) + u_xlat1.xyz;
    ...
    u_xlat18 = u_xlat18 * 255.0;
    u_xlat18 = ceil(u_xlat18);
    u_xlat18 = u_xlat18 * 0.00392156886;
