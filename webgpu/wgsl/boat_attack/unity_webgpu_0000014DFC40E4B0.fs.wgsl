...
fn main_1() {
  ...
  u_xlat0 = sqrt(x_1459);
  let x_1461 : vec2<f32> = vs_TEXCOORD0;
  let x_1464 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1468 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1470 : vec2<f32> = ((x_1461 * vec2<f32>(x_1464.x, x_1464.y)) + vec2<f32>(x_1468.z, x_1468.w));
  let x_1471 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1470.x, x_1470.y, x_1471.z, x_1471.w);
  let x_1478 : vec4<f32> = u_xlat1;
  let x_1481 : f32 = x_14.x_GlobalMipBias.x;
  let x_1482 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1478.x, x_1478.y), x_1481);
  u_xlat15 = x_1482.w;
  let x_1484 : f32 = u_xlat15;
  u_xlat15 = ((x_1484 * 2.0f) + -1.0f);
  let x_1487 : f32 = u_xlat15;
  u_xlatb1 = (x_1487 >= 0.0f);
  let x_1489 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1489);
  let x_1492 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1492)) + 1.0f);
  let x_1496 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1496);
  let x_1498 : f32 = u_xlat15;
  u_xlat15 = (-(x_1498) + 1.0f);
  let x_1501 : f32 = u_xlat15;
  let x_1503 : f32 = u_xlat1.x;
  u_xlat15 = (x_1501 * x_1503);
  let x_1505 : vec3<f32> = u_xlat0;
  let x_1506 : vec3<f32> = (x_1505 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1507 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1506.x, x_1506.y, x_1506.z, x_1507.w);
  let x_1509 : vec3<f32> = u_xlat0;
  let x_1510 : vec3<f32> = log2(x_1509);
