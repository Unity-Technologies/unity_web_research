...
;
    ...
    u_xlatb41 = 0.0>=u_xlat21.z;
    u_xlatb61 = u_xlat21.z>=1.0;
    u_xlatb41 = u_xlatb61 || u_xlatb41;
    u_xlat21.x = (u_xlatb41) ? 1.0 : u_xlat21.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat67 = dot(_AdditionalLightsSpotDir[u_xlati64].xyz, u_xlat9.xyz);
        u_xlat67 = u_xlat67 * _AdditionalLightsAttenuation[u_xlati64].z + _AdditionalLightsAttenuation[u_xlati64].w;
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat65 = u_xlat65 * u_xlat67;
        u_xlat10.xyz = vec3(u_xlat44) * _AdditionalLightsColor[u_xlati64].xyz;
