...
;
    ...
    u_xlat4.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati13 + 1) / 4][(u_xlati13 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati13 / 4][u_xlati13 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati13 + 2) / 4][(u_xlati13 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat4.xyz;
    u_xlat13.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati13 + 3) / 4][(u_xlati13 + 3) % 4].xyz;
    u_xlat2.w = 1.0;
    ...
    u_xlat6.xyz = u_xlat0.xyz * vec3(u_xlat36) + u_xlat5.xyz;
