...
;
    ...
    u_xlat4.x = u_xlat18.x * u_xlat32 + u_xlat4.x;
    ...
    if(u_xlatb18.x){
        ...
        u_xlat32 = (u_xlatb18.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb18.x) ? u_xlat7.xyz : vec3(u_xlat32);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat8.xyz = u_xlat2.xyz * (-u_xlat18.xxx) + (-u_xlat3.xyz);
    u_xlat18.x = dot(u_xlat2.xyz, u_xlat3.xyz);
    u_xlat18.x = clamp(u_xlat18.x, 0.0, 1.0);
    u_xlat18.x = (-u_xlat18.x) + 1.0;
    u_xlat18.x = u_xlat18.x * u_xlat18.x;
    u_xlat18.x = u_xlat18.x * u_xlat18.x;
    u_xlat32 = (-u_xlat42) * 0.699999988 + 1.70000005;
    ...
    u_xlat34.xy = vec2(u_xlat45) * vec2(u_xlat45) + vec2(-1.0, 1.0);
    ...
    u_xlat4.xyz = vec3(u_xlat42) * u_xlat7.xyz;
    ...
    u_xlat42 = u_xlat42 * u_xlat34.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu45)].www + _AdditionalLightsPosition[int(u_xlatu45)].xyz;
        ...
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[int(u_xlatu45)].x;
        u_xlat48 = (-u_xlat48) * u_xlat48 + 1.0;
        u_xlat48 = max(u_xlat48, 0.0);
        u_xlat48 = u_xlat48 * u_xlat48;
        u_xlat48 = u_xlat48 * u_xlat49;
        u_xlat49 = dot(_AdditionalLightsSpotDir[int(u_xlatu45)].xyz, u_xlat10.xyz);
        u_xlat49 = u_xlat49 * _AdditionalLightsAttenuation[int(u_xlatu45)].z + _AdditionalLightsAttenuation[int(u_xlatu45)].w;
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat48 = u_xlat48 * u_xlat49;
        u_xlatu49 = u_xlatu45 >> (5u & uint(0x1F));
        u_xlati50 = 1 << (int(u_xlatu45) & int(0x1F));
        u_xlati49 = int(uint(u_xlati50) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu49)]));
        if(u_xlati49 != 0) {
            u_xlati49 = int(_AdditionalLightsLightTypes[int(u_xlatu45)]);
            u_xlati50 = (u_xlati49 != 0) ? 0 : 1;
            u_xlati51 = int(u_xlatu45) << (2 & int(0x1F));
            if(u_xlati50 != 0) {
                u_xlat11.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati51 + 1) / 4][(u_xlati51 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati51 / 4][u_xlati51 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati51 + 2) / 4][(u_xlati51 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat11.xyz;
                ...
                if(u_xlati49 != 0) {
                    u_xlat39.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati51 + 1) / 4][(u_xlati51 + 1) % 4].xy;
                    u_xlat39.xy = _AdditionalLightsWorldToLights[u_xlati51 / 4][u_xlati51 % 4].xy * vs_TEXCOORD1.xx + u_xlat39.xy;
                    u_xlat39.xy = _AdditionalLightsWorldToLights[(u_xlati51 + 2) / 4][(u_xlati51 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat39.xy;
                    ...
                    u_xlat12 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati51 + 1) / 4][(u_xlati51 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati51 / 4][u_xlati51 % 4] * vs_TEXCOORD1.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati51 + 2) / 4][(u_xlati51 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat12;
