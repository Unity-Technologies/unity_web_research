...
;
    ...
    u_xlat14 = min(u_xlat14, u_xlat46);
    ...
    if(u_xlatb17.x){
        ...
        u_xlat6.xyz = (u_xlatb17.x) ? u_xlat6.xyz : vec3(u_xlat31);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat8.xyz = u_xlat1.xyz * (-u_xlat17.xxx) + (-u_xlat2.xyz);
    ...
    u_xlat9.xyz = u_xlat17.xxx * u_xlat9.xyz + u_xlat5.xyz;
    ...
    u_xlat3.xyz = vec3(u_xlat28) * u_xlat6.xyz;
    ...
    u_xlat6.xyz = u_xlat5.xyz * vec3(u_xlat28) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat46) + u_xlat7.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat14) + u_xlat3.xyz;
