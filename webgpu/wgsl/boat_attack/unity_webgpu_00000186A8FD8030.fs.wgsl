...
fn main_1() {
  ...
  u_xlat0 = sqrt(x_1583);
  let x_1585 : vec2<f32> = vs_TEXCOORD0;
  let x_1588 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1592 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1594 : vec2<f32> = ((x_1585 * vec2<f32>(x_1588.x, x_1588.y)) + vec2<f32>(x_1592.z, x_1592.w));
  let x_1595 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1594.x, x_1594.y, x_1595.z, x_1595.w);
  let x_1602 : vec4<f32> = u_xlat1;
  let x_1605 : f32 = x_26.x_GlobalMipBias.x;
  let x_1606 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1602.x, x_1602.y), x_1605);
  u_xlat15 = x_1606.w;
  let x_1608 : f32 = u_xlat15;
  u_xlat15 = ((x_1608 * 2.0f) + -1.0f);
  let x_1611 : f32 = u_xlat15;
  u_xlatb1 = (x_1611 >= 0.0f);
  let x_1613 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1613);
  let x_1616 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1616)) + 1.0f);
  let x_1620 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1620);
  let x_1622 : f32 = u_xlat15;
  u_xlat15 = (-(x_1622) + 1.0f);
  let x_1625 : f32 = u_xlat15;
  let x_1627 : f32 = u_xlat1.x;
  u_xlat15 = (x_1625 * x_1627);
  let x_1629 : vec3<f32> = u_xlat0;
  let x_1630 : vec3<f32> = (x_1629 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1631 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1630.x, x_1630.y, x_1630.z, x_1631.w);
  let x_1633 : vec3<f32> = u_xlat0;
  let x_1634 : vec3<f32> = log2(x_1633);
