...
;
    ...
    u_xlat22.x = u_xlat2.x * u_xlat2.x + (-u_xlat22.x);
    u_xlat5.xyz = unity_SHC.xyz * u_xlat22.xxx + u_xlat6.xyz;
    ...
    if(u_xlatb22){
        ...
        if(u_xlatb22){
            ...
            if(u_xlatb66){
                ...
                u_xlat1.x = u_xlat12.x * u_xlat1.x + u_xlat68;
                ...
                u_xlat1.x = u_xlat13.x * u_xlat68 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat13.y * u_xlat68 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat13.z * u_xlat68 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat13.w * u_xlat68 + u_xlat1.x;
                ...
                u_xlat22.x = u_xlat66 * u_xlat68 + u_xlat1.x;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat49.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat66 = u_xlat16.x * u_xlat66 + u_xlat1.x;
                ...
                u_xlat66 = u_xlat18.x * u_xlat1.x + u_xlat66;
                ...
                u_xlat66 = u_xlat18.y * u_xlat1.x + u_xlat66;
                ...
                u_xlat66 = u_xlat18.z * u_xlat1.x + u_xlat66;
                ...
                u_xlat66 = u_xlat18.w * u_xlat1.x + u_xlat66;
                ...
                u_xlat66 = u_xlat6.x * u_xlat1.x + u_xlat66;
                ...
                u_xlat66 = u_xlat6.y * u_xlat1.x + u_xlat66;
                ...
                u_xlat66 = u_xlat6.z * u_xlat1.x + u_xlat66;
                ...
                u_xlat22.x = u_xlat6.w * u_xlat1.x + u_xlat66;
            }
        }
    } else {
        vec3 txVec29 = vec3(u_xlat3.xy,u_xlat3.z);
        u_xlat22.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec29, 0.0);
    }
    u_xlat66 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat22.x = u_xlat22.x * _MainLightShadowParams.x + u_xlat66;
    u_xlatb66 = 0.0>=u_xlat3.z;
    u_xlatb1 = u_xlat3.z>=1.0;
    u_xlatb66 = u_xlatb66 || u_xlatb1;
    u_xlat22.x = (u_xlatb66) ? 1.0 : u_xlat22.x;
    u_xlat3.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat66 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat1.x = u_xlat66 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat68 = (-u_xlat22.x) + 1.0;
    u_xlat22.x = u_xlat1.x * u_xlat68 + u_xlat22.x;
    u_xlat22.x = u_xlat22.x * unity_LightData.z;
    u_xlat3.xyz = u_xlat22.xxx * _MainLightColor.xyz;
