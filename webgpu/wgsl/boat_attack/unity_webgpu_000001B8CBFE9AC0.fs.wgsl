...
fn main_1() {
  ...
  u_xlat4 = (vec3<f32>(x_61.z, x_61.x, x_61.y) * vec3<f32>(x_63.y, x_63.z, x_63.x));
  let x_66 : vec3<f32> = vs_INTERP1;
  let x_68 : vec4<f32> = vs_INTERP2;
  ...
  u_xlat0.x = max(x_157, 1.17549435e-37f);
  ...
  let x_185 : f32 = vs_INTERP0.y;
  u_xlat4.x = (-(x_181) + x_185);
  let x_189 : f32 = u_xlat4.x;
  u_xlat4.x = (x_189 * 0.050000001f);
  ...
  u_xlat8 = ((-(x_217) * 0.011111f) + 0.949999988f);
