...
void main()
{
    ...
    u_xlat15.xyz = u_xlat15.xyz * u_xlat16.xyz + u_xlat6.xyz;
    ...
    u_xlat1 = u_xlat29 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat9) + u_xlat13.xyz;
    ...
    u_xlat0.xyz = u_xlat19.xyz * u_xlat6.xyz + u_xlat15.xyz;
