...
fn main_1() {
  ...
  let x_1471 : vec3<f32> = u_xlat0;
  let x_1474 : vec3<f32> = (x_1471 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1475 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1474.x, x_1474.y, x_1474.z, x_1475.w);
  let x_1477 : vec3<f32> = u_xlat0;
  let x_1479 : vec3<f32> = log2(abs(x_1477));
  let x_1480 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1479.x, x_1479.y, x_1479.z, x_1480.w);
  let x_1482 : vec4<f32> = u_xlat2;
  let x_1486 : vec3<f32> = (vec3<f32>(x_1482.x, x_1482.y, x_1482.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1487 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1486.x, x_1486.y, x_1486.z, x_1487.w);
  let x_1489 : vec4<f32> = u_xlat2;
  let x_1491 : vec3<f32> = exp2(vec3<f32>(x_1489.x, x_1489.y, x_1489.z));
  let x_1492 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1491.x, x_1491.y, x_1491.z, x_1492.w);
  let x_1494 : vec4<f32> = u_xlat2;
  let x_1501 : vec3<f32> = ((vec3<f32>(x_1494.x, x_1494.y, x_1494.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  ...
  let x_1550 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1554 : vec4<f32> = x_27.x_Dithering_Params;
  ...
  let x_1567 : f32 = x_27.x_GlobalMipBias.x;
  let x_1568 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1564.x, x_1564.y), x_1567);
  u_xlat21 = x_1568.w;
  let x_1570 : f32 = u_xlat21;
  u_xlat21 = ((x_1570 * 2.0f) + -1.0f);
  let x_1573 : f32 = u_xlat21;
  u_xlatb1.x = (x_1573 >= 0.0f);
  let x_1577 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1577);
  let x_1580 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1580)) + 1.0f);
  let x_1584 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1584);
  let x_1586 : f32 = u_xlat21;
  u_xlat21 = (-(x_1586) + 1.0f);
  let x_1589 : f32 = u_xlat21;
  let x_1591 : f32 = u_xlat1.x;
  u_xlat21 = (x_1589 * x_1591);
  let x_1593 : vec3<f32> = u_xlat0;
  let x_1594 : vec3<f32> = (x_1593 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1595 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1594.x, x_1594.y, x_1594.z, x_1595.w);
  let x_1597 : vec3<f32> = u_xlat0;
  let x_1599 : vec3<f32> = log2(abs(x_1597));
  ...
  u_xlat0.z = x_1656;
  let x_1658 : f32 = u_xlat21;
  let x_1663 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1658, x_1658, x_1658) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1663);
  let x_1665 : vec3<f32> = u_xlat0;
  let x_1668 : vec3<f32> = (x_1665 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1669 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1668.x, x_1668.y, x_1668.z, x_1669.w);
  let x_1671 : vec3<f32> = u_xlat0;
  let x_1674 : vec3<f32> = (x_1671 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1675 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1674.x, x_1674.y, x_1674.z, x_1675.w);
  let x_1677 : vec4<f32> = u_xlat2;
  let x_1681 : vec3<f32> = (vec3<f32>(x_1677.x, x_1677.y, x_1677.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  ...
  let x_1694 : vec3<f32> = (vec3<f32>(x_1690.x, x_1690.y, x_1690.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1695 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1694.x, x_1694.y, x_1694.z, x_1695.w);
  let x_1697 : vec4<f32> = u_xlat2;
  let x_1699 : vec3<f32> = exp2(vec3<f32>(x_1697.x, x_1697.y, x_1697.z));
  let x_1700 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1699.x, x_1699.y, x_1699.z, x_1700.w);
  let x_1704 : vec3<f32> = u_xlat0;
  let x_1706 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1704.x, x_1704.y, x_1704.z, x_1704.x));
  u_xlatb0 = vec3<bool>(x_1706.x, x_1706.y, x_1706.z);
  let x_1711 : bool = u_xlatb0.x;
  if (x_1711) {
  ...
  SV_Target0.x = x_1720;
  let x_1724 : bool = u_xlatb0.y;
  if (x_1724) {
    let x_1729 : f32 = u_xlat1.y;
    x_1725 = x_1729;
  } else {
    let x_1732 : f32 = u_xlat2.y;
    x_1725 = x_1732;
  }
  let x_1733 : f32 = x_1725;
  SV_Target0.y = x_1733;
  let x_1736 : bool = u_xlatb0.z;
  if (x_1736) {
    let x_1741 : f32 = u_xlat1.z;
    x_1737 = x_1741;
  } else {
