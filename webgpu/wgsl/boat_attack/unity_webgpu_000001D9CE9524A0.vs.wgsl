...
fn main_1() {
  ...
  let x_649 : vec2<f32> = ((vec2<f32>(x_644.x, x_644.z) * vec2<f32>(0.00200000009499490261f, 0.00200000009499490261f)) + vec2<f32>(0.5f, 0.5f));
  ...
  u_xlat13 = (x_694 * 0.40000000596046447754f);
  ...
  u_xlat11 = ((x_707 * 0.10000000149011611938f) + 0.05000000074505805969f);
  ...
  loop {
    ...
    u_xlat37 = (6.28318023681640625f / x_782);
    ...
    u_xlat29 = (vec2<f32>(10000.0f, 0.01745329238474369049f) * vec2<f32>(x_804.x, x_804.y));
  ...
  u_xlat35 = max(x_1079, 1.17549435e-38f);
  ...
  let x_1153 : vec2<f32> = (vec2<f32>(x_1149.x, x_1149.z) * vec2<f32>(0.00499999988824129105f, 0.00499999988824129105f));
