...
fn main_1() {
  ...
  let x_1446 : bool = u_xlatb0.x;
  if (x_1446) {
    let x_1451 : f32 = u_xlat1.x;
    x_1447 = x_1451;
  } else {
    let x_1454 : f32 = u_xlat2.x;
    x_1447 = x_1454;
  }
  let x_1455 : f32 = x_1447;
  u_xlat0.x = x_1455;
  let x_1458 : bool = u_xlatb0.y;
  if (x_1458) {
    let x_1463 : f32 = u_xlat1.y;
    x_1459 = x_1463;
  } else {
    let x_1466 : f32 = u_xlat2.y;
    x_1459 = x_1466;
  }
  let x_1467 : f32 = x_1459;
  u_xlat0.y = x_1467;
  let x_1470 : bool = u_xlatb0.z;
  if (x_1470) {
  ...
  u_xlat0.z = x_1479;
  let x_1481 : vec2<f32> = vs_TEXCOORD0;
  let x_1484 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1488 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1490 : vec2<f32> = ((x_1481 * vec2<f32>(x_1484.x, x_1484.y)) + vec2<f32>(x_1488.z, x_1488.w));
  let x_1491 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1490.x, x_1490.y, x_1491.z, x_1491.w);
  let x_1498 : vec4<f32> = u_xlat1;
  let x_1501 : f32 = x_27.x_GlobalMipBias.x;
  let x_1502 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1498.x, x_1498.y), x_1501);
  u_xlat21 = x_1502.w;
  let x_1504 : f32 = u_xlat21;
  u_xlat21 = ((x_1504 * 2.0f) + -1.0f);
  let x_1507 : f32 = u_xlat21;
  u_xlatb1.x = (x_1507 >= 0.0f);
  let x_1511 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1511);
  let x_1514 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1514)) + 1.0f);
  let x_1518 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1518);
  let x_1520 : f32 = u_xlat21;
  u_xlat21 = (-(x_1520) + 1.0f);
  let x_1523 : f32 = u_xlat21;
  let x_1525 : f32 = u_xlat1.x;
  u_xlat21 = (x_1523 * x_1525);
  let x_1527 : vec3<f32> = u_xlat0;
  let x_1528 : vec3<f32> = (x_1527 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  ...
  let x_1538 : vec3<f32> = (vec3<f32>(x_1536.x, x_1536.y, x_1536.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1549 : vec3<f32> = ((vec3<f32>(x_1546.x, x_1546.y, x_1546.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
