...
fn main_1() {
  ...
  let x_2028 : vec2<f32> = vs_TEXCOORD0;
  let x_2031 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_2035 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_2037 : vec2<f32> = ((x_2028 * vec2<f32>(x_2031.x, x_2031.y)) + vec2<f32>(x_2035.z, x_2035.w));
  let x_2038 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2037.x, x_2037.y, x_2038.z, x_2038.w);
  let x_2045 : vec4<f32> = u_xlat1;
  let x_2048 : f32 = x_25.x_GlobalMipBias.x;
  let x_2049 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_2045.x, x_2045.y), x_2048);
  u_xlat21 = x_2049.w;
  let x_2051 : f32 = u_xlat21;
  u_xlat21 = (x_2051 + -0.5f);
  let x_2053 : f32 = u_xlat21;
  let x_2054 : f32 = u_xlat21;
  u_xlat21 = (x_2053 + x_2054);
  let x_2056 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_2056.x, x_2056.y, x_2056.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_2065 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_2065);
  let x_2070 : f32 = x_25.x_Grain_Params.y;
  let x_2072 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_2070 * -(x_2072)) + 1.0f);
  let x_2077 : f32 = u_xlat21;
  let x_2079 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_2077, x_2077, x_2077) * vec3<f32>(x_2079.x, x_2079.y, x_2079.z));
  let x_2082 : vec3<f32> = u_xlat8;
  let x_2085 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_2082 * vec3<f32>(x_2085.x, x_2085.x, x_2085.x));
  let x_2088 : vec3<f32> = u_xlat8;
  ...
  let x_2099 : vec3<f32> = (vec3<f32>(x_2097.x, x_2097.y, x_2097.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2100 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2099.x, x_2099.y, x_2099.z, x_2100.w);
  let x_2102 : vec4<f32> = u_xlat0;
  let x_2105 : vec3<f32> = log2(abs(vec3<f32>(x_2102.x, x_2102.y, x_2102.z)));
  let x_2106 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2105.x, x_2105.y, x_2105.z, x_2106.w);
  let x_2108 : vec4<f32> = u_xlat2;
  let x_2110 : vec3<f32> = (vec3<f32>(x_2108.x, x_2108.y, x_2108.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2111 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2110.x, x_2110.y, x_2110.z, x_2111.w);
  let x_2113 : vec4<f32> = u_xlat2;
  let x_2115 : vec3<f32> = exp2(vec3<f32>(x_2113.x, x_2113.y, x_2113.z));
  let x_2116 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2115.x, x_2115.y, x_2115.z, x_2116.w);
  let x_2118 : vec4<f32> = u_xlat2;
  let x_2121 : vec3<f32> = ((vec3<f32>(x_2118.x, x_2118.y, x_2118.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2122 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2121.x, x_2121.y, x_2121.z, x_2122.w);
  let x_2124 : vec4<f32> = u_xlat0;
  let x_2126 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2124.x, x_2124.y, x_2124.z, x_2124.x));
  u_xlatb0 = vec3<bool>(x_2126.x, x_2126.y, x_2126.z);
  let x_2129 : bool = u_xlatb0.x;
  if (x_2129) {
    let x_2134 : f32 = u_xlat1.x;
    x_2130 = x_2134;
  } else {
    let x_2137 : f32 = u_xlat2.x;
    x_2130 = x_2137;
  }
  let x_2138 : f32 = x_2130;
  u_xlat0.x = x_2138;
  let x_2141 : bool = u_xlatb0.y;
  if (x_2141) {
    let x_2146 : f32 = u_xlat1.y;
    x_2142 = x_2146;
  } else {
    let x_2149 : f32 = u_xlat2.y;
    x_2142 = x_2149;
  }
  let x_2150 : f32 = x_2142;
  u_xlat0.y = x_2150;
  let x_2153 : bool = u_xlatb0.z;
  if (x_2153) {
    let x_2158 : f32 = u_xlat1.z;
    x_2154 = x_2158;
  } else {
  ...
  u_xlat0.z = x_2162;
  let x_2164 : vec2<f32> = vs_TEXCOORD0;
  let x_2167 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2171 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2173 : vec2<f32> = ((x_2164 * vec2<f32>(x_2167.x, x_2167.y)) + vec2<f32>(x_2171.z, x_2171.w));
  let x_2174 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2173.x, x_2173.y, x_2174.z, x_2174.w);
  let x_2181 : vec4<f32> = u_xlat1;
  let x_2184 : f32 = x_25.x_GlobalMipBias.x;
  let x_2185 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2181.x, x_2181.y), x_2184);
  u_xlat21 = x_2185.w;
  let x_2187 : f32 = u_xlat21;
  u_xlat21 = ((x_2187 * 2.0f) + -1.0f);
  let x_2190 : f32 = u_xlat21;
  u_xlatb1 = (x_2190 >= 0.0f);
  let x_2192 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2192);
  let x_2195 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2195)) + 1.0f);
  let x_2199 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2199);
  let x_2201 : f32 = u_xlat21;
  u_xlat21 = (-(x_2201) + 1.0f);
  let x_2204 : f32 = u_xlat21;
  let x_2206 : f32 = u_xlat1.x;
  u_xlat21 = (x_2204 * x_2206);
  let x_2208 : vec4<f32> = u_xlat0;
  let x_2210 : vec3<f32> = (vec3<f32>(x_2208.x, x_2208.y, x_2208.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2211 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2210.x, x_2210.y, x_2210.z, x_2211.w);
  let x_2213 : vec4<f32> = u_xlat0;
  let x_2216 : vec3<f32> = log2(abs(vec3<f32>(x_2213.x, x_2213.y, x_2213.z)));
  let x_2217 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2216.x, x_2216.y, x_2216.z, x_2217.w);
  let x_2219 : vec4<f32> = u_xlat2;
  let x_2221 : vec3<f32> = (vec3<f32>(x_2219.x, x_2219.y, x_2219.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2222 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2221.x, x_2221.y, x_2221.z, x_2222.w);
  let x_2224 : vec4<f32> = u_xlat2;
  let x_2226 : vec3<f32> = exp2(vec3<f32>(x_2224.x, x_2224.y, x_2224.z));
  let x_2227 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2226.x, x_2226.y, x_2226.z, x_2227.w);
  let x_2229 : vec4<f32> = u_xlat2;
  let x_2232 : vec3<f32> = ((vec3<f32>(x_2229.x, x_2229.y, x_2229.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2233 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2232.x, x_2232.y, x_2232.z, x_2233.w);
  let x_2235 : vec4<f32> = u_xlat0;
  let x_2237 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2235.x, x_2235.y, x_2235.z, x_2235.x));
  u_xlatb0 = vec3<bool>(x_2237.x, x_2237.y, x_2237.z);
  let x_2240 : bool = u_xlatb0.x;
  if (x_2240) {
    let x_2245 : f32 = u_xlat1.x;
    x_2241 = x_2245;
  } else {
    let x_2248 : f32 = u_xlat2.x;
    x_2241 = x_2248;
  }
  let x_2249 : f32 = x_2241;
  u_xlat0.x = x_2249;
  let x_2252 : bool = u_xlatb0.y;
  if (x_2252) {
    let x_2257 : f32 = u_xlat1.y;
    x_2253 = x_2257;
  } else {
    let x_2260 : f32 = u_xlat2.y;
    x_2253 = x_2260;
  }
  let x_2261 : f32 = x_2253;
  u_xlat0.y = x_2261;
  let x_2264 : bool = u_xlatb0.z;
  if (x_2264) {
    let x_2269 : f32 = u_xlat1.z;
    x_2265 = x_2269;
  } else {
    let x_2272 : f32 = u_xlat2.z;
    x_2265 = x_2272;
  }
  let x_2273 : f32 = x_2265;
  u_xlat0.z = x_2273;
  let x_2275 : f32 = u_xlat21;
  let x_2280 : vec4<f32> = u_xlat0;
  let x_2282 : vec3<f32> = ((vec3<f32>(x_2275, x_2275, x_2275) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2280.x, x_2280.y, x_2280.z));
  let x_2283 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2282.x, x_2282.y, x_2282.z, x_2283.w);
  let x_2285 : vec4<f32> = u_xlat0;
  let x_2287 : vec3<f32> = (vec3<f32>(x_2285.x, x_2285.y, x_2285.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2288 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2287.x, x_2287.y, x_2287.z, x_2288.w);
  let x_2290 : vec4<f32> = u_xlat0;
  let x_2292 : vec3<f32> = (vec3<f32>(x_2290.x, x_2290.y, x_2290.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2293 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2292.x, x_2292.y, x_2292.z, x_2293.w);
  let x_2295 : vec4<f32> = u_xlat2;
  let x_2297 : vec3<f32> = (vec3<f32>(x_2295.x, x_2295.y, x_2295.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2298 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2297.x, x_2297.y, x_2297.z, x_2298.w);
  let x_2300 : vec4<f32> = u_xlat2;
  let x_2303 : vec3<f32> = log2(abs(vec3<f32>(x_2300.x, x_2300.y, x_2300.z)));
  let x_2304 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2303.x, x_2303.y, x_2303.z, x_2304.w);
  let x_2306 : vec4<f32> = u_xlat2;
  let x_2308 : vec3<f32> = (vec3<f32>(x_2306.x, x_2306.y, x_2306.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2309 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2308.x, x_2308.y, x_2308.z, x_2309.w);
  let x_2311 : vec4<f32> = u_xlat2;
  let x_2313 : vec3<f32> = exp2(vec3<f32>(x_2311.x, x_2311.y, x_2311.z));
  let x_2314 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2313.x, x_2313.y, x_2313.z, x_2314.w);
  let x_2316 : vec4<f32> = u_xlat0;
  let x_2318 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2316.x, x_2316.y, x_2316.z, x_2316.x));
  u_xlatb0 = vec3<bool>(x_2318.x, x_2318.y, x_2318.z);
  let x_2321 : bool = u_xlatb0.x;
  if (x_2321) {
    let x_2326 : f32 = u_xlat1.x;
    x_2322 = x_2326;
  } else {
    let x_2329 : f32 = u_xlat2.x;
    x_2322 = x_2329;
  }
  let x_2330 : f32 = x_2322;
  u_xlat0.x = x_2330;
  let x_2333 : bool = u_xlatb0.y;
  if (x_2333) {
    let x_2338 : f32 = u_xlat1.y;
    x_2334 = x_2338;
  } else {
    let x_2341 : f32 = u_xlat2.y;
    x_2334 = x_2341;
  }
  let x_2342 : f32 = x_2334;
  u_xlat0.y = x_2342;
  let x_2345 : bool = u_xlatb0.z;
  if (x_2345) {
    let x_2350 : f32 = u_xlat1.z;
    x_2346 = x_2350;
  } else {
  ...
  let x_2360 : vec3<f32> = max(vec3<f32>(x_2358.x, x_2358.y, x_2358.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2361 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2360.x, x_2360.y, x_2360.z, x_2361.w);
  SV_Target0.w = 1.0f;
  return;
}
