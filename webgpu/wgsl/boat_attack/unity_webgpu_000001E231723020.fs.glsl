...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat66 = dot(unity_LightIndices[int(u_xlatu66)], uintBitsToFloat(ImmCB_0[u_xlati48]));
        u_xlati66 = int(u_xlat66);
        u_xlat30.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati66].www + _AdditionalLightsPosition[u_xlati66].xyz;
        u_xlat48 = dot(u_xlat30.xyz, u_xlat30.xyz);
        u_xlat48 = max(u_xlat48, 6.10351562e-05);
        u_xlat69 = inversesqrt(u_xlat48);
        u_xlat10.xyz = vec3(u_xlat69) * u_xlat30.xyz;
        u_xlat70 = float(1.0) / float(u_xlat48);
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[u_xlati66].x;
        u_xlat48 = (-u_xlat48) * u_xlat48 + 1.0;
        u_xlat48 = max(u_xlat48, 0.0);
        u_xlat48 = u_xlat48 * u_xlat48;
        u_xlat48 = u_xlat48 * u_xlat70;
        u_xlat70 = dot(_AdditionalLightsSpotDir[u_xlati66].xyz, u_xlat10.xyz);
        ...
        u_xlat48 = u_xlat48 * u_xlat70;
        u_xlat11.xyz = vec3(u_xlat27) * _AdditionalLightsColor[u_xlati66].xyz;
        u_xlat66 = dot(u_xlat3.xyz, u_xlat10.xyz);
        u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
        u_xlat66 = u_xlat66 * u_xlat48;
        u_xlat11.xyz = vec3(u_xlat66) * u_xlat11.xyz;
        u_xlat30.xyz = u_xlat30.xyz * vec3(u_xlat69) + u_xlat4.xyz;
        ...
        u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
        u_xlat48 = dot(u_xlat10.xyz, u_xlat30.xyz);
