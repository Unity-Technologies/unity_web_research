...
fn main_1() {
  ...
  let x_2315 : vec3<f32> = sqrt(vec3<f32>(x_2313.x, x_2313.y, x_2313.z));
  let x_2316 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2315.x, x_2315.y, x_2315.z, x_2316.w);
  let x_2318 : vec2<f32> = vs_TEXCOORD0;
  let x_2321 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2325 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2327 : vec2<f32> = ((x_2318 * vec2<f32>(x_2321.x, x_2321.y)) + vec2<f32>(x_2325.z, x_2325.w));
  let x_2328 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2327.x, x_2327.y, x_2328.z, x_2328.w);
  let x_2335 : vec4<f32> = u_xlat1;
  let x_2338 : f32 = x_25.x_GlobalMipBias.x;
  let x_2339 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2335.x, x_2335.y), x_2338);
  u_xlat21 = x_2339.w;
  let x_2341 : f32 = u_xlat21;
  u_xlat21 = ((x_2341 * 2.0f) + -1.0f);
  let x_2344 : f32 = u_xlat21;
  u_xlatb1 = (x_2344 >= 0.0f);
  let x_2346 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2346);
  let x_2349 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2349)) + 1.0f);
  let x_2353 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2353);
  let x_2355 : f32 = u_xlat21;
  u_xlat21 = (-(x_2355) + 1.0f);
  let x_2358 : f32 = u_xlat21;
  let x_2360 : f32 = u_xlat1.x;
  u_xlat21 = (x_2358 * x_2360);
  let x_2362 : vec4<f32> = u_xlat0;
  let x_2364 : vec3<f32> = (vec3<f32>(x_2362.x, x_2362.y, x_2362.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2365 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2364.x, x_2364.y, x_2364.z, x_2365.w);
  let x_2367 : vec4<f32> = u_xlat0;
  let x_2369 : vec3<f32> = log2(vec3<f32>(x_2367.x, x_2367.y, x_2367.z));
  let x_2370 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2369.x, x_2369.y, x_2369.z, x_2370.w);
  let x_2372 : vec4<f32> = u_xlat2;
  let x_2374 : vec3<f32> = (vec3<f32>(x_2372.x, x_2372.y, x_2372.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2375 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2374.x, x_2374.y, x_2374.z, x_2375.w);
  let x_2377 : vec4<f32> = u_xlat2;
  let x_2379 : vec3<f32> = exp2(vec3<f32>(x_2377.x, x_2377.y, x_2377.z));
  let x_2380 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2379.x, x_2379.y, x_2379.z, x_2380.w);
  let x_2382 : vec4<f32> = u_xlat2;
  let x_2385 : vec3<f32> = ((vec3<f32>(x_2382.x, x_2382.y, x_2382.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2386 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2385.x, x_2385.y, x_2385.z, x_2386.w);
  let x_2388 : vec4<f32> = u_xlat0;
  let x_2390 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2388.x, x_2388.y, x_2388.z, x_2388.x));
  u_xlatb0 = vec3<bool>(x_2390.x, x_2390.y, x_2390.z);
  let x_2393 : bool = u_xlatb0.x;
  if (x_2393) {
    let x_2398 : f32 = u_xlat1.x;
    x_2394 = x_2398;
  } else {
    let x_2401 : f32 = u_xlat2.x;
    x_2394 = x_2401;
  }
  let x_2402 : f32 = x_2394;
  u_xlat0.x = x_2402;
  let x_2405 : bool = u_xlatb0.y;
  if (x_2405) {
    let x_2410 : f32 = u_xlat1.y;
    x_2406 = x_2410;
  } else {
    let x_2413 : f32 = u_xlat2.y;
    x_2406 = x_2413;
  }
  let x_2414 : f32 = x_2406;
  u_xlat0.y = x_2414;
  let x_2417 : bool = u_xlatb0.z;
  if (x_2417) {
    let x_2422 : f32 = u_xlat1.z;
    x_2418 = x_2422;
  } else {
    let x_2425 : f32 = u_xlat2.z;
    x_2418 = x_2425;
  }
  let x_2426 : f32 = x_2418;
  u_xlat0.z = x_2426;
  let x_2428 : f32 = u_xlat21;
  let x_2433 : vec4<f32> = u_xlat0;
  let x_2435 : vec3<f32> = ((vec3<f32>(x_2428, x_2428, x_2428) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2433.x, x_2433.y, x_2433.z));
  let x_2436 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2435.x, x_2435.y, x_2435.z, x_2436.w);
  let x_2438 : vec4<f32> = u_xlat0;
  let x_2440 : vec3<f32> = (vec3<f32>(x_2438.x, x_2438.y, x_2438.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2441 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2440.x, x_2440.y, x_2440.z, x_2441.w);
  let x_2443 : vec4<f32> = u_xlat0;
  let x_2445 : vec3<f32> = (vec3<f32>(x_2443.x, x_2443.y, x_2443.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2446 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2445.x, x_2445.y, x_2445.z, x_2446.w);
  let x_2448 : vec4<f32> = u_xlat2;
  let x_2450 : vec3<f32> = (vec3<f32>(x_2448.x, x_2448.y, x_2448.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2451 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2450.x, x_2450.y, x_2450.z, x_2451.w);
  let x_2453 : vec4<f32> = u_xlat2;
  let x_2456 : vec3<f32> = log2(abs(vec3<f32>(x_2453.x, x_2453.y, x_2453.z)));
  let x_2457 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2456.x, x_2456.y, x_2456.z, x_2457.w);
  let x_2459 : vec4<f32> = u_xlat2;
  let x_2461 : vec3<f32> = (vec3<f32>(x_2459.x, x_2459.y, x_2459.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2462 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2461.x, x_2461.y, x_2461.z, x_2462.w);
  let x_2464 : vec4<f32> = u_xlat2;
  let x_2466 : vec3<f32> = exp2(vec3<f32>(x_2464.x, x_2464.y, x_2464.z));
  let x_2467 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2466.x, x_2466.y, x_2466.z, x_2467.w);
  let x_2469 : vec4<f32> = u_xlat0;
  let x_2471 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2469.x, x_2469.y, x_2469.z, x_2469.x));
  u_xlatb0 = vec3<bool>(x_2471.x, x_2471.y, x_2471.z);
  let x_2474 : bool = u_xlatb0.x;
  if (x_2474) {
    let x_2479 : f32 = u_xlat1.x;
    x_2475 = x_2479;
  } else {
    let x_2482 : f32 = u_xlat2.x;
    x_2475 = x_2482;
  }
  let x_2483 : f32 = x_2475;
  u_xlat0.x = x_2483;
  let x_2486 : bool = u_xlatb0.y;
  if (x_2486) {
    let x_2491 : f32 = u_xlat1.y;
    x_2487 = x_2491;
  } else {
    let x_2494 : f32 = u_xlat2.y;
    x_2487 = x_2494;
  }
  let x_2495 : f32 = x_2487;
  u_xlat0.y = x_2495;
  let x_2498 : bool = u_xlatb0.z;
  if (x_2498) {
    let x_2503 : f32 = u_xlat1.z;
    x_2499 = x_2503;
  } else {
    let x_2506 : f32 = u_xlat2.z;
    x_2499 = x_2506;
  }
  let x_2507 : f32 = x_2499;
  u_xlat0.z = x_2507;
  let x_2511 : vec4<f32> = u_xlat0;
  let x_2513 : vec3<f32> = max(vec3<f32>(x_2511.x, x_2511.y, x_2511.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2514 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2513.x, x_2513.y, x_2513.z, x_2514.w);
  SV_Target0.w = 1.0f;
  return;
}
