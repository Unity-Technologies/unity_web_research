...
fn main_1() {
  ...
  let x_2213 : vec3<f32> = ((vec3<f32>(x_2207.x, x_2207.x, x_2207.x) * vec3<f32>(x_2209.x, x_2209.y, x_2209.z)) + x_2212);
  let x_2214 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2213.x, x_2213.y, x_2213.z, x_2214.w);
  SV_Target0.w = 1.0f;
  return;
}
