...
fn main_1() {
  ...
  u_xlat0.x = (x_115 * 0.00389105058275163174f);
  ...
  u_xlat0.x = ((x_135 * 0.00389105058275163174f) + x_138);
  let x_142 : f32 = u_xlat0.x;
  u_xlat0.x = max(x_142, 0.0f);
  let x_146 : f32 = u_xlat0.x;
  u_xlat0.x = min(x_146, 0.49997711181640625f);
  ...
  let x_182 : vec2<f32> = (x_179 * vec2<f32>(0.0039215688593685627f, 0.0039215688593685627f));
