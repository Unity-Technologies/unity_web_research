...
layout(set = 0, binding = 0) uniform mediump texture2D Texture2D_8BA53EED;
...
vec3 u_xlat2;
float u_xlat6;
layout(set = 0, binding = 1) uniform mediump  sampler samplerTexture2D_8BA53EED;
void main()
{
    ...
    u_xlat1.xyz = texture(sampler2D(Texture2D_8BA53EED, samplerTexture2D_8BA53EED), vs_INTERP1.xy, _GlobalMipBias.x).xyw;
    ...
    u_xlat0.xyz = vec3(u_xlat6) * vs_INTERP2.xyz + u_xlat0.xyz;
