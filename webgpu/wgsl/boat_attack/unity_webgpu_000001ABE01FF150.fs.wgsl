...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1223.x, x_1223.y, x_1223.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1226 : vec4<f32> = u_xlat0;
  let x_1229 : vec3<f32> = log2(abs(vec3<f32>(x_1226.x, x_1226.y, x_1226.z)));
  let x_1230 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1229.x, x_1229.y, x_1229.z, x_1230.w);
  let x_1232 : vec4<f32> = u_xlat2;
  let x_1234 : vec3<f32> = (vec3<f32>(x_1232.x, x_1232.y, x_1232.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1245 : vec3<f32> = ((vec3<f32>(x_1242.x, x_1242.y, x_1242.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1246 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1245.x, x_1245.y, x_1245.z, x_1246.w);
  let x_1248 : vec4<f32> = u_xlat0;
  let x_1250 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1248.x, x_1248.y, x_1248.z, x_1248.x));
  u_xlatb0 = vec3<bool>(x_1250.x, x_1250.y, x_1250.z);
  let x_1255 : bool = u_xlatb0.x;
  if (x_1255) {
