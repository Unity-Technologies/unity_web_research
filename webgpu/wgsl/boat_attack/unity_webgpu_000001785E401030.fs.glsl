...
;
    ...
    u_xlat2.xyz = vec3(u_xlat41) * u_xlat2.xyz + u_xlat0.xyz;
    ...
    u_xlat41 = dot(u_xlat20.xy, u_xlat20.xy);
    ...
    u_xlatb21.z = unity_WorldTransformParams.w>=0.0;
    u_xlat21.x = (u_xlatb21.x) ? float(1.0) : float(-1.0);
    u_xlat21.z = (u_xlatb21.z) ? float(1.0) : float(-1.0);
    ...
    u_xlat3.xyz = u_xlat20.yyy * u_xlat3.xyz;
    u_xlat3.xyz = u_xlat20.xxx * vs_INTERP2.xyz + u_xlat3.xyz;
    u_xlat21.xyz = vec3(u_xlat41) * vs_INTERP1.xyz + u_xlat3.xyz;
    ...
    u_xlat4.x = (u_xlatb20) ? u_xlat3.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb20) ? u_xlat3.y : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb20) ? u_xlat3.z : unity_MatrixV[2].z;
    ...
    u_xlat20.x = dot(u_xlat21.xyz, u_xlat3.xyz);
    u_xlat20.x = u_xlat20.x + 0.5;
    u_xlat3.xyz = u_xlat20.xxx * u_xlat5.xyz;
    u_xlat20.x = max(u_xlat3.w, 9.99999975e-05);
    u_xlat3.xyz = u_xlat3.xyz / u_xlat20.xxx;
    u_xlat20.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat5.xy = u_xlat20.xy * hlslcc_FragCoord.xy;
    u_xlat20.x = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat20.x) + 1.0;
    u_xlat20.x = (-u_xlat0.x) * 0.959999979 + 0.959999979;
    u_xlat40 = (-u_xlat20.x) + u_xlat1.x;
    u_xlat6.xyz = u_xlat20.xxx * u_xlat2.xyz;
    ...
    u_xlat60 = min(u_xlat0.w, u_xlat63);
    ...
    u_xlat65 = dot((-u_xlat4.xyz), u_xlat21.xyz);
    u_xlat65 = u_xlat65 + u_xlat65;
    u_xlat7.xyz = u_xlat21.xyz * (-vec3(u_xlat65)) + (-u_xlat4.xyz);
    u_xlat65 = dot(u_xlat21.xyz, u_xlat4.xyz);
    u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
    u_xlat65 = (-u_xlat65) + 1.0;
    u_xlat65 = u_xlat65 * u_xlat65;
    u_xlat65 = u_xlat65 * u_xlat65;
    u_xlat66 = (-u_xlat0.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat0.xy = u_xlat20.xx * u_xlat20.xx + vec2(-1.0, 1.0);
    u_xlat20.x = float(1.0) / u_xlat0.y;
    u_xlat8.xyz = (-u_xlat2.xyz) + vec3(u_xlat40);
    u_xlat8.xyz = vec3(u_xlat65) * u_xlat8.xyz + u_xlat2.xyz;
    u_xlat8.xyz = u_xlat20.xxx * u_xlat8.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat3.xyz = u_xlat3.xyz * u_xlat6.xyz + u_xlat7.xyz;
    u_xlat20.x = u_xlat63 * unity_LightData.z;
    u_xlat40 = dot(u_xlat21.xyz, _MainLightPosition.xyz);
    ...
    u_xlat20.x = dot(u_xlat21.xyz, u_xlat7.xyz);
    u_xlat20.x = clamp(u_xlat20.x, 0.0, 1.0);
    u_xlat20.y = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    ...
    u_xlat20.x = u_xlat40 * u_xlat20.x;
    u_xlat20.x = u_xlat62 * u_xlat20.x;
    u_xlat20.x = u_xlat1.x / u_xlat20.x;
    u_xlat7.xyz = u_xlat2.xyz * u_xlat20.xxx + u_xlat6.xyz;
    u_xlat5.xyz = u_xlat5.xyz * u_xlat7.xyz;
    u_xlat20.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu20 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu63)].www + _AdditionalLightsPosition[int(u_xlatu63)].xyz;
        ...
        if(u_xlati47 != 0) {
            ...
            u_xlati68 = int(u_xlatu63) << (2 & int(0x1F));
            if(u_xlati67 != 0) {
                u_xlat11.xyz = vs_INTERP0.yyy * _AdditionalLightsWorldToLights[(u_xlati68 + 1) / 4][(u_xlati68 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati68 / 4][u_xlati68 % 4].xyw * vs_INTERP0.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati68 + 2) / 4][(u_xlati68 + 2) % 4].xyw * vs_INTERP0.zzz + u_xlat11.xyz;
                u_xlat11.xyz = u_xlat11.xyz + _AdditionalLightsWorldToLights[(u_xlati68 + 3) / 4][(u_xlati68 + 3) % 4].xyw;
                ...
                if(u_xlati47 != 0) {
                    u_xlat47.xy = vs_INTERP0.yy * _AdditionalLightsWorldToLights[(u_xlati68 + 1) / 4][(u_xlati68 + 1) % 4].xy;
                    u_xlat47.xy = _AdditionalLightsWorldToLights[u_xlati68 / 4][u_xlati68 % 4].xy * vs_INTERP0.xx + u_xlat47.xy;
                    u_xlat47.xy = _AdditionalLightsWorldToLights[(u_xlati68 + 2) / 4][(u_xlati68 + 2) % 4].xy * vs_INTERP0.zz + u_xlat47.xy;
                    u_xlat47.xy = u_xlat47.xy + _AdditionalLightsWorldToLights[(u_xlati68 + 3) / 4][(u_xlati68 + 3) % 4].xy;
                    ...
                    u_xlat12 = vs_INTERP0.yyyy * _AdditionalLightsWorldToLights[(u_xlati68 + 1) / 4][(u_xlati68 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati68 / 4][u_xlati68 % 4] * vs_INTERP0.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati68 + 2) / 4][(u_xlati68 + 2) % 4] * vs_INTERP0.zzzz + u_xlat12;
                    u_xlat12 = u_xlat12 + _AdditionalLightsWorldToLights[(u_xlati68 + 3) / 4][(u_xlati68 + 3) % 4];
        ...
        u_xlat63 = dot(u_xlat21.xyz, u_xlat10.xyz);
        ...
        u_xlat63 = dot(u_xlat21.xyz, u_xlat9.xyz);
        u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
        u_xlat65 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
        u_xlat63 = u_xlat63 * u_xlat63;
        u_xlat63 = u_xlat63 * u_xlat0.x + 1.00001001;
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat63 = u_xlat63 * u_xlat63;
        ...
        u_xlat9.xyz = u_xlat2.xyz * vec3(u_xlat63) + u_xlat6.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat60) + u_xlat5.xyz;
