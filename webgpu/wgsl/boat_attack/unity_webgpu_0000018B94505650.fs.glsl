...
;
    ...
    u_xlat6.xyz = vs_INTERP8.yyy * _MainLightWorldToShadow[(u_xlati78 + 1) / 4][(u_xlati78 + 1) % 4].xyz;
    u_xlat6.xyz = _MainLightWorldToShadow[u_xlati78 / 4][u_xlati78 % 4].xyz * vs_INTERP8.xxx + u_xlat6.xyz;
    u_xlat6.xyz = _MainLightWorldToShadow[(u_xlati78 + 2) / 4][(u_xlati78 + 2) % 4].xyz * vs_INTERP8.zzz + u_xlat6.xyz;
    u_xlat6.xyz = u_xlat6.xyz + _MainLightWorldToShadow[(u_xlati78 + 3) / 4][(u_xlati78 + 3) % 4].xyz;
    ...
    u_xlatb84 = u_xlat6.z>=1.0;
    u_xlatb82 = u_xlatb82 || u_xlatb84;
    u_xlat79 = (u_xlatb82) ? 1.0 : u_xlat79;
    u_xlat0.x = dot(u_xlat0.xyz, (-_MainLightPosition.xyz));
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat7.xyz = vec3(u_xlat79) * _MainLightColor.xyz;
    ...
    u_xlat54 = max(u_xlat7.w, 9.99999975e-05);
    ...
    u_xlat84 = u_xlat81 * u_xlat81;
    u_xlat5.x = u_xlat5.x + 0.0400000215;
    u_xlat5.x = min(u_xlat5.x, 1.0);
    u_xlat7.x = u_xlat81 * 4.0 + 2.0;
    ...
    if(u_xlatb78){
        ...
        if(u_xlatb78){
            ...
            if(u_xlatb59){
                u_xlat59.xy = u_xlat6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat59.xy = floor(u_xlat59.xy);
                u_xlat8.xy = u_xlat6.xy * _MainLightShadowmapSize.zw + (-u_xlat59.xy);
                ...
                vec3 txVec49 = vec3(u_xlat66.xy,u_xlat6.z);
                ...
                vec3 txVec53 = vec3(u_xlat35.xy,u_xlat6.z);
                ...
                vec3 txVec57 = vec3(u_xlat63.xy,u_xlat6.z);
                ...
                vec3 txVec58 = vec3(u_xlat59.xy,u_xlat6.z);
    ...
    u_xlat78 = (u_xlatb82) ? 1.0 : u_xlat78;
    u_xlat6.xyz = vs_INTERP8.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat80 = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat82 = u_xlat80 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    u_xlat6.x = (-u_xlat78) + 1.0;
    u_xlat78 = u_xlat82 * u_xlat6.x + u_xlat78;
    u_xlat82 = dot((-u_xlat1.xyz), u_xlat3.xyz);
    u_xlat82 = u_xlat82 + u_xlat82;
    u_xlat6.xyz = u_xlat3.xyz * (-vec3(u_xlat82)) + (-u_xlat1.xyz);
    u_xlat82 = dot(u_xlat3.xyz, u_xlat1.xyz);
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    u_xlat82 = (-u_xlat82) + 1.0;
    u_xlat82 = u_xlat82 * u_xlat82;
    u_xlat82 = u_xlat82 * u_xlat82;
    u_xlat59.x = (-u_xlat54) * 0.699999988 + 1.70000005;
    u_xlat54 = u_xlat54 * u_xlat59.x;
    u_xlat54 = u_xlat54 * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat54);
    ...
    u_xlat6.xyz = u_xlat8.xyz * vec3(u_xlat54);
    u_xlat59.xy = vec2(u_xlat81) * vec2(u_xlat81) + vec2(-1.0, 1.0);
    u_xlat54 = float(1.0) / u_xlat59.y;
    u_xlat81 = u_xlat5.x + -0.0399999991;
    u_xlat81 = u_xlat82 * u_xlat81 + 0.0399999991;
    u_xlat54 = u_xlat54 * u_xlat81;
    u_xlat6.xyz = vec3(u_xlat54) * u_xlat6.xyz;
    u_xlat5.xyz = u_xlat31.xyz * u_xlat4.xyz + u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = vec3(u_xlat81) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat1.xyz = u_xlat5.xyz * vec3(u_xlat33) + u_xlat6.xyz;
