...
fn main_1() {
  ...
  let x_1497 : vec2<f32> = vs_TEXCOORD0;
  let x_1500 : vec4<f32> = x_26.x_Grain_TilingParams;
  let x_1504 : vec4<f32> = x_26.x_Grain_TilingParams;
  let x_1506 : vec2<f32> = ((x_1497 * vec2<f32>(x_1500.x, x_1500.y)) + vec2<f32>(x_1504.z, x_1504.w));
  let x_1507 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1506.x, x_1506.y, x_1507.z, x_1507.w);
  let x_1514 : vec4<f32> = u_xlat1;
  let x_1517 : f32 = x_26.x_GlobalMipBias.x;
  let x_1518 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1514.x, x_1514.y), x_1517);
  u_xlat15 = x_1518.w;
  let x_1520 : f32 = u_xlat15;
  u_xlat15 = (x_1520 + -0.5f);
  let x_1522 : f32 = u_xlat15;
  let x_1523 : f32 = u_xlat15;
  u_xlat15 = (x_1522 + x_1523);
  let x_1525 : vec3<f32> = u_xlat0;
  u_xlat1.x = dot(x_1525, vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1533 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1533);
  let x_1538 : f32 = x_26.x_Grain_Params.y;
  let x_1540 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1538 * -(x_1540)) + 1.0f);
  let x_1545 : f32 = u_xlat15;
  let x_1547 : vec3<f32> = u_xlat0;
  u_xlat6 = (vec3<f32>(x_1545, x_1545, x_1545) * x_1547);
  let x_1549 : vec3<f32> = u_xlat6;
  let x_1552 : vec2<f32> = x_26.x_Grain_Params;
  u_xlat6 = (x_1549 * vec3<f32>(x_1552.x, x_1552.x, x_1552.x));
  let x_1555 : vec3<f32> = u_xlat6;
  let x_1556 : vec4<f32> = u_xlat1;
  let x_1559 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1555 * vec3<f32>(x_1556.x, x_1556.x, x_1556.x)) + x_1559);
  let x_1561 : vec3<f32> = u_xlat0;
  let x_1562 : vec3<f32> = (x_1561 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1563 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1562.x, x_1562.y, x_1562.z, x_1563.w);
  let x_1565 : vec3<f32> = u_xlat0;
  let x_1567 : vec3<f32> = log2(abs(x_1565));
  let x_1568 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1567.x, x_1567.y, x_1567.z, x_1568.w);
  let x_1570 : vec4<f32> = u_xlat2;
  let x_1572 : vec3<f32> = (vec3<f32>(x_1570.x, x_1570.y, x_1570.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1583 : vec3<f32> = ((vec3<f32>(x_1580.x, x_1580.y, x_1580.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1584 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1583.x, x_1583.y, x_1583.z, x_1584.w);
  let x_1586 : vec3<f32> = u_xlat0;
  let x_1588 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1586.x, x_1586.y, x_1586.z, x_1586.x));
  u_xlatb0 = vec3<bool>(x_1588.x, x_1588.y, x_1588.z);
  let x_1591 : bool = u_xlatb0.x;
  if (x_1591) {
  ...
  u_xlat0.x = x_1600;
  let x_1603 : bool = u_xlatb0.y;
  if (x_1603) {
    let x_1608 : f32 = u_xlat1.y;
    x_1604 = x_1608;
  } else {
    let x_1611 : f32 = u_xlat2.y;
    x_1604 = x_1611;
  }
  let x_1612 : f32 = x_1604;
  u_xlat0.y = x_1612;
  let x_1615 : bool = u_xlatb0.z;
  if (x_1615) {
    let x_1620 : f32 = u_xlat1.z;
    x_1616 = x_1620;
  } else {
  ...
  u_xlat0.z = x_1624;
  let x_1626 : vec2<f32> = vs_TEXCOORD0;
  let x_1629 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1633 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1635 : vec2<f32> = ((x_1626 * vec2<f32>(x_1629.x, x_1629.y)) + vec2<f32>(x_1633.z, x_1633.w));
  let x_1636 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1635.x, x_1635.y, x_1636.z, x_1636.w);
  let x_1643 : vec4<f32> = u_xlat1;
  let x_1646 : f32 = x_26.x_GlobalMipBias.x;
  let x_1647 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1643.x, x_1643.y), x_1646);
  u_xlat15 = x_1647.w;
  let x_1649 : f32 = u_xlat15;
  u_xlat15 = ((x_1649 * 2.0f) + -1.0f);
  let x_1652 : f32 = u_xlat15;
  u_xlatb1 = (x_1652 >= 0.0f);
  let x_1654 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1654);
  let x_1657 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1657)) + 1.0f);
  let x_1661 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1661);
  let x_1663 : f32 = u_xlat15;
  u_xlat15 = (-(x_1663) + 1.0f);
  let x_1666 : f32 = u_xlat15;
  let x_1668 : f32 = u_xlat1.x;
  u_xlat15 = (x_1666 * x_1668);
  let x_1670 : vec3<f32> = u_xlat0;
  let x_1671 : vec3<f32> = (x_1670 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1672 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1671.x, x_1671.y, x_1671.z, x_1672.w);
  let x_1674 : vec3<f32> = u_xlat0;
  let x_1676 : vec3<f32> = log2(abs(x_1674));
  let x_1677 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1676.x, x_1676.y, x_1676.z, x_1677.w);
  let x_1679 : vec4<f32> = u_xlat2;
  let x_1681 : vec3<f32> = (vec3<f32>(x_1679.x, x_1679.y, x_1679.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1692 : vec3<f32> = ((vec3<f32>(x_1689.x, x_1689.y, x_1689.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1693 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1692.x, x_1692.y, x_1692.z, x_1693.w);
  let x_1695 : vec3<f32> = u_xlat0;
  let x_1697 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1695.x, x_1695.y, x_1695.z, x_1695.x));
  ...
  u_xlat0 = ((vec3<f32>(x_1735, x_1735, x_1735) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1740);
  let x_1742 : vec3<f32> = u_xlat0;
  let x_1743 : vec3<f32> = (x_1742 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1744 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1743.x, x_1743.y, x_1743.z, x_1744.w);
  let x_1746 : vec3<f32> = u_xlat0;
  let x_1747 : vec3<f32> = (x_1746 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1748 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1747.x, x_1747.y, x_1747.z, x_1748.w);
  let x_1750 : vec4<f32> = u_xlat2;
  let x_1752 : vec3<f32> = (vec3<f32>(x_1750.x, x_1750.y, x_1750.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1753 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1752.x, x_1752.y, x_1752.z, x_1753.w);
  let x_1755 : vec4<f32> = u_xlat2;
  let x_1758 : vec3<f32> = log2(abs(vec3<f32>(x_1755.x, x_1755.y, x_1755.z)));
  let x_1759 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1758.x, x_1758.y, x_1758.z, x_1759.w);
  let x_1761 : vec4<f32> = u_xlat2;
  let x_1763 : vec3<f32> = (vec3<f32>(x_1761.x, x_1761.y, x_1761.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1764 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1763.x, x_1763.y, x_1763.z, x_1764.w);
  let x_1766 : vec4<f32> = u_xlat2;
  let x_1768 : vec3<f32> = exp2(vec3<f32>(x_1766.x, x_1766.y, x_1766.z));
  let x_1769 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1768.x, x_1768.y, x_1768.z, x_1769.w);
  let x_1771 : vec3<f32> = u_xlat0;
  let x_1773 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1771.x, x_1771.y, x_1771.z, x_1771.x));
  u_xlatb0 = vec3<bool>(x_1773.x, x_1773.y, x_1773.z);
  let x_1776 : bool = u_xlatb0.x;
  if (x_1776) {
    let x_1781 : f32 = u_xlat1.x;
    x_1777 = x_1781;
  } else {
    let x_1784 : f32 = u_xlat2.x;
    x_1777 = x_1784;
  }
  let x_1785 : f32 = x_1777;
  u_xlat0.x = x_1785;
  let x_1788 : bool = u_xlatb0.y;
  if (x_1788) {
    let x_1793 : f32 = u_xlat1.y;
    x_1789 = x_1793;
  } else {
    let x_1796 : f32 = u_xlat2.y;
    x_1789 = x_1796;
  }
  let x_1797 : f32 = x_1789;
  u_xlat0.y = x_1797;
  let x_1800 : bool = u_xlatb0.z;
  if (x_1800) {
    let x_1805 : f32 = u_xlat1.z;
    x_1801 = x_1805;
  } else {
  ...
  let x_1814 : vec3<f32> = max(x_1813, vec3<f32>(0.0f, 0.0f, 0.0f));
