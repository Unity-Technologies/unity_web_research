...
layout(set = 1, binding = 3, std140) uniform UnityDrawCallInfo {
	int unity_BaseInstanceID;
	int unity_InstanceCount;
};
layout(set = 1, binding = 4, std140) uniform _Terrain {
	float _NormalScale0;
	float _NormalScale1;
	float _NormalScale2;
	float _NormalScale3;
...
layout(set = 0, binding = 2) uniform mediump texture2D _TerrainHeightmapTexture;
layout(set = 0, binding = 3) uniform mediump texture2D _TerrainNormalmapTexture;
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat6.xxx * unity_ObjectToWorld[1].xyz;
    u_xlat6.xy = u_xlat0.xy * _TerrainHeightmapScale.xz;
    vs_TEXCOORD0.xy = u_xlat0.xy * _TerrainHeightmapRecipSize.zw;
    u_xlat0.xyz = unity_ObjectToWorld[0].xyz * u_xlat6.xxx + u_xlat2.xyz;
    u_xlat0.xyz = unity_ObjectToWorld[2].xyz * u_xlat6.yyy + u_xlat0.xyz;
