...
@group(1) @binding(5) var<uniform> x_205 : VGlobals;
...
fn main_1() {
  ...
  let x_207 : vec4<f32> = x_205.unity_MatrixVP[1i];
  u_xlat1 = (vec4<f32>(x_201.y, x_201.y, x_201.y, x_201.y) * x_207);
  let x_210 : vec4<f32> = x_205.unity_MatrixVP[0i];
  let x_211 : vec4<f32> = u_xlat0;
  let x_214 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_210 * vec4<f32>(x_211.x, x_211.x, x_211.x, x_211.x)) + x_214);
  let x_217 : vec4<f32> = x_205.unity_MatrixVP[2i];
  let x_218 : vec4<f32> = u_xlat0;
  let x_221 : vec4<f32> = u_xlat1;
  u_xlat0 = ((x_217 * vec4<f32>(x_218.z, x_218.z, x_218.z, x_218.z)) + x_221);
  let x_227 : vec4<f32> = u_xlat0;
  let x_229 : vec4<f32> = x_205.unity_MatrixVP[3i];
