...
void main()
{
    ...
    if(u_xlatb12){
        ...
        u_xlat0.xyw = _NonJitteredViewProjMatrix[0].xyw * u_xlat0.xxx + u_xlat3.xyz;
        ...
        u_xlat0 = u_xlat2.yyyy * unity_MatrixPreviousM[1];
        u_xlat0 = unity_MatrixPreviousM[0] * u_xlat2.xxxx + u_xlat0;
        u_xlat0 = unity_MatrixPreviousM[2] * u_xlat2.zzzz + u_xlat0;
        u_xlat0 = u_xlat0 + unity_MatrixPreviousM[3];
        u_xlat2.xyz = u_xlat0.yyy * _PrevViewProjMatrix[1].xyw;
        u_xlat2.xyz = _PrevViewProjMatrix[0].xyw * u_xlat0.xxx + u_xlat2.xyz;
        u_xlat0.xyz = _PrevViewProjMatrix[2].xyw * u_xlat0.zzz + u_xlat2.xyz;
