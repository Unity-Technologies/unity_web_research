...
void main()
{
    ...
    u_xlat6.x = (u_xlatb27.x) ? u_xlat29.x : unity_MatrixV[0].z;
    u_xlat6.y = (u_xlatb27.x) ? u_xlat29.y : unity_MatrixV[1].z;
    u_xlat6.z = (u_xlatb27.x) ? u_xlat29.z : unity_MatrixV[2].z;
    u_xlat5.w = 1.0;
    ...
    u_xlat27.x = u_xlat5.y * u_xlat5.y;
    u_xlat27.x = u_xlat5.x * u_xlat5.x + (-u_xlat27.x);
    u_xlat29.xyz = unity_SHC.xyz * u_xlat27.xxx + u_xlat9.xyz;
    u_xlat29.xyz = u_xlat29.xyz + u_xlat7.xyz;
    ...
    u_xlat30.x = u_xlat79 * 4.0 + 2.0;
    u_xlat56 = min(vs_INTERP6.w, 1.0);
    if(u_xlatb78){
        ...
        if(u_xlatb78){
            ...
            if(u_xlatb82){
                ...
                u_xlat78 = u_xlat82 * u_xlat84 + u_xlat83;
            } else {
                u_xlat7.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat59.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec44, 0.0);
                u_xlat83 = u_xlat83 * u_xlat18.y;
                u_xlat82 = u_xlat18.x * u_xlat82 + u_xlat83;
                vec3 txVec45 = vec3(u_xlat59.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec45, 0.0);
                u_xlat82 = u_xlat18.z * u_xlat83 + u_xlat82;
                vec3 txVec46 = vec3(u_xlat16.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec46, 0.0);
                u_xlat82 = u_xlat18.w * u_xlat83 + u_xlat82;
                vec3 txVec47 = vec3(u_xlat14.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec47, 0.0);
                u_xlat82 = u_xlat19.x * u_xlat83 + u_xlat82;
                vec3 txVec48 = vec3(u_xlat14.zw,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec48, 0.0);
                u_xlat82 = u_xlat19.y * u_xlat83 + u_xlat82;
                vec3 txVec49 = vec3(u_xlat15.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec49, 0.0);
                u_xlat82 = u_xlat19.z * u_xlat83 + u_xlat82;
                vec3 txVec50 = vec3(u_xlat16.zw,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec50, 0.0);
                u_xlat82 = u_xlat19.w * u_xlat83 + u_xlat82;
                vec3 txVec51 = vec3(u_xlat17.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec51, 0.0);
                u_xlat82 = u_xlat20.x * u_xlat83 + u_xlat82;
                vec3 txVec52 = vec3(u_xlat17.zw,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec52, 0.0);
                u_xlat82 = u_xlat20.y * u_xlat83 + u_xlat82;
                vec3 txVec53 = vec3(u_xlat35.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec53, 0.0);
                u_xlat82 = u_xlat20.z * u_xlat83 + u_xlat82;
                vec3 txVec54 = vec3(u_xlat67.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec54, 0.0);
                u_xlat82 = u_xlat20.w * u_xlat83 + u_xlat82;
                vec3 txVec55 = vec3(u_xlat12.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec55, 0.0);
                u_xlat82 = u_xlat8.x * u_xlat83 + u_xlat82;
                vec3 txVec56 = vec3(u_xlat12.zw,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec56, 0.0);
                u_xlat82 = u_xlat8.y * u_xlat83 + u_xlat82;
                vec3 txVec57 = vec3(u_xlat62.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec57, 0.0);
                u_xlat82 = u_xlat8.z * u_xlat83 + u_xlat82;
                vec3 txVec58 = vec3(u_xlat7.xy,vs_INTERP3.z);
                u_xlat83 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec58, 0.0);
                u_xlat78 = u_xlat8.w * u_xlat83 + u_xlat82;
            }
        }
    } else {
    ...
    u_xlatb82 = vs_INTERP3.z>=1.0;
    u_xlatb4 = u_xlatb82 || u_xlatb4;
    u_xlat78 = (u_xlatb4) ? 1.0 : u_xlat78;
    u_xlat7.xyz = vs_INTERP8.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat4.x = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat82 = u_xlat4.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    u_xlat83 = (-u_xlat78) + 1.0;
    u_xlat78 = u_xlat82 * u_xlat83 + u_xlat78;
    u_xlat82 = dot((-u_xlat6.xyz), u_xlat5.xyz);
    u_xlat82 = u_xlat82 + u_xlat82;
    u_xlat7.xyz = u_xlat5.xyz * (-vec3(u_xlat82)) + (-u_xlat6.xyz);
    u_xlat82 = dot(u_xlat5.xyz, u_xlat6.xyz);
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    ...
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat27.x);
    u_xlat27.x = u_xlat7.w + -1.0;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
        u_xlat82 = u_xlat82 * u_xlat84;
        u_xlat11.xyz = vec3(u_xlat82) * _AdditionalLightsColor[u_xlati4].xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat83) + u_xlat6.xyz;
        u_xlat4.x = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat4.x = max(u_xlat4.x, 1.17549435e-38);
        u_xlat4.x = inversesqrt(u_xlat4.x);
        u_xlat9.xyz = u_xlat4.xxx * u_xlat9.xyz;
        u_xlat4.x = dot(u_xlat5.xyz, u_xlat9.xyz);
