...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat22 = u_xlat0.w * vs_TEXCOORD7.w + (-_Cutoff);
    u_xlat44 = dFdxCoarse(u_xlat1.w);
    u_xlat66 = dFdyCoarse(u_xlat1.w);
...
;
    ...
    if(u_xlatb66){
        ...
        if(u_xlatb66){
            ...
            if(u_xlatb67){
                ...
                u_xlat66 = u_xlat67 * u_xlat69 + u_xlat68;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat49.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat67 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec13, 0.0);
                ...
                u_xlat67 = u_xlat16.x * u_xlat67 + u_xlat68;
                ...
                u_xlat67 = u_xlat16.z * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat16.w * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat17.x * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat17.y * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat17.z * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat17.w * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat18.x * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat18.y * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat6.x * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat6.y * u_xlat68 + u_xlat67;
                ...
                u_xlat67 = u_xlat6.z * u_xlat68 + u_xlat67;
                ...
                u_xlat66 = u_xlat6.w * u_xlat68 + u_xlat67;
            }
        }
    } else {
    ...
    u_xlat66 = u_xlat66 * _MainLightShadowParams.x + u_xlat67;
    u_xlatb67 = 0.0>=u_xlat3.z;
    ...
    u_xlat68 = u_xlat67 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    ...
    u_xlat67 = u_xlat67 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.xyz = (-vs_TEXCOORD2.xyz) * _AdditionalLightsPosition[u_xlati69].www + _AdditionalLightsPosition[u_xlati69].xyz;
        ...
        if(u_xlatb72){
            ...
            u_xlat7 = vs_TEXCOORD2.yyyy * _AdditionalLightsWorldToShadow[(u_xlati71 + 1) / 4][(u_xlati71 + 1) % 4];
            u_xlat7 = _AdditionalLightsWorldToShadow[u_xlati71 / 4][u_xlati71 % 4] * vs_TEXCOORD2.xxxx + u_xlat7;
            u_xlat7 = _AdditionalLightsWorldToShadow[(u_xlati71 + 2) / 4][(u_xlati71 + 2) % 4] * vs_TEXCOORD2.zzzz + u_xlat7;
        ...
        u_xlat71 = u_xlat67 * u_xlat72 + u_xlat71;
        u_xlat70 = u_xlat70 * u_xlat71;
    ...
    SV_Target0.w = (u_xlatb44) ? u_xlat22 : 1.0;
    return;
}
