...
void main()
{
    ...
    u_xlat3.xyz = u_xlat26.xyz * vec3(u_xlat54);
    ...
    u_xlat52.x = u_xlat3.y * u_xlat3.y;
    u_xlat52.x = u_xlat3.x * u_xlat3.x + (-u_xlat52.x);
    u_xlat6.xyz = unity_SHC.xyz * u_xlat52.xxx + u_xlat9.xyz;
    ...
    if(u_xlatb0){
        ...
        if(u_xlatb0){
            ...
            if(u_xlatb83){
                u_xlat7.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat59.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                vec3 txVec36 = vec3(u_xlat59.xy,vs_INTERP3.z);
                ...
                vec3 txVec38 = vec3(u_xlat12.xy,vs_INTERP3.z);
                ...
                vec3 txVec39 = vec3(u_xlat12.zw,vs_INTERP3.z);
                ...
                u_xlat0.x = u_xlat83 * u_xlat7.x + u_xlat84;
            } else {
                u_xlat7.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat59.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                u_xlat83 = u_xlat19.x * u_xlat84 + u_xlat83;
                ...
                u_xlat83 = u_xlat19.y * u_xlat84 + u_xlat83;
                vec3 txVec49 = vec3(u_xlat15.xy,vs_INTERP3.z);
                ...
                vec3 txVec50 = vec3(u_xlat16.zw,vs_INTERP3.z);
                ...
                vec3 txVec51 = vec3(u_xlat17.xy,vs_INTERP3.z);
                ...
                vec3 txVec52 = vec3(u_xlat17.zw,vs_INTERP3.z);
                ...
                vec3 txVec53 = vec3(u_xlat35.xy,vs_INTERP3.z);
                ...
                vec3 txVec54 = vec3(u_xlat67.xy,vs_INTERP3.z);
                ...
                u_xlat83 = u_xlat8.z * u_xlat84 + u_xlat83;
                vec3 txVec58 = vec3(u_xlat7.xy,vs_INTERP3.z);
                u_xlat84 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec58, 0.0);
                u_xlat0.x = u_xlat8.w * u_xlat84 + u_xlat83;
            }
        }
    } else {
    ...
    u_xlatb2.x = u_xlatb2.x || u_xlatb83;
    u_xlat0.x = (u_xlatb2.x) ? 1.0 : u_xlat0.x;
    u_xlat7.xyz = vs_INTERP8.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat2.x = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat83 = u_xlat2.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
    u_xlat84 = (-u_xlat0.x) + 1.0;
    u_xlat0.x = u_xlat83 * u_xlat84 + u_xlat0.x;
    u_xlatb83 = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb83){
        u_xlat7.xy = vs_INTERP8.yy * _MainLightWorldToLight[1].xy;
        u_xlat7.xy = _MainLightWorldToLight[0].xy * vs_INTERP8.xx + u_xlat7.xy;
        u_xlat7.xy = _MainLightWorldToLight[2].xy * vs_INTERP8.zz + u_xlat7.xy;
        ...
        u_xlat83 = (u_xlatb8.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb8.x) ? u_xlat7.xyz : vec3(u_xlat83);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat83 = dot((-u_xlat4.xyz), u_xlat3.xyz);
    u_xlat83 = u_xlat83 + u_xlat83;
    u_xlat8.xyz = u_xlat3.xyz * (-vec3(u_xlat83)) + (-u_xlat4.xyz);
    u_xlat83 = dot(u_xlat3.xyz, u_xlat4.xyz);
    u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
    ...
    u_xlat80 = u_xlat83 * u_xlat80 + 0.0399999991;
    ...
    u_xlat78 = dot(u_xlat3.xyz, _MainLightPosition.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlati88 != 0) {
            ...
            u_xlat88 = (u_xlatb2.w) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb2.x) ? u_xlat11.xyz : vec3(u_xlat88);
        } else {
        ...
        u_xlat85 = dot(u_xlat3.xyz, u_xlat10.xyz);
    ...
    u_xlat0.xzw = u_xlat5.xyz * vec3(u_xlat82) + u_xlat7.xyz;
