...
fn main_1() {
  ...
  u_xlat18 = (x_1267 + -0.5f);
  let x_1269 : f32 = u_xlat18;
  let x_1270 : f32 = u_xlat18;
  u_xlat18 = (x_1269 + x_1270);
  let x_1272 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1272.x, x_1272.y, x_1272.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  ...
  u_xlat7 = (vec3<f32>(x_1294, x_1294, x_1294) * vec3<f32>(x_1296.x, x_1296.y, x_1296.z));
  let x_1299 : vec3<f32> = u_xlat7;
  let x_1302 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat7 = (x_1299 * vec3<f32>(x_1302.x, x_1302.x, x_1302.x));
