...
@group(1) @binding(1) var<uniform> x_2030 : AdditionalLights;
...
fn main_1() {
  ...
  let x_1724 : vec4<f32> = x_44.x_MainLightColor;
  let x_1726 : vec3<f32> = (vec3<f32>(x_1721, x_1721, x_1721) * vec3<f32>(x_1724.x, x_1724.y, x_1724.z));
  let x_1727 : vec4<f32> = u_xlat6;
  u_xlat6 = vec4<f32>(x_1726.x, x_1726.y, x_1726.z, x_1727.w);
  let x_1729 : vec3<f32> = u_xlat21;
  let x_1731 : vec4<f32> = u_xlat2;
  u_xlat66 = dot(-(x_1729), vec3<f32>(x_1731.x, x_1731.y, x_1731.z));
  let x_1734 : f32 = u_xlat66;
  let x_1735 : f32 = u_xlat66;
  u_xlat66 = (x_1734 + x_1735);
  let x_1737 : vec4<f32> = u_xlat2;
  let x_1739 : f32 = u_xlat66;
  let x_1743 : vec3<f32> = u_xlat21;
  let x_1745 : vec3<f32> = ((vec3<f32>(x_1737.x, x_1737.y, x_1737.z) * -(vec3<f32>(x_1739, x_1739, x_1739))) + -(x_1743));
  ...
  u_xlat66 = dot(vec3<f32>(x_1748.x, x_1748.y, x_1748.z), x_1750);
  let x_1752 : f32 = u_xlat66;
  u_xlat66 = clamp(x_1752, 0.0f, 1.0f);
  let x_1754 : f32 = u_xlat66;
  u_xlat66 = (-(x_1754) + 1.0f);
  let x_1757 : f32 = u_xlat66;
  let x_1758 : f32 = u_xlat66;
  u_xlat66 = (x_1757 * x_1758);
  let x_1760 : f32 = u_xlat66;
  let x_1761 : f32 = u_xlat66;
  u_xlat66 = (x_1760 * x_1761);
  let x_1764 : f32 = u_xlat1;
  u_xlat67 = ((-(x_1764) * 0.699999988f) + 1.700000048f);
  let x_1770 : f32 = u_xlat1;
  let x_1771 : f32 = u_xlat67;
  u_xlat1 = (x_1770 * x_1771);
  let x_1773 : f32 = u_xlat1;
  u_xlat1 = (x_1773 * 6.0f);
  let x_1784 : vec4<f32> = u_xlat7;
  let x_1786 : f32 = u_xlat1;
  let x_1787 : vec4<f32> = textureSampleLevel(unity_SpecCube0, samplerunity_SpecCube0, vec3<f32>(x_1784.x, x_1784.y, x_1784.z), x_1786);
  u_xlat7 = x_1787;
  let x_1789 : f32 = u_xlat7.w;
  u_xlat1 = (x_1789 + -1.0f);
  let x_1792 : f32 = x_197.unity_SpecCube0_HDR.w;
  let x_1793 : f32 = u_xlat1;
  u_xlat1 = ((x_1792 * x_1793) + 1.0f);
  let x_1796 : f32 = u_xlat1;
  u_xlat1 = max(x_1796, 0.0f);
  let x_1798 : f32 = u_xlat1;
  u_xlat1 = log2(x_1798);
  let x_1800 : f32 = u_xlat1;
  let x_1802 : f32 = x_197.unity_SpecCube0_HDR.y;
  u_xlat1 = (x_1800 * x_1802);
  let x_1804 : f32 = u_xlat1;
  u_xlat1 = exp2(x_1804);
  let x_1806 : f32 = u_xlat1;
  let x_1808 : f32 = x_197.unity_SpecCube0_HDR.x;
  u_xlat1 = (x_1806 * x_1808);
  let x_1810 : vec4<f32> = u_xlat7;
  let x_1812 : f32 = u_xlat1;
  let x_1814 : vec3<f32> = (vec3<f32>(x_1810.x, x_1810.y, x_1810.z) * vec3<f32>(x_1812, x_1812, x_1812));
  let x_1815 : vec4<f32> = u_xlat7;
  u_xlat7 = vec4<f32>(x_1814.x, x_1814.y, x_1814.z, x_1815.w);
  let x_1817 : f32 = u_xlat62;
  let x_1819 : f32 = u_xlat62;
  let x_1823 : vec2<f32> = ((vec2<f32>(x_1817, x_1817) * vec2<f32>(x_1819, x_1819)) + vec2<f32>(-1.0f, 1.0f));
  let x_1824 : vec4<f32> = u_xlat8;
  u_xlat8 = vec4<f32>(x_1823.x, x_1823.y, x_1824.z, x_1824.w);
  let x_1827 : f32 = u_xlat8.y;
  u_xlat1 = (1.0f / x_1827);
  let x_1829 : vec4<f32> = u_xlat0;
  let x_1832 : f32 = u_xlat60;
  u_xlat28 = (-(vec3<f32>(x_1829.x, x_1829.y, x_1829.z)) + vec3<f32>(x_1832, x_1832, x_1832));
  let x_1835 : f32 = u_xlat66;
  let x_1837 : vec3<f32> = u_xlat28;
  let x_1839 : vec4<f32> = u_xlat0;
  u_xlat28 = ((vec3<f32>(x_1835, x_1835, x_1835) * x_1837) + vec3<f32>(x_1839.x, x_1839.y, x_1839.z));
  let x_1842 : f32 = u_xlat1;
  let x_1844 : vec3<f32> = u_xlat28;
  u_xlat28 = (vec3<f32>(x_1842, x_1842, x_1842) * x_1844);
  let x_1846 : vec4<f32> = u_xlat7;
  let x_1848 : vec3<f32> = u_xlat28;
  let x_1849 : vec3<f32> = (vec3<f32>(x_1846.x, x_1846.y, x_1846.z) * x_1848);
  ...
  u_xlat23 = ((x_1852 * vec3<f32>(x_1853.x, x_1853.y, x_1853.z)) + vec3<f32>(x_1856.x, x_1856.y, x_1856.z));
  let x_1859 : f32 = u_xlat65;
  let x_1862 : f32 = x_197.unity_LightData.z;
  u_xlat60 = (x_1859 * x_1862);
  let x_1864 : vec4<f32> = u_xlat2;
  let x_1867 : vec4<f32> = x_44.x_MainLightPosition;
  u_xlat1 = dot(vec3<f32>(x_1864.x, x_1864.y, x_1864.z), vec3<f32>(x_1867.x, x_1867.y, x_1867.z));
  let x_1870 : f32 = u_xlat1;
  u_xlat1 = clamp(x_1870, 0.0f, 1.0f);
  let x_1872 : f32 = u_xlat60;
  let x_1873 : f32 = u_xlat1;
  u_xlat60 = (x_1872 * x_1873);
  let x_1875 : f32 = u_xlat60;
  let x_1877 : vec4<f32> = u_xlat6;
  let x_1879 : vec3<f32> = (vec3<f32>(x_1875, x_1875, x_1875) * vec3<f32>(x_1877.x, x_1877.y, x_1877.z));
  ...
  let x_1886 : vec3<f32> = (x_1882 + vec3<f32>(x_1884.x, x_1884.y, x_1884.z));
  ...
  u_xlat60 = dot(vec3<f32>(x_1889.x, x_1889.y, x_1889.z), vec3<f32>(x_1891.x, x_1891.y, x_1891.z));
  let x_1894 : f32 = u_xlat60;
  u_xlat60 = max(x_1894, 1.17549435e-37f);
  let x_1897 : f32 = u_xlat60;
  u_xlat60 = inverseSqrt(x_1897);
  ...
  let x_1962 : vec3<f32> = (vec3<f32>(x_1958.x, x_1958.y, x_1958.z) * vec3<f32>(x_1960.x, x_1960.y, x_1960.z));
  let x_1963 : vec4<f32> = u_xlat6;
  u_xlat6 = vec4<f32>(x_1962.x, x_1962.y, x_1962.z, x_1963.w);
  let x_1966 : f32 = x_44.x_AdditionalLightsCount.x;
  let x_1968 : f32 = x_197.unity_LightData.y;
  u_xlat60 = min(x_1966, x_1968);
  let x_1972 : f32 = u_xlat60;
  u_xlatu60 = bitcast<u32>(i32(x_1972));
  u_xlat7.x = 0.0f;
  u_xlat7.y = 0.0f;
  u_xlat7.z = 0.0f;
  u_xlatu_loop_1 = 0u;
  loop {
    ...
    u_xlati65 = bitcast<i32>((x_1992 & 3u));
    let x_1995 : u32 = u_xlatu62;
    let x_1998 : vec4<f32> = x_197.unity_LightIndices[bitcast<i32>(x_1995)];
    let x_2008 : i32 = u_xlati65;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_2013 : vec4<u32> = indexable[x_2008];
    u_xlat62 = dot(x_1998, bitcast<vec4<f32>>(x_2013));
    let x_2017 : f32 = u_xlat62;
    u_xlati62 = i32(x_2017);
    let x_2019 : vec3<f32> = vs_TEXCOORD7;
    let x_2031 : i32 = u_xlati62;
    let x_2033 : vec4<f32> = x_2030.x_AdditionalLightsPosition[x_2031];
    let x_2036 : i32 = u_xlati62;
    let x_2038 : vec4<f32> = x_2030.x_AdditionalLightsPosition[x_2036];
    u_xlat28 = ((-(x_2019) * vec3<f32>(x_2033.w, x_2033.w, x_2033.w)) + vec3<f32>(x_2038.x, x_2038.y, x_2038.z));
    let x_2041 : vec3<f32> = u_xlat28;
    let x_2042 : vec3<f32> = u_xlat28;
    u_xlat65 = dot(x_2041, x_2042);
    let x_2044 : f32 = u_xlat65;
    u_xlat65 = max(x_2044, 6.10351562e-05f);
    let x_2047 : f32 = u_xlat65;
    u_xlat66 = inverseSqrt(x_2047);
    let x_2049 : f32 = u_xlat66;
    let x_2051 : vec3<f32> = u_xlat28;
    let x_2052 : vec3<f32> = (vec3<f32>(x_2049, x_2049, x_2049) * x_2051);
    let x_2053 : vec4<f32> = u_xlat9;
    u_xlat9 = vec4<f32>(x_2052.x, x_2052.y, x_2052.z, x_2053.w);
    let x_2055 : f32 = u_xlat65;
    u_xlat67 = (1.0f / x_2055);
    let x_2057 : f32 = u_xlat65;
    let x_2058 : i32 = u_xlati62;
    let x_2060 : f32 = x_2030.x_AdditionalLightsAttenuation[x_2058].x;
    u_xlat65 = (x_2057 * x_2060);
    let x_2062 : f32 = u_xlat65;
    let x_2064 : f32 = u_xlat65;
    u_xlat65 = ((-(x_2062) * x_2064) + 1.0f);
    let x_2067 : f32 = u_xlat65;
    u_xlat65 = max(x_2067, 0.0f);
    let x_2069 : f32 = u_xlat65;
    let x_2070 : f32 = u_xlat65;
    u_xlat65 = (x_2069 * x_2070);
    let x_2072 : f32 = u_xlat65;
    let x_2073 : f32 = u_xlat67;
    u_xlat65 = (x_2072 * x_2073);
    let x_2075 : i32 = u_xlati62;
    let x_2077 : vec4<f32> = x_2030.x_AdditionalLightsSpotDir[x_2075];
    let x_2079 : vec4<f32> = u_xlat9;
    u_xlat67 = dot(vec3<f32>(x_2077.x, x_2077.y, x_2077.z), vec3<f32>(x_2079.x, x_2079.y, x_2079.z));
    let x_2082 : f32 = u_xlat67;
    let x_2083 : i32 = u_xlati62;
    let x_2085 : f32 = x_2030.x_AdditionalLightsAttenuation[x_2083].z;
    let x_2087 : i32 = u_xlati62;
    let x_2089 : f32 = x_2030.x_AdditionalLightsAttenuation[x_2087].w;
    u_xlat67 = ((x_2082 * x_2085) + x_2089);
    let x_2091 : f32 = u_xlat67;
    u_xlat67 = clamp(x_2091, 0.0f, 1.0f);
    let x_2093 : f32 = u_xlat67;
    let x_2094 : f32 = u_xlat67;
    u_xlat67 = (x_2093 * x_2094);
    let x_2096 : f32 = u_xlat65;
    let x_2097 : f32 = u_xlat67;
    u_xlat65 = (x_2096 * x_2097);
    let x_2099 : f32 = u_xlat44;
    let x_2101 : i32 = u_xlati62;
    let x_2103 : vec4<f32> = x_2030.x_AdditionalLightsColor[x_2101];
    let x_2105 : vec3<f32> = (vec3<f32>(x_2099, x_2099, x_2099) * vec3<f32>(x_2103.x, x_2103.y, x_2103.z));
    let x_2106 : vec4<f32> = u_xlat10;
    u_xlat10 = vec4<f32>(x_2105.x, x_2105.y, x_2105.z, x_2106.w);
    let x_2108 : vec4<f32> = u_xlat2;
    let x_2110 : vec4<f32> = u_xlat9;
    u_xlat62 = dot(vec3<f32>(x_2108.x, x_2108.y, x_2108.z), vec3<f32>(x_2110.x, x_2110.y, x_2110.z));
    let x_2113 : f32 = u_xlat62;
    u_xlat62 = clamp(x_2113, 0.0f, 1.0f);
    let x_2115 : f32 = u_xlat62;
    let x_2116 : f32 = u_xlat65;
    u_xlat62 = (x_2115 * x_2116);
    ...
    let x_2129 : vec3<f32> = u_xlat21;
    u_xlat28 = ((x_2125 * vec3<f32>(x_2126, x_2126, x_2126)) + x_2129);
    let x_2131 : vec3<f32> = u_xlat28;
    let x_2132 : vec3<f32> = u_xlat28;
    u_xlat62 = dot(x_2131, x_2132);
    let x_2134 : f32 = u_xlat62;
    u_xlat62 = max(x_2134, 1.17549435e-37f);
    let x_2136 : f32 = u_xlat62;
    u_xlat62 = inverseSqrt(x_2136);
    let x_2138 : f32 = u_xlat62;
    let x_2140 : vec3<f32> = u_xlat28;
    u_xlat28 = (vec3<f32>(x_2138, x_2138, x_2138) * x_2140);
    let x_2142 : vec4<f32> = u_xlat2;
    let x_2144 : vec3<f32> = u_xlat28;
    u_xlat62 = dot(vec3<f32>(x_2142.x, x_2142.y, x_2142.z), x_2144);
    let x_2146 : f32 = u_xlat62;
    u_xlat62 = clamp(x_2146, 0.0f, 1.0f);
    let x_2148 : vec4<f32> = u_xlat9;
    let x_2150 : vec3<f32> = u_xlat28;
    u_xlat65 = dot(vec3<f32>(x_2148.x, x_2148.y, x_2148.z), x_2150);
    let x_2152 : f32 = u_xlat65;
    u_xlat65 = clamp(x_2152, 0.0f, 1.0f);
    let x_2154 : f32 = u_xlat62;
    let x_2155 : f32 = u_xlat62;
    u_xlat62 = (x_2154 * x_2155);
    let x_2157 : f32 = u_xlat62;
    let x_2159 : f32 = u_xlat8.x;
    u_xlat62 = ((x_2157 * x_2159) + 1.000010014f);
    let x_2162 : f32 = u_xlat65;
    let x_2163 : f32 = u_xlat65;
    u_xlat65 = (x_2162 * x_2163);
    let x_2165 : f32 = u_xlat62;
    let x_2166 : f32 = u_xlat62;
    u_xlat62 = (x_2165 * x_2166);
    let x_2168 : f32 = u_xlat65;
    u_xlat65 = max(x_2168, 0.100000001f);
    let x_2170 : f32 = u_xlat62;
    let x_2171 : f32 = u_xlat65;
    u_xlat62 = (x_2170 * x_2171);
    let x_2173 : f32 = u_xlat24;
    let x_2174 : f32 = u_xlat62;
    u_xlat62 = (x_2173 * x_2174);
    let x_2176 : f32 = u_xlat64;
    let x_2177 : f32 = u_xlat62;
    u_xlat62 = (x_2176 / x_2177);
    let x_2179 : vec4<f32> = u_xlat0;
    let x_2181 : f32 = u_xlat62;
    let x_2184 : vec4<f32> = u_xlat5;
    u_xlat28 = ((vec3<f32>(x_2179.x, x_2179.y, x_2179.z) * vec3<f32>(x_2181, x_2181, x_2181)) + vec3<f32>(x_2184.x, x_2184.y, x_2184.z));
    let x_2187 : vec3<f32> = u_xlat28;
    let x_2188 : vec4<f32> = u_xlat10;
    let x_2191 : vec4<f32> = u_xlat7;
    let x_2193 : vec3<f32> = ((x_2187 * vec3<f32>(x_2188.x, x_2188.y, x_2188.z)) + vec3<f32>(x_2191.x, x_2191.y, x_2191.z));
    let x_2194 : vec4<f32> = u_xlat7;
    u_xlat7 = vec4<f32>(x_2193.x, x_2193.y, x_2193.z, x_2194.w);

    continuing {
      let x_2196 : u32 = u_xlatu_loop_1;
      u_xlatu_loop_1 = (x_2196 + bitcast<u32>(1i));
    }
  }
  let x_2198 : vec3<f32> = u_xlat23;
  let x_2199 : vec3<f32> = u_xlat4;
  let x_2202 : vec4<f32> = u_xlat6;
  let x_2204 : vec3<f32> = ((x_2198 * vec3<f32>(x_2199.x, x_2199.x, x_2199.x)) + vec3<f32>(x_2202.x, x_2202.y, x_2202.z));
  let x_2205 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2204.x, x_2204.y, x_2204.z, x_2205.w);
  ...
  let x_2217 : f32 = u_xlat3.x;
  u_xlat60 = (x_2215 * -(x_2217));
  let x_2220 : f32 = u_xlat60;
  u_xlat60 = exp2(x_2220);
  let x_2222 : vec4<f32> = u_xlat0;
  let x_2226 : vec4<f32> = x_44.unity_FogColor;
  let x_2229 : vec3<f32> = (vec3<f32>(x_2222.x, x_2222.y, x_2222.z) + -(vec3<f32>(x_2226.x, x_2226.y, x_2226.z)));
  let x_2230 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2229.x, x_2229.y, x_2229.z, x_2230.w);
  let x_2234 : f32 = u_xlat60;
  let x_2236 : vec4<f32> = u_xlat0;
  let x_2240 : vec4<f32> = x_44.unity_FogColor;
  let x_2242 : vec3<f32> = ((vec3<f32>(x_2234, x_2234, x_2234) * vec3<f32>(x_2236.x, x_2236.y, x_2236.z)) + vec3<f32>(x_2240.x, x_2240.y, x_2240.z));
  let x_2243 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2242.x, x_2242.y, x_2242.z, x_2243.w);
  SV_Target0.w = 1.0f;
  return;
}
