...
;
    ...
    u_xlat3.xyz = u_xlat20.xxx * u_xlat21.xyz;
    ...
    u_xlat4.x = (u_xlatb20) ? u_xlat21.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb20) ? u_xlat21.y : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb20) ? u_xlat21.z : unity_MatrixV[2].z;
    u_xlat3.w = 1.0;
    ...
    u_xlat21.xyz = unity_SHC.xyz * u_xlat20.xxx + u_xlat7.xyz;
    u_xlat21.xyz = u_xlat21.xyz + u_xlat5.xyz;
    ...
    u_xlat7.xyz = u_xlat3.xyz * (-vec3(u_xlat65)) + (-u_xlat4.xyz);
    ...
    u_xlat21.xyz = u_xlat21.xyz * u_xlat6.xyz + u_xlat7.xyz;
    ...
    u_xlat0.xyz = u_xlat21.xyz * vec3(u_xlat60) + u_xlat5.xyz;
