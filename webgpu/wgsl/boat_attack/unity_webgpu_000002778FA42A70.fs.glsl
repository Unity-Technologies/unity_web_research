...
;
    ...
    u_xlat79 = dot(u_xlat3, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat79 = (-u_xlat79) + 4.0;
    u_xlatu79 = uint(u_xlat79);
    u_xlati79 = int(u_xlatu79) << (2 & int(0x1F));
    u_xlat2.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati79 + 1) / 4][(u_xlati79 + 1) % 4].xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[u_xlati79 / 4][u_xlati79 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat2.xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[(u_xlati79 + 2) / 4][(u_xlati79 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat2.xyz;
    u_xlat2.xyz = u_xlat2.xyz + _MainLightWorldToShadow[(u_xlati79 + 3) / 4][(u_xlati79 + 3) % 4].xyz;
    ...
    u_xlat79 = dot(u_xlat1.xyz, u_xlat3.xyz);
    u_xlat79 = u_xlat79 + 0.5;
    u_xlat3.xyz = vec3(u_xlat79) * u_xlat4.xyz;
    u_xlat79 = max(u_xlat3.w, 9.99999975e-05);
    ...
    if(u_xlatb82){
        ...
        if(u_xlatb82){
            ...
            if(u_xlatb83){
                ...
                u_xlat58.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                ...
                vec3 txVec6 = vec3(u_xlat58.xy,u_xlat2.z);
                ...
                vec3 txVec15 = vec3(u_xlat58.xy,u_xlat2.z);
    ...
    u_xlat2.x = u_xlat82 * _MainLightShadowParams.x + u_xlat2.x;
    ...
    u_xlat54 = u_xlat28 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
    u_xlat82 = (-u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat54 * u_xlat82 + u_xlat2.x;
    ...
    if(u_xlatb54){
        ...
        u_xlat54 = (u_xlatb7.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb7.x) ? u_xlat6.xyz : vec3(u_xlat54);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat8.xyz = u_xlat1.xyz * (-vec3(u_xlat54)) + (-u_xlat7.xyz);
    u_xlat54 = dot(u_xlat1.xyz, u_xlat7.xyz);
    u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
    u_xlat54 = (-u_xlat54) + 1.0;
    u_xlat54 = u_xlat54 * u_xlat54;
    u_xlat54 = u_xlat54 * u_xlat54;
    u_xlat82 = (-u_xlat0.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat9.xyz = (-u_xlat5.xyz) + vec3(u_xlat80);
    u_xlat9.xyz = vec3(u_xlat54) * u_xlat9.xyz + u_xlat5.xyz;
    ...
    u_xlat2.xzw = vec3(u_xlat52) * u_xlat6.xyz;
    ...
    u_xlat82 = dot(_MainLightPosition.xyz, u_xlat6.xyz);
    ...
    u_xlat52 = u_xlat52 * u_xlat82;
    u_xlat52 = u_xlat81 * u_xlat52;
    u_xlat52 = u_xlat79 / u_xlat52;
    u_xlat6.xyz = u_xlat5.xyz * vec3(u_xlat52) + u_xlat4.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu52 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat83 = dot(unity_LightIndices[int(u_xlatu83)], uintBitsToFloat(ImmCB_0[u_xlati58]));
        u_xlati83 = int(u_xlat83);
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati83].www + _AdditionalLightsPosition[u_xlati83].xyz;
        u_xlat58.x = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat58.x = max(u_xlat58.x, 6.10351562e-05);
        u_xlat84 = inversesqrt(u_xlat58.x);
        u_xlat10.xyz = vec3(u_xlat84) * u_xlat9.xyz;
        u_xlat85 = float(1.0) / float(u_xlat58.x);
        u_xlat58.x = u_xlat58.x * _AdditionalLightsAttenuation[u_xlati83].x;
        u_xlat58.x = (-u_xlat58.x) * u_xlat58.x + 1.0;
        ...
        if(u_xlati86 != 0) {
            ...
            u_xlat86 = (u_xlatb6.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb6.x) ? u_xlat11.xyz : vec3(u_xlat86);
        } else {
        ...
        u_xlat83 = u_xlat58.x * u_xlat85;
        u_xlat58.x = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat58.x = clamp(u_xlat58.x, 0.0, 1.0);
        u_xlat83 = u_xlat83 * u_xlat58.x;
        u_xlat11.xyz = vec3(u_xlat83) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat84) + u_xlat7.xyz;
        ...
        u_xlat58.x = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat58.x = clamp(u_xlat58.x, 0.0, 1.0);
        u_xlat83 = u_xlat83 * u_xlat83;
        u_xlat83 = u_xlat83 * u_xlat0.x + 1.00001001;
        u_xlat58.x = u_xlat58.x * u_xlat58.x;
        u_xlat83 = u_xlat83 * u_xlat83;
        u_xlat58.x = max(u_xlat58.x, 0.100000001);
        u_xlat83 = u_xlat83 * u_xlat58.x;
        u_xlat83 = u_xlat81 * u_xlat83;
        u_xlat83 = u_xlat79 / u_xlat83;
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat83) + u_xlat4.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat26) + u_xlat2.xzw;
