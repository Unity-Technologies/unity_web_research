...
;
    ...
    u_xlat3.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati63 + 1) / 4][(u_xlati63 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati63 / 4][u_xlati63 % 4].xyz * vs_INTERP0.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati63 + 2) / 4][(u_xlati63 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati63 + 3) / 4][(u_xlati63 + 3) % 4].xyz;
    u_xlat1.w = 1.0;
    ...
    u_xlat63 = u_xlat1.y * u_xlat1.y;
    u_xlat63 = u_xlat1.x * u_xlat1.x + (-u_xlat63);
    u_xlat6.xyz = unity_SHC.xyz * vec3(u_xlat63) + u_xlat7.xyz;
    ...
    u_xlat63 = (-u_xlat2.x) * 0.959999979 + 0.959999979;
    ...
    u_xlat63 = (-u_xlat2.y) + 1.0;
    u_xlat2.x = u_xlat63 * u_xlat63;
    u_xlat2.x = max(u_xlat2.x, 0.0078125);
    u_xlat65 = u_xlat2.x * u_xlat2.x;
    u_xlat64 = u_xlat64 + u_xlat2.y;
    u_xlat64 = min(u_xlat64, 1.0);
    u_xlat23 = u_xlat2.x * 4.0 + 2.0;
    ...
    u_xlat44 = min(u_xlat2.z, u_xlat66);
    ...
    u_xlat68 = dot((-u_xlat4.xyz), u_xlat1.xyz);
    u_xlat68 = u_xlat68 + u_xlat68;
    u_xlat6.xyz = u_xlat1.xyz * (-vec3(u_xlat68)) + (-u_xlat4.xyz);
    u_xlat68 = dot(u_xlat1.xyz, u_xlat4.xyz);
    ...
    u_xlat6 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat63);
    ...
    u_xlat29.xyz = (-u_xlat0.xyz) + vec3(u_xlat64);
    ...
    u_xlat63 = dot(u_xlat1.xyz, u_xlat6.xyz);
    u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
    u_xlat64 = dot(_MainLightPosition.xyz, u_xlat6.xyz);
    u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
    ...
    u_xlat6.xyz = u_xlat0.xyz * vec3(u_xlat63) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat2.x = dot(unity_LightIndices[int(u_xlatu2)], uintBitsToFloat(ImmCB_0[u_xlati66]));
        ...
        u_xlat48.x = float(1.0) / float(u_xlat66);
        u_xlat66 = u_xlat66 * _AdditionalLightsAttenuation[int(u_xlatu2)].x;
        u_xlat66 = (-u_xlat66) * u_xlat66 + 1.0;
        u_xlat66 = max(u_xlat66, 0.0);
        u_xlat66 = u_xlat66 * u_xlat66;
        u_xlat66 = u_xlat66 * u_xlat48.x;
        u_xlat48.x = dot(_AdditionalLightsSpotDir[int(u_xlatu2)].xyz, u_xlat10.xyz);
        u_xlat48.x = u_xlat48.x * _AdditionalLightsAttenuation[int(u_xlatu2)].z + _AdditionalLightsAttenuation[int(u_xlatu2)].w;
        u_xlat48.x = clamp(u_xlat48.x, 0.0, 1.0);
        u_xlat48.x = u_xlat48.x * u_xlat48.x;
        u_xlat66 = u_xlat66 * u_xlat48.x;
        u_xlatu48 = u_xlatu2 >> (5u & uint(0x1F));
        u_xlati69 = 1 << (int(u_xlatu2) & int(0x1F));
        u_xlati48 = int(uint(u_xlati69) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu48)]));
        if(u_xlati48 != 0) {
            u_xlati48 = int(_AdditionalLightsLightTypes[int(u_xlatu2)]);
            u_xlati69 = (u_xlati48 != 0) ? 0 : 1;
            u_xlati70 = int(u_xlatu2) << (2 & int(0x1F));
            if(u_xlati69 != 0) {
                u_xlat11.xyz = vs_INTERP0.yyy * _AdditionalLightsWorldToLights[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati70 / 4][u_xlati70 % 4].xyw * vs_INTERP0.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4].xyw * vs_INTERP0.zzz + u_xlat11.xyz;
                ...
                if(u_xlati48 != 0) {
                    u_xlat48.xy = vs_INTERP0.yy * _AdditionalLightsWorldToLights[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4].xy;
                    u_xlat48.xy = _AdditionalLightsWorldToLights[u_xlati70 / 4][u_xlati70 % 4].xy * vs_INTERP0.xx + u_xlat48.xy;
                    u_xlat48.xy = _AdditionalLightsWorldToLights[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4].xy * vs_INTERP0.zz + u_xlat48.xy;
                    u_xlat48.xy = u_xlat48.xy + _AdditionalLightsWorldToLights[(u_xlati70 + 3) / 4][(u_xlati70 + 3) % 4].xy;
                    u_xlat48.xy = u_xlat48.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat48.xy = fract(u_xlat48.xy);
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu2)].xy * u_xlat48.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu2)].zw;
                } else {
                    u_xlat12 = vs_INTERP0.yyyy * _AdditionalLightsWorldToLights[(u_xlati70 + 1) / 4][(u_xlati70 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati70 / 4][u_xlati70 % 4] * vs_INTERP0.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati70 + 2) / 4][(u_xlati70 + 2) % 4] * vs_INTERP0.zzzz + u_xlat12;
                    u_xlat12 = u_xlat12 + _AdditionalLightsWorldToLights[(u_xlati70 + 3) / 4][(u_xlati70 + 3) % 4];
                    u_xlat12.xyz = u_xlat12.xyz / u_xlat12.www;
                    u_xlat48.x = dot(u_xlat12.xyz, u_xlat12.xyz);
                    u_xlat48.x = inversesqrt(u_xlat48.x);
                    u_xlat12.xyz = u_xlat48.xxx * u_xlat12.xyz;
                    u_xlat48.x = dot(abs(u_xlat12.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat48.x = max(u_xlat48.x, 9.99999997e-07);
                    u_xlat48.x = float(1.0) / float(u_xlat48.x);
                    u_xlat13.xyz = u_xlat48.xxx * u_xlat12.zxy;
                    ...
                    u_xlat48.xy = u_xlat12.xy * u_xlat48.xx + u_xlat53.xy;
                    u_xlat48.xy = u_xlat48.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat48.x = (u_xlatb6.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb6.x) ? u_xlat11.xyz : u_xlat48.xxx;
        } else {
        ...
        u_xlat2.x = u_xlat2.x * u_xlat66;
        u_xlat11.xyz = u_xlat2.xxx * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat68) + u_xlat4.xyz;
        ...
        u_xlat9.xyz = u_xlat0.xyz * u_xlat2.xxx + u_xlat7.xyz;
        u_xlat29.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat29.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat44) + u_xlat3.xyz;
