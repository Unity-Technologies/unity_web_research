...
fn main_1() {
  ...
  let x_2065 : vec2<f32> = vs_TEXCOORD0;
  let x_2068 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_2072 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_2074 : vec2<f32> = ((x_2065 * vec2<f32>(x_2068.x, x_2068.y)) + vec2<f32>(x_2072.z, x_2072.w));
  let x_2075 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2074.x, x_2074.y, x_2075.z, x_2075.w);
  let x_2082 : vec4<f32> = u_xlat1;
  let x_2085 : f32 = x_25.x_GlobalMipBias.x;
  let x_2086 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_2082.x, x_2082.y), x_2085);
  u_xlat21 = x_2086.w;
  let x_2088 : f32 = u_xlat21;
  u_xlat21 = (x_2088 + -0.5f);
  let x_2090 : f32 = u_xlat21;
  let x_2091 : f32 = u_xlat21;
  u_xlat21 = (x_2090 + x_2091);
  let x_2093 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_2093.x, x_2093.y, x_2093.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_2102 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_2102);
  let x_2107 : f32 = x_25.x_Grain_Params.y;
  let x_2109 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_2107 * -(x_2109)) + 1.0f);
  let x_2114 : f32 = u_xlat21;
  let x_2116 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_2114, x_2114, x_2114) * vec3<f32>(x_2116.x, x_2116.y, x_2116.z));
  let x_2119 : vec3<f32> = u_xlat8;
  let x_2122 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_2119 * vec3<f32>(x_2122.x, x_2122.x, x_2122.x));
  let x_2125 : vec3<f32> = u_xlat8;
  let x_2126 : vec4<f32> = u_xlat1;
  let x_2129 : vec4<f32> = u_xlat0;
  let x_2131 : vec3<f32> = ((x_2125 * vec3<f32>(x_2126.x, x_2126.x, x_2126.x)) + vec3<f32>(x_2129.x, x_2129.y, x_2129.z));
  let x_2132 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2131.x, x_2131.y, x_2131.z, x_2132.w);
  let x_2134 : vec4<f32> = u_xlat0;
  let x_2136 : vec3<f32> = (vec3<f32>(x_2134.x, x_2134.y, x_2134.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2137 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2136.x, x_2136.y, x_2136.z, x_2137.w);
  let x_2139 : vec4<f32> = u_xlat0;
  let x_2142 : vec3<f32> = log2(abs(vec3<f32>(x_2139.x, x_2139.y, x_2139.z)));
  let x_2143 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2142.x, x_2142.y, x_2142.z, x_2143.w);
  let x_2145 : vec4<f32> = u_xlat2;
  let x_2147 : vec3<f32> = (vec3<f32>(x_2145.x, x_2145.y, x_2145.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2148 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2147.x, x_2147.y, x_2147.z, x_2148.w);
  let x_2150 : vec4<f32> = u_xlat2;
  let x_2152 : vec3<f32> = exp2(vec3<f32>(x_2150.x, x_2150.y, x_2150.z));
  let x_2153 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2152.x, x_2152.y, x_2152.z, x_2153.w);
  let x_2155 : vec4<f32> = u_xlat2;
  let x_2158 : vec3<f32> = ((vec3<f32>(x_2155.x, x_2155.y, x_2155.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2159 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2158.x, x_2158.y, x_2158.z, x_2159.w);
  let x_2161 : vec4<f32> = u_xlat0;
  let x_2163 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2161.x, x_2161.y, x_2161.z, x_2161.x));
  u_xlatb0 = vec3<bool>(x_2163.x, x_2163.y, x_2163.z);
  let x_2166 : bool = u_xlatb0.x;
  if (x_2166) {
    let x_2171 : f32 = u_xlat1.x;
    x_2167 = x_2171;
  } else {
    let x_2174 : f32 = u_xlat2.x;
    x_2167 = x_2174;
  }
  let x_2175 : f32 = x_2167;
  u_xlat0.x = x_2175;
  let x_2178 : bool = u_xlatb0.y;
  if (x_2178) {
    let x_2183 : f32 = u_xlat1.y;
    x_2179 = x_2183;
  } else {
    let x_2186 : f32 = u_xlat2.y;
    x_2179 = x_2186;
  }
  let x_2187 : f32 = x_2179;
  u_xlat0.y = x_2187;
  let x_2190 : bool = u_xlatb0.z;
  if (x_2190) {
    let x_2195 : f32 = u_xlat1.z;
    x_2191 = x_2195;
  } else {
    let x_2198 : f32 = u_xlat2.z;
    x_2191 = x_2198;
  }
  let x_2199 : f32 = x_2191;
  u_xlat0.z = x_2199;
  let x_2201 : vec2<f32> = vs_TEXCOORD0;
  let x_2204 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2208 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2210 : vec2<f32> = ((x_2201 * vec2<f32>(x_2204.x, x_2204.y)) + vec2<f32>(x_2208.z, x_2208.w));
  let x_2211 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2210.x, x_2210.y, x_2211.z, x_2211.w);
  let x_2218 : vec4<f32> = u_xlat1;
  let x_2221 : f32 = x_25.x_GlobalMipBias.x;
  let x_2222 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2218.x, x_2218.y), x_2221);
  u_xlat21 = x_2222.w;
  let x_2224 : f32 = u_xlat21;
  u_xlat21 = ((x_2224 * 2.0f) + -1.0f);
  let x_2227 : f32 = u_xlat21;
  u_xlatb1 = (x_2227 >= 0.0f);
  let x_2229 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2229);
  let x_2232 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2232)) + 1.0f);
  let x_2236 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2236);
  let x_2238 : f32 = u_xlat21;
  u_xlat21 = (-(x_2238) + 1.0f);
  let x_2241 : f32 = u_xlat21;
  let x_2243 : f32 = u_xlat1.x;
  u_xlat21 = (x_2241 * x_2243);
  let x_2245 : vec4<f32> = u_xlat0;
  let x_2247 : vec3<f32> = (vec3<f32>(x_2245.x, x_2245.y, x_2245.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2248 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2247.x, x_2247.y, x_2247.z, x_2248.w);
  let x_2250 : vec4<f32> = u_xlat0;
  let x_2253 : vec3<f32> = log2(abs(vec3<f32>(x_2250.x, x_2250.y, x_2250.z)));
  let x_2254 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2253.x, x_2253.y, x_2253.z, x_2254.w);
  let x_2256 : vec4<f32> = u_xlat2;
  let x_2258 : vec3<f32> = (vec3<f32>(x_2256.x, x_2256.y, x_2256.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2259 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2258.x, x_2258.y, x_2258.z, x_2259.w);
  let x_2261 : vec4<f32> = u_xlat2;
  let x_2263 : vec3<f32> = exp2(vec3<f32>(x_2261.x, x_2261.y, x_2261.z));
  let x_2264 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2263.x, x_2263.y, x_2263.z, x_2264.w);
  let x_2266 : vec4<f32> = u_xlat2;
  let x_2269 : vec3<f32> = ((vec3<f32>(x_2266.x, x_2266.y, x_2266.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2270 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2269.x, x_2269.y, x_2269.z, x_2270.w);
  let x_2272 : vec4<f32> = u_xlat0;
  let x_2274 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2272.x, x_2272.y, x_2272.z, x_2272.x));
  u_xlatb0 = vec3<bool>(x_2274.x, x_2274.y, x_2274.z);
  let x_2277 : bool = u_xlatb0.x;
  if (x_2277) {
  ...
  let x_2286 : f32 = x_2278;
  u_xlat0.x = x_2286;
  let x_2289 : bool = u_xlatb0.y;
  if (x_2289) {
    let x_2294 : f32 = u_xlat1.y;
    x_2290 = x_2294;
  } else {
    let x_2297 : f32 = u_xlat2.y;
    x_2290 = x_2297;
  }
  let x_2298 : f32 = x_2290;
  u_xlat0.y = x_2298;
  let x_2301 : bool = u_xlatb0.z;
  if (x_2301) {
    let x_2306 : f32 = u_xlat1.z;
    x_2302 = x_2306;
  } else {
    let x_2309 : f32 = u_xlat2.z;
    x_2302 = x_2309;
  }
  let x_2310 : f32 = x_2302;
  u_xlat0.z = x_2310;
  let x_2312 : f32 = u_xlat21;
  let x_2317 : vec4<f32> = u_xlat0;
  let x_2319 : vec3<f32> = ((vec3<f32>(x_2312, x_2312, x_2312) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2317.x, x_2317.y, x_2317.z));
  let x_2320 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2319.x, x_2319.y, x_2319.z, x_2320.w);
  let x_2322 : vec4<f32> = u_xlat0;
  let x_2324 : vec3<f32> = (vec3<f32>(x_2322.x, x_2322.y, x_2322.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2325 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2324.x, x_2324.y, x_2324.z, x_2325.w);
  let x_2327 : vec4<f32> = u_xlat0;
  let x_2329 : vec3<f32> = (vec3<f32>(x_2327.x, x_2327.y, x_2327.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2330 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2329.x, x_2329.y, x_2329.z, x_2330.w);
  let x_2332 : vec4<f32> = u_xlat2;
  let x_2334 : vec3<f32> = (vec3<f32>(x_2332.x, x_2332.y, x_2332.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2335 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2334.x, x_2334.y, x_2334.z, x_2335.w);
  let x_2337 : vec4<f32> = u_xlat2;
  let x_2340 : vec3<f32> = log2(abs(vec3<f32>(x_2337.x, x_2337.y, x_2337.z)));
  let x_2341 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2340.x, x_2340.y, x_2340.z, x_2341.w);
  let x_2343 : vec4<f32> = u_xlat2;
  let x_2345 : vec3<f32> = (vec3<f32>(x_2343.x, x_2343.y, x_2343.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2346 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2345.x, x_2345.y, x_2345.z, x_2346.w);
  let x_2348 : vec4<f32> = u_xlat2;
  let x_2350 : vec3<f32> = exp2(vec3<f32>(x_2348.x, x_2348.y, x_2348.z));
  let x_2351 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2350.x, x_2350.y, x_2350.z, x_2351.w);
  let x_2353 : vec4<f32> = u_xlat0;
  let x_2355 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2353.x, x_2353.y, x_2353.z, x_2353.x));
  u_xlatb0 = vec3<bool>(x_2355.x, x_2355.y, x_2355.z);
  let x_2358 : bool = u_xlatb0.x;
  if (x_2358) {
  ...
  let x_2367 : f32 = x_2359;
  u_xlat0.x = x_2367;
  let x_2370 : bool = u_xlatb0.y;
  if (x_2370) {
    let x_2375 : f32 = u_xlat1.y;
    x_2371 = x_2375;
  } else {
    let x_2378 : f32 = u_xlat2.y;
    x_2371 = x_2378;
  }
  let x_2379 : f32 = x_2371;
  u_xlat0.y = x_2379;
  let x_2382 : bool = u_xlatb0.z;
  if (x_2382) {
    let x_2387 : f32 = u_xlat1.z;
    x_2383 = x_2387;
  } else {
  ...
  let x_2397 : vec3<f32> = max(vec3<f32>(x_2395.x, x_2395.y, x_2395.z), vec3<f32>(0.0f, 0.0f, 0.0f));
