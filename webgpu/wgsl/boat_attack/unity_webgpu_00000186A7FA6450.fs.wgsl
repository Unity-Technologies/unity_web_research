...
fn main_1() {
  ...
  let x_1815 : vec3<f32> = u_xlat8;
  let x_1816 : vec4<f32> = u_xlat1;
  let x_1819 : vec3<f32> = u_xlat0;
  let x_1820 : vec3<f32> = ((x_1815 * vec3<f32>(x_1816.x, x_1816.x, x_1816.x)) + x_1819);
  let x_1821 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1820.x, x_1820.y, x_1820.z, x_1821.w);
  SV_Target0.w = 1.0f;
  return;
}
