...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat3.x = (u_xlatb21) ? u_xlat2.x : unity_MatrixV[0].z;
    u_xlat3.y = (u_xlatb21) ? u_xlat2.y : unity_MatrixV[1].z;
    u_xlat3.z = (u_xlatb21) ? u_xlat2.z : unity_MatrixV[2].z;
    ...
    u_xlat7.xyz = u_xlat21.xyz * (-vec3(u_xlat65)) + (-u_xlat3.xyz);
    u_xlat65 = dot(u_xlat21.xyz, u_xlat3.xyz);
    u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
    u_xlat65 = (-u_xlat65) + 1.0;
    u_xlat65 = u_xlat65 * u_xlat65;
    u_xlat65 = u_xlat65 * u_xlat65;
    u_xlat66 = (-u_xlat1) * 0.699999988 + 1.70000005;
    u_xlat1 = u_xlat1 * u_xlat66;
    u_xlat1 = u_xlat1 * 6.0;
    ...
    u_xlat60 = dot(u_xlat21.xyz, u_xlat7.xyz);
    u_xlat60 = clamp(u_xlat60, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu62)].www + _AdditionalLightsPosition[int(u_xlatu62)].xyz;
        ...
        if(u_xlati66 != 0) {
            ...
            if(u_xlati47 != 0) {
                u_xlat11.xyz = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati67 + 1) / 4][(u_xlati67 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati67 / 4][u_xlati67 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati67 + 2) / 4][(u_xlati67 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat11.xyz;
                ...
                if(u_xlati66 != 0) {
                    u_xlat51.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati67 + 1) / 4][(u_xlati67 + 1) % 4].xy;
                    u_xlat51.xy = _AdditionalLightsWorldToLights[u_xlati67 / 4][u_xlati67 % 4].xy * vs_TEXCOORD7.xx + u_xlat51.xy;
                    u_xlat51.xy = _AdditionalLightsWorldToLights[(u_xlati67 + 2) / 4][(u_xlati67 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat51.xy;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat62) + u_xlat5.xyz;
