...
fn main_1() {
  ...
  u_xlat9 = (x_117 * 3.1424999237060546875f);
  ...
  let x_161 : vec2<f32> = ((vec2<f32>(x_153.x, x_153.x) * vec2<f32>(x_155.x, x_155.x)) + vec2<f32>(-0.37999999523162841797f, -0.58000004291534423828f));
  let x_162 : vec3<f32> = u_xlat0;
  u_xlat0 = vec3<f32>(x_161.x, x_161.y, x_162.z);
  let x_164 : vec3<f32> = u_xlat0;
  let x_169 : vec2<f32> = (vec2<f32>(x_164.x, x_164.y) * vec2<f32>(24.9999866485595703125f, 25.0000247955322265625f));
