...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat3.x = (u_xlatb63) ? u_xlat2.x : unity_MatrixV[0].z;
    u_xlat3.y = (u_xlatb63) ? u_xlat2.y : unity_MatrixV[1].z;
    u_xlat3.z = (u_xlatb63) ? u_xlat2.z : unity_MatrixV[2].z;
...
;
    ...
    if(u_xlatb48){
        ...
        if(u_xlatb48){
            ...
            if(u_xlatb69){
                ...
                u_xlat48.x = u_xlat69 * u_xlat28 + u_xlat7.x;
            } else {
                u_xlat7.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat49.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
    ...
    u_xlat8.xyz = u_xlat2.xyz * (-u_xlat25.xxx) + (-u_xlat3.xyz);
    u_xlat25.x = dot(u_xlat2.xyz, u_xlat3.xyz);
    u_xlat25.x = clamp(u_xlat25.x, 0.0, 1.0);
    u_xlat25.x = (-u_xlat25.x) + 1.0;
    u_xlat25.x = u_xlat25.x * u_xlat25.x;
    u_xlat25.x = u_xlat25.x * u_xlat25.x;
    u_xlat46 = (-u_xlat63) * 0.699999988 + 1.70000005;
    ...
    u_xlat9.xyz = (-u_xlat0.xyz) + vec3(u_xlat65);
    ...
    u_xlat4.xyz = vec3(u_xlat63) * u_xlat7.xyz;
    ...
    u_xlat63 = u_xlat63 * u_xlat48.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu63 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu66)].www + _AdditionalLightsPosition[int(u_xlatu66)].xyz;
        ...
        if(u_xlati70 != 0) {
            ...
            if(u_xlati71 != 0) {
                u_xlat11.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati72 + 1) / 4][(u_xlati72 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati72 / 4][u_xlati72 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati72 + 2) / 4][(u_xlati72 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat11.xyz;
                ...
                if(u_xlati70 != 0) {
                    u_xlat53.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati72 + 1) / 4][(u_xlati72 + 1) % 4].xy;
                    u_xlat53.xy = _AdditionalLightsWorldToLights[u_xlati72 / 4][u_xlati72 % 4].xy * vs_TEXCOORD1.xx + u_xlat53.xy;
                    u_xlat53.xy = _AdditionalLightsWorldToLights[(u_xlati72 + 2) / 4][(u_xlati72 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat53.xy;
                    ...
                    u_xlat12 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati72 + 1) / 4][(u_xlati72 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati72 / 4][u_xlati72 % 4] * vs_TEXCOORD1.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati72 + 2) / 4][(u_xlati72 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat12;
        ...
        u_xlat9.xyz = u_xlat9.xyz * u_xlat49.xxx + u_xlat3.xyz;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat66) + u_xlat22.xyz;
