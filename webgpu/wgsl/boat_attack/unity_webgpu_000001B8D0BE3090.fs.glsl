...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat20.xyz = u_xlat0.xxx * u_xlat9.xyz;
...
;
    ...
    u_xlat37 = (u_xlatb37) ? u_xlat2.x : unity_LODFade.x;
    u_xlatb2.x = 0.5>=u_xlat37;
    ...
    u_xlat2.x = (u_xlatb2.x) ? u_xlat14.x : u_xlat26.x;
    u_xlat37 = u_xlat37 * 2.0 + (-u_xlat2.x);
    u_xlat2.x = u_xlat37 * u_xlat6.w;
    u_xlatb14 = u_xlat2.x>=0.400000006;
    u_xlat14.x = u_xlatb14 ? u_xlat2.x : float(0.0);
    u_xlat37 = u_xlat6.w * u_xlat37 + -0.400000006;
    ...
    u_xlat37 = (u_xlatb2.x) ? u_xlat37 : u_xlat14.x;
    ...
    u_xlat5.xy = u_xlat26.xy * hlslcc_FragCoord.xy;
    u_xlat26.x = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat26.x) + 1.0;
    u_xlat8.x = u_xlat8.x;
    ...
    u_xlat0.x = u_xlat41 * u_xlat42 + u_xlat0.x;
    u_xlat7.xyz = vec3(u_xlat29) * _MainLightColor.xyz;
    u_xlat41 = dot((-u_xlat4.xyz), u_xlat12.xyz);
    u_xlat41 = u_xlat41 + u_xlat41;
    u_xlat8.xyz = u_xlat12.xyz * (-vec3(u_xlat41)) + (-u_xlat4.xyz);
    u_xlat41 = dot(u_xlat12.xyz, u_xlat4.xyz);
    u_xlat41 = clamp(u_xlat41, 0.0, 1.0);
    ...
    u_xlat0.x = dot(u_xlat12.xyz, u_xlat8.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat40 = dot(u_xlat12.xyz, u_xlat10.xyz);
        ...
        u_xlat40 = dot(u_xlat12.xyz, u_xlat9.xyz);
        u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
    ...
    SV_Target0.w = (u_xlatb2.x) ? u_xlat37 : 1.0;
    return;
}
