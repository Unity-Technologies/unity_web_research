...
void main()
{
    ...
    u_xlat3.xyz = vec3(u_xlat42) * u_xlat5.xyz;
    ...
    u_xlat43 = (-u_xlat42) + u_xlat2.y;
    u_xlat5.xyz = vec3(u_xlat42) * u_xlat0.xyz;
    ...
    u_xlat47 = dot((-u_xlat4.xyz), u_xlat1.xyz);
    u_xlat47 = u_xlat47 + u_xlat47;
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat47)) + (-u_xlat4.xyz);
    u_xlat47 = dot(u_xlat1.xyz, u_xlat4.xyz);
    u_xlat47 = clamp(u_xlat47, 0.0, 1.0);
    ...
    u_xlat22.xyz = (-u_xlat0.xyz) + vec3(u_xlat43);
    ...
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat30) + u_xlat6.xyz;
