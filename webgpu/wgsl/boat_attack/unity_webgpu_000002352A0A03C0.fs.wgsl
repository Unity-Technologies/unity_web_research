...
fn main_1() {
  ...
  let x_323 : vec4<f32> = x_291.unity_FogColor;
  let x_326 : vec3<f32> = ((vec3<f32>(x_317.x, x_317.y, x_317.z) * vec3<f32>(x_319.x, x_319.y, x_319.z)) + -(vec3<f32>(x_323.x, x_323.y, x_323.z)));
  let x_327 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_326.x, x_326.y, x_326.z, x_327.w);
  let x_332 : f32 = u_xlat1.w;
  SV_Target0.w = x_332;
  let x_338 : f32 = vs_TEXCOORD3.w;
  let x_340 : f32 = vs_TEXCOORD3.w;
  u_xlat6 = (x_338 * -(x_340));
  let x_343 : f32 = u_xlat6;
  u_xlat6 = exp2(x_343);
  let x_345 : f32 = u_xlat6;
  let x_347 : vec4<f32> = u_xlat0;
  let x_351 : vec4<f32> = x_291.unity_FogColor;
  let x_353 : vec3<f32> = ((vec3<f32>(x_345, x_345, x_345) * vec3<f32>(x_347.x, x_347.y, x_347.z)) + vec3<f32>(x_351.x, x_351.y, x_351.z));
  let x_354 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_353.x, x_353.y, x_353.z, x_354.w);
  return;
}
