...
void main()
{
    ...
    u_xlat4.x = (-u_xlat78) + 1.0;
    u_xlat29.xyz = u_xlat0.xyz * vec3(u_xlat78);
    ...
    if(u_xlatb30){
        ...
        if(u_xlatb30){
            ...
            if(u_xlatb55){
                u_xlat55.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat55.xy = floor(u_xlat55.xy);
                u_xlat6.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat55.xy);
                ...
                vec3 txVec19 = vec3(u_xlat62.xy,vs_TEXCOORD8.z);
                ...
                vec3 txVec27 = vec3(u_xlat59.xy,vs_TEXCOORD8.z);
                ...
                vec3 txVec28 = vec3(u_xlat55.xy,vs_TEXCOORD8.z);
    ...
    u_xlatb55 = 0.0>=vs_TEXCOORD8.z;
    u_xlatb80 = vs_TEXCOORD8.z>=1.0;
    ...
    u_xlat80 = dot((-u_xlat26.xyz), u_xlat2.xyz);
    u_xlat80 = u_xlat80 + u_xlat80;
    u_xlat6.xyz = u_xlat2.xyz * (-vec3(u_xlat80)) + (-u_xlat26.xyz);
    u_xlat80 = dot(u_xlat2.xyz, u_xlat26.xyz);
    u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
    ...
    u_xlat3.xyz = u_xlat3.xyz * u_xlat29.xyz + u_xlat6.xyz;
    ...
    u_xlat75 = u_xlat5 / u_xlat75;
    u_xlat32.xyz = u_xlat0.xyz * vec3(u_xlat75) + u_xlat29.xyz;
    u_xlat75 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu75 =  uint(int(u_xlat75));
    u_xlat1 = u_xlat55.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat81 = u_xlat5 / u_xlat81;
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat81) + u_xlat29.xyz;
        u_xlat30.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat30.xyz;
    }
    u_xlat0.xyz = u_xlat32.xyz * u_xlat6.xyz + u_xlat3.xyz;
    u_xlat0.xyz = u_xlat30.xyz + u_xlat0.xyz;
