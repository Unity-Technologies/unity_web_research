...
fn main_1() {
  ...
  let x_2247 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2251 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_2265 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2261.x, x_2261.y), x_2264);
  u_xlat21 = x_2265.w;
  let x_2267 : f32 = u_xlat21;
  u_xlat21 = ((x_2267 * 2.0f) + -1.0f);
  let x_2270 : f32 = u_xlat21;
  u_xlatb1 = (x_2270 >= 0.0f);
  let x_2272 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2272);
  let x_2275 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2275)) + 1.0f);
  let x_2279 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2279);
  let x_2281 : f32 = u_xlat21;
  u_xlat21 = (-(x_2281) + 1.0f);
  let x_2284 : f32 = u_xlat21;
  let x_2286 : f32 = u_xlat1.x;
  u_xlat21 = (x_2284 * x_2286);
  let x_2288 : vec4<f32> = u_xlat0;
  let x_2290 : vec3<f32> = (vec3<f32>(x_2288.x, x_2288.y, x_2288.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2291 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2290.x, x_2290.y, x_2290.z, x_2291.w);
  let x_2293 : vec4<f32> = u_xlat0;
  let x_2296 : vec3<f32> = log2(abs(vec3<f32>(x_2293.x, x_2293.y, x_2293.z)));
  let x_2297 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2296.x, x_2296.y, x_2296.z, x_2297.w);
  let x_2299 : vec4<f32> = u_xlat2;
  let x_2301 : vec3<f32> = (vec3<f32>(x_2299.x, x_2299.y, x_2299.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2302 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2301.x, x_2301.y, x_2301.z, x_2302.w);
  let x_2304 : vec4<f32> = u_xlat2;
  let x_2306 : vec3<f32> = exp2(vec3<f32>(x_2304.x, x_2304.y, x_2304.z));
  let x_2307 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2306.x, x_2306.y, x_2306.z, x_2307.w);
  let x_2309 : vec4<f32> = u_xlat2;
  let x_2312 : vec3<f32> = ((vec3<f32>(x_2309.x, x_2309.y, x_2309.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2313 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2312.x, x_2312.y, x_2312.z, x_2313.w);
  let x_2315 : vec4<f32> = u_xlat0;
  let x_2317 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2315.x, x_2315.y, x_2315.z, x_2315.x));
  u_xlatb0 = vec3<bool>(x_2317.x, x_2317.y, x_2317.z);
  let x_2320 : bool = u_xlatb0.x;
  if (x_2320) {
    let x_2325 : f32 = u_xlat1.x;
    x_2321 = x_2325;
  } else {
  ...
  u_xlat0.x = x_2329;
  let x_2332 : bool = u_xlatb0.y;
  if (x_2332) {
    let x_2337 : f32 = u_xlat1.y;
    x_2333 = x_2337;
  } else {
    let x_2340 : f32 = u_xlat2.y;
    x_2333 = x_2340;
  }
  let x_2341 : f32 = x_2333;
  u_xlat0.y = x_2341;
  let x_2344 : bool = u_xlatb0.z;
  if (x_2344) {
    let x_2349 : f32 = u_xlat1.z;
    x_2345 = x_2349;
  } else {
  ...
  let x_2362 : vec3<f32> = ((vec3<f32>(x_2355, x_2355, x_2355) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2360.x, x_2360.y, x_2360.z));
  let x_2363 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2362.x, x_2362.y, x_2362.z, x_2363.w);
  let x_2365 : vec4<f32> = u_xlat0;
  let x_2367 : vec3<f32> = (vec3<f32>(x_2365.x, x_2365.y, x_2365.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2368 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2367.x, x_2367.y, x_2367.z, x_2368.w);
  let x_2370 : vec4<f32> = u_xlat0;
  let x_2372 : vec3<f32> = (vec3<f32>(x_2370.x, x_2370.y, x_2370.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2373 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2372.x, x_2372.y, x_2372.z, x_2373.w);
  let x_2375 : vec4<f32> = u_xlat2;
  let x_2377 : vec3<f32> = (vec3<f32>(x_2375.x, x_2375.y, x_2375.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2378 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2377.x, x_2377.y, x_2377.z, x_2378.w);
  let x_2380 : vec4<f32> = u_xlat2;
  let x_2383 : vec3<f32> = log2(abs(vec3<f32>(x_2380.x, x_2380.y, x_2380.z)));
  let x_2384 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2383.x, x_2383.y, x_2383.z, x_2384.w);
  let x_2386 : vec4<f32> = u_xlat2;
  let x_2388 : vec3<f32> = (vec3<f32>(x_2386.x, x_2386.y, x_2386.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2389 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2388.x, x_2388.y, x_2388.z, x_2389.w);
  let x_2391 : vec4<f32> = u_xlat2;
  let x_2393 : vec3<f32> = exp2(vec3<f32>(x_2391.x, x_2391.y, x_2391.z));
  let x_2394 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2393.x, x_2393.y, x_2393.z, x_2394.w);
  let x_2396 : vec4<f32> = u_xlat0;
  let x_2398 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2396.x, x_2396.y, x_2396.z, x_2396.x));
  u_xlatb0 = vec3<bool>(x_2398.x, x_2398.y, x_2398.z);
  let x_2401 : bool = u_xlatb0.x;
  if (x_2401) {
    let x_2406 : f32 = u_xlat1.x;
    x_2402 = x_2406;
  } else {
  ...
  u_xlat0.x = x_2410;
  let x_2413 : bool = u_xlatb0.y;
  if (x_2413) {
    let x_2418 : f32 = u_xlat1.y;
    x_2414 = x_2418;
  } else {
    let x_2421 : f32 = u_xlat2.y;
    x_2414 = x_2421;
  }
  let x_2422 : f32 = x_2414;
  u_xlat0.y = x_2422;
  let x_2425 : bool = u_xlatb0.z;
  if (x_2425) {
    let x_2430 : f32 = u_xlat1.z;
    x_2426 = x_2430;
  } else {
  ...
  let x_2440 : vec3<f32> = max(vec3<f32>(x_2438.x, x_2438.y, x_2438.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2441 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2440.x, x_2440.y, x_2440.z, x_2441.w);
  SV_Target0.w = 1.0f;
  return;
}
