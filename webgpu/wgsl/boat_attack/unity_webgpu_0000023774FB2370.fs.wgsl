...
fn main_1() {
  ...
  u_xlat0.x = x_1456;
  let x_1459 : bool = u_xlatb0.y;
  if (x_1459) {
    let x_1464 : f32 = u_xlat1.y;
    x_1460 = x_1464;
  } else {
  ...
  u_xlat0.y = x_1468;
  let x_1471 : bool = u_xlatb0.z;
  if (x_1471) {
    let x_1476 : f32 = u_xlat1.z;
    x_1472 = x_1476;
  } else {
  ...
  u_xlat0.z = x_1480;
  let x_1482 : vec2<f32> = vs_TEXCOORD0;
  let x_1485 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1489 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1491 : vec2<f32> = ((x_1482 * vec2<f32>(x_1485.x, x_1485.y)) + vec2<f32>(x_1489.z, x_1489.w));
  let x_1492 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1491.x, x_1491.y, x_1492.z, x_1492.w);
  let x_1499 : vec4<f32> = u_xlat1;
  let x_1502 : f32 = x_27.x_GlobalMipBias.x;
  let x_1503 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1499.x, x_1499.y), x_1502);
  u_xlat21 = x_1503.w;
  let x_1505 : f32 = u_xlat21;
  u_xlat21 = ((x_1505 * 2.0f) + -1.0f);
  let x_1508 : f32 = u_xlat21;
  u_xlatb1.x = (x_1508 >= 0.0f);
  let x_1512 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1512);
  let x_1515 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1515)) + 1.0f);
  let x_1519 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1519);
  let x_1521 : f32 = u_xlat21;
  u_xlat21 = (-(x_1521) + 1.0f);
  let x_1524 : f32 = u_xlat21;
  let x_1526 : f32 = u_xlat1.x;
  u_xlat21 = (x_1524 * x_1526);
