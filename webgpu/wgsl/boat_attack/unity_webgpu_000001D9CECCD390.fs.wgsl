...
fn main_1() {
  ...
  let x_100 : vec2<f32> = ((vec2<f32>(x_93.x, x_93.y) * vec2<f32>(0.28126230835914611816f, 0.28126230835914611816f)) + vec2<f32>(0.5f, 0.5f));
  ...
  u_xlatb3 = (x_132 < 0.99998462200164794922f);
  ...
  u_xlat0.z = ((-(x_148) * 0.0039215688593685627f) + x_153);
