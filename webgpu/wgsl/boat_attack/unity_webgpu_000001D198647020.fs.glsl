...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat54 = u_xlat2.y * u_xlat2.y;
    u_xlat54 = u_xlat2.x * u_xlat2.x + (-u_xlat54);
    ...
    u_xlat4.xyz = vec3(u_xlat55) * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu54 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.xyz = (-vs_TEXCOORD2.xyz) * _AdditionalLightsPosition[u_xlati57].www + _AdditionalLightsPosition[u_xlati57].xyz;
        ...
        u_xlat58 = u_xlat58 * u_xlat59;
        u_xlat7.xyz = vec3(u_xlat55) * _AdditionalLightsColor[u_xlati57].xyz;
