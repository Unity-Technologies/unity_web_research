...
;
    ...
    u_xlat82 = dot(u_xlat32.xyz, u_xlat32.xyz);
    u_xlat82 = inversesqrt(u_xlat82);
    u_xlat32.xyz = vec3(u_xlat82) * u_xlat32.xyz;
    u_xlat6.x = unity_MatrixV[0].z;
    u_xlat6.y = unity_MatrixV[1].z;
    u_xlat6.z = unity_MatrixV[2].z;
    u_xlat32.xyz = (u_xlatb28.x) ? u_xlat32.xyz : u_xlat6.xyz;
    ...
    u_xlat82 = dot(u_xlat30.xyz, u_xlat6.xyz);
    u_xlat82 = u_xlat82 + 0.5;
    u_xlat6.xyz = vec3(u_xlat82) * u_xlat7.xyz;
    u_xlat82 = max(u_xlat6.w, 9.99999975e-05);
    ...
    u_xlat5.x = dot((-u_xlat32.xyz), u_xlat30.xyz);
    u_xlat5.x = u_xlat5.x + u_xlat5.x;
    u_xlat8.xyz = u_xlat30.xyz * (-u_xlat5.xxx) + (-u_xlat32.xyz);
    u_xlat5.x = dot(u_xlat30.xyz, u_xlat32.xyz);
    ...
    u_xlat2.xyz = u_xlat6.xyz * u_xlat34.xxx + u_xlat31.xyz;
