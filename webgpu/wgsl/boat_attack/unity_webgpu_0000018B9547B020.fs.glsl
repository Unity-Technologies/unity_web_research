...
;
    ...
    u_xlat81 = dot(u_xlat2.xyz, u_xlat4.xyz);
    u_xlat81 = u_xlat81 + 0.5;
    u_xlat4.xyz = vec3(u_xlat81) * u_xlat5.xyz;
    u_xlat81 = max(u_xlat4.w, 9.99999975e-05);
    u_xlat4.xyz = u_xlat4.xyz / vec3(u_xlat81);
    u_xlat81 = (-u_xlat1) * 0.959999979 + 0.959999979;
    u_xlat82 = (-u_xlat81) + 1.0;
    u_xlat5.xyz = u_xlat0.xyz * vec3(u_xlat81);
    ...
    u_xlat78 = u_xlat0.w + u_xlat82;
    u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
    u_xlat82 = u_xlat81 * 4.0 + 2.0;
    ...
    if(u_xlatb6){
        ...
        if(u_xlatb6){
            ...
            if(u_xlatb32){
                ...
                u_xlat7.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat32.xy);
                ...
                vec3 txVec6 = vec3(u_xlat12.xy,u_xlat3.z);
                ...
                vec3 txVec8 = vec3(u_xlat13.xy,u_xlat3.z);
                ...
                vec3 txVec9 = vec3(u_xlat13.zw,u_xlat3.z);
                ...
                vec3 txVec15 = vec3(u_xlat13.xy,u_xlat3.z);
                ...
                vec3 txVec16 = vec3(u_xlat15.xy,u_xlat3.z);
                ...
                vec3 txVec19 = vec3(u_xlat65.xy,u_xlat3.z);
                ...
                vec3 txVec20 = vec3(u_xlat15.zw,u_xlat3.z);
                ...
                vec3 txVec21 = vec3(u_xlat16.xy,u_xlat3.z);
                ...
                vec3 txVec22 = vec3(u_xlat16.zw,u_xlat3.z);
                ...
                vec3 txVec23 = vec3(u_xlat34.xy,u_xlat3.z);
                ...
                vec3 txVec24 = vec3(u_xlat17.xy,u_xlat3.z);
                ...
                vec3 txVec25 = vec3(u_xlat11.xy,u_xlat3.z);
                ...
                vec3 txVec26 = vec3(u_xlat11.zw,u_xlat3.z);
                ...
                vec3 txVec28 = vec3(u_xlat32.xy,u_xlat3.z);
    ...
    u_xlat3.x = u_xlat55 * u_xlat6.x + u_xlat3.x;
    ...
    if(u_xlatb55){
        ...
        u_xlat55 = (u_xlatb7.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb7.x) ? u_xlat6.xyz : vec3(u_xlat55);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat55 = dot((-u_xlat27.xyz), u_xlat2.xyz);
    u_xlat55 = u_xlat55 + u_xlat55;
    u_xlat7.xyz = u_xlat2.xyz * (-vec3(u_xlat55)) + (-u_xlat27.xyz);
    u_xlat55 = dot(u_xlat2.xyz, u_xlat27.xyz);
    u_xlat55 = clamp(u_xlat55, 0.0, 1.0);
    ...
    u_xlat34.xyz = vec3(u_xlat55) * u_xlat34.xyz + u_xlat0.xyz;
    ...
    u_xlat3.xzw = vec3(u_xlat78) * u_xlat6.xyz;
    u_xlat6.xyz = u_xlat27.xyz + _MainLightPosition.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat87 = float(1.0) / float(u_xlat59.x);
        u_xlat59.x = u_xlat59.x * _AdditionalLightsAttenuation[u_xlati84].x;
        u_xlat59.x = (-u_xlat59.x) * u_xlat59.x + 1.0;
        u_xlat59.x = max(u_xlat59.x, 0.0);
        u_xlat59.x = u_xlat59.x * u_xlat59.x;
        u_xlat59.x = u_xlat59.x * u_xlat87;
        ...
        u_xlat84 = u_xlat59.x * u_xlat87;
        u_xlat59.x = dot(u_xlat2.xyz, u_xlat10.xyz);
        u_xlat59.x = clamp(u_xlat59.x, 0.0, 1.0);
        u_xlat84 = u_xlat84 * u_xlat59.x;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat84) + u_xlat5.xyz;
