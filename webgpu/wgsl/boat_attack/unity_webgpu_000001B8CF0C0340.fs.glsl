...
;
    ...
    u_xlat31.xyz = vec3(u_xlat25) * u_xlat31.xyz + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat31.xyz = vec3(u_xlat73) * u_xlat8.xyz;
        u_xlat74 = float(1.0) / float(u_xlat71);
        u_xlat71 = u_xlat71 * _AdditionalLightsAttenuation[u_xlati68].x;
        u_xlat71 = (-u_xlat71) * u_xlat71 + 1.0;
        u_xlat71 = max(u_xlat71, 0.0);
        u_xlat71 = u_xlat71 * u_xlat71;
        u_xlat71 = u_xlat71 * u_xlat74;
        u_xlat74 = dot(_AdditionalLightsSpotDir[u_xlati68].xyz, u_xlat31.xyz);
        u_xlat74 = u_xlat74 * _AdditionalLightsAttenuation[u_xlati68].z + _AdditionalLightsAttenuation[u_xlati68].w;
        ...
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat73) + u_xlat1.xyz;
        ...
        u_xlat68 = dot(u_xlat2.xyz, u_xlat8.xyz);
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
        u_xlat71 = dot(u_xlat31.xyz, u_xlat8.xyz);
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat68) + u_xlat7.xyz;
