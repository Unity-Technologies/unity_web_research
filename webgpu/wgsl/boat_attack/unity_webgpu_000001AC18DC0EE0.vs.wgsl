...
fn main_1() {
  ...
  u_xlatu0.z = (bitcast<u32>(x_59) & 2u);
  let x_69 : vec3<u32> = u_xlatu0;
  u_xlat0 = vec2<f32>(vec2<u32>(x_69.x, x_69.z));
  let x_78 : vec2<f32> = u_xlat0;
  let x_84 : vec2<f32> = ((x_78 * vec2<f32>(2.0f, 2.0f)) + vec2<f32>(-1.0f, -1.0f));
  let x_87 : vec4<f32> = gl_Position;
  gl_Position = vec4<f32>(x_84.x, x_84.y, x_87.z, x_87.w);
