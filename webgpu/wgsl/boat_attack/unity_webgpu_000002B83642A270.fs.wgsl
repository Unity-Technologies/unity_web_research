...
fn main_1() {
  ...
  let x_1699 : vec2<f32> = vs_TEXCOORD0;
  let x_1702 : vec4<f32> = x_17.x_Dithering_Params;
  let x_1706 : vec4<f32> = x_17.x_Dithering_Params;
  let x_1708 : vec2<f32> = ((x_1699 * vec2<f32>(x_1702.x, x_1702.y)) + vec2<f32>(x_1706.z, x_1706.w));
  let x_1709 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1708.x, x_1708.y, x_1709.z, x_1709.w);
  let x_1716 : vec4<f32> = u_xlat1;
  let x_1719 : f32 = x_17.x_GlobalMipBias.x;
  let x_1720 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1716.x, x_1716.y), x_1719);
  u_xlat27 = x_1720.w;
  let x_1722 : f32 = u_xlat27;
  u_xlat27 = ((x_1722 * 2.0f) + -1.0f);
  let x_1725 : f32 = u_xlat27;
  u_xlatb1.x = (x_1725 >= 0.0f);
  let x_1729 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1729);
  let x_1732 : f32 = u_xlat27;
  u_xlat27 = (-(abs(x_1732)) + 1.0f);
  let x_1736 : f32 = u_xlat27;
  u_xlat27 = sqrt(x_1736);
  let x_1738 : f32 = u_xlat27;
  u_xlat27 = (-(x_1738) + 1.0f);
  let x_1741 : f32 = u_xlat27;
  let x_1743 : f32 = u_xlat1.x;
  u_xlat27 = (x_1741 * x_1743);
  let x_1745 : vec3<f32> = u_xlat0;
  let x_1748 : vec3<f32> = (x_1745 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1749 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1748.x, x_1748.y, x_1748.z, x_1749.w);
  let x_1751 : vec3<f32> = u_xlat0;
  let x_1753 : vec3<f32> = log2(abs(x_1751));
  let x_1754 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1753.x, x_1753.y, x_1753.z, x_1754.w);
  let x_1756 : vec4<f32> = u_xlat2;
  let x_1760 : vec3<f32> = (vec3<f32>(x_1756.x, x_1756.y, x_1756.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1775 : vec3<f32> = ((vec3<f32>(x_1768.x, x_1768.y, x_1768.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
