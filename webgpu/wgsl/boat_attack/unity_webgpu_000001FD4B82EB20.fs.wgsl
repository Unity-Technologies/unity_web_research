...
fn main_1() {
  ...
  let x_842 : vec3<f32> = (vec3<f32>(x_840.x, x_840.y, x_840.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  ...
  let x_853 : vec3<f32> = (vec3<f32>(x_851.x, x_851.y, x_851.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_864 : vec3<f32> = ((vec3<f32>(x_861.x, x_861.y, x_861.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_865 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_864.x, x_864.y, x_864.z, x_865.w);
  let x_868 : vec4<f32> = u_xlat0;
  let x_870 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_868.x, x_868.y, x_868.z, x_868.x));
  ...
  let x_915 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_928 : f32 = x_25.x_GlobalMipBias.x;
  ...
  u_xlat15 = (-(abs(x_942)) + 1.0f);
  let x_946 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_946);
  let x_948 : f32 = u_xlat15;
  u_xlat15 = (-(x_948) + 1.0f);
  let x_951 : f32 = u_xlat15;
  let x_953 : f32 = u_xlat1.x;
  u_xlat15 = (x_951 * x_953);
  let x_955 : vec4<f32> = u_xlat0;
  let x_957 : vec3<f32> = (vec3<f32>(x_955.x, x_955.y, x_955.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  ...
  let x_984 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_982.x, x_982.y, x_982.z, x_982.x));
  ...
  let x_1029 : vec3<f32> = ((vec3<f32>(x_1022, x_1022, x_1022) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1027.x, x_1027.y, x_1027.z));
  let x_1030 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1029.x, x_1029.y, x_1029.z, x_1030.w);
  let x_1032 : vec4<f32> = u_xlat0;
  let x_1034 : vec3<f32> = (vec3<f32>(x_1032.x, x_1032.y, x_1032.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1035 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1034.x, x_1034.y, x_1034.z, x_1035.w);
  let x_1037 : vec4<f32> = u_xlat0;
  let x_1039 : vec3<f32> = (vec3<f32>(x_1037.x, x_1037.y, x_1037.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1040 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1039.x, x_1039.y, x_1039.z, x_1040.w);
  let x_1042 : vec4<f32> = u_xlat2;
  let x_1044 : vec3<f32> = (vec3<f32>(x_1042.x, x_1042.y, x_1042.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  ...
  let x_1055 : vec3<f32> = (vec3<f32>(x_1053.x, x_1053.y, x_1053.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1065 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1063.x, x_1063.y, x_1063.z, x_1063.x));
