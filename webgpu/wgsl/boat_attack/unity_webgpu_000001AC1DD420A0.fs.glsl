...
;
    ...
    u_xlat28 = u_xlat28 * _MainLightShadowParams.x + u_xlat3.x;
    u_xlatb3.x = 0.0>=u_xlat3.z;
    u_xlatb12 = u_xlat3.z>=1.0;
    u_xlatb3.x = u_xlatb12 || u_xlatb3.x;
    u_xlat28 = (u_xlatb3.x) ? 1.0 : u_xlat28;
    u_xlat3.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat3.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat12.x = u_xlat3.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat12.x = clamp(u_xlat12.x, 0.0, 1.0);
    u_xlat21 = (-u_xlat28) + 1.0;
    u_xlat28 = u_xlat12.x * u_xlat21 + u_xlat28;
    u_xlat28 = u_xlat28 * unity_LightData.z;
    u_xlat12.xyz = vec3(u_xlat28) * _MainLightColor.xyz;
    ...
    u_xlat31 = inversesqrt(u_xlat4.w);
    ...
    for(uint u_xlatu_loop_1 = uint(0u) ; u_xlatu_loop_1<u_xlatu31 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat16.x = u_xlat3.x * u_xlat25 + u_xlat16.x;
        u_xlat7.x = u_xlat16.x * u_xlat7.x;
