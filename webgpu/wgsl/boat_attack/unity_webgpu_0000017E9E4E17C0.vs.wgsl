...
@group(1) @binding(3) var<uniform> x_14 : UnityDrawCallInfo;
...
@group(0) @binding(2) var x_TerrainHeightmapTexture : texture_2d<f32>;

var<private> u_xlat1 : vec4<f32>;

@group(0) @binding(3) var x_TerrainNormalmapTexture : texture_2d<f32>;

@group(1) @binding(4) var<uniform> x_120 : x_Terrain;

var<private> u_xlat2 : vec3<f32>;

@group(1) @binding(2) var<uniform> x_140 : UnityPerDraw;

var<private> vs_TEXCOORD0 : vec2<f32>;

@group(1) @binding(1) var<uniform> x_194 : VGlobals;
...
fn main_1() {
  ...
  u_xlat9 = max(x_240, 1.17549435e-38f);
