...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat46 = u_xlat47 * u_xlat6.x + u_xlat46;
    ...
    u_xlat7.xyz = u_xlat15.xyz * (-vec3(u_xlat47)) + (-u_xlat3.xyz);
