...
fn main_1() {
  ...
  let x_1690 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1694 : vec4<f32> = x_38.x_Dithering_Params;
  ...
  let x_1708 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1704.x, x_1704.y), x_1707);
  u_xlat18 = x_1708.w;
  let x_1710 : f32 = u_xlat18;
  u_xlat18 = ((x_1710 * 2.0f) + -1.0f);
  let x_1713 : f32 = u_xlat18;
  u_xlatb1 = (x_1713 >= 0.0f);
  let x_1715 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1715);
  let x_1718 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1718)) + 1.0f);
  let x_1722 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1722);
  let x_1724 : f32 = u_xlat18;
  u_xlat18 = (-(x_1724) + 1.0f);
  let x_1727 : f32 = u_xlat18;
  let x_1729 : f32 = u_xlat1.x;
  u_xlat18 = (x_1727 * x_1729);
  let x_1731 : vec4<f32> = u_xlat0;
  let x_1733 : vec3<f32> = (vec3<f32>(x_1731.x, x_1731.y, x_1731.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1734 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1733.x, x_1733.y, x_1733.z, x_1734.w);
  let x_1736 : vec4<f32> = u_xlat0;
  let x_1739 : vec3<f32> = log2(abs(vec3<f32>(x_1736.x, x_1736.y, x_1736.z)));
  ...
  let x_1805 : vec3<f32> = ((vec3<f32>(x_1798, x_1798, x_1798) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1803.x, x_1803.y, x_1803.z));
  let x_1806 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1805.x, x_1805.y, x_1805.z, x_1806.w);
  let x_1808 : vec4<f32> = u_xlat0;
  let x_1810 : vec3<f32> = (vec3<f32>(x_1808.x, x_1808.y, x_1808.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1811 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1810.x, x_1810.y, x_1810.z, x_1811.w);
  let x_1813 : vec4<f32> = u_xlat0;
  let x_1815 : vec3<f32> = (vec3<f32>(x_1813.x, x_1813.y, x_1813.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1816 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1815.x, x_1815.y, x_1815.z, x_1816.w);
  let x_1818 : vec4<f32> = u_xlat2;
  let x_1820 : vec3<f32> = (vec3<f32>(x_1818.x, x_1818.y, x_1818.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1821 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1820.x, x_1820.y, x_1820.z, x_1821.w);
  let x_1823 : vec4<f32> = u_xlat2;
  let x_1826 : vec3<f32> = log2(abs(vec3<f32>(x_1823.x, x_1823.y, x_1823.z)));
  let x_1827 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1826.x, x_1826.y, x_1826.z, x_1827.w);
  let x_1829 : vec4<f32> = u_xlat2;
  let x_1831 : vec3<f32> = (vec3<f32>(x_1829.x, x_1829.y, x_1829.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1832 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1831.x, x_1831.y, x_1831.z, x_1832.w);
  let x_1834 : vec4<f32> = u_xlat2;
  let x_1836 : vec3<f32> = exp2(vec3<f32>(x_1834.x, x_1834.y, x_1834.z));
  let x_1837 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1836.x, x_1836.y, x_1836.z, x_1837.w);
  let x_1839 : vec4<f32> = u_xlat0;
  let x_1841 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1839.x, x_1839.y, x_1839.z, x_1839.x));
  u_xlatb0 = vec3<bool>(x_1841.x, x_1841.y, x_1841.z);
  let x_1844 : bool = u_xlatb0.x;
  if (x_1844) {
  ...
  u_xlat0.x = x_1853;
  let x_1856 : bool = u_xlatb0.y;
  if (x_1856) {
    let x_1861 : f32 = u_xlat1.y;
    x_1857 = x_1861;
  } else {
    let x_1864 : f32 = u_xlat2.y;
    x_1857 = x_1864;
  }
  let x_1865 : f32 = x_1857;
  u_xlat0.y = x_1865;
  let x_1868 : bool = u_xlatb0.z;
  if (x_1868) {
    let x_1873 : f32 = u_xlat1.z;
    x_1869 = x_1873;
  } else {
    let x_1876 : f32 = u_xlat2.z;
    x_1869 = x_1876;
  }
  let x_1877 : f32 = x_1869;
  u_xlat0.z = x_1877;
  let x_1881 : vec4<f32> = u_xlat0;
  let x_1883 : vec3<f32> = max(vec3<f32>(x_1881.x, x_1881.y, x_1881.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1884 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1883.x, x_1883.y, x_1883.z, x_1884.w);
  SV_Target0.w = 1.0f;
  return;
}
