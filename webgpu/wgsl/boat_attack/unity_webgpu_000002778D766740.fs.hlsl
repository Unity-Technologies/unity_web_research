#line 1 "Hidden/Universal/CoreBlitColorAndDepth"
...
#line 8 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.core@16.0.1/Runtime/Utilities/BlitColorAndDepth.hlsl"
...
return _BlitTexture . SampleLevel ( sampler_LinearClamp , input . texcoord . xy , _BlitMipLevel ) ;
}
...
PixelData pd ;
pd . color = _BlitTexture . SampleLevel ( sampler_LinearClamp , input . texcoord . xy , _BlitMipLevel ) ;
pd . depth = _InputDepthTexture . SampleLevel ( sampler_PointClamp , input . texcoord . xy , _BlitMipLevel ) . x ;
return pd ;
}
