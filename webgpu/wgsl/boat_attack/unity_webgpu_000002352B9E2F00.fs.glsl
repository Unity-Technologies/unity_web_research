...
;
    ...
    u_xlat23.xyz = vec3(u_xlat17) * u_xlat23.xyz + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat23.xyz = vec3(u_xlat48) * u_xlat8.xyz;
        ...
        u_xlat43 = clamp(u_xlat43, 0.0, 1.0);
        u_xlat46 = dot(u_xlat23.xyz, u_xlat8.xyz);
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat43) + u_xlat7.xyz;
