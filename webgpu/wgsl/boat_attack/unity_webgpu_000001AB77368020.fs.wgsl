...
fn main_1() {
  ...
  let x_1456 : vec2<f32> = vs_TEXCOORD0;
  let x_1459 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1463 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1465 : vec2<f32> = ((x_1456 * vec2<f32>(x_1459.x, x_1459.y)) + vec2<f32>(x_1463.z, x_1463.w));
  let x_1466 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1465.x, x_1465.y, x_1466.z, x_1466.w);
  let x_1473 : vec4<f32> = u_xlat1;
  let x_1476 : f32 = x_38.x_GlobalMipBias.x;
  let x_1477 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1473.x, x_1473.y), x_1476);
  u_xlat15 = x_1477.w;
  let x_1479 : f32 = u_xlat15;
  u_xlat15 = ((x_1479 * 2.0f) + -1.0f);
  let x_1482 : f32 = u_xlat15;
  u_xlatb1 = (x_1482 >= 0.0f);
  let x_1484 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1484);
  let x_1487 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1487)) + 1.0f);
  let x_1491 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1491);
  let x_1493 : f32 = u_xlat15;
  u_xlat15 = (-(x_1493) + 1.0f);
  let x_1496 : f32 = u_xlat15;
  let x_1498 : f32 = u_xlat1.x;
  u_xlat15 = (x_1496 * x_1498);
  let x_1500 : vec4<f32> = u_xlat0;
  let x_1502 : vec3<f32> = (vec3<f32>(x_1500.x, x_1500.y, x_1500.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1503 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1502.x, x_1502.y, x_1502.z, x_1503.w);
  let x_1505 : vec4<f32> = u_xlat0;
  let x_1508 : vec3<f32> = log2(abs(vec3<f32>(x_1505.x, x_1505.y, x_1505.z)));
  let x_1509 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1508.x, x_1508.y, x_1508.z, x_1509.w);
  let x_1511 : vec4<f32> = u_xlat2;
  let x_1513 : vec3<f32> = (vec3<f32>(x_1511.x, x_1511.y, x_1511.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1514 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1513.x, x_1513.y, x_1513.z, x_1514.w);
  let x_1516 : vec4<f32> = u_xlat2;
  let x_1518 : vec3<f32> = exp2(vec3<f32>(x_1516.x, x_1516.y, x_1516.z));
  let x_1519 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1518.x, x_1518.y, x_1518.z, x_1519.w);
  let x_1521 : vec4<f32> = u_xlat2;
  let x_1524 : vec3<f32> = ((vec3<f32>(x_1521.x, x_1521.y, x_1521.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1525 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1524.x, x_1524.y, x_1524.z, x_1525.w);
  let x_1527 : vec4<f32> = u_xlat0;
  let x_1529 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1527.x, x_1527.y, x_1527.z, x_1527.x));
  u_xlatb0 = vec3<bool>(x_1529.x, x_1529.y, x_1529.z);
  ...
  u_xlat0.x = x_1541;
  let x_1544 : bool = u_xlatb0.y;
  if (x_1544) {
    let x_1549 : f32 = u_xlat1.y;
    x_1545 = x_1549;
  } else {
    let x_1552 : f32 = u_xlat2.y;
    x_1545 = x_1552;
  }
  let x_1553 : f32 = x_1545;
  u_xlat0.y = x_1553;
  let x_1556 : bool = u_xlatb0.z;
  if (x_1556) {
    let x_1561 : f32 = u_xlat1.z;
    x_1557 = x_1561;
  } else {
  ...
  let x_1574 : vec3<f32> = ((vec3<f32>(x_1567, x_1567, x_1567) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1572.x, x_1572.y, x_1572.z));
  let x_1575 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1574.x, x_1574.y, x_1574.z, x_1575.w);
  let x_1577 : vec4<f32> = u_xlat0;
  let x_1579 : vec3<f32> = (vec3<f32>(x_1577.x, x_1577.y, x_1577.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1580 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1579.x, x_1579.y, x_1579.z, x_1580.w);
  ...
  let x_1652 : vec3<f32> = max(vec3<f32>(x_1650.x, x_1650.y, x_1650.z), vec3<f32>(0.0f, 0.0f, 0.0f));
