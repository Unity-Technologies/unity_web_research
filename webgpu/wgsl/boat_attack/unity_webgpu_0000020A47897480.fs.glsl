...
void main()
{
    ...
    u_xlat38 = inversesqrt(u_xlat38);
    u_xlat20.xyz = vec3(u_xlat38) * u_xlat20.xyz;
    u_xlat38 = dot(u_xlat1.xyw, u_xlat20.xyz);
