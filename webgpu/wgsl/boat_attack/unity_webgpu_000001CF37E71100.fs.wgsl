...
fn main_1() {
  ...
  let x_1749 : vec3<f32> = u_xlat7;
  let x_1750 : vec4<f32> = u_xlat1;
  let x_1753 : vec4<f32> = u_xlat0;
  let x_1755 : vec3<f32> = ((x_1749 * vec3<f32>(x_1750.x, x_1750.x, x_1750.x)) + vec3<f32>(x_1753.x, x_1753.y, x_1753.z));
  let x_1756 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1755.x, x_1755.y, x_1755.z, x_1756.w);
  SV_Target0.w = 1.0f;
  return;
}
