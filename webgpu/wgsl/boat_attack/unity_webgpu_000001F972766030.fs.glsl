...
void main()
{
    ...
    u_xlat5.xyz = u_xlat0.xyz * vec3(u_xlat34);
    ...
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat34);
    ...
    u_xlat6.xyz = u_xlat7.xyz * vec3(u_xlat34);
    ...
    u_xlat18.xyz = u_xlat0.xyz * vec3(u_xlat34) + u_xlat5.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat18.xyz;
    u_xlat34 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu34 =  uint(int(u_xlat34));
    u_xlat2.x = u_xlat38 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu34 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat41 = u_xlat2.x * u_xlat42 + u_xlat41;
        u_xlat38 = u_xlat38 * u_xlat41;
    ...
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat24) + u_xlat6.xyz;
