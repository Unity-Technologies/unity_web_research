...
void main()
{
    ...
    u_xlat1.x = _Time.x * 0.25;
    u_xlat1.xy = u_xlat0.xw * vec2(0.0250000004, 0.0250000004) + u_xlat1.xx;
    ...
    u_xlat1.xy = u_xlat0.xz + _Time.xx;
    ...
    u_xlat1.xy = textureLod(sampler2D(_CausticMap, sampler_CausticMap), u_xlat1.xy, u_xlat9).zw;
    u_xlat0.xzw = textureLod(sampler2D(_CausticMap, sampler_CausticMap), u_xlat0.xz, u_xlat9).xzw;
    u_xlat7 = u_xlat0.z * u_xlat1.x;
    u_xlat1.x = u_xlat7 * 10.0 + u_xlat1.x;
    u_xlat2.x = u_xlat1.y * 0.5;
    u_xlat6.x = u_xlat0.z + u_xlat1.x;
    u_xlat2.yz = u_xlat0.wx * vec2(0.75, 1.0);
    u_xlat0.x = u_xlat3 * u_xlat6.x;
    u_xlat0.xyz = u_xlat2.xyz * u_xlat0.xxx;
    SV_Target0.xyz = u_xlat0.xyz * _MainLightColor.xyz + vec3(1.0, 1.0, 1.0);
    SV_Target0.w = 1.0;
    return;
}
