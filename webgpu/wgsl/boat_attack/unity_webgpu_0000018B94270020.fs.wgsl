...
fn main_1() {
  ...
  let x_1637 : vec4<f32> = x_17.x_Dithering_Params;
  let x_1641 : vec4<f32> = x_17.x_Dithering_Params;
  ...
  let x_1655 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1651.x, x_1651.y), x_1654);
  u_xlat27 = x_1655.w;
  let x_1657 : f32 = u_xlat27;
  u_xlat27 = ((x_1657 * 2.0f) + -1.0f);
  let x_1660 : f32 = u_xlat27;
  u_xlatb1.x = (x_1660 >= 0.0f);
  let x_1664 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1664);
  let x_1667 : f32 = u_xlat27;
  u_xlat27 = (-(abs(x_1667)) + 1.0f);
  let x_1671 : f32 = u_xlat27;
  u_xlat27 = sqrt(x_1671);
  let x_1673 : f32 = u_xlat27;
  u_xlat27 = (-(x_1673) + 1.0f);
  let x_1676 : f32 = u_xlat27;
  let x_1678 : f32 = u_xlat1.x;
  u_xlat27 = (x_1676 * x_1678);
  let x_1680 : vec3<f32> = u_xlat0;
  let x_1683 : vec3<f32> = (x_1680 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1684 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1683.x, x_1683.y, x_1683.z, x_1684.w);
  let x_1686 : vec3<f32> = u_xlat0;
  let x_1688 : vec3<f32> = log2(abs(x_1686));
  let x_1689 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1688.x, x_1688.y, x_1688.z, x_1689.w);
  let x_1691 : vec4<f32> = u_xlat2;
  let x_1695 : vec3<f32> = (vec3<f32>(x_1691.x, x_1691.y, x_1691.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1710 : vec3<f32> = ((vec3<f32>(x_1703.x, x_1703.y, x_1703.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1711 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1710.x, x_1710.y, x_1710.z, x_1711.w);
  let x_1716 : vec3<f32> = u_xlat0;
  let x_1718 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1716.x, x_1716.y, x_1716.z, x_1716.x));
  u_xlatb0 = vec3<bool>(x_1718.x, x_1718.y, x_1718.z);
  ...
  u_xlat0.x = x_1730;
  let x_1733 : bool = u_xlatb0.y;
  if (x_1733) {
    let x_1738 : f32 = u_xlat1.y;
    x_1734 = x_1738;
  } else {
  ...
  u_xlat0.y = x_1742;
  let x_1745 : bool = u_xlatb0.z;
  if (x_1745) {
    let x_1750 : f32 = u_xlat1.z;
    x_1746 = x_1750;
  } else {
  ...
  u_xlat0 = ((vec3<f32>(x_1756, x_1756, x_1756) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1761);
  let x_1763 : vec3<f32> = u_xlat0;
  let x_1766 : vec3<f32> = (x_1763 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1767 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1766.x, x_1766.y, x_1766.z, x_1767.w);
  let x_1769 : vec3<f32> = u_xlat0;
  let x_1772 : vec3<f32> = (x_1769 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1773 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1772.x, x_1772.y, x_1772.z, x_1773.w);
  let x_1775 : vec4<f32> = u_xlat2;
  let x_1779 : vec3<f32> = (vec3<f32>(x_1775.x, x_1775.y, x_1775.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1780 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1779.x, x_1779.y, x_1779.z, x_1780.w);
  let x_1782 : vec4<f32> = u_xlat2;
  let x_1785 : vec3<f32> = log2(abs(vec3<f32>(x_1782.x, x_1782.y, x_1782.z)));
  let x_1786 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1785.x, x_1785.y, x_1785.z, x_1786.w);
  let x_1788 : vec4<f32> = u_xlat2;
  let x_1792 : vec3<f32> = (vec3<f32>(x_1788.x, x_1788.y, x_1788.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1802 : vec3<f32> = u_xlat0;
  let x_1804 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1802.x, x_1802.y, x_1802.z, x_1802.x));
  u_xlatb0 = vec3<bool>(x_1804.x, x_1804.y, x_1804.z);
  let x_1809 : bool = u_xlatb0.x;
  if (x_1809) {
    let x_1814 : f32 = u_xlat1.x;
    x_1810 = x_1814;
  } else {
    let x_1817 : f32 = u_xlat2.x;
    x_1810 = x_1817;
  }
