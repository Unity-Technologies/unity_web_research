...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    if(u_xlatb30){
        ...
        if(u_xlatb30){
            ...
            if(u_xlatb55){
                u_xlat55.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat55.xy = floor(u_xlat55.xy);
                u_xlat6.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat55.xy);
                ...
                vec3 txVec19 = vec3(u_xlat62.xy,vs_TEXCOORD6.z);
                ...
                vec3 txVec23 = vec3(u_xlat32.xy,vs_TEXCOORD6.z);
                ...
                vec3 txVec28 = vec3(u_xlat55.xy,vs_TEXCOORD6.z);
    ...
    u_xlat55.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat30.x = u_xlat30.x * _MainLightShadowParams.x + u_xlat55.x;
    u_xlatb55 = 0.0>=vs_TEXCOORD6.z;
    u_xlatb80 = vs_TEXCOORD6.z>=1.0;
    u_xlatb55 = u_xlatb80 || u_xlatb55;
    u_xlat30.x = (u_xlatb55) ? 1.0 : u_xlat30.x;
    u_xlat6.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat55.x = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat80 = u_xlat55.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
    u_xlat6.x = (-u_xlat30.x) + 1.0;
    u_xlat30.x = u_xlat80 * u_xlat6.x + u_xlat30.x;
    u_xlat80 = dot((-u_xlat3.xyz), u_xlat2.xyz);
    u_xlat80 = u_xlat80 + u_xlat80;
    u_xlat6.xyz = u_xlat2.xyz * (-vec3(u_xlat80)) + (-u_xlat3.xyz);
    ...
    u_xlat4.xyz = u_xlat4.xyz * u_xlat26.xyz + u_xlat6.xyz;
    u_xlat75 = u_xlat30.x * unity_LightData.z;
    ...
    u_xlat77 = u_xlat55.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat77 = clamp(u_xlat77, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat30.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat30.xyz;
    }
    u_xlat0.xyz = u_xlat32.xyz * u_xlat6.xyz + u_xlat4.xyz;
    SV_Target0.xyz = u_xlat30.xyz + u_xlat0.xyz;
