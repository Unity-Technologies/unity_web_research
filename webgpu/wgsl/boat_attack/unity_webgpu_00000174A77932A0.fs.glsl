...
;
    ...
    u_xlat43.xy = u_xlat0.xy;
    u_xlat61 = 0.0;
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<4u ; u_xlatu_loop_1++)
    {
        u_xlat43.xy = u_xlat5.xy + u_xlat43.xy;
        u_xlat25.x = float(u_xlatu_loop_1);
        u_xlat44.xy = u_xlat25.xx * _ScreenParams.xy + u_xlat43.xy;
        u_xlat7.xyz = texture(sampler2D(_DitherPattern, sampler_DitherPattern), u_xlat44.xy, _GlobalMipBias.x).xyz;
        u_xlat7.xyz = u_xlat7.xzy * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
        u_xlat7.xyw = u_xlat41.yyy * u_xlat7.xyz;
        u_xlat7.xyw = u_xlat25.xxx * u_xlat7.xyw;
        u_xlat7.xyw = u_xlat7.xyw * vec3(0.100000001, 0.100000001, 0.100000001) + vs_TEXCOORD1.xyz;
        u_xlat25.x = u_xlat25.x + u_xlat7.z;
        u_xlat25.xyz = u_xlat4.xyz * u_xlat25.xxx + u_xlat7.xyw;
        u_xlat7.xyz = u_xlat25.xyz + (-_CascadeShadowSplitSpheres0.xyz);
        u_xlat8.xyz = u_xlat25.xyz + (-_CascadeShadowSplitSpheres1.xyz);
        u_xlat9.xyz = u_xlat25.xyz + (-_CascadeShadowSplitSpheres2.xyz);
        u_xlat10.xyz = u_xlat25.xyz + (-_CascadeShadowSplitSpheres3.xyz);
...
;
        ...
        u_xlat26.xyz = u_xlat25.yyy * _MainLightWorldToShadow[(u_xlati7 + 1) / 4][(u_xlati7 + 1) % 4].xyz;
        u_xlat26.xyz = _MainLightWorldToShadow[u_xlati7 / 4][u_xlati7 % 4].xyz * u_xlat25.xxx + u_xlat26.xyz;
        u_xlat25.xyz = _MainLightWorldToShadow[(u_xlati7 + 2) / 4][(u_xlati7 + 2) % 4].xyz * u_xlat25.zzz + u_xlat26.xyz;
        u_xlat25.xyz = u_xlat25.xyz + _MainLightWorldToShadow[(u_xlati7 + 3) / 4][(u_xlati7 + 3) % 4].xyz;
        vec3 txVec30 = vec3(u_xlat25.xy,u_xlat25.z);
        u_xlat25.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec30, 0.0);
...
;
    ...
    SV_Target0.xyz = vec3(u_xlat19) * u_xlat1.xyz + u_xlat0.xzw;
    SV_Target0.w = 1.0;
    return;
}
