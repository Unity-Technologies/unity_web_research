...
fn main_1() {
  ...
  let x_1482 : vec3<f32> = (vec3<f32>(x_1480.x, x_1480.y, x_1480.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1483 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1482.x, x_1482.y, x_1482.z, x_1483.w);
  let x_1485 : vec4<f32> = u_xlat0;
  let x_1488 : vec3<f32> = log2(abs(vec3<f32>(x_1485.x, x_1485.y, x_1485.z)));
  let x_1489 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1488.x, x_1488.y, x_1488.z, x_1489.w);
  let x_1491 : vec4<f32> = u_xlat2;
  let x_1493 : vec3<f32> = (vec3<f32>(x_1491.x, x_1491.y, x_1491.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1494 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1493.x, x_1493.y, x_1493.z, x_1494.w);
  let x_1496 : vec4<f32> = u_xlat2;
  let x_1498 : vec3<f32> = exp2(vec3<f32>(x_1496.x, x_1496.y, x_1496.z));
  let x_1499 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1498.x, x_1498.y, x_1498.z, x_1499.w);
  let x_1501 : vec4<f32> = u_xlat2;
  let x_1504 : vec3<f32> = ((vec3<f32>(x_1501.x, x_1501.y, x_1501.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1505 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1504.x, x_1504.y, x_1504.z, x_1505.w);
  let x_1507 : vec4<f32> = u_xlat0;
  let x_1509 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1507.x, x_1507.y, x_1507.z, x_1507.x));
  u_xlatb0 = vec3<bool>(x_1509.x, x_1509.y, x_1509.z);
  ...
  let x_1521 : f32 = x_1513;
  u_xlat0.x = x_1521;
  let x_1524 : bool = u_xlatb0.y;
  if (x_1524) {
    let x_1529 : f32 = u_xlat1.y;
    x_1525 = x_1529;
  } else {
    let x_1532 : f32 = u_xlat2.y;
    x_1525 = x_1532;
  }
  let x_1533 : f32 = x_1525;
  u_xlat0.y = x_1533;
  let x_1536 : bool = u_xlatb0.z;
  if (x_1536) {
  ...
  u_xlat0.z = x_1545;
  let x_1547 : vec2<f32> = vs_TEXCOORD0;
  let x_1550 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1554 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1556 : vec2<f32> = ((x_1547 * vec2<f32>(x_1550.x, x_1550.y)) + vec2<f32>(x_1554.z, x_1554.w));
  let x_1557 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1556.x, x_1556.y, x_1557.z, x_1557.w);
  let x_1564 : vec4<f32> = u_xlat1;
  let x_1567 : f32 = x_38.x_GlobalMipBias.x;
  let x_1568 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1564.x, x_1564.y), x_1567);
  u_xlat15 = x_1568.w;
  let x_1570 : f32 = u_xlat15;
  u_xlat15 = ((x_1570 * 2.0f) + -1.0f);
  let x_1573 : f32 = u_xlat15;
  u_xlatb1 = (x_1573 >= 0.0f);
  let x_1575 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1575);
  let x_1578 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1578)) + 1.0f);
  let x_1582 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1582);
  let x_1584 : f32 = u_xlat15;
  u_xlat15 = (-(x_1584) + 1.0f);
  let x_1587 : f32 = u_xlat15;
  let x_1589 : f32 = u_xlat1.x;
  u_xlat15 = (x_1587 * x_1589);
  let x_1591 : vec4<f32> = u_xlat0;
  let x_1593 : vec3<f32> = (vec3<f32>(x_1591.x, x_1591.y, x_1591.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1594 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1593.x, x_1593.y, x_1593.z, x_1594.w);
  let x_1596 : vec4<f32> = u_xlat0;
  let x_1599 : vec3<f32> = log2(abs(vec3<f32>(x_1596.x, x_1596.y, x_1596.z)));
  let x_1600 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1599.x, x_1599.y, x_1599.z, x_1600.w);
  let x_1602 : vec4<f32> = u_xlat2;
  let x_1604 : vec3<f32> = (vec3<f32>(x_1602.x, x_1602.y, x_1602.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1605 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1604.x, x_1604.y, x_1604.z, x_1605.w);
  let x_1607 : vec4<f32> = u_xlat2;
  let x_1609 : vec3<f32> = exp2(vec3<f32>(x_1607.x, x_1607.y, x_1607.z));
  let x_1610 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1609.x, x_1609.y, x_1609.z, x_1610.w);
  let x_1612 : vec4<f32> = u_xlat2;
  let x_1615 : vec3<f32> = ((vec3<f32>(x_1612.x, x_1612.y, x_1612.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1616 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1615.x, x_1615.y, x_1615.z, x_1616.w);
  let x_1618 : vec4<f32> = u_xlat0;
  let x_1620 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1618.x, x_1618.y, x_1618.z, x_1618.x));
  u_xlatb0 = vec3<bool>(x_1620.x, x_1620.y, x_1620.z);
  let x_1623 : bool = u_xlatb0.x;
  if (x_1623) {
  ...
  let x_1632 : f32 = x_1624;
  u_xlat0.x = x_1632;
  let x_1635 : bool = u_xlatb0.y;
  if (x_1635) {
    let x_1640 : f32 = u_xlat1.y;
    x_1636 = x_1640;
  } else {
  ...
  u_xlat0.y = x_1644;
  let x_1647 : bool = u_xlatb0.z;
  if (x_1647) {
    let x_1652 : f32 = u_xlat1.z;
    x_1648 = x_1652;
  } else {
  ...
  u_xlat0.z = x_1656;
  let x_1658 : f32 = u_xlat15;
  let x_1663 : vec4<f32> = u_xlat0;
  let x_1665 : vec3<f32> = ((vec3<f32>(x_1658, x_1658, x_1658) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1663.x, x_1663.y, x_1663.z));
  let x_1666 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1666.w);
  let x_1668 : vec4<f32> = u_xlat0;
  let x_1670 : vec3<f32> = (vec3<f32>(x_1668.x, x_1668.y, x_1668.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1671 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1670.x, x_1670.y, x_1670.z, x_1671.w);
  let x_1673 : vec4<f32> = u_xlat0;
  let x_1675 : vec3<f32> = (vec3<f32>(x_1673.x, x_1673.y, x_1673.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1676 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1675.x, x_1675.y, x_1675.z, x_1676.w);
  let x_1678 : vec4<f32> = u_xlat2;
  let x_1680 : vec3<f32> = (vec3<f32>(x_1678.x, x_1678.y, x_1678.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  ...
  let x_1691 : vec3<f32> = (vec3<f32>(x_1689.x, x_1689.y, x_1689.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1692 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1691.x, x_1691.y, x_1691.z, x_1692.w);
  let x_1694 : vec4<f32> = u_xlat2;
  let x_1696 : vec3<f32> = exp2(vec3<f32>(x_1694.x, x_1694.y, x_1694.z));
  let x_1697 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1696.x, x_1696.y, x_1696.z, x_1697.w);
  let x_1699 : vec4<f32> = u_xlat0;
  let x_1701 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1699.x, x_1699.y, x_1699.z, x_1699.x));
  u_xlatb0 = vec3<bool>(x_1701.x, x_1701.y, x_1701.z);
  ...
  u_xlat0.x = x_1713;
  let x_1716 : bool = u_xlatb0.y;
  if (x_1716) {
    let x_1721 : f32 = u_xlat1.y;
    x_1717 = x_1721;
  } else {
    let x_1724 : f32 = u_xlat2.y;
    x_1717 = x_1724;
  }
  let x_1725 : f32 = x_1717;
  u_xlat0.y = x_1725;
  let x_1728 : bool = u_xlatb0.z;
  if (x_1728) {
    let x_1733 : f32 = u_xlat1.z;
    x_1729 = x_1733;
  } else {
  ...
  let x_1743 : vec3<f32> = max(vec3<f32>(x_1741.x, x_1741.y, x_1741.z), vec3<f32>(0.0f, 0.0f, 0.0f));
