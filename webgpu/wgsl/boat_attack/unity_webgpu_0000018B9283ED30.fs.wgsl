...
fn main_1() {
  ...
  let x_1419 : vec2<f32> = vs_TEXCOORD0;
  let x_1422 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1426 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1428 : vec2<f32> = ((x_1419 * vec2<f32>(x_1422.x, x_1422.y)) + vec2<f32>(x_1426.z, x_1426.w));
  let x_1429 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1428.x, x_1428.y, x_1429.z, x_1429.w);
  let x_1436 : vec4<f32> = u_xlat1;
  let x_1439 : f32 = x_14.x_GlobalMipBias.x;
  let x_1440 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1436.x, x_1436.y), x_1439);
  u_xlat15 = x_1440.w;
  let x_1442 : f32 = u_xlat15;
  u_xlat15 = ((x_1442 * 2.0f) + -1.0f);
  let x_1445 : f32 = u_xlat15;
  u_xlatb1 = (x_1445 >= 0.0f);
  let x_1447 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1447);
  let x_1450 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1450)) + 1.0f);
  let x_1454 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1454);
  let x_1456 : f32 = u_xlat15;
  u_xlat15 = (-(x_1456) + 1.0f);
  let x_1459 : f32 = u_xlat15;
  let x_1461 : f32 = u_xlat1.x;
  u_xlat15 = (x_1459 * x_1461);
  let x_1463 : vec3<f32> = u_xlat0;
  let x_1464 : vec3<f32> = (x_1463 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1465 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1464.x, x_1464.y, x_1464.z, x_1465.w);
  let x_1467 : vec3<f32> = u_xlat0;
  let x_1469 : vec3<f32> = log2(abs(x_1467));
  let x_1470 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1469.x, x_1469.y, x_1469.z, x_1470.w);
  let x_1472 : vec4<f32> = u_xlat2;
  let x_1474 : vec3<f32> = (vec3<f32>(x_1472.x, x_1472.y, x_1472.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1475 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1474.x, x_1474.y, x_1474.z, x_1475.w);
  let x_1477 : vec4<f32> = u_xlat2;
  let x_1479 : vec3<f32> = exp2(vec3<f32>(x_1477.x, x_1477.y, x_1477.z));
  let x_1480 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1479.x, x_1479.y, x_1479.z, x_1480.w);
  let x_1482 : vec4<f32> = u_xlat2;
  let x_1485 : vec3<f32> = ((vec3<f32>(x_1482.x, x_1482.y, x_1482.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1486 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1485.x, x_1485.y, x_1485.z, x_1486.w);
  let x_1488 : vec3<f32> = u_xlat0;
  let x_1490 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1488.x, x_1488.y, x_1488.z, x_1488.x));
  ...
  let x_1533 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1528, x_1528, x_1528) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1533);
  let x_1535 : vec3<f32> = u_xlat0;
  let x_1536 : vec3<f32> = (x_1535 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1537 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1536.x, x_1536.y, x_1536.z, x_1537.w);
  let x_1539 : vec3<f32> = u_xlat0;
  let x_1540 : vec3<f32> = (x_1539 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1541 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1540.x, x_1540.y, x_1540.z, x_1541.w);
  let x_1543 : vec4<f32> = u_xlat2;
  let x_1545 : vec3<f32> = (vec3<f32>(x_1543.x, x_1543.y, x_1543.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1546 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1545.x, x_1545.y, x_1545.z, x_1546.w);
  let x_1548 : vec4<f32> = u_xlat2;
  let x_1551 : vec3<f32> = log2(abs(vec3<f32>(x_1548.x, x_1548.y, x_1548.z)));
  let x_1552 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1551.x, x_1551.y, x_1551.z, x_1552.w);
  let x_1554 : vec4<f32> = u_xlat2;
  let x_1556 : vec3<f32> = (vec3<f32>(x_1554.x, x_1554.y, x_1554.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1566 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1564.x, x_1564.y, x_1564.z, x_1564.x));
  ...
  let x_1607 : vec3<f32> = max(x_1606, vec3<f32>(0.0f, 0.0f, 0.0f));
