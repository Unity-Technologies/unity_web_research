...
;
    ...
    u_xlat4.xyz = unity_SHC.xyz * vec3(u_xlat44) + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat48 = dot(_AdditionalLightsSpotDir[int(u_xlatu46)].xyz, u_xlat10.xyz);
        u_xlat48 = u_xlat48 * _AdditionalLightsAttenuation[int(u_xlatu46)].z + _AdditionalLightsAttenuation[int(u_xlatu46)].w;
        u_xlat48 = clamp(u_xlat48, 0.0, 1.0);
        u_xlat48 = u_xlat48 * u_xlat48;
        u_xlat47 = u_xlat47 * u_xlat48;
        u_xlatu48 = u_xlatu46 >> (5u & uint(0x1F));
        u_xlati49 = 1 << (int(u_xlatu46) & int(0x1F));
        u_xlati48 = int(uint(u_xlati49) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu48)]));
        if(u_xlati48 != 0) {
            u_xlati48 = int(_AdditionalLightsLightTypes[int(u_xlatu46)]);
            u_xlati49 = (u_xlati48 != 0) ? 0 : 1;
            u_xlati50 = int(u_xlatu46) << (2 & int(0x1F));
            if(u_xlati49 != 0) {
                ...
                if(u_xlati48 != 0) {
                    u_xlat39.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati50 + 1) / 4][(u_xlati50 + 1) % 4].xy;
                    u_xlat39.xy = _AdditionalLightsWorldToLights[u_xlati50 / 4][u_xlati50 % 4].xy * vs_TEXCOORD7.xx + u_xlat39.xy;
                    u_xlat39.xy = _AdditionalLightsWorldToLights[(u_xlati50 + 2) / 4][(u_xlati50 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat39.xy;
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat34) + u_xlat7.xyz;
        ...
        u_xlat46 = u_xlat18 / u_xlat46;
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat46) + u_xlat5.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * u_xlat4.xxx + u_xlat15.xyz;
