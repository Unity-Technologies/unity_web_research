...
void main()
{
    ...
    u_xlat27.xyz = unity_SHC.xyz * vec3(u_xlat76) + u_xlat6.xyz;
    ...
    u_xlat3.x = u_xlat50 + (-u_xlat76);
    u_xlat28.xyz = vec3(u_xlat76) * u_xlat5.xyz;
    ...
    u_xlat27.xyz = u_xlat27.xyz * u_xlat28.xyz + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu50 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat81 = u_xlat76 / u_xlat81;
        u_xlat8.xyz = u_xlat4.xyz * vec3(u_xlat81) + u_xlat28.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat27.xyz * vec3(u_xlat25) + u_xlat5.xzw;
    u_xlat0.xyz = u_xlat7.xyz + u_xlat0.xyz;
    u_xlat0.xyz = vec3(u_xlat75) * u_xlat0.xyz;
    u_xlat75 = u_xlat2.x * (-u_xlat2.x);
