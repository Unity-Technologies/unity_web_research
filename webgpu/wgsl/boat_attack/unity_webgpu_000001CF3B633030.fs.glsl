...
void main()
{
    ...
    u_xlat26.x = u_xlat2.y * u_xlat2.y;
    u_xlat26.x = u_xlat2.x * u_xlat2.x + (-u_xlat26.x);
    u_xlat26.xyz = unity_SHC.xyz * u_xlat26.xxx + u_xlat6.xyz;
    ...
    u_xlat6.xyz = u_xlat2.xyz * (-vec3(u_xlat55)) + (-u_xlat3.xyz);
    ...
    u_xlat32.xyz = vec3(u_xlat55) * u_xlat32.xyz + u_xlat0.xyz;
    u_xlat32.xyz = u_xlat1.xxx * u_xlat32.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat32.xyz;
    u_xlat1.xyz = u_xlat26.xyz * u_xlat4.xyz + u_xlat6.xyz;
    u_xlat75 = u_xlat5.x * unity_LightData.z;
    u_xlat76 = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
    u_xlat75 = u_xlat75 * u_xlat76;
    u_xlat5.xzw = vec3(u_xlat75) * _MainLightColor.xyz;
    ...
    u_xlat75 = clamp(u_xlat75, 0.0, 1.0);
    u_xlat76 = dot(_MainLightPosition.xyz, u_xlat6.xyz);
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat30.x = dot(unity_LightIndices[int(u_xlatu30)], uintBitsToFloat(ImmCB_0[u_xlati81]));
        u_xlati30 = int(u_xlat30.x);
        u_xlat8.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati30].www + _AdditionalLightsPosition[u_xlati30].xyz;
        ...
        u_xlat81 = u_xlat81 * _AdditionalLightsAttenuation[u_xlati30].x;
        u_xlat81 = (-u_xlat81) * u_xlat81 + 1.0;
        u_xlat81 = max(u_xlat81, 0.0);
        u_xlat81 = u_xlat81 * u_xlat81;
        u_xlat81 = u_xlat81 * u_xlat84;
        u_xlat84 = dot(_AdditionalLightsSpotDir[u_xlati30].xyz, u_xlat9.xyz);
        u_xlat84 = u_xlat84 * _AdditionalLightsAttenuation[u_xlati30].z + _AdditionalLightsAttenuation[u_xlati30].w;
        u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
        u_xlat84 = u_xlat84 * u_xlat84;
        u_xlat81 = u_xlat81 * u_xlat84;
        u_xlati84 = int(_AdditionalShadowParams[u_xlati30].w);
        ...
        if(u_xlatb10.x){
            ...
            if(u_xlatb10.x){
                ...
                u_xlat35.x = trunc(_AdditionalShadowParams[u_xlati30].w);
            ...
            u_xlatb84 = 0.0<_AdditionalShadowParams[u_xlati30].y;
            if(u_xlatb84){
                u_xlatb84 = 1.0==_AdditionalShadowParams[u_xlati30].y;
                if(u_xlatb84){
            ...
            u_xlat10.x = 1.0 + (-_AdditionalShadowParams[u_xlati30].x);
            u_xlat84 = u_xlat84 * _AdditionalShadowParams[u_xlati30].x + u_xlat10.x;
        ...
        u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
        u_xlat81 = u_xlat81 * u_xlat84;
        u_xlat10.xyz = vec3(u_xlat81) * _AdditionalLightsColor[u_xlati30].xyz;
        ...
        u_xlat30.x = dot(u_xlat2.xyz, u_xlat8.xyz);
        ...
        u_xlat30.x = u_xlat30.x * u_xlat7.x + 1.00001001;
        u_xlat81 = u_xlat81 * u_xlat81;
        u_xlat30.x = u_xlat30.x * u_xlat30.x;
        u_xlat81 = max(u_xlat81, 0.100000001);
        u_xlat30.x = u_xlat30.x * u_xlat81;
        u_xlat30.x = u_xlat78 * u_xlat30.x;
        u_xlat30.x = u_xlat79 / u_xlat30.x;
        u_xlat8.xyz = u_xlat0.xyz * u_xlat30.xxx + u_xlat4.xyz;
