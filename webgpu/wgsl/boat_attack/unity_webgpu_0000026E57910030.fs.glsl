...
void main()
{
    ...
    u_xlat77 = dot(u_xlat2.xyz, u_xlat3.xyz);
    ...
    u_xlat31.x = dot((-u_xlat1.xyz), u_xlat2.xyz);
    u_xlat31.x = u_xlat31.x + u_xlat31.x;
    u_xlat31.xyz = u_xlat2.xyz * (-u_xlat31.xxx) + (-u_xlat1.xyz);
    u_xlat7.x = dot(u_xlat2.xyz, u_xlat1.xyz);
    u_xlat7.x = clamp(u_xlat7.x, 0.0, 1.0);
    u_xlat7.x = (-u_xlat7.x) + 1.0;
    u_xlat7.x = u_xlat7.x * u_xlat7.x;
    u_xlat7.x = u_xlat7.x * u_xlat7.x;
    u_xlat32.x = (-u_xlat0.x) * 0.699999988 + 1.70000005;
    u_xlat0.x = u_xlat0.x * u_xlat32.x;
    u_xlat0.x = u_xlat0.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat31.xyz, u_xlat0.x);
    ...
    u_xlat31.xyz = u_xlat8.xyz * u_xlat0.xxx;
    u_xlat0.xz = vec2(u_xlat50) * vec2(u_xlat50) + vec2(-1.0, 1.0);
    u_xlat50 = float(1.0) / u_xlat0.z;
    u_xlat32.xyz = (-u_xlat5.xyz) + vec3(u_xlat78);
    u_xlat7.xyz = u_xlat7.xxx * u_xlat32.xyz + u_xlat5.xyz;
    ...
    u_xlat50 = u_xlat80 * unity_LightData.z;
    u_xlat78 = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
    u_xlat50 = u_xlat50 * u_xlat78;
    u_xlat31.xyz = vec3(u_xlat50) * _MainLightColor.xyz;
    ...
    u_xlat78 = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
    ...
    u_xlat78 = u_xlat6.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu50 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat84 = u_xlat78 * u_xlat10.x + u_xlat84;
        u_xlat82 = u_xlat82 * u_xlat84;
        ...
        u_xlat6.x = u_xlat77 / u_xlat6.x;
        u_xlat8.xyz = u_xlat5.xyz * u_xlat6.xxx + u_xlat4.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat25) + u_xlat31.xyz;
