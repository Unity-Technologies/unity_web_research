...
;
    ...
    u_xlat6.xyz = unity_SHC.xyz * vec3(u_xlat77) + u_xlat7.xyz;
    ...
    u_xlat33.xyz = vec3(u_xlat53) * u_xlat33.xyz + u_xlat5.xyz;
    ...
    u_xlat33.xyz = u_xlat1.xyz + _MainLightPosition.xyz;
    u_xlat0.x = dot(u_xlat33.xyz, u_xlat33.xyz);
    u_xlat0.x = max(u_xlat0.x, 1.17549435e-38);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat33.xyz = u_xlat0.xxx * u_xlat33.xyz;
    u_xlat0.x = dot(u_xlat2.xyz, u_xlat33.xyz);
    ...
    u_xlat33.xyz = u_xlat5.xyz * u_xlat0.xxx + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat33.xyz;
    u_xlat0.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu0 =  uint(int(u_xlat0.x));
    u_xlat50 = u_xlat28 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
    u_xlat3.x = float(0.0);
    u_xlat3.y = float(0.0);
    u_xlat3.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat33.xyz = u_xlat33.xyz * vec3(u_xlat82) + u_xlat1.xyz;
        ...
        u_xlat80 = dot(u_xlat2.xyz, u_xlat33.xyz);
        ...
        u_xlat33.xyz = u_xlat5.xyz * vec3(u_xlat80) + u_xlat6.xyz;
        u_xlat3.xyz = u_xlat33.xyz * u_xlat10.xyz + u_xlat3.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat25) + u_xlat7.xyz;
