...
fn main_1() {
  ...
  let x_1576 : vec3<f32> = (x_1575 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1577 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1576.x, x_1576.y, x_1576.z, x_1577.w);
  let x_1579 : vec3<f32> = u_xlat0;
  let x_1581 : vec3<f32> = log2(abs(x_1579));
  let x_1582 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1581.x, x_1581.y, x_1581.z, x_1582.w);
  let x_1584 : vec4<f32> = u_xlat2;
  let x_1586 : vec3<f32> = (vec3<f32>(x_1584.x, x_1584.y, x_1584.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1587 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1586.x, x_1586.y, x_1586.z, x_1587.w);
  let x_1589 : vec4<f32> = u_xlat2;
  let x_1591 : vec3<f32> = exp2(vec3<f32>(x_1589.x, x_1589.y, x_1589.z));
  let x_1592 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1591.x, x_1591.y, x_1591.z, x_1592.w);
  let x_1594 : vec4<f32> = u_xlat2;
  let x_1597 : vec3<f32> = ((vec3<f32>(x_1594.x, x_1594.y, x_1594.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1598 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1597.x, x_1597.y, x_1597.z, x_1598.w);
  let x_1600 : vec3<f32> = u_xlat0;
  let x_1602 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1600.x, x_1600.y, x_1600.z, x_1600.x));
  u_xlatb0 = vec3<bool>(x_1602.x, x_1602.y, x_1602.z);
  let x_1605 : bool = u_xlatb0.x;
  if (x_1605) {
  ...
  u_xlat0.x = x_1614;
  let x_1617 : bool = u_xlatb0.y;
  if (x_1617) {
    let x_1622 : f32 = u_xlat1.y;
    x_1618 = x_1622;
  } else {
    let x_1625 : f32 = u_xlat2.y;
    x_1618 = x_1625;
  }
  let x_1626 : f32 = x_1618;
  u_xlat0.y = x_1626;
  let x_1629 : bool = u_xlatb0.z;
  if (x_1629) {
    let x_1634 : f32 = u_xlat1.z;
    x_1630 = x_1634;
  } else {
  ...
  u_xlat0.z = x_1638;
  let x_1640 : vec2<f32> = vs_TEXCOORD0;
  let x_1643 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1647 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1649 : vec2<f32> = ((x_1640 * vec2<f32>(x_1643.x, x_1643.y)) + vec2<f32>(x_1647.z, x_1647.w));
  let x_1650 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1649.x, x_1649.y, x_1650.z, x_1650.w);
  let x_1657 : vec4<f32> = u_xlat1;
  let x_1660 : f32 = x_14.x_GlobalMipBias.x;
  let x_1661 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1657.x, x_1657.y), x_1660);
  u_xlat18 = x_1661.w;
  let x_1663 : f32 = u_xlat18;
  u_xlat18 = ((x_1663 * 2.0f) + -1.0f);
  let x_1666 : f32 = u_xlat18;
  u_xlatb1 = (x_1666 >= 0.0f);
  let x_1668 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1668);
  let x_1671 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1671)) + 1.0f);
  let x_1675 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1675);
  let x_1677 : f32 = u_xlat18;
  u_xlat18 = (-(x_1677) + 1.0f);
  let x_1680 : f32 = u_xlat18;
  let x_1682 : f32 = u_xlat1.x;
  u_xlat18 = (x_1680 * x_1682);
  let x_1684 : vec3<f32> = u_xlat0;
  let x_1685 : vec3<f32> = (x_1684 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1686 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1685.x, x_1685.y, x_1685.z, x_1686.w);
  let x_1688 : vec3<f32> = u_xlat0;
  let x_1690 : vec3<f32> = log2(abs(x_1688));
  let x_1691 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1690.x, x_1690.y, x_1690.z, x_1691.w);
  let x_1693 : vec4<f32> = u_xlat2;
  let x_1695 : vec3<f32> = (vec3<f32>(x_1693.x, x_1693.y, x_1693.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1696 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1695.x, x_1695.y, x_1695.z, x_1696.w);
  let x_1698 : vec4<f32> = u_xlat2;
  let x_1700 : vec3<f32> = exp2(vec3<f32>(x_1698.x, x_1698.y, x_1698.z));
  let x_1701 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1700.x, x_1700.y, x_1700.z, x_1701.w);
  let x_1703 : vec4<f32> = u_xlat2;
  let x_1706 : vec3<f32> = ((vec3<f32>(x_1703.x, x_1703.y, x_1703.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1707 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1706.x, x_1706.y, x_1706.z, x_1707.w);
  let x_1709 : vec3<f32> = u_xlat0;
  let x_1711 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1709.x, x_1709.y, x_1709.z, x_1709.x));
  u_xlatb0 = vec3<bool>(x_1711.x, x_1711.y, x_1711.z);
  let x_1714 : bool = u_xlatb0.x;
  if (x_1714) {
  ...
  u_xlat0.x = x_1723;
  let x_1726 : bool = u_xlatb0.y;
  if (x_1726) {
    let x_1731 : f32 = u_xlat1.y;
    x_1727 = x_1731;
  } else {
  ...
  u_xlat0.y = x_1735;
  let x_1738 : bool = u_xlatb0.z;
  if (x_1738) {
    let x_1743 : f32 = u_xlat1.z;
    x_1739 = x_1743;
  } else {
  ...
  u_xlat0.z = x_1747;
  let x_1749 : f32 = u_xlat18;
  let x_1754 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1749, x_1749, x_1749) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1754);
  let x_1756 : vec3<f32> = u_xlat0;
  let x_1757 : vec3<f32> = (x_1756 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1758 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1757.x, x_1757.y, x_1757.z, x_1758.w);
  let x_1760 : vec3<f32> = u_xlat0;
  let x_1761 : vec3<f32> = (x_1760 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1762 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1761.x, x_1761.y, x_1761.z, x_1762.w);
  let x_1764 : vec4<f32> = u_xlat2;
  let x_1766 : vec3<f32> = (vec3<f32>(x_1764.x, x_1764.y, x_1764.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1767 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1766.x, x_1766.y, x_1766.z, x_1767.w);
  let x_1769 : vec4<f32> = u_xlat2;
  let x_1772 : vec3<f32> = log2(abs(vec3<f32>(x_1769.x, x_1769.y, x_1769.z)));
  let x_1773 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1772.x, x_1772.y, x_1772.z, x_1773.w);
  let x_1775 : vec4<f32> = u_xlat2;
  let x_1777 : vec3<f32> = (vec3<f32>(x_1775.x, x_1775.y, x_1775.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1778 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1777.x, x_1777.y, x_1777.z, x_1778.w);
  let x_1780 : vec4<f32> = u_xlat2;
  let x_1782 : vec3<f32> = exp2(vec3<f32>(x_1780.x, x_1780.y, x_1780.z));
  let x_1783 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1782.x, x_1782.y, x_1782.z, x_1783.w);
  let x_1785 : vec3<f32> = u_xlat0;
  let x_1787 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1785.x, x_1785.y, x_1785.z, x_1785.x));
  u_xlatb0 = vec3<bool>(x_1787.x, x_1787.y, x_1787.z);
  ...
  u_xlat0.x = x_1799;
  let x_1802 : bool = u_xlatb0.y;
  if (x_1802) {
    let x_1807 : f32 = u_xlat1.y;
    x_1803 = x_1807;
  } else {
    let x_1810 : f32 = u_xlat2.y;
    x_1803 = x_1810;
  }
  let x_1811 : f32 = x_1803;
  u_xlat0.y = x_1811;
  let x_1814 : bool = u_xlatb0.z;
  if (x_1814) {
    let x_1819 : f32 = u_xlat1.z;
    x_1815 = x_1819;
  } else {
  ...
  let x_1828 : vec3<f32> = max(x_1827, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1829 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1828.x, x_1828.y, x_1828.z, x_1829.w);
  SV_Target0.w = 1.0f;
  return;
}
