...
fn main_1() {
  ...
  let x_787 : f32 = vs_TEXCOORD9;
  let x_790 : f32 = x_21.x_ProjectionParams.y;
  u_xlat12 = (x_787 / x_790);
  let x_792 : f32 = u_xlat12;
  u_xlat12 = (-(x_792) + 1.0f);
  let x_795 : f32 = u_xlat12;
  let x_797 : f32 = x_21.x_ProjectionParams.z;
  u_xlat12 = (x_795 * x_797);
  let x_799 : f32 = u_xlat12;
  u_xlat12 = max(x_799, 0.0f);
  let x_801 : f32 = u_xlat12;
  let x_804 : f32 = x_21.unity_FogParams.x;
  u_xlat12 = (x_801 * x_804);
  let x_806 : f32 = u_xlat12;
  let x_807 : f32 = u_xlat12;
  u_xlat12 = (x_806 * -(x_807));
  let x_810 : f32 = u_xlat12;
  u_xlat12 = exp2(x_810);
  let x_812 : vec4<f32> = u_xlat0;
  let x_814 : f32 = u_xlat12;
  let x_816 : vec3<f32> = (vec3<f32>(x_812.x, x_812.y, x_812.z) * vec3<f32>(x_814, x_814, x_814));
