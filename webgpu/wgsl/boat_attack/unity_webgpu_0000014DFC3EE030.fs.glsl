...
;
    ...
    if(u_xlatb72){
        ...
        if(u_xlatb72){
            ...
            if(u_xlatb73){
                ...
                u_xlat28.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec5, 0.0);
                u_xlat28.x = u_xlat28.x * u_xlat12.y;
                u_xlat5.x = u_xlat12.x * u_xlat5.x + u_xlat28.x;
                vec3 txVec6 = vec3(u_xlat51.xy,u_xlat3.z);
                u_xlat28.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat5.x = u_xlat12.z * u_xlat28.x + u_xlat5.x;
                vec3 txVec7 = vec3(u_xlat8.xy,u_xlat3.z);
                u_xlat28.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat5.x = u_xlat12.w * u_xlat28.x + u_xlat5.x;
                vec3 txVec8 = vec3(u_xlat10.xy,u_xlat3.z);
                u_xlat28.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat5.x = u_xlat13.x * u_xlat28.x + u_xlat5.x;
                vec3 txVec9 = vec3(u_xlat10.zw,u_xlat3.z);
                u_xlat28.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat5.x = u_xlat13.y * u_xlat28.x + u_xlat5.x;
                vec3 txVec10 = vec3(u_xlat8.zw,u_xlat3.z);
                u_xlat28.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat5.x = u_xlat13.z * u_xlat28.x + u_xlat5.x;
                vec3 txVec11 = vec3(u_xlat7.xy,u_xlat3.z);
                u_xlat28.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat5.x = u_xlat13.w * u_xlat28.x + u_xlat5.x;
                vec3 txVec12 = vec3(u_xlat7.zw,u_xlat3.z);
                u_xlat28.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                u_xlat72 = u_xlat73 * u_xlat28.x + u_xlat5.x;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat51.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
    ...
    u_xlat49 = u_xlat26.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
    u_xlat72 = (-u_xlat3.x) + 1.0;
    u_xlat3.x = u_xlat49 * u_xlat72 + u_xlat3.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu5 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat75 = inversesqrt(u_xlat52);
        u_xlat7.xyz = vec3(u_xlat75) * u_xlat7.xyz;
        u_xlat75 = float(1.0) / float(u_xlat52);
        u_xlat52 = u_xlat52 * _AdditionalLightsAttenuation[u_xlati29].x;
        u_xlat52 = (-u_xlat52) * u_xlat52 + 1.0;
        u_xlat52 = max(u_xlat52, 0.0);
        u_xlat52 = u_xlat52 * u_xlat52;
        u_xlat52 = u_xlat52 * u_xlat75;
        ...
        u_xlat75 = u_xlat26.x * u_xlat76 + u_xlat75;
        u_xlat52 = u_xlat75 * u_xlat52;
        u_xlat29.xyz = vec3(u_xlat52) * _AdditionalLightsColor[u_xlati29].xyz;
