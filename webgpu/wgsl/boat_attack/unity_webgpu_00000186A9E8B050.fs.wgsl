...
fn main_1() {
  ...
  let x_1758 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1762 : vec4<f32> = x_26.x_Dithering_Params;
  ...
  let x_1776 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1772.x, x_1772.y), x_1775);
  u_xlat21 = x_1776.w;
  let x_1778 : f32 = u_xlat21;
  u_xlat21 = ((x_1778 * 2.0f) + -1.0f);
  let x_1781 : f32 = u_xlat21;
  u_xlatb1 = (x_1781 >= 0.0f);
  let x_1783 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1783);
  let x_1786 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1786)) + 1.0f);
  let x_1790 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1790);
  let x_1792 : f32 = u_xlat21;
  u_xlat21 = (-(x_1792) + 1.0f);
  let x_1795 : f32 = u_xlat21;
  let x_1797 : f32 = u_xlat1.x;
  u_xlat21 = (x_1795 * x_1797);
  let x_1799 : vec3<f32> = u_xlat0;
  let x_1800 : vec3<f32> = (x_1799 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1801 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1800.x, x_1800.y, x_1800.z, x_1801.w);
  let x_1803 : vec3<f32> = u_xlat0;
  let x_1805 : vec3<f32> = log2(abs(x_1803));
  let x_1806 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1805.x, x_1805.y, x_1805.z, x_1806.w);
  let x_1808 : vec4<f32> = u_xlat2;
  let x_1810 : vec3<f32> = (vec3<f32>(x_1808.x, x_1808.y, x_1808.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1811 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1810.x, x_1810.y, x_1810.z, x_1811.w);
  let x_1813 : vec4<f32> = u_xlat2;
  let x_1815 : vec3<f32> = exp2(vec3<f32>(x_1813.x, x_1813.y, x_1813.z));
  let x_1816 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1815.x, x_1815.y, x_1815.z, x_1816.w);
  let x_1818 : vec4<f32> = u_xlat2;
  let x_1821 : vec3<f32> = ((vec3<f32>(x_1818.x, x_1818.y, x_1818.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1822 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1821.x, x_1821.y, x_1821.z, x_1822.w);
  let x_1824 : vec3<f32> = u_xlat0;
  let x_1826 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1824.x, x_1824.y, x_1824.z, x_1824.x));
  u_xlatb0 = vec3<bool>(x_1826.x, x_1826.y, x_1826.z);
  let x_1829 : bool = u_xlatb0.x;
  if (x_1829) {
  ...
  u_xlat0.z = x_1862;
  let x_1864 : f32 = u_xlat21;
  let x_1869 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1864, x_1864, x_1864) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1869);
  let x_1871 : vec3<f32> = u_xlat0;
  let x_1872 : vec3<f32> = (x_1871 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1873 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1872.x, x_1872.y, x_1872.z, x_1873.w);
  let x_1875 : vec3<f32> = u_xlat0;
  let x_1876 : vec3<f32> = (x_1875 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1877 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1876.x, x_1876.y, x_1876.z, x_1877.w);
  let x_1879 : vec4<f32> = u_xlat2;
  let x_1881 : vec3<f32> = (vec3<f32>(x_1879.x, x_1879.y, x_1879.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1882 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1881.x, x_1881.y, x_1881.z, x_1882.w);
  let x_1884 : vec4<f32> = u_xlat2;
  let x_1887 : vec3<f32> = log2(abs(vec3<f32>(x_1884.x, x_1884.y, x_1884.z)));
  let x_1888 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1887.x, x_1887.y, x_1887.z, x_1888.w);
  let x_1890 : vec4<f32> = u_xlat2;
  let x_1892 : vec3<f32> = (vec3<f32>(x_1890.x, x_1890.y, x_1890.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1893 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1892.x, x_1892.y, x_1892.z, x_1893.w);
  let x_1895 : vec4<f32> = u_xlat2;
  let x_1897 : vec3<f32> = exp2(vec3<f32>(x_1895.x, x_1895.y, x_1895.z));
  let x_1898 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1897.x, x_1897.y, x_1897.z, x_1898.w);
  let x_1900 : vec3<f32> = u_xlat0;
  let x_1902 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1900.x, x_1900.y, x_1900.z, x_1900.x));
  u_xlatb0 = vec3<bool>(x_1902.x, x_1902.y, x_1902.z);
  let x_1905 : bool = u_xlatb0.x;
  if (x_1905) {
    let x_1910 : f32 = u_xlat1.x;
    x_1906 = x_1910;
  } else {
    let x_1913 : f32 = u_xlat2.x;
    x_1906 = x_1913;
  }
  let x_1914 : f32 = x_1906;
  u_xlat0.x = x_1914;
  let x_1917 : bool = u_xlatb0.y;
  if (x_1917) {
    let x_1922 : f32 = u_xlat1.y;
    x_1918 = x_1922;
  } else {
    let x_1925 : f32 = u_xlat2.y;
    x_1918 = x_1925;
  }
  let x_1926 : f32 = x_1918;
  u_xlat0.y = x_1926;
  let x_1929 : bool = u_xlatb0.z;
  if (x_1929) {
    let x_1934 : f32 = u_xlat1.z;
    x_1930 = x_1934;
  } else {
    let x_1937 : f32 = u_xlat2.z;
    x_1930 = x_1937;
  }
  let x_1938 : f32 = x_1930;
  u_xlat0.z = x_1938;
  let x_1942 : vec3<f32> = u_xlat0;
  let x_1943 : vec3<f32> = max(x_1942, vec3<f32>(0.0f, 0.0f, 0.0f));
