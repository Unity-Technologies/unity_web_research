...
fn main_1() {
  ...
  u_xlat0.x = (x_60 + -0.06274499744176864624f);
  ...
  let x_120 : vec2<f32> = (vec2<f32>(x_115.x, x_115.w) + vec2<f32>(-0.87253999710083007812f, -1.06861996650695800781f));
  ...
  SV_Target0.y = (x_133 + 0.53136998414993286133f);
  return;
}
