...
;
    ...
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati35 + 1) / 4][(u_xlati35 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati35 / 4][u_xlati35 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati35 + 2) / 4][(u_xlati35 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati35 + 3) / 4][(u_xlati35 + 3) % 4].xyz;
    u_xlat35 = vs_TEXCOORD7.y * unity_MatrixV[1].z;
    u_xlat35 = unity_MatrixV[0].z * vs_TEXCOORD7.x + u_xlat35;
    u_xlat35 = unity_MatrixV[2].z * vs_TEXCOORD7.z + u_xlat35;
    ...
    u_xlat36 = (-u_xlat1) * 0.959999979 + 0.959999979;
    ...
    u_xlat14 = dot((-u_xlat12.xyz), u_xlat2.xyz);
    u_xlat14 = u_xlat14 + u_xlat14;
    u_xlat8.xyz = u_xlat2.xyz * (-vec3(u_xlat14)) + (-u_xlat12.xyz);
    u_xlat14 = dot(u_xlat2.xyz, u_xlat12.xyz);
    u_xlat14 = clamp(u_xlat14, 0.0, 1.0);
    u_xlat14 = (-u_xlat14) + 1.0;
    u_xlat14 = u_xlat14 * u_xlat14;
    u_xlat14 = u_xlat14 * u_xlat14;
    u_xlat25.x = (-u_xlat1) * 0.699999988 + 1.70000005;
    u_xlat1 = u_xlat1 * u_xlat25.x;
    u_xlat1 = u_xlat1 * 6.0;
    ...
    u_xlat1 = float(1.0) / u_xlat25.y;
    u_xlat9.xyz = (-u_xlat0.xyz) + vec3(u_xlat33);
    u_xlat9.xyz = vec3(u_xlat14) * u_xlat9.xyz + u_xlat0.xyz;
    ...
    u_xlat3.xyw = vec3(u_xlat33) * u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat39 = u_xlat39 * u_xlat41;
        u_xlat10.xyz = vec3(u_xlat27) * _AdditionalLightsColor[u_xlati38].xyz;
