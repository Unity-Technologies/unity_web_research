...
fn main_1() {
  ...
  let x_200 : vec4<f32> = x_189.unity_FogColor;
  u_xlat0 = ((vec3<f32>(x_194.x, x_194.y, x_194.z) * x_196) + -(vec3<f32>(x_200.x, x_200.y, x_200.z)));
  let x_207 : f32 = u_xlat1.w;
  SV_Target0.w = x_207;
  let x_211 : f32 = vs_TEXCOORD3.w;
  let x_213 : f32 = vs_TEXCOORD3.w;
  u_xlat9 = (x_211 * -(x_213));
  let x_216 : f32 = u_xlat9;
  u_xlat9 = exp2(x_216);
  let x_218 : f32 = u_xlat9;
  let x_220 : vec3<f32> = u_xlat0;
  let x_223 : vec4<f32> = x_189.unity_FogColor;
  let x_225 : vec3<f32> = ((vec3<f32>(x_218, x_218, x_218) * x_220) + vec3<f32>(x_223.x, x_223.y, x_223.z));
  let x_226 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_225.x, x_225.y, x_225.z, x_226.w);
  return;
}
