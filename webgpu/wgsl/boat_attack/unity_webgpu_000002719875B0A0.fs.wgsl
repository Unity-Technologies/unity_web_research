...
fn main_1() {
  ...
  loop {
    ...
    let x_1420 : u32 = u_xlatu1;
    let x_1423 : vec4<f32> = x_1066.unity_LightIndices[bitcast<i32>(x_1420)];
    let x_1432 : i32 = u_xlati38;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1437 : vec4<u32> = indexable[x_1432];
    u_xlat1.x = dot(x_1423, bitcast<vec4<f32>>(x_1437));
    let x_1443 : f32 = u_xlat1.x;
    u_xlati1 = i32(x_1443);
    let x_1445 : vec3<f32> = vs_TEXCOORD1;
    let x_1456 : i32 = u_xlati1;
    let x_1458 : vec4<f32> = x_1455.x_AdditionalLightsPosition[x_1456];
    let x_1461 : i32 = u_xlati1;
    let x_1463 : vec4<f32> = x_1455.x_AdditionalLightsPosition[x_1461];
    u_xlat9 = ((-(x_1445) * vec3<f32>(x_1458.w, x_1458.w, x_1458.w)) + vec3<f32>(x_1463.x, x_1463.y, x_1463.z));
    let x_1466 : vec3<f32> = u_xlat9;
    let x_1467 : vec3<f32> = u_xlat9;
    u_xlat38 = dot(x_1466, x_1467);
    let x_1469 : f32 = u_xlat38;
    u_xlat38 = max(x_1469, 0.00006103515625f);
    let x_1471 : f32 = u_xlat38;
    u_xlat15.x = inverseSqrt(x_1471);
    let x_1475 : vec3<f32> = u_xlat15;
    let x_1477 : vec3<f32> = u_xlat9;
    u_xlat10 = (vec3<f32>(x_1475.x, x_1475.x, x_1475.x) * x_1477);
    let x_1479 : f32 = u_xlat38;
    u_xlat27.x = (1.0f / x_1479);
    let x_1482 : f32 = u_xlat38;
    let x_1483 : i32 = u_xlati1;
    let x_1485 : f32 = x_1455.x_AdditionalLightsAttenuation[x_1483].x;
    u_xlat38 = (x_1482 * x_1485);
    let x_1487 : f32 = u_xlat38;
    let x_1489 : f32 = u_xlat38;
    u_xlat38 = ((-(x_1487) * x_1489) + 1.0f);
    let x_1492 : f32 = u_xlat38;
    u_xlat38 = max(x_1492, 0.0f);
    let x_1494 : f32 = u_xlat38;
    let x_1495 : f32 = u_xlat38;
    u_xlat38 = (x_1494 * x_1495);
    let x_1497 : f32 = u_xlat38;
    let x_1499 : f32 = u_xlat27.x;
    u_xlat38 = (x_1497 * x_1499);
    let x_1501 : i32 = u_xlati1;
    let x_1503 : vec4<f32> = x_1455.x_AdditionalLightsSpotDir[x_1501];
    let x_1505 : vec3<f32> = u_xlat10;
    u_xlat27.x = dot(vec3<f32>(x_1503.x, x_1503.y, x_1503.z), x_1505);
    let x_1509 : f32 = u_xlat27.x;
    let x_1510 : i32 = u_xlati1;
    let x_1512 : f32 = x_1455.x_AdditionalLightsAttenuation[x_1510].z;
    let x_1514 : i32 = u_xlati1;
    let x_1516 : f32 = x_1455.x_AdditionalLightsAttenuation[x_1514].w;
    u_xlat27.x = ((x_1509 * x_1512) + x_1516);
    let x_1520 : f32 = u_xlat27.x;
    u_xlat27.x = clamp(x_1520, 0.0f, 1.0f);
    let x_1524 : f32 = u_xlat27.x;
    let x_1526 : f32 = u_xlat27.x;
    u_xlat27.x = (x_1524 * x_1526);
    let x_1529 : f32 = u_xlat38;
    let x_1531 : f32 = u_xlat27.x;
    u_xlat38 = (x_1529 * x_1531);
    let x_1533 : vec4<f32> = u_xlat2;
    let x_1535 : vec3<f32> = u_xlat10;
    u_xlat27.x = dot(vec3<f32>(x_1533.x, x_1533.y, x_1533.z), x_1535);
    let x_1539 : f32 = u_xlat27.x;
    u_xlat27.x = clamp(x_1539, 0.0f, 1.0f);
    let x_1542 : f32 = u_xlat38;
    let x_1544 : f32 = u_xlat27.x;
    u_xlat27.x = (x_1542 * x_1544);
    let x_1548 : vec2<f32> = u_xlat27;
    let x_1550 : i32 = u_xlati1;
    let x_1552 : vec4<f32> = x_1455.x_AdditionalLightsColor[x_1550];
    u_xlat11 = (vec3<f32>(x_1548.x, x_1548.x, x_1548.x) * vec3<f32>(x_1552.x, x_1552.y, x_1552.z));
    let x_1555 : vec3<f32> = u_xlat9;
    let x_1556 : vec3<f32> = u_xlat15;
    let x_1559 : vec3<f32> = vs_TEXCOORD2;
    u_xlat9 = ((x_1555 * vec3<f32>(x_1556.x, x_1556.x, x_1556.x)) + x_1559);
    ...
    u_xlat9 = (vec3<f32>(x_1573.x, x_1573.x, x_1573.x) * x_1575);
    ...
    let x_1587 : vec3<f32> = u_xlat9;
    u_xlat15.y = dot(x_1586, x_1587);
    let x_1591 : f32 = u_xlat15.y;
    u_xlat15.y = clamp(x_1591, 0.0f, 1.0f);
    let x_1594 : vec3<f32> = u_xlat15;
    let x_1596 : vec3<f32> = u_xlat15;
    let x_1598 : vec2<f32> = (vec2<f32>(x_1594.x, x_1594.y) * vec2<f32>(x_1596.x, x_1596.y));
    let x_1599 : vec3<f32> = u_xlat15;
    u_xlat15 = vec3<f32>(x_1598.x, x_1598.y, x_1599.z);
    let x_1602 : f32 = u_xlat15.x;
    u_xlat15.x = ((x_1602 * -0.99993896484375f) + 1.00001001358032226562f);
    let x_1607 : f32 = u_xlat15.x;
    let x_1609 : f32 = u_xlat15.x;
    u_xlat15.x = (x_1607 * x_1609);
    let x_1613 : f32 = u_xlat15.y;
    u_xlat27.x = max(x_1613, 0.10000000149011611938f);
    let x_1617 : f32 = u_xlat27.x;
    let x_1619 : f32 = u_xlat15.x;
    u_xlat15.x = (x_1617 * x_1619);
    let x_1623 : f32 = u_xlat15.x;
    u_xlat15.x = (x_1623 * 2.03125f);
    let x_1627 : f32 = u_xlat15.x;
    u_xlat15.x = (0.00006103515625f / x_1627);
    let x_1631 : f32 = u_xlat15.x;
    u_xlat15.x = (x_1631 * 0.03999999910593032837f);
    let x_1634 : vec3<f32> = u_xlat15;
    let x_1636 : vec3<f32> = u_xlat11;
    let x_1638 : vec3<f32> = u_xlat8;
    u_xlat8 = ((vec3<f32>(x_1634.x, x_1634.x, x_1634.x) * x_1636) + x_1638);
    let x_1640 : f32 = u_xlat38;
    let x_1642 : i32 = u_xlati1;
    let x_1644 : vec4<f32> = x_1455.x_AdditionalLightsColor[x_1642];
    let x_1647 : vec4<f32> = u_xlat7;
    let x_1649 : vec3<f32> = ((vec3<f32>(x_1640, x_1640, x_1640) * vec3<f32>(x_1644.x, x_1644.y, x_1644.z)) + vec3<f32>(x_1647.x, x_1647.y, x_1647.z));
    let x_1650 : vec4<f32> = u_xlat7;
    u_xlat7 = vec4<f32>(x_1649.x, x_1649.y, x_1649.z, x_1650.w);

    continuing {
      let x_1652 : u32 = u_xlatu_loop_2;
      u_xlatu_loop_2 = (x_1652 + bitcast<u32>(1i));
    }
  }
  let x_1654 : f32 = u_xlat37;
  let x_1655 : f32 = u_xlat24;
  u_xlat5.x = (x_1654 * x_1655);
  u_xlat5.y = 0.375f;
  u_xlat5.z = 0.0f;
  let x_1664 : vec4<f32> = u_xlat5;
  let x_1667 : f32 = x_40.x_GlobalMipBias.x;
  let x_1668 : vec4<f32> = textureSampleBias(x_AbsorptionScatteringRamp, sampler_AbsorptionScatteringRamp, vec2<f32>(x_1664.x, x_1664.y), x_1667);
  let x_1669 : vec3<f32> = vec3<f32>(x_1668.x, x_1668.y, x_1668.z);
  let x_1670 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1669.x, x_1670.y, x_1669.y, x_1669.z);
  let x_1672 : vec3<f32> = vs_TEXCOORD2;
  let x_1674 : vec4<f32> = u_xlat2;
  u_xlat1.x = dot(-(x_1672), vec3<f32>(x_1674.x, x_1674.y, x_1674.z));
  let x_1679 : f32 = u_xlat1.x;
  let x_1681 : f32 = u_xlat1.x;
  u_xlat1.x = (x_1679 + x_1681);
  let x_1684 : vec4<f32> = u_xlat2;
  let x_1686 : vec3<f32> = u_xlat1;
  let x_1690 : vec3<f32> = vs_TEXCOORD2;
  let x_1692 : vec3<f32> = ((vec3<f32>(x_1684.x, x_1684.y, x_1684.z) * -(vec3<f32>(x_1686.x, x_1686.x, x_1686.x))) + -(x_1690));
  let x_1693 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1692.x, x_1692.y, x_1692.z, x_1693.w);
  let x_1703 : vec4<f32> = u_xlat2;
  let x_1706 : f32 = x_40.x_GlobalMipBias.x;
  let x_1707 : vec4<f32> = textureSampleBias(x_CubemapTexture, sampler_CubemapTexture, vec3<f32>(x_1703.x, x_1703.y, x_1703.z), x_1706);
  let x_1708 : vec3<f32> = vec3<f32>(x_1707.x, x_1707.y, x_1707.z);
  let x_1709 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1708.x, x_1708.y, x_1708.z, x_1709.w);
  let x_1716 : vec2<f32> = u_xlat13;
  let x_1718 : f32 = u_xlat27.y;
  let x_1719 : vec4<f32> = textureSampleLevel(x_CameraOpaqueTexture, sampler_CameraOpaqueTexture_linear_clamp, x_1716, x_1718);
  u_xlat1 = vec3<f32>(x_1719.x, x_1719.y, x_1719.z);
  let x_1724 : vec4<f32> = u_xlat5;
  let x_1727 : f32 = x_40.x_GlobalMipBias.x;
  let x_1728 : vec4<f32> = textureSampleBias(x_AbsorptionScatteringRamp, sampler_AbsorptionScatteringRamp, vec2<f32>(x_1724.x, x_1724.z), x_1727);
  u_xlat15 = vec3<f32>(x_1728.x, x_1728.y, x_1728.z);
  let x_1730 : vec3<f32> = u_xlat1;
  let x_1731 : vec3<f32> = u_xlat15;
  let x_1732 : vec3<f32> = (x_1730 * x_1731);
  let x_1733 : vec4<f32> = u_xlat5;
  u_xlat5 = vec4<f32>(x_1732.x, x_1732.y, x_1732.z, x_1733.w);
  let x_1735 : vec3<f32> = u_xlat1;
  let x_1737 : vec3<f32> = u_xlat15;
  let x_1739 : vec4<f32> = u_xlat2;
  u_xlat1 = ((-(x_1735) * x_1737) + vec3<f32>(x_1739.x, x_1739.y, x_1739.z));
  let x_1742 : f32 = u_xlat3;
  let x_1744 : vec3<f32> = u_xlat1;
  let x_1746 : vec4<f32> = u_xlat5;
  u_xlat1 = ((vec3<f32>(x_1742, x_1742, x_1742) * x_1744) + vec3<f32>(x_1746.x, x_1746.y, x_1746.z));
  let x_1749 : vec4<f32> = u_xlat7;
  let x_1751 : vec4<f32> = u_xlat0;
  let x_1754 : vec3<f32> = u_xlat1;
  let x_1755 : vec3<f32> = ((vec3<f32>(x_1749.x, x_1749.y, x_1749.z) * vec3<f32>(x_1751.x, x_1751.z, x_1751.w)) + x_1754);
  let x_1756 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1755.x, x_1756.y, x_1755.y, x_1755.z);
  let x_1758 : vec3<f32> = u_xlat8;
  let x_1759 : vec4<f32> = u_xlat0;
  let x_1761 : vec3<f32> = (x_1758 + vec3<f32>(x_1759.x, x_1759.z, x_1759.w));
  let x_1762 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1761.x, x_1762.y, x_1761.y, x_1761.z);
  let x_1764 : f32 = u_xlat12;
  let x_1766 : vec3<f32> = u_xlat4;
  let x_1768 : vec4<f32> = u_xlat0;
  u_xlat1 = ((vec3<f32>(x_1764, x_1764, x_1764) * x_1766) + -(vec3<f32>(x_1768.x, x_1768.z, x_1768.w)));
  let x_1772 : f32 = u_xlat12;
  let x_1774 : vec3<f32> = u_xlat1;
  let x_1776 : vec4<f32> = u_xlat0;
  let x_1778 : vec3<f32> = ((vec3<f32>(x_1772, x_1772, x_1772) * x_1774) + vec3<f32>(x_1776.x, x_1776.z, x_1776.w));
  let x_1779 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1778.x, x_1778.y, x_1778.z, x_1779.w);
  let x_1784 : f32 = vs_TEXCOORD4.x;
  let x_1786 : f32 = vs_TEXCOORD4.x;
  u_xlat36 = (x_1784 * -(x_1786));
  let x_1789 : f32 = u_xlat36;
  u_xlat36 = exp2(x_1789);
  let x_1791 : vec4<f32> = u_xlat0;
  let x_1794 : vec4<f32> = x_40.unity_FogColor;
  let x_1797 : vec3<f32> = (vec3<f32>(x_1791.x, x_1791.y, x_1791.z) + -(vec3<f32>(x_1794.x, x_1794.y, x_1794.z)));
  let x_1798 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1797.x, x_1797.y, x_1797.z, x_1798.w);
  let x_1802 : f32 = u_xlat36;
  let x_1804 : vec4<f32> = u_xlat0;
  let x_1808 : vec4<f32> = x_40.unity_FogColor;
  let x_1810 : vec3<f32> = ((vec3<f32>(x_1802, x_1802, x_1802) * vec3<f32>(x_1804.x, x_1804.y, x_1804.z)) + vec3<f32>(x_1808.x, x_1808.y, x_1808.z));
  let x_1811 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1810.x, x_1810.y, x_1810.z, x_1811.w);
  SV_Target0.w = 1.0f;
  return;
}
