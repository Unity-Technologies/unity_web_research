...
fn main_1() {
  ...
  u_xlat9 = (x_109 * 3.1424999237060546875f);
  ...
  let x_153 : vec2<f32> = ((vec2<f32>(x_145.x, x_145.x) * vec2<f32>(x_147.x, x_147.x)) + vec2<f32>(-0.37999999523162841797f, -0.58000004291534423828f));
  let x_154 : vec3<f32> = u_xlat0;
  u_xlat0 = vec3<f32>(x_153.x, x_153.y, x_154.z);
  let x_156 : vec3<f32> = u_xlat0;
  let x_161 : vec2<f32> = (vec2<f32>(x_156.x, x_156.y) * vec2<f32>(24.9999866485595703125f, 25.0000247955322265625f));
