...
void main()
{
    ...
    u_xlat33 = u_xlat19.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat33 = clamp(u_xlat33, 0.0, 1.0);
    u_xlat47 = (-u_xlat5.x) + 1.0;
    u_xlat5.x = u_xlat33 * u_xlat47 + u_xlat5.x;
    u_xlat6.x = vs_TEXCOORD3.w;
    u_xlat6.y = vs_TEXCOORD4.w;
    u_xlat6.z = vs_TEXCOORD5.w;
    u_xlat33 = dot((-u_xlat6.xyz), u_xlat1.xyz);
    u_xlat33 = u_xlat33 + u_xlat33;
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat33)) + (-u_xlat6.xyz);
    ...
    u_xlat8.xyz = vec3(u_xlat33) * u_xlat8.xyz + u_xlat4.xyz;
    ...
    u_xlat5.xzw = vec3(u_xlat28) * _MainLightColor.xyz;
    ...
    u_xlat7.xyz = u_xlat4.xyz * vec3(u_xlat28) + u_xlat17.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat51 = u_xlat3.x * u_xlat10.x + u_xlat51;
        u_xlat49 = u_xlat49 * u_xlat51;
        u_xlat51 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat51 = clamp(u_xlat51, 0.0, 1.0);
        u_xlat49 = u_xlat49 * u_xlat51;
        u_xlat10.xyz = vec3(u_xlat49) * _AdditionalLightsColor[u_xlati48].xyz;
        ...
        u_xlat8.xyz = u_xlat4.xyz * vec3(u_xlat48) + u_xlat17.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat2.xyz * vec3(u_xlat14) + u_xlat5.xzw;
