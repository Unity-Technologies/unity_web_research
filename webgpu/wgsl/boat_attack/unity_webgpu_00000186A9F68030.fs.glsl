...
;
    ...
    u_xlat19.xz = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat5.xy = u_xlat19.xz * hlslcc_FragCoord.xy;
    u_xlat19.x = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat5.z = (-u_xlat19.x) + 1.0;
    u_xlat19.x = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat5.xz, _GlobalMipBias.x).x;
    u_xlat57 = u_xlat19.x + -1.0;
    ...
    if(u_xlatb1){
        ...
        if(u_xlatb1){
            ...
            if(u_xlatb59){
                ...
                u_xlat1.x = u_xlat59 * u_xlat61 + u_xlat60;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat43.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat1.x = u_xlat6.w * u_xlat60 + u_xlat59;
            }
        }
    } else {
    ...
    u_xlat1.x = u_xlat1.x * _MainLightShadowParams.x + u_xlat59;
    u_xlatb59 = 0.0>=u_xlat3.z;
    u_xlatb3.x = u_xlat3.z>=1.0;
    u_xlatb59 = u_xlatb59 || u_xlatb3.x;
    u_xlat1.x = (u_xlatb59) ? 1.0 : u_xlat1.x;
    ...
    u_xlat1.x = u_xlat59 * u_xlat3.x + u_xlat1.x;
    ...
    u_xlat19.x = u_xlat1.x * unity_LightData.z;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu19 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat7.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu59)].www + _AdditionalLightsPosition[int(u_xlatu59)].xyz;
        ...
        if(u_xlati61 != 0) {
            ...
            if(u_xlati43 != 0) {
                u_xlat8.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati62 + 1) / 4][(u_xlati62 + 1) % 4].xyw;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[u_xlati62 / 4][u_xlati62 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat8.xyz;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[(u_xlati62 + 2) / 4][(u_xlati62 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat8.xyz;
                ...
                if(u_xlati61 != 0) {
                    u_xlat46.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati62 + 1) / 4][(u_xlati62 + 1) % 4].xy;
                    u_xlat46.xy = _AdditionalLightsWorldToLights[u_xlati62 / 4][u_xlati62 % 4].xy * vs_TEXCOORD1.xx + u_xlat46.xy;
                    u_xlat46.xy = _AdditionalLightsWorldToLights[(u_xlati62 + 2) / 4][(u_xlati62 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat46.xy;
                    ...
                    u_xlat9 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati62 + 1) / 4][(u_xlati62 + 1) % 4];
                    u_xlat9 = _AdditionalLightsWorldToLights[u_xlati62 / 4][u_xlati62 % 4] * vs_TEXCOORD1.xxxx + u_xlat9;
                    u_xlat9 = _AdditionalLightsWorldToLights[(u_xlati62 + 2) / 4][(u_xlati62 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat9;
