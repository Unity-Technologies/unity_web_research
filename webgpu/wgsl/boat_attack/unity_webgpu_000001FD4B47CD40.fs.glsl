...
;
    ...
    u_xlat67 = dot(u_xlat3, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat67 = (-u_xlat67) + 4.0;
    u_xlatu67 = uint(u_xlat67);
    u_xlati67 = int(u_xlatu67) << (2 & int(0x1F));
    u_xlat2.xyz = vs_TEXCOORD1.yyy * _MainLightWorldToShadow[(u_xlati67 + 1) / 4][(u_xlati67 + 1) % 4].xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[u_xlati67 / 4][u_xlati67 % 4].xyz * vs_TEXCOORD1.xxx + u_xlat2.xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[(u_xlati67 + 2) / 4][(u_xlati67 + 2) % 4].xyz * vs_TEXCOORD1.zzz + u_xlat2.xyz;
    u_xlat2.xyz = u_xlat2.xyz + _MainLightWorldToShadow[(u_xlati67 + 3) / 4][(u_xlati67 + 3) % 4].xyz;
    ...
    u_xlat67 = dot(u_xlat1.xyz, u_xlat3.xyz);
    u_xlat67 = u_xlat67 + 0.5;
    u_xlat3.xyz = vec3(u_xlat67) * u_xlat4.xyz;
    u_xlat67 = max(u_xlat3.w, 9.99999975e-05);
