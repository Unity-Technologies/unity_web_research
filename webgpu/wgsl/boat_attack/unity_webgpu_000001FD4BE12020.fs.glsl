...
;
    ...
    u_xlat71 = dot(u_xlat1.xyz, u_xlat4.xyz);
    u_xlat71 = u_xlat71 + 0.5;
    u_xlat4.xyz = vec3(u_xlat71) * u_xlat5.xyz;
    u_xlat71 = max(u_xlat4.w, 9.99999975e-05);
    u_xlat4.xyz = u_xlat4.xyz / vec3(u_xlat71);
    ...
    if(u_xlatb71){
        ...
        if(u_xlatb71){
            ...
            u_xlat71 = dot(u_xlat6, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb72){
                ...
                u_xlat71 = u_xlat72 * u_xlat5.x + u_xlat73;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat51.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat71 = u_xlat6.w * u_xlat73 + u_xlat72;
            }
        }
    } else {
    ...
    u_xlat71 = u_xlat71 * _MainLightShadowParams.x + u_xlat3.x;
    u_xlatb3.x = 0.0>=u_xlat3.z;
    u_xlatb26 = u_xlat3.z>=1.0;
    u_xlatb3.x = u_xlatb26 || u_xlatb3.x;
    u_xlat71 = (u_xlatb3.x) ? 1.0 : u_xlat71;
    u_xlat3.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat3.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat26.x = u_xlat3.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat26.x = clamp(u_xlat26.x, 0.0, 1.0);
    u_xlat49 = (-u_xlat71) + 1.0;
    u_xlat71 = u_xlat26.x * u_xlat49 + u_xlat71;
    ...
    u_xlat5.xyz = vec3(u_xlat71) * u_xlat26.xyz;
    ...
    for(uint u_xlatu_loop_1 = uint(0u) ; u_xlatu_loop_1<u_xlatu73 ; u_xlatu_loop_1++)
    {
            ...
            if(u_xlatb8.x){
                ...
                if(u_xlatb8.x){
                    ...
                    if(u_xlatb31){
                        ...
                        u_xlat54.x = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec34, 0.0);
                        ...
                        u_xlat54.x = u_xlat16.x * u_xlat54.x + u_xlat77;
                        ...
                        u_xlat54.x = u_xlat16.z * u_xlat77 + u_xlat54.x;
                        ...
                        u_xlat54.x = u_xlat16.w * u_xlat77 + u_xlat54.x;
                        ...
                        u_xlat54.x = u_xlat17.x * u_xlat77 + u_xlat54.x;
                        ...
                        u_xlat54.x = u_xlat17.y * u_xlat77 + u_xlat54.x;
                        ...
                        u_xlat54.x = u_xlat17.z * u_xlat77 + u_xlat54.x;
                        ...
                        u_xlat54.x = u_xlat17.w * u_xlat77 + u_xlat54.x;
                        ...
                        u_xlat8.x = u_xlat31.x * u_xlat77 + u_xlat54.x;
                    } else {
                        u_xlat31.xy = u_xlat30.xy * _AdditionalShadowmapSize.zw + vec2(0.5, 0.5);
                        u_xlat31.xy = floor(u_xlat31.xy);
                        u_xlat9.xy = u_xlat30.xy * _AdditionalShadowmapSize.zw + (-u_xlat31.xy);
        ...
        u_xlat30.x = u_xlat3.x * u_xlat53.x + u_xlat30.x;
        u_xlat7.x = u_xlat30.x * u_xlat7.x;
