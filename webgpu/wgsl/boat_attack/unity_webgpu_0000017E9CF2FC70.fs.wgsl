...
fn main_1() {
  ...
  let x_1413 : vec3<f32> = (vec3<f32>(x_1411.x, x_1411.y, x_1411.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1414 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1413.x, x_1413.y, x_1413.z, x_1414.w);
  let x_1416 : vec4<f32> = u_xlat0;
  let x_1419 : vec3<f32> = log2(abs(vec3<f32>(x_1416.x, x_1416.y, x_1416.z)));
  let x_1420 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1419.x, x_1419.y, x_1419.z, x_1420.w);
  let x_1422 : vec4<f32> = u_xlat2;
  let x_1424 : vec3<f32> = (vec3<f32>(x_1422.x, x_1422.y, x_1422.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1435 : vec3<f32> = ((vec3<f32>(x_1432.x, x_1432.y, x_1432.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1436 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1435.x, x_1435.y, x_1435.z, x_1436.w);
  let x_1438 : vec4<f32> = u_xlat0;
  let x_1440 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1438.x, x_1438.y, x_1438.z, x_1438.x));
  u_xlatb0 = vec3<bool>(x_1440.x, x_1440.y, x_1440.z);
  let x_1443 : bool = u_xlatb0.x;
  if (x_1443) {
  ...
  u_xlat0.x = x_1452;
  let x_1455 : bool = u_xlatb0.y;
  if (x_1455) {
    let x_1460 : f32 = u_xlat1.y;
    x_1456 = x_1460;
  } else {
    let x_1463 : f32 = u_xlat2.y;
    x_1456 = x_1463;
  }
  let x_1464 : f32 = x_1456;
  u_xlat0.y = x_1464;
  let x_1467 : bool = u_xlatb0.z;
  if (x_1467) {
  ...
  u_xlat0.z = x_1476;
  let x_1478 : vec2<f32> = vs_TEXCOORD0;
  let x_1481 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1485 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1487 : vec2<f32> = ((x_1478 * vec2<f32>(x_1481.x, x_1481.y)) + vec2<f32>(x_1485.z, x_1485.w));
  let x_1488 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1487.x, x_1487.y, x_1488.z, x_1488.w);
  let x_1495 : vec4<f32> = u_xlat1;
  let x_1498 : f32 = x_38.x_GlobalMipBias.x;
  let x_1499 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1495.x, x_1495.y), x_1498);
  u_xlat15 = x_1499.w;
  let x_1501 : f32 = u_xlat15;
  u_xlat15 = ((x_1501 * 2.0f) + -1.0f);
  let x_1504 : f32 = u_xlat15;
  u_xlatb1 = (x_1504 >= 0.0f);
  let x_1506 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1506);
  let x_1509 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1509)) + 1.0f);
  let x_1513 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1513);
  let x_1515 : f32 = u_xlat15;
  u_xlat15 = (-(x_1515) + 1.0f);
  let x_1518 : f32 = u_xlat15;
  let x_1520 : f32 = u_xlat1.x;
  u_xlat15 = (x_1518 * x_1520);
  let x_1522 : vec4<f32> = u_xlat0;
  let x_1524 : vec3<f32> = (vec3<f32>(x_1522.x, x_1522.y, x_1522.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1525 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1524.x, x_1524.y, x_1524.z, x_1525.w);
  let x_1527 : vec4<f32> = u_xlat0;
  let x_1530 : vec3<f32> = log2(abs(vec3<f32>(x_1527.x, x_1527.y, x_1527.z)));
  let x_1531 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1530.x, x_1530.y, x_1530.z, x_1531.w);
  let x_1533 : vec4<f32> = u_xlat2;
  let x_1535 : vec3<f32> = (vec3<f32>(x_1533.x, x_1533.y, x_1533.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1536 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1535.x, x_1535.y, x_1535.z, x_1536.w);
  let x_1538 : vec4<f32> = u_xlat2;
  let x_1540 : vec3<f32> = exp2(vec3<f32>(x_1538.x, x_1538.y, x_1538.z));
  let x_1541 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1540.x, x_1540.y, x_1540.z, x_1541.w);
  let x_1543 : vec4<f32> = u_xlat2;
  let x_1546 : vec3<f32> = ((vec3<f32>(x_1543.x, x_1543.y, x_1543.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1547 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1546.x, x_1546.y, x_1546.z, x_1547.w);
  let x_1549 : vec4<f32> = u_xlat0;
  let x_1551 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1549.x, x_1549.y, x_1549.z, x_1549.x));
  ...
  if (x_1566) {
    let x_1571 : f32 = u_xlat1.y;
    x_1567 = x_1571;
  } else {
    let x_1574 : f32 = u_xlat2.y;
    x_1567 = x_1574;
  }
  ...
  let x_1596 : vec3<f32> = ((vec3<f32>(x_1589, x_1589, x_1589) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1594.x, x_1594.y, x_1594.z));
  let x_1597 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1596.x, x_1596.y, x_1596.z, x_1597.w);
  let x_1599 : vec4<f32> = u_xlat0;
  let x_1601 : vec3<f32> = (vec3<f32>(x_1599.x, x_1599.y, x_1599.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1602 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1601.x, x_1601.y, x_1601.z, x_1602.w);
  let x_1604 : vec4<f32> = u_xlat0;
  let x_1606 : vec3<f32> = (vec3<f32>(x_1604.x, x_1604.y, x_1604.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1607 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1606.x, x_1606.y, x_1606.z, x_1607.w);
  let x_1609 : vec4<f32> = u_xlat2;
  let x_1611 : vec3<f32> = (vec3<f32>(x_1609.x, x_1609.y, x_1609.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1612 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1611.x, x_1611.y, x_1611.z, x_1612.w);
  let x_1614 : vec4<f32> = u_xlat2;
  let x_1617 : vec3<f32> = log2(abs(vec3<f32>(x_1614.x, x_1614.y, x_1614.z)));
  let x_1618 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1617.x, x_1617.y, x_1617.z, x_1618.w);
  let x_1620 : vec4<f32> = u_xlat2;
  let x_1622 : vec3<f32> = (vec3<f32>(x_1620.x, x_1620.y, x_1620.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1623 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1622.x, x_1622.y, x_1622.z, x_1623.w);
  let x_1625 : vec4<f32> = u_xlat2;
  let x_1627 : vec3<f32> = exp2(vec3<f32>(x_1625.x, x_1625.y, x_1625.z));
  let x_1628 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1627.x, x_1627.y, x_1627.z, x_1628.w);
  let x_1630 : vec4<f32> = u_xlat0;
  let x_1632 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1630.x, x_1630.y, x_1630.z, x_1630.x));
  u_xlatb0 = vec3<bool>(x_1632.x, x_1632.y, x_1632.z);
  let x_1635 : bool = u_xlatb0.x;
  if (x_1635) {
    let x_1640 : f32 = u_xlat1.x;
    x_1636 = x_1640;
  } else {
    let x_1643 : f32 = u_xlat2.x;
    x_1636 = x_1643;
  }
  let x_1644 : f32 = x_1636;
  u_xlat0.x = x_1644;
  let x_1647 : bool = u_xlatb0.y;
  if (x_1647) {
    let x_1652 : f32 = u_xlat1.y;
    x_1648 = x_1652;
  } else {
    let x_1655 : f32 = u_xlat2.y;
    x_1648 = x_1655;
  }
  let x_1656 : f32 = x_1648;
  u_xlat0.y = x_1656;
  let x_1659 : bool = u_xlatb0.z;
  if (x_1659) {
    let x_1664 : f32 = u_xlat1.z;
    x_1660 = x_1664;
  } else {
