...
fn main_1() {
  ...
  let x_1793 : vec4<f32> = u_xlat1;
  let x_1796 : vec3<f32> = u_xlat7;
  let x_1797 : vec3<f32> = ((vec3<f32>(x_1791.x, x_1791.x, x_1791.x) * vec3<f32>(x_1793.x, x_1793.y, x_1793.z)) + x_1796);
  let x_1798 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1797.x, x_1797.y, x_1797.z, x_1798.w);
  SV_Target0.w = 1.0f;
  return;
}
