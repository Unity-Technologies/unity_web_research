...
;
    ...
    u_xlat19.x = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat19.x = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat19.x;
    u_xlat19.x = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat19.x;
    u_xlat19.x = u_xlat19.x + unity_MatrixV[3].z;
    ...
    if(u_xlatb3.x){
        ...
        u_xlat60 = (u_xlatb5.y) ? u_xlat3.w : u_xlat3.x;
        u_xlat3.xyz = (u_xlatb5.x) ? u_xlat3.xyz : vec3(u_xlat60);
    } else {
        u_xlat3.x = float(1.0);
        u_xlat3.y = float(1.0);
        u_xlat3.z = float(1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu57 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat7.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu60)].www + _AdditionalLightsPosition[int(u_xlatu60)].xyz;
        ...
        u_xlat43.x = float(1.0) / float(u_xlat61);
        u_xlat61 = u_xlat61 * _AdditionalLightsAttenuation[int(u_xlatu60)].x;
        u_xlat61 = (-u_xlat61) * u_xlat61 + 1.0;
        u_xlat61 = max(u_xlat61, 0.0);
        u_xlat61 = u_xlat61 * u_xlat61;
        u_xlat61 = u_xlat61 * u_xlat43.x;
        u_xlat43.x = dot(_AdditionalLightsSpotDir[int(u_xlatu60)].xyz, u_xlat7.xyz);
        u_xlat43.x = u_xlat43.x * _AdditionalLightsAttenuation[int(u_xlatu60)].z + _AdditionalLightsAttenuation[int(u_xlatu60)].w;
        u_xlat43.x = clamp(u_xlat43.x, 0.0, 1.0);
        u_xlat43.x = u_xlat43.x * u_xlat43.x;
        u_xlat61 = u_xlat61 * u_xlat43.x;
        u_xlatu43 = u_xlatu60 >> (5u & uint(0x1F));
        u_xlati62 = 1 << (int(u_xlatu60) & int(0x1F));
        u_xlati43 = int(uint(u_xlati62) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu43)]));
        if(u_xlati43 != 0) {
            u_xlati43 = int(_AdditionalLightsLightTypes[int(u_xlatu60)]);
            u_xlati62 = (u_xlati43 != 0) ? 0 : 1;
            u_xlati63 = int(u_xlatu60) << (2 & int(0x1F));
            if(u_xlati62 != 0) {
                u_xlat8.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati63 + 1) / 4][(u_xlati63 + 1) % 4].xyw;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[u_xlati63 / 4][u_xlati63 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat8.xyz;
                u_xlat8.xyz = _AdditionalLightsWorldToLights[(u_xlati63 + 2) / 4][(u_xlati63 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat8.xyz;
                u_xlat8.xyz = u_xlat8.xyz + _AdditionalLightsWorldToLights[(u_xlati63 + 3) / 4][(u_xlati63 + 3) % 4].xyw;
                u_xlat8.xy = u_xlat8.xy / u_xlat8.zz;
                u_xlat8.xy = u_xlat8.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat8.xy = clamp(u_xlat8.xy, 0.0, 1.0);
                u_xlat8.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu60)].xy * u_xlat8.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu60)].zw;
            } else {
                u_xlatb43 = u_xlati43==1;
                u_xlati43 = u_xlatb43 ? 1 : int(0);
                if(u_xlati43 != 0) {
                    u_xlat43.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati63 + 1) / 4][(u_xlati63 + 1) % 4].xy;
                    u_xlat43.xy = _AdditionalLightsWorldToLights[u_xlati63 / 4][u_xlati63 % 4].xy * vs_TEXCOORD1.xx + u_xlat43.xy;
                    u_xlat43.xy = _AdditionalLightsWorldToLights[(u_xlati63 + 2) / 4][(u_xlati63 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat43.xy;
                    u_xlat43.xy = u_xlat43.xy + _AdditionalLightsWorldToLights[(u_xlati63 + 3) / 4][(u_xlati63 + 3) % 4].xy;
                    u_xlat43.xy = u_xlat43.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat43.xy = fract(u_xlat43.xy);
                    u_xlat8.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu60)].xy * u_xlat43.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu60)].zw;
                } else {
                    u_xlat9 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati63 + 1) / 4][(u_xlati63 + 1) % 4];
                    u_xlat9 = _AdditionalLightsWorldToLights[u_xlati63 / 4][u_xlati63 % 4] * vs_TEXCOORD1.xxxx + u_xlat9;
                    u_xlat9 = _AdditionalLightsWorldToLights[(u_xlati63 + 2) / 4][(u_xlati63 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat9;
                    u_xlat9 = u_xlat9 + _AdditionalLightsWorldToLights[(u_xlati63 + 3) / 4][(u_xlati63 + 3) % 4];
                    u_xlat9.xyz = u_xlat9.xyz / u_xlat9.www;
                    u_xlat43.x = dot(u_xlat9.xyz, u_xlat9.xyz);
                    u_xlat43.x = inversesqrt(u_xlat43.x);
                    u_xlat9.xyz = u_xlat43.xxx * u_xlat9.xyz;
                    u_xlat43.x = dot(abs(u_xlat9.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat43.x = max(u_xlat43.x, 9.99999997e-07);
                    u_xlat43.x = float(1.0) / float(u_xlat43.x);
                    u_xlat10.xyz = u_xlat43.xxx * u_xlat9.zxy;
                    u_xlat10.x = (-u_xlat10.x);
                    u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
                    u_xlatb46.xy = greaterThanEqual(u_xlat10.yzyz, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    u_xlat46.x = (u_xlatb46.x) ? u_xlat10.x : (-u_xlat10.x);
                    u_xlat46.y = (u_xlatb46.y) ? u_xlat10.x : (-u_xlat10.x);
                    u_xlat43.xy = u_xlat9.xy * u_xlat43.xx + u_xlat46.xy;
                    u_xlat43.xy = u_xlat43.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat43.x = (u_xlatb5.y) ? u_xlat8.w : u_xlat8.x;
            u_xlat8.xyz = (u_xlatb5.x) ? u_xlat8.xyz : u_xlat43.xxx;
        } else {
            u_xlat8.x = float(1.0);
            u_xlat8.y = float(1.0);
            u_xlat8.z = float(1.0);
        }
        u_xlat8.xyz = u_xlat8.xyz * _AdditionalLightsColor[int(u_xlatu60)].xyz;
        u_xlat8.xyz = u_xlat1.xxx * u_xlat8.xyz;
        u_xlat8.xyz = vec3(u_xlat61) * u_xlat8.xyz;
        u_xlat60 = dot(u_xlat2.xyz, u_xlat7.xyz);
        u_xlat60 = clamp(u_xlat60, 0.0, 1.0);
        u_xlat7.xyz = vec3(u_xlat60) * u_xlat8.xyz;
