...
;
    ...
    {
        u_xlat17.x = float(u_xlatu_loop_1);
        u_xlat29.xy = u_xlat17.xx * _ScreenParams.xy;
        u_xlat29.xy = u_xlat0.xy * _DitherPattern_TexelSize.xy + u_xlat29.xy;
        u_xlat6.xyz = texture(sampler2D(_DitherPattern, sampler_DitherPattern), u_xlat29.xy, _GlobalMipBias.x).xyz;
        u_xlat6.xyz = u_xlat6.xzy * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
        u_xlat6.xyw = u_xlat27.yyy * u_xlat6.xyz;
        u_xlat6.xyw = u_xlat17.xxx * u_xlat6.xyw;
        u_xlat6.xyw = u_xlat6.xyw * vec3(0.100000001, 0.100000001, 0.100000001) + vs_TEXCOORD1.xyz;
        u_xlat17.x = u_xlat17.x + u_xlat6.z;
        u_xlat17.xyz = u_xlat4.xyz * u_xlat17.xxx + u_xlat6.xyw;
        u_xlat6.xyz = u_xlat17.xyz + (-_CascadeShadowSplitSpheres0.xyz);
        u_xlat7.xyz = u_xlat17.xyz + (-_CascadeShadowSplitSpheres1.xyz);
        u_xlat8.xyz = u_xlat17.xyz + (-_CascadeShadowSplitSpheres2.xyz);
        u_xlat9.xyz = u_xlat17.xyz + (-_CascadeShadowSplitSpheres3.xyz);
...
;
        ...
        u_xlat18.xyz = u_xlat17.yyy * _MainLightWorldToShadow[(u_xlati6 + 1) / 4][(u_xlati6 + 1) % 4].xyz;
        u_xlat18.xyz = _MainLightWorldToShadow[u_xlati6 / 4][u_xlati6 % 4].xyz * u_xlat17.xxx + u_xlat18.xyz;
        u_xlat17.xyz = _MainLightWorldToShadow[(u_xlati6 + 2) / 4][(u_xlati6 + 2) % 4].xyz * u_xlat17.zzz + u_xlat18.xyz;
        u_xlat17.xyz = u_xlat17.xyz + _MainLightWorldToShadow[(u_xlati6 + 3) / 4][(u_xlati6 + 3) % 4].xyz;
        vec3 txVec1 = vec3(u_xlat17.xy,u_xlat17.z);
        u_xlat17.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec1, 0.0);
        u_xlat40 = u_xlat40 + u_xlat17.x;
    }
