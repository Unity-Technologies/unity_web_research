...
fn main_1() {
  ...
  let x_1583 : vec2<f32> = vs_TEXCOORD0;
  let x_1586 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1590 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1592 : vec2<f32> = ((x_1583 * vec2<f32>(x_1586.x, x_1586.y)) + vec2<f32>(x_1590.z, x_1590.w));
  let x_1593 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1592.x, x_1592.y, x_1593.z, x_1593.w);
  let x_1600 : vec4<f32> = u_xlat1;
  let x_1603 : f32 = x_26.x_GlobalMipBias.x;
  let x_1604 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1600.x, x_1600.y), x_1603);
  u_xlat15 = x_1604.w;
  let x_1606 : f32 = u_xlat15;
  u_xlat15 = ((x_1606 * 2.0f) + -1.0f);
  let x_1609 : f32 = u_xlat15;
  u_xlatb1 = (x_1609 >= 0.0f);
  let x_1611 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1611);
  let x_1614 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1614)) + 1.0f);
  let x_1618 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1618);
  let x_1620 : f32 = u_xlat15;
  u_xlat15 = (-(x_1620) + 1.0f);
  let x_1623 : f32 = u_xlat15;
  let x_1625 : f32 = u_xlat1.x;
  u_xlat15 = (x_1623 * x_1625);
  let x_1627 : vec3<f32> = u_xlat0;
  let x_1628 : vec3<f32> = (x_1627 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1629 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1628.x, x_1628.y, x_1628.z, x_1629.w);
  let x_1631 : vec3<f32> = u_xlat0;
  let x_1633 : vec3<f32> = log2(abs(x_1631));
  let x_1634 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1633.x, x_1633.y, x_1633.z, x_1634.w);
  let x_1636 : vec4<f32> = u_xlat2;
  let x_1638 : vec3<f32> = (vec3<f32>(x_1636.x, x_1636.y, x_1636.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1649 : vec3<f32> = ((vec3<f32>(x_1646.x, x_1646.y, x_1646.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1650 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1649.x, x_1649.y, x_1649.z, x_1650.w);
  let x_1652 : vec3<f32> = u_xlat0;
  let x_1654 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1652.x, x_1652.y, x_1652.z, x_1652.x));
  ...
  u_xlat0 = ((vec3<f32>(x_1692, x_1692, x_1692) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1697);
  let x_1699 : vec3<f32> = u_xlat0;
  let x_1700 : vec3<f32> = (x_1699 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1701 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1700.x, x_1700.y, x_1700.z, x_1701.w);
  let x_1703 : vec3<f32> = u_xlat0;
  let x_1704 : vec3<f32> = (x_1703 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1705 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1704.x, x_1704.y, x_1704.z, x_1705.w);
  let x_1707 : vec4<f32> = u_xlat2;
  let x_1709 : vec3<f32> = (vec3<f32>(x_1707.x, x_1707.y, x_1707.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1710 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1709.x, x_1709.y, x_1709.z, x_1710.w);
  let x_1712 : vec4<f32> = u_xlat2;
  let x_1715 : vec3<f32> = log2(abs(vec3<f32>(x_1712.x, x_1712.y, x_1712.z)));
  let x_1716 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1715.x, x_1715.y, x_1715.z, x_1716.w);
  let x_1718 : vec4<f32> = u_xlat2;
  let x_1720 : vec3<f32> = (vec3<f32>(x_1718.x, x_1718.y, x_1718.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1730 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1728.x, x_1728.y, x_1728.z, x_1728.x));
  u_xlatb0 = vec3<bool>(x_1730.x, x_1730.y, x_1730.z);
  let x_1733 : bool = u_xlatb0.x;
  if (x_1733) {
  ...
  u_xlat0.x = x_1742;
  let x_1745 : bool = u_xlatb0.y;
  if (x_1745) {
    let x_1750 : f32 = u_xlat1.y;
    x_1746 = x_1750;
  } else {
    let x_1753 : f32 = u_xlat2.y;
    x_1746 = x_1753;
  }
  let x_1754 : f32 = x_1746;
  u_xlat0.y = x_1754;
  let x_1757 : bool = u_xlatb0.z;
  if (x_1757) {
    let x_1762 : f32 = u_xlat1.z;
    x_1758 = x_1762;
  } else {
  ...
  let x_1771 : vec3<f32> = max(x_1770, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1772 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1771.x, x_1771.y, x_1771.z, x_1772.w);
  SV_Target0.w = 1.0f;
  return;
}
