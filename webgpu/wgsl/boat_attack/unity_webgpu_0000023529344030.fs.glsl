...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    if(u_xlatb67){
        ...
        if(u_xlatb67){
            ...
            u_xlatb26.x = _MainLightShadowParams.y==2.0;
            if(u_xlatb26.x){
    ...
    u_xlatb26.x = 0.0>=vs_INTERP8.z;
    u_xlatb47 = vs_INTERP8.z>=1.0;
    u_xlatb26.x = u_xlatb47 || u_xlatb26.x;
    u_xlat67 = (u_xlatb26.x) ? 1.0 : u_xlat67;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu64 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat29.xyz = u_xlat0.xyz * vec3(u_xlat69) + u_xlat6.xyz;
