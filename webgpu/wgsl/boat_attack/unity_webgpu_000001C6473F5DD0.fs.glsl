...
layout(set = 0, binding = 6) uniform mediump  sampler sampler_MainLightCookieTexture;
layout(set = 0, binding = 7) uniform mediump  sampler sampler_AdditionalLightsCookieAtlasTexture;
void main()
{
vec4 u_xlat0;
bool u_xlatb0;
...
int u_xlati61;
    ...
    u_xlat19 = u_xlat0.w * _BaseColor.w + (-_Cutoff);
...
;
    ...
    if(u_xlatb19){
        ...
        if(u_xlatb19){
            ...
            if(u_xlatb57){
                ...
                u_xlat19 = u_xlat57 * u_xlat59 + u_xlat1.x;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat43.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat19 = u_xlat6.w * u_xlat1.x + u_xlat57;
            }
        }
    } else {
        vec3 txVec29 = vec3(u_xlat3.xy,u_xlat3.z);
        u_xlat19 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    ...
    u_xlat19 = u_xlat57 * u_xlat1.x + u_xlat19;
    ...
    u_xlat19 = min(_AdditionalLightsCount.x, unity_LightData.y);
