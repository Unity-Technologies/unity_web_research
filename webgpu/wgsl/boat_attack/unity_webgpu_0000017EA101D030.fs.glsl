...
void main()
{
    ...
    u_xlat3.xyz = (bool(u_xlatb75)) ? u_xlat3.xyz : u_xlat4.xyz;
    u_xlat75 = vs_INTERP7.y * unity_MatrixV[1].z;
    u_xlat75 = unity_MatrixV[0].z * vs_INTERP7.x + u_xlat75;
    u_xlat75 = unity_MatrixV[2].z * vs_INTERP7.z + u_xlat75;
    ...
    u_xlat81 = dot(u_xlat1.xyz, u_xlat3.xyz);
    ...
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat76);
    ...
    u_xlat6.xyz = u_xlat7.xyz * vec3(u_xlat76);
    ...
    u_xlat76 = u_xlat27 / u_xlat76;
    u_xlat32.xyz = u_xlat0.xyz * vec3(u_xlat76) + u_xlat5.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat32.xyz;
    u_xlat76 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu76 =  uint(int(u_xlat76));
    u_xlat2.x = u_xlat80 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu76 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat79 = dot(u_xlat1.xyz, u_xlat8.xyz);
        ...
        u_xlat79 = u_xlat27 / u_xlat79;
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat79) + u_xlat5.xyz;
        u_xlat32.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat32.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat52) + u_xlat6.xyz;
