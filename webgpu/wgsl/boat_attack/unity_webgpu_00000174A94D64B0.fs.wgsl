...
fn main_1() {
  ...
  let x_1357 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1361 : vec4<f32> = x_27.x_Dithering_Params;
  ...
  let x_1399 : vec3<f32> = (x_1398 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_1409 : vec3<f32> = (vec3<f32>(x_1407.x, x_1407.y, x_1407.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1420 : vec3<f32> = ((vec3<f32>(x_1417.x, x_1417.y, x_1417.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1421 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1420.x, x_1420.y, x_1420.z, x_1421.w);
  let x_1423 : vec3<f32> = u_xlat0;
  let x_1425 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1423.x, x_1423.y, x_1423.z, x_1423.x));
  ...
  u_xlat0 = ((vec3<f32>(x_1463, x_1463, x_1463) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1468);
  let x_1470 : vec3<f32> = u_xlat0;
  let x_1471 : vec3<f32> = (x_1470 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1472 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1471.x, x_1471.y, x_1471.z, x_1472.w);
  let x_1474 : vec3<f32> = u_xlat0;
  let x_1475 : vec3<f32> = (x_1474 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1476 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1475.x, x_1475.y, x_1475.z, x_1476.w);
  let x_1478 : vec4<f32> = u_xlat2;
  let x_1480 : vec3<f32> = (vec3<f32>(x_1478.x, x_1478.y, x_1478.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1491 : vec3<f32> = (vec3<f32>(x_1489.x, x_1489.y, x_1489.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1501 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1499.x, x_1499.y, x_1499.z, x_1499.x));
