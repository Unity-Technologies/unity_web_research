...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat33.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati79].www + _AdditionalLightsPosition[u_xlati79].xyz;
        ...
        if(u_xlatb84){
            ...
            u_xlat10 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati82 + 1) / 4][(u_xlati82 + 1) % 4];
            u_xlat10 = _AdditionalLightsWorldToShadow[u_xlati82 / 4][u_xlati82 % 4] * vs_TEXCOORD7.xxxx + u_xlat10;
            u_xlat10 = _AdditionalLightsWorldToShadow[(u_xlati82 + 2) / 4][(u_xlati82 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat10;
        ...
        u_xlat79 = dot(u_xlat1.xyz, u_xlat33.xyz);
        ...
        u_xlat33.xyz = u_xlat5.xyz * vec3(u_xlat79) + u_xlat4.xyz;
