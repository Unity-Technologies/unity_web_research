...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat0.yzw = u_xlat20.xxx * u_xlat1.xyz;
    ...
    u_xlat61 = u_xlat0.x * 4.0 + vs_INTERP0.y;
    u_xlat61 = u_xlat61 * 0.330000013;
    u_xlat62 = vs_INTERP0.y + 1.0;
    u_xlat62 = u_xlat62 * -1.33333337 + 1.0;
    u_xlat61 = max(u_xlat61, u_xlat62);
    u_xlat1.w = max(u_xlat61, 0.100000001);
    ...
    u_xlat62 = (-Vector1_8B35DE98) * 0.0111109996 + 0.949999988;
    u_xlat63 = Vector1_A492C01C + -10.0;
    u_xlat63 = (-u_xlat63) + vs_INTERP0.y;
    u_xlat63 = u_xlat63 * 0.0500000007;
    u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
    u_xlat64 = u_xlat63 * -2.0 + 3.0;
    ...
    u_xlat27.xyz = u_xlat7.wyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat1.x = u_xlat63 * u_xlat1.x + (-u_xlat62);
    u_xlat1.x = u_xlat1.x * 10.0;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat21.x = u_xlat1.x * -2.0 + 3.0;
    ...
    u_xlat24.xyz = texture(sampler2D(Texture2D_C005B064, samplerTexture2D_C005B064), u_xlat5.xy, _GlobalMipBias.x).xyw;
    u_xlat24.x = u_xlat24.x * u_xlat24.z;
    u_xlat5.xy = u_xlat24.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat21.x = dot(u_xlat5.xy, u_xlat5.xy);
    u_xlat21.x = min(u_xlat21.x, 1.0);
    u_xlat21.x = (-u_xlat21.x) + 1.0;
    u_xlat21.x = sqrt(u_xlat21.x);
    u_xlat5.z = max(u_xlat21.x, 1.00000002e-16);
    u_xlat21.x = dot(unity_ObjectToWorld[0].xyz, unity_ObjectToWorld[0].xyz);
    u_xlat6.x = sqrt(u_xlat21.x);
    u_xlat21.x = dot(unity_ObjectToWorld[1].xyz, unity_ObjectToWorld[1].xyz);
    u_xlat6.y = sqrt(u_xlat21.x);
    u_xlat21.x = dot(unity_ObjectToWorld[2].xyz, unity_ObjectToWorld[2].xyz);
    u_xlat6.z = sqrt(u_xlat21.x);
    u_xlat21.x = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat21.x = sqrt(u_xlat21.x);
    u_xlat21.x = u_xlat21.x * Vector1_90E376AD;
    u_xlat21.x = u_xlat21.x * 30.0;
    u_xlat21.xy = u_xlat21.xx * vs_INTERP3.xy;
    u_xlat24.xyz = texture(sampler2D(_SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1, sampler_SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1), u_xlat21.xy, _GlobalMipBias.x).xyw;
    u_xlat24.x = u_xlat24.x * u_xlat24.z;
    u_xlat21.xy = u_xlat24.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat62 = dot(u_xlat21.xy, u_xlat21.xy);
    u_xlat62 = min(u_xlat62, 1.0);
    u_xlat62 = (-u_xlat62) + 1.0;
    u_xlat62 = sqrt(u_xlat62);
    u_xlat62 = max(u_xlat62, 1.00000002e-16);
    u_xlat6.xy = u_xlat21.xy + u_xlat27.xy;
    u_xlat6.z = u_xlat62 * u_xlat27.z;
    u_xlat21.x = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat21.x = max(u_xlat21.x, 1.17549435e-37);
    u_xlat21.x = inversesqrt(u_xlat21.x);
    u_xlat24.xyz = u_xlat6.xyz * u_xlat21.xxx + (-u_xlat5.xyz);
    u_xlat4.yzw = u_xlat1.xxx * u_xlat24.xyz + u_xlat5.xyz;
    ...
    u_xlat20.xyz = u_xlat4.yyy * vs_INTERP2.xyz + u_xlat0.yzw;
    u_xlat20.xyz = u_xlat4.www * vs_INTERP1.xyz + u_xlat20.xyz;
    u_xlat1.x = dot(u_xlat20.xyz, u_xlat20.xyz);
    u_xlat1.x = inversesqrt(u_xlat1.x);
    u_xlat20.xyz = u_xlat20.xyz * u_xlat1.xxx;
    ...
    if(u_xlatb64){
        ...
        if(u_xlatb64){
            ...
            if(u_xlatb65){
                ...
                u_xlat46.xy = vs_INTERP8.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                ...
                vec3 txVec6 = vec3(u_xlat46.xy,vs_INTERP8.z);
                ...
                vec3 txVec15 = vec3(u_xlat46.xy,vs_INTERP8.z);
                ...
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec16, 0.0);
                u_xlat65 = u_xlat17.w * u_xlat46.x + u_xlat65;
                vec3 txVec17 = vec3(u_xlat13.xy,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec17, 0.0);
                u_xlat65 = u_xlat18.x * u_xlat46.x + u_xlat65;
                vec3 txVec18 = vec3(u_xlat13.zw,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec18, 0.0);
                u_xlat65 = u_xlat18.y * u_xlat46.x + u_xlat65;
                vec3 txVec19 = vec3(u_xlat14.xy,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec19, 0.0);
                u_xlat65 = u_xlat18.z * u_xlat46.x + u_xlat65;
                vec3 txVec20 = vec3(u_xlat15.zw,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec20, 0.0);
                u_xlat65 = u_xlat18.w * u_xlat46.x + u_xlat65;
                vec3 txVec21 = vec3(u_xlat16.xy,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec21, 0.0);
                u_xlat65 = u_xlat19.x * u_xlat46.x + u_xlat65;
                vec3 txVec22 = vec3(u_xlat16.zw,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec22, 0.0);
                u_xlat65 = u_xlat19.y * u_xlat46.x + u_xlat65;
                vec3 txVec23 = vec3(u_xlat28.xy,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat65 = u_xlat19.z * u_xlat46.x + u_xlat65;
                vec3 txVec24 = vec3(u_xlat54.xy,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec24, 0.0);
                u_xlat65 = u_xlat19.w * u_xlat46.x + u_xlat65;
                vec3 txVec25 = vec3(u_xlat11.xy,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec25, 0.0);
                u_xlat65 = u_xlat7.x * u_xlat46.x + u_xlat65;
                vec3 txVec26 = vec3(u_xlat11.zw,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec26, 0.0);
                u_xlat65 = u_xlat7.y * u_xlat46.x + u_xlat65;
                vec3 txVec27 = vec3(u_xlat49.xy,vs_INTERP8.z);
                u_xlat46.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
    ...
    if(u_xlatb65){
        ...
        u_xlat65 = (u_xlatb7.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb7.x) ? u_xlat6.xyz : vec3(u_xlat65);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat65 = dot((-u_xlat5.xyz), u_xlat20.xyz);
    u_xlat65 = u_xlat65 + u_xlat65;
    u_xlat7.xyz = u_xlat20.xyz * (-vec3(u_xlat65)) + (-u_xlat5.xyz);
    u_xlat65 = dot(u_xlat20.xyz, u_xlat5.xyz);
    u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
    u_xlat65 = (-u_xlat65) + 1.0;
    u_xlat65 = u_xlat65 * u_xlat65;
    u_xlat65 = u_xlat65 * u_xlat65;
    u_xlat66 = (-u_xlat61) * 0.699999988 + 1.70000005;
    u_xlat61 = u_xlat61 * u_xlat66;
    u_xlat61 = u_xlat61 * 6.0;
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat61);
    ...
    u_xlat61 = float(1.0) / u_xlat8.y;
    u_xlat28.xyz = (-u_xlat2.xyz) + u_xlat0.xxx;
    u_xlat28.xyz = vec3(u_xlat65) * u_xlat28.xyz + u_xlat2.xyz;
    u_xlat28.xyz = vec3(u_xlat61) * u_xlat28.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat28.xyz;
    u_xlat1.xyz = u_xlat1.xyz * u_xlat3.xyz + u_xlat7.xyz;
    u_xlat0.x = u_xlat64 * unity_LightData.z;
    u_xlat61 = dot(u_xlat20.xyz, _MainLightPosition.xyz);
    ...
    u_xlat0.x = dot(u_xlat20.xyz, u_xlat7.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat62 = dot(unity_LightIndices[int(u_xlatu62)], uintBitsToFloat(ImmCB_0[u_xlati64]));
        u_xlatu62 =  uint(int(u_xlat62));
        u_xlat9.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu62)].www + _AdditionalLightsPosition[int(u_xlatu62)].xyz;
        ...
        u_xlat64 = u_xlat64 * _AdditionalLightsAttenuation[int(u_xlatu62)].x;
        u_xlat64 = (-u_xlat64) * u_xlat64 + 1.0;
        u_xlat64 = max(u_xlat64, 0.0);
        u_xlat64 = u_xlat64 * u_xlat64;
        u_xlat64 = u_xlat64 * u_xlat66;
        u_xlat66 = dot(_AdditionalLightsSpotDir[int(u_xlatu62)].xyz, u_xlat10.xyz);
        u_xlat66 = u_xlat66 * _AdditionalLightsAttenuation[int(u_xlatu62)].z + _AdditionalLightsAttenuation[int(u_xlatu62)].w;
        u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
        u_xlat66 = u_xlat66 * u_xlat66;
        u_xlat64 = u_xlat64 * u_xlat66;
        u_xlatu66 = u_xlatu62 >> (5u & uint(0x1F));
        u_xlati47 = 1 << (int(u_xlatu62) & int(0x1F));
        u_xlati66 = int(uint(u_xlati47) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu66)]));
        if(u_xlati66 != 0) {
            u_xlati66 = int(_AdditionalLightsLightTypes[int(u_xlatu62)]);
            u_xlati47 = (u_xlati66 != 0) ? 0 : 1;
            u_xlati67 = int(u_xlatu62) << (2 & int(0x1F));
            if(u_xlati47 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].zw;
            } else {
                ...
                if(u_xlati66 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].xy * u_xlat51.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].zw;
                } else {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].xy * u_xlat47.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].zw;
                }
            }
        ...
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[int(u_xlatu62)].xyz;
        u_xlat11.xyz = vec3(u_xlat44) * u_xlat11.xyz;
        u_xlat62 = dot(u_xlat20.xyz, u_xlat10.xyz);
        u_xlat62 = clamp(u_xlat62, 0.0, 1.0);
        u_xlat62 = u_xlat62 * u_xlat64;
        u_xlat11.xyz = vec3(u_xlat62) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat65) + u_xlat5.xyz;
        u_xlat62 = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat62 = max(u_xlat62, 1.17549435e-37);
        u_xlat62 = inversesqrt(u_xlat62);
        u_xlat9.xyz = vec3(u_xlat62) * u_xlat9.xyz;
        u_xlat62 = dot(u_xlat20.xyz, u_xlat9.xyz);
        u_xlat62 = clamp(u_xlat62, 0.0, 1.0);
        ...
        u_xlat62 = u_xlat62 * u_xlat64;
        u_xlat62 = u_xlat24.x * u_xlat62;
        u_xlat62 = u_xlat63 / u_xlat62;
        u_xlat9.xyz = u_xlat2.xyz * vec3(u_xlat62) + u_xlat3.xyz;
