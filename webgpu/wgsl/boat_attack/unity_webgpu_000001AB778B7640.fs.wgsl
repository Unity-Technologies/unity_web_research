...
fn main_1() {
  ...
  let x_1648 : vec3<f32> = sqrt(vec3<f32>(x_1646.x, x_1646.y, x_1646.z));
  let x_1649 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1648.x, x_1648.y, x_1648.z, x_1649.w);
  let x_1651 : vec2<f32> = vs_TEXCOORD0;
  let x_1654 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1658 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1660 : vec2<f32> = ((x_1651 * vec2<f32>(x_1654.x, x_1654.y)) + vec2<f32>(x_1658.z, x_1658.w));
  let x_1661 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1660.x, x_1660.y, x_1661.z, x_1661.w);
  let x_1668 : vec4<f32> = u_xlat1;
  let x_1671 : f32 = x_38.x_GlobalMipBias.x;
  let x_1672 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1668.x, x_1668.y), x_1671);
  u_xlat18 = x_1672.w;
  let x_1674 : f32 = u_xlat18;
  u_xlat18 = ((x_1674 * 2.0f) + -1.0f);
  let x_1677 : f32 = u_xlat18;
  u_xlatb1 = (x_1677 >= 0.0f);
  let x_1679 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1679);
  let x_1682 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1682)) + 1.0f);
  let x_1686 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1686);
  let x_1688 : f32 = u_xlat18;
  u_xlat18 = (-(x_1688) + 1.0f);
  let x_1691 : f32 = u_xlat18;
  let x_1693 : f32 = u_xlat1.x;
  u_xlat18 = (x_1691 * x_1693);
  let x_1695 : vec4<f32> = u_xlat0;
  let x_1697 : vec3<f32> = (vec3<f32>(x_1695.x, x_1695.y, x_1695.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1698 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1697.x, x_1697.y, x_1697.z, x_1698.w);
  ...
  u_xlat0.z = x_1759;
  let x_1761 : f32 = u_xlat18;
  let x_1766 : vec4<f32> = u_xlat0;
  let x_1768 : vec3<f32> = ((vec3<f32>(x_1761, x_1761, x_1761) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1766.x, x_1766.y, x_1766.z));
  ...
  let x_1789 : vec3<f32> = log2(abs(vec3<f32>(x_1786.x, x_1786.y, x_1786.z)));
  let x_1790 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1789.x, x_1789.y, x_1789.z, x_1790.w);
  let x_1792 : vec4<f32> = u_xlat2;
  let x_1794 : vec3<f32> = (vec3<f32>(x_1792.x, x_1792.y, x_1792.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1795 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1794.x, x_1794.y, x_1794.z, x_1795.w);
  let x_1797 : vec4<f32> = u_xlat2;
  let x_1799 : vec3<f32> = exp2(vec3<f32>(x_1797.x, x_1797.y, x_1797.z));
  let x_1800 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1799.x, x_1799.y, x_1799.z, x_1800.w);
  let x_1802 : vec4<f32> = u_xlat0;
  let x_1804 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1802.x, x_1802.y, x_1802.z, x_1802.x));
  u_xlatb0 = vec3<bool>(x_1804.x, x_1804.y, x_1804.z);
  let x_1807 : bool = u_xlatb0.x;
  if (x_1807) {
  ...
  u_xlat0.x = x_1816;
  let x_1819 : bool = u_xlatb0.y;
  if (x_1819) {
    let x_1824 : f32 = u_xlat1.y;
    x_1820 = x_1824;
  } else {
    let x_1827 : f32 = u_xlat2.y;
    x_1820 = x_1827;
  }
  let x_1828 : f32 = x_1820;
  u_xlat0.y = x_1828;
  let x_1831 : bool = u_xlatb0.z;
  if (x_1831) {
    let x_1836 : f32 = u_xlat1.z;
    x_1832 = x_1836;
  } else {
    let x_1839 : f32 = u_xlat2.z;
    x_1832 = x_1839;
  }
  let x_1840 : f32 = x_1832;
  u_xlat0.z = x_1840;
  let x_1844 : vec4<f32> = u_xlat0;
  let x_1846 : vec3<f32> = max(vec3<f32>(x_1844.x, x_1844.y, x_1844.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1847 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1846.x, x_1846.y, x_1846.z, x_1847.w);
  SV_Target0.w = 1.0f;
  return;
}
