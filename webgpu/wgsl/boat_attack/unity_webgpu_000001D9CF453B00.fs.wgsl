...
fn main_1() {
  ...
  let x_1405 : vec2<f32> = vs_TEXCOORD0;
  let x_1408 : vec4<f32> = x_27.x_Grain_TilingParams;
  let x_1412 : vec4<f32> = x_27.x_Grain_TilingParams;
  let x_1414 : vec2<f32> = ((x_1405 * vec2<f32>(x_1408.x, x_1408.y)) + vec2<f32>(x_1412.z, x_1412.w));
  let x_1415 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1414.x, x_1414.y, x_1415.z, x_1415.w);
  let x_1422 : vec4<f32> = u_xlat1;
  let x_1425 : f32 = x_27.x_GlobalMipBias.x;
  let x_1426 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1422.x, x_1422.y), x_1425);
  u_xlat21 = x_1426.w;
  let x_1428 : f32 = u_xlat21;
  u_xlat21 = (x_1428 + -0.5f);
  let x_1431 : f32 = u_xlat21;
  let x_1432 : f32 = u_xlat21;
  u_xlat21 = (x_1431 + x_1432);
  let x_1434 : vec3<f32> = u_xlat0;
  u_xlat1.x = dot(x_1434, vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1442 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1442);
  let x_1447 : f32 = x_27.x_Grain_Params.y;
  let x_1449 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1447 * -(x_1449)) + 1.0f);
  ...
  let x_1461 : vec2<f32> = x_27.x_Grain_Params;
  u_xlat8 = (x_1458 * vec3<f32>(x_1461.x, x_1461.x, x_1461.x));
  let x_1464 : vec3<f32> = u_xlat8;
  let x_1465 : vec4<f32> = u_xlat1;
  let x_1468 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1464 * vec3<f32>(x_1465.x, x_1465.x, x_1465.x)) + x_1468);
  let x_1470 : vec3<f32> = u_xlat0;
  let x_1473 : vec3<f32> = (x_1470 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1474 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1473.x, x_1473.y, x_1473.z, x_1474.w);
  let x_1476 : vec3<f32> = u_xlat0;
  let x_1478 : vec3<f32> = log2(abs(x_1476));
  let x_1479 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1478.x, x_1478.y, x_1478.z, x_1479.w);
  let x_1481 : vec4<f32> = u_xlat2;
  let x_1485 : vec3<f32> = (vec3<f32>(x_1481.x, x_1481.y, x_1481.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1486 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1485.x, x_1485.y, x_1485.z, x_1486.w);
  let x_1488 : vec4<f32> = u_xlat2;
  let x_1490 : vec3<f32> = exp2(vec3<f32>(x_1488.x, x_1488.y, x_1488.z));
  let x_1491 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1490.x, x_1490.y, x_1490.z, x_1491.w);
  let x_1493 : vec4<f32> = u_xlat2;
  let x_1500 : vec3<f32> = ((vec3<f32>(x_1493.x, x_1493.y, x_1493.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1501 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1500.x, x_1500.y, x_1500.z, x_1501.w);
  let x_1506 : vec3<f32> = u_xlat0;
  let x_1508 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1506.x, x_1506.y, x_1506.z, x_1506.x));
  u_xlatb0 = vec3<bool>(x_1508.x, x_1508.y, x_1508.z);
  let x_1511 : bool = u_xlatb0.x;
  if (x_1511) {
    let x_1516 : f32 = u_xlat1.x;
    x_1512 = x_1516;
  } else {
    let x_1519 : f32 = u_xlat2.x;
    x_1512 = x_1519;
  }
  let x_1520 : f32 = x_1512;
  u_xlat0.x = x_1520;
  let x_1523 : bool = u_xlatb0.y;
  if (x_1523) {
    let x_1528 : f32 = u_xlat1.y;
    x_1524 = x_1528;
  } else {
    let x_1531 : f32 = u_xlat2.y;
    x_1524 = x_1531;
  }
  let x_1532 : f32 = x_1524;
  u_xlat0.y = x_1532;
  let x_1535 : bool = u_xlatb0.z;
  if (x_1535) {
    let x_1540 : f32 = u_xlat1.z;
    x_1536 = x_1540;
  } else {
  ...
  u_xlat0.z = x_1544;
  let x_1546 : vec2<f32> = vs_TEXCOORD0;
  let x_1549 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1553 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1555 : vec2<f32> = ((x_1546 * vec2<f32>(x_1549.x, x_1549.y)) + vec2<f32>(x_1553.z, x_1553.w));
  let x_1556 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1555.x, x_1555.y, x_1556.z, x_1556.w);
  let x_1563 : vec4<f32> = u_xlat1;
  let x_1566 : f32 = x_27.x_GlobalMipBias.x;
  let x_1567 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1563.x, x_1563.y), x_1566);
  u_xlat21 = x_1567.w;
  let x_1569 : f32 = u_xlat21;
  u_xlat21 = ((x_1569 * 2.0f) + -1.0f);
  let x_1572 : f32 = u_xlat21;
  u_xlatb1.x = (x_1572 >= 0.0f);
  let x_1576 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1576);
  let x_1579 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1579)) + 1.0f);
  let x_1583 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1583);
  let x_1585 : f32 = u_xlat21;
  u_xlat21 = (-(x_1585) + 1.0f);
  let x_1588 : f32 = u_xlat21;
  let x_1590 : f32 = u_xlat1.x;
  u_xlat21 = (x_1588 * x_1590);
  let x_1592 : vec3<f32> = u_xlat0;
  let x_1593 : vec3<f32> = (x_1592 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1594 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1593.x, x_1593.y, x_1593.z, x_1594.w);
  let x_1596 : vec3<f32> = u_xlat0;
  let x_1598 : vec3<f32> = log2(abs(x_1596));
  let x_1599 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1598.x, x_1598.y, x_1598.z, x_1599.w);
  let x_1601 : vec4<f32> = u_xlat2;
  let x_1603 : vec3<f32> = (vec3<f32>(x_1601.x, x_1601.y, x_1601.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1604 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1603.x, x_1603.y, x_1603.z, x_1604.w);
  let x_1606 : vec4<f32> = u_xlat2;
  let x_1608 : vec3<f32> = exp2(vec3<f32>(x_1606.x, x_1606.y, x_1606.z));
  let x_1609 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1608.x, x_1608.y, x_1608.z, x_1609.w);
  let x_1611 : vec4<f32> = u_xlat2;
  let x_1614 : vec3<f32> = ((vec3<f32>(x_1611.x, x_1611.y, x_1611.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1615 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1614.x, x_1614.y, x_1614.z, x_1615.w);
  let x_1617 : vec3<f32> = u_xlat0;
  let x_1619 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1617.x, x_1617.y, x_1617.z, x_1617.x));
  u_xlatb0 = vec3<bool>(x_1619.x, x_1619.y, x_1619.z);
  let x_1622 : bool = u_xlatb0.x;
  if (x_1622) {
  ...
  u_xlat0.x = x_1631;
  let x_1634 : bool = u_xlatb0.y;
  if (x_1634) {
    let x_1639 : f32 = u_xlat1.y;
    x_1635 = x_1639;
  } else {
    let x_1642 : f32 = u_xlat2.y;
    x_1635 = x_1642;
  }
  let x_1643 : f32 = x_1635;
  u_xlat0.y = x_1643;
  let x_1646 : bool = u_xlatb0.z;
  if (x_1646) {
    let x_1651 : f32 = u_xlat1.z;
    x_1647 = x_1651;
  } else {
  ...
  u_xlat0 = ((vec3<f32>(x_1657, x_1657, x_1657) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1662);
  let x_1664 : vec3<f32> = u_xlat0;
  let x_1667 : vec3<f32> = (x_1664 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1668 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1667.x, x_1667.y, x_1667.z, x_1668.w);
  let x_1670 : vec3<f32> = u_xlat0;
  let x_1673 : vec3<f32> = (x_1670 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1674 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1673.x, x_1673.y, x_1673.z, x_1674.w);
  let x_1676 : vec4<f32> = u_xlat2;
  let x_1680 : vec3<f32> = (vec3<f32>(x_1676.x, x_1676.y, x_1676.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1681 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1680.x, x_1680.y, x_1680.z, x_1681.w);
  let x_1683 : vec4<f32> = u_xlat2;
  let x_1686 : vec3<f32> = log2(abs(vec3<f32>(x_1683.x, x_1683.y, x_1683.z)));
  let x_1687 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1686.x, x_1686.y, x_1686.z, x_1687.w);
  let x_1689 : vec4<f32> = u_xlat2;
  let x_1693 : vec3<f32> = (vec3<f32>(x_1689.x, x_1689.y, x_1689.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1694 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1693.x, x_1693.y, x_1693.z, x_1694.w);
  let x_1696 : vec4<f32> = u_xlat2;
  let x_1698 : vec3<f32> = exp2(vec3<f32>(x_1696.x, x_1696.y, x_1696.z));
  let x_1699 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1698.x, x_1698.y, x_1698.z, x_1699.w);
  let x_1703 : vec3<f32> = u_xlat0;
  let x_1705 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1703.x, x_1703.y, x_1703.z, x_1703.x));
  u_xlatb0 = vec3<bool>(x_1705.x, x_1705.y, x_1705.z);
  ...
  SV_Target0.x = x_1719;
  let x_1723 : bool = u_xlatb0.y;
  if (x_1723) {
    let x_1728 : f32 = u_xlat1.y;
    x_1724 = x_1728;
  } else {
  ...
  SV_Target0.y = x_1732;
  let x_1735 : bool = u_xlatb0.z;
  if (x_1735) {
    let x_1740 : f32 = u_xlat1.z;
    x_1736 = x_1740;
  } else {
