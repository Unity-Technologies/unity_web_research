...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1258.x, x_1258.y, x_1258.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1261 : vec4<f32> = u_xlat0;
  let x_1264 : vec3<f32> = log2(abs(vec3<f32>(x_1261.x, x_1261.y, x_1261.z)));
  let x_1265 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1264.x, x_1264.y, x_1264.z, x_1265.w);
  let x_1267 : vec4<f32> = u_xlat2;
  let x_1269 : vec3<f32> = (vec3<f32>(x_1267.x, x_1267.y, x_1267.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1270 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1269.x, x_1269.y, x_1269.z, x_1270.w);
  let x_1272 : vec4<f32> = u_xlat2;
  let x_1274 : vec3<f32> = exp2(vec3<f32>(x_1272.x, x_1272.y, x_1272.z));
  let x_1275 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1274.x, x_1274.y, x_1274.z, x_1275.w);
  let x_1277 : vec4<f32> = u_xlat2;
  let x_1280 : vec3<f32> = ((vec3<f32>(x_1277.x, x_1277.y, x_1277.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1281 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1280.x, x_1280.y, x_1280.z, x_1281.w);
  let x_1283 : vec4<f32> = u_xlat0;
  let x_1285 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1283.x, x_1283.y, x_1283.z, x_1283.x));
  u_xlatb0 = vec3<bool>(x_1285.x, x_1285.y, x_1285.z);
  let x_1288 : bool = u_xlatb0.x;
  if (x_1288) {
  ...
  u_xlat0.x = x_1297;
  let x_1300 : bool = u_xlatb0.y;
  if (x_1300) {
    let x_1305 : f32 = u_xlat1.y;
    x_1301 = x_1305;
  } else {
    let x_1308 : f32 = u_xlat2.y;
    x_1301 = x_1308;
  }
  let x_1309 : f32 = x_1301;
  u_xlat0.y = x_1309;
  let x_1312 : bool = u_xlatb0.z;
  if (x_1312) {
    let x_1317 : f32 = u_xlat1.z;
    x_1313 = x_1317;
  } else {
    let x_1320 : f32 = u_xlat2.z;
    x_1313 = x_1320;
  }
  let x_1321 : f32 = x_1313;
  u_xlat0.z = x_1321;
  let x_1323 : vec2<f32> = vs_TEXCOORD0;
  let x_1326 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1330 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1332 : vec2<f32> = ((x_1323 * vec2<f32>(x_1326.x, x_1326.y)) + vec2<f32>(x_1330.z, x_1330.w));
  let x_1333 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1332.x, x_1332.y, x_1333.z);
  let x_1340 : vec3<f32> = u_xlat1;
  let x_1343 : f32 = x_25.x_GlobalMipBias.x;
  let x_1344 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1340.x, x_1340.y), x_1343);
  u_xlat18 = x_1344.w;
  let x_1346 : f32 = u_xlat18;
  u_xlat18 = ((x_1346 * 2.0f) + -1.0f);
  let x_1349 : f32 = u_xlat18;
  u_xlatb1.x = (x_1349 >= 0.0f);
  let x_1353 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1353);
  let x_1356 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1356)) + 1.0f);
  let x_1360 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1360);
  let x_1362 : f32 = u_xlat18;
  u_xlat18 = (-(x_1362) + 1.0f);
  let x_1365 : f32 = u_xlat18;
  let x_1367 : f32 = u_xlat1.x;
  u_xlat18 = (x_1365 * x_1367);
  let x_1369 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1369.x, x_1369.y, x_1369.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1372 : vec4<f32> = u_xlat0;
  let x_1375 : vec3<f32> = log2(abs(vec3<f32>(x_1372.x, x_1372.y, x_1372.z)));
  let x_1376 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1375.x, x_1375.y, x_1375.z, x_1376.w);
  let x_1378 : vec4<f32> = u_xlat2;
  let x_1380 : vec3<f32> = (vec3<f32>(x_1378.x, x_1378.y, x_1378.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1391 : vec3<f32> = ((vec3<f32>(x_1388.x, x_1388.y, x_1388.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1392 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1391.x, x_1391.y, x_1391.z, x_1392.w);
  let x_1394 : vec4<f32> = u_xlat0;
  let x_1396 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1394.x, x_1394.y, x_1394.z, x_1394.x));
  ...
  let x_1441 : vec3<f32> = ((vec3<f32>(x_1434, x_1434, x_1434) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1439.x, x_1439.y, x_1439.z));
  let x_1442 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1441.x, x_1441.y, x_1441.z, x_1442.w);
  let x_1444 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1444.x, x_1444.y, x_1444.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1447 : vec4<f32> = u_xlat0;
  let x_1449 : vec3<f32> = (vec3<f32>(x_1447.x, x_1447.y, x_1447.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1450 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1449.x, x_1449.y, x_1449.z, x_1450.w);
  let x_1452 : vec4<f32> = u_xlat2;
  let x_1454 : vec3<f32> = (vec3<f32>(x_1452.x, x_1452.y, x_1452.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1455 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1454.x, x_1454.y, x_1454.z, x_1455.w);
  let x_1457 : vec4<f32> = u_xlat2;
  let x_1460 : vec3<f32> = log2(abs(vec3<f32>(x_1457.x, x_1457.y, x_1457.z)));
  let x_1461 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1460.x, x_1460.y, x_1460.z, x_1461.w);
  let x_1463 : vec4<f32> = u_xlat2;
  let x_1465 : vec3<f32> = (vec3<f32>(x_1463.x, x_1463.y, x_1463.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1466 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1465.x, x_1465.y, x_1465.z, x_1466.w);
  let x_1468 : vec4<f32> = u_xlat2;
  let x_1470 : vec3<f32> = exp2(vec3<f32>(x_1468.x, x_1468.y, x_1468.z));
  let x_1471 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1470.x, x_1470.y, x_1470.z, x_1471.w);
  let x_1473 : vec4<f32> = u_xlat0;
  let x_1475 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1473.x, x_1473.y, x_1473.z, x_1473.x));
  ...
  let x_1518 : vec3<f32> = max(vec3<f32>(x_1515.x, x_1515.y, x_1515.z), vec3<f32>(0.0f, 0.0f, 0.0f));
