...
fn main_1() {
  ...
  let x_1356 : vec3<f32> = (x_1355 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1357 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1356.x, x_1356.y, x_1356.z, x_1357.w);
  let x_1359 : vec3<f32> = u_xlat0;
  let x_1361 : vec3<f32> = log2(abs(x_1359));
  let x_1362 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1361.x, x_1361.y, x_1361.z, x_1362.w);
  let x_1364 : vec4<f32> = u_xlat2;
  let x_1366 : vec3<f32> = (vec3<f32>(x_1364.x, x_1364.y, x_1364.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1367 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1366.x, x_1366.y, x_1366.z, x_1367.w);
  let x_1369 : vec4<f32> = u_xlat2;
  let x_1371 : vec3<f32> = exp2(vec3<f32>(x_1369.x, x_1369.y, x_1369.z));
  let x_1372 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1371.x, x_1371.y, x_1371.z, x_1372.w);
  let x_1374 : vec4<f32> = u_xlat2;
  let x_1377 : vec3<f32> = ((vec3<f32>(x_1374.x, x_1374.y, x_1374.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1378 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1377.x, x_1377.y, x_1377.z, x_1378.w);
  let x_1380 : vec3<f32> = u_xlat0;
  let x_1382 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1380.x, x_1380.y, x_1380.z, x_1380.x));
  ...
  if (x_1397) {
    let x_1402 : f32 = u_xlat1.y;
    x_1398 = x_1402;
  } else {
    let x_1405 : f32 = u_xlat2.y;
    x_1398 = x_1405;
  }
  ...
  u_xlat0.z = x_1418;
  let x_1420 : vec2<f32> = vs_TEXCOORD0;
  let x_1423 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1427 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1429 : vec2<f32> = ((x_1420 * vec2<f32>(x_1423.x, x_1423.y)) + vec2<f32>(x_1427.z, x_1427.w));
  let x_1430 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1429.x, x_1429.y, x_1430.z, x_1430.w);
  let x_1437 : vec4<f32> = u_xlat1;
  let x_1440 : f32 = x_14.x_GlobalMipBias.x;
  let x_1441 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1437.x, x_1437.y), x_1440);
  u_xlat15 = x_1441.w;
  let x_1443 : f32 = u_xlat15;
  u_xlat15 = ((x_1443 * 2.0f) + -1.0f);
  let x_1446 : f32 = u_xlat15;
  u_xlatb1 = (x_1446 >= 0.0f);
  let x_1448 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1448);
  let x_1451 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1451)) + 1.0f);
  let x_1455 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1455);
  let x_1457 : f32 = u_xlat15;
  u_xlat15 = (-(x_1457) + 1.0f);
  let x_1460 : f32 = u_xlat15;
  let x_1462 : f32 = u_xlat1.x;
  u_xlat15 = (x_1460 * x_1462);
  let x_1464 : vec3<f32> = u_xlat0;
  let x_1465 : vec3<f32> = (x_1464 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1466 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1465.x, x_1465.y, x_1465.z, x_1466.w);
  let x_1468 : vec3<f32> = u_xlat0;
  let x_1470 : vec3<f32> = log2(abs(x_1468));
  let x_1471 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1470.x, x_1470.y, x_1470.z, x_1471.w);
  let x_1473 : vec4<f32> = u_xlat2;
  let x_1475 : vec3<f32> = (vec3<f32>(x_1473.x, x_1473.y, x_1473.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1476 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1475.x, x_1475.y, x_1475.z, x_1476.w);
  let x_1478 : vec4<f32> = u_xlat2;
  let x_1480 : vec3<f32> = exp2(vec3<f32>(x_1478.x, x_1478.y, x_1478.z));
  let x_1481 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1480.x, x_1480.y, x_1480.z, x_1481.w);
  let x_1483 : vec4<f32> = u_xlat2;
  let x_1486 : vec3<f32> = ((vec3<f32>(x_1483.x, x_1483.y, x_1483.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1487 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1486.x, x_1486.y, x_1486.z, x_1487.w);
  let x_1489 : vec3<f32> = u_xlat0;
  let x_1491 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1489.x, x_1489.y, x_1489.z, x_1489.x));
  u_xlatb0 = vec3<bool>(x_1491.x, x_1491.y, x_1491.z);
  let x_1494 : bool = u_xlatb0.x;
  if (x_1494) {
  ...
  u_xlat0 = ((vec3<f32>(x_1529, x_1529, x_1529) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1534);
  let x_1536 : vec3<f32> = u_xlat0;
  let x_1537 : vec3<f32> = (x_1536 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1538 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1537.x, x_1537.y, x_1537.z, x_1538.w);
  let x_1540 : vec3<f32> = u_xlat0;
  let x_1541 : vec3<f32> = (x_1540 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1542 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1541.x, x_1541.y, x_1541.z, x_1542.w);
  let x_1544 : vec4<f32> = u_xlat2;
  let x_1546 : vec3<f32> = (vec3<f32>(x_1544.x, x_1544.y, x_1544.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1547 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1546.x, x_1546.y, x_1546.z, x_1547.w);
  let x_1549 : vec4<f32> = u_xlat2;
  let x_1552 : vec3<f32> = log2(abs(vec3<f32>(x_1549.x, x_1549.y, x_1549.z)));
  let x_1553 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1552.x, x_1552.y, x_1552.z, x_1553.w);
  let x_1555 : vec4<f32> = u_xlat2;
  let x_1557 : vec3<f32> = (vec3<f32>(x_1555.x, x_1555.y, x_1555.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1558 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1557.x, x_1557.y, x_1557.z, x_1558.w);
  let x_1560 : vec4<f32> = u_xlat2;
  let x_1562 : vec3<f32> = exp2(vec3<f32>(x_1560.x, x_1560.y, x_1560.z));
  let x_1563 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1562.x, x_1562.y, x_1562.z, x_1563.w);
  let x_1565 : vec3<f32> = u_xlat0;
  let x_1567 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1565.x, x_1565.y, x_1565.z, x_1565.x));
  ...
  let x_1608 : vec3<f32> = max(x_1607, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1609 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1608.x, x_1608.y, x_1608.z, x_1609.w);
  SV_Target0.w = 1.0f;
  return;
}
