...
;
    ...
    u_xlati55 = int(uint(u_xlati55) ^ u_xlatu4.y);
    ...
    u_xlati55 = int(u_xlatu81 ^ u_xlatu55);
    u_xlati55 = u_xlati55 * 32769;
    u_xlati55 = int(uint(u_xlati55) ^ u_xlatu4.x);
    u_xlatu55 = uint(u_xlati55) * 1025u;
    u_xlatu81 = u_xlatu55 >> (6u & uint(0x1F));
    u_xlati55 = int(u_xlatu81 ^ u_xlatu55);
    u_xlatu55 = uint(u_xlati55) * 9u;
    ...
    u_xlat55.x = dot(u_xlat26.xyz, u_xlat4.xyz);
    u_xlat55.x = u_xlat55.x + 0.5;
    u_xlat4.xyz = u_xlat55.xxx * u_xlat6.xyz;
    u_xlat55.x = max(u_xlat4.w, 9.99999975e-05);
    u_xlat4.xyz = u_xlat4.xyz / u_xlat55.xxx;
    u_xlat8.x = u_xlat8.x;
    u_xlat8.x = clamp(u_xlat8.x, 0.0, 1.0);
    u_xlat79 = u_xlat79;
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    u_xlat6.xyz = u_xlat7.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat55.x = (-u_xlat8.x) + 1.0;
    u_xlat81 = u_xlat55.x * u_xlat55.x;
    u_xlat81 = max(u_xlat81, 0.0078125);
    u_xlat82 = u_xlat81 * u_xlat81;
    u_xlat83 = u_xlat8.x + 0.0400000215;
    u_xlat83 = min(u_xlat83, 1.0);
    u_xlat84 = u_xlat81 * 4.0 + 2.0;
    ...
    if(u_xlatb0){
        ...
        if(u_xlatb0){
            ...
            u_xlatb33 = _MainLightShadowParams.y==2.0;
            if(u_xlatb33){
                u_xlat33.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat33.xy = floor(u_xlat33.xy);
                u_xlat8.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat33.xy);
                ...
                u_xlat11.xyz = u_xlat11.xyz * _MainLightShadowmapSize.yyy;
                u_xlat10.w = u_xlat11.x;
                u_xlat12 = u_xlat33.xyxy * _MainLightShadowmapSize.xyxy + u_xlat10.ywxw;
                u_xlat13.xy = u_xlat33.xy * _MainLightShadowmapSize.xy + u_xlat10.zw;
                u_xlat11.w = u_xlat10.y;
                u_xlat10.yw = u_xlat11.yz;
                u_xlat14 = u_xlat33.xyxy * _MainLightShadowmapSize.xyxy + u_xlat10.xyzy;
                u_xlat11 = u_xlat33.xyxy * _MainLightShadowmapSize.xyxy + u_xlat11.wywz;
                u_xlat10 = u_xlat33.xyxy * _MainLightShadowmapSize.xyxy + u_xlat10.xwzw;
                u_xlat15 = u_xlat8.xxxy * u_xlat9.zwyz;
                u_xlat16 = u_xlat8.yyzz * u_xlat9;
                u_xlat33.x = u_xlat8.z * u_xlat9.y;
                vec3 txVec34 = vec3(u_xlat12.xy,u_xlat2.z);
                u_xlat59 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec34, 0.0);
                ...
                u_xlat59 = u_xlat15.x * u_xlat59 + u_xlat85;
                ...
                u_xlat59 = u_xlat15.z * u_xlat85 + u_xlat59;
                ...
                u_xlat59 = u_xlat15.w * u_xlat85 + u_xlat59;
                ...
                u_xlat59 = u_xlat16.x * u_xlat85 + u_xlat59;
                ...
                u_xlat59 = u_xlat16.y * u_xlat85 + u_xlat59;
                ...
                u_xlat59 = u_xlat16.z * u_xlat85 + u_xlat59;
                ...
                u_xlat59 = u_xlat16.w * u_xlat85 + u_xlat59;
                ...
                u_xlat0.x = u_xlat33.x * u_xlat85 + u_xlat59;
            } else {
                u_xlat33.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat33.xy = floor(u_xlat33.xy);
                u_xlat8.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat33.xy);
                ...
                u_xlat13 = u_xlat33.xyxy * _MainLightShadowmapSize.xyxy + u_xlat12.xyzy;
                u_xlat14.xy = u_xlat33.xy * _MainLightShadowmapSize.xy + u_xlat12.wy;
                u_xlat9.y = u_xlat12.y;
                u_xlat12.y = u_xlat11.z;
                u_xlat15 = u_xlat33.xyxy * _MainLightShadowmapSize.xyxy + u_xlat12.xyzy;
                u_xlat66.xy = u_xlat33.xy * _MainLightShadowmapSize.xy + u_xlat12.wy;
                u_xlat9.z = u_xlat12.y;
                u_xlat16 = u_xlat33.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xyxz;
                u_xlat12.y = u_xlat11.w;
                u_xlat17 = u_xlat33.xyxy * _MainLightShadowmapSize.xyxy + u_xlat12.xyzy;
                u_xlat35.xy = u_xlat33.xy * _MainLightShadowmapSize.xy + u_xlat12.wy;
                u_xlat9.w = u_xlat12.y;
                u_xlat18.xy = u_xlat33.xy * _MainLightShadowmapSize.xy + u_xlat9.xw;
                u_xlat11.xzw = u_xlat12.xzw;
                u_xlat12 = u_xlat33.xyxy * _MainLightShadowmapSize.xyxy + u_xlat11.xyzy;
                u_xlat63.xy = u_xlat33.xy * _MainLightShadowmapSize.xy + u_xlat11.wy;
                u_xlat11.x = u_xlat9.x;
                u_xlat33.xy = u_xlat33.xy * _MainLightShadowmapSize.xy + u_xlat11.xy;
                ...
                vec3 txVec58 = vec3(u_xlat33.xy,u_xlat2.z);
                u_xlat33.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec58, 0.0);
                u_xlat0.x = u_xlat8.w * u_xlat33.x + u_xlat85;
            }
        }
    } else {
    ...
    u_xlat3.x = dot((-u_xlat5.xyz), u_xlat26.xyz);
    u_xlat3.x = u_xlat3.x + u_xlat3.x;
    u_xlat33.xyz = u_xlat26.xyz * (-u_xlat3.xxx) + (-u_xlat5.xyz);
    u_xlat3.x = dot(u_xlat26.xyz, u_xlat5.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat3.x = (-u_xlat3.x) + 1.0;
    u_xlat3.x = u_xlat3.x * u_xlat3.x;
    u_xlat3.x = u_xlat3.x * u_xlat3.x;
    u_xlat8.x = (-u_xlat55.x) * 0.699999988 + 1.70000005;
    u_xlat55.x = u_xlat55.x * u_xlat8.x;
    u_xlat55.x = u_xlat55.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat33.xyz, u_xlat55.x);
    u_xlat55.x = u_xlat8.w + -1.0;
    u_xlat55.x = unity_SpecCube0_HDR.w * u_xlat55.x + 1.0;
    u_xlat55.x = max(u_xlat55.x, 0.0);
    u_xlat55.x = log2(u_xlat55.x);
    u_xlat55.x = u_xlat55.x * unity_SpecCube0_HDR.y;
    u_xlat55.x = exp2(u_xlat55.x);
    u_xlat55.x = u_xlat55.x * unity_SpecCube0_HDR.x;
    u_xlat33.xyz = u_xlat8.xyz * u_xlat55.xxx;
    u_xlat55.xy = vec2(u_xlat81) * vec2(u_xlat81) + vec2(-1.0, 1.0);
    u_xlat81 = float(1.0) / u_xlat55.y;
    u_xlat83 = u_xlat83 + -0.0399999991;
    u_xlat3.x = u_xlat3.x * u_xlat83 + 0.0399999991;
    u_xlat3.x = u_xlat3.x * u_xlat81;
    u_xlat33.xyz = u_xlat3.xxx * u_xlat33.xyz;
    u_xlat4.xyz = u_xlat4.xyz * u_xlat6.xyz + u_xlat33.xyz;
    ...
    u_xlat0.x = dot(u_xlat26.xyz, u_xlat33.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat3.x = dot(_MainLightPosition.xyz, u_xlat33.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat55.x + 1.00001001;
    u_xlat3.x = u_xlat3.x * u_xlat3.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat3.x = max(u_xlat3.x, 0.100000001);
    u_xlat0.x = u_xlat0.x * u_xlat3.x;
    u_xlat0.x = u_xlat84 * u_xlat0.x;
    u_xlat0.x = u_xlat82 / u_xlat0.x;
    u_xlat33.xyz = u_xlat0.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat6.xyz;
    u_xlat28.xyz = u_xlat28.xyz * u_xlat33.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat34.xyz = (-vs_INTERP8.xyz) * _AdditionalLightsPosition[u_xlati8].www + _AdditionalLightsPosition[u_xlati8].xyz;
        u_xlat9.x = dot(u_xlat34.xyz, u_xlat34.xyz);
        u_xlat9.x = max(u_xlat9.x, 6.10351562e-05);
        u_xlat35.x = inversesqrt(u_xlat9.x);
        u_xlat10.xyz = u_xlat34.xyz * u_xlat35.xxx;
        u_xlat61 = float(1.0) / float(u_xlat9.x);
        u_xlat9.x = u_xlat9.x * _AdditionalLightsAttenuation[u_xlati8].x;
        u_xlat9.x = (-u_xlat9.x) * u_xlat9.x + 1.0;
        u_xlat9.x = max(u_xlat9.x, 0.0);
        u_xlat9.x = u_xlat9.x * u_xlat9.x;
        u_xlat9.x = u_xlat9.x * u_xlat61;
        u_xlat61 = dot(_AdditionalLightsSpotDir[u_xlati8].xyz, u_xlat10.xyz);
        u_xlat61 = u_xlat61 * _AdditionalLightsAttenuation[u_xlati8].z + _AdditionalLightsAttenuation[u_xlati8].w;
        u_xlat61 = clamp(u_xlat61, 0.0, 1.0);
        u_xlat61 = u_xlat61 * u_xlat61;
        u_xlat9.x = u_xlat61 * u_xlat9.x;
        ...
        if(u_xlatb87){
            ...
            u_xlat11 = vs_INTERP8.yyyy * _AdditionalLightsWorldToShadow[(u_xlati61 + 1) / 4][(u_xlati61 + 1) % 4];
            u_xlat11 = _AdditionalLightsWorldToShadow[u_xlati61 / 4][u_xlati61 % 4] * vs_INTERP8.xxxx + u_xlat11;
            u_xlat11 = _AdditionalLightsWorldToShadow[(u_xlati61 + 2) / 4][(u_xlati61 + 2) % 4] * vs_INTERP8.zzzz + u_xlat11;
            ...
            if(u_xlatb61){
                ...
                if(u_xlatb61){
                    ...
                    u_xlat61 = dot(u_xlat13, vec4(0.25, 0.25, 0.25, 0.25));
                } else {
                    ...
                    if(u_xlatb87){
                        ...
                        u_xlat61 = u_xlat87 * u_xlat89 + u_xlat88;
                    } else {
                        u_xlat12.xy = u_xlat11.xy * _AdditionalShadowmapSize.zw + vec2(0.5, 0.5);
                        u_xlat12.xy = floor(u_xlat12.xy);
                        u_xlat64.xy = u_xlat11.xy * _AdditionalShadowmapSize.zw + (-u_xlat12.xy);
                        ...
                        u_xlat61 = u_xlat13.w * u_xlat88 + u_xlat87;
                    }
                }
            } else {
                vec3 txVec89 = vec3(u_xlat11.xy,u_xlat11.z);
                u_xlat61 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec89, 0.0);
            }
            u_xlat87 = 1.0 + (-_AdditionalShadowParams[u_xlati8].x);
            u_xlat61 = u_xlat61 * _AdditionalShadowParams[u_xlati8].x + u_xlat87;
            u_xlatb87 = 0.0>=u_xlat11.z;
            u_xlatb88 = u_xlat11.z>=1.0;
            u_xlatb87 = u_xlatb87 || u_xlatb88;
            u_xlat61 = (u_xlatb87) ? 1.0 : u_xlat61;
        } else {
            u_xlat61 = 1.0;
        }
        u_xlat87 = (-u_xlat61) + 1.0;
        u_xlat61 = u_xlat2.x * u_xlat87 + u_xlat61;
        u_xlati87 = 1 << (u_xlati8 & int(0x1F));
        u_xlati87 = int(uint(u_xlati87) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati87 != 0) {
            u_xlati87 = int(_AdditionalLightsLightTypes[u_xlati8]);
            u_xlati88 = (u_xlati87 != 0) ? 0 : 1;
            u_xlati11 = u_xlati8 << (2 & int(0x1F));
            if(u_xlati88 != 0) {
                ...
                u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati8].xy * u_xlat37.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati8].zw;
            } else {
                ...
                if(u_xlati87 != 0) {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati8].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati8].zw;
                } else {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati8].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati8].zw;
                }
            }
            u_xlat11 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat37.xy, 0.0);
            u_xlat87 = (u_xlatb3.w) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat87);
        } else {
        ...
        u_xlat8.x = u_xlat61 * u_xlat9.x;
        u_xlat9.x = dot(u_xlat26.xyz, u_xlat10.xyz);
        u_xlat9.x = clamp(u_xlat9.x, 0.0, 1.0);
        u_xlat8.x = u_xlat8.x * u_xlat9.x;
        u_xlat9.xzw = u_xlat8.xxx * u_xlat11.xyz;
        u_xlat8.xyz = u_xlat34.xyz * u_xlat35.xxx + u_xlat5.xyz;
        ...
        u_xlat8.x = u_xlat82 / u_xlat8.x;
        u_xlat8.xyz = u_xlat8.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat6.xyz;
        u_xlat33.xyz = u_xlat8.xyz * u_xlat9.xzw + u_xlat33.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * u_xlat7.xxx + u_xlat28.xyz;
