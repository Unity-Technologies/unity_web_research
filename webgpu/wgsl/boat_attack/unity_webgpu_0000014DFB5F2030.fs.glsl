...
void main()
{
    ...
    u_xlat76 = vs_TEXCOORD7.y * unity_MatrixV[1].z;
    u_xlat76 = unity_MatrixV[0].z * vs_TEXCOORD7.x + u_xlat76;
    u_xlat76 = unity_MatrixV[2].z * vs_TEXCOORD7.z + u_xlat76;
    u_xlat76 = u_xlat76 + unity_MatrixV[3].z;
    u_xlat76 = (-u_xlat76) + (-_ProjectionParams.y);
    u_xlat76 = max(u_xlat76, 0.0);
    u_xlat76 = u_xlat76 * unity_FogParams.x;
    ...
    u_xlat77 = max(u_xlat2.w, 9.99999975e-05);
    u_xlat2.xyz = u_xlat2.xyz / vec3(u_xlat77);
    u_xlat77 = (-u_xlat0.x) * 0.959999979 + 0.959999979;
    u_xlat3.x = u_xlat50 + (-u_xlat77);
    u_xlat28.xyz = vec3(u_xlat77) * u_xlat5.xyz;
    ...
    u_xlat77 = u_xlat50 * u_xlat50;
    u_xlat3.x = u_xlat3.x + 1.0;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat79 = u_xlat50 * 4.0 + 2.0;
    ...
    if(u_xlatb5){
        ...
        if(u_xlatb5){
            ...
            if(u_xlatb30){
                u_xlat30.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat30.xy = floor(u_xlat30.xy);
                u_xlat6.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat30.xy);
                ...
                vec3 txVec28 = vec3(u_xlat30.xy,vs_TEXCOORD8.z);
    ...
    u_xlat30.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat5.x = u_xlat5.x * _MainLightShadowParams.x + u_xlat30.x;
    u_xlatb30 = 0.0>=vs_TEXCOORD8.z;
    u_xlatb55 = vs_TEXCOORD8.z>=1.0;
    u_xlatb30 = u_xlatb55 || u_xlatb30;
    u_xlat5.x = (u_xlatb30) ? 1.0 : u_xlat5.x;
    u_xlat30.xyz = vs_TEXCOORD7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat30.x = dot(u_xlat30.xyz, u_xlat30.xyz);
    u_xlat55 = u_xlat30.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat55 = clamp(u_xlat55, 0.0, 1.0);
    u_xlat80 = (-u_xlat5.x) + 1.0;
    u_xlat5.x = u_xlat55 * u_xlat80 + u_xlat5.x;
    u_xlat6.x = vs_TEXCOORD3.w;
    u_xlat6.y = vs_TEXCOORD4.w;
    u_xlat6.z = vs_TEXCOORD5.w;
    u_xlat55 = dot((-u_xlat6.xyz), u_xlat1.xyz);
    u_xlat55 = u_xlat55 + u_xlat55;
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat55)) + (-u_xlat6.xyz);
    ...
    u_xlat8.xyz = (-u_xlat4.xyz) + u_xlat3.xxx;
    u_xlat8.xyz = vec3(u_xlat55) * u_xlat8.xyz + u_xlat4.xyz;
    u_xlat8.xyz = vec3(u_xlat50) * u_xlat8.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat28.xyz + u_xlat7.xyz;
    u_xlat50 = u_xlat5.x * unity_LightData.z;
    u_xlat3.x = dot(u_xlat1.xyz, _MainLightPosition.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat50 = u_xlat50 * u_xlat3.x;
    u_xlat5.xzw = vec3(u_xlat50) * _MainLightColor.xyz;
    ...
    u_xlat50 = u_xlat50 * u_xlat3.x;
    u_xlat50 = u_xlat79 * u_xlat50;
    u_xlat50 = u_xlat77 / u_xlat50;
    u_xlat7.xyz = u_xlat4.xyz * vec3(u_xlat50) + u_xlat28.xyz;
    u_xlat5.xzw = u_xlat5.xzw * u_xlat7.xyz;
    u_xlat50 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu50 =  uint(int(u_xlat50));
    u_xlat3.x = u_xlat30.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu50 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat84 = dot(_AdditionalLightsSpotDir[u_xlati81].xyz, u_xlat9.xyz);
        ...
        if(u_xlatb10.x){
            u_xlatb10.x = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati81].z);
            if(u_xlatb10.x){
                ...
                u_xlat35.x = trunc(_AdditionalShadowParams[u_xlati81].w);
            ...
            u_xlat84 = u_xlat84 * _AdditionalShadowParams[u_xlati81].x + u_xlat10.x;
        ...
        u_xlat84 = u_xlat3.x * u_xlat10.x + u_xlat84;
        u_xlat82 = u_xlat82 * u_xlat84;
        u_xlat84 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
        u_xlat82 = u_xlat82 * u_xlat84;
        u_xlat10.xyz = vec3(u_xlat82) * _AdditionalLightsColor[u_xlati81].xyz;
        ...
        u_xlat81 = dot(u_xlat1.xyz, u_xlat8.xyz);
        ...
        u_xlat81 = u_xlat77 / u_xlat81;
        u_xlat8.xyz = u_xlat4.xyz * vec3(u_xlat81) + u_xlat28.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat2.xyz * vec3(u_xlat25) + u_xlat5.xzw;
    u_xlat0.xyz = u_xlat7.xyz + u_xlat0.xyz;
    u_xlat0.xyz = vec3(u_xlat75) * u_xlat0.xyz;
    u_xlat75 = u_xlat76 * (-u_xlat76);
