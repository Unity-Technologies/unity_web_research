...
fn main_1() {
  ...
  let x_950 : vec3<f32> = ((x_944 * vec3<f32>(x_945.x, x_945.x, x_945.x)) + vec3<f32>(x_948.x, x_948.y, x_948.z));
  let x_951 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_950.x, x_950.y, x_950.z, x_951.w);
  SV_Target0.w = 1.0f;
  return;
}
