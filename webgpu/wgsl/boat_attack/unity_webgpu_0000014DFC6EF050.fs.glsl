...
float u_xlat9;
float u_xlat10;
layout(set = 0, binding = 6) uniform mediump  sampler sampler_Control;
layout(set = 0, binding = 7) uniform mediump  sampler sampler_Normal0;
layout(set = 0, binding = 8) uniform mediump  sampler sampler_TerrainHolesTexture;
void main()
{
