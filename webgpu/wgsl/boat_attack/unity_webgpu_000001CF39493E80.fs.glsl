...
;
    ...
    u_xlat29.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati3 + 1) / 4][(u_xlati3 + 1) % 4].xyz;
    u_xlat29.xyz = _MainLightWorldToShadow[u_xlati3 / 4][u_xlati3 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat29.xyz;
    u_xlat29.xyz = _MainLightWorldToShadow[(u_xlati3 + 2) / 4][(u_xlati3 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat29.xyz;
    u_xlat3.xyz = u_xlat29.xyz + _MainLightWorldToShadow[(u_xlati3 + 3) / 4][(u_xlati3 + 3) % 4].xyz;
    u_xlat81 = vs_TEXCOORD7.y * unity_MatrixV[1].z;
    u_xlat81 = unity_MatrixV[0].z * vs_TEXCOORD7.x + u_xlat81;
    u_xlat81 = unity_MatrixV[2].z * vs_TEXCOORD7.z + u_xlat81;
    ...
    u_xlat55 = u_xlat29.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    ...
    u_xlat1 = u_xlat29.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat55 = dot(unity_LightIndices[int(u_xlatu55)], uintBitsToFloat(ImmCB_0[u_xlati84]));
        u_xlati55 = int(u_xlat55);
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati55].www + _AdditionalLightsPosition[u_xlati55].xyz;
        ...
        u_xlat84 = u_xlat84 * _AdditionalLightsAttenuation[u_xlati55].x;
        u_xlat84 = (-u_xlat84) * u_xlat84 + 1.0;
        u_xlat84 = max(u_xlat84, 0.0);
        u_xlat84 = u_xlat84 * u_xlat84;
        u_xlat84 = u_xlat84 * u_xlat87;
        u_xlat87 = dot(_AdditionalLightsSpotDir[u_xlati55].xyz, u_xlat10.xyz);
        u_xlat87 = u_xlat87 * _AdditionalLightsAttenuation[u_xlati55].z + _AdditionalLightsAttenuation[u_xlati55].w;
        u_xlat87 = clamp(u_xlat87, 0.0, 1.0);
        u_xlat87 = u_xlat87 * u_xlat87;
        u_xlat84 = u_xlat84 * u_xlat87;
        u_xlati87 = int(_AdditionalShadowParams[u_xlati55].w);
        u_xlatb88 = u_xlati87>=0;
        if(u_xlatb88){
            u_xlatb88 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati55].z);
            if(u_xlatb88){
                ...
                u_xlat11.x = trunc(_AdditionalShadowParams[u_xlati55].w);
            ...
            u_xlatb87 = 0.0<_AdditionalShadowParams[u_xlati55].y;
            if(u_xlatb87){
                u_xlatb87 = 1.0==_AdditionalShadowParams[u_xlati55].y;
                if(u_xlatb87){
                    ...
                    u_xlatb88 = 2.0==_AdditionalShadowParams[u_xlati55].y;
                    if(u_xlatb88){
            ...
            u_xlat88 = 1.0 + (-_AdditionalShadowParams[u_xlati55].x);
            u_xlat87 = u_xlat87 * _AdditionalShadowParams[u_xlati55].x + u_xlat88;
        ...
        u_xlati88 = 1 << (u_xlati55 & int(0x1F));
        u_xlati88 = int(uint(u_xlati88) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati88 != 0) {
            u_xlati88 = int(_AdditionalLightsLightTypes[u_xlati55]);
            u_xlati11 = (u_xlati88 != 0) ? 0 : 1;
            u_xlati37 = u_xlati55 << (2 & int(0x1F));
            if(u_xlati11 != 0) {
                ...
                u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati55].xy * u_xlat11.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati55].zw;
            } else {
                ...
                if(u_xlati88 != 0) {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati55].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati55].zw;
                } else {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati55].xy * u_xlat37.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati55].zw;
                }
            }
            u_xlat11 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat11.xz, 0.0);
            u_xlat88 = (u_xlatb3.y) ? u_xlat11.w : u_xlat11.x;
        ...
        u_xlat55 = u_xlat83 / u_xlat55;
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat55) + u_xlat5.xyz;
