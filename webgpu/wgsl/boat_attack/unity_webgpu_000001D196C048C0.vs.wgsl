...
fn main_1() {
  ...
  let x_131 : vec4<f32> = x_17.x_TintColor;
  vs_COLOR0 = (x_128 * x_131);
  let x_138 : vec2<f32> = in_TEXCOORD0;
  let x_141 : vec4<f32> = x_17.x_MainTex_ST;
  let x_145 : vec4<f32> = x_17.x_MainTex_ST;
  vs_TEXCOORD0 = ((x_138 * vec2<f32>(x_141.x, x_141.y)) + vec2<f32>(x_145.z, x_145.w));
  return;
}
