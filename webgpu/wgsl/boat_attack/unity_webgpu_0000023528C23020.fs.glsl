...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat63 = texture(sampler2D(_DitheringTexture, sampler_DitheringTexture), u_xlat2.xy, _GlobalMipBias.x).w;
    u_xlatb2 = unity_LODFade.x>=0.0;
    u_xlat63 = (u_xlatb2) ? abs(u_xlat63) : -abs(u_xlat63);
...
;
    ...
    u_xlat4.x = u_xlat69 * _MainLightShadowParams.x + u_xlat4.x;
    ...
    u_xlat4.x = u_xlat25.x * u_xlat46.x + u_xlat4.x;
    ...
    if(u_xlatb25.x){
        ...
        u_xlat46.x = (u_xlatb25.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb25.x) ? u_xlat7.xyz : u_xlat46.xxx;
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat8.xyz = u_xlat3.xyz * (-u_xlat25.xxx) + (-u_xlat2.xyz);
    ...
    u_xlat9.xyz = (-u_xlat0.xyz) + vec3(u_xlat66);
    u_xlat9.xyz = u_xlat25.xxx * u_xlat9.xyz + u_xlat0.xyz;
    ...
    u_xlat4.xyw = vec3(u_xlat65) * u_xlat7.xyz;
    ...
    u_xlat66 = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat66 = clamp(u_xlat66, 0.0, 1.0);
    u_xlat65 = u_xlat65 * u_xlat65;
    u_xlat65 = u_xlat65 * u_xlat46.x + 1.00001001;
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat65) + u_xlat22.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu65 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat69 = dot(unity_LightIndices[int(u_xlatu69)], uintBitsToFloat(ImmCB_0[u_xlati49]));
        u_xlatu69 =  uint(int(u_xlat69));
        u_xlat9.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu69)].www + _AdditionalLightsPosition[int(u_xlatu69)].xyz;
        ...
        u_xlat49.x = u_xlat49.x * _AdditionalLightsAttenuation[int(u_xlatu69)].x;
        ...
        u_xlat71 = dot(_AdditionalLightsSpotDir[int(u_xlatu69)].xyz, u_xlat10.xyz);
        u_xlat71 = u_xlat71 * _AdditionalLightsAttenuation[int(u_xlatu69)].z + _AdditionalLightsAttenuation[int(u_xlatu69)].w;
        u_xlat71 = clamp(u_xlat71, 0.0, 1.0);
        u_xlat71 = u_xlat71 * u_xlat71;
        u_xlat49.x = u_xlat49.x * u_xlat71;
        u_xlatu71 = u_xlatu69 >> (5u & uint(0x1F));
        u_xlati72 = 1 << (int(u_xlatu69) & int(0x1F));
        u_xlati71 = int(uint(u_xlati72) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu71)]));
        if(u_xlati71 != 0) {
            u_xlati71 = int(_AdditionalLightsLightTypes[int(u_xlatu69)]);
            u_xlati72 = (u_xlati71 != 0) ? 0 : 1;
            u_xlati73 = int(u_xlatu69) << (2 & int(0x1F));
            if(u_xlati72 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].zw;
            } else {
                ...
                if(u_xlati71 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].xy * u_xlat53.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu69)].zw;
                } else {
        ...
        u_xlat69 = u_xlat69 * u_xlat46.x + 1.00001001;
        u_xlat49.x = u_xlat49.x * u_xlat49.x;
        u_xlat69 = u_xlat69 * u_xlat69;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat69) + u_xlat22.xyz;
