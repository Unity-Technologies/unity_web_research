...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1314.x, x_1314.y, x_1314.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1317 : vec4<f32> = u_xlat0;
  let x_1320 : vec3<f32> = log2(abs(vec3<f32>(x_1317.x, x_1317.y, x_1317.z)));
  let x_1321 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1320.x, x_1320.y, x_1320.z, x_1321.w);
  let x_1323 : vec4<f32> = u_xlat2;
  let x_1325 : vec3<f32> = (vec3<f32>(x_1323.x, x_1323.y, x_1323.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1336 : vec3<f32> = ((vec3<f32>(x_1333.x, x_1333.y, x_1333.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1337 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1336.x, x_1336.y, x_1336.z, x_1337.w);
  let x_1339 : vec4<f32> = u_xlat0;
  let x_1341 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1339.x, x_1339.y, x_1339.z, x_1339.x));
  u_xlatb0 = vec3<bool>(x_1341.x, x_1341.y, x_1341.z);
  let x_1344 : bool = u_xlatb0.x;
  if (x_1344) {
  ...
  u_xlat0.x = x_1353;
  let x_1356 : bool = u_xlatb0.y;
  if (x_1356) {
    let x_1361 : f32 = u_xlat1.y;
    x_1357 = x_1361;
  } else {
    let x_1364 : f32 = u_xlat2.y;
    x_1357 = x_1364;
  }
  let x_1365 : f32 = x_1357;
  u_xlat0.y = x_1365;
  let x_1368 : bool = u_xlatb0.z;
  if (x_1368) {
    let x_1373 : f32 = u_xlat1.z;
    x_1369 = x_1373;
  } else {
    let x_1376 : f32 = u_xlat2.z;
    x_1369 = x_1376;
  }
  ...
  let x_1431 : vec3<f32> = log2(abs(vec3<f32>(x_1428.x, x_1428.y, x_1428.z)));
  let x_1432 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1431.x, x_1431.y, x_1431.z, x_1432.w);
  let x_1434 : vec4<f32> = u_xlat2;
  let x_1436 : vec3<f32> = (vec3<f32>(x_1434.x, x_1434.y, x_1434.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1437 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1436.x, x_1436.y, x_1436.z, x_1437.w);
  let x_1439 : vec4<f32> = u_xlat2;
  let x_1441 : vec3<f32> = exp2(vec3<f32>(x_1439.x, x_1439.y, x_1439.z));
  let x_1442 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1441.x, x_1441.y, x_1441.z, x_1442.w);
  let x_1444 : vec4<f32> = u_xlat2;
  let x_1447 : vec3<f32> = ((vec3<f32>(x_1444.x, x_1444.y, x_1444.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1448 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1447.x, x_1447.y, x_1447.z, x_1448.w);
  let x_1450 : vec4<f32> = u_xlat0;
  let x_1452 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1450.x, x_1450.y, x_1450.z, x_1450.x));
  ...
  u_xlat0.z = x_1488;
  let x_1490 : f32 = u_xlat21;
  let x_1495 : vec4<f32> = u_xlat0;
  let x_1497 : vec3<f32> = ((vec3<f32>(x_1490, x_1490, x_1490) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1495.x, x_1495.y, x_1495.z));
  let x_1498 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1497.x, x_1497.y, x_1497.z, x_1498.w);
  let x_1500 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1500.x, x_1500.y, x_1500.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1503 : vec4<f32> = u_xlat0;
  let x_1505 : vec3<f32> = (vec3<f32>(x_1503.x, x_1503.y, x_1503.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1506 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1505.x, x_1505.y, x_1505.z, x_1506.w);
  let x_1508 : vec4<f32> = u_xlat2;
  let x_1510 : vec3<f32> = (vec3<f32>(x_1508.x, x_1508.y, x_1508.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1511 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1510.x, x_1510.y, x_1510.z, x_1511.w);
  let x_1513 : vec4<f32> = u_xlat2;
  let x_1516 : vec3<f32> = log2(abs(vec3<f32>(x_1513.x, x_1513.y, x_1513.z)));
  let x_1517 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1516.x, x_1516.y, x_1516.z, x_1517.w);
  let x_1519 : vec4<f32> = u_xlat2;
  let x_1521 : vec3<f32> = (vec3<f32>(x_1519.x, x_1519.y, x_1519.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1531 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1529.x, x_1529.y, x_1529.z, x_1529.x));
  ...
  let x_1574 : vec3<f32> = max(vec3<f32>(x_1571.x, x_1571.y, x_1571.z), vec3<f32>(0.0f, 0.0f, 0.0f));
