...
void main()
{
    ...
    u_xlat1.x = inversesqrt(u_xlat1.x);
    u_xlat4.xyz = u_xlat13.xyz * u_xlat1.xxx;
    ...
    u_xlat5.x = (u_xlatb13.x) ? u_xlat1.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb13.x) ? u_xlat1.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb13.x) ? u_xlat1.z : unity_MatrixV[2].z;
    u_xlat13.xyz = vs_INTERP7.xyz + (-_CascadeShadowSplitSpheres0.xyz);
...
;
    u_xlat13.x = (u_xlatb6.x) ? float(-1.0) : float(-0.0);
    u_xlat13.y = (u_xlatb6.y) ? float(-1.0) : float(-0.0);
    u_xlat13.z = (u_xlatb6.z) ? float(-1.0) : float(-0.0);
    u_xlat13.xyz = u_xlat13.xyz + u_xlat8.yzw;
    u_xlat8.yzw = max(u_xlat13.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat13.x = dot(u_xlat8, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat13.x = (-u_xlat13.x) + 4.0;
    u_xlatu13 = uint(u_xlat13.x);
    u_xlati13 = int(u_xlatu13) << (2 & int(0x1F));
    u_xlat1.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati13 + 1) / 4][(u_xlati13 + 1) % 4].xyz;
    u_xlat1.xyz = _MainLightWorldToShadow[u_xlati13 / 4][u_xlati13 % 4].xyz * vs_INTERP7.xxx + u_xlat1.xyz;
    u_xlat1.xyz = _MainLightWorldToShadow[(u_xlati13 + 2) / 4][(u_xlati13 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat1.xyz;
    u_xlat13.xyz = u_xlat1.xyz + _MainLightWorldToShadow[(u_xlati13 + 3) / 4][(u_xlati13 + 3) % 4].xyz;
    u_xlat4.w = 1.0;
    ...
    u_xlat13.x = u_xlat13.x * _MainLightShadowParams.x + u_xlat26;
    u_xlatb26 = 0.0>=u_xlat13.z;
    u_xlatb39 = u_xlat13.z>=1.0;
    u_xlatb26 = u_xlatb39 || u_xlatb26;
    u_xlat13.x = (u_xlatb26) ? 1.0 : u_xlat13.x;
    u_xlat6.xyz = vs_INTERP7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat26 = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat39 = u_xlat26 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat39 = clamp(u_xlat39, 0.0, 1.0);
    u_xlat6.x = (-u_xlat13.x) + 1.0;
    u_xlat13.x = u_xlat39 * u_xlat6.x + u_xlat13.x;
    ...
    u_xlat7.xyz = u_xlat4.xyz * (-vec3(u_xlat39)) + (-u_xlat5.xyz);
    ...
    u_xlat21.xyz = vec3(u_xlat39) * u_xlat21.xyz + u_xlat2.xyz;
    ...
    u_xlat0.x = u_xlat13.x * unity_LightData.z;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu40 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat48 = u_xlat26 * u_xlat10.x + u_xlat48;
        ...
        u_xlat32.x = dot(u_xlat4.xyz, u_xlat21.xyz);
    ...
    u_xlat0.xyz = u_xlat1.xyz * vec3(u_xlat44) + u_xlat0.xyw;
