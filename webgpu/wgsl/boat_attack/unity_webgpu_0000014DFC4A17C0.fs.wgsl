...
fn main_1() {
  ...
  let x_1042 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1046 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1048 : vec2<f32> = ((x_1039 * vec2<f32>(x_1042.x, x_1042.y)) + vec2<f32>(x_1046.z, x_1046.w));
  let x_1049 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1048.x, x_1048.y, x_1049.z, x_1049.w);
  let x_1056 : vec4<f32> = u_xlat1;
  let x_1059 : f32 = x_25.x_GlobalMipBias.x;
  let x_1060 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1056.x, x_1056.y), x_1059);
  u_xlat21 = x_1060.w;
  let x_1062 : f32 = u_xlat21;
  u_xlat21 = ((x_1062 * 2.0f) + -1.0f);
  let x_1066 : f32 = u_xlat21;
  u_xlatb1.x = (x_1066 >= 0.0f);
  let x_1070 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1070);
  let x_1073 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1073)) + 1.0f);
  let x_1077 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1077);
  let x_1079 : f32 = u_xlat21;
  u_xlat21 = (-(x_1079) + 1.0f);
  let x_1082 : f32 = u_xlat21;
  let x_1084 : f32 = u_xlat1.x;
  u_xlat21 = (x_1082 * x_1084);
  let x_1086 : vec4<f32> = u_xlat0;
  let x_1088 : vec3<f32> = (vec3<f32>(x_1086.x, x_1086.y, x_1086.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  ...
  let x_1099 : vec3<f32> = (vec3<f32>(x_1097.x, x_1097.y, x_1097.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1110 : vec3<f32> = ((vec3<f32>(x_1107.x, x_1107.y, x_1107.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1111 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1110.x, x_1110.y, x_1110.z, x_1111.w);
  let x_1114 : vec4<f32> = u_xlat0;
  let x_1116 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1114.x, x_1114.y, x_1114.z, x_1114.x));
  u_xlatb0 = vec3<bool>(x_1116.x, x_1116.y, x_1116.z);
  ...
  u_xlat0.y = x_1140;
  let x_1143 : bool = u_xlatb0.z;
  if (x_1143) {
    let x_1148 : f32 = u_xlat1.z;
    x_1144 = x_1148;
  } else {
  ...
  u_xlat0.z = x_1152;
  let x_1154 : f32 = u_xlat21;
  let x_1159 : vec4<f32> = u_xlat0;
  let x_1161 : vec3<f32> = ((vec3<f32>(x_1154, x_1154, x_1154) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1159.x, x_1159.y, x_1159.z));
  let x_1162 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1161.x, x_1161.y, x_1161.z, x_1162.w);
  let x_1164 : vec4<f32> = u_xlat0;
  let x_1166 : vec3<f32> = (vec3<f32>(x_1164.x, x_1164.y, x_1164.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1167 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1166.x, x_1166.y, x_1166.z, x_1167.w);
  let x_1169 : vec4<f32> = u_xlat0;
  let x_1171 : vec3<f32> = (vec3<f32>(x_1169.x, x_1169.y, x_1169.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1172 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1171.x, x_1171.y, x_1171.z, x_1172.w);
  let x_1174 : vec4<f32> = u_xlat2;
  let x_1176 : vec3<f32> = (vec3<f32>(x_1174.x, x_1174.y, x_1174.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1177 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1176.x, x_1176.y, x_1176.z, x_1177.w);
  let x_1179 : vec4<f32> = u_xlat2;
  let x_1182 : vec3<f32> = log2(abs(vec3<f32>(x_1179.x, x_1179.y, x_1179.z)));
  let x_1183 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1182.x, x_1182.y, x_1182.z, x_1183.w);
  let x_1185 : vec4<f32> = u_xlat2;
  let x_1187 : vec3<f32> = (vec3<f32>(x_1185.x, x_1185.y, x_1185.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1188 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1187.x, x_1187.y, x_1187.z, x_1188.w);
  let x_1190 : vec4<f32> = u_xlat2;
  let x_1192 : vec3<f32> = exp2(vec3<f32>(x_1190.x, x_1190.y, x_1190.z));
  let x_1193 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1192.x, x_1192.y, x_1192.z, x_1193.w);
  let x_1195 : vec4<f32> = u_xlat0;
  let x_1197 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1195.x, x_1195.y, x_1195.z, x_1195.x));
  ...
  let x_1240 : vec3<f32> = max(vec3<f32>(x_1237.x, x_1237.y, x_1237.z), vec3<f32>(0.0f, 0.0f, 0.0f));
