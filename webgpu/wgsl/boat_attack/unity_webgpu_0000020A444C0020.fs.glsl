...
void main()
{
    ...
    u_xlati54 = int(u_xlatu80 ^ u_xlatu54);
    u_xlati54 = u_xlati54 * 32769;
    u_xlat54.x = intBitsToFloat(int(int_bitfieldInsert(1065353216, u_xlati54, 0 & int(0x1F), 23)));
    u_xlat54.x = u_xlat54.x + -1.0;
    u_xlat80 = (-u_xlat54.x) + 1.0;
    u_xlat28 = (u_xlatb28) ? u_xlat54.x : u_xlat80;
    u_xlat79 = u_xlat79 * 2.0 + (-u_xlat28);
    u_xlat28 = u_xlat79 * u_xlat6.w;
    u_xlatb54 = u_xlat28>=0.400000006;
    u_xlat54.x = u_xlatb54 ? u_xlat28 : float(0.0);
    ...
    u_xlat79 = (u_xlatb28) ? u_xlat79 : u_xlat54.x;
    u_xlat54.x = u_xlat79 + -9.99999975e-05;
    u_xlatb54 = u_xlat54.x<0.0;
    ...
    u_xlat54.x = dot(u_xlat26.xyz, u_xlat26.xyz);
    u_xlat54.x = inversesqrt(u_xlat54.x);
    u_xlat26.xyz = u_xlat26.xyz * u_xlat54.xxx;
    ...
    u_xlat54.x = dot(u_xlat26.xyz, u_xlat3.xyz);
    u_xlat54.x = u_xlat54.x + 0.5;
    u_xlat3.xyz = u_xlat54.xxx * u_xlat4.xyz;
    u_xlat54.x = max(u_xlat3.w, 9.99999975e-05);
    u_xlat3.xyz = u_xlat3.xyz / u_xlat54.xxx;
    u_xlat8.x = u_xlat8.x;
    u_xlat8.x = clamp(u_xlat8.x, 0.0, 1.0);
    u_xlat79 = u_xlat79;
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    u_xlat4.xyz = u_xlat7.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat54.x = (-u_xlat8.x) + 1.0;
    u_xlat80 = u_xlat54.x * u_xlat54.x;
    u_xlat80 = max(u_xlat80, 0.0078125);
    u_xlat81 = u_xlat80 * u_xlat80;
    u_xlat82 = u_xlat8.x + 0.0400000215;
    u_xlat82 = min(u_xlat82, 1.0);
    u_xlat83 = u_xlat80 * 4.0 + 2.0;
    ...
    if(u_xlatb0){
        ...
        if(u_xlatb0){
            ...
            if(u_xlatb32.x){
                ...
                u_xlat0.x = u_xlat32.x * u_xlat84 + u_xlat58;
            } else {
                u_xlat32.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat32.xy = floor(u_xlat32.xy);
                u_xlat7.xy = vs_INTERP3.xy * _MainLightShadowmapSize.zw + (-u_xlat32.xy);
                ...
                u_xlat0.x = u_xlat7.w * u_xlat32.x + u_xlat84;
            }
        }
    } else {
    ...
    u_xlatb2 = u_xlatb2 || u_xlatb32.x;
    u_xlat0.x = (u_xlatb2) ? 1.0 : u_xlat0.x;
    u_xlat32.xyz = vs_INTERP8.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat2.x = dot(u_xlat32.xyz, u_xlat32.xyz);
    u_xlat32.x = u_xlat2.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat32.x = clamp(u_xlat32.x, 0.0, 1.0);
    u_xlat58 = (-u_xlat0.x) + 1.0;
    u_xlat0.x = u_xlat32.x * u_xlat58 + u_xlat0.x;
    ...
    u_xlat7.x = dot((-u_xlat5.xyz), u_xlat26.xyz);
    u_xlat7.x = u_xlat7.x + u_xlat7.x;
    u_xlat7.xyz = u_xlat26.xyz * (-u_xlat7.xxx) + (-u_xlat5.xyz);
    u_xlat85 = dot(u_xlat26.xyz, u_xlat5.xyz);
    u_xlat85 = clamp(u_xlat85, 0.0, 1.0);
    u_xlat85 = (-u_xlat85) + 1.0;
    u_xlat85 = u_xlat85 * u_xlat85;
    u_xlat85 = u_xlat85 * u_xlat85;
    u_xlat8.x = (-u_xlat54.x) * 0.699999988 + 1.70000005;
    u_xlat54.x = u_xlat54.x * u_xlat8.x;
    u_xlat54.x = u_xlat54.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat54.x);
    u_xlat54.x = u_xlat8.w + -1.0;
    u_xlat54.x = unity_SpecCube0_HDR.w * u_xlat54.x + 1.0;
    u_xlat54.x = max(u_xlat54.x, 0.0);
    u_xlat54.x = log2(u_xlat54.x);
    u_xlat54.x = u_xlat54.x * unity_SpecCube0_HDR.y;
    u_xlat54.x = exp2(u_xlat54.x);
    u_xlat54.x = u_xlat54.x * unity_SpecCube0_HDR.x;
    u_xlat7.xyz = u_xlat8.xyz * u_xlat54.xxx;
    u_xlat54.xy = vec2(u_xlat80) * vec2(u_xlat80) + vec2(-1.0, 1.0);
    u_xlat80 = float(1.0) / u_xlat54.y;
    ...
    u_xlat0.x = dot(u_xlat26.xyz, u_xlat7.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat80 = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat54.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat59.x = dot(u_xlat26.xyz, u_xlat10.xyz);
