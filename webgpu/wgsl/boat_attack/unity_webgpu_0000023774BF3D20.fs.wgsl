...
fn main_1() {
  ...
  let x_308 : vec3<f32> = ((vec3<f32>(x_301.x, x_301.y, x_301.z) * vec3<f32>(x_304.x, x_304.y, x_304.z)) + vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_309 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_308.x, x_308.y, x_308.z, x_309.w);
  SV_Target0.w = 1.0f;
  return;
}
