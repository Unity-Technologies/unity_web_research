...
void main()
{
    ...
    u_xlat30.x = (-u_xlat16.x) + 1.0;
    u_xlat2.x = (u_xlatb2) ? u_xlat16.x : u_xlat30.x;
    ...
    u_xlat16.x = vs_INTERP8.y * unity_MatrixV[1].z;
    u_xlat16.x = unity_MatrixV[0].z * vs_INTERP8.x + u_xlat16.x;
    u_xlat16.x = unity_MatrixV[2].z * vs_INTERP8.z + u_xlat16.x;
    ...
    u_xlat30.x = dot(u_xlat14.xyz, u_xlat3.xyz);
    u_xlat30.x = u_xlat30.x + 0.5;
    u_xlat3.xyz = u_xlat30.xxx * u_xlat5.xyz;
    u_xlat30.x = max(u_xlat3.w, 9.99999975e-05);
    ...
    u_xlat34.x = dot((-u_xlat4.xyz), u_xlat14.xyz);
    u_xlat34.x = u_xlat34.x + u_xlat34.x;
    u_xlat8.xyz = u_xlat14.xyz * (-u_xlat34.xxx) + (-u_xlat4.xyz);
    u_xlat34.x = dot(u_xlat14.xyz, u_xlat4.xyz);
    u_xlat34.x = clamp(u_xlat34.x, 0.0, 1.0);
    ...
    u_xlat44 = dot(u_xlat14.xyz, _MainLightPosition.xyz);
    ...
    u_xlat43 = u_xlat43 * u_xlat30.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu43 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat48 = dot(u_xlat14.xyz, u_xlat9.xyz);
    ...
    u_xlat14.xyz = u_xlat3.xyz * u_xlat6.xxx + u_xlat7.xyz;
