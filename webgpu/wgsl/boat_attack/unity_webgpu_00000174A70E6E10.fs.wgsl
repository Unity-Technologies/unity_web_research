...
@group(1) @binding(1) var<uniform> x_1042 : AdditionalLights;
...
fn main_1() {
  ...
  loop {
    ...
    let x_1007 : u32 = u_xlatu36;
    let x_1010 : vec4<f32> = x_282.unity_LightIndices[bitcast<i32>(x_1007)];
    let x_1020 : i32 = u_xlati38;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1025 : vec4<u32> = indexable[x_1020];
    u_xlat36 = dot(x_1010, bitcast<vec4<f32>>(x_1025));
    let x_1029 : f32 = u_xlat36;
    u_xlati36 = i32(x_1029);
    let x_1031 : vec3<f32> = vs_INTERP0;
    let x_1043 : i32 = u_xlati36;
    let x_1045 : vec4<f32> = x_1042.x_AdditionalLightsPosition[x_1043];
    let x_1048 : i32 = u_xlati36;
    let x_1050 : vec4<f32> = x_1042.x_AdditionalLightsPosition[x_1048];
    u_xlat8 = ((-(x_1031) * vec3<f32>(x_1045.w, x_1045.w, x_1045.w)) + vec3<f32>(x_1050.x, x_1050.y, x_1050.z));
    let x_1053 : vec3<f32> = u_xlat8;
    let x_1054 : vec3<f32> = u_xlat8;
    u_xlat38 = dot(x_1053, x_1054);
    let x_1056 : f32 = u_xlat38;
    u_xlat38 = max(x_1056, 6.10351562e-05f);
    let x_1059 : f32 = u_xlat38;
    u_xlat39 = inverseSqrt(x_1059);
    let x_1062 : f32 = u_xlat39;
    let x_1064 : vec3<f32> = u_xlat8;
    u_xlat9 = (vec3<f32>(x_1062, x_1062, x_1062) * x_1064);
    let x_1067 : f32 = u_xlat38;
    u_xlat40 = (1.0f / x_1067);
    let x_1069 : f32 = u_xlat38;
    let x_1070 : i32 = u_xlati36;
    let x_1072 : f32 = x_1042.x_AdditionalLightsAttenuation[x_1070].x;
    u_xlat38 = (x_1069 * x_1072);
    let x_1074 : f32 = u_xlat38;
    let x_1076 : f32 = u_xlat38;
    u_xlat38 = ((-(x_1074) * x_1076) + 1.0f);
    let x_1079 : f32 = u_xlat38;
    u_xlat38 = max(x_1079, 0.0f);
    let x_1081 : f32 = u_xlat38;
    let x_1082 : f32 = u_xlat38;
    u_xlat38 = (x_1081 * x_1082);
    let x_1084 : f32 = u_xlat38;
    let x_1085 : f32 = u_xlat40;
    u_xlat38 = (x_1084 * x_1085);
    let x_1087 : i32 = u_xlati36;
    let x_1089 : vec4<f32> = x_1042.x_AdditionalLightsSpotDir[x_1087];
    let x_1091 : vec3<f32> = u_xlat9;
    u_xlat40 = dot(vec3<f32>(x_1089.x, x_1089.y, x_1089.z), x_1091);
    let x_1093 : f32 = u_xlat40;
    let x_1094 : i32 = u_xlati36;
    let x_1096 : f32 = x_1042.x_AdditionalLightsAttenuation[x_1094].z;
    let x_1098 : i32 = u_xlati36;
    let x_1100 : f32 = x_1042.x_AdditionalLightsAttenuation[x_1098].w;
    u_xlat40 = ((x_1093 * x_1096) + x_1100);
    let x_1102 : f32 = u_xlat40;
    u_xlat40 = clamp(x_1102, 0.0f, 1.0f);
    ...
    let x_1113 : i32 = u_xlati36;
    let x_1115 : vec4<f32> = x_1042.x_AdditionalLightsColor[x_1113];
    u_xlat10 = (vec3<f32>(x_1111, x_1111, x_1111) * vec3<f32>(x_1115.x, x_1115.y, x_1115.z));
    let x_1118 : vec4<f32> = u_xlat3;
    let x_1120 : vec3<f32> = u_xlat9;
    u_xlat36 = dot(vec3<f32>(x_1118.x, x_1118.y, x_1118.z), x_1120);
    let x_1122 : f32 = u_xlat36;
    u_xlat36 = clamp(x_1122, 0.0f, 1.0f);
    let x_1124 : f32 = u_xlat36;
    let x_1125 : f32 = u_xlat38;
    u_xlat36 = (x_1124 * x_1125);
    let x_1127 : f32 = u_xlat36;
    let x_1129 : vec3<f32> = u_xlat10;
    u_xlat10 = (vec3<f32>(x_1127, x_1127, x_1127) * x_1129);
    let x_1131 : vec3<f32> = u_xlat8;
    let x_1132 : f32 = u_xlat39;
    let x_1135 : vec3<f32> = u_xlat4;
    u_xlat8 = ((x_1131 * vec3<f32>(x_1132, x_1132, x_1132)) + x_1135);
    let x_1137 : vec3<f32> = u_xlat8;
    let x_1138 : vec3<f32> = u_xlat8;
    u_xlat36 = dot(x_1137, x_1138);
    let x_1140 : f32 = u_xlat36;
    u_xlat36 = max(x_1140, 1.17549435e-37f);
    let x_1142 : f32 = u_xlat36;
    u_xlat36 = inverseSqrt(x_1142);
  ...
  let x_1202 : vec3<f32> = u_xlat12;
  let x_1203 : f32 = u_xlat33;
  let x_1206 : vec3<f32> = u_xlat5;
  let x_1207 : vec3<f32> = ((x_1202 * vec3<f32>(x_1203, x_1203, x_1203)) + x_1206);
