...
fn main_1() {
  ...
  let x_1639 : vec2<f32> = vs_TEXCOORD0;
  let x_1642 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1646 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1648 : vec2<f32> = ((x_1639 * vec2<f32>(x_1642.x, x_1642.y)) + vec2<f32>(x_1646.z, x_1646.w));
  let x_1649 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1648.x, x_1648.y, x_1649.z, x_1649.w);
  let x_1656 : vec4<f32> = u_xlat1;
  let x_1659 : f32 = x_14.x_GlobalMipBias.x;
  let x_1660 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1656.x, x_1656.y), x_1659);
  u_xlat18 = x_1660.w;
  let x_1662 : f32 = u_xlat18;
  u_xlat18 = ((x_1662 * 2.0f) + -1.0f);
  let x_1665 : f32 = u_xlat18;
  u_xlatb1 = (x_1665 >= 0.0f);
  let x_1667 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1667);
  let x_1670 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1670)) + 1.0f);
  let x_1674 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1674);
  let x_1676 : f32 = u_xlat18;
  u_xlat18 = (-(x_1676) + 1.0f);
  let x_1679 : f32 = u_xlat18;
  let x_1681 : f32 = u_xlat1.x;
  u_xlat18 = (x_1679 * x_1681);
  let x_1683 : vec3<f32> = u_xlat0;
  let x_1684 : vec3<f32> = (x_1683 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1685 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1684.x, x_1684.y, x_1684.z, x_1685.w);
  let x_1687 : vec3<f32> = u_xlat0;
  let x_1689 : vec3<f32> = log2(abs(x_1687));
  let x_1690 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1689.x, x_1689.y, x_1689.z, x_1690.w);
  let x_1692 : vec4<f32> = u_xlat2;
  let x_1694 : vec3<f32> = (vec3<f32>(x_1692.x, x_1692.y, x_1692.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1705 : vec3<f32> = ((vec3<f32>(x_1702.x, x_1702.y, x_1702.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1706 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1705.x, x_1705.y, x_1705.z, x_1706.w);
  let x_1708 : vec3<f32> = u_xlat0;
  let x_1710 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1708.x, x_1708.y, x_1708.z, x_1708.x));
  ...
  u_xlat0.z = x_1746;
  let x_1748 : f32 = u_xlat18;
  let x_1753 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1748, x_1748, x_1748) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1753);
  let x_1755 : vec3<f32> = u_xlat0;
  let x_1756 : vec3<f32> = (x_1755 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1757 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1756.x, x_1756.y, x_1756.z, x_1757.w);
  let x_1759 : vec3<f32> = u_xlat0;
  let x_1760 : vec3<f32> = (x_1759 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1761 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1760.x, x_1760.y, x_1760.z, x_1761.w);
  let x_1763 : vec4<f32> = u_xlat2;
  let x_1765 : vec3<f32> = (vec3<f32>(x_1763.x, x_1763.y, x_1763.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1766 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1765.x, x_1765.y, x_1765.z, x_1766.w);
  let x_1768 : vec4<f32> = u_xlat2;
  let x_1771 : vec3<f32> = log2(abs(vec3<f32>(x_1768.x, x_1768.y, x_1768.z)));
  let x_1772 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1771.x, x_1771.y, x_1771.z, x_1772.w);
  let x_1774 : vec4<f32> = u_xlat2;
  let x_1776 : vec3<f32> = (vec3<f32>(x_1774.x, x_1774.y, x_1774.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1784 : vec3<f32> = u_xlat0;
  let x_1786 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1784.x, x_1784.y, x_1784.z, x_1784.x));
  u_xlatb0 = vec3<bool>(x_1786.x, x_1786.y, x_1786.z);
  let x_1789 : bool = u_xlatb0.x;
  if (x_1789) {
  ...
  let x_1798 : f32 = x_1790;
  u_xlat0.x = x_1798;
  let x_1801 : bool = u_xlatb0.y;
  if (x_1801) {
    let x_1806 : f32 = u_xlat1.y;
    x_1802 = x_1806;
  } else {
    let x_1809 : f32 = u_xlat2.y;
    x_1802 = x_1809;
  }
  let x_1810 : f32 = x_1802;
  u_xlat0.y = x_1810;
  let x_1813 : bool = u_xlatb0.z;
  if (x_1813) {
    let x_1818 : f32 = u_xlat1.z;
    x_1814 = x_1818;
  } else {
    let x_1821 : f32 = u_xlat2.z;
    x_1814 = x_1821;
  }
  let x_1822 : f32 = x_1814;
  u_xlat0.z = x_1822;
  let x_1826 : vec3<f32> = u_xlat0;
  let x_1827 : vec3<f32> = max(x_1826, vec3<f32>(0.0f, 0.0f, 0.0f));
