...
fn main_1() {
  ...
  let x_1277 : vec2<f32> = vs_TEXCOORD0;
  let x_1280 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1284 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1286 : vec2<f32> = ((x_1277 * vec2<f32>(x_1280.x, x_1280.y)) + vec2<f32>(x_1284.z, x_1284.w));
  let x_1287 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1286.x, x_1286.y, x_1287.z);
  let x_1294 : vec3<f32> = u_xlat1;
  let x_1297 : f32 = x_25.x_GlobalMipBias.x;
  let x_1298 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1294.x, x_1294.y), x_1297);
  u_xlat21 = x_1298.w;
  let x_1300 : f32 = u_xlat21;
  u_xlat21 = ((x_1300 * 2.0f) + -1.0f);
  let x_1303 : f32 = u_xlat21;
  u_xlatb1.x = (x_1303 >= 0.0f);
  let x_1307 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1307);
  let x_1310 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1310)) + 1.0f);
  let x_1314 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1314);
  let x_1316 : f32 = u_xlat21;
  u_xlat21 = (-(x_1316) + 1.0f);
  let x_1319 : f32 = u_xlat21;
  let x_1321 : f32 = u_xlat1.x;
  u_xlat21 = (x_1319 * x_1321);
  let x_1323 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1323.x, x_1323.y, x_1323.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1326 : vec4<f32> = u_xlat0;
  let x_1329 : vec3<f32> = log2(abs(vec3<f32>(x_1326.x, x_1326.y, x_1326.z)));
  let x_1330 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1329.x, x_1329.y, x_1329.z, x_1330.w);
  let x_1332 : vec4<f32> = u_xlat2;
  let x_1334 : vec3<f32> = (vec3<f32>(x_1332.x, x_1332.y, x_1332.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1335 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1334.x, x_1334.y, x_1334.z, x_1335.w);
  let x_1337 : vec4<f32> = u_xlat2;
  let x_1339 : vec3<f32> = exp2(vec3<f32>(x_1337.x, x_1337.y, x_1337.z));
  let x_1340 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1339.x, x_1339.y, x_1339.z, x_1340.w);
  let x_1342 : vec4<f32> = u_xlat2;
  let x_1345 : vec3<f32> = ((vec3<f32>(x_1342.x, x_1342.y, x_1342.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1346 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1345.x, x_1345.y, x_1345.z, x_1346.w);
  let x_1348 : vec4<f32> = u_xlat0;
  let x_1350 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1348.x, x_1348.y, x_1348.z, x_1348.x));
  u_xlatb0 = vec3<bool>(x_1350.x, x_1350.y, x_1350.z);
  ...
  u_xlat0.x = x_1362;
  let x_1365 : bool = u_xlatb0.y;
  if (x_1365) {
    let x_1370 : f32 = u_xlat1.y;
    x_1366 = x_1370;
  } else {
    let x_1373 : f32 = u_xlat2.y;
    x_1366 = x_1373;
  }
  let x_1374 : f32 = x_1366;
  u_xlat0.y = x_1374;
  let x_1377 : bool = u_xlatb0.z;
  if (x_1377) {
    let x_1382 : f32 = u_xlat1.z;
    x_1378 = x_1382;
  } else {
  ...
  u_xlat0.z = x_1386;
  let x_1388 : f32 = u_xlat21;
  let x_1393 : vec4<f32> = u_xlat0;
  let x_1395 : vec3<f32> = ((vec3<f32>(x_1388, x_1388, x_1388) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1393.x, x_1393.y, x_1393.z));
  let x_1396 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1395.x, x_1395.y, x_1395.z, x_1396.w);
  let x_1398 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1398.x, x_1398.y, x_1398.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1401 : vec4<f32> = u_xlat0;
  let x_1403 : vec3<f32> = (vec3<f32>(x_1401.x, x_1401.y, x_1401.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1404 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1403.x, x_1403.y, x_1403.z, x_1404.w);
  let x_1406 : vec4<f32> = u_xlat2;
  let x_1408 : vec3<f32> = (vec3<f32>(x_1406.x, x_1406.y, x_1406.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1409 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1408.x, x_1408.y, x_1408.z, x_1409.w);
  let x_1411 : vec4<f32> = u_xlat2;
  let x_1414 : vec3<f32> = log2(abs(vec3<f32>(x_1411.x, x_1411.y, x_1411.z)));
  let x_1415 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1414.x, x_1414.y, x_1414.z, x_1415.w);
  let x_1417 : vec4<f32> = u_xlat2;
  let x_1419 : vec3<f32> = (vec3<f32>(x_1417.x, x_1417.y, x_1417.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1420 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1419.x, x_1419.y, x_1419.z, x_1420.w);
  let x_1422 : vec4<f32> = u_xlat2;
  let x_1424 : vec3<f32> = exp2(vec3<f32>(x_1422.x, x_1422.y, x_1422.z));
  let x_1425 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1424.x, x_1424.y, x_1424.z, x_1425.w);
  let x_1427 : vec4<f32> = u_xlat0;
  let x_1429 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1427.x, x_1427.y, x_1427.z, x_1427.x));
  u_xlatb0 = vec3<bool>(x_1429.x, x_1429.y, x_1429.z);
  let x_1432 : bool = u_xlatb0.x;
  if (x_1432) {
  ...
  u_xlat0.x = x_1441;
  let x_1444 : bool = u_xlatb0.y;
  if (x_1444) {
    let x_1449 : f32 = u_xlat1.y;
    x_1445 = x_1449;
  } else {
    let x_1452 : f32 = u_xlat2.y;
    x_1445 = x_1452;
  }
  let x_1453 : f32 = x_1445;
  u_xlat0.y = x_1453;
  let x_1456 : bool = u_xlatb0.z;
  if (x_1456) {
    let x_1461 : f32 = u_xlat1.z;
    x_1457 = x_1461;
  } else {
  ...
  let x_1472 : vec3<f32> = max(vec3<f32>(x_1469.x, x_1469.y, x_1469.z), vec3<f32>(0.0f, 0.0f, 0.0f));
