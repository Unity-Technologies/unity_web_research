...
fn main_1() {
  ...
  u_xlat2 = (vec4<f32>(x_97.y, x_97.y, x_97.y, x_97.y) * vec4<f32>(0.00600000005215406418f, 0.01999999955296516418f, 0.01999999955296516418f, 0.05000000074505805969f));
  let x_104 : vec4<f32> = u_xlat1;
  let x_111 : vec4<f32> = u_xlat2;
  u_xlat1 = ((vec4<f32>(x_104.x, x_104.x, x_104.x, x_104.x) * vec4<f32>(0.01200000010430812836f, 0.01999999955296516418f, 0.05999999865889549255f, 0.02400000020861625671f)) + x_111);
  let x_114 : vec4<f32> = x_18.x_WaveAndDistance;
  let x_122 : vec4<f32> = u_xlat1;
  u_xlat1 = ((vec4<f32>(x_114.x, x_114.x, x_114.x, x_114.x) * vec4<f32>(1.20000004768371582031f, 2.0f, 1.60000002384185791016f, 4.80000019073486328125f)) + x_122);
  let x_124 : vec4<f32> = u_xlat1;
  u_xlat1 = fract(x_124);
  let x_126 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_126 * vec4<f32>(6.40884876251220703125f, 6.40884876251220703125f, 6.40884876251220703125f, 6.40884876251220703125f)) + vec4<f32>(-3.14159274101257324219f, -3.14159274101257324219f, -3.14159274101257324219f, -3.14159274101257324219f));
  ...
  u_xlat1 = ((x_140 * vec4<f32>(-0.16161616146564483643f, -0.16161616146564483643f, -0.16161616146564483643f, -0.16161616146564483643f)) + x_144);
  ...
  u_xlat1 = ((x_152 * vec4<f32>(0.00833330024033784866f, 0.00833330024033784866f, 0.00833330024033784866f, 0.00833330024033784866f)) + x_156);
  let x_158 : vec4<f32> = u_xlat2;
  let x_162 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_158 * vec4<f32>(-0.00019840999448206276f, -0.00019840999448206276f, -0.00019840999448206276f, -0.00019840999448206276f)) + x_162);
  ...
  u_xlat12 = dot(x_175, vec4<f32>(0.67419987916946411133f, 0.67419987916946411133f, 0.26967993378639221191f, 0.13483996689319610596f));
  let x_181 : f32 = u_xlat12;
  u_xlat12 = (x_181 * 0.69999998807907104492f);
  let x_184 : vec4<f32> = u_xlat2;
  u_xlat1.x = dot(x_184, vec4<f32>(0.02400000020861625671f, 0.03999999910593032837f, -0.11999999731779098511f, 0.09600000083446502686f));
  let x_191 : vec4<f32> = u_xlat2;
  u_xlat1.z = dot(x_191, vec4<f32>(0.00600000005215406418f, 0.01999999955296516418f, -0.01999999955296516418f, 0.10000000149011611938f));
