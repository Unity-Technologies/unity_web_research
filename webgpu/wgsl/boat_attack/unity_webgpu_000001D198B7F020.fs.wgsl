...
@group(1) @binding(1) var<uniform> x_3666 : AdditionalLights;
...
fn main_1() {
  ...
  u_xlat3.w = 1.0f;
  let x_1952 : vec4<f32> = x_145.unity_SHAr;
  let x_1953 : vec4<f32> = u_xlat3;
  u_xlat6.x = dot(x_1952, x_1953);
  let x_1958 : vec4<f32> = x_145.unity_SHAg;
  let x_1959 : vec4<f32> = u_xlat3;
  u_xlat6.y = dot(x_1958, x_1959);
  let x_1964 : vec4<f32> = x_145.unity_SHAb;
  let x_1965 : vec4<f32> = u_xlat3;
  u_xlat6.z = dot(x_1964, x_1965);
  let x_1968 : vec4<f32> = u_xlat3;
  let x_1970 : vec4<f32> = u_xlat3;
  u_xlat7 = (vec4<f32>(x_1968.y, x_1968.z, x_1968.z, x_1968.x) * vec4<f32>(x_1970.x, x_1970.y, x_1970.z, x_1970.z));
  let x_1975 : vec4<f32> = x_145.unity_SHBr;
  let x_1976 : vec4<f32> = u_xlat7;
  u_xlat8.x = dot(x_1975, x_1976);
  let x_1981 : vec4<f32> = x_145.unity_SHBg;
  let x_1982 : vec4<f32> = u_xlat7;
  u_xlat8.y = dot(x_1981, x_1982);
  let x_1986 : vec4<f32> = x_145.unity_SHBb;
  let x_1987 : vec4<f32> = u_xlat7;
  u_xlat8.z = dot(x_1986, x_1987);
  let x_1991 : f32 = u_xlat3.y;
  let x_1993 : f32 = u_xlat3.y;
  u_xlat44 = (x_1991 * x_1993);
  let x_1996 : f32 = u_xlat3.x;
  let x_1998 : f32 = u_xlat3.x;
  let x_2000 : f32 = u_xlat44;
  u_xlat44 = ((x_1996 * x_1998) + -(x_2000));
  let x_2005 : vec4<f32> = x_145.unity_SHC;
  let x_2007 : f32 = u_xlat44;
  let x_2010 : vec4<f32> = u_xlat8;
  u_xlat26 = ((vec3<f32>(x_2005.x, x_2005.y, x_2005.z) * vec3<f32>(x_2007, x_2007, x_2007)) + vec3<f32>(x_2010.x, x_2010.y, x_2010.z));
  let x_2013 : vec3<f32> = u_xlat26;
  let x_2014 : vec4<f32> = u_xlat6;
  u_xlat26 = (x_2013 + vec3<f32>(x_2014.x, x_2014.y, x_2014.z));
  let x_2017 : vec3<f32> = u_xlat26;
  u_xlat26 = max(x_2017, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2021 : vec4<f32> = x_90.x_ScaledScreenParams;
  let x_2022 : vec2<f32> = vec2<f32>(x_2021.x, x_2021.y);
  let x_2026 : vec2<f32> = (vec2<f32>(1.0f, 1.0f) / vec2<f32>(x_2022.x, x_2022.y));
  let x_2027 : vec4<f32> = u_xlat6;
  u_xlat6 = vec4<f32>(x_2026.x, x_2026.y, x_2027.z, x_2027.w);
  let x_2029 : vec4<f32> = u_xlat6;
  let x_2031 : vec4<f32> = hlslcc_FragCoord;
  let x_2033 : vec2<f32> = (vec2<f32>(x_2029.x, x_2029.y) * vec2<f32>(x_2031.x, x_2031.y));
  let x_2034 : vec4<f32> = u_xlat6;
  u_xlat6 = vec4<f32>(x_2033.x, x_2033.y, x_2034.z, x_2034.w);
  let x_2037 : f32 = u_xlat6.y;
  let x_2040 : f32 = x_90.x_ScaleBiasRt.x;
  let x_2043 : f32 = x_90.x_ScaleBiasRt.y;
  u_xlat44 = ((x_2037 * x_2040) + x_2043);
  let x_2045 : f32 = u_xlat44;
  u_xlat6.z = (-(x_2045) + 1.0f);
  let x_2050 : f32 = u_xlat5.x;
  u_xlat5.x = x_2050;
  let x_2053 : f32 = u_xlat5.x;
  u_xlat5.x = clamp(x_2053, 0.0f, 1.0f);
  let x_2056 : f32 = u_xlat64;
  u_xlat64 = x_2056;
  let x_2057 : f32 = u_xlat64;
  u_xlat64 = clamp(x_2057, 0.0f, 1.0f);
  let x_2059 : vec3<f32> = u_xlat4;
  u_xlat4 = (x_2059 * vec3<f32>(0.959999979f, 0.959999979f, 0.959999979f));
  let x_2064 : f32 = u_xlat5.x;
  u_xlat44 = (-(x_2064) + 1.0f);
  let x_2068 : f32 = u_xlat44;
  let x_2069 : f32 = u_xlat44;
  u_xlat66 = (x_2068 * x_2069);
  let x_2071 : f32 = u_xlat66;
  u_xlat66 = max(x_2071, 0.0078125f);
  let x_2074 : f32 = u_xlat66;
  let x_2075 : f32 = u_xlat66;
  u_xlat67 = (x_2074 * x_2075);
  let x_2078 : f32 = u_xlat5.x;
  u_xlat5.x = (x_2078 + 0.040000021f);
  let x_2083 : f32 = u_xlat5.x;
  u_xlat5.x = min(x_2083, 1.0f);
  let x_2087 : f32 = u_xlat66;
  u_xlat27 = ((x_2087 * 4.0f) + 2.0f);
  let x_2096 : vec4<f32> = u_xlat6;
  let x_2099 : f32 = x_90.x_GlobalMipBias.x;
  let x_2100 : vec4<f32> = textureSampleBias(x_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture, vec2<f32>(x_2096.x, x_2096.z), x_2099);
  u_xlat6.x = x_2100.x;
  let x_2105 : f32 = u_xlat6.x;
  u_xlat48 = (x_2105 + -1.0f);
  let x_2109 : f32 = x_90.x_AmbientOcclusionParam.w;
  let x_2110 : f32 = u_xlat48;
  u_xlat48 = ((x_2109 * x_2110) + 1.0f);
  let x_2114 : f32 = u_xlat6.x;
  let x_2116 : f32 = vs_INTERP4.w;
  u_xlat6.x = min(x_2114, x_2116);
  let x_2119 : bool = u_xlatb63;
  if (x_2119) {
    let x_2123 : f32 = x_256.x_MainLightShadowParams.y;
    u_xlatb63 = (x_2123 == 1.0f);
    let x_2125 : bool = u_xlatb63;
    if (x_2125) {
      let x_2129 : vec4<f32> = vs_INTERP9;
      let x_2132 : vec4<f32> = x_256.x_MainLightShadowOffset0;
      ...
      txVec30 = vec3<f32>(x_2136.x, x_2136.y, x_2138);
      let x_2145 : vec3<f32> = txVec30;
      ...
      txVec31 = vec3<f32>(x_2151.x, x_2151.y, x_2153);
      let x_2160 : vec3<f32> = txVec31;
      ...
      let x_2167 : vec4<f32> = x_256.x_MainLightShadowOffset1;
      u_xlat7 = (vec4<f32>(x_2164.x, x_2164.y, x_2164.x, x_2164.y) + x_2167);
      let x_2170 : vec4<f32> = u_xlat7;
      let x_2171 : vec2<f32> = vec2<f32>(x_2170.x, x_2170.y);
      let x_2173 : f32 = vs_INTERP9.z;
      txVec32 = vec3<f32>(x_2171.x, x_2171.y, x_2173);
      let x_2180 : vec3<f32> = txVec32;
      ...
      let x_2188 : f32 = vs_INTERP9.z;
      txVec33 = vec3<f32>(x_2186.x, x_2186.y, x_2188);
      let x_2195 : vec3<f32> = txVec33;
      ...
      u_xlat63 = dot(x_2199, vec4<f32>(0.25f, 0.25f, 0.25f, 0.25f));
    } else {
      let x_2204 : f32 = x_256.x_MainLightShadowParams.y;
      u_xlatb69 = (x_2204 == 2.0f);
      let x_2206 : bool = u_xlatb69;
      if (x_2206) {
        let x_2209 : vec4<f32> = vs_INTERP9;
        let x_2212 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2215 : vec2<f32> = ((vec2<f32>(x_2209.x, x_2209.y) * vec2<f32>(x_2212.z, x_2212.w)) + vec2<f32>(0.5f, 0.5f));
        let x_2216 : vec4<f32> = u_xlat7;
        u_xlat7 = vec4<f32>(x_2215.x, x_2215.y, x_2216.z, x_2216.w);
        let x_2218 : vec4<f32> = u_xlat7;
        let x_2220 : vec2<f32> = floor(vec2<f32>(x_2218.x, x_2218.y));
        let x_2221 : vec4<f32> = u_xlat7;
        u_xlat7 = vec4<f32>(x_2220.x, x_2220.y, x_2221.z, x_2221.w);
        let x_2223 : vec4<f32> = vs_INTERP9;
        let x_2226 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2229 : vec4<f32> = u_xlat7;
        u_xlat49 = ((vec2<f32>(x_2223.x, x_2223.y) * vec2<f32>(x_2226.z, x_2226.w)) + -(vec2<f32>(x_2229.x, x_2229.y)));
        let x_2233 : vec2<f32> = u_xlat49;
        u_xlat8 = (vec4<f32>(x_2233.x, x_2233.x, x_2233.y, x_2233.y) + vec4<f32>(0.5f, 1.0f, 0.5f, 1.0f));
        let x_2236 : vec4<f32> = u_xlat8;
        let x_2238 : vec4<f32> = u_xlat8;
        u_xlat9 = (vec4<f32>(x_2236.x, x_2236.x, x_2236.z, x_2236.z) * vec4<f32>(x_2238.x, x_2238.x, x_2238.z, x_2238.z));
        let x_2241 : vec4<f32> = u_xlat9;
        let x_2243 : vec2<f32> = (vec2<f32>(x_2241.y, x_2241.w) * vec2<f32>(0.079999998f, 0.079999998f));
        let x_2244 : vec4<f32> = u_xlat8;
        u_xlat8 = vec4<f32>(x_2243.x, x_2244.y, x_2243.y, x_2244.w);
        let x_2246 : vec4<f32> = u_xlat9;
        let x_2249 : vec2<f32> = u_xlat49;
        let x_2251 : vec2<f32> = ((vec2<f32>(x_2246.x, x_2246.z) * vec2<f32>(0.5f, 0.5f)) + -(x_2249));
        let x_2252 : vec4<f32> = u_xlat9;
        u_xlat9 = vec4<f32>(x_2251.x, x_2251.y, x_2252.z, x_2252.w);
        let x_2254 : vec2<f32> = u_xlat49;
        u_xlat51 = (-(x_2254) + vec2<f32>(1.0f, 1.0f));
        let x_2257 : vec2<f32> = u_xlat49;
        let x_2258 : vec2<f32> = min(x_2257, vec2<f32>(0.0f, 0.0f));
        ...
        let x_2268 : vec2<f32> = ((-(vec2<f32>(x_2261.x, x_2261.y)) * vec2<f32>(x_2264.x, x_2264.y)) + x_2267);
        let x_2269 : vec4<f32> = u_xlat10;
        u_xlat10 = vec4<f32>(x_2268.x, x_2268.y, x_2269.z, x_2269.w);
        let x_2271 : vec2<f32> = u_xlat49;
        u_xlat49 = max(x_2271, vec2<f32>(0.0f, 0.0f));
        let x_2273 : vec2<f32> = u_xlat49;
        let x_2275 : vec2<f32> = u_xlat49;
        let x_2277 : vec4<f32> = u_xlat8;
        u_xlat49 = ((-(x_2273) * x_2275) + vec2<f32>(x_2277.y, x_2277.w));
        let x_2280 : vec4<f32> = u_xlat10;
        let x_2282 : vec2<f32> = (vec2<f32>(x_2280.x, x_2280.y) + vec2<f32>(1.0f, 1.0f));
        let x_2283 : vec4<f32> = u_xlat10;
        u_xlat10 = vec4<f32>(x_2282.x, x_2282.y, x_2283.z, x_2283.w);
        let x_2285 : vec2<f32> = u_xlat49;
        u_xlat49 = (x_2285 + vec2<f32>(1.0f, 1.0f));
        ...
        let x_2298 : vec2<f32> = (vec2<f32>(x_2296.x, x_2296.y) * vec2<f32>(0.159999996f, 0.159999996f));
        let x_2299 : vec4<f32> = u_xlat10;
        u_xlat10 = vec4<f32>(x_2298.x, x_2298.y, x_2299.z, x_2299.w);
        let x_2301 : vec2<f32> = u_xlat49;
        let x_2302 : vec2<f32> = (x_2301 * vec2<f32>(0.159999996f, 0.159999996f));
        let x_2303 : vec4<f32> = u_xlat12;
        u_xlat12 = vec4<f32>(x_2302.x, x_2302.y, x_2303.z, x_2303.w);
        let x_2305 : vec4<f32> = u_xlat8;
        u_xlat49 = (vec2<f32>(x_2305.y, x_2305.w) * vec2<f32>(0.159999996f, 0.159999996f));
        let x_2309 : f32 = u_xlat10.x;
        u_xlat11.z = x_2309;
        let x_2312 : f32 = u_xlat49.x;
        u_xlat11.w = x_2312;
        let x_2315 : f32 = u_xlat12.x;
        u_xlat9.z = x_2315;
        let x_2318 : f32 = u_xlat8.x;
        u_xlat9.w = x_2318;
        let x_2320 : vec4<f32> = u_xlat9;
        let x_2322 : vec4<f32> = u_xlat11;
        u_xlat13 = (vec4<f32>(x_2320.z, x_2320.w, x_2320.x, x_2320.z) + vec4<f32>(x_2322.z, x_2322.w, x_2322.x, x_2322.z));
        let x_2326 : f32 = u_xlat11.y;
        u_xlat10.z = x_2326;
        let x_2329 : f32 = u_xlat49.y;
        u_xlat10.w = x_2329;
        ...
        let x_2341 : vec3<f32> = (vec3<f32>(x_2337.z, x_2337.y, x_2337.w) + vec3<f32>(x_2339.z, x_2339.y, x_2339.w));
        ...
        let x_2348 : vec3<f32> = (vec3<f32>(x_2344.x, x_2344.z, x_2344.w) / vec3<f32>(x_2346.z, x_2346.w, x_2346.y));
        let x_2349 : vec4<f32> = u_xlat9;
        u_xlat9 = vec4<f32>(x_2348.x, x_2348.y, x_2348.z, x_2349.w);
        let x_2351 : vec4<f32> = u_xlat9;
        let x_2353 : vec3<f32> = (vec3<f32>(x_2351.x, x_2351.y, x_2351.z) + vec3<f32>(-2.5f, -0.5f, 1.5f));
        ...
        let x_2360 : vec3<f32> = (vec3<f32>(x_2356.z, x_2356.y, x_2356.w) / vec3<f32>(x_2358.x, x_2358.y, x_2358.z));
        ...
        let x_2371 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2373 : vec3<f32> = (vec3<f32>(x_2368.y, x_2368.x, x_2368.z) * vec3<f32>(x_2371.x, x_2371.x, x_2371.x));
        let x_2374 : vec4<f32> = u_xlat9;
        u_xlat9 = vec4<f32>(x_2373.x, x_2373.y, x_2373.z, x_2374.w);
        let x_2376 : vec4<f32> = u_xlat10;
        let x_2379 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2381 : vec3<f32> = (vec3<f32>(x_2376.x, x_2376.y, x_2376.z) * vec3<f32>(x_2379.y, x_2379.y, x_2379.y));
        ...
        let x_2390 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2393 : vec4<f32> = u_xlat9;
        u_xlat11 = ((vec4<f32>(x_2387.x, x_2387.y, x_2387.x, x_2387.y) * vec4<f32>(x_2390.x, x_2390.y, x_2390.x, x_2390.y)) + vec4<f32>(x_2393.y, x_2393.w, x_2393.x, x_2393.w));
        let x_2396 : vec4<f32> = u_xlat7;
        let x_2399 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2402 : vec4<f32> = u_xlat9;
        u_xlat49 = ((vec2<f32>(x_2396.x, x_2396.y) * vec2<f32>(x_2399.x, x_2399.y)) + vec2<f32>(x_2402.z, x_2402.w));
        let x_2406 : f32 = u_xlat9.y;
        u_xlat10.w = x_2406;
        let x_2408 : vec4<f32> = u_xlat10;
        let x_2409 : vec2<f32> = vec2<f32>(x_2408.y, x_2408.z);
        let x_2410 : vec4<f32> = u_xlat9;
        u_xlat9 = vec4<f32>(x_2410.x, x_2409.x, x_2410.z, x_2409.y);
        let x_2412 : vec4<f32> = u_xlat7;
        let x_2415 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2418 : vec4<f32> = u_xlat9;
        u_xlat12 = ((vec4<f32>(x_2412.x, x_2412.y, x_2412.x, x_2412.y) * vec4<f32>(x_2415.x, x_2415.y, x_2415.x, x_2415.y)) + vec4<f32>(x_2418.x, x_2418.y, x_2418.z, x_2418.y));
        let x_2421 : vec4<f32> = u_xlat7;
        let x_2424 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2427 : vec4<f32> = u_xlat10;
        u_xlat10 = ((vec4<f32>(x_2421.x, x_2421.y, x_2421.x, x_2421.y) * vec4<f32>(x_2424.x, x_2424.y, x_2424.x, x_2424.y)) + vec4<f32>(x_2427.w, x_2427.y, x_2427.w, x_2427.z));
        let x_2430 : vec4<f32> = u_xlat7;
        let x_2433 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2436 : vec4<f32> = u_xlat9;
        u_xlat9 = ((vec4<f32>(x_2430.x, x_2430.y, x_2430.x, x_2430.y) * vec4<f32>(x_2433.x, x_2433.y, x_2433.x, x_2433.y)) + vec4<f32>(x_2436.x, x_2436.w, x_2436.z, x_2436.w));
        let x_2439 : vec4<f32> = u_xlat8;
        let x_2441 : vec4<f32> = u_xlat13;
        u_xlat14 = (vec4<f32>(x_2439.x, x_2439.x, x_2439.x, x_2439.y) * vec4<f32>(x_2441.z, x_2441.w, x_2441.y, x_2441.z));
        let x_2444 : vec4<f32> = u_xlat8;
        let x_2446 : vec4<f32> = u_xlat13;
        u_xlat15 = (vec4<f32>(x_2444.y, x_2444.y, x_2444.z, x_2444.z) * x_2446);
        let x_2449 : f32 = u_xlat8.z;
        let x_2451 : f32 = u_xlat13.y;
        u_xlat69 = (x_2449 * x_2451);
        let x_2454 : vec4<f32> = u_xlat11;
        let x_2455 : vec2<f32> = vec2<f32>(x_2454.x, x_2454.y);
        let x_2457 : f32 = vs_INTERP9.z;
        txVec34 = vec3<f32>(x_2455.x, x_2455.y, x_2457);
        let x_2464 : vec3<f32> = txVec34;
        let x_2466 : f32 = textureSampleCompareLevel(x_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture, x_2464.xy, x_2464.z);
        u_xlat7.x = x_2466;
        let x_2469 : vec4<f32> = u_xlat11;
        let x_2470 : vec2<f32> = vec2<f32>(x_2469.z, x_2469.w);
        let x_2472 : f32 = vs_INTERP9.z;
        txVec35 = vec3<f32>(x_2470.x, x_2470.y, x_2472);
        let x_2480 : vec3<f32> = txVec35;
        ...
        let x_2485 : f32 = u_xlat14.y;
        u_xlat28 = (x_2483 * x_2485);
        let x_2488 : f32 = u_xlat14.x;
        let x_2490 : f32 = u_xlat7.x;
        let x_2492 : f32 = u_xlat28;
        u_xlat7.x = ((x_2488 * x_2490) + x_2492);
        let x_2496 : vec2<f32> = u_xlat49;
        let x_2498 : f32 = vs_INTERP9.z;
        txVec36 = vec3<f32>(x_2496.x, x_2496.y, x_2498);
        let x_2505 : vec3<f32> = txVec36;
        ...
        u_xlat28 = x_2507;
        let x_2509 : f32 = u_xlat14.z;
        let x_2510 : f32 = u_xlat28;
        let x_2513 : f32 = u_xlat7.x;
        u_xlat7.x = ((x_2509 * x_2510) + x_2513);
        let x_2517 : vec4<f32> = u_xlat10;
        let x_2518 : vec2<f32> = vec2<f32>(x_2517.x, x_2517.y);
        let x_2520 : f32 = vs_INTERP9.z;
        txVec37 = vec3<f32>(x_2518.x, x_2518.y, x_2520);
        let x_2527 : vec3<f32> = txVec37;
        let x_2529 : f32 = textureSampleCompareLevel(x_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture, x_2527.xy, x_2527.z);
        u_xlat28 = x_2529;
        let x_2531 : f32 = u_xlat14.w;
        let x_2532 : f32 = u_xlat28;
        let x_2535 : f32 = u_xlat7.x;
        u_xlat7.x = ((x_2531 * x_2532) + x_2535);
        let x_2539 : vec4<f32> = u_xlat12;
        let x_2540 : vec2<f32> = vec2<f32>(x_2539.x, x_2539.y);
        let x_2542 : f32 = vs_INTERP9.z;
        txVec38 = vec3<f32>(x_2540.x, x_2540.y, x_2542);
        let x_2549 : vec3<f32> = txVec38;
        ...
        u_xlat7.x = ((x_2553 * x_2554) + x_2557);
        let x_2561 : vec4<f32> = u_xlat12;
        let x_2562 : vec2<f32> = vec2<f32>(x_2561.z, x_2561.w);
        let x_2564 : f32 = vs_INTERP9.z;
        txVec39 = vec3<f32>(x_2562.x, x_2562.y, x_2564);
        let x_2571 : vec3<f32> = txVec39;
        let x_2573 : f32 = textureSampleCompareLevel(x_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture, x_2571.xy, x_2571.z);
        u_xlat28 = x_2573;
        let x_2575 : f32 = u_xlat15.y;
        let x_2576 : f32 = u_xlat28;
        let x_2579 : f32 = u_xlat7.x;
        u_xlat7.x = ((x_2575 * x_2576) + x_2579);
        let x_2583 : vec4<f32> = u_xlat10;
        let x_2584 : vec2<f32> = vec2<f32>(x_2583.z, x_2583.w);
        let x_2586 : f32 = vs_INTERP9.z;
        txVec40 = vec3<f32>(x_2584.x, x_2584.y, x_2586);
        let x_2593 : vec3<f32> = txVec40;
        ...
        u_xlat28 = x_2595;
        let x_2597 : f32 = u_xlat15.z;
        let x_2598 : f32 = u_xlat28;
        let x_2601 : f32 = u_xlat7.x;
        u_xlat7.x = ((x_2597 * x_2598) + x_2601);
        let x_2605 : vec4<f32> = u_xlat9;
        let x_2606 : vec2<f32> = vec2<f32>(x_2605.x, x_2605.y);
        let x_2608 : f32 = vs_INTERP9.z;
        txVec41 = vec3<f32>(x_2606.x, x_2606.y, x_2608);
        let x_2615 : vec3<f32> = txVec41;
        ...
        u_xlat28 = x_2617;
        let x_2619 : f32 = u_xlat15.w;
        let x_2620 : f32 = u_xlat28;
        let x_2623 : f32 = u_xlat7.x;
        u_xlat7.x = ((x_2619 * x_2620) + x_2623);
        let x_2627 : vec4<f32> = u_xlat9;
        let x_2628 : vec2<f32> = vec2<f32>(x_2627.z, x_2627.w);
        let x_2630 : f32 = vs_INTERP9.z;
        txVec42 = vec3<f32>(x_2628.x, x_2628.y, x_2630);
        let x_2637 : vec3<f32> = txVec42;
        let x_2639 : f32 = textureSampleCompareLevel(x_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture, x_2637.xy, x_2637.z);
        u_xlat28 = x_2639;
        let x_2640 : f32 = u_xlat69;
        let x_2641 : f32 = u_xlat28;
        let x_2644 : f32 = u_xlat7.x;
        u_xlat63 = ((x_2640 * x_2641) + x_2644);
      } else {
        let x_2647 : vec4<f32> = vs_INTERP9;
        let x_2650 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2653 : vec2<f32> = ((vec2<f32>(x_2647.x, x_2647.y) * vec2<f32>(x_2650.z, x_2650.w)) + vec2<f32>(0.5f, 0.5f));
        let x_2654 : vec4<f32> = u_xlat7;
        u_xlat7 = vec4<f32>(x_2653.x, x_2653.y, x_2654.z, x_2654.w);
        let x_2656 : vec4<f32> = u_xlat7;
        let x_2658 : vec2<f32> = floor(vec2<f32>(x_2656.x, x_2656.y));
        let x_2659 : vec4<f32> = u_xlat7;
        u_xlat7 = vec4<f32>(x_2658.x, x_2658.y, x_2659.z, x_2659.w);
        let x_2661 : vec4<f32> = vs_INTERP9;
        let x_2664 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2667 : vec4<f32> = u_xlat7;
        u_xlat49 = ((vec2<f32>(x_2661.x, x_2661.y) * vec2<f32>(x_2664.z, x_2664.w)) + -(vec2<f32>(x_2667.x, x_2667.y)));
        let x_2671 : vec2<f32> = u_xlat49;
        u_xlat8 = (vec4<f32>(x_2671.x, x_2671.x, x_2671.y, x_2671.y) + vec4<f32>(0.5f, 1.0f, 0.5f, 1.0f));
        let x_2674 : vec4<f32> = u_xlat8;
        let x_2676 : vec4<f32> = u_xlat8;
        u_xlat9 = (vec4<f32>(x_2674.x, x_2674.x, x_2674.z, x_2674.z) * vec4<f32>(x_2676.x, x_2676.x, x_2676.z, x_2676.z));
        let x_2679 : vec4<f32> = u_xlat9;
        let x_2681 : vec2<f32> = (vec2<f32>(x_2679.y, x_2679.w) * vec2<f32>(0.040816002f, 0.040816002f));
        let x_2682 : vec4<f32> = u_xlat10;
        u_xlat10 = vec4<f32>(x_2682.x, x_2681.x, x_2682.z, x_2681.y);
        let x_2684 : vec4<f32> = u_xlat9;
        let x_2687 : vec2<f32> = u_xlat49;
        let x_2689 : vec2<f32> = ((vec2<f32>(x_2684.x, x_2684.z) * vec2<f32>(0.5f, 0.5f)) + -(x_2687));
        let x_2690 : vec4<f32> = u_xlat8;
        u_xlat8 = vec4<f32>(x_2689.x, x_2690.y, x_2689.y, x_2690.w);
        let x_2692 : vec2<f32> = u_xlat49;
        let x_2694 : vec2<f32> = (-(x_2692) + vec2<f32>(1.0f, 1.0f));
        let x_2695 : vec4<f32> = u_xlat9;
        u_xlat9 = vec4<f32>(x_2694.x, x_2694.y, x_2695.z, x_2695.w);
        let x_2697 : vec2<f32> = u_xlat49;
        u_xlat51 = min(x_2697, vec2<f32>(0.0f, 0.0f));
        let x_2699 : vec2<f32> = u_xlat51;
        let x_2701 : vec2<f32> = u_xlat51;
        let x_2703 : vec4<f32> = u_xlat9;
        let x_2705 : vec2<f32> = ((-(x_2699) * x_2701) + vec2<f32>(x_2703.x, x_2703.y));
        let x_2706 : vec4<f32> = u_xlat9;
        u_xlat9 = vec4<f32>(x_2705.x, x_2705.y, x_2706.z, x_2706.w);
        let x_2708 : vec2<f32> = u_xlat49;
        u_xlat51 = max(x_2708, vec2<f32>(0.0f, 0.0f));
        let x_2710 : vec2<f32> = u_xlat51;
        let x_2712 : vec2<f32> = u_xlat51;
        let x_2714 : vec4<f32> = u_xlat8;
        let x_2716 : vec2<f32> = ((-(x_2710) * x_2712) + vec2<f32>(x_2714.y, x_2714.w));
        let x_2717 : vec3<f32> = u_xlat29;
        u_xlat29 = vec3<f32>(x_2716.x, x_2717.y, x_2716.y);
        let x_2719 : vec4<f32> = u_xlat9;
        let x_2721 : vec2<f32> = (vec2<f32>(x_2719.x, x_2719.y) + vec2<f32>(2.0f, 2.0f));
        let x_2722 : vec4<f32> = u_xlat9;
        u_xlat9 = vec4<f32>(x_2721.x, x_2721.y, x_2722.z, x_2722.w);
        let x_2724 : vec3<f32> = u_xlat29;
        let x_2726 : vec2<f32> = (vec2<f32>(x_2724.x, x_2724.z) + vec2<f32>(2.0f, 2.0f));
        let x_2727 : vec4<f32> = u_xlat8;
        u_xlat8 = vec4<f32>(x_2727.x, x_2726.x, x_2727.z, x_2726.y);
        let x_2730 : f32 = u_xlat8.y;
        u_xlat11.z = (x_2730 * 0.081632003f);
        let x_2733 : vec4<f32> = u_xlat8;
        let x_2735 : vec3<f32> = (vec3<f32>(x_2733.z, x_2733.x, x_2733.w) * vec3<f32>(0.081632003f, 0.081632003f, 0.081632003f));
        let x_2736 : vec4<f32> = u_xlat12;
        u_xlat12 = vec4<f32>(x_2735.x, x_2735.y, x_2735.z, x_2736.w);
        let x_2738 : vec4<f32> = u_xlat9;
        let x_2740 : vec2<f32> = (vec2<f32>(x_2738.x, x_2738.y) * vec2<f32>(0.081632003f, 0.081632003f));
        let x_2741 : vec4<f32> = u_xlat8;
        u_xlat8 = vec4<f32>(x_2740.x, x_2740.y, x_2741.z, x_2741.w);
        let x_2744 : f32 = u_xlat12.y;
        u_xlat11.x = x_2744;
        let x_2746 : vec2<f32> = u_xlat49;
        let x_2749 : vec2<f32> = ((vec2<f32>(x_2746.x, x_2746.x) * vec2<f32>(-0.081632003f, 0.081632003f)) + vec2<f32>(0.163264006f, 0.081632003f));
        let x_2750 : vec4<f32> = u_xlat11;
        u_xlat11 = vec4<f32>(x_2750.x, x_2749.x, x_2750.z, x_2749.y);
        let x_2752 : vec2<f32> = u_xlat49;
        let x_2755 : vec2<f32> = ((vec2<f32>(x_2752.x, x_2752.x) * vec2<f32>(-0.081632003f, 0.081632003f)) + vec2<f32>(0.081632003f, 0.163264006f));
        ...
        u_xlat11 = (x_2764 + x_2765);
        let x_2767 : vec2<f32> = u_xlat49;
        let x_2770 : vec2<f32> = ((vec2<f32>(x_2767.y, x_2767.y) * vec2<f32>(-0.081632003f, 0.081632003f)) + vec2<f32>(0.163264006f, 0.081632003f));
        let x_2771 : vec4<f32> = u_xlat12;
        u_xlat12 = vec4<f32>(x_2771.x, x_2770.x, x_2771.z, x_2770.y);
        let x_2773 : vec2<f32> = u_xlat49;
        let x_2776 : vec2<f32> = ((vec2<f32>(x_2773.y, x_2773.y) * vec2<f32>(-0.081632003f, 0.081632003f)) + vec2<f32>(0.081632003f, 0.163264006f));
        let x_2777 : vec4<f32> = u_xlat10;
        u_xlat10 = vec4<f32>(x_2776.x, x_2777.y, x_2776.y, x_2777.w);
        let x_2780 : f32 = u_xlat8.y;
        u_xlat10.y = x_2780;
        let x_2782 : vec4<f32> = u_xlat10;
        let x_2783 : vec4<f32> = u_xlat12;
        u_xlat8 = (x_2782 + x_2783);
        let x_2785 : vec4<f32> = u_xlat9;
        let x_2786 : vec4<f32> = u_xlat11;
        u_xlat9 = (x_2785 / x_2786);
        let x_2788 : vec4<f32> = u_xlat9;
        u_xlat9 = (x_2788 + vec4<f32>(-3.5f, -1.5f, 0.5f, 2.5f));
        let x_2790 : vec4<f32> = u_xlat10;
        let x_2791 : vec4<f32> = u_xlat8;
        u_xlat10 = (x_2790 / x_2791);
        let x_2793 : vec4<f32> = u_xlat10;
        u_xlat10 = (x_2793 + vec4<f32>(-3.5f, -1.5f, 0.5f, 2.5f));
        let x_2795 : vec4<f32> = u_xlat9;
        let x_2798 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        u_xlat9 = (vec4<f32>(x_2795.w, x_2795.x, x_2795.y, x_2795.z) * vec4<f32>(x_2798.x, x_2798.x, x_2798.x, x_2798.x));
        let x_2801 : vec4<f32> = u_xlat10;
        let x_2804 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        u_xlat10 = (vec4<f32>(x_2801.x, x_2801.w, x_2801.y, x_2801.z) * vec4<f32>(x_2804.y, x_2804.y, x_2804.y, x_2804.y));
        let x_2807 : vec4<f32> = u_xlat9;
        let x_2808 : vec3<f32> = vec3<f32>(x_2807.y, x_2807.z, x_2807.w);
        let x_2809 : vec4<f32> = u_xlat12;
        u_xlat12 = vec4<f32>(x_2808.x, x_2809.y, x_2808.y, x_2808.z);
        ...
        u_xlat49 = ((vec2<f32>(x_2823.x, x_2823.y) * vec2<f32>(x_2826.x, x_2826.y)) + vec2<f32>(x_2829.w, x_2829.y));
        let x_2833 : f32 = u_xlat12.y;
        u_xlat9.y = x_2833;
        let x_2836 : f32 = u_xlat10.z;
        u_xlat12.y = x_2836;
        let x_2838 : vec4<f32> = u_xlat7;
        let x_2841 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2844 : vec4<f32> = u_xlat12;
        u_xlat14 = ((vec4<f32>(x_2838.x, x_2838.y, x_2838.x, x_2838.y) * vec4<f32>(x_2841.x, x_2841.y, x_2841.x, x_2841.y)) + vec4<f32>(x_2844.x, x_2844.y, x_2844.z, x_2844.y));
        let x_2847 : vec4<f32> = u_xlat7;
        let x_2850 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2853 : vec4<f32> = u_xlat12;
        let x_2855 : vec2<f32> = ((vec2<f32>(x_2847.x, x_2847.y) * vec2<f32>(x_2850.x, x_2850.y)) + vec2<f32>(x_2853.w, x_2853.y));
        let x_2856 : vec4<f32> = u_xlat15;
        u_xlat15 = vec4<f32>(x_2855.x, x_2855.y, x_2856.z, x_2856.w);
        let x_2859 : f32 = u_xlat12.y;
        u_xlat9.z = x_2859;
        let x_2861 : vec4<f32> = u_xlat7;
        let x_2864 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2867 : vec4<f32> = u_xlat9;
        u_xlat16 = ((vec4<f32>(x_2861.x, x_2861.y, x_2861.x, x_2861.y) * vec4<f32>(x_2864.x, x_2864.y, x_2864.x, x_2864.y)) + vec4<f32>(x_2867.x, x_2867.y, x_2867.x, x_2867.z));
        let x_2871 : f32 = u_xlat10.w;
        u_xlat12.y = x_2871;
        let x_2873 : vec4<f32> = u_xlat7;
        let x_2876 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2879 : vec4<f32> = u_xlat12;
        u_xlat17 = ((vec4<f32>(x_2873.x, x_2873.y, x_2873.x, x_2873.y) * vec4<f32>(x_2876.x, x_2876.y, x_2876.x, x_2876.y)) + vec4<f32>(x_2879.x, x_2879.y, x_2879.z, x_2879.y));
        let x_2882 : vec4<f32> = u_xlat7;
        let x_2885 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2888 : vec4<f32> = u_xlat12;
        let x_2890 : vec2<f32> = ((vec2<f32>(x_2882.x, x_2882.y) * vec2<f32>(x_2885.x, x_2885.y)) + vec2<f32>(x_2888.w, x_2888.y));
        let x_2891 : vec3<f32> = u_xlat30;
        u_xlat30 = vec3<f32>(x_2890.x, x_2890.y, x_2891.z);
        let x_2894 : f32 = u_xlat12.y;
        u_xlat9.w = x_2894;
        let x_2896 : vec4<f32> = u_xlat7;
        let x_2899 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2902 : vec4<f32> = u_xlat9;
        u_xlat57 = ((vec2<f32>(x_2896.x, x_2896.y) * vec2<f32>(x_2899.x, x_2899.y)) + vec2<f32>(x_2902.x, x_2902.w));
        let x_2905 : vec4<f32> = u_xlat12;
        let x_2906 : vec3<f32> = vec3<f32>(x_2905.x, x_2905.z, x_2905.w);
        let x_2907 : vec4<f32> = u_xlat10;
        u_xlat10 = vec4<f32>(x_2906.x, x_2907.y, x_2906.y, x_2906.z);
        let x_2909 : vec4<f32> = u_xlat7;
        let x_2912 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2915 : vec4<f32> = u_xlat10;
        u_xlat12 = ((vec4<f32>(x_2909.x, x_2909.y, x_2909.x, x_2909.y) * vec4<f32>(x_2912.x, x_2912.y, x_2912.x, x_2912.y)) + vec4<f32>(x_2915.x, x_2915.y, x_2915.z, x_2915.y));
        let x_2918 : vec4<f32> = u_xlat7;
        let x_2921 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        let x_2924 : vec4<f32> = u_xlat10;
        u_xlat52 = ((vec2<f32>(x_2918.x, x_2918.y) * vec2<f32>(x_2921.x, x_2921.y)) + vec2<f32>(x_2924.w, x_2924.y));
        let x_2928 : f32 = u_xlat9.x;
        u_xlat10.x = x_2928;
        let x_2930 : vec4<f32> = u_xlat7;
        let x_2933 : vec4<f32> = x_256.x_MainLightShadowmapSize;
        ...
        u_xlat7 = vec4<f32>(x_2938.x, x_2938.y, x_2939.z, x_2939.w);
        let x_2941 : vec4<f32> = u_xlat8;
        let x_2943 : vec4<f32> = u_xlat11;
        u_xlat18 = (vec4<f32>(x_2941.x, x_2941.x, x_2941.x, x_2941.x) * x_2943);
        let x_2945 : vec4<f32> = u_xlat8;
        let x_2947 : vec4<f32> = u_xlat11;
        u_xlat19 = (vec4<f32>(x_2945.y, x_2945.y, x_2945.y, x_2945.y) * x_2947);
        let x_2949 : vec4<f32> = u_xlat8;
        let x_2951 : vec4<f32> = u_xlat11;
        u_xlat20 = (vec4<f32>(x_2949.z, x_2949.z, x_2949.z, x_2949.z) * x_2951);
        let x_2953 : vec4<f32> = u_xlat8;
        let x_2955 : vec4<f32> = u_xlat11;
        u_xlat8 = (vec4<f32>(x_2953.w, x_2953.w, x_2953.w, x_2953.w) * x_2955);
        let x_2958 : vec4<f32> = u_xlat13;
        let x_2959 : vec2<f32> = vec2<f32>(x_2958.x, x_2958.y);
        let x_2961 : f32 = vs_INTERP9.z;
        txVec43 = vec3<f32>(x_2959.x, x_2959.y, x_2961);
        let x_2968 : vec3<f32> = txVec43;
        ...
        txVec44 = vec3<f32>(x_2973.x, x_2973.y, x_2975);
        let x_2982 : vec3<f32> = txVec44;
        ...
        u_xlat9.x = x_2984;
        let x_2987 : f32 = u_xlat9.x;
        let x_2989 : f32 = u_xlat18.y;
        u_xlat9.x = (x_2987 * x_2989);
        let x_2993 : f32 = u_xlat18.x;
        let x_2994 : f32 = u_xlat69;
        let x_2997 : f32 = u_xlat9.x;
        u_xlat69 = ((x_2993 * x_2994) + x_2997);
        let x_3000 : vec2<f32> = u_xlat49;
        let x_3002 : f32 = vs_INTERP9.z;
        txVec45 = vec3<f32>(x_3000.x, x_3000.y, x_3002);
        let x_3009 : vec3<f32> = txVec45;
        ...
        let x_3016 : f32 = u_xlat49.x;
        let x_3018 : f32 = u_xlat69;
        u_xlat69 = ((x_3014 * x_3016) + x_3018);
        let x_3021 : vec4<f32> = u_xlat16;
        let x_3022 : vec2<f32> = vec2<f32>(x_3021.x, x_3021.y);
        let x_3024 : f32 = vs_INTERP9.z;
        txVec46 = vec3<f32>(x_3022.x, x_3022.y, x_3024);
        let x_3031 : vec3<f32> = txVec46;
        ...
        txVec47 = vec3<f32>(x_3044.x, x_3044.y, x_3046);
        let x_3053 : vec3<f32> = txVec47;
        ...
        txVec48 = vec3<f32>(x_3066.x, x_3066.y, x_3068);
        let x_3075 : vec3<f32> = txVec48;
        ...
        txVec49 = vec3<f32>(x_3088.x, x_3088.y, x_3090);
        let x_3097 : vec3<f32> = txVec49;
        ...
        u_xlat49.x = x_3099;
        let x_3102 : f32 = u_xlat19.z;
        let x_3104 : f32 = u_xlat49.x;
        let x_3106 : f32 = u_xlat69;
        u_xlat69 = ((x_3102 * x_3104) + x_3106);
        let x_3109 : vec4<f32> = u_xlat16;
        let x_3110 : vec2<f32> = vec2<f32>(x_3109.z, x_3109.w);
        let x_3112 : f32 = vs_INTERP9.z;
        txVec50 = vec3<f32>(x_3110.x, x_3110.y, x_3112);
        let x_3119 : vec3<f32> = txVec50;
        ...
        u_xlat49.x = x_3121;
        let x_3124 : f32 = u_xlat19.w;
        let x_3126 : f32 = u_xlat49.x;
        let x_3128 : f32 = u_xlat69;
        u_xlat69 = ((x_3124 * x_3126) + x_3128);
        let x_3131 : vec4<f32> = u_xlat17;
        let x_3132 : vec2<f32> = vec2<f32>(x_3131.x, x_3131.y);
        let x_3134 : f32 = vs_INTERP9.z;
        txVec51 = vec3<f32>(x_3132.x, x_3132.y, x_3134);
        let x_3141 : vec3<f32> = txVec51;
        ...
        u_xlat49.x = x_3143;
        let x_3146 : f32 = u_xlat20.x;
        let x_3148 : f32 = u_xlat49.x;
        let x_3150 : f32 = u_xlat69;
        u_xlat69 = ((x_3146 * x_3148) + x_3150);
        let x_3153 : vec4<f32> = u_xlat17;
        let x_3154 : vec2<f32> = vec2<f32>(x_3153.z, x_3153.w);
        let x_3156 : f32 = vs_INTERP9.z;
        txVec52 = vec3<f32>(x_3154.x, x_3154.y, x_3156);
        let x_3163 : vec3<f32> = txVec52;
        ...
        let x_3170 : f32 = u_xlat49.x;
        let x_3172 : f32 = u_xlat69;
        u_xlat69 = ((x_3168 * x_3170) + x_3172);
        let x_3175 : vec3<f32> = u_xlat30;
        let x_3176 : vec2<f32> = vec2<f32>(x_3175.x, x_3175.y);
        let x_3178 : f32 = vs_INTERP9.z;
        txVec53 = vec3<f32>(x_3176.x, x_3176.y, x_3178);
        let x_3185 : vec3<f32> = txVec53;
        let x_3187 : f32 = textureSampleCompareLevel(x_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture, x_3185.xy, x_3185.z);
        u_xlat49.x = x_3187;
        let x_3190 : f32 = u_xlat20.z;
        let x_3192 : f32 = u_xlat49.x;
        let x_3194 : f32 = u_xlat69;
        u_xlat69 = ((x_3190 * x_3192) + x_3194);
        let x_3197 : vec2<f32> = u_xlat57;
        let x_3199 : f32 = vs_INTERP9.z;
        txVec54 = vec3<f32>(x_3197.x, x_3197.y, x_3199);
        let x_3206 : vec3<f32> = txVec54;
        ...
        let x_3213 : f32 = u_xlat49.x;
        let x_3215 : f32 = u_xlat69;
        u_xlat69 = ((x_3211 * x_3213) + x_3215);
        let x_3218 : vec4<f32> = u_xlat12;
        let x_3219 : vec2<f32> = vec2<f32>(x_3218.x, x_3218.y);
        let x_3221 : f32 = vs_INTERP9.z;
        txVec55 = vec3<f32>(x_3219.x, x_3219.y, x_3221);
        let x_3228 : vec3<f32> = txVec55;
        ...
        u_xlat49.x = x_3252;
        let x_3255 : f32 = u_xlat8.y;
        let x_3257 : f32 = u_xlat49.x;
        let x_3259 : f32 = u_xlat69;
        u_xlat69 = ((x_3255 * x_3257) + x_3259);
        let x_3262 : vec2<f32> = u_xlat52;
        let x_3264 : f32 = vs_INTERP9.z;
        txVec57 = vec3<f32>(x_3262.x, x_3262.y, x_3264);
        let x_3271 : vec3<f32> = txVec57;
        ...
        let x_3278 : f32 = u_xlat49.x;
        let x_3280 : f32 = u_xlat69;
        u_xlat69 = ((x_3276 * x_3278) + x_3280);
        ...
        u_xlat7.x = x_3295;
        let x_3298 : f32 = u_xlat8.w;
        let x_3300 : f32 = u_xlat7.x;
        let x_3302 : f32 = u_xlat69;
        u_xlat63 = ((x_3298 * x_3300) + x_3302);
      }
    }
  } else {
    let x_3306 : vec4<f32> = vs_INTERP9;
    ...
    let x_3318 : f32 = textureSampleCompareLevel(x_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture, x_3316.xy, x_3316.z);
    u_xlat63 = x_3318;
  }
  let x_3319 : f32 = u_xlat63;
  let x_3321 : f32 = x_256.x_MainLightShadowParams.x;
  let x_3323 : f32 = u_xlat65;
  u_xlat63 = ((x_3319 * x_3321) + x_3323);
  let x_3326 : f32 = vs_INTERP9.z;
  u_xlatb65 = (0.0f >= x_3326);
  let x_3329 : f32 = vs_INTERP9.z;
  u_xlatb69 = (x_3329 >= 1.0f);
  let x_3331 : bool = u_xlatb65;
  let x_3332 : bool = u_xlatb69;
  u_xlatb65 = (x_3331 | x_3332);
  let x_3334 : bool = u_xlatb65;
  let x_3335 : f32 = u_xlat63;
  u_xlat63 = select(x_3335, 1.0f, x_3334);
  let x_3337 : vec3<f32> = vs_INTERP0;
  let x_3339 : vec3<f32> = x_90.x_WorldSpaceCameraPos;
  let x_3341 : vec3<f32> = (x_3337 + -(x_3339));
  ...
  u_xlat65 = dot(vec3<f32>(x_3344.x, x_3344.y, x_3344.z), vec3<f32>(x_3346.x, x_3346.y, x_3346.z));
  let x_3349 : f32 = u_xlat65;
  let x_3351 : f32 = x_256.x_MainLightShadowParams.z;
  let x_3354 : f32 = x_256.x_MainLightShadowParams.w;
  u_xlat65 = ((x_3349 * x_3351) + x_3354);
  let x_3356 : f32 = u_xlat65;
  u_xlat65 = clamp(x_3356, 0.0f, 1.0f);
  let x_3358 : f32 = u_xlat63;
  u_xlat69 = (-(x_3358) + 1.0f);
  let x_3361 : f32 = u_xlat65;
  let x_3362 : f32 = u_xlat69;
  let x_3364 : f32 = u_xlat63;
  u_xlat63 = ((x_3361 * x_3362) + x_3364);
  let x_3366 : f32 = u_xlat48;
  let x_3369 : vec4<f32> = x_90.x_MainLightColor;
  let x_3371 : vec3<f32> = (vec3<f32>(x_3366, x_3366, x_3366) * vec3<f32>(x_3369.x, x_3369.y, x_3369.z));
  let x_3372 : vec4<f32> = u_xlat7;
  u_xlat7 = vec4<f32>(x_3371.x, x_3371.y, x_3371.z, x_3372.w);
  let x_3374 : vec3<f32> = u_xlat1;
  let x_3376 : vec4<f32> = u_xlat3;
  u_xlat65 = dot(-(x_3374), vec3<f32>(x_3376.x, x_3376.y, x_3376.z));
  let x_3379 : f32 = u_xlat65;
  let x_3380 : f32 = u_xlat65;
  u_xlat65 = (x_3379 + x_3380);
  let x_3382 : vec4<f32> = u_xlat3;
  let x_3384 : f32 = u_xlat65;
  let x_3388 : vec3<f32> = u_xlat1;
  let x_3390 : vec3<f32> = ((vec3<f32>(x_3382.x, x_3382.y, x_3382.z) * -(vec3<f32>(x_3384, x_3384, x_3384))) + -(x_3388));
  let x_3391 : vec4<f32> = u_xlat8;
  u_xlat8 = vec4<f32>(x_3390.x, x_3390.y, x_3390.z, x_3391.w);
  let x_3393 : vec4<f32> = u_xlat3;
  let x_3395 : vec3<f32> = u_xlat1;
  u_xlat65 = dot(vec3<f32>(x_3393.x, x_3393.y, x_3393.z), x_3395);
  let x_3397 : f32 = u_xlat65;
  u_xlat65 = clamp(x_3397, 0.0f, 1.0f);
  let x_3399 : f32 = u_xlat65;
  u_xlat65 = (-(x_3399) + 1.0f);
  let x_3402 : f32 = u_xlat65;
  let x_3403 : f32 = u_xlat65;
  u_xlat65 = (x_3402 * x_3403);
  let x_3405 : f32 = u_xlat65;
  let x_3406 : f32 = u_xlat65;
  u_xlat65 = (x_3405 * x_3406);
  let x_3408 : f32 = u_xlat44;
  u_xlat69 = ((-(x_3408) * 0.699999988f) + 1.700000048f);
  let x_3414 : f32 = u_xlat44;
  let x_3415 : f32 = u_xlat69;
  u_xlat44 = (x_3414 * x_3415);
  let x_3417 : f32 = u_xlat44;
  u_xlat44 = (x_3417 * 6.0f);
  let x_3428 : vec4<f32> = u_xlat8;
  let x_3430 : f32 = u_xlat44;
  let x_3431 : vec4<f32> = textureSampleLevel(unity_SpecCube0, samplerunity_SpecCube0, vec3<f32>(x_3428.x, x_3428.y, x_3428.z), x_3430);
  u_xlat8 = x_3431;
  let x_3433 : f32 = u_xlat8.w;
  u_xlat44 = (x_3433 + -1.0f);
  let x_3436 : f32 = x_145.unity_SpecCube0_HDR.w;
  let x_3437 : f32 = u_xlat44;
  u_xlat44 = ((x_3436 * x_3437) + 1.0f);
  let x_3440 : f32 = u_xlat44;
  u_xlat44 = max(x_3440, 0.0f);
  let x_3442 : f32 = u_xlat44;
  u_xlat44 = log2(x_3442);
  let x_3444 : f32 = u_xlat44;
  let x_3446 : f32 = x_145.unity_SpecCube0_HDR.y;
  u_xlat44 = (x_3444 * x_3446);
  let x_3448 : f32 = u_xlat44;
  u_xlat44 = exp2(x_3448);
  let x_3450 : f32 = u_xlat44;
  let x_3452 : f32 = x_145.unity_SpecCube0_HDR.x;
  u_xlat44 = (x_3450 * x_3452);
  let x_3454 : vec4<f32> = u_xlat8;
  let x_3456 : f32 = u_xlat44;
  let x_3458 : vec3<f32> = (vec3<f32>(x_3454.x, x_3454.y, x_3454.z) * vec3<f32>(x_3456, x_3456, x_3456));
  let x_3459 : vec4<f32> = u_xlat8;
  u_xlat8 = vec4<f32>(x_3458.x, x_3458.y, x_3458.z, x_3459.w);
  let x_3461 : f32 = u_xlat66;
  let x_3463 : f32 = u_xlat66;
  let x_3467 : vec2<f32> = ((vec2<f32>(x_3461, x_3461) * vec2<f32>(x_3463, x_3463)) + vec2<f32>(-1.0f, 1.0f));
  let x_3468 : vec4<f32> = u_xlat9;
  u_xlat9 = vec4<f32>(x_3467.x, x_3467.y, x_3468.z, x_3468.w);
  let x_3471 : f32 = u_xlat9.y;
  u_xlat44 = (1.0f / x_3471);
  let x_3474 : f32 = u_xlat5.x;
  u_xlat66 = (x_3474 + -0.039999999f);
  let x_3477 : f32 = u_xlat65;
  let x_3478 : f32 = u_xlat66;
  u_xlat65 = ((x_3477 * x_3478) + 0.039999999f);
  let x_3482 : f32 = u_xlat65;
  let x_3483 : f32 = u_xlat44;
  u_xlat44 = (x_3482 * x_3483);
  let x_3485 : f32 = u_xlat44;
  ...
  let x_3498 : vec4<f32> = u_xlat5;
  u_xlat5 = vec4<f32>(x_3497.x, x_3497.y, x_3497.z, x_3498.w);
  let x_3500 : f32 = u_xlat63;
  let x_3502 : f32 = x_145.unity_LightData.z;
  u_xlat63 = (x_3500 * x_3502);
  let x_3504 : vec4<f32> = u_xlat3;
  let x_3507 : vec4<f32> = x_90.x_MainLightPosition;
  u_xlat44 = dot(vec3<f32>(x_3504.x, x_3504.y, x_3504.z), vec3<f32>(x_3507.x, x_3507.y, x_3507.z));
  let x_3510 : f32 = u_xlat44;
  u_xlat44 = clamp(x_3510, 0.0f, 1.0f);
  let x_3512 : f32 = u_xlat63;
  let x_3513 : f32 = u_xlat44;
  u_xlat63 = (x_3512 * x_3513);
  let x_3515 : f32 = u_xlat63;
  let x_3517 : vec4<f32> = u_xlat7;
  let x_3519 : vec3<f32> = (vec3<f32>(x_3515, x_3515, x_3515) * vec3<f32>(x_3517.x, x_3517.y, x_3517.z));
  ...
  u_xlat63 = dot(vec3<f32>(x_3529.x, x_3529.y, x_3529.z), vec3<f32>(x_3531.x, x_3531.y, x_3531.z));
  let x_3534 : f32 = u_xlat63;
  u_xlat63 = max(x_3534, 1.17549435e-37f);
  let x_3537 : f32 = u_xlat63;
  u_xlat63 = inverseSqrt(x_3537);
  let x_3539 : f32 = u_xlat63;
  ...
  let x_3546 : vec4<f32> = u_xlat3;
  let x_3548 : vec4<f32> = u_xlat8;
  u_xlat63 = dot(vec3<f32>(x_3546.x, x_3546.y, x_3546.z), vec3<f32>(x_3548.x, x_3548.y, x_3548.z));
  let x_3551 : f32 = u_xlat63;
  u_xlat63 = clamp(x_3551, 0.0f, 1.0f);
  let x_3554 : vec4<f32> = x_90.x_MainLightPosition;
  let x_3556 : vec4<f32> = u_xlat8;
  u_xlat44 = dot(vec3<f32>(x_3554.x, x_3554.y, x_3554.z), vec3<f32>(x_3556.x, x_3556.y, x_3556.z));
  let x_3559 : f32 = u_xlat44;
  u_xlat44 = clamp(x_3559, 0.0f, 1.0f);
  let x_3561 : f32 = u_xlat63;
  let x_3562 : f32 = u_xlat63;
  u_xlat63 = (x_3561 * x_3562);
  let x_3564 : f32 = u_xlat63;
  let x_3566 : f32 = u_xlat9.x;
  u_xlat63 = ((x_3564 * x_3566) + 1.000010014f);
  let x_3570 : f32 = u_xlat44;
  let x_3571 : f32 = u_xlat44;
  u_xlat44 = (x_3570 * x_3571);
  let x_3573 : f32 = u_xlat63;
  let x_3574 : f32 = u_xlat63;
  u_xlat63 = (x_3573 * x_3574);
  let x_3576 : f32 = u_xlat44;
  u_xlat44 = max(x_3576, 0.100000001f);
  let x_3579 : f32 = u_xlat63;
  let x_3580 : f32 = u_xlat44;
  u_xlat63 = (x_3579 * x_3580);
  let x_3582 : f32 = u_xlat27;
  let x_3583 : f32 = u_xlat63;
  u_xlat63 = (x_3582 * x_3583);
  let x_3585 : f32 = u_xlat67;
  let x_3586 : f32 = u_xlat63;
  u_xlat63 = (x_3585 / x_3586);
  let x_3588 : f32 = u_xlat63;
  let x_3592 : vec3<f32> = u_xlat4;
  let x_3593 : vec3<f32> = ((vec3<f32>(x_3588, x_3588, x_3588) * vec3<f32>(0.039999999f, 0.039999999f, 0.039999999f)) + x_3592);
  ...
  let x_3600 : vec3<f32> = (vec3<f32>(x_3596.x, x_3596.y, x_3596.z) * vec3<f32>(x_3598.x, x_3598.y, x_3598.z));
  let x_3601 : vec4<f32> = u_xlat7;
  u_xlat7 = vec4<f32>(x_3600.x, x_3600.y, x_3600.z, x_3601.w);
  let x_3604 : f32 = x_90.x_AdditionalLightsCount.x;
  let x_3606 : f32 = x_145.unity_LightData.y;
  u_xlat63 = min(x_3604, x_3606);
  let x_3609 : f32 = u_xlat63;
  u_xlatu63 = bitcast<u32>(i32(x_3609));
  u_xlat8.x = 0.0f;
  u_xlat8.y = 0.0f;
  u_xlat8.z = 0.0f;
  u_xlatu_loop_1 = 0u;
  loop {
    ...
    u_xlati66 = bitcast<i32>((x_3628 & 3u));
    let x_3631 : u32 = u_xlatu65;
    let x_3634 : vec4<f32> = x_145.unity_LightIndices[bitcast<i32>(x_3631)];
    let x_3644 : i32 = u_xlati66;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_3649 : vec4<u32> = indexable[x_3644];
    u_xlat65 = dot(x_3634, bitcast<vec4<f32>>(x_3649));
    let x_3653 : f32 = u_xlat65;
    u_xlati65 = i32(x_3653);
    let x_3655 : vec3<f32> = vs_INTERP0;
    let x_3667 : i32 = u_xlati65;
    let x_3669 : vec4<f32> = x_3666.x_AdditionalLightsPosition[x_3667];
    let x_3672 : i32 = u_xlati65;
    let x_3674 : vec4<f32> = x_3666.x_AdditionalLightsPosition[x_3672];
    u_xlat30 = ((-(x_3655) * vec3<f32>(x_3669.w, x_3669.w, x_3669.w)) + vec3<f32>(x_3674.x, x_3674.y, x_3674.z));
    let x_3677 : vec3<f32> = u_xlat30;
    let x_3678 : vec3<f32> = u_xlat30;
    u_xlat66 = dot(x_3677, x_3678);
    let x_3680 : f32 = u_xlat66;
    u_xlat66 = max(x_3680, 6.10351562e-05f);
    let x_3684 : f32 = u_xlat66;
    u_xlat68 = inverseSqrt(x_3684);
    let x_3686 : f32 = u_xlat68;
    let x_3688 : vec3<f32> = u_xlat30;
    let x_3689 : vec3<f32> = (vec3<f32>(x_3686, x_3686, x_3686) * x_3688);
    let x_3690 : vec4<f32> = u_xlat10;
    u_xlat10 = vec4<f32>(x_3689.x, x_3689.y, x_3689.z, x_3690.w);
    let x_3692 : f32 = u_xlat66;
    u_xlat69 = (1.0f / x_3692);
    let x_3694 : f32 = u_xlat66;
    let x_3695 : i32 = u_xlati65;
    let x_3697 : f32 = x_3666.x_AdditionalLightsAttenuation[x_3695].x;
    u_xlat66 = (x_3694 * x_3697);
    let x_3699 : f32 = u_xlat66;
    let x_3701 : f32 = u_xlat66;
    u_xlat66 = ((-(x_3699) * x_3701) + 1.0f);
    let x_3704 : f32 = u_xlat66;
    u_xlat66 = max(x_3704, 0.0f);
    let x_3706 : f32 = u_xlat66;
    let x_3707 : f32 = u_xlat66;
    u_xlat66 = (x_3706 * x_3707);
    let x_3709 : f32 = u_xlat66;
    let x_3710 : f32 = u_xlat69;
    u_xlat66 = (x_3709 * x_3710);
    let x_3712 : i32 = u_xlati65;
    let x_3714 : vec4<f32> = x_3666.x_AdditionalLightsSpotDir[x_3712];
    let x_3716 : vec4<f32> = u_xlat10;
    u_xlat69 = dot(vec3<f32>(x_3714.x, x_3714.y, x_3714.z), vec3<f32>(x_3716.x, x_3716.y, x_3716.z));
    let x_3719 : f32 = u_xlat69;
    let x_3720 : i32 = u_xlati65;
    let x_3722 : f32 = x_3666.x_AdditionalLightsAttenuation[x_3720].z;
    let x_3724 : i32 = u_xlati65;
    let x_3726 : f32 = x_3666.x_AdditionalLightsAttenuation[x_3724].w;
    u_xlat69 = ((x_3719 * x_3722) + x_3726);
    let x_3728 : f32 = u_xlat69;
    u_xlat69 = clamp(x_3728, 0.0f, 1.0f);
    let x_3730 : f32 = u_xlat69;
    let x_3731 : f32 = u_xlat69;
    u_xlat69 = (x_3730 * x_3731);
    let x_3733 : f32 = u_xlat66;
    let x_3734 : f32 = u_xlat69;
    u_xlat66 = (x_3733 * x_3734);
    let x_3736 : f32 = u_xlat48;
    let x_3738 : i32 = u_xlati65;
    let x_3740 : vec4<f32> = x_3666.x_AdditionalLightsColor[x_3738];
    let x_3742 : vec3<f32> = (vec3<f32>(x_3736, x_3736, x_3736) * vec3<f32>(x_3740.x, x_3740.y, x_3740.z));
    let x_3743 : vec4<f32> = u_xlat11;
    u_xlat11 = vec4<f32>(x_3742.x, x_3742.y, x_3742.z, x_3743.w);
    let x_3745 : vec4<f32> = u_xlat3;
    let x_3747 : vec4<f32> = u_xlat10;
    u_xlat65 = dot(vec3<f32>(x_3745.x, x_3745.y, x_3745.z), vec3<f32>(x_3747.x, x_3747.y, x_3747.z));
    let x_3750 : f32 = u_xlat65;
    u_xlat65 = clamp(x_3750, 0.0f, 1.0f);
    let x_3752 : f32 = u_xlat65;
    let x_3753 : f32 = u_xlat66;
    u_xlat65 = (x_3752 * x_3753);
    ...
    u_xlat11 = vec4<f32>(x_3759.x, x_3759.y, x_3759.z, x_3760.w);
    let x_3762 : vec3<f32> = u_xlat30;
    let x_3763 : f32 = u_xlat68;
    let x_3766 : vec3<f32> = u_xlat1;
    u_xlat30 = ((x_3762 * vec3<f32>(x_3763, x_3763, x_3763)) + x_3766);
    let x_3768 : vec3<f32> = u_xlat30;
    let x_3769 : vec3<f32> = u_xlat30;
    u_xlat65 = dot(x_3768, x_3769);
    let x_3771 : f32 = u_xlat65;
    u_xlat65 = max(x_3771, 1.17549435e-37f);
    let x_3773 : f32 = u_xlat65;
    u_xlat65 = inverseSqrt(x_3773);
    let x_3775 : f32 = u_xlat65;
    let x_3777 : vec3<f32> = u_xlat30;
    u_xlat30 = (vec3<f32>(x_3775, x_3775, x_3775) * x_3777);
    let x_3779 : vec4<f32> = u_xlat3;
    let x_3781 : vec3<f32> = u_xlat30;
    u_xlat65 = dot(vec3<f32>(x_3779.x, x_3779.y, x_3779.z), x_3781);
    let x_3783 : f32 = u_xlat65;
    u_xlat65 = clamp(x_3783, 0.0f, 1.0f);
    let x_3785 : vec4<f32> = u_xlat10;
    let x_3787 : vec3<f32> = u_xlat30;
    u_xlat66 = dot(vec3<f32>(x_3785.x, x_3785.y, x_3785.z), x_3787);
    let x_3789 : f32 = u_xlat66;
    u_xlat66 = clamp(x_3789, 0.0f, 1.0f);
    let x_3791 : f32 = u_xlat65;
    let x_3792 : f32 = u_xlat65;
    u_xlat65 = (x_3791 * x_3792);
    let x_3794 : f32 = u_xlat65;
    let x_3796 : f32 = u_xlat9.x;
    u_xlat65 = ((x_3794 * x_3796) + 1.000010014f);
    let x_3799 : f32 = u_xlat66;
    let x_3800 : f32 = u_xlat66;
    u_xlat66 = (x_3799 * x_3800);
    let x_3802 : f32 = u_xlat65;
    let x_3803 : f32 = u_xlat65;
    u_xlat65 = (x_3802 * x_3803);
    let x_3805 : f32 = u_xlat66;
    u_xlat66 = max(x_3805, 0.100000001f);
    let x_3807 : f32 = u_xlat65;
    let x_3808 : f32 = u_xlat66;
    u_xlat65 = (x_3807 * x_3808);
    let x_3810 : f32 = u_xlat27;
    let x_3811 : f32 = u_xlat65;
    u_xlat65 = (x_3810 * x_3811);
    let x_3813 : f32 = u_xlat67;
    let x_3814 : f32 = u_xlat65;
    u_xlat65 = (x_3813 / x_3814);
    let x_3816 : f32 = u_xlat65;
    let x_3819 : vec3<f32> = u_xlat4;
    u_xlat30 = ((vec3<f32>(x_3816, x_3816, x_3816) * vec3<f32>(0.039999999f, 0.039999999f, 0.039999999f)) + x_3819);
    let x_3821 : vec3<f32> = u_xlat30;
    let x_3822 : vec4<f32> = u_xlat11;
    let x_3825 : vec4<f32> = u_xlat8;
    let x_3827 : vec3<f32> = ((x_3821 * vec3<f32>(x_3822.x, x_3822.y, x_3822.z)) + vec3<f32>(x_3825.x, x_3825.y, x_3825.z));
    let x_3828 : vec4<f32> = u_xlat8;
    u_xlat8 = vec4<f32>(x_3827.x, x_3827.y, x_3827.z, x_3828.w);

    continuing {
      let x_3830 : u32 = u_xlatu_loop_1;
      u_xlatu_loop_1 = (x_3830 + bitcast<u32>(1i));
    }
  }
  let x_3832 : vec4<f32> = u_xlat5;
  let x_3834 : vec4<f32> = u_xlat6;
  let x_3837 : vec4<f32> = u_xlat7;
  u_xlat1 = ((vec3<f32>(x_3832.x, x_3832.y, x_3832.z) * vec3<f32>(x_3834.x, x_3834.x, x_3834.x)) + vec3<f32>(x_3837.x, x_3837.y, x_3837.z));
  let x_3840 : vec4<f32> = u_xlat8;
  let x_3842 : vec3<f32> = u_xlat1;
  u_xlat1 = (vec3<f32>(x_3840.x, x_3840.y, x_3840.z) + x_3842);
  let x_3844 : vec4<f32> = vs_INTERP4;
  let x_3846 : vec3<f32> = u_xlat0;
  let x_3848 : vec3<f32> = u_xlat1;
  u_xlat0 = ((vec3<f32>(x_3844.w, x_3844.w, x_3844.w) * x_3846) + x_3848);
  let x_3851 : f32 = u_xlat23.x;
  let x_3853 : f32 = u_xlat23.x;
  u_xlat63 = (x_3851 * -(x_3853));
  let x_3856 : f32 = u_xlat63;
  u_xlat63 = exp2(x_3856);
  let x_3858 : vec3<f32> = u_xlat0;
  let x_3861 : vec4<f32> = x_90.unity_FogColor;
  u_xlat0 = (x_3858 + -(vec3<f32>(x_3861.x, x_3861.y, x_3861.z)));
  let x_3867 : f32 = u_xlat63;
  let x_3869 : vec3<f32> = u_xlat0;
  let x_3872 : vec4<f32> = x_90.unity_FogColor;
  let x_3874 : vec3<f32> = ((vec3<f32>(x_3867, x_3867, x_3867) * x_3869) + vec3<f32>(x_3872.x, x_3872.y, x_3872.z));
  let x_3875 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_3874.x, x_3874.y, x_3874.z, x_3875.w);
  let x_3877 : bool = u_xlatb2;
  let x_3878 : f32 = u_xlat64;
  SV_Target0.w = select(1.0f, x_3878, x_3877);
  let x_3885 : u32 = x_90.x_RenderingLayerMaxInt;
  let x_3887 : f32 = x_145.unity_RenderingLayer.x;
  u_xlatu0 = (x_3885 & bitcast<u32>(x_3887));
  let x_3890 : u32 = u_xlatu0;
  u_xlat0.x = f32(x_3890);
  let x_3895 : f32 = u_xlat0.x;
  let x_3897 : f32 = x_90.x_RenderingLayerRcpMaxInt;
  SV_Target1.x = (x_3895 * x_3897);
  let x_3901 : f32 = SV_Target1.x;
  SV_Target1.x = clamp(x_3901, 0.0f, 1.0f);
  let x_3904 : vec4<f32> = SV_Target1;
  SV_Target1 = vec4<f32>(x_3904.x, vec3<f32>(0.0f, 0.0f, 0.0f).x, vec3<f32>(0.0f, 0.0f, 0.0f).y, vec3<f32>(0.0f, 0.0f, 0.0f).z);
  return;
}
