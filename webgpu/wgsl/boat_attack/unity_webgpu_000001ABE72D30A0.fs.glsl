...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat64 = u_xlat1.y * _Smoothness + (-u_xlat43.x);
    ...
    if(u_xlatb68){
        ...
        if(u_xlatb68){
            ...
            u_xlatb27.x = _MainLightShadowParams.y==2.0;
            if(u_xlatb27.x){
                ...
                u_xlat48 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec4, 0.0);
                ...
                u_xlat68 = u_xlat27.x * u_xlat69 + u_xlat48;
            } else {
                u_xlat27.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat27.xy = floor(u_xlat27.xy);
                u_xlat7.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat27.xy);
                ...
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec15, 0.0);
                u_xlat69 = u_xlat18.z * u_xlat8.x + u_xlat69;
                vec3 txVec16 = vec3(u_xlat15.xy,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec16, 0.0);
                u_xlat69 = u_xlat18.w * u_xlat8.x + u_xlat69;
                vec3 txVec17 = vec3(u_xlat14.xy,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec17, 0.0);
                u_xlat69 = u_xlat19.x * u_xlat8.x + u_xlat69;
                vec3 txVec18 = vec3(u_xlat14.zw,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec18, 0.0);
                u_xlat69 = u_xlat19.y * u_xlat8.x + u_xlat69;
                vec3 txVec19 = vec3(u_xlat55.xy,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec19, 0.0);
                u_xlat69 = u_xlat19.z * u_xlat8.x + u_xlat69;
                vec3 txVec20 = vec3(u_xlat15.zw,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec20, 0.0);
                u_xlat69 = u_xlat19.w * u_xlat8.x + u_xlat69;
                vec3 txVec21 = vec3(u_xlat16.xy,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec21, 0.0);
                u_xlat69 = u_xlat20.x * u_xlat8.x + u_xlat69;
                vec3 txVec22 = vec3(u_xlat16.zw,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec22, 0.0);
                u_xlat69 = u_xlat20.y * u_xlat8.x + u_xlat69;
                vec3 txVec23 = vec3(u_xlat29.xy,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat69 = u_xlat20.z * u_xlat8.x + u_xlat69;
                vec3 txVec24 = vec3(u_xlat17.xy,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec24, 0.0);
                u_xlat69 = u_xlat20.w * u_xlat8.x + u_xlat69;
                vec3 txVec25 = vec3(u_xlat11.xy,vs_TEXCOORD6.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec25, 0.0);
                u_xlat69 = u_xlat7.x * u_xlat8.x + u_xlat69;
                vec3 txVec26 = vec3(u_xlat11.zw,vs_TEXCOORD6.z);
                u_xlat7.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec26, 0.0);
                u_xlat69 = u_xlat7.y * u_xlat7.x + u_xlat69;
                vec3 txVec27 = vec3(u_xlat52.xy,vs_TEXCOORD6.z);
                u_xlat7.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
                u_xlat69 = u_xlat7.z * u_xlat7.x + u_xlat69;
                vec3 txVec28 = vec3(u_xlat27.xy,vs_TEXCOORD6.z);
                u_xlat27.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec28, 0.0);
                u_xlat68 = u_xlat7.w * u_xlat27.x + u_xlat69;
            }
        }
    } else {
    ...
    u_xlat68 = u_xlat68 * _MainLightShadowParams.x + u_xlat27.x;
    u_xlatb27.x = 0.0>=vs_TEXCOORD6.z;
    u_xlatb48 = vs_TEXCOORD6.z>=1.0;
    u_xlatb27.x = u_xlatb48 || u_xlatb27.x;
    u_xlat68 = (u_xlatb27.x) ? 1.0 : u_xlat68;
    ...
    u_xlat48 = (-u_xlat68) + 1.0;
    u_xlat68 = u_xlat27.x * u_xlat48 + u_xlat68;
    ...
    if(u_xlatb27.x){
        ...
        u_xlat27.xyz = (u_xlatb27.x) ? u_xlat7.xyz : vec3(u_xlat48);
    } else {
    ...
    u_xlat1.xy = u_xlat22.xx * u_xlat22.xx + vec2(-1.0, 1.0);
    ...
    u_xlat5.xyz = u_xlat5.xyz * u_xlat23.xyz + u_xlat7.xyz;
    u_xlat22.x = u_xlat68 * unity_LightData.z;
    u_xlat64 = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
    u_xlat22.x = u_xlat64 * u_xlat22.x;
    u_xlat27.xyz = u_xlat22.xxx * u_xlat27.xyz;
    ...
    u_xlat22.z = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat22.z = clamp(u_xlat22.z, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu22 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat68 = u_xlat43.x / u_xlat68;
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat68) + u_xlat23.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * u_xlat3.xxx + u_xlat27.xyz;
