...
fn main_1() {
  ...
  u_xlat1 = ((vec4<f32>(x_44.z, x_44.w, x_44.z, x_44.w) * vec4<f32>(0.89999997615814208984f, -0.40000000596046447754f, -0.89999997615814208984f, 0.40000000596046447754f)) + vec4<f32>(x_52.x, x_52.y, x_52.x, x_52.y));
  ...
  u_xlat2 = ((vec4<f32>(x_85.z, x_85.w, x_85.z, x_85.w) * vec4<f32>(0.40000000596046447754f, 0.89999997615814208984f, -0.40000000596046447754f, -0.89999997615814208984f)) + vec4<f32>(x_89.x, x_89.y, x_89.x, x_89.y));
  ...
  SV_Target0 = (x_120 * 0.20000000298023223877f);
  ...
  let x_211 : vec3<f32> = (x_209 * vec3<f32>(0.20000000298023223877f, 0.20000000298023223877f, 0.20000000298023223877f));
  let x_212 : vec4<f32> = SV_Target1;
  SV_Target1 = vec4<f32>(x_211.x, x_211.y, x_211.z, x_212.w);
  SV_Target1.w = 0.0f;
  return;
}
