...
void main()
{
    ...
    u_xlat38 = u_xlat18.x * _MainLightShadowParams.x + u_xlat38;
    u_xlatb18 = 0.0>=vs_INTERP3.z;
    u_xlatb30 = vs_INTERP3.z>=1.0;
    u_xlatb18 = u_xlatb30 || u_xlatb18;
    u_xlat38 = (u_xlatb18) ? 1.0 : u_xlat38;
    ...
    u_xlat7.xyz = u_xlat1.xzw * (-vec3(u_xlat30)) + (-u_xlat15.xyz);
    ...
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat5.x);
    ...
    u_xlat5.xy = vec2(u_xlat17) * vec2(u_xlat17) + vec2(-1.0, 1.0);
    u_xlat17 = float(1.0) / u_xlat5.y;
    ...
    u_xlat16.xyz = u_xlat16.xyz * u_xlat2.xyz + u_xlat7.xyz;
    ...
    u_xlat38 = u_xlat38 * u_xlat5.x + 1.00001001;
    u_xlat3.x = u_xlat3.x * u_xlat3.x;
    u_xlat38 = u_xlat38 * u_xlat38;
    u_xlat3.x = max(u_xlat3.x, 0.100000001);
    u_xlat38 = u_xlat38 * u_xlat3.x;
    u_xlat38 = u_xlat41 * u_xlat38;
    u_xlat38 = u_xlat29 / u_xlat38;
    ...
    u_xlat3.x = u_xlat18.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu38 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat10.x = u_xlat3.x * u_xlat22 + u_xlat10.x;
        u_xlat44 = u_xlat44 * u_xlat10.x;
        u_xlat10.x = dot(u_xlat1.xzw, u_xlat21.xyz);
        u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
        u_xlat44 = u_xlat44 * u_xlat10.x;
        u_xlat10.xyz = vec3(u_xlat44) * _AdditionalLightsColor[u_xlati43].xyz;
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat9) + u_xlat15.xyz;
        u_xlat43 = dot(u_xlat8.xyz, u_xlat8.xyz);
        u_xlat43 = max(u_xlat43, 1.17549435e-38);
        u_xlat43 = inversesqrt(u_xlat43);
        u_xlat8.xyz = vec3(u_xlat43) * u_xlat8.xyz;
        u_xlat43 = dot(u_xlat1.xzw, u_xlat8.xyz);
        ...
        u_xlat8.xyz = vec3(u_xlat43) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat18.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat18.xyz;
    }
    u_xlat1.xzw = u_xlat16.xyz * vec3(u_xlat6) + u_xlat7.xyz;
    u_xlat1.xzw = u_xlat18.xyz + u_xlat1.xzw;
