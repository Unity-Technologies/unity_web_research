...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat2.x = (u_xlatb26) ? abs(u_xlat2.x) : -abs(u_xlat2.x);
    ...
    u_xlat24.x = inversesqrt(u_xlat24.x);
    u_xlat72 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat72 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat72;
    u_xlat72 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat72;
    u_xlat72 = u_xlat72 + unity_MatrixV[3].z;
    ...
    if(u_xlatb1){
        ...
        if(u_xlatb1){
            ...
            if(u_xlatb74){
                ...
                u_xlat74 = u_xlat6.z * u_xlat11.y;
                vec3 txVec4 = vec3(u_xlat9.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec4, 0.0);
                vec3 txVec5 = vec3(u_xlat9.zw,vs_TEXCOORD6.z);
                u_xlat76 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec5, 0.0);
                u_xlat76 = u_xlat76 * u_xlat12.y;
                u_xlat75 = u_xlat12.x * u_xlat75 + u_xlat76;
                vec3 txVec6 = vec3(u_xlat53.xy,vs_TEXCOORD6.z);
                u_xlat76 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat75 = u_xlat12.z * u_xlat76 + u_xlat75;
                vec3 txVec7 = vec3(u_xlat8.xy,vs_TEXCOORD6.z);
                u_xlat76 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat75 = u_xlat12.w * u_xlat76 + u_xlat75;
                vec3 txVec8 = vec3(u_xlat10.xy,vs_TEXCOORD6.z);
                u_xlat76 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat75 = u_xlat13.x * u_xlat76 + u_xlat75;
                vec3 txVec9 = vec3(u_xlat10.zw,vs_TEXCOORD6.z);
                u_xlat76 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat75 = u_xlat13.y * u_xlat76 + u_xlat75;
                vec3 txVec10 = vec3(u_xlat8.zw,vs_TEXCOORD6.z);
                u_xlat76 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat75 = u_xlat13.z * u_xlat76 + u_xlat75;
                vec3 txVec11 = vec3(u_xlat7.xy,vs_TEXCOORD6.z);
                u_xlat76 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat75 = u_xlat13.w * u_xlat76 + u_xlat75;
                vec3 txVec12 = vec3(u_xlat7.zw,vs_TEXCOORD6.z);
                u_xlat76 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                u_xlat1.x = u_xlat74 * u_xlat76 + u_xlat75;
            } else {
                u_xlat5.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat53.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat74 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec13, 0.0);
                ...
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec15, 0.0);
                u_xlat74 = u_xlat16.z * u_xlat75 + u_xlat74;
                vec3 txVec16 = vec3(u_xlat14.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec16, 0.0);
                u_xlat74 = u_xlat16.w * u_xlat75 + u_xlat74;
                vec3 txVec17 = vec3(u_xlat12.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec17, 0.0);
                u_xlat74 = u_xlat17.x * u_xlat75 + u_xlat74;
                vec3 txVec18 = vec3(u_xlat12.zw,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec18, 0.0);
                u_xlat74 = u_xlat17.y * u_xlat75 + u_xlat74;
                vec3 txVec19 = vec3(u_xlat13.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec19, 0.0);
                u_xlat74 = u_xlat17.z * u_xlat75 + u_xlat74;
                vec3 txVec20 = vec3(u_xlat14.zw,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec20, 0.0);
                u_xlat74 = u_xlat17.w * u_xlat75 + u_xlat74;
                vec3 txVec21 = vec3(u_xlat15.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec21, 0.0);
                u_xlat74 = u_xlat18.x * u_xlat75 + u_xlat74;
                vec3 txVec22 = vec3(u_xlat15.zw,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec22, 0.0);
                u_xlat74 = u_xlat18.y * u_xlat75 + u_xlat74;
                vec3 txVec23 = vec3(u_xlat31.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec23, 0.0);
                u_xlat74 = u_xlat18.z * u_xlat75 + u_xlat74;
                vec3 txVec24 = vec3(u_xlat61.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat74 = u_xlat18.w * u_xlat75 + u_xlat74;
                vec3 txVec25 = vec3(u_xlat10.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec25, 0.0);
                u_xlat74 = u_xlat6.x * u_xlat75 + u_xlat74;
                vec3 txVec26 = vec3(u_xlat10.zw,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec26, 0.0);
                u_xlat74 = u_xlat6.y * u_xlat75 + u_xlat74;
                vec3 txVec27 = vec3(u_xlat56.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
                u_xlat74 = u_xlat6.z * u_xlat75 + u_xlat74;
                vec3 txVec28 = vec3(u_xlat5.xy,vs_TEXCOORD6.z);
                u_xlat75 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec28, 0.0);
                u_xlat1.x = u_xlat6.w * u_xlat75 + u_xlat74;
            }
        }
    } else {
    ...
    u_xlat74 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat1.x = u_xlat1.x * _MainLightShadowParams.x + u_xlat74;
    u_xlatb74 = 0.0>=vs_TEXCOORD6.z;
    u_xlatb75 = vs_TEXCOORD6.z>=1.0;
    u_xlatb74 = u_xlatb74 || u_xlatb75;
    u_xlat1.x = (u_xlatb74) ? 1.0 : u_xlat1.x;
    u_xlat5.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat74 = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat75 = u_xlat74 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat75 = clamp(u_xlat75, 0.0, 1.0);
    u_xlat76 = (-u_xlat1.x) + 1.0;
    u_xlat1.x = u_xlat75 * u_xlat76 + u_xlat1.x;
    ...
    if(u_xlatb75){
        ...
        u_xlat75 = (u_xlatb6.y) ? u_xlat5.w : u_xlat5.x;
        u_xlat5.xyz = (u_xlatb6.x) ? u_xlat5.xyz : vec3(u_xlat75);
    } else {
        u_xlat5.x = float(1.0);
        u_xlat5.y = float(1.0);
        u_xlat5.z = float(1.0);
    ...
    u_xlat74 = u_xlat74 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    ...
    {
        u_xlatu77 = u_xlatu_loop_1 >> (2u & uint(0x1F));
        u_xlati54 = int(u_xlatu_loop_1 & 3u);
        u_xlat77 = dot(unity_LightIndices[int(u_xlatu77)], uintBitsToFloat(ImmCB_0[u_xlati54]));
        u_xlati77 = int(u_xlat77);
        u_xlat8.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati77].www + _AdditionalLightsPosition[u_xlati77].xyz;
        u_xlat54 = dot(u_xlat8.xyz, u_xlat8.xyz);
        u_xlat54 = max(u_xlat54, 6.10351562e-05);
        u_xlat78 = inversesqrt(u_xlat54);
        u_xlat8.xyz = vec3(u_xlat78) * u_xlat8.xyz;
        u_xlat78 = float(1.0) / float(u_xlat54);
        u_xlat54 = u_xlat54 * _AdditionalLightsAttenuation[u_xlati77].x;
        u_xlat54 = (-u_xlat54) * u_xlat54 + 1.0;
        u_xlat54 = max(u_xlat54, 0.0);
        u_xlat54 = u_xlat54 * u_xlat54;
        u_xlat54 = u_xlat54 * u_xlat78;
        u_xlat78 = dot(_AdditionalLightsSpotDir[u_xlati77].xyz, u_xlat8.xyz);
        u_xlat78 = u_xlat78 * _AdditionalLightsAttenuation[u_xlati77].z + _AdditionalLightsAttenuation[u_xlati77].w;
        u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
        u_xlat78 = u_xlat78 * u_xlat78;
        u_xlat54 = u_xlat78 * u_xlat54;
        u_xlati78 = int(_AdditionalShadowParams[u_xlati77].w);
        u_xlatb79 = u_xlati78>=0;
        if(u_xlatb79){
            u_xlatb79 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati77].z);
            if(u_xlatb79){
                u_xlatb9.xyz = greaterThanEqual(abs(u_xlat8.zzyz), abs(u_xlat8.xyxx)).xyz;
                u_xlatb79 = u_xlatb9.y && u_xlatb9.x;
                ...
                u_xlat80 = u_xlatb9.w ? 1.0 : float(0.0);
                u_xlat80 = (u_xlatb9.z) ? u_xlat9.y : u_xlat80;
                u_xlat79 = (u_xlatb79) ? u_xlat9.x : u_xlat80;
                u_xlat80 = trunc(_AdditionalShadowParams[u_xlati77].w);
                u_xlat79 = u_xlat79 + u_xlat80;
                u_xlati78 = int(u_xlat79);
            }
            u_xlati78 = u_xlati78 << (2 & int(0x1F));
            u_xlat9 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToShadow[(u_xlati78 + 1) / 4][(u_xlati78 + 1) % 4];
            u_xlat9 = _AdditionalLightsWorldToShadow[u_xlati78 / 4][u_xlati78 % 4] * vs_TEXCOORD1.xxxx + u_xlat9;
            u_xlat9 = _AdditionalLightsWorldToShadow[(u_xlati78 + 2) / 4][(u_xlati78 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat9;
            u_xlat9 = u_xlat9 + _AdditionalLightsWorldToShadow[(u_xlati78 + 3) / 4][(u_xlati78 + 3) % 4];
            u_xlat9.xyz = u_xlat9.xyz / u_xlat9.www;
            u_xlatb78 = 0.0<_AdditionalShadowParams[u_xlati77].y;
            if(u_xlatb78){
                u_xlatb78 = 1.0==_AdditionalShadowParams[u_xlati77].y;
                if(u_xlatb78){
                    ...
                    u_xlat78 = dot(u_xlat11, vec4(0.25, 0.25, 0.25, 0.25));
                } else {
                    u_xlatb79 = 2.0==_AdditionalShadowParams[u_xlati77].y;
                    if(u_xlatb79){
                        ...
                        u_xlat79 = u_xlat11.z * u_xlat16.y;
                        vec3 txVec34 = vec3(u_xlat14.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec34, 0.0);
                        vec3 txVec35 = vec3(u_xlat14.zw,u_xlat9.z);
                        u_xlat81 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec35, 0.0);
                        u_xlat81 = u_xlat81 * u_xlat17.y;
                        u_xlat80 = u_xlat17.x * u_xlat80 + u_xlat81;
                        vec3 txVec36 = vec3(u_xlat58.xy,u_xlat9.z);
                        u_xlat81 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec36, 0.0);
                        u_xlat80 = u_xlat17.z * u_xlat81 + u_xlat80;
                        vec3 txVec37 = vec3(u_xlat13.xy,u_xlat9.z);
                        u_xlat81 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec37, 0.0);
                        u_xlat80 = u_xlat17.w * u_xlat81 + u_xlat80;
                        vec3 txVec38 = vec3(u_xlat15.xy,u_xlat9.z);
                        u_xlat81 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec38, 0.0);
                        u_xlat80 = u_xlat18.x * u_xlat81 + u_xlat80;
                        vec3 txVec39 = vec3(u_xlat15.zw,u_xlat9.z);
                        u_xlat81 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec39, 0.0);
                        u_xlat80 = u_xlat18.y * u_xlat81 + u_xlat80;
                        vec3 txVec40 = vec3(u_xlat13.zw,u_xlat9.z);
                        u_xlat81 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec40, 0.0);
                        u_xlat80 = u_xlat18.z * u_xlat81 + u_xlat80;
                        vec3 txVec41 = vec3(u_xlat12.xy,u_xlat9.z);
                        u_xlat81 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec41, 0.0);
                        u_xlat80 = u_xlat18.w * u_xlat81 + u_xlat80;
                        vec3 txVec42 = vec3(u_xlat12.zw,u_xlat9.z);
                        u_xlat81 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec42, 0.0);
                        ...
                        u_xlat79 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec43, 0.0);
                        ...
                        u_xlat80 = u_xlat80 * u_xlat21.y;
                        u_xlat79 = u_xlat21.x * u_xlat79 + u_xlat80;
                        vec3 txVec45 = vec3(u_xlat58.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec45, 0.0);
                        u_xlat79 = u_xlat21.z * u_xlat80 + u_xlat79;
                        vec3 txVec46 = vec3(u_xlat19.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec46, 0.0);
                        u_xlat79 = u_xlat21.w * u_xlat80 + u_xlat79;
                        vec3 txVec47 = vec3(u_xlat17.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec47, 0.0);
                        u_xlat79 = u_xlat22.x * u_xlat80 + u_xlat79;
                        vec3 txVec48 = vec3(u_xlat17.zw,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec48, 0.0);
                        u_xlat79 = u_xlat22.y * u_xlat80 + u_xlat79;
                        vec3 txVec49 = vec3(u_xlat18.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec49, 0.0);
                        u_xlat79 = u_xlat22.z * u_xlat80 + u_xlat79;
                        vec3 txVec50 = vec3(u_xlat19.zw,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec50, 0.0);
                        u_xlat79 = u_xlat22.w * u_xlat80 + u_xlat79;
                        vec3 txVec51 = vec3(u_xlat20.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec51, 0.0);
                        u_xlat79 = u_xlat23.x * u_xlat80 + u_xlat79;
                        vec3 txVec52 = vec3(u_xlat20.zw,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec52, 0.0);
                        u_xlat79 = u_xlat23.y * u_xlat80 + u_xlat79;
                        vec3 txVec53 = vec3(u_xlat36.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec53, 0.0);
                        u_xlat79 = u_xlat23.z * u_xlat80 + u_xlat79;
                        vec3 txVec54 = vec3(u_xlat66.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec54, 0.0);
                        u_xlat79 = u_xlat23.w * u_xlat80 + u_xlat79;
                        vec3 txVec55 = vec3(u_xlat15.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec55, 0.0);
                        u_xlat79 = u_xlat11.x * u_xlat80 + u_xlat79;
                        vec3 txVec56 = vec3(u_xlat15.zw,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec56, 0.0);
                        u_xlat79 = u_xlat11.y * u_xlat80 + u_xlat79;
                        vec3 txVec57 = vec3(u_xlat61.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec57, 0.0);
                        u_xlat79 = u_xlat11.z * u_xlat80 + u_xlat79;
                        vec3 txVec58 = vec3(u_xlat10.xy,u_xlat9.z);
                        u_xlat80 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec58, 0.0);
                        u_xlat78 = u_xlat11.w * u_xlat80 + u_xlat79;
                    }
                }
            } else {
                vec3 txVec59 = vec3(u_xlat9.xy,u_xlat9.z);
                u_xlat78 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec59, 0.0);
            }
            u_xlat79 = 1.0 + (-_AdditionalShadowParams[u_xlati77].x);
            u_xlat78 = u_xlat78 * _AdditionalShadowParams[u_xlati77].x + u_xlat79;
            u_xlatb79 = 0.0>=u_xlat9.z;
            u_xlatb80 = u_xlat9.z>=1.0;
        ...
        u_xlat78 = u_xlat74 * u_xlat79 + u_xlat78;
        u_xlati79 = 1 << (u_xlati77 & int(0x1F));
        u_xlati79 = int(uint(u_xlati79) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati79 != 0) {
            u_xlati79 = int(_AdditionalLightsLightTypes[u_xlati77]);
            u_xlati80 = (u_xlati79 != 0) ? 0 : 1;
            u_xlati9 = u_xlati77 << (2 & int(0x1F));
            if(u_xlati80 != 0) {
                u_xlat33.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati9 + 1) / 4][(u_xlati9 + 1) % 4].xyw;
                u_xlat33.xyz = _AdditionalLightsWorldToLights[u_xlati9 / 4][u_xlati9 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat33.xyz;
                u_xlat33.xyz = _AdditionalLightsWorldToLights[(u_xlati9 + 2) / 4][(u_xlati9 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat33.xyz;
                u_xlat33.xyz = u_xlat33.xyz + _AdditionalLightsWorldToLights[(u_xlati9 + 3) / 4][(u_xlati9 + 3) % 4].xyw;
                ...
                u_xlat33.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati77].xy * u_xlat33.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati77].zw;
            } else {
                ...
                if(u_xlati79 != 0) {
                    ...
                    u_xlat33.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati77].xy * u_xlat10.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati77].zw;
                } else {
                    ...
                    u_xlat10.xyz = vec3(u_xlat79) * u_xlat10.xyz;
                    u_xlat79 = dot(abs(u_xlat10.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat79 = max(u_xlat79, 9.99999997e-07);
                    u_xlat79 = float(1.0) / float(u_xlat79);
                    u_xlat11.xyz = vec3(u_xlat79) * u_xlat10.zxy;
                    ...
                    u_xlat9.xw = u_xlat10.xy * vec2(u_xlat79) + u_xlat9.xw;
                    u_xlat9.xw = u_xlat9.xw * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat9.xw = clamp(u_xlat9.xw, 0.0, 1.0);
                    u_xlat33.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati77].xy * u_xlat9.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati77].zw;
                }
            }
            u_xlat9 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat33.xy, 0.0);
            u_xlat79 = (u_xlatb6.y) ? u_xlat9.w : u_xlat9.x;
            u_xlat9.xyz = (u_xlatb6.x) ? u_xlat9.xyz : vec3(u_xlat79);
        } else {
            u_xlat9.x = float(1.0);
            u_xlat9.y = float(1.0);
            u_xlat9.z = float(1.0);
        }
        u_xlat9.xyz = u_xlat9.xyz * _AdditionalLightsColor[u_xlati77].xyz;
        u_xlat77 = u_xlat78 * u_xlat54;
        u_xlat9.xyz = vec3(u_xlat77) * u_xlat9.xyz;
        u_xlat77 = dot(u_xlat2.xyz, u_xlat8.xyz);
        u_xlat77 = clamp(u_xlat77, 0.0, 1.0);
        u_xlat10.xyz = vec3(u_xlat77) * u_xlat9.xyz;
        ...
        u_xlat77 = u_xlat1.x * u_xlat77;
        u_xlat77 = exp2(u_xlat77);
        u_xlat8.xyz = vec3(u_xlat77) * _SpecColor.xyz;
    ...
    u_xlat24.x = u_xlat72 * (-u_xlat72);
    u_xlat24.x = exp2(u_xlat24.x);
    u_xlat1.xyz = u_xlat1.xyz + (-unity_FogColor.xyz);
    SV_Target0.xyz = u_xlat24.xxx * u_xlat1.xyz + unity_FogColor.xyz;
