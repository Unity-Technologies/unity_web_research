...
fn main_1() {
  ...
  let x_1637 : vec3<f32> = (x_1634 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1638 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1637.x, x_1637.y, x_1637.z, x_1638.w);
  let x_1640 : vec3<f32> = u_xlat0;
  let x_1642 : vec3<f32> = log2(abs(x_1640));
  let x_1643 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1642.x, x_1642.y, x_1642.z, x_1643.w);
  let x_1645 : vec4<f32> = u_xlat2;
  let x_1649 : vec3<f32> = (vec3<f32>(x_1645.x, x_1645.y, x_1645.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1650 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1649.x, x_1649.y, x_1649.z, x_1650.w);
  let x_1652 : vec4<f32> = u_xlat2;
  let x_1654 : vec3<f32> = exp2(vec3<f32>(x_1652.x, x_1652.y, x_1652.z));
  let x_1655 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1654.x, x_1654.y, x_1654.z, x_1655.w);
  let x_1657 : vec4<f32> = u_xlat2;
  let x_1664 : vec3<f32> = ((vec3<f32>(x_1657.x, x_1657.y, x_1657.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1665 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1664.x, x_1664.y, x_1664.z, x_1665.w);
  let x_1670 : vec3<f32> = u_xlat0;
  let x_1672 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1670.x, x_1670.y, x_1670.z, x_1670.x));
  u_xlatb0 = vec3<bool>(x_1672.x, x_1672.y, x_1672.z);
  ...
  u_xlat0.x = x_1684;
  let x_1687 : bool = u_xlatb0.y;
  if (x_1687) {
    let x_1692 : f32 = u_xlat1.y;
    x_1688 = x_1692;
  } else {
  ...
  u_xlat0.y = x_1696;
  let x_1699 : bool = u_xlatb0.z;
  if (x_1699) {
    let x_1704 : f32 = u_xlat1.z;
    x_1700 = x_1704;
  } else {
  ...
  u_xlat0.z = x_1708;
  let x_1710 : vec2<f32> = vs_TEXCOORD0;
  let x_1713 : vec4<f32> = x_17.x_Dithering_Params;
  let x_1717 : vec4<f32> = x_17.x_Dithering_Params;
  let x_1719 : vec2<f32> = ((x_1710 * vec2<f32>(x_1713.x, x_1713.y)) + vec2<f32>(x_1717.z, x_1717.w));
  let x_1720 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1719.x, x_1719.y, x_1720.z, x_1720.w);
  let x_1727 : vec4<f32> = u_xlat1;
  let x_1730 : f32 = x_17.x_GlobalMipBias.x;
  let x_1731 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1727.x, x_1727.y), x_1730);
  u_xlat27 = x_1731.w;
  let x_1733 : f32 = u_xlat27;
  u_xlat27 = ((x_1733 * 2.0f) + -1.0f);
  let x_1736 : f32 = u_xlat27;
  u_xlatb1.x = (x_1736 >= 0.0f);
  let x_1740 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1740);
  let x_1743 : f32 = u_xlat27;
  u_xlat27 = (-(abs(x_1743)) + 1.0f);
  let x_1747 : f32 = u_xlat27;
  u_xlat27 = sqrt(x_1747);
  let x_1749 : f32 = u_xlat27;
  u_xlat27 = (-(x_1749) + 1.0f);
  let x_1752 : f32 = u_xlat27;
  let x_1754 : f32 = u_xlat1.x;
  u_xlat27 = (x_1752 * x_1754);
  let x_1756 : vec3<f32> = u_xlat0;
  let x_1757 : vec3<f32> = (x_1756 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1758 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1757.x, x_1757.y, x_1757.z, x_1758.w);
  let x_1760 : vec3<f32> = u_xlat0;
  let x_1762 : vec3<f32> = log2(abs(x_1760));
  let x_1763 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1762.x, x_1762.y, x_1762.z, x_1763.w);
  let x_1765 : vec4<f32> = u_xlat2;
  let x_1767 : vec3<f32> = (vec3<f32>(x_1765.x, x_1765.y, x_1765.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1768 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1767.x, x_1767.y, x_1767.z, x_1768.w);
  let x_1770 : vec4<f32> = u_xlat2;
  let x_1772 : vec3<f32> = exp2(vec3<f32>(x_1770.x, x_1770.y, x_1770.z));
  let x_1773 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1772.x, x_1772.y, x_1772.z, x_1773.w);
  let x_1775 : vec4<f32> = u_xlat2;
  let x_1778 : vec3<f32> = ((vec3<f32>(x_1775.x, x_1775.y, x_1775.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1779 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1778.x, x_1778.y, x_1778.z, x_1779.w);
  let x_1781 : vec3<f32> = u_xlat0;
  let x_1783 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1781.x, x_1781.y, x_1781.z, x_1781.x));
  u_xlatb0 = vec3<bool>(x_1783.x, x_1783.y, x_1783.z);
  let x_1786 : bool = u_xlatb0.x;
  if (x_1786) {
  ...
  u_xlat0.x = x_1795;
  let x_1798 : bool = u_xlatb0.y;
  if (x_1798) {
    let x_1803 : f32 = u_xlat1.y;
    x_1799 = x_1803;
  } else {
    let x_1806 : f32 = u_xlat2.y;
    x_1799 = x_1806;
  }
  let x_1807 : f32 = x_1799;
  u_xlat0.y = x_1807;
  let x_1810 : bool = u_xlatb0.z;
  if (x_1810) {
    let x_1815 : f32 = u_xlat1.z;
    x_1811 = x_1815;
  } else {
  ...
  u_xlat0.z = x_1819;
  let x_1821 : f32 = u_xlat27;
  let x_1826 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1821, x_1821, x_1821) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1826);
  let x_1828 : vec3<f32> = u_xlat0;
  let x_1831 : vec3<f32> = (x_1828 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1832 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1831.x, x_1831.y, x_1831.z, x_1832.w);
  let x_1834 : vec3<f32> = u_xlat0;
  let x_1837 : vec3<f32> = (x_1834 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1838 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1837.x, x_1837.y, x_1837.z, x_1838.w);
  let x_1840 : vec4<f32> = u_xlat2;
  let x_1844 : vec3<f32> = (vec3<f32>(x_1840.x, x_1840.y, x_1840.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1845 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1844.x, x_1844.y, x_1844.z, x_1845.w);
  let x_1847 : vec4<f32> = u_xlat2;
  let x_1850 : vec3<f32> = log2(abs(vec3<f32>(x_1847.x, x_1847.y, x_1847.z)));
  let x_1851 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1850.x, x_1850.y, x_1850.z, x_1851.w);
  let x_1853 : vec4<f32> = u_xlat2;
  let x_1857 : vec3<f32> = (vec3<f32>(x_1853.x, x_1853.y, x_1853.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1858 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1857.x, x_1857.y, x_1857.z, x_1858.w);
  let x_1860 : vec4<f32> = u_xlat2;
  let x_1862 : vec3<f32> = exp2(vec3<f32>(x_1860.x, x_1860.y, x_1860.z));
  let x_1863 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1862.x, x_1862.y, x_1862.z, x_1863.w);
  let x_1867 : vec3<f32> = u_xlat0;
  let x_1869 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1867.x, x_1867.y, x_1867.z, x_1867.x));
  ...
  SV_Target0.x = x_1883;
  let x_1887 : bool = u_xlatb0.y;
  if (x_1887) {
    let x_1892 : f32 = u_xlat1.y;
    x_1888 = x_1892;
  } else {
    let x_1895 : f32 = u_xlat2.y;
    x_1888 = x_1895;
  }
  let x_1896 : f32 = x_1888;
  SV_Target0.y = x_1896;
  let x_1899 : bool = u_xlatb0.z;
  if (x_1899) {
    let x_1904 : f32 = u_xlat1.z;
    x_1900 = x_1904;
  } else {
    let x_1907 : f32 = u_xlat2.z;
    x_1900 = x_1907;
  }
