...
fn main_1() {
  ...
  let x_72 : vec4<f32> = textureSampleBias(x_BlitTexture, sampler_LinearClamp, x_69, x_71);
  ...
  u_xlat0.x = dot(x_86, vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
