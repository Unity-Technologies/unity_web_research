...
;
    ...
    u_xlat4.xyz = vs_INTERP8.yyy * _MainLightWorldToShadow[(u_xlati36 + 1) / 4][(u_xlati36 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati36 / 4][u_xlati36 % 4].xyz * vs_INTERP8.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati36 + 2) / 4][(u_xlati36 + 2) % 4].xyz * vs_INTERP8.zzz + u_xlat4.xyz;
    ...
    u_xlat13.x = u_xlat1.w + -0.400000006;
    u_xlat25 = dFdxCoarse(u_xlat1.w);
    u_xlat37 = dFdyCoarse(u_xlat1.w);
    u_xlat25 = abs(u_xlat37) + abs(u_xlat25);
    u_xlat25 = max(u_xlat25, 9.99999975e-05);
    u_xlat13.x = u_xlat13.x / u_xlat25;
    u_xlat13.x = u_xlat13.x + 0.5;
    u_xlat13.x = clamp(u_xlat13.x, 0.0, 1.0);
    u_xlatb25 = _AlphaToMaskAvailable!=0.0;
    u_xlat1.x = (u_xlatb25) ? u_xlat13.x : u_xlat1.x;
    u_xlat13.x = u_xlat1.x + -9.99999975e-05;
    u_xlatb13.x = u_xlat13.x<0.0;
    if(((int(u_xlatb13.x) * int(0xffffffffu)))!=0){discard;}
    u_xlatb13.x = 0.0<vs_INTERP4.w;
    u_xlatb13.z = unity_WorldTransformParams.w>=0.0;
    ...
    u_xlat4.xyz = u_xlat15.xxx * vs_INTERP4.xyz + u_xlat4.xyz;
    u_xlat15.xyz = u_xlat15.zzz * vs_INTERP9.xyz + u_xlat4.xyz;
    ...
    u_xlat5.x = (u_xlatb13.x) ? u_xlat4.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb13.x) ? u_xlat4.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb13.x) ? u_xlat4.z : unity_MatrixV[2].z;
    ...
    u_xlat13.x = dot(u_xlat15.xyz, u_xlat4.xyz);
    u_xlat13.x = u_xlat13.x + 0.5;
    u_xlat4.xyz = u_xlat13.xxx * u_xlat6.xyz;
    u_xlat13.x = max(u_xlat4.w, 9.99999975e-05);
    u_xlat4.xyz = u_xlat4.xyz / u_xlat13.xxx;
    u_xlat3.x = u_xlat3.x;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat1.x = min(u_xlat1.x, 1.0);
    u_xlat2.xyz = u_xlat2.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat13.x = (-u_xlat3.x) + 1.0;
    u_xlat37 = u_xlat13.x * u_xlat13.x;
    ...
    u_xlat18.x = dot((-u_xlat5.xyz), u_xlat15.xyz);
    u_xlat18.x = u_xlat18.x + u_xlat18.x;
    u_xlat18.xyz = u_xlat15.xyz * (-u_xlat18.xxx) + (-u_xlat5.xyz);
    u_xlat7.x = dot(u_xlat15.xyz, u_xlat5.xyz);
    u_xlat7.x = clamp(u_xlat7.x, 0.0, 1.0);
    u_xlat7.x = (-u_xlat7.x) + 1.0;
    u_xlat7.x = u_xlat7.x * u_xlat7.x;
    u_xlat7.x = u_xlat7.x * u_xlat7.x;
    u_xlat19 = (-u_xlat13.x) * 0.699999988 + 1.70000005;
    u_xlat13.x = u_xlat13.x * u_xlat19;
    u_xlat13.x = u_xlat13.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat18.xyz, u_xlat13.x);
    ...
    u_xlat18.xyz = u_xlat8.xyz * u_xlat13.xxx;
    u_xlat13.xz = vec2(u_xlat37) * vec2(u_xlat37) + vec2(-1.0, 1.0);
    u_xlat37 = float(1.0) / u_xlat13.z;
    ...
    u_xlat4.xyz = u_xlat4.xyz * u_xlat2.xyz + u_xlat18.xyz;
    u_xlat36 = u_xlat36 * unity_LightData.z;
    u_xlat37 = dot(u_xlat15.xyz, _MainLightPosition.xyz);
    ...
    u_xlat36 = dot(u_xlat15.xyz, u_xlat7.xyz);
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    u_xlat37 = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
    u_xlat36 = u_xlat36 * u_xlat36;
    u_xlat36 = u_xlat36 * u_xlat13.x + 1.00001001;
    ...
    u_xlat7.xyz = vec3(u_xlat36) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.x = dot(u_xlat15.xyz, u_xlat8.xyz);
        u_xlat6.x = clamp(u_xlat6.x, 0.0, 1.0);
        u_xlat43 = dot(u_xlat9.xyz, u_xlat8.xyz);
        u_xlat43 = clamp(u_xlat43, 0.0, 1.0);
        u_xlat6.x = u_xlat6.x * u_xlat6.x;
        u_xlat6.x = u_xlat6.x * u_xlat13.x + 1.00001001;
        u_xlat43 = u_xlat43 * u_xlat43;
        u_xlat6.x = u_xlat6.x * u_xlat6.x;
