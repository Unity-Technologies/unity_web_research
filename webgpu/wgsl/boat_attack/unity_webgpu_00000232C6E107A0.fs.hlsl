#line 1 "Hidden/Universal Render Pipeline/SubpixelMorphologicalAntialiasing"
static const int _SMAA_PRESET_LOW = 0 ;
static const int _SMAA_PRESET_MEDIUM = 0 ;
...
#line 12 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.core@16.0.1/Runtime/Utilities/Blit.hlsl"
...
#line 18 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.universal@16.0.1/Shaders/PostProcessing/SubpixelMorphologicalAntialiasingBridge.hlsl"
Texture2D _BlendTexture ;
Texture2D _AreaTexture ;
Texture2D _SearchTexture ;

float4 _Metrics ;
#line 613 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.universal@16.0.1/Shaders/PostProcessing/SubpixelMorphologicalAntialiasing.hlsl"
float3 SMAAGatherNeighbours ( float2 texcoord ,
float4 offset [ 3 ] ,
Texture2D tex ) {
#line 619
float P = tex . SampleBias ( sampler_PointClamp , texcoord , _GlobalMipBias . x ) . r ;
float Pleft = tex . SampleBias ( sampler_PointClamp , offset [ 0 ] . xy , _GlobalMipBias . x ) . r ;
float Ptop = tex . SampleBias ( sampler_PointClamp , offset [ 0 ] . zw , _GlobalMipBias . x ) . r ;
...
out float4 offset [ 3 ] ) {
offset [ 0 ] = mad ( _Metrics . xyxy , float4 ( - 1.0 , 0.0 , 0.0 , - 1.0 ) , texcoord . xyxy ) ;
offset [ 1 ] = mad ( _Metrics . xyxy , float4 ( 1.0 , 0.0 , 0.0 , 1.0 ) , texcoord . xyxy ) ;
offset [ 2 ] = mad ( _Metrics . xyxy , float4 ( - 2.0 , 0.0 , 0.0 , - 2.0 ) , texcoord . xyxy ) ;
}
#line 669
void SMAABlendingWeightCalculationVS ( float2 texcoord ,
out float2 pixcoord ,
out float4 offset [ 3 ] ) {
pixcoord = texcoord * _Metrics . zw ;
#line 675
offset [ 0 ] = mad ( _Metrics . xyxy , float4 ( - 0.25 , - 0.125 , 1.25 , - 0.125 ) , texcoord . xyxy ) ;
offset [ 1 ] = mad ( _Metrics . xyxy , float4 ( - 0.125 , - 0.25 , - 0.125 , 1.25 ) , texcoord . xyxy ) ;
#line 679
offset [ 2 ] = mad ( _Metrics . xxyy ,
...
out float4 offset ) {
offset = mad ( _Metrics . xyxy , float4 ( 1.0 , 0.0 , 0.0 , 1.0 ) , texcoord . xyxy ) ;
}
#line 703
...
float L = dot ( colorTex . SampleBias ( sampler_PointClamp , texcoord , _GlobalMipBias . x ) . rgb , weights ) ;

float Lleft = dot ( colorTex . SampleBias ( sampler_PointClamp , offset [ 0 ] . xy , _GlobalMipBias . x ) . rgb , weights ) ;
float Ltop = dot ( colorTex . SampleBias ( sampler_PointClamp , offset [ 0 ] . zw , _GlobalMipBias . x ) . rgb , weights ) ;
#line 725
float4 delta ;
...
discard ;
#line 734
float Lright = dot ( colorTex . SampleBias ( sampler_PointClamp , offset [ 1 ] . xy , _GlobalMipBias . x ) . rgb , weights ) ;
float Lbottom = dot ( colorTex . SampleBias ( sampler_PointClamp , offset [ 1 ] . zw , _GlobalMipBias . x ) . rgb , weights ) ;
delta . zw = abs ( L - float2 ( Lright , Lbottom ) ) ;
#line 739
float2 maxDelta = max ( delta . xy , delta . zw ) ;
#line 742
float Lleftleft = dot ( colorTex . SampleBias ( sampler_PointClamp , offset [ 2 ] . xy , _GlobalMipBias . x ) . rgb , weights ) ;
float Ltoptop = dot ( colorTex . SampleBias ( sampler_PointClamp , offset [ 2 ] . zw , _GlobalMipBias . x ) . rgb , weights ) ;
...
#line 779
float4 delta ;
float3 C = PositivePow ( colorTex . SampleBias ( sampler_PointClamp , texcoord , _GlobalMipBias . x ) . rgb , ( 1 / 2.2 ) ) ;

float3 Cleft = PositivePow ( colorTex . SampleBias ( sampler_PointClamp , offset [ 0 ] . xy , _GlobalMipBias . x ) . rgb , ( 1 / 2.2 ) ) ;
float3 t = abs ( C - Cleft ) ;
delta . x = max ( max ( t . r , t . g ) , t . b ) ;

float3 Ctop = PositivePow ( colorTex . SampleBias ( sampler_PointClamp , offset [ 0 ] . zw , _GlobalMipBias . x ) . rgb , ( 1 / 2.2 ) ) ;
t = abs ( C - Ctop ) ;
...
discard ;
#line 798
float3 Cright = PositivePow ( colorTex . SampleBias ( sampler_PointClamp , offset [ 1 ] . xy , _GlobalMipBias . x ) . rgb , ( 1 / 2.2 ) ) ;
t = abs ( C - Cright ) ;
delta . z = max ( max ( t . r , t . g ) , t . b ) ;

float3 Cbottom = PositivePow ( colorTex . SampleBias ( sampler_PointClamp , offset [ 1 ] . zw , _GlobalMipBias . x ) . rgb , ( 1 / 2.2 ) ) ;
t = abs ( C - Cbottom ) ;
delta . w = max ( max ( t . r , t . g ) , t . b ) ;
#line 807
float2 maxDelta = max ( delta . xy , delta . zw ) ;
#line 810
float3 Cleftleft = PositivePow ( colorTex . SampleBias ( sampler_PointClamp , offset [ 2 ] . xy , _GlobalMipBias . x ) . rgb , ( 1 / 2.2 ) ) ;
t = abs ( Cleft - Cleftleft ) ;
delta . z = max ( max ( t . r , t . g ) , t . b ) ;

float3 Ctoptop = PositivePow ( colorTex . SampleBias ( sampler_PointClamp , offset [ 2 ] . zw , _GlobalMipBias . x ) . rgb , ( 1 / 2.2 ) ) ;
t = abs ( Ctop - Ctoptop ) ;
delta . w = max ( max ( t . r , t . g ) , t . b ) ;
#line 819
maxDelta = max ( maxDelta . xy , delta . zw ) ;
...
float2 edges = step ( ( 0.1 * 0.1 ) , delta ) ;
...
float3 t = float3 ( _Metrics . xy , 1.0 ) ;
while ( coord . z < float ( 8 - 1 ) &&
coord . w > 0.9 ) {
coord . xyz = mad ( t , float3 ( dir , 1.0 ) , coord . xyz ) ;
e = edgesTex . SampleLevel ( sampler_LinearClamp , coord . xy , 0 ) . rg ;
...
#line 931
return areaTex . SampleLevel ( sampler_LinearClamp , texcoord , 0 ) . rg ;
}
#line 937
...
float4 coords = mad ( float4 ( - d . x + 0.25 , d . x , d . y , - d . y - 0.25 ) , _Metrics . xyxy , texcoord . xyxy ) ;
float4 c ;
c . xy = edgesTex . SampleLevel ( sampler_LinearClamp , coords . xy + int2 ( - 1 , 0 ) * _Metrics . xy , 0 ) . rg ;
c . zw = edgesTex . SampleLevel ( sampler_LinearClamp , coords . zw + int2 ( 1 , 0 ) * _Metrics . xy , 0 ) . rg ;
...
if ( edgesTex . SampleLevel ( sampler_LinearClamp , texcoord + int2 ( 1 , 0 ) * _Metrics . xy , 0 ) . r > 0.0 ) {
...
float4 coords = mad ( float4 ( - d . x , - d . x , d . y , d . y ) , _Metrics . xyxy , texcoord . xyxy ) ;
float4 c ;
c . x = edgesTex . SampleLevel ( sampler_LinearClamp , coords . xy + int2 ( - 1 , 0 ) * _Metrics . xy , 0 ) . g ;
c . y = edgesTex . SampleLevel ( sampler_LinearClamp , coords . xy + int2 ( 0 , - 1 ) * _Metrics . xy , 0 ) . r ;
c . zw = edgesTex . SampleLevel ( sampler_LinearClamp , coords . zw + int2 ( 1 , 0 ) * _Metrics . xy , 0 ) . gr ;
float2 cc = mad ( float2 ( 2.0 , 2.0 ) , c . xz , c . yw ) ;
#line 998
SMAAMovc ( bool2 ( step ( float2 ( 0.9 , 0.9 ) , d . zw ) ) , cc , float2 ( 0.0 , 0.0 ) ) ;
#line 1001
...
#line 1033
return searchTex . SampleLevel ( sampler_LinearClamp , mad ( scale , e , bias ) , 0 ) . a ;
}
#line 1039
...
e . g > 0.8281 &&
e . r == 0.0 ) {
e = edgesTex . SampleLevel ( sampler_LinearClamp , texcoord , 0 ) . rg ;
texcoord = mad ( - float2 ( 2.0 , 0.0 ) , _Metrics . xy , texcoord ) ;
}

float offset = mad ( - ( 255.0 / 127.0 ) , SMAASearchLength ( searchTex , e , 0.0 ) , 3.25 ) ;
return mad ( _Metrics . x , offset , texcoord . x ) ;
#line 1069
}
...
e . g == 0.0 ) {
e = edgesTex . SampleLevel ( sampler_LinearClamp , texcoord , 0 ) . rg ;
texcoord = mad ( - float2 ( 0.0 , 2.0 ) , _Metrics . xy , texcoord ) ;
}
float offset = mad ( - ( 255.0 / 127.0 ) , SMAASearchLength ( searchTex , e . gr , 0.0 ) , 3.25 ) ;
return mad ( _Metrics . y , offset , texcoord . y ) ;
}
...
factor . x -= rounding . x * edgesTex . SampleLevel ( sampler_LinearClamp , texcoord . xy + int2 ( 0 , 1 ) * _Metrics . xy , 0 ) . r ;
factor . x -= rounding . y * edgesTex . SampleLevel ( sampler_LinearClamp , texcoord . zw + int2 ( 1 , 1 ) * _Metrics . xy , 0 ) . r ;
factor . y -= rounding . x * edgesTex . SampleLevel ( sampler_LinearClamp , texcoord . xy + int2 ( 0 , - 2 ) * _Metrics . xy , 0 ) . r ;
factor . y -= rounding . y * edgesTex . SampleLevel ( sampler_LinearClamp , texcoord . zw + int2 ( 1 , - 2 ) * _Metrics . xy , 0 ) . r ;
...
float2 factor = float2 ( 1.0 , 1.0 ) ;
factor . x -= rounding . x * edgesTex . SampleLevel ( sampler_LinearClamp , texcoord . xy + int2 ( 1 , 0 ) * _Metrics . xy , 0 ) . g ;
factor . x -= rounding . y * edgesTex . SampleLevel ( sampler_LinearClamp , texcoord . zw + int2 ( 1 , 1 ) * _Metrics . xy , 0 ) . g ;
factor . y -= rounding . x * edgesTex . SampleLevel ( sampler_LinearClamp , texcoord . xy + int2 ( - 2 , 0 ) * _Metrics . xy , 0 ) . g ;
factor . y -= rounding . y * edgesTex . SampleLevel ( sampler_LinearClamp , texcoord . zw + int2 ( - 2 , 1 ) * _Metrics . xy , 0 ) . g ;
...
float2 e = edgesTex . SampleBias ( sampler_LinearClamp , texcoord , _GlobalMipBias . x ) . rg ;
...
d . x = coords . x ;
#line 1201
float e1 = edgesTex . SampleLevel ( sampler_LinearClamp , coords . xy , 0 ) . r ;
#line 1204
coords . z = SMAASearchXRight ( edgesTex , searchTex , offset [ 0 ] . zw , offset [ 2 ] . y ) ;
d . y = coords . z ;
#line 1209
d = abs ( round ( mad ( _Metrics . zz , d , - pixcoord . xx ) ) ) ;
#line 1213
float2 sqrt_d = sqrt ( d ) ;
#line 1216
float e2 = edgesTex . SampleLevel ( sampler_LinearClamp , coords . zy + int2 ( 1 , 0 ) * _Metrics . xy , 0 ) . r ;
#line 1220
...
d . x = coords . y ;
#line 1244
float e1 = edgesTex . SampleLevel ( sampler_LinearClamp , coords . xy , 0 ) . g ;
#line 1247
coords . z = SMAASearchYDown ( edgesTex , searchTex , offset [ 1 ] . zw , offset [ 2 ] . w ) ;
d . y = coords . z ;
#line 1251
d = abs ( round ( mad ( _Metrics . ww , d , - pixcoord . yy ) ) ) ;
#line 1255
float2 sqrt_d = sqrt ( d ) ;
#line 1258
float e2 = edgesTex . SampleLevel ( sampler_LinearClamp , coords . xz + int2 ( 0 , 1 ) * _Metrics . xy , 0 ) . g ;
#line 1261
...
float4 a ;
a . x = blendTex . SampleBias ( sampler_LinearClamp , offset . xy , _GlobalMipBias . x ) . a ;
a . y = blendTex . SampleBias ( sampler_LinearClamp , offset . zw , _GlobalMipBias . x ) . g ;
a . wz = blendTex . SampleBias ( sampler_LinearClamp , texcoord , _GlobalMipBias . x ) . xz ;
#line 1310
[ branch ]
if ( dot ( a , float4 ( 1.0 , 1.0 , 1.0 , 1.0 ) ) < 1e-5 ) {
float4 color = colorTex . SampleLevel ( sampler_LinearClamp , texcoord , 0 ) ;
#line 1325
return color ;
}
else {
...
#line 1338
float4 blendingCoord = mad ( blendingOffset , float4 ( _Metrics . xy , - _Metrics . xy ) , texcoord . xyxy ) ;
#line 1342
float4 color = blendingWeight . x * colorTex . SampleLevel ( sampler_LinearClamp , blendingCoord . xy , 0 ) ;
color += blendingWeight . y * colorTex . SampleLevel ( sampler_LinearClamp , blendingCoord . zw , 0 ) ;
#line 1360
return color ;
}
}
...
Texture2D currentColorTex ,
Texture2D previousColorTex
#line 1373
) {
#line 1415
float4 current = currentColorTex . SampleBias ( sampler_PointClamp , texcoord , _GlobalMipBias . x ) ;
float4 previous = previousColorTex . SampleBias ( sampler_PointClamp , texcoord , _GlobalMipBias . x ) ;
...
target0 = colorTexMS . Load ( pos , 0 ) ;
target1 = colorTexMS . Load ( pos , 1 ) ;
}
#line 41 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.universal@16.0.1/Shaders/PostProcessing/SubpixelMorphologicalAntialiasingBridge.hlsl"
struct VaryingsEdge
{
float4 positionCS : SV_POSITION ;
float2 texcoord : TEXCOORD0 ;
