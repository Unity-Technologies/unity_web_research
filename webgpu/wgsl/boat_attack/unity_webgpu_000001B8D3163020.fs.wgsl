...
fn main_1() {
  ...
  let x_1603 : f32 = vs_TEXCOORD3.w;
  let x_1605 : f32 = vs_TEXCOORD3.w;
  u_xlat51 = (x_1603 * -(x_1605));
  let x_1608 : f32 = u_xlat51;
  u_xlat51 = exp2(x_1608);
  let x_1610 : vec4<f32> = u_xlat2;
  let x_1612 : vec4<f32> = u_xlat0;
  let x_1616 : vec4<f32> = x_237.unity_FogColor;
  let x_1619 : vec3<f32> = ((vec3<f32>(x_1610.x, x_1610.y, x_1610.z) * vec3<f32>(x_1612.x, x_1612.y, x_1612.z)) + -(vec3<f32>(x_1616.x, x_1616.y, x_1616.z)));
  ...
  let x_1630 : vec4<f32> = x_237.unity_FogColor;
  let x_1632 : vec3<f32> = ((vec3<f32>(x_1624, x_1624, x_1624) * vec3<f32>(x_1626.x, x_1626.y, x_1626.z)) + vec3<f32>(x_1630.x, x_1630.y, x_1630.z));
  let x_1633 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1632.x, x_1632.y, x_1632.z, x_1633.w);
  let x_1636 : f32 = u_xlat2.w;
  SV_Target0.w = x_1636;
  return;
}
