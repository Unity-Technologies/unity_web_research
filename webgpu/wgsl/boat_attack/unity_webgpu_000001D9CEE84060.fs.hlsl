#line 1 "Hidden/Universal Render Pipeline/LutBuilderHdr"
static const int _TONEMAP_ACES = 0 ;
static const int _TONEMAP_NEUTRAL = 0 ;
...
float4 _HDROutputGradingParams ;
...
{
float x = curve . SampleBias ( sampler_LinearClamp , float2 ( t , 0.0 ) , _GlobalMipBias . x ) . x ;
return saturate ( x ) ;
}
