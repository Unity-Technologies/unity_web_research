...
;
    ...
    u_xlat80 = dot(u_xlat4, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat80 = (-u_xlat80) + 4.0;
    u_xlatu80 = uint(u_xlat80);
    u_xlati80 = int(u_xlatu80) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati80 + 1) / 4][(u_xlati80 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati80 / 4][u_xlati80 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati80 + 2) / 4][(u_xlati80 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati80 + 3) / 4][(u_xlati80 + 3) % 4].xyz;
    u_xlat1.w = 1.0;
    ...
    u_xlat35.xyz = vec3(u_xlat55) * u_xlat35.xyz + u_xlat5.xyz;
    ...
    u_xlat8.xyz = u_xlat5.xyz * u_xlat0.xxx + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat0.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu0 =  uint(int(u_xlat0.x));
    u_xlat52 = u_xlat29 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat52 = clamp(u_xlat52, 0.0, 1.0);
    ...
    {
        u_xlatu55 = u_xlatu_loop_1 >> (2u & uint(0x1F));
        u_xlati82 = int(u_xlatu_loop_1 & 3u);
        u_xlat55 = dot(unity_LightIndices[int(u_xlatu55)], uintBitsToFloat(ImmCB_0[u_xlati82]));
        u_xlati55 = int(u_xlat55);
        u_xlat35.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati55].www + _AdditionalLightsPosition[u_xlati55].xyz;
        ...
        u_xlat82 = u_xlat82 * _AdditionalLightsAttenuation[u_xlati55].x;
        u_xlat82 = (-u_xlat82) * u_xlat82 + 1.0;
        u_xlat82 = max(u_xlat82, 0.0);
        u_xlat82 = u_xlat82 * u_xlat82;
        u_xlat82 = u_xlat82 * u_xlat84;
        u_xlat84 = dot(_AdditionalLightsSpotDir[u_xlati55].xyz, u_xlat10.xyz);
        u_xlat84 = u_xlat84 * _AdditionalLightsAttenuation[u_xlati55].z + _AdditionalLightsAttenuation[u_xlati55].w;
        u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
        u_xlat84 = u_xlat84 * u_xlat84;
        u_xlat82 = u_xlat82 * u_xlat84;
        u_xlati84 = int(_AdditionalShadowParams[u_xlati55].w);
        u_xlatb85 = u_xlati84>=0;
        if(u_xlatb85){
            u_xlatb85 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati55].z);
            if(u_xlatb85){
                ...
                u_xlat86 = trunc(_AdditionalShadowParams[u_xlati55].w);
            ...
            u_xlatb84 = 0.0<_AdditionalShadowParams[u_xlati55].y;
            if(u_xlatb84){
                u_xlatb84 = 1.0==_AdditionalShadowParams[u_xlati55].y;
                if(u_xlatb84){
                    ...
                    u_xlatb85 = 2.0==_AdditionalShadowParams[u_xlati55].y;
                    if(u_xlatb85){
            ...
            u_xlat85 = 1.0 + (-_AdditionalShadowParams[u_xlati55].x);
            u_xlat84 = u_xlat84 * _AdditionalShadowParams[u_xlati55].x + u_xlat85;
        ...
        u_xlati85 = 1 << (u_xlati55 & int(0x1F));
        u_xlati85 = int(uint(u_xlati85) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati85 != 0) {
            u_xlati85 = int(_AdditionalLightsLightTypes[u_xlati55]);
            u_xlati86 = (u_xlati85 != 0) ? 0 : 1;
            u_xlati88 = u_xlati55 << (2 & int(0x1F));
            if(u_xlati86 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati55].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati55].zw;
            } else {
                ...
                if(u_xlati85 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati55].xy * u_xlat63.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati55].zw;
                } else {
            ...
            u_xlat85 = (u_xlatb3.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat85);
        } else {
            u_xlat11.x = float(1.0);
            u_xlat11.y = float(1.0);
            u_xlat11.z = float(1.0);
        }
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[u_xlati55].xyz;
        u_xlat55 = u_xlat82 * u_xlat84;
        u_xlat82 = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        u_xlat55 = u_xlat55 * u_xlat82;
        u_xlat11.xyz = vec3(u_xlat55) * u_xlat11.xyz;
        u_xlat35.xyz = u_xlat35.xyz * vec3(u_xlat83) + u_xlat2.xyz;
        u_xlat55 = dot(u_xlat35.xyz, u_xlat35.xyz);
        u_xlat55 = max(u_xlat55, 1.17549435e-38);
        u_xlat55 = inversesqrt(u_xlat55);
        u_xlat35.xyz = vec3(u_xlat55) * u_xlat35.xyz;
        u_xlat55 = dot(u_xlat1.xyz, u_xlat35.xyz);
        u_xlat55 = clamp(u_xlat55, 0.0, 1.0);
        u_xlat82 = dot(u_xlat10.xyz, u_xlat35.xyz);
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        u_xlat55 = u_xlat55 * u_xlat55;
        u_xlat55 = u_xlat55 * u_xlat9.x + 1.00001001;
        u_xlat82 = u_xlat82 * u_xlat82;
        u_xlat55 = u_xlat55 * u_xlat55;
        u_xlat82 = max(u_xlat82, 0.100000001);
        u_xlat55 = u_xlat55 * u_xlat82;
        u_xlat55 = u_xlat80 * u_xlat55;
        u_xlat55 = u_xlat81 / u_xlat55;
        u_xlat35.xyz = u_xlat5.xyz * vec3(u_xlat55) + u_xlat6.xyz;
