...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_759.x, x_759.y, x_759.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_770 : vec3<f32> = (vec3<f32>(x_768.x, x_768.y, x_768.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_781 : vec3<f32> = ((vec3<f32>(x_778.x, x_778.y, x_778.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_782 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_781.x, x_781.y, x_781.z, x_782.w);
  let x_785 : vec4<f32> = u_xlat0;
  let x_787 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_785.x, x_785.y, x_785.z, x_785.x));
  u_xlatb0 = vec3<bool>(x_787.x, x_787.y, x_787.z);
