...
fn main_1() {
  ...
  u_xlat21 = (x_1229 + -0.5f);
  let x_1231 : f32 = u_xlat21;
  let x_1232 : f32 = u_xlat21;
  u_xlat21 = (x_1231 + x_1232);
  let x_1234 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1234.x, x_1234.y, x_1234.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  ...
  u_xlat8 = (vec3<f32>(x_1256, x_1256, x_1256) * vec3<f32>(x_1258.x, x_1258.y, x_1258.z));
  let x_1261 : vec3<f32> = u_xlat8;
  let x_1264 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_1261 * vec3<f32>(x_1264.x, x_1264.x, x_1264.x));
  let x_1269 : vec3<f32> = u_xlat8;
  let x_1270 : vec3<f32> = u_xlat1;
  let x_1273 : vec4<f32> = u_xlat0;
  let x_1275 : vec3<f32> = ((x_1269 * vec3<f32>(x_1270.x, x_1270.x, x_1270.x)) + vec3<f32>(x_1273.x, x_1273.y, x_1273.z));
