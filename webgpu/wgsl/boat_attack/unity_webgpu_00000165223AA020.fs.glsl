...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat19.x = inversesqrt(u_xlat19.x);
    u_xlat57 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat57 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat57;
    u_xlat57 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat57;
    u_xlat57 = u_xlat57 + unity_MatrixV[3].z;
    ...
    u_xlat59 = u_xlat1.x + -1.0;
    u_xlat59 = _AmbientOcclusionParam.w * u_xlat59 + 1.0;
    u_xlat1.x = min(u_xlat1.x, 1.0);
    u_xlatb60 = 0.0<_MainLightShadowParams.y;
    if(u_xlatb60){
        u_xlatb60 = _MainLightShadowParams.y==1.0;
        if(u_xlatb60){
            ...
            u_xlat60 = dot(u_xlat6, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb61){
                ...
                u_xlat24 = u_xlat24 * u_xlat12.y;
                u_xlat5.x = u_xlat12.x * u_xlat5.x + u_xlat24;
                ...
                u_xlat5.x = u_xlat12.z * u_xlat24 + u_xlat5.x;
                ...
                u_xlat5.x = u_xlat12.w * u_xlat24 + u_xlat5.x;
                ...
                u_xlat5.x = u_xlat13.x * u_xlat24 + u_xlat5.x;
                ...
                u_xlat5.x = u_xlat13.y * u_xlat24 + u_xlat5.x;
                ...
                u_xlat5.x = u_xlat13.z * u_xlat24 + u_xlat5.x;
                ...
                u_xlat60 = u_xlat61 * u_xlat24 + u_xlat5.x;
            } else {
                u_xlat5.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat43.xy = vs_TEXCOORD6.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat61 = u_xlat16.x * u_xlat61 + u_xlat7.x;
                ...
                u_xlat61 = u_xlat16.z * u_xlat43.x + u_xlat61;
                vec3 txVec16 = vec3(u_xlat14.xy,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec16, 0.0);
                u_xlat61 = u_xlat16.w * u_xlat43.x + u_xlat61;
                vec3 txVec17 = vec3(u_xlat12.xy,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec17, 0.0);
                u_xlat61 = u_xlat17.x * u_xlat43.x + u_xlat61;
                vec3 txVec18 = vec3(u_xlat12.zw,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec18, 0.0);
                u_xlat61 = u_xlat17.y * u_xlat43.x + u_xlat61;
                vec3 txVec19 = vec3(u_xlat13.xy,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec19, 0.0);
                u_xlat61 = u_xlat17.z * u_xlat43.x + u_xlat61;
                vec3 txVec20 = vec3(u_xlat14.zw,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec20, 0.0);
                u_xlat61 = u_xlat17.w * u_xlat43.x + u_xlat61;
                vec3 txVec21 = vec3(u_xlat15.xy,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec21, 0.0);
                u_xlat61 = u_xlat18.x * u_xlat43.x + u_xlat61;
                vec3 txVec22 = vec3(u_xlat15.zw,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec22, 0.0);
                u_xlat61 = u_xlat18.y * u_xlat43.x + u_xlat61;
                vec3 txVec23 = vec3(u_xlat26.xy,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat61 = u_xlat18.z * u_xlat43.x + u_xlat61;
                vec3 txVec24 = vec3(u_xlat51.xy,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec24, 0.0);
                u_xlat61 = u_xlat18.w * u_xlat43.x + u_xlat61;
                vec3 txVec25 = vec3(u_xlat10.xy,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec25, 0.0);
                u_xlat61 = u_xlat6.x * u_xlat43.x + u_xlat61;
                vec3 txVec26 = vec3(u_xlat10.zw,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec26, 0.0);
                u_xlat61 = u_xlat6.y * u_xlat43.x + u_xlat61;
                vec3 txVec27 = vec3(u_xlat46.xy,vs_TEXCOORD6.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
                u_xlat61 = u_xlat6.z * u_xlat43.x + u_xlat61;
                ...
                u_xlat60 = u_xlat6.w * u_xlat5.x + u_xlat61;
            }
        }
    } else {
        vec3 txVec29 = vec3(vs_TEXCOORD6.xy,vs_TEXCOORD6.z);
        u_xlat60 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat61 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat60 = u_xlat60 * _MainLightShadowParams.x + u_xlat61;
    u_xlatb61 = 0.0>=vs_TEXCOORD6.z;
    u_xlatb5 = vs_TEXCOORD6.z>=1.0;
    u_xlatb61 = u_xlatb61 || u_xlatb5;
    ...
    u_xlat5.x = (-u_xlat60) + 1.0;
    u_xlat60 = u_xlat61 * u_xlat5.x + u_xlat60;
    ...
    if(u_xlatb61){
        ...
        u_xlat61 = (u_xlatb6.y) ? u_xlat5.w : u_xlat5.x;
        u_xlat5.xyz = (u_xlatb6.x) ? u_xlat5.xyz : vec3(u_xlat61);
    } else {
        u_xlat5.x = float(1.0);
        u_xlat5.y = float(1.0);
        u_xlat5.z = float(1.0);
    ...
    u_xlat1.x = u_xlat60 * unity_LightData.z;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat62 = dot(unity_LightIndices[int(u_xlatu62)], uintBitsToFloat(ImmCB_0[u_xlati44]));
        u_xlatu62 =  uint(int(u_xlat62));
        u_xlat8.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu62)].www + _AdditionalLightsPosition[int(u_xlatu62)].xyz;
        ...
        u_xlat44 = u_xlat44 * _AdditionalLightsAttenuation[int(u_xlatu62)].x;
        u_xlat44 = (-u_xlat44) * u_xlat44 + 1.0;
        u_xlat44 = max(u_xlat44, 0.0);
        u_xlat44 = u_xlat44 * u_xlat44;
        u_xlat44 = u_xlat44 * u_xlat63;
        u_xlat63 = dot(_AdditionalLightsSpotDir[int(u_xlatu62)].xyz, u_xlat8.xyz);
        u_xlat63 = u_xlat63 * _AdditionalLightsAttenuation[int(u_xlatu62)].z + _AdditionalLightsAttenuation[int(u_xlatu62)].w;
        u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
        u_xlat63 = u_xlat63 * u_xlat63;
        u_xlat44 = u_xlat63 * u_xlat44;
        u_xlatu63 = u_xlatu62 >> (5u & uint(0x1F));
        u_xlati64 = 1 << (int(u_xlatu62) & int(0x1F));
        u_xlati63 = int(uint(u_xlati64) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu63)]));
        if(u_xlati63 != 0) {
            u_xlati63 = int(_AdditionalLightsLightTypes[int(u_xlatu62)]);
            u_xlati64 = (u_xlati63 != 0) ? 0 : 1;
            u_xlati65 = int(u_xlatu62) << (2 & int(0x1F));
            if(u_xlati64 != 0) {
                u_xlat9.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati65 + 1) / 4][(u_xlati65 + 1) % 4].xyw;
                u_xlat9.xyz = _AdditionalLightsWorldToLights[u_xlati65 / 4][u_xlati65 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat9.xyz;
                u_xlat9.xyz = _AdditionalLightsWorldToLights[(u_xlati65 + 2) / 4][(u_xlati65 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat9.xyz;
                u_xlat9.xyz = u_xlat9.xyz + _AdditionalLightsWorldToLights[(u_xlati65 + 3) / 4][(u_xlati65 + 3) % 4].xyw;
                u_xlat9.xy = u_xlat9.xy / u_xlat9.zz;
                u_xlat9.xy = u_xlat9.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat9.xy = clamp(u_xlat9.xy, 0.0, 1.0);
                u_xlat9.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].xy * u_xlat9.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].zw;
            } else {
                u_xlatb63 = u_xlati63==1;
                u_xlati63 = u_xlatb63 ? 1 : int(0);
                if(u_xlati63 != 0) {
                    u_xlat47.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati65 + 1) / 4][(u_xlati65 + 1) % 4].xy;
                    u_xlat47.xy = _AdditionalLightsWorldToLights[u_xlati65 / 4][u_xlati65 % 4].xy * vs_TEXCOORD1.xx + u_xlat47.xy;
                    u_xlat47.xy = _AdditionalLightsWorldToLights[(u_xlati65 + 2) / 4][(u_xlati65 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat47.xy;
                    u_xlat47.xy = u_xlat47.xy + _AdditionalLightsWorldToLights[(u_xlati65 + 3) / 4][(u_xlati65 + 3) % 4].xy;
                    u_xlat47.xy = u_xlat47.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat47.xy = fract(u_xlat47.xy);
                    u_xlat9.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].xy * u_xlat47.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu62)].zw;
                } else {
                    u_xlat10 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati65 + 1) / 4][(u_xlati65 + 1) % 4];
                    u_xlat10 = _AdditionalLightsWorldToLights[u_xlati65 / 4][u_xlati65 % 4] * vs_TEXCOORD1.xxxx + u_xlat10;
                    u_xlat10 = _AdditionalLightsWorldToLights[(u_xlati65 + 2) / 4][(u_xlati65 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat10;
                    u_xlat10 = u_xlat10 + _AdditionalLightsWorldToLights[(u_xlati65 + 3) / 4][(u_xlati65 + 3) % 4];
        ...
        u_xlat9.xyz = u_xlat9.xyz * _AdditionalLightsColor[int(u_xlatu62)].xyz;
        ...
        u_xlat62 = u_xlat1.x * u_xlat62;
        u_xlat62 = exp2(u_xlat62);
        u_xlat8.xyz = vec3(u_xlat62) * _SpecColor.xyz;
