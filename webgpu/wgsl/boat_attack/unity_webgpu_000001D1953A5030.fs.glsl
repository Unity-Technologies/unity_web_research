...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat22.xyz = texture(sampler2D(unity_Lightmap, samplerunity_Lightmap), vs_TEXCOORD0.zw, _GlobalMipBias.x).xyz;
    ...
    u_xlat23 = (-u_xlat1) * 0.959999979 + 0.959999979;
    u_xlat63 = (-u_xlat23) + 1.0;
    ...
    u_xlat23 = u_xlat1 * u_xlat1;
    u_xlat23 = max(u_xlat23, 0.0078125);
    u_xlat64 = u_xlat23 * u_xlat23;
    u_xlat60 = u_xlat0.w + u_xlat63;
    u_xlat60 = clamp(u_xlat60, 0.0, 1.0);
    u_xlat63 = u_xlat23 * 4.0 + 2.0;
    ...
    if(u_xlatb5){
        ...
        if(u_xlatb5){
            ...
            u_xlatb25.x = _MainLightShadowParams.y==2.0;
            if(u_xlatb25.x){
                u_xlat25.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat25.xy = floor(u_xlat25.xy);
                u_xlat6.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat25.xy);
                ...
                vec3 txVec28 = vec3(u_xlat25.xy,vs_TEXCOORD8.z);
    ...
    u_xlat5.x = u_xlat5.x * _MainLightShadowParams.x + u_xlat25.x;
    u_xlatb25.x = 0.0>=vs_TEXCOORD8.z;
    u_xlatb45 = vs_TEXCOORD8.z>=1.0;
    u_xlatb25.x = u_xlatb45 || u_xlatb25.x;
    u_xlat5.x = (u_xlatb25.x) ? 1.0 : u_xlat5.x;
    ...
    u_xlat5.x = u_xlat25.x * u_xlat45 + u_xlat5.x;
    ...
    if(u_xlatb25.x){
        ...
        u_xlat45 = (u_xlatb25.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat25.xyz = (u_xlatb25.x) ? u_xlat6.xyz : vec3(u_xlat45);
    } else {
    ...
    u_xlat25.xyz = vec3(u_xlat43) * u_xlat25.xyz;
    u_xlat6.x = vs_TEXCOORD3.w;
    u_xlat6.y = vs_TEXCOORD4.w;
    u_xlat6.z = vs_TEXCOORD5.w;
    u_xlat66 = dot((-u_xlat6.xyz), u_xlat21.xyz);
    u_xlat66 = u_xlat66 + u_xlat66;
    u_xlat7.xyz = u_xlat21.xyz * (-vec3(u_xlat66)) + (-u_xlat6.xyz);
    u_xlat66 = dot(u_xlat21.xyz, u_xlat6.xyz);
    ...
    u_xlat8.xy = vec2(u_xlat23) * vec2(u_xlat23) + vec2(-1.0, 1.0);
    ...
    u_xlat22.xyz = u_xlat22.xyz * u_xlat4.xyz + u_xlat7.xyz;
    u_xlat60 = u_xlat5.x * unity_LightData.z;
    u_xlat1 = dot(u_xlat21.xyz, _MainLightPosition.xyz);
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat60 = u_xlat60 * u_xlat1;
    u_xlat5.xyz = vec3(u_xlat60) * u_xlat25.xyz;
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat60) + u_xlat4.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat23 = dot(unity_LightIndices[int(u_xlatu23)], uintBitsToFloat(ImmCB_0[u_xlati65]));
        u_xlatu23 =  uint(int(u_xlat23));
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu23)].www + _AdditionalLightsPosition[int(u_xlatu23)].xyz;
        ...
        u_xlat65 = u_xlat65 * _AdditionalLightsAttenuation[int(u_xlatu23)].x;
        u_xlat65 = (-u_xlat65) * u_xlat65 + 1.0;
        u_xlat65 = max(u_xlat65, 0.0);
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat65 = u_xlat65 * u_xlat47.x;
        u_xlat47.x = dot(_AdditionalLightsSpotDir[int(u_xlatu23)].xyz, u_xlat10.xyz);
        u_xlat47.x = u_xlat47.x * _AdditionalLightsAttenuation[int(u_xlatu23)].z + _AdditionalLightsAttenuation[int(u_xlatu23)].w;
        u_xlat47.x = clamp(u_xlat47.x, 0.0, 1.0);
        u_xlat47.x = u_xlat47.x * u_xlat47.x;
        u_xlat65 = u_xlat65 * u_xlat47.x;
        u_xlatu47 = u_xlatu23 >> (5u & uint(0x1F));
        u_xlati67 = 1 << (int(u_xlatu23) & int(0x1F));
        u_xlati47 = int(uint(u_xlati67) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu47)]));
        if(u_xlati47 != 0) {
            u_xlati47 = int(_AdditionalLightsLightTypes[int(u_xlatu23)]);
            u_xlati67 = (u_xlati47 != 0) ? 0 : 1;
            u_xlati69 = int(u_xlatu23) << (2 & int(0x1F));
            if(u_xlati67 != 0) {
                ...
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu23)].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu23)].zw;
            } else {
                u_xlatb47 = u_xlati47==1;
                u_xlati47 = u_xlatb47 ? 1 : int(0);
                if(u_xlati47 != 0) {
                    u_xlat47.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati69 + 1) / 4][(u_xlati69 + 1) % 4].xy;
                    u_xlat47.xy = _AdditionalLightsWorldToLights[u_xlati69 / 4][u_xlati69 % 4].xy * vs_TEXCOORD7.xx + u_xlat47.xy;
                    u_xlat47.xy = _AdditionalLightsWorldToLights[(u_xlati69 + 2) / 4][(u_xlati69 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat47.xy;
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu23)].xy * u_xlat47.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu23)].zw;
                } else {
        ...
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[int(u_xlatu23)].xyz;
        u_xlat11.xyz = vec3(u_xlat43) * u_xlat11.xyz;
        u_xlat23 = dot(u_xlat21.xyz, u_xlat10.xyz);
        u_xlat23 = clamp(u_xlat23, 0.0, 1.0);
        u_xlat23 = u_xlat23 * u_xlat65;
        ...
        u_xlat23 = dot(u_xlat21.xyz, u_xlat9.xyz);
        u_xlat23 = clamp(u_xlat23, 0.0, 1.0);
        u_xlat65 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
        u_xlat23 = u_xlat23 * u_xlat23;
        u_xlat23 = u_xlat23 * u_xlat8.x + 1.00001001;
        u_xlat65 = u_xlat65 * u_xlat65;
        u_xlat23 = u_xlat23 * u_xlat23;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat23) + u_xlat4.xyz;
        u_xlat28.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat28.xyz;
    }
    u_xlat0.xyz = u_xlat22.xyz * u_xlat3.xxx + u_xlat5.xyz;
    u_xlat0.xyz = u_xlat28.xyz + u_xlat0.xyz;
    u_xlat60 = u_xlat2 * (-u_xlat2);
