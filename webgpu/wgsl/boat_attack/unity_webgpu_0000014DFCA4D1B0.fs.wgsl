...
fn main_1() {
  ...
  u_xlat0 = sqrt(x_1575);
  let x_1577 : vec2<f32> = vs_TEXCOORD0;
  let x_1580 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1584 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1586 : vec2<f32> = ((x_1577 * vec2<f32>(x_1580.x, x_1580.y)) + vec2<f32>(x_1584.z, x_1584.w));
  let x_1587 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1586.x, x_1586.y, x_1587.z, x_1587.w);
  let x_1594 : vec4<f32> = u_xlat1;
  let x_1597 : f32 = x_14.x_GlobalMipBias.x;
  let x_1598 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1594.x, x_1594.y), x_1597);
  u_xlat18 = x_1598.w;
  let x_1600 : f32 = u_xlat18;
  u_xlat18 = ((x_1600 * 2.0f) + -1.0f);
  let x_1603 : f32 = u_xlat18;
  u_xlatb1 = (x_1603 >= 0.0f);
  let x_1605 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1605);
  let x_1608 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1608)) + 1.0f);
  let x_1612 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1612);
  let x_1614 : f32 = u_xlat18;
  u_xlat18 = (-(x_1614) + 1.0f);
  let x_1617 : f32 = u_xlat18;
  let x_1619 : f32 = u_xlat1.x;
  u_xlat18 = (x_1617 * x_1619);
  let x_1621 : vec3<f32> = u_xlat0;
  let x_1622 : vec3<f32> = (x_1621 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1623 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1622.x, x_1622.y, x_1622.z, x_1623.w);
  let x_1625 : vec3<f32> = u_xlat0;
  let x_1626 : vec3<f32> = log2(x_1625);
  let x_1627 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1626.x, x_1626.y, x_1626.z, x_1627.w);
  let x_1629 : vec4<f32> = u_xlat2;
  let x_1631 : vec3<f32> = (vec3<f32>(x_1629.x, x_1629.y, x_1629.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1632 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1631.x, x_1631.y, x_1631.z, x_1632.w);
  let x_1634 : vec4<f32> = u_xlat2;
  let x_1636 : vec3<f32> = exp2(vec3<f32>(x_1634.x, x_1634.y, x_1634.z));
  let x_1637 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1636.x, x_1636.y, x_1636.z, x_1637.w);
  let x_1639 : vec4<f32> = u_xlat2;
  let x_1642 : vec3<f32> = ((vec3<f32>(x_1639.x, x_1639.y, x_1639.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1643 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1642.x, x_1642.y, x_1642.z, x_1643.w);
  let x_1645 : vec3<f32> = u_xlat0;
  let x_1647 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1645.x, x_1645.y, x_1645.z, x_1645.x));
  ...
  u_xlat0.z = x_1683;
  let x_1685 : f32 = u_xlat18;
  let x_1690 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1685, x_1685, x_1685) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1690);
  let x_1692 : vec3<f32> = u_xlat0;
  let x_1693 : vec3<f32> = (x_1692 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1694 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1693.x, x_1693.y, x_1693.z, x_1694.w);
  let x_1696 : vec3<f32> = u_xlat0;
  let x_1697 : vec3<f32> = (x_1696 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1698 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1697.x, x_1697.y, x_1697.z, x_1698.w);
  let x_1700 : vec4<f32> = u_xlat2;
  let x_1702 : vec3<f32> = (vec3<f32>(x_1700.x, x_1700.y, x_1700.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1703 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1702.x, x_1702.y, x_1702.z, x_1703.w);
  let x_1705 : vec4<f32> = u_xlat2;
  let x_1708 : vec3<f32> = log2(abs(vec3<f32>(x_1705.x, x_1705.y, x_1705.z)));
  let x_1709 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1708.x, x_1708.y, x_1708.z, x_1709.w);
  let x_1711 : vec4<f32> = u_xlat2;
  let x_1713 : vec3<f32> = (vec3<f32>(x_1711.x, x_1711.y, x_1711.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1714 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1713.x, x_1713.y, x_1713.z, x_1714.w);
  let x_1716 : vec4<f32> = u_xlat2;
  let x_1718 : vec3<f32> = exp2(vec3<f32>(x_1716.x, x_1716.y, x_1716.z));
  let x_1719 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1718.x, x_1718.y, x_1718.z, x_1719.w);
  let x_1721 : vec3<f32> = u_xlat0;
  let x_1723 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1721.x, x_1721.y, x_1721.z, x_1721.x));
  ...
  let x_1764 : vec3<f32> = max(x_1763, vec3<f32>(0.0f, 0.0f, 0.0f));
