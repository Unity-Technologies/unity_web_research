...
fn main_1() {
  ...
  let x_1396 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1400 : vec4<f32> = x_25.x_Grain_TilingParams;
  ...
  let x_1414 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1410.x, x_1410.y), x_1413);
  u_xlat21 = x_1414.w;
  let x_1416 : f32 = u_xlat21;
  u_xlat21 = (x_1416 + -0.5f);
  let x_1418 : f32 = u_xlat21;
  let x_1419 : f32 = u_xlat21;
  u_xlat21 = (x_1418 + x_1419);
  let x_1421 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1421.x, x_1421.y, x_1421.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1430 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1430);
  let x_1435 : f32 = x_25.x_Grain_Params.y;
  let x_1437 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1435 * -(x_1437)) + 1.0f);
  let x_1443 : f32 = u_xlat21;
  let x_1445 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_1443, x_1443, x_1443) * vec3<f32>(x_1445.x, x_1445.y, x_1445.z));
  let x_1448 : vec3<f32> = u_xlat8;
  let x_1451 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_1448 * vec3<f32>(x_1451.x, x_1451.x, x_1451.x));
  let x_1454 : vec3<f32> = u_xlat8;
  let x_1455 : vec3<f32> = u_xlat1;
  let x_1458 : vec4<f32> = u_xlat0;
  let x_1460 : vec3<f32> = ((x_1454 * vec3<f32>(x_1455.x, x_1455.x, x_1455.x)) + vec3<f32>(x_1458.x, x_1458.y, x_1458.z));
  let x_1461 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1460.x, x_1460.y, x_1460.z, x_1461.w);
  let x_1463 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1463.x, x_1463.y, x_1463.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1466 : vec4<f32> = u_xlat0;
  let x_1469 : vec3<f32> = log2(abs(vec3<f32>(x_1466.x, x_1466.y, x_1466.z)));
