...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat3 = texture(sampler2D(unity_LightmapInd, samplerunity_Lightmap), vs_INTERP5.xy, _GlobalMipBias.x);
    ...
    u_xlat43 = u_xlat43 * u_xlat17.x + 1.00001001;
    ...
    u_xlat7.xyz = vec3(u_xlat43) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu43 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = vec3(u_xlat47) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat14.xyz = u_xlat16.xyz * u_xlat3.xxx + u_xlat20.xyz;
