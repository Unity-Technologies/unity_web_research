...
fn main_1() {
  ...
  let x_2216 : vec3<f32> = (vec3<f32>(x_2214.x, x_2214.y, x_2214.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2217 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2216.x, x_2216.y, x_2216.z, x_2217.w);
  let x_2219 : vec4<f32> = u_xlat0;
  let x_2222 : vec3<f32> = log2(abs(vec3<f32>(x_2219.x, x_2219.y, x_2219.z)));
  let x_2223 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2222.x, x_2222.y, x_2222.z, x_2223.w);
  let x_2225 : vec4<f32> = u_xlat2;
  let x_2227 : vec3<f32> = (vec3<f32>(x_2225.x, x_2225.y, x_2225.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2228 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2227.x, x_2227.y, x_2227.z, x_2228.w);
  let x_2230 : vec4<f32> = u_xlat2;
  let x_2232 : vec3<f32> = exp2(vec3<f32>(x_2230.x, x_2230.y, x_2230.z));
  let x_2233 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2232.x, x_2232.y, x_2232.z, x_2233.w);
  let x_2235 : vec4<f32> = u_xlat2;
  let x_2238 : vec3<f32> = ((vec3<f32>(x_2235.x, x_2235.y, x_2235.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2239 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2238.x, x_2238.y, x_2238.z, x_2239.w);
  let x_2241 : vec4<f32> = u_xlat0;
  let x_2243 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2241.x, x_2241.y, x_2241.z, x_2241.x));
  u_xlatb0 = vec3<bool>(x_2243.x, x_2243.y, x_2243.z);
  let x_2246 : bool = u_xlatb0.x;
  if (x_2246) {
  ...
  u_xlat0.x = x_2255;
  let x_2258 : bool = u_xlatb0.y;
  if (x_2258) {
    let x_2263 : f32 = u_xlat1.y;
    x_2259 = x_2263;
  } else {
    let x_2266 : f32 = u_xlat2.y;
    x_2259 = x_2266;
  }
  let x_2267 : f32 = x_2259;
  u_xlat0.y = x_2267;
  let x_2270 : bool = u_xlatb0.z;
  if (x_2270) {
    let x_2275 : f32 = u_xlat1.z;
    x_2271 = x_2275;
  } else {
  ...
  u_xlat0.z = x_2279;
  let x_2281 : vec2<f32> = vs_TEXCOORD0;
  let x_2284 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2288 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2290 : vec2<f32> = ((x_2281 * vec2<f32>(x_2284.x, x_2284.y)) + vec2<f32>(x_2288.z, x_2288.w));
  let x_2291 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2290.x, x_2290.y, x_2291.z, x_2291.w);
  let x_2298 : vec4<f32> = u_xlat1;
  let x_2301 : f32 = x_25.x_GlobalMipBias.x;
  let x_2302 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2298.x, x_2298.y), x_2301);
  u_xlat21 = x_2302.w;
  let x_2304 : f32 = u_xlat21;
  u_xlat21 = ((x_2304 * 2.0f) + -1.0f);
  let x_2307 : f32 = u_xlat21;
  u_xlatb1 = (x_2307 >= 0.0f);
  let x_2309 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2309);
  let x_2312 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2312)) + 1.0f);
  let x_2316 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2316);
  let x_2318 : f32 = u_xlat21;
  u_xlat21 = (-(x_2318) + 1.0f);
  let x_2321 : f32 = u_xlat21;
  let x_2323 : f32 = u_xlat1.x;
  u_xlat21 = (x_2321 * x_2323);
  let x_2325 : vec4<f32> = u_xlat0;
  let x_2327 : vec3<f32> = (vec3<f32>(x_2325.x, x_2325.y, x_2325.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2328 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2327.x, x_2327.y, x_2327.z, x_2328.w);
  let x_2330 : vec4<f32> = u_xlat0;
  let x_2333 : vec3<f32> = log2(abs(vec3<f32>(x_2330.x, x_2330.y, x_2330.z)));
  let x_2334 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2333.x, x_2333.y, x_2333.z, x_2334.w);
  let x_2336 : vec4<f32> = u_xlat2;
  let x_2338 : vec3<f32> = (vec3<f32>(x_2336.x, x_2336.y, x_2336.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2339 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2338.x, x_2338.y, x_2338.z, x_2339.w);
  let x_2341 : vec4<f32> = u_xlat2;
  let x_2343 : vec3<f32> = exp2(vec3<f32>(x_2341.x, x_2341.y, x_2341.z));
  let x_2344 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2343.x, x_2343.y, x_2343.z, x_2344.w);
  let x_2346 : vec4<f32> = u_xlat2;
  let x_2349 : vec3<f32> = ((vec3<f32>(x_2346.x, x_2346.y, x_2346.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2350 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2349.x, x_2349.y, x_2349.z, x_2350.w);
  let x_2352 : vec4<f32> = u_xlat0;
  let x_2354 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2352.x, x_2352.y, x_2352.z, x_2352.x));
  u_xlatb0 = vec3<bool>(x_2354.x, x_2354.y, x_2354.z);
  let x_2357 : bool = u_xlatb0.x;
  if (x_2357) {
    let x_2362 : f32 = u_xlat1.x;
    x_2358 = x_2362;
  } else {
  ...
  u_xlat0.x = x_2366;
  let x_2369 : bool = u_xlatb0.y;
  if (x_2369) {
    let x_2374 : f32 = u_xlat1.y;
    x_2370 = x_2374;
  } else {
  ...
  u_xlat0.y = x_2378;
  let x_2381 : bool = u_xlatb0.z;
  if (x_2381) {
    let x_2386 : f32 = u_xlat1.z;
    x_2382 = x_2386;
  } else {
  ...
  u_xlat0.z = x_2390;
  let x_2392 : f32 = u_xlat21;
  let x_2397 : vec4<f32> = u_xlat0;
  let x_2399 : vec3<f32> = ((vec3<f32>(x_2392, x_2392, x_2392) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2397.x, x_2397.y, x_2397.z));
  let x_2400 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2399.x, x_2399.y, x_2399.z, x_2400.w);
  let x_2402 : vec4<f32> = u_xlat0;
  let x_2404 : vec3<f32> = (vec3<f32>(x_2402.x, x_2402.y, x_2402.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2405 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2404.x, x_2404.y, x_2404.z, x_2405.w);
  let x_2407 : vec4<f32> = u_xlat0;
  let x_2409 : vec3<f32> = (vec3<f32>(x_2407.x, x_2407.y, x_2407.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2410 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2409.x, x_2409.y, x_2409.z, x_2410.w);
  let x_2412 : vec4<f32> = u_xlat2;
  let x_2414 : vec3<f32> = (vec3<f32>(x_2412.x, x_2412.y, x_2412.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2415 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2414.x, x_2414.y, x_2414.z, x_2415.w);
  let x_2417 : vec4<f32> = u_xlat2;
  let x_2420 : vec3<f32> = log2(abs(vec3<f32>(x_2417.x, x_2417.y, x_2417.z)));
  let x_2421 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2420.x, x_2420.y, x_2420.z, x_2421.w);
  let x_2423 : vec4<f32> = u_xlat2;
  let x_2425 : vec3<f32> = (vec3<f32>(x_2423.x, x_2423.y, x_2423.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2426 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2425.x, x_2425.y, x_2425.z, x_2426.w);
  let x_2428 : vec4<f32> = u_xlat2;
  let x_2430 : vec3<f32> = exp2(vec3<f32>(x_2428.x, x_2428.y, x_2428.z));
  let x_2431 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2430.x, x_2430.y, x_2430.z, x_2431.w);
  let x_2433 : vec4<f32> = u_xlat0;
  let x_2435 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2433.x, x_2433.y, x_2433.z, x_2433.x));
  u_xlatb0 = vec3<bool>(x_2435.x, x_2435.y, x_2435.z);
  let x_2438 : bool = u_xlatb0.x;
  if (x_2438) {
    let x_2443 : f32 = u_xlat1.x;
    x_2439 = x_2443;
  } else {
  ...
  u_xlat0.x = x_2447;
  let x_2450 : bool = u_xlatb0.y;
  if (x_2450) {
    let x_2455 : f32 = u_xlat1.y;
    x_2451 = x_2455;
  } else {
    let x_2458 : f32 = u_xlat2.y;
    x_2451 = x_2458;
  }
  let x_2459 : f32 = x_2451;
  u_xlat0.y = x_2459;
  let x_2462 : bool = u_xlatb0.z;
  if (x_2462) {
    let x_2467 : f32 = u_xlat1.z;
    x_2463 = x_2467;
  } else {
  ...
  let x_2477 : vec3<f32> = max(vec3<f32>(x_2475.x, x_2475.y, x_2475.z), vec3<f32>(0.0f, 0.0f, 0.0f));
