...
void main()
{
    ...
    u_xlat7.xyz = u_xlat15.xyz * (-u_xlat33.xxx) + (-u_xlat3.xyz);
    ...
    u_xlat1 = u_xlat19.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat19.x = dot(unity_LightIndices[int(u_xlatu19)], uintBitsToFloat(ImmCB_0[u_xlati48]));
