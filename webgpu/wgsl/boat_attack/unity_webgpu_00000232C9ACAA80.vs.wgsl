...
@group(1) @binding(0) var<uniform> x_62 : VGlobals;
...
fn main_1() {
  ...
  let x_748 : f32 = u_xlat3.y;
  vs_TEXCOORD0 = (x_748 * -50.0f);
  ...
  u_xlat0 = ((vec3<f32>(x_752, x_754, x_756) * x_758) + x_760);
  let x_764 : vec3<f32> = u_xlat0;
  let x_766 : f32 = x_62.x_Exposure;
  vs_TEXCOORD1 = (x_764 * vec3<f32>(x_766, x_766, x_766));
  let x_770 : vec4<f32> = x_62.x_MainLightPosition;
  let x_772 : vec3<f32> = u_xlat3;
  u_xlat0.x = dot(vec3<f32>(x_770.x, x_770.y, x_770.z), -(x_772));
  let x_777 : f32 = u_xlat0.x;
  let x_779 : f32 = u_xlat0.x;
  u_xlat0.x = (x_777 * x_779);
  let x_783 : f32 = u_xlat0.x;
  u_xlat0.x = ((x_783 * 0.75f) + 0.75f);
  let x_788 : vec3<f32> = u_xlat0;
  let x_790 : vec3<f32> = u_xlat4;
  u_xlat0 = (vec3<f32>(x_788.x, x_788.x, x_788.x) * x_790);
  let x_793 : vec3<f32> = u_xlat0;
  let x_795 : f32 = x_62.x_Exposure;
  vs_TEXCOORD2 = (x_793 * vec3<f32>(x_795, x_795, x_795));
  return;
}
