...
fn main_1() {
  ...
  let x_1262 : vec3<f32> = ((vec3<f32>(x_1256.x, x_1256.x, x_1256.x) * x_1258) + vec3<f32>(x_1260.x, x_1260.y, x_1260.z));
  let x_1263 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1262.x, x_1262.y, x_1262.z, x_1263.w);
  let x_1265 : vec2<f32> = vs_TEXCOORD0;
  let x_1268 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1272 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1274 : vec2<f32> = ((x_1265 * vec2<f32>(x_1268.x, x_1268.y)) + vec2<f32>(x_1272.z, x_1272.w));
  let x_1275 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1274.x, x_1274.y, x_1275.z);
  let x_1282 : vec3<f32> = u_xlat1;
  let x_1285 : f32 = x_25.x_GlobalMipBias.x;
  let x_1286 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1282.x, x_1282.y), x_1285);
  u_xlat21 = x_1286.w;
  let x_1288 : f32 = u_xlat21;
  u_xlat21 = (x_1288 + -0.5f);
  let x_1290 : f32 = u_xlat21;
  let x_1291 : f32 = u_xlat21;
  u_xlat21 = (x_1290 + x_1291);
  let x_1293 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1293.x, x_1293.y, x_1293.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1302 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1302);
  let x_1307 : f32 = x_25.x_Grain_Params.y;
  let x_1309 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1307 * -(x_1309)) + 1.0f);
  let x_1315 : f32 = u_xlat21;
  let x_1317 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_1315, x_1315, x_1315) * vec3<f32>(x_1317.x, x_1317.y, x_1317.z));
  let x_1320 : vec3<f32> = u_xlat8;
  let x_1323 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_1320 * vec3<f32>(x_1323.x, x_1323.x, x_1323.x));
