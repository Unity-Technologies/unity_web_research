...
layout(set = 1, binding = 4, std140) uniform UnityDrawCallInfo {
...
layout(set = 1, binding = 5, std140) uniform UnityInstancing_Terrain {
	TerrainArray_Type TerrainArray[UNITY_RUNTIME_INSTANCING_ARRAY_SIZE];
};
layout(set = 0, binding = 7) uniform mediump texture2D _TerrainHeightmapTexture;
layout(set = 0, binding = 8) uniform mediump texture2D _TerrainNormalmapTexture;
