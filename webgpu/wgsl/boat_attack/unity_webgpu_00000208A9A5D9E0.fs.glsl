...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat6.x = u_xlat6.x * _MainLightShadowParams.x + u_xlat17.x;
    ...
    u_xlat17.xyz = vec3(u_xlat27) * _MainLightColor.xyz;
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat35);
    ...
    u_xlat7.xyz = u_xlat8.xyz * vec3(u_xlat35);
    ...
    u_xlat35 = u_xlat6.x * unity_LightData.z;
    u_xlat36 = dot(u_xlat3.xyz, _MainLightPosition.xyz);
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    u_xlat35 = u_xlat35 * u_xlat36;
    u_xlat6.xyz = vec3(u_xlat35) * u_xlat17.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu35 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = vec3(u_xlat40) * u_xlat19.xyz;
        ...
        u_xlat39 = u_xlat39 * u_xlat42;
        u_xlat10.xyz = vec3(u_xlat27) * _AdditionalLightsColor[u_xlati37].xyz;
        u_xlat37 = dot(u_xlat3.xyz, u_xlat9.xyz);
        u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
        u_xlat37 = u_xlat37 * u_xlat39;
        u_xlat10.xyz = vec3(u_xlat37) * u_xlat10.xyz;
        u_xlat19.xyz = u_xlat19.xyz * vec3(u_xlat40) + u_xlat2.xyz;
        ...
        u_xlat19.xyz = u_xlat0.xyz * vec3(u_xlat37) + u_xlat12.xyz;
