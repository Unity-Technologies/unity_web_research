...
;
    ...
    u_xlat3.xzw = vec3(u_xlat28) * u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat50 = dot(_AdditionalLightsSpotDir[u_xlati48].xyz, u_xlat10.xyz);
        u_xlat50 = u_xlat50 * _AdditionalLightsAttenuation[u_xlati48].z + _AdditionalLightsAttenuation[u_xlati48].w;
        u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
        u_xlat50 = u_xlat50 * u_xlat50;
        u_xlat35 = u_xlat35 * u_xlat50;
        u_xlati50 = int(_AdditionalShadowParams[u_xlati48].w);
        u_xlatb51 = u_xlati50>=0;
        if(u_xlatb51){
            u_xlatb51 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati48].z);
            if(u_xlatb51){
                ...
                u_xlat52 = trunc(_AdditionalShadowParams[u_xlati48].w);
            ...
            u_xlat51 = 1.0 + (-_AdditionalShadowParams[u_xlati48].x);
            u_xlat50 = u_xlat50 * _AdditionalShadowParams[u_xlati48].x + u_xlat51;
        ...
        u_xlat50 = u_xlat17 * u_xlat51 + u_xlat50;
        u_xlati51 = 1 << (u_xlati48 & int(0x1F));
        ...
        if(u_xlati51 != 0) {
            ...
            u_xlati11 = u_xlati48 << (2 & int(0x1F));
            if(u_xlati52 != 0) {
                ...
                u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati48].xy * u_xlat25.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati48].zw;
            } else {
                ...
                if(u_xlati51 != 0) {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati48].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati48].zw;
                } else {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati48].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati48].zw;
                }
            }
        ...
        u_xlat48 = u_xlat44 / u_xlat48;
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat48) + u_xlat6.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat14) + u_xlat3.xzw;
