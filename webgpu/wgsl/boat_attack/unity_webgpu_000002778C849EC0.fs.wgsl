...
fn main_1() {
  ...
  u_xlat0 = vec3<f32>(x_142.x, x_142.y, x_142.z);
  let x_146 : vec3<f32> = u_xlat0;
  let x_151 : f32 = dot(x_146, vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  SV_Target0 = vec4<f32>(x_151, x_151, x_151, x_151);
  return;
}
