...
bool u_xlatb28;
    ...
    u_xlat1.x = _ZBufferParams.z * u_xlat1.x + _ZBufferParams.w;
    u_xlat2.z = float(1.0) / u_xlat1.x;
    u_xlat11.x = 0.0;
    u_xlat11.y = _SourceSize.w * 2.0;
    u_xlat11.xy = u_xlat11.xy + vs_TEXCOORD0.xy;
    u_xlat1.x = texture(sampler2D(_CameraDepthTexture, sampler_CameraDepthTexture), u_xlat11.xy, _GlobalMipBias.x).x;
    u_xlat1.x = _ZBufferParams.z * u_xlat1.x + _ZBufferParams.w;
    u_xlat11.z = float(1.0) / u_xlat1.x;
    u_xlat12.x = 0.0;
    ...
    u_xlatb1 = u_xlat2.z<u_xlat9.z;
    u_xlatb26 = u_xlat11.z<u_xlat12.z;
    u_xlat5.xyz = (bool(u_xlatb1)) ? u_xlat9.xyz : u_xlat12.xyz;
    u_xlat4.yzw = (bool(u_xlatb1)) ? u_xlat12.xyz : u_xlat2.xyz;
    u_xlat2.xyz = (bool(u_xlatb1)) ? u_xlat11.xyz : u_xlat2.xyz;
    u_xlat1.yzw = (bool(u_xlatb1)) ? u_xlat9.xyz : u_xlat11.xyz;
    u_xlat2.xy = (bool(u_xlatb26)) ? u_xlat5.xy : u_xlat2.xy;
    u_xlat4.x = u_xlat5.z;
    u_xlat1.x = u_xlat2.z;
    u_xlat1 = (bool(u_xlatb26)) ? u_xlat4 : u_xlat1;
    ...
    u_xlat10.x = (-u_xlat2.y) + 1.0;
    u_xlat2.xzw = _CameraViewXExtent[0].yzx * u_xlat2.xxx + _CameraViewTopLeftCorner[0].yzx;
    u_xlat2.xyz = _CameraViewYExtent[0].yzx * u_xlat10.xxx + u_xlat2.xzw;
    ...
    u_xlat3 = u_xlat2.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.0833333358, 0.0833333358, 0.166666672, 0.166666672);
    ...
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.106250003, 0.106250003, 0.106250003) + u_xlat8.xyz;
    ...
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.125, 0.125, 0.125) + u_xlat8.xyz;
    u_xlat18.xy = u_xlat3.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat18.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat3.xx + u_xlat18.xy;
    u_xlat18.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat3.zz + u_xlat18.xy;
...
;
    ...
    u_xlat3 = u_xlat2.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.25, 0.25, 0.333333343, 0.333333343);
...
;
    ...
    u_xlat3.xyz = u_xlat18.xxx * u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.200000003, 0.200000003, 0.200000003) + u_xlat8.xyz;
    u_xlat18.xy = u_xlat3.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat18.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat3.xx + u_xlat18.xy;
    u_xlat18.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat3.zz + u_xlat18.xy;
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat3.xyz);
...
;
    ...
    u_xlat18.x = u_xlat26 * u_xlat18.x;
    u_xlat25 = u_xlat18.x * u_xlat3.x + u_xlat25;
    u_xlat3 = u_xlat2.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.416666687, 0.416666687, 0.5, 0.5);
    u_xlat18.x = texture(sampler2D(_BlueNoiseTexture, sampler_PointRepeat), u_xlat3.xy, _GlobalMipBias.x).w;
    ...
    u_xlat5.xyz = u_xlat18.xxx * u_xlat5.xyz;
    u_xlat5.xyz = u_xlat5.xyz * _SSAOParams.yyy;
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.256250024, 0.256250024, 0.256250024) + u_xlat8.xyz;
    u_xlat18.xy = u_xlat5.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat18.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat5.xx + u_xlat18.xy;
    u_xlat18.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat5.zz + u_xlat18.xy;
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat5.xyz);
...
;
    ...
    u_xlat18.x = u_xlat26 * u_xlat18.x;
    u_xlat25 = u_xlat18.x * u_xlat3.x + u_xlat25;
    u_xlat3 = u_xlat2.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.583333373, 0.583333373, 0.666666687, 0.666666687);
    u_xlat18.x = texture(sampler2D(_BlueNoiseTexture, sampler_PointRepeat), u_xlat3.xy, _GlobalMipBias.x).w;
    ...
    u_xlat5.xyz = u_xlat18.xxx * u_xlat5.xyz;
    u_xlat5.xyz = u_xlat5.xyz * _SSAOParams.yyy;
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.40625003, 0.40625003, 0.40625003) + u_xlat8.xyz;
    u_xlat18.xy = u_xlat5.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat18.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat5.xx + u_xlat18.xy;
    u_xlat18.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat5.zz + u_xlat18.xy;
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat5.xyz);
...
;
    ...
    u_xlat18.x = u_xlat26 * u_xlat18.x;
    u_xlat25 = u_xlat18.x * u_xlat3.x + u_xlat25;
    u_xlat3 = u_xlat2.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.75, 0.75, 0.833333373, 0.833333373);
    u_xlat18.x = texture(sampler2D(_BlueNoiseTexture, sampler_PointRepeat), u_xlat3.xy, _GlobalMipBias.x).w;
    ...
    u_xlat5.xyz = u_xlat18.xxx * u_xlat5.xyz;
    u_xlat5.xyz = u_xlat5.xyz * _SSAOParams.yyy;
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.606249988, 0.606249988, 0.606249988) + u_xlat8.xyz;
    u_xlat18.xy = u_xlat5.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat18.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat5.xx + u_xlat18.xy;
    u_xlat18.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat5.zz + u_xlat18.xy;
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat5.xyz);
...
;
    ...
    u_xlat3.xyz = u_xlat18.xxx * u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.725000083, 0.725000083, 0.725000083) + u_xlat8.xyz;
    u_xlat18.xy = u_xlat3.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat18.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat3.xx + u_xlat18.xy;
    u_xlat18.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat3.zz + u_xlat18.xy;
    u_xlat3.x = dot(u_xlat4.xyz, u_xlat3.xyz);
...
;
    ...
    u_xlat18.x = u_xlat26 * u_xlat18.x;
    u_xlat25 = u_xlat18.x * u_xlat3.x + u_xlat25;
    u_xlat2.xy = u_xlat2.xy * _SSAOBlueNoiseParams.xy + vec2(0.916666687, 0.916666687);
    ...
    u_xlat2.xyz = u_xlat2.xyz * vec3(0.856249988, 0.856249988, 0.856249988) + u_xlat8.xyz;
