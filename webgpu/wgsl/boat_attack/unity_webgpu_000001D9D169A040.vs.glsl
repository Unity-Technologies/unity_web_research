...
void main()
{
    ...
    u_xlat2.x = in_COLOR0.x * 0.100000001;
    u_xlat22 = in_COLOR0.y * 4.5 + u_xlat22;
    u_xlat3.x = dot(u_xlat1.xyz, vec3(u_xlat22));
    u_xlat3.y = in_COLOR0.y;
    u_xlat3 = u_xlat3.xxyy * vec4(3.95000005, 1.38600004, 2.4749999, 1.27380002) + vec4(-1.0, -1.0, -1.0, -1.0);
    ...
    u_xlat9.xyz = u_xlat3.ywy + u_xlat3.xzx;
    u_xlat3.xz = u_xlat0.xy * u_xlat2.xx;
    u_xlat3.y = in_COLOR0.z * -0.349999994 + 0.349999994;
    u_xlat1.xyz = u_xlat9.xyz * u_xlat3.xyz + u_xlat1.xyz;
    ...
    if(u_xlatb0){
        ...
        if(u_xlatb0){
            ...
            u_xlat5.y = in_COLOR0.y;
            u_xlat5 = u_xlat5.xxyy * vec4(3.95000005, 1.38600004, 2.4749999, 1.27380002) + vec4(-1.0, -1.0, -1.0, -1.0);
