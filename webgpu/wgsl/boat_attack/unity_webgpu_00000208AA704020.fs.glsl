...
;
    ...
    u_xlat31 = u_xlat4.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat4.z = (-u_xlat31) + 1.0;
    u_xlat31 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat4.xz, _GlobalMipBias.x).x;
    ...
    u_xlat10.xyz = u_xlat3.xyz * u_xlat0.yzw + u_xlat2.xyz;
