...
fn main_1() {
  ...
  let x_1655 : vec3<f32> = u_xlat6;
  let x_1656 : vec4<f32> = u_xlat1;
  let x_1659 : vec3<f32> = u_xlat0;
  let x_1660 : vec3<f32> = ((x_1655 * vec3<f32>(x_1656.x, x_1656.x, x_1656.x)) + x_1659);
  let x_1661 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1660.x, x_1660.y, x_1660.z, x_1661.w);
  SV_Target0.w = 1.0f;
  return;
}
