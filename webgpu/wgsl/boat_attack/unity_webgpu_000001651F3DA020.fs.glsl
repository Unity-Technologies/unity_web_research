...
;
    ...
    if(u_xlatb0){
        ...
        if(u_xlatb67){
            ...
            if(u_xlatb68){
                ...
                u_xlat25 = u_xlat25 * u_xlat13.y;
                u_xlat3.x = u_xlat13.x * u_xlat3.x + u_xlat25;
                ...
                u_xlat3.x = u_xlat13.z * u_xlat25 + u_xlat3.x;
                ...
                u_xlat3.x = u_xlat13.w * u_xlat25 + u_xlat3.x;
                ...
                u_xlat3.x = u_xlat14.y * u_xlat25 + u_xlat3.x;
                ...
                u_xlat3.x = u_xlat14.z * u_xlat25 + u_xlat3.x;
                ...
                u_xlat3.x = u_xlat14.w * u_xlat25 + u_xlat3.x;
    ...
    u_xlat25 = u_xlat4.w + -0.400000006;
    ...
    u_xlat25 = u_xlat25 / u_xlat47.x;
    u_xlat25 = u_xlat25 + 0.5;
    u_xlat25 = clamp(u_xlat25, 0.0, 1.0);
    u_xlatb47 = _AlphaToMaskAvailable!=0.0;
    u_xlat67 = (u_xlatb47) ? u_xlat25 : u_xlat67;
    u_xlat25 = u_xlat67 + -9.99999975e-05;
    ...
    u_xlat25 = dot(u_xlat22.xyz, u_xlat22.xyz);
    u_xlat25 = inversesqrt(u_xlat25);
    u_xlat22.xyz = u_xlat22.xyz * vec3(u_xlat25);
    ...
    u_xlat4.xyz = (bool(u_xlatb25)) ? u_xlat4.xyz : u_xlat7.xyz;
    u_xlat25 = vs_INTERP0.y * unity_MatrixV[1].z;
    u_xlat25 = unity_MatrixV[0].z * vs_INTERP0.x + u_xlat25;
    u_xlat25 = unity_MatrixV[2].z * vs_INTERP0.z + u_xlat25;
    ...
    u_xlat0.x = u_xlat0.x * u_xlat68;
    u_xlat0.x = u_xlat29.x * u_xlat0.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat69 = u_xlat69 * u_xlat70;
        u_xlat69 = u_xlat29.x * u_xlat69;
        u_xlat69 = u_xlat71 / u_xlat69;
        u_xlat10.xyz = vec3(u_xlat69) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat5.xyz;
        u_xlat9.xyz = u_xlat10.xyz * u_xlat12.xyz + u_xlat9.xyz;
    }
    u_xlat0.xyz = u_xlat6.xyz * u_xlat7.xxx + u_xlat2.xyz;
    u_xlat0.xyz = u_xlat9.xyz + u_xlat0.xyz;
    u_xlat0.xyz = vs_INTERP4.www * u_xlat1.xyz + u_xlat0.xyz;
    u_xlat66 = u_xlat25 * (-u_xlat25);
