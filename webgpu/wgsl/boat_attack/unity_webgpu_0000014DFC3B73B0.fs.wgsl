...
fn main_1() {
  ...
  let x_1041 : vec3<f32> = sqrt(vec3<f32>(x_1039.x, x_1039.y, x_1039.z));
  let x_1042 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1041.x, x_1041.y, x_1041.z, x_1042.w);
  let x_1044 : vec2<f32> = vs_TEXCOORD0;
  let x_1047 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1051 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1053 : vec2<f32> = ((x_1044 * vec2<f32>(x_1047.x, x_1047.y)) + vec2<f32>(x_1051.z, x_1051.w));
  let x_1054 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1053.x, x_1053.y, x_1054.z, x_1054.w);
  let x_1061 : vec4<f32> = u_xlat1;
  let x_1064 : f32 = x_25.x_GlobalMipBias.x;
  let x_1065 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1061.x, x_1061.y), x_1064);
  u_xlat21 = x_1065.w;
  let x_1067 : f32 = u_xlat21;
  u_xlat21 = ((x_1067 * 2.0f) + -1.0f);
  let x_1071 : f32 = u_xlat21;
  u_xlatb1.x = (x_1071 >= 0.0f);
  let x_1075 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1075);
  let x_1078 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1078)) + 1.0f);
  let x_1082 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1082);
  let x_1084 : f32 = u_xlat21;
  u_xlat21 = (-(x_1084) + 1.0f);
  let x_1087 : f32 = u_xlat21;
  let x_1089 : f32 = u_xlat1.x;
  u_xlat21 = (x_1087 * x_1089);
  let x_1091 : vec4<f32> = u_xlat0;
  let x_1093 : vec3<f32> = (vec3<f32>(x_1091.x, x_1091.y, x_1091.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1094 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1093.x, x_1093.y, x_1093.z, x_1094.w);
  let x_1096 : vec4<f32> = u_xlat0;
  let x_1098 : vec3<f32> = log2(vec3<f32>(x_1096.x, x_1096.y, x_1096.z));
  let x_1099 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1098.x, x_1098.y, x_1098.z, x_1099.w);
  let x_1101 : vec4<f32> = u_xlat2;
  let x_1103 : vec3<f32> = (vec3<f32>(x_1101.x, x_1101.y, x_1101.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1114 : vec3<f32> = ((vec3<f32>(x_1111.x, x_1111.y, x_1111.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1115 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1114.x, x_1114.y, x_1114.z, x_1115.w);
  let x_1118 : vec4<f32> = u_xlat0;
  let x_1120 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1118.x, x_1118.y, x_1118.z, x_1118.x));
  u_xlatb0 = vec3<bool>(x_1120.x, x_1120.y, x_1120.z);
  let x_1123 : bool = u_xlatb0.x;
  if (x_1123) {
  ...
  u_xlat0.x = x_1132;
  let x_1135 : bool = u_xlatb0.y;
  if (x_1135) {
    let x_1140 : f32 = u_xlat1.y;
    x_1136 = x_1140;
  } else {
    let x_1143 : f32 = u_xlat2.y;
    x_1136 = x_1143;
  }
  let x_1144 : f32 = x_1136;
  u_xlat0.y = x_1144;
  let x_1147 : bool = u_xlatb0.z;
  if (x_1147) {
    let x_1152 : f32 = u_xlat1.z;
    x_1148 = x_1152;
  } else {
    let x_1155 : f32 = u_xlat2.z;
    x_1148 = x_1155;
  }
  ...
  let x_1165 : vec3<f32> = ((vec3<f32>(x_1158, x_1158, x_1158) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1163.x, x_1163.y, x_1163.z));
  let x_1166 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1165.x, x_1165.y, x_1165.z, x_1166.w);
  let x_1168 : vec4<f32> = u_xlat0;
  let x_1170 : vec3<f32> = (vec3<f32>(x_1168.x, x_1168.y, x_1168.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1171 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1170.x, x_1170.y, x_1170.z, x_1171.w);
  let x_1173 : vec4<f32> = u_xlat0;
  let x_1175 : vec3<f32> = (vec3<f32>(x_1173.x, x_1173.y, x_1173.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1176 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1175.x, x_1175.y, x_1175.z, x_1176.w);
  let x_1178 : vec4<f32> = u_xlat2;
  let x_1180 : vec3<f32> = (vec3<f32>(x_1178.x, x_1178.y, x_1178.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1181 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1180.x, x_1180.y, x_1180.z, x_1181.w);
  let x_1183 : vec4<f32> = u_xlat2;
  let x_1186 : vec3<f32> = log2(abs(vec3<f32>(x_1183.x, x_1183.y, x_1183.z)));
  let x_1187 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1186.x, x_1186.y, x_1186.z, x_1187.w);
  let x_1189 : vec4<f32> = u_xlat2;
  let x_1191 : vec3<f32> = (vec3<f32>(x_1189.x, x_1189.y, x_1189.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1192 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1191.x, x_1191.y, x_1191.z, x_1192.w);
  let x_1194 : vec4<f32> = u_xlat2;
  let x_1196 : vec3<f32> = exp2(vec3<f32>(x_1194.x, x_1194.y, x_1194.z));
  let x_1197 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1196.x, x_1196.y, x_1196.z, x_1197.w);
  let x_1199 : vec4<f32> = u_xlat0;
  let x_1201 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1199.x, x_1199.y, x_1199.z, x_1199.x));
  u_xlatb0 = vec3<bool>(x_1201.x, x_1201.y, x_1201.z);
  let x_1204 : bool = u_xlatb0.x;
  if (x_1204) {
  ...
  u_xlat0.x = x_1213;
  let x_1216 : bool = u_xlatb0.y;
  if (x_1216) {
    let x_1221 : f32 = u_xlat1.y;
    x_1217 = x_1221;
  } else {
    let x_1224 : f32 = u_xlat2.y;
    x_1217 = x_1224;
  }
  let x_1225 : f32 = x_1217;
  u_xlat0.y = x_1225;
  let x_1228 : bool = u_xlatb0.z;
  if (x_1228) {
  ...
  let x_1244 : vec3<f32> = max(vec3<f32>(x_1241.x, x_1241.y, x_1241.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1245 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1244.x, x_1244.y, x_1244.z, x_1245.w);
  SV_Target0.w = 1.0f;
  return;
}
