...
fn main_1() {
  ...
  let x_1596 : vec3<f32> = (x_1595 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1597 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1596.x, x_1596.y, x_1596.z, x_1597.w);
  let x_1599 : vec3<f32> = u_xlat0;
  let x_1601 : vec3<f32> = log2(abs(x_1599));
  let x_1602 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1601.x, x_1601.y, x_1601.z, x_1602.w);
  let x_1604 : vec4<f32> = u_xlat2;
  let x_1606 : vec3<f32> = (vec3<f32>(x_1604.x, x_1604.y, x_1604.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1607 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1606.x, x_1606.y, x_1606.z, x_1607.w);
  let x_1609 : vec4<f32> = u_xlat2;
  let x_1611 : vec3<f32> = exp2(vec3<f32>(x_1609.x, x_1609.y, x_1609.z));
  let x_1612 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1611.x, x_1611.y, x_1611.z, x_1612.w);
  let x_1614 : vec4<f32> = u_xlat2;
  let x_1617 : vec3<f32> = ((vec3<f32>(x_1614.x, x_1614.y, x_1614.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1618 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1617.x, x_1617.y, x_1617.z, x_1618.w);
  let x_1620 : vec3<f32> = u_xlat0;
  let x_1622 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1620.x, x_1620.y, x_1620.z, x_1620.x));
  u_xlatb0 = vec3<bool>(x_1622.x, x_1622.y, x_1622.z);
  let x_1625 : bool = u_xlatb0.x;
  if (x_1625) {
  ...
  u_xlat0.z = x_1658;
  let x_1660 : vec2<f32> = vs_TEXCOORD0;
  let x_1663 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1667 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1669 : vec2<f32> = ((x_1660 * vec2<f32>(x_1663.x, x_1663.y)) + vec2<f32>(x_1667.z, x_1667.w));
  let x_1670 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1669.x, x_1669.y, x_1670.z, x_1670.w);
  let x_1677 : vec4<f32> = u_xlat1;
  let x_1680 : f32 = x_26.x_GlobalMipBias.x;
  let x_1681 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1677.x, x_1677.y), x_1680);
  u_xlat15 = x_1681.w;
  let x_1683 : f32 = u_xlat15;
  u_xlat15 = ((x_1683 * 2.0f) + -1.0f);
  let x_1686 : f32 = u_xlat15;
  u_xlatb1 = (x_1686 >= 0.0f);
  let x_1688 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1688);
  let x_1691 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1691)) + 1.0f);
  let x_1695 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1695);
  let x_1697 : f32 = u_xlat15;
  u_xlat15 = (-(x_1697) + 1.0f);
  let x_1700 : f32 = u_xlat15;
  let x_1702 : f32 = u_xlat1.x;
  u_xlat15 = (x_1700 * x_1702);
  let x_1704 : vec3<f32> = u_xlat0;
  let x_1705 : vec3<f32> = (x_1704 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1706 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1705.x, x_1705.y, x_1705.z, x_1706.w);
  let x_1708 : vec3<f32> = u_xlat0;
  let x_1710 : vec3<f32> = log2(abs(x_1708));
  let x_1711 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1710.x, x_1710.y, x_1710.z, x_1711.w);
  let x_1713 : vec4<f32> = u_xlat2;
  let x_1715 : vec3<f32> = (vec3<f32>(x_1713.x, x_1713.y, x_1713.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1716 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1715.x, x_1715.y, x_1715.z, x_1716.w);
  let x_1718 : vec4<f32> = u_xlat2;
  let x_1720 : vec3<f32> = exp2(vec3<f32>(x_1718.x, x_1718.y, x_1718.z));
  let x_1721 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1720.x, x_1720.y, x_1720.z, x_1721.w);
  let x_1723 : vec4<f32> = u_xlat2;
  let x_1726 : vec3<f32> = ((vec3<f32>(x_1723.x, x_1723.y, x_1723.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1727 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1726.x, x_1726.y, x_1726.z, x_1727.w);
  let x_1729 : vec3<f32> = u_xlat0;
  let x_1731 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1729.x, x_1729.y, x_1729.z, x_1729.x));
  u_xlatb0 = vec3<bool>(x_1731.x, x_1731.y, x_1731.z);
  let x_1734 : bool = u_xlatb0.x;
  if (x_1734) {
  ...
  u_xlat0.x = x_1743;
  let x_1746 : bool = u_xlatb0.y;
  if (x_1746) {
    let x_1751 : f32 = u_xlat1.y;
    x_1747 = x_1751;
  } else {
    let x_1754 : f32 = u_xlat2.y;
    x_1747 = x_1754;
  }
  let x_1755 : f32 = x_1747;
  u_xlat0.y = x_1755;
  let x_1758 : bool = u_xlatb0.z;
  if (x_1758) {
    let x_1763 : f32 = u_xlat1.z;
    x_1759 = x_1763;
  } else {
  ...
  u_xlat0.z = x_1767;
  let x_1769 : f32 = u_xlat15;
  let x_1774 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1769, x_1769, x_1769) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1774);
  let x_1776 : vec3<f32> = u_xlat0;
  let x_1777 : vec3<f32> = (x_1776 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1778 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1777.x, x_1777.y, x_1777.z, x_1778.w);
  let x_1780 : vec3<f32> = u_xlat0;
  let x_1781 : vec3<f32> = (x_1780 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1782 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1781.x, x_1781.y, x_1781.z, x_1782.w);
  let x_1784 : vec4<f32> = u_xlat2;
  let x_1786 : vec3<f32> = (vec3<f32>(x_1784.x, x_1784.y, x_1784.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1787 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1786.x, x_1786.y, x_1786.z, x_1787.w);
  let x_1789 : vec4<f32> = u_xlat2;
  let x_1792 : vec3<f32> = log2(abs(vec3<f32>(x_1789.x, x_1789.y, x_1789.z)));
  let x_1793 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1792.x, x_1792.y, x_1792.z, x_1793.w);
  let x_1795 : vec4<f32> = u_xlat2;
  let x_1797 : vec3<f32> = (vec3<f32>(x_1795.x, x_1795.y, x_1795.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1798 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1797.x, x_1797.y, x_1797.z, x_1798.w);
  let x_1800 : vec4<f32> = u_xlat2;
  let x_1802 : vec3<f32> = exp2(vec3<f32>(x_1800.x, x_1800.y, x_1800.z));
  let x_1803 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1802.x, x_1802.y, x_1802.z, x_1803.w);
  let x_1805 : vec3<f32> = u_xlat0;
  let x_1807 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1805.x, x_1805.y, x_1805.z, x_1805.x));
  u_xlatb0 = vec3<bool>(x_1807.x, x_1807.y, x_1807.z);
  let x_1810 : bool = u_xlatb0.x;
  if (x_1810) {
    let x_1815 : f32 = u_xlat1.x;
    x_1811 = x_1815;
  } else {
    let x_1818 : f32 = u_xlat2.x;
    x_1811 = x_1818;
  }
  let x_1819 : f32 = x_1811;
  u_xlat0.x = x_1819;
  let x_1822 : bool = u_xlatb0.y;
  if (x_1822) {
    let x_1827 : f32 = u_xlat1.y;
    x_1823 = x_1827;
  } else {
    let x_1830 : f32 = u_xlat2.y;
    x_1823 = x_1830;
  }
  let x_1831 : f32 = x_1823;
  u_xlat0.y = x_1831;
  let x_1834 : bool = u_xlatb0.z;
  if (x_1834) {
    let x_1839 : f32 = u_xlat1.z;
    x_1835 = x_1839;
  } else {
    let x_1842 : f32 = u_xlat2.z;
    x_1835 = x_1842;
  }
  let x_1843 : f32 = x_1835;
  u_xlat0.z = x_1843;
  let x_1847 : vec3<f32> = u_xlat0;
  let x_1848 : vec3<f32> = max(x_1847, vec3<f32>(0.0f, 0.0f, 0.0f));
