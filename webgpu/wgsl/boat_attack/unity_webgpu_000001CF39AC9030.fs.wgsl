...
fn main_1() {
  ...
  u_xlat0.x = x_1797;
  let x_1800 : bool = u_xlatb0.y;
  if (x_1800) {
    let x_1805 : f32 = u_xlat1.y;
    x_1801 = x_1805;
  } else {
    let x_1808 : f32 = u_xlat2.y;
    x_1801 = x_1808;
  }
  let x_1809 : f32 = x_1801;
  u_xlat0.y = x_1809;
  let x_1812 : bool = u_xlatb0.z;
  if (x_1812) {
    let x_1817 : f32 = u_xlat1.z;
    x_1813 = x_1817;
  } else {
    let x_1820 : f32 = u_xlat2.z;
    x_1813 = x_1820;
  }
  let x_1821 : f32 = x_1813;
  u_xlat0.z = x_1821;
  let x_1823 : vec2<f32> = vs_TEXCOORD0;
  let x_1826 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1830 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1832 : vec2<f32> = ((x_1823 * vec2<f32>(x_1826.x, x_1826.y)) + vec2<f32>(x_1830.z, x_1830.w));
  let x_1833 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1832.x, x_1832.y, x_1833.z, x_1833.w);
  let x_1840 : vec4<f32> = u_xlat1;
  let x_1843 : f32 = x_38.x_GlobalMipBias.x;
  let x_1844 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1840.x, x_1840.y), x_1843);
  u_xlat18 = x_1844.w;
  let x_1846 : f32 = u_xlat18;
  u_xlat18 = ((x_1846 * 2.0f) + -1.0f);
  let x_1849 : f32 = u_xlat18;
  u_xlatb1 = (x_1849 >= 0.0f);
  let x_1851 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1851);
  let x_1854 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1854)) + 1.0f);
  let x_1858 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1858);
  let x_1860 : f32 = u_xlat18;
  u_xlat18 = (-(x_1860) + 1.0f);
  let x_1863 : f32 = u_xlat18;
  let x_1865 : f32 = u_xlat1.x;
  u_xlat18 = (x_1863 * x_1865);
  let x_1867 : vec4<f32> = u_xlat0;
  let x_1869 : vec3<f32> = (vec3<f32>(x_1867.x, x_1867.y, x_1867.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1870 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1869.x, x_1869.y, x_1869.z, x_1870.w);
  let x_1872 : vec4<f32> = u_xlat0;
  let x_1875 : vec3<f32> = log2(abs(vec3<f32>(x_1872.x, x_1872.y, x_1872.z)));
  let x_1876 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1875.x, x_1875.y, x_1875.z, x_1876.w);
  let x_1878 : vec4<f32> = u_xlat2;
  let x_1880 : vec3<f32> = (vec3<f32>(x_1878.x, x_1878.y, x_1878.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1881 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1880.x, x_1880.y, x_1880.z, x_1881.w);
  let x_1883 : vec4<f32> = u_xlat2;
  let x_1885 : vec3<f32> = exp2(vec3<f32>(x_1883.x, x_1883.y, x_1883.z));
  let x_1886 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1885.x, x_1885.y, x_1885.z, x_1886.w);
  let x_1888 : vec4<f32> = u_xlat2;
  let x_1891 : vec3<f32> = ((vec3<f32>(x_1888.x, x_1888.y, x_1888.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1892 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1891.x, x_1891.y, x_1891.z, x_1892.w);
  let x_1894 : vec4<f32> = u_xlat0;
  let x_1896 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1894.x, x_1894.y, x_1894.z, x_1894.x));
  u_xlatb0 = vec3<bool>(x_1896.x, x_1896.y, x_1896.z);
  let x_1899 : bool = u_xlatb0.x;
  if (x_1899) {
  ...
  u_xlat0.x = x_1908;
  let x_1911 : bool = u_xlatb0.y;
  if (x_1911) {
    let x_1916 : f32 = u_xlat1.y;
    x_1912 = x_1916;
  } else {
    let x_1919 : f32 = u_xlat2.y;
    x_1912 = x_1919;
  }
  let x_1920 : f32 = x_1912;
  u_xlat0.y = x_1920;
  let x_1923 : bool = u_xlatb0.z;
  if (x_1923) {
    let x_1928 : f32 = u_xlat1.z;
    x_1924 = x_1928;
  } else {
    let x_1931 : f32 = u_xlat2.z;
    x_1924 = x_1931;
  }
  let x_1932 : f32 = x_1924;
  u_xlat0.z = x_1932;
  let x_1934 : f32 = u_xlat18;
  let x_1939 : vec4<f32> = u_xlat0;
  let x_1941 : vec3<f32> = ((vec3<f32>(x_1934, x_1934, x_1934) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1939.x, x_1939.y, x_1939.z));
  let x_1942 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1941.x, x_1941.y, x_1941.z, x_1942.w);
  let x_1944 : vec4<f32> = u_xlat0;
  let x_1946 : vec3<f32> = (vec3<f32>(x_1944.x, x_1944.y, x_1944.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1947 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1946.x, x_1946.y, x_1946.z, x_1947.w);
  let x_1949 : vec4<f32> = u_xlat0;
  let x_1951 : vec3<f32> = (vec3<f32>(x_1949.x, x_1949.y, x_1949.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1952 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1951.x, x_1951.y, x_1951.z, x_1952.w);
  let x_1954 : vec4<f32> = u_xlat2;
  let x_1956 : vec3<f32> = (vec3<f32>(x_1954.x, x_1954.y, x_1954.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1957 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1956.x, x_1956.y, x_1956.z, x_1957.w);
  let x_1959 : vec4<f32> = u_xlat2;
  let x_1962 : vec3<f32> = log2(abs(vec3<f32>(x_1959.x, x_1959.y, x_1959.z)));
  let x_1963 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1962.x, x_1962.y, x_1962.z, x_1963.w);
  let x_1965 : vec4<f32> = u_xlat2;
  let x_1967 : vec3<f32> = (vec3<f32>(x_1965.x, x_1965.y, x_1965.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1968 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1967.x, x_1967.y, x_1967.z, x_1968.w);
  let x_1970 : vec4<f32> = u_xlat2;
  let x_1972 : vec3<f32> = exp2(vec3<f32>(x_1970.x, x_1970.y, x_1970.z));
  let x_1973 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1972.x, x_1972.y, x_1972.z, x_1973.w);
  let x_1975 : vec4<f32> = u_xlat0;
  let x_1977 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1975.x, x_1975.y, x_1975.z, x_1975.x));
  u_xlatb0 = vec3<bool>(x_1977.x, x_1977.y, x_1977.z);
  let x_1980 : bool = u_xlatb0.x;
  if (x_1980) {
  ...
  let x_1989 : f32 = x_1981;
  u_xlat0.x = x_1989;
  let x_1992 : bool = u_xlatb0.y;
  if (x_1992) {
    let x_1997 : f32 = u_xlat1.y;
    x_1993 = x_1997;
  } else {
    let x_2000 : f32 = u_xlat2.y;
    x_1993 = x_2000;
  }
  let x_2001 : f32 = x_1993;
  u_xlat0.y = x_2001;
  let x_2004 : bool = u_xlatb0.z;
  if (x_2004) {
    let x_2009 : f32 = u_xlat1.z;
    x_2005 = x_2009;
  } else {
    let x_2012 : f32 = u_xlat2.z;
    x_2005 = x_2012;
  }
  let x_2013 : f32 = x_2005;
  u_xlat0.z = x_2013;
  let x_2017 : vec4<f32> = u_xlat0;
  let x_2019 : vec3<f32> = max(vec3<f32>(x_2017.x, x_2017.y, x_2017.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2020 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2019.x, x_2019.y, x_2019.z, x_2020.w);
  SV_Target0.w = 1.0f;
  return;
}
