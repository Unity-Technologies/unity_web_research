...
fn main_1() {
  ...
  if (x_75) {
    ...
    u_xlat3 = ((-(vec4<f32>(x_107.x, x_107.y, x_107.x, x_107.y)) * vec4<f32>(0.5f, 0.5f, 0.16666667163372039795f, 0.16666667163372039795f)) + vec4<f32>(0.5f, 0.5f, 0.5f, 0.5f));
    ...
    let x_143 : vec2<f32> = ((x_137 * vec2<f32>(x_138.x, x_138.y)) + vec2<f32>(0.6666666865348815918f, 0.6666666865348815918f));
    ...
    u_xlat3 = ((vec4<f32>(x_146.x, x_146.y, x_146.x, x_146.y) * x_148) + vec4<f32>(0.16666667163372039795f, 0.16666667163372039795f, 0.16666667163372039795f, 0.16666667163372039795f));
    ...
    u_xlat0.x = (x_331 * 6.28318548202514648438f);
