...
float u_xlat41;
    ...
    u_xlat22 = texture(sampler2D(_CameraDepthTexture, sampler_ScreenTextures_linear_clamp), u_xlat0.xy, _GlobalMipBias.x).x;
    ...
    u_xlat3 = texture(sampler2D(_CameraDepthTexture, sampler_ScreenTextures_linear_clamp), u_xlat12.xy, _GlobalMipBias.x).x;
...
;
        ...
        u_xlat38 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec1, 0.0);
