...
fn main_1() {
  ...
  let x_479 : vec2<f32> = (x_476 * vec2<f32>(0.08163200318813323975f, 0.08163200318813323975f));
  ...
  u_xlat5.z = (x_509 * 0.08163200318813323975f);
  let x_514 : f32 = u_xlat19.y;
  u_xlat6.z = (x_514 * 0.08163200318813323975f);
  ...
  let x_528 : vec2<f32> = (vec2<f32>(x_524.y, x_524.w) * vec2<f32>(0.04081600159406661987f, 0.04081600159406661987f));
  let x_529 : vec4<f32> = u_xlat4;
  u_xlat4 = vec4<f32>(x_528.x, x_528.y, x_529.z, x_529.w);
  let x_531 : vec2<f32> = u_xlat19;
  let x_533 : vec2<f32> = (vec2<f32>(x_531.y, x_531.x) * vec2<f32>(0.08163200318813323975f, 0.08163200318813323975f));
  ...
  let x_546 : vec2<f32> = ((vec2<f32>(x_539.x, x_539.x) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.16326400637626647949f, 0.08163200318813323975f));
  let x_547 : vec4<f32> = u_xlat5;
  u_xlat5 = vec4<f32>(x_547.x, x_546.x, x_547.z, x_546.y);
  let x_549 : vec4<f32> = u_xlat0;
  let x_553 : vec2<f32> = ((vec2<f32>(x_549.x, x_549.x) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.08163200318813323975f, 0.16326400637626647949f));
  ...
  let x_583 : vec2<f32> = ((vec2<f32>(x_580.y, x_580.y) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.16326400637626647949f, 0.08163200318813323975f));
  let x_584 : vec4<f32> = u_xlat6;
  u_xlat6 = vec4<f32>(x_584.x, x_583.x, x_584.z, x_583.y);
  let x_586 : vec4<f32> = u_xlat0;
  let x_589 : vec2<f32> = ((vec2<f32>(x_586.y, x_586.y) * vec2<f32>(-0.08163200318813323975f, 0.08163200318813323975f)) + vec2<f32>(0.08163200318813323975f, 0.16326400637626647949f));
