...
fn main_1() {
  ...
  let x_1409 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1413 : vec4<f32> = x_27.x_Dithering_Params;
  ...
  let x_1427 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1423.x, x_1423.y), x_1426);
  u_xlat21 = x_1427.w;
  let x_1429 : f32 = u_xlat21;
  u_xlat21 = ((x_1429 * 2.0f) + -1.0f);
  let x_1432 : f32 = u_xlat21;
  u_xlatb1.x = (x_1432 >= 0.0f);
  let x_1436 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1436);
  let x_1439 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1439)) + 1.0f);
  let x_1443 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1443);
  let x_1445 : f32 = u_xlat21;
  u_xlat21 = (-(x_1445) + 1.0f);
  let x_1448 : f32 = u_xlat21;
  let x_1450 : f32 = u_xlat1.x;
  u_xlat21 = (x_1448 * x_1450);
  let x_1452 : vec3<f32> = u_xlat0;
  let x_1455 : vec3<f32> = (x_1452 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1456 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1455.x, x_1455.y, x_1455.z, x_1456.w);
  let x_1458 : vec3<f32> = u_xlat0;
  let x_1460 : vec3<f32> = log2(abs(x_1458));
  let x_1461 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1460.x, x_1460.y, x_1460.z, x_1461.w);
  let x_1463 : vec4<f32> = u_xlat2;
  let x_1467 : vec3<f32> = (vec3<f32>(x_1463.x, x_1463.y, x_1463.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1468 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1467.x, x_1467.y, x_1467.z, x_1468.w);
  let x_1470 : vec4<f32> = u_xlat2;
  let x_1472 : vec3<f32> = exp2(vec3<f32>(x_1470.x, x_1470.y, x_1470.z));
  let x_1473 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1472.x, x_1472.y, x_1472.z, x_1473.w);
  let x_1475 : vec4<f32> = u_xlat2;
  let x_1482 : vec3<f32> = ((vec3<f32>(x_1475.x, x_1475.y, x_1475.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  ...
  let x_1538 : vec3<f32> = (x_1535 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1539 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1538.x, x_1538.y, x_1538.z, x_1539.w);
  let x_1541 : vec3<f32> = u_xlat0;
  let x_1544 : vec3<f32> = (x_1541 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1545 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1544.x, x_1544.y, x_1544.z, x_1545.w);
  let x_1547 : vec4<f32> = u_xlat2;
  let x_1551 : vec3<f32> = (vec3<f32>(x_1547.x, x_1547.y, x_1547.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1552 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1551.x, x_1551.y, x_1551.z, x_1552.w);
  let x_1554 : vec4<f32> = u_xlat2;
  let x_1557 : vec3<f32> = log2(abs(vec3<f32>(x_1554.x, x_1554.y, x_1554.z)));
  let x_1558 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1557.x, x_1557.y, x_1557.z, x_1558.w);
  let x_1560 : vec4<f32> = u_xlat2;
  let x_1564 : vec3<f32> = (vec3<f32>(x_1560.x, x_1560.y, x_1560.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1576 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1574.x, x_1574.y, x_1574.z, x_1574.x));
  u_xlatb0 = vec3<bool>(x_1576.x, x_1576.y, x_1576.z);
  let x_1581 : bool = u_xlatb0.x;
  if (x_1581) {
