...
void main()
{
    ...
    u_xlat26.xyz = (bool(u_xlatb26)) ? u_xlat2.xyz : u_xlat3.xyz;
...
;
    ...
    u_xlat77 = dot(u_xlat4, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat77 = (-u_xlat77) + 4.0;
    u_xlatu77 = uint(u_xlat77);
    u_xlati77 = int(u_xlatu77) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati77 + 1) / 4][(u_xlati77 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati77 / 4][u_xlati77 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati77 + 2) / 4][(u_xlati77 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati77 + 3) / 4][(u_xlati77 + 3) % 4].xyz;
    ...
    if(u_xlatb6){
        ...
        if(u_xlatb6){
            ...
            if(u_xlatb31){
                u_xlat31.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat31.xy = floor(u_xlat31.xy);
                u_xlat7.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat31.xy);
                ...
                vec3 txVec19 = vec3(u_xlat63.xy,u_xlat3.z);
                ...
                vec3 txVec23 = vec3(u_xlat33.xy,u_xlat3.z);
                ...
                vec3 txVec27 = vec3(u_xlat60.xy,u_xlat3.z);
                ...
                vec3 txVec28 = vec3(u_xlat31.xy,u_xlat3.z);
    ...
    u_xlat3.x = (u_xlatb28) ? 1.0 : u_xlat3.x;
    u_xlat6.xyz = vs_TEXCOORD7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat28 = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat53 = u_xlat28 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat53 = clamp(u_xlat53, 0.0, 1.0);
    u_xlat6.x = (-u_xlat3.x) + 1.0;
    u_xlat3.x = u_xlat53 * u_xlat6.x + u_xlat3.x;
    u_xlat53 = dot((-u_xlat26.xyz), u_xlat2.xyz);
    u_xlat53 = u_xlat53 + u_xlat53;
    u_xlat6.xyz = u_xlat2.xyz * (-vec3(u_xlat53)) + (-u_xlat26.xyz);
    ...
    u_xlat32.xyz = vec3(u_xlat53) * u_xlat32.xyz + u_xlat0.xyz;
    ...
    u_xlat75 = u_xlat3.x * unity_LightData.z;
    u_xlat1 = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat75 = u_xlat75 * u_xlat1;
    u_xlat3.xzw = vec3(u_xlat75) * _MainLightColor.xyz;
    u_xlat6.xyz = u_xlat26.xyz + _MainLightPosition.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat8.xyz * u_xlat9.xxx + u_xlat26.xyz;
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat81) + u_xlat5.xyz;
