...
void main()
{
    ...
    u_xlat1.xzw = (u_xlatb1.x) ? u_xlat15.xyz : u_xlat5.xyz;
    ...
    u_xlat7.xyz = u_xlat4.xyz * (-vec3(u_xlat30)) + (-u_xlat1.xzw);
    u_xlat30 = dot(u_xlat4.xyz, u_xlat1.xzw);
    u_xlat30 = clamp(u_xlat30, 0.0, 1.0);
    u_xlat30 = (-u_xlat30) + 1.0;
    u_xlat30 = u_xlat30 * u_xlat30;
    u_xlat30 = u_xlat30 * u_xlat30;
    u_xlat42 = (-u_xlat27.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat27.xy = vec2(u_xlat39) * vec2(u_xlat39) + vec2(-1.0, 1.0);
    u_xlat39 = float(1.0) / u_xlat27.y;
    ...
    u_xlat38 = u_xlat38 * u_xlat27.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu38 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat9) + u_xlat1.xzw;
        ...
        u_xlat43 = u_xlat43 * u_xlat27.x + 1.00001001;
