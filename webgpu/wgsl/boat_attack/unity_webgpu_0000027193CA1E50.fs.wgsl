...
fn main_1() {
  ...
  let x_792 : vec3<f32> = u_xlat1;
  let x_795 : vec4<f32> = u_xlat0;
  let x_797 : vec3<f32> = ((x_791 * vec3<f32>(x_792.x, x_792.x, x_792.x)) + vec3<f32>(x_795.x, x_795.y, x_795.z));
  let x_798 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_797.x, x_797.y, x_797.z, x_798.w);
  SV_Target0.w = 1.0f;
  return;
}
