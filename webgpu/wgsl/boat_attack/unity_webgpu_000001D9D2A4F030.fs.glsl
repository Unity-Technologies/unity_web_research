...
;
    ...
    if(u_xlatb6.x){
        ...
        if(u_xlatb6.x){
            ...
            if(u_xlatb31){
                ...
                u_xlat56.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec4, 0.0);
                ...
                u_xlat56.x = u_xlat14.x * u_xlat56.x + u_xlat81;
                ...
                u_xlat56.x = u_xlat14.z * u_xlat81 + u_xlat56.x;
                ...
                u_xlat56.x = u_xlat14.w * u_xlat81 + u_xlat56.x;
                ...
                u_xlat56.x = u_xlat15.x * u_xlat81 + u_xlat56.x;
                ...
                u_xlat56.x = u_xlat15.y * u_xlat81 + u_xlat56.x;
                ...
                u_xlat56.x = u_xlat15.z * u_xlat81 + u_xlat56.x;
                ...
                u_xlat56.x = u_xlat15.w * u_xlat81 + u_xlat56.x;
                ...
                u_xlat6.x = u_xlat31.x * u_xlat81 + u_xlat56.x;
            } else {
                u_xlat31.xy = u_xlat25.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat31.xy = floor(u_xlat31.xy);
                u_xlat7.xy = u_xlat25.xy * _MainLightShadowmapSize.zw + (-u_xlat31.xy);
    ...
    if(u_xlatb75){
        ...
        u_xlat75 = (u_xlatb7.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb7.x) ? u_xlat6.xyz : vec3(u_xlat75);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat7.xyz = u_xlat4.xyz * (-vec3(u_xlat75)) + (-u_xlat5.xyz);
    ...
    u_xlat8.xy = vec2(u_xlat77) * vec2(u_xlat77) + vec2(-1.0, 1.0);
    u_xlat76 = float(1.0) / u_xlat8.y;
    u_xlat33.xyz = (-u_xlat2.xyz) + u_xlat0.xxx;
    u_xlat33.xyz = vec3(u_xlat75) * u_xlat33.xyz + u_xlat2.xyz;
    ...
    u_xlat76 = u_xlat76 * u_xlat8.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu76 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat56.x = dot(unity_LightIndices[int(u_xlatu56)], uintBitsToFloat(ImmCB_0[u_xlati81]));
        u_xlati56 = int(u_xlat56.x);
        u_xlat33.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati56].www + _AdditionalLightsPosition[u_xlati56].xyz;
        ...
        u_xlat81 = u_xlat81 * _AdditionalLightsAttenuation[u_xlati56].x;
        u_xlat81 = (-u_xlat81) * u_xlat81 + 1.0;
        u_xlat81 = max(u_xlat81, 0.0);
        u_xlat81 = u_xlat81 * u_xlat81;
        u_xlat81 = u_xlat81 * u_xlat84;
        u_xlat84 = dot(_AdditionalLightsSpotDir[u_xlati56].xyz, u_xlat9.xyz);
        u_xlat84 = u_xlat84 * _AdditionalLightsAttenuation[u_xlati56].z + _AdditionalLightsAttenuation[u_xlati56].w;
        u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
        u_xlat84 = u_xlat84 * u_xlat84;
        u_xlat81 = u_xlat81 * u_xlat84;
        u_xlati84 = int(_AdditionalShadowParams[u_xlati56].w);
        u_xlatb10.x = u_xlati84>=0;
        if(u_xlatb10.x){
            u_xlatb10.x = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati56].z);
            if(u_xlatb10.x){
                ...
                u_xlat35.x = trunc(_AdditionalShadowParams[u_xlati56].w);
                u_xlat10.x = u_xlat10.x + u_xlat35.x;
                u_xlati84 = int(u_xlat10.x);
            }
            u_xlati84 = u_xlati84 << (2 & int(0x1F));
            u_xlat10 = vs_INTERP7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati84 + 1) / 4][(u_xlati84 + 1) % 4];
            u_xlat10 = _AdditionalLightsWorldToShadow[u_xlati84 / 4][u_xlati84 % 4] * vs_INTERP7.xxxx + u_xlat10;
            u_xlat10 = _AdditionalLightsWorldToShadow[(u_xlati84 + 2) / 4][(u_xlati84 + 2) % 4] * vs_INTERP7.zzzz + u_xlat10;
            u_xlat10 = u_xlat10 + _AdditionalLightsWorldToShadow[(u_xlati84 + 3) / 4][(u_xlati84 + 3) % 4];
            u_xlat10.xyz = u_xlat10.xyz / u_xlat10.www;
            u_xlatb84 = 0.0<_AdditionalShadowParams[u_xlati56].y;
            if(u_xlatb84){
                u_xlatb84 = 1.0==_AdditionalShadowParams[u_xlati56].y;
                if(u_xlatb84){
                    ...
                    u_xlatb85 = 2.0==_AdditionalShadowParams[u_xlati56].y;
                    if(u_xlatb85){
            ...
            u_xlat10.x = 1.0 + (-_AdditionalShadowParams[u_xlati56].x);
            u_xlat84 = u_xlat84 * _AdditionalShadowParams[u_xlati56].x + u_xlat10.x;
        ...
        u_xlati10 = 1 << (u_xlati56 & int(0x1F));
        u_xlati10 = int(uint(u_xlati10) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati10 != 0) {
            u_xlati10 = int(_AdditionalLightsLightTypes[u_xlati56]);
            u_xlati35 = (u_xlati10 != 0) ? 0 : 1;
            u_xlati60 = u_xlati56 << (2 & int(0x1F));
            if(u_xlati35 != 0) {
                u_xlat11.xyz = vs_INTERP7.yyy * _AdditionalLightsWorldToLights[(u_xlati60 + 1) / 4][(u_xlati60 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati60 / 4][u_xlati60 % 4].xyw * vs_INTERP7.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati60 + 2) / 4][(u_xlati60 + 2) % 4].xyw * vs_INTERP7.zzz + u_xlat11.xyz;
                u_xlat11.xyz = u_xlat11.xyz + _AdditionalLightsWorldToLights[(u_xlati60 + 3) / 4][(u_xlati60 + 3) % 4].xyw;
                u_xlat35.xz = u_xlat11.xy / u_xlat11.zz;
                u_xlat35.xz = u_xlat35.xz * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat35.xz = clamp(u_xlat35.xz, 0.0, 1.0);
                u_xlat35.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati56].xy * u_xlat35.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati56].zw;
            } else {
                u_xlatb10.x = u_xlati10==1;
                u_xlati10 = u_xlatb10.x ? 1 : int(0);
                if(u_xlati10 != 0) {
                    u_xlat11.xy = vs_INTERP7.yy * _AdditionalLightsWorldToLights[(u_xlati60 + 1) / 4][(u_xlati60 + 1) % 4].xy;
                    u_xlat11.xy = _AdditionalLightsWorldToLights[u_xlati60 / 4][u_xlati60 % 4].xy * vs_INTERP7.xx + u_xlat11.xy;
                    u_xlat11.xy = _AdditionalLightsWorldToLights[(u_xlati60 + 2) / 4][(u_xlati60 + 2) % 4].xy * vs_INTERP7.zz + u_xlat11.xy;
                    u_xlat11.xy = u_xlat11.xy + _AdditionalLightsWorldToLights[(u_xlati60 + 3) / 4][(u_xlati60 + 3) % 4].xy;
                    u_xlat11.xy = u_xlat11.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat11.xy = fract(u_xlat11.xy);
                    u_xlat35.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati56].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati56].zw;
                } else {
                    u_xlat11 = vs_INTERP7.yyyy * _AdditionalLightsWorldToLights[(u_xlati60 + 1) / 4][(u_xlati60 + 1) % 4];
                    u_xlat11 = _AdditionalLightsWorldToLights[u_xlati60 / 4][u_xlati60 % 4] * vs_INTERP7.xxxx + u_xlat11;
                    u_xlat11 = _AdditionalLightsWorldToLights[(u_xlati60 + 2) / 4][(u_xlati60 + 2) % 4] * vs_INTERP7.zzzz + u_xlat11;
                    u_xlat11 = u_xlat11 + _AdditionalLightsWorldToLights[(u_xlati60 + 3) / 4][(u_xlati60 + 3) % 4];
                    ...
                    u_xlatb61.xy = greaterThanEqual(u_xlat12.yzyz, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    u_xlat61.x = (u_xlatb61.x) ? u_xlat12.x : (-u_xlat12.x);
                    u_xlat61.y = (u_xlatb61.y) ? u_xlat12.x : (-u_xlat12.x);
                    u_xlat10.xz = u_xlat11.xy * u_xlat10.xx + u_xlat61.xy;
                    u_xlat10.xz = u_xlat10.xz * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat10.xz = clamp(u_xlat10.xz, 0.0, 1.0);
                    u_xlat35.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati56].xy * u_xlat10.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati56].zw;
                }
            }
            u_xlat10 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat35.xz, 0.0);
            u_xlat85 = (u_xlatb6.y) ? u_xlat10.w : u_xlat10.x;
            u_xlat10.xyz = (u_xlatb6.x) ? u_xlat10.xyz : vec3(u_xlat85);
        } else {
            u_xlat10.x = float(1.0);
            u_xlat10.y = float(1.0);
            u_xlat10.z = float(1.0);
        }
        u_xlat10.xyz = u_xlat10.xyz * _AdditionalLightsColor[u_xlati56].xyz;
        u_xlat56.x = u_xlat81 * u_xlat84;
        u_xlat81 = dot(u_xlat4.xyz, u_xlat9.xyz);
        u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
        u_xlat56.x = u_xlat81 * u_xlat56.x;
        u_xlat10.xyz = u_xlat56.xxx * u_xlat10.xyz;
        u_xlat33.xyz = u_xlat33.xyz * vec3(u_xlat82) + u_xlat5.xyz;
        u_xlat56.x = dot(u_xlat33.xyz, u_xlat33.xyz);
        u_xlat56.x = max(u_xlat56.x, 1.17549435e-38);
        u_xlat56.x = inversesqrt(u_xlat56.x);
        u_xlat33.xyz = u_xlat56.xxx * u_xlat33.xyz;
        u_xlat56.x = dot(u_xlat4.xyz, u_xlat33.xyz);
        u_xlat56.x = clamp(u_xlat56.x, 0.0, 1.0);
        u_xlat56.y = dot(u_xlat9.xyz, u_xlat33.xyz);
        u_xlat56.y = clamp(u_xlat56.y, 0.0, 1.0);
        u_xlat56.xy = u_xlat56.xy * u_xlat56.xy;
        u_xlat56.x = u_xlat56.x * u_xlat8.x + 1.00001001;
        u_xlat56.x = u_xlat56.x * u_xlat56.x;
        u_xlat81 = max(u_xlat56.y, 0.100000001);
        u_xlat56.x = u_xlat81 * u_xlat56.x;
        u_xlat56.x = u_xlat79 * u_xlat56.x;
        u_xlat56.x = u_xlat78 / u_xlat56.x;
        u_xlat33.xyz = u_xlat2.xyz * u_xlat56.xxx + u_xlat3.xyz;
