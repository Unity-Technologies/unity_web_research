...
fn main_1() {
  ...
  let x_428 : vec4<f32> = in_TEXCOORD1;
  let x_432 : vec4<f32> = x_16.unity_LightmapST;
  let x_436 : vec4<f32> = x_16.unity_LightmapST;
  vs_INTERP0 = ((vec2<f32>(x_428.x, x_428.y) * vec2<f32>(x_432.x, x_432.y)) + vec2<f32>(x_436.z, x_436.w));
  ...
  u_xlat12 = dot(vec3<f32>(x_470.x, x_470.y, x_470.z), vec3<f32>(x_472.x, x_472.y, x_472.z));
  let x_475 : f32 = u_xlat12;
  u_xlat12 = max(x_475, 1.17549435e-38f);
  let x_477 : f32 = u_xlat12;
  u_xlat12 = inverseSqrt(x_477);
  ...
  let x_485 : vec4<f32> = vs_INTERP4;
  vs_INTERP4 = vec4<f32>(x_484.x, x_484.y, x_484.z, x_485.w);
