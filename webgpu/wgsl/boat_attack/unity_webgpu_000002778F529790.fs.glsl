...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat42 = texture(sampler2D(_DitheringTexture, sampler_PointRepeat), u_xlat2.xy, _GlobalMipBias.x).w;
    ...
    u_xlat20 = (-u_xlat33) + 1.0;
    u_xlat33 = u_xlat6.x * u_xlat20 + u_xlat33;
    ...
    u_xlat7.xyz = u_xlat3.xyz * (-vec3(u_xlat48)) + (-u_xlat2.xyz);
    ...
    u_xlat44 = u_xlat33 * unity_LightData.z;
    ...
    u_xlat45 = u_xlat47 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
    u_xlatb33.xy = equal(vec4(vec4(_AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat)), vec4(0.0, 1.0, 0.0, 1.0)).xy;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu44 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat52 = dot(_AdditionalLightsSpotDir[u_xlati48].xyz, u_xlat10.xyz);
        u_xlat52 = u_xlat52 * _AdditionalLightsAttenuation[u_xlati48].z + _AdditionalLightsAttenuation[u_xlati48].w;
        ...
        if(u_xlatb11.x){
            ...
            if(u_xlatb11.x){
                ...
                u_xlat25.x = trunc(_AdditionalShadowParams[u_xlati48].w);
            ...
            u_xlat11.x = 1.0 + (-_AdditionalShadowParams[u_xlati48].x);
            u_xlat52 = u_xlat52 * _AdditionalShadowParams[u_xlati48].x + u_xlat11.x;
        ...
        u_xlati11 = 1 << (u_xlati48 & int(0x1F));
        u_xlati11 = int(uint(u_xlati11) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati11 != 0) {
            u_xlati11 = int(_AdditionalLightsLightTypes[u_xlati48]);
            u_xlati25 = (u_xlati11 != 0) ? 0 : 1;
            u_xlati39 = u_xlati48 << (2 & int(0x1F));
            if(u_xlati25 != 0) {
                ...
                u_xlat25.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati48].xy * u_xlat25.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati48].zw;
            } else {
                ...
                if(u_xlati11 != 0) {
                    ...
                    u_xlat25.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati48].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati48].zw;
                } else {
                    ...
                    u_xlat25.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati48].xy * u_xlat11.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati48].zw;
                }
            }
            u_xlat11 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat25.xz, 0.0);
            u_xlat53 = (u_xlatb33.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb33.x) ? u_xlat11.xyz : vec3(u_xlat53);
        } else {
