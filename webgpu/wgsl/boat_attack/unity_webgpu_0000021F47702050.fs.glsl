...
;
    ...
    u_xlat4.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati33 + 1) / 4][(u_xlati33 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati33 / 4][u_xlati33 % 4].xyz * vs_INTERP0.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati33 + 2) / 4][(u_xlati33 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat4.xyz;
    ...
    u_xlatb35 = u_xlatb35 || u_xlatb4.x;
    ...
    u_xlat12.x = u_xlat1.w + -0.400000006;
    u_xlat23 = dFdxCoarse(u_xlat1.w);
    u_xlat34 = dFdyCoarse(u_xlat1.w);
    u_xlat23 = abs(u_xlat34) + abs(u_xlat23);
    u_xlat23 = max(u_xlat23, 9.99999975e-05);
    u_xlat12.x = u_xlat12.x / u_xlat23;
    u_xlat12.x = u_xlat12.x + 0.5;
    u_xlat12.x = clamp(u_xlat12.x, 0.0, 1.0);
    u_xlatb23 = _AlphaToMaskAvailable!=0.0;
    u_xlat1.x = (u_xlatb23) ? u_xlat12.x : u_xlat1.x;
    u_xlat12.x = u_xlat1.x + -9.99999975e-05;
    ...
    u_xlat4.xyz = u_xlat14.xxx * vs_INTERP2.xyz + u_xlat4.xyz;
    u_xlat14.xyz = u_xlat14.zzz * vs_INTERP1.xyz + u_xlat4.xyz;
    u_xlat12.x = dot(u_xlat14.xyz, u_xlat14.xyz);
    ...
    u_xlat5.x = (u_xlatb12.x) ? u_xlat4.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb12.x) ? u_xlat4.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb12.x) ? u_xlat4.z : unity_MatrixV[2].z;
    ...
    u_xlat6.xy = u_xlat12.xz * hlslcc_FragCoord.xy;
    u_xlat12.x = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    ...
    u_xlat38 = min(u_xlat38, vs_INTERP4.w);
    ...
    u_xlat40 = dot(u_xlat14.xyz, u_xlat5.xyz);
    u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
    u_xlat40 = (-u_xlat40) + 1.0;
    u_xlat40 = u_xlat40 * u_xlat40;
    u_xlat40 = u_xlat40 * u_xlat40;
    u_xlat8.x = (-u_xlat12.x) * 0.699999988 + 1.70000005;
    u_xlat12.x = u_xlat12.x * u_xlat8.x;
    u_xlat12.x = u_xlat12.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat12.x);
    ...
    u_xlat7.xyz = u_xlat8.xyz * u_xlat12.xxx;
    u_xlat12.xz = vec2(u_xlat34) * vec2(u_xlat34) + vec2(-1.0, 1.0);
    u_xlat34 = float(1.0) / u_xlat12.z;
    ...
    u_xlat34 = dot(u_xlat14.xyz, _MainLightPosition.xyz);
    ...
    u_xlat33 = dot(u_xlat14.xyz, u_xlat7.xyz);
    u_xlat33 = clamp(u_xlat33, 0.0, 1.0);
    u_xlat34 = dot(_MainLightPosition.xyz, u_xlat7.xyz);
    u_xlat34 = clamp(u_xlat34, 0.0, 1.0);
    u_xlat33 = u_xlat33 * u_xlat33;
    u_xlat33 = u_xlat33 * u_xlat12.x + 1.00001001;
    ...
    u_xlat7.xyz = vec3(u_xlat33) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati3].www + _AdditionalLightsPosition[u_xlati3].xyz;
        ...
        u_xlat42 = dot(_AdditionalLightsSpotDir[u_xlati3].xyz, u_xlat9.xyz);
        u_xlat42 = u_xlat42 * _AdditionalLightsAttenuation[u_xlati3].z + _AdditionalLightsAttenuation[u_xlati3].w;
        u_xlat42 = clamp(u_xlat42, 0.0, 1.0);
        u_xlat42 = u_xlat42 * u_xlat42;
        u_xlat40 = u_xlat40 * u_xlat42;
        u_xlat10.xyz = u_xlat6.xxx * _AdditionalLightsColor[u_xlati3].xyz;
        u_xlat3.x = dot(u_xlat14.xyz, u_xlat9.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        ...
        u_xlat3.x = dot(u_xlat14.xyz, u_xlat8.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        u_xlat40 = dot(u_xlat9.xyz, u_xlat8.xyz);
        u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat3.x = u_xlat3.x * u_xlat12.x + 1.00001001;
        u_xlat40 = u_xlat40 * u_xlat40;
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        ...
        u_xlat8.xyz = u_xlat3.xxx * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat2.xyz = u_xlat4.xyz * vec3(u_xlat38) + u_xlat17.xyz;
    u_xlat2.xyz = u_xlat7.xyz + u_xlat2.xyz;
    SV_Target0.xyz = vs_INTERP4.www * u_xlat0.xyz + u_xlat2.xyz;
    SV_Target0.w = (u_xlatb23) ? u_xlat1.x : 1.0;
    return;
}
