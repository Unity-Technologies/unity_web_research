...
fn main_1() {
  ...
  let x_2136 : vec3<f32> = sqrt(vec3<f32>(x_2134.x, x_2134.y, x_2134.z));
  let x_2137 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2136.x, x_2136.y, x_2136.z, x_2137.w);
  let x_2139 : vec2<f32> = vs_TEXCOORD0;
  let x_2142 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2146 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2148 : vec2<f32> = ((x_2139 * vec2<f32>(x_2142.x, x_2142.y)) + vec2<f32>(x_2146.z, x_2146.w));
  let x_2149 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2148.x, x_2148.y, x_2149.z, x_2149.w);
  let x_2156 : vec4<f32> = u_xlat1;
  let x_2159 : f32 = x_25.x_GlobalMipBias.x;
  let x_2160 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2156.x, x_2156.y), x_2159);
  u_xlat21 = x_2160.w;
  let x_2162 : f32 = u_xlat21;
  u_xlat21 = ((x_2162 * 2.0f) + -1.0f);
  let x_2165 : f32 = u_xlat21;
  u_xlatb1 = (x_2165 >= 0.0f);
  let x_2167 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2167);
  let x_2170 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2170)) + 1.0f);
  let x_2174 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2174);
  let x_2176 : f32 = u_xlat21;
  u_xlat21 = (-(x_2176) + 1.0f);
  let x_2179 : f32 = u_xlat21;
  let x_2181 : f32 = u_xlat1.x;
  u_xlat21 = (x_2179 * x_2181);
  let x_2183 : vec4<f32> = u_xlat0;
  let x_2185 : vec3<f32> = (vec3<f32>(x_2183.x, x_2183.y, x_2183.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2186 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2185.x, x_2185.y, x_2185.z, x_2186.w);
  let x_2188 : vec4<f32> = u_xlat0;
  let x_2190 : vec3<f32> = log2(vec3<f32>(x_2188.x, x_2188.y, x_2188.z));
  let x_2191 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2190.x, x_2190.y, x_2190.z, x_2191.w);
  let x_2193 : vec4<f32> = u_xlat2;
  let x_2195 : vec3<f32> = (vec3<f32>(x_2193.x, x_2193.y, x_2193.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2196 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2195.x, x_2195.y, x_2195.z, x_2196.w);
  let x_2198 : vec4<f32> = u_xlat2;
  let x_2200 : vec3<f32> = exp2(vec3<f32>(x_2198.x, x_2198.y, x_2198.z));
  let x_2201 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2200.x, x_2200.y, x_2200.z, x_2201.w);
  let x_2203 : vec4<f32> = u_xlat2;
  let x_2206 : vec3<f32> = ((vec3<f32>(x_2203.x, x_2203.y, x_2203.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2207 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2206.x, x_2206.y, x_2206.z, x_2207.w);
  let x_2209 : vec4<f32> = u_xlat0;
  let x_2211 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2209.x, x_2209.y, x_2209.z, x_2209.x));
  u_xlatb0 = vec3<bool>(x_2211.x, x_2211.y, x_2211.z);
  let x_2214 : bool = u_xlatb0.x;
  if (x_2214) {
    let x_2219 : f32 = u_xlat1.x;
    x_2215 = x_2219;
  } else {
    let x_2222 : f32 = u_xlat2.x;
    x_2215 = x_2222;
  }
  let x_2223 : f32 = x_2215;
  u_xlat0.x = x_2223;
  let x_2226 : bool = u_xlatb0.y;
  if (x_2226) {
    let x_2231 : f32 = u_xlat1.y;
    x_2227 = x_2231;
  } else {
    let x_2234 : f32 = u_xlat2.y;
    x_2227 = x_2234;
  }
  let x_2235 : f32 = x_2227;
  u_xlat0.y = x_2235;
  let x_2238 : bool = u_xlatb0.z;
  if (x_2238) {
    let x_2243 : f32 = u_xlat1.z;
    x_2239 = x_2243;
  } else {
  ...
  u_xlat0.z = x_2247;
  let x_2249 : f32 = u_xlat21;
  let x_2254 : vec4<f32> = u_xlat0;
  let x_2256 : vec3<f32> = ((vec3<f32>(x_2249, x_2249, x_2249) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2254.x, x_2254.y, x_2254.z));
  let x_2257 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2256.x, x_2256.y, x_2256.z, x_2257.w);
  let x_2259 : vec4<f32> = u_xlat0;
  let x_2261 : vec3<f32> = (vec3<f32>(x_2259.x, x_2259.y, x_2259.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2262 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2261.x, x_2261.y, x_2261.z, x_2262.w);
  let x_2264 : vec4<f32> = u_xlat0;
  let x_2266 : vec3<f32> = (vec3<f32>(x_2264.x, x_2264.y, x_2264.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2267 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2266.x, x_2266.y, x_2266.z, x_2267.w);
  let x_2269 : vec4<f32> = u_xlat2;
  let x_2271 : vec3<f32> = (vec3<f32>(x_2269.x, x_2269.y, x_2269.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2272 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2271.x, x_2271.y, x_2271.z, x_2272.w);
  let x_2274 : vec4<f32> = u_xlat2;
  let x_2277 : vec3<f32> = log2(abs(vec3<f32>(x_2274.x, x_2274.y, x_2274.z)));
  let x_2278 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2277.x, x_2277.y, x_2277.z, x_2278.w);
  let x_2280 : vec4<f32> = u_xlat2;
  let x_2282 : vec3<f32> = (vec3<f32>(x_2280.x, x_2280.y, x_2280.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2283 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2282.x, x_2282.y, x_2282.z, x_2283.w);
  let x_2285 : vec4<f32> = u_xlat2;
  let x_2287 : vec3<f32> = exp2(vec3<f32>(x_2285.x, x_2285.y, x_2285.z));
  let x_2288 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2287.x, x_2287.y, x_2287.z, x_2288.w);
  let x_2290 : vec4<f32> = u_xlat0;
  let x_2292 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2290.x, x_2290.y, x_2290.z, x_2290.x));
  u_xlatb0 = vec3<bool>(x_2292.x, x_2292.y, x_2292.z);
  let x_2295 : bool = u_xlatb0.x;
  if (x_2295) {
  ...
  let x_2304 : f32 = x_2296;
  u_xlat0.x = x_2304;
  let x_2307 : bool = u_xlatb0.y;
  if (x_2307) {
    let x_2312 : f32 = u_xlat1.y;
    x_2308 = x_2312;
  } else {
    let x_2315 : f32 = u_xlat2.y;
    x_2308 = x_2315;
  }
  let x_2316 : f32 = x_2308;
  u_xlat0.y = x_2316;
  let x_2319 : bool = u_xlatb0.z;
  if (x_2319) {
    let x_2324 : f32 = u_xlat1.z;
    x_2320 = x_2324;
  } else {
    let x_2327 : f32 = u_xlat2.z;
    x_2320 = x_2327;
  }
  let x_2328 : f32 = x_2320;
  u_xlat0.z = x_2328;
  let x_2332 : vec4<f32> = u_xlat0;
  let x_2334 : vec3<f32> = max(vec3<f32>(x_2332.x, x_2332.y, x_2332.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2335 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2334.x, x_2334.y, x_2334.z, x_2335.w);
  SV_Target0.w = 1.0f;
  return;
}
