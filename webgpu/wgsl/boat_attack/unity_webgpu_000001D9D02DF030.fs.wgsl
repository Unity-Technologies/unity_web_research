...
fn main_1() {
  ...
  let x_114 : vec2<f32> = (vec2<f32>(x_110.x, x_110.y) * vec2<f32>(0.00389105058275163174f, 0.00389105058275163174f));
  ...
  let x_169 : vec2<f32> = (vec2<f32>(x_167.x, x_167.y) * vec2<f32>(0.00389105058275163174f, 0.00389105058275163174f));
  ...
  u_xlat0.x = (x_188 * 0.00389105058275163174f);
  ...
  u_xlat0.y = (x_207 * 0.00389105058275163174f);
  ...
  u_xlat3.x = (x_276 * 0.00389105058275163174f);
  ...
  u_xlat3.y = (x_294 * 0.00389105058275163174f);
  ...
  u_xlat3.x = (x_339 * 0.00389105058275163174f);
  ...
  u_xlat3.y = (x_355 * 0.00389105058275163174f);
  ...
  u_xlat3.x = (x_399 * 0.00389105058275163174f);
  ...
  u_xlat3.y = (x_415 * 0.00389105058275163174f);
  ...
  u_xlat1 = max(x_456, vec4<f32>(0.00000010000000116861f, 0.00000010000000116861f, 0.00000010000000116861f, 0.00000010000000116861f));
  ...
  let x_488 : u32 = u_xlatu0.x;
  u_xlatu0.y = (x_488 & 255u);
  let x_495 : u32 = u_xlatu0.x;
  param = x_495;
  param_1 = 8i;
  param_2 = 8i;
  let x_498 : u32 = uint_bitfieldExtract_u1_i1_i1_(&(param), &(param_1), &(param_2));
  u_xlatu0.x = x_498;
  let x_500 : vec2<u32> = u_xlatu0;
  let x_502 : vec2<f32> = vec2<f32>(vec2<u32>(x_500.y, x_500.x));
  let x_503 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_502.x, x_502.y, x_503.z, x_503.w);
  let x_507 : vec4<f32> = u_xlat1;
  let x_511 : vec2<f32> = (vec2<f32>(x_507.x, x_507.y) * vec2<f32>(0.0039215688593685627f, 0.0039215688593685627f));
  let x_512 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_511.x, x_511.y, x_512.z, x_512.w);
  let x_514 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_514.x, x_514.y, vec2<f32>(0.0f, 0.0f).x, vec2<f32>(0.0f, 0.0f).y);
  return;
}
