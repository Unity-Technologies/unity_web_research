...
;
    ...
    u_xlat6.xyz = vec3(u_xlat80) * u_xlat5.xyz;
    ...
    if(u_xlatb83){
        ...
        if(u_xlatb83){
            ...
            u_xlat83 = dot(u_xlat8, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb84){
                ...
                u_xlat33 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec5, 0.0);
                u_xlat33 = u_xlat33 * u_xlat14.y;
                u_xlat7.x = u_xlat14.x * u_xlat7.x + u_xlat33;
                vec3 txVec6 = vec3(u_xlat59.xy,u_xlat3.z);
                u_xlat33 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat7.x = u_xlat14.z * u_xlat33 + u_xlat7.x;
                vec3 txVec7 = vec3(u_xlat10.xy,u_xlat3.z);
                u_xlat33 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat7.x = u_xlat14.w * u_xlat33 + u_xlat7.x;
                vec3 txVec8 = vec3(u_xlat12.xy,u_xlat3.z);
                u_xlat33 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat7.x = u_xlat15.x * u_xlat33 + u_xlat7.x;
                vec3 txVec9 = vec3(u_xlat12.zw,u_xlat3.z);
                u_xlat33 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat7.x = u_xlat15.y * u_xlat33 + u_xlat7.x;
                vec3 txVec10 = vec3(u_xlat10.zw,u_xlat3.z);
                u_xlat33 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat7.x = u_xlat15.z * u_xlat33 + u_xlat7.x;
                vec3 txVec11 = vec3(u_xlat9.xy,u_xlat3.z);
                u_xlat33 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat7.x = u_xlat15.w * u_xlat33 + u_xlat7.x;
                vec3 txVec12 = vec3(u_xlat9.zw,u_xlat3.z);
                u_xlat33 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                u_xlat83 = u_xlat84 * u_xlat33 + u_xlat7.x;
            } else {
                u_xlat7.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat7.xy = floor(u_xlat7.xy);
                u_xlat59.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
                ...
                u_xlat84 = u_xlat18.x * u_xlat84 + u_xlat9.x;
                ...
                u_xlat84 = u_xlat18.z * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat18.w * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat19.x * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat19.y * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat19.z * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat19.w * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat20.x * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat20.y * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat20.z * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat20.w * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat8.x * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat8.y * u_xlat59.x + u_xlat84;
                ...
                u_xlat84 = u_xlat8.z * u_xlat59.x + u_xlat84;
                ...
                u_xlat83 = u_xlat8.w * u_xlat7.x + u_xlat84;
            }
        }
    } else {
    ...
    u_xlat3.x = u_xlat83 * _MainLightShadowParams.x + u_xlat3.x;
    ...
    u_xlat83 = (-u_xlat3.x) + 1.0;
    u_xlat3.x = u_xlat55 * u_xlat83 + u_xlat3.x;
    ...
    u_xlat8.xyz = u_xlat2.xyz * (-vec3(u_xlat55)) + (-u_xlat1.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat55 = dot(unity_LightIndices[int(u_xlatu55)], uintBitsToFloat(ImmCB_0[u_xlati83]));
        ...
        u_xlat83 = u_xlat83 * _AdditionalLightsAttenuation[u_xlati55].x;
        u_xlat83 = (-u_xlat83) * u_xlat83 + 1.0;
        u_xlat83 = max(u_xlat83, 0.0);
        u_xlat83 = u_xlat83 * u_xlat83;
        u_xlat83 = u_xlat83 * u_xlat85;
        u_xlat85 = dot(_AdditionalLightsSpotDir[u_xlati55].xyz, u_xlat10.xyz);
        u_xlat85 = u_xlat85 * _AdditionalLightsAttenuation[u_xlati55].z + _AdditionalLightsAttenuation[u_xlati55].w;
        u_xlat85 = clamp(u_xlat85, 0.0, 1.0);
        u_xlat85 = u_xlat85 * u_xlat85;
        u_xlat83 = u_xlat83 * u_xlat85;
        u_xlati85 = int(_AdditionalShadowParams[u_xlati55].w);
        u_xlatb86 = u_xlati85>=0;
        if(u_xlatb86){
            u_xlatb86 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati55].z);
            if(u_xlatb86){
                ...
                u_xlat88 = trunc(_AdditionalShadowParams[u_xlati55].w);
            ...
            u_xlatb85 = 0.0<_AdditionalShadowParams[u_xlati55].y;
            if(u_xlatb85){
                u_xlatb85 = 1.0==_AdditionalShadowParams[u_xlati55].y;
                if(u_xlatb85){
                    ...
                    u_xlatb86 = 2.0==_AdditionalShadowParams[u_xlati55].y;
                    if(u_xlatb86){
            ...
            u_xlat86 = 1.0 + (-_AdditionalShadowParams[u_xlati55].x);
            u_xlat85 = u_xlat85 * _AdditionalShadowParams[u_xlati55].x + u_xlat86;
        ...
        u_xlati86 = 1 << (u_xlati55 & int(0x1F));
        u_xlati86 = int(uint(u_xlati86) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati86 != 0) {
            u_xlati86 = int(_AdditionalLightsLightTypes[u_xlati55]);
            u_xlati88 = (u_xlati86 != 0) ? 0 : 1;
            u_xlati11 = u_xlati55 << (2 & int(0x1F));
            if(u_xlati88 != 0) {
                ...
                u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati55].xy * u_xlat37.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati55].zw;
            } else {
                ...
                if(u_xlati86 != 0) {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati55].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati55].zw;
                } else {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati55].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati55].zw;
                }
            }
