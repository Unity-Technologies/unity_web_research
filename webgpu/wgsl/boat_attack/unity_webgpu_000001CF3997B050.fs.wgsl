...
fn main_1() {
  ...
  let x_936 : vec3<f32> = sqrt(vec3<f32>(x_934.x, x_934.y, x_934.z));
  let x_937 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_936.x, x_936.y, x_936.z, x_937.w);
  let x_939 : vec2<f32> = vs_TEXCOORD0;
  let x_942 : vec4<f32> = x_38.x_Dithering_Params;
  let x_946 : vec4<f32> = x_38.x_Dithering_Params;
  let x_948 : vec2<f32> = ((x_939 * vec2<f32>(x_942.x, x_942.y)) + vec2<f32>(x_946.z, x_946.w));
  let x_949 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_948.x, x_948.y, x_949.z, x_949.w);
  let x_956 : vec4<f32> = u_xlat1;
  let x_959 : f32 = x_38.x_GlobalMipBias.x;
  let x_960 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_956.x, x_956.y), x_959);
  u_xlat18 = x_960.w;
  let x_962 : f32 = u_xlat18;
  u_xlat18 = ((x_962 * 2.0f) + -1.0f);
  let x_965 : f32 = u_xlat18;
  u_xlatb1.x = (x_965 >= 0.0f);
  let x_969 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_969);
  let x_972 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_972)) + 1.0f);
  let x_976 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_976);
  let x_978 : f32 = u_xlat18;
  u_xlat18 = (-(x_978) + 1.0f);
  let x_981 : f32 = u_xlat18;
  let x_983 : f32 = u_xlat1.x;
  u_xlat18 = (x_981 * x_983);
  let x_985 : vec4<f32> = u_xlat0;
  let x_987 : vec3<f32> = (vec3<f32>(x_985.x, x_985.y, x_985.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_988 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_987.x, x_987.y, x_987.z, x_988.w);
  let x_990 : vec4<f32> = u_xlat0;
  let x_992 : vec3<f32> = log2(vec3<f32>(x_990.x, x_990.y, x_990.z));
  ...
  let x_1014 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1012.x, x_1012.y, x_1012.z, x_1012.x));
  ...
  let x_1059 : vec3<f32> = ((vec3<f32>(x_1052, x_1052, x_1052) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1057.x, x_1057.y, x_1057.z));
  let x_1060 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1059.x, x_1059.y, x_1059.z, x_1060.w);
  let x_1062 : vec4<f32> = u_xlat0;
  let x_1064 : vec3<f32> = (vec3<f32>(x_1062.x, x_1062.y, x_1062.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1065 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1064.x, x_1064.y, x_1064.z, x_1065.w);
  let x_1067 : vec4<f32> = u_xlat0;
  let x_1069 : vec3<f32> = (vec3<f32>(x_1067.x, x_1067.y, x_1067.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1070 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1069.x, x_1069.y, x_1069.z, x_1070.w);
  let x_1072 : vec4<f32> = u_xlat2;
  let x_1074 : vec3<f32> = (vec3<f32>(x_1072.x, x_1072.y, x_1072.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1075 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1074.x, x_1074.y, x_1074.z, x_1075.w);
  let x_1077 : vec4<f32> = u_xlat2;
  let x_1080 : vec3<f32> = log2(abs(vec3<f32>(x_1077.x, x_1077.y, x_1077.z)));
  let x_1081 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1080.x, x_1080.y, x_1080.z, x_1081.w);
  let x_1083 : vec4<f32> = u_xlat2;
  let x_1085 : vec3<f32> = (vec3<f32>(x_1083.x, x_1083.y, x_1083.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1086 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1085.x, x_1085.y, x_1085.z, x_1086.w);
  let x_1088 : vec4<f32> = u_xlat2;
  let x_1090 : vec3<f32> = exp2(vec3<f32>(x_1088.x, x_1088.y, x_1088.z));
  let x_1091 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1090.x, x_1090.y, x_1090.z, x_1091.w);
  let x_1093 : vec4<f32> = u_xlat0;
  let x_1095 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1093.x, x_1093.y, x_1093.z, x_1093.x));
  u_xlatb0 = vec3<bool>(x_1095.x, x_1095.y, x_1095.z);
  let x_1098 : bool = u_xlatb0.x;
  if (x_1098) {
  ...
  let x_1138 : vec3<f32> = max(vec3<f32>(x_1135.x, x_1135.y, x_1135.z), vec3<f32>(0.0f, 0.0f, 0.0f));
