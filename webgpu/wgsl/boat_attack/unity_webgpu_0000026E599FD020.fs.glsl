...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat14.xyz = vec3(u_xlat33) * u_xlat14.xyz;
    ...
    u_xlat33 = dot(u_xlat14.xyz, u_xlat4.xyz);
    ...
    u_xlat6.x = dot((-u_xlat5.xyz), u_xlat14.xyz);
    u_xlat6.x = u_xlat6.x + u_xlat6.x;
    u_xlat6.xyz = u_xlat14.xyz * (-u_xlat6.xxx) + (-u_xlat5.xyz);
    u_xlat39 = dot(u_xlat14.xyz, u_xlat5.xyz);
    ...
    u_xlat1.x = dot(u_xlat14.xyz, _MainLightPosition.xyz);
    ...
    u_xlat33 = inversesqrt(u_xlat33);
    u_xlat18.xyz = vec3(u_xlat33) * u_xlat18.xyz;
    u_xlat33 = dot(u_xlat14.xyz, u_xlat18.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat38 = u_xlat38 * u_xlat41;
        u_xlat41 = dot(u_xlat14.xyz, u_xlat9.xyz);
        u_xlat41 = clamp(u_xlat41, 0.0, 1.0);
        u_xlat38 = u_xlat38 * u_xlat41;
