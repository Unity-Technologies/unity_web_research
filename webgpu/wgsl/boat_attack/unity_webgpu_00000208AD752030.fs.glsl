...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat1.xyz = u_xlat1.xxx * vs_INTERP2.xyz + u_xlat15.xyz;
    u_xlat1.xyz = vec3(u_xlat42) * vs_INTERP1.xyz + u_xlat1.xyz;
...
;
    ...
    u_xlat3.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati42 + 1) / 4][(u_xlati42 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati42 / 4][u_xlati42 % 4].xyz * vs_INTERP0.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati42 + 2) / 4][(u_xlati42 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat3.xyz;
    ...
    u_xlat7.xyz = vec3(u_xlat42) * u_xlat0.xyz;
    ...
    u_xlat30 = min(u_xlat2.z, u_xlat45);
    ...
    if(u_xlatb17.x){
        ...
        u_xlat17.xyz = (u_xlatb17.x) ? u_xlat6.xyz : vec3(u_xlat31);
    } else {
    ...
    u_xlat6.xyz = u_xlat1.xyz * (-vec3(u_xlat47)) + (-u_xlat4.xyz);
    ...
    u_xlat6 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat42);
    ...
    u_xlat3.xyz = vec3(u_xlat42) * u_xlat17.xyz;
    ...
    u_xlat6.xyz = u_xlat0.xyz * vec3(u_xlat42) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat2.x = dot(unity_LightIndices[int(u_xlatu2)], uintBitsToFloat(ImmCB_0[u_xlati45]));
        ...
        u_xlat34.x = float(1.0) / float(u_xlat45);
        u_xlat45 = u_xlat45 * _AdditionalLightsAttenuation[int(u_xlatu2)].x;
        u_xlat45 = (-u_xlat45) * u_xlat45 + 1.0;
        u_xlat45 = max(u_xlat45, 0.0);
        u_xlat45 = u_xlat45 * u_xlat45;
        u_xlat45 = u_xlat45 * u_xlat34.x;
        u_xlat34.x = dot(_AdditionalLightsSpotDir[int(u_xlatu2)].xyz, u_xlat10.xyz);
        u_xlat34.x = u_xlat34.x * _AdditionalLightsAttenuation[int(u_xlatu2)].z + _AdditionalLightsAttenuation[int(u_xlatu2)].w;
        u_xlat34.x = clamp(u_xlat34.x, 0.0, 1.0);
        u_xlat34.x = u_xlat34.x * u_xlat34.x;
        u_xlat45 = u_xlat45 * u_xlat34.x;
        u_xlatu34 = u_xlatu2 >> (5u & uint(0x1F));
        u_xlati48 = 1 << (int(u_xlatu2) & int(0x1F));
        u_xlati34 = int(uint(u_xlati48) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu34)]));
        if(u_xlati34 != 0) {
            u_xlati34 = int(_AdditionalLightsLightTypes[int(u_xlatu2)]);
            u_xlati48 = (u_xlati34 != 0) ? 0 : 1;
            u_xlati49 = int(u_xlatu2) << (2 & int(0x1F));
            if(u_xlati48 != 0) {
                u_xlat11.xyz = vs_INTERP0.yyy * _AdditionalLightsWorldToLights[(u_xlati49 + 1) / 4][(u_xlati49 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati49 / 4][u_xlati49 % 4].xyw * vs_INTERP0.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati49 + 2) / 4][(u_xlati49 + 2) % 4].xyw * vs_INTERP0.zzz + u_xlat11.xyz;
                ...
                if(u_xlati34 != 0) {
                    u_xlat34.xy = vs_INTERP0.yy * _AdditionalLightsWorldToLights[(u_xlati49 + 1) / 4][(u_xlati49 + 1) % 4].xy;
                    u_xlat34.xy = _AdditionalLightsWorldToLights[u_xlati49 / 4][u_xlati49 % 4].xy * vs_INTERP0.xx + u_xlat34.xy;
                    u_xlat34.xy = _AdditionalLightsWorldToLights[(u_xlati49 + 2) / 4][(u_xlati49 + 2) % 4].xy * vs_INTERP0.zz + u_xlat34.xy;
                    u_xlat34.xy = u_xlat34.xy + _AdditionalLightsWorldToLights[(u_xlati49 + 3) / 4][(u_xlati49 + 3) % 4].xy;
                    u_xlat34.xy = u_xlat34.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat34.xy = fract(u_xlat34.xy);
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu2)].xy * u_xlat34.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu2)].zw;
                } else {
                    u_xlat12 = vs_INTERP0.yyyy * _AdditionalLightsWorldToLights[(u_xlati49 + 1) / 4][(u_xlati49 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati49 / 4][u_xlati49 % 4] * vs_INTERP0.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati49 + 2) / 4][(u_xlati49 + 2) % 4] * vs_INTERP0.zzzz + u_xlat12;
                    u_xlat12 = u_xlat12 + _AdditionalLightsWorldToLights[(u_xlati49 + 3) / 4][(u_xlati49 + 3) % 4];
                    u_xlat12.xyz = u_xlat12.xyz / u_xlat12.www;
                    u_xlat34.x = dot(u_xlat12.xyz, u_xlat12.xyz);
                    u_xlat34.x = inversesqrt(u_xlat34.x);
                    u_xlat12.xyz = u_xlat34.xxx * u_xlat12.xyz;
                    u_xlat34.x = dot(abs(u_xlat12.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat34.x = max(u_xlat34.x, 9.99999997e-07);
                    u_xlat34.x = float(1.0) / float(u_xlat34.x);
                    u_xlat13.xyz = u_xlat34.xxx * u_xlat12.zxy;
                    ...
                    u_xlat34.xy = u_xlat12.xy * u_xlat34.xx + u_xlat39.xy;
                    u_xlat34.xy = u_xlat34.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat34.x = (u_xlatb6.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb6.x) ? u_xlat11.xyz : u_xlat34.xxx;
        } else {
    ...
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat30) + u_xlat3.xyz;
