...
;
    ...
    u_xlat12.xyz = vs_INTERP7.xyz + (-_CascadeShadowSplitSpheres0.xyz);
...
;
    ...
    u_xlat12.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati11 + 1) / 4][(u_xlati11 + 1) % 4].xyz;
    u_xlat12.xyz = _MainLightWorldToShadow[u_xlati11 / 4][u_xlati11 % 4].xyz * vs_INTERP7.xxx + u_xlat12.xyz;
    u_xlat12.xyz = _MainLightWorldToShadow[(u_xlati11 + 2) / 4][(u_xlati11 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat12.xyz;
    ...
    u_xlat12.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec0, 0.0);
    ...
    u_xlat12.x = u_xlat34 * u_xlat36 + u_xlat12.x;
    u_xlat34 = dot((-u_xlat4.xyz), u_xlat3.xyz);
    u_xlat34 = u_xlat34 + u_xlat34;
    u_xlat7.xyz = u_xlat3.xyz * (-vec3(u_xlat34)) + (-u_xlat4.xyz);
    u_xlat34 = dot(u_xlat3.xyz, u_xlat4.xyz);
    u_xlat34 = clamp(u_xlat34, 0.0, 1.0);
    u_xlat34 = (-u_xlat34) + 1.0;
    u_xlat34 = u_xlat34 * u_xlat34;
    u_xlat34 = u_xlat34 * u_xlat34;
    u_xlat36 = (-u_xlat0.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat8.xyz = vec3(u_xlat34) * u_xlat8.xyz + u_xlat2.xyz;
    ...
    u_xlat8.xyz = u_xlat2.xyz * u_xlat11.xxx + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat11.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu11 =  uint(int(u_xlat11.x));
    u_xlat22 = u_xlat23 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat22 = clamp(u_xlat22, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu11 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat12.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat12.xyz;
    }
