...
fn main_1() {
  ...
  let x_1851 : bool = u_xlatb0.x;
  if (x_1851) {
    let x_1856 : f32 = u_xlat1.x;
    x_1852 = x_1856;
  } else {
    let x_1859 : f32 = u_xlat2.x;
    x_1852 = x_1859;
  }
  let x_1860 : f32 = x_1852;
  SV_Target0.x = x_1860;
  let x_1864 : bool = u_xlatb0.y;
  if (x_1864) {
    let x_1869 : f32 = u_xlat1.y;
    x_1865 = x_1869;
  } else {
    let x_1872 : f32 = u_xlat2.y;
    x_1865 = x_1872;
  }
  let x_1873 : f32 = x_1865;
  SV_Target0.y = x_1873;
  let x_1876 : bool = u_xlatb0.z;
  if (x_1876) {
    let x_1881 : f32 = u_xlat1.z;
    x_1877 = x_1881;
  } else {
    let x_1884 : f32 = u_xlat2.z;
    x_1877 = x_1884;
  }
