...
void main()
{
    ...
    u_xlat5.x = (u_xlatb27.x) ? u_xlat30.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb27.x) ? u_xlat30.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb27.x) ? u_xlat30.z : unity_MatrixV[2].z;
    ...
    u_xlat27.x = dot(u_xlat29.xyz, u_xlat6.xyz);
    u_xlat27.x = u_xlat27.x + 0.5;
    u_xlat30.xyz = u_xlat27.xxx * u_xlat30.xyz;
    u_xlat27.x = max(u_xlat6.w, 9.99999975e-05);
    u_xlat30.xyz = u_xlat30.xyz / u_xlat27.xxx;
    u_xlat3.x = u_xlat3.x;
    ...
    u_xlatb4 = u_xlatb4 || u_xlatb32.x;
    u_xlat78 = (u_xlatb4) ? 1.0 : u_xlat78;
    u_xlat32.xyz = vs_INTERP8.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat4.x = dot(u_xlat32.xyz, u_xlat32.xyz);
    u_xlat32.x = u_xlat4.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    ...
    u_xlat7.x = dot((-u_xlat5.xyz), u_xlat29.xyz);
    u_xlat7.x = u_xlat7.x + u_xlat7.x;
    u_xlat7.xyz = u_xlat29.xyz * (-u_xlat7.xxx) + (-u_xlat5.xyz);
    u_xlat85 = dot(u_xlat29.xyz, u_xlat5.xyz);
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat27.x);
    ...
    u_xlat7.xyz = vec3(u_xlat78) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat4.x = dot(unity_LightIndices[int(u_xlatu4)], uintBitsToFloat(ImmCB_0[u_xlati59]));
        ...
        u_xlat59.x = u_xlat59.x * _AdditionalLightsAttenuation[u_xlati4].x;
        ...
        u_xlat4.x = u_xlat59.x * u_xlat86;
        u_xlat59.x = dot(u_xlat29.xyz, u_xlat10.xyz);
        u_xlat59.x = clamp(u_xlat59.x, 0.0, 1.0);
        u_xlat4.x = u_xlat4.x * u_xlat59.x;
        u_xlat11.xyz = u_xlat4.xxx * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat85) + u_xlat5.xyz;
    ...
    u_xlat2.xyz = u_xlat30.xyz * u_xlat6.xxx + u_xlat32.xyz;
