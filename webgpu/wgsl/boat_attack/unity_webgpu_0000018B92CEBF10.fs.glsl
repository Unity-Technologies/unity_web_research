...
void main()
{
    ...
    u_xlat1 = (-u_xlat0.xyxy) * vec4(0.5, 0.5, 0.166666672, 0.166666672) + vec4(0.5, 0.5, 0.5, 0.5);
    u_xlat1 = u_xlat0.xyxy * u_xlat1 + vec4(0.5, 0.5, -0.5, -0.5);
    ...
    u_xlat1 = u_xlat0.xyxy * u_xlat1 + vec4(0.166666672, 0.166666672, 0.166666672, 0.166666672);
    u_xlat0.xy = (-u_xlat3.xy) + vec2(1.0, 1.0);
    u_xlat0.xy = (-u_xlat1.xy) + u_xlat0.xy;
    u_xlat0.xy = (-u_xlat1.zw) + u_xlat0.xy;
    u_xlat13.xy = u_xlat3.xy + u_xlat1.zw;
    u_xlat1.xy = u_xlat0.xy + u_xlat1.xy;
    u_xlat15.xy = vec2(1.0) / vec2(u_xlat13.xy);
    u_xlat3.zw = u_xlat3.xy * u_xlat15.xy + vec2(-1.0, -1.0);
    u_xlat4.xy = vec2(1.0) / vec2(u_xlat1.xy);
    ...
    u_xlat4 = u_xlat13.xxxx * u_xlat5 + u_xlat4;
    ...
    u_xlat3 = textureLod(sampler2D(_Bloom_Texture, sampler_LinearClamp), u_xlat0.xy, 0.0);
    u_xlat0 = textureLod(sampler2D(_Bloom_Texture, sampler_LinearClamp), u_xlat0.zw, 0.0);
    u_xlat0 = u_xlat0 * u_xlat1.xxxx;
    u_xlat0 = u_xlat13.xxxx * u_xlat3 + u_xlat0;
    u_xlat0 = u_xlat0 * u_xlat1.yyyy;
    u_xlat0 = u_xlat13.yyyy * u_xlat4 + u_xlat0;
