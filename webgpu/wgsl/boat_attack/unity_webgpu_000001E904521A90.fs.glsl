...
bool u_xlatb6;
    ...
    u_xlat1 = texture(sampler2D(Texture2D_B222E8F, samplerTexture2D_B222E8F), vs_INTERP1.xy, _GlobalMipBias.x);
    u_xlat2 = u_xlat1.w * u_xlat0.x + -0.400000006;
    u_xlat0.x = u_xlat0.x * u_xlat1.w;
    SV_TARGET0.xyz = u_xlat1.xyz * Color_C30C7CA3.xyz;
