...
half4 A = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( - 1.0 , - 1.0 ) , _GlobalMipBias . x ) ;
half4 B = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( 0.0 , - 1.0 ) , _GlobalMipBias . x ) ;
half4 C = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( 1.0 , - 1.0 ) , _GlobalMipBias . x ) ;
half4 D = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( - 0.5 , - 0.5 ) , _GlobalMipBias . x ) ;
half4 E = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( 0.5 , - 0.5 ) , _GlobalMipBias . x ) ;
half4 F = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( - 1.0 , 0.0 ) , _GlobalMipBias . x ) ;
half4 G = _BlitTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) ;
half4 H = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( 1.0 , 0.0 ) , _GlobalMipBias . x ) ;
half4 I = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( - 0.5 , 0.5 ) , _GlobalMipBias . x ) ;
half4 J = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( 0.5 , 0.5 ) , _GlobalMipBias . x ) ;
half4 K = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( - 1.0 , 1.0 ) , _GlobalMipBias . x ) ;
half4 L = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( 0.0 , 1.0 ) , _GlobalMipBias . x ) ;
half4 M = _BlitTexture . SampleBias ( sampler_LinearClamp , uv + texelSize * float2 ( 1.0 , 1.0 ) , _GlobalMipBias . x ) ;
...
float2 uv = input . texcoord ;
#line 112
half3 c0 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv - float2 ( texelSize . x * 4.0 , 0.0 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c1 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv - float2 ( texelSize . x * 3.0 , 0.0 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c2 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv - float2 ( texelSize . x * 2.0 , 0.0 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c3 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv - float2 ( texelSize . x * 1.0 , 0.0 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c4 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c5 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv + float2 ( texelSize . x * 1.0 , 0.0 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c6 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv + float2 ( texelSize . x * 2.0 , 0.0 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c7 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv + float2 ( texelSize . x * 3.0 , 0.0 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c8 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv + float2 ( texelSize . x * 4.0 , 0.0 ) , texelSize ) , _GlobalMipBias . x ) ) ;
...
float2 uv = input . texcoord ;
#line 136
half3 c0 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv - float2 ( 0.0 , texelSize . y * 3.23076923 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c1 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv - float2 ( 0.0 , texelSize . y * 1.38461538 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c2 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c3 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv + float2 ( 0.0 , texelSize . y * 1.38461538 ) , texelSize ) , _GlobalMipBias . x ) ) ;
half3 c4 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , ClampUVForBilinear ( uv + float2 ( 0.0 , texelSize . y * 3.23076923 ) , texelSize ) , _GlobalMipBias . x ) ) ;
