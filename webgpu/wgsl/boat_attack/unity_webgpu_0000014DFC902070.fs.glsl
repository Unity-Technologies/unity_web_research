...
void main()
{
    ...
    u_xlat2.xyz = vec3(u_xlat43) * u_xlat3.xyz;
    ...
    u_xlatb19.x = vs_TEXCOORD8.z>=1.0;
    ...
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat48)) + (-u_xlat6.xyz);
    ...
    u_xlat8.xyz = vec3(u_xlat48) * u_xlat8.xyz + u_xlat4.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat49 = dot(_AdditionalLightsSpotDir[u_xlati5].xyz, u_xlat10.xyz);
        u_xlat49 = u_xlat49 * _AdditionalLightsAttenuation[u_xlati5].z + _AdditionalLightsAttenuation[u_xlati5].w;
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat48 = u_xlat48 * u_xlat49;
        u_xlati49 = int(_AdditionalShadowParams[u_xlati5].w);
        ...
        if(u_xlatb50){
            ...
            if(u_xlatb50){
                ...
                u_xlat51 = trunc(_AdditionalShadowParams[u_xlati5].w);
            ...
            u_xlat50 = 1.0 + (-_AdditionalShadowParams[u_xlati5].x);
            u_xlat49 = u_xlat49 * _AdditionalShadowParams[u_xlati5].x + u_xlat50;
        ...
        u_xlat49 = u_xlat44 * u_xlat50 + u_xlat49;
        u_xlati50 = 1 << (u_xlati5 & int(0x1F));
        u_xlati50 = int(uint(u_xlati50) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati50 != 0) {
            u_xlati50 = int(_AdditionalLightsLightTypes[u_xlati5]);
            u_xlati51 = (u_xlati50 != 0) ? 0 : 1;
            u_xlati52 = u_xlati5 << (2 & int(0x1F));
            if(u_xlati51 != 0) {
                ...
                if(u_xlati50 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati5].xy * u_xlat39.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati5].zw;
                } else {
