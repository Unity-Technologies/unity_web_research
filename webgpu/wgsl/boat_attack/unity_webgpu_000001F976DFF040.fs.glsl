...
layout(set = 0, binding = 5) uniform mediump  samplerShadow sampler_LinearClampCompare;
...
void main()
{
    ...
    if(u_xlatb45){
        ...
        if(u_xlatb45){
            ...
            u_xlat2.y = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec1, 0.0);
            u_xlat1 = vs_TEXCOORD4.xyxy + _MainLightShadowOffset1;
            vec3 txVec2 = vec3(u_xlat1.xy,vs_TEXCOORD4.z);
            u_xlat2.z = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec2, 0.0);
            vec3 txVec3 = vec3(u_xlat1.zw,vs_TEXCOORD4.z);
            u_xlat2.w = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec3, 0.0);
            ...
            if(u_xlatb1){
                ...
                u_xlat16 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec4, 0.0);
                vec3 txVec5 = vec3(u_xlat5.zw,vs_TEXCOORD4.z);
                u_xlat2.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec5, 0.0);
                u_xlat2.x = u_xlat2.x * u_xlat8.y;
                u_xlat16 = u_xlat8.x * u_xlat16 + u_xlat2.x;
                vec3 txVec6 = vec3(u_xlat31.xy,vs_TEXCOORD4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat16 = u_xlat8.z * u_xlat31.x + u_xlat16;
                vec3 txVec7 = vec3(u_xlat4.xy,vs_TEXCOORD4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat16 = u_xlat8.w * u_xlat31.x + u_xlat16;
                vec3 txVec8 = vec3(u_xlat6.xy,vs_TEXCOORD4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat16 = u_xlat9.x * u_xlat31.x + u_xlat16;
                vec3 txVec9 = vec3(u_xlat6.zw,vs_TEXCOORD4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat16 = u_xlat9.y * u_xlat31.x + u_xlat16;
                vec3 txVec10 = vec3(u_xlat4.zw,vs_TEXCOORD4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat16 = u_xlat9.z * u_xlat31.x + u_xlat16;
                vec3 txVec11 = vec3(u_xlat3.xy,vs_TEXCOORD4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat16 = u_xlat9.w * u_xlat31.x + u_xlat16;
                vec3 txVec12 = vec3(u_xlat3.zw,vs_TEXCOORD4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                ...
                u_xlat3.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec13, 0.0);
                vec3 txVec14 = vec3(u_xlat7.zw,vs_TEXCOORD4.z);
                u_xlat48 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec14, 0.0);
                u_xlat48 = u_xlat48 * u_xlat12.y;
                u_xlat3.x = u_xlat12.x * u_xlat3.x + u_xlat48;
                vec3 txVec15 = vec3(u_xlat31.xy,vs_TEXCOORD4.z);
                u_xlat31.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec15, 0.0);
                u_xlat31.x = u_xlat12.z * u_xlat31.x + u_xlat3.x;
                vec3 txVec16 = vec3(u_xlat10.xy,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec16, 0.0);
                u_xlat31.x = u_xlat12.w * u_xlat46 + u_xlat31.x;
                vec3 txVec17 = vec3(u_xlat8.xy,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec17, 0.0);
                u_xlat31.x = u_xlat13.x * u_xlat46 + u_xlat31.x;
                vec3 txVec18 = vec3(u_xlat8.zw,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec18, 0.0);
                u_xlat31.x = u_xlat13.y * u_xlat46 + u_xlat31.x;
                vec3 txVec19 = vec3(u_xlat9.xy,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec19, 0.0);
                u_xlat31.x = u_xlat13.z * u_xlat46 + u_xlat31.x;
                vec3 txVec20 = vec3(u_xlat10.zw,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec20, 0.0);
                u_xlat31.x = u_xlat13.w * u_xlat46 + u_xlat31.x;
                vec3 txVec21 = vec3(u_xlat11.xy,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec21, 0.0);
                u_xlat31.x = u_xlat14.x * u_xlat46 + u_xlat31.x;
                vec3 txVec22 = vec3(u_xlat11.zw,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec22, 0.0);
                u_xlat31.x = u_xlat14.y * u_xlat46 + u_xlat31.x;
                vec3 txVec23 = vec3(u_xlat18.xy,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec23, 0.0);
                u_xlat31.x = u_xlat14.z * u_xlat46 + u_xlat31.x;
                vec3 txVec24 = vec3(u_xlat39.xy,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat31.x = u_xlat14.w * u_xlat46 + u_xlat31.x;
                vec3 txVec25 = vec3(u_xlat6.xy,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec25, 0.0);
                u_xlat31.x = u_xlat2.x * u_xlat46 + u_xlat31.x;
                vec3 txVec26 = vec3(u_xlat6.zw,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec26, 0.0);
                u_xlat31.x = u_xlat2.y * u_xlat46 + u_xlat31.x;
                vec3 txVec27 = vec3(u_xlat34.xy,vs_TEXCOORD4.z);
                u_xlat46 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
        ...
        u_xlat45 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec29, 0.0);
    }
    ...
    SV_Target0 = vec4(0.0, 0.0, 0.0, 0.0156862754);
