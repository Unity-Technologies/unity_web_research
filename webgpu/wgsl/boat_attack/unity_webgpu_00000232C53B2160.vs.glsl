...
void main()
{
    ...
    if(u_xlatb12){
        ...
        if(u_xlatb12){
            u_xlat12 = in_TEXCOORD4.x;
            u_xlat9 = in_TEXCOORD4.y;
            u_xlat2.x = in_TEXCOORD4.z;
        } else {
            u_xlat12 = in_POSITION0.x;
            u_xlat9 = in_POSITION0.y;
            u_xlat2.x = in_POSITION0.z;
        }
        u_xlat6.xyz = u_xlat0.yyy * _NonJitteredViewProjMatrix[1].xyw;
        u_xlat6.xyz = _NonJitteredViewProjMatrix[0].xyw * u_xlat0.xxx + u_xlat6.xyz;
        u_xlat6.xyz = _NonJitteredViewProjMatrix[2].xyw * u_xlat0.zzz + u_xlat6.xyz;
        vs_CLIP_POSITION_NO_JITTER0.xyz = u_xlat6.xyz + _NonJitteredViewProjMatrix[3].xyw;
        u_xlat3 = vec4(u_xlat9) * unity_MatrixPreviousM[1];
        u_xlat3 = unity_MatrixPreviousM[0] * vec4(u_xlat12) + u_xlat3;
        u_xlat2 = unity_MatrixPreviousM[2] * u_xlat2.xxxx + u_xlat3;
