...
fn main_1() {
  ...
  u_xlat2 = max(x_66, 0.00009999999747378752f);
  ...
  u_xlat0 = (x_97 + -0.00009999999747378752f);
  ...
  u_xlat0 = dot(x_114, x_115);
  let x_117 : f32 = u_xlat0;
  u_xlat0 = inverseSqrt(x_117);
  let x_121 : f32 = u_xlat0;
  let x_123 : vec3<f32> = vs_TEXCOORD2;
  let x_124 : vec3<f32> = (vec3<f32>(x_121, x_121, x_121) * x_123);
  let x_125 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_124.x, x_124.y, x_124.z, x_125.w);
  SV_Target0.w = 0.0f;
  return;
}
...
@fragment
fn main(@location(0) vs_TEXCOORD1_param : vec2<f32>, @location(1) vs_TEXCOORD2_param : vec3<f32>, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
