...
void main()
{
    ...
    u_xlat7.xyz = u_xlat3.xyz * (-u_xlat58.xxx) + (-u_xlat1.xyz);
    ...
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat54);
    ...
    u_xlat5.xyz = u_xlat31.xyz * u_xlat4.xyz + u_xlat7.xyz;
    ...
    u_xlat34.xyz = vec3(u_xlat78) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
    ...
    u_xlat1.xyz = u_xlat34.xyz + u_xlat1.xyz;
