...
layout(set = 0, binding = 4) uniform mediump  sampler sampler_PointRepeat;
...
bool u_xlatb9;
    ...
    u_xlat9 = texture(sampler2D(_BlueNoise_Texture, sampler_PointRepeat), u_xlat1.xy, _GlobalMipBias.x).w;
