...
fn main_1() {
  ...
  u_xlat0 = sqrt(x_1639);
  let x_1641 : vec2<f32> = vs_TEXCOORD0;
  let x_1644 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1648 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1650 : vec2<f32> = ((x_1641 * vec2<f32>(x_1644.x, x_1644.y)) + vec2<f32>(x_1648.z, x_1648.w));
  let x_1651 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1650.x, x_1650.y, x_1651.z, x_1651.w);
  let x_1658 : vec4<f32> = u_xlat1;
  let x_1661 : f32 = x_14.x_GlobalMipBias.x;
  let x_1662 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1658.x, x_1658.y), x_1661);
  u_xlat18 = x_1662.w;
  let x_1664 : f32 = u_xlat18;
  u_xlat18 = ((x_1664 * 2.0f) + -1.0f);
  let x_1667 : f32 = u_xlat18;
  u_xlatb1 = (x_1667 >= 0.0f);
  let x_1669 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1669);
  let x_1672 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1672)) + 1.0f);
  let x_1676 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1676);
  let x_1678 : f32 = u_xlat18;
  u_xlat18 = (-(x_1678) + 1.0f);
  let x_1681 : f32 = u_xlat18;
  let x_1683 : f32 = u_xlat1.x;
  u_xlat18 = (x_1681 * x_1683);
  let x_1685 : vec3<f32> = u_xlat0;
  let x_1686 : vec3<f32> = (x_1685 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1687 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1686.x, x_1686.y, x_1686.z, x_1687.w);
  let x_1689 : vec3<f32> = u_xlat0;
  let x_1690 : vec3<f32> = log2(x_1689);
