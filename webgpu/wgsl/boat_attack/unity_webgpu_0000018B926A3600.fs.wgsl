...
fn main_1() {
  ...
  let x_1424 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1428 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1430 : vec2<f32> = ((x_1421 * vec2<f32>(x_1424.x, x_1424.y)) + vec2<f32>(x_1428.z, x_1428.w));
  let x_1431 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1430.x, x_1430.y, x_1431.z, x_1431.w);
  let x_1438 : vec4<f32> = u_xlat1;
  let x_1441 : f32 = x_14.x_GlobalMipBias.x;
  let x_1442 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1438.x, x_1438.y), x_1441);
  u_xlat15 = x_1442.w;
  let x_1444 : f32 = u_xlat15;
  u_xlat15 = ((x_1444 * 2.0f) + -1.0f);
  let x_1447 : f32 = u_xlat15;
  u_xlatb1 = (x_1447 >= 0.0f);
  let x_1449 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1449);
  let x_1452 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1452)) + 1.0f);
  let x_1456 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1456);
  let x_1458 : f32 = u_xlat15;
  u_xlat15 = (-(x_1458) + 1.0f);
  let x_1461 : f32 = u_xlat15;
  let x_1463 : f32 = u_xlat1.x;
  u_xlat15 = (x_1461 * x_1463);
  let x_1465 : vec3<f32> = u_xlat0;
  let x_1466 : vec3<f32> = (x_1465 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1467 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1466.x, x_1466.y, x_1466.z, x_1467.w);
  let x_1469 : vec3<f32> = u_xlat0;
  let x_1470 : vec3<f32> = log2(x_1469);
