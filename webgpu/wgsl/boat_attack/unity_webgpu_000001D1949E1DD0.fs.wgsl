...
fn main_1() {
  ...
  let x_2096 : vec2<f32> = vs_TEXCOORD0;
  let x_2099 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2103 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2105 : vec2<f32> = ((x_2096 * vec2<f32>(x_2099.x, x_2099.y)) + vec2<f32>(x_2103.z, x_2103.w));
  let x_2106 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2105.x, x_2105.y, x_2106.z, x_2106.w);
  let x_2113 : vec4<f32> = u_xlat1;
  let x_2116 : f32 = x_25.x_GlobalMipBias.x;
  let x_2117 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2113.x, x_2113.y), x_2116);
  u_xlat18 = x_2117.w;
  let x_2119 : f32 = u_xlat18;
  u_xlat18 = ((x_2119 * 2.0f) + -1.0f);
  let x_2122 : f32 = u_xlat18;
  u_xlatb1 = (x_2122 >= 0.0f);
  let x_2124 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2124);
  let x_2127 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2127)) + 1.0f);
  let x_2131 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2131);
  let x_2133 : f32 = u_xlat18;
  u_xlat18 = (-(x_2133) + 1.0f);
  let x_2136 : f32 = u_xlat18;
  let x_2138 : f32 = u_xlat1.x;
  u_xlat18 = (x_2136 * x_2138);
  let x_2140 : vec4<f32> = u_xlat0;
  let x_2142 : vec3<f32> = (vec3<f32>(x_2140.x, x_2140.y, x_2140.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2143 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2142.x, x_2142.y, x_2142.z, x_2143.w);
  let x_2145 : vec4<f32> = u_xlat0;
  let x_2148 : vec3<f32> = log2(abs(vec3<f32>(x_2145.x, x_2145.y, x_2145.z)));
  let x_2149 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2148.x, x_2148.y, x_2148.z, x_2149.w);
  let x_2151 : vec4<f32> = u_xlat2;
  let x_2153 : vec3<f32> = (vec3<f32>(x_2151.x, x_2151.y, x_2151.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2154 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2153.x, x_2153.y, x_2153.z, x_2154.w);
  let x_2156 : vec4<f32> = u_xlat2;
  let x_2158 : vec3<f32> = exp2(vec3<f32>(x_2156.x, x_2156.y, x_2156.z));
  let x_2159 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2158.x, x_2158.y, x_2158.z, x_2159.w);
  let x_2161 : vec4<f32> = u_xlat2;
  let x_2164 : vec3<f32> = ((vec3<f32>(x_2161.x, x_2161.y, x_2161.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2165 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2164.x, x_2164.y, x_2164.z, x_2165.w);
  let x_2167 : vec4<f32> = u_xlat0;
  let x_2169 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2167.x, x_2167.y, x_2167.z, x_2167.x));
  u_xlatb0 = vec3<bool>(x_2169.x, x_2169.y, x_2169.z);
  let x_2172 : bool = u_xlatb0.x;
  if (x_2172) {
    let x_2177 : f32 = u_xlat1.x;
    x_2173 = x_2177;
  } else {
    let x_2180 : f32 = u_xlat2.x;
    x_2173 = x_2180;
  }
  let x_2181 : f32 = x_2173;
  u_xlat0.x = x_2181;
  let x_2184 : bool = u_xlatb0.y;
  if (x_2184) {
    let x_2189 : f32 = u_xlat1.y;
    x_2185 = x_2189;
  } else {
    let x_2192 : f32 = u_xlat2.y;
    x_2185 = x_2192;
  }
  let x_2193 : f32 = x_2185;
  u_xlat0.y = x_2193;
  let x_2196 : bool = u_xlatb0.z;
  if (x_2196) {
    let x_2201 : f32 = u_xlat1.z;
    x_2197 = x_2201;
  } else {
    let x_2204 : f32 = u_xlat2.z;
    x_2197 = x_2204;
  }
  let x_2205 : f32 = x_2197;
  u_xlat0.z = x_2205;
  let x_2207 : f32 = u_xlat18;
  let x_2212 : vec4<f32> = u_xlat0;
  let x_2214 : vec3<f32> = ((vec3<f32>(x_2207, x_2207, x_2207) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2212.x, x_2212.y, x_2212.z));
  let x_2215 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2214.x, x_2214.y, x_2214.z, x_2215.w);
  let x_2217 : vec4<f32> = u_xlat0;
  let x_2219 : vec3<f32> = (vec3<f32>(x_2217.x, x_2217.y, x_2217.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2220 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2219.x, x_2219.y, x_2219.z, x_2220.w);
  let x_2222 : vec4<f32> = u_xlat0;
  let x_2224 : vec3<f32> = (vec3<f32>(x_2222.x, x_2222.y, x_2222.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2225 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2224.x, x_2224.y, x_2224.z, x_2225.w);
  let x_2227 : vec4<f32> = u_xlat2;
  let x_2229 : vec3<f32> = (vec3<f32>(x_2227.x, x_2227.y, x_2227.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2230 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2229.x, x_2229.y, x_2229.z, x_2230.w);
  let x_2232 : vec4<f32> = u_xlat2;
  let x_2235 : vec3<f32> = log2(abs(vec3<f32>(x_2232.x, x_2232.y, x_2232.z)));
  let x_2236 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2235.x, x_2235.y, x_2235.z, x_2236.w);
  let x_2238 : vec4<f32> = u_xlat2;
  let x_2240 : vec3<f32> = (vec3<f32>(x_2238.x, x_2238.y, x_2238.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2241 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2240.x, x_2240.y, x_2240.z, x_2241.w);
  let x_2243 : vec4<f32> = u_xlat2;
  let x_2245 : vec3<f32> = exp2(vec3<f32>(x_2243.x, x_2243.y, x_2243.z));
  let x_2246 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2245.x, x_2245.y, x_2245.z, x_2246.w);
  let x_2248 : vec4<f32> = u_xlat0;
  let x_2250 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2248.x, x_2248.y, x_2248.z, x_2248.x));
  u_xlatb0 = vec3<bool>(x_2250.x, x_2250.y, x_2250.z);
  let x_2253 : bool = u_xlatb0.x;
  if (x_2253) {
    let x_2258 : f32 = u_xlat1.x;
    x_2254 = x_2258;
  } else {
    let x_2261 : f32 = u_xlat2.x;
    x_2254 = x_2261;
  }
  let x_2262 : f32 = x_2254;
  u_xlat0.x = x_2262;
  let x_2265 : bool = u_xlatb0.y;
  if (x_2265) {
    let x_2270 : f32 = u_xlat1.y;
    x_2266 = x_2270;
  } else {
    let x_2273 : f32 = u_xlat2.y;
    x_2266 = x_2273;
  }
  let x_2274 : f32 = x_2266;
  u_xlat0.y = x_2274;
  let x_2277 : bool = u_xlatb0.z;
  if (x_2277) {
    let x_2282 : f32 = u_xlat1.z;
    x_2278 = x_2282;
  } else {
  ...
  let x_2292 : vec3<f32> = max(vec3<f32>(x_2290.x, x_2290.y, x_2290.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2293 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2292.x, x_2292.y, x_2292.z, x_2293.w);
  SV_Target0.w = 1.0f;
  return;
}
