...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat4.xyz = u_xlat1.xzw * u_xlat14.xxx;
    u_xlatb1.x = unity_OrthoParams.w==0.0;
    u_xlat14.xyz = (-vs_INTERP0.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat23 = dot(u_xlat14.xyz, u_xlat14.xyz);
    u_xlat23 = inversesqrt(u_xlat23);
    u_xlat14.xyz = vec3(u_xlat23) * u_xlat14.xyz;
    u_xlat5.x = (u_xlatb1.x) ? u_xlat14.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb1.x) ? u_xlat14.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb1.x) ? u_xlat14.z : unity_MatrixV[2].z;
    u_xlat4.w = 1.0;
    ...
    u_xlat25 = u_xlat14.x * u_xlat14.x;
    ...
    u_xlat14.xy = vec2(u_xlat25) * vec2(u_xlat25) + vec2(-1.0, 1.0);
    ...
    u_xlat35 = u_xlat35 * u_xlat14.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu35 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat25 = dot(unity_LightIndices[int(u_xlatu25)], uintBitsToFloat(ImmCB_0[u_xlati40]));
        u_xlati25 = int(u_xlat25);
        u_xlat8.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[u_xlati25].www + _AdditionalLightsPosition[u_xlati25].xyz;
        ...
        u_xlat40 = u_xlat40 * _AdditionalLightsAttenuation[u_xlati25].x;
        u_xlat40 = (-u_xlat40) * u_xlat40 + 1.0;
        u_xlat40 = max(u_xlat40, 0.0);
        u_xlat40 = u_xlat40 * u_xlat40;
        u_xlat40 = u_xlat40 * u_xlat42;
        u_xlat42 = dot(_AdditionalLightsSpotDir[u_xlati25].xyz, u_xlat9.xyz);
        u_xlat42 = u_xlat42 * _AdditionalLightsAttenuation[u_xlati25].z + _AdditionalLightsAttenuation[u_xlati25].w;
        u_xlat42 = clamp(u_xlat42, 0.0, 1.0);
        u_xlat42 = u_xlat42 * u_xlat42;
        u_xlat40 = u_xlat40 * u_xlat42;
        u_xlat10.xyz = u_xlat6.xxx * _AdditionalLightsColor[u_xlati25].xyz;
        u_xlat25 = dot(u_xlat4.xyz, u_xlat9.xyz);
        ...
        u_xlat25 = max(u_xlat25, 1.17549435e-37);
        ...
        u_xlat25 = u_xlat25 * u_xlat14.x + 1.00001001;
        u_xlat40 = u_xlat40 * u_xlat40;
        u_xlat25 = u_xlat25 * u_xlat25;
        ...
        u_xlat8.xyz = vec3(u_xlat25) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat1.xzw = u_xlat1.xzw * vec3(u_xlat38) + u_xlat17.xyz;
