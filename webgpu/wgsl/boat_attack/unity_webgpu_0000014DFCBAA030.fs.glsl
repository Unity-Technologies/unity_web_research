...
void main()
{
    ...
    u_xlat3.x = (-u_xlat80) + 1.0;
    u_xlat29.xyz = u_xlat0.xyz * vec3(u_xlat80);
    ...
    u_xlat4 = u_xlat80 * u_xlat80;
    u_xlat78 = u_xlat0.w + u_xlat3.x;
    u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
    u_xlat3.x = u_xlat80 * 4.0 + 2.0;
    u_xlatb30.x = 0.0<_MainLightShadowParams.y;
    if(u_xlatb30.x){
        u_xlatb30.x = _MainLightShadowParams.y==1.0;
        if(u_xlatb30.x){
            ...
            u_xlat30 = dot(u_xlat6, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            u_xlatb56 = _MainLightShadowParams.y==2.0;
            if(u_xlatb56){
                u_xlat56.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat56.xy = floor(u_xlat56.xy);
                u_xlat5.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat56.xy);
                u_xlat6 = u_xlat5.xxyy + vec4(0.5, 1.0, 0.5, 1.0);
                u_xlat7 = u_xlat6.xxzz * u_xlat6.xxzz;
                u_xlat57.xy = u_xlat7.yw * vec2(0.0799999982, 0.0799999982);
                u_xlat6.xz = u_xlat7.xz * vec2(0.5, 0.5) + (-u_xlat5.xy);
                u_xlat7.xy = (-u_xlat5.xy) + vec2(1.0, 1.0);
                u_xlat59.xy = min(u_xlat5.xy, vec2(0.0, 0.0));
                u_xlat59.xy = (-u_xlat59.xy) * u_xlat59.xy + u_xlat7.xy;
                ...
                u_xlat7.w = u_xlat8.x;
                u_xlat9 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat7.ywxw;
                u_xlat10.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat7.zw;
                u_xlat8.w = u_xlat7.y;
                u_xlat7.yw = u_xlat8.yz;
                u_xlat11 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat7.xyzy;
                u_xlat8 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat8.wywz;
                u_xlat7 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat7.xwzw;
                u_xlat12 = u_xlat5.xxxy * u_xlat6.zwyz;
                u_xlat13 = u_xlat5.yyzz * u_xlat6;
                u_xlat56.x = u_xlat5.z * u_xlat6.y;
                ...
                u_xlat82 = u_xlat12.x * u_xlat82 + u_xlat5.x;
                vec3 txVec6 = vec3(u_xlat10.xy,vs_TEXCOORD8.z);
                u_xlat5.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat82 = u_xlat12.z * u_xlat5.x + u_xlat82;
                ...
                u_xlat82 = u_xlat12.w * u_xlat5.x + u_xlat82;
                ...
                u_xlat82 = u_xlat13.x * u_xlat5.x + u_xlat82;
                ...
                u_xlat82 = u_xlat13.y * u_xlat5.x + u_xlat82;
                ...
                u_xlat82 = u_xlat13.z * u_xlat5.x + u_xlat82;
                ...
                u_xlat82 = u_xlat13.w * u_xlat5.x + u_xlat82;
                ...
                u_xlat30 = u_xlat56.x * u_xlat5.x + u_xlat82;
            } else {
                u_xlat56.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat56.xy = floor(u_xlat56.xy);
                u_xlat5.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat56.xy);
                ...
                u_xlat57.xy = u_xlat7.xz * vec2(0.5, 0.5) + (-u_xlat5.xy);
                ...
                u_xlat9.xy = u_xlat57.yx * vec2(0.0816320032, 0.0816320032);
                u_xlat57.xy = u_xlat6.xz * vec2(0.0816320032, 0.0816320032);
                ...
                u_xlat9.y = u_xlat8.x;
                u_xlat10 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xyzy;
                u_xlat11.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat9.wy;
                u_xlat6.y = u_xlat9.y;
                u_xlat9.y = u_xlat8.z;
                u_xlat12 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xyzy;
                u_xlat63.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat9.wy;
                u_xlat6.z = u_xlat9.y;
                u_xlat13 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat6.xyxz;
                u_xlat9.y = u_xlat8.w;
                u_xlat14 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xyzy;
                u_xlat32.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat9.wy;
                u_xlat6.w = u_xlat9.y;
                u_xlat15.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat6.xw;
                u_xlat8.xzw = u_xlat9.xzw;
                u_xlat9 = u_xlat56.xyxy * _MainLightShadowmapSize.xyxy + u_xlat8.xyzy;
                u_xlat60.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat8.wy;
                u_xlat8.x = u_xlat6.x;
                u_xlat56.xy = u_xlat56.xy * _MainLightShadowmapSize.xy + u_xlat8.xy;
                u_xlat16 = u_xlat5.xxxx * u_xlat7;
                u_xlat17 = u_xlat5.yyyy * u_xlat7;
                u_xlat18 = u_xlat5.zzzz * u_xlat7;
                u_xlat5 = u_xlat5.wwww * u_xlat7;
                vec3 txVec13 = vec3(u_xlat10.xy,vs_TEXCOORD8.z);
                u_xlat6.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec13, 0.0);
                vec3 txVec14 = vec3(u_xlat10.zw,vs_TEXCOORD8.z);
                u_xlat84 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec14, 0.0);
                u_xlat84 = u_xlat84 * u_xlat16.y;
                u_xlat6.x = u_xlat16.x * u_xlat6.x + u_xlat84;
                vec3 txVec15 = vec3(u_xlat11.xy,vs_TEXCOORD8.z);
                u_xlat84 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec15, 0.0);
                u_xlat6.x = u_xlat16.z * u_xlat84 + u_xlat6.x;
                vec3 txVec16 = vec3(u_xlat13.xy,vs_TEXCOORD8.z);
                u_xlat84 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec16, 0.0);
                u_xlat6.x = u_xlat16.w * u_xlat84 + u_xlat6.x;
                ...
                u_xlat6.x = u_xlat17.x * u_xlat84 + u_xlat6.x;
                ...
                u_xlat6.x = u_xlat17.y * u_xlat84 + u_xlat6.x;
                vec3 txVec19 = vec3(u_xlat63.xy,vs_TEXCOORD8.z);
                u_xlat84 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec19, 0.0);
                u_xlat6.x = u_xlat17.z * u_xlat84 + u_xlat6.x;
                vec3 txVec20 = vec3(u_xlat13.zw,vs_TEXCOORD8.z);
                u_xlat84 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec20, 0.0);
                u_xlat6.x = u_xlat17.w * u_xlat84 + u_xlat6.x;
                vec3 txVec21 = vec3(u_xlat14.xy,vs_TEXCOORD8.z);
                u_xlat84 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec21, 0.0);
                u_xlat6.x = u_xlat18.x * u_xlat84 + u_xlat6.x;
                vec3 txVec22 = vec3(u_xlat14.zw,vs_TEXCOORD8.z);
                u_xlat84 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec22, 0.0);
                u_xlat6.x = u_xlat18.y * u_xlat84 + u_xlat6.x;
                vec3 txVec23 = vec3(u_xlat32.xy,vs_TEXCOORD8.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec23, 0.0);
                u_xlat6.x = u_xlat18.z * u_xlat32.x + u_xlat6.x;
                vec3 txVec24 = vec3(u_xlat15.xy,vs_TEXCOORD8.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat6.x = u_xlat18.w * u_xlat32.x + u_xlat6.x;
                vec3 txVec25 = vec3(u_xlat9.xy,vs_TEXCOORD8.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec25, 0.0);
                u_xlat5.x = u_xlat5.x * u_xlat32.x + u_xlat6.x;
                vec3 txVec26 = vec3(u_xlat9.zw,vs_TEXCOORD8.z);
                ...
                u_xlat31 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
                u_xlat5.x = u_xlat5.z * u_xlat31 + u_xlat5.x;
                vec3 txVec28 = vec3(u_xlat56.xy,vs_TEXCOORD8.z);
                u_xlat56.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec28, 0.0);
                u_xlat30 = u_xlat5.w * u_xlat56.x + u_xlat5.x;
            }
        }
    } else {
        vec3 txVec29 = vec3(vs_TEXCOORD8.xy,vs_TEXCOORD8.z);
        u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec29, 0.0);
    }
    u_xlat56.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat30 = u_xlat30 * _MainLightShadowParams.x + u_xlat56.x;
    u_xlatb56 = 0.0>=vs_TEXCOORD8.z;
    u_xlatb82 = vs_TEXCOORD8.z>=1.0;
    u_xlatb56 = u_xlatb82 || u_xlatb56;
    u_xlat30 = (u_xlatb56) ? 1.0 : u_xlat30;
    u_xlat5.xyz = vs_TEXCOORD7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat56.x = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat82 = u_xlat56.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    u_xlat5.x = (-u_xlat30) + 1.0;
    u_xlat30 = u_xlat82 * u_xlat5.x + u_xlat30;
    ...
    if(u_xlatb82){
        ...
        u_xlat82 = (u_xlatb6.y) ? u_xlat5.w : u_xlat5.x;
        u_xlat5.xyz = (u_xlatb6.x) ? u_xlat5.xyz : vec3(u_xlat82);
    } else {
        u_xlat5.x = float(1.0);
        u_xlat5.y = float(1.0);
        u_xlat5.z = float(1.0);
    ...
    u_xlat82 = dot((-u_xlat6.xyz), u_xlat27.xyz);
    u_xlat82 = u_xlat82 + u_xlat82;
    u_xlat7.xyz = u_xlat27.xyz * (-vec3(u_xlat82)) + (-u_xlat6.xyz);
    u_xlat82 = dot(u_xlat27.xyz, u_xlat6.xyz);
    u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
    ...
    u_xlat34.xyz = vec3(u_xlat82) * u_xlat34.xyz + u_xlat0.xyz;
    u_xlat34.xyz = vec3(u_xlat1) * u_xlat34.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat34.xyz;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat29.xyz + u_xlat7.xyz;
    u_xlat78 = u_xlat30 * unity_LightData.z;
    ...
    u_xlat78 = u_xlat4 / u_xlat78;
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat78) + u_xlat29.xyz;
    u_xlat78 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu78 =  uint(int(u_xlat78));
    u_xlat1 = u_xlat56.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlatb30.xy = equal(vec4(vec4(_AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat)), vec4(0.0, 1.0, 0.0, 0.0)).xy;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlatb87){
            ...
            u_xlat85 = u_xlat85 * _AdditionalShadowParams[u_xlati82].x + u_xlat87;
        ...
        if(u_xlati87 != 0) {
            ...
            u_xlat87 = (u_xlatb30.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb30.x) ? u_xlat11.xyz : vec3(u_xlat87);
        } else {
        ...
        u_xlat82 = dot(u_xlat27.xyz, u_xlat9.xyz);
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        ...
        u_xlat82 = u_xlat4 / u_xlat82;
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat82) + u_xlat29.xyz;
