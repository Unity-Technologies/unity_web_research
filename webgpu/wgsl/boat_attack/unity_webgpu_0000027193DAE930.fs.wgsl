...
fn main_1() {
  ...
  let x_1514 : vec3<f32> = (vec3<f32>(x_1512.x, x_1512.y, x_1512.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1515 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1514.x, x_1514.y, x_1514.z, x_1515.w);
  let x_1517 : vec4<f32> = u_xlat0;
  let x_1520 : vec3<f32> = log2(abs(vec3<f32>(x_1517.x, x_1517.y, x_1517.z)));
  let x_1521 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1520.x, x_1520.y, x_1520.z, x_1521.w);
  let x_1523 : vec4<f32> = u_xlat2;
  let x_1525 : vec3<f32> = (vec3<f32>(x_1523.x, x_1523.y, x_1523.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1526 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1525.x, x_1525.y, x_1525.z, x_1526.w);
  let x_1528 : vec4<f32> = u_xlat2;
  let x_1530 : vec3<f32> = exp2(vec3<f32>(x_1528.x, x_1528.y, x_1528.z));
  let x_1531 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1530.x, x_1530.y, x_1530.z, x_1531.w);
  let x_1533 : vec4<f32> = u_xlat2;
  let x_1536 : vec3<f32> = ((vec3<f32>(x_1533.x, x_1533.y, x_1533.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1537 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1536.x, x_1536.y, x_1536.z, x_1537.w);
  let x_1539 : vec4<f32> = u_xlat0;
  let x_1541 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1539.x, x_1539.y, x_1539.z, x_1539.x));
  u_xlatb0 = vec3<bool>(x_1541.x, x_1541.y, x_1541.z);
  let x_1544 : bool = u_xlatb0.x;
  if (x_1544) {
  ...
  u_xlat0.x = x_1553;
  let x_1556 : bool = u_xlatb0.y;
  if (x_1556) {
    let x_1561 : f32 = u_xlat1.y;
    x_1557 = x_1561;
  } else {
    let x_1564 : f32 = u_xlat2.y;
    x_1557 = x_1564;
  }
  let x_1565 : f32 = x_1557;
  u_xlat0.y = x_1565;
  let x_1568 : bool = u_xlatb0.z;
  if (x_1568) {
    let x_1573 : f32 = u_xlat1.z;
    x_1569 = x_1573;
  } else {
  ...
  u_xlat0.z = x_1577;
  let x_1579 : vec2<f32> = vs_TEXCOORD0;
  let x_1582 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1586 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1588 : vec2<f32> = ((x_1579 * vec2<f32>(x_1582.x, x_1582.y)) + vec2<f32>(x_1586.z, x_1586.w));
  let x_1589 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1588.x, x_1588.y, x_1589.z, x_1589.w);
  let x_1596 : vec4<f32> = u_xlat1;
  let x_1599 : f32 = x_38.x_GlobalMipBias.x;
  let x_1600 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1596.x, x_1596.y), x_1599);
  u_xlat15 = x_1600.w;
  let x_1602 : f32 = u_xlat15;
  u_xlat15 = ((x_1602 * 2.0f) + -1.0f);
  let x_1605 : f32 = u_xlat15;
  u_xlatb1 = (x_1605 >= 0.0f);
  let x_1607 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1607);
  let x_1610 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1610)) + 1.0f);
  let x_1614 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1614);
  let x_1616 : f32 = u_xlat15;
  u_xlat15 = (-(x_1616) + 1.0f);
  let x_1619 : f32 = u_xlat15;
  let x_1621 : f32 = u_xlat1.x;
  u_xlat15 = (x_1619 * x_1621);
  let x_1623 : vec4<f32> = u_xlat0;
  let x_1625 : vec3<f32> = (vec3<f32>(x_1623.x, x_1623.y, x_1623.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1626 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1625.x, x_1625.y, x_1625.z, x_1626.w);
  let x_1628 : vec4<f32> = u_xlat0;
  let x_1631 : vec3<f32> = log2(abs(vec3<f32>(x_1628.x, x_1628.y, x_1628.z)));
  let x_1632 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1631.x, x_1631.y, x_1631.z, x_1632.w);
  let x_1634 : vec4<f32> = u_xlat2;
  let x_1636 : vec3<f32> = (vec3<f32>(x_1634.x, x_1634.y, x_1634.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1637 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1636.x, x_1636.y, x_1636.z, x_1637.w);
  let x_1639 : vec4<f32> = u_xlat2;
  let x_1641 : vec3<f32> = exp2(vec3<f32>(x_1639.x, x_1639.y, x_1639.z));
  let x_1642 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1641.x, x_1641.y, x_1641.z, x_1642.w);
  let x_1644 : vec4<f32> = u_xlat2;
  let x_1647 : vec3<f32> = ((vec3<f32>(x_1644.x, x_1644.y, x_1644.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1648 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1647.x, x_1647.y, x_1647.z, x_1648.w);
  let x_1650 : vec4<f32> = u_xlat0;
  let x_1652 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1650.x, x_1650.y, x_1650.z, x_1650.x));
  u_xlatb0 = vec3<bool>(x_1652.x, x_1652.y, x_1652.z);
  let x_1655 : bool = u_xlatb0.x;
  if (x_1655) {
  ...
  u_xlat0.x = x_1664;
  let x_1667 : bool = u_xlatb0.y;
  if (x_1667) {
    let x_1672 : f32 = u_xlat1.y;
    x_1668 = x_1672;
  } else {
    let x_1675 : f32 = u_xlat2.y;
    x_1668 = x_1675;
  }
  let x_1676 : f32 = x_1668;
  u_xlat0.y = x_1676;
  let x_1679 : bool = u_xlatb0.z;
  if (x_1679) {
    let x_1684 : f32 = u_xlat1.z;
    x_1680 = x_1684;
  } else {
    let x_1687 : f32 = u_xlat2.z;
    x_1680 = x_1687;
  }
  let x_1688 : f32 = x_1680;
  u_xlat0.z = x_1688;
  let x_1690 : f32 = u_xlat15;
  let x_1695 : vec4<f32> = u_xlat0;
  let x_1697 : vec3<f32> = ((vec3<f32>(x_1690, x_1690, x_1690) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1695.x, x_1695.y, x_1695.z));
  let x_1698 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1697.x, x_1697.y, x_1697.z, x_1698.w);
  let x_1700 : vec4<f32> = u_xlat0;
  let x_1702 : vec3<f32> = (vec3<f32>(x_1700.x, x_1700.y, x_1700.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1703 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1702.x, x_1702.y, x_1702.z, x_1703.w);
  let x_1705 : vec4<f32> = u_xlat0;
  let x_1707 : vec3<f32> = (vec3<f32>(x_1705.x, x_1705.y, x_1705.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1708 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1707.x, x_1707.y, x_1707.z, x_1708.w);
  let x_1710 : vec4<f32> = u_xlat2;
  let x_1712 : vec3<f32> = (vec3<f32>(x_1710.x, x_1710.y, x_1710.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1713 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1712.x, x_1712.y, x_1712.z, x_1713.w);
  let x_1715 : vec4<f32> = u_xlat2;
  let x_1718 : vec3<f32> = log2(abs(vec3<f32>(x_1715.x, x_1715.y, x_1715.z)));
  let x_1719 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1718.x, x_1718.y, x_1718.z, x_1719.w);
  let x_1721 : vec4<f32> = u_xlat2;
  let x_1723 : vec3<f32> = (vec3<f32>(x_1721.x, x_1721.y, x_1721.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1724 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1723.x, x_1723.y, x_1723.z, x_1724.w);
  let x_1726 : vec4<f32> = u_xlat2;
  let x_1728 : vec3<f32> = exp2(vec3<f32>(x_1726.x, x_1726.y, x_1726.z));
  let x_1729 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1728.x, x_1728.y, x_1728.z, x_1729.w);
  let x_1731 : vec4<f32> = u_xlat0;
  let x_1733 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1731.x, x_1731.y, x_1731.z, x_1731.x));
  u_xlatb0 = vec3<bool>(x_1733.x, x_1733.y, x_1733.z);
  ...
  u_xlat0.x = x_1745;
  let x_1748 : bool = u_xlatb0.y;
  if (x_1748) {
    let x_1753 : f32 = u_xlat1.y;
    x_1749 = x_1753;
  } else {
    let x_1756 : f32 = u_xlat2.y;
    x_1749 = x_1756;
  }
  let x_1757 : f32 = x_1749;
  u_xlat0.y = x_1757;
  let x_1760 : bool = u_xlatb0.z;
  if (x_1760) {
    let x_1765 : f32 = u_xlat1.z;
    x_1761 = x_1765;
  } else {
  ...
  let x_1775 : vec3<f32> = max(vec3<f32>(x_1773.x, x_1773.y, x_1773.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1776 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1775.x, x_1775.y, x_1775.z, x_1776.w);
  SV_Target0.w = 1.0f;
  return;
}
