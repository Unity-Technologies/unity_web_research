...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_1244.x, x_1244.y, x_1244.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1247 : vec4<f32> = u_xlat0;
  let x_1250 : vec3<f32> = log2(abs(vec3<f32>(x_1247.x, x_1247.y, x_1247.z)));
  let x_1251 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1250.x, x_1250.y, x_1250.z, x_1251.w);
  let x_1253 : vec4<f32> = u_xlat2;
  let x_1255 : vec3<f32> = (vec3<f32>(x_1253.x, x_1253.y, x_1253.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1256 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1255.x, x_1255.y, x_1255.z, x_1256.w);
  let x_1258 : vec4<f32> = u_xlat2;
  let x_1260 : vec3<f32> = exp2(vec3<f32>(x_1258.x, x_1258.y, x_1258.z));
  let x_1261 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1260.x, x_1260.y, x_1260.z, x_1261.w);
  let x_1263 : vec4<f32> = u_xlat2;
  let x_1266 : vec3<f32> = ((vec3<f32>(x_1263.x, x_1263.y, x_1263.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1267 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1266.x, x_1266.y, x_1266.z, x_1267.w);
  let x_1269 : vec4<f32> = u_xlat0;
  let x_1271 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1269.x, x_1269.y, x_1269.z, x_1269.x));
  ...
  let x_1312 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1316 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_1329 : f32 = x_25.x_GlobalMipBias.x;
  let x_1330 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1326.x, x_1326.y), x_1329);
  u_xlat21 = x_1330.w;
  let x_1332 : f32 = u_xlat21;
  u_xlat21 = ((x_1332 * 2.0f) + -1.0f);
  let x_1335 : f32 = u_xlat21;
  u_xlatb1.x = (x_1335 >= 0.0f);
  let x_1339 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1339);
  let x_1342 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1342)) + 1.0f);
  let x_1346 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1346);
  let x_1348 : f32 = u_xlat21;
  u_xlat21 = (-(x_1348) + 1.0f);
  let x_1351 : f32 = u_xlat21;
  let x_1353 : f32 = u_xlat1.x;
  u_xlat21 = (x_1351 * x_1353);
  let x_1355 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1355.x, x_1355.y, x_1355.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1358 : vec4<f32> = u_xlat0;
  let x_1361 : vec3<f32> = log2(abs(vec3<f32>(x_1358.x, x_1358.y, x_1358.z)));
  ...
  u_xlat0.z = x_1418;
  let x_1420 : f32 = u_xlat21;
  let x_1425 : vec4<f32> = u_xlat0;
  let x_1427 : vec3<f32> = ((vec3<f32>(x_1420, x_1420, x_1420) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1425.x, x_1425.y, x_1425.z));
  let x_1428 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1427.x, x_1427.y, x_1427.z, x_1428.w);
  let x_1430 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1430.x, x_1430.y, x_1430.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1433 : vec4<f32> = u_xlat0;
  let x_1435 : vec3<f32> = (vec3<f32>(x_1433.x, x_1433.y, x_1433.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1436 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1435.x, x_1435.y, x_1435.z, x_1436.w);
  let x_1438 : vec4<f32> = u_xlat2;
  let x_1440 : vec3<f32> = (vec3<f32>(x_1438.x, x_1438.y, x_1438.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1441 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1440.x, x_1440.y, x_1440.z, x_1441.w);
  let x_1443 : vec4<f32> = u_xlat2;
  let x_1446 : vec3<f32> = log2(abs(vec3<f32>(x_1443.x, x_1443.y, x_1443.z)));
  let x_1447 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1446.x, x_1446.y, x_1446.z, x_1447.w);
  let x_1449 : vec4<f32> = u_xlat2;
  let x_1451 : vec3<f32> = (vec3<f32>(x_1449.x, x_1449.y, x_1449.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1452 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1451.x, x_1451.y, x_1451.z, x_1452.w);
  let x_1454 : vec4<f32> = u_xlat2;
  let x_1456 : vec3<f32> = exp2(vec3<f32>(x_1454.x, x_1454.y, x_1454.z));
  let x_1457 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1456.x, x_1456.y, x_1456.z, x_1457.w);
  let x_1459 : vec4<f32> = u_xlat0;
  let x_1461 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1459.x, x_1459.y, x_1459.z, x_1459.x));
  u_xlatb0 = vec3<bool>(x_1461.x, x_1461.y, x_1461.z);
  let x_1464 : bool = u_xlatb0.x;
  if (x_1464) {
    let x_1469 : f32 = u_xlat1.x;
    x_1465 = x_1469;
  } else {
  ...
  u_xlat0.x = x_1473;
  let x_1476 : bool = u_xlatb0.y;
  if (x_1476) {
    let x_1481 : f32 = u_xlat1.y;
    x_1477 = x_1481;
  } else {
    let x_1484 : f32 = u_xlat2.y;
    x_1477 = x_1484;
  }
  let x_1485 : f32 = x_1477;
  u_xlat0.y = x_1485;
  let x_1488 : bool = u_xlatb0.z;
  if (x_1488) {
    let x_1493 : f32 = u_xlat1.z;
    x_1489 = x_1493;
  } else {
  ...
  let x_1504 : vec3<f32> = max(vec3<f32>(x_1501.x, x_1501.y, x_1501.z), vec3<f32>(0.0f, 0.0f, 0.0f));
