...
layout(set = 0, binding = 9) uniform mediump  sampler sampler_EmissionMap;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat42 = u_xlat42 * _MainLightShadowParams.x + u_xlat7.x;
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat38);
    ...
    u_xlat38 = u_xlat42 * unity_LightData.z;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu38 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat40 = dot(unity_LightIndices[int(u_xlatu40)], uintBitsToFloat(ImmCB_0[u_xlati42]));
        u_xlati40 = int(u_xlat40);
        u_xlat21.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati40].www + _AdditionalLightsPosition[u_xlati40].xyz;
        ...
        u_xlat21.xyz = u_xlat0.xyz * vec3(u_xlat40) + u_xlat13.xyz;
