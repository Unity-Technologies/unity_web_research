...
fn main_1() {
  ...
  let x_831 : vec4<f32> = x_22.x_LightColor0;
  ...
  let x_840 : vec4<f32> = x_22.x_SpecColor;
  let x_842 : vec3<f32> = (vec3<f32>(x_836.x, x_836.y, x_836.z) * vec3<f32>(x_840.x, x_840.y, x_840.z));
  ...
  let x_853 : f32 = u_xlat1.w;
  u_xlat14 = max(x_853, 0.00009999999747378752f);
  let x_856 : vec4<f32> = u_xlat1;
  let x_858 : f32 = u_xlat14;
  ...
  let x_883 : vec3<f32> = ((vec3<f32>(x_876.x, x_876.y, x_876.z) * vec3<f32>(x_878.w, x_878.w, x_878.w)) + vec3<f32>(x_881.x, x_881.y, x_881.z));
  let x_884 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_883.x, x_883.y, x_883.z, x_884.w);
  let x_887 : f32 = vs_TEXCOORD9;
  let x_889 : f32 = x_22.x_ProjectionParams.y;
  u_xlat12 = (x_887 / x_889);
  let x_891 : f32 = u_xlat12;
  u_xlat12 = (-(x_891) + 1.0f);
  let x_894 : f32 = u_xlat12;
  let x_896 : f32 = x_22.x_ProjectionParams.z;
  u_xlat12 = (x_894 * x_896);
  let x_898 : f32 = u_xlat12;
  u_xlat12 = max(x_898, 0.0f);
  let x_900 : f32 = u_xlat12;
  let x_903 : f32 = x_22.unity_FogParams.x;
  u_xlat12 = (x_900 * x_903);
  let x_905 : f32 = u_xlat12;
  let x_906 : f32 = u_xlat12;
  u_xlat12 = (x_905 * -(x_906));
  let x_909 : f32 = u_xlat12;
  u_xlat12 = exp2(x_909);
  let x_911 : vec4<f32> = u_xlat0;
  let x_913 : f32 = u_xlat12;
  let x_915 : vec3<f32> = (vec3<f32>(x_911.x, x_911.y, x_911.z) * vec3<f32>(x_913, x_913, x_913));
  let x_916 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_915.x, x_915.y, x_915.z, x_916.w);
  return;
}
