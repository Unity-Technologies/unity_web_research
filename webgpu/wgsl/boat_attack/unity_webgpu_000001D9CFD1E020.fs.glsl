...
;
    ...
    u_xlatb5.x = 0.0>=u_xlat4.z;
    u_xlatb31 = u_xlat4.z>=1.0;
    u_xlatb5.x = u_xlatb31 || u_xlatb5.x;
    u_xlat80 = (u_xlatb5.x) ? 1.0 : u_xlat80;
    ...
    u_xlat78 = (u_xlatb5.x) ? 1.0 : u_xlat78;
    ...
    u_xlat8.xyz = u_xlat6.xyz * (-u_xlat5.xxx) + (-u_xlat7.xyz);
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat27.x);
    ...
    u_xlat3.xyz = u_xlat29.xyz * u_xlat2.xyz + u_xlat8.xyz;
    ...
    u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
    u_xlatb5.xw = equal(vec4(vec4(_AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat, _AdditionalLightsCookieAtlasTextureFormat)), vec4(0.0, 0.0, 0.0, 1.0)).xw;
    u_xlat8.x = float(0.0);
    u_xlat8.y = float(0.0);
    u_xlat8.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat4.x = dot(unity_LightIndices[int(u_xlatu4)], uintBitsToFloat(ImmCB_0[u_xlati84]));
        ...
        u_xlat84 = u_xlat84 * _AdditionalLightsAttenuation[u_xlati4].x;
        ...
        if(u_xlati87 != 0) {
            ...
            u_xlat87 = (u_xlatb5.w) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb5.x) ? u_xlat11.xyz : vec3(u_xlat87);
        } else {
