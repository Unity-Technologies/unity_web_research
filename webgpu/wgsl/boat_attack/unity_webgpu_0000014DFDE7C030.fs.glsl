...
;
    ...
    u_xlat7.xyz = unity_SHC.xyz * u_xlat29.xxx + u_xlat8.xyz;
    ...
    if(u_xlatb33.x){
        u_xlat33.xy = vs_TEXCOORD1.yy * _MainLightWorldToLight[1].xy;
        u_xlat33.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD1.xx + u_xlat33.xy;
        u_xlat33.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD1.zz + u_xlat33.xy;
        u_xlat33.xy = u_xlat33.xy + _MainLightWorldToLight[3].xy;
        u_xlat33.xy = u_xlat33.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat7 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat33.xy, _GlobalMipBias.x);
        ...
        u_xlat47 = (u_xlatb33.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat7.xyz = (u_xlatb33.x) ? u_xlat7.xyz : vec3(u_xlat47);
    } else {
        u_xlat7.x = float(1.0);
        u_xlat7.y = float(1.0);
        u_xlat7.z = float(1.0);
    ...
    u_xlat33.x = dot((-u_xlat17.xyz), u_xlat4.xyz);
    u_xlat33.x = u_xlat33.x + u_xlat33.x;
    u_xlat8.xyz = u_xlat4.xyz * (-u_xlat33.xxx) + (-u_xlat17.xyz);
    u_xlat33.x = dot(u_xlat4.xyz, u_xlat17.xyz);
    u_xlat33.x = clamp(u_xlat33.x, 0.0, 1.0);
    ...
    u_xlat29.x = u_xlat19.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat29.x = clamp(u_xlat29.x, 0.0, 1.0);
