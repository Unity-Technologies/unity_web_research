...
layout(set = 0, binding = 4) uniform mediump  sampler sampler_LinearRepeat;
void main()
{
    u_xlatu0.z = uint(0u);
    u_xlatu0.w = uint(0u);
    ...
    u_xlat27 = texture(sampler2D(_Grain_Texture, sampler_LinearRepeat), u_xlat1.xy, _GlobalMipBias.x).w;
