...
fn main_1() {
  ...
  let x_1358 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1362 : vec4<f32> = x_14.x_Dithering_Params;
  ...
  let x_1376 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1372.x, x_1372.y), x_1375);
  u_xlat15 = x_1376.w;
  let x_1378 : f32 = u_xlat15;
  u_xlat15 = ((x_1378 * 2.0f) + -1.0f);
  let x_1381 : f32 = u_xlat15;
  u_xlatb1 = (x_1381 >= 0.0f);
  let x_1383 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1383);
  let x_1386 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1386)) + 1.0f);
  let x_1390 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1390);
  let x_1392 : f32 = u_xlat15;
  u_xlat15 = (-(x_1392) + 1.0f);
  let x_1395 : f32 = u_xlat15;
  let x_1397 : f32 = u_xlat1.x;
  u_xlat15 = (x_1395 * x_1397);
  let x_1399 : vec3<f32> = u_xlat0;
  let x_1400 : vec3<f32> = (x_1399 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1401 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1400.x, x_1400.y, x_1400.z, x_1401.w);
  let x_1403 : vec3<f32> = u_xlat0;
  let x_1405 : vec3<f32> = log2(abs(x_1403));
  let x_1406 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1405.x, x_1405.y, x_1405.z, x_1406.w);
  let x_1408 : vec4<f32> = u_xlat2;
  let x_1410 : vec3<f32> = (vec3<f32>(x_1408.x, x_1408.y, x_1408.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1411 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1410.x, x_1410.y, x_1410.z, x_1411.w);
  let x_1413 : vec4<f32> = u_xlat2;
  let x_1415 : vec3<f32> = exp2(vec3<f32>(x_1413.x, x_1413.y, x_1413.z));
  let x_1416 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1415.x, x_1415.y, x_1415.z, x_1416.w);
  let x_1418 : vec4<f32> = u_xlat2;
  let x_1421 : vec3<f32> = ((vec3<f32>(x_1418.x, x_1418.y, x_1418.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1422 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1421.x, x_1421.y, x_1421.z, x_1422.w);
  let x_1424 : vec3<f32> = u_xlat0;
  let x_1426 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1424.x, x_1424.y, x_1424.z, x_1424.x));
  u_xlatb0 = vec3<bool>(x_1426.x, x_1426.y, x_1426.z);
  let x_1429 : bool = u_xlatb0.x;
  if (x_1429) {
    let x_1434 : f32 = u_xlat1.x;
    x_1430 = x_1434;
  } else {
    let x_1437 : f32 = u_xlat2.x;
    x_1430 = x_1437;
  }
  let x_1438 : f32 = x_1430;
  u_xlat0.x = x_1438;
  let x_1441 : bool = u_xlatb0.y;
  if (x_1441) {
    let x_1446 : f32 = u_xlat1.y;
    x_1442 = x_1446;
  } else {
  ...
  u_xlat0.z = x_1462;
  let x_1464 : f32 = u_xlat15;
  let x_1469 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1464, x_1464, x_1464) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1469);
  let x_1471 : vec3<f32> = u_xlat0;
  let x_1472 : vec3<f32> = (x_1471 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1473 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1472.x, x_1472.y, x_1472.z, x_1473.w);
  let x_1475 : vec3<f32> = u_xlat0;
  let x_1476 : vec3<f32> = (x_1475 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1477 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1476.x, x_1476.y, x_1476.z, x_1477.w);
  let x_1479 : vec4<f32> = u_xlat2;
  let x_1481 : vec3<f32> = (vec3<f32>(x_1479.x, x_1479.y, x_1479.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1482 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1481.x, x_1481.y, x_1481.z, x_1482.w);
  let x_1484 : vec4<f32> = u_xlat2;
  let x_1487 : vec3<f32> = log2(abs(vec3<f32>(x_1484.x, x_1484.y, x_1484.z)));
  let x_1488 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1487.x, x_1487.y, x_1487.z, x_1488.w);
  let x_1490 : vec4<f32> = u_xlat2;
  let x_1492 : vec3<f32> = (vec3<f32>(x_1490.x, x_1490.y, x_1490.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1502 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1500.x, x_1500.y, x_1500.z, x_1500.x));
  ...
  let x_1543 : vec3<f32> = max(x_1542, vec3<f32>(0.0f, 0.0f, 0.0f));
