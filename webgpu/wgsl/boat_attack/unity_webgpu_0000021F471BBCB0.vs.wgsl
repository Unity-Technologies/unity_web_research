...
@group(1) @binding(7) var<uniform> x_185 : VGlobals;
...
fn main_1() {
  ...
  let x_187 : vec4<f32> = x_185.unity_MatrixVP[1i];
  u_xlat1 = (vec4<f32>(x_181.y, x_181.y, x_181.y, x_181.y) * x_187);
  let x_190 : vec4<f32> = x_185.unity_MatrixVP[0i];
  let x_191 : vec4<f32> = u_xlat0;
  let x_194 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_190 * vec4<f32>(x_191.x, x_191.x, x_191.x, x_191.x)) + x_194);
  let x_197 : vec4<f32> = x_185.unity_MatrixVP[2i];
  let x_198 : vec4<f32> = u_xlat0;
  let x_201 : vec4<f32> = u_xlat1;
  u_xlat0 = ((x_197 * vec4<f32>(x_198.z, x_198.z, x_198.z, x_198.z)) + x_201);
  let x_207 : vec4<f32> = u_xlat0;
  let x_209 : vec4<f32> = x_185.unity_MatrixVP[3i];
  gl_Position = (x_207 + x_209);
  return;
}
