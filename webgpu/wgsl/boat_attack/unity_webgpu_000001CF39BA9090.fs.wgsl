...
fn main_1() {
  ...
  let x_936 : vec3<f32> = (vec3<f32>(x_934.x, x_934.y, x_934.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  ...
  let x_947 : vec3<f32> = (vec3<f32>(x_945.x, x_945.y, x_945.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_958 : vec3<f32> = ((vec3<f32>(x_955.x, x_955.y, x_955.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_959 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_958.x, x_958.y, x_958.z, x_959.w);
  let x_962 : vec4<f32> = u_xlat0;
  let x_964 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_962.x, x_962.y, x_962.z, x_962.x));
  ...
  let x_1005 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1009 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1011 : vec2<f32> = ((x_1002 * vec2<f32>(x_1005.x, x_1005.y)) + vec2<f32>(x_1009.z, x_1009.w));
  let x_1012 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1011.x, x_1011.y, x_1012.z, x_1012.w);
  let x_1019 : vec4<f32> = u_xlat1;
  let x_1022 : f32 = x_38.x_GlobalMipBias.x;
  let x_1023 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1019.x, x_1019.y), x_1022);
  u_xlat18 = x_1023.w;
  let x_1025 : f32 = u_xlat18;
  u_xlat18 = ((x_1025 * 2.0f) + -1.0f);
  let x_1028 : f32 = u_xlat18;
  u_xlatb1.x = (x_1028 >= 0.0f);
  let x_1032 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1032);
  let x_1035 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1035)) + 1.0f);
  let x_1039 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1039);
  let x_1041 : f32 = u_xlat18;
  u_xlat18 = (-(x_1041) + 1.0f);
  let x_1044 : f32 = u_xlat18;
  let x_1046 : f32 = u_xlat1.x;
  u_xlat18 = (x_1044 * x_1046);
  let x_1048 : vec4<f32> = u_xlat0;
  let x_1050 : vec3<f32> = (vec3<f32>(x_1048.x, x_1048.y, x_1048.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1051 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1050.x, x_1050.y, x_1050.z, x_1051.w);
  let x_1053 : vec4<f32> = u_xlat0;
  let x_1056 : vec3<f32> = log2(abs(vec3<f32>(x_1053.x, x_1053.y, x_1053.z)));
  let x_1057 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1056.x, x_1056.y, x_1056.z, x_1057.w);
  let x_1059 : vec4<f32> = u_xlat2;
  let x_1061 : vec3<f32> = (vec3<f32>(x_1059.x, x_1059.y, x_1059.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1072 : vec3<f32> = ((vec3<f32>(x_1069.x, x_1069.y, x_1069.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1073 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1072.x, x_1072.y, x_1072.z, x_1073.w);
  let x_1075 : vec4<f32> = u_xlat0;
  let x_1077 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1075.x, x_1075.y, x_1075.z, x_1075.x));
  ...
  u_xlat0.z = x_1113;
  let x_1115 : f32 = u_xlat18;
  let x_1120 : vec4<f32> = u_xlat0;
  let x_1122 : vec3<f32> = ((vec3<f32>(x_1115, x_1115, x_1115) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1120.x, x_1120.y, x_1120.z));
  let x_1123 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1122.x, x_1122.y, x_1122.z, x_1123.w);
  let x_1125 : vec4<f32> = u_xlat0;
  let x_1127 : vec3<f32> = (vec3<f32>(x_1125.x, x_1125.y, x_1125.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1128 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1127.x, x_1127.y, x_1127.z, x_1128.w);
  let x_1130 : vec4<f32> = u_xlat0;
  let x_1132 : vec3<f32> = (vec3<f32>(x_1130.x, x_1130.y, x_1130.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1133 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1132.x, x_1132.y, x_1132.z, x_1133.w);
  let x_1135 : vec4<f32> = u_xlat2;
  let x_1137 : vec3<f32> = (vec3<f32>(x_1135.x, x_1135.y, x_1135.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1138 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1137.x, x_1137.y, x_1137.z, x_1138.w);
  let x_1140 : vec4<f32> = u_xlat2;
  let x_1143 : vec3<f32> = log2(abs(vec3<f32>(x_1140.x, x_1140.y, x_1140.z)));
  let x_1144 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1143.x, x_1143.y, x_1143.z, x_1144.w);
  let x_1146 : vec4<f32> = u_xlat2;
  let x_1148 : vec3<f32> = (vec3<f32>(x_1146.x, x_1146.y, x_1146.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1149 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1148.x, x_1148.y, x_1148.z, x_1149.w);
  let x_1151 : vec4<f32> = u_xlat2;
  let x_1153 : vec3<f32> = exp2(vec3<f32>(x_1151.x, x_1151.y, x_1151.z));
  let x_1154 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1153.x, x_1153.y, x_1153.z, x_1154.w);
  let x_1156 : vec4<f32> = u_xlat0;
  let x_1158 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1156.x, x_1156.y, x_1156.z, x_1156.x));
  u_xlatb0 = vec3<bool>(x_1158.x, x_1158.y, x_1158.z);
  let x_1161 : bool = u_xlatb0.x;
  if (x_1161) {
  ...
  let x_1201 : vec3<f32> = max(vec3<f32>(x_1198.x, x_1198.y, x_1198.z), vec3<f32>(0.0f, 0.0f, 0.0f));
