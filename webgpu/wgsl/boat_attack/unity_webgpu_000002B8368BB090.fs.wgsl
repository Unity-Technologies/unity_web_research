...
fn main_1() {
  ...
  let x_921 : vec3<f32> = (vec3<f32>(x_919.x, x_919.y, x_919.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_922 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_921.x, x_921.y, x_921.z, x_922.w);
  let x_924 : vec4<f32> = u_xlat0;
  let x_927 : vec3<f32> = log2(abs(vec3<f32>(x_924.x, x_924.y, x_924.z)));
  let x_928 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_927.x, x_927.y, x_927.z, x_928.w);
  let x_930 : vec4<f32> = u_xlat2;
  let x_932 : vec3<f32> = (vec3<f32>(x_930.x, x_930.y, x_930.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_943 : vec3<f32> = ((vec3<f32>(x_940.x, x_940.y, x_940.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_944 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_943.x, x_943.y, x_943.z, x_944.w);
  let x_947 : vec4<f32> = u_xlat0;
  let x_949 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_947.x, x_947.y, x_947.z, x_947.x));
  ...
  let x_985 : f32 = x_977;
  u_xlat0.z = x_985;
  let x_987 : vec2<f32> = vs_TEXCOORD0;
  let x_990 : vec4<f32> = x_25.x_Dithering_Params;
  let x_994 : vec4<f32> = x_25.x_Dithering_Params;
  let x_996 : vec2<f32> = ((x_987 * vec2<f32>(x_990.x, x_990.y)) + vec2<f32>(x_994.z, x_994.w));
  let x_997 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_996.x, x_996.y, x_997.z, x_997.w);
  let x_1004 : vec4<f32> = u_xlat1;
  let x_1007 : f32 = x_25.x_GlobalMipBias.x;
  let x_1008 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1004.x, x_1004.y), x_1007);
  u_xlat15 = x_1008.w;
  let x_1010 : f32 = u_xlat15;
  u_xlat15 = ((x_1010 * 2.0f) + -1.0f);
  let x_1014 : f32 = u_xlat15;
  u_xlatb1.x = (x_1014 >= 0.0f);
  let x_1018 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1018);
  let x_1021 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1021)) + 1.0f);
  let x_1025 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1025);
  let x_1027 : f32 = u_xlat15;
  u_xlat15 = (-(x_1027) + 1.0f);
  let x_1030 : f32 = u_xlat15;
  let x_1032 : f32 = u_xlat1.x;
  u_xlat15 = (x_1030 * x_1032);
  let x_1034 : vec4<f32> = u_xlat0;
  let x_1036 : vec3<f32> = (vec3<f32>(x_1034.x, x_1034.y, x_1034.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1037 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1036.x, x_1036.y, x_1036.z, x_1037.w);
  let x_1039 : vec4<f32> = u_xlat0;
  let x_1042 : vec3<f32> = log2(abs(vec3<f32>(x_1039.x, x_1039.y, x_1039.z)));
  let x_1043 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1042.x, x_1042.y, x_1042.z, x_1043.w);
  let x_1045 : vec4<f32> = u_xlat2;
  let x_1047 : vec3<f32> = (vec3<f32>(x_1045.x, x_1045.y, x_1045.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1058 : vec3<f32> = ((vec3<f32>(x_1055.x, x_1055.y, x_1055.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1059 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1058.x, x_1058.y, x_1058.z, x_1059.w);
  let x_1061 : vec4<f32> = u_xlat0;
  let x_1063 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1061.x, x_1061.y, x_1061.z, x_1061.x));
  u_xlatb0 = vec3<bool>(x_1063.x, x_1063.y, x_1063.z);
  ...
  u_xlat0.x = x_1075;
  let x_1078 : bool = u_xlatb0.y;
  if (x_1078) {
    let x_1083 : f32 = u_xlat1.y;
    x_1079 = x_1083;
  } else {
    let x_1086 : f32 = u_xlat2.y;
    x_1079 = x_1086;
  }
  let x_1087 : f32 = x_1079;
  u_xlat0.y = x_1087;
  let x_1090 : bool = u_xlatb0.z;
  if (x_1090) {
  ...
  u_xlat0.z = x_1099;
  let x_1101 : f32 = u_xlat15;
  let x_1106 : vec4<f32> = u_xlat0;
  let x_1108 : vec3<f32> = ((vec3<f32>(x_1101, x_1101, x_1101) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1106.x, x_1106.y, x_1106.z));
  let x_1109 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1108.x, x_1108.y, x_1108.z, x_1109.w);
  let x_1111 : vec4<f32> = u_xlat0;
  let x_1113 : vec3<f32> = (vec3<f32>(x_1111.x, x_1111.y, x_1111.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1114 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1113.x, x_1113.y, x_1113.z, x_1114.w);
  let x_1116 : vec4<f32> = u_xlat0;
  let x_1118 : vec3<f32> = (vec3<f32>(x_1116.x, x_1116.y, x_1116.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1119 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1118.x, x_1118.y, x_1118.z, x_1119.w);
  let x_1121 : vec4<f32> = u_xlat2;
  let x_1123 : vec3<f32> = (vec3<f32>(x_1121.x, x_1121.y, x_1121.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1124 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1123.x, x_1123.y, x_1123.z, x_1124.w);
  let x_1126 : vec4<f32> = u_xlat2;
  let x_1129 : vec3<f32> = log2(abs(vec3<f32>(x_1126.x, x_1126.y, x_1126.z)));
  let x_1130 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1129.x, x_1129.y, x_1129.z, x_1130.w);
  let x_1132 : vec4<f32> = u_xlat2;
  let x_1134 : vec3<f32> = (vec3<f32>(x_1132.x, x_1132.y, x_1132.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1135 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1134.x, x_1134.y, x_1134.z, x_1135.w);
  let x_1137 : vec4<f32> = u_xlat2;
  let x_1139 : vec3<f32> = exp2(vec3<f32>(x_1137.x, x_1137.y, x_1137.z));
  let x_1140 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1139.x, x_1139.y, x_1139.z, x_1140.w);
  let x_1142 : vec4<f32> = u_xlat0;
  let x_1144 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1142.x, x_1142.y, x_1142.z, x_1142.x));
  ...
  u_xlat0.x = x_1156;
  let x_1159 : bool = u_xlatb0.y;
  if (x_1159) {
    let x_1164 : f32 = u_xlat1.y;
    x_1160 = x_1164;
  } else {
    let x_1167 : f32 = u_xlat2.y;
    x_1160 = x_1167;
  }
  let x_1168 : f32 = x_1160;
  u_xlat0.y = x_1168;
  let x_1171 : bool = u_xlatb0.z;
  if (x_1171) {
    let x_1176 : f32 = u_xlat1.z;
    x_1172 = x_1176;
  } else {
  ...
  let x_1187 : vec3<f32> = max(vec3<f32>(x_1184.x, x_1184.y, x_1184.z), vec3<f32>(0.0f, 0.0f, 0.0f));
