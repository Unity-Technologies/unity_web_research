...
void main()
{
    ...
    u_xlat13.xyz = unity_SHC.xyz * u_xlat13.xxx + u_xlat5.xyz;
    ...
    u_xlat6.xyz = u_xlat2.xyz * (-vec3(u_xlat40)) + (-u_xlat5.xyz);
    ...
    u_xlat1.xyz = u_xlat13.xyz * u_xlat15.xyz + u_xlat6.xyz;
    ...
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    u_xlat37 = dot(_MainLightPosition.xyz, u_xlat19.xyz);
    u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
    ...
    u_xlat37 = u_xlat28 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
    ...
    u_xlat0.xyz = u_xlat19.xyz * u_xlat6.xyz + u_xlat1.xyz;
