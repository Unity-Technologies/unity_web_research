...
void main()
{
    ...
    u_xlat22.xyz = (-u_xlat4.xyz) + vec3(u_xlat28);
    u_xlat22.xyz = vec3(u_xlat48) * u_xlat22.xyz + u_xlat4.xyz;
    u_xlat22.xyz = u_xlat0.xxx * u_xlat22.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat22.xyz;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat3.xyz + u_xlat7.xyz;
    u_xlat0.x = u_xlat46 * unity_LightData.z;
    ...
    u_xlat7.xyz = u_xlat4.xyz * u_xlat0.xxx + u_xlat3.xyz;
    u_xlat19.xyz = u_xlat19.xyz * u_xlat7.xyz;
    u_xlat0.x = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu0 =  uint(int(u_xlat0.x));
    u_xlat28 = u_xlat5.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat28 = clamp(u_xlat28, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat46 = dot(unity_LightIndices[int(u_xlatu46)], uintBitsToFloat(ImmCB_0[u_xlati5]));
        ...
        u_xlat48 = inversesqrt(u_xlat5.x);
        u_xlat10.xyz = vec3(u_xlat48) * u_xlat9.xyz;
        u_xlat35 = float(1.0) / float(u_xlat5.x);
        u_xlat5.x = u_xlat5.x * _AdditionalLightsAttenuation[u_xlati46].x;
        ...
        if(u_xlatb49){
            ...
            u_xlat11 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati35 + 1) / 4][(u_xlati35 + 1) % 4];
            u_xlat11 = _AdditionalLightsWorldToShadow[u_xlati35 / 4][u_xlati35 % 4] * vs_TEXCOORD7.xxxx + u_xlat11;
            u_xlat11 = _AdditionalLightsWorldToShadow[(u_xlati35 + 2) / 4][(u_xlati35 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat11;
        ...
        u_xlat46 = u_xlat5.x * u_xlat35;
        u_xlat5.x = dot(u_xlat1.xyz, u_xlat10.xyz);
        ...
        u_xlat9.xyz = u_xlat4.xyz * vec3(u_xlat46) + u_xlat3.xyz;
