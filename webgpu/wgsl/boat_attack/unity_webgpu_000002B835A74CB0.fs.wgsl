...
fn main_1() {
  ...
  u_xlat3 = (vec3<f32>(x_105.y, x_105.x, x_105.z) + vec3<f32>(-0.87253999710083007812f, 0.53136998414993286133f, -1.06861996650695800781f));
  let x_112 : vec3<f32> = u_xlat3;
  u_xlat0 = ((x_112 * vec3<f32>(0.30530601739883422852f, 0.30530601739883422852f, 0.30530601739883422852f)) + vec3<f32>(0.68217110633850097656f, 0.68217110633850097656f, 0.68217110633850097656f));
  let x_119 : vec3<f32> = u_xlat3;
  let x_120 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_119 * x_120) + vec3<f32>(0.01252287812530994415f, 0.01252287812530994415f, 0.01252287812530994415f));
  ...
  u_xlat0.x = (x_144 + -0.06274499744176864624f);
