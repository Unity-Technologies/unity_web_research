...
fn main_1() {
  ...
  u_xlat3 = (-(x_310) + 1.0f);
  let x_313 : f32 = u_xlat3;
  let x_315 : f32 = u_xlat0.x;
  u_xlat3 = (x_313 * x_315);
  let x_318 : f32 = u_xlat0.x;
  u_xlat0.x = (x_318 + 0.00000099999999747524f);
  let x_322 : f32 = u_xlat3;
  let x_324 : f32 = u_xlat0.x;
  u_xlat0.x = (x_322 / x_324);
  let x_328 : f32 = u_xlat0.x;
  u_xlat0.x = log2(x_328);
  let x_332 : f32 = u_xlat0.x;
  let x_334 : f32 = x_162.x_FlareData3.z;
  u_xlat0.x = (x_332 * x_334);
  let x_338 : f32 = u_xlat0.x;
  u_xlat0.x = exp2(x_338);
  let x_342 : f32 = u_xlat0.x;
  u_xlat0.x = min(x_342, 1.0f);
  let x_345 : vec4<f32> = u_xlat0;
  let x_349 : vec4<f32> = x_162.x_FlareColorValue;
  u_xlat0 = (vec4<f32>(x_345.x, x_345.x, x_345.x, x_345.x) * x_349);
  let x_353 : vec4<f32> = u_xlat0;
  let x_356 : f32 = vs_TEXCOORD1;
  SV_Target0 = (x_353 * vec4<f32>(x_356, x_356, x_356, x_356));
  return;
}
