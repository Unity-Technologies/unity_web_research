...
;
    ...
    u_xlat4.xyz = u_xlat13.xxx * u_xlat15.xyz;
    ...
    u_xlat15.xyz = vec3(u_xlat37) * u_xlat15.xyz;
    u_xlat5.x = (u_xlatb13.x) ? u_xlat15.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb13.x) ? u_xlat15.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb13.x) ? u_xlat15.z : unity_MatrixV[2].z;
    u_xlat4.w = 1.0;
    ...
    u_xlat15.xyz = unity_SHC.xyz * u_xlat13.xxx + u_xlat8.xyz;
    ...
    u_xlat18.x = dot((-u_xlat5.xyz), u_xlat4.xyz);
    u_xlat18.x = u_xlat18.x + u_xlat18.x;
    u_xlat18.xyz = u_xlat4.xyz * (-u_xlat18.xxx) + (-u_xlat5.xyz);
    ...
    u_xlat2.xyz = u_xlat3.xyz * vec3(u_xlat41) + u_xlat18.xyz;
