...
fn main_1() {
  ...
  let x_1476 : vec3<f32> = (x_1475 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1477 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1476.x, x_1476.y, x_1476.z, x_1477.w);
  let x_1479 : vec3<f32> = u_xlat0;
  let x_1481 : vec3<f32> = log2(abs(x_1479));
  let x_1482 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1481.x, x_1481.y, x_1481.z, x_1482.w);
  let x_1484 : vec4<f32> = u_xlat2;
  let x_1486 : vec3<f32> = (vec3<f32>(x_1484.x, x_1484.y, x_1484.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1497 : vec3<f32> = ((vec3<f32>(x_1494.x, x_1494.y, x_1494.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1498 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1497.x, x_1497.y, x_1497.z, x_1498.w);
  let x_1500 : vec3<f32> = u_xlat0;
  let x_1502 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1500.x, x_1500.y, x_1500.z, x_1500.x));
  u_xlatb0 = vec3<bool>(x_1502.x, x_1502.y, x_1502.z);
  let x_1507 : bool = u_xlatb0.x;
  if (x_1507) {
    let x_1512 : f32 = u_xlat1.x;
    x_1508 = x_1512;
  } else {
    let x_1515 : f32 = u_xlat2.x;
    x_1508 = x_1515;
  }
  let x_1516 : f32 = x_1508;
  SV_Target0.x = x_1516;
  let x_1520 : bool = u_xlatb0.y;
  if (x_1520) {
    let x_1525 : f32 = u_xlat1.y;
    x_1521 = x_1525;
  } else {
    let x_1528 : f32 = u_xlat2.y;
    x_1521 = x_1528;
  }
  let x_1529 : f32 = x_1521;
  SV_Target0.y = x_1529;
  let x_1532 : bool = u_xlatb0.z;
  if (x_1532) {
