...
fn main_1() {
  ...
  let x_1861 : vec3<f32> = (x_1860 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1862 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1861.x, x_1861.y, x_1861.z, x_1862.w);
  let x_1864 : vec3<f32> = u_xlat0;
  let x_1866 : vec3<f32> = log2(abs(x_1864));
  let x_1867 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1866.x, x_1866.y, x_1866.z, x_1867.w);
  let x_1869 : vec4<f32> = u_xlat2;
  let x_1871 : vec3<f32> = (vec3<f32>(x_1869.x, x_1869.y, x_1869.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1872 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1871.x, x_1871.y, x_1871.z, x_1872.w);
  let x_1874 : vec4<f32> = u_xlat2;
  let x_1876 : vec3<f32> = exp2(vec3<f32>(x_1874.x, x_1874.y, x_1874.z));
  let x_1877 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1876.x, x_1876.y, x_1876.z, x_1877.w);
  let x_1879 : vec4<f32> = u_xlat2;
  let x_1882 : vec3<f32> = ((vec3<f32>(x_1879.x, x_1879.y, x_1879.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1883 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1882.x, x_1882.y, x_1882.z, x_1883.w);
  let x_1885 : vec3<f32> = u_xlat0;
  let x_1887 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1885.x, x_1885.y, x_1885.z, x_1885.x));
  u_xlatb0 = vec3<bool>(x_1887.x, x_1887.y, x_1887.z);
  let x_1890 : bool = u_xlatb0.x;
  if (x_1890) {
  ...
  u_xlat0.x = x_1899;
  let x_1902 : bool = u_xlatb0.y;
  if (x_1902) {
    let x_1907 : f32 = u_xlat1.y;
    x_1903 = x_1907;
  } else {
  ...
  u_xlat0.y = x_1911;
  let x_1914 : bool = u_xlatb0.z;
  if (x_1914) {
    let x_1919 : f32 = u_xlat1.z;
    x_1915 = x_1919;
  } else {
    let x_1922 : f32 = u_xlat2.z;
    x_1915 = x_1922;
  }
  let x_1923 : f32 = x_1915;
  u_xlat0.z = x_1923;
  let x_1925 : vec2<f32> = vs_TEXCOORD0;
  let x_1928 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1932 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1934 : vec2<f32> = ((x_1925 * vec2<f32>(x_1928.x, x_1928.y)) + vec2<f32>(x_1932.z, x_1932.w));
  let x_1935 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1934.x, x_1934.y, x_1935.z, x_1935.w);
  let x_1942 : vec4<f32> = u_xlat1;
  let x_1945 : f32 = x_26.x_GlobalMipBias.x;
  let x_1946 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1942.x, x_1942.y), x_1945);
  u_xlat21 = x_1946.w;
  let x_1948 : f32 = u_xlat21;
  u_xlat21 = ((x_1948 * 2.0f) + -1.0f);
  let x_1951 : f32 = u_xlat21;
  u_xlatb1 = (x_1951 >= 0.0f);
  let x_1953 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1953);
  let x_1956 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1956)) + 1.0f);
  let x_1960 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1960);
  let x_1962 : f32 = u_xlat21;
  u_xlat21 = (-(x_1962) + 1.0f);
  let x_1965 : f32 = u_xlat21;
  let x_1967 : f32 = u_xlat1.x;
  u_xlat21 = (x_1965 * x_1967);
  let x_1969 : vec3<f32> = u_xlat0;
  let x_1970 : vec3<f32> = (x_1969 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1971 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1970.x, x_1970.y, x_1970.z, x_1971.w);
  let x_1973 : vec3<f32> = u_xlat0;
  let x_1975 : vec3<f32> = log2(abs(x_1973));
  let x_1976 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1975.x, x_1975.y, x_1975.z, x_1976.w);
  let x_1978 : vec4<f32> = u_xlat2;
  let x_1980 : vec3<f32> = (vec3<f32>(x_1978.x, x_1978.y, x_1978.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1981 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1980.x, x_1980.y, x_1980.z, x_1981.w);
  let x_1983 : vec4<f32> = u_xlat2;
  let x_1985 : vec3<f32> = exp2(vec3<f32>(x_1983.x, x_1983.y, x_1983.z));
  let x_1986 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1985.x, x_1985.y, x_1985.z, x_1986.w);
  let x_1988 : vec4<f32> = u_xlat2;
  let x_1991 : vec3<f32> = ((vec3<f32>(x_1988.x, x_1988.y, x_1988.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1992 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1991.x, x_1991.y, x_1991.z, x_1992.w);
  let x_1994 : vec3<f32> = u_xlat0;
  let x_1996 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1994.x, x_1994.y, x_1994.z, x_1994.x));
  u_xlatb0 = vec3<bool>(x_1996.x, x_1996.y, x_1996.z);
  let x_1999 : bool = u_xlatb0.x;
  if (x_1999) {
    let x_2004 : f32 = u_xlat1.x;
    x_2000 = x_2004;
  } else {
    let x_2007 : f32 = u_xlat2.x;
    x_2000 = x_2007;
  }
  let x_2008 : f32 = x_2000;
  u_xlat0.x = x_2008;
  let x_2011 : bool = u_xlatb0.y;
  if (x_2011) {
    let x_2016 : f32 = u_xlat1.y;
    x_2012 = x_2016;
  } else {
    let x_2019 : f32 = u_xlat2.y;
    x_2012 = x_2019;
  }
  let x_2020 : f32 = x_2012;
  u_xlat0.y = x_2020;
  let x_2023 : bool = u_xlatb0.z;
  if (x_2023) {
    let x_2028 : f32 = u_xlat1.z;
    x_2024 = x_2028;
  } else {
  ...
  u_xlat0.z = x_2032;
  let x_2034 : f32 = u_xlat21;
  let x_2039 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_2034, x_2034, x_2034) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_2039);
  let x_2041 : vec3<f32> = u_xlat0;
  let x_2042 : vec3<f32> = (x_2041 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2043 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2042.x, x_2042.y, x_2042.z, x_2043.w);
  let x_2045 : vec3<f32> = u_xlat0;
  let x_2046 : vec3<f32> = (x_2045 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2047 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2046.x, x_2046.y, x_2046.z, x_2047.w);
  let x_2049 : vec4<f32> = u_xlat2;
  let x_2051 : vec3<f32> = (vec3<f32>(x_2049.x, x_2049.y, x_2049.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2052 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2051.x, x_2051.y, x_2051.z, x_2052.w);
  let x_2054 : vec4<f32> = u_xlat2;
  let x_2057 : vec3<f32> = log2(abs(vec3<f32>(x_2054.x, x_2054.y, x_2054.z)));
  let x_2058 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2057.x, x_2057.y, x_2057.z, x_2058.w);
  let x_2060 : vec4<f32> = u_xlat2;
  let x_2062 : vec3<f32> = (vec3<f32>(x_2060.x, x_2060.y, x_2060.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2063 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2062.x, x_2062.y, x_2062.z, x_2063.w);
  let x_2065 : vec4<f32> = u_xlat2;
  let x_2067 : vec3<f32> = exp2(vec3<f32>(x_2065.x, x_2065.y, x_2065.z));
  let x_2068 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2067.x, x_2067.y, x_2067.z, x_2068.w);
  let x_2070 : vec3<f32> = u_xlat0;
  let x_2072 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2070.x, x_2070.y, x_2070.z, x_2070.x));
  u_xlatb0 = vec3<bool>(x_2072.x, x_2072.y, x_2072.z);
  let x_2075 : bool = u_xlatb0.x;
  if (x_2075) {
    let x_2080 : f32 = u_xlat1.x;
    x_2076 = x_2080;
  } else {
    let x_2083 : f32 = u_xlat2.x;
    x_2076 = x_2083;
  }
  let x_2084 : f32 = x_2076;
  u_xlat0.x = x_2084;
  let x_2087 : bool = u_xlatb0.y;
  if (x_2087) {
    let x_2092 : f32 = u_xlat1.y;
    x_2088 = x_2092;
  } else {
    let x_2095 : f32 = u_xlat2.y;
    x_2088 = x_2095;
  }
  let x_2096 : f32 = x_2088;
  u_xlat0.y = x_2096;
  let x_2099 : bool = u_xlatb0.z;
  if (x_2099) {
  ...
  u_xlat0.z = x_2108;
  let x_2112 : vec3<f32> = u_xlat0;
  let x_2113 : vec3<f32> = max(x_2112, vec3<f32>(0.0f, 0.0f, 0.0f));
