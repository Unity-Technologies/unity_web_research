...
;
    ...
    u_xlat80 = dot(u_xlat27.xyz, u_xlat3.xyz);
    u_xlat80 = u_xlat80 + 0.5;
    u_xlat3.xyz = vec3(u_xlat80) * u_xlat4.xyz;
    ...
    if(u_xlatb5){
        ...
        if(u_xlatb5){
            ...
            if(u_xlatb31){
                u_xlat31.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat31.xy = floor(u_xlat31.xy);
                u_xlat6.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat31.xy);
                ...
                vec3 txVec28 = vec3(u_xlat31.xy,u_xlat2.z);
    ...
    u_xlat2.x = u_xlat5.x * _MainLightShadowParams.x + u_xlat2.x;
    ...
    u_xlat2.x = u_xlat54 * u_xlat5.x + u_xlat2.x;
    ...
    if(u_xlatb54){
        ...
        u_xlat54 = (u_xlatb6.y) ? u_xlat5.w : u_xlat5.x;
        u_xlat5.xyz = (u_xlatb6.x) ? u_xlat5.xyz : vec3(u_xlat54);
    } else {
        u_xlat5.x = float(1.0);
        u_xlat5.y = float(1.0);
        u_xlat5.z = float(1.0);
    ...
    u_xlat2.xzw = vec3(u_xlat78) * u_xlat5.xyz;
    ...
    u_xlat78 = dot(u_xlat27.xyz, u_xlat5.xyz);
    u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
