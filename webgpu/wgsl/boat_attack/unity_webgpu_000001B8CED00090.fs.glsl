...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat3.x = (u_xlatb12) ? u_xlat2.x : unity_MatrixV[0].z;
    u_xlat3.y = (u_xlatb12) ? u_xlat2.y : unity_MatrixV[1].z;
    u_xlat3.z = (u_xlatb12) ? u_xlat2.z : unity_MatrixV[2].z;
...
;
    ...
    u_xlat13.x = dot((-u_xlat3.xyz), u_xlat12.xyz);
    u_xlat13.x = u_xlat13.x + u_xlat13.x;
    u_xlat8.xyz = u_xlat12.xyz * (-u_xlat13.xxx) + (-u_xlat3.xyz);
    u_xlat13.x = dot(u_xlat12.xyz, u_xlat3.xyz);
    u_xlat13.x = clamp(u_xlat13.x, 0.0, 1.0);
    ...
    u_xlat2.xyw = vec3(u_xlat33) * u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat27.x = dot(unity_LightIndices[int(u_xlatu27)], uintBitsToFloat(ImmCB_0[u_xlati38]));
        u_xlati27 = int(u_xlat27.x);
        u_xlat8.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati27].www + _AdditionalLightsPosition[u_xlati27].xyz;
        ...
        u_xlat40 = dot(_AdditionalLightsSpotDir[u_xlati27].xyz, u_xlat9.xyz);
        u_xlat40 = u_xlat40 * _AdditionalLightsAttenuation[u_xlati27].z + _AdditionalLightsAttenuation[u_xlati27].w;
        u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
        u_xlat40 = u_xlat40 * u_xlat40;
        u_xlat38 = u_xlat38 * u_xlat40;
        u_xlat10.xyz = vec3(u_xlat16) * _AdditionalLightsColor[u_xlati27].xyz;
        u_xlat27.x = dot(u_xlat12.xyz, u_xlat9.xyz);
        ...
        u_xlat8.xyz = u_xlat0.xyz * u_xlat27.xxx + u_xlat6.xyz;
