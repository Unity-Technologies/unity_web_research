...
fn main_1() {
  ...
  let x_1400 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1404 : vec4<f32> = x_14.x_Dithering_Params;
  ...
  let x_1417 : f32 = x_14.x_GlobalMipBias.x;
  ...
  let x_1442 : vec3<f32> = (x_1441 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1443 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1442.x, x_1442.y, x_1442.z, x_1443.w);
  let x_1445 : vec3<f32> = u_xlat0;
  let x_1446 : vec3<f32> = log2(x_1445);
  let x_1447 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1446.x, x_1446.y, x_1446.z, x_1447.w);
  let x_1449 : vec4<f32> = u_xlat2;
  let x_1451 : vec3<f32> = (vec3<f32>(x_1449.x, x_1449.y, x_1449.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1462 : vec3<f32> = ((vec3<f32>(x_1459.x, x_1459.y, x_1459.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1463 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1462.x, x_1462.y, x_1462.z, x_1463.w);
  let x_1465 : vec3<f32> = u_xlat0;
  let x_1467 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1465.x, x_1465.y, x_1465.z, x_1465.x));
  u_xlatb0 = vec3<bool>(x_1467.x, x_1467.y, x_1467.z);
  ...
  u_xlat0.x = x_1479;
  let x_1482 : bool = u_xlatb0.y;
  if (x_1482) {
    let x_1487 : f32 = u_xlat1.y;
    x_1483 = x_1487;
  } else {
    let x_1490 : f32 = u_xlat2.y;
    x_1483 = x_1490;
  }
  let x_1491 : f32 = x_1483;
  u_xlat0.y = x_1491;
  let x_1494 : bool = u_xlatb0.z;
  if (x_1494) {
    let x_1499 : f32 = u_xlat1.z;
    x_1495 = x_1499;
  } else {
  ...
  u_xlat0.z = x_1503;
  let x_1505 : f32 = u_xlat15;
  let x_1510 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1505, x_1505, x_1505) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1510);
  let x_1512 : vec3<f32> = u_xlat0;
  let x_1513 : vec3<f32> = (x_1512 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1514 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1513.x, x_1513.y, x_1513.z, x_1514.w);
  let x_1516 : vec3<f32> = u_xlat0;
  let x_1517 : vec3<f32> = (x_1516 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1518 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1517.x, x_1517.y, x_1517.z, x_1518.w);
  let x_1520 : vec4<f32> = u_xlat2;
  let x_1522 : vec3<f32> = (vec3<f32>(x_1520.x, x_1520.y, x_1520.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1523 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1522.x, x_1522.y, x_1522.z, x_1523.w);
  let x_1525 : vec4<f32> = u_xlat2;
  let x_1528 : vec3<f32> = log2(abs(vec3<f32>(x_1525.x, x_1525.y, x_1525.z)));
  let x_1529 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1528.x, x_1528.y, x_1528.z, x_1529.w);
  let x_1531 : vec4<f32> = u_xlat2;
  let x_1533 : vec3<f32> = (vec3<f32>(x_1531.x, x_1531.y, x_1531.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1534 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1533.x, x_1533.y, x_1533.z, x_1534.w);
  let x_1536 : vec4<f32> = u_xlat2;
  let x_1538 : vec3<f32> = exp2(vec3<f32>(x_1536.x, x_1536.y, x_1536.z));
  let x_1539 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1538.x, x_1538.y, x_1538.z, x_1539.w);
  let x_1541 : vec3<f32> = u_xlat0;
  let x_1543 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1541.x, x_1541.y, x_1541.z, x_1541.x));
  u_xlatb0 = vec3<bool>(x_1543.x, x_1543.y, x_1543.z);
  let x_1546 : bool = u_xlatb0.x;
  if (x_1546) {
    let x_1551 : f32 = u_xlat1.x;
    x_1547 = x_1551;
  } else {
    let x_1554 : f32 = u_xlat2.x;
    x_1547 = x_1554;
  }
  let x_1555 : f32 = x_1547;
  u_xlat0.x = x_1555;
  let x_1558 : bool = u_xlatb0.y;
  if (x_1558) {
    let x_1563 : f32 = u_xlat1.y;
    x_1559 = x_1563;
  } else {
    let x_1566 : f32 = u_xlat2.y;
    x_1559 = x_1566;
  }
  let x_1567 : f32 = x_1559;
  u_xlat0.y = x_1567;
  let x_1570 : bool = u_xlatb0.z;
  if (x_1570) {
    let x_1575 : f32 = u_xlat1.z;
    x_1571 = x_1575;
  } else {
  ...
  let x_1584 : vec3<f32> = max(x_1583, vec3<f32>(0.0f, 0.0f, 0.0f));
