...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    if(u_xlatb4){
        ...
        u_xlat73 = (u_xlatb5.y) ? u_xlat4.w : u_xlat4.x;
        u_xlat4.xyz = (u_xlatb5.x) ? u_xlat4.xyz : vec3(u_xlat73);
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.y = float(1.0);
        u_xlat4.z = float(1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu73 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlatb8.x){
            ...
            if(u_xlatb8.x){
                ...
                u_xlat54 = (u_xlatb8.z) ? u_xlat31.z : u_xlat9.x;
                u_xlat8.x = (u_xlatb8.x) ? u_xlat31.x : u_xlat54;
        ...
        u_xlat76 = u_xlat72 * u_xlat8.x + u_xlat76;
        ...
        u_xlat7.xyz = u_xlat2.xyz * vec3(u_xlat70) + u_xlat7.xyz;
