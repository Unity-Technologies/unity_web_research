...
bool u_xlatb15;
    ...
    u_xlat5.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec0, 0.0);
    ...
    u_xlat5.xyz = u_xlat2.yyy * unity_WorldToLight[1].xyw;
    u_xlat5.xyz = unity_WorldToLight[0].xyw * u_xlat2.xxx + u_xlat5.xyz;
    u_xlat5.xyz = unity_WorldToLight[2].xyw * u_xlat2.www + u_xlat5.xyz;
    u_xlat5.xyz = u_xlat5.xyz + unity_WorldToLight[3].xyw;
    u_xlat5.xy = u_xlat5.xy / u_xlat5.zz;
    u_xlatb15 = u_xlat5.z<0.0;
    u_xlat15 = u_xlatb15 ? 1.0 : float(0.0);
    u_xlat5.x = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat5.xy, -8.0).w;
    u_xlat5.x = u_xlat15 * u_xlat5.x;
    u_xlat3.xyz = (-u_xlat2.xyw) + _LightPos.xyz;
    u_xlat2.xyz = u_xlat2.xyw + (-_WorldSpaceCameraPos.xyz);
    u_xlat10 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat15 = u_xlat10 * _LightPos.w;
    u_xlat10 = inversesqrt(u_xlat10);
    u_xlat3.xyz = vec3(u_xlat10) * u_xlat3.xyz;
    u_xlat10 = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), vec2(u_xlat15)).x;
