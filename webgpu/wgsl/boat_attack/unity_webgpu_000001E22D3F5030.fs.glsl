...
;
    ...
    u_xlat66 = u_xlat2.x * u_xlat2.x;
    u_xlat23 = u_xlat65 + u_xlat2.y;
    u_xlat23 = min(u_xlat23, 1.0);
    u_xlat65 = u_xlat2.x * 4.0 + 2.0;
    ...
    u_xlat29.xyz = (-u_xlat0.xyz) + vec3(u_xlat23);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu64 ; u_xlatu_loop_1++)
    {
        ...
        if(u_xlati10 != 0) {
            ...
            u_xlat73 = (u_xlatb2.y) ? u_xlat10.w : u_xlat10.x;
