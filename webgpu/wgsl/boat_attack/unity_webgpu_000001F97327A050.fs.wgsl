...
fn main_1() {
  ...
  let x_1969 : vec3<f32> = (vec3<f32>(x_1967.x, x_1967.y, x_1967.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1970 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1969.x, x_1969.y, x_1969.z, x_1970.w);
  let x_1972 : vec4<f32> = u_xlat0;
  let x_1975 : vec3<f32> = log2(abs(vec3<f32>(x_1972.x, x_1972.y, x_1972.z)));
  ...
  let x_2001 : bool = u_xlatb0.x;
  if (x_2001) {
    let x_2006 : f32 = u_xlat1.x;
    x_2002 = x_2006;
  } else {
    let x_2009 : f32 = u_xlat2.x;
    x_2002 = x_2009;
  }
  let x_2010 : f32 = x_2002;
  SV_Target0.x = x_2010;
  let x_2014 : bool = u_xlatb0.y;
  if (x_2014) {
    let x_2019 : f32 = u_xlat1.y;
    x_2015 = x_2019;
  } else {
    let x_2022 : f32 = u_xlat2.y;
    x_2015 = x_2022;
  }
  let x_2023 : f32 = x_2015;
  SV_Target0.y = x_2023;
  let x_2026 : bool = u_xlatb0.z;
  if (x_2026) {
    let x_2031 : f32 = u_xlat1.z;
    x_2027 = x_2031;
  } else {
    let x_2034 : f32 = u_xlat2.z;
    x_2027 = x_2034;
  }
  let x_2035 : f32 = x_2027;
  SV_Target0.z = x_2035;
  SV_Target0.w = 1.0f;
  return;
}
