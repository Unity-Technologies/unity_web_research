...
;
    ...
    u_xlat31 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat31 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat31;
    u_xlat31 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat31;
    u_xlat31 = u_xlat31 + unity_MatrixV[3].z;
    ...
    u_xlat32 = max(u_xlat3.w, 9.99999975e-05);
    ...
    u_xlatb22.x = u_xlat2.z>=1.0;
    u_xlatb12 = u_xlatb22.x || u_xlatb12;
    u_xlat2.x = (u_xlatb12) ? 1.0 : u_xlat2.x;
    u_xlat12.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat12.x = dot(u_xlat12.xyz, u_xlat12.xyz);
    u_xlat22.x = u_xlat12.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat22.x = clamp(u_xlat22.x, 0.0, 1.0);
    u_xlat32 = (-u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat22.x * u_xlat32 + u_xlat2.x;
    u_xlatb22.x = _MainLightCookieTextureFormat!=-1.0;
    if(u_xlatb22.x){
        u_xlat22.xy = vs_TEXCOORD1.yy * _MainLightWorldToLight[1].xy;
        u_xlat22.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD1.xx + u_xlat22.xy;
        u_xlat22.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD1.zz + u_xlat22.xy;
        u_xlat22.xy = u_xlat22.xy + _MainLightWorldToLight[3].xy;
        u_xlat22.xy = u_xlat22.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
        u_xlat4 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat22.xy, _GlobalMipBias.x);
        ...
        u_xlat32 = (u_xlatb22.y) ? u_xlat4.w : u_xlat4.x;
        u_xlat4.xyz = (u_xlatb22.x) ? u_xlat4.xyz : vec3(u_xlat32);
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.y = float(1.0);
        u_xlat4.z = float(1.0);
    ...
    u_xlat2.xzw = u_xlat2.xzw * vec3(u_xlat33);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat36 = u_xlat12.x * u_xlat7.x + u_xlat36;
    ...
    u_xlat10.xyz = u_xlat3.xyz * u_xlat0.yzw + u_xlat2.xzw;
