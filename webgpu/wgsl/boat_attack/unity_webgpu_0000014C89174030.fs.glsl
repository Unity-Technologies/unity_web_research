...
;
    ...
    u_xlat76 = dot(u_xlat3, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat76 = (-u_xlat76) + 4.0;
    u_xlatu76 = uint(u_xlat76);
    u_xlati76 = int(u_xlatu76) << (2 & int(0x1F));
    u_xlat2.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati76 + 1) / 4][(u_xlati76 + 1) % 4].xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[u_xlati76 / 4][u_xlati76 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat2.xyz;
    u_xlat2.xyz = _MainLightWorldToShadow[(u_xlati76 + 2) / 4][(u_xlati76 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat2.xyz;
    u_xlat2.xyz = u_xlat2.xyz + _MainLightWorldToShadow[(u_xlati76 + 3) / 4][(u_xlati76 + 3) % 4].xyz;
    ...
    u_xlat76 = dot(u_xlat1.xyz, u_xlat3.xyz);
    u_xlat76 = u_xlat76 + 0.5;
    u_xlat3.xyz = vec3(u_xlat76) * u_xlat4.xyz;
    u_xlat76 = max(u_xlat3.w, 9.99999975e-05);
    ...
    u_xlat2.x = u_xlat79 * _MainLightShadowParams.x + u_xlat2.x;
    ...
    u_xlat52 = u_xlat27 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat52 = clamp(u_xlat52, 0.0, 1.0);
    u_xlat79 = (-u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat52 * u_xlat79 + u_xlat2.x;
    ...
    u_xlat52 = u_xlat52 * u_xlat52;
    u_xlat52 = u_xlat52 * u_xlat52;
    u_xlat79 = (-u_xlat0.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat8.xyz = (-u_xlat5.xyz) + vec3(u_xlat77);
    u_xlat8.xyz = vec3(u_xlat52) * u_xlat8.xyz + u_xlat5.xyz;
    u_xlat8.xyz = vec3(u_xlat50) * u_xlat8.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat3.xyz = u_xlat3.xyz * u_xlat4.xyz + u_xlat7.xyz;
    u_xlat50 = u_xlat2.x * unity_LightData.z;
    u_xlat2.x = dot(u_xlat1.xyz, _MainLightPosition.xyz);
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat50 = u_xlat50 * u_xlat2.x;
    u_xlat2.xzw = vec3(u_xlat50) * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu50 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat83 = dot(_AdditionalLightsSpotDir[u_xlati80].xyz, u_xlat9.xyz);
        u_xlat83 = u_xlat83 * _AdditionalLightsAttenuation[u_xlati80].z + _AdditionalLightsAttenuation[u_xlati80].w;
        u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
        u_xlat83 = u_xlat83 * u_xlat83;
        u_xlat81 = u_xlat81 * u_xlat83;
        u_xlati83 = int(_AdditionalShadowParams[u_xlati80].w);
        u_xlatb84 = u_xlati83>=0;
        if(u_xlatb84){
            u_xlatb84 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati80].z);
            if(u_xlatb84){
                ...
                u_xlat10.x = trunc(_AdditionalShadowParams[u_xlati80].w);
            ...
            u_xlatb83 = 0.0<_AdditionalShadowParams[u_xlati80].y;
            if(u_xlatb83){
                u_xlatb83 = 1.0==_AdditionalShadowParams[u_xlati80].y;
                if(u_xlatb83){
                    ...
                    u_xlatb84 = 2.0==_AdditionalShadowParams[u_xlati80].y;
                    if(u_xlatb84){
            ...
            u_xlat84 = 1.0 + (-_AdditionalShadowParams[u_xlati80].x);
            u_xlat83 = u_xlat83 * _AdditionalShadowParams[u_xlati80].x + u_xlat84;
        ...
        u_xlat83 = u_xlat27 * u_xlat84 + u_xlat83;
        u_xlat81 = u_xlat81 * u_xlat83;
        ...
        u_xlat80 = dot(u_xlat1.xyz, u_xlat8.xyz);
        ...
        u_xlat80 = u_xlat80 * u_xlat0.x + 1.00001001;
        u_xlat81 = u_xlat81 * u_xlat81;
        u_xlat80 = u_xlat80 * u_xlat80;
        u_xlat81 = max(u_xlat81, 0.100000001);
        u_xlat80 = u_xlat80 * u_xlat81;
        u_xlat80 = u_xlat78 * u_xlat80;
        u_xlat80 = u_xlat76 / u_xlat80;
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat80) + u_xlat4.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat25) + u_xlat2.xzw;
