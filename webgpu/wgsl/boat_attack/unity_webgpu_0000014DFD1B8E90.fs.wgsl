...
fn main_1() {
  ...
  let x_1396 : vec3<f32> = (x_1395 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1397 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1396.x, x_1396.y, x_1396.z, x_1397.w);
  let x_1399 : vec3<f32> = u_xlat0;
  let x_1401 : vec3<f32> = log2(abs(x_1399));
  let x_1402 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1401.x, x_1401.y, x_1401.z, x_1402.w);
  let x_1404 : vec4<f32> = u_xlat2;
  let x_1406 : vec3<f32> = (vec3<f32>(x_1404.x, x_1404.y, x_1404.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1417 : vec3<f32> = ((vec3<f32>(x_1414.x, x_1414.y, x_1414.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1418 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1417.x, x_1417.y, x_1417.z, x_1418.w);
  let x_1420 : vec3<f32> = u_xlat0;
  let x_1422 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1420.x, x_1420.y, x_1420.z, x_1420.x));
  u_xlatb0 = vec3<bool>(x_1422.x, x_1422.y, x_1422.z);
  ...
  u_xlat0.x = x_1434;
  let x_1437 : bool = u_xlatb0.y;
  if (x_1437) {
    let x_1442 : f32 = u_xlat1.y;
    x_1438 = x_1442;
  } else {
    let x_1445 : f32 = u_xlat2.y;
    x_1438 = x_1445;
  }
  let x_1446 : f32 = x_1438;
  u_xlat0.y = x_1446;
  let x_1449 : bool = u_xlatb0.z;
  if (x_1449) {
    let x_1454 : f32 = u_xlat1.z;
    x_1450 = x_1454;
  } else {
  ...
  u_xlat0.z = x_1458;
  let x_1460 : vec2<f32> = vs_TEXCOORD0;
  let x_1463 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1467 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1469 : vec2<f32> = ((x_1460 * vec2<f32>(x_1463.x, x_1463.y)) + vec2<f32>(x_1467.z, x_1467.w));
  let x_1470 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1469.x, x_1469.y, x_1470.z, x_1470.w);
  let x_1477 : vec4<f32> = u_xlat1;
  let x_1480 : f32 = x_14.x_GlobalMipBias.x;
  let x_1481 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1477.x, x_1477.y), x_1480);
  u_xlat15 = x_1481.w;
  let x_1483 : f32 = u_xlat15;
  u_xlat15 = ((x_1483 * 2.0f) + -1.0f);
  let x_1486 : f32 = u_xlat15;
  u_xlatb1 = (x_1486 >= 0.0f);
  let x_1488 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1488);
  let x_1491 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1491)) + 1.0f);
  let x_1495 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1495);
  let x_1497 : f32 = u_xlat15;
  u_xlat15 = (-(x_1497) + 1.0f);
  let x_1500 : f32 = u_xlat15;
  let x_1502 : f32 = u_xlat1.x;
  u_xlat15 = (x_1500 * x_1502);
  let x_1504 : vec3<f32> = u_xlat0;
  let x_1505 : vec3<f32> = (x_1504 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1506 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1505.x, x_1505.y, x_1505.z, x_1506.w);
  let x_1508 : vec3<f32> = u_xlat0;
  let x_1510 : vec3<f32> = log2(abs(x_1508));
  let x_1511 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1510.x, x_1510.y, x_1510.z, x_1511.w);
  let x_1513 : vec4<f32> = u_xlat2;
  let x_1515 : vec3<f32> = (vec3<f32>(x_1513.x, x_1513.y, x_1513.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1526 : vec3<f32> = ((vec3<f32>(x_1523.x, x_1523.y, x_1523.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1527 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1526.x, x_1526.y, x_1526.z, x_1527.w);
  let x_1529 : vec3<f32> = u_xlat0;
  let x_1531 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1529.x, x_1529.y, x_1529.z, x_1529.x));
  ...
  u_xlat0 = ((vec3<f32>(x_1569, x_1569, x_1569) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1574);
  let x_1576 : vec3<f32> = u_xlat0;
  let x_1577 : vec3<f32> = (x_1576 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1578 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1577.x, x_1577.y, x_1577.z, x_1578.w);
  let x_1580 : vec3<f32> = u_xlat0;
  let x_1581 : vec3<f32> = (x_1580 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1582 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1581.x, x_1581.y, x_1581.z, x_1582.w);
  let x_1584 : vec4<f32> = u_xlat2;
  let x_1586 : vec3<f32> = (vec3<f32>(x_1584.x, x_1584.y, x_1584.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1587 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1586.x, x_1586.y, x_1586.z, x_1587.w);
  let x_1589 : vec4<f32> = u_xlat2;
  let x_1592 : vec3<f32> = log2(abs(vec3<f32>(x_1589.x, x_1589.y, x_1589.z)));
  let x_1593 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1592.x, x_1592.y, x_1592.z, x_1593.w);
  let x_1595 : vec4<f32> = u_xlat2;
  let x_1597 : vec3<f32> = (vec3<f32>(x_1595.x, x_1595.y, x_1595.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1598 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1597.x, x_1597.y, x_1597.z, x_1598.w);
  let x_1600 : vec4<f32> = u_xlat2;
  let x_1602 : vec3<f32> = exp2(vec3<f32>(x_1600.x, x_1600.y, x_1600.z));
  let x_1603 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1602.x, x_1602.y, x_1602.z, x_1603.w);
  let x_1605 : vec3<f32> = u_xlat0;
  let x_1607 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1605.x, x_1605.y, x_1605.z, x_1605.x));
  u_xlatb0 = vec3<bool>(x_1607.x, x_1607.y, x_1607.z);
  let x_1610 : bool = u_xlatb0.x;
  if (x_1610) {
  ...
  u_xlat0.x = x_1619;
  let x_1622 : bool = u_xlatb0.y;
  if (x_1622) {
    let x_1627 : f32 = u_xlat1.y;
    x_1623 = x_1627;
  } else {
  ...
  u_xlat0.y = x_1631;
  let x_1634 : bool = u_xlatb0.z;
  if (x_1634) {
    let x_1639 : f32 = u_xlat1.z;
    x_1635 = x_1639;
  } else {
  ...
  let x_1648 : vec3<f32> = max(x_1647, vec3<f32>(0.0f, 0.0f, 0.0f));
