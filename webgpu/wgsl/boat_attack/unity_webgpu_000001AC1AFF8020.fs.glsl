...
;
    ...
    u_xlat34 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec0, 0.0);
    u_xlat3.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat34 = u_xlat34 * _MainLightShadowParams.x + u_xlat3.x;
    u_xlatb3.x = 0.0>=u_xlat3.z;
    u_xlatb14.x = u_xlat3.z>=1.0;
    u_xlatb3.x = u_xlatb14.x || u_xlatb3.x;
    u_xlat34 = (u_xlatb3.x) ? 1.0 : u_xlat34;
    u_xlat3.xyz = vs_TEXCOORD1.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat3.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat14.x = u_xlat3.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat14.x = clamp(u_xlat14.x, 0.0, 1.0);
    u_xlat25 = (-u_xlat34) + 1.0;
    u_xlat34 = u_xlat14.x * u_xlat25 + u_xlat34;
    ...
    u_xlat37 = inversesqrt(u_xlat4.w);
