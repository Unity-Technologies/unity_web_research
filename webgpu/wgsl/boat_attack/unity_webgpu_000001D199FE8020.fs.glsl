...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat6.xyz = (-vs_TEXCOORD2.xyz) * _AdditionalLightsPosition[u_xlati59].www + _AdditionalLightsPosition[u_xlati59].xyz;
        ...
        u_xlat60 = u_xlat60 * u_xlat61;
        u_xlat7.xyz = vec3(u_xlat57) * _AdditionalLightsColor[u_xlati59].xyz;
