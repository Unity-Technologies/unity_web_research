...
fn main_1() {
  ...
  let x_1459 : vec2<f32> = vs_TEXCOORD0;
  let x_1462 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1466 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1468 : vec2<f32> = ((x_1459 * vec2<f32>(x_1462.x, x_1462.y)) + vec2<f32>(x_1466.z, x_1466.w));
  let x_1469 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1468.x, x_1468.y, x_1469.z, x_1469.w);
  let x_1476 : vec4<f32> = u_xlat1;
  let x_1479 : f32 = x_14.x_GlobalMipBias.x;
  let x_1480 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1476.x, x_1476.y), x_1479);
  u_xlat15 = x_1480.w;
  let x_1482 : f32 = u_xlat15;
  u_xlat15 = ((x_1482 * 2.0f) + -1.0f);
  let x_1485 : f32 = u_xlat15;
  u_xlatb1 = (x_1485 >= 0.0f);
  let x_1487 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1487);
  let x_1490 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1490)) + 1.0f);
  let x_1494 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1494);
  let x_1496 : f32 = u_xlat15;
  u_xlat15 = (-(x_1496) + 1.0f);
  let x_1499 : f32 = u_xlat15;
  let x_1501 : f32 = u_xlat1.x;
  u_xlat15 = (x_1499 * x_1501);
  let x_1503 : vec3<f32> = u_xlat0;
  let x_1504 : vec3<f32> = (x_1503 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1505 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1504.x, x_1504.y, x_1504.z, x_1505.w);
  let x_1507 : vec3<f32> = u_xlat0;
  let x_1509 : vec3<f32> = log2(abs(x_1507));
  let x_1510 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1509.x, x_1509.y, x_1509.z, x_1510.w);
  let x_1512 : vec4<f32> = u_xlat2;
  let x_1514 : vec3<f32> = (vec3<f32>(x_1512.x, x_1512.y, x_1512.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1525 : vec3<f32> = ((vec3<f32>(x_1522.x, x_1522.y, x_1522.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1526 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1525.x, x_1525.y, x_1525.z, x_1526.w);
  let x_1528 : vec3<f32> = u_xlat0;
  let x_1530 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1528.x, x_1528.y, x_1528.z, x_1528.x));
  ...
  u_xlat0.z = x_1566;
  let x_1568 : f32 = u_xlat15;
  let x_1573 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1568, x_1568, x_1568) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1573);
  let x_1575 : vec3<f32> = u_xlat0;
  let x_1576 : vec3<f32> = (x_1575 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1577 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1576.x, x_1576.y, x_1576.z, x_1577.w);
  let x_1579 : vec3<f32> = u_xlat0;
  let x_1580 : vec3<f32> = (x_1579 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1581 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1580.x, x_1580.y, x_1580.z, x_1581.w);
  let x_1583 : vec4<f32> = u_xlat2;
  let x_1585 : vec3<f32> = (vec3<f32>(x_1583.x, x_1583.y, x_1583.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1586 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1585.x, x_1585.y, x_1585.z, x_1586.w);
  let x_1588 : vec4<f32> = u_xlat2;
  let x_1591 : vec3<f32> = log2(abs(vec3<f32>(x_1588.x, x_1588.y, x_1588.z)));
  let x_1592 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1591.x, x_1591.y, x_1591.z, x_1592.w);
  let x_1594 : vec4<f32> = u_xlat2;
  let x_1596 : vec3<f32> = (vec3<f32>(x_1594.x, x_1594.y, x_1594.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1597 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1596.x, x_1596.y, x_1596.z, x_1597.w);
  let x_1599 : vec4<f32> = u_xlat2;
  let x_1601 : vec3<f32> = exp2(vec3<f32>(x_1599.x, x_1599.y, x_1599.z));
  let x_1602 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1601.x, x_1601.y, x_1601.z, x_1602.w);
  let x_1604 : vec3<f32> = u_xlat0;
  let x_1606 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1604.x, x_1604.y, x_1604.z, x_1604.x));
  u_xlatb0 = vec3<bool>(x_1606.x, x_1606.y, x_1606.z);
  let x_1609 : bool = u_xlatb0.x;
  if (x_1609) {
    let x_1614 : f32 = u_xlat1.x;
    x_1610 = x_1614;
  } else {
    let x_1617 : f32 = u_xlat2.x;
    x_1610 = x_1617;
  }
  let x_1618 : f32 = x_1610;
  u_xlat0.x = x_1618;
  let x_1621 : bool = u_xlatb0.y;
  if (x_1621) {
    let x_1626 : f32 = u_xlat1.y;
    x_1622 = x_1626;
  } else {
    let x_1629 : f32 = u_xlat2.y;
    x_1622 = x_1629;
  }
  let x_1630 : f32 = x_1622;
  u_xlat0.y = x_1630;
  let x_1633 : bool = u_xlatb0.z;
  if (x_1633) {
    let x_1638 : f32 = u_xlat1.z;
    x_1634 = x_1638;
  } else {
  ...
  let x_1647 : vec3<f32> = max(x_1646, vec3<f32>(0.0f, 0.0f, 0.0f));
