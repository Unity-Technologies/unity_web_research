...
fn main_1() {
  ...
  let x_700 : vec3<f32> = ((vec3<f32>(x_694.x, x_694.x, x_694.x) * x_696) + vec3<f32>(x_698.x, x_698.y, x_698.z));
  let x_701 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_700.x, x_700.y, x_700.z, x_701.w);
  SV_Target0.w = 1.0f;
  return;
}
