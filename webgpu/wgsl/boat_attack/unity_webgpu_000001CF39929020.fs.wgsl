...
fn main_1() {
  ...
  let x_1689 : vec3<f32> = sqrt(vec3<f32>(x_1687.x, x_1687.y, x_1687.z));
  let x_1690 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1689.x, x_1689.y, x_1689.z, x_1690.w);
  let x_1692 : vec2<f32> = vs_TEXCOORD0;
  let x_1695 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1699 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1701 : vec2<f32> = ((x_1692 * vec2<f32>(x_1695.x, x_1695.y)) + vec2<f32>(x_1699.z, x_1699.w));
  let x_1702 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1701.x, x_1701.y, x_1702.z, x_1702.w);
  let x_1709 : vec4<f32> = u_xlat1;
  let x_1712 : f32 = x_38.x_GlobalMipBias.x;
  let x_1713 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1709.x, x_1709.y), x_1712);
  u_xlat18 = x_1713.w;
  let x_1715 : f32 = u_xlat18;
  u_xlat18 = ((x_1715 * 2.0f) + -1.0f);
  let x_1718 : f32 = u_xlat18;
  u_xlatb1 = (x_1718 >= 0.0f);
  let x_1720 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1720);
  let x_1723 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1723)) + 1.0f);
  let x_1727 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1727);
  let x_1729 : f32 = u_xlat18;
  u_xlat18 = (-(x_1729) + 1.0f);
  let x_1732 : f32 = u_xlat18;
  let x_1734 : f32 = u_xlat1.x;
  u_xlat18 = (x_1732 * x_1734);
  let x_1736 : vec4<f32> = u_xlat0;
  let x_1738 : vec3<f32> = (vec3<f32>(x_1736.x, x_1736.y, x_1736.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1739 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1738.x, x_1738.y, x_1738.z, x_1739.w);
  let x_1741 : vec4<f32> = u_xlat0;
  let x_1743 : vec3<f32> = log2(vec3<f32>(x_1741.x, x_1741.y, x_1741.z));
  let x_1744 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1743.x, x_1743.y, x_1743.z, x_1744.w);
  let x_1746 : vec4<f32> = u_xlat2;
  let x_1748 : vec3<f32> = (vec3<f32>(x_1746.x, x_1746.y, x_1746.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1749 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1748.x, x_1748.y, x_1748.z, x_1749.w);
  let x_1751 : vec4<f32> = u_xlat2;
  let x_1753 : vec3<f32> = exp2(vec3<f32>(x_1751.x, x_1751.y, x_1751.z));
  let x_1754 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1753.x, x_1753.y, x_1753.z, x_1754.w);
  let x_1756 : vec4<f32> = u_xlat2;
  let x_1759 : vec3<f32> = ((vec3<f32>(x_1756.x, x_1756.y, x_1756.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1760 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1759.x, x_1759.y, x_1759.z, x_1760.w);
  let x_1762 : vec4<f32> = u_xlat0;
  let x_1764 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1762.x, x_1762.y, x_1762.z, x_1762.x));
  ...
  u_xlat0.z = x_1800;
  let x_1802 : f32 = u_xlat18;
  let x_1807 : vec4<f32> = u_xlat0;
  let x_1809 : vec3<f32> = ((vec3<f32>(x_1802, x_1802, x_1802) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1807.x, x_1807.y, x_1807.z));
  let x_1810 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1809.x, x_1809.y, x_1809.z, x_1810.w);
  let x_1812 : vec4<f32> = u_xlat0;
  let x_1814 : vec3<f32> = (vec3<f32>(x_1812.x, x_1812.y, x_1812.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1815 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1814.x, x_1814.y, x_1814.z, x_1815.w);
  let x_1817 : vec4<f32> = u_xlat0;
  let x_1819 : vec3<f32> = (vec3<f32>(x_1817.x, x_1817.y, x_1817.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1820 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1819.x, x_1819.y, x_1819.z, x_1820.w);
  let x_1822 : vec4<f32> = u_xlat2;
  let x_1824 : vec3<f32> = (vec3<f32>(x_1822.x, x_1822.y, x_1822.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1825 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1824.x, x_1824.y, x_1824.z, x_1825.w);
  let x_1827 : vec4<f32> = u_xlat2;
  let x_1830 : vec3<f32> = log2(abs(vec3<f32>(x_1827.x, x_1827.y, x_1827.z)));
  let x_1831 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1830.x, x_1830.y, x_1830.z, x_1831.w);
  let x_1833 : vec4<f32> = u_xlat2;
  let x_1835 : vec3<f32> = (vec3<f32>(x_1833.x, x_1833.y, x_1833.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1836 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1835.x, x_1835.y, x_1835.z, x_1836.w);
  let x_1838 : vec4<f32> = u_xlat2;
  let x_1840 : vec3<f32> = exp2(vec3<f32>(x_1838.x, x_1838.y, x_1838.z));
  let x_1841 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1840.x, x_1840.y, x_1840.z, x_1841.w);
  let x_1843 : vec4<f32> = u_xlat0;
  let x_1845 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1843.x, x_1843.y, x_1843.z, x_1843.x));
  u_xlatb0 = vec3<bool>(x_1845.x, x_1845.y, x_1845.z);
  let x_1848 : bool = u_xlatb0.x;
  if (x_1848) {
    let x_1853 : f32 = u_xlat1.x;
    x_1849 = x_1853;
  } else {
    let x_1856 : f32 = u_xlat2.x;
    x_1849 = x_1856;
  }
  let x_1857 : f32 = x_1849;
  u_xlat0.x = x_1857;
  let x_1860 : bool = u_xlatb0.y;
  if (x_1860) {
    let x_1865 : f32 = u_xlat1.y;
    x_1861 = x_1865;
  } else {
    let x_1868 : f32 = u_xlat2.y;
    x_1861 = x_1868;
  }
  let x_1869 : f32 = x_1861;
  u_xlat0.y = x_1869;
  let x_1872 : bool = u_xlatb0.z;
  if (x_1872) {
    let x_1877 : f32 = u_xlat1.z;
    x_1873 = x_1877;
  } else {
    let x_1880 : f32 = u_xlat2.z;
    x_1873 = x_1880;
  }
  let x_1881 : f32 = x_1873;
  u_xlat0.z = x_1881;
  let x_1885 : vec4<f32> = u_xlat0;
  let x_1887 : vec3<f32> = max(vec3<f32>(x_1885.x, x_1885.y, x_1885.z), vec3<f32>(0.0f, 0.0f, 0.0f));
