...
void main()
{
    ...
    u_xlat4 = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD0.xy).w;
    u_xlat0.x = u_xlat4 * 1.15625 + (-u_xlat0.x);
    u_xlat2 = u_xlat4 * 1.15625 + u_xlat0.y;
    u_xlat1.z = u_xlat2 + -1.06861997;
    u_xlat2 = texture(sampler2D(_ThirdTex, sampler_ThirdTex), vs_TEXCOORD0.xy).w;
    u_xlat0.x = (-u_xlat2) * 0.8125 + u_xlat0.x;
    u_xlat2 = u_xlat2 * 1.59375;
    u_xlat0.y = u_xlat4 * 1.15625 + u_xlat2;
