...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat6.xyz = vec3(u_xlat65) * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu60 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat41.x = dot(unity_LightIndices[int(u_xlatu41)], uintBitsToFloat(ImmCB_0[u_xlati64]));
        u_xlati41 = int(u_xlat41.x);
        u_xlat28.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati41].www + _AdditionalLightsPosition[u_xlati41].xyz;
        u_xlat64 = dot(u_xlat28.xyz, u_xlat28.xyz);
        u_xlat64 = max(u_xlat64, 6.10351562e-05);
        u_xlat66 = inversesqrt(u_xlat64);
        u_xlat9.xyz = vec3(u_xlat66) * u_xlat28.xyz;
        u_xlat67 = float(1.0) / float(u_xlat64);
        u_xlat64 = u_xlat64 * _AdditionalLightsAttenuation[u_xlati41].x;
        u_xlat64 = (-u_xlat64) * u_xlat64 + 1.0;
        u_xlat64 = max(u_xlat64, 0.0);
        u_xlat64 = u_xlat64 * u_xlat64;
        u_xlat64 = u_xlat64 * u_xlat67;
        u_xlat67 = dot(_AdditionalLightsSpotDir[u_xlati41].xyz, u_xlat9.xyz);
        u_xlat67 = u_xlat67 * _AdditionalLightsAttenuation[u_xlati41].z + _AdditionalLightsAttenuation[u_xlati41].w;
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat67 = u_xlat67 * u_xlat67;
        u_xlat64 = u_xlat64 * u_xlat67;
        u_xlat10.xyz = vec3(u_xlat65) * _AdditionalLightsColor[u_xlati41].xyz;
        u_xlat41.x = dot(u_xlat23.xyz, u_xlat9.xyz);
        u_xlat41.x = clamp(u_xlat41.x, 0.0, 1.0);
        u_xlat41.x = u_xlat41.x * u_xlat64;
        u_xlat10.xyz = u_xlat41.xxx * u_xlat10.xyz;
        u_xlat28.xyz = u_xlat28.xyz * vec3(u_xlat66) + u_xlat5.xyz;
        u_xlat41.x = dot(u_xlat28.xyz, u_xlat28.xyz);
        u_xlat41.x = max(u_xlat41.x, 1.17549435e-37);
        u_xlat41.x = inversesqrt(u_xlat41.x);
        u_xlat28.xyz = u_xlat41.xxx * u_xlat28.xyz;
        u_xlat41.x = dot(u_xlat23.xyz, u_xlat28.xyz);
        u_xlat41.x = clamp(u_xlat41.x, 0.0, 1.0);
        u_xlat64 = dot(u_xlat9.xyz, u_xlat28.xyz);
        u_xlat64 = clamp(u_xlat64, 0.0, 1.0);
        u_xlat41.x = u_xlat41.x * u_xlat41.x;
        u_xlat41.x = u_xlat41.x * u_xlat8.x + 1.00001001;
        u_xlat64 = u_xlat64 * u_xlat64;
        u_xlat41.x = u_xlat41.x * u_xlat41.x;
        u_xlat64 = max(u_xlat64, 0.100000001);
        u_xlat41.x = u_xlat41.x * u_xlat64;
        u_xlat41.x = u_xlat61 * u_xlat41.x;
        u_xlat41.x = u_xlat21 / u_xlat41.x;
        u_xlat28.xyz = u_xlat0.xyz * u_xlat41.xxx + u_xlat22.xyz;
