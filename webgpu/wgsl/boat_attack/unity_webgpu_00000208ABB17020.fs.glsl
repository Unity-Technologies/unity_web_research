...
;
    ...
    u_xlat3.x = u_xlat17 * u_xlat31 + u_xlat3.x;
    u_xlat6.xyz = vec3(u_xlat47) * _MainLightColor.xyz;
    u_xlat17 = dot((-u_xlat2.xyz), u_xlat1.xyz);
    u_xlat17 = u_xlat17 + u_xlat17;
    u_xlat8.xyz = u_xlat1.xyz * (-vec3(u_xlat17)) + (-u_xlat2.xyz);
    ...
    u_xlat9.xyz = vec3(u_xlat17) * u_xlat9.xyz + u_xlat5.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati46].www + _AdditionalLightsPosition[u_xlati46].xyz;
        ...
        u_xlat50 = dot(_AdditionalLightsSpotDir[u_xlati46].xyz, u_xlat9.xyz);
        u_xlat50 = u_xlat50 * _AdditionalLightsAttenuation[u_xlati46].z + _AdditionalLightsAttenuation[u_xlati46].w;
        ...
        u_xlat46 = dot(u_xlat1.xyz, u_xlat8.xyz);
        u_xlat46 = clamp(u_xlat46, 0.0, 1.0);
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat46) + u_xlat7.xyz;
