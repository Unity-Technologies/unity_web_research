...
fn main_1() {
  ...
  let x_1317 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1321 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_1334 : f32 = x_25.x_GlobalMipBias.x;
  let x_1335 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1331.x, x_1331.y), x_1334);
  u_xlat21 = x_1335.w;
  let x_1337 : f32 = u_xlat21;
  u_xlat21 = ((x_1337 * 2.0f) + -1.0f);
  let x_1340 : f32 = u_xlat21;
  u_xlatb1.x = (x_1340 >= 0.0f);
  let x_1344 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1344);
  let x_1347 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1347)) + 1.0f);
  let x_1351 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1351);
  let x_1353 : f32 = u_xlat21;
  u_xlat21 = (-(x_1353) + 1.0f);
  let x_1356 : f32 = u_xlat21;
  let x_1358 : f32 = u_xlat1.x;
  u_xlat21 = (x_1356 * x_1358);
  let x_1360 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1360.x, x_1360.y, x_1360.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1363 : vec4<f32> = u_xlat0;
  let x_1366 : vec3<f32> = log2(abs(vec3<f32>(x_1363.x, x_1363.y, x_1363.z)));
  let x_1367 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1366.x, x_1366.y, x_1366.z, x_1367.w);
  let x_1369 : vec4<f32> = u_xlat2;
  let x_1371 : vec3<f32> = (vec3<f32>(x_1369.x, x_1369.y, x_1369.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1372 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1371.x, x_1371.y, x_1371.z, x_1372.w);
  let x_1374 : vec4<f32> = u_xlat2;
  let x_1376 : vec3<f32> = exp2(vec3<f32>(x_1374.x, x_1374.y, x_1374.z));
  let x_1377 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1376.x, x_1376.y, x_1376.z, x_1377.w);
  let x_1379 : vec4<f32> = u_xlat2;
  let x_1382 : vec3<f32> = ((vec3<f32>(x_1379.x, x_1379.y, x_1379.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1383 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1382.x, x_1382.y, x_1382.z, x_1383.w);
  let x_1385 : vec4<f32> = u_xlat0;
  let x_1387 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1385.x, x_1385.y, x_1385.z, x_1385.x));
  u_xlatb0 = vec3<bool>(x_1387.x, x_1387.y, x_1387.z);
  let x_1390 : bool = u_xlatb0.x;
  if (x_1390) {
  ...
  u_xlat0.x = x_1399;
  let x_1402 : bool = u_xlatb0.y;
  if (x_1402) {
    let x_1407 : f32 = u_xlat1.y;
    x_1403 = x_1407;
  } else {
    let x_1410 : f32 = u_xlat2.y;
    x_1403 = x_1410;
  }
  let x_1411 : f32 = x_1403;
  u_xlat0.y = x_1411;
  let x_1414 : bool = u_xlatb0.z;
  if (x_1414) {
    let x_1419 : f32 = u_xlat1.z;
    x_1415 = x_1419;
  } else {
  ...
  let x_1432 : vec3<f32> = ((vec3<f32>(x_1425, x_1425, x_1425) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1430.x, x_1430.y, x_1430.z));
  let x_1433 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1432.x, x_1432.y, x_1432.z, x_1433.w);
  let x_1435 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1435.x, x_1435.y, x_1435.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1438 : vec4<f32> = u_xlat0;
  let x_1440 : vec3<f32> = (vec3<f32>(x_1438.x, x_1438.y, x_1438.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1441 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1440.x, x_1440.y, x_1440.z, x_1441.w);
  let x_1443 : vec4<f32> = u_xlat2;
  let x_1445 : vec3<f32> = (vec3<f32>(x_1443.x, x_1443.y, x_1443.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1446 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1445.x, x_1445.y, x_1445.z, x_1446.w);
  let x_1448 : vec4<f32> = u_xlat2;
  let x_1451 : vec3<f32> = log2(abs(vec3<f32>(x_1448.x, x_1448.y, x_1448.z)));
  let x_1452 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1451.x, x_1451.y, x_1451.z, x_1452.w);
  let x_1454 : vec4<f32> = u_xlat2;
  let x_1456 : vec3<f32> = (vec3<f32>(x_1454.x, x_1454.y, x_1454.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1466 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1464.x, x_1464.y, x_1464.z, x_1464.x));
  ...
  let x_1509 : vec3<f32> = max(vec3<f32>(x_1506.x, x_1506.y, x_1506.z), vec3<f32>(0.0f, 0.0f, 0.0f));
