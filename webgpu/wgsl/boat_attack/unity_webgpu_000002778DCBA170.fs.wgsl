...
fn main_1() {
  ...
  let x_18 : f32 = vs_PREVIOUS_CLIP_POSITION_NO_JITTER0.z;
  u_xlat0.x = (1.0f / x_18);
  let x_23 : vec2<f32> = u_xlat0;
  let x_25 : vec3<f32> = vs_PREVIOUS_CLIP_POSITION_NO_JITTER0;
  u_xlat0 = (vec2<f32>(x_23.x, x_23.x) * vec2<f32>(x_25.x, x_25.y));
  let x_31 : f32 = vs_CLIP_POSITION_NO_JITTER0.z;
  u_xlat2 = (1.0f / x_31);
  let x_33 : vec3<f32> = vs_CLIP_POSITION_NO_JITTER0;
...
@fragment
fn main(@location(1) vs_PREVIOUS_CLIP_POSITION_NO_JITTER0_param : vec3<f32>, @location(0) vs_CLIP_POSITION_NO_JITTER0_param : vec3<f32>, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
