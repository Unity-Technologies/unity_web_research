...
void main()
{
    ...
    u_xlat4.x = (u_xlatb12.x) ? u_xlat2.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb12.x) ? u_xlat2.z : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb12.x) ? u_xlat2.w : unity_MatrixV[2].z;
    u_xlat3.w = 1.0;
    ...
    u_xlat18.xyz = u_xlat3.xyz * (-u_xlat18.xxx) + (-u_xlat4.xyz);
    ...
    u_xlat40 = u_xlat17 + -0.0399999991;
    u_xlat40 = u_xlat7.x * u_xlat40 + 0.0399999991;
    u_xlat39 = u_xlat39 * u_xlat40;
    u_xlat18.xyz = vec3(u_xlat39) * u_xlat18.xyz;
    u_xlat12.xyz = u_xlat12.xyz * u_xlat2.xzw + u_xlat18.xyz;
    ...
    u_xlat7.xzw = u_xlat4.xyz + _MainLightPosition.xyz;
    ...
    u_xlat7.xzw = vec3(u_xlat37) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xzw;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu37 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat17 = dot(unity_LightIndices[int(u_xlatu17)], uintBitsToFloat(ImmCB_0[u_xlati6]));
        u_xlati17 = int(u_xlat17);
        u_xlat8.xyz = (-vs_INTERP8.xyz) * _AdditionalLightsPosition[u_xlati17].www + _AdditionalLightsPosition[u_xlati17].xyz;
        ...
        u_xlat6.x = u_xlat6.x * _AdditionalLightsAttenuation[u_xlati17].x;
        ...
        u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
        u_xlat6.x = u_xlat6.x * u_xlat45;
        u_xlat10.xyz = u_xlat6.xxx * _AdditionalLightsColor[u_xlati17].xyz;
        ...
        u_xlat8.xyz = vec3(u_xlat17) * u_xlat8.xyz;
        u_xlat17 = dot(u_xlat3.xyz, u_xlat8.xyz);
        u_xlat17 = clamp(u_xlat17, 0.0, 1.0);
        u_xlat6.x = dot(u_xlat9.xyz, u_xlat8.xyz);
        u_xlat6.x = clamp(u_xlat6.x, 0.0, 1.0);
        u_xlat17 = u_xlat17 * u_xlat17;
        u_xlat17 = u_xlat17 * u_xlat19.x + 1.00001001;
        u_xlat6.x = u_xlat6.x * u_xlat6.x;
        u_xlat17 = u_xlat17 * u_xlat17;
        ...
        u_xlat8.xyz = vec3(u_xlat17) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xzw;
