#line 1 "TextMeshPro/Bitmap Custom Atlas"
...
OUT . texcoord1 = ( UnpackUV ( v . texcoord1 ) . xy * _FaceTex_ST . xy + _FaceTex_ST . zw ) ;
...
{
float4 color = tex2D ( _MainTex , IN . texcoord0 ) * tex2D ( _FaceTex , IN . texcoord1 ) * IN . color ;
#line 135
return color ;
}
