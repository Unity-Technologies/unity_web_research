...
;
    ...
    u_xlat72 = dot(u_xlat5, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat72 = (-u_xlat72) + 4.0;
    u_xlatu72 = uint(u_xlat72);
    u_xlati72 = int(u_xlatu72) << (2 & int(0x1F));
    u_xlat4.xyz = vs_TEXCOORD1.yyy * _MainLightWorldToShadow[(u_xlati72 + 1) / 4][(u_xlati72 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati72 / 4][u_xlati72 % 4].xyz * vs_TEXCOORD1.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati72 + 2) / 4][(u_xlati72 + 2) % 4].xyz * vs_TEXCOORD1.zzz + u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati72 + 3) / 4][(u_xlati72 + 3) % 4].xyz;
    u_xlat2.w = 1.0;
    ...
    u_xlat72 = u_xlat2.y * u_xlat2.y;
    u_xlat72 = u_xlat2.x * u_xlat2.x + (-u_xlat72);
    u_xlat6.xyz = unity_SHC.xyz * vec3(u_xlat72) + u_xlat7.xyz;
    ...
    if(u_xlatb72){
        ...
        if(u_xlatb72){
            ...
            u_xlat72 = dot(u_xlat7, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            u_xlatb1 = _MainLightShadowParams.y==2.0;
            if(u_xlatb1){
                u_xlat6.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat6.xy = floor(u_xlat6.xy);
                u_xlat54.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                u_xlat7 = u_xlat54.xxyy + vec4(0.5, 1.0, 0.5, 1.0);
                u_xlat8 = u_xlat7.xxzz * u_xlat7.xxzz;
                u_xlat7.xz = u_xlat8.yw * vec2(0.0799999982, 0.0799999982);
                u_xlat8.xy = u_xlat8.xz * vec2(0.5, 0.5) + (-u_xlat54.xy);
                u_xlat56.xy = (-u_xlat54.xy) + vec2(1.0, 1.0);
                u_xlat9.xy = min(u_xlat54.xy, vec2(0.0, 0.0));
                u_xlat9.xy = (-u_xlat9.xy) * u_xlat9.xy + u_xlat56.xy;
                u_xlat54.xy = max(u_xlat54.xy, vec2(0.0, 0.0));
                u_xlat54.xy = (-u_xlat54.xy) * u_xlat54.xy + u_xlat7.yw;
                u_xlat9.xy = u_xlat9.xy + vec2(1.0, 1.0);
                u_xlat54.xy = u_xlat54.xy + vec2(1.0, 1.0);
                u_xlat10.xy = u_xlat8.xy * vec2(0.159999996, 0.159999996);
                u_xlat8.xy = u_xlat56.xy * vec2(0.159999996, 0.159999996);
                u_xlat9.xy = u_xlat9.xy * vec2(0.159999996, 0.159999996);
                u_xlat11.xy = u_xlat54.xy * vec2(0.159999996, 0.159999996);
                u_xlat54.xy = u_xlat7.yw * vec2(0.159999996, 0.159999996);
                u_xlat10.z = u_xlat9.x;
                u_xlat10.w = u_xlat54.x;
                u_xlat8.z = u_xlat11.x;
                u_xlat8.w = u_xlat7.x;
                u_xlat12 = u_xlat8.zwxz + u_xlat10.zwxz;
                u_xlat9.z = u_xlat10.y;
                u_xlat9.w = u_xlat54.y;
                ...
                u_xlat54.xy = u_xlat6.xy * _MainLightShadowmapSize.xy + u_xlat8.zw;
                u_xlat9.w = u_xlat8.y;
                ...
                u_xlat75 = u_xlat75 * u_xlat13.y;
                u_xlat74 = u_xlat13.x * u_xlat74 + u_xlat75;
                vec3 txVec6 = vec3(u_xlat54.xy,u_xlat4.z);
                ...
                u_xlat74 = u_xlat14.x * u_xlat75 + u_xlat74;
                ...
                u_xlat74 = u_xlat14.y * u_xlat75 + u_xlat74;
                ...
                u_xlat74 = u_xlat14.z * u_xlat75 + u_xlat74;
                ...
                u_xlat74 = u_xlat14.w * u_xlat75 + u_xlat74;
                ...
                u_xlat7.xz = u_xlat8.xz * vec2(0.5, 0.5) + (-u_xlat54.xy);
                u_xlat8.xy = (-u_xlat54.xy) + vec2(1.0, 1.0);
                u_xlat56.xy = min(u_xlat54.xy, vec2(0.0, 0.0));
                u_xlat8.xy = (-u_xlat56.xy) * u_xlat56.xy + u_xlat8.xy;
                u_xlat56.xy = max(u_xlat54.xy, vec2(0.0, 0.0));
                u_xlat31.xz = (-u_xlat56.xy) * u_xlat56.xy + u_xlat7.yw;
                u_xlat8.xy = u_xlat8.xy + vec2(2.0, 2.0);
                u_xlat7.yw = u_xlat31.xz + vec2(2.0, 2.0);
                ...
                u_xlat10.yw = u_xlat54.xx * vec2(-0.0816320032, 0.0816320032) + vec2(0.163264006, 0.0816320032);
                u_xlat8.xz = u_xlat54.xx * vec2(-0.0816320032, 0.0816320032) + vec2(0.0816320032, 0.163264006);
                u_xlat8.y = u_xlat7.x;
                u_xlat8.w = u_xlat9.y;
                u_xlat10 = u_xlat8 + u_xlat10;
                u_xlat11.yw = u_xlat54.yy * vec2(-0.0816320032, 0.0816320032) + vec2(0.163264006, 0.0816320032);
                u_xlat9.xz = u_xlat54.yy * vec2(-0.0816320032, 0.0816320032) + vec2(0.0816320032, 0.163264006);
                u_xlat9.y = u_xlat7.y;
                ...
                u_xlat54.xy = u_xlat6.xy * _MainLightShadowmapSize.xy + u_xlat11.wy;
                ...
                u_xlat32.xy = u_xlat6.xy * _MainLightShadowmapSize.xy + u_xlat11.wy;
                u_xlat8.w = u_xlat11.y;
                u_xlat62.xy = u_xlat6.xy * _MainLightShadowmapSize.xy + u_xlat8.xw;
                u_xlat9.xzw = u_xlat11.xzw;
                u_xlat11 = u_xlat6.xyxy * _MainLightShadowmapSize.xyxy + u_xlat9.xyzy;
                u_xlat57.xy = u_xlat6.xy * _MainLightShadowmapSize.xy + u_xlat9.wy;
                u_xlat9.x = u_xlat8.x;
                ...
                u_xlat74 = u_xlat74 * u_xlat17.y;
                u_xlat1.x = u_xlat17.x * u_xlat1.x + u_xlat74;
                vec3 txVec15 = vec3(u_xlat54.xy,u_xlat4.z);
                ...
                u_xlat1.x = u_xlat19.x * u_xlat74 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat19.y * u_xlat74 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat19.z * u_xlat74 + u_xlat1.x;
                vec3 txVec24 = vec3(u_xlat62.xy,u_xlat4.z);
                u_xlat74 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat1.x = u_xlat19.w * u_xlat74 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat7.x * u_xlat74 + u_xlat1.x;
                ...
                u_xlat1.x = u_xlat7.y * u_xlat74 + u_xlat1.x;
                vec3 txVec27 = vec3(u_xlat57.xy,u_xlat4.z);
                u_xlat74 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
                u_xlat1.x = u_xlat7.z * u_xlat74 + u_xlat1.x;
                ...
                u_xlat72 = u_xlat7.w * u_xlat74 + u_xlat1.x;
            }
        }
    } else {
    ...
    if(u_xlatb74){
        ...
        u_xlat74 = (u_xlatb6.y) ? u_xlat4.w : u_xlat4.x;
        u_xlat4.xyz = (u_xlatb6.x) ? u_xlat4.xyz : vec3(u_xlat74);
    } else {
        u_xlat4.x = float(1.0);
        u_xlat4.y = float(1.0);
        u_xlat4.z = float(1.0);
    ...
    u_xlat6.xyz = vec3(u_xlat72) * u_xlat4.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu74 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat54.x = inversesqrt(u_xlat77);
        u_xlat8.xyz = u_xlat54.xxx * u_xlat8.xyz;
        u_xlat54.x = float(1.0) / float(u_xlat77);
        ...
        u_xlat77 = u_xlat77 * u_xlat54.x;
        u_xlat54.x = dot(_AdditionalLightsSpotDir[u_xlati76].xyz, u_xlat8.xyz);
        u_xlat54.x = u_xlat54.x * _AdditionalLightsAttenuation[u_xlati76].z + _AdditionalLightsAttenuation[u_xlati76].w;
        ...
        if(u_xlatb78){
            ...
            if(u_xlatb54){
                ...
                if(u_xlatb54){
                    ...
                    u_xlat54.x = dot(u_xlat11, vec4(0.25, 0.25, 0.25, 0.25));
                } else {
                    ...
                    if(u_xlatb78){
                        ...
                        u_xlat54.x = u_xlat78 * u_xlat80 + u_xlat79;
                    } else {
                        u_xlat10.xy = u_xlat9.xy * _AdditionalShadowmapSize.zw + vec2(0.5, 0.5);
                        u_xlat10.xy = floor(u_xlat10.xy);
                        u_xlat58.xy = u_xlat9.xy * _AdditionalShadowmapSize.zw + (-u_xlat10.xy);
                        ...
                        u_xlat54.x = u_xlat11.w * u_xlat79 + u_xlat78;
                    }
                }
            } else {
                vec3 txVec59 = vec3(u_xlat9.xy,u_xlat9.z);
                u_xlat54.x = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec59, 0.0);
            }
            u_xlat78 = 1.0 + (-_AdditionalShadowParams[u_xlati76].x);
            u_xlat54.x = u_xlat54.x * _AdditionalShadowParams[u_xlati76].x + u_xlat78;
            u_xlatb78 = 0.0>=u_xlat9.z;
            u_xlatb79 = u_xlat9.z>=1.0;
            u_xlatb78 = u_xlatb78 || u_xlatb79;
            u_xlat54.x = (u_xlatb78) ? 1.0 : u_xlat54.x;
        } else {
            u_xlat54.x = 1.0;
        }
        u_xlat78 = (-u_xlat54.x) + 1.0;
        u_xlat54.x = u_xlat1.x * u_xlat78 + u_xlat54.x;
