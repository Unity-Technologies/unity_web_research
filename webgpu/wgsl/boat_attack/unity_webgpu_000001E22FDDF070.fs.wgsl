...
fn main_1() {
  ...
  let x_1531 : vec3<f32> = u_xlat6;
  let x_1532 : vec4<f32> = u_xlat1;
  let x_1535 : vec4<f32> = u_xlat0;
  let x_1537 : vec3<f32> = ((x_1531 * vec3<f32>(x_1532.x, x_1532.x, x_1532.x)) + vec3<f32>(x_1535.x, x_1535.y, x_1535.z));
  let x_1538 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1537.x, x_1537.y, x_1537.z, x_1538.w);
  SV_Target0.w = 1.0f;
  return;
}
