...
fn main_1() {
  ...
  u_xlat8 = ((x_73 * 0.05000000074505805969f) + 1.0f);
  ...
  u_xlat12 = max(x_327, 1.17549435e-38f);
  ...
  u_xlat2.y = ((x_347 * -0.34999999403953552246f) + 0.34999999403953552246f);
  ...
  vs_INTERP1 = vec3<f32>(x_421.x, x_421.y, x_421.z);
  let x_427 : vec4<f32> = u_xlat1;
  let x_429 : vec4<f32> = x_44.unity_MatrixVP[3i];
  gl_Position = (x_427 + x_429);
  let x_435 : vec4<f32> = in_TEXCOORD0;
  vs_INTERP0 = x_435;
  return;
}
