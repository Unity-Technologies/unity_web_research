...
#line 25 "D:/unity/BoatAttack_fix/Library/PackageCache/com.unity.render-pipelines.universal@16.0.1/Shaders/PostProcessing/TemporalAA.hlsl"
...
{
return _BlitTexture . SampleBias ( sampler_PointClamp , uv + _BlitTexture_TexelSize . xy * texelOffset , _GlobalMipBias . x ) ;
}

half4 SampleColorLinear ( float2 uv , float2 texelOffset )
{
return _BlitTexture . SampleBias ( sampler_LinearClamp , uv + _BlitTexture_TexelSize . xy * texelOffset , _GlobalMipBias . x ) ;
}
...
#line 179
half3 SampleBicubic5TapHalf ( Texture2D sourceTexture , float2 UV , float4 sourceTexture_TexelSize )
{
...
half3 s0 = SceneToWorkingSpace ( sourceTexture . SampleBias ( sampler_LinearClamp , float2 ( tc12 . x , tc0 . y ) , _GlobalMipBias . x ) . xyz ) ;
half3 s1 = SceneToWorkingSpace ( sourceTexture . SampleBias ( sampler_LinearClamp , float2 ( tc0 . x , tc12 . y ) , _GlobalMipBias . x ) . xyz ) ;
half3 s2 = SceneToWorkingSpace ( sourceTexture . SampleBias ( sampler_LinearClamp , float2 ( tc12 . x , tc12 . y ) , _GlobalMipBias . x ) . xyz ) ;
half3 s3 = SceneToWorkingSpace ( sourceTexture . SampleBias ( sampler_LinearClamp , float2 ( tc3 . x , tc12 . y ) , _GlobalMipBias . x ) . xyz ) ;
half3 s4 = SceneToWorkingSpace ( sourceTexture . SampleBias ( sampler_LinearClamp , float2 ( tc12 . x , tc3 . y ) , _GlobalMipBias . x ) . xyz ) ;
