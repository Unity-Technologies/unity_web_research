...
fn main_1() {
  ...
  u_xlat12 = (x_193 * 0.10000000149011611938f);
  ...
  u_xlat2 = (x_232 * vec4<f32>(1.97500002384185791016f, 0.79299998283386230469f, 0.375f, 0.19300000369548797607f));
  ...
  u_xlat2.z = 0.30000001192092895508f;
