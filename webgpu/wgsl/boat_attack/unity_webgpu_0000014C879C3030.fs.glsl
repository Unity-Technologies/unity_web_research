...
void main()
{
    ...
    u_xlat4.xyz = u_xlat1.xzw * u_xlat15.xxx;
    ...
    u_xlat15.xyz = vec3(u_xlat25) * u_xlat15.xyz;
    u_xlat5.x = (u_xlatb1.x) ? u_xlat15.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb1.x) ? u_xlat15.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb1.x) ? u_xlat15.z : unity_MatrixV[2].z;
    u_xlat4.w = 1.0;
    ...
    u_xlat7.x = u_xlat7.x * u_xlat7.x;
    u_xlat19 = (-u_xlat15.x) * 0.699999988 + 1.70000005;
    u_xlat15.x = u_xlat15.x * u_xlat19;
    u_xlat15.x = u_xlat15.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat18.xyz, u_xlat15.x);
    ...
    u_xlat18.xyz = u_xlat8.xyz * u_xlat15.xxx;
    u_xlat15.xy = vec2(u_xlat27) * vec2(u_xlat27) + vec2(-1.0, 1.0);
    ...
    u_xlat1.xzw = u_xlat1.xzw * u_xlat2.xyz + u_xlat18.xyz;
    ...
    u_xlat38 = u_xlat38 * u_xlat15.x + 1.00001001;
    ...
    u_xlat3.x = u_xlat6.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu38 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat45 = u_xlat3.x * u_xlat10.x + u_xlat45;
        u_xlat43 = u_xlat43 * u_xlat45;
    ...
    u_xlat1.xzw = u_xlat1.xzw * vec3(u_xlat41) + u_xlat18.xyz;
