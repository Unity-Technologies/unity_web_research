...
fn main_1() {
  ...
  let x_1421 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1425 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1427 : vec2<f32> = ((x_1418 * vec2<f32>(x_1421.x, x_1421.y)) + vec2<f32>(x_1425.z, x_1425.w));
  let x_1428 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1427.x, x_1427.y, x_1428.z, x_1428.w);
  let x_1435 : vec4<f32> = u_xlat1;
  let x_1438 : f32 = x_27.x_GlobalMipBias.x;
  let x_1439 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1435.x, x_1435.y), x_1438);
  u_xlat15 = x_1439.w;
  let x_1441 : f32 = u_xlat15;
  u_xlat15 = ((x_1441 * 2.0f) + -1.0f);
  let x_1444 : f32 = u_xlat15;
  u_xlatb1 = (x_1444 >= 0.0f);
  let x_1446 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1446);
  let x_1449 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1449)) + 1.0f);
  let x_1453 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1453);
  let x_1455 : f32 = u_xlat15;
  u_xlat15 = (-(x_1455) + 1.0f);
  let x_1458 : f32 = u_xlat15;
  let x_1460 : f32 = u_xlat1.x;
  u_xlat15 = (x_1458 * x_1460);
  let x_1462 : vec3<f32> = u_xlat0;
  let x_1463 : vec3<f32> = (x_1462 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1464 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1463.x, x_1463.y, x_1463.z, x_1464.w);
  let x_1466 : vec3<f32> = u_xlat0;
  let x_1468 : vec3<f32> = log2(abs(x_1466));
  let x_1469 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1468.x, x_1468.y, x_1468.z, x_1469.w);
  let x_1471 : vec4<f32> = u_xlat2;
  let x_1473 : vec3<f32> = (vec3<f32>(x_1471.x, x_1471.y, x_1471.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1484 : vec3<f32> = ((vec3<f32>(x_1481.x, x_1481.y, x_1481.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1485 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1484.x, x_1484.y, x_1484.z, x_1485.w);
  let x_1487 : vec3<f32> = u_xlat0;
  let x_1489 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1487.x, x_1487.y, x_1487.z, x_1487.x));
  ...
  u_xlat0 = ((vec3<f32>(x_1527, x_1527, x_1527) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1532);
  let x_1534 : vec3<f32> = u_xlat0;
  let x_1535 : vec3<f32> = (x_1534 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1536 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1535.x, x_1535.y, x_1535.z, x_1536.w);
  let x_1538 : vec3<f32> = u_xlat0;
  let x_1539 : vec3<f32> = (x_1538 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1540 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1539.x, x_1539.y, x_1539.z, x_1540.w);
  let x_1542 : vec4<f32> = u_xlat2;
  let x_1544 : vec3<f32> = (vec3<f32>(x_1542.x, x_1542.y, x_1542.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1545 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1544.x, x_1544.y, x_1544.z, x_1545.w);
  let x_1547 : vec4<f32> = u_xlat2;
  let x_1550 : vec3<f32> = log2(abs(vec3<f32>(x_1547.x, x_1547.y, x_1547.z)));
  let x_1551 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1550.x, x_1550.y, x_1550.z, x_1551.w);
  let x_1553 : vec4<f32> = u_xlat2;
  let x_1555 : vec3<f32> = (vec3<f32>(x_1553.x, x_1553.y, x_1553.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1556 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1555.x, x_1555.y, x_1555.z, x_1556.w);
  let x_1558 : vec4<f32> = u_xlat2;
  let x_1560 : vec3<f32> = exp2(vec3<f32>(x_1558.x, x_1558.y, x_1558.z));
  let x_1561 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1560.x, x_1560.y, x_1560.z, x_1561.w);
  let x_1563 : vec3<f32> = u_xlat0;
  let x_1565 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1563.x, x_1563.y, x_1563.z, x_1563.x));
  u_xlatb0 = vec3<bool>(x_1565.x, x_1565.y, x_1565.z);
  let x_1568 : bool = u_xlatb0.x;
  if (x_1568) {
    let x_1573 : f32 = u_xlat1.x;
    x_1569 = x_1573;
  } else {
    let x_1576 : f32 = u_xlat2.x;
    x_1569 = x_1576;
  }
  ...
  let x_1606 : vec3<f32> = max(x_1605, vec3<f32>(0.0f, 0.0f, 0.0f));
