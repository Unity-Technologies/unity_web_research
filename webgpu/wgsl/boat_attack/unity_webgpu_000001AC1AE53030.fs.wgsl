...
fn main_1() {
  ...
  let x_1425 : vec3<f32> = sqrt(vec3<f32>(x_1423.x, x_1423.y, x_1423.z));
  let x_1426 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1425.x, x_1425.y, x_1425.z, x_1426.w);
  let x_1428 : vec2<f32> = vs_TEXCOORD0;
  let x_1431 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1435 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1437 : vec2<f32> = ((x_1428 * vec2<f32>(x_1431.x, x_1431.y)) + vec2<f32>(x_1435.z, x_1435.w));
  let x_1438 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1437.x, x_1437.y, x_1438.z);
  let x_1445 : vec3<f32> = u_xlat1;
  let x_1448 : f32 = x_25.x_GlobalMipBias.x;
  let x_1449 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1445.x, x_1445.y), x_1448);
  u_xlat21 = x_1449.w;
  let x_1451 : f32 = u_xlat21;
  u_xlat21 = ((x_1451 * 2.0f) + -1.0f);
  let x_1454 : f32 = u_xlat21;
  u_xlatb1.x = (x_1454 >= 0.0f);
  let x_1458 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1458);
  let x_1461 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1461)) + 1.0f);
  let x_1465 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1465);
  let x_1467 : f32 = u_xlat21;
  u_xlat21 = (-(x_1467) + 1.0f);
  let x_1470 : f32 = u_xlat21;
  let x_1472 : f32 = u_xlat1.x;
  u_xlat21 = (x_1470 * x_1472);
  let x_1474 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1474.x, x_1474.y, x_1474.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1477 : vec4<f32> = u_xlat0;
  let x_1479 : vec3<f32> = log2(vec3<f32>(x_1477.x, x_1477.y, x_1477.z));
  let x_1480 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1479.x, x_1479.y, x_1479.z, x_1480.w);
  let x_1482 : vec4<f32> = u_xlat2;
  let x_1484 : vec3<f32> = (vec3<f32>(x_1482.x, x_1482.y, x_1482.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1485 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1484.x, x_1484.y, x_1484.z, x_1485.w);
  let x_1487 : vec4<f32> = u_xlat2;
  let x_1489 : vec3<f32> = exp2(vec3<f32>(x_1487.x, x_1487.y, x_1487.z));
  let x_1490 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1489.x, x_1489.y, x_1489.z, x_1490.w);
  let x_1492 : vec4<f32> = u_xlat2;
  let x_1495 : vec3<f32> = ((vec3<f32>(x_1492.x, x_1492.y, x_1492.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1496 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1495.x, x_1495.y, x_1495.z, x_1496.w);
  let x_1498 : vec4<f32> = u_xlat0;
  let x_1500 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1498.x, x_1498.y, x_1498.z, x_1498.x));
  u_xlatb0 = vec3<bool>(x_1500.x, x_1500.y, x_1500.z);
  let x_1503 : bool = u_xlatb0.x;
  if (x_1503) {
    let x_1508 : f32 = u_xlat1.x;
    x_1504 = x_1508;
  } else {
  ...
  u_xlat0.x = x_1512;
  let x_1515 : bool = u_xlatb0.y;
  if (x_1515) {
    let x_1520 : f32 = u_xlat1.y;
    x_1516 = x_1520;
  } else {
    let x_1523 : f32 = u_xlat2.y;
    x_1516 = x_1523;
  }
  let x_1524 : f32 = x_1516;
  u_xlat0.y = x_1524;
  let x_1527 : bool = u_xlatb0.z;
  if (x_1527) {
    let x_1532 : f32 = u_xlat1.z;
    x_1528 = x_1532;
  } else {
  ...
  u_xlat0.z = x_1536;
  let x_1538 : f32 = u_xlat21;
  let x_1543 : vec4<f32> = u_xlat0;
  let x_1545 : vec3<f32> = ((vec3<f32>(x_1538, x_1538, x_1538) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1543.x, x_1543.y, x_1543.z));
  let x_1546 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1545.x, x_1545.y, x_1545.z, x_1546.w);
  let x_1548 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1548.x, x_1548.y, x_1548.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1551 : vec4<f32> = u_xlat0;
  let x_1553 : vec3<f32> = (vec3<f32>(x_1551.x, x_1551.y, x_1551.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1554 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1553.x, x_1553.y, x_1553.z, x_1554.w);
  let x_1556 : vec4<f32> = u_xlat2;
  let x_1558 : vec3<f32> = (vec3<f32>(x_1556.x, x_1556.y, x_1556.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  ...
  let x_1569 : vec3<f32> = (vec3<f32>(x_1567.x, x_1567.y, x_1567.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1579 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1577.x, x_1577.y, x_1577.z, x_1577.x));
  u_xlatb0 = vec3<bool>(x_1579.x, x_1579.y, x_1579.z);
  let x_1582 : bool = u_xlatb0.x;
  if (x_1582) {
  ...
  u_xlat0.x = x_1591;
  let x_1594 : bool = u_xlatb0.y;
  if (x_1594) {
    let x_1599 : f32 = u_xlat1.y;
    x_1595 = x_1599;
  } else {
    let x_1602 : f32 = u_xlat2.y;
    x_1595 = x_1602;
  }
  let x_1603 : f32 = x_1595;
  u_xlat0.y = x_1603;
  let x_1606 : bool = u_xlatb0.z;
  if (x_1606) {
    let x_1611 : f32 = u_xlat1.z;
    x_1607 = x_1611;
  } else {
  ...
  let x_1622 : vec3<f32> = max(vec3<f32>(x_1619.x, x_1619.y, x_1619.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1623 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1622.x, x_1622.y, x_1622.z, x_1623.w);
  SV_Target0.w = 1.0f;
  return;
}
