...
fn main_1() {
  ...
  u_xlat0 = sqrt(x_1819);
  let x_1821 : vec2<f32> = vs_TEXCOORD0;
  let x_1824 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1828 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1830 : vec2<f32> = ((x_1821 * vec2<f32>(x_1824.x, x_1824.y)) + vec2<f32>(x_1828.z, x_1828.w));
  let x_1831 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1830.x, x_1830.y, x_1831.z, x_1831.w);
  let x_1838 : vec4<f32> = u_xlat1;
  let x_1841 : f32 = x_26.x_GlobalMipBias.x;
  let x_1842 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1838.x, x_1838.y), x_1841);
  u_xlat21 = x_1842.w;
  let x_1844 : f32 = u_xlat21;
  u_xlat21 = ((x_1844 * 2.0f) + -1.0f);
  let x_1847 : f32 = u_xlat21;
  u_xlatb1 = (x_1847 >= 0.0f);
  let x_1849 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1849);
  let x_1852 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1852)) + 1.0f);
  let x_1856 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1856);
  let x_1858 : f32 = u_xlat21;
  u_xlat21 = (-(x_1858) + 1.0f);
  let x_1861 : f32 = u_xlat21;
  let x_1863 : f32 = u_xlat1.x;
  u_xlat21 = (x_1861 * x_1863);
  let x_1865 : vec3<f32> = u_xlat0;
  let x_1866 : vec3<f32> = (x_1865 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1867 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1866.x, x_1866.y, x_1866.z, x_1867.w);
  let x_1869 : vec3<f32> = u_xlat0;
  let x_1870 : vec3<f32> = log2(x_1869);
  let x_1871 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1870.x, x_1870.y, x_1870.z, x_1871.w);
  let x_1873 : vec4<f32> = u_xlat2;
  let x_1875 : vec3<f32> = (vec3<f32>(x_1873.x, x_1873.y, x_1873.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1876 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1875.x, x_1875.y, x_1875.z, x_1876.w);
  let x_1878 : vec4<f32> = u_xlat2;
  let x_1880 : vec3<f32> = exp2(vec3<f32>(x_1878.x, x_1878.y, x_1878.z));
  let x_1881 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1880.x, x_1880.y, x_1880.z, x_1881.w);
  let x_1883 : vec4<f32> = u_xlat2;
  let x_1886 : vec3<f32> = ((vec3<f32>(x_1883.x, x_1883.y, x_1883.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1887 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1886.x, x_1886.y, x_1886.z, x_1887.w);
  let x_1889 : vec3<f32> = u_xlat0;
  let x_1891 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1889.x, x_1889.y, x_1889.z, x_1889.x));
  u_xlatb0 = vec3<bool>(x_1891.x, x_1891.y, x_1891.z);
  let x_1894 : bool = u_xlatb0.x;
  if (x_1894) {
  ...
  u_xlat0.x = x_1903;
  let x_1906 : bool = u_xlatb0.y;
  if (x_1906) {
    let x_1911 : f32 = u_xlat1.y;
    x_1907 = x_1911;
  } else {
  ...
  u_xlat0.y = x_1915;
  let x_1918 : bool = u_xlatb0.z;
  if (x_1918) {
    let x_1923 : f32 = u_xlat1.z;
    x_1919 = x_1923;
  } else {
  ...
  u_xlat0.z = x_1927;
  let x_1929 : f32 = u_xlat21;
  let x_1934 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1929, x_1929, x_1929) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1934);
  let x_1936 : vec3<f32> = u_xlat0;
  let x_1937 : vec3<f32> = (x_1936 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1938 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1937.x, x_1937.y, x_1937.z, x_1938.w);
  let x_1940 : vec3<f32> = u_xlat0;
  let x_1941 : vec3<f32> = (x_1940 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1942 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1941.x, x_1941.y, x_1941.z, x_1942.w);
  let x_1944 : vec4<f32> = u_xlat2;
  let x_1946 : vec3<f32> = (vec3<f32>(x_1944.x, x_1944.y, x_1944.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1947 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1946.x, x_1946.y, x_1946.z, x_1947.w);
  let x_1949 : vec4<f32> = u_xlat2;
  let x_1952 : vec3<f32> = log2(abs(vec3<f32>(x_1949.x, x_1949.y, x_1949.z)));
  let x_1953 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1952.x, x_1952.y, x_1952.z, x_1953.w);
  let x_1955 : vec4<f32> = u_xlat2;
  let x_1957 : vec3<f32> = (vec3<f32>(x_1955.x, x_1955.y, x_1955.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1958 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1957.x, x_1957.y, x_1957.z, x_1958.w);
  let x_1960 : vec4<f32> = u_xlat2;
  let x_1962 : vec3<f32> = exp2(vec3<f32>(x_1960.x, x_1960.y, x_1960.z));
  let x_1963 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1962.x, x_1962.y, x_1962.z, x_1963.w);
  let x_1965 : vec3<f32> = u_xlat0;
  let x_1967 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1965.x, x_1965.y, x_1965.z, x_1965.x));
  u_xlatb0 = vec3<bool>(x_1967.x, x_1967.y, x_1967.z);
  let x_1970 : bool = u_xlatb0.x;
  if (x_1970) {
    let x_1975 : f32 = u_xlat1.x;
    x_1971 = x_1975;
  } else {
    let x_1978 : f32 = u_xlat2.x;
    x_1971 = x_1978;
  }
  let x_1979 : f32 = x_1971;
  u_xlat0.x = x_1979;
  let x_1982 : bool = u_xlatb0.y;
  if (x_1982) {
    let x_1987 : f32 = u_xlat1.y;
    x_1983 = x_1987;
  } else {
    let x_1990 : f32 = u_xlat2.y;
    x_1983 = x_1990;
  }
  let x_1991 : f32 = x_1983;
  u_xlat0.y = x_1991;
  let x_1994 : bool = u_xlatb0.z;
  if (x_1994) {
    let x_1999 : f32 = u_xlat1.z;
    x_1995 = x_1999;
  } else {
    let x_2002 : f32 = u_xlat2.z;
    x_1995 = x_2002;
  }
  let x_2003 : f32 = x_1995;
  u_xlat0.z = x_2003;
  let x_2007 : vec3<f32> = u_xlat0;
  let x_2008 : vec3<f32> = max(x_2007, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2009 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2008.x, x_2008.y, x_2008.z, x_2009.w);
  SV_Target0.w = 1.0f;
  return;
}
