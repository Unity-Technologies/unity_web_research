...
@group(0) @binding(0) var Texture2D_E9EC22CC : texture_2d<f32>;

@group(0) @binding(1) var samplerTexture2D_E9EC22CC : sampler;
...
fn main_1() {
  ...
  u_xlat2 = (vec3<f32>(x_59.y, x_59.z, x_59.x) * vec3<f32>(x_63.z, x_63.x, x_63.y));
  let x_66 : vec3<f32> = vs_INTERP2;
  ...
  let x_91 : vec4<f32> = vs_INTERP1;
  let x_98 : f32 = x_95.x_GlobalMipBias.x;
  let x_99 : vec4<f32> = textureSampleBias(Texture2D_E9EC22CC, samplerTexture2D_E9EC22CC, vec2<f32>(x_91.x, x_91.y), x_98);
  ...
  u_xlat6 = max(x_140, 0.0000000000000001f);
  let x_143 : f32 = u_xlat6;
  let x_145 : vec3<f32> = vs_INTERP2;
...
@fragment
fn main(@location(0) vs_INTERP0_param : vec4<f32>, @location(2) vs_INTERP2_param : vec3<f32>, @location(1) vs_INTERP1_param : vec4<f32>, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
