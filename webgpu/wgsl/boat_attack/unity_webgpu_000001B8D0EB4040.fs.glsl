...
;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat51.x = dot(_AdditionalLightsSpotDir[u_xlati68].xyz, u_xlat10.xyz);
        u_xlat51.x = u_xlat51.x * _AdditionalLightsAttenuation[u_xlati68].z + _AdditionalLightsAttenuation[u_xlati68].w;
        u_xlat51.x = clamp(u_xlat51.x, 0.0, 1.0);
        u_xlat51.x = u_xlat51.x * u_xlat51.x;
        u_xlat70 = u_xlat70 * u_xlat51.x;
        u_xlat11.xyz = vec3(u_xlat29) * _AdditionalLightsColor[u_xlati68].xyz;
