...
;
    ...
    u_xlat4.xyz = vs_INTERP0.yyy * _MainLightWorldToShadow[(u_xlati14 + 1) / 4][(u_xlati14 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati14 / 4][u_xlati14 % 4].xyz * vs_INTERP0.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati14 + 2) / 4][(u_xlati14 + 2) % 4].xyz * vs_INTERP0.zzz + u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz + _MainLightWorldToShadow[(u_xlati14 + 3) / 4][(u_xlati14 + 3) % 4].xyz;
    ...
    u_xlat28 = dot(u_xlat15.xyz, u_xlat5.xyz);
    ...
    u_xlat28 = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    ...
    u_xlat46 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat6.xz, _GlobalMipBias.x).x;
    ...
    if(u_xlatb18.x){
        ...
        u_xlat6 = texture(sampler2D(_MainLightCookieTexture, sampler_MainLightCookieTexture), u_xlat18.xy, _GlobalMipBias.x);
        ...
        u_xlat32 = (u_xlatb18.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat18.xyz = (u_xlatb18.x) ? u_xlat6.xyz : vec3(u_xlat32);
    } else {
    ...
    u_xlat6.xyz = u_xlat15.xyz * (-u_xlat6.xxx) + (-u_xlat3.xyz);
    ...
    u_xlat4.xyz = vec3(u_xlat28) * u_xlat18.xyz;
    ...
    u_xlat28 = dot(u_xlat15.xyz, u_xlat6.xyz);
    ...
    u_xlat6.xyz = u_xlat2.xyz * vec3(u_xlat28) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat46 = dot(unity_LightIndices[int(u_xlatu46)], uintBitsToFloat(ImmCB_0[u_xlati34]));
        ...
        u_xlat34 = u_xlat34 * _AdditionalLightsAttenuation[int(u_xlatu46)].x;
        ...
        u_xlat9.xyz = u_xlat2.xyz * vec3(u_xlat46) + u_xlat7.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xzw = u_xlat5.xyz * vec3(u_xlat42) + u_xlat4.xyz;
