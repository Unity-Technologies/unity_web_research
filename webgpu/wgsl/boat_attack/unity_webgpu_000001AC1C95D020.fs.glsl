...
;
    ...
    u_xlat82 = u_xlat79 * u_xlat79;
    u_xlat52 = u_xlat52 + u_xlat81;
    u_xlat52 = clamp(u_xlat52, 0.0, 1.0);
    u_xlat81 = u_xlat79 * 4.0 + 2.0;
    ...
    if(u_xlatb83){
        ...
        if(u_xlatb83){
            ...
            u_xlat83 = dot(u_xlat7, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb6){
                ...
                u_xlat32 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec4, 0.0);
                ...
                u_xlat32 = u_xlat13.x * u_xlat32 + u_xlat7.x;
                vec3 txVec6 = vec3(u_xlat58.xy,u_xlat2.z);
                u_xlat58.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat32 = u_xlat13.z * u_xlat58.x + u_xlat32;
                vec3 txVec7 = vec3(u_xlat9.xy,u_xlat2.z);
                u_xlat58.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat32 = u_xlat13.w * u_xlat58.x + u_xlat32;
                vec3 txVec8 = vec3(u_xlat11.xy,u_xlat2.z);
                u_xlat58.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat32 = u_xlat14.x * u_xlat58.x + u_xlat32;
                vec3 txVec9 = vec3(u_xlat11.zw,u_xlat2.z);
                u_xlat58.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat32 = u_xlat14.y * u_xlat58.x + u_xlat32;
                vec3 txVec10 = vec3(u_xlat9.zw,u_xlat2.z);
                u_xlat58.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat32 = u_xlat14.z * u_xlat58.x + u_xlat32;
                vec3 txVec11 = vec3(u_xlat8.xy,u_xlat2.z);
                u_xlat58.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat32 = u_xlat14.w * u_xlat58.x + u_xlat32;
                vec3 txVec12 = vec3(u_xlat8.zw,u_xlat2.z);
                u_xlat58.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                u_xlat83 = u_xlat6.x * u_xlat58.x + u_xlat32;
            } else {
                u_xlat6.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat6.xy = floor(u_xlat6.xy);
                u_xlat58.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat6.xy);
                ...
                u_xlat86 = u_xlat86 * u_xlat17.y;
                u_xlat8.x = u_xlat17.x * u_xlat8.x + u_xlat86;
                ...
                u_xlat58.x = u_xlat17.z * u_xlat58.x + u_xlat8.x;
                ...
                u_xlat58.x = u_xlat17.w * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat18.x * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat18.y * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat18.z * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat18.w * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat19.x * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat19.y * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat19.z * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat19.w * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat7.x * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat7.y * u_xlat84 + u_xlat58.x;
                ...
                u_xlat58.x = u_xlat7.z * u_xlat84 + u_xlat58.x;
                ...
                u_xlat83 = u_xlat7.w * u_xlat6.x + u_xlat58.x;
            }
        }
    } else {
    ...
    u_xlat2.x = u_xlat83 * _MainLightShadowParams.x + u_xlat2.x;
    ...
    u_xlat83 = (-u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat54 * u_xlat83 + u_xlat2.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat54 = dot(unity_LightIndices[int(u_xlatu54)], uintBitsToFloat(ImmCB_0[u_xlati83]));
        ...
        u_xlat83 = u_xlat83 * _AdditionalLightsAttenuation[u_xlati54].x;
        u_xlat83 = (-u_xlat83) * u_xlat83 + 1.0;
        u_xlat83 = max(u_xlat83, 0.0);
        u_xlat83 = u_xlat83 * u_xlat83;
        u_xlat83 = u_xlat83 * u_xlat85;
        u_xlat85 = dot(_AdditionalLightsSpotDir[u_xlati54].xyz, u_xlat10.xyz);
        u_xlat85 = u_xlat85 * _AdditionalLightsAttenuation[u_xlati54].z + _AdditionalLightsAttenuation[u_xlati54].w;
        u_xlat85 = clamp(u_xlat85, 0.0, 1.0);
        u_xlat85 = u_xlat85 * u_xlat85;
        u_xlat83 = u_xlat83 * u_xlat85;
        u_xlati85 = int(_AdditionalShadowParams[u_xlati54].w);
        u_xlatb86 = u_xlati85>=0;
        if(u_xlatb86){
            u_xlatb86 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati54].z);
            if(u_xlatb86){
                ...
                u_xlat86 = (u_xlatb86) ? u_xlat11.x : u_xlat88;
                u_xlat88 = trunc(_AdditionalShadowParams[u_xlati54].w);
            ...
            if(u_xlatb85){
                ...
                if(u_xlatb85){
                    ...
                    u_xlatb86 = 2.0==_AdditionalShadowParams[u_xlati54].y;
                    if(u_xlatb86){
                        ...
                        u_xlat85 = u_xlat86 * u_xlat89 + u_xlat88;
                    } else {
                        u_xlat12.xy = u_xlat11.xy * _AdditionalShadowmapSize.zw + vec2(0.5, 0.5);
                        u_xlat12.xy = floor(u_xlat12.xy);
                        u_xlat64.xy = u_xlat11.xy * _AdditionalShadowmapSize.zw + (-u_xlat12.xy);
                        ...
                        u_xlat86 = u_xlat13.x * u_xlat88 + u_xlat86;
                        ...
                        u_xlat86 = u_xlat13.y * u_xlat88 + u_xlat86;
                        ...
                        u_xlat86 = u_xlat13.z * u_xlat88 + u_xlat86;
                        ...
                        u_xlat85 = u_xlat13.w * u_xlat88 + u_xlat86;
                    }
                }
            } else {
            ...
            u_xlat86 = 1.0 + (-_AdditionalShadowParams[u_xlati54].x);
            u_xlat85 = u_xlat85 * _AdditionalShadowParams[u_xlati54].x + u_xlat86;
            u_xlatb86 = 0.0>=u_xlat11.z;
            u_xlatb88 = u_xlat11.z>=1.0;
            u_xlatb86 = u_xlatb86 || u_xlatb88;
            u_xlat85 = (u_xlatb86) ? 1.0 : u_xlat85;
        } else {
            u_xlat85 = 1.0;
        }
        u_xlat86 = (-u_xlat85) + 1.0;
        u_xlat85 = u_xlat52 * u_xlat86 + u_xlat85;
        u_xlati86 = 1 << (u_xlati54 & int(0x1F));
        u_xlati86 = int(uint(u_xlati86) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati86 != 0) {
            u_xlati86 = int(_AdditionalLightsLightTypes[u_xlati54]);
            u_xlati88 = (u_xlati86 != 0) ? 0 : 1;
            u_xlati11 = u_xlati54 << (2 & int(0x1F));
            if(u_xlati88 != 0) {
                ...
                u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati54].xy * u_xlat37.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati54].zw;
            } else {
                ...
                if(u_xlati86 != 0) {
                    ...
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati54].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati54].zw;
                } else {
                    ...
                    u_xlat11.xw = u_xlat12.xy * vec2(u_xlat86) + u_xlat11.xw;
                    u_xlat11.xw = u_xlat11.xw * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat11.xw = clamp(u_xlat11.xw, 0.0, 1.0);
                    u_xlat37.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati54].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati54].zw;
                }
            }
            u_xlat11 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat37.xy, 0.0);
            u_xlat86 = (u_xlatb2.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb2.x) ? u_xlat11.xyz : vec3(u_xlat86);
        } else {
