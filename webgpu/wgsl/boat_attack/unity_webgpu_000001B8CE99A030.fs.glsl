...
layout(set = 0, binding = 7) uniform mediump texture2D _SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1;
...
layout(set = 0, binding = 18) uniform mediump  sampler sampler_SampleTexture2D_a490b3241735d68e9ee2d1f1bbfed8dc_Texture_1;
layout(set = 0, binding = 19) uniform mediump  sampler sampler_MainTex;
layout(set = 0, binding = 20) uniform mediump  sampler samplerTexture2D_DE8BF47E;
layout(set = 0, binding = 21) uniform mediump  sampler samplerTexture2D_C005B064;
layout(set = 0, binding = 22) uniform mediump  sampler samplerTexture2D_D7D66558;
void main()
{
vec4 u_xlat0;
uint u_xlatu0;
...
;
    ...
    u_xlat66 = dot(u_xlat21.xyz, u_xlat5.xyz);
