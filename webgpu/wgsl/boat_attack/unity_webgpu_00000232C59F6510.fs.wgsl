...
fn main_1() {
  ...
  u_xlat1 = ((vec4<f32>(0.53804999589920043945f, 0.53804999589920043945f, 2.06277990341186523438f, 2.06277990341186523438f) * vec4<f32>(x_41.x, x_41.y, x_41.x, x_41.y)) + vec4<f32>(x_46.x, x_46.y, x_46.x, x_46.y));
  let x_52 : vec4<f32> = u_xlat0;
  let x_55 : vec2<f32> = vs_TEXCOORD0;
  u_xlat0 = ((vec4<f32>(-0.53804999589920043945f, -0.53804999589920043945f, -2.06277990341186523438f, -2.06277990341186523438f) * vec4<f32>(x_52.x, x_52.y, x_52.x, x_52.y)) + vec4<f32>(x_55.x, x_55.y, x_55.x, x_55.y));
  ...
  u_xlat0.x = ((x_119 * 0.44907999038696289062f) + x_122);
  let x_128 : f32 = u_xlat0.x;
  SV_Target0.w = (-(x_128) + 1.0f);
  let x_135 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(vec3<f32>(0.0f, 0.0f, 0.0f).x, vec3<f32>(0.0f, 0.0f, 0.0f).y, vec3<f32>(0.0f, 0.0f, 0.0f).z, x_135.w);
  return;
}
