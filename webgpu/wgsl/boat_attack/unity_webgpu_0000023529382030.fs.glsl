...
;
    ...
    u_xlat2.xyz = vec3(u_xlat51) * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat70 = u_xlat70 * u_xlat73;
        u_xlat11.xyz = vec3(u_xlat51) * _AdditionalLightsColor[u_xlati69].xyz;
        ...
        u_xlat9.xyz = vec3(u_xlat69) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat5.xyz;
