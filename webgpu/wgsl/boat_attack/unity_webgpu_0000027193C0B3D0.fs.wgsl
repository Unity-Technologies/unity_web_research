...
fn main_1() {
  ...
  let x_826 : vec3<f32> = ((x_820 * vec3<f32>(x_821.x, x_821.x, x_821.x)) + vec3<f32>(x_824.x, x_824.y, x_824.z));
  let x_827 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_826.x, x_826.y, x_826.z, x_827.w);
  SV_Target0.w = 1.0f;
  return;
}
