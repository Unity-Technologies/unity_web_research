...
void main()
{
    ...
    u_xlat28.xyz = unity_SHC.xyz * vec3(u_xlat79) + u_xlat6.xyz;
    ...
    u_xlat3.x = u_xlat52 + (-u_xlat79);
    u_xlat29.xyz = vec3(u_xlat79) * u_xlat5.xyz;
    ...
    u_xlat28.xyz = u_xlat28.xyz * u_xlat29.xyz + u_xlat8.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu52 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat58.x = u_xlat79 / u_xlat58.x;
        u_xlat9.xyz = u_xlat4.xyz * u_xlat58.xxx + u_xlat29.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat28.xyz * vec3(u_xlat26) + u_xlat5.xzw;
    u_xlat0.xyz = u_xlat8.xyz + u_xlat0.xyz;
    u_xlat0.xyz = vec3(u_xlat78) * u_xlat0.xyz;
    u_xlat78 = u_xlat2.x * (-u_xlat2.x);
