...
fn main_1() {
  ...
  let x_2278 : bool = u_xlatb0.x;
  if (x_2278) {
    let x_2283 : f32 = u_xlat1.x;
    x_2279 = x_2283;
  } else {
    let x_2286 : f32 = u_xlat2.x;
    x_2279 = x_2286;
  }
  let x_2287 : f32 = x_2279;
  SV_Target0.x = x_2287;
  let x_2291 : bool = u_xlatb0.y;
  if (x_2291) {
    let x_2296 : f32 = u_xlat1.y;
    x_2292 = x_2296;
  } else {
    let x_2299 : f32 = u_xlat2.y;
    x_2292 = x_2299;
  }
  let x_2300 : f32 = x_2292;
  SV_Target0.y = x_2300;
  let x_2303 : bool = u_xlatb0.z;
  if (x_2303) {
    let x_2308 : f32 = u_xlat1.z;
    x_2304 = x_2308;
  } else {
