...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat0.xyz = Color_7eff2e7fc27440719d0a871a39dabdd3.xyz * u_xlat0.xyz + (-unity_FogColor.xyz);
    u_xlat1.xyz = vs_INTERP2.yyy * unity_WorldToObject[1].xyz;
    u_xlat1.xyz = unity_WorldToObject[0].xyz * vs_INTERP2.xxx + u_xlat1.xyz;
    u_xlat1.xyz = unity_WorldToObject[2].xyz * vs_INTERP2.zzz + u_xlat1.xyz;
    ...
    u_xlat18 = u_xlat18 / _BA_SkyboxRatio;
    u_xlat18 = (-u_xlat18) * u_xlat18 + 1.0;
    u_xlat18 = exp2(u_xlat18);
    u_xlat18 = (-u_xlat18) + 1.0;
    u_xlat1.x = (-_BA_SkyboxRatio) + 1.0;
    u_xlat1.x = (-_WorldSpaceCameraPos.y) * u_xlat1.x + vs_INTERP2.y;
    u_xlat1.x = (-Vector1_10DA9AB3) * _BA_SkyboxRatio + u_xlat1.x;
    u_xlat7 = _BA_SkyboxRatio * Vector1_33982692;
