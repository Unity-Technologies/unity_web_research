...
fn main_1() {
  ...
  let x_2016 : vec3<f32> = (vec3<f32>(x_2014.x, x_2014.y, x_2014.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2017 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2016.x, x_2016.y, x_2016.z, x_2017.w);
  let x_2019 : vec4<f32> = u_xlat0;
  let x_2022 : vec3<f32> = log2(abs(vec3<f32>(x_2019.x, x_2019.y, x_2019.z)));
  let x_2023 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2022.x, x_2022.y, x_2022.z, x_2023.w);
  let x_2025 : vec4<f32> = u_xlat2;
  let x_2027 : vec3<f32> = (vec3<f32>(x_2025.x, x_2025.y, x_2025.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2028 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2027.x, x_2027.y, x_2027.z, x_2028.w);
  let x_2030 : vec4<f32> = u_xlat2;
  let x_2032 : vec3<f32> = exp2(vec3<f32>(x_2030.x, x_2030.y, x_2030.z));
  let x_2033 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2032.x, x_2032.y, x_2032.z, x_2033.w);
  let x_2035 : vec4<f32> = u_xlat2;
  let x_2038 : vec3<f32> = ((vec3<f32>(x_2035.x, x_2035.y, x_2035.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2039 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2038.x, x_2038.y, x_2038.z, x_2039.w);
  let x_2041 : vec4<f32> = u_xlat0;
  let x_2043 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2041.x, x_2041.y, x_2041.z, x_2041.x));
  u_xlatb0 = vec3<bool>(x_2043.x, x_2043.y, x_2043.z);
  let x_2046 : bool = u_xlatb0.x;
  if (x_2046) {
    let x_2051 : f32 = u_xlat1.x;
    x_2047 = x_2051;
  } else {
  ...
  u_xlat0.x = x_2055;
  let x_2058 : bool = u_xlatb0.y;
  if (x_2058) {
    let x_2063 : f32 = u_xlat1.y;
    x_2059 = x_2063;
  } else {
    let x_2066 : f32 = u_xlat2.y;
    x_2059 = x_2066;
  }
  let x_2067 : f32 = x_2059;
  u_xlat0.y = x_2067;
  let x_2070 : bool = u_xlatb0.z;
  if (x_2070) {
    let x_2075 : f32 = u_xlat1.z;
    x_2071 = x_2075;
  } else {
    let x_2078 : f32 = u_xlat2.z;
    x_2071 = x_2078;
  }
  let x_2079 : f32 = x_2071;
  u_xlat0.z = x_2079;
  let x_2081 : vec2<f32> = vs_TEXCOORD0;
  let x_2084 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2088 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2090 : vec2<f32> = ((x_2081 * vec2<f32>(x_2084.x, x_2084.y)) + vec2<f32>(x_2088.z, x_2088.w));
  let x_2091 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2090.x, x_2090.y, x_2091.z, x_2091.w);
  let x_2098 : vec4<f32> = u_xlat1;
  let x_2101 : f32 = x_25.x_GlobalMipBias.x;
  let x_2102 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2098.x, x_2098.y), x_2101);
  u_xlat18 = x_2102.w;
  let x_2104 : f32 = u_xlat18;
  u_xlat18 = ((x_2104 * 2.0f) + -1.0f);
  let x_2107 : f32 = u_xlat18;
  u_xlatb1 = (x_2107 >= 0.0f);
  let x_2109 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2109);
  let x_2112 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_2112)) + 1.0f);
  let x_2116 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_2116);
  let x_2118 : f32 = u_xlat18;
  u_xlat18 = (-(x_2118) + 1.0f);
  let x_2121 : f32 = u_xlat18;
  let x_2123 : f32 = u_xlat1.x;
  u_xlat18 = (x_2121 * x_2123);
  let x_2125 : vec4<f32> = u_xlat0;
  let x_2127 : vec3<f32> = (vec3<f32>(x_2125.x, x_2125.y, x_2125.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2128 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2127.x, x_2127.y, x_2127.z, x_2128.w);
  let x_2130 : vec4<f32> = u_xlat0;
  let x_2133 : vec3<f32> = log2(abs(vec3<f32>(x_2130.x, x_2130.y, x_2130.z)));
  let x_2134 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2133.x, x_2133.y, x_2133.z, x_2134.w);
  let x_2136 : vec4<f32> = u_xlat2;
  let x_2138 : vec3<f32> = (vec3<f32>(x_2136.x, x_2136.y, x_2136.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2139 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2138.x, x_2138.y, x_2138.z, x_2139.w);
  let x_2141 : vec4<f32> = u_xlat2;
  let x_2143 : vec3<f32> = exp2(vec3<f32>(x_2141.x, x_2141.y, x_2141.z));
  let x_2144 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2143.x, x_2143.y, x_2143.z, x_2144.w);
  let x_2146 : vec4<f32> = u_xlat2;
  let x_2149 : vec3<f32> = ((vec3<f32>(x_2146.x, x_2146.y, x_2146.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2150 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2149.x, x_2149.y, x_2149.z, x_2150.w);
  let x_2152 : vec4<f32> = u_xlat0;
  let x_2154 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2152.x, x_2152.y, x_2152.z, x_2152.x));
  u_xlatb0 = vec3<bool>(x_2154.x, x_2154.y, x_2154.z);
  let x_2157 : bool = u_xlatb0.x;
  if (x_2157) {
    let x_2162 : f32 = u_xlat1.x;
    x_2158 = x_2162;
  } else {
    let x_2165 : f32 = u_xlat2.x;
    x_2158 = x_2165;
  }
  let x_2166 : f32 = x_2158;
  u_xlat0.x = x_2166;
  let x_2169 : bool = u_xlatb0.y;
  if (x_2169) {
    let x_2174 : f32 = u_xlat1.y;
    x_2170 = x_2174;
  } else {
    let x_2177 : f32 = u_xlat2.y;
    x_2170 = x_2177;
  }
  let x_2178 : f32 = x_2170;
  u_xlat0.y = x_2178;
  let x_2181 : bool = u_xlatb0.z;
  if (x_2181) {
    let x_2186 : f32 = u_xlat1.z;
    x_2182 = x_2186;
  } else {
  ...
  u_xlat0.z = x_2190;
  let x_2192 : f32 = u_xlat18;
  let x_2197 : vec4<f32> = u_xlat0;
  let x_2199 : vec3<f32> = ((vec3<f32>(x_2192, x_2192, x_2192) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_2197.x, x_2197.y, x_2197.z));
  let x_2200 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2199.x, x_2199.y, x_2199.z, x_2200.w);
  let x_2202 : vec4<f32> = u_xlat0;
  let x_2204 : vec3<f32> = (vec3<f32>(x_2202.x, x_2202.y, x_2202.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2205 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2204.x, x_2204.y, x_2204.z, x_2205.w);
  let x_2207 : vec4<f32> = u_xlat0;
  let x_2209 : vec3<f32> = (vec3<f32>(x_2207.x, x_2207.y, x_2207.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2210 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2209.x, x_2209.y, x_2209.z, x_2210.w);
  let x_2212 : vec4<f32> = u_xlat2;
  let x_2214 : vec3<f32> = (vec3<f32>(x_2212.x, x_2212.y, x_2212.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2215 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2214.x, x_2214.y, x_2214.z, x_2215.w);
  let x_2217 : vec4<f32> = u_xlat2;
  let x_2220 : vec3<f32> = log2(abs(vec3<f32>(x_2217.x, x_2217.y, x_2217.z)));
  let x_2221 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2220.x, x_2220.y, x_2220.z, x_2221.w);
  let x_2223 : vec4<f32> = u_xlat2;
  let x_2225 : vec3<f32> = (vec3<f32>(x_2223.x, x_2223.y, x_2223.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2226 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2225.x, x_2225.y, x_2225.z, x_2226.w);
  let x_2228 : vec4<f32> = u_xlat2;
  let x_2230 : vec3<f32> = exp2(vec3<f32>(x_2228.x, x_2228.y, x_2228.z));
  let x_2231 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2230.x, x_2230.y, x_2230.z, x_2231.w);
  let x_2233 : vec4<f32> = u_xlat0;
  let x_2235 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2233.x, x_2233.y, x_2233.z, x_2233.x));
  u_xlatb0 = vec3<bool>(x_2235.x, x_2235.y, x_2235.z);
  let x_2238 : bool = u_xlatb0.x;
  if (x_2238) {
  ...
  u_xlat0.x = x_2247;
  let x_2250 : bool = u_xlatb0.y;
  if (x_2250) {
    let x_2255 : f32 = u_xlat1.y;
    x_2251 = x_2255;
  } else {
    let x_2258 : f32 = u_xlat2.y;
    x_2251 = x_2258;
  }
  let x_2259 : f32 = x_2251;
  u_xlat0.y = x_2259;
  let x_2262 : bool = u_xlatb0.z;
  if (x_2262) {
    let x_2267 : f32 = u_xlat1.z;
    x_2263 = x_2267;
  } else {
  ...
  let x_2277 : vec3<f32> = max(vec3<f32>(x_2275.x, x_2275.y, x_2275.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2278 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2277.x, x_2277.y, x_2277.z, x_2278.w);
  SV_Target0.w = 1.0f;
  return;
}
