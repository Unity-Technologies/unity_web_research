...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat27.x = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat6.z = (-u_xlat27.x) + 1.0;
    u_xlat3.x = u_xlat3.x;
    ...
    u_xlat8.xyz = u_xlat4.xyz * (-vec3(u_xlat30)) + (-u_xlat1.xzw);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu38 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat42) + u_xlat1.xzw;
        ...
        u_xlat39 = u_xlat39 * u_xlat27.x + 1.00001001;
        u_xlat30 = u_xlat30 * u_xlat30;
        u_xlat39 = u_xlat39 * u_xlat39;
        ...
        u_xlat9.xyz = vec3(u_xlat39) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
