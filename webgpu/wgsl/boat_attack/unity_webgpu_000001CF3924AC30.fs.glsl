...
void main()
{
    ...
    u_xlatb20.x = vs_TEXCOORD8.z>=1.0;
    ...
    if(u_xlatb20.x){
        u_xlat20.xy = vs_TEXCOORD7.yy * _MainLightWorldToLight[1].xy;
        u_xlat20.xy = _MainLightWorldToLight[0].xy * vs_TEXCOORD7.xx + u_xlat20.xy;
        u_xlat20.xy = _MainLightWorldToLight[2].xy * vs_TEXCOORD7.zz + u_xlat20.xy;
    ...
    u_xlat8.xyz = (-u_xlat5.xyz) + vec3(u_xlat45);
    u_xlat8.xyz = vec3(u_xlat49) * u_xlat8.xyz + u_xlat5.xyz;
