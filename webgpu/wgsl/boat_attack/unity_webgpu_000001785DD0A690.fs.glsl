...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat40 = u_xlat5.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    ...
    u_xlat43 = texture(sampler2D(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture), u_xlat5.xz, _GlobalMipBias.x).x;
    ...
    u_xlat43 = u_xlat43 * _MainLightShadowParams.x + u_xlat18.x;
    u_xlatb18.x = 0.0>=vs_INTERP8.z;
    u_xlatb31 = vs_INTERP8.z>=1.0;
    u_xlatb18.x = u_xlatb31 || u_xlatb18.x;
    u_xlat43 = (u_xlatb18.x) ? 1.0 : u_xlat43;
    ...
    u_xlat43 = u_xlat18.x * u_xlat31 + u_xlat43;
    ...
    if(u_xlatb18.x){
        ...
        u_xlat31 = (u_xlatb18.y) ? u_xlat7.w : u_xlat7.x;
        u_xlat18.xyz = (u_xlatb18.x) ? u_xlat7.xyz : vec3(u_xlat31);
    } else {
    ...
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat45)) + (-u_xlat3.xyz);
    ...
    u_xlat40 = u_xlat43 * unity_LightData.z;
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat40) + u_xlat6.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu40 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat21.xyz = u_xlat0.xyz * vec3(u_xlat45) + u_xlat6.xyz;
        u_xlat7.xyz = u_xlat21.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat28) + u_xlat18.xyz;
