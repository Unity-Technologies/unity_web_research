...
fn main_1() {
  ...
  u_xlat0 = sqrt(x_1519);
  let x_1521 : vec2<f32> = vs_TEXCOORD0;
  let x_1524 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1528 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1530 : vec2<f32> = ((x_1521 * vec2<f32>(x_1524.x, x_1524.y)) + vec2<f32>(x_1528.z, x_1528.w));
  let x_1531 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1530.x, x_1530.y, x_1531.z, x_1531.w);
  let x_1538 : vec4<f32> = u_xlat1;
  let x_1541 : f32 = x_26.x_GlobalMipBias.x;
  let x_1542 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1538.x, x_1538.y), x_1541);
  u_xlat15 = x_1542.w;
  let x_1544 : f32 = u_xlat15;
  u_xlat15 = ((x_1544 * 2.0f) + -1.0f);
  let x_1547 : f32 = u_xlat15;
  u_xlatb1 = (x_1547 >= 0.0f);
  let x_1549 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1549);
  let x_1552 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1552)) + 1.0f);
  let x_1556 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1556);
  let x_1558 : f32 = u_xlat15;
  u_xlat15 = (-(x_1558) + 1.0f);
  let x_1561 : f32 = u_xlat15;
  let x_1563 : f32 = u_xlat1.x;
  u_xlat15 = (x_1561 * x_1563);
  let x_1565 : vec3<f32> = u_xlat0;
  let x_1566 : vec3<f32> = (x_1565 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1567 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1566.x, x_1566.y, x_1566.z, x_1567.w);
  let x_1569 : vec3<f32> = u_xlat0;
  let x_1570 : vec3<f32> = log2(x_1569);
  ...
  u_xlat0.z = x_1627;
  let x_1629 : f32 = u_xlat15;
  let x_1634 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1629, x_1629, x_1629) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1634);
  let x_1636 : vec3<f32> = u_xlat0;
  let x_1637 : vec3<f32> = (x_1636 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1638 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1637.x, x_1637.y, x_1637.z, x_1638.w);
  let x_1640 : vec3<f32> = u_xlat0;
  let x_1641 : vec3<f32> = (x_1640 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1642 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1641.x, x_1641.y, x_1641.z, x_1642.w);
  let x_1644 : vec4<f32> = u_xlat2;
  let x_1646 : vec3<f32> = (vec3<f32>(x_1644.x, x_1644.y, x_1644.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1647 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1646.x, x_1646.y, x_1646.z, x_1647.w);
  let x_1649 : vec4<f32> = u_xlat2;
  let x_1652 : vec3<f32> = log2(abs(vec3<f32>(x_1649.x, x_1649.y, x_1649.z)));
  let x_1653 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1652.x, x_1652.y, x_1652.z, x_1653.w);
  let x_1655 : vec4<f32> = u_xlat2;
  let x_1657 : vec3<f32> = (vec3<f32>(x_1655.x, x_1655.y, x_1655.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1658 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1657.x, x_1657.y, x_1657.z, x_1658.w);
  let x_1660 : vec4<f32> = u_xlat2;
  let x_1662 : vec3<f32> = exp2(vec3<f32>(x_1660.x, x_1660.y, x_1660.z));
  let x_1663 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1662.x, x_1662.y, x_1662.z, x_1663.w);
  let x_1665 : vec3<f32> = u_xlat0;
  let x_1667 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1665.x));
  ...
  let x_1708 : vec3<f32> = max(x_1707, vec3<f32>(0.0f, 0.0f, 0.0f));
