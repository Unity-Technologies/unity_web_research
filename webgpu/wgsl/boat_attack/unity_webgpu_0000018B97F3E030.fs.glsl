...
;
    ...
    u_xlatb28.x = 0.0>=u_xlat2.z;
    u_xlatb54 = u_xlat2.z>=1.0;
    u_xlatb28.x = u_xlatb54 || u_xlatb28.x;
    u_xlat2.x = (u_xlatb28.x) ? 1.0 : u_xlat2.x;
    ...
    u_xlat9.xyz = (-u_xlat5.xyz) + vec3(u_xlat81);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu52 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat86 = dot(_AdditionalLightsSpotDir[u_xlati83].xyz, u_xlat10.xyz);
        u_xlat86 = u_xlat86 * _AdditionalLightsAttenuation[u_xlati83].z + _AdditionalLightsAttenuation[u_xlati83].w;
        u_xlat86 = clamp(u_xlat86, 0.0, 1.0);
        u_xlat86 = u_xlat86 * u_xlat86;
        u_xlat84 = u_xlat84 * u_xlat86;
        u_xlati86 = int(_AdditionalShadowParams[u_xlati83].w);
        ...
        if(u_xlatb87){
            ...
            u_xlatb86 = 0.0<_AdditionalShadowParams[u_xlati83].y;
            if(u_xlatb86){
                u_xlatb86 = 1.0==_AdditionalShadowParams[u_xlati83].y;
                if(u_xlatb86){
            ...
            u_xlat86 = u_xlat86 * _AdditionalShadowParams[u_xlati83].x + u_xlat87;
        ...
        if(u_xlati87 != 0) {
            ...
            u_xlat87 = (u_xlatb28.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb28.x) ? u_xlat11.xyz : vec3(u_xlat87);
        } else {
