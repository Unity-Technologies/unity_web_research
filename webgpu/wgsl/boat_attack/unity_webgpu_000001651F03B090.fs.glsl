...
;
    ...
    u_xlat4.xzw = vec3(u_xlat18) * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu28 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat48 = u_xlat48 * u_xlat50;
        u_xlat10.xyz = vec3(u_xlat18) * _AdditionalLightsColor[u_xlati47].xyz;
        u_xlat47 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat47 = clamp(u_xlat47, 0.0, 1.0);
        u_xlat47 = u_xlat47 * u_xlat48;
        u_xlat10.xyz = vec3(u_xlat47) * u_xlat10.xyz;
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat49) + u_xlat7.xyz;
        ...
        u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat47) + u_xlat6.xyz;
