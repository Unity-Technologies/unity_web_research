...
;
    ...
    if(u_xlatb0){
        ...
        if(u_xlatb0){
            ...
            if(u_xlatb57){
                ...
                u_xlat58 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec4, 0.0);
                ...
                u_xlat0.x = u_xlat57 * u_xlat59 + u_xlat58;
            } else {
                u_xlat5.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat5.xy = floor(u_xlat5.xy);
                u_xlat43.xy = u_xlat3.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat58 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec14, 0.0);
                u_xlat58 = u_xlat58 * u_xlat16.y;
                u_xlat57 = u_xlat16.x * u_xlat57 + u_xlat58;
                vec3 txVec15 = vec3(u_xlat43.xy,u_xlat3.z);
                u_xlat58 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec15, 0.0);
                ...
                u_xlat58 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec28, 0.0);
                u_xlat0.x = u_xlat6.w * u_xlat58 + u_xlat57;
            }
        }
    } else {
        vec3 txVec29 = vec3(u_xlat3.xy,u_xlat3.z);
        u_xlat0.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat57 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat0.x = u_xlat0.x * _MainLightShadowParams.x + u_xlat57;
    u_xlatb57 = 0.0>=u_xlat3.z;
    u_xlatb58 = u_xlat3.z>=1.0;
    u_xlatb57 = u_xlatb57 || u_xlatb58;
    u_xlat0.x = (u_xlatb57) ? 1.0 : u_xlat0.x;
    u_xlat3.xyz = vs_TEXCOORD2.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat57 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat57 = u_xlat57 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat57 = clamp(u_xlat57, 0.0, 1.0);
    u_xlat58 = (-u_xlat0.x) + 1.0;
    u_xlat0.x = u_xlat57 * u_xlat58 + u_xlat0.x;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat59 = u_xlat59 * u_xlat60;
        u_xlat7.xyz = vec3(u_xlat59) * _AdditionalLightsColor[u_xlati58].xyz;
