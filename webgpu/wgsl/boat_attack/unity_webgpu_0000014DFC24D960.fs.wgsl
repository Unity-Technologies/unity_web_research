...
fn main_1() {
  ...
  let x_122 : f32 = u_xlat0.w;
  let x_125 : f32 = vs_TEXCOORD3.z;
  u_xlat1.x = ((x_122 * x_125) + -0.00100000004749745131f);
  let x_130 : vec4<f32> = u_xlat0;
  let x_131 : vec4<f32> = vs_TEXCOORD3;
  u_xlat0 = (x_130 * vec4<f32>(x_131.z, x_131.z, x_131.z, x_131.z));
  let x_136 : vec4<f32> = u_xlat0;
  SV_Target0 = x_136;
  let x_141 : f32 = u_xlat1.x;
  u_xlatb0 = (x_141 < 0.0f);
  let x_143 : bool = u_xlatb0;
  if (((select(0i, 1i, x_143) * -1i) != 0i)) {
    discard;
  }
  return;
}
