...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat29 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec0, 0.0);
    ...
    u_xlat22 = (-u_xlat29) + 1.0;
    u_xlat29 = u_xlat13.x * u_xlat22 + u_xlat29;
    u_xlat29 = u_xlat29 * unity_LightData.z;
    u_xlat13.xyz = vec3(u_xlat29) * _MainLightColor.xyz;
    u_xlat29 = dot(u_xlat2.xyz, _MainLightPosition.xyz);
    u_xlat29 = clamp(u_xlat29, 0.0, 1.0);
    u_xlat5.xyz = vec3(u_xlat29) * u_xlat13.xyz;
    ...
    u_xlat9.xyz = u_xlat12.xyz * u_xlat0.yzw + u_xlat13.xyz;
