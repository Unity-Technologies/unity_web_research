...
;
    ...
    u_xlat79 = dot(u_xlat4, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat79 = (-u_xlat79) + 4.0;
    u_xlatu79 = uint(u_xlat79);
    u_xlati79 = int(u_xlatu79) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati79 + 1) / 4][(u_xlati79 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati79 / 4][u_xlati79 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati79 + 2) / 4][(u_xlati79 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati79 + 3) / 4][(u_xlati79 + 3) % 4].xyz;
    ...
    u_xlat4.xyz = vec3(u_xlat79) * u_xlat6.xyz;
    ...
    u_xlat6.xyz = vec3(u_xlat79) * u_xlat5.xyz;
    ...
    u_xlat3.x = u_xlat82 * _MainLightShadowParams.x + u_xlat3.x;
    u_xlatb29 = 0.0>=u_xlat3.z;
    u_xlatb55 = u_xlat3.z>=1.0;
    ...
    u_xlat55 = u_xlat29 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat55 = clamp(u_xlat55, 0.0, 1.0);
    u_xlat82 = (-u_xlat3.x) + 1.0;
    u_xlat3.x = u_xlat55 * u_xlat82 + u_xlat3.x;
    ...
    u_xlat8.xyz = u_xlat1.xyz * (-vec3(u_xlat55)) + (-u_xlat2.xyz);
    ...
    u_xlat9.xyz = vec3(u_xlat55) * u_xlat9.xyz + u_xlat5.xyz;
    ...
    u_xlat8.xyz = u_xlat5.xyz * vec3(u_xlat52) + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat8.xyz;
    u_xlat52 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu52 =  uint(int(u_xlat52));
    u_xlat80 = u_xlat29 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu52 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati82].www + _AdditionalLightsPosition[u_xlati82].xyz;
        ...
        u_xlat85 = dot(_AdditionalLightsSpotDir[u_xlati82].xyz, u_xlat10.xyz);
        ...
        u_xlati86 = 1 << (u_xlati82 & int(0x1F));
        u_xlati86 = int(uint(u_xlati86) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati86 != 0) {
            u_xlati86 = int(_AdditionalLightsLightTypes[u_xlati82]);
            ...
            u_xlat86 = (u_xlatb3.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb3.x) ? u_xlat11.xyz : vec3(u_xlat86);
        } else {
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat84) + u_xlat2.xyz;
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat82) + u_xlat6.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat26) + u_xlat7.xyz;
