...
bool u_xlatb24;
    ...
    u_xlat3 = u_xlat14.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.0833333358, 0.0833333358, 0.166666672, 0.166666672);
    ...
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.106250003, 0.106250003, 0.106250003) + u_xlat1.xyz;
...
;
    ...
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.125, 0.125, 0.125) + u_xlat1.xyz;
    u_xlat10.xz = u_xlat3.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat3.xx + u_xlat10.xz;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat3.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat3 = u_xlat14.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.25, 0.25, 0.333333343, 0.333333343);
    ...
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.200000003, 0.200000003, 0.200000003) + u_xlat1.xyz;
    u_xlat10.xz = u_xlat3.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat3.xx + u_xlat10.xz;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat3.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat3.x = u_xlat3.x * u_xlat24;
    u_xlat22 = u_xlat3.x * u_xlat23 + u_xlat22;
    u_xlat3 = u_xlat14.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.416666687, 0.416666687, 0.5, 0.5);
    u_xlat23 = texture(sampler2D(_BlueNoiseTexture, sampler_PointRepeat), u_xlat3.xy, _GlobalMipBias.x).w;
    ...
    u_xlat4.xyz = vec3(u_xlat23) * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz * _SSAOParams.yyy;
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.256250024, 0.256250024, 0.256250024) + u_xlat1.xyz;
    u_xlat3.xy = u_xlat4.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat4.xx + u_xlat3.xy;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat4.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat3.x = u_xlat3.x * u_xlat24;
    u_xlat22 = u_xlat3.x * u_xlat23 + u_xlat22;
    u_xlat3 = u_xlat14.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.583333373, 0.583333373, 0.666666687, 0.666666687);
    u_xlat23 = texture(sampler2D(_BlueNoiseTexture, sampler_PointRepeat), u_xlat3.xy, _GlobalMipBias.x).w;
    ...
    u_xlat4.xyz = vec3(u_xlat23) * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz * _SSAOParams.yyy;
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.40625003, 0.40625003, 0.40625003) + u_xlat1.xyz;
    u_xlat3.xy = u_xlat4.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat4.xx + u_xlat3.xy;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat4.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat3.x = u_xlat3.x * u_xlat24;
    u_xlat22 = u_xlat3.x * u_xlat23 + u_xlat22;
    u_xlat3 = u_xlat14.xyxy * _SSAOBlueNoiseParams.xyxy + vec4(0.75, 0.75, 0.833333373, 0.833333373);
    u_xlat23 = texture(sampler2D(_BlueNoiseTexture, sampler_PointRepeat), u_xlat3.xy, _GlobalMipBias.x).w;
    ...
    u_xlat4.xyz = vec3(u_xlat23) * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz * _SSAOParams.yyy;
    u_xlat4.xyz = u_xlat4.xyz * vec3(0.606249988, 0.606249988, 0.606249988) + u_xlat1.xyz;
    u_xlat3.xy = u_xlat4.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat4.xx + u_xlat3.xy;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat4.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat3.xyz = vec3(u_xlat23) * u_xlat4.xyz;
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.725000083, 0.725000083, 0.725000083) + u_xlat1.xyz;
    u_xlat10.xz = u_xlat3.yy * _CameraViewProjections[1 / 4][1 % 4].xy;
    u_xlat3.xy = _CameraViewProjections[0 / 4][0 % 4].xy * u_xlat3.xx + u_xlat10.xz;
    u_xlat3.xy = _CameraViewProjections[2 / 4][2 % 4].xy * u_xlat3.zz + u_xlat3.xy;
    u_xlat3.xy = u_xlat3.xy + vec2(1.0, 1.0);
    ...
    u_xlat3.x = u_xlat3.x * u_xlat24;
    u_xlat22 = u_xlat3.x * u_xlat23 + u_xlat22;
    u_xlat14.xy = u_xlat14.xy * _SSAOBlueNoiseParams.xy + vec2(0.916666687, 0.916666687);
    ...
    u_xlat3.xyz = u_xlat3.xyz * _SSAOParams.yyy;
    u_xlat3.xyz = u_xlat3.xyz * vec3(0.856249988, 0.856249988, 0.856249988) + u_xlat1.xyz;
