...
output . positionCS = pos ;
output . texcoord . xy = DynamicScalingApplyScaleBias ( uv , _BlitScaleBias ) ;
...
half2 offsetUv = _MotionVectorTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) . xy ;
return - offsetUv ;
}
#line 66
...
#line 74
float4 worldPos = float4 ( ComputeWorldSpacePosition ( uv . xy , depth , unity_MatrixInvVP ) , 1.0 ) ;
...
return _BlitTexture . SampleBias ( sampler_PointClamp , sampleUV , _GlobalMipBias . x ) . xyz ;
}
