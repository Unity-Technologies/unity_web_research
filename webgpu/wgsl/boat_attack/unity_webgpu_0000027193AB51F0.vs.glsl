...
void main()
{
    ...
    u_xlat2.xyz = in_NORMAL0.yyy * unity_ObjectToWorld[1].xyz;
    u_xlat2.xyz = unity_ObjectToWorld[0].xyz * in_NORMAL0.xxx + u_xlat2.xyz;
    u_xlat2.xyz = unity_ObjectToWorld[2].xyz * in_NORMAL0.zzz + u_xlat2.xyz;
