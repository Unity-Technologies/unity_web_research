...
fn main_1() {
  ...
  let x_1598 : vec4<f32> = x_26.x_Grain_TilingParams;
  let x_1602 : vec4<f32> = x_26.x_Grain_TilingParams;
  ...
  let x_1616 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1612.x, x_1612.y), x_1615);
  u_xlat15 = x_1616.w;
  let x_1618 : f32 = u_xlat15;
  u_xlat15 = (x_1618 + -0.5f);
  let x_1620 : f32 = u_xlat15;
  let x_1621 : f32 = u_xlat15;
  u_xlat15 = (x_1620 + x_1621);
  let x_1623 : vec3<f32> = u_xlat0;
  u_xlat1.x = dot(x_1623, vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1631 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1631);
  let x_1636 : f32 = x_26.x_Grain_Params.y;
  let x_1638 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1636 * -(x_1638)) + 1.0f);
  let x_1643 : f32 = u_xlat15;
  let x_1645 : vec3<f32> = u_xlat0;
  u_xlat6 = (vec3<f32>(x_1643, x_1643, x_1643) * x_1645);
  let x_1647 : vec3<f32> = u_xlat6;
  let x_1650 : vec2<f32> = x_26.x_Grain_Params;
  u_xlat6 = (x_1647 * vec3<f32>(x_1650.x, x_1650.x, x_1650.x));
  let x_1653 : vec3<f32> = u_xlat6;
  let x_1654 : vec4<f32> = u_xlat1;
  let x_1657 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1653 * vec3<f32>(x_1654.x, x_1654.x, x_1654.x)) + x_1657);
  let x_1659 : vec3<f32> = u_xlat0;
  let x_1660 : vec3<f32> = (x_1659 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1661 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1660.x, x_1660.y, x_1660.z, x_1661.w);
  let x_1663 : vec3<f32> = u_xlat0;
  let x_1665 : vec3<f32> = log2(abs(x_1663));
  let x_1666 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1666.w);
  let x_1668 : vec4<f32> = u_xlat2;
  let x_1670 : vec3<f32> = (vec3<f32>(x_1668.x, x_1668.y, x_1668.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1671 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1670.x, x_1670.y, x_1670.z, x_1671.w);
  let x_1673 : vec4<f32> = u_xlat2;
  let x_1675 : vec3<f32> = exp2(vec3<f32>(x_1673.x, x_1673.y, x_1673.z));
  let x_1676 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1675.x, x_1675.y, x_1675.z, x_1676.w);
  let x_1678 : vec4<f32> = u_xlat2;
  let x_1681 : vec3<f32> = ((vec3<f32>(x_1678.x, x_1678.y, x_1678.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1682 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1681.x, x_1681.y, x_1681.z, x_1682.w);
  let x_1684 : vec3<f32> = u_xlat0;
  let x_1686 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1684.x, x_1684.y, x_1684.z, x_1684.x));
  u_xlatb0 = vec3<bool>(x_1686.x, x_1686.y, x_1686.z);
  let x_1689 : bool = u_xlatb0.x;
  if (x_1689) {
  ...
  u_xlat0.x = x_1698;
  let x_1701 : bool = u_xlatb0.y;
  if (x_1701) {
    let x_1706 : f32 = u_xlat1.y;
    x_1702 = x_1706;
  } else {
    let x_1709 : f32 = u_xlat2.y;
    x_1702 = x_1709;
  }
  let x_1710 : f32 = x_1702;
  u_xlat0.y = x_1710;
  let x_1713 : bool = u_xlatb0.z;
  if (x_1713) {
    let x_1718 : f32 = u_xlat1.z;
    x_1714 = x_1718;
  } else {
  ...
  u_xlat0.z = x_1722;
  let x_1724 : vec2<f32> = vs_TEXCOORD0;
  let x_1727 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1731 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1733 : vec2<f32> = ((x_1724 * vec2<f32>(x_1727.x, x_1727.y)) + vec2<f32>(x_1731.z, x_1731.w));
  let x_1734 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1733.x, x_1733.y, x_1734.z, x_1734.w);
  let x_1741 : vec4<f32> = u_xlat1;
  let x_1744 : f32 = x_26.x_GlobalMipBias.x;
  let x_1745 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1741.x, x_1741.y), x_1744);
  u_xlat15 = x_1745.w;
  let x_1747 : f32 = u_xlat15;
  u_xlat15 = ((x_1747 * 2.0f) + -1.0f);
  let x_1750 : f32 = u_xlat15;
  u_xlatb1 = (x_1750 >= 0.0f);
  let x_1752 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1752);
  let x_1755 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1755)) + 1.0f);
  let x_1759 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1759);
  let x_1761 : f32 = u_xlat15;
  u_xlat15 = (-(x_1761) + 1.0f);
  let x_1764 : f32 = u_xlat15;
  let x_1766 : f32 = u_xlat1.x;
  u_xlat15 = (x_1764 * x_1766);
  let x_1768 : vec3<f32> = u_xlat0;
  let x_1769 : vec3<f32> = (x_1768 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1770 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1769.x, x_1769.y, x_1769.z, x_1770.w);
  let x_1772 : vec3<f32> = u_xlat0;
  let x_1774 : vec3<f32> = log2(abs(x_1772));
  let x_1775 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1774.x, x_1774.y, x_1774.z, x_1775.w);
  let x_1777 : vec4<f32> = u_xlat2;
  let x_1779 : vec3<f32> = (vec3<f32>(x_1777.x, x_1777.y, x_1777.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1780 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1779.x, x_1779.y, x_1779.z, x_1780.w);
  let x_1782 : vec4<f32> = u_xlat2;
  let x_1784 : vec3<f32> = exp2(vec3<f32>(x_1782.x, x_1782.y, x_1782.z));
  let x_1785 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1784.x, x_1784.y, x_1784.z, x_1785.w);
  let x_1787 : vec4<f32> = u_xlat2;
  let x_1790 : vec3<f32> = ((vec3<f32>(x_1787.x, x_1787.y, x_1787.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1791 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1790.x, x_1790.y, x_1790.z, x_1791.w);
  let x_1793 : vec3<f32> = u_xlat0;
  let x_1795 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1793.x, x_1793.y, x_1793.z, x_1793.x));
  ...
  u_xlat0.z = x_1831;
  let x_1833 : f32 = u_xlat15;
  let x_1838 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1833, x_1833, x_1833) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1838);
  let x_1840 : vec3<f32> = u_xlat0;
  let x_1841 : vec3<f32> = (x_1840 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1842 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1841.x, x_1841.y, x_1841.z, x_1842.w);
  let x_1844 : vec3<f32> = u_xlat0;
  let x_1845 : vec3<f32> = (x_1844 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1846 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1845.x, x_1845.y, x_1845.z, x_1846.w);
  let x_1848 : vec4<f32> = u_xlat2;
  let x_1850 : vec3<f32> = (vec3<f32>(x_1848.x, x_1848.y, x_1848.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1851 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1850.x, x_1850.y, x_1850.z, x_1851.w);
  let x_1853 : vec4<f32> = u_xlat2;
  let x_1856 : vec3<f32> = log2(abs(vec3<f32>(x_1853.x, x_1853.y, x_1853.z)));
  let x_1857 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1856.x, x_1856.y, x_1856.z, x_1857.w);
  let x_1859 : vec4<f32> = u_xlat2;
  let x_1861 : vec3<f32> = (vec3<f32>(x_1859.x, x_1859.y, x_1859.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1862 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1861.x, x_1861.y, x_1861.z, x_1862.w);
  let x_1864 : vec4<f32> = u_xlat2;
  let x_1866 : vec3<f32> = exp2(vec3<f32>(x_1864.x, x_1864.y, x_1864.z));
  let x_1867 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1866.x, x_1866.y, x_1866.z, x_1867.w);
  let x_1869 : vec3<f32> = u_xlat0;
  let x_1871 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1869.x, x_1869.y, x_1869.z, x_1869.x));
  u_xlatb0 = vec3<bool>(x_1871.x, x_1871.y, x_1871.z);
  let x_1874 : bool = u_xlatb0.x;
  if (x_1874) {
    let x_1879 : f32 = u_xlat1.x;
    x_1875 = x_1879;
  } else {
    let x_1882 : f32 = u_xlat2.x;
    x_1875 = x_1882;
  }
  let x_1883 : f32 = x_1875;
  u_xlat0.x = x_1883;
  let x_1886 : bool = u_xlatb0.y;
  if (x_1886) {
    let x_1891 : f32 = u_xlat1.y;
    x_1887 = x_1891;
  } else {
    let x_1894 : f32 = u_xlat2.y;
    x_1887 = x_1894;
  }
  let x_1895 : f32 = x_1887;
  u_xlat0.y = x_1895;
  let x_1898 : bool = u_xlatb0.z;
  if (x_1898) {
    let x_1903 : f32 = u_xlat1.z;
    x_1899 = x_1903;
  } else {
    let x_1906 : f32 = u_xlat2.z;
    x_1899 = x_1906;
  }
  let x_1907 : f32 = x_1899;
  u_xlat0.z = x_1907;
  let x_1911 : vec3<f32> = u_xlat0;
  let x_1912 : vec3<f32> = max(x_1911, vec3<f32>(0.0f, 0.0f, 0.0f));
