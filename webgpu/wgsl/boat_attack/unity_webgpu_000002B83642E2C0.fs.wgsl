...
fn main_1() {
  ...
  let x_1210 : vec3<f32> = max(vec3<f32>(x_1208.x, x_1208.y, x_1208.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1211 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1210.x, x_1210.y, x_1210.z, x_1211.w);
  let x_1213 : vec4<f32> = u_xlat0;
  u_xlat1 = ((vec3<f32>(x_1213.x, x_1213.y, x_1213.z) * vec3<f32>(0.26267722249031066895f, 0.26267722249031066895f, 0.26267722249031066895f)) + vec3<f32>(0.06959999352693557739f, 0.06959999352693557739f, 0.06959999352693557739f));
  let x_1221 : vec4<f32> = u_xlat0;
  u_xlat2 = (vec3<f32>(x_1221.x, x_1221.y, x_1221.z) * vec3<f32>(1.31338608264923095703f, 1.31338608264923095703f, 1.31338608264923095703f));
  let x_1226 : vec4<f32> = u_xlat0;
  let x_1231 : vec3<f32> = ((vec3<f32>(x_1226.x, x_1226.y, x_1226.z) * vec3<f32>(0.26267722249031066895f, 0.26267722249031066895f, 0.26267722249031066895f)) + vec3<f32>(0.28999999165534973145f, 0.28999999165534973145f, 0.28999999165534973145f));
  ...
  let x_1240 : vec3<f32> = ((x_1234 * vec3<f32>(x_1235.x, x_1235.y, x_1235.z)) + vec3<f32>(0.08160001039505004883f, 0.08160001039505004883f, 0.08160001039505004883f));
  ...
  u_xlat1 = ((x_1243 * x_1244) + vec3<f32>(0.00543999997898936272f, 0.00543999997898936272f, 0.00543999997898936272f));
  let x_1249 : vec3<f32> = u_xlat1;
  let x_1250 : vec4<f32> = u_xlat0;
  let x_1252 : vec3<f32> = (x_1249 / vec3<f32>(x_1250.x, x_1250.y, x_1250.z));
  let x_1253 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1252.x, x_1252.y, x_1252.z, x_1253.w);
  let x_1255 : vec4<f32> = u_xlat0;
  let x_1259 : vec3<f32> = (vec3<f32>(x_1255.x, x_1255.y, x_1255.z) + vec3<f32>(-0.06666666269302368164f, -0.06666666269302368164f, -0.06666666269302368164f));
  let x_1260 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1259.x, x_1259.y, x_1259.z, x_1260.w);
  let x_1264 : vec4<f32> = u_xlat0;
  let x_1266 : vec3<f32> = (vec3<f32>(x_1264.x, x_1264.y, x_1264.z) * vec3<f32>(1.31338608264923095703f, 1.31338608264923095703f, 1.31338608264923095703f));
  let x_1267 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1266.x, x_1266.y, x_1266.z, x_1267.w);
  SV_Target0.w = 1.0f;
  return;
}
