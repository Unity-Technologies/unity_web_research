...
fn main_1() {
  ...
  let x_2030 : vec3<f32> = (vec3<f32>(x_2028.x, x_2028.y, x_2028.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2031 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2030.x, x_2030.y, x_2030.z, x_2031.w);
  let x_2033 : vec4<f32> = u_xlat0;
  let x_2036 : vec3<f32> = log2(abs(vec3<f32>(x_2033.x, x_2033.y, x_2033.z)));
  let x_2037 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2036.x, x_2036.y, x_2036.z, x_2037.w);
  let x_2039 : vec4<f32> = u_xlat2;
  let x_2041 : vec3<f32> = (vec3<f32>(x_2039.x, x_2039.y, x_2039.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2042 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2041.x, x_2041.y, x_2041.z, x_2042.w);
  let x_2044 : vec4<f32> = u_xlat2;
  let x_2046 : vec3<f32> = exp2(vec3<f32>(x_2044.x, x_2044.y, x_2044.z));
  let x_2047 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2046.x, x_2046.y, x_2046.z, x_2047.w);
  let x_2049 : vec4<f32> = u_xlat2;
  let x_2052 : vec3<f32> = ((vec3<f32>(x_2049.x, x_2049.y, x_2049.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2053 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2052.x, x_2052.y, x_2052.z, x_2053.w);
  let x_2055 : vec4<f32> = u_xlat0;
  let x_2057 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2055.x, x_2055.y, x_2055.z, x_2055.x));
  u_xlatb0 = vec3<bool>(x_2057.x, x_2057.y, x_2057.z);
  let x_2062 : bool = u_xlatb0.x;
  if (x_2062) {
  ...
  let x_2071 : f32 = x_2063;
  SV_Target0.x = x_2071;
  let x_2075 : bool = u_xlatb0.y;
  if (x_2075) {
    let x_2080 : f32 = u_xlat1.y;
    x_2076 = x_2080;
  } else {
    let x_2083 : f32 = u_xlat2.y;
    x_2076 = x_2083;
  }
  let x_2084 : f32 = x_2076;
  SV_Target0.y = x_2084;
  let x_2087 : bool = u_xlatb0.z;
  if (x_2087) {
    let x_2092 : f32 = u_xlat1.z;
    x_2088 = x_2092;
  } else {
    let x_2095 : f32 = u_xlat2.z;
    x_2088 = x_2095;
  }
