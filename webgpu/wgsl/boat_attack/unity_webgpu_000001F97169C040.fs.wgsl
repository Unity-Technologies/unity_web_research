...
fn main_1() {
  ...
  let x_1970 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1974 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_1988 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1984.x, x_1984.y), x_1987);
  u_xlat21 = x_1988.w;
  let x_1990 : f32 = u_xlat21;
  u_xlat21 = ((x_1990 * 2.0f) + -1.0f);
  let x_1993 : f32 = u_xlat21;
  u_xlatb1 = (x_1993 >= 0.0f);
  let x_1995 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1995);
  let x_1998 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1998)) + 1.0f);
  let x_2002 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2002);
  let x_2004 : f32 = u_xlat21;
  u_xlat21 = (-(x_2004) + 1.0f);
  let x_2007 : f32 = u_xlat21;
  let x_2009 : f32 = u_xlat1.x;
  u_xlat21 = (x_2007 * x_2009);
  let x_2011 : vec4<f32> = u_xlat0;
  let x_2013 : vec3<f32> = (vec3<f32>(x_2011.x, x_2011.y, x_2011.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2014 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2013.x, x_2013.y, x_2013.z, x_2014.w);
  let x_2016 : vec4<f32> = u_xlat0;
  let x_2019 : vec3<f32> = log2(abs(vec3<f32>(x_2016.x, x_2016.y, x_2016.z)));
  let x_2020 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2019.x, x_2019.y, x_2019.z, x_2020.w);
  let x_2022 : vec4<f32> = u_xlat2;
  let x_2024 : vec3<f32> = (vec3<f32>(x_2022.x, x_2022.y, x_2022.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2025 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2024.x, x_2024.y, x_2024.z, x_2025.w);
  let x_2027 : vec4<f32> = u_xlat2;
  let x_2029 : vec3<f32> = exp2(vec3<f32>(x_2027.x, x_2027.y, x_2027.z));
  let x_2030 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2029.x, x_2029.y, x_2029.z, x_2030.w);
  let x_2032 : vec4<f32> = u_xlat2;
  let x_2035 : vec3<f32> = ((vec3<f32>(x_2032.x, x_2032.y, x_2032.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2036 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2035.x, x_2035.y, x_2035.z, x_2036.w);
  let x_2038 : vec4<f32> = u_xlat0;
  let x_2040 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2038.x, x_2038.y, x_2038.z, x_2038.x));
  u_xlatb0 = vec3<bool>(x_2040.x, x_2040.y, x_2040.z);
  let x_2043 : bool = u_xlatb0.x;
  if (x_2043) {
    let x_2048 : f32 = u_xlat1.x;
    x_2044 = x_2048;
  } else {
    let x_2051 : f32 = u_xlat2.x;
    x_2044 = x_2051;
  }
  let x_2052 : f32 = x_2044;
  u_xlat0.x = x_2052;
  let x_2055 : bool = u_xlatb0.y;
  if (x_2055) {
    let x_2060 : f32 = u_xlat1.y;
    x_2056 = x_2060;
  } else {
  ...
  u_xlat0.y = x_2064;
  let x_2067 : bool = u_xlatb0.z;
  if (x_2067) {
    let x_2072 : f32 = u_xlat1.z;
    x_2068 = x_2072;
  } else {
    let x_2075 : f32 = u_xlat2.z;
    x_2068 = x_2075;
  }
  let x_2076 : f32 = x_2068;
  u_xlat0.z = x_2076;
  let x_2078 : f32 = u_xlat21;
  let x_2083 : vec4<f32> = u_xlat0;
  let x_2085 : vec3<f32> = ((vec3<f32>(x_2078, x_2078, x_2078) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2083.x, x_2083.y, x_2083.z));
  let x_2086 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2085.x, x_2085.y, x_2085.z, x_2086.w);
  let x_2088 : vec4<f32> = u_xlat0;
  let x_2090 : vec3<f32> = (vec3<f32>(x_2088.x, x_2088.y, x_2088.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2091 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2090.x, x_2090.y, x_2090.z, x_2091.w);
  let x_2093 : vec4<f32> = u_xlat0;
  let x_2095 : vec3<f32> = (vec3<f32>(x_2093.x, x_2093.y, x_2093.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2096 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2095.x, x_2095.y, x_2095.z, x_2096.w);
  let x_2098 : vec4<f32> = u_xlat2;
  let x_2100 : vec3<f32> = (vec3<f32>(x_2098.x, x_2098.y, x_2098.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2101 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2100.x, x_2100.y, x_2100.z, x_2101.w);
  let x_2103 : vec4<f32> = u_xlat2;
  let x_2106 : vec3<f32> = log2(abs(vec3<f32>(x_2103.x, x_2103.y, x_2103.z)));
  let x_2107 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2106.x, x_2106.y, x_2106.z, x_2107.w);
  let x_2109 : vec4<f32> = u_xlat2;
  let x_2111 : vec3<f32> = (vec3<f32>(x_2109.x, x_2109.y, x_2109.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2112 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2111.x, x_2111.y, x_2111.z, x_2112.w);
  let x_2114 : vec4<f32> = u_xlat2;
  let x_2116 : vec3<f32> = exp2(vec3<f32>(x_2114.x, x_2114.y, x_2114.z));
  let x_2117 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2116.x, x_2116.y, x_2116.z, x_2117.w);
  let x_2119 : vec4<f32> = u_xlat0;
  let x_2121 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2119.x, x_2119.y, x_2119.z, x_2119.x));
  u_xlatb0 = vec3<bool>(x_2121.x, x_2121.y, x_2121.z);
  let x_2124 : bool = u_xlatb0.x;
  if (x_2124) {
    let x_2129 : f32 = u_xlat1.x;
    x_2125 = x_2129;
  } else {
    let x_2132 : f32 = u_xlat2.x;
    x_2125 = x_2132;
  }
  let x_2133 : f32 = x_2125;
  u_xlat0.x = x_2133;
  let x_2136 : bool = u_xlatb0.y;
  if (x_2136) {
    let x_2141 : f32 = u_xlat1.y;
    x_2137 = x_2141;
  } else {
    let x_2144 : f32 = u_xlat2.y;
    x_2137 = x_2144;
  }
  let x_2145 : f32 = x_2137;
  u_xlat0.y = x_2145;
  let x_2148 : bool = u_xlatb0.z;
  if (x_2148) {
    let x_2153 : f32 = u_xlat1.z;
    x_2149 = x_2153;
  } else {
  ...
  let x_2163 : vec3<f32> = max(vec3<f32>(x_2161.x, x_2161.y, x_2161.z), vec3<f32>(0.0f, 0.0f, 0.0f));
