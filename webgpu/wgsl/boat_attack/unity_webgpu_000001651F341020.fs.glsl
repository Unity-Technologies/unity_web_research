...
;
    ...
    u_xlat4.xyz = u_xlat51.xxx * _MainLightColor.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat3.x = u_xlat3.x * _AdditionalLightsAttenuation[u_xlati68].x;
        u_xlat3.x = (-u_xlat3.x) * u_xlat3.x + 1.0;
        u_xlat3.x = max(u_xlat3.x, 0.0);
        u_xlat3.x = u_xlat3.x * u_xlat3.x;
        u_xlat3.x = u_xlat3.x * u_xlat5.x;
        u_xlat5.x = dot(_AdditionalLightsSpotDir[u_xlati68].xyz, u_xlat10.xyz);
        u_xlat5.x = u_xlat5.x * _AdditionalLightsAttenuation[u_xlati68].z + _AdditionalLightsAttenuation[u_xlati68].w;
        ...
        u_xlat31.xyz = u_xlat31.xyz * vec3(u_xlat70) + u_xlat27.xyz;
        ...
        u_xlat68 = dot(u_xlat25.xyz, u_xlat31.xyz);
        u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
        u_xlat3.x = dot(u_xlat10.xyz, u_xlat31.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
        ...
        u_xlat31.xyz = vec3(u_xlat68) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat2.xyz;
