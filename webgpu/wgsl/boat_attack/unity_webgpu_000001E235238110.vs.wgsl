...
@group(1) @binding(7) var<uniform> x_148 : VGlobals;
...
fn main_1() {
  ...
  let x_134 : vec2<f32> = in_TEXCOORD1;
  let x_137 : vec4<f32> = x_44.unity_LightmapST;
  let x_141 : vec4<f32> = x_44.unity_LightmapST;
  vs_TEXCOORD8 = ((x_134 * vec2<f32>(x_137.x, x_137.y)) + vec2<f32>(x_141.z, x_141.w));
  ...
  let x_172 : vec4<f32> = x_148.unity_MatrixVP[3i];
  gl_Position = (x_170 + x_172);
  return;
}
