...
fn main_1() {
  ...
  u_xlat24.x = dot(vec2<f32>(x_117.z, x_117.w), vec2<f32>(127.09999847412109375f, 311.70001220703125f));
  let x_126 : vec4<f32> = u_xlat1;
  u_xlat24.y = dot(vec2<f32>(x_126.z, x_126.w), vec2<f32>(269.5f, 183.3000030517578125f));
  ...
  u_xlat35 = dot(vec2<f32>(x_163.x, x_163.y), vec2<f32>(127.09999847412109375f, 311.70001220703125f));
  let x_166 : vec4<f32> = u_xlat3;
  u_xlat3.x = dot(vec2<f32>(x_166.x, x_166.y), vec2<f32>(269.5f, 183.3000030517578125f));
  ...
  u_xlat35 = dot(vec2<f32>(x_217.z, x_217.w), vec2<f32>(127.09999847412109375f, 311.70001220703125f));
  let x_220 : vec4<f32> = u_xlat3;
  u_xlat3.x = dot(vec2<f32>(x_220.z, x_220.w), vec2<f32>(269.5f, 183.3000030517578125f));
  ...
  u_xlat3.x = dot(vec2<f32>(x_255.z, x_255.w), vec2<f32>(127.09999847412109375f, 311.70001220703125f));
  let x_260 : vec4<f32> = u_xlat1;
  u_xlat23.x = dot(vec2<f32>(x_260.z, x_260.w), vec2<f32>(269.5f, 183.3000030517578125f));
  ...
  u_xlat34 = dot(vec2<f32>(x_352.x, x_352.y), vec2<f32>(127.09999847412109375f, 311.70001220703125f));
  let x_355 : vec4<f32> = u_xlat2;
  u_xlat3.x = dot(vec2<f32>(x_355.x, x_355.y), vec2<f32>(269.5f, 183.3000030517578125f));
  ...
  u_xlat4.x = dot(vec2<f32>(x_390.x, x_390.y), vec2<f32>(127.09999847412109375f, 311.70001220703125f));
  let x_394 : vec4<f32> = u_xlat3;
  u_xlat3.x = dot(vec2<f32>(x_394.x, x_394.y), vec2<f32>(269.5f, 183.3000030517578125f));
  ...
  u_xlat3.x = dot(vec2<f32>(x_444.z, x_444.w), vec2<f32>(127.09999847412109375f, 311.70001220703125f));
  let x_448 : vec4<f32> = u_xlat3;
  u_xlat3.y = dot(vec2<f32>(x_448.z, x_448.w), vec2<f32>(269.5f, 183.3000030517578125f));
  ...
  u_xlat14 = dot(vec2<f32>(x_486.x, x_486.y), vec2<f32>(127.09999847412109375f, 311.70001220703125f));
  let x_489 : vec4<f32> = u_xlat2;
  u_xlat2.x = dot(vec2<f32>(x_489.x, x_489.y), vec2<f32>(269.5f, 183.3000030517578125f));
  ...
  let x_580 : vec2<f32> = (vec2<f32>(x_575.y, x_575.y) * vec2<f32>(0.05000000074505805969f, 0.10000000149011611938f));
  ...
  let x_589 : vec2<f32> = ((vec2<f32>(x_583.x, x_583.z) * vec2<f32>(0.10000000149011611938f, 0.10000000149011611938f)) + vec2<f32>(x_587.x, x_587.x));
  ...
  let x_599 : vec2<f32> = ((vec2<f32>(x_594.x, x_594.x) * vec2<f32>(0.10000000149011611938f, 0.10000000149011611938f)) + vec2<f32>(x_597.x, x_597.z));
  ...
  let x_610 : vec2<f32> = ((vec2<f32>(x_602.x, x_602.z) * vec2<f32>(0.40000000596046447754f, 0.40000000596046447754f)) + -(vec2<f32>(x_607.y, x_607.y)));
  ...
  let x_620 : vec2<f32> = ((vec2<f32>(x_613.x, x_613.x) * vec2<f32>(0.20000000298023223877f, 0.20000000298023223877f)) + vec2<f32>(x_618.x, x_618.y));
  ...
  let x_682 : vec2<f32> = ((vec2<f32>(x_677.x, x_677.z) * vec2<f32>(0.00200000009499490261f, 0.00200000009499490261f)) + vec2<f32>(0.5f, 0.5f));
  ...
  u_xlat13 = (x_727 * 0.40000000596046447754f);
  ...
  u_xlat11 = ((x_740 * 0.10000000149011611938f) + 0.05000000074505805969f);
  ...
  loop {
    ...
    u_xlat37 = (6.28318023681640625f / x_814);
    let x_817 : f32 = u_xlat37;
    u_xlat38 = (x_817 * 9.80000019073486328125f);
    ...
    let x_844 : vec2<f32> = (vec2<f32>(10000.0f, 0.01745329238474369049f) * vec2<f32>(x_842.x, x_842.y));
  ...
  u_xlat35 = max(x_1106, 1.17549435e-38f);
  ...
  let x_1119 : f32 = u_xlat4.z;
  let x_1121 : f32 = x_75.x_ProjectionParams.y;
  u_xlat35 = (x_1119 / x_1121);
  let x_1123 : f32 = u_xlat35;
  u_xlat35 = (-(x_1123) + 1.0f);
  let x_1126 : f32 = u_xlat35;
  let x_1128 : f32 = x_75.x_ProjectionParams.z;
  u_xlat35 = (x_1126 * x_1128);
  let x_1130 : f32 = u_xlat35;
  u_xlat35 = max(x_1130, 0.0f);
  let x_1134 : f32 = u_xlat35;
  let x_1136 : f32 = x_75.unity_FogParams.x;
  vs_TEXCOORD4.x = (x_1134 * x_1136);
  let x_1140 : vec4<f32> = u_xlat0;
  let x_1144 : vec4<f32> = x_75.unity_MatrixV[1i];
  u_xlat5 = (vec3<f32>(x_1140.w, x_1140.w, x_1140.w) * vec3<f32>(x_1144.x, x_1144.y, x_1144.z));
  let x_1148 : vec4<f32> = x_75.unity_MatrixV[0i];
  let x_1150 : vec4<f32> = u_xlat0;
  let x_1153 : vec3<f32> = u_xlat5;
  u_xlat5 = ((vec3<f32>(x_1148.x, x_1148.y, x_1148.z) * vec3<f32>(x_1150.x, x_1150.x, x_1150.x)) + x_1153);
  let x_1156 : vec4<f32> = x_75.unity_MatrixV[2i];
  let x_1158 : vec4<f32> = u_xlat0;
  let x_1161 : vec3<f32> = u_xlat5;
  u_xlat5 = ((vec3<f32>(x_1156.x, x_1156.y, x_1156.z) * vec3<f32>(x_1158.z, x_1158.z, x_1158.z)) + x_1161);
  let x_1163 : vec3<f32> = u_xlat5;
  let x_1165 : vec4<f32> = x_75.unity_MatrixV[3i];
  u_xlat5 = (x_1163 + vec3<f32>(x_1165.x, x_1165.y, x_1165.z));
  let x_1168 : vec3<f32> = u_xlat5;
  let x_1169 : vec3<f32> = u_xlat5;
  u_xlat5 = (x_1168 / vec3<f32>(x_1169.z, x_1169.z, x_1169.z));
  let x_1172 : vec3<f32> = u_xlat5;
  let x_1173 : vec3<f32> = u_xlat5;
  u_xlat35 = dot(x_1172, x_1173);
  let x_1176 : f32 = u_xlat35;
  vs_TEXCOORD5.x = sqrt(x_1176);
  let x_1179 : f32 = u_xlat11;
  vs_TEXCOORD5.y = sqrt(x_1179);
  let x_1183 : f32 = u_xlat7.y;
  let x_1186 : f32 = x_75.x_MaxWaveHeight;
  u_xlat11 = (x_1183 / x_1186);
  let x_1188 : f32 = u_xlat11;
  vs_TEXCOORD5.z = ((x_1188 * 0.5f) + 0.5f);
  let x_1193 : f32 = u_xlat7.z;
  let x_1195 : f32 = u_xlat7.x;
  vs_TEXCOORD5.w = (x_1193 + x_1195);
  let x_1198 : vec4<f32> = u_xlat3;
  let x_1202 : vec2<f32> = (vec2<f32>(x_1198.x, x_1198.z) * vec2<f32>(0.00499999988824129105f, 0.00499999988824129105f));
  let x_1203 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_1202.x, x_1202.y, x_1203.z, x_1203.w);
  let x_1205 : vec4<f32> = u_xlat3;
  let x_1207 : vec4<f32> = u_xlat3;
  u_xlat11 = dot(vec2<f32>(x_1205.x, x_1205.y), vec2<f32>(x_1207.x, x_1207.y));
  let x_1210 : f32 = u_xlat11;
  u_xlat11 = sqrt(x_1210);
  let x_1212 : f32 = u_xlat11;
  u_xlat11 = (x_1212 + -0.25f);
  let x_1215 : f32 = u_xlat11;
  u_xlat11 = clamp(x_1215, 0.0f, 1.0f);
  let x_1217 : vec3<f32> = u_xlat6;
  let x_1219 : vec4<f32> = u_xlat2;
  let x_1223 : vec3<f32> = ((-(x_1217) * vec3<f32>(x_1219.x, x_1219.y, x_1219.z)) + vec3<f32>(0.0f, 1.0f, 0.0f));
  let x_1224 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1223.x, x_1223.y, x_1223.z, x_1224.w);
  let x_1227 : f32 = u_xlat11;
  let x_1229 : vec4<f32> = u_xlat2;
  let x_1232 : vec3<f32> = u_xlat8;
  vs_NORMAL0 = ((vec3<f32>(x_1227, x_1227, x_1227) * vec3<f32>(x_1229.x, x_1229.y, x_1229.z)) + x_1232);
  let x_1234 : vec4<f32> = u_xlat4;
  let x_1235 : vec2<f32> = vec2<f32>(x_1234.z, x_1234.w);
  let x_1236 : vec4<f32> = vs_TEXCOORD6;
  vs_TEXCOORD6 = vec4<f32>(x_1236.x, x_1236.y, x_1235.x, x_1235.y);
  let x_1242 : vec4<f32> = u_xlat4;
  gl_Position = x_1242;
  let x_1245 : vec4<f32> = u_xlat0;
  vs_TEXCOORD1 = vec3<f32>(x_1245.x, x_1245.w, x_1245.z);
  let x_1248 : vec3<f32> = u_xlat12;
  vs_TEXCOORD3 = x_1248;
  let x_1250 : f32 = u_xlat1.x;
  vs_TEXCOORD4.y = x_1250;
  return;
}
