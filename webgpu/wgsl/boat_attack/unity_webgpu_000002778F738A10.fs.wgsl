...
fn main_1() {
  ...
  let x_2068 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2072 : vec4<f32> = x_25.x_Dithering_Params;
  ...
  let x_2086 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2082.x, x_2082.y), x_2085);
  u_xlat21 = x_2086.w;
  let x_2088 : f32 = u_xlat21;
  u_xlat21 = ((x_2088 * 2.0f) + -1.0f);
  let x_2091 : f32 = u_xlat21;
  u_xlatb1 = (x_2091 >= 0.0f);
  let x_2093 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2093);
  let x_2096 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2096)) + 1.0f);
  let x_2100 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2100);
  let x_2102 : f32 = u_xlat21;
  u_xlat21 = (-(x_2102) + 1.0f);
  let x_2105 : f32 = u_xlat21;
  let x_2107 : f32 = u_xlat1.x;
  u_xlat21 = (x_2105 * x_2107);
  let x_2109 : vec4<f32> = u_xlat0;
  let x_2111 : vec3<f32> = (vec3<f32>(x_2109.x, x_2109.y, x_2109.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2112 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2111.x, x_2111.y, x_2111.z, x_2112.w);
  let x_2114 : vec4<f32> = u_xlat0;
  let x_2117 : vec3<f32> = log2(abs(vec3<f32>(x_2114.x, x_2114.y, x_2114.z)));
  let x_2118 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2117.x, x_2117.y, x_2117.z, x_2118.w);
  let x_2120 : vec4<f32> = u_xlat2;
  let x_2122 : vec3<f32> = (vec3<f32>(x_2120.x, x_2120.y, x_2120.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2123 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2122.x, x_2122.y, x_2122.z, x_2123.w);
  let x_2125 : vec4<f32> = u_xlat2;
  let x_2127 : vec3<f32> = exp2(vec3<f32>(x_2125.x, x_2125.y, x_2125.z));
  let x_2128 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2127.x, x_2127.y, x_2127.z, x_2128.w);
  let x_2130 : vec4<f32> = u_xlat2;
  let x_2133 : vec3<f32> = ((vec3<f32>(x_2130.x, x_2130.y, x_2130.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2134 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2133.x, x_2133.y, x_2133.z, x_2134.w);
  let x_2136 : vec4<f32> = u_xlat0;
  let x_2138 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2136.x, x_2136.y, x_2136.z, x_2136.x));
  u_xlatb0 = vec3<bool>(x_2138.x, x_2138.y, x_2138.z);
  let x_2141 : bool = u_xlatb0.x;
  if (x_2141) {
  ...
  u_xlat0.x = x_2150;
  let x_2153 : bool = u_xlatb0.y;
  if (x_2153) {
    let x_2158 : f32 = u_xlat1.y;
    x_2154 = x_2158;
  } else {
    let x_2161 : f32 = u_xlat2.y;
    x_2154 = x_2161;
  }
  let x_2162 : f32 = x_2154;
  u_xlat0.y = x_2162;
  let x_2165 : bool = u_xlatb0.z;
  if (x_2165) {
    let x_2170 : f32 = u_xlat1.z;
    x_2166 = x_2170;
  } else {
    let x_2173 : f32 = u_xlat2.z;
    x_2166 = x_2173;
  }
  let x_2174 : f32 = x_2166;
  u_xlat0.z = x_2174;
  let x_2176 : f32 = u_xlat21;
  let x_2181 : vec4<f32> = u_xlat0;
  let x_2183 : vec3<f32> = ((vec3<f32>(x_2176, x_2176, x_2176) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2181.x, x_2181.y, x_2181.z));
  let x_2184 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2183.x, x_2183.y, x_2183.z, x_2184.w);
  let x_2186 : vec4<f32> = u_xlat0;
  let x_2188 : vec3<f32> = (vec3<f32>(x_2186.x, x_2186.y, x_2186.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2189 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2188.x, x_2188.y, x_2188.z, x_2189.w);
  let x_2191 : vec4<f32> = u_xlat0;
  let x_2193 : vec3<f32> = (vec3<f32>(x_2191.x, x_2191.y, x_2191.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2194 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2193.x, x_2193.y, x_2193.z, x_2194.w);
  let x_2196 : vec4<f32> = u_xlat2;
  let x_2198 : vec3<f32> = (vec3<f32>(x_2196.x, x_2196.y, x_2196.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2199 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2198.x, x_2198.y, x_2198.z, x_2199.w);
  let x_2201 : vec4<f32> = u_xlat2;
  let x_2204 : vec3<f32> = log2(abs(vec3<f32>(x_2201.x, x_2201.y, x_2201.z)));
  let x_2205 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2204.x, x_2204.y, x_2204.z, x_2205.w);
  let x_2207 : vec4<f32> = u_xlat2;
  let x_2209 : vec3<f32> = (vec3<f32>(x_2207.x, x_2207.y, x_2207.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2210 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2209.x, x_2209.y, x_2209.z, x_2210.w);
  let x_2212 : vec4<f32> = u_xlat2;
  let x_2214 : vec3<f32> = exp2(vec3<f32>(x_2212.x, x_2212.y, x_2212.z));
  let x_2215 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2214.x, x_2214.y, x_2214.z, x_2215.w);
  let x_2217 : vec4<f32> = u_xlat0;
  let x_2219 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2217.x, x_2217.y, x_2217.z, x_2217.x));
  u_xlatb0 = vec3<bool>(x_2219.x, x_2219.y, x_2219.z);
  let x_2222 : bool = u_xlatb0.x;
  if (x_2222) {
    let x_2227 : f32 = u_xlat1.x;
    x_2223 = x_2227;
  } else {
    let x_2230 : f32 = u_xlat2.x;
    x_2223 = x_2230;
  }
  let x_2231 : f32 = x_2223;
  u_xlat0.x = x_2231;
  let x_2234 : bool = u_xlatb0.y;
  if (x_2234) {
    let x_2239 : f32 = u_xlat1.y;
    x_2235 = x_2239;
  } else {
    let x_2242 : f32 = u_xlat2.y;
    x_2235 = x_2242;
  }
  let x_2243 : f32 = x_2235;
  u_xlat0.y = x_2243;
  let x_2246 : bool = u_xlatb0.z;
  if (x_2246) {
  ...
  let x_2255 : f32 = x_2247;
  u_xlat0.z = x_2255;
  let x_2259 : vec4<f32> = u_xlat0;
  let x_2261 : vec3<f32> = max(vec3<f32>(x_2259.x, x_2259.y, x_2259.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2262 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2261.x, x_2261.y, x_2261.z, x_2262.w);
  SV_Target0.w = 1.0f;
  return;
}
