...
;
    ...
    u_xlat28.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati3 + 1) / 4][(u_xlati3 + 1) % 4].xyz;
    u_xlat28.xyz = _MainLightWorldToShadow[u_xlati3 / 4][u_xlati3 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat28.xyz;
    u_xlat28.xyz = _MainLightWorldToShadow[(u_xlati3 + 2) / 4][(u_xlati3 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat28.xyz;
    u_xlat3.xyz = u_xlat28.xyz + _MainLightWorldToShadow[(u_xlati3 + 3) / 4][(u_xlati3 + 3) % 4].xyz;
    u_xlat78 = vs_TEXCOORD7.y * unity_MatrixV[1].z;
    u_xlat78 = unity_MatrixV[0].z * vs_TEXCOORD7.x + u_xlat78;
    u_xlat78 = unity_MatrixV[2].z * vs_TEXCOORD7.z + u_xlat78;
    ...
    u_xlat5.xyz = unity_SHC.xyz * vec3(u_xlat77) + u_xlat6.xyz;
    ...
    u_xlat53 = u_xlat28.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    ...
    u_xlat32.xyz = u_xlat26.xyz + _MainLightPosition.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat3.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat3.xyz;
    }
    u_xlat0.xyz = u_xlat32.xyz * u_xlat6.xyz + u_xlat4.xyz;
    u_xlat0.xyz = u_xlat3.xyz + u_xlat0.xyz;
    u_xlat75 = u_xlat78 * (-u_xlat78);
