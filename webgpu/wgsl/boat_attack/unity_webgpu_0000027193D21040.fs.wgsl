...
fn main_1() {
  ...
  u_xlat0 = sqrt(x_1497);
  let x_1499 : vec2<f32> = vs_TEXCOORD0;
  let x_1502 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1506 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1508 : vec2<f32> = ((x_1499 * vec2<f32>(x_1502.x, x_1502.y)) + vec2<f32>(x_1506.z, x_1506.w));
  let x_1509 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1508.x, x_1508.y, x_1509.z, x_1509.w);
  let x_1516 : vec4<f32> = u_xlat1;
  let x_1519 : f32 = x_26.x_GlobalMipBias.x;
  let x_1520 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1516.x, x_1516.y), x_1519);
  u_xlat15 = x_1520.w;
  let x_1522 : f32 = u_xlat15;
  u_xlat15 = ((x_1522 * 2.0f) + -1.0f);
  let x_1525 : f32 = u_xlat15;
  u_xlatb1 = (x_1525 >= 0.0f);
  let x_1527 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1527);
  let x_1530 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1530)) + 1.0f);
  let x_1534 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1534);
  let x_1536 : f32 = u_xlat15;
  u_xlat15 = (-(x_1536) + 1.0f);
  let x_1539 : f32 = u_xlat15;
  let x_1541 : f32 = u_xlat1.x;
  u_xlat15 = (x_1539 * x_1541);
  let x_1543 : vec3<f32> = u_xlat0;
  let x_1544 : vec3<f32> = (x_1543 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1545 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1544.x, x_1544.y, x_1544.z, x_1545.w);
  let x_1547 : vec3<f32> = u_xlat0;
  let x_1548 : vec3<f32> = log2(x_1547);
  let x_1549 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1548.x, x_1548.y, x_1548.z, x_1549.w);
  let x_1551 : vec4<f32> = u_xlat2;
  let x_1553 : vec3<f32> = (vec3<f32>(x_1551.x, x_1551.y, x_1551.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1554 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1553.x, x_1553.y, x_1553.z, x_1554.w);
  let x_1556 : vec4<f32> = u_xlat2;
  let x_1558 : vec3<f32> = exp2(vec3<f32>(x_1556.x, x_1556.y, x_1556.z));
  let x_1559 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1558.x, x_1558.y, x_1558.z, x_1559.w);
  let x_1561 : vec4<f32> = u_xlat2;
  let x_1564 : vec3<f32> = ((vec3<f32>(x_1561.x, x_1561.y, x_1561.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1565 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1564.x, x_1564.y, x_1564.z, x_1565.w);
  let x_1567 : vec3<f32> = u_xlat0;
  let x_1569 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1567.x, x_1567.y, x_1567.z, x_1567.x));
  u_xlatb0 = vec3<bool>(x_1569.x, x_1569.y, x_1569.z);
  let x_1572 : bool = u_xlatb0.x;
  if (x_1572) {
  ...
  u_xlat0.x = x_1581;
  let x_1584 : bool = u_xlatb0.y;
  if (x_1584) {
    let x_1589 : f32 = u_xlat1.y;
    x_1585 = x_1589;
  } else {
  ...
  u_xlat0.y = x_1593;
  let x_1596 : bool = u_xlatb0.z;
  if (x_1596) {
    let x_1601 : f32 = u_xlat1.z;
    x_1597 = x_1601;
  } else {
  ...
  u_xlat0 = ((vec3<f32>(x_1607, x_1607, x_1607) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1612);
  let x_1614 : vec3<f32> = u_xlat0;
  let x_1615 : vec3<f32> = (x_1614 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1616 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1615.x, x_1615.y, x_1615.z, x_1616.w);
  let x_1618 : vec3<f32> = u_xlat0;
  let x_1619 : vec3<f32> = (x_1618 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1620 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1619.x, x_1619.y, x_1619.z, x_1620.w);
  let x_1622 : vec4<f32> = u_xlat2;
  let x_1624 : vec3<f32> = (vec3<f32>(x_1622.x, x_1622.y, x_1622.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1625 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1624.x, x_1624.y, x_1624.z, x_1625.w);
  let x_1627 : vec4<f32> = u_xlat2;
  let x_1630 : vec3<f32> = log2(abs(vec3<f32>(x_1627.x, x_1627.y, x_1627.z)));
  let x_1631 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1630.x, x_1630.y, x_1630.z, x_1631.w);
  let x_1633 : vec4<f32> = u_xlat2;
  let x_1635 : vec3<f32> = (vec3<f32>(x_1633.x, x_1633.y, x_1633.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1645 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1643.x, x_1643.y, x_1643.z, x_1643.x));
  ...
  let x_1686 : vec3<f32> = max(x_1685, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1687 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1686.x, x_1686.y, x_1686.z, x_1687.w);
  SV_Target0.w = 1.0f;
  return;
}
