...
fn main_1() {
  ...
  let x_1515 : vec4<f32> = x_38.x_Grain_TilingParams;
  let x_1519 : vec4<f32> = x_38.x_Grain_TilingParams;
  ...
  let x_1533 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1529.x, x_1529.y), x_1532);
  u_xlat15 = x_1533.w;
  let x_1535 : f32 = u_xlat15;
  u_xlat15 = (x_1535 + -0.5f);
  let x_1537 : f32 = u_xlat15;
  let x_1538 : f32 = u_xlat15;
  u_xlat15 = (x_1537 + x_1538);
  let x_1540 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1540.x, x_1540.y, x_1540.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1549 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1549);
  let x_1554 : f32 = x_38.x_Grain_Params.y;
  let x_1556 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1554 * -(x_1556)) + 1.0f);
  let x_1561 : f32 = u_xlat15;
  let x_1563 : vec4<f32> = u_xlat0;
  u_xlat6 = (vec3<f32>(x_1561, x_1561, x_1561) * vec3<f32>(x_1563.x, x_1563.y, x_1563.z));
  let x_1566 : vec3<f32> = u_xlat6;
  let x_1569 : vec2<f32> = x_38.x_Grain_Params;
  u_xlat6 = (x_1566 * vec3<f32>(x_1569.x, x_1569.x, x_1569.x));
  let x_1572 : vec3<f32> = u_xlat6;
  let x_1573 : vec4<f32> = u_xlat1;
  let x_1576 : vec4<f32> = u_xlat0;
  let x_1578 : vec3<f32> = ((x_1572 * vec3<f32>(x_1573.x, x_1573.x, x_1573.x)) + vec3<f32>(x_1576.x, x_1576.y, x_1576.z));
  let x_1579 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1578.x, x_1578.y, x_1578.z, x_1579.w);
  let x_1581 : vec4<f32> = u_xlat0;
  let x_1583 : vec3<f32> = (vec3<f32>(x_1581.x, x_1581.y, x_1581.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1584 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1583.x, x_1583.y, x_1583.z, x_1584.w);
  let x_1586 : vec4<f32> = u_xlat0;
  let x_1589 : vec3<f32> = log2(abs(vec3<f32>(x_1586.x, x_1586.y, x_1586.z)));
  let x_1590 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1589.x, x_1589.y, x_1589.z, x_1590.w);
  let x_1592 : vec4<f32> = u_xlat2;
  let x_1594 : vec3<f32> = (vec3<f32>(x_1592.x, x_1592.y, x_1592.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1605 : vec3<f32> = ((vec3<f32>(x_1602.x, x_1602.y, x_1602.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1606 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1605.x, x_1605.y, x_1605.z, x_1606.w);
  let x_1608 : vec4<f32> = u_xlat0;
  let x_1610 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1608.x, x_1608.y, x_1608.z, x_1608.x));
  ...
  let x_1651 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1655 : vec4<f32> = x_38.x_Dithering_Params;
  ...
  let x_1668 : f32 = x_38.x_GlobalMipBias.x;
  ...
  let x_1694 : vec3<f32> = (vec3<f32>(x_1692.x, x_1692.y, x_1692.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1695 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1694.x, x_1694.y, x_1694.z, x_1695.w);
  let x_1697 : vec4<f32> = u_xlat0;
  let x_1700 : vec3<f32> = log2(abs(vec3<f32>(x_1697.x, x_1697.y, x_1697.z)));
  let x_1701 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1700.x, x_1700.y, x_1700.z, x_1701.w);
  let x_1703 : vec4<f32> = u_xlat2;
  let x_1705 : vec3<f32> = (vec3<f32>(x_1703.x, x_1703.y, x_1703.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1716 : vec3<f32> = ((vec3<f32>(x_1713.x, x_1713.y, x_1713.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1717 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1716.x, x_1716.y, x_1716.z, x_1717.w);
  let x_1719 : vec4<f32> = u_xlat0;
  let x_1721 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1719.x, x_1719.y, x_1719.z, x_1719.x));
  u_xlatb0 = vec3<bool>(x_1721.x, x_1721.y, x_1721.z);
  let x_1724 : bool = u_xlatb0.x;
  if (x_1724) {
    let x_1729 : f32 = u_xlat1.x;
    x_1725 = x_1729;
  } else {
    let x_1732 : f32 = u_xlat2.x;
    x_1725 = x_1732;
  }
  let x_1733 : f32 = x_1725;
  u_xlat0.x = x_1733;
  let x_1736 : bool = u_xlatb0.y;
  if (x_1736) {
    let x_1741 : f32 = u_xlat1.y;
    x_1737 = x_1741;
  } else {
    let x_1744 : f32 = u_xlat2.y;
    x_1737 = x_1744;
  }
  let x_1745 : f32 = x_1737;
  u_xlat0.y = x_1745;
  let x_1748 : bool = u_xlatb0.z;
  if (x_1748) {
    let x_1753 : f32 = u_xlat1.z;
    x_1749 = x_1753;
  } else {
  ...
  let x_1766 : vec3<f32> = ((vec3<f32>(x_1759, x_1759, x_1759) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1764.x, x_1764.y, x_1764.z));
  let x_1767 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1766.x, x_1766.y, x_1766.z, x_1767.w);
  let x_1769 : vec4<f32> = u_xlat0;
  let x_1771 : vec3<f32> = (vec3<f32>(x_1769.x, x_1769.y, x_1769.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1772 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1771.x, x_1771.y, x_1771.z, x_1772.w);
  let x_1774 : vec4<f32> = u_xlat0;
  let x_1776 : vec3<f32> = (vec3<f32>(x_1774.x, x_1774.y, x_1774.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1777 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1776.x, x_1776.y, x_1776.z, x_1777.w);
  let x_1779 : vec4<f32> = u_xlat2;
  let x_1781 : vec3<f32> = (vec3<f32>(x_1779.x, x_1779.y, x_1779.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1782 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1781.x, x_1781.y, x_1781.z, x_1782.w);
  let x_1784 : vec4<f32> = u_xlat2;
  let x_1787 : vec3<f32> = log2(abs(vec3<f32>(x_1784.x, x_1784.y, x_1784.z)));
  let x_1788 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1787.x, x_1787.y, x_1787.z, x_1788.w);
  let x_1790 : vec4<f32> = u_xlat2;
  let x_1792 : vec3<f32> = (vec3<f32>(x_1790.x, x_1790.y, x_1790.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1793 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1792.x, x_1792.y, x_1792.z, x_1793.w);
  let x_1795 : vec4<f32> = u_xlat2;
  let x_1797 : vec3<f32> = exp2(vec3<f32>(x_1795.x, x_1795.y, x_1795.z));
  let x_1798 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1797.x, x_1797.y, x_1797.z, x_1798.w);
  let x_1800 : vec4<f32> = u_xlat0;
  let x_1802 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1800.x, x_1800.y, x_1800.z, x_1800.x));
  u_xlatb0 = vec3<bool>(x_1802.x, x_1802.y, x_1802.z);
  let x_1805 : bool = u_xlatb0.x;
  if (x_1805) {
    let x_1810 : f32 = u_xlat1.x;
    x_1806 = x_1810;
  } else {
    let x_1813 : f32 = u_xlat2.x;
    x_1806 = x_1813;
  }
  let x_1814 : f32 = x_1806;
  u_xlat0.x = x_1814;
  let x_1817 : bool = u_xlatb0.y;
  if (x_1817) {
    let x_1822 : f32 = u_xlat1.y;
    x_1818 = x_1822;
  } else {
  ...
  u_xlat0.y = x_1826;
  let x_1829 : bool = u_xlatb0.z;
  if (x_1829) {
    let x_1834 : f32 = u_xlat1.z;
    x_1830 = x_1834;
  } else {
  ...
  let x_1844 : vec3<f32> = max(vec3<f32>(x_1842.x, x_1842.y, x_1842.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1845 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1844.x, x_1844.y, x_1844.z, x_1845.w);
  SV_Target0.w = 1.0f;
  return;
}
