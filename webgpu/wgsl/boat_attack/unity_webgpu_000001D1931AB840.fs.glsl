...
float u_xlat19;
    ...
    u_xlat1.xyz = vs_INTERP0.yyy * unity_WorldToObject[1].xyz;
    u_xlat1.xyz = unity_WorldToObject[0].xyz * vs_INTERP0.xxx + u_xlat1.xyz;
    u_xlat1.xyz = unity_WorldToObject[2].xyz * vs_INTERP0.zzz + u_xlat1.xyz;
    ...
    u_xlat1.x = (-_WorldSpaceCameraPos.y) * u_xlat1.x + vs_INTERP0.y;
