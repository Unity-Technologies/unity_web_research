...
;
    ...
    u_xlat4.xyz = vs_INTERP7.yyy * _MainLightWorldToShadow[(u_xlati75 + 1) / 4][(u_xlati75 + 1) % 4].xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[u_xlati75 / 4][u_xlati75 % 4].xyz * vs_INTERP7.xxx + u_xlat4.xyz;
    u_xlat4.xyz = _MainLightWorldToShadow[(u_xlati75 + 2) / 4][(u_xlati75 + 2) % 4].xyz * vs_INTERP7.zzz + u_xlat4.xyz;
    ...
    u_xlat76 = dot(u_xlat1.xyz, u_xlat5.xyz);
    u_xlat76 = u_xlat76 + 0.5;
    u_xlat5.xyz = vec3(u_xlat76) * u_xlat6.xyz;
    u_xlat76 = max(u_xlat5.w, 9.99999975e-05);
    ...
    u_xlat6.xyz = u_xlat0.xyz * vec3(u_xlat76);
    ...
    if(u_xlatb79){
        ...
        if(u_xlatb79){
            ...
            if(u_xlatb80){
                ...
                u_xlat57.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat7.xy);
    ...
    u_xlat4.x = u_xlat79 * _MainLightShadowParams.x + u_xlat4.x;
    ...
    u_xlat79 = (-u_xlat4.x) + 1.0;
    u_xlat4.x = u_xlat54 * u_xlat79 + u_xlat4.x;
    u_xlat54 = dot((-u_xlat3.xyz), u_xlat1.xyz);
    u_xlat54 = u_xlat54 + u_xlat54;
    u_xlat7.xyz = u_xlat1.xyz * (-vec3(u_xlat54)) + (-u_xlat3.xyz);
    u_xlat54 = dot(u_xlat1.xyz, u_xlat3.xyz);
    u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
    u_xlat54 = (-u_xlat54) + 1.0;
    u_xlat54 = u_xlat54 * u_xlat54;
    u_xlat54 = u_xlat54 * u_xlat54;
    u_xlat79 = (-u_xlat76) * 0.699999988 + 1.70000005;
    ...
    u_xlat33.xyz = (-u_xlat0.xyz) + vec3(u_xlat77);
    u_xlat33.xyz = vec3(u_xlat54) * u_xlat33.xyz + u_xlat0.xyz;
    ...
    u_xlat76 = u_xlat4.x * unity_LightData.z;
    u_xlat2.x = dot(u_xlat1.xyz, _MainLightPosition.xyz);
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat76 = u_xlat76 * u_xlat2.x;
    u_xlat4.xzw = vec3(u_xlat76) * _MainLightColor.xyz;
    ...
    u_xlat76 = dot(u_xlat1.xyz, u_xlat7.xyz);
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat76) + u_xlat6.xyz;
    u_xlat4.xzw = u_xlat4.xzw * u_xlat7.xyz;
    u_xlat76 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu76 =  uint(int(u_xlat76));
    u_xlat2.x = u_xlat29.x * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat7.x = float(0.0);
    u_xlat7.y = float(0.0);
    u_xlat7.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu76 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat29.x = dot(unity_LightIndices[int(u_xlatu29)], uintBitsToFloat(ImmCB_0[u_xlati80]));
        u_xlati29 = int(u_xlat29.x);
        u_xlat33.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati29].www + _AdditionalLightsPosition[u_xlati29].xyz;
        ...
        u_xlat80 = u_xlat80 * _AdditionalLightsAttenuation[u_xlati29].x;
        u_xlat80 = (-u_xlat80) * u_xlat80 + 1.0;
        u_xlat80 = max(u_xlat80, 0.0);
        u_xlat80 = u_xlat80 * u_xlat80;
        u_xlat80 = u_xlat80 * u_xlat82;
        u_xlat82 = dot(_AdditionalLightsSpotDir[u_xlati29].xyz, u_xlat9.xyz);
        u_xlat82 = u_xlat82 * _AdditionalLightsAttenuation[u_xlati29].z + _AdditionalLightsAttenuation[u_xlati29].w;
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        u_xlat82 = u_xlat82 * u_xlat82;
        u_xlat80 = u_xlat80 * u_xlat82;
        u_xlati82 = int(_AdditionalShadowParams[u_xlati29].w);
        u_xlatb84 = u_xlati82>=0;
        if(u_xlatb84){
            u_xlatb84 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati29].z);
            if(u_xlatb84){
                ...
                u_xlat10.x = trunc(_AdditionalShadowParams[u_xlati29].w);
            ...
            u_xlatb82 = 0.0<_AdditionalShadowParams[u_xlati29].y;
            if(u_xlatb82){
                u_xlatb82 = 1.0==_AdditionalShadowParams[u_xlati29].y;
                if(u_xlatb82){
                    ...
                    u_xlatb84 = 2.0==_AdditionalShadowParams[u_xlati29].y;
                    if(u_xlatb84){
            ...
            u_xlat84 = 1.0 + (-_AdditionalShadowParams[u_xlati29].x);
            u_xlat82 = u_xlat82 * _AdditionalShadowParams[u_xlati29].x + u_xlat84;
        ...
        u_xlat82 = u_xlat2.x * u_xlat84 + u_xlat82;
        u_xlat80 = u_xlat80 * u_xlat82;
        u_xlat82 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat82 = clamp(u_xlat82, 0.0, 1.0);
        u_xlat80 = u_xlat80 * u_xlat82;
        u_xlat10.xyz = vec3(u_xlat80) * _AdditionalLightsColor[u_xlati29].xyz;
        u_xlat33.xyz = u_xlat33.xyz * vec3(u_xlat81) + u_xlat3.xyz;
        u_xlat29.x = dot(u_xlat33.xyz, u_xlat33.xyz);
        u_xlat29.x = max(u_xlat29.x, 1.17549435e-38);
        u_xlat29.x = inversesqrt(u_xlat29.x);
        u_xlat33.xyz = u_xlat29.xxx * u_xlat33.xyz;
        u_xlat29.x = dot(u_xlat1.xyz, u_xlat33.xyz);
        ...
        u_xlat29.x = u_xlat29.x * u_xlat8.x + 1.00001001;
        u_xlat80 = u_xlat80 * u_xlat80;
        u_xlat29.x = u_xlat29.x * u_xlat29.x;
        u_xlat80 = max(u_xlat80, 0.100000001);
        u_xlat29.x = u_xlat29.x * u_xlat80;
        u_xlat29.x = u_xlat78 * u_xlat29.x;
        u_xlat29.x = u_xlat27 / u_xlat29.x;
        u_xlat33.xyz = u_xlat0.xyz * u_xlat29.xxx + u_xlat6.xyz;
        u_xlat7.xyz = u_xlat33.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat52) + u_xlat4.xzw;
