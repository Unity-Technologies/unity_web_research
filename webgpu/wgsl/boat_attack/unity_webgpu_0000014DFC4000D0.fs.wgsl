...
fn main_1() {
  ...
  let x_1396 : vec3<f32> = ((vec3<f32>(x_1390.x, x_1390.x, x_1390.x) * vec3<f32>(x_1392.x, x_1392.y, x_1392.z)) + x_1395);
  let x_1397 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1396.x, x_1396.y, x_1396.z, x_1397.w);
  SV_Target0.w = 1.0f;
  return;
}
