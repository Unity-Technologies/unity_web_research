...
fn main_1() {
  ...
  u_xlat0 = vec4<f32>(x_1495.x, x_1495.y, x_1495.z, x_1496.w);
  let x_1498 : vec2<f32> = vs_TEXCOORD0;
  let x_1501 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1505 : vec4<f32> = x_25.x_Dithering_Params;
  let x_1507 : vec2<f32> = ((x_1498 * vec2<f32>(x_1501.x, x_1501.y)) + vec2<f32>(x_1505.z, x_1505.w));
  let x_1508 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1507.x, x_1507.y, x_1508.z);
  let x_1515 : vec3<f32> = u_xlat1;
  let x_1518 : f32 = x_25.x_GlobalMipBias.x;
  let x_1519 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1515.x, x_1515.y), x_1518);
  u_xlat21 = x_1519.w;
  let x_1521 : f32 = u_xlat21;
  u_xlat21 = ((x_1521 * 2.0f) + -1.0f);
  let x_1524 : f32 = u_xlat21;
  u_xlatb1.x = (x_1524 >= 0.0f);
  let x_1528 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1528);
  let x_1531 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1531)) + 1.0f);
  let x_1535 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1535);
  let x_1537 : f32 = u_xlat21;
  u_xlat21 = (-(x_1537) + 1.0f);
  let x_1540 : f32 = u_xlat21;
  let x_1542 : f32 = u_xlat1.x;
  u_xlat21 = (x_1540 * x_1542);
  let x_1544 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1544.x, x_1544.y, x_1544.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1547 : vec4<f32> = u_xlat0;
  let x_1549 : vec3<f32> = log2(vec3<f32>(x_1547.x, x_1547.y, x_1547.z));
  let x_1550 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1549.x, x_1549.y, x_1549.z, x_1550.w);
  let x_1552 : vec4<f32> = u_xlat2;
  let x_1554 : vec3<f32> = (vec3<f32>(x_1552.x, x_1552.y, x_1552.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1555 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1554.x, x_1554.y, x_1554.z, x_1555.w);
  let x_1557 : vec4<f32> = u_xlat2;
  let x_1559 : vec3<f32> = exp2(vec3<f32>(x_1557.x, x_1557.y, x_1557.z));
  let x_1560 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1559.x, x_1559.y, x_1559.z, x_1560.w);
  let x_1562 : vec4<f32> = u_xlat2;
  let x_1565 : vec3<f32> = ((vec3<f32>(x_1562.x, x_1562.y, x_1562.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1566 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1565.x, x_1565.y, x_1565.z, x_1566.w);
  let x_1568 : vec4<f32> = u_xlat0;
  let x_1570 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1568.x, x_1568.y, x_1568.z, x_1568.x));
  u_xlatb0 = vec3<bool>(x_1570.x, x_1570.y, x_1570.z);
  let x_1573 : bool = u_xlatb0.x;
  if (x_1573) {
  ...
  u_xlat0.x = x_1582;
  let x_1585 : bool = u_xlatb0.y;
  if (x_1585) {
    let x_1590 : f32 = u_xlat1.y;
    x_1586 = x_1590;
  } else {
  ...
  u_xlat0.y = x_1594;
  let x_1597 : bool = u_xlatb0.z;
  if (x_1597) {
    let x_1602 : f32 = u_xlat1.z;
    x_1598 = x_1602;
  } else {
  ...
  u_xlat0.z = x_1606;
  let x_1608 : f32 = u_xlat21;
  let x_1613 : vec4<f32> = u_xlat0;
  let x_1615 : vec3<f32> = ((vec3<f32>(x_1608, x_1608, x_1608) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1613.x, x_1613.y, x_1613.z));
  let x_1616 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1615.x, x_1615.y, x_1615.z, x_1616.w);
  let x_1618 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1618.x, x_1618.y, x_1618.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1621 : vec4<f32> = u_xlat0;
  let x_1623 : vec3<f32> = (vec3<f32>(x_1621.x, x_1621.y, x_1621.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1624 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1623.x, x_1623.y, x_1623.z, x_1624.w);
  let x_1626 : vec4<f32> = u_xlat2;
  let x_1628 : vec3<f32> = (vec3<f32>(x_1626.x, x_1626.y, x_1626.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  ...
  let x_1639 : vec3<f32> = (vec3<f32>(x_1637.x, x_1637.y, x_1637.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1649 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1647.x, x_1647.y, x_1647.z, x_1647.x));
  ...
  let x_1692 : vec3<f32> = max(vec3<f32>(x_1689.x, x_1689.y, x_1689.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1693 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1692.x, x_1692.y, x_1692.z, x_1693.w);
  SV_Target0.w = 1.0f;
  return;
}
