...
fn main_1() {
  ...
  let x_1539 : vec2<f32> = vs_TEXCOORD0;
  let x_1542 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1546 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1548 : vec2<f32> = ((x_1539 * vec2<f32>(x_1542.x, x_1542.y)) + vec2<f32>(x_1546.z, x_1546.w));
  let x_1549 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1548.x, x_1548.y, x_1549.z, x_1549.w);
  let x_1556 : vec4<f32> = u_xlat1;
  let x_1559 : f32 = x_26.x_GlobalMipBias.x;
  let x_1560 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1556.x, x_1556.y), x_1559);
  u_xlat15 = x_1560.w;
  let x_1562 : f32 = u_xlat15;
  u_xlat15 = ((x_1562 * 2.0f) + -1.0f);
  let x_1565 : f32 = u_xlat15;
  u_xlatb1 = (x_1565 >= 0.0f);
  let x_1567 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1567);
  let x_1570 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1570)) + 1.0f);
  let x_1574 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1574);
  let x_1576 : f32 = u_xlat15;
  u_xlat15 = (-(x_1576) + 1.0f);
  ...
  u_xlat0.z = x_1646;
  let x_1648 : f32 = u_xlat15;
  let x_1653 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1648, x_1648, x_1648) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1653);
  let x_1655 : vec3<f32> = u_xlat0;
  let x_1656 : vec3<f32> = (x_1655 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1657 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1656.x, x_1656.y, x_1656.z, x_1657.w);
  let x_1659 : vec3<f32> = u_xlat0;
  let x_1660 : vec3<f32> = (x_1659 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1661 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1660.x, x_1660.y, x_1660.z, x_1661.w);
  let x_1663 : vec4<f32> = u_xlat2;
  let x_1665 : vec3<f32> = (vec3<f32>(x_1663.x, x_1663.y, x_1663.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1666 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1666.w);
  let x_1668 : vec4<f32> = u_xlat2;
  let x_1671 : vec3<f32> = log2(abs(vec3<f32>(x_1668.x, x_1668.y, x_1668.z)));
  let x_1672 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1671.x, x_1671.y, x_1671.z, x_1672.w);
  let x_1674 : vec4<f32> = u_xlat2;
  let x_1676 : vec3<f32> = (vec3<f32>(x_1674.x, x_1674.y, x_1674.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1677 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1676.x, x_1676.y, x_1676.z, x_1677.w);
  let x_1679 : vec4<f32> = u_xlat2;
  let x_1681 : vec3<f32> = exp2(vec3<f32>(x_1679.x, x_1679.y, x_1679.z));
  let x_1682 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1681.x, x_1681.y, x_1681.z, x_1682.w);
  let x_1684 : vec3<f32> = u_xlat0;
  let x_1686 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1684.x, x_1684.y, x_1684.z, x_1684.x));
  ...
  let x_1727 : vec3<f32> = max(x_1726, vec3<f32>(0.0f, 0.0f, 0.0f));
