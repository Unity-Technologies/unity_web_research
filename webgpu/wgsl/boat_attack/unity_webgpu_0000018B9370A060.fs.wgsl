...
fn main_1() {
  ...
  let x_1355 : vec2<f32> = vs_TEXCOORD0;
  let x_1358 : vec4<f32> = x_14.x_Grain_TilingParams;
  let x_1362 : vec4<f32> = x_14.x_Grain_TilingParams;
  let x_1364 : vec2<f32> = ((x_1355 * vec2<f32>(x_1358.x, x_1358.y)) + vec2<f32>(x_1362.z, x_1362.w));
  let x_1365 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1364.x, x_1364.y, x_1365.z, x_1365.w);
  let x_1372 : vec4<f32> = u_xlat1;
  let x_1375 : f32 = x_14.x_GlobalMipBias.x;
  let x_1376 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1372.x, x_1372.y), x_1375);
  u_xlat15 = x_1376.w;
  let x_1378 : f32 = u_xlat15;
  u_xlat15 = (x_1378 + -0.5f);
  let x_1380 : f32 = u_xlat15;
  let x_1381 : f32 = u_xlat15;
  u_xlat15 = (x_1380 + x_1381);
  let x_1383 : vec3<f32> = u_xlat0;
  u_xlat1.x = dot(x_1383, vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_1391 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1391);
  let x_1396 : f32 = x_14.x_Grain_Params.y;
  let x_1398 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1396 * -(x_1398)) + 1.0f);
  let x_1403 : f32 = u_xlat15;
  let x_1405 : vec3<f32> = u_xlat0;
  u_xlat6 = (vec3<f32>(x_1403, x_1403, x_1403) * x_1405);
  let x_1407 : vec3<f32> = u_xlat6;
  let x_1410 : vec2<f32> = x_14.x_Grain_Params;
  u_xlat6 = (x_1407 * vec3<f32>(x_1410.x, x_1410.x, x_1410.x));
  let x_1413 : vec3<f32> = u_xlat6;
  let x_1414 : vec4<f32> = u_xlat1;
  let x_1417 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1413 * vec3<f32>(x_1414.x, x_1414.x, x_1414.x)) + x_1417);
  let x_1419 : vec3<f32> = u_xlat0;
  let x_1420 : vec3<f32> = (x_1419 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1421 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1420.x, x_1420.y, x_1420.z, x_1421.w);
  let x_1423 : vec3<f32> = u_xlat0;
  let x_1425 : vec3<f32> = log2(abs(x_1423));
  let x_1426 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1425.x, x_1425.y, x_1425.z, x_1426.w);
  let x_1428 : vec4<f32> = u_xlat2;
  let x_1430 : vec3<f32> = (vec3<f32>(x_1428.x, x_1428.y, x_1428.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1431 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1430.x, x_1430.y, x_1430.z, x_1431.w);
  let x_1433 : vec4<f32> = u_xlat2;
  let x_1435 : vec3<f32> = exp2(vec3<f32>(x_1433.x, x_1433.y, x_1433.z));
  let x_1436 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1435.x, x_1435.y, x_1435.z, x_1436.w);
  let x_1438 : vec4<f32> = u_xlat2;
  let x_1441 : vec3<f32> = ((vec3<f32>(x_1438.x, x_1438.y, x_1438.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1442 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1441.x, x_1441.y, x_1441.z, x_1442.w);
  let x_1444 : vec3<f32> = u_xlat0;
  let x_1446 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1444.x, x_1444.y, x_1444.z, x_1444.x));
  u_xlatb0 = vec3<bool>(x_1446.x, x_1446.y, x_1446.z);
  ...
  u_xlat0.z = x_1482;
  let x_1484 : vec2<f32> = vs_TEXCOORD0;
  let x_1487 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1491 : vec4<f32> = x_14.x_Dithering_Params;
  let x_1493 : vec2<f32> = ((x_1484 * vec2<f32>(x_1487.x, x_1487.y)) + vec2<f32>(x_1491.z, x_1491.w));
  let x_1494 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1493.x, x_1493.y, x_1494.z, x_1494.w);
  let x_1501 : vec4<f32> = u_xlat1;
  let x_1504 : f32 = x_14.x_GlobalMipBias.x;
  let x_1505 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1501.x, x_1501.y), x_1504);
  u_xlat15 = x_1505.w;
  let x_1507 : f32 = u_xlat15;
  u_xlat15 = ((x_1507 * 2.0f) + -1.0f);
  let x_1510 : f32 = u_xlat15;
  u_xlatb1 = (x_1510 >= 0.0f);
  let x_1512 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1512);
  let x_1515 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1515)) + 1.0f);
  let x_1519 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1519);
  let x_1521 : f32 = u_xlat15;
  u_xlat15 = (-(x_1521) + 1.0f);
  let x_1524 : f32 = u_xlat15;
  let x_1526 : f32 = u_xlat1.x;
  u_xlat15 = (x_1524 * x_1526);
  let x_1528 : vec3<f32> = u_xlat0;
  let x_1529 : vec3<f32> = (x_1528 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1530 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1529.x, x_1529.y, x_1529.z, x_1530.w);
  let x_1532 : vec3<f32> = u_xlat0;
  let x_1534 : vec3<f32> = log2(abs(x_1532));
  let x_1535 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1534.x, x_1534.y, x_1534.z, x_1535.w);
  let x_1537 : vec4<f32> = u_xlat2;
  let x_1539 : vec3<f32> = (vec3<f32>(x_1537.x, x_1537.y, x_1537.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1540 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1539.x, x_1539.y, x_1539.z, x_1540.w);
  let x_1542 : vec4<f32> = u_xlat2;
  let x_1544 : vec3<f32> = exp2(vec3<f32>(x_1542.x, x_1542.y, x_1542.z));
  let x_1545 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1544.x, x_1544.y, x_1544.z, x_1545.w);
  let x_1547 : vec4<f32> = u_xlat2;
  let x_1550 : vec3<f32> = ((vec3<f32>(x_1547.x, x_1547.y, x_1547.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  ...
  let x_1601 : vec3<f32> = (x_1600 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1602 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1601.x, x_1601.y, x_1601.z, x_1602.w);
  let x_1604 : vec3<f32> = u_xlat0;
  let x_1605 : vec3<f32> = (x_1604 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1606 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1605.x, x_1605.y, x_1605.z, x_1606.w);
  let x_1608 : vec4<f32> = u_xlat2;
  let x_1610 : vec3<f32> = (vec3<f32>(x_1608.x, x_1608.y, x_1608.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1611 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1610.x, x_1610.y, x_1610.z, x_1611.w);
  let x_1613 : vec4<f32> = u_xlat2;
  let x_1616 : vec3<f32> = log2(abs(vec3<f32>(x_1613.x, x_1613.y, x_1613.z)));
  let x_1617 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1616.x, x_1616.y, x_1616.z, x_1617.w);
  let x_1619 : vec4<f32> = u_xlat2;
  let x_1621 : vec3<f32> = (vec3<f32>(x_1619.x, x_1619.y, x_1619.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1622 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1621.x, x_1621.y, x_1621.z, x_1622.w);
  let x_1624 : vec4<f32> = u_xlat2;
  let x_1626 : vec3<f32> = exp2(vec3<f32>(x_1624.x, x_1624.y, x_1624.z));
  let x_1627 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1626.x, x_1626.y, x_1626.z, x_1627.w);
  let x_1629 : vec3<f32> = u_xlat0;
  let x_1631 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1629.x, x_1629.y, x_1629.z, x_1629.x));
  ...
  let x_1672 : vec3<f32> = max(x_1671, vec3<f32>(0.0f, 0.0f, 0.0f));
