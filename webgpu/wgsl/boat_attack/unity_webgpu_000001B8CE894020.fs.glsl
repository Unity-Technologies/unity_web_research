...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat2.x = (u_xlatb66) ? u_xlat1.x : unity_MatrixV[0].z;
    u_xlat2.y = (u_xlatb66) ? u_xlat1.y : unity_MatrixV[1].z;
    u_xlat2.z = (u_xlatb66) ? u_xlat1.z : unity_MatrixV[2].z;
...
;
    ...
    u_xlatu45 = u_xlatu1.z * 1025u;
    u_xlatu25 = u_xlatu45 >> (6u & uint(0x1F));
    u_xlati45 = int(u_xlatu45 ^ u_xlatu25);
    u_xlatu45 = uint(u_xlati45) * 9u;
    u_xlatu25 = u_xlatu45 >> (11u & uint(0x1F));
    u_xlati45 = int(u_xlatu45 ^ u_xlatu25);
    u_xlati45 = u_xlati45 * 32769;
    u_xlati23 = int(uint(u_xlati45) ^ u_xlatu1.y);
    u_xlatu23 = uint(u_xlati23) * 1025u;
    u_xlatu45 = u_xlatu23 >> (6u & uint(0x1F));
    u_xlati23 = int(u_xlatu45 ^ u_xlatu23);
    u_xlatu23 = uint(u_xlati23) * 9u;
    u_xlatu45 = u_xlatu23 >> (11u & uint(0x1F));
    u_xlati23 = int(u_xlatu45 ^ u_xlatu23);
    u_xlati23 = u_xlati23 * 32769;
    u_xlati1 = int(uint(u_xlati23) ^ u_xlatu1.x);
    u_xlatu1.x = uint(u_xlati1) * 1025u;
    u_xlatu23 = u_xlatu1.x >> (6u & uint(0x1F));
    u_xlati1 = int(u_xlatu23 ^ u_xlatu1.x);
    u_xlatu1.x = uint(u_xlati1) * 9u;
    u_xlatu23 = u_xlatu1.x >> (11u & uint(0x1F));
    u_xlati1 = int(u_xlatu23 ^ u_xlatu1.x);
    ...
    u_xlat1.x = (u_xlatb3) ? u_xlat1.x : u_xlat23;
    u_xlat1.x = u_xlat67 * 2.0 + (-u_xlat1.x);
    u_xlat23 = u_xlat1.x * u_xlat3.w;
    u_xlatb45.x = u_xlat23>=0.400000006;
    u_xlat45.x = u_xlatb45.x ? u_xlat23 : float(0.0);
    u_xlat1.x = u_xlat3.w * u_xlat1.x + -0.400000006;
    u_xlat67 = dFdxCoarse(u_xlat23);
    u_xlat23 = dFdyCoarse(u_xlat23);
    u_xlat23 = abs(u_xlat23) + abs(u_xlat67);
    u_xlat23 = max(u_xlat23, 9.99999975e-05);
    u_xlat1.x = u_xlat1.x / u_xlat23;
    u_xlat1.x = u_xlat1.x + 0.5;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlatb23 = _AlphaToMaskAvailable!=0.0;
    u_xlat1.x = (u_xlatb23) ? u_xlat1.x : u_xlat45.x;
    u_xlat45.x = u_xlat1.x + -9.99999975e-05;
    u_xlatb45.x = u_xlat45.x<0.0;
    if(((int(u_xlatb45.x) * int(0xffffffffu)))!=0){discard;}
    u_xlatb45.x = 0.0<vs_INTERP2.w;
    u_xlatb45.y = unity_WorldTransformParams.w>=0.0;
    u_xlat45.x = (u_xlatb45.x) ? float(1.0) : float(-1.0);
    u_xlat45.y = (u_xlatb45.y) ? float(1.0) : float(-1.0);
    u_xlat45.x = u_xlat45.y * u_xlat45.x;
    u_xlat3.xyz = vs_INTERP1.zxy * vs_INTERP2.yzx;
    u_xlat3.xyz = vs_INTERP1.yzx * vs_INTERP2.zxy + (-u_xlat3.xyz);
    u_xlat3.xyz = u_xlat45.xxx * u_xlat3.xyz;
    ...
    u_xlat45.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    ...
    u_xlat45.x = dot(u_xlat3.xyz, u_xlat7.xyz);
    u_xlat45.x = u_xlat45.x + 0.5;
    u_xlat27.xyz = u_xlat45.xxx * u_xlat27.xyz;
    u_xlat45.x = max(u_xlat7.w, 9.99999975e-05);
    u_xlat27.xyz = u_xlat27.xyz / u_xlat45.xxx;
    u_xlat45.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat7.xy = u_xlat45.xy * hlslcc_FragCoord.xy;
    u_xlat45.x = u_xlat7.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat7.z = (-u_xlat45.x) + 1.0;
    u_xlat5.x = u_xlat5.x;
    ...
    u_xlat67 = u_xlat45.x * u_xlat45.x;
    u_xlat67 = max(u_xlat67, 0.0078125);
    u_xlat69 = u_xlat67 * u_xlat67;
    ...
    if(u_xlatb66){
        ...
        if(u_xlatb66){
            ...
            if(u_xlatb51.x){
                u_xlat51.xy = u_xlat6.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat51.xy = floor(u_xlat51.xy);
                u_xlat8.xy = u_xlat6.xy * _MainLightShadowmapSize.zw + (-u_xlat51.xy);
                ...
                vec3 txVec49 = vec3(u_xlat58.xy,u_xlat6.z);
                ...
                vec3 txVec53 = vec3(u_xlat31.xy,u_xlat6.z);
                ...
                u_xlat30.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec57, 0.0);
                u_xlat8.x = u_xlat8.z * u_xlat30.x + u_xlat8.x;
                vec3 txVec58 = vec3(u_xlat51.xy,u_xlat6.z);
    ...
    u_xlat8.xyz = u_xlat3.xyz * (-vec3(u_xlat68)) + (-u_xlat2.xyz);
    u_xlat68 = dot(u_xlat3.xyz, u_xlat2.xyz);
    u_xlat68 = clamp(u_xlat68, 0.0, 1.0);
    u_xlat68 = (-u_xlat68) + 1.0;
    u_xlat68 = u_xlat68 * u_xlat68;
    u_xlat68 = u_xlat68 * u_xlat68;
    u_xlat70 = (-u_xlat45.x) * 0.699999988 + 1.70000005;
    u_xlat45.x = u_xlat45.x * u_xlat70;
    u_xlat45.x = u_xlat45.x * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat45.x);
    ...
    u_xlat45.xy = vec2(u_xlat67) * vec2(u_xlat67) + vec2(-1.0, 1.0);
    u_xlat67 = float(1.0) / u_xlat45.y;
    u_xlat70 = u_xlat5.x + -0.0399999991;
    ...
    u_xlat67 = dot(u_xlat3.xyz, _MainLightPosition.xyz);
    ...
    u_xlat66 = u_xlat66 * u_xlat45.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu66 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat68 = dot(unity_LightIndices[int(u_xlatu68)], uintBitsToFloat(ImmCB_0[u_xlati70]));
        ...
        u_xlat70 = u_xlat70 * _AdditionalLightsAttenuation[int(u_xlatu68)].x;
        u_xlat70 = (-u_xlat70) * u_xlat70 + 1.0;
        u_xlat70 = max(u_xlat70, 0.0);
        u_xlat70 = u_xlat70 * u_xlat70;
        u_xlat70 = u_xlat70 * u_xlat74;
        u_xlat74 = dot(_AdditionalLightsSpotDir[int(u_xlatu68)].xyz, u_xlat10.xyz);
        u_xlat74 = u_xlat74 * _AdditionalLightsAttenuation[int(u_xlatu68)].z + _AdditionalLightsAttenuation[int(u_xlatu68)].w;
        u_xlat74 = clamp(u_xlat74, 0.0, 1.0);
        u_xlat74 = u_xlat74 * u_xlat74;
        u_xlat70 = u_xlat70 * u_xlat74;
        u_xlatu74 = u_xlatu68 >> (5u & uint(0x1F));
        u_xlati75 = 1 << (int(u_xlatu68) & int(0x1F));
        u_xlati74 = int(uint(u_xlati75) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu74)]));
        if(u_xlati74 != 0) {
            u_xlati74 = int(_AdditionalLightsLightTypes[int(u_xlatu68)]);
            u_xlati75 = (u_xlati74 != 0) ? 0 : 1;
            u_xlati76 = int(u_xlatu68) << (2 & int(0x1F));
            if(u_xlati75 != 0) {
                ...
                if(u_xlati74 != 0) {
                    ...
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].xy * u_xlat55.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu68)].zw;
                } else {
        ...
        u_xlat68 = u_xlat68 * u_xlat68;
        u_xlat68 = u_xlat68 * u_xlat45.x + 1.00001001;
        u_xlat70 = u_xlat70 * u_xlat70;
        u_xlat68 = u_xlat68 * u_xlat68;
        ...
        u_xlat9.xyz = vec3(u_xlat68) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat4.xyz;
