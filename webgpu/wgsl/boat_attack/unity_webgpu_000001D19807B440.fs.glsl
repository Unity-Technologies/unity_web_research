...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat3.xyz = u_xlat12.xyz * u_xlat0.xxx;
    ...
    u_xlat18.xyz = u_xlat0.xxx * u_xlat7.xyz;
...
;
    ...
    u_xlat0.x = u_xlat0.x * _MainLightShadowParams.x + u_xlat37;
    u_xlatb37 = 0.0>=u_xlat2.z;
    u_xlatb2.x = u_xlat2.z>=1.0;
    u_xlatb37 = u_xlatb37 || u_xlatb2.x;
    u_xlat0.x = (u_xlatb37) ? 1.0 : u_xlat0.x;
    u_xlat1.x = dot(u_xlat1.xyz, (-_MainLightPosition.xyz));
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat13.xyz = u_xlat0.xxx * _MainLightColor.xyz;
    u_xlat1.xyz = u_xlat13.xyz * u_xlat1.xxx;
    u_xlat1.xyz = u_xlat1.xyz * u_xlat4.xyz;
    u_xlatb37 = u_xlat4.w>=0.400000006;
    u_xlat37 = u_xlatb37 ? u_xlat4.w : float(0.0);
    ...
    u_xlat37 = (u_xlatb14) ? u_xlat2.x : u_xlat37;
    ...
    u_xlat12.xyz = u_xlat18.xxx * vs_INTERP2.xyz + u_xlat12.xyz;
    u_xlat12.xyz = u_xlat18.zzz * vs_INTERP1.xyz + u_xlat12.xyz;
    ...
    u_xlat26.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat7.xy = u_xlat26.xy * hlslcc_FragCoord.xy;
    u_xlat26.x = u_xlat7.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat7.z = (-u_xlat26.x) + 1.0;
    u_xlat6.x = u_xlat6.x;
    ...
    u_xlat0.x = u_xlat30 * u_xlat42 + u_xlat0.x;
    u_xlat7.xyz = u_xlat18.xxx * _MainLightColor.xyz;
    u_xlat30 = dot((-u_xlat12.xyz), u_xlat3.xyz);
    u_xlat30 = u_xlat30 + u_xlat30;
    u_xlat8.xyz = u_xlat3.xyz * (-vec3(u_xlat30)) + (-u_xlat12.xyz);
    ...
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat8.xyz, u_xlat26.x);
    ...
    u_xlat0.x = u_xlat0.x * u_xlat26.x + 1.00001001;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat40 = dot(unity_LightIndices[int(u_xlatu40)], uintBitsToFloat(ImmCB_0[u_xlati30]));
        ...
        u_xlat30 = u_xlat30 * _AdditionalLightsAttenuation[u_xlati40].x;
        ...
        u_xlat30 = u_xlat30 * u_xlat43;
        u_xlat11.xyz = u_xlat18.xxx * _AdditionalLightsColor[u_xlati40].xyz;
        u_xlat40 = dot(u_xlat3.xyz, u_xlat10.xyz);
        u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
        u_xlat40 = u_xlat40 * u_xlat30;
        u_xlat11.xyz = vec3(u_xlat40) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat42) + u_xlat12.xyz;
        ...
        u_xlat40 = u_xlat40 * u_xlat26.x + 1.00001001;
        u_xlat30 = u_xlat30 * u_xlat30;
        u_xlat40 = u_xlat40 * u_xlat40;
        ...
        u_xlat9.xyz = vec3(u_xlat40) * vec3(0.0399999991, 0.0399999991, 0.0399999991) + u_xlat5.xyz;
    ...
    SV_Target0.w = (u_xlatb14) ? u_xlat37 : 1.0;
    return;
}
