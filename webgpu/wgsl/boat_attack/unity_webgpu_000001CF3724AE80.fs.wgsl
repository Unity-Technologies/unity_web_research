...
fn main_1() {
  ...
  let x_1540 : vec3<f32> = sqrt(vec3<f32>(x_1538.x, x_1538.y, x_1538.z));
  let x_1541 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1540.x, x_1540.y, x_1540.z, x_1541.w);
  let x_1543 : vec2<f32> = vs_TEXCOORD0;
  let x_1546 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1550 : vec4<f32> = x_38.x_Dithering_Params;
  let x_1552 : vec2<f32> = ((x_1543 * vec2<f32>(x_1546.x, x_1546.y)) + vec2<f32>(x_1550.z, x_1550.w));
  let x_1553 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1552.x, x_1552.y, x_1553.z, x_1553.w);
  let x_1560 : vec4<f32> = u_xlat1;
  let x_1563 : f32 = x_38.x_GlobalMipBias.x;
  let x_1564 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1560.x, x_1560.y), x_1563);
  u_xlat15 = x_1564.w;
  let x_1566 : f32 = u_xlat15;
  u_xlat15 = ((x_1566 * 2.0f) + -1.0f);
  let x_1569 : f32 = u_xlat15;
  u_xlatb1 = (x_1569 >= 0.0f);
  let x_1571 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1571);
  let x_1574 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1574)) + 1.0f);
  let x_1578 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1578);
  let x_1580 : f32 = u_xlat15;
  u_xlat15 = (-(x_1580) + 1.0f);
  let x_1583 : f32 = u_xlat15;
  let x_1585 : f32 = u_xlat1.x;
  u_xlat15 = (x_1583 * x_1585);
  let x_1587 : vec4<f32> = u_xlat0;
  let x_1589 : vec3<f32> = (vec3<f32>(x_1587.x, x_1587.y, x_1587.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1590 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1589.x, x_1589.y, x_1589.z, x_1590.w);
  let x_1592 : vec4<f32> = u_xlat0;
  let x_1594 : vec3<f32> = log2(vec3<f32>(x_1592.x, x_1592.y, x_1592.z));
  let x_1595 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1594.x, x_1594.y, x_1594.z, x_1595.w);
  let x_1597 : vec4<f32> = u_xlat2;
  let x_1599 : vec3<f32> = (vec3<f32>(x_1597.x, x_1597.y, x_1597.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1610 : vec3<f32> = ((vec3<f32>(x_1607.x, x_1607.y, x_1607.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1611 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1610.x, x_1610.y, x_1610.z, x_1611.w);
  let x_1613 : vec4<f32> = u_xlat0;
  let x_1615 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1613.x, x_1613.y, x_1613.z, x_1613.x));
  u_xlatb0 = vec3<bool>(x_1615.x, x_1615.y, x_1615.z);
  ...
  u_xlat0.x = x_1627;
  let x_1630 : bool = u_xlatb0.y;
  if (x_1630) {
    let x_1635 : f32 = u_xlat1.y;
    x_1631 = x_1635;
  } else {
    let x_1638 : f32 = u_xlat2.y;
    x_1631 = x_1638;
  }
  let x_1639 : f32 = x_1631;
  u_xlat0.y = x_1639;
  let x_1642 : bool = u_xlatb0.z;
  if (x_1642) {
    let x_1647 : f32 = u_xlat1.z;
    x_1643 = x_1647;
  } else {
  ...
  u_xlat0.z = x_1651;
  let x_1653 : f32 = u_xlat15;
  let x_1658 : vec4<f32> = u_xlat0;
  let x_1660 : vec3<f32> = ((vec3<f32>(x_1653, x_1653, x_1653) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_1658.x, x_1658.y, x_1658.z));
  let x_1661 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1660.x, x_1660.y, x_1660.z, x_1661.w);
  let x_1663 : vec4<f32> = u_xlat0;
  let x_1665 : vec3<f32> = (vec3<f32>(x_1663.x, x_1663.y, x_1663.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1666 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1666.w);
  let x_1668 : vec4<f32> = u_xlat0;
  let x_1670 : vec3<f32> = (vec3<f32>(x_1668.x, x_1668.y, x_1668.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1671 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1670.x, x_1670.y, x_1670.z, x_1671.w);
  let x_1673 : vec4<f32> = u_xlat2;
  let x_1675 : vec3<f32> = (vec3<f32>(x_1673.x, x_1673.y, x_1673.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1676 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1675.x, x_1675.y, x_1675.z, x_1676.w);
  let x_1678 : vec4<f32> = u_xlat2;
  let x_1681 : vec3<f32> = log2(abs(vec3<f32>(x_1678.x, x_1678.y, x_1678.z)));
  let x_1682 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1681.x, x_1681.y, x_1681.z, x_1682.w);
  let x_1684 : vec4<f32> = u_xlat2;
  let x_1686 : vec3<f32> = (vec3<f32>(x_1684.x, x_1684.y, x_1684.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1696 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1694.x, x_1694.y, x_1694.z, x_1694.x));
  u_xlatb0 = vec3<bool>(x_1696.x, x_1696.y, x_1696.z);
  let x_1699 : bool = u_xlatb0.x;
  if (x_1699) {
    let x_1704 : f32 = u_xlat1.x;
    x_1700 = x_1704;
  } else {
  ...
  u_xlat0.x = x_1708;
  let x_1711 : bool = u_xlatb0.y;
  if (x_1711) {
    let x_1716 : f32 = u_xlat1.y;
    x_1712 = x_1716;
  } else {
    let x_1719 : f32 = u_xlat2.y;
    x_1712 = x_1719;
  }
  let x_1720 : f32 = x_1712;
  u_xlat0.y = x_1720;
  let x_1723 : bool = u_xlatb0.z;
  if (x_1723) {
    let x_1728 : f32 = u_xlat1.z;
    x_1724 = x_1728;
  } else {
  ...
  let x_1738 : vec3<f32> = max(vec3<f32>(x_1736.x, x_1736.y, x_1736.z), vec3<f32>(0.0f, 0.0f, 0.0f));
