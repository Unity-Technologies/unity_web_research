...
fn main_1() {
  ...
  let x_1967 : vec2<f32> = vs_TEXCOORD0;
  let x_1970 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1974 : vec4<f32> = x_25.x_Grain_TilingParams;
  let x_1976 : vec2<f32> = ((x_1967 * vec2<f32>(x_1970.x, x_1970.y)) + vec2<f32>(x_1974.z, x_1974.w));
  let x_1977 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1976.x, x_1976.y, x_1977.z, x_1977.w);
  let x_1984 : vec4<f32> = u_xlat1;
  let x_1987 : f32 = x_25.x_GlobalMipBias.x;
  let x_1988 : vec4<f32> = textureSampleBias(x_Grain_Texture, sampler_LinearRepeat, vec2<f32>(x_1984.x, x_1984.y), x_1987);
  u_xlat21 = x_1988.w;
  let x_1990 : f32 = u_xlat21;
  u_xlat21 = (x_1990 + -0.5f);
  let x_1992 : f32 = u_xlat21;
  let x_1993 : f32 = u_xlat21;
  u_xlat21 = (x_1992 + x_1993);
  let x_1995 : vec4<f32> = u_xlat0;
  u_xlat1.x = dot(vec3<f32>(x_1995.x, x_1995.y, x_1995.z), vec3<f32>(0.21267290413379669189f, 0.71515220403671264648f, 0.07217500358819961548f));
  let x_2004 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_2004);
  let x_2009 : f32 = x_25.x_Grain_Params.y;
  let x_2011 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_2009 * -(x_2011)) + 1.0f);
  let x_2016 : f32 = u_xlat21;
  let x_2018 : vec4<f32> = u_xlat0;
  u_xlat8 = (vec3<f32>(x_2016, x_2016, x_2016) * vec3<f32>(x_2018.x, x_2018.y, x_2018.z));
  let x_2021 : vec3<f32> = u_xlat8;
  let x_2024 : vec2<f32> = x_25.x_Grain_Params;
  u_xlat8 = (x_2021 * vec3<f32>(x_2024.x, x_2024.x, x_2024.x));
  let x_2027 : vec3<f32> = u_xlat8;
  let x_2028 : vec4<f32> = u_xlat1;
  let x_2031 : vec4<f32> = u_xlat0;
  let x_2033 : vec3<f32> = ((x_2027 * vec3<f32>(x_2028.x, x_2028.x, x_2028.x)) + vec3<f32>(x_2031.x, x_2031.y, x_2031.z));
  let x_2034 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2033.x, x_2033.y, x_2033.z, x_2034.w);
  let x_2036 : vec4<f32> = u_xlat0;
  let x_2038 : vec3<f32> = sqrt(vec3<f32>(x_2036.x, x_2036.y, x_2036.z));
  let x_2039 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2038.x, x_2038.y, x_2038.z, x_2039.w);
  let x_2041 : vec2<f32> = vs_TEXCOORD0;
  let x_2044 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2048 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2050 : vec2<f32> = ((x_2041 * vec2<f32>(x_2044.x, x_2044.y)) + vec2<f32>(x_2048.z, x_2048.w));
  let x_2051 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2050.x, x_2050.y, x_2051.z, x_2051.w);
  let x_2058 : vec4<f32> = u_xlat1;
  let x_2061 : f32 = x_25.x_GlobalMipBias.x;
  let x_2062 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2058.x, x_2058.y), x_2061);
  u_xlat21 = x_2062.w;
  let x_2064 : f32 = u_xlat21;
  u_xlat21 = ((x_2064 * 2.0f) + -1.0f);
  let x_2067 : f32 = u_xlat21;
  u_xlatb1 = (x_2067 >= 0.0f);
  let x_2069 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2069);
  let x_2072 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2072)) + 1.0f);
  let x_2076 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2076);
  let x_2078 : f32 = u_xlat21;
  u_xlat21 = (-(x_2078) + 1.0f);
  let x_2081 : f32 = u_xlat21;
  let x_2083 : f32 = u_xlat1.x;
  u_xlat21 = (x_2081 * x_2083);
  let x_2085 : vec4<f32> = u_xlat0;
  let x_2087 : vec3<f32> = (vec3<f32>(x_2085.x, x_2085.y, x_2085.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2088 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2087.x, x_2087.y, x_2087.z, x_2088.w);
  let x_2090 : vec4<f32> = u_xlat0;
  let x_2092 : vec3<f32> = log2(vec3<f32>(x_2090.x, x_2090.y, x_2090.z));
  let x_2093 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2092.x, x_2092.y, x_2092.z, x_2093.w);
  let x_2095 : vec4<f32> = u_xlat2;
  let x_2097 : vec3<f32> = (vec3<f32>(x_2095.x, x_2095.y, x_2095.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2098 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2097.x, x_2097.y, x_2097.z, x_2098.w);
  let x_2100 : vec4<f32> = u_xlat2;
  let x_2102 : vec3<f32> = exp2(vec3<f32>(x_2100.x, x_2100.y, x_2100.z));
  let x_2103 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2102.x, x_2102.y, x_2102.z, x_2103.w);
  let x_2105 : vec4<f32> = u_xlat2;
  let x_2108 : vec3<f32> = ((vec3<f32>(x_2105.x, x_2105.y, x_2105.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2109 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2108.x, x_2108.y, x_2108.z, x_2109.w);
  let x_2111 : vec4<f32> = u_xlat0;
  let x_2113 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2111.x, x_2111.y, x_2111.z, x_2111.x));
  u_xlatb0 = vec3<bool>(x_2113.x, x_2113.y, x_2113.z);
  let x_2116 : bool = u_xlatb0.x;
  if (x_2116) {
    let x_2121 : f32 = u_xlat1.x;
    x_2117 = x_2121;
  } else {
    let x_2124 : f32 = u_xlat2.x;
    x_2117 = x_2124;
  }
  let x_2125 : f32 = x_2117;
  u_xlat0.x = x_2125;
  let x_2128 : bool = u_xlatb0.y;
  if (x_2128) {
    let x_2133 : f32 = u_xlat1.y;
    x_2129 = x_2133;
  } else {
    let x_2136 : f32 = u_xlat2.y;
    x_2129 = x_2136;
  }
  let x_2137 : f32 = x_2129;
  u_xlat0.y = x_2137;
  let x_2140 : bool = u_xlatb0.z;
  if (x_2140) {
    let x_2145 : f32 = u_xlat1.z;
    x_2141 = x_2145;
  } else {
    let x_2148 : f32 = u_xlat2.z;
    x_2141 = x_2148;
  }
  let x_2149 : f32 = x_2141;
  u_xlat0.z = x_2149;
  let x_2151 : f32 = u_xlat21;
  let x_2156 : vec4<f32> = u_xlat0;
  let x_2158 : vec3<f32> = ((vec3<f32>(x_2151, x_2151, x_2151) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2156.x, x_2156.y, x_2156.z));
  let x_2159 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2158.x, x_2158.y, x_2158.z, x_2159.w);
  let x_2161 : vec4<f32> = u_xlat0;
  let x_2163 : vec3<f32> = (vec3<f32>(x_2161.x, x_2161.y, x_2161.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2164 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2163.x, x_2163.y, x_2163.z, x_2164.w);
  let x_2166 : vec4<f32> = u_xlat0;
  let x_2168 : vec3<f32> = (vec3<f32>(x_2166.x, x_2166.y, x_2166.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2169 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2168.x, x_2168.y, x_2168.z, x_2169.w);
  let x_2171 : vec4<f32> = u_xlat2;
  let x_2173 : vec3<f32> = (vec3<f32>(x_2171.x, x_2171.y, x_2171.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2174 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2173.x, x_2173.y, x_2173.z, x_2174.w);
  let x_2176 : vec4<f32> = u_xlat2;
  let x_2179 : vec3<f32> = log2(abs(vec3<f32>(x_2176.x, x_2176.y, x_2176.z)));
  let x_2180 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2179.x, x_2179.y, x_2179.z, x_2180.w);
  let x_2182 : vec4<f32> = u_xlat2;
  let x_2184 : vec3<f32> = (vec3<f32>(x_2182.x, x_2182.y, x_2182.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2185 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2184.x, x_2184.y, x_2184.z, x_2185.w);
  let x_2187 : vec4<f32> = u_xlat2;
  let x_2189 : vec3<f32> = exp2(vec3<f32>(x_2187.x, x_2187.y, x_2187.z));
  let x_2190 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2189.x, x_2189.y, x_2189.z, x_2190.w);
  let x_2192 : vec4<f32> = u_xlat0;
  let x_2194 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2192.x, x_2192.y, x_2192.z, x_2192.x));
  u_xlatb0 = vec3<bool>(x_2194.x, x_2194.y, x_2194.z);
  let x_2197 : bool = u_xlatb0.x;
  if (x_2197) {
  ...
  u_xlat0.x = x_2206;
  let x_2209 : bool = u_xlatb0.y;
  if (x_2209) {
    let x_2214 : f32 = u_xlat1.y;
    x_2210 = x_2214;
  } else {
    let x_2217 : f32 = u_xlat2.y;
    x_2210 = x_2217;
  }
  let x_2218 : f32 = x_2210;
  u_xlat0.y = x_2218;
  let x_2221 : bool = u_xlatb0.z;
  if (x_2221) {
    let x_2226 : f32 = u_xlat1.z;
    x_2222 = x_2226;
  } else {
    let x_2229 : f32 = u_xlat2.z;
    x_2222 = x_2229;
  }
  let x_2230 : f32 = x_2222;
  u_xlat0.z = x_2230;
  let x_2234 : vec4<f32> = u_xlat0;
  let x_2236 : vec3<f32> = max(vec3<f32>(x_2234.x, x_2234.y, x_2234.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_2237 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_2236.x, x_2236.y, x_2236.z, x_2237.w);
  SV_Target0.w = 1.0f;
  return;
}
