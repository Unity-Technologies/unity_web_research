...
;
    ...
    u_xlat64 = dot(u_xlat4, vec4(4.0, 3.0, 2.0, 1.0));
    u_xlat64 = (-u_xlat64) + 4.0;
    u_xlatu64 = uint(u_xlat64);
    u_xlati64 = int(u_xlatu64) << (2 & int(0x1F));
    u_xlat3.xyz = vs_TEXCOORD7.yyy * _MainLightWorldToShadow[(u_xlati64 + 1) / 4][(u_xlati64 + 1) % 4].xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[u_xlati64 / 4][u_xlati64 % 4].xyz * vs_TEXCOORD7.xxx + u_xlat3.xyz;
    u_xlat3.xyz = _MainLightWorldToShadow[(u_xlati64 + 2) / 4][(u_xlati64 + 2) % 4].xyz * vs_TEXCOORD7.zzz + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat3.xyz + _MainLightWorldToShadow[(u_xlati64 + 3) / 4][(u_xlati64 + 3) % 4].xyz;
    ...
    u_xlat64 = dot(u_xlat1.xyz, u_xlat4.xyz);
    u_xlat64 = u_xlat64 + 0.5;
    u_xlat4.xyz = vec3(u_xlat64) * u_xlat6.xyz;
    u_xlat64 = max(u_xlat4.w, 9.99999975e-05);
    ...
    u_xlat9.xyz = u_xlat24.xxx * u_xlat9.xyz + u_xlat5.xyz;
    ...
    u_xlat3.xyz = vec3(u_xlat42) * u_xlat6.xyz;
    ...
    u_xlat65 = dot(_MainLightPosition.xyz, u_xlat6.xyz);
    u_xlat65 = clamp(u_xlat65, 0.0, 1.0);
    ...
    u_xlat6.xyz = u_xlat5.xyz * vec3(u_xlat42) + u_xlat7.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu42 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu67)].www + _AdditionalLightsPosition[int(u_xlatu67)].xyz;
        ...
        if(u_xlati70 != 0) {
            ...
            if(u_xlati71 != 0) {
                u_xlat11.xyz = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati72 + 1) / 4][(u_xlati72 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati72 / 4][u_xlati72 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati72 + 2) / 4][(u_xlati72 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat11.xyz;
                ...
                if(u_xlati70 != 0) {
                    u_xlat53.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati72 + 1) / 4][(u_xlati72 + 1) % 4].xy;
                    u_xlat53.xy = _AdditionalLightsWorldToLights[u_xlati72 / 4][u_xlati72 % 4].xy * vs_TEXCOORD7.xx + u_xlat53.xy;
                    u_xlat53.xy = _AdditionalLightsWorldToLights[(u_xlati72 + 2) / 4][(u_xlati72 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat53.xy;
                    ...
                    u_xlat12 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToLights[(u_xlati72 + 1) / 4][(u_xlati72 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati72 / 4][u_xlati72 % 4] * vs_TEXCOORD7.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati72 + 2) / 4][(u_xlati72 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat12;
        ...
        u_xlat67 = dot(u_xlat1.xyz, u_xlat10.xyz);
        u_xlat67 = clamp(u_xlat67, 0.0, 1.0);
        u_xlat67 = u_xlat67 * u_xlat48.x;
        u_xlat11.xyz = vec3(u_xlat67) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat69) + u_xlat2.xyz;
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat67) + u_xlat7.xyz;
