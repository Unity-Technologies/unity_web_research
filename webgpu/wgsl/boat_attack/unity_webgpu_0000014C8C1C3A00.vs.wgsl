...
@group(0) @binding(22) var x_TerrainNormalmapTexture : texture_2d<f32>;

@group(0) @binding(21) var x_TerrainHeightmapTexture : texture_2d<f32>;
...
@group(1) @binding(6) var<uniform> x_315 : VGlobals;
