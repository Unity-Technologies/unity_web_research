...
fn main_1() {
  ...
  let x_778 : vec3<f32> = vs_TEXCOORD5;
  let x_781 : vec4<f32> = u_xlat2;
  u_xlat2 = ((x_777 * vec4<f32>(x_778.z, x_778.z, x_778.z, x_778.z)) + x_781);
  ...
  let x_842 : vec4<f32> = x_22.x_LightColor0;
  let x_844 : vec3<f32> = (vec3<f32>(x_839.x, x_839.x, x_839.x) * vec3<f32>(x_842.x, x_842.y, x_842.z));
  let x_845 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_844.x, x_844.y, x_844.z, x_845.w);
  let x_847 : vec4<f32> = u_xlat2;
  let x_851 : vec4<f32> = x_22.x_SpecColor;
  let x_853 : vec3<f32> = (vec3<f32>(x_847.x, x_847.y, x_847.z) * vec3<f32>(x_851.x, x_851.y, x_851.z));
  ...
  let x_864 : f32 = u_xlat1.w;
  u_xlat14 = max(x_864, 0.0001f);
  let x_867 : vec4<f32> = u_xlat1;
  let x_869 : f32 = u_xlat14;
  ...
  let x_894 : vec3<f32> = ((vec3<f32>(x_887.x, x_887.y, x_887.z) * vec3<f32>(x_889.w, x_889.w, x_889.w)) + vec3<f32>(x_892.x, x_892.y, x_892.z));
