...
fn main_1() {
  ...
  let x_1408 : vec4<f32> = x_27.x_Dithering_Params;
  let x_1412 : vec4<f32> = x_27.x_Dithering_Params;
  ...
  let x_1426 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1422.x, x_1422.y), x_1425);
  u_xlat21 = x_1426.w;
  let x_1428 : f32 = u_xlat21;
  u_xlat21 = ((x_1428 * 2.0f) + -1.0f);
  let x_1431 : f32 = u_xlat21;
  u_xlatb1.x = (x_1431 >= 0.0f);
  let x_1435 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1435);
  let x_1438 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1438)) + 1.0f);
  let x_1442 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1442);
  let x_1444 : f32 = u_xlat21;
  u_xlat21 = (-(x_1444) + 1.0f);
  let x_1447 : f32 = u_xlat21;
  let x_1449 : f32 = u_xlat1.x;
  u_xlat21 = (x_1447 * x_1449);
  let x_1451 : vec3<f32> = u_xlat0;
  let x_1454 : vec3<f32> = (x_1451 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1455 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1454.x, x_1454.y, x_1454.z, x_1455.w);
  let x_1457 : vec3<f32> = u_xlat0;
  let x_1459 : vec3<f32> = log2(abs(x_1457));
  let x_1460 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1459.x, x_1459.y, x_1459.z, x_1460.w);
  let x_1462 : vec4<f32> = u_xlat2;
  let x_1466 : vec3<f32> = (vec3<f32>(x_1462.x, x_1462.y, x_1462.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_1467 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1466.x, x_1466.y, x_1466.z, x_1467.w);
  let x_1469 : vec4<f32> = u_xlat2;
  let x_1471 : vec3<f32> = exp2(vec3<f32>(x_1469.x, x_1469.y, x_1469.z));
  let x_1472 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1471.x, x_1471.y, x_1471.z, x_1472.w);
  let x_1474 : vec4<f32> = u_xlat2;
  let x_1481 : vec3<f32> = ((vec3<f32>(x_1474.x, x_1474.y, x_1474.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1482 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1481.x, x_1481.y, x_1481.z, x_1482.w);
  let x_1487 : vec3<f32> = u_xlat0;
  let x_1489 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1487.x, x_1487.y, x_1487.z, x_1487.x));
  ...
  u_xlat0.z = x_1525;
  let x_1527 : f32 = u_xlat21;
  let x_1532 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1527, x_1527, x_1527) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1532);
  let x_1534 : vec3<f32> = u_xlat0;
  let x_1537 : vec3<f32> = (x_1534 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1538 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1537.x, x_1537.y, x_1537.z, x_1538.w);
  let x_1540 : vec3<f32> = u_xlat0;
  let x_1543 : vec3<f32> = (x_1540 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1544 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1543.x, x_1543.y, x_1543.z, x_1544.w);
  let x_1546 : vec4<f32> = u_xlat2;
  let x_1550 : vec3<f32> = (vec3<f32>(x_1546.x, x_1546.y, x_1546.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1551 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1550.x, x_1550.y, x_1550.z, x_1551.w);
  let x_1553 : vec4<f32> = u_xlat2;
  let x_1556 : vec3<f32> = log2(abs(vec3<f32>(x_1553.x, x_1553.y, x_1553.z)));
  let x_1557 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1556.x, x_1556.y, x_1556.z, x_1557.w);
  let x_1559 : vec4<f32> = u_xlat2;
  let x_1563 : vec3<f32> = (vec3<f32>(x_1559.x, x_1559.y, x_1559.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_1564 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1563.x, x_1563.y, x_1563.z, x_1564.w);
  let x_1566 : vec4<f32> = u_xlat2;
  let x_1568 : vec3<f32> = exp2(vec3<f32>(x_1566.x, x_1566.y, x_1566.z));
  ...
  if (x_1580) {
    ...
    let x_1588 : f32 = u_xlat2.x;
    x_1581 = x_1588;
  }
  let x_1589 : f32 = x_1581;
  SV_Target0.x = x_1589;
  let x_1593 : bool = u_xlatb0.y;
  if (x_1593) {
    let x_1598 : f32 = u_xlat1.y;
    x_1594 = x_1598;
  } else {
    let x_1601 : f32 = u_xlat2.y;
    x_1594 = x_1601;
  }
  let x_1602 : f32 = x_1594;
  SV_Target0.y = x_1602;
  let x_1605 : bool = u_xlatb0.z;
  if (x_1605) {
