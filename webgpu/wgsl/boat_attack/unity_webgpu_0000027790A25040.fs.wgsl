...
fn main_1() {
  ...
  let x_2067 : vec3<f32> = sqrt(vec3<f32>(x_2065.x, x_2065.y, x_2065.z));
  let x_2068 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2067.x, x_2067.y, x_2067.z, x_2068.w);
  let x_2070 : vec2<f32> = vs_TEXCOORD0;
  let x_2073 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2077 : vec4<f32> = x_25.x_Dithering_Params;
  let x_2079 : vec2<f32> = ((x_2070 * vec2<f32>(x_2073.x, x_2073.y)) + vec2<f32>(x_2077.z, x_2077.w));
  let x_2080 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2079.x, x_2079.y, x_2080.z, x_2080.w);
  let x_2087 : vec4<f32> = u_xlat1;
  let x_2090 : f32 = x_25.x_GlobalMipBias.x;
  let x_2091 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_2087.x, x_2087.y), x_2090);
  u_xlat21 = x_2091.w;
  let x_2093 : f32 = u_xlat21;
  u_xlat21 = ((x_2093 * 2.0f) + -1.0f);
  let x_2096 : f32 = u_xlat21;
  u_xlatb1 = (x_2096 >= 0.0f);
  let x_2098 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_2098);
  let x_2101 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_2101)) + 1.0f);
  let x_2105 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_2105);
  let x_2107 : f32 = u_xlat21;
  u_xlat21 = (-(x_2107) + 1.0f);
  let x_2110 : f32 = u_xlat21;
  let x_2112 : f32 = u_xlat1.x;
  u_xlat21 = (x_2110 * x_2112);
  let x_2114 : vec4<f32> = u_xlat0;
  let x_2116 : vec3<f32> = (vec3<f32>(x_2114.x, x_2114.y, x_2114.z) * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_2117 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2116.x, x_2116.y, x_2116.z, x_2117.w);
  let x_2119 : vec4<f32> = u_xlat0;
  let x_2121 : vec3<f32> = log2(vec3<f32>(x_2119.x, x_2119.y, x_2119.z));
  let x_2122 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2121.x, x_2121.y, x_2121.z, x_2122.w);
  let x_2124 : vec4<f32> = u_xlat2;
  let x_2126 : vec3<f32> = (vec3<f32>(x_2124.x, x_2124.y, x_2124.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  let x_2127 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2126.x, x_2126.y, x_2126.z, x_2127.w);
  let x_2129 : vec4<f32> = u_xlat2;
  let x_2131 : vec3<f32> = exp2(vec3<f32>(x_2129.x, x_2129.y, x_2129.z));
  let x_2132 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2131.x, x_2131.y, x_2131.z, x_2132.w);
  let x_2134 : vec4<f32> = u_xlat2;
  let x_2137 : vec3<f32> = ((vec3<f32>(x_2134.x, x_2134.y, x_2134.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_2138 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2137.x, x_2137.y, x_2137.z, x_2138.w);
  let x_2140 : vec4<f32> = u_xlat0;
  let x_2142 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_2140.x, x_2140.y, x_2140.z, x_2140.x));
  u_xlatb0 = vec3<bool>(x_2142.x, x_2142.y, x_2142.z);
  let x_2145 : bool = u_xlatb0.x;
  if (x_2145) {
    let x_2150 : f32 = u_xlat1.x;
    x_2146 = x_2150;
  } else {
    let x_2153 : f32 = u_xlat2.x;
    x_2146 = x_2153;
  }
  let x_2154 : f32 = x_2146;
  u_xlat0.x = x_2154;
  let x_2157 : bool = u_xlatb0.y;
  if (x_2157) {
    let x_2162 : f32 = u_xlat1.y;
    x_2158 = x_2162;
  } else {
    let x_2165 : f32 = u_xlat2.y;
    x_2158 = x_2165;
  }
  let x_2166 : f32 = x_2158;
  u_xlat0.y = x_2166;
  let x_2169 : bool = u_xlatb0.z;
  if (x_2169) {
  ...
  u_xlat0.z = x_2178;
  let x_2180 : f32 = u_xlat21;
  let x_2185 : vec4<f32> = u_xlat0;
  let x_2187 : vec3<f32> = ((vec3<f32>(x_2180, x_2180, x_2180) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + vec3<f32>(x_2185.x, x_2185.y, x_2185.z));
  let x_2188 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_2187.x, x_2187.y, x_2187.z, x_2188.w);
  let x_2190 : vec4<f32> = u_xlat0;
  let x_2192 : vec3<f32> = (vec3<f32>(x_2190.x, x_2190.y, x_2190.z) * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_2193 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2192.x, x_2192.y, x_2192.z, x_2193.w);
  let x_2195 : vec4<f32> = u_xlat0;
  let x_2197 : vec3<f32> = (vec3<f32>(x_2195.x, x_2195.y, x_2195.z) + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_2198 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2197.x, x_2197.y, x_2197.z, x_2198.w);
  let x_2200 : vec4<f32> = u_xlat2;
  let x_2202 : vec3<f32> = (vec3<f32>(x_2200.x, x_2200.y, x_2200.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_2203 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2202.x, x_2202.y, x_2202.z, x_2203.w);
  let x_2205 : vec4<f32> = u_xlat2;
  let x_2208 : vec3<f32> = log2(abs(vec3<f32>(x_2205.x, x_2205.y, x_2205.z)));
  let x_2209 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2208.x, x_2208.y, x_2208.z, x_2209.w);
  let x_2211 : vec4<f32> = u_xlat2;
  let x_2213 : vec3<f32> = (vec3<f32>(x_2211.x, x_2211.y, x_2211.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  let x_2214 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2213.x, x_2213.y, x_2213.z, x_2214.w);
  let x_2216 : vec4<f32> = u_xlat2;
  let x_2218 : vec3<f32> = exp2(vec3<f32>(x_2216.x, x_2216.y, x_2216.z));
  let x_2219 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_2218.x, x_2218.y, x_2218.z, x_2219.w);
  let x_2221 : vec4<f32> = u_xlat0;
  let x_2223 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_2221.x, x_2221.y, x_2221.z, x_2221.x));
  u_xlatb0 = vec3<bool>(x_2223.x, x_2223.y, x_2223.z);
  let x_2226 : bool = u_xlatb0.x;
  if (x_2226) {
  ...
  u_xlat0.x = x_2235;
  let x_2238 : bool = u_xlatb0.y;
  if (x_2238) {
    let x_2243 : f32 = u_xlat1.y;
    x_2239 = x_2243;
  } else {
    let x_2246 : f32 = u_xlat2.y;
    x_2239 = x_2246;
  }
  let x_2247 : f32 = x_2239;
  u_xlat0.y = x_2247;
  let x_2250 : bool = u_xlatb0.z;
  if (x_2250) {
    let x_2255 : f32 = u_xlat1.z;
    x_2251 = x_2255;
  } else {
  ...
  let x_2265 : vec3<f32> = max(vec3<f32>(x_2263.x, x_2263.y, x_2263.z), vec3<f32>(0.0f, 0.0f, 0.0f));
