...
void main()
{
    ...
    u_xlat28.xyz = vec3(u_xlat75) * u_xlat28.xyz;
    ...
    u_xlat75 = dot(u_xlat28.xyz, u_xlat4.xyz);
    u_xlat75 = u_xlat75 + 0.5;
    u_xlat4.xyz = vec3(u_xlat75) * u_xlat6.xyz;
    ...
    u_xlat6.x = dot((-u_xlat5.xyz), u_xlat28.xyz);
    u_xlat6.x = u_xlat6.x + u_xlat6.x;
    u_xlat6.xyz = u_xlat28.xyz * (-u_xlat6.xxx) + (-u_xlat5.xyz);
    u_xlat81 = dot(u_xlat28.xyz, u_xlat5.xyz);
    ...
    u_xlat1.x = dot(u_xlat28.xyz, _MainLightPosition.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat80 = u_xlat80 * u_xlat83;
        u_xlat83 = dot(u_xlat28.xyz, u_xlat9.xyz);
        u_xlat83 = clamp(u_xlat83, 0.0, 1.0);
        u_xlat80 = u_xlat80 * u_xlat83;
        ...
        u_xlat79 = dot(u_xlat28.xyz, u_xlat8.xyz);
