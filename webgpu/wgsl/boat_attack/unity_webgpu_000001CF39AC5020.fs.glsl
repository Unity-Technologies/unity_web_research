...
;
    ...
    u_xlat15.xyz = (u_xlatb13.x) ? u_xlat15.xyz : u_xlat5.xyz;
    ...
    u_xlat37 = u_xlat4.y * u_xlat4.y;
    u_xlat37 = u_xlat4.x * u_xlat4.x + (-u_xlat37);
    ...
    u_xlat7.xyz = u_xlat4.xyz * (-vec3(u_xlat30)) + (-u_xlat15.xyz);
    ...
    u_xlat20.xyz = u_xlat15.xyz + _MainLightPosition.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu36 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat20.xyz = u_xlat20.xyz * vec3(u_xlat9) + u_xlat15.xyz;
        u_xlat3.x = dot(u_xlat20.xyz, u_xlat20.xyz);
        u_xlat3.x = max(u_xlat3.x, 1.17549435e-38);
        u_xlat3.x = inversesqrt(u_xlat3.x);
        u_xlat20.xyz = u_xlat3.xxx * u_xlat20.xyz;
        u_xlat3.x = dot(u_xlat4.xyz, u_xlat20.xyz);
        u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
