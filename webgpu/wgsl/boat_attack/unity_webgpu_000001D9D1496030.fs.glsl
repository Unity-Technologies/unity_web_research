...
void main()
{
    ...
    u_xlat48 = max(u_xlat0.w, 9.99999975e-05);
    ...
    if(u_xlatb48){
        ...
        if(u_xlatb48){
            ...
            u_xlat3.y = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec1, 0.0);
            u_xlat2 = vs_TEXCOORD4.xyxy + _MainLightShadowOffset1;
            vec3 txVec2 = vec3(u_xlat2.xy,vs_TEXCOORD4.z);
            u_xlat3.z = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec2, 0.0);
            vec3 txVec3 = vec3(u_xlat2.zw,vs_TEXCOORD4.z);
            u_xlat3.w = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec3, 0.0);
            ...
            if(u_xlatb2){
                ...
                u_xlat18 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec4, 0.0);
                vec3 txVec5 = vec3(u_xlat6.zw,vs_TEXCOORD4.z);
                u_xlat3.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec5, 0.0);
                u_xlat3.x = u_xlat3.x * u_xlat9.y;
                u_xlat18 = u_xlat9.x * u_xlat18 + u_xlat3.x;
                vec3 txVec6 = vec3(u_xlat34.xy,vs_TEXCOORD4.z);
                u_xlat34.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec6, 0.0);
                u_xlat18 = u_xlat9.z * u_xlat34.x + u_xlat18;
                vec3 txVec7 = vec3(u_xlat5.xy,vs_TEXCOORD4.z);
                u_xlat34.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec7, 0.0);
                u_xlat18 = u_xlat9.w * u_xlat34.x + u_xlat18;
                vec3 txVec8 = vec3(u_xlat7.xy,vs_TEXCOORD4.z);
                u_xlat34.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec8, 0.0);
                u_xlat18 = u_xlat10.x * u_xlat34.x + u_xlat18;
                vec3 txVec9 = vec3(u_xlat7.zw,vs_TEXCOORD4.z);
                u_xlat34.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec9, 0.0);
                u_xlat18 = u_xlat10.y * u_xlat34.x + u_xlat18;
                vec3 txVec10 = vec3(u_xlat5.zw,vs_TEXCOORD4.z);
                u_xlat34.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec10, 0.0);
                u_xlat18 = u_xlat10.z * u_xlat34.x + u_xlat18;
                vec3 txVec11 = vec3(u_xlat4.xy,vs_TEXCOORD4.z);
                u_xlat34.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec11, 0.0);
                u_xlat18 = u_xlat10.w * u_xlat34.x + u_xlat18;
                vec3 txVec12 = vec3(u_xlat4.zw,vs_TEXCOORD4.z);
                u_xlat34.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec12, 0.0);
                ...
                u_xlat4.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec13, 0.0);
                vec3 txVec14 = vec3(u_xlat8.zw,vs_TEXCOORD4.z);
                u_xlat52 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec14, 0.0);
                u_xlat52 = u_xlat52 * u_xlat13.y;
                u_xlat4.x = u_xlat13.x * u_xlat4.x + u_xlat52;
                vec3 txVec15 = vec3(u_xlat34.xy,vs_TEXCOORD4.z);
                u_xlat34.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec15, 0.0);
                u_xlat34.x = u_xlat13.z * u_xlat34.x + u_xlat4.x;
                vec3 txVec16 = vec3(u_xlat11.xy,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec16, 0.0);
                u_xlat34.x = u_xlat13.w * u_xlat50 + u_xlat34.x;
                vec3 txVec17 = vec3(u_xlat9.xy,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec17, 0.0);
                u_xlat34.x = u_xlat14.x * u_xlat50 + u_xlat34.x;
                vec3 txVec18 = vec3(u_xlat9.zw,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec18, 0.0);
                u_xlat34.x = u_xlat14.y * u_xlat50 + u_xlat34.x;
                vec3 txVec19 = vec3(u_xlat10.xy,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec19, 0.0);
                u_xlat34.x = u_xlat14.z * u_xlat50 + u_xlat34.x;
                vec3 txVec20 = vec3(u_xlat11.zw,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec20, 0.0);
                u_xlat34.x = u_xlat14.w * u_xlat50 + u_xlat34.x;
                vec3 txVec21 = vec3(u_xlat12.xy,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec21, 0.0);
                u_xlat34.x = u_xlat15.x * u_xlat50 + u_xlat34.x;
                vec3 txVec22 = vec3(u_xlat12.zw,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec22, 0.0);
                u_xlat34.x = u_xlat15.y * u_xlat50 + u_xlat34.x;
                vec3 txVec23 = vec3(u_xlat20.xy,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec23, 0.0);
                u_xlat34.x = u_xlat15.z * u_xlat50 + u_xlat34.x;
                vec3 txVec24 = vec3(u_xlat42.xy,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec24, 0.0);
                u_xlat34.x = u_xlat15.w * u_xlat50 + u_xlat34.x;
                vec3 txVec25 = vec3(u_xlat7.xy,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec25, 0.0);
                u_xlat34.x = u_xlat3.x * u_xlat50 + u_xlat34.x;
                vec3 txVec26 = vec3(u_xlat7.zw,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec26, 0.0);
                u_xlat34.x = u_xlat3.y * u_xlat50 + u_xlat34.x;
                vec3 txVec27 = vec3(u_xlat37.xy,vs_TEXCOORD4.z);
                u_xlat50 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec27, 0.0);
                u_xlat34.x = u_xlat3.z * u_xlat50 + u_xlat34.x;
                vec3 txVec28 = vec3(u_xlat2.xy,vs_TEXCOORD4.z);
                u_xlat2.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec28, 0.0);
                u_xlat48 = u_xlat3.w * u_xlat2.x + u_xlat34.x;
            }
        }
    } else {
        vec3 txVec29 = vec3(vs_TEXCOORD4.xy,vs_TEXCOORD4.z);
        u_xlat48 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec29, 0.0);
    }
