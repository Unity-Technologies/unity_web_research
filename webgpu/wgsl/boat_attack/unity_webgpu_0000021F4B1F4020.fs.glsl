...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat19 = u_xlat46 * u_xlat46;
    u_xlat45 = u_xlat45 + 1.0;
    u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
    u_xlat47 = u_xlat46 * 4.0 + 2.0;
    ...
    u_xlat6.x = (u_xlatb20.x) ? 1.0 : u_xlat6.x;
    ...
    u_xlat6.x = u_xlat20.x * u_xlat34 + u_xlat6.x;
    ...
    u_xlat49 = u_xlat49 * u_xlat49;
    u_xlat8.x = (-u_xlat44) * 0.699999988 + 1.70000005;
    u_xlat44 = u_xlat44 * u_xlat8.x;
    u_xlat44 = u_xlat44 * 6.0;
    u_xlat8 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat7.xyz, u_xlat44);
    ...
    u_xlat7.xyz = u_xlat8.xyz * vec3(u_xlat44);
    ...
    u_xlat44 = u_xlat6.x * unity_LightData.z;
    u_xlat45 = dot(u_xlat3.xyz, _MainLightPosition.xyz);
    u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
    u_xlat44 = u_xlat44 * u_xlat45;
    u_xlat6.xyz = vec3(u_xlat44) * u_xlat20.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu44 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu46)].www + _AdditionalLightsPosition[int(u_xlatu46)].xyz;
        ...
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat35) + u_xlat2.xyz;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat46) + u_xlat15.xyz;
