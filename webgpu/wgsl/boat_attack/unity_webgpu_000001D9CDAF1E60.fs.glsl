...
void main()
{
    ...
    u_xlat5.x = (u_xlatb78) ? u_xlat1.x : unity_MatrixV[0].z;
    u_xlat5.y = (u_xlatb78) ? u_xlat1.y : unity_MatrixV[1].z;
    u_xlat5.z = (u_xlatb78) ? u_xlat1.w : unity_MatrixV[2].z;
    u_xlat4.w = 1.0;
    ...
    u_xlat1.xyw = unity_SHC.xyz * vec3(u_xlat78) + u_xlat8.xyz;
    u_xlat1.xyw = u_xlat1.xyw + u_xlat6.xyz;
    u_xlat1.xyw = max(u_xlat1.xyw, vec3(0.0, 0.0, 0.0));
    u_xlat3.xy = u_xlat3.xy;
    u_xlat3.xy = clamp(u_xlat3.xy, 0.0, 1.0);
    u_xlat78 = (-u_xlat3.x) * 0.959999979 + 0.959999979;
    u_xlat80 = (-u_xlat78) + u_xlat3.y;
    ...
    u_xlat78 = (-u_xlat3.y) + 1.0;
    u_xlat3.x = u_xlat78 * u_xlat78;
    ...
    u_xlatb84 = vs_INTERP3.z>=1.0;
    u_xlatb83 = u_xlatb83 || u_xlatb84;
    u_xlat82 = (u_xlatb83) ? 1.0 : u_xlat82;
    u_xlat7.xyz = vs_INTERP7.xyz + (-_WorldSpaceCameraPos.xyz);
    u_xlat83 = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat84 = u_xlat83 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
    u_xlat7.x = (-u_xlat82) + 1.0;
    u_xlat82 = u_xlat84 * u_xlat7.x + u_xlat82;
    ...
    u_xlat34.xyz = u_xlat0.xyz * vec3(u_xlat78) + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat34.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat85 = u_xlat80 * u_xlat87 + u_xlat85;
        u_xlat83 = u_xlat83 * u_xlat85;
        ...
        u_xlat82 = u_xlat29 / u_xlat82;
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat82) + u_xlat6.xyz;
        u_xlat34.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat34.xyz;
    }
    u_xlat0.xyz = u_xlat1.xyw * vec3(u_xlat55) + u_xlat7.xyz;
    u_xlat0.xyz = u_xlat34.xyz + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat2.xyz * vec3(u_xlat53) + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
