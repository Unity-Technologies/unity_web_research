...
;
    ...
    u_xlat41 = u_xlat6.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat6.z = (-u_xlat41) + 1.0;
    ...
    u_xlat14.x = dot(u_xlat19.xyz, u_xlat19.xyz);
    ...
    if(u_xlatb14.x){
        ...
        u_xlat19.xyz = (u_xlatb14.x) ? u_xlat7.xyz : u_xlat27.xxx;
    } else {
    ...
    u_xlat19.xyz = u_xlat6.xxx * u_xlat19.xyz;
    u_xlat14.x = dot((-u_xlat5.xyz), u_xlat13.xyz);
    u_xlat14.x = u_xlat14.x + u_xlat14.x;
    u_xlat7.xyz = u_xlat13.xyz * (-u_xlat14.xxx) + (-u_xlat5.xyz);
    ...
    u_xlat27.xy = vec2(u_xlat41) * vec2(u_xlat41) + vec2(-1.0, 1.0);
    u_xlat40 = float(1.0) / u_xlat27.y;
    u_xlat8.xyz = (-u_xlat2.xyz) + u_xlat0.xxx;
    u_xlat8.xyz = u_xlat14.xxx * u_xlat8.xyz + u_xlat2.xyz;
    ...
    u_xlat1.xyw = u_xlat0.xxx * u_xlat19.xyz;
    ...
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat41 = dot(_MainLightPosition.xyz, u_xlat19.xyz);
    ...
    u_xlat19.xyz = u_xlat2.xyz * u_xlat0.xxx + u_xlat3.xyz;
    u_xlat1.xyw = u_xlat1.xyw * u_xlat19.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_INTERP0.xyz) * _AdditionalLightsPosition[int(u_xlatu45)].www + _AdditionalLightsPosition[int(u_xlatu45)].xyz;
        ...
        if(u_xlati48 != 0) {
            ...
            if(u_xlati10 != 0) {
                u_xlat10.xzw = vs_INTERP0.yyy * _AdditionalLightsWorldToLights[(u_xlati23 + 1) / 4][(u_xlati23 + 1) % 4].xyw;
                u_xlat10.xzw = _AdditionalLightsWorldToLights[u_xlati23 / 4][u_xlati23 % 4].xyw * vs_INTERP0.xxx + u_xlat10.xzw;
                u_xlat10.xzw = _AdditionalLightsWorldToLights[(u_xlati23 + 2) / 4][(u_xlati23 + 2) % 4].xyw * vs_INTERP0.zzz + u_xlat10.xzw;
                ...
                if(u_xlati48 != 0) {
                    u_xlat11.xy = vs_INTERP0.yy * _AdditionalLightsWorldToLights[(u_xlati23 + 1) / 4][(u_xlati23 + 1) % 4].xy;
                    u_xlat11.xy = _AdditionalLightsWorldToLights[u_xlati23 / 4][u_xlati23 % 4].xy * vs_INTERP0.xx + u_xlat11.xy;
                    u_xlat11.xy = _AdditionalLightsWorldToLights[(u_xlati23 + 2) / 4][(u_xlati23 + 2) % 4].xy * vs_INTERP0.zz + u_xlat11.xy;
                    ...
                    u_xlat11 = vs_INTERP0.yyyy * _AdditionalLightsWorldToLights[(u_xlati23 + 1) / 4][(u_xlati23 + 1) % 4];
                    u_xlat11 = _AdditionalLightsWorldToLights[u_xlati23 / 4][u_xlati23 % 4] * vs_INTERP0.xxxx + u_xlat11;
                    u_xlat11 = _AdditionalLightsWorldToLights[(u_xlati23 + 2) / 4][(u_xlati23 + 2) % 4] * vs_INTERP0.zzzz + u_xlat11;
            ...
            u_xlat48 = (u_xlatb19.y) ? u_xlat10.w : u_xlat10.x;
            u_xlat10.xyz = (u_xlatb19.x) ? u_xlat10.xyz : vec3(u_xlat48);
        } else {
        ...
        u_xlat45 = dot(u_xlat13.xyz, u_xlat8.xyz);
        u_xlat45 = clamp(u_xlat45, 0.0, 1.0);
        u_xlat46 = dot(u_xlat9.xyz, u_xlat8.xyz);
        u_xlat46 = clamp(u_xlat46, 0.0, 1.0);
        u_xlat45 = u_xlat45 * u_xlat45;
        u_xlat45 = u_xlat45 * u_xlat27.x + 1.00001001;
        u_xlat46 = u_xlat46 * u_xlat46;
        u_xlat45 = u_xlat45 * u_xlat45;
        ...
        u_xlat8.xyz = u_xlat2.xyz * vec3(u_xlat45) + u_xlat3.xyz;
        u_xlat7.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat7.xyz;
    }
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat44) + u_xlat1.xyw;
