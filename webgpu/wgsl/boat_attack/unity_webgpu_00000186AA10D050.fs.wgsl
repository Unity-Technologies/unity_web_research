...
fn main_1() {
  ...
  let x_1076 : vec3<f32> = (x_1075 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1077 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1076.x, x_1076.y, x_1076.z, x_1077.w);
  let x_1079 : vec3<f32> = u_xlat0;
  let x_1081 : vec3<f32> = log2(abs(x_1079));
  let x_1082 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1081.x, x_1081.y, x_1081.z, x_1082.w);
  let x_1084 : vec4<f32> = u_xlat2;
  let x_1086 : vec3<f32> = (vec3<f32>(x_1084.x, x_1084.y, x_1084.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1097 : vec3<f32> = ((vec3<f32>(x_1094.x, x_1094.y, x_1094.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1098 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1097.x, x_1097.y, x_1097.z, x_1098.w);
  let x_1101 : vec3<f32> = u_xlat0;
  let x_1103 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1101.x, x_1101.y, x_1101.z, x_1101.x));
  ...
  if (x_1130) {
    ...
    let x_1138 : f32 = u_xlat2.z;
    x_1131 = x_1138;
  }
  let x_1139 : f32 = x_1131;
  u_xlat0.z = x_1139;
  let x_1141 : vec2<f32> = vs_TEXCOORD0;
  let x_1144 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1148 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1150 : vec2<f32> = ((x_1141 * vec2<f32>(x_1144.x, x_1144.y)) + vec2<f32>(x_1148.z, x_1148.w));
  let x_1151 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1150.x, x_1150.y, x_1151.z, x_1151.w);
  let x_1158 : vec4<f32> = u_xlat1;
  let x_1161 : f32 = x_26.x_GlobalMipBias.x;
  let x_1162 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1158.x, x_1158.y), x_1161);
  u_xlat21 = x_1162.w;
  let x_1164 : f32 = u_xlat21;
  u_xlat21 = ((x_1164 * 2.0f) + -1.0f);
  let x_1168 : f32 = u_xlat21;
  u_xlatb1.x = (x_1168 >= 0.0f);
  let x_1172 : bool = u_xlatb1.x;
  u_xlat1.x = select(-1.0f, 1.0f, x_1172);
  let x_1175 : f32 = u_xlat21;
  u_xlat21 = (-(abs(x_1175)) + 1.0f);
  let x_1179 : f32 = u_xlat21;
  u_xlat21 = sqrt(x_1179);
  let x_1181 : f32 = u_xlat21;
  u_xlat21 = (-(x_1181) + 1.0f);
  let x_1184 : f32 = u_xlat21;
  let x_1186 : f32 = u_xlat1.x;
  u_xlat21 = (x_1184 * x_1186);
  let x_1188 : vec3<f32> = u_xlat0;
  let x_1189 : vec3<f32> = (x_1188 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1190 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1189.x, x_1189.y, x_1189.z, x_1190.w);
  let x_1192 : vec3<f32> = u_xlat0;
  let x_1194 : vec3<f32> = log2(abs(x_1192));
  let x_1195 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1194.x, x_1194.y, x_1194.z, x_1195.w);
  let x_1197 : vec4<f32> = u_xlat2;
  let x_1199 : vec3<f32> = (vec3<f32>(x_1197.x, x_1197.y, x_1197.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1210 : vec3<f32> = ((vec3<f32>(x_1207.x, x_1207.y, x_1207.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1211 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1210.x, x_1210.y, x_1210.z, x_1211.w);
  let x_1213 : vec3<f32> = u_xlat0;
  let x_1215 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1213.x, x_1213.y, x_1213.z, x_1213.x));
  u_xlatb0 = vec3<bool>(x_1215.x, x_1215.y, x_1215.z);
  let x_1218 : bool = u_xlatb0.x;
  if (x_1218) {
  ...
  u_xlat0.x = x_1303;
  let x_1306 : bool = u_xlatb0.y;
  if (x_1306) {
    let x_1311 : f32 = u_xlat1.y;
    x_1307 = x_1311;
  } else {
    let x_1314 : f32 = u_xlat2.y;
    x_1307 = x_1314;
  }
  let x_1315 : f32 = x_1307;
  u_xlat0.y = x_1315;
  let x_1318 : bool = u_xlatb0.z;
  if (x_1318) {
    let x_1323 : f32 = u_xlat1.z;
    x_1319 = x_1323;
  } else {
  ...
  let x_1332 : vec3<f32> = max(x_1331, vec3<f32>(0.0f, 0.0f, 0.0f));
