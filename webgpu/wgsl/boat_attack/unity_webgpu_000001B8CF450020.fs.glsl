...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat4.xyz = vec3(u_xlat66) * vs_TEXCOORD2.xyz;
...
;
    ...
    u_xlat66 = vs_TEXCOORD1.y * unity_MatrixV[1].z;
    u_xlat66 = unity_MatrixV[0].z * vs_TEXCOORD1.x + u_xlat66;
    u_xlat66 = unity_MatrixV[2].z * vs_TEXCOORD1.z + u_xlat66;
    ...
    u_xlat68 = u_xlat4.y * u_xlat4.y;
    u_xlat68 = u_xlat4.x * u_xlat4.x + (-u_xlat68);
    u_xlat7.xyz = unity_SHC.xyz * vec3(u_xlat68) + u_xlat8.xyz;
    ...
    if(u_xlatb51){
        ...
        if(u_xlatb51){
            ...
            u_xlat51.x = dot(u_xlat9, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb73){
                ...
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec4, 0.0);
                vec3 txVec5 = vec3(u_xlat12.zw,u_xlat5.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec5, 0.0);
                u_xlat30 = u_xlat30 * u_xlat15.y;
                u_xlat8.x = u_xlat15.x * u_xlat8.x + u_xlat30;
                vec3 txVec6 = vec3(u_xlat52.xy,u_xlat5.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec6, 0.0);
                u_xlat8.x = u_xlat15.z * u_xlat30 + u_xlat8.x;
                vec3 txVec7 = vec3(u_xlat11.xy,u_xlat5.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec7, 0.0);
                u_xlat8.x = u_xlat15.w * u_xlat30 + u_xlat8.x;
                vec3 txVec8 = vec3(u_xlat13.xy,u_xlat5.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec8, 0.0);
                u_xlat8.x = u_xlat16.x * u_xlat30 + u_xlat8.x;
                vec3 txVec9 = vec3(u_xlat13.zw,u_xlat5.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec9, 0.0);
                u_xlat8.x = u_xlat16.y * u_xlat30 + u_xlat8.x;
                vec3 txVec10 = vec3(u_xlat11.zw,u_xlat5.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec10, 0.0);
                u_xlat8.x = u_xlat16.z * u_xlat30 + u_xlat8.x;
                vec3 txVec11 = vec3(u_xlat10.xy,u_xlat5.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec11, 0.0);
                u_xlat8.x = u_xlat16.w * u_xlat30 + u_xlat8.x;
                vec3 txVec12 = vec3(u_xlat10.zw,u_xlat5.z);
                u_xlat30 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec12, 0.0);
                u_xlat51.x = u_xlat73 * u_xlat30 + u_xlat8.x;
            } else {
                u_xlat8.xy = u_xlat5.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat8.xy = floor(u_xlat8.xy);
                u_xlat52.xy = u_xlat5.xy * _MainLightShadowmapSize.zw + (-u_xlat8.xy);
                ...
                u_xlat73 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec13, 0.0);
                ...
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec15, 0.0);
                u_xlat73 = u_xlat19.z * u_xlat52.x + u_xlat73;
                vec3 txVec16 = vec3(u_xlat17.xy,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec16, 0.0);
                u_xlat73 = u_xlat19.w * u_xlat52.x + u_xlat73;
                vec3 txVec17 = vec3(u_xlat15.xy,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec17, 0.0);
                u_xlat73 = u_xlat20.x * u_xlat52.x + u_xlat73;
                vec3 txVec18 = vec3(u_xlat15.zw,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec18, 0.0);
                u_xlat73 = u_xlat20.y * u_xlat52.x + u_xlat73;
                vec3 txVec19 = vec3(u_xlat16.xy,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec19, 0.0);
                u_xlat73 = u_xlat20.z * u_xlat52.x + u_xlat73;
                vec3 txVec20 = vec3(u_xlat17.zw,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec20, 0.0);
                u_xlat73 = u_xlat20.w * u_xlat52.x + u_xlat73;
                vec3 txVec21 = vec3(u_xlat18.xy,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec21, 0.0);
                u_xlat73 = u_xlat21.x * u_xlat52.x + u_xlat73;
                vec3 txVec22 = vec3(u_xlat18.zw,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec22, 0.0);
                u_xlat73 = u_xlat21.y * u_xlat52.x + u_xlat73;
                vec3 txVec23 = vec3(u_xlat32.xy,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat73 = u_xlat21.z * u_xlat52.x + u_xlat73;
                vec3 txVec24 = vec3(u_xlat60.xy,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec24, 0.0);
                u_xlat73 = u_xlat21.w * u_xlat52.x + u_xlat73;
                vec3 txVec25 = vec3(u_xlat13.xy,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec25, 0.0);
                u_xlat73 = u_xlat9.x * u_xlat52.x + u_xlat73;
                vec3 txVec26 = vec3(u_xlat13.zw,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec26, 0.0);
                u_xlat73 = u_xlat9.y * u_xlat52.x + u_xlat73;
                vec3 txVec27 = vec3(u_xlat55.xy,u_xlat5.z);
                u_xlat52.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
                u_xlat73 = u_xlat9.z * u_xlat52.x + u_xlat73;
                vec3 txVec28 = vec3(u_xlat8.xy,u_xlat5.z);
                u_xlat8.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec28, 0.0);
                u_xlat51.x = u_xlat9.w * u_xlat8.x + u_xlat73;
            }
        }
    } else {
        vec3 txVec29 = vec3(u_xlat5.xy,u_xlat5.z);
        u_xlat51.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat5.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat5.x = u_xlat51.x * _MainLightShadowParams.x + u_xlat5.x;
    ...
    if(u_xlatb27.x){
        ...
        u_xlat8.xyz = (u_xlatb27.x) ? u_xlat8.xyz : vec3(u_xlat49);
    } else {
        u_xlat8.x = float(1.0);
        u_xlat8.y = float(1.0);
        u_xlat8.z = float(1.0);
    ...
    u_xlat9.xyz = u_xlat4.xyz * (-u_xlat27.xxx) + (-u_xlat3.xyz);
    u_xlat27.x = dot(u_xlat4.xyz, u_xlat3.xyz);
    u_xlat27.x = clamp(u_xlat27.x, 0.0, 1.0);
    u_xlat27.x = (-u_xlat27.x) + 1.0;
    u_xlat27.x = u_xlat27.x * u_xlat27.x;
    u_xlat27.x = u_xlat27.x * u_xlat27.x;
    u_xlat49 = (-u_xlat68) * 0.699999988 + 1.70000005;
    u_xlat68 = u_xlat68 * u_xlat49;
    u_xlat68 = u_xlat68 * 6.0;
    u_xlat9 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat9.xyz, u_xlat68);
    ...
    u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat68);
    u_xlat51.xy = vec2(u_xlat70) * vec2(u_xlat70) + vec2(-1.0, 1.0);
    u_xlat68 = float(1.0) / u_xlat51.y;
    u_xlat10.xyz = (-u_xlat0.xyz) + vec3(u_xlat69);
    u_xlat10.xyz = u_xlat27.xxx * u_xlat10.xyz + u_xlat0.xyz;
    u_xlat10.xyz = vec3(u_xlat68) * u_xlat10.xyz;
    u_xlat9.xyz = u_xlat9.xyz * u_xlat10.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat23.xyz + u_xlat9.xyz;
    u_xlat68 = u_xlat5.x * unity_LightData.z;
    u_xlat69 = dot(u_xlat4.xyz, _MainLightPosition.xyz);
    u_xlat69 = clamp(u_xlat69, 0.0, 1.0);
    u_xlat68 = u_xlat68 * u_xlat69;
    u_xlat5.xyz = vec3(u_xlat68) * u_xlat8.xyz;
    ...
    u_xlat68 = u_xlat68 * u_xlat51.x + 1.00001001;
    ...
    u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat68) + u_xlat23.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu68 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat70 = dot(unity_LightIndices[int(u_xlatu70)], uintBitsToFloat(ImmCB_0[u_xlati73]));
        u_xlatu70 =  uint(int(u_xlat70));
        u_xlat10.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[int(u_xlatu70)].www + _AdditionalLightsPosition[int(u_xlatu70)].xyz;
        u_xlat73 = dot(u_xlat10.xyz, u_xlat10.xyz);
        u_xlat73 = max(u_xlat73, 6.10351562e-05);
        u_xlat52.x = inversesqrt(u_xlat73);
        u_xlat11.xyz = u_xlat52.xxx * u_xlat10.xyz;
        u_xlat74 = float(1.0) / float(u_xlat73);
        u_xlat73 = u_xlat73 * _AdditionalLightsAttenuation[int(u_xlatu70)].x;
        u_xlat73 = (-u_xlat73) * u_xlat73 + 1.0;
        u_xlat73 = max(u_xlat73, 0.0);
        u_xlat73 = u_xlat73 * u_xlat73;
        u_xlat73 = u_xlat73 * u_xlat74;
        u_xlat74 = dot(_AdditionalLightsSpotDir[int(u_xlatu70)].xyz, u_xlat11.xyz);
        ...
        u_xlati75 = 1 << (int(u_xlatu70) & int(0x1F));
        ...
        if(u_xlati74 != 0) {
            ...
            u_xlati76 = int(u_xlatu70) << (2 & int(0x1F));
            if(u_xlati75 != 0) {
                u_xlat12.xyz = vs_TEXCOORD1.yyy * _AdditionalLightsWorldToLights[(u_xlati76 + 1) / 4][(u_xlati76 + 1) % 4].xyw;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[u_xlati76 / 4][u_xlati76 % 4].xyw * vs_TEXCOORD1.xxx + u_xlat12.xyz;
                u_xlat12.xyz = _AdditionalLightsWorldToLights[(u_xlati76 + 2) / 4][(u_xlati76 + 2) % 4].xyw * vs_TEXCOORD1.zzz + u_xlat12.xyz;
                u_xlat12.xyz = u_xlat12.xyz + _AdditionalLightsWorldToLights[(u_xlati76 + 3) / 4][(u_xlati76 + 3) % 4].xyw;
                u_xlat12.xy = u_xlat12.xy / u_xlat12.zz;
                u_xlat12.xy = u_xlat12.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat12.xy = clamp(u_xlat12.xy, 0.0, 1.0);
                u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu70)].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu70)].zw;
            } else {
                u_xlatb74 = u_xlati74==1;
                u_xlati74 = u_xlatb74 ? 1 : int(0);
                if(u_xlati74 != 0) {
                    u_xlat56.xy = vs_TEXCOORD1.yy * _AdditionalLightsWorldToLights[(u_xlati76 + 1) / 4][(u_xlati76 + 1) % 4].xy;
                    u_xlat56.xy = _AdditionalLightsWorldToLights[u_xlati76 / 4][u_xlati76 % 4].xy * vs_TEXCOORD1.xx + u_xlat56.xy;
                    u_xlat56.xy = _AdditionalLightsWorldToLights[(u_xlati76 + 2) / 4][(u_xlati76 + 2) % 4].xy * vs_TEXCOORD1.zz + u_xlat56.xy;
                    u_xlat56.xy = u_xlat56.xy + _AdditionalLightsWorldToLights[(u_xlati76 + 3) / 4][(u_xlati76 + 3) % 4].xy;
                    u_xlat56.xy = u_xlat56.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat56.xy = fract(u_xlat56.xy);
                    u_xlat12.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu70)].xy * u_xlat56.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu70)].zw;
                } else {
                    u_xlat13 = vs_TEXCOORD1.yyyy * _AdditionalLightsWorldToLights[(u_xlati76 + 1) / 4][(u_xlati76 + 1) % 4];
                    u_xlat13 = _AdditionalLightsWorldToLights[u_xlati76 / 4][u_xlati76 % 4] * vs_TEXCOORD1.xxxx + u_xlat13;
                    u_xlat13 = _AdditionalLightsWorldToLights[(u_xlati76 + 2) / 4][(u_xlati76 + 2) % 4] * vs_TEXCOORD1.zzzz + u_xlat13;
                    u_xlat13 = u_xlat13 + _AdditionalLightsWorldToLights[(u_xlati76 + 3) / 4][(u_xlati76 + 3) % 4];
                    u_xlat13.xyz = u_xlat13.xyz / u_xlat13.www;
                    u_xlat74 = dot(u_xlat13.xyz, u_xlat13.xyz);
                    u_xlat74 = inversesqrt(u_xlat74);
                    u_xlat13.xyz = vec3(u_xlat74) * u_xlat13.xyz;
                    u_xlat74 = dot(abs(u_xlat13.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat74 = max(u_xlat74, 9.99999997e-07);
                    u_xlat74 = float(1.0) / float(u_xlat74);
                    u_xlat14.xyz = vec3(u_xlat74) * u_xlat13.zxy;
                    ...
                    u_xlat56.xy = u_xlat13.xy * vec2(u_xlat74) + u_xlat56.xy;
                    u_xlat56.xy = u_xlat56.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
            ...
            u_xlat74 = (u_xlatb8.y) ? u_xlat12.w : u_xlat12.x;
            u_xlat12.xyz = (u_xlatb8.x) ? u_xlat12.xyz : vec3(u_xlat74);
        } else {
            u_xlat12.x = float(1.0);
            u_xlat12.y = float(1.0);
            u_xlat12.z = float(1.0);
        }
        u_xlat12.xyz = u_xlat12.xyz * _AdditionalLightsColor[int(u_xlatu70)].xyz;
        u_xlat12.xyz = vec3(u_xlat29) * u_xlat12.xyz;
        u_xlat70 = dot(u_xlat4.xyz, u_xlat11.xyz);
        u_xlat70 = clamp(u_xlat70, 0.0, 1.0);
        u_xlat70 = u_xlat70 * u_xlat73;
        u_xlat12.xyz = vec3(u_xlat70) * u_xlat12.xyz;
        u_xlat10.xyz = u_xlat10.xyz * u_xlat52.xxx + u_xlat3.xyz;
        ...
        u_xlat70 = clamp(u_xlat70, 0.0, 1.0);
        u_xlat73 = dot(u_xlat11.xyz, u_xlat10.xyz);
        u_xlat73 = clamp(u_xlat73, 0.0, 1.0);
        u_xlat70 = u_xlat70 * u_xlat70;
        u_xlat70 = u_xlat70 * u_xlat51.x + 1.00001001;
        u_xlat73 = u_xlat73 * u_xlat73;
        u_xlat70 = u_xlat70 * u_xlat70;
        ...
        u_xlat10.xyz = u_xlat0.xyz * vec3(u_xlat70) + u_xlat23.xyz;
