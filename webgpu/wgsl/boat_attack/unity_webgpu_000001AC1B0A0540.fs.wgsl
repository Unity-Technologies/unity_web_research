...
fn main_1() {
  ...
  let x_1856 : vec3<f32> = u_xlat8;
  let x_1857 : vec4<f32> = u_xlat1;
  let x_1860 : vec3<f32> = u_xlat0;
  let x_1861 : vec3<f32> = ((x_1856 * vec3<f32>(x_1857.x, x_1857.x, x_1857.x)) + x_1860);
  let x_1862 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1861.x, x_1861.y, x_1861.z, x_1862.w);
  SV_Target0.w = 1.0f;
  return;
}
