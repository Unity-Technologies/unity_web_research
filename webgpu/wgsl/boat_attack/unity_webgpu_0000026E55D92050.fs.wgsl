...
fn main_1() {
  ...
  let x_1828 : bool = u_xlatb0.x;
  if (x_1828) {
    let x_1833 : f32 = u_xlat1.x;
    x_1829 = x_1833;
  } else {
    let x_1836 : f32 = u_xlat2.x;
    x_1829 = x_1836;
  }
  let x_1837 : f32 = x_1829;
  SV_Target0.x = x_1837;
  let x_1841 : bool = u_xlatb0.y;
  if (x_1841) {
    let x_1846 : f32 = u_xlat1.y;
    x_1842 = x_1846;
  } else {
    let x_1849 : f32 = u_xlat2.y;
    x_1842 = x_1849;
  }
  let x_1850 : f32 = x_1842;
  SV_Target0.y = x_1850;
  let x_1853 : bool = u_xlatb0.z;
  if (x_1853) {
    let x_1858 : f32 = u_xlat1.z;
    x_1854 = x_1858;
  } else {
    let x_1861 : f32 = u_xlat2.z;
    x_1854 = x_1861;
  }
