...
void main()
{
    ...
    u_xlat5.xyz = vec3(u_xlat33) * u_xlat0.xyz;
    ...
    u_xlat6.xyz = u_xlat1.xyz * (-vec3(u_xlat38)) + (-u_xlat4.xyz);
    ...
    u_xlat6 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat33);
    ...
    u_xlat18.xyz = (-u_xlat0.xyz) + vec3(u_xlat34);
    ...
    u_xlat34 = dot(_MainLightPosition.xyz, u_xlat18.xyz);
    u_xlat34 = clamp(u_xlat34, 0.0, 1.0);
    ...
    u_xlat18.xyz = u_xlat0.xyz * vec3(u_xlat33) + u_xlat5.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat18.xyz;
    u_xlat33 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu33 =  uint(int(u_xlat33));
    u_xlat34 = u_xlat37 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat34 = clamp(u_xlat34, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu33 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat8.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati36].www + _AdditionalLightsPosition[u_xlati36].xyz;
        ...
        u_xlat37 = u_xlat37 * u_xlat39;
        u_xlati39 = int(_AdditionalShadowParams[u_xlati36].w);
        u_xlatb41 = u_xlati39>=0;
        if(u_xlatb41){
            u_xlatb41 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati36].z);
            if(u_xlatb41){
                ...
                u_xlat42 = trunc(_AdditionalShadowParams[u_xlati36].w);
            ...
            u_xlat41 = 1.0 + (-_AdditionalShadowParams[u_xlati36].x);
            u_xlat39 = u_xlat39 * _AdditionalShadowParams[u_xlati36].x + u_xlat41;
        ...
        u_xlat39 = u_xlat34 * u_xlat41 + u_xlat39;
        u_xlat37 = u_xlat37 * u_xlat39;
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat36) + u_xlat5.xyz;
        u_xlat18.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat18.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat24) + u_xlat6.xyz;
