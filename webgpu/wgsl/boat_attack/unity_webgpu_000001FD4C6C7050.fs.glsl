...
;
    ...
    u_xlat80 = u_xlat80 + _Smoothness;
    u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
    u_xlat83 = u_xlat81 * 4.0 + 2.0;
    ...
    if(u_xlatb6){
        ...
        if(u_xlatb6){
            ...
            if(u_xlatb32){
                ...
                u_xlat7.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat32.xy);
                ...
                u_xlat58 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec4, 0.0);
                ...
                u_xlat6.x = u_xlat32.x * u_xlat84 + u_xlat58;
            } else {
                u_xlat32.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat32.xy = floor(u_xlat32.xy);
                u_xlat7.xy = u_xlat4.xy * _MainLightShadowmapSize.zw + (-u_xlat32.xy);
                ...
                vec3 txVec28 = vec3(u_xlat32.xy,u_xlat4.z);
                u_xlat32.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec28, 0.0);
                u_xlat6.x = u_xlat7.w * u_xlat32.x + u_xlat84;
            }
        }
    } else {
    ...
    u_xlat4.x = u_xlat56 * u_xlat6.x + u_xlat4.x;
    ...
    if(u_xlatb56){
        ...
        u_xlat56 = (u_xlatb7.y) ? u_xlat6.w : u_xlat6.x;
        u_xlat6.xyz = (u_xlatb7.x) ? u_xlat6.xyz : vec3(u_xlat56);
    } else {
        u_xlat6.x = float(1.0);
        u_xlat6.y = float(1.0);
        u_xlat6.z = float(1.0);
    ...
    u_xlat7.xyz = u_xlat2.xyz * (-vec3(u_xlat56)) + (-u_xlat3.xyz);
    ...
    u_xlat80 = u_xlat30 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu78 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat56 = dot(unity_LightIndices[int(u_xlatu56)], uintBitsToFloat(ImmCB_0[u_xlati84]));
        u_xlati56 = int(u_xlat56);
        u_xlat9.xyz = (-vs_TEXCOORD1.xyz) * _AdditionalLightsPosition[u_xlati56].www + _AdditionalLightsPosition[u_xlati56].xyz;
        ...
        u_xlat84 = u_xlat84 * _AdditionalLightsAttenuation[u_xlati56].x;
        u_xlat84 = (-u_xlat84) * u_xlat84 + 1.0;
        u_xlat84 = max(u_xlat84, 0.0);
        u_xlat84 = u_xlat84 * u_xlat84;
        u_xlat84 = u_xlat84 * u_xlat87;
        u_xlat87 = dot(_AdditionalLightsSpotDir[u_xlati56].xyz, u_xlat10.xyz);
        u_xlat87 = u_xlat87 * _AdditionalLightsAttenuation[u_xlati56].z + _AdditionalLightsAttenuation[u_xlati56].w;
        u_xlat87 = clamp(u_xlat87, 0.0, 1.0);
        u_xlat87 = u_xlat87 * u_xlat87;
        u_xlat84 = u_xlat84 * u_xlat87;
        u_xlati87 = int(_AdditionalShadowParams[u_xlati56].w);
        u_xlatb88 = u_xlati87>=0;
        if(u_xlatb88){
            u_xlatb88 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati56].z);
            if(u_xlatb88){
                ...
                u_xlat11.x = trunc(_AdditionalShadowParams[u_xlati56].w);
            ...
            u_xlatb87 = 0.0<_AdditionalShadowParams[u_xlati56].y;
            if(u_xlatb87){
                u_xlatb87 = 1.0==_AdditionalShadowParams[u_xlati56].y;
                if(u_xlatb87){
                    ...
                    u_xlatb88 = 2.0==_AdditionalShadowParams[u_xlati56].y;
                    if(u_xlatb88){
            ...
            u_xlat88 = 1.0 + (-_AdditionalShadowParams[u_xlati56].x);
            u_xlat87 = u_xlat87 * _AdditionalShadowParams[u_xlati56].x + u_xlat88;
        ...
        u_xlati88 = 1 << (u_xlati56 & int(0x1F));
        u_xlati88 = int(uint(u_xlati88) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati88 != 0) {
            u_xlati88 = int(_AdditionalLightsLightTypes[u_xlati56]);
            u_xlati11 = (u_xlati88 != 0) ? 0 : 1;
            u_xlati37 = u_xlati56 << (2 & int(0x1F));
            if(u_xlati11 != 0) {
                ...
                u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati56].xy * u_xlat11.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati56].zw;
            } else {
                ...
                if(u_xlati88 != 0) {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati56].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati56].zw;
                } else {
                    ...
                    u_xlat11.xz = _AdditionalLightsCookieAtlasUVRects[u_xlati56].xy * u_xlat37.xz + _AdditionalLightsCookieAtlasUVRects[u_xlati56].zw;
                }
            }
            u_xlat11 = textureLod(sampler2D(_AdditionalLightsCookieAtlasTexture, sampler_LinearClamp), u_xlat11.xz, 0.0);
            u_xlat88 = (u_xlatb4.y) ? u_xlat11.w : u_xlat11.x;
        ...
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[u_xlati56].xyz;
        u_xlat56 = u_xlat84 * u_xlat87;
        ...
        u_xlat56 = dot(u_xlat2.xyz, u_xlat9.xyz);
        u_xlat56 = clamp(u_xlat56, 0.0, 1.0);
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat56) + u_xlat27.xyz;
