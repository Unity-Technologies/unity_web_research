...
fn main_1() {
  ...
  loop {
    ...
    let x_1047 : u32 = u_xlatu35;
    let x_1050 : vec4<f32> = x_359.unity_LightIndices[bitcast<i32>(x_1047)];
    let x_1060 : i32 = u_xlati37;
    indexable = array<vec4<u32>, 4u>(vec4<u32>(1065353216u, 0u, 0u, 0u), vec4<u32>(0u, 1065353216u, 0u, 0u), vec4<u32>(0u, 0u, 1065353216u, 0u), vec4<u32>(0u, 0u, 0u, 1065353216u));
    let x_1065 : vec4<u32> = indexable[x_1060];
    u_xlat35 = dot(x_1050, bitcast<vec4<f32>>(x_1065));
    let x_1069 : f32 = u_xlat35;
    u_xlati35 = i32(x_1069);
    let x_1071 : vec3<f32> = vs_INTERP0;
    let x_1083 : i32 = u_xlati35;
    let x_1085 : vec4<f32> = x_1082.x_AdditionalLightsPosition[x_1083];
    let x_1088 : i32 = u_xlati35;
    ...
    u_xlat10 = (vec3<f32>(x_1150.x, x_1150.x, x_1150.x) * vec3<f32>(x_1154.x, x_1154.y, x_1154.z));
    let x_1157 : vec4<f32> = u_xlat1;
    let x_1159 : vec3<f32> = u_xlat9;
    u_xlat35 = dot(vec3<f32>(x_1157.x, x_1157.y, x_1157.z), x_1159);
    let x_1161 : f32 = u_xlat35;
    u_xlat35 = clamp(x_1161, 0.0f, 1.0f);
  ...
  let x_1242 : f32 = u_xlat24;
  let x_1245 : vec3<f32> = u_xlat16;
  let x_1246 : vec3<f32> = ((x_1241 * vec3<f32>(x_1242, x_1242, x_1242)) + x_1245);
  ...
  let x_1253 : vec3<f32> = (vec3<f32>(x_1249.x, x_1249.y, x_1249.z) + vec3<f32>(x_1251.x, x_1251.y, x_1251.z));
  ...
  u_xlat33 = (x_1256 * -(x_1257));
  let x_1260 : f32 = u_xlat33;
  u_xlat33 = exp2(x_1260);
  let x_1262 : vec4<f32> = u_xlat0;
  let x_1266 : vec4<f32> = x_44.unity_FogColor;
  let x_1269 : vec3<f32> = (vec3<f32>(x_1262.x, x_1262.y, x_1262.z) + -(vec3<f32>(x_1266.x, x_1266.y, x_1266.z)));
  let x_1270 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1269.x, x_1269.y, x_1269.z, x_1270.w);
  let x_1274 : f32 = u_xlat33;
  let x_1276 : vec4<f32> = u_xlat0;
  let x_1280 : vec4<f32> = x_44.unity_FogColor;
  let x_1282 : vec3<f32> = ((vec3<f32>(x_1274, x_1274, x_1274) * vec3<f32>(x_1276.x, x_1276.y, x_1276.z)) + vec3<f32>(x_1280.x, x_1280.y, x_1280.z));
