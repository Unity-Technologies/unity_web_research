...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat4.xyz = unity_SHC.xyz * u_xlat22.xxx + u_xlat5.xyz;
    ...
    if(u_xlatb22){
        ...
        if(u_xlatb22){
            ...
            u_xlat22.x = dot(u_xlat5, vec4(0.25, 0.25, 0.25, 0.25));
        } else {
            ...
            if(u_xlatb66){
                ...
                u_xlat22.x = u_xlat5.w * u_xlat1.x + u_xlat66;
            }
        }
    } else {
    ...
    u_xlat4.xyz = u_xlat22.xxx * _MainLightColor.xyz;
