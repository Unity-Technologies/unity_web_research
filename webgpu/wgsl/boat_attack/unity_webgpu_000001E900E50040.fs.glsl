...
float u_xlat25;
    ...
    u_xlat2.x = texture(sampler2D(_BlitTexture, sampler_LinearClamp), u_xlat15.xy, _GlobalMipBias.x).x;
    ...
    if(u_xlatb8){
        ...
        u_xlat18 = u_xlat18 * u_xlat25 + u_xlat5.x;
        u_xlat1.x = min(u_xlat1.x, 1.0);
        u_xlatb1.x = u_xlat1.x<(-u_xlat1.x);
    ...
    u_xlat0.xy = u_xlat15.xy * _Bloom_Texture_TexelSize.zw + vec2(0.5, 0.5);
    ...
    u_xlat0 = u_xlat17.xxxx * u_xlat4 + u_xlat0;
    u_xlat0 = u_xlat0 * u_xlat3.yyyy;
    u_xlat0 = u_xlat17.yyyy * u_xlat5 + u_xlat0;
    ...
    u_xlat1.xyz = textureLod(sampler2D(_InternalLut, sampler_LinearClamp), u_xlat14.xy, 0.0).xyz;
