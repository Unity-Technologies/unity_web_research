...
layout(set = 0, binding = 16) uniform mediump  sampler samplerunity_Lightmap;
layout(set = 0, binding = 17) uniform mediump  sampler sampler_Control;
layout(set = 0, binding = 18) uniform mediump  sampler sampler_Splat0;
layout(set = 0, binding = 19) uniform mediump  sampler sampler_Normal0;
layout(set = 0, binding = 20) uniform mediump  sampler sampler_TerrainHolesTexture;
...
;
    ...
    u_xlat80 = dot(u_xlat1.xyz, u_xlat3.xyz);
    ...
    u_xlat54 = dot((-u_xlat6.xyz), u_xlat1.xyz);
    ...
    u_xlat8.xyz = (-u_xlat5.xyz) + vec3(u_xlat81);
    u_xlat8.xyz = vec3(u_xlat54) * u_xlat8.xyz + u_xlat5.xyz;
    ...
    u_xlat7.xyz = vec3(u_xlat52) * _MainLightColor.xyz;
    ...
    u_xlat2.x = u_xlat28 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat8.x = float(0.0);
    u_xlat8.y = float(0.0);
    u_xlat8.z = float(0.0);
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu52 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat54 = dot(unity_LightIndices[int(u_xlatu54)], uintBitsToFloat(ImmCB_0[u_xlati81]));
        u_xlati54 = int(u_xlat54);
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati54].www + _AdditionalLightsPosition[u_xlati54].xyz;
        ...
        u_xlat81 = u_xlat81 * _AdditionalLightsAttenuation[u_xlati54].x;
        ...
        u_xlat84 = clamp(u_xlat84, 0.0, 1.0);
        u_xlat81 = u_xlat81 * u_xlat84;
        u_xlat11.xyz = vec3(u_xlat81) * _AdditionalLightsColor[u_xlati54].xyz;
        ...
        u_xlat54 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat54 = clamp(u_xlat54, 0.0, 1.0);
        u_xlat81 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
        u_xlat54 = u_xlat54 * u_xlat54;
        u_xlat54 = u_xlat54 * u_xlat0.x + 1.00001001;
        u_xlat81 = u_xlat81 * u_xlat81;
        u_xlat54 = u_xlat54 * u_xlat54;
        ...
        u_xlat9.xyz = u_xlat5.xyz * vec3(u_xlat54) + u_xlat4.xyz;
        u_xlat8.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat8.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat26) + u_xlat7.xyz;
