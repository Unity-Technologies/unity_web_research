...
fn main_1() {
  ...
  let x_1561 : vec2<f32> = vs_TEXCOORD0;
  let x_1564 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1568 : vec4<f32> = x_26.x_Dithering_Params;
  let x_1570 : vec2<f32> = ((x_1561 * vec2<f32>(x_1564.x, x_1564.y)) + vec2<f32>(x_1568.z, x_1568.w));
  let x_1571 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1570.x, x_1570.y, x_1571.z, x_1571.w);
  let x_1578 : vec4<f32> = u_xlat1;
  let x_1581 : f32 = x_26.x_GlobalMipBias.x;
  let x_1582 : vec4<f32> = textureSampleBias(x_BlueNoise_Texture, sampler_PointRepeat, vec2<f32>(x_1578.x, x_1578.y), x_1581);
  u_xlat15 = x_1582.w;
  let x_1584 : f32 = u_xlat15;
  u_xlat15 = ((x_1584 * 2.0f) + -1.0f);
  let x_1587 : f32 = u_xlat15;
  u_xlatb1 = (x_1587 >= 0.0f);
  let x_1589 : bool = u_xlatb1;
  u_xlat1.x = select(-1.0f, 1.0f, x_1589);
  let x_1592 : f32 = u_xlat15;
  u_xlat15 = (-(abs(x_1592)) + 1.0f);
  let x_1596 : f32 = u_xlat15;
  u_xlat15 = sqrt(x_1596);
  let x_1598 : f32 = u_xlat15;
  u_xlat15 = (-(x_1598) + 1.0f);
  let x_1601 : f32 = u_xlat15;
  let x_1603 : f32 = u_xlat1.x;
  u_xlat15 = (x_1601 * x_1603);
  let x_1605 : vec3<f32> = u_xlat0;
  let x_1606 : vec3<f32> = (x_1605 * vec3<f32>(12.9200000762939453125f, 12.9200000762939453125f, 12.9200000762939453125f));
  let x_1607 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1606.x, x_1606.y, x_1606.z, x_1607.w);
  let x_1609 : vec3<f32> = u_xlat0;
  let x_1611 : vec3<f32> = log2(abs(x_1609));
  let x_1612 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1611.x, x_1611.y, x_1611.z, x_1612.w);
  let x_1614 : vec4<f32> = u_xlat2;
  let x_1616 : vec3<f32> = (vec3<f32>(x_1614.x, x_1614.y, x_1614.z) * vec3<f32>(0.4166666567325592041f, 0.4166666567325592041f, 0.4166666567325592041f));
  ...
  let x_1627 : vec3<f32> = ((vec3<f32>(x_1624.x, x_1624.y, x_1624.z) * vec3<f32>(1.05499994754791259766f, 1.05499994754791259766f, 1.05499994754791259766f)) + vec3<f32>(-0.05499999970197677612f, -0.05499999970197677612f, -0.05499999970197677612f));
  let x_1628 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1627.x, x_1627.y, x_1627.z, x_1628.w);
  let x_1630 : vec3<f32> = u_xlat0;
  let x_1632 : vec4<bool> = (vec4<f32>(0.00313080009073019028f, 0.00313080009073019028f, 0.00313080009073019028f, 0.0f) >= vec4<f32>(x_1630.x, x_1630.y, x_1630.z, x_1630.x));
  ...
  u_xlat0.z = x_1668;
  let x_1670 : f32 = u_xlat15;
  let x_1675 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1670, x_1670, x_1670) * vec3<f32>(0.0039215688593685627f, 0.0039215688593685627f, 0.0039215688593685627f)) + x_1675);
  let x_1677 : vec3<f32> = u_xlat0;
  let x_1678 : vec3<f32> = (x_1677 * vec3<f32>(0.07739938050508499146f, 0.07739938050508499146f, 0.07739938050508499146f));
  let x_1679 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1678.x, x_1678.y, x_1678.z, x_1679.w);
  let x_1681 : vec3<f32> = u_xlat0;
  let x_1682 : vec3<f32> = (x_1681 + vec3<f32>(0.05499999970197677612f, 0.05499999970197677612f, 0.05499999970197677612f));
  let x_1683 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1682.x, x_1682.y, x_1682.z, x_1683.w);
  let x_1685 : vec4<f32> = u_xlat2;
  let x_1687 : vec3<f32> = (vec3<f32>(x_1685.x, x_1685.y, x_1685.z) * vec3<f32>(0.94786733388900756836f, 0.94786733388900756836f, 0.94786733388900756836f));
  let x_1688 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1687.x, x_1687.y, x_1687.z, x_1688.w);
  let x_1690 : vec4<f32> = u_xlat2;
  let x_1693 : vec3<f32> = log2(abs(vec3<f32>(x_1690.x, x_1690.y, x_1690.z)));
  let x_1694 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1693.x, x_1693.y, x_1693.z, x_1694.w);
  let x_1696 : vec4<f32> = u_xlat2;
  let x_1698 : vec3<f32> = (vec3<f32>(x_1696.x, x_1696.y, x_1696.z) * vec3<f32>(2.40000009536743164062f, 2.40000009536743164062f, 2.40000009536743164062f));
  ...
  let x_1706 : vec3<f32> = u_xlat0;
  let x_1708 : vec4<bool> = (vec4<f32>(0.04044999927282333374f, 0.04044999927282333374f, 0.04044999927282333374f, 0.0f) >= vec4<f32>(x_1706.x, x_1706.y, x_1706.z, x_1706.x));
  u_xlatb0 = vec3<bool>(x_1708.x, x_1708.y, x_1708.z);
  ...
  let x_1749 : vec3<f32> = max(x_1748, vec3<f32>(0.0f, 0.0f, 0.0f));
  let x_1750 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1749.x, x_1749.y, x_1749.z, x_1750.w);
  SV_Target0.w = 1.0f;
  return;
}
