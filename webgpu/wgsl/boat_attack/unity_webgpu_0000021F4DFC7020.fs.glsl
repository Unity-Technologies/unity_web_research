...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu57 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat27.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[u_xlati59].www + _AdditionalLightsPosition[u_xlati59].xyz;
        ...
        u_xlat63 = dot(_AdditionalLightsSpotDir[u_xlati59].xyz, u_xlat9.xyz);
        u_xlat63 = u_xlat63 * _AdditionalLightsAttenuation[u_xlati59].z + _AdditionalLightsAttenuation[u_xlati59].w;
        u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
        u_xlat63 = u_xlat63 * u_xlat63;
        u_xlat61 = u_xlat61 * u_xlat63;
        u_xlat10.xyz = vec3(u_xlat41) * _AdditionalLightsColor[u_xlati59].xyz;
        u_xlat59 = dot(u_xlat20.xyz, u_xlat9.xyz);
        u_xlat59 = clamp(u_xlat59, 0.0, 1.0);
        u_xlat59 = u_xlat59 * u_xlat61;
        u_xlat10.xyz = vec3(u_xlat59) * u_xlat10.xyz;
        u_xlat27.xyz = u_xlat27.xyz * vec3(u_xlat62) + u_xlat6.xyz;
        u_xlat59 = dot(u_xlat27.xyz, u_xlat27.xyz);
        u_xlat59 = max(u_xlat59, 1.17549435e-37);
        u_xlat59 = inversesqrt(u_xlat59);
        u_xlat27.xyz = vec3(u_xlat59) * u_xlat27.xyz;
        u_xlat59 = dot(u_xlat20.xyz, u_xlat27.xyz);
        u_xlat59 = clamp(u_xlat59, 0.0, 1.0);
        ...
        u_xlat27.xyz = u_xlat0.xyz * vec3(u_xlat59) + u_xlat4.xyz;
