...
half4 s ;
s = _BlitTexture . SampleBias ( sampler_BlitTexture , uv + d . xy , _GlobalMipBias . x ) ;
s += _BlitTexture . SampleBias ( sampler_BlitTexture , uv + d . zy , _GlobalMipBias . x ) ;
s += _BlitTexture . SampleBias ( sampler_BlitTexture , uv + d . xw , _GlobalMipBias . x ) ;
s += _BlitTexture . SampleBias ( sampler_BlitTexture , uv + d . zw , _GlobalMipBias . x ) ;
