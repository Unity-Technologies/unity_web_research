#line 1 "Hidden/Universal Render Pipeline/PaniniProjection"
static const int _UNIT_DISTANCE = 0 ;
...
return _BlitTexture . SampleBias ( sampler_LinearClamp , coords , _GlobalMipBias . x ) ;
}
