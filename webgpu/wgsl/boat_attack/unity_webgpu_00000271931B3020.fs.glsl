...
void main()
{
    ...
    u_xlat41 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_LinearClampCompare), txVec0, 0.0);
    u_xlat42 = (-_MainLightShadowParams.x) + 1.0;
    u_xlat41 = u_xlat41 * _MainLightShadowParams.x + u_xlat42;
    u_xlatb42 = 0.0>=vs_INTERP3.z;
    ...
    u_xlat7.x = u_xlat42 * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat7.x = clamp(u_xlat7.x, 0.0, 1.0);
    u_xlat19 = (-u_xlat41) + 1.0;
    u_xlat41 = u_xlat7.x * u_xlat19 + u_xlat41;
    ...
    u_xlat20.xyz = u_xlat1.xyw + _MainLightPosition.xyz;
    u_xlat38 = dot(u_xlat20.xyz, u_xlat20.xyz);
    ...
    u_xlat38 = u_xlat38 * u_xlat8.x + 1.00001001;
    ...
    u_xlat20.xyz = u_xlat0.xyz * vec3(u_xlat38) + u_xlat6.xyz;
    u_xlat7.xyz = u_xlat7.xyz * u_xlat20.xyz;
    u_xlat38 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu38 =  uint(int(u_xlat38));
    u_xlat3.x = u_xlat42 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu38 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat9.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati41].www + _AdditionalLightsPosition[u_xlati41].xyz;
        ...
        u_xlat45 = dot(_AdditionalLightsSpotDir[u_xlati41].xyz, u_xlat10.xyz);
        ...
        if(u_xlatb46){
            ...
            if(u_xlatb46){
                ...
                u_xlat11.x = trunc(_AdditionalShadowParams[u_xlati41].w);
                u_xlat46 = u_xlat46 + u_xlat11.x;
                u_xlati45 = int(u_xlat46);
            }
            u_xlati45 = u_xlati45 << (2 & int(0x1F));
            u_xlat11 = vs_INTERP7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati45 + 1) / 4][(u_xlati45 + 1) % 4];
            u_xlat11 = _AdditionalLightsWorldToShadow[u_xlati45 / 4][u_xlati45 % 4] * vs_INTERP7.xxxx + u_xlat11;
            u_xlat11 = _AdditionalLightsWorldToShadow[(u_xlati45 + 2) / 4][(u_xlati45 + 2) % 4] * vs_INTERP7.zzzz + u_xlat11;
            u_xlat11 = u_xlat11 + _AdditionalLightsWorldToShadow[(u_xlati45 + 3) / 4][(u_xlati45 + 3) % 4];
            ...
            u_xlat46 = 1.0 + (-_AdditionalShadowParams[u_xlati41].x);
            u_xlat45 = u_xlat45 * _AdditionalShadowParams[u_xlati41].x + u_xlat46;
        ...
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat41) + u_xlat6.xyz;
        u_xlat20.xyz = u_xlat9.xyz * u_xlat11.xyz + u_xlat20.xyz;
    }
    u_xlat0.xyz = u_xlat5.xyz * vec3(u_xlat27) + u_xlat7.xyz;
