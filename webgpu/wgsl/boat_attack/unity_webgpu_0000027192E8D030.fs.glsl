...
;
    ...
    u_xlat77 = dot(u_xlat26.xyz, u_xlat3.xyz);
    u_xlat77 = u_xlat77 + 0.5;
    u_xlat3.xyz = vec3(u_xlat77) * u_xlat4.xyz;
    u_xlat77 = max(u_xlat3.w, 9.99999975e-05);
    ...
    if(u_xlatb5){
        ...
        if(u_xlatb5){
            ...
            if(u_xlatb30){
                u_xlat30.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + vec2(0.5, 0.5);
                u_xlat30.xy = floor(u_xlat30.xy);
                u_xlat6.xy = u_xlat2.xy * _MainLightShadowmapSize.zw + (-u_xlat30.xy);
                ...
                vec3 txVec19 = vec3(u_xlat62.xy,u_xlat2.z);
                ...
                vec3 txVec28 = vec3(u_xlat30.xy,u_xlat2.z);
    ...
    u_xlat27.x = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat52 = u_xlat27.x * _MainLightShadowParams.z + _MainLightShadowParams.w;
    u_xlat52 = clamp(u_xlat52, 0.0, 1.0);
    u_xlat5.x = (-u_xlat2.x) + 1.0;
    u_xlat2.x = u_xlat52 * u_xlat5.x + u_xlat2.x;
    u_xlat5.x = vs_TEXCOORD3.w;
    u_xlat5.y = vs_TEXCOORD4.w;
    u_xlat5.z = vs_TEXCOORD5.w;
    u_xlat52 = dot((-u_xlat5.xyz), u_xlat26.xyz);
    u_xlat52 = u_xlat52 + u_xlat52;
    u_xlat6.xyz = u_xlat26.xyz * (-vec3(u_xlat52)) + (-u_xlat5.xyz);
    u_xlat52 = dot(u_xlat26.xyz, u_xlat5.xyz);
    u_xlat52 = clamp(u_xlat52, 0.0, 1.0);
