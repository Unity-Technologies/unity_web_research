...
;
    ...
    u_xlat8.xyz = u_xlat2.xyz * (-vec3(u_xlat31)) + (-u_xlat1.xyz);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu0 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat31 = dot(unity_LightIndices[int(u_xlatu31)], uintBitsToFloat(ImmCB_0[u_xlati47]));
        ...
        u_xlat49 = dot(_AdditionalLightsSpotDir[u_xlati31].xyz, u_xlat10.xyz);
        u_xlat49 = u_xlat49 * _AdditionalLightsAttenuation[u_xlati31].z + _AdditionalLightsAttenuation[u_xlati31].w;
        u_xlat49 = clamp(u_xlat49, 0.0, 1.0);
        u_xlat49 = u_xlat49 * u_xlat49;
        u_xlat47 = u_xlat47 * u_xlat49;
        u_xlati49 = int(_AdditionalShadowParams[u_xlati31].w);
        u_xlatb50 = u_xlati49>=0;
        if(u_xlatb50){
            u_xlatb50 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati31].z);
            if(u_xlatb50){
                ...
                u_xlat50 = (u_xlatb50) ? u_xlat11.x : u_xlat52;
                u_xlat52 = trunc(_AdditionalShadowParams[u_xlati31].w);
            ...
            u_xlat50 = 1.0 + (-_AdditionalShadowParams[u_xlati31].x);
            u_xlat49 = u_xlat49 * _AdditionalShadowParams[u_xlati31].x + u_xlat50;
        ...
        u_xlat49 = u_xlat28 * u_xlat50 + u_xlat49;
        u_xlati50 = 1 << (u_xlati31 & int(0x1F));
        u_xlati50 = int(uint(u_xlati50) & floatBitsToUint(_AdditionalLightsCookieEnableBits));
        if(u_xlati50 != 0) {
            u_xlati50 = int(_AdditionalLightsLightTypes[u_xlati31]);
            ...
            if(u_xlati52 != 0) {
                ...
                u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati31].xy * u_xlat25.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati31].zw;
            } else {
                ...
                if(u_xlati50 != 0) {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati31].xy * u_xlat12.xy + _AdditionalLightsCookieAtlasUVRects[u_xlati31].zw;
                } else {
                    ...
                    u_xlat25.xy = _AdditionalLightsCookieAtlasUVRects[u_xlati31].xy * u_xlat11.xw + _AdditionalLightsCookieAtlasUVRects[u_xlati31].zw;
                }
            }
