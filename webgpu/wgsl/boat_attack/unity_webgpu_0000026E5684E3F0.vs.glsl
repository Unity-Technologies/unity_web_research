...
layout(location = 6) in highp vec4 in_NORMAL0;
layout(location = 7) in highp vec4 in_TANGENT0;
layout(location = 0) out highp vec4 vs_TEXCOORD0;
layout(location = 1) out highp vec4 vs_TEXCOORD1;
layout(location = 2) out highp vec4 vs_TEXCOORD2;
layout(location = 3) out highp vec4 vs_TEXCOORD3;
layout(location = 4) out highp vec4 vs_COLOR0;
layout(location = 5) out highp vec4 vs_NORMAL0;
layout(location = 6) out highp vec4 vs_TANGENT0;
vec4 u_xlat0;
vec4 u_xlat1;
void main()
{
