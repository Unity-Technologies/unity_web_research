...
fn main_1() {
  ...
  u_xlat1 = (vec3<f32>(x_647.x, x_647.y, x_647.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  ...
  let x_702 : f32 = x_694;
  SV_Target0.y = x_702;
  let x_705 : bool = u_xlatb0.z;
  if (x_705) {
    let x_710 : f32 = u_xlat1.z;
    x_706 = x_710;
  } else {
