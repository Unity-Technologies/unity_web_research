...
void main()
{
    ...
    u_xlat1 = vec4(u_xlat25) * u_xlat1 + u_xlat2;
    u_xlat0.x = min(u_xlat1.y, u_xlat1.w);
    u_xlat0.x = (-u_xlat0.x) + u_xlat1.x;
    u_xlatb25 = u_xlat0.x==0.0;
    u_xlat50 = u_xlat1.x + 1.00000001e-10;
    u_xlat25 = (u_xlatb25) ? u_xlat1.x : u_xlat50;
    u_xlat1.x = (-u_xlat1.y) + u_xlat1.w;
    u_xlat26.x = u_xlat0.x * 6.0 + 1.00000001e-10;
    u_xlat1.x = u_xlat1.x / u_xlat26.x;
    u_xlat1.x = u_xlat1.x + u_xlat1.z;
    u_xlat0.x = u_xlat0.x / u_xlat50;
    u_xlat50 = u_xlat0.w * _Hue + abs(u_xlat1.x);
    u_xlatb75 = u_xlat50<0.0;
    u_xlatb1 = 1.0<u_xlat50;
    u_xlat26.xy = vec2(u_xlat50) + vec2(1.0, -1.0);
    u_xlat50 = (u_xlatb1) ? u_xlat26.y : u_xlat50;
    u_xlat50 = (u_xlatb75) ? u_xlat26.x : u_xlat50;
    u_xlat1.xyz = vec3(u_xlat50) + vec3(1.0, 0.666666687, 0.333333343);
    ...
    u_xlat0.xyz = u_xlat0.xzw * vec3(u_xlat25);
    ...
    u_xlat75 = dot(u_xlat1.xy, u_xlat1.xy);
    ...
    u_xlat26.xyz = u_xlat1.yyy * u_xlat3.xyz;
    u_xlat1.xyz = u_xlat1.xxx * vs_INTERP4.xyz + u_xlat26.xyz;
    u_xlat1.xyz = vec3(u_xlat75) * vs_INTERP8.xyz + u_xlat1.xyz;
    ...
    u_xlat4.x = (u_xlatb75) ? u_xlat3.x : unity_MatrixV[0].z;
    u_xlat4.y = (u_xlatb75) ? u_xlat3.y : unity_MatrixV[1].z;
    u_xlat4.z = (u_xlatb75) ? u_xlat3.z : unity_MatrixV[2].z;
    ...
    u_xlat75 = dot(u_xlat1.xyz, u_xlat3.xyz);
    u_xlat75 = u_xlat75 + 0.5;
    u_xlat3.xyz = vec3(u_xlat75) * u_xlat5.xyz;
    u_xlat75 = max(u_xlat3.w, 9.99999975e-05);
    u_xlat3.xyz = u_xlat3.xyz / vec3(u_xlat75);
    u_xlat2.xy = u_xlat2.xy;
    u_xlat2.xy = clamp(u_xlat2.xy, 0.0, 1.0);
    u_xlat75 = (-u_xlat2.x) * 0.959999979 + 0.959999979;
    u_xlat76 = (-u_xlat75) + u_xlat2.y;
    u_xlat5.xyz = vec3(u_xlat75) * u_xlat0.xyz;
    u_xlat0.xyz = u_xlat0.xyz + vec3(-0.0399999991, -0.0399999991, -0.0399999991);
    u_xlat0.xyz = u_xlat2.xxx * u_xlat0.xyz + vec3(0.0399999991, 0.0399999991, 0.0399999991);
    u_xlat75 = (-u_xlat2.y) + 1.0;
    u_xlat2.x = u_xlat75 * u_xlat75;
    u_xlat2.x = max(u_xlat2.x, 0.0078125);
    u_xlat27 = u_xlat2.x * u_xlat2.x;
    u_xlat76 = u_xlat76 + 1.0;
    u_xlat76 = min(u_xlat76, 1.0);
    u_xlat77 = u_xlat2.x * 4.0 + 2.0;
    u_xlat52 = min(u_xlat2.z, 1.0);
    ...
    u_xlat80 = dot((-u_xlat4.xyz), u_xlat1.xyz);
    u_xlat80 = u_xlat80 + u_xlat80;
    u_xlat6.xyz = u_xlat1.xyz * (-vec3(u_xlat80)) + (-u_xlat4.xyz);
    u_xlat80 = dot(u_xlat1.xyz, u_xlat4.xyz);
    u_xlat80 = clamp(u_xlat80, 0.0, 1.0);
    ...
    u_xlat75 = u_xlat27 / u_xlat75;
    u_xlat32.xyz = u_xlat0.xyz * vec3(u_xlat75) + u_xlat5.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat32.xyz;
    u_xlat75 = min(_AdditionalLightsCount.x, unity_LightData.y);
    u_xlatu75 =  uint(int(u_xlat75));
    u_xlat76 = u_xlat79 * _AdditionalShadowFadeParams.x + _AdditionalShadowFadeParams.y;
    u_xlat76 = clamp(u_xlat76, 0.0, 1.0);
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu75 ; u_xlatu_loop_1++)
    {
        ...
        u_xlati79 = int(u_xlatu_loop_1 & 3u);
        u_xlat78 = dot(unity_LightIndices[int(u_xlatu78)], uintBitsToFloat(ImmCB_0[u_xlati79]));
        u_xlati78 = int(u_xlat78);
        u_xlat8.xyz = (-vs_INTERP7.xyz) * _AdditionalLightsPosition[u_xlati78].www + _AdditionalLightsPosition[u_xlati78].xyz;
        u_xlat79 = dot(u_xlat8.xyz, u_xlat8.xyz);
        u_xlat79 = max(u_xlat79, 6.10351562e-05);
        u_xlat80 = inversesqrt(u_xlat79);
        u_xlat9.xyz = vec3(u_xlat80) * u_xlat8.xyz;
        u_xlat81 = float(1.0) / float(u_xlat79);
        ...
        u_xlat81 = dot(_AdditionalLightsSpotDir[u_xlati78].xyz, u_xlat9.xyz);
        u_xlat81 = u_xlat81 * _AdditionalLightsAttenuation[u_xlati78].z + _AdditionalLightsAttenuation[u_xlati78].w;
        u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
        u_xlat81 = u_xlat81 * u_xlat81;
        u_xlat79 = u_xlat79 * u_xlat81;
        u_xlati81 = int(_AdditionalShadowParams[u_xlati78].w);
        u_xlatb83 = u_xlati81>=0;
        if(u_xlatb83){
            u_xlatb83 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(_AdditionalShadowParams[u_xlati78].z);
            if(u_xlatb83){
                ...
                u_xlat84 = trunc(_AdditionalShadowParams[u_xlati78].w);
                u_xlat83 = u_xlat83 + u_xlat84;
                u_xlati81 = int(u_xlat83);
            }
            u_xlati81 = u_xlati81 << (2 & int(0x1F));
            u_xlat10 = vs_INTERP7.yyyy * _AdditionalLightsWorldToShadow[(u_xlati81 + 1) / 4][(u_xlati81 + 1) % 4];
            u_xlat10 = _AdditionalLightsWorldToShadow[u_xlati81 / 4][u_xlati81 % 4] * vs_INTERP7.xxxx + u_xlat10;
            u_xlat10 = _AdditionalLightsWorldToShadow[(u_xlati81 + 2) / 4][(u_xlati81 + 2) % 4] * vs_INTERP7.zzzz + u_xlat10;
            u_xlat10 = u_xlat10 + _AdditionalLightsWorldToShadow[(u_xlati81 + 3) / 4][(u_xlati81 + 3) % 4];
            u_xlat10.xyz = u_xlat10.xyz / u_xlat10.www;
            u_xlatb81 = 0.0<_AdditionalShadowParams[u_xlati78].y;
            if(u_xlatb81){
                u_xlatb81 = 1.0==_AdditionalShadowParams[u_xlati78].y;
                if(u_xlatb81){
                    ...
                    u_xlat81 = dot(u_xlat12, vec4(0.25, 0.25, 0.25, 0.25));
                } else {
                    u_xlatb83 = 2.0==_AdditionalShadowParams[u_xlati78].y;
                    if(u_xlatb83){
                        ...
                        u_xlat81 = u_xlat83 * u_xlat85 + u_xlat84;
                    } else {
                        u_xlat11.xy = u_xlat10.xy * _AdditionalShadowmapSize.zw + vec2(0.5, 0.5);
                        u_xlat11.xy = floor(u_xlat11.xy);
                        u_xlat61.xy = u_xlat10.xy * _AdditionalShadowmapSize.zw + (-u_xlat11.xy);
                        ...
                        u_xlat81 = u_xlat12.w * u_xlat84 + u_xlat83;
                    }
                }
            } else {
                vec3 txVec59 = vec3(u_xlat10.xy,u_xlat10.z);
                u_xlat81 = textureLod(sampler2DShadow(_AdditionalLightsShadowmapTexture, sampler_LinearClampCompare), txVec59, 0.0);
            }
            u_xlat83 = 1.0 + (-_AdditionalShadowParams[u_xlati78].x);
            u_xlat81 = u_xlat81 * _AdditionalShadowParams[u_xlati78].x + u_xlat83;
            u_xlatb83 = 0.0>=u_xlat10.z;
            u_xlatb84 = u_xlat10.z>=1.0;
            u_xlatb83 = u_xlatb83 || u_xlatb84;
            u_xlat81 = (u_xlatb83) ? 1.0 : u_xlat81;
        } else {
            u_xlat81 = 1.0;
        }
        u_xlat83 = (-u_xlat81) + 1.0;
        u_xlat81 = u_xlat76 * u_xlat83 + u_xlat81;
        u_xlat79 = u_xlat79 * u_xlat81;
        u_xlat81 = dot(u_xlat1.xyz, u_xlat9.xyz);
        u_xlat81 = clamp(u_xlat81, 0.0, 1.0);
        u_xlat79 = u_xlat79 * u_xlat81;
        u_xlat10.xyz = vec3(u_xlat79) * _AdditionalLightsColor[u_xlati78].xyz;
        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat80) + u_xlat4.xyz;
        ...
        u_xlat78 = dot(u_xlat1.xyz, u_xlat8.xyz);
        u_xlat78 = clamp(u_xlat78, 0.0, 1.0);
        u_xlat79 = dot(u_xlat9.xyz, u_xlat8.xyz);
        u_xlat79 = clamp(u_xlat79, 0.0, 1.0);
        u_xlat78 = u_xlat78 * u_xlat78;
        u_xlat78 = u_xlat78 * u_xlat7.x + 1.00001001;
        u_xlat79 = u_xlat79 * u_xlat79;
        u_xlat78 = u_xlat78 * u_xlat78;
        ...
        u_xlat8.xyz = u_xlat0.xyz * vec3(u_xlat78) + u_xlat5.xyz;
        u_xlat32.xyz = u_xlat8.xyz * u_xlat10.xyz + u_xlat32.xyz;
    }
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat52) + u_xlat6.xyz;
