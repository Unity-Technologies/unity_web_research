...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat59 = max(u_xlat2.w, 9.99999975e-05);
    u_xlat2.xyz = u_xlat2.xyz / vec3(u_xlat59);
    u_xlat3.xy = vec2(1.0) / vec2(_ScaledScreenParams.xy);
    u_xlat3.xy = u_xlat3.xy * hlslcc_FragCoord.xy;
    u_xlat59 = u_xlat3.y * _ScaleBiasRt.x + _ScaleBiasRt.y;
    u_xlat3.z = (-u_xlat59) + 1.0;
    u_xlat59 = (-u_xlat1) * 0.959999979 + 0.959999979;
    ...
    u_xlat59 = u_xlat1 * u_xlat1;
    u_xlat59 = max(u_xlat59, 0.0078125);
    u_xlat60 = u_xlat59 * u_xlat59;
    u_xlat57 = u_xlat0.w + u_xlat22;
    u_xlat57 = clamp(u_xlat57, 0.0, 1.0);
    u_xlat22 = u_xlat59 * 4.0 + 2.0;
    ...
    if(u_xlatb61){
        ...
        if(u_xlatb61){
            ...
            if(u_xlatb5){
                ...
                u_xlat43.xy = vs_TEXCOORD8.xy * _MainLightShadowmapSize.zw + (-u_xlat5.xy);
                ...
                u_xlat24 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec4, 0.0);
                ...
                vec3 txVec6 = vec3(u_xlat43.xy,vs_TEXCOORD8.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec6, 0.0);
                u_xlat24 = u_xlat12.z * u_xlat43.x + u_xlat24;
                vec3 txVec7 = vec3(u_xlat8.xy,vs_TEXCOORD8.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec7, 0.0);
                u_xlat24 = u_xlat12.w * u_xlat43.x + u_xlat24;
                vec3 txVec8 = vec3(u_xlat10.xy,vs_TEXCOORD8.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec8, 0.0);
                u_xlat24 = u_xlat13.x * u_xlat43.x + u_xlat24;
                vec3 txVec9 = vec3(u_xlat10.zw,vs_TEXCOORD8.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec9, 0.0);
                u_xlat24 = u_xlat13.y * u_xlat43.x + u_xlat24;
                vec3 txVec10 = vec3(u_xlat8.zw,vs_TEXCOORD8.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec10, 0.0);
                u_xlat24 = u_xlat13.z * u_xlat43.x + u_xlat24;
                vec3 txVec11 = vec3(u_xlat7.xy,vs_TEXCOORD8.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec11, 0.0);
                u_xlat24 = u_xlat13.w * u_xlat43.x + u_xlat24;
                vec3 txVec12 = vec3(u_xlat7.zw,vs_TEXCOORD8.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec12, 0.0);
                ...
                u_xlat7.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec13, 0.0);
                ...
                vec3 txVec15 = vec3(u_xlat43.xy,vs_TEXCOORD8.z);
                u_xlat43.x = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec15, 0.0);
                u_xlat43.x = u_xlat16.z * u_xlat43.x + u_xlat7.x;
                vec3 txVec16 = vec3(u_xlat14.xy,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec16, 0.0);
                u_xlat43.x = u_xlat16.w * u_xlat62 + u_xlat43.x;
                vec3 txVec17 = vec3(u_xlat12.xy,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec17, 0.0);
                u_xlat43.x = u_xlat17.x * u_xlat62 + u_xlat43.x;
                vec3 txVec18 = vec3(u_xlat12.zw,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec18, 0.0);
                u_xlat43.x = u_xlat17.y * u_xlat62 + u_xlat43.x;
                vec3 txVec19 = vec3(u_xlat13.xy,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec19, 0.0);
                u_xlat43.x = u_xlat17.z * u_xlat62 + u_xlat43.x;
                vec3 txVec20 = vec3(u_xlat14.zw,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec20, 0.0);
                u_xlat43.x = u_xlat17.w * u_xlat62 + u_xlat43.x;
                vec3 txVec21 = vec3(u_xlat15.xy,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec21, 0.0);
                u_xlat43.x = u_xlat18.x * u_xlat62 + u_xlat43.x;
                vec3 txVec22 = vec3(u_xlat15.zw,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec22, 0.0);
                u_xlat43.x = u_xlat18.y * u_xlat62 + u_xlat43.x;
                vec3 txVec23 = vec3(u_xlat26.xy,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec23, 0.0);
                u_xlat43.x = u_xlat18.z * u_xlat62 + u_xlat43.x;
                vec3 txVec24 = vec3(u_xlat51.xy,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec24, 0.0);
                u_xlat43.x = u_xlat18.w * u_xlat62 + u_xlat43.x;
                vec3 txVec25 = vec3(u_xlat10.xy,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec25, 0.0);
                u_xlat43.x = u_xlat6.x * u_xlat62 + u_xlat43.x;
                vec3 txVec26 = vec3(u_xlat10.zw,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec26, 0.0);
                u_xlat43.x = u_xlat6.y * u_xlat62 + u_xlat43.x;
                vec3 txVec27 = vec3(u_xlat46.xy,vs_TEXCOORD8.z);
                u_xlat62 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec27, 0.0);
        ...
        u_xlat61 = textureLod(sampler2DShadow(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture), txVec29, 0.0);
    }
    u_xlat5.x = (-_MainLightShadowParams.x) + 1.0;
    u_xlat61 = u_xlat61 * _MainLightShadowParams.x + u_xlat5.x;
    ...
    u_xlat24 = (-u_xlat61) + 1.0;
    u_xlat61 = u_xlat5.x * u_xlat24 + u_xlat61;
    ...
    if(u_xlatb5){
        ...
        u_xlat62 = (u_xlatb6.y) ? u_xlat5.w : u_xlat5.x;
        u_xlat5.xyz = (u_xlatb6.x) ? u_xlat5.xyz : vec3(u_xlat62);
    } else {
        u_xlat5.x = float(1.0);
        u_xlat5.y = float(1.0);
        u_xlat5.z = float(1.0);
    ...
    u_xlat62 = dot((-u_xlat6.xyz), u_xlat20.xyz);
    u_xlat62 = u_xlat62 + u_xlat62;
    u_xlat7.xyz = u_xlat20.xyz * (-vec3(u_xlat62)) + (-u_xlat6.xyz);
    u_xlat62 = dot(u_xlat20.xyz, u_xlat6.xyz);
    u_xlat62 = clamp(u_xlat62, 0.0, 1.0);
    u_xlat62 = (-u_xlat62) + 1.0;
    u_xlat62 = u_xlat62 * u_xlat62;
    u_xlat62 = u_xlat62 * u_xlat62;
    u_xlat63 = (-u_xlat1) * 0.699999988 + 1.70000005;
    u_xlat1 = u_xlat1 * u_xlat63;
    u_xlat1 = u_xlat1 * 6.0;
    ...
    u_xlat8.xy = vec2(u_xlat59) * vec2(u_xlat59) + vec2(-1.0, 1.0);
    u_xlat1 = float(1.0) / u_xlat8.y;
    u_xlat27.xyz = (-u_xlat0.xyz) + vec3(u_xlat57);
    u_xlat27.xyz = vec3(u_xlat62) * u_xlat27.xyz + u_xlat0.xyz;
    ...
    u_xlat57 = u_xlat61 * unity_LightData.z;
    u_xlat1 = dot(u_xlat20.xyz, _MainLightPosition.xyz);
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat57 = u_xlat57 * u_xlat1;
    u_xlat5.xyz = vec3(u_xlat57) * u_xlat5.xyz;
    u_xlat7.xyz = u_xlat6.xyz + _MainLightPosition.xyz;
    u_xlat57 = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat57 = max(u_xlat57, 1.17549435e-37);
    u_xlat57 = inversesqrt(u_xlat57);
    u_xlat7.xyz = vec3(u_xlat57) * u_xlat7.xyz;
    u_xlat57 = dot(u_xlat20.xyz, u_xlat7.xyz);
    u_xlat57 = clamp(u_xlat57, 0.0, 1.0);
    ...
    u_xlat7.xyz = u_xlat0.xyz * vec3(u_xlat57) + u_xlat4.xyz;
    ...
    for(uint u_xlatu_loop_1 = 0u ; u_xlatu_loop_1<u_xlatu57 ; u_xlatu_loop_1++)
    {
        ...
        u_xlat59 = dot(unity_LightIndices[int(u_xlatu59)], uintBitsToFloat(ImmCB_0[u_xlati61]));
        u_xlatu59 =  uint(int(u_xlat59));
        u_xlat9.xyz = (-vs_TEXCOORD7.xyz) * _AdditionalLightsPosition[int(u_xlatu59)].www + _AdditionalLightsPosition[int(u_xlatu59)].xyz;
        u_xlat61 = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat61 = max(u_xlat61, 6.10351562e-05);
        u_xlat62 = inversesqrt(u_xlat61);
        u_xlat10.xyz = vec3(u_xlat62) * u_xlat9.xyz;
        u_xlat63 = float(1.0) / float(u_xlat61);
        u_xlat61 = u_xlat61 * _AdditionalLightsAttenuation[int(u_xlatu59)].x;
        u_xlat61 = (-u_xlat61) * u_xlat61 + 1.0;
        u_xlat61 = max(u_xlat61, 0.0);
        u_xlat61 = u_xlat61 * u_xlat61;
        u_xlat61 = u_xlat61 * u_xlat63;
        u_xlat63 = dot(_AdditionalLightsSpotDir[int(u_xlatu59)].xyz, u_xlat10.xyz);
        u_xlat63 = u_xlat63 * _AdditionalLightsAttenuation[int(u_xlatu59)].z + _AdditionalLightsAttenuation[int(u_xlatu59)].w;
        u_xlat63 = clamp(u_xlat63, 0.0, 1.0);
        u_xlat63 = u_xlat63 * u_xlat63;
        u_xlat61 = u_xlat61 * u_xlat63;
        u_xlatu63 = u_xlatu59 >> (5u & uint(0x1F));
        u_xlati45 = 1 << (int(u_xlatu59) & int(0x1F));
        u_xlati63 = int(uint(u_xlati45) & floatBitsToUint(_AdditionalLightsCookieEnableBits[int(u_xlatu63)]));
        if(u_xlati63 != 0) {
            u_xlati63 = int(_AdditionalLightsLightTypes[int(u_xlatu59)]);
            u_xlati45 = (u_xlati63 != 0) ? 0 : 1;
            u_xlati64 = int(u_xlatu59) << (2 & int(0x1F));
            if(u_xlati45 != 0) {
                u_xlat11.xyz = vs_TEXCOORD7.yyy * _AdditionalLightsWorldToLights[(u_xlati64 + 1) / 4][(u_xlati64 + 1) % 4].xyw;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[u_xlati64 / 4][u_xlati64 % 4].xyw * vs_TEXCOORD7.xxx + u_xlat11.xyz;
                u_xlat11.xyz = _AdditionalLightsWorldToLights[(u_xlati64 + 2) / 4][(u_xlati64 + 2) % 4].xyw * vs_TEXCOORD7.zzz + u_xlat11.xyz;
                u_xlat11.xyz = u_xlat11.xyz + _AdditionalLightsWorldToLights[(u_xlati64 + 3) / 4][(u_xlati64 + 3) % 4].xyw;
                u_xlat11.xy = u_xlat11.xy / u_xlat11.zz;
                u_xlat11.xy = u_xlat11.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                u_xlat11.xy = clamp(u_xlat11.xy, 0.0, 1.0);
                u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu59)].xy * u_xlat11.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu59)].zw;
            } else {
                u_xlatb63 = u_xlati63==1;
                u_xlati63 = u_xlatb63 ? 1 : int(0);
                if(u_xlati63 != 0) {
                    u_xlat49.xy = vs_TEXCOORD7.yy * _AdditionalLightsWorldToLights[(u_xlati64 + 1) / 4][(u_xlati64 + 1) % 4].xy;
                    u_xlat49.xy = _AdditionalLightsWorldToLights[u_xlati64 / 4][u_xlati64 % 4].xy * vs_TEXCOORD7.xx + u_xlat49.xy;
                    u_xlat49.xy = _AdditionalLightsWorldToLights[(u_xlati64 + 2) / 4][(u_xlati64 + 2) % 4].xy * vs_TEXCOORD7.zz + u_xlat49.xy;
                    u_xlat49.xy = u_xlat49.xy + _AdditionalLightsWorldToLights[(u_xlati64 + 3) / 4][(u_xlati64 + 3) % 4].xy;
                    u_xlat49.xy = u_xlat49.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat49.xy = fract(u_xlat49.xy);
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu59)].xy * u_xlat49.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu59)].zw;
                } else {
                    u_xlat12 = vs_TEXCOORD7.yyyy * _AdditionalLightsWorldToLights[(u_xlati64 + 1) / 4][(u_xlati64 + 1) % 4];
                    u_xlat12 = _AdditionalLightsWorldToLights[u_xlati64 / 4][u_xlati64 % 4] * vs_TEXCOORD7.xxxx + u_xlat12;
                    u_xlat12 = _AdditionalLightsWorldToLights[(u_xlati64 + 2) / 4][(u_xlati64 + 2) % 4] * vs_TEXCOORD7.zzzz + u_xlat12;
                    u_xlat12 = u_xlat12 + _AdditionalLightsWorldToLights[(u_xlati64 + 3) / 4][(u_xlati64 + 3) % 4];
                    u_xlat12.xyz = u_xlat12.xyz / u_xlat12.www;
                    u_xlat63 = dot(u_xlat12.xyz, u_xlat12.xyz);
                    u_xlat63 = inversesqrt(u_xlat63);
                    u_xlat12.xyz = vec3(u_xlat63) * u_xlat12.xyz;
                    u_xlat63 = dot(abs(u_xlat12.xyz), vec3(1.0, 1.0, 1.0));
                    u_xlat63 = max(u_xlat63, 9.99999997e-07);
                    u_xlat63 = float(1.0) / float(u_xlat63);
                    u_xlat13.xyz = vec3(u_xlat63) * u_xlat12.zxy;
                    u_xlat13.x = (-u_xlat13.x);
                    u_xlat13.x = clamp(u_xlat13.x, 0.0, 1.0);
                    u_xlatb45.xy = greaterThanEqual(u_xlat13.yzyz, vec4(0.0, 0.0, 0.0, 0.0)).xy;
                    u_xlat45.x = (u_xlatb45.x) ? u_xlat13.x : (-u_xlat13.x);
                    u_xlat45.y = (u_xlatb45.y) ? u_xlat13.x : (-u_xlat13.x);
                    u_xlat45.xy = u_xlat12.xy * vec2(u_xlat63) + u_xlat45.xy;
                    u_xlat45.xy = u_xlat45.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
                    u_xlat45.xy = clamp(u_xlat45.xy, 0.0, 1.0);
                    u_xlat11.xy = _AdditionalLightsCookieAtlasUVRects[int(u_xlatu59)].xy * u_xlat45.xy + _AdditionalLightsCookieAtlasUVRects[int(u_xlatu59)].zw;
                }
            }
            ...
            u_xlat63 = (u_xlatb7.y) ? u_xlat11.w : u_xlat11.x;
            u_xlat11.xyz = (u_xlatb7.x) ? u_xlat11.xyz : vec3(u_xlat63);
        } else {
            u_xlat11.x = float(1.0);
            u_xlat11.y = float(1.0);
            u_xlat11.z = float(1.0);
        }
        u_xlat11.xyz = u_xlat11.xyz * _AdditionalLightsColor[int(u_xlatu59)].xyz;
        u_xlat11.xyz = vec3(u_xlat41) * u_xlat11.xyz;
        u_xlat59 = dot(u_xlat20.xyz, u_xlat10.xyz);
        u_xlat59 = clamp(u_xlat59, 0.0, 1.0);
        u_xlat59 = u_xlat59 * u_xlat61;
        u_xlat11.xyz = vec3(u_xlat59) * u_xlat11.xyz;
        u_xlat9.xyz = u_xlat9.xyz * vec3(u_xlat62) + u_xlat6.xyz;
        u_xlat59 = dot(u_xlat9.xyz, u_xlat9.xyz);
        u_xlat59 = max(u_xlat59, 1.17549435e-37);
        u_xlat59 = inversesqrt(u_xlat59);
        u_xlat9.xyz = vec3(u_xlat59) * u_xlat9.xyz;
        u_xlat59 = dot(u_xlat20.xyz, u_xlat9.xyz);
        u_xlat59 = clamp(u_xlat59, 0.0, 1.0);
        u_xlat61 = dot(u_xlat10.xyz, u_xlat9.xyz);
        u_xlat61 = clamp(u_xlat61, 0.0, 1.0);
        u_xlat59 = u_xlat59 * u_xlat59;
        u_xlat59 = u_xlat59 * u_xlat8.x + 1.00001001;
        u_xlat61 = u_xlat61 * u_xlat61;
        u_xlat59 = u_xlat59 * u_xlat59;
        u_xlat61 = max(u_xlat61, 0.100000001);
        u_xlat59 = u_xlat59 * u_xlat61;
        u_xlat59 = u_xlat22 * u_xlat59;
        u_xlat59 = u_xlat60 / u_xlat59;
        u_xlat9.xyz = u_xlat0.xyz * vec3(u_xlat59) + u_xlat4.xyz;
