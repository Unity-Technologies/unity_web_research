...
@group(0) @binding(26) var x_TerrainHeightmapTexture : texture_2d<f32>;

var<private> u_xlat1 : vec4<f32>;

@group(0) @binding(27) var x_TerrainNormalmapTexture : texture_2d<f32>;

var<private> u_xlat2 : vec3<f32>;

@group(1) @binding(6) var<uniform> x_262 : VGlobals;
...
fn main_1() {
  ...
  vs_TEXCOORD7 = vec3<f32>(x_447.x, x_447.y, x_447.z);
  vs_TEXCOORD6 = 0.0f;
