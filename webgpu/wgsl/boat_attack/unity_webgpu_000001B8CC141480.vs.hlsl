#line 1 "Hidden/Universal Render Pipeline/XR/XROcclusionMesh"
static const int XR_OCCLUSION_MESH_COMBINED = 0 ;
...
{
Varyings output ;
output . vertex = float4 ( input . vertex . xy * float2 ( 2.0f , - 2.0f ) + float2 ( - 1.0f , 1.0f ) , ( 1.0 ) , 1.0f ) ;
#line 38
return output ;
}
