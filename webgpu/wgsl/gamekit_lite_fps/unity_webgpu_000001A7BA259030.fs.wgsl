...
fn main_1() {
  ...
  let x_1217 : vec2<f32> = vs_TEXCOORD0;
  let x_1220 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1224 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1226 : vec2<f32> = ((x_1217 * vec2<f32>(x_1220.x, x_1220.y)) + vec2<f32>(x_1224.z, x_1224.w));
  let x_1227 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1226.x, x_1226.y, x_1227.z, x_1227.w);
  let x_1234 : vec4<f32> = u_xlat0;
  let x_1236 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1234.x, x_1234.y));
  u_xlat0.x = x_1236.w;
  let x_1240 : f32 = u_xlat0.x;
  u_xlat0.x = ((x_1240 * 2.0f) + -1.0f);
  let x_1246 : f32 = u_xlat0.x;
  u_xlat10.x = ((x_1246 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1252 : f32 = u_xlat10.x;
  u_xlat10.x = clamp(x_1252, 0.0f, 1.0f);
  let x_1256 : f32 = u_xlat10.x;
  u_xlat10.x = ((x_1256 * 2.0f) + -1.0f);
  let x_1261 : f32 = u_xlat0.x;
  u_xlat0.x = (-(abs(x_1261)) + 1.0f);
  let x_1267 : f32 = u_xlat0.x;
  u_xlat0.x = sqrt(x_1267);
  let x_1271 : f32 = u_xlat0.x;
  u_xlat0.x = (-(x_1271) + 1.0f);
  let x_1276 : f32 = u_xlat0.x;
  let x_1278 : f32 = u_xlat10.x;
  u_xlat0.x = (x_1276 * x_1278);
  let x_1281 : vec3<f32> = u_xlat2;
  u_xlat10 = (x_1281 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1285 : vec3<f32> = u_xlat2;
  u_xlat1 = max(abs(x_1285), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1289 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1289);
  let x_1291 : vec3<f32> = u_xlat1;
  u_xlat1 = (x_1291 * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1295 : vec3<f32> = u_xlat1;
  u_xlat1 = exp2(x_1295);
  let x_1297 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1297 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1309 : vec3<f32> = u_xlat2;
  let x_1312 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1309.x, x_1309.y, x_1309.z, x_1309.x));
  u_xlatb2 = vec3<bool>(x_1312.x, x_1312.y, x_1312.z);
  let x_1316 : vec3<f32> = u_xlat10;
  hlslcc_movcTemp = x_1316;
  let x_1318 : bool = u_xlatb2.x;
  if (x_1318) {
  ...
  hlslcc_movcTemp.x = x_1327;
  let x_1330 : bool = u_xlatb2.y;
  if (x_1330) {
    let x_1335 : f32 = u_xlat10.y;
    x_1331 = x_1335;
  } else {
    let x_1338 : f32 = u_xlat1.y;
    x_1331 = x_1338;
  }
  let x_1339 : f32 = x_1331;
  hlslcc_movcTemp.y = x_1339;
  let x_1342 : bool = u_xlatb2.z;
  if (x_1342) {
    let x_1347 : f32 = u_xlat10.z;
    x_1343 = x_1347;
  } else {
    let x_1350 : f32 = u_xlat1.z;
    x_1343 = x_1350;
  }
  let x_1351 : f32 = x_1343;
  hlslcc_movcTemp.z = x_1351;
  let x_1353 : vec3<f32> = hlslcc_movcTemp;
  u_xlat10 = x_1353;
  let x_1354 : vec4<f32> = u_xlat0;
  let x_1359 : vec3<f32> = u_xlat10;
  let x_1360 : vec3<f32> = ((vec3<f32>(x_1354.x, x_1354.x, x_1354.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1359);
  ...
  u_xlat2 = (vec3<f32>(x_1367.x, x_1367.y, x_1367.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1371 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1371 * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1374 : vec3<f32> = u_xlat2;
  u_xlat2 = max(abs(x_1374), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1377 : vec3<f32> = u_xlat2;
  u_xlat2 = log2(x_1377);
  let x_1379 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1379 * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  u_xlat3.x = x_1400;
  let x_1403 : bool = u_xlatb0.y;
  if (x_1403) {
    let x_1408 : f32 = u_xlat1.y;
    x_1404 = x_1408;
  } else {
    let x_1411 : f32 = u_xlat2.y;
    x_1404 = x_1411;
  }
  let x_1412 : f32 = x_1404;
  u_xlat3.y = x_1412;
  let x_1415 : bool = u_xlatb0.z;
  if (x_1415) {
    let x_1420 : f32 = u_xlat1.z;
    x_1416 = x_1420;
  } else {
    let x_1423 : f32 = u_xlat2.z;
    x_1416 = x_1423;
  }
