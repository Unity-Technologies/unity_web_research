...
layout(set = 0, binding = 13) uniform highp  sampler sampler_LightTexture0;
layout(set = 0, binding = 14) uniform highp  sampler sampler_LightTextureB0;
void main()
{
    ...
    if(u_xlatb36){
        ...
        u_xlat36 = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec0, 0.0);
        vec3 txVec1 = vec3(u_xlat9.zw,u_xlat5.z);
        u_xlat5.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec1, 0.0);
        ...
        u_xlat5.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec2, 0.0);
        u_xlat36 = u_xlat8.z * u_xlat5.x + u_xlat36;
        vec3 txVec3 = vec3(u_xlat6.zw,u_xlat5.z);
        u_xlat5.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec3, 0.0);
    ...
    u_xlat36 = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat5.xy).w;
    u_xlat35 = u_xlat35 * u_xlat36;
    u_xlat36 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat36 = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), vec2(u_xlat36)).x;
    u_xlat35 = u_xlat35 * u_xlat36;
    ...
    u_xlat11 = (-u_xlat0.y) * _GlossMapScale + 1.0;
    ...
    u_xlat24 = dot(vec2(u_xlat24), vec2(u_xlat11));
    ...
    u_xlat1.xyz = u_xlat4.xyz * vec3(u_xlat11) + u_xlat1.xyz;
