...
float2 _LightCoord : TEXCOORD6 ; float4 _ShadowCoord : TEXCOORD7 ;
#line 371
} ;
...
#line 410
o . _LightCoord = mul ( unity_WorldToLight , mul ( unity_ObjectToWorld , v . vertex ) ) . xy ; o . _ShadowCoord = ComputeScreenPos ( o . pos ) ; ;
...
float2 lightCoord = mul ( unity_WorldToLight , float4 ( s . posWorld , 1 ) ) . xy ; float shadow = UnityComputeForwardShadows ( 0 , s . posWorld , i . _ShadowCoord ) ; float atten = tex2D ( _LightTexture0 , lightCoord ) . w * shadow ; ;
