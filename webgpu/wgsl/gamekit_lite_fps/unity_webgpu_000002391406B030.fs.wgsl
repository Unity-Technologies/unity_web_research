...
fn main_1() {
  ...
  let x_580 : vec3<f32> = x_31.x_Bloom_Settings;
  ...
  let x_593 : vec3<f32> = x_31.x_Bloom_Color;
  ...
  u_xlat0 = (x_612 + x_613);
  let x_618 : f32 = x_31.x_Vignette_Mode;
  u_xlatb1 = (x_618 < 0.5f);
  let x_620 : bool = u_xlatb1;
  if (x_620) {
    let x_623 : vec2<f32> = u_xlat14;
    let x_627 : vec2<f32> = x_31.x_Vignette_Center;
    ...
    let x_637 : vec4<f32> = x_31.x_Vignette_Settings;
    ...
    let x_645 : f32 = x_31.x_ScreenParams.x;
    let x_647 : f32 = x_31.x_ScreenParams.y;
    u_xlat19 = (x_645 / x_647);
    let x_649 : f32 = u_xlat19;
    u_xlat19 = (x_649 + -1.0f);
    let x_652 : f32 = x_31.x_Vignette_Settings.w;
    ...
    let x_681 : vec4<f32> = x_31.x_Vignette_Settings;
    ...
    let x_713 : f32 = x_31.x_Vignette_Settings.y;
    u_xlat1.x = (x_711 * x_713);
    let x_717 : f32 = u_xlat1.x;
    u_xlat1.x = exp2(x_717);
    let x_723 : vec3<f32> = x_31.x_Vignette_Color;
    ...
    let x_805 : vec3<f32> = x_31.x_Vignette_Color;
    ...
    let x_817 : f32 = x_31.x_Vignette_Opacity;
  ...
  let x_843 : vec4<f32> = x_31.x_Grain_Params2;
  ...
  u_xlat18 = sqrt(x_871);
  let x_875 : f32 = x_31.x_Grain_Params1.x;
  ...
  let x_891 : f32 = x_31.x_Grain_Params1.y;
  let x_893 : f32 = x_31.x_Grain_Params1.y;
  ...
  let x_910 : f32 = x_31.x_PostExposure;
  let x_912 : f32 = x_31.x_PostExposure;
  let x_914 : f32 = x_31.x_PostExposure;
  let x_916 : f32 = x_31.x_PostExposure;
  ...
  let x_960 : vec3<f32> = x_31.x_Lut2D_Params;
  ...
  u_xlat6 = floor(x_966);
  let x_969 : vec3<f32> = x_31.x_Lut2D_Params;
  ...
  let x_978 : vec3<f32> = x_31.x_Lut2D_Params;
  ...
  let x_988 : f32 = x_31.x_Lut2D_Params.y;
  ...
  let x_1004 : f32 = x_31.x_Lut2D_Params.y;
  u_xlat3.x = x_1004;
  u_xlat3.y = 0.0f;
  ...
  let x_1026 : f32 = x_31.x_Lut2D_Params.z;
  ...
  let x_1052 : vec4<f32> = x_31.x_Dithering_Coords;
  let x_1056 : vec4<f32> = x_31.x_Dithering_Coords;
