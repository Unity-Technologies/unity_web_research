...
fn main_1() {
  ...
  let x_1396 : vec3<f32> = vec3<f32>(x_1395.x, x_1395.y, x_1395.z);
  let x_1397 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1396.x, x_1396.y, x_1396.z, x_1397.w);
  let x_1399 : vec4<f32> = u_xlat1;
  let x_1403 : vec3<f32> = clamp(vec3<f32>(x_1399.x, x_1399.y, x_1399.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1404 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1403.x, x_1403.y, x_1403.z, x_1404.w);
  let x_1407 : vec4<f32> = u_xlat1;
  u_xlat30 = dot(vec3<f32>(x_1407.x, x_1407.y, x_1407.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1414 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1414);
  let x_1418 : f32 = x_26.x_Grain_Params1.x;
  let x_1419 : f32 = u_xlat30;
  u_xlat30 = ((x_1418 * -(x_1419)) + 1.0f);
  let x_1423 : vec4<f32> = u_xlat0;
  let x_1425 : vec4<f32> = u_xlat2;
  let x_1427 : vec3<f32> = (vec3<f32>(x_1423.x, x_1423.y, x_1423.z) * vec3<f32>(x_1425.x, x_1425.y, x_1425.z));
  let x_1428 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1427.x, x_1427.y, x_1427.z, x_1428.w);
  let x_1430 : vec4<f32> = u_xlat0;
  let x_1433 : f32 = x_26.x_Grain_Params1.y;
  let x_1435 : f32 = x_26.x_Grain_Params1.y;
  let x_1437 : f32 = x_26.x_Grain_Params1.y;
  let x_1439 : vec3<f32> = (vec3<f32>(x_1430.x, x_1430.y, x_1430.z) * vec3<f32>(x_1433, x_1435, x_1437));
  ...
  let x_1449 : vec3<f32> = ((vec3<f32>(x_1442.x, x_1442.y, x_1442.z) * vec3<f32>(x_1444, x_1444, x_1444)) + vec3<f32>(x_1447.x, x_1447.y, x_1447.z));
  let x_1450 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_1449.x, x_1449.y, x_1449.z, x_1450.w);
  let x_1452 : vec4<f32> = u_xlat3;
  let x_1455 : f32 = x_26.x_PostExposure;
  let x_1457 : f32 = x_26.x_PostExposure;
  let x_1459 : f32 = x_26.x_PostExposure;
  let x_1461 : f32 = x_26.x_PostExposure;
  let x_1462 : vec4<f32> = vec4<f32>(x_1455, x_1457, x_1459, x_1461);
  u_xlat0 = (x_1452 * vec4<f32>(x_1462.x, x_1462.y, x_1462.z, x_1462.w));
  let x_1469 : vec4<f32> = u_xlat0;
  let x_1476 : vec3<f32> = ((vec3<f32>(x_1469.z, x_1469.x, x_1469.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1477 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1476.x, x_1476.y, x_1476.z, x_1477.w);
  let x_1479 : vec4<f32> = u_xlat0;
  let x_1481 : vec3<f32> = log2(vec3<f32>(x_1479.x, x_1479.y, x_1479.z));
  let x_1482 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1481.x, x_1481.y, x_1481.z, x_1482.w);
  let x_1484 : vec4<f32> = u_xlat0;
  let x_1491 : vec3<f32> = ((vec3<f32>(x_1484.x, x_1484.y, x_1484.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1492 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1491.x, x_1491.y, x_1491.z, x_1492.w);
  let x_1494 : vec4<f32> = u_xlat0;
  let x_1498 : vec3<f32> = clamp(vec3<f32>(x_1494.x, x_1494.y, x_1494.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1499 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1498.x, x_1498.y, x_1498.z, x_1499.w);
  let x_1501 : vec4<f32> = u_xlat0;
  let x_1505 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1507 : vec3<f32> = (vec3<f32>(x_1501.x, x_1501.y, x_1501.z) * vec3<f32>(x_1505.z, x_1505.z, x_1505.z));
  let x_1508 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1507.x, x_1507.y, x_1507.z, x_1508.w);
  let x_1512 : f32 = u_xlat1.x;
  u_xlat10 = floor(x_1512);
  let x_1515 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1517 : vec2<f32> = (vec2<f32>(x_1515.x, x_1515.y) * vec2<f32>(0.5f, 0.5f));
  let x_1518 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1517.x, x_1518.y, x_1518.z, x_1517.y);
  let x_1520 : vec4<f32> = u_xlat1;
  let x_1523 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1526 : vec4<f32> = u_xlat1;
  let x_1528 : vec2<f32> = ((vec2<f32>(x_1520.y, x_1520.z) * vec2<f32>(x_1523.x, x_1523.y)) + vec2<f32>(x_1526.x, x_1526.w));
  let x_1529 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1529.x, x_1528.x, x_1528.y, x_1529.w);
  let x_1531 : f32 = u_xlat10;
  let x_1533 : f32 = x_26.x_Lut2D_Params.y;
  let x_1536 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1531 * x_1533) + x_1536);
  let x_1544 : vec4<f32> = u_xlat1;
  let x_1546 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1544.x, x_1544.z));
  let x_1547 : vec3<f32> = vec3<f32>(x_1546.x, x_1546.y, x_1546.z);
  let x_1548 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1547.x, x_1547.y, x_1547.z, x_1548.w);
  let x_1551 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat3.x = x_1551;
  u_xlat3.y = 0.0f;
  let x_1554 : vec4<f32> = u_xlat1;
  let x_1556 : vec4<f32> = u_xlat3;
  let x_1558 : vec2<f32> = (vec2<f32>(x_1554.x, x_1554.z) + vec2<f32>(x_1556.x, x_1556.y));
  let x_1559 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1558.x, x_1558.y, x_1559.z, x_1559.w);
  let x_1564 : vec4<f32> = u_xlat1;
  let x_1566 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1564.x, x_1564.y));
  let x_1567 : vec3<f32> = vec3<f32>(x_1566.x, x_1566.y, x_1566.z);
  let x_1568 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1567.x, x_1567.y, x_1567.z, x_1568.w);
  let x_1571 : f32 = u_xlat0.x;
  let x_1573 : f32 = x_26.x_Lut2D_Params.z;
  let x_1575 : f32 = u_xlat10;
  u_xlat0.x = ((x_1571 * x_1573) + -(x_1575));
  let x_1579 : vec4<f32> = u_xlat2;
  let x_1582 : vec4<f32> = u_xlat1;
  let x_1584 : vec3<f32> = (-(vec3<f32>(x_1579.x, x_1579.y, x_1579.z)) + vec3<f32>(x_1582.x, x_1582.y, x_1582.z));
  ...
  let x_1594 : vec3<f32> = ((vec3<f32>(x_1587.x, x_1587.x, x_1587.x) * vec3<f32>(x_1589.x, x_1589.y, x_1589.z)) + vec3<f32>(x_1592.x, x_1592.y, x_1592.z));
  let x_1595 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1594.x, x_1594.y, x_1594.z, x_1595.w);
  let x_1597 : vec2<f32> = vs_TEXCOORD0;
  let x_1600 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1604 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1606 : vec2<f32> = ((x_1597 * vec2<f32>(x_1600.x, x_1600.y)) + vec2<f32>(x_1604.z, x_1604.w));
  let x_1607 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1606.x, x_1606.y, x_1607.z, x_1607.w);
  let x_1614 : vec4<f32> = u_xlat1;
  let x_1616 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1614.x, x_1614.y));
  u_xlat1.x = x_1616.w;
  let x_1620 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1620 * 2.0f) + -1.0f);
  let x_1625 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1625 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1631 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1631, 0.0f, 1.0f);
  let x_1635 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1635 * 2.0f) + -1.0f);
  let x_1640 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1640)) + 1.0f);
  let x_1646 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1646);
  let x_1650 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1650) + 1.0f);
  let x_1655 : f32 = u_xlat1.x;
  let x_1657 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1655 * x_1657);
  let x_1660 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1660.x, x_1660.y, x_1660.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1665 : vec4<f32> = u_xlat0;
  let x_1669 : vec3<f32> = max(abs(vec3<f32>(x_1665.x, x_1665.y, x_1665.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1707 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1704.x, x_1704.y, x_1704.z, x_1704.x));
  u_xlatb0 = vec3<bool>(x_1707.x, x_1707.y, x_1707.z);
  let x_1710 : bool = u_xlatb0.x;
  if (x_1710) {
  ...
  u_xlat0.y = x_1731;
  let x_1734 : bool = u_xlatb0.z;
  if (x_1734) {
    let x_1739 : f32 = u_xlat11.z;
    x_1735 = x_1739;
  } else {
    let x_1742 : f32 = u_xlat2.z;
    x_1735 = x_1742;
  }
  ...
  let x_1752 : vec3<f32> = ((vec3<f32>(x_1745.x, x_1745.x, x_1745.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1750.x, x_1750.y, x_1750.z));
  let x_1753 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1752.x, x_1752.y, x_1752.z, x_1753.w);
  let x_1755 : vec4<f32> = u_xlat0;
  let x_1758 : vec3<f32> = (vec3<f32>(x_1755.x, x_1755.y, x_1755.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1759 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1758.x, x_1758.y, x_1758.z, x_1759.w);
  let x_1761 : vec4<f32> = u_xlat0;
  let x_1764 : vec3<f32> = (vec3<f32>(x_1761.x, x_1761.y, x_1761.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1765 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1764.x, x_1764.y, x_1764.z, x_1765.w);
  let x_1767 : vec4<f32> = u_xlat2;
  let x_1770 : vec3<f32> = (vec3<f32>(x_1767.x, x_1767.y, x_1767.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1771 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1770.x, x_1770.y, x_1770.z, x_1771.w);
  let x_1773 : vec4<f32> = u_xlat2;
  let x_1776 : vec3<f32> = max(abs(vec3<f32>(x_1773.x, x_1773.y, x_1773.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1777 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1776.x, x_1776.y, x_1776.z, x_1777.w);
  let x_1779 : vec4<f32> = u_xlat2;
  let x_1781 : vec3<f32> = log2(vec3<f32>(x_1779.x, x_1779.y, x_1779.z));
  let x_1782 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1781.x, x_1781.y, x_1781.z, x_1782.w);
  let x_1784 : vec4<f32> = u_xlat2;
  let x_1787 : vec3<f32> = (vec3<f32>(x_1784.x, x_1784.y, x_1784.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1788 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1787.x, x_1787.y, x_1787.z, x_1788.w);
  let x_1790 : vec4<f32> = u_xlat2;
  let x_1792 : vec3<f32> = exp2(vec3<f32>(x_1790.x, x_1790.y, x_1790.z));
  let x_1793 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1792.x, x_1792.y, x_1792.z, x_1793.w);
  let x_1796 : vec4<f32> = u_xlat0;
  let x_1798 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1796.x, x_1796.y, x_1796.z, x_1796.x));
  u_xlatb0 = vec3<bool>(x_1798.x, x_1798.y, x_1798.z);
  let x_1803 : bool = u_xlatb0.x;
  if (x_1803) {
    let x_1808 : f32 = u_xlat1.x;
    x_1804 = x_1808;
  } else {
    let x_1811 : f32 = u_xlat2.x;
    x_1804 = x_1811;
  }
