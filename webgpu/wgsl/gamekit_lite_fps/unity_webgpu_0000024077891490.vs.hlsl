#line 1 "Hidden/PostProcessing/MultiScaleVO"
...
#line 4 "F:/src/Graphics/com.unity.postprocessing/PostProcessing/Shaders/Builtins/Fog.hlsl"
half4 _FogColor ;
float3 _FogParams ;
#line 11
...
Texture2D _MSVOcclusionTexture ; SamplerState sampler_MSVOcclusionTexture ;
float3 _AOColor ;
#line 77 ""
float4 Frag ( VaryingsDefault i ) : SV_Target
{
half ao = 1.0 - _MSVOcclusionTexture . Sample ( sampler_MSVOcclusionTexture , i . texcoordStereo ) . r ;
#line 83
float d = Linear01Depth ( _CameraDepthTexture . Sample ( sampler_CameraDepthTexture , i . texcoordStereo ) . r ) ;
