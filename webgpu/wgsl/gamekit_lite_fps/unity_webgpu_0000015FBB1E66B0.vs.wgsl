...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_152.y, x_152.y, x_152.y, x_152.y) * x_155);
  let x_158 : vec4<f32> = x_17.unity_WorldToLight[0i];
  let x_159 : vec4<f32> = u_xlat0;
  let x_162 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_158 * vec4<f32>(x_159.x, x_159.x, x_159.x, x_159.x)) + x_162);
  let x_165 : vec4<f32> = x_17.unity_WorldToLight[2i];
  let x_166 : vec4<f32> = u_xlat0;
  let x_169 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_165 * vec4<f32>(x_166.z, x_166.z, x_166.z, x_166.z)) + x_169);
  let x_173 : vec4<f32> = x_17.unity_WorldToLight[3i];
  let x_174 : vec4<f32> = u_xlat0;
  let x_177 : vec4<f32> = u_xlat1;
  vs_TEXCOORD3 = ((x_173 * vec4<f32>(x_174.w, x_174.w, x_174.w, x_174.w)) + x_177);
