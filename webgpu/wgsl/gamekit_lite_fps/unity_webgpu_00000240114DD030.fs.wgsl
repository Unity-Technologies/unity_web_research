...
fn main_1() {
  ...
  let x_698 : vec3<f32> = x_31.x_Lut2D_Params;
  ...
  u_xlat5 = floor(x_704);
  let x_707 : vec3<f32> = x_31.x_Lut2D_Params;
  ...
  let x_716 : vec3<f32> = x_31.x_Lut2D_Params;
  ...
  let x_726 : f32 = x_31.x_Lut2D_Params.y;
  ...
  let x_744 : f32 = x_31.x_Lut2D_Params.y;
  u_xlat3.x = x_744;
  u_xlat3.y = 0.0f;
  ...
  let x_766 : f32 = x_31.x_Lut2D_Params.z;
  ...
  let x_880 : vec4<f32> = x_31.x_Dithering_Coords;
  let x_884 : vec4<f32> = x_31.x_Dithering_Coords;
