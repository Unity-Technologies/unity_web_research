...
fn main_1() {
  ...
  let x_1203 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1203);
  let x_1205 : bool = u_xlatb1;
  if (x_1205) {
    ...
    let x_1216 : vec3<f32> = clamp(vec3<f32>(x_1212.x, x_1212.y, x_1212.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1217 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1216.x, x_1216.y, x_1216.z, x_1217.w);
    let x_1219 : vec4<f32> = u_xlat1;
    u_xlat0.w = dot(vec3<f32>(x_1219.x, x_1219.y, x_1219.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
