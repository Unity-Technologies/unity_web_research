...
float4 fragmentMix ( v2f i ) : COLOR
{
float4 mainCol = tex2D ( _MainTex , i . texcoord ) ;
float4 secondCol = tex2D ( _SecondTex , i . texcoord ) ;

return float4 ( _AlphaParam * mainCol . a * mainCol . rgb + _SecondAlphaParam * secondCol . a * secondCol . rgb , 1.0f ) ;
}
