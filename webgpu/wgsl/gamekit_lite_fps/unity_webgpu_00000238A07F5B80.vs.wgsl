...
fn main_1() {
  ...
  let x_168 : vec4<f32> = x_17.unity_WorldToLight[2i];
  let x_169 : vec4<f32> = u_xlat0;
  let x_172 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_168 * vec4<f32>(x_169.z, x_169.z, x_169.z, x_169.z)) + x_172);
  let x_176 : vec4<f32> = x_17.unity_WorldToLight[3i];
  let x_177 : vec4<f32> = u_xlat0;
  let x_180 : vec4<f32> = u_xlat1;
  vs_TEXCOORD3 = ((x_176 * vec4<f32>(x_177.w, x_177.w, x_177.w, x_177.w)) + x_180);
