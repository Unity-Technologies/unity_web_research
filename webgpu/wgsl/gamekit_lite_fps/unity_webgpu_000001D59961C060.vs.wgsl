...
fn main_1() {
  ...
  let x_383 : f32 = u_xlat3.y;
  u_xlat0.x = (x_381 * x_383);
  let x_387 : f32 = u_xlat3.x;
  let x_389 : f32 = u_xlat3.x;
  let x_392 : f32 = u_xlat0.x;
  u_xlat0.x = ((x_387 * x_389) + -(x_392));
  let x_396 : vec4<f32> = u_xlat3;
  let x_398 : vec4<f32> = u_xlat3;
  u_xlat1 = (vec4<f32>(x_396.y, x_396.w, x_396.z, x_396.x) * x_398);
  let x_401 : vec4<f32> = x_17.unity_SHBr;
  let x_402 : vec4<f32> = u_xlat1;
  u_xlat2.x = dot(x_401, x_402);
  let x_406 : vec4<f32> = x_17.unity_SHBg;
  let x_407 : vec4<f32> = u_xlat1;
  u_xlat2.y = dot(x_406, x_407);
  let x_411 : vec4<f32> = x_17.unity_SHBb;
  let x_412 : vec4<f32> = u_xlat1;
  u_xlat2.z = dot(x_411, x_412);
  let x_419 : vec4<f32> = x_17.unity_SHC;
  let x_421 : vec4<f32> = u_xlat0;
  let x_424 : vec4<f32> = u_xlat2;
  vs_TEXCOORD7 = ((vec3<f32>(x_419.x, x_419.y, x_419.z) * vec3<f32>(x_421.x, x_421.x, x_421.x)) + vec3<f32>(x_424.x, x_424.y, x_424.z));
  return;
}
