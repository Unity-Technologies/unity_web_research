#line 1 "TextMeshPro/Distance Field (Surface)"
...
#line 2 "Assets/3DGamekitLite/Packages/TextMesh Pro/Resources/Shaders/TMPro_Properties.cginc"
...
#line 1 "Assets/3DGamekitLite/Packages/TextMesh Pro/Resources/Shaders/TMPro.cginc"
...
#line 1 "Assets/3DGamekitLite/Packages/TextMesh Pro/Resources/Shaders/TMPro_Surface.cginc"
...
n = normalize ( n - bump ) ;
#line 91
float4 reflcol = texCUBE ( _Cube , reflect ( input . viewDirEnv , mul ( ( float3x3 ) unity_ObjectToWorld , n ) ) ) ;
...
float4 color : COLOR0 ;
float2 custompack0 : TEXCOORD6 ;
float3 custompack1 : TEXCOORD7 ;
