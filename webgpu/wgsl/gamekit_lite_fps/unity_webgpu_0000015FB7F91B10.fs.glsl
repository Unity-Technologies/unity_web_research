...
layout(set = 0, binding = 1) uniform mediump textureCube _TexA;
layout(set = 0, binding = 2) uniform mediump textureCube _TexB;
layout(location = 0) in highp vec3 vs_TEXCOORD0;
layout(location = 0) out highp vec4 SV_Target0;
vec4 u_xlat0;
vec4 u_xlat1;
float u_xlat6;
layout(set = 0, binding = 3) uniform mediump  sampler sampler_TexA;
layout(set = 0, binding = 4) uniform mediump  sampler sampler_TexB;
void main()
{
