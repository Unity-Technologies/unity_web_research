...
fn main_1() {
  ...
  let x_1293 : f32 = x_26.x_PostExposure;
  let x_1295 : f32 = x_26.x_PostExposure;
  let x_1297 : f32 = x_26.x_PostExposure;
  let x_1299 : f32 = x_26.x_PostExposure;
  let x_1300 : vec4<f32> = vec4<f32>(x_1293, x_1295, x_1297, x_1299);
  u_xlat0 = (vec4<f32>(x_1289.w, x_1289.x, x_1289.y, x_1289.z) * vec4<f32>(x_1300.x, x_1300.y, x_1300.z, x_1300.w));
  let x_1307 : vec4<f32> = u_xlat0;
  u_xlat1 = ((vec3<f32>(x_1307.y, x_1307.z, x_1307.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1315 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1315);
  let x_1317 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1317 * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1324 : vec3<f32> = u_xlat1;
  u_xlat1 = clamp(x_1324, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1328 : vec3<f32> = u_xlat1;
  let x_1331 : vec2<f32> = x_26.x_Lut3D_Params;
  u_xlat1 = (x_1328 * vec3<f32>(x_1331.y, x_1331.y, x_1331.y));
  let x_1335 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat31 = (x_1335 * 0.5f);
  let x_1337 : vec3<f32> = u_xlat1;
  let x_1339 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1342 : f32 = u_xlat31;
  u_xlat1 = ((x_1337 * vec3<f32>(x_1339.x, x_1339.x, x_1339.x)) + vec3<f32>(x_1342, x_1342, x_1342));
  let x_1353 : vec3<f32> = u_xlat1;
  let x_1354 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, x_1353);
  let x_1355 : vec3<f32> = vec3<f32>(x_1354.x, x_1354.y, x_1354.z);
  let x_1356 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1356.x, x_1355.x, x_1355.y, x_1355.z);
  let x_1360 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1360);
  let x_1362 : bool = u_xlatb1;
  if (x_1362) {
    let x_1365 : vec4<f32> = u_xlat0;
    u_xlat1 = vec3<f32>(x_1365.y, x_1365.z, x_1365.w);
    let x_1367 : vec3<f32> = u_xlat1;
    u_xlat1 = clamp(x_1367, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1371 : vec3<f32> = u_xlat1;
    u_xlat0.x = dot(x_1371, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1376 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1376.y, x_1376.z, x_1376.w, x_1376.x);
  return;
}
