...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_146.y, x_146.y, x_146.y, x_146.y) * x_149);
  let x_152 : vec4<f32> = x_30.unity_WorldToLight[0i];
  let x_153 : vec4<f32> = u_xlat0;
  let x_156 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_152 * vec4<f32>(x_153.x, x_153.x, x_153.x, x_153.x)) + x_156);
  let x_159 : vec4<f32> = x_30.unity_WorldToLight[2i];
  let x_160 : vec4<f32> = u_xlat0;
  let x_163 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_159 * vec4<f32>(x_160.z, x_160.z, x_160.z, x_160.z)) + x_163);
  let x_167 : vec4<f32> = x_30.unity_WorldToLight[3i];
  let x_168 : vec4<f32> = u_xlat0;
  let x_171 : vec4<f32> = u_xlat1;
  vs_TEXCOORD2 = ((x_167 * vec4<f32>(x_168.w, x_168.w, x_168.w, x_168.w)) + x_171);
