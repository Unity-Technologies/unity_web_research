...
#line 65 "Packages/com.unity.postprocessing/PostProcessing/Shaders/Builtins/MultiScaleVORender.compute"
Texture2DArray < float > DepthTex ;
#line 71
RWTexture2D < float > Occlusion ;
#line 74
groupshared float DepthSamples [ 16 * 16 ] ;
#line 77
...
#line 207
[ numthreads ( 8 , 8 , 1 ) ]
void MultiScaleVORender_interleaved ( uint3 Gid : SV_GroupID , uint GI : SV_GroupIndex , uint3 GTid : SV_GroupThreadID , uint3 DTid : SV_DispatchThreadID )
{
#line 213
...
DepthSamples [ destIdx + 16 ] = depths . x ;
DepthSamples [ destIdx + 16 + 1 ] = depths . y ;
#line 243
