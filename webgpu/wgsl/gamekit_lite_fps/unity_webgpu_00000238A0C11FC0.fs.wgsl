...
fn main_1() {
  ...
  let x_1232 : vec3<f32> = ((vec3<f32>(x_1225.x, x_1225.y, x_1225.z) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1262 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1264 : vec3<f32> = (vec3<f32>(x_1257.x, x_1257.y, x_1257.z) * vec3<f32>(x_1262.y, x_1262.y, x_1262.y));
  let x_1265 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1264.x, x_1264.y, x_1264.z, x_1265.w);
  let x_1268 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat1.x = (x_1268 * 0.5f);
  let x_1271 : vec4<f32> = u_xlat0;
  let x_1274 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1277 : vec4<f32> = u_xlat1;
  let x_1279 : vec3<f32> = ((vec3<f32>(x_1271.x, x_1271.y, x_1271.z) * vec3<f32>(x_1274.x, x_1274.x, x_1274.x)) + vec3<f32>(x_1277.x, x_1277.x, x_1277.x));
  let x_1280 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1279.x, x_1279.y, x_1279.z, x_1280.w);
  let x_1290 : vec4<f32> = u_xlat0;
  let x_1292 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1290.x, x_1290.y, x_1290.z));
  let x_1293 : vec3<f32> = vec3<f32>(x_1292.x, x_1292.y, x_1292.z);
  let x_1294 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1293.x, x_1293.y, x_1293.z, x_1294.w);
  let x_1296 : vec2<f32> = vs_TEXCOORD0;
  let x_1299 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1303 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1305 : vec2<f32> = ((x_1296 * vec2<f32>(x_1299.x, x_1299.y)) + vec2<f32>(x_1303.z, x_1303.w));
  let x_1306 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1305.x, x_1305.y, x_1306.z, x_1306.w);
  let x_1313 : vec4<f32> = u_xlat1;
  let x_1315 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1313.x, x_1313.y));
  u_xlat1.x = x_1315.w;
  let x_1319 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1319 * 2.0f) + -1.0f);
  let x_1324 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1324 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1330 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1330, 0.0f, 1.0f);
  let x_1334 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1334 * 2.0f) + -1.0f);
  let x_1339 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1339)) + 1.0f);
  let x_1345 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1345);
  let x_1349 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1349) + 1.0f);
  let x_1354 : f32 = u_xlat1.x;
  let x_1356 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1354 * x_1356);
  let x_1359 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1359.x, x_1359.y, x_1359.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1364 : vec4<f32> = u_xlat0;
  let x_1369 : vec3<f32> = max(abs(vec3<f32>(x_1364.x, x_1364.y, x_1364.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1407 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1404.x, x_1404.y, x_1404.z, x_1404.x));
  u_xlatb0 = vec3<bool>(x_1407.x, x_1407.y, x_1407.z);
  let x_1410 : bool = u_xlatb0.x;
  if (x_1410) {
    let x_1415 : f32 = u_xlat11.x;
    x_1411 = x_1415;
  } else {
  ...
  let x_1453 : vec3<f32> = ((vec3<f32>(x_1446.x, x_1446.x, x_1446.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1451.x, x_1451.y, x_1451.z));
  let x_1454 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1453.x, x_1453.y, x_1453.z, x_1454.w);
  let x_1456 : vec4<f32> = u_xlat0;
  let x_1460 : vec3<f32> = (vec3<f32>(x_1456.x, x_1456.y, x_1456.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1461 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1460.x, x_1460.y, x_1460.z, x_1461.w);
  let x_1463 : vec4<f32> = u_xlat0;
  let x_1467 : vec3<f32> = (vec3<f32>(x_1463.x, x_1463.y, x_1463.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1468 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1467.x, x_1467.y, x_1467.z, x_1468.w);
  let x_1470 : vec4<f32> = u_xlat2;
  let x_1474 : vec3<f32> = (vec3<f32>(x_1470.x, x_1470.y, x_1470.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1475 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1474.x, x_1474.y, x_1474.z, x_1475.w);
  let x_1477 : vec4<f32> = u_xlat2;
  let x_1480 : vec3<f32> = max(abs(vec3<f32>(x_1477.x, x_1477.y, x_1477.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1481 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1480.x, x_1480.y, x_1480.z, x_1481.w);
  let x_1483 : vec4<f32> = u_xlat2;
  let x_1485 : vec3<f32> = log2(vec3<f32>(x_1483.x, x_1483.y, x_1483.z));
  let x_1486 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1485.x, x_1485.y, x_1485.z, x_1486.w);
  let x_1488 : vec4<f32> = u_xlat2;
  let x_1492 : vec3<f32> = (vec3<f32>(x_1488.x, x_1488.y, x_1488.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1493 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1492.x, x_1492.y, x_1492.z, x_1493.w);
  let x_1495 : vec4<f32> = u_xlat2;
  let x_1497 : vec3<f32> = exp2(vec3<f32>(x_1495.x, x_1495.y, x_1495.z));
  let x_1498 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1497.x, x_1497.y, x_1497.z, x_1498.w);
  let x_1502 : vec4<f32> = u_xlat0;
  let x_1504 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1502.x, x_1502.y, x_1502.z, x_1502.x));
  u_xlatb0 = vec3<bool>(x_1504.x, x_1504.y, x_1504.z);
  ...
  SV_Target0.x = x_1518;
  let x_1522 : bool = u_xlatb0.y;
  if (x_1522) {
    let x_1527 : f32 = u_xlat1.y;
    x_1523 = x_1527;
  } else {
    let x_1530 : f32 = u_xlat2.y;
    x_1523 = x_1530;
  }
  let x_1531 : f32 = x_1523;
  SV_Target0.y = x_1531;
  let x_1534 : bool = u_xlatb0.z;
  if (x_1534) {
    let x_1539 : f32 = u_xlat1.z;
    x_1535 = x_1539;
  } else {
