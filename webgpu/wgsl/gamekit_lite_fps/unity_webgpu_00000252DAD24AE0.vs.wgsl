...
fn main_1() {
  ...
  let x_411 : vec4<f32> = x_18.unity_WorldToLight[3i];
  let x_413 : vec4<f32> = u_xlat0;
  let x_416 : vec4<f32> = u_xlat0;
  vs_TEXCOORD6 = ((vec3<f32>(x_411.x, x_411.y, x_411.z) * vec3<f32>(x_413.w, x_413.w, x_413.w)) + vec3<f32>(x_416.x, x_416.y, x_416.z));
