...
fn main_1() {
  ...
  u_xlat1 = vec4<f32>(x_1237.x, x_1237.y, x_1237.z, x_1238.w);
  ...
  u_xlat11 = (vec3<f32>(x_1257.x, x_1257.y, x_1257.z) * vec3<f32>(x_1261.z, x_1261.z, x_1261.z));
  let x_1265 : f32 = u_xlat11.x;
  u_xlat11.x = floor(x_1265);
  let x_1269 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1271 : vec2<f32> = (vec2<f32>(x_1269.x, x_1269.y) * vec2<f32>(0.5f, 0.5f));
  let x_1272 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1271.x, x_1271.y, x_1272.z, x_1272.w);
  let x_1274 : vec3<f32> = u_xlat11;
  let x_1277 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1280 : vec4<f32> = u_xlat2;
  let x_1282 : vec2<f32> = ((vec2<f32>(x_1274.y, x_1274.z) * vec2<f32>(x_1277.x, x_1277.y)) + vec2<f32>(x_1280.x, x_1280.y));
  let x_1283 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1283.x, x_1282.x, x_1282.y, x_1283.w);
  let x_1286 : f32 = u_xlat11.x;
  let x_1288 : f32 = x_26.x_Lut2D_Params.y;
  let x_1291 : f32 = u_xlat2.y;
  u_xlat2.x = ((x_1286 * x_1288) + x_1291);
  let x_1299 : vec4<f32> = u_xlat2;
  let x_1301 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1299.x, x_1299.z));
  ...
  let x_1306 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat4.x = x_1306;
  u_xlat4.y = 0.0f;
  let x_1309 : vec4<f32> = u_xlat2;
  let x_1311 : vec4<f32> = u_xlat4;
  u_xlat21 = (vec2<f32>(x_1309.x, x_1309.z) + vec2<f32>(x_1311.x, x_1311.y));
  let x_1317 : vec2<f32> = u_xlat21;
  let x_1318 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, x_1317);
  let x_1319 : vec3<f32> = vec3<f32>(x_1318.x, x_1318.y, x_1318.z);
  let x_1320 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1319.x, x_1319.y, x_1319.z, x_1320.w);
  let x_1323 : f32 = u_xlat1.x;
  let x_1326 : f32 = x_26.x_Lut2D_Params.z;
  let x_1329 : f32 = u_xlat11.x;
  u_xlat1.x = ((x_1323 * x_1326) + -(x_1329));
  let x_1333 : vec4<f32> = u_xlat3;
  let x_1336 : vec4<f32> = u_xlat2;
  u_xlat11 = (-(vec3<f32>(x_1333.x, x_1333.y, x_1333.z)) + vec3<f32>(x_1336.x, x_1336.y, x_1336.z));
  let x_1339 : vec4<f32> = u_xlat1;
  let x_1341 : vec3<f32> = u_xlat11;
  let x_1343 : vec4<f32> = u_xlat3;
  let x_1345 : vec3<f32> = ((vec3<f32>(x_1339.x, x_1339.x, x_1339.x) * x_1341) + vec3<f32>(x_1343.x, x_1343.y, x_1343.z));
  let x_1346 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1345.x, x_1345.y, x_1345.z, x_1346.w);
  let x_1350 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1350);
  let x_1352 : bool = u_xlatb1;
  if (x_1352) {
    let x_1355 : vec4<f32> = u_xlat0;
    let x_1356 : vec3<f32> = vec3<f32>(x_1355.x, x_1355.y, x_1355.z);
    let x_1357 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1356.x, x_1356.y, x_1356.z, x_1357.w);
    let x_1359 : vec4<f32> = u_xlat1;
    let x_1363 : vec3<f32> = clamp(vec3<f32>(x_1359.x, x_1359.y, x_1359.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1364 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1363.x, x_1363.y, x_1363.z, x_1364.w);
    let x_1366 : vec4<f32> = u_xlat1;
    u_xlat0.w = dot(vec3<f32>(x_1366.x, x_1366.y, x_1366.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
