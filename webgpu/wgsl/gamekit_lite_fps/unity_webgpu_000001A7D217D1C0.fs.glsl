...
layout(set = 0, binding = 8) uniform mediump texture2D _Vignette_Mask;
layout(set = 0, binding = 9) uniform mediump texture2D _GrainTex;
...
bool u_xlatb36;
float u_xlat38;
layout(set = 0, binding = 10) uniform mediump  sampler sampler_DitheringTex;
layout(set = 0, binding = 11) uniform mediump  sampler sampler_MainTex;
layout(set = 0, binding = 12) uniform mediump  sampler sampler_AutoExposureTex;
layout(set = 0, binding = 13) uniform mediump  sampler sampler_BloomTex;
layout(set = 0, binding = 14) uniform mediump  sampler sampler_Bloom_DirtTex;
layout(set = 0, binding = 15) uniform mediump  sampler sampler_ChromaticAberration_SpectralLut;
layout(set = 0, binding = 16) uniform mediump  sampler sampler_Lut2D;
layout(set = 0, binding = 17) uniform mediump  sampler sampler_Vignette_Mask;
layout(set = 0, binding = 18) uniform mediump  sampler sampler_GrainTex;
void main()
{
    ...
    u_xlat5 = texture(sampler2D(_BloomTex, sampler_BloomTex), u_xlat0.xy);
    u_xlat4 = u_xlat4 + u_xlat5;
    ...
    u_xlat4.xyz = texture(sampler2D(_Bloom_DirtTex, sampler_Bloom_DirtTex), u_xlat1.xy).xyz;
