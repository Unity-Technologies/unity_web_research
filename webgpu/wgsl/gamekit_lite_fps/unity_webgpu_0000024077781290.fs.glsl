...
void main()
{
    ...
    u_xlat4.xyz = vs_TEXCOORD4.zyx + (-unity_ObjectToWorld[3].zyx);
    u_xlat5.yw = u_xlat4.xz * vec2(0.200000003, 0.200000003);
    u_xlat28 = _Cutoff + _Cutoff;
    u_xlat5.x = u_xlat4.y * 2.0 + u_xlat28;
    u_xlat6.x = u_xlat4.y * 4.0 + _Cutoff;
    u_xlat28 = _bounds.y + 0.200000003;
    u_xlat29 = texture(sampler2D(_Noise, sampler_Noise), u_xlat5.xy).x;
    u_xlat6.y = u_xlat5.w;
    u_xlat21 = texture(sampler2D(_Noise, sampler_Noise), u_xlat6.xy).x;
    u_xlat29 = dot(vec2(u_xlat29), vec2(u_xlat21));
    u_xlat21 = u_xlat28 * 0.5;
    u_xlat28 = _Cutoff * u_xlat28 + (-u_xlat21);
    u_xlatb21 = u_xlat4.y>=u_xlat28;
    u_xlat30 = u_xlat28 + (-_EdgeSizeBot);
    ...
    u_xlat22 = u_xlat28 + _EdgeSizeTop;
    u_xlat28 = u_xlat28 + (-u_xlat22);
    u_xlat13.x = (-u_xlat22) + u_xlat4.y;
    u_xlat28 = float(1.0) / u_xlat28;
    u_xlat28 = u_xlat28 * u_xlat13.x;
    u_xlat28 = clamp(u_xlat28, 0.0, 1.0);
    u_xlat13.x = u_xlat28 * -2.0 + 3.0;
    u_xlat28 = u_xlat28 * u_xlat28;
    u_xlat28 = u_xlat28 * u_xlat13.x;
    u_xlat13.xyz = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD0.xy).xyz;
    u_xlat5.xyz = u_xlat13.xyz * _Color.xyz;
    ...
    u_xlat28 = u_xlat29 * u_xlat28 + u_xlat21;
    u_xlat28 = u_xlat28 + (-_Cutoff);
    u_xlat28 = u_xlat28 + (-_Cutoff2);
    ...
    u_xlat21 = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat8.xy).w;
    ...
    u_xlat4.xyz = u_xlat13.xyz * _Color.xyz + vec3(-0.0399999991, -0.0399999991, -0.0399999991);
    ...
    u_xlat28 = (-u_xlat3.y) * u_xlat30 + 1.0;
