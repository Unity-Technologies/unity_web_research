...
fn main_1() {
  ...
  let x_165 : vec4<f32> = vs_TEXCOORD5;
  vs_TEXCOORD5 = vec4<f32>(x_165.x, x_165.y, x_164.x, x_164.y);
  let x_167 : vec4<f32> = u_xlat1;
  let x_169 : vec4<f32> = u_xlat1;
  let x_171 : vec2<f32> = (vec2<f32>(x_167.z, x_167.z) + vec2<f32>(x_169.x, x_169.w));
  let x_172 : vec4<f32> = vs_TEXCOORD5;
  vs_TEXCOORD5 = vec4<f32>(x_171.x, x_171.y, x_172.z, x_172.w);
