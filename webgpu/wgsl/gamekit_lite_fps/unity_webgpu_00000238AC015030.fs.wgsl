...
fn main_1() {
  ...
  if (x_163) {
    ...
    if (x_1382) {
      let x_1388 : bool = u_xlatb8.x;
      x_1384 = x_1388;
    } else {
      let x_1391 : bool = u_xlatb8.y;
      x_1384 = x_1391;
    }
    let x_1392 : bool = x_1384;
    u_xlatb2 = x_1392;
    let x_1394 : f32 = u_xlat6.x;
    let x_1396 : f32 = u_xlat6.x;
    u_xlat6.x = (x_1394 * x_1396);
    let x_1399 : f32 = u_xlat12;
    let x_1400 : f32 = u_xlat20;
    u_xlat12 = ((x_1399 * -(x_1400)) + 0.5f);
    let x_1404 : bool = u_xlatb2;
    let x_1405 : f32 = u_xlat12;
    u_xlat12 = select(0.0f, x_1405, x_1404);
    let x_1408 : f32 = u_xlat6.x;
    let x_1409 : f32 = u_xlat12;
    u_xlat6.x = max(x_1408, x_1409);
    let x_1412 : vec2<f32> = u_xlat6;
    let x_1414 : f32 = u_xlat18;
    let x_1417 : vec2<f32> = vs_TEXCOORD0;
    u_xlat6 = ((vec2<f32>(x_1412.x, x_1412.x) * vec2<f32>(x_1414, x_1414)) + x_1417);
    let x_1420 : bool = u_xlatb0.x;
    if (x_1420) {
      let x_1425 : f32 = vs_TEXCOORD0.x;
      x_1421 = x_1425;
    } else {
      let x_1428 : f32 = u_xlat6.x;
      x_1421 = x_1428;
    }
    let x_1429 : f32 = x_1421;
    u_xlat2.x = x_1429;
    let x_1432 : f32 = u_xlat2.x;
    u_xlat2.x = clamp(x_1432, 0.0f, 1.0f);
    let x_1436 : bool = u_xlatb0.x;
    if (x_1436) {
      let x_1441 : f32 = u_xlat6.y;
      x_1437 = x_1441;
    } else {
      let x_1444 : f32 = vs_TEXCOORD0.y;
      x_1437 = x_1444;
    }
    let x_1445 : f32 = x_1437;
    u_xlat2.y = x_1445;
    let x_1448 : f32 = u_xlat2.y;
    u_xlat2.y = clamp(x_1448, 0.0f, 1.0f);
    let x_1451 : vec3<f32> = u_xlat2;
    let x_1454 : f32 = x_30.x_RenderViewportScaleFactor;
    let x_1456 : vec2<f32> = (vec2<f32>(x_1451.x, x_1451.y) * vec2<f32>(x_1454, x_1454));
    let x_1457 : vec3<f32> = u_xlat0;
    u_xlat0 = vec3<f32>(x_1456.x, x_1456.y, x_1457.z);
    let x_1462 : vec3<f32> = u_xlat0;
    let x_1464 : vec4<f32> = textureSampleLevel(x_MainTex, sampler_MainTex, vec2<f32>(x_1462.x, x_1462.y), 0.0f);
    u_xlat0 = vec3<f32>(x_1464.x, x_1464.y, x_1464.z);
    let x_1467 : f32 = u_xlat1.y;
    u_xlat1.w = x_1467;
  } else {
    let x_1471 : vec4<f32> = u_xlat1;
    u_xlat0 = vec3<f32>(x_1471.x, x_1471.y, x_1471.z);
  }
  let x_1473 : vec2<f32> = vs_TEXCOORD0;
  let x_1476 : vec4<f32> = x_30.x_Dithering_Coords;
  let x_1480 : vec4<f32> = x_30.x_Dithering_Coords;
  let x_1482 : vec2<f32> = ((x_1473 * vec2<f32>(x_1476.x, x_1476.y)) + vec2<f32>(x_1480.z, x_1480.w));
  let x_1483 : vec3<f32> = u_xlat2;
  u_xlat2 = vec3<f32>(x_1482.x, x_1482.y, x_1483.z);
  let x_1490 : vec3<f32> = u_xlat2;
  let x_1492 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1490.x, x_1490.y));
  u_xlat18 = x_1492.w;
  let x_1494 : f32 = u_xlat18;
  u_xlat18 = ((x_1494 * 2.0f) + -1.0f);
  let x_1498 : f32 = u_xlat18;
  u_xlat2.x = ((x_1498 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1504 : f32 = u_xlat2.x;
  u_xlat2.x = clamp(x_1504, 0.0f, 1.0f);
  let x_1508 : f32 = u_xlat2.x;
  u_xlat2.x = ((x_1508 * 2.0f) + -1.0f);
  let x_1512 : f32 = u_xlat18;
  u_xlat18 = (-(abs(x_1512)) + 1.0f);
  let x_1516 : f32 = u_xlat18;
  u_xlat18 = sqrt(x_1516);
  let x_1518 : f32 = u_xlat18;
  u_xlat18 = (-(x_1518) + 1.0f);
  let x_1521 : f32 = u_xlat18;
  let x_1523 : f32 = u_xlat2.x;
  u_xlat18 = (x_1521 * x_1523);
  let x_1525 : vec3<f32> = u_xlat0;
  u_xlat2 = (x_1525 * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1529 : vec3<f32> = u_xlat0;
  u_xlat3 = max(abs(x_1529), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1534 : vec3<f32> = u_xlat3;
  u_xlat3 = log2(x_1534);
  let x_1536 : vec3<f32> = u_xlat3;
  u_xlat3 = (x_1536 * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1540 : vec3<f32> = u_xlat3;
  u_xlat3 = exp2(x_1540);
  let x_1542 : vec3<f32> = u_xlat3;
  u_xlat3 = ((x_1542 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1551 : vec3<f32> = u_xlat0;
  let x_1553 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1551.x, x_1551.y, x_1551.z, x_1551.x));
  u_xlatb0 = vec3<bool>(x_1553.x, x_1553.y, x_1553.z);
  let x_1556 : bool = u_xlatb0.x;
  if (x_1556) {
    let x_1561 : f32 = u_xlat2.x;
    x_1557 = x_1561;
  } else {
    let x_1564 : f32 = u_xlat3.x;
    x_1557 = x_1564;
  }
  ...
  if (x_1568) {
    let x_1573 : f32 = u_xlat2.y;
    x_1569 = x_1573;
  } else {
    let x_1576 : f32 = u_xlat3.y;
    x_1569 = x_1576;
  }
  ...
  if (x_1580) {
    ...
    let x_1588 : f32 = u_xlat3.z;
    x_1581 = x_1588;
  }
  let x_1589 : f32 = x_1581;
  u_xlat0.z = x_1589;
  let x_1591 : f32 = u_xlat18;
  let x_1596 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_1591, x_1591, x_1591) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1596);
  let x_1598 : vec3<f32> = u_xlat0;
  u_xlat2 = (x_1598 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1602 : vec3<f32> = u_xlat0;
  u_xlat3 = (x_1602 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1606 : vec3<f32> = u_xlat3;
  u_xlat3 = (x_1606 * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1610 : vec3<f32> = u_xlat3;
  u_xlat3 = max(abs(x_1610), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1613 : vec3<f32> = u_xlat3;
  u_xlat3 = log2(x_1613);
  let x_1615 : vec3<f32> = u_xlat3;
  u_xlat3 = (x_1615 * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1619 : vec3<f32> = u_xlat3;
  u_xlat3 = exp2(x_1619);
  let x_1623 : vec3<f32> = u_xlat0;
  let x_1625 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1623.x, x_1623.y, x_1623.z, x_1623.x));
