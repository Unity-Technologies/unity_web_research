...
void main()
{
    ...
    u_xlat10 = dot(u_xlat3, in_POSITION0);
    ...
    u_xlat17 = dot(u_xlat4, in_POSITION0);
    ...
    u_xlat0.xzw = u_xlat0.xzw * u_xlat9.xxx;
    u_xlat7.y = dot(in_NORMAL0.xyz, u_xlat0.xzw);
    ...
    u_xlat0.xzw = u_xlat9.xxx * u_xlat0.xzw;
    u_xlat3.xyz = u_xlat9.xxx * u_xlat6.xyz;
    u_xlat7.x = dot(in_NORMAL0.xyz, u_xlat3.xyz);
    u_xlat7.z = dot(in_NORMAL0.xyz, u_xlat0.xzw);
    u_xlat0.x = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat3 = u_xlat0.xxxx * u_xlat7.xyzz;
    ...
    u_xlat9.x = in_TANGENT0.w * unity_WorldTransformParams.w;
    u_xlat4.xyz = u_xlat9.xxx * u_xlat4.xyz;
    vs_TEXCOORD0.y = u_xlat4.x;
    vs_TEXCOORD0.z = u_xlat3.x;
    vs_TEXCOORD0.x = u_xlat0.w;
    vs_TEXCOORD0.w = u_xlat17;
    u_xlat5 = (-vec4(u_xlat17)) + unity_4LightPosX0;
    vs_TEXCOORD1.x = u_xlat0.x;
    vs_TEXCOORD1.z = u_xlat3.y;
    vs_TEXCOORD1.y = u_xlat4.y;
    vs_TEXCOORD2.y = u_xlat4.z;
    vs_TEXCOORD1.w = u_xlat10;
    u_xlat4 = (-vec4(u_xlat10)) + unity_4LightPosY0;
    ...
    u_xlatu9.xy = uvec2(uint_bitfieldExtract(floatBitsToUint(u_xlat2.w), int(8), int(8)), uint_bitfieldExtract(floatBitsToUint(u_xlat2.w), int(16), int(8)));
    ...
    u_xlat1.xy = (bool(u_xlatb17)) ? u_xlat1.xy : in_TEXCOORD0.xy;
    ...
    u_xlat1.xyz = unity_SHC.xyz * vec3(u_xlat24) + u_xlat2.xyz;
