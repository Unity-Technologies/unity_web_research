...
fn main_1() {
  ...
  u_xlat1 = vec4<f32>(x_1392.x, x_1392.y, x_1392.z, x_1393.w);
  let x_1395 : vec4<f32> = u_xlat1;
  let x_1399 : vec3<f32> = x_26.x_Lut2D_Params;
  u_xlat11 = (vec3<f32>(x_1395.x, x_1395.y, x_1395.z) * vec3<f32>(x_1399.z, x_1399.z, x_1399.z));
  let x_1403 : f32 = u_xlat11.x;
  u_xlat11.x = floor(x_1403);
  let x_1407 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1409 : vec2<f32> = (vec2<f32>(x_1407.x, x_1407.y) * vec2<f32>(0.5f, 0.5f));
  let x_1410 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1409.x, x_1409.y, x_1410.z, x_1410.w);
  let x_1412 : vec3<f32> = u_xlat11;
  let x_1415 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1418 : vec4<f32> = u_xlat2;
  let x_1420 : vec2<f32> = ((vec2<f32>(x_1412.y, x_1412.z) * vec2<f32>(x_1415.x, x_1415.y)) + vec2<f32>(x_1418.x, x_1418.y));
  let x_1421 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1421.x, x_1420.x, x_1420.y, x_1421.w);
  let x_1424 : f32 = u_xlat11.x;
  let x_1426 : f32 = x_26.x_Lut2D_Params.y;
  let x_1429 : f32 = u_xlat2.y;
  u_xlat2.x = ((x_1424 * x_1426) + x_1429);
  let x_1437 : vec4<f32> = u_xlat2;
  let x_1439 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1437.x, x_1437.z));
  ...
  let x_1444 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat4.x = x_1444;
  u_xlat4.y = 0.0f;
  let x_1447 : vec4<f32> = u_xlat2;
  let x_1449 : vec4<f32> = u_xlat4;
  u_xlat21 = (vec2<f32>(x_1447.x, x_1447.z) + vec2<f32>(x_1449.x, x_1449.y));
  let x_1455 : vec2<f32> = u_xlat21;
  let x_1456 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, x_1455);
  let x_1457 : vec3<f32> = vec3<f32>(x_1456.x, x_1456.y, x_1456.z);
  let x_1458 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1457.x, x_1457.y, x_1457.z, x_1458.w);
  let x_1461 : f32 = u_xlat1.x;
  let x_1464 : f32 = x_26.x_Lut2D_Params.z;
  let x_1467 : f32 = u_xlat11.x;
  u_xlat1.x = ((x_1461 * x_1464) + -(x_1467));
  let x_1471 : vec4<f32> = u_xlat3;
  let x_1474 : vec4<f32> = u_xlat2;
  u_xlat11 = (-(vec3<f32>(x_1471.x, x_1471.y, x_1471.z)) + vec3<f32>(x_1474.x, x_1474.y, x_1474.z));
  let x_1477 : vec4<f32> = u_xlat1;
  let x_1479 : vec3<f32> = u_xlat11;
  let x_1481 : vec4<f32> = u_xlat3;
  let x_1483 : vec3<f32> = ((vec3<f32>(x_1477.x, x_1477.x, x_1477.x) * x_1479) + vec3<f32>(x_1481.x, x_1481.y, x_1481.z));
  let x_1484 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1483.x, x_1483.y, x_1483.z, x_1484.w);
  let x_1488 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1488);
  let x_1490 : bool = u_xlatb1;
  if (x_1490) {
    let x_1493 : vec4<f32> = u_xlat0;
    let x_1494 : vec3<f32> = vec3<f32>(x_1493.x, x_1493.y, x_1493.z);
    let x_1495 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1494.x, x_1494.y, x_1494.z, x_1495.w);
    let x_1497 : vec4<f32> = u_xlat1;
    let x_1501 : vec3<f32> = clamp(vec3<f32>(x_1497.x, x_1497.y, x_1497.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1502 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1501.x, x_1501.y, x_1501.z, x_1502.w);
    let x_1504 : vec4<f32> = u_xlat1;
    u_xlat0.w = dot(vec3<f32>(x_1504.x, x_1504.y, x_1504.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
