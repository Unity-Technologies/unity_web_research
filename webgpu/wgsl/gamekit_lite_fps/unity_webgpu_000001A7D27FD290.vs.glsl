...
layout(set = 0, binding = 10, std140) uniform UnityInstancing_PerDraw0 {
...
void main()
{
    ...
    vs_TEXCOORD1.xyz = unity_Builtins0Array[u_xlati0 / 8].unity_ObjectToWorldArray[3].xyz * in_POSITION0.www + u_xlat1.xyz;
    ...
    u_xlat1.x = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati0 / 8].unity_WorldToObjectArray[0].xyz);
    u_xlat1.y = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati0 / 8].unity_WorldToObjectArray[1].xyz);
    u_xlat1.z = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati0 / 8].unity_WorldToObjectArray[2].xyz);
    ...
    u_xlat9 = u_xlat2.y * unity_MatrixV[1].z;
    u_xlat9 = unity_MatrixV[0].z * u_xlat2.x + u_xlat9;
    u_xlat9 = unity_MatrixV[2].z * u_xlat2.z + u_xlat9;
    u_xlat9 = unity_MatrixV[3].z * u_xlat2.w + u_xlat9;
    vs_TEXCOORD3.z = (-u_xlat9);
    u_xlat1.xyz = u_xlat2.yyy * unity_MatrixVP[1].xyw;
    u_xlat1.xyz = unity_MatrixVP[0].xyw * u_xlat2.xxx + u_xlat1.xyz;
    u_xlat1.xyz = unity_MatrixVP[2].xyw * u_xlat2.zzz + u_xlat1.xyz;
    u_xlat1.xyz = unity_MatrixVP[3].xyw * u_xlat2.www + u_xlat1.xyz;
