...
layout(set = 0, binding = 12) uniform mediump  sampler sampler_Gradient;
...
void main()
{
    ...
    u_xlat23 = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat6.xy).x;
    u_xlat16 = (-u_xlat23) + u_xlat16;
    u_xlat22 = u_xlat22 * u_xlat16 + u_xlat23;
