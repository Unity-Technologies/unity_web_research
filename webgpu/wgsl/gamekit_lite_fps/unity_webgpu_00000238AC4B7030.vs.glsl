...
void main()
{
    ...
    u_xlat3.xyz = in_TANGENT0.yyy * unity_Builtins0Array[u_xlati6 / 8].unity_ObjectToWorldArray[1].yzx;
    u_xlat3.xyz = unity_Builtins0Array[u_xlati6 / 8].unity_ObjectToWorldArray[0].yzx * in_TANGENT0.xxx + u_xlat3.xyz;
    u_xlat3.xyz = unity_Builtins0Array[u_xlati6 / 8].unity_ObjectToWorldArray[2].yzx * in_TANGENT0.zzz + u_xlat3.xyz;
    u_xlat12 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat12 = inversesqrt(u_xlat12);
    u_xlat3.xyz = vec3(u_xlat12) * u_xlat3.xyz;
    u_xlat4.x = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati6 / 8].unity_WorldToObjectArray[0].xyz);
    u_xlat4.y = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati6 / 8].unity_WorldToObjectArray[1].xyz);
    u_xlat4.z = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati6 / 8].unity_WorldToObjectArray[2].xyz);
    u_xlat6.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat6.x = inversesqrt(u_xlat6.x);
    u_xlat4 = u_xlat6.xxxx * u_xlat4.xyzz;
    u_xlat6.xyz = u_xlat3.xyz * u_xlat4.wxy;
    u_xlat6.xyz = u_xlat4.ywx * u_xlat3.yzx + (-u_xlat6.xyz);
    ...
    u_xlat6.x = u_xlat4.y * u_xlat4.y;
    u_xlat6.x = u_xlat4.x * u_xlat4.x + (-u_xlat6.x);
    ...
    u_xlat0.xyz = unity_Builtins2Array[u_xlati0 / 7].unity_SHCArray.xyz * u_xlat6.xxx + u_xlat3.xyz;
