...
layout(set = 0, binding = 20, std140) uniform VGlobals {
	vec4 _Time;
...
void main()
{
    ...
    u_xlat6.xy = in_POSITION0.yy * unity_ObjectToWorld[1].xy;
    u_xlat6.xy = unity_ObjectToWorld[0].xy * in_POSITION0.xx + u_xlat6.xy;
    u_xlat1.yz = unity_ObjectToWorld[2].xy * in_POSITION0.zz + u_xlat6.xy;
    u_xlat1.x = _Time.x * 30.0 + u_xlat1.y;
    u_xlat6.xy = u_xlat1.xz * vec2(0.5, 0.5);
    u_xlat6.xyz = textureLod(sampler2D(_Noise, sampler_Noise), u_xlat6.xy, 0.0).xyz;
