...
void main()
{
    ...
    gl_Position = u_xlat2;
    u_xlat3.xyz = in_TANGENT0.yyy * unity_Builtins0Array[u_xlati7 / 8].unity_ObjectToWorldArray[1].yzx;
    u_xlat3.xyz = unity_Builtins0Array[u_xlati7 / 8].unity_ObjectToWorldArray[0].yzx * in_TANGENT0.xxx + u_xlat3.xyz;
    u_xlat3.xyz = unity_Builtins0Array[u_xlati7 / 8].unity_ObjectToWorldArray[2].yzx * in_TANGENT0.zzz + u_xlat3.xyz;
