...
fn main_1() {
  ...
  let x_1208 : vec2<f32> = vs_TEXCOORD0;
  let x_1211 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1215 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1217 : vec2<f32> = ((x_1208 * vec2<f32>(x_1211.x, x_1211.y)) + vec2<f32>(x_1215.z, x_1215.w));
  let x_1218 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1217.x, x_1217.y, x_1218.z, x_1218.w);
  let x_1225 : vec4<f32> = u_xlat1;
  let x_1227 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1225.x, x_1225.y));
  u_xlat1.x = x_1227.w;
  let x_1231 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1231 * 2.0f) + -1.0f);
  let x_1236 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1236 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1242 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1242, 0.0f, 1.0f);
  let x_1246 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1246 * 2.0f) + -1.0f);
  let x_1251 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1251)) + 1.0f);
  let x_1257 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1257);
  let x_1261 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1261) + 1.0f);
  let x_1266 : f32 = u_xlat1.x;
  let x_1268 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1266 * x_1268);
  let x_1271 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1271.x, x_1271.y, x_1271.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1276 : vec4<f32> = u_xlat0;
  let x_1281 : vec3<f32> = max(abs(vec3<f32>(x_1276.x, x_1276.y, x_1276.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1319 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1316.x, x_1316.y, x_1316.z, x_1316.x));
  ...
  let x_1365 : vec3<f32> = ((vec3<f32>(x_1358.x, x_1358.x, x_1358.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1363.x, x_1363.y, x_1363.z));
  let x_1366 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1365.x, x_1365.y, x_1365.z, x_1366.w);
  let x_1368 : vec4<f32> = u_xlat0;
  let x_1372 : vec3<f32> = (vec3<f32>(x_1368.x, x_1368.y, x_1368.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1373 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1372.x, x_1372.y, x_1372.z, x_1373.w);
  let x_1375 : vec4<f32> = u_xlat0;
  let x_1379 : vec3<f32> = (vec3<f32>(x_1375.x, x_1375.y, x_1375.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1380 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1379.x, x_1379.y, x_1379.z, x_1380.w);
  let x_1382 : vec4<f32> = u_xlat2;
  let x_1386 : vec3<f32> = (vec3<f32>(x_1382.x, x_1382.y, x_1382.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1387 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1386.x, x_1386.y, x_1386.z, x_1387.w);
  let x_1389 : vec4<f32> = u_xlat2;
  let x_1392 : vec3<f32> = max(abs(vec3<f32>(x_1389.x, x_1389.y, x_1389.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1393 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1392.x, x_1392.y, x_1392.z, x_1393.w);
  let x_1395 : vec4<f32> = u_xlat2;
  let x_1397 : vec3<f32> = log2(vec3<f32>(x_1395.x, x_1395.y, x_1395.z));
  let x_1398 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1397.x, x_1397.y, x_1397.z, x_1398.w);
  let x_1400 : vec4<f32> = u_xlat2;
  let x_1404 : vec3<f32> = (vec3<f32>(x_1400.x, x_1400.y, x_1400.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  SV_Target0.x = x_1430;
  let x_1434 : bool = u_xlatb0.y;
  if (x_1434) {
    let x_1439 : f32 = u_xlat1.y;
    x_1435 = x_1439;
  } else {
  ...
  SV_Target0.y = x_1443;
  let x_1446 : bool = u_xlatb0.z;
  if (x_1446) {
    let x_1451 : f32 = u_xlat1.z;
    x_1447 = x_1451;
  } else {
