...
@group(0) @binding(10) var<uniform> x_14 : UnityDrawCallInfo;

var<private> u_xlat1 : vec4<f32>;

var<private> in_POSITION0 : vec4<f32>;

@group(0) @binding(11) var<uniform> x_38 : UnityInstancing_PerDraw0;

var<private> u_xlat2 : vec4<f32>;

var<private> u_xlat5 : vec3<f32>;

@group(0) @binding(9) var<uniform> x_91 : VGlobals;
...
fn main_1() {
  ...
  let x_427 : vec4<f32> = x_91.unity_SHBr;
  let x_428 : vec4<f32> = u_xlat1;
  u_xlat2.x = dot(x_427, x_428);
  let x_432 : vec4<f32> = x_91.unity_SHBg;
  let x_433 : vec4<f32> = u_xlat1;
  u_xlat2.y = dot(x_432, x_433);
  let x_437 : vec4<f32> = x_91.unity_SHBb;
  let x_438 : vec4<f32> = u_xlat1;
  u_xlat2.z = dot(x_437, x_438);
  let x_445 : vec4<f32> = x_91.unity_SHC;
  let x_447 : vec3<f32> = u_xlat0;
  let x_450 : vec4<f32> = u_xlat2;
  vs_TEXCOORD7 = ((vec3<f32>(x_445.x, x_445.y, x_445.z) * vec3<f32>(x_447.x, x_447.x, x_447.x)) + vec3<f32>(x_450.x, x_450.y, x_450.z));
...
fn main(@builtin(instance_index) gl_InstanceIndex_param : u32, @location(0) in_POSITION0_param : vec4<f32>, @location(4) in_TANGENT0_param : vec4<f32>, @location(1) in_NORMAL0_param : vec3<f32>, @location(2) in_COLOR0_param : vec4<f32>, @location(3) in_TEXCOORD0_param : vec2<f32>) -> main_out {
  ...
  main_1();
  return main_out(gl_Position, vs_TEXCOORD0, vs_TEXCOORD1, vs_TEXCOORD2, vs_COLOR0, vs_TEXCOORD3, vs_TEXCOORD7);
}
