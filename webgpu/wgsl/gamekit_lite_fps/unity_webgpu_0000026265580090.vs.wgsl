...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_207.y, x_207.z, x_207.z, x_207.x) * vec4<f32>(x_209.x, x_209.y, x_209.z, x_209.z));
  ...
  let x_229 : vec4<f32> = x_91.unity_SHC;
  let x_231 : f32 = u_xlat9;
  let x_234 : vec3<f32> = u_xlat0;
  vs_TEXCOORD5 = ((vec3<f32>(x_229.x, x_229.y, x_229.z) * vec3<f32>(x_231, x_231, x_231)) + x_234);
