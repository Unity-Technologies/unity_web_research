...
fn main_1() {
  ...
  if (x_878) {
    ...
    let x_1095 : f32 = x_26.x_Vignette_Opacity;
    let x_1097 : vec3<f32> = u_xlat11;
    let x_1099 : vec4<f32> = u_xlat0;
    let x_1101 : vec3<f32> = ((vec3<f32>(x_1095, x_1095, x_1095) * x_1097) + vec3<f32>(x_1099.x, x_1099.y, x_1099.z));
    let x_1102 : vec4<f32> = u_xlat2;
    u_xlat2 = vec4<f32>(x_1101.x, x_1101.y, x_1101.z, x_1102.w);
    let x_1105 : f32 = u_xlat0.w;
    u_xlat0.x = (x_1105 + -1.0f);
    let x_1109 : f32 = u_xlat1.x;
    let x_1111 : f32 = u_xlat0.x;
    u_xlat2.w = ((x_1109 * x_1111) + 1.0f);
  }
  let x_1115 : vec4<f32> = u_xlat2;
  let x_1118 : f32 = x_26.x_PostExposure;
  let x_1120 : f32 = x_26.x_PostExposure;
  let x_1122 : f32 = x_26.x_PostExposure;
  let x_1124 : f32 = x_26.x_PostExposure;
  let x_1125 : vec4<f32> = vec4<f32>(x_1118, x_1120, x_1122, x_1124);
  u_xlat0 = (x_1115 * vec4<f32>(x_1125.x, x_1125.y, x_1125.z, x_1125.w));
  let x_1132 : vec4<f32> = u_xlat0;
  let x_1139 : vec3<f32> = ((vec3<f32>(x_1132.x, x_1132.y, x_1132.z) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1154 : vec3<f32> = ((vec3<f32>(x_1147.x, x_1147.y, x_1147.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1155 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1154.x, x_1154.y, x_1154.z, x_1155.w);
  let x_1157 : vec4<f32> = u_xlat0;
  let x_1161 : vec3<f32> = clamp(vec3<f32>(x_1157.x, x_1157.y, x_1157.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1162 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1161.x, x_1161.y, x_1161.z, x_1162.w);
  let x_1164 : vec4<f32> = u_xlat0;
  let x_1168 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1170 : vec3<f32> = (vec3<f32>(x_1164.x, x_1164.y, x_1164.z) * vec3<f32>(x_1168.y, x_1168.y, x_1168.y));
  let x_1171 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1170.x, x_1170.y, x_1170.z, x_1171.w);
  let x_1174 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat1.x = (x_1174 * 0.5f);
  let x_1177 : vec4<f32> = u_xlat0;
  let x_1180 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1183 : vec3<f32> = u_xlat1;
  let x_1185 : vec3<f32> = ((vec3<f32>(x_1177.x, x_1177.y, x_1177.z) * vec3<f32>(x_1180.x, x_1180.x, x_1180.x)) + vec3<f32>(x_1183.x, x_1183.x, x_1183.x));
  let x_1186 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1185.x, x_1185.y, x_1185.z, x_1186.w);
  let x_1196 : vec4<f32> = u_xlat0;
  let x_1198 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1196.x, x_1196.y, x_1196.z));
  let x_1199 : vec3<f32> = vec3<f32>(x_1198.x, x_1198.y, x_1198.z);
  let x_1200 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1199.x, x_1199.y, x_1199.z, x_1200.w);
  let x_1202 : vec2<f32> = vs_TEXCOORD0;
  let x_1205 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1209 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1211 : vec2<f32> = ((x_1202 * vec2<f32>(x_1205.x, x_1205.y)) + vec2<f32>(x_1209.z, x_1209.w));
  let x_1212 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1211.x, x_1211.y, x_1212.z);
  let x_1219 : vec3<f32> = u_xlat1;
  let x_1221 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1219.x, x_1219.y));
  u_xlat1.x = x_1221.w;
  let x_1225 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1225 * 2.0f) + -1.0f);
  let x_1230 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1230 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1236 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1236, 0.0f, 1.0f);
  let x_1240 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1240 * 2.0f) + -1.0f);
  let x_1245 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1245)) + 1.0f);
  let x_1251 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1251);
  let x_1255 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1255) + 1.0f);
  let x_1260 : f32 = u_xlat1.x;
  let x_1262 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1260 * x_1262);
  let x_1265 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1265.x, x_1265.y, x_1265.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1270 : vec4<f32> = u_xlat0;
  let x_1274 : vec3<f32> = max(abs(vec3<f32>(x_1270.x, x_1270.y, x_1270.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1275 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1274.x, x_1274.y, x_1274.z, x_1275.w);
  let x_1277 : vec4<f32> = u_xlat2;
  let x_1279 : vec3<f32> = log2(vec3<f32>(x_1277.x, x_1277.y, x_1277.z));
  let x_1280 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1279.x, x_1279.y, x_1279.z, x_1280.w);
  let x_1282 : vec4<f32> = u_xlat2;
  let x_1286 : vec3<f32> = (vec3<f32>(x_1282.x, x_1282.y, x_1282.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1287 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1286.x, x_1286.y, x_1286.z, x_1287.w);
  let x_1289 : vec4<f32> = u_xlat2;
  let x_1291 : vec3<f32> = exp2(vec3<f32>(x_1289.x, x_1289.y, x_1289.z));
  let x_1292 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1291.x, x_1291.y, x_1291.z, x_1292.w);
  let x_1294 : vec4<f32> = u_xlat2;
  let x_1301 : vec3<f32> = ((vec3<f32>(x_1294.x, x_1294.y, x_1294.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  ...
  u_xlat1 = (vec3<f32>(x_1360.x, x_1360.y, x_1360.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1364 : vec4<f32> = u_xlat0;
  let x_1367 : vec3<f32> = (vec3<f32>(x_1364.x, x_1364.y, x_1364.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1368 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1367.x, x_1367.y, x_1367.z, x_1368.w);
  let x_1370 : vec4<f32> = u_xlat2;
  let x_1373 : vec3<f32> = (vec3<f32>(x_1370.x, x_1370.y, x_1370.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1374 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1373.x, x_1373.y, x_1373.z, x_1374.w);
  let x_1376 : vec4<f32> = u_xlat2;
  let x_1379 : vec3<f32> = max(abs(vec3<f32>(x_1376.x, x_1376.y, x_1376.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1390 : vec3<f32> = (vec3<f32>(x_1387.x, x_1387.y, x_1387.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1391 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1390.x, x_1390.y, x_1390.z, x_1391.w);
  let x_1393 : vec4<f32> = u_xlat2;
  let x_1395 : vec3<f32> = exp2(vec3<f32>(x_1393.x, x_1393.y, x_1393.z));
  let x_1396 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1395.x, x_1395.y, x_1395.z, x_1396.w);
  let x_1399 : vec4<f32> = u_xlat0;
  let x_1401 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1399.x, x_1399.y, x_1399.z, x_1399.x));
