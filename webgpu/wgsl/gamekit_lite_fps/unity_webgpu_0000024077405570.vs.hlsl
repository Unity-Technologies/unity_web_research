#line 1 "Sprites/Mask"
static const int ETC1_EXTERNAL_ALPHA = 0 ;
static const int PIXELSNAP_ON = 0 ;
...
#line 22 "F:/src/unity_webgpu/Shaders/Includes/UnitySprites.cginc"
...
float4 SpriteFrag ( v2f IN ) : COLOR
{
...
#line 74
float4 frag ( v2f_masking IN ) : COLOR
{
float4 c = SampleSpriteTexture ( IN . uv ) ;
