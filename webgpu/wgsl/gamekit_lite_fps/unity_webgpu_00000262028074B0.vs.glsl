...
layout(set = 0, binding = 13, std140) uniform VGlobals {
	vec4 _Time;
...
layout(set = 0, binding = 14) uniform mediump texture2D _Gradient;
...
layout(set = 0, binding = 15) uniform mediump  sampler sampler_Gradient;
void main()
{
