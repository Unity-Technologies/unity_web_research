...
fn main_1() {
  ...
  let x_1449 : f32 = x_26.x_LumaInAlpha;
  u_xlatb0 = (0.5f < x_1449);
  let x_1451 : bool = u_xlatb0;
  if (x_1451) {
    let x_1454 : vec4<f32> = u_xlat3;
    let x_1455 : vec3<f32> = vec3<f32>(x_1454.x, x_1454.y, x_1454.z);
    let x_1456 : vec4<f32> = u_xlat0;
    u_xlat0 = vec4<f32>(x_1455.x, x_1455.y, x_1455.z, x_1456.w);
    let x_1458 : vec4<f32> = u_xlat0;
    let x_1462 : vec3<f32> = clamp(vec3<f32>(x_1458.x, x_1458.y, x_1458.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1463 : vec4<f32> = u_xlat0;
    u_xlat0 = vec4<f32>(x_1462.x, x_1462.y, x_1462.z, x_1463.w);
    let x_1465 : vec4<f32> = u_xlat0;
    u_xlat3.w = dot(vec3<f32>(x_1465.x, x_1465.y, x_1465.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
