...
fn main_1() {
  ...
  u_xlat0 = ((vec4<f32>(x_1254.w, x_1254.x, x_1254.y, x_1254.z) * vec4<f32>(x_1256.w, x_1256.x, x_1256.y, x_1256.z)) + vec4<f32>(x_1259.w, x_1259.x, x_1259.y, x_1259.z));
  let x_1264 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1264);
  let x_1266 : bool = u_xlatb1;
  if (x_1266) {
    let x_1269 : vec4<f32> = u_xlat0;
    let x_1270 : vec3<f32> = vec3<f32>(x_1269.y, x_1269.z, x_1269.w);
    let x_1271 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1270.x, x_1270.y, x_1270.z, x_1271.w);
    let x_1273 : vec4<f32> = u_xlat1;
    let x_1277 : vec3<f32> = clamp(vec3<f32>(x_1273.x, x_1273.y, x_1273.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1278 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1277.x, x_1277.y, x_1277.z, x_1278.w);
    let x_1280 : vec4<f32> = u_xlat1;
    u_xlat0.x = dot(vec3<f32>(x_1280.x, x_1280.y, x_1280.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1290 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1290.y, x_1290.z, x_1290.w, x_1290.x);
  return;
}
