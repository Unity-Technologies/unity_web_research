...
layout(set = 0, binding = 8, std140) uniform UnityInstancing_PerDraw0 {
...
void main()
{
    ...
    vs_TEXCOORD1.xyz = unity_Builtins0Array[u_xlati4 / 8].unity_ObjectToWorldArray[3].xyz * in_POSITION0.www + u_xlat1.xyz;
    ...
    u_xlat1.x = u_xlat2.y * unity_MatrixV[1].z;
    u_xlat1.x = unity_MatrixV[0].z * u_xlat2.x + u_xlat1.x;
    u_xlat1.x = unity_MatrixV[2].z * u_xlat2.z + u_xlat1.x;
    u_xlat1.x = unity_MatrixV[3].z * u_xlat2.w + u_xlat1.x;
    ...
    vs_TEXCOORD6.xyz = unity_Builtins2Array[u_xlati0 / 7].unity_SHCArray.xyz * u_xlat1.xxx + u_xlat3.xyz;
