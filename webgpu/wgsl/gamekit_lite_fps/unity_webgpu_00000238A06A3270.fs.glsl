...
layout(set = 0, binding = 11) uniform mediump  sampler sampler_ShadowMapTexture;
...
layout(set = 0, binding = 14) uniform mediump  sampler sampler_Normal;
layout(set = 0, binding = 15) uniform mediump  sampler sampler_MetallicSmooth;
void main()
{
    ...
    u_xlat49 = _Cutoff + _Cutoff;
    u_xlat6.x = u_xlat4.w * 2.0 + u_xlat49;
    u_xlat6.z = u_xlat4.y * 4.0 + _Cutoff;
    u_xlat49 = _bounds.y + 0.200000003;
    u_xlat6.yw = u_xlat5.yw;
    u_xlat50 = texture(sampler2D(_Noise, sampler_Noise), u_xlat6.xy).x;
    u_xlat35 = texture(sampler2D(_Noise, sampler_Noise), u_xlat6.zw).x;
    u_xlat50 = dot(vec2(u_xlat50), vec2(u_xlat35));
    u_xlat5.y = 0.0;
    u_xlat35 = texture(sampler2D(_Noise, sampler_Noise), u_xlat5.xy).x;
    u_xlat51 = u_xlat49 * 0.5;
    u_xlat49 = _Cutoff * u_xlat49 + (-u_xlat51);
    u_xlatb51 = u_xlat4.w>=u_xlat49;
    u_xlat4.x = u_xlatb51 ? 1.0 : float(0.0);
    u_xlat20 = u_xlat49 + (-_EdgeSizeBot);
    u_xlat36 = u_xlat49 + (-u_xlat20);
    ...
    u_xlat5.x = u_xlat20 * u_xlat36;
    u_xlat21 = u_xlat49 + _EdgeSizeTop;
    u_xlat49 = u_xlat49 + (-u_xlat21);
    u_xlat52 = u_xlat4.w + (-u_xlat21);
    ...
    u_xlat5.xyz = u_xlat5.xyz * vec3(u_xlat35) + u_xlat9.xyz;
    ...
    u_xlat35 = (-u_xlat36) * u_xlat20 + 1.0;
    u_xlat3.x = u_xlat35 * u_xlat3.x;
    u_xlat49 = u_xlat50 * u_xlat49 + u_xlat51;
    u_xlat49 = u_xlat49 + (-_Cutoff);
    u_xlat49 = u_xlat49 + (-_Cutoff2);
    ...
    u_xlat50 = dot(u_xlat4, unity_OcclusionMaskSelector);
    u_xlat50 = clamp(u_xlat50, 0.0, 1.0);
    u_xlat4.xy = vs_TEXCOORD6.xy / vs_TEXCOORD6.ww;
    u_xlat51 = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat4.xy).x;
    u_xlat50 = u_xlat50 + (-u_xlat51);
    u_xlat49 = u_xlat49 * u_xlat50 + u_xlat51;
    ...
    u_xlat50 = (-u_xlat3.y) * u_xlat35 + 1.0;
    u_xlat51 = dot((-u_xlat2.xyz), u_xlat4.xyz);
    u_xlat51 = u_xlat51 + u_xlat51;
    u_xlat6.xyz = u_xlat4.xyz * (-vec3(u_xlat51)) + (-u_xlat2.xyz);
    ...
    if(u_xlatb52){
        ...
        u_xlat6 = textureLod(samplerCube(unity_SpecCube1, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat49);
    ...
    u_xlat6.xyz = vec3(u_xlat49) * u_xlat8.xyz;
    ...
    u_xlat3.x = abs(u_xlat48) * u_xlat50 + u_xlat33;
    u_xlat50 = u_xlat2.x * u_xlat50 + u_xlat33;
    u_xlat48 = abs(u_xlat48) * u_xlat50;
    u_xlat48 = u_xlat2.x * u_xlat3.x + u_xlat48;
    u_xlat48 = u_xlat48 + 9.99999975e-06;
    u_xlat48 = 0.5 / u_xlat48;
    u_xlat50 = u_xlat33 * u_xlat33;
    u_xlat3.x = u_xlat18 * u_xlat50 + (-u_xlat18);
