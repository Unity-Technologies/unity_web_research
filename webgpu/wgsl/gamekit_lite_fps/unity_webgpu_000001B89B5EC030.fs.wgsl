...
fn main_1() {
  ...
  u_xlat11 = (vec3<f32>(x_1177.x, x_1177.y, x_1177.z) * vec3<f32>(x_1181.z, x_1181.z, x_1181.z));
  let x_1185 : f32 = u_xlat11.x;
  u_xlat11.x = floor(x_1185);
  let x_1189 : vec3<f32> = x_26.x_Lut2D_Params;
  ...
  let x_1197 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1200 : vec4<f32> = u_xlat2;
  let x_1202 : vec2<f32> = ((vec2<f32>(x_1194.y, x_1194.z) * vec2<f32>(x_1197.x, x_1197.y)) + vec2<f32>(x_1200.x, x_1200.y));
  let x_1203 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1203.x, x_1202.x, x_1202.y, x_1203.w);
  let x_1206 : f32 = u_xlat11.x;
  let x_1208 : f32 = x_26.x_Lut2D_Params.y;
  let x_1211 : f32 = u_xlat2.y;
  u_xlat2.x = ((x_1206 * x_1208) + x_1211);
  let x_1219 : vec4<f32> = u_xlat2;
  let x_1221 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1219.x, x_1219.z));
  let x_1222 : vec3<f32> = vec3<f32>(x_1221.x, x_1221.y, x_1221.z);
  let x_1223 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_1222.x, x_1222.y, x_1222.z, x_1223.w);
  let x_1226 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat4.x = x_1226;
  u_xlat4.y = 0.0f;
  let x_1229 : vec4<f32> = u_xlat2;
  let x_1231 : vec4<f32> = u_xlat4;
  u_xlat21 = (vec2<f32>(x_1229.x, x_1229.z) + vec2<f32>(x_1231.x, x_1231.y));
  let x_1237 : vec2<f32> = u_xlat21;
  let x_1238 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, x_1237);
  ...
  let x_1246 : f32 = x_26.x_Lut2D_Params.z;
  let x_1249 : f32 = u_xlat11.x;
  u_xlat1.x = ((x_1243 * x_1246) + -(x_1249));
  let x_1253 : vec4<f32> = u_xlat3;
  let x_1256 : vec4<f32> = u_xlat2;
  u_xlat11 = (-(vec3<f32>(x_1253.x, x_1253.y, x_1253.z)) + vec3<f32>(x_1256.x, x_1256.y, x_1256.z));
  let x_1259 : vec4<f32> = u_xlat1;
  let x_1261 : vec3<f32> = u_xlat11;
  let x_1263 : vec4<f32> = u_xlat3;
  let x_1265 : vec3<f32> = ((vec3<f32>(x_1259.x, x_1259.x, x_1259.x) * x_1261) + vec3<f32>(x_1263.x, x_1263.y, x_1263.z));
  let x_1266 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1265.x, x_1265.y, x_1265.z, x_1266.w);
  let x_1270 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1270);
  let x_1272 : bool = u_xlatb1;
  if (x_1272) {
    let x_1275 : vec4<f32> = u_xlat0;
    let x_1276 : vec3<f32> = vec3<f32>(x_1275.x, x_1275.y, x_1275.z);
    let x_1277 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1276.x, x_1276.y, x_1276.z, x_1277.w);
    let x_1279 : vec4<f32> = u_xlat1;
    let x_1283 : vec3<f32> = clamp(vec3<f32>(x_1279.x, x_1279.y, x_1279.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1284 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1283.x, x_1283.y, x_1283.z, x_1284.w);
    let x_1286 : vec4<f32> = u_xlat1;
    u_xlat0.w = dot(vec3<f32>(x_1286.x, x_1286.y, x_1286.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
