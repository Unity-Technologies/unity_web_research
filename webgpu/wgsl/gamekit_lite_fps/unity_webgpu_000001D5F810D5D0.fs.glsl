...
layout(set = 0, binding = 7) uniform mediump  sampler sampler_Noise;
layout(set = 0, binding = 8) uniform mediump  sampler sampler_Normal;
layout(set = 0, binding = 9) uniform mediump  sampler sampler_MetallicSmooth;
layout(set = 0, binding = 10) uniform mediump  sampler sampler_AO;
void main()
{
