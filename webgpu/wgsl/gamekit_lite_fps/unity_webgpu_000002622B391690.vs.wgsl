...
@group(0) @binding(12) var<uniform> x_42 : UnityInstancing_PerDraw0;

var<private> u_xlat2 : vec4<f32>;

var<private> u_xlat3 : vec4<f32>;

@group(0) @binding(11) var<uniform> x_96 : VGlobals;
...
@group(0) @binding(2) var<uniform> x_336 : UnityInstancing_PerDraw2;
...
fn main_1() {
  ...
  let x_315 : f32 = u_xlat3.y;
  u_xlat4.x = (x_313 * x_315);
  let x_319 : f32 = u_xlat3.x;
  let x_321 : f32 = u_xlat3.x;
  let x_324 : f32 = u_xlat4.x;
  u_xlat4.x = ((x_319 * x_321) + -(x_324));
  let x_328 : vec4<f32> = u_xlat3;
  let x_330 : vec4<f32> = u_xlat3;
  u_xlat1 = (vec4<f32>(x_328.y, x_328.w, x_328.z, x_328.x) * x_330);
  let x_337 : i32 = u_xlati0;
  let x_340 : vec4<f32> = x_336.unity_Builtins2Array[(x_337 / 7i)].unity_SHBrArray;
  let x_341 : vec4<f32> = u_xlat1;
  u_xlat2.x = dot(x_340, x_341);
  let x_344 : i32 = u_xlati0;
  let x_348 : vec4<f32> = x_336.unity_Builtins2Array[(x_344 / 7i)].unity_SHBgArray;
  let x_349 : vec4<f32> = u_xlat1;
  u_xlat2.y = dot(x_348, x_349);
  let x_352 : i32 = u_xlati0;
  let x_356 : vec4<f32> = x_336.unity_Builtins2Array[(x_352 / 7i)].unity_SHBbArray;
  let x_357 : vec4<f32> = u_xlat1;
  u_xlat2.z = dot(x_356, x_357);
  let x_362 : i32 = u_xlati0;
  let x_366 : vec4<f32> = x_336.unity_Builtins2Array[(x_362 / 7i)].unity_SHCArray;
  let x_368 : vec3<f32> = u_xlat4;
  let x_371 : vec4<f32> = u_xlat2;
  vs_TEXCOORD6 = ((vec3<f32>(x_366.x, x_366.y, x_366.z) * vec3<f32>(x_368.x, x_368.x, x_368.x)) + vec3<f32>(x_371.x, x_371.y, x_371.z));
...
fn main(@builtin(instance_index) gl_InstanceIndex_param : u32, @location(0) in_POSITION0_param : vec4<f32>, @location(4) in_TANGENT0_param : vec4<f32>, @location(1) in_NORMAL0_param : vec3<f32>, @location(2) in_COLOR0_param : vec4<f32>, @location(3) in_TEXCOORD0_param : vec2<f32>) -> main_out {
  ...
  main_1();
  return main_out(gl_Position, vs_TEXCOORD0, vs_TEXCOORD1, vs_TEXCOORD2, vs_COLOR0, vs_TEXCOORD3, vs_TEXCOORD6, vs_SV_InstanceID0);
}
