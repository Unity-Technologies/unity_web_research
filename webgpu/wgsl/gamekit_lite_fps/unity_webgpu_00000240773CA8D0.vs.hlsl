...
#line 32 "F:/src/unity_webgpu/Shaders/Includes/UnityStandardShadow.cginc"
float4 _Color ;
float _Cutoff ;
sampler2D _MainTex ;
float4 _MainTex_ST ;
...
float RoughnessSetup_ShadowGetOneMinusReflectivity ( float2 uv )
{
float metallicity = _Metallic ;
#line 70
return OneMinusReflectivityFromMetallic ( metallicity ) ;
...
float SpecularSetup_ShadowGetOneMinusReflectivity ( float2 uv )
{
...
float4 fragShadowCaster ( float4 vpos : SV_POSITION
...
{
#line 166
float alpha = tex2D ( _MainTex , i . tex . xy ) . a * _Color . a ;
#line 184
