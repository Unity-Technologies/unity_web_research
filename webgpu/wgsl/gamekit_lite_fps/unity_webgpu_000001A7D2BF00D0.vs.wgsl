...
@group(0) @binding(5) var<uniform> x_14 : UnityDrawCallInfo;

var<private> u_xlat7 : vec3<f32>;

@group(0) @binding(6) var<storage, read> x_31 : unity_ParticleInstanceData;

var<private> u_xlat14 : f32;

@group(0) @binding(4) var<uniform> x_52 : VGlobals;
...
fn main_1() {
  ...
  if (x_416) {
    ...
    x_418 = vec3<f32>(x_424.x, x_424.y, x_424.z);
  }
  let x_426 : vec3<f32> = x_418;
  let x_427 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_426.x, x_426.y, x_426.z, x_427.w);
  let x_429 : vec4<f32> = u_xlat0;
  let x_432 : vec4<f32> = x_52.unity_MatrixVP[1i];
  u_xlat1 = (vec4<f32>(x_429.y, x_429.y, x_429.y, x_429.y) * x_432);
  let x_435 : vec4<f32> = x_52.unity_MatrixVP[0i];
  let x_436 : vec4<f32> = u_xlat0;
  let x_439 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_435 * vec4<f32>(x_436.x, x_436.x, x_436.x, x_436.x)) + x_439);
  let x_442 : vec4<f32> = x_52.unity_MatrixVP[2i];
  let x_443 : vec4<f32> = u_xlat0;
  let x_446 : vec4<f32> = u_xlat1;
  u_xlat0 = ((x_442 * vec4<f32>(x_443.z, x_443.z, x_443.z, x_443.z)) + x_446);
  let x_449 : vec4<f32> = x_52.unity_MatrixVP[3i];
  let x_450 : vec4<f32> = in_POSITION0;
  let x_453 : vec4<f32> = u_xlat0;
  u_xlat0 = ((x_449 * vec4<f32>(x_450.w, x_450.w, x_450.w, x_450.w)) + x_453);
  let x_456 : f32 = x_52.unity_LightShadowBias.x;
  let x_458 : f32 = u_xlat0.w;
  u_xlat1.x = (x_456 / x_458);
  let x_462 : f32 = u_xlat1.x;
  u_xlat1.x = min(x_462, 0.0f);
  let x_466 : f32 = u_xlat1.x;
  u_xlat1.x = max(x_466, -1.0f);
  let x_471 : f32 = u_xlat0.z;
  let x_473 : f32 = u_xlat1.x;
  u_xlat14 = (x_471 + x_473);
  let x_476 : f32 = u_xlat0.w;
  let x_477 : f32 = u_xlat14;
  u_xlat1.x = min(x_476, x_477);
  let x_484 : vec4<f32> = u_xlat0;
  let x_485 : vec3<f32> = vec3<f32>(x_484.x, x_484.y, x_484.w);
  let x_487 : vec4<f32> = gl_Position;
  gl_Position = vec4<f32>(x_485.x, x_485.y, x_487.z, x_485.z);
  let x_489 : f32 = u_xlat14;
  let x_492 : f32 = u_xlat1.x;
  u_xlat0.x = (-(x_489) + x_492);
  let x_496 : f32 = x_52.unity_LightShadowBias.y;
  let x_498 : f32 = u_xlat0.x;
  let x_500 : f32 = u_xlat14;
  gl_Position.z = ((x_496 * x_498) + x_500);
  return;
}
