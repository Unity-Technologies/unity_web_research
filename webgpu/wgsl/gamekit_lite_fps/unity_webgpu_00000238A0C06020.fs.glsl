...
layout(set = 0, binding = 6) uniform mediump texture2D _EmissionMap;
...
layout(set = 0, binding = 17) uniform mediump  sampler sampler_ShadowMapTexture;
void main()
{
    ...
    u_xlat49 = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat6.xy).x;
    u_xlat47 = u_xlat47 + (-u_xlat49);
    u_xlat45 = u_xlat45 * u_xlat47 + u_xlat49;
    ...
    u_xlat6.xyz = (-vs_TEXCOORD1.xyz) * u_xlat30.xxx + _WorldSpaceLightPos0.xyz;
