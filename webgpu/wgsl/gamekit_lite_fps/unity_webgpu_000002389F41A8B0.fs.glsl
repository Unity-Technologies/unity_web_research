...
void main()
{
    ...
    u_xlat14.xy = vs_TEXCOORD5.yy * unity_WorldToLight[1].xy;
    u_xlat14.xy = unity_WorldToLight[0].xy * vs_TEXCOORD5.xx + u_xlat14.xy;
    u_xlat14.xy = unity_WorldToLight[2].xy * vs_TEXCOORD5.zz + u_xlat14.xy;
    u_xlat14.xy = u_xlat14.xy + unity_WorldToLight[3].xy;
