...
fn main_1() {
  ...
  u_xlat1 = x_304;
  let x_306 : vec4<f32> = x_21.x_Color;
  let x_308 : vec4<f32> = u_xlat1;
  u_xlat2 = ((vec3<f32>(x_306.x, x_306.y, x_306.z) * vec3<f32>(x_308.x, x_308.y, x_308.z)) + vec3<f32>(-0.039999999f, -0.039999999f, -0.039999999f));
  let x_316 : f32 = x_21.x_Metallic;
  let x_318 : f32 = x_21.x_Metallic;
  let x_320 : f32 = x_21.x_Metallic;
  let x_321 : vec3<f32> = vec3<f32>(x_316, x_318, x_320);
  let x_326 : vec3<f32> = u_xlat2;
  u_xlat2 = ((vec3<f32>(x_321.x, x_321.y, x_321.z) * x_326) + vec3<f32>(0.039999999f, 0.039999999f, 0.039999999f));
  let x_331 : f32 = u_xlat9;
  let x_333 : vec3<f32> = u_xlat2;
  u_xlat2 = (vec3<f32>(x_331, x_331, x_331) * x_333);
  let x_336 : f32 = x_21.x_Metallic;
  u_xlat9 = ((-(x_336) * 0.959999979f) + 0.959999979f);
  let x_341 : vec4<f32> = u_xlat1;
  let x_344 : vec4<f32> = x_21.x_Color;
  let x_346 : vec3<f32> = (vec3<f32>(x_341.x, x_341.y, x_341.z) * vec3<f32>(x_344.x, x_344.y, x_344.z));
  let x_347 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_346.x, x_346.y, x_346.z, x_347.w);
  let x_352 : f32 = u_xlat1.w;
  let x_354 : f32 = x_21.x_Color.w;
  SV_Target0.w = (x_352 * x_354);
  let x_358 : vec4<f32> = u_xlat1;
  let x_360 : f32 = u_xlat9;
  let x_363 : vec3<f32> = u_xlat2;
  let x_364 : vec3<f32> = ((vec3<f32>(x_358.x, x_358.y, x_358.z) * vec3<f32>(x_360, x_360, x_360)) + x_363);
  ...
  let x_372 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_371.x, x_371.y, x_371.z, x_372.w);
  return;
}
