...
@group(0) @binding(2) var x_GUIClipTexture : texture_2d<f32>;

@group(0) @binding(4) var sampler_GUIClipTexture : sampler;
...
fn main_1() {
  ...
  let x_515 : vec3<f32> = (vec3<f32>(x_511.x, x_511.y, x_511.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_530 : vec3<f32> = ((vec3<f32>(x_523.x, x_523.y, x_523.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
