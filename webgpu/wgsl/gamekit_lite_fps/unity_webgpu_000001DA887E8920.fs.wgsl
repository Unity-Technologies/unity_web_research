...
fn main_1() {
  ...
  if (x_1132) {
    ...
    let x_1271 : f32 = u_xlat11.x;
    SV_Target0.w = ((x_1269 * x_1271) + 1.0f);
  } else {
    let x_1282 : vec2<f32> = u_xlat21;
    let x_1283 : vec4<f32> = textureSample(x_Vignette_Mask, sampler_Vignette_Mask, x_1282);
    u_xlat1.x = x_1283.w;
    let x_1287 : f32 = u_xlat1.x;
    u_xlat1.z = (x_1287 + 0.055f);
    let x_1291 : vec3<f32> = u_xlat1;
    let x_1296 : vec2<f32> = (vec2<f32>(x_1291.x, x_1291.z) * vec2<f32>(0.077399381f, 0.947867334f));
    let x_1297 : vec3<f32> = u_xlat11;
    u_xlat11 = vec3<f32>(x_1296.x, x_1296.y, x_1297.z);
    let x_1300 : f32 = u_xlat11.y;
    u_xlat21.x = max(abs(x_1300), 1.1920929e-07f);
    let x_1306 : f32 = u_xlat21.x;
    u_xlat21.x = log2(x_1306);
    let x_1310 : f32 = u_xlat21.x;
    u_xlat21.x = (x_1310 * 2.400000095f);
    let x_1315 : f32 = u_xlat21.x;
    u_xlat21.x = exp2(x_1315);
    let x_1320 : f32 = u_xlat1.x;
    u_xlatb1 = (0.040449999f >= x_1320);
    let x_1322 : bool = u_xlatb1;
    if (x_1322) {
      let x_1327 : f32 = u_xlat11.x;
      x_1323 = x_1327;
    } else {
      let x_1330 : f32 = u_xlat21.x;
      x_1323 = x_1330;
    }
    let x_1331 : f32 = x_1323;
    u_xlat1.x = x_1331;
    let x_1334 : vec3<f32> = x_26.x_Vignette_Color;
    u_xlat11 = (-(x_1334) + vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1337 : vec3<f32> = u_xlat1;
    let x_1339 : vec3<f32> = u_xlat11;
    let x_1342 : vec3<f32> = x_26.x_Vignette_Color;
    u_xlat11 = ((vec3<f32>(x_1337.x, x_1337.x, x_1337.x) * x_1339) + x_1342);
    let x_1344 : vec4<f32> = u_xlat0;
    let x_1346 : vec3<f32> = u_xlat11;
    let x_1348 : vec4<f32> = u_xlat0;
    u_xlat11 = ((vec3<f32>(x_1344.x, x_1344.y, x_1344.z) * x_1346) + -(vec3<f32>(x_1348.x, x_1348.y, x_1348.z)));
    let x_1354 : f32 = x_26.x_Vignette_Opacity;
    let x_1356 : vec3<f32> = u_xlat11;
    let x_1358 : vec4<f32> = u_xlat0;
    let x_1360 : vec3<f32> = ((vec3<f32>(x_1354, x_1354, x_1354) * x_1356) + vec3<f32>(x_1358.x, x_1358.y, x_1358.z));
    let x_1361 : vec4<f32> = u_xlat2;
    u_xlat2 = vec4<f32>(x_1360.x, x_1360.y, x_1360.z, x_1361.w);
    let x_1364 : f32 = u_xlat0.w;
    u_xlat0.x = (x_1364 + -1.0f);
    let x_1368 : f32 = u_xlat1.x;
    let x_1370 : f32 = u_xlat0.x;
    SV_Target0.w = ((x_1368 * x_1370) + 1.0f);
  }
  let x_1375 : vec2<f32> = vs_TEXCOORD1;
  let x_1378 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1382 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1384 : vec2<f32> = ((x_1375 * vec2<f32>(x_1378.x, x_1378.y)) + vec2<f32>(x_1382.z, x_1382.w));
  let x_1385 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1384.x, x_1384.y, x_1385.z, x_1385.w);
  let x_1392 : vec4<f32> = u_xlat0;
  let x_1394 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1392.x, x_1392.y));
  ...
  let x_1400 : vec3<f32> = u_xlat1;
  u_xlat1 = clamp(x_1400, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1405 : vec3<f32> = u_xlat1;
  u_xlat30 = dot(x_1405, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1411 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1411);
  let x_1415 : f32 = x_26.x_Grain_Params1.x;
  let x_1416 : f32 = u_xlat30;
  u_xlat30 = ((x_1415 * -(x_1416)) + 1.0f);
  let x_1420 : vec4<f32> = u_xlat0;
  let x_1422 : vec4<f32> = u_xlat2;
  let x_1424 : vec3<f32> = (vec3<f32>(x_1420.x, x_1420.y, x_1420.z) * vec3<f32>(x_1422.x, x_1422.y, x_1422.z));
  ...
  let x_1436 : vec3<f32> = (vec3<f32>(x_1427.x, x_1427.y, x_1427.z) * vec3<f32>(x_1430, x_1432, x_1434));
  ...
  let x_1446 : vec3<f32> = ((vec3<f32>(x_1439.x, x_1439.y, x_1439.z) * vec3<f32>(x_1441, x_1441, x_1441)) + vec3<f32>(x_1444.x, x_1444.y, x_1444.z));
  let x_1447 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1446.x, x_1446.y, x_1446.z, x_1447.w);
  let x_1449 : vec2<f32> = vs_TEXCOORD0;
  let x_1452 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1456 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1458 : vec2<f32> = ((x_1449 * vec2<f32>(x_1452.x, x_1452.y)) + vec2<f32>(x_1456.z, x_1456.w));
  let x_1459 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1458.x, x_1458.y, x_1459.z);
  let x_1466 : vec3<f32> = u_xlat1;
  let x_1468 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1466.x, x_1466.y));
  u_xlat30 = x_1468.w;
  let x_1470 : f32 = u_xlat30;
  u_xlat30 = ((x_1470 * 2.0f) + -1.0f);
  let x_1473 : f32 = u_xlat30;
  u_xlat1.x = ((x_1473 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1479 : f32 = u_xlat1.x;
  u_xlat1.x = clamp(x_1479, 0.0f, 1.0f);
  let x_1483 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1483 * 2.0f) + -1.0f);
  let x_1487 : f32 = u_xlat30;
  u_xlat30 = (-(abs(x_1487)) + 1.0f);
  let x_1491 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1491);
  let x_1493 : f32 = u_xlat30;
  u_xlat30 = (-(x_1493) + 1.0f);
  let x_1496 : f32 = u_xlat30;
  let x_1498 : f32 = u_xlat1.x;
  u_xlat30 = (x_1496 * x_1498);
  let x_1500 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1500.x, x_1500.y, x_1500.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1505 : vec4<f32> = u_xlat0;
  let x_1509 : vec3<f32> = max(abs(vec3<f32>(x_1505.x, x_1505.y, x_1505.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1510 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1509.x, x_1509.y, x_1509.z, x_1510.w);
  let x_1512 : vec4<f32> = u_xlat2;
  let x_1514 : vec3<f32> = log2(vec3<f32>(x_1512.x, x_1512.y, x_1512.z));
  let x_1515 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1514.x, x_1514.y, x_1514.z, x_1515.w);
  let x_1517 : vec4<f32> = u_xlat2;
  let x_1521 : vec3<f32> = (vec3<f32>(x_1517.x, x_1517.y, x_1517.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1522 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1521.x, x_1521.y, x_1521.z, x_1522.w);
  let x_1524 : vec4<f32> = u_xlat2;
  let x_1526 : vec3<f32> = exp2(vec3<f32>(x_1524.x, x_1524.y, x_1524.z));
  let x_1527 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1526.x, x_1526.y, x_1526.z, x_1527.w);
  let x_1529 : vec4<f32> = u_xlat2;
  let x_1536 : vec3<f32> = ((vec3<f32>(x_1529.x, x_1529.y, x_1529.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1537 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1536.x, x_1536.y, x_1536.z, x_1537.w);
  let x_1544 : vec4<f32> = u_xlat0;
  let x_1547 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1544.x, x_1544.y, x_1544.z, x_1544.x));
  ...
  u_xlat0.z = x_1583;
  let x_1585 : f32 = u_xlat30;
  let x_1590 : vec4<f32> = u_xlat0;
  let x_1592 : vec3<f32> = ((vec3<f32>(x_1585, x_1585, x_1585) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1590.x, x_1590.y, x_1590.z));
  let x_1593 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1592.x, x_1592.y, x_1592.z, x_1593.w);
  let x_1595 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1595.x, x_1595.y, x_1595.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1599 : vec4<f32> = u_xlat0;
  let x_1602 : vec3<f32> = (vec3<f32>(x_1599.x, x_1599.y, x_1599.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1603 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1602.x, x_1602.y, x_1602.z, x_1603.w);
  let x_1605 : vec4<f32> = u_xlat2;
  let x_1608 : vec3<f32> = (vec3<f32>(x_1605.x, x_1605.y, x_1605.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1609 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1608.x, x_1608.y, x_1608.z, x_1609.w);
  let x_1611 : vec4<f32> = u_xlat2;
  let x_1614 : vec3<f32> = max(abs(vec3<f32>(x_1611.x, x_1611.y, x_1611.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1615 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1614.x, x_1614.y, x_1614.z, x_1615.w);
  let x_1617 : vec4<f32> = u_xlat2;
  let x_1619 : vec3<f32> = log2(vec3<f32>(x_1617.x, x_1617.y, x_1617.z));
  let x_1620 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1619.x, x_1619.y, x_1619.z, x_1620.w);
  let x_1622 : vec4<f32> = u_xlat2;
  let x_1625 : vec3<f32> = (vec3<f32>(x_1622.x, x_1622.y, x_1622.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1626 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1625.x, x_1625.y, x_1625.z, x_1626.w);
  let x_1628 : vec4<f32> = u_xlat2;
  let x_1630 : vec3<f32> = exp2(vec3<f32>(x_1628.x, x_1628.y, x_1628.z));
  let x_1631 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1630.x, x_1630.y, x_1630.z, x_1631.w);
  let x_1634 : vec4<f32> = u_xlat0;
  let x_1636 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1634.x, x_1634.y, x_1634.z, x_1634.x));
  u_xlatb0 = vec3<bool>(x_1636.x, x_1636.y, x_1636.z);
  let x_1639 : bool = u_xlatb0.x;
  if (x_1639) {
  ...
  SV_Target0.x = x_1648;
  let x_1651 : bool = u_xlatb0.y;
  if (x_1651) {
    let x_1656 : f32 = u_xlat1.y;
    x_1652 = x_1656;
  } else {
    let x_1659 : f32 = u_xlat2.y;
    x_1652 = x_1659;
  }
  let x_1660 : f32 = x_1652;
  SV_Target0.y = x_1660;
  let x_1663 : bool = u_xlatb0.z;
  if (x_1663) {
    let x_1668 : f32 = u_xlat1.z;
    x_1664 = x_1668;
  } else {
