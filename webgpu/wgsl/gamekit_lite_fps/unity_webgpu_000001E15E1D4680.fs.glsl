...
void main()
{
    ...
    u_xlat10.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec0, 0.0);
    ...
    u_xlat10.x = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat10.xy).w;
    u_xlat2.x = u_xlat10.x * u_xlat2.x;
    u_xlat10.x = dot(u_xlat6.xyz, u_xlat6.xyz);
    u_xlat10.x = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), u_xlat10.xx).x;
    u_xlat2.x = u_xlat10.x * u_xlat2.x;
