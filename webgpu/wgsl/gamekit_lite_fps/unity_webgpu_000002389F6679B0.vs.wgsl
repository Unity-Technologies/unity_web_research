...
fn main_1() {
  ...
  let x_361 : f32 = x_260.unity_LightShadowBias.x;
  let x_363 : f32 = u_xlat0.w;
  u_xlat1.x = (x_361 / x_363);
  let x_367 : f32 = u_xlat1.x;
  u_xlat1.x = min(x_367, 0.0f);
  let x_371 : f32 = u_xlat1.x;
  u_xlat1.x = max(x_371, -1.0f);
  let x_377 : f32 = u_xlat0.z;
  let x_379 : f32 = u_xlat1.x;
  u_xlat14 = (x_377 + x_379);
  let x_382 : f32 = u_xlat0.w;
  let x_383 : f32 = u_xlat14;
  u_xlat1.x = min(x_382, x_383);
  let x_390 : vec4<f32> = u_xlat0;
  let x_391 : vec3<f32> = vec3<f32>(x_390.x, x_390.y, x_390.w);
  let x_394 : vec4<f32> = gl_Position;
  gl_Position = vec4<f32>(x_391.x, x_391.y, x_394.z, x_391.z);
  let x_396 : f32 = u_xlat14;
  let x_399 : f32 = u_xlat1.x;
  u_xlat0.x = (-(x_396) + x_399);
  let x_403 : f32 = x_260.unity_LightShadowBias.y;
  let x_405 : f32 = u_xlat0.x;
  let x_407 : f32 = u_xlat14;
  gl_Position.z = ((x_403 * x_405) + x_407);
  return;
}
