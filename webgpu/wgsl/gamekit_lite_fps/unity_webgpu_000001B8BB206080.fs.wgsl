...
fn main_1() {
  ...
  let x_1152 : vec3<f32> = ((vec3<f32>(x_1145.x, x_1145.y, x_1145.z) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1182 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1184 : vec3<f32> = (vec3<f32>(x_1177.x, x_1177.y, x_1177.z) * vec3<f32>(x_1182.y, x_1182.y, x_1182.y));
  let x_1185 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1184.x, x_1184.y, x_1184.z, x_1185.w);
  let x_1188 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat1.x = (x_1188 * 0.5f);
  let x_1191 : vec4<f32> = u_xlat0;
  let x_1194 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1197 : vec4<f32> = u_xlat1;
  let x_1199 : vec3<f32> = ((vec3<f32>(x_1191.x, x_1191.y, x_1191.z) * vec3<f32>(x_1194.x, x_1194.x, x_1194.x)) + vec3<f32>(x_1197.x, x_1197.x, x_1197.x));
  let x_1200 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1199.x, x_1199.y, x_1199.z, x_1200.w);
  let x_1210 : vec4<f32> = u_xlat0;
  let x_1212 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1210.x, x_1210.y, x_1210.z));
  let x_1213 : vec3<f32> = vec3<f32>(x_1212.x, x_1212.y, x_1212.z);
  ...
  let x_1289 : vec3<f32> = max(abs(vec3<f32>(x_1284.x, x_1284.y, x_1284.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1327 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1324.x, x_1324.y, x_1324.z, x_1324.x));
  u_xlatb0 = vec3<bool>(x_1327.x, x_1327.y, x_1327.z);
  let x_1330 : bool = u_xlatb0.x;
  if (x_1330) {
    let x_1335 : f32 = u_xlat11.x;
    x_1331 = x_1335;
  } else {
  ...
  u_xlat0.x = x_1339;
  let x_1342 : bool = u_xlatb0.y;
  if (x_1342) {
    let x_1347 : f32 = u_xlat11.y;
    x_1343 = x_1347;
  } else {
    let x_1350 : f32 = u_xlat2.y;
    x_1343 = x_1350;
  }
  let x_1351 : f32 = x_1343;
  u_xlat0.y = x_1351;
  let x_1355 : bool = u_xlatb0.z;
  if (x_1355) {
    let x_1360 : f32 = u_xlat11.z;
    x_1356 = x_1360;
  } else {
  ...
  let x_1373 : vec3<f32> = ((vec3<f32>(x_1366.x, x_1366.x, x_1366.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1371.x, x_1371.y, x_1371.z));
  let x_1374 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1373.x, x_1373.y, x_1373.z, x_1374.w);
  let x_1376 : vec4<f32> = u_xlat0;
  let x_1380 : vec3<f32> = (vec3<f32>(x_1376.x, x_1376.y, x_1376.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1381 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1380.x, x_1380.y, x_1380.z, x_1381.w);
  let x_1383 : vec4<f32> = u_xlat0;
  let x_1387 : vec3<f32> = (vec3<f32>(x_1383.x, x_1383.y, x_1383.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1388 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1387.x, x_1387.y, x_1387.z, x_1388.w);
  let x_1390 : vec4<f32> = u_xlat2;
  let x_1394 : vec3<f32> = (vec3<f32>(x_1390.x, x_1390.y, x_1390.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1395 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1394.x, x_1394.y, x_1394.z, x_1395.w);
  let x_1397 : vec4<f32> = u_xlat2;
  let x_1400 : vec3<f32> = max(abs(vec3<f32>(x_1397.x, x_1397.y, x_1397.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1401 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1400.x, x_1400.y, x_1400.z, x_1401.w);
  let x_1403 : vec4<f32> = u_xlat2;
  let x_1405 : vec3<f32> = log2(vec3<f32>(x_1403.x, x_1403.y, x_1403.z));
  let x_1406 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1405.x, x_1405.y, x_1405.z, x_1406.w);
  let x_1408 : vec4<f32> = u_xlat2;
  let x_1412 : vec3<f32> = (vec3<f32>(x_1408.x, x_1408.y, x_1408.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1413 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1412.x, x_1412.y, x_1412.z, x_1413.w);
  let x_1415 : vec4<f32> = u_xlat2;
  let x_1417 : vec3<f32> = exp2(vec3<f32>(x_1415.x, x_1415.y, x_1415.z));
  let x_1418 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1417.x, x_1417.y, x_1417.z, x_1418.w);
  let x_1422 : vec4<f32> = u_xlat0;
  let x_1424 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1422.x, x_1422.y, x_1422.z, x_1422.x));
