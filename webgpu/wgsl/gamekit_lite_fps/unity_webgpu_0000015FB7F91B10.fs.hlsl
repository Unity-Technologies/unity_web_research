...
TextureCube _TexA ; SamplerState sampler_TexA ;
TextureCube _TexB ; SamplerState sampler_TexB ;
...
{
float3 texA = DecodeHDR ( _TexA . SampleLevel ( sampler_TexA , i . texcoord , _Level ) , _TexA_HDR ) ;
float3 texB = DecodeHDR ( _TexB . SampleLevel ( sampler_TexB , i . texcoord , _Level ) , _TexB_HDR ) ;

float3 res = lerp ( texA , texB , _value ) ;
