...
@group(0) @binding(2) var<uniform> x_38 : UnityInstancing_PerDraw0;

var<private> u_xlatb3 : bool;

@group(0) @binding(0) var<uniform> x_80 : VGlobals;
...
fn main_1() {
  ...
  let x_240 : vec3<f32> = vec3<f32>(x_239.x, x_239.y, x_239.w);
  let x_243 : vec4<f32> = gl_Position;
  gl_Position = vec4<f32>(x_240.x, x_240.y, x_243.z, x_240.z);
  return;
}
