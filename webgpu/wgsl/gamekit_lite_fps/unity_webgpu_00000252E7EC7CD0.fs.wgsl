...
fn main_1() {
  ...
  let x_401 : vec3<f32> = vs_TEXCOORD6;
  ...
  let x_464 : f32 = x_30.x_EmissionColor.x;
  let x_466 : f32 = x_30.x_EmissionColor.y;
  let x_468 : f32 = x_30.x_EmissionColor.z;
  let x_471 : vec3<f32> = u_xlat1;
  let x_472 : vec3<f32> = ((x_461 * vec3<f32>(x_464, x_466, x_468)) + x_471);
  let x_473 : vec4<f32> = SV_Target3;
  SV_Target3 = vec4<f32>(x_472.x, x_472.y, x_472.z, x_473.w);
  ...
  SV_Target0.w = 1.0f;
  let x_484 : f32 = x_30.x_Glossiness;
  SV_Target1.w = x_484;
  SV_Target2.w = 1.0f;
  SV_Target3.w = 1.0f;
  return;
