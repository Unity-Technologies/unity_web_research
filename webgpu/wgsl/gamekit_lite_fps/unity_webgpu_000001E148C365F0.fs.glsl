...
void main()
{
    ...
    u_xlat1.xyz = texture(sampler2D(_BumpMap, sampler_BumpMap), vs_TEXCOORD0.xy).xyw;
    ...
    u_xlat7.xy = texture(sampler2D(_MetallicGlossMap, sampler_MetallicGlossMap), vs_TEXCOORD0.xy).xw;
    u_xlat1.y = (-u_xlat7.y) * _GlossMapScale + 1.0;
    u_xlat9 = texture(sampler2D(unity_NHxRoughness, samplerunity_NHxRoughness), u_xlat1.xy).x;
    u_xlat9 = u_xlat9 * 16.0;
    u_xlat1.xyw = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD0.xy).xyz;
    u_xlat2.xyz = _Color.xyz * u_xlat1.xyw + vec3(-0.0399999991, -0.0399999991, -0.0399999991);
    u_xlat1.xyw = u_xlat1.xyw * _Color.xyz;
    u_xlat2.xyz = u_xlat7.xxx * u_xlat2.xyz + vec3(0.0399999991, 0.0399999991, 0.0399999991);
    u_xlat7.x = (-u_xlat7.x) * 0.959999979 + 0.959999979;
