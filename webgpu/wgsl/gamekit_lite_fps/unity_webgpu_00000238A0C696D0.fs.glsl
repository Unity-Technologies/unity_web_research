...
void main()
{
    ...
    u_xlat3.xy = texture(sampler2D(_MetallicGlossMap, sampler_MetallicGlossMap), vs_TEXCOORD0.xy).xw;
    u_xlat1.y = (-u_xlat3.y) * _GlossMapScale + 1.0;
    u_xlat6 = texture(sampler2D(unity_NHxRoughness, samplerunity_NHxRoughness), u_xlat1.xy).x;
    ...
    u_xlat2.xyz = u_xlat3.xxx * u_xlat2.xyz + vec3(0.0399999991, 0.0399999991, 0.0399999991);
    u_xlat3.x = (-u_xlat3.x) * 0.959999979 + 0.959999979;
