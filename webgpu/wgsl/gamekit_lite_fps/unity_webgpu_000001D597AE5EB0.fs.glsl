...
void main()
{
    ...
    u_xlat21 = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat16.xy).x;
    u_xlat20 = u_xlat20 + (-u_xlat21);
    u_xlat19 = u_xlat19 * u_xlat20 + u_xlat21;
    u_xlat20 = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat4.xy).w;
