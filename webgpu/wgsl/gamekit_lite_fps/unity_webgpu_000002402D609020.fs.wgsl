...
fn main_1() {
  ...
  let x_1341 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1341);
  let x_1343 : bool = u_xlatb1;
  if (x_1343) {
    let x_1346 : vec4<f32> = u_xlat0;
    let x_1347 : vec3<f32> = vec3<f32>(x_1346.x, x_1346.y, x_1346.z);
    let x_1348 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1347.x, x_1347.y, x_1347.z, x_1348.w);
    let x_1350 : vec4<f32> = u_xlat1;
    let x_1354 : vec3<f32> = clamp(vec3<f32>(x_1350.x, x_1350.y, x_1350.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1355 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1354.x, x_1354.y, x_1354.z, x_1355.w);
    let x_1357 : vec4<f32> = u_xlat1;
    u_xlat0.w = dot(vec3<f32>(x_1357.x, x_1357.y, x_1357.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
