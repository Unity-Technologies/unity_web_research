...
void main()
{
    ...
    u_xlat40 = dot(vs_TEXCOORD0.xyz, u_xlat1.xyz);
    u_xlat40 = log2(u_xlat40);
    u_xlat40 = u_xlat40 * 0.100000001;
    u_xlat40 = exp2(u_xlat40);
    u_xlat40 = (-u_xlat40) + 1.0;
    u_xlat40 = max(u_xlat40, 0.0);
    u_xlat2.xyz = vec3(u_xlat40) * _Color.xyz;
    u_xlat40 = _Time.x * 200.0;
    ...
    if(u_xlatb42){
        ...
        u_xlat17.xyz = vs_TEXCOORD1.yyy * unity_ProbeVolumeWorldToObject[1].xyz;
        u_xlat17.xyz = unity_ProbeVolumeWorldToObject[0].xyz * vs_TEXCOORD1.xxx + u_xlat17.xyz;
        u_xlat17.xyz = unity_ProbeVolumeWorldToObject[2].xyz * vs_TEXCOORD1.zzz + u_xlat17.xyz;
        u_xlat17.xyz = u_xlat17.xyz + unity_ProbeVolumeWorldToObject[3].xyz;
        u_xlat4.xyz = (bool(u_xlatb4)) ? u_xlat17.xyz : vs_TEXCOORD1.xyz;
    ...
    u_xlat17.x = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat17.xy).x;
    u_xlat4.x = (-u_xlat17.x) + u_xlat4.x;
    u_xlat41 = u_xlat41 * u_xlat4.x + u_xlat17.x;
    u_xlat4.x = (-_Glossiness) + 1.0;
    u_xlat17.x = dot((-u_xlat1.xyz), vs_TEXCOORD0.xyz);
    u_xlat17.x = u_xlat17.x + u_xlat17.x;
    u_xlat17.xyz = vs_TEXCOORD0.xyz * (-u_xlat17.xxx) + (-u_xlat1.xyz);
    ...
    u_xlat6.xyz = u_xlat7.xyz + vs_TEXCOORD2.xyz;
    ...
    if(u_xlatb44){
        ...
        u_xlat9 = textureLod(samplerCube(unity_SpecCube1, samplerunity_SpecCube0), u_xlat17.xyz, u_xlat41);
        ...
        u_xlat17.xyz = u_xlat9.xyz * vec3(u_xlat41);
    ...
    u_xlat41 = inversesqrt(u_xlat41);
    u_xlat17.xyz = vec3(u_xlat41) * vs_TEXCOORD0.xyz;
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat40) + vec3(-0.0399999991, -0.0399999991, -0.0399999991);
    ...
    u_xlat39 = dot(u_xlat17.xyz, u_xlat1.xyz);
    u_xlat1.x = dot(u_xlat17.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat14 = dot(u_xlat17.xyz, u_xlat0.xyz);
