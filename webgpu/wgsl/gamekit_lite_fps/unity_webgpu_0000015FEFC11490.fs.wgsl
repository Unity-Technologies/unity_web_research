...
@group(0) @binding(3) var x_CameraMotionVectorsTexture : texture_2d<f32>;

@group(0) @binding(6) var sampler_CameraMotionVectorsTexture : sampler;

@group(0) @binding(2) var x_History : texture_2d<f32>;

@group(0) @binding(5) var sampler_History : sampler;
