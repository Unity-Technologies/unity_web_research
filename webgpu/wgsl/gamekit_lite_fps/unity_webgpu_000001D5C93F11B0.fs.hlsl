...
#line 410
o . _LightCoord = mul ( unity_WorldToLight , mul ( unity_ObjectToWorld , v . vertex ) ) . xy ; ;
...
float2 lightCoord = mul ( unity_WorldToLight , float4 ( s . posWorld , 1 ) ) . xy ; float shadow = UnityComputeForwardShadows ( 0 , s . posWorld , 0 ) ; float atten = tex2D ( _LightTexture0 , lightCoord ) . w * shadow ; ;
