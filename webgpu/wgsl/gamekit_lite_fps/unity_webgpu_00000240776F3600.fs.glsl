...
void main()
{
    ...
    u_xlat39 = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat4.xy).x;
    ...
    if(u_xlatb40){
        ...
        u_xlat4 = textureLod(samplerCube(unity_SpecCube1, samplerunity_SpecCube0), u_xlat4.xyz, u_xlat37);
