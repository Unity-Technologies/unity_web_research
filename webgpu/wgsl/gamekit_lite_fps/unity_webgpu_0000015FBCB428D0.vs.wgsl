...
fn main_1() {
  ...
  let x_72 : vec4<f32> = x_18.unity_MatrixVP[3i];
  let x_73 : vec4<f32> = u_xlat0;
  let x_76 : vec4<f32> = u_xlat1;
  gl_Position = ((x_72 * vec4<f32>(x_73.w, x_73.w, x_73.w, x_73.w)) + x_76);
  let x_83 : vec2<f32> = in_TEXCOORD0;
  let x_86 : vec4<f32> = x_18.x_MainTex_ST;
  let x_90 : vec4<f32> = x_18.x_MainTex_ST;
  let x_92 : vec2<f32> = ((x_83 * vec2<f32>(x_86.x, x_86.y)) + vec2<f32>(x_90.z, x_90.w));
  let x_93 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_92.x, x_92.y, x_93.z, x_93.w);
  let x_99 : i32 = x_18.unity_StereoEyeIndex;
  u_xlat4 = f32(x_99);
  let x_103 : f32 = u_xlat4;
  let x_106 : vec4<f32> = x_18.x_RightEyeUVOffset;
  let x_109 : vec4<f32> = u_xlat0;
  vs_TEXCOORD0 = ((vec2<f32>(x_103, x_103) * vec2<f32>(x_106.x, x_106.y)) + vec2<f32>(x_109.x, x_109.y));
  return;
}
