...
fn main_1() {
  ...
  let x_1088 : vec3<f32> = (vec3<f32>(x_1084.x, x_1084.y, x_1084.z) * vec3<f32>(0.25f, 0.25f, 0.25f));
  let x_1089 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_1088.x, x_1088.y, x_1088.z, x_1089.w);
  let x_1091 : vec4<f32> = u_xlat1;
  let x_1094 : vec3<f32> = x_26.x_Bloom_Settings;
  let x_1096 : vec3<f32> = (vec3<f32>(x_1091.x, x_1091.y, x_1091.z) * vec3<f32>(x_1094.z, x_1094.z, x_1094.z));
  let x_1097 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1096.x, x_1096.y, x_1096.z, x_1097.w);
  let x_1099 : vec4<f32> = u_xlat2;
  u_xlat2 = (x_1099 * vec4<f32>(0.25f, 0.25f, 0.25f, 1.0f));
  let x_1102 : vec4<f32> = u_xlat2;
  let x_1106 : vec3<f32> = x_26.x_Bloom_Color;
  let x_1107 : vec3<f32> = (vec3<f32>(x_1102.x, x_1102.y, x_1102.z) * x_1106);
  let x_1108 : vec4<f32> = u_xlat4;
  u_xlat4 = vec4<f32>(x_1107.x, x_1107.y, x_1107.z, x_1108.w);
  let x_1111 : f32 = u_xlat2.w;
  u_xlat4.w = (x_1111 * 0.25f);
  let x_1114 : vec4<f32> = u_xlat0;
  let x_1115 : vec4<f32> = u_xlat4;
  u_xlat0 = (x_1114 + x_1115);
  ...
  let x_1218 : f32 = x_26.x_PostExposure;
  let x_1219 : vec4<f32> = vec4<f32>(x_1212, x_1214, x_1216, x_1218);
  u_xlat0 = (vec4<f32>(x_1208.w, x_1208.x, x_1208.y, x_1208.z) * vec4<f32>(x_1219.x, x_1219.y, x_1219.z, x_1219.w));
  let x_1226 : vec4<f32> = u_xlat0;
  let x_1233 : vec3<f32> = ((vec3<f32>(x_1226.y, x_1226.z, x_1226.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1234 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1233.x, x_1233.y, x_1233.z, x_1234.w);
  let x_1236 : vec4<f32> = u_xlat1;
  let x_1238 : vec3<f32> = log2(vec3<f32>(x_1236.x, x_1236.y, x_1236.z));
  let x_1239 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1238.x, x_1238.y, x_1238.z, x_1239.w);
  let x_1241 : vec4<f32> = u_xlat1;
  let x_1248 : vec3<f32> = ((vec3<f32>(x_1241.x, x_1241.y, x_1241.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1249 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1248.x, x_1248.y, x_1248.z, x_1249.w);
  let x_1251 : vec4<f32> = u_xlat1;
  let x_1255 : vec3<f32> = clamp(vec3<f32>(x_1251.x, x_1251.y, x_1251.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1256 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1255.x, x_1255.y, x_1255.z, x_1256.w);
  let x_1258 : vec4<f32> = u_xlat1;
  let x_1263 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1265 : vec3<f32> = (vec3<f32>(x_1258.x, x_1258.y, x_1258.z) * vec3<f32>(x_1263.y, x_1263.y, x_1263.y));
  let x_1266 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1265.x, x_1265.y, x_1265.z, x_1266.w);
  let x_1269 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat31 = (x_1269 * 0.5f);
  let x_1271 : vec4<f32> = u_xlat1;
  let x_1274 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1277 : f32 = u_xlat31;
  let x_1279 : vec3<f32> = ((vec3<f32>(x_1271.x, x_1271.y, x_1271.z) * vec3<f32>(x_1274.x, x_1274.x, x_1274.x)) + vec3<f32>(x_1277, x_1277, x_1277));
  ...
  u_xlat0 = vec4<f32>(x_1294.x, x_1293.x, x_1293.y, x_1293.z);
  let x_1298 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1298);
  let x_1300 : bool = u_xlatb1;
  if (x_1300) {
    ...
    let x_1311 : vec3<f32> = clamp(vec3<f32>(x_1307.x, x_1307.y, x_1307.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1312 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1311.x, x_1311.y, x_1311.z, x_1312.w);
    let x_1314 : vec4<f32> = u_xlat1;
    u_xlat0.x = dot(vec3<f32>(x_1314.x, x_1314.y, x_1314.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1320 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1320.y, x_1320.z, x_1320.w, x_1320.x);
  return;
}
