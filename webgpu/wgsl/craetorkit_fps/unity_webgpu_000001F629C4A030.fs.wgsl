...
fn main_1() {
  ...
  u_xlat1 = vec4<f32>(x_1253.x, x_1253.y, x_1253.z, x_1254.w);
  let x_1256 : vec4<f32> = u_xlat1;
  let x_1260 : vec3<f32> = x_26.x_Lut2D_Params;
  u_xlat11 = (vec3<f32>(x_1256.x, x_1256.y, x_1256.z) * vec3<f32>(x_1260.z, x_1260.z, x_1260.z));
  let x_1264 : f32 = u_xlat11.x;
  u_xlat11.x = floor(x_1264);
  let x_1268 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1270 : vec2<f32> = (vec2<f32>(x_1268.x, x_1268.y) * vec2<f32>(0.5f, 0.5f));
  let x_1271 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1270.x, x_1270.y, x_1271.z, x_1271.w);
  let x_1273 : vec3<f32> = u_xlat11;
  let x_1276 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1279 : vec4<f32> = u_xlat2;
  let x_1281 : vec2<f32> = ((vec2<f32>(x_1273.y, x_1273.z) * vec2<f32>(x_1276.x, x_1276.y)) + vec2<f32>(x_1279.x, x_1279.y));
  let x_1282 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1282.x, x_1281.x, x_1281.y, x_1282.w);
  let x_1285 : f32 = u_xlat11.x;
  let x_1287 : f32 = x_26.x_Lut2D_Params.y;
  let x_1290 : f32 = u_xlat2.y;
  u_xlat2.x = ((x_1285 * x_1287) + x_1290);
  let x_1298 : vec4<f32> = u_xlat2;
  let x_1300 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1298.x, x_1298.z));
  let x_1301 : vec3<f32> = vec3<f32>(x_1300.x, x_1300.y, x_1300.z);
  let x_1302 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_1301.x, x_1301.y, x_1301.z, x_1302.w);
  let x_1305 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat4.x = x_1305;
  u_xlat4.y = 0.0f;
  let x_1308 : vec4<f32> = u_xlat2;
  let x_1310 : vec4<f32> = u_xlat4;
  u_xlat21 = (vec2<f32>(x_1308.x, x_1308.z) + vec2<f32>(x_1310.x, x_1310.y));
  let x_1316 : vec2<f32> = u_xlat21;
  let x_1317 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, x_1316);
  let x_1318 : vec3<f32> = vec3<f32>(x_1317.x, x_1317.y, x_1317.z);
  let x_1319 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1318.x, x_1318.y, x_1318.z, x_1319.w);
  let x_1322 : f32 = u_xlat1.x;
  let x_1325 : f32 = x_26.x_Lut2D_Params.z;
  let x_1328 : f32 = u_xlat11.x;
  u_xlat1.x = ((x_1322 * x_1325) + -(x_1328));
  let x_1332 : vec4<f32> = u_xlat3;
  let x_1335 : vec4<f32> = u_xlat2;
  u_xlat11 = (-(vec3<f32>(x_1332.x, x_1332.y, x_1332.z)) + vec3<f32>(x_1335.x, x_1335.y, x_1335.z));
  let x_1338 : vec4<f32> = u_xlat1;
  let x_1340 : vec3<f32> = u_xlat11;
  let x_1342 : vec4<f32> = u_xlat3;
  let x_1344 : vec3<f32> = ((vec3<f32>(x_1338.x, x_1338.x, x_1338.x) * x_1340) + vec3<f32>(x_1342.x, x_1342.y, x_1342.z));
  let x_1345 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1344.x, x_1344.y, x_1344.z, x_1345.w);
  let x_1349 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1349);
  let x_1351 : bool = u_xlatb1;
  if (x_1351) {
    ...
    let x_1362 : vec3<f32> = clamp(vec3<f32>(x_1358.x, x_1358.y, x_1358.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1363 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1362.x, x_1362.y, x_1362.z, x_1363.w);
    let x_1365 : vec4<f32> = u_xlat1;
    u_xlat0.w = dot(vec3<f32>(x_1365.x, x_1365.y, x_1365.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
