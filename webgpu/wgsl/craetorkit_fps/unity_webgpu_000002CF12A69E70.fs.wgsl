...
fn main_1() {
  ...
  SV_Target0.x = exp2(x_674);
  let x_678 : vec3<f32> = u_xlat10;
  let x_683 : vec3<f32> = ((x_678 * vec3<f32>(0.5f, 0.5f, -0.5f)) + vec3<f32>(0.5f, 0.5f, 0.5f));
  let x_684 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_684.x, x_683.x, x_683.y, x_683.z);
  return;
}
