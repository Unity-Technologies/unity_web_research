...
fn main_1() {
  ...
  let x_342 : f32 = u_xlat13;
  u_xlat0.x = (-(x_340) + x_342);
  let x_346 : f32 = x_18.unity_LightShadowBias.y;
  let x_348 : f32 = u_xlat0.x;
  let x_350 : f32 = u_xlat8;
  gl_Position.z = ((x_346 * x_348) + x_350);
  let x_354 : vec4<f32> = u_xlat1;
  let x_357 : vec4<f32> = x_18.unity_ObjectToWorld[1i];
  ...
  let x_363 : vec4<f32> = x_18.unity_ObjectToWorld[0i];
  ...
  let x_374 : vec4<f32> = x_18.unity_ObjectToWorld[2i];
  ...
  let x_387 : vec4<f32> = x_18.unity_ObjectToWorld[3i];
  let x_389 : vec4<f32> = in_POSITION0;
  let x_392 : vec4<f32> = u_xlat0;
  vs_TEXCOORD1 = ((vec3<f32>(x_387.x, x_387.y, x_387.z) * vec3<f32>(x_389.w, x_389.w, x_389.w)) + vec3<f32>(x_392.x, x_392.y, x_392.z));
  return;
}
