...
fn main_1() {
  ...
  let x_142 : vec4<f32> = x_34.unity_FogColor;
  u_xlat1 = ((vec3<f32>(x_137, x_137, x_137) * x_139) + vec3<f32>(x_142.x, x_142.y, x_142.z));
  let x_145 : vec4<f32> = u_xlat0;
  let x_147 : f32 = u_xlat9;
  let x_149 : vec3<f32> = (vec3<f32>(x_145.x, x_145.y, x_145.z) * vec3<f32>(x_147, x_147, x_147));
  let x_150 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_149.x, x_149.y, x_149.z, x_150.w);
  let x_156 : i32 = x_34.x_DstBlend;
  u_xlatb9 = (x_156 == 1i);
  let x_158 : bool = u_xlatb9;
  if (x_158) {
    let x_162 : vec4<f32> = u_xlat0;
    x_159 = vec3<f32>(x_162.x, x_162.y, x_162.z);
  } else {
    let x_165 : vec3<f32> = u_xlat1;
    x_159 = x_165;
  }
  let x_166 : vec3<f32> = x_159;
