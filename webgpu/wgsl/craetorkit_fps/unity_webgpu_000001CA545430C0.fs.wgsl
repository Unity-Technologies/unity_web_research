...
@group(0) @binding(7) var sampler_CameraGBufferTexture2 : sampler;

@group(0) @binding(2) var x_CameraGBufferTexture1 : texture_2d<f32>;

@group(0) @binding(6) var sampler_CameraGBufferTexture1 : sampler;

@group(0) @binding(1) var x_CameraGBufferTexture0 : texture_2d<f32>;

@group(0) @binding(5) var sampler_CameraGBufferTexture0 : sampler;
...
fn main_1() {
  ...
  let x_471 : vec3<f32> = ((vec3<f32>(x_464.x, x_464.y, x_464.w) * vec3<f32>(x_466.x, x_466.y, x_466.z)) + vec3<f32>(x_469.x, x_469.y, x_469.z));
