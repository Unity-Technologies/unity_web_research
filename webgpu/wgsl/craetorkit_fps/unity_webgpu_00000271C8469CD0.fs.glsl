...
int u_xlati22;
    ...
    if(u_xlatb21){
        ...
        u_xlat2.x = u_xlat21 * 0.0773993805;
        u_xlat9 = u_xlat21 + 0.0549999997;
        ...
        u_xlat21 = (u_xlatb21) ? u_xlat2.x : u_xlat9;
        u_xlat4.xyz = (-_Vignette_Color.xyz) + vec3(1.0, 1.0, 1.0);
        u_xlat4.xyz = vec3(u_xlat21) * u_xlat4.xyz + _Vignette_Color.xyz;
