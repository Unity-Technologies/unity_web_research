...
fn main_1() {
  ...
  u_xlatb3 = vec3<bool>(x_1409.x, x_1409.y, x_1409.z);
  let x_1412 : vec4<f32> = u_xlat0;
  hlslcc_movcTemp = x_1412;
  let x_1414 : bool = u_xlatb3.x;
  if (x_1414) {
  ...
  u_xlat3 = vec4<f32>(x_1496.x, x_1496.y, x_1496.z, x_1497.w);
  ...
  u_xlat3 = vec4<f32>(x_1551.x, x_1551.y, x_1551.z, x_1552.w);
  ...
  u_xlat3 = vec4<f32>(x_1568.x, x_1568.y, x_1568.z, x_1569.w);
  ...
  u_xlat2.z = x_1616;
  let x_1620 : f32 = x_26.x_LumaInAlpha;
  u_xlatb0.x = (0.5f < x_1620);
  let x_1624 : bool = u_xlatb0.x;
  if (x_1624) {
    let x_1627 : vec4<f32> = u_xlat2;
    let x_1628 : vec3<f32> = vec3<f32>(x_1627.x, x_1627.y, x_1627.z);
    ...
    u_xlat2.w = dot(vec3<f32>(x_1638.x, x_1638.y, x_1638.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
