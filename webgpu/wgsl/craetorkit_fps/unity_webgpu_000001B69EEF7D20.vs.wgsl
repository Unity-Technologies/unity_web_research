...
fn main_1() {
  ...
  vs_TEXCOORD3 = vec4<f32>(x_311.x, x_311.y, x_310.x, x_310.y);
  let x_314 : f32 = u_xlat1.y;
  let x_316 : f32 = x_19.x_ProjectionParams.x;
  u_xlat0.x = (x_314 * x_316);
  let x_319 : vec4<f32> = u_xlat1;
  let x_323 : vec2<f32> = (vec2<f32>(x_319.x, x_319.w) * vec2<f32>(0.5f, 0.5f));
  let x_324 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_323.x, x_324.y, x_323.y, x_324.w);
  let x_327 : f32 = u_xlat0.x;
  u_xlat1.w = (x_327 * 0.5f);
  ...
  vs_TEXCOORD3 = vec4<f32>(x_335.x, x_335.y, x_336.z, x_336.w);
  return;
}
...
fn main(@location(0) in_POSITION0_param : vec4<f32>, @location(2) in_COLOR0_param : vec4<f32>, @location(1) in_NORMAL0_param : vec3<f32>) -> main_out {
  ...
  main_1();
  return main_out(gl_Position, vs_TEXCOORD0, vs_TEXCOORD1, vs_COLOR0, vs_TEXCOORD4, vs_TEXCOORD3);
}
