...
float u_xlat24;
    ...
    u_xlat2.xzw = u_xlat6.xyz * u_xlat7.xxx;
    u_xlat7.xyz = u_xlat1.xyz * vec3(u_xlat21) + u_xlat2.xzw;
    u_xlat1.xyz = vec3(u_xlat24) * u_xlat4.xyz;
    u_xlat2.xzw = (-u_xlat6.xyz) + u_xlat0.xxx;
    u_xlat2.xyz = u_xlat2.yyy * u_xlat2.xzw + u_xlat6.xyz;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat3.xyz;
    u_xlat0.xyz = u_xlat7.xyz * u_xlat1.xyz + u_xlat2.xyz;
