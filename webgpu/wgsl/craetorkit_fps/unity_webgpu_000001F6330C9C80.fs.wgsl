...
fn main_1() {
  ...
  let x_550 : f32 = vs_TEXCOORD1.w;
  u_xlat27 = x_550;
  let x_551 : f32 = u_xlat27;
  u_xlat27 = clamp(x_551, 0.0f, 1.0f);
  let x_553 : vec3<f32> = u_xlat0;
  let x_555 : vec4<f32> = x_45.unity_FogColor;
  u_xlat0 = (x_553 + -(vec3<f32>(x_555.x, x_555.y, x_555.z)));
  let x_561 : f32 = u_xlat27;
  let x_563 : vec3<f32> = u_xlat0;
  let x_566 : vec4<f32> = x_45.unity_FogColor;
  let x_568 : vec3<f32> = ((vec3<f32>(x_561, x_561, x_561) * x_563) + vec3<f32>(x_566.x, x_566.y, x_566.z));
  let x_569 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_568.x, x_568.y, x_568.z, x_569.w);
  SV_Target0.w = 1.0f;
  return;
}
