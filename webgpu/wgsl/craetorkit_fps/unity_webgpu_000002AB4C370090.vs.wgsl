...
fn main_1() {
  ...
  let x_270 : vec4<f32> = x_17.unity_WorldToLight[0i];
  ...
  let x_281 : vec4<f32> = x_17.unity_WorldToLight[2i];
  ...
  let x_294 : vec4<f32> = x_17.unity_WorldToLight[3i];
  let x_296 : vec4<f32> = u_xlat0;
  let x_299 : vec4<f32> = u_xlat0;
  vs_TEXCOORD5 = ((vec3<f32>(x_294.x, x_294.y, x_294.z) * vec3<f32>(x_296.w, x_296.w, x_296.w)) + vec3<f32>(x_299.x, x_299.y, x_299.z));
