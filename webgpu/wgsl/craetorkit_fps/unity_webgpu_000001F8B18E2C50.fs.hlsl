...
static const int CHROMATIC_ABERRATION_LOW = 0 ;
static const int BLOOM = 0 ;
static const int VIGNETTE = 0 ;
static const int FINALPASS = 0 ;
static const int COLOR_GRADING_LDR_2D = 0 ;
static const int COLOR_GRADING_HDR_3D = 0 ;
...
#line 15 "D:/unity/fps_webgpu/Library/PackageCache/com.unity.postprocessing@3.2.2/PostProcessing/Shaders/Sampling.hlsl"
...
#line 4 "D:/unity/fps_webgpu/Library/PackageCache/com.unity.postprocessing@3.2.2/PostProcessing/Shaders/Builtins/Distortion.hlsl"
...
#line 55
Texture2D _Lut2D ; SamplerState sampler_Lut2D ;
...
half4 s = _MainTex . SampleLevel ( sampler_MainTex , UnityStereoTransformScreenSpaceTex ( Distort ( pos ) ) , 0 ) ;
half4 filter = half4 ( _ChromaticAberration_SpectralLut . SampleLevel ( sampler_ChromaticAberration_SpectralLut , float2 ( t , 0.0 ) , 0 ) . rgb , 1.0 ) ;
...
{
#line 154
half4 bloom = UpsampleBox ( _BloomTex , sampler_BloomTex , uvDistorted , _BloomTex_TexelSize . xy , _Bloom_Settings . x ) ;
#line 161
...
color . rgb = ApplyLut2D ( _Lut2D , sampler_Lut2D , colorLutSpace , _Lut2D_Params ) ;
}
#line 235
half4 output = color ;
#line 248
