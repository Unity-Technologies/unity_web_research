...
fn main_1() {
  ...
  let x_265 : f32 = u_xlat6;
  let x_268 : vec4<f32> = u_xlat1;
  let x_270 : vec3<f32> = ((vec3<f32>(x_263.x, x_263.y, x_263.w) * vec3<f32>(x_265, x_265, x_265)) + vec3<f32>(x_268.x, x_268.y, x_268.z));
  let x_271 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_270.x, x_270.y, x_270.z, x_271.w);
  let x_274 : vec4<f32> = u_xlat0;
  let x_277 : vec3<f32> = exp2(-(vec3<f32>(x_274.x, x_274.y, x_274.z)));
  let x_278 : vec4<f32> = SV_Target3;
  SV_Target3 = vec4<f32>(x_277.x, x_277.y, x_277.z, x_278.w);
  SV_Target3.w = 1.0f;
  return;
}
