...
fn main_1() {
  ...
  vs_TEXCOORD5 = vec4<f32>(x_309.x, x_309.y, x_308.x, x_308.y);
  let x_312 : f32 = u_xlat1.y;
  let x_315 : f32 = x_131.x_ProjectionParams.x;
  u_xlat0.x = (x_312 * x_315);
  let x_318 : vec4<f32> = u_xlat1;
  let x_322 : vec2<f32> = (vec2<f32>(x_318.x, x_318.w) * vec2<f32>(0.5f, 0.5f));
  let x_323 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_322.x, x_323.y, x_322.y, x_323.w);
  let x_326 : f32 = u_xlat0.x;
  u_xlat1.w = (x_326 * 0.5f);
  ...
  vs_TEXCOORD5 = vec4<f32>(x_333.x, x_333.y, x_334.z, x_334.w);
  return;
}
...
fn main(@location(1) in_TEXCOORD0_param : vec4<f32>, @location(2) in_NORMAL0_param : vec3<f32>, @location(0) in_POSITION0_param : vec4<f32>) -> main_out {
  ...
  main_1();
  return main_out(gl_Position, vs_TEXCOORD0, vs_TEXCOORD3, vs_TEXCOORD1, vs_TEXCOORD2, vs_TEXCOORD6, vs_TEXCOORD5);
}
