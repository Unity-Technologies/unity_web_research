...
fn main_1() {
  ...
  let x_419 : f32 = vs_TEXCOORD1.w;
  u_xlat9 = x_419;
  let x_420 : f32 = u_xlat9;
  u_xlat9 = clamp(x_420, 0.0f, 1.0f);
  let x_424 : vec4<f32> = u_xlat0;
  let x_426 : f32 = u_xlat9;
  let x_428 : vec3<f32> = (vec3<f32>(x_424.x, x_424.y, x_424.z) * vec3<f32>(x_426, x_426, x_426));
  let x_429 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_428.x, x_428.y, x_428.z, x_429.w);
  SV_Target0.w = 1.0f;
  return;
}
