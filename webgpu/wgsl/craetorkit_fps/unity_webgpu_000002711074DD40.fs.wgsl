...
fn main_1() {
  ...
  let x_1215 : vec4<f32> = vs_TEXCOORD0;
  let x_1217 : vec4<f32> = textureSample(x_EmissionMap, sampler_EmissionMap, vec2<f32>(x_1215.x, x_1215.y));
  u_xlat1 = vec3<f32>(x_1217.x, x_1217.y, x_1217.z);
  let x_1219 : vec3<f32> = u_xlat1;
  let x_1222 : vec4<f32> = x_33.x_EmissionColor;
  let x_1225 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1219 * vec3<f32>(x_1222.x, x_1222.y, x_1222.z)) + x_1225);
  let x_1228 : f32 = vs_TEXCOORD1.w;
  let x_1230 : f32 = x_33.x_ProjectionParams.y;
  u_xlat45 = (x_1228 / x_1230);
  let x_1232 : f32 = u_xlat45;
  u_xlat45 = (-(x_1232) + 1.0f);
  let x_1235 : f32 = u_xlat45;
  let x_1237 : f32 = x_33.x_ProjectionParams.z;
  u_xlat45 = (x_1235 * x_1237);
  let x_1239 : f32 = u_xlat45;
  u_xlat45 = max(x_1239, 0.0f);
  let x_1241 : f32 = u_xlat45;
  let x_1244 : f32 = x_33.unity_FogParams.x;
  u_xlat45 = (x_1241 * x_1244);
  let x_1246 : f32 = u_xlat45;
  let x_1247 : f32 = u_xlat45;
  u_xlat45 = (x_1246 * -(x_1247));
  let x_1250 : f32 = u_xlat45;
  u_xlat45 = exp2(x_1250);
  let x_1252 : vec3<f32> = u_xlat0;
  let x_1255 : vec4<f32> = x_33.unity_FogColor;
  u_xlat0 = (x_1252 + -(vec3<f32>(x_1255.x, x_1255.y, x_1255.z)));
  let x_1261 : f32 = u_xlat45;
  let x_1263 : vec3<f32> = u_xlat0;
  let x_1266 : vec4<f32> = x_33.unity_FogColor;
  let x_1268 : vec3<f32> = ((vec3<f32>(x_1261, x_1261, x_1261) * x_1263) + vec3<f32>(x_1266.x, x_1266.y, x_1266.z));
