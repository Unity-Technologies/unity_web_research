...
fn main_1() {
  ...
  let x_420 : vec3<f32> = (vec3<f32>(x_417.x, x_417.y, x_417.w) * x_419);
  let x_421 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_420.x, x_420.y, x_420.z, x_421.w);
  let x_424 : f32 = vs_TEXCOORD1.w;
  u_xlat21 = x_424;
  let x_425 : f32 = u_xlat21;
  u_xlat21 = clamp(x_425, 0.0f, 1.0f);
  let x_429 : vec4<f32> = u_xlat0;
  let x_431 : f32 = u_xlat21;
  let x_433 : vec3<f32> = (vec3<f32>(x_429.x, x_429.y, x_429.z) * vec3<f32>(x_431, x_431, x_431));
  let x_434 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_433.x, x_433.y, x_433.z, x_434.w);
  SV_Target0.w = 1.0f;
  return;
}
