...
fn main_1() {
  ...
  let x_1532 : vec3<f32> = ((vec3<f32>(x_1525.x, x_1525.y, x_1525.z) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1561 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1563 : vec3<f32> = (vec3<f32>(x_1557.x, x_1557.y, x_1557.z) * vec3<f32>(x_1561.y, x_1561.y, x_1561.y));
  let x_1564 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1563.x, x_1563.y, x_1563.z, x_1564.w);
  let x_1567 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat1.x = (x_1567 * 0.5f);
  let x_1570 : vec4<f32> = u_xlat0;
  let x_1573 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1576 : vec3<f32> = u_xlat1;
  let x_1578 : vec3<f32> = ((vec3<f32>(x_1570.x, x_1570.y, x_1570.z) * vec3<f32>(x_1573.x, x_1573.x, x_1573.x)) + vec3<f32>(x_1576.x, x_1576.x, x_1576.x));
  let x_1579 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1578.x, x_1578.y, x_1578.z, x_1579.w);
  let x_1589 : vec4<f32> = u_xlat0;
  let x_1591 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1589.x, x_1589.y, x_1589.z));
  let x_1592 : vec3<f32> = vec3<f32>(x_1591.x, x_1591.y, x_1591.z);
  let x_1593 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1592.x, x_1592.y, x_1592.z, x_1593.w);
  let x_1595 : vec2<f32> = vs_TEXCOORD0;
  let x_1598 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1602 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1604 : vec2<f32> = ((x_1595 * vec2<f32>(x_1598.x, x_1598.y)) + vec2<f32>(x_1602.z, x_1602.w));
  let x_1605 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1604.x, x_1604.y, x_1605.z);
  let x_1612 : vec3<f32> = u_xlat1;
  let x_1614 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1612.x, x_1612.y));
  u_xlat1.x = x_1614.w;
  let x_1618 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1618 * 2.0f) + -1.0f);
  let x_1623 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1623 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1629 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1629, 0.0f, 1.0f);
  let x_1633 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1633 * 2.0f) + -1.0f);
  let x_1638 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1638)) + 1.0f);
  let x_1644 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1644);
  let x_1648 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1648) + 1.0f);
  let x_1653 : f32 = u_xlat1.x;
  let x_1655 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1653 * x_1655);
  let x_1658 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1658.x, x_1658.y, x_1658.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1663 : vec4<f32> = u_xlat0;
  let x_1667 : vec3<f32> = max(abs(vec3<f32>(x_1663.x, x_1663.y, x_1663.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1668 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1667.x, x_1667.y, x_1667.z, x_1668.w);
  let x_1670 : vec4<f32> = u_xlat2;
  let x_1672 : vec3<f32> = log2(vec3<f32>(x_1670.x, x_1670.y, x_1670.z));
  let x_1673 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1672.x, x_1672.y, x_1672.z, x_1673.w);
  let x_1675 : vec4<f32> = u_xlat2;
  let x_1679 : vec3<f32> = (vec3<f32>(x_1675.x, x_1675.y, x_1675.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1680 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1679.x, x_1679.y, x_1679.z, x_1680.w);
  let x_1682 : vec4<f32> = u_xlat2;
  let x_1684 : vec3<f32> = exp2(vec3<f32>(x_1682.x, x_1682.y, x_1682.z));
  let x_1685 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1684.x, x_1684.y, x_1684.z, x_1685.w);
  let x_1687 : vec4<f32> = u_xlat2;
  let x_1694 : vec3<f32> = ((vec3<f32>(x_1687.x, x_1687.y, x_1687.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1695 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1694.x, x_1694.y, x_1694.z, x_1695.w);
  let x_1702 : vec4<f32> = u_xlat0;
  let x_1705 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1702.x, x_1702.y, x_1702.z, x_1702.x));
  u_xlatb0 = vec3<bool>(x_1705.x, x_1705.y, x_1705.z);
  let x_1708 : bool = u_xlatb0.x;
  if (x_1708) {
  ...
  let x_1750 : vec3<f32> = ((vec3<f32>(x_1743.x, x_1743.x, x_1743.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1748.x, x_1748.y, x_1748.z));
  ...
  let x_1794 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1792.x, x_1792.y, x_1792.z, x_1792.x));
  u_xlatb0 = vec3<bool>(x_1794.x, x_1794.y, x_1794.z);
  let x_1799 : bool = u_xlatb0.x;
  if (x_1799) {
    let x_1804 : f32 = u_xlat1.x;
    x_1800 = x_1804;
  } else {
    let x_1807 : f32 = u_xlat2.x;
    x_1800 = x_1807;
  }
  let x_1808 : f32 = x_1800;
  SV_Target0.x = x_1808;
  let x_1812 : bool = u_xlatb0.y;
  if (x_1812) {
    let x_1817 : f32 = u_xlat1.y;
    x_1813 = x_1817;
  } else {
    let x_1820 : f32 = u_xlat2.y;
    x_1813 = x_1820;
  }
  let x_1821 : f32 = x_1813;
  SV_Target0.y = x_1821;
  let x_1824 : bool = u_xlatb0.z;
  if (x_1824) {
    let x_1829 : f32 = u_xlat1.z;
    x_1825 = x_1829;
  } else {
    let x_1832 : f32 = u_xlat2.z;
    x_1825 = x_1832;
  }
  let x_1833 : f32 = x_1825;
  SV_Target0.z = x_1833;
  let x_1836 : f32 = u_xlat0.w;
  SV_Target0.w = x_1836;
  return;
}
