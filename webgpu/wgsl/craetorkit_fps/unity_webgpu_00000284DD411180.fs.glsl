...
bool u_xlatb18;
    ...
    u_xlat3.xyz = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD1.zw).xyz;
...
;
    ...
    u_xlat4.xyz = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD2.xy).xyz;
    u_xlat4.xyz = u_xlat0.xyz + (-u_xlat4.xyz);
    u_xlat18 = max(abs(u_xlat4.y), abs(u_xlat4.x));
    u_xlat4.x = max(abs(u_xlat4.z), u_xlat18);
    u_xlat5.xyz = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD2.zw).xyz;
    ...
    u_xlat4.xyz = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD3.xy).xyz;
    u_xlat1.xyz = u_xlat1.xyz + (-u_xlat4.xyz);
    u_xlat12 = max(abs(u_xlat1.y), abs(u_xlat1.x));
    u_xlat1.x = max(abs(u_xlat1.z), u_xlat12);
    u_xlat4.xyz = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD3.zw).xyz;
