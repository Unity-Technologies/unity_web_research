...
layout(location = 1) in highp float vs_TEXCOORD6;
...
layout(set = 0, binding = 7) uniform mediump  sampler sampler_Specular;
void main()
{
vec3 u_xlat0;
vec3 u_xlat1;
...
bool u_xlatb23;
    ...
    u_xlat4.xy = texture(sampler2D(_Specular, sampler_Specular), vs_TEXCOORD0.xy).xw;
    u_xlat22 = u_xlat4.x * _Metallic;
    u_xlat4.xzw = texture(sampler2D(_NormalMap, sampler_NormalMap), vs_TEXCOORD0.xy).xyw;
    ...
    if(u_xlatb23){
        ...
        u_xlat4.xzw = vs_TEXCOORD4.yyy * unity_ProbeVolumeWorldToObject[1].xyz;
        u_xlat4.xzw = unity_ProbeVolumeWorldToObject[0].xyz * vs_TEXCOORD4.xxx + u_xlat4.xzw;
        u_xlat4.xzw = unity_ProbeVolumeWorldToObject[2].xyz * vs_TEXCOORD4.zzz + u_xlat4.xzw;
        u_xlat4.xzw = u_xlat4.xzw + unity_ProbeVolumeWorldToObject[3].xyz;
        u_xlat4.xzw = (bool(u_xlatb23)) ? u_xlat4.xzw : vs_TEXCOORD4.xyz;
        ...
        u_xlat6.x = max(u_xlat23, u_xlat4.x);
    ...
    u_xlat2.xyz = vec3(u_xlat22) * u_xlat2.xyz + vec3(0.0399999991, 0.0399999991, 0.0399999991);
    u_xlat22 = (-u_xlat22) * 0.959999979 + 0.959999979;
    u_xlat3.xyz = vec3(u_xlat22) * u_xlat3.xyz;
    u_xlat22 = (-u_xlat4.y) * _Glossiness + 1.0;
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat21) + _WorldSpaceLightPos0.xyz;
    u_xlat21 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat21 = max(u_xlat21, 0.00100000005);
    u_xlat21 = inversesqrt(u_xlat21);
    u_xlat0.xyz = vec3(u_xlat21) * u_xlat0.xyz;
    u_xlat21 = dot(u_xlat4.xzw, u_xlat1.xyz);
    u_xlat1.x = dot(u_xlat4.xzw, _WorldSpaceLightPos0.xyz);
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat8 = dot(u_xlat4.xzw, u_xlat0.xyz);
