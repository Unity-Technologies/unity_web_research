...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_370.y, x_370.y, x_370.y, x_370.y) * x_374);
  let x_377 : vec4<f32> = x_17.unity_WorldToLight[0i];
  let x_378 : vec4<f32> = u_xlat0;
  let x_381 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_377 * vec4<f32>(x_378.x, x_378.x, x_378.x, x_378.x)) + x_381);
  let x_384 : vec4<f32> = x_17.unity_WorldToLight[2i];
  let x_385 : vec4<f32> = u_xlat0;
  let x_388 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_384 * vec4<f32>(x_385.z, x_385.z, x_385.z, x_385.z)) + x_388);
  let x_392 : vec4<f32> = x_17.unity_WorldToLight[3i];
  let x_393 : vec4<f32> = u_xlat0;
  let x_396 : vec4<f32> = u_xlat1;
  vs_TEXCOORD6 = ((x_392 * vec4<f32>(x_393.w, x_393.w, x_393.w, x_393.w)) + x_396);
