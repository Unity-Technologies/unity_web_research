...
#line 14 "D:/src/unity_webgpu/Shaders/Includes/UnityStandardParticleInstancing.cginc"
...
#line 41 "D:/src/unity_webgpu/Shaders/Includes/UnityStandardParticles.cginc"
...
if ( _DstBlend == 1 )
{
float unityFogFactor = unity_FogParams . x * ( max ( ( ( 1.0 - ( ( IN . fogCoord ) . x ) / _ProjectionParams . y ) * _ProjectionParams . z ) , 0 ) ) ; unityFogFactor = exp2 ( - unityFogFactor * unityFogFactor ) ; result . rgb = lerp ( ( float4 ( 0 , 0 , 0 , 0 ) ) . rgb , ( result ) . rgb , saturate ( unityFogFactor ) ) ;
}
else
{
float unityFogFactor = unity_FogParams . x * ( max ( ( ( 1.0 - ( ( IN . fogCoord ) . x ) / _ProjectionParams . y ) * _ProjectionParams . z ) , 0 ) ) ; unityFogFactor = exp2 ( - unityFogFactor * unityFogFactor ) ; result . rgb = lerp ( ( unity_FogColor ) . rgb , ( result ) . rgb , saturate ( unityFogFactor ) ) ;
}
#line 422
return result ;
}
