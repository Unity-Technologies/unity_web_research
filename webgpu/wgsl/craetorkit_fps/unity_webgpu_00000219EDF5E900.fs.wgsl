...
fn main_1() {
  ...
  let x_577 : vec3<f32> = x_32.x_Bloom_Settings;
  ...
  let x_591 : vec3<f32> = x_32.x_Bloom_Color;
  ...
  let x_610 : f32 = x_32.x_Vignette_Mode;
  u_xlatb1 = (x_610 < 0.5f);
  let x_612 : bool = u_xlatb1;
  if (x_612) {
    let x_615 : vec2<f32> = u_xlat14;
    let x_619 : vec2<f32> = x_32.x_Vignette_Center;
    ...
    let x_629 : vec4<f32> = x_32.x_Vignette_Settings;
    ...
    let x_637 : f32 = x_32.x_ScreenParams.x;
    let x_639 : f32 = x_32.x_ScreenParams.y;
    u_xlat19 = (x_637 / x_639);
    let x_641 : f32 = u_xlat19;
    u_xlat19 = (x_641 + -1.0f);
    let x_644 : f32 = x_32.x_Vignette_Settings.w;
    ...
    let x_673 : vec4<f32> = x_32.x_Vignette_Settings;
    ...
    let x_786 : f32 = x_779;
    u_xlat1.x = x_786;
    let x_789 : vec3<f32> = x_32.x_Vignette_Color;
    ...
    let x_809 : f32 = x_32.x_Vignette_Opacity;
  ...
  let x_835 : vec4<f32> = x_32.x_Grain_Params2;
  ...
  u_xlat18 = sqrt(x_863);
  let x_867 : f32 = x_32.x_Grain_Params1.x;
  ...
  let x_883 : f32 = x_32.x_Grain_Params1.y;
  let x_885 : f32 = x_32.x_Grain_Params1.y;
  ...
  let x_902 : f32 = x_32.x_PostExposure;
  let x_904 : f32 = x_32.x_PostExposure;
  let x_906 : f32 = x_32.x_PostExposure;
  let x_908 : f32 = x_32.x_PostExposure;
  ...
  let x_952 : vec2<f32> = x_32.x_Lut3D_Params;
  ...
  let x_958 : f32 = x_32.x_Lut3D_Params.x;
  u_xlat1.x = (x_958 * 0.5f);
  let x_961 : vec4<f32> = u_xlat0;
  let x_964 : vec2<f32> = x_32.x_Lut3D_Params;
  ...
  let x_990 : vec4<f32> = x_32.x_Dithering_Coords;
  let x_994 : vec4<f32> = x_32.x_Dithering_Coords;
