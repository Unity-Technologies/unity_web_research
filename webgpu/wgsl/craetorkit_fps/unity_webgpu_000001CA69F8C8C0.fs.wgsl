...
fn main_1() {
  ...
  u_xlat0 = (-(x_84) + 1.0f);
  let x_94 : vec2<f32> = vs_TEXCOORD1;
  let x_95 : vec4<f32> = textureSample(x_MainTex, sampler_MainTex, x_94);
  u_xlat1 = x_95;
  let x_97 : vec4<f32> = u_xlat1;
  let x_102 : vec4<f32> = x_13.x_FogColor;
  u_xlat2 = (-(x_97) + x_102);
  let x_106 : f32 = u_xlat0;
  let x_108 : vec4<f32> = u_xlat2;
  let x_110 : vec4<f32> = u_xlat1;
  SV_Target0 = ((vec4<f32>(x_106, x_106, x_106, x_106) * x_108) + x_110);
  return;
}
