...
@group(1) @binding(0) var<uniform> x_83 : PGlobals;
...
fn main_1() {
  ...
  let x_88 : f32 = x_83.x_DistortionStrengthScaled;
  let x_90 : f32 = x_83.x_DistortionStrengthScaled;
  ...
  let x_105 : f32 = x_83.x_CameraFadeParams.x;
  u_xlat4 = (x_102 + -(x_105));
  let x_108 : f32 = u_xlat4;
  let x_111 : f32 = x_83.x_CameraFadeParams.y;
  u_xlat4 = (x_108 * x_111);
  ...
  let x_128 : vec4<f32> = x_83.x_Color;
  u_xlat1 = (x_124 * x_128);
  ...
  let x_146 : f32 = x_83.x_DistortionBlend;
  ...
  let x_204 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_203.x, x_203.y, x_203.z, x_204.w);
  return;
}
...
@fragment
fn main(@location(1) vs_TEXCOORD1_param : vec2<f32>, @location(2) vs_TEXCOORD3_param : vec4<f32>, @location(0) vs_COLOR0_param : vec4<f32>, @location(3) vs_TEXCOORD4_param : vec4<f32>, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
