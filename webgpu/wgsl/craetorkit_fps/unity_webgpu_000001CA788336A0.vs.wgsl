...
fn main_1() {
  ...
  let x_498 : f32 = u_xlat0.y;
  let x_500 : f32 = u_xlat0.y;
  u_xlat21 = (x_498 * x_500);
  let x_503 : f32 = u_xlat0.x;
  let x_505 : f32 = u_xlat0.x;
  let x_507 : f32 = u_xlat21;
  u_xlat21 = ((x_503 * x_505) + -(x_507));
  let x_510 : vec4<f32> = u_xlat0;
  let x_512 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec4<f32>(x_510.y, x_510.z, x_510.z, x_510.x) * vec4<f32>(x_512.x, x_512.y, x_512.z, x_512.z));
  let x_516 : vec4<f32> = x_184.unity_SHBr;
  let x_517 : vec4<f32> = u_xlat1;
  u_xlat0.x = dot(x_516, x_517);
  let x_521 : vec4<f32> = x_184.unity_SHBg;
  let x_522 : vec4<f32> = u_xlat1;
  u_xlat0.y = dot(x_521, x_522);
  let x_526 : vec4<f32> = x_184.unity_SHBb;
  let x_527 : vec4<f32> = u_xlat1;
  u_xlat0.z = dot(x_526, x_527);
  let x_532 : vec4<f32> = x_184.unity_SHC;
  let x_534 : f32 = u_xlat21;
  let x_537 : vec4<f32> = u_xlat0;
  vs_TEXCOORD3 = ((vec3<f32>(x_532.x, x_532.y, x_532.z) * vec3<f32>(x_534, x_534, x_534)) + vec3<f32>(x_537.x, x_537.y, x_537.z));
