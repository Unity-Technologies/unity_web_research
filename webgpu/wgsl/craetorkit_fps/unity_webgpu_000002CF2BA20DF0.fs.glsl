...
float u_xlat23;
    ...
    u_xlat23 = texture(sampler2D(_OcclusionMap, sampler_OcclusionMap), vs_TEXCOORD0.xy).y;
    ...
    u_xlat4 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat4.xyz, u_xlat22);
    ...
    u_xlat22 = clamp(u_xlat22, 0.0, 1.0);
    u_xlat9.x = texture(sampler2D(unity_NHxRoughness, samplerunity_NHxRoughness), u_xlat3.yw).x;
    ...
    u_xlat3.xyw = (-u_xlat0.xyz) + vec3(u_xlat22);
