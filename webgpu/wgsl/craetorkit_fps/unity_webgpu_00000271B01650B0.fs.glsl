...
float u_xlat9;
    ...
    u_xlat9 = texture(sampler2D(_AutoExposureTex, sampler_AutoExposureTex), vs_TEXCOORD0.xy).x;
    ...
    u_xlat4.xy = vs_TEXCOORD1.xy * _Grain_Params2.xy + _Grain_Params2.zw;
    u_xlat4.xyz = texture(sampler2D(_GrainTex, sampler_GrainTex), u_xlat4.xy).xyz;
    u_xlat4.xyz = u_xlat0.xyz * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz * vec3(_Grain_Params1.y, _Grain_Params1.y, _Grain_Params1.y);
