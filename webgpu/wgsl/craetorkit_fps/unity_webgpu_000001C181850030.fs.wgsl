...
fn main_1() {
  ...
  u_xlat3 = (x_1229 * vec4<f32>(0.0625f, 0.0625f, 0.0625f, 0.0625f));
  ...
  u_xlat1 = vec4<f32>(x_1238.x, x_1238.y, x_1238.z, x_1239.w);
  u_xlat1.w = 0.0f;
  ...
  u_xlat4 = vec4<f32>(x_1250.x, x_1250.y, x_1250.z, x_1251.w);
  let x_1254 : f32 = u_xlat2.w;
  u_xlat4.w = (x_1254 * 0.0625f);
  ...
  let x_1266 : vec2<f32> = vs_TEXCOORD1;
  let x_1269 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1273 : vec4<f32> = x_26.x_Grain_Params2;
  ...
  let x_1285 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1283.x, x_1283.y));
  let x_1286 : vec3<f32> = vec3<f32>(x_1285.x, x_1285.y, x_1285.z);
  let x_1287 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1286.x, x_1286.y, x_1286.z, x_1287.w);
  ...
  let x_1297 : vec3<f32> = clamp(vec3<f32>(x_1293.x, x_1293.y, x_1293.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1298 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1297.x, x_1297.y, x_1297.z, x_1298.w);
  let x_1300 : vec4<f32> = u_xlat2;
  u_xlat31 = dot(vec3<f32>(x_1300.x, x_1300.y, x_1300.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1307 : f32 = u_xlat31;
  u_xlat31 = sqrt(x_1307);
  let x_1311 : f32 = x_26.x_Grain_Params1.x;
  let x_1312 : f32 = u_xlat31;
  u_xlat31 = ((x_1311 * -(x_1312)) + 1.0f);
  ...
  let x_1326 : f32 = x_26.x_Grain_Params1.y;
  let x_1328 : f32 = x_26.x_Grain_Params1.y;
  let x_1330 : f32 = x_26.x_Grain_Params1.y;
  let x_1332 : vec3<f32> = (vec3<f32>(x_1323.x, x_1323.y, x_1323.z) * vec3<f32>(x_1326, x_1328, x_1330));
  let x_1333 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1332.x, x_1332.y, x_1332.z, x_1333.w);
  let x_1335 : vec4<f32> = u_xlat1;
  let x_1337 : f32 = u_xlat31;
  let x_1340 : vec4<f32> = u_xlat0;
  let x_1342 : vec3<f32> = ((vec3<f32>(x_1335.x, x_1335.y, x_1335.z) * vec3<f32>(x_1337, x_1337, x_1337)) + vec3<f32>(x_1340.x, x_1340.y, x_1340.z));
  let x_1343 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1342.x, x_1342.y, x_1342.z, x_1343.w);
  let x_1345 : vec4<f32> = u_xlat0;
  let x_1349 : vec3<f32> = clamp(vec3<f32>(x_1345.x, x_1345.y, x_1345.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1350 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1349.x, x_1349.y, x_1349.z, x_1350.w);
  let x_1354 : f32 = u_xlat0.w;
  u_xlat30 = x_1354;
  let x_1355 : f32 = u_xlat30;
  u_xlat30 = clamp(x_1355, 0.0f, 1.0f);
  let x_1357 : vec4<f32> = u_xlat0;
  let x_1361 : vec3<f32> = (vec3<f32>(x_1357.z, x_1357.x, x_1357.y) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1362 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1361.x, x_1361.y, x_1361.z, x_1362.w);
  let x_1364 : vec4<f32> = u_xlat0;
  let x_1368 : vec3<f32> = max(vec3<f32>(x_1364.z, x_1364.x, x_1364.y), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1406 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1403.z, x_1403.x, x_1403.y, x_1403.z));
  ...
  let x_1449 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1451 : vec3<f32> = (vec3<f32>(x_1445.x, x_1445.y, x_1445.z) * vec3<f32>(x_1449.z, x_1449.z, x_1449.z));
  let x_1452 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1451.x, x_1451.y, x_1451.z, x_1452.w);
  let x_1456 : f32 = u_xlat1.x;
  u_xlat10 = floor(x_1456);
  let x_1459 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1461 : vec2<f32> = (vec2<f32>(x_1459.x, x_1459.y) * vec2<f32>(0.5f, 0.5f));
  let x_1462 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1461.x, x_1462.y, x_1462.z, x_1461.y);
  let x_1464 : vec4<f32> = u_xlat1;
  let x_1467 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1470 : vec4<f32> = u_xlat1;
  let x_1472 : vec2<f32> = ((vec2<f32>(x_1464.y, x_1464.z) * vec2<f32>(x_1467.x, x_1467.y)) + vec2<f32>(x_1470.x, x_1470.w));
  let x_1473 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1473.x, x_1472.x, x_1472.y, x_1473.w);
  let x_1475 : f32 = u_xlat10;
  let x_1477 : f32 = x_26.x_Lut2D_Params.y;
  let x_1480 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1475 * x_1477) + x_1480);
  let x_1488 : vec4<f32> = u_xlat1;
  let x_1490 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1488.x, x_1488.z));
  let x_1491 : vec3<f32> = vec3<f32>(x_1490.x, x_1490.y, x_1490.z);
  let x_1492 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1491.x, x_1491.y, x_1491.z, x_1492.w);
  let x_1495 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat3.x = x_1495;
  u_xlat3.y = 0.0f;
  let x_1498 : vec4<f32> = u_xlat1;
  let x_1500 : vec4<f32> = u_xlat3;
  let x_1502 : vec2<f32> = (vec2<f32>(x_1498.x, x_1498.z) + vec2<f32>(x_1500.x, x_1500.y));
  let x_1503 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1502.x, x_1502.y, x_1503.z, x_1503.w);
  let x_1508 : vec4<f32> = u_xlat1;
  let x_1510 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1508.x, x_1508.y));
  let x_1511 : vec3<f32> = vec3<f32>(x_1510.x, x_1510.y, x_1510.z);
  let x_1512 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1511.x, x_1511.y, x_1511.z, x_1512.w);
  let x_1515 : f32 = u_xlat0.x;
  let x_1517 : f32 = x_26.x_Lut2D_Params.z;
  let x_1519 : f32 = u_xlat10;
  u_xlat0.x = ((x_1515 * x_1517) + -(x_1519));
  let x_1523 : vec4<f32> = u_xlat2;
  let x_1526 : vec4<f32> = u_xlat1;
  let x_1528 : vec3<f32> = (-(vec3<f32>(x_1523.x, x_1523.y, x_1523.z)) + vec3<f32>(x_1526.x, x_1526.y, x_1526.z));
  ...
  let x_1538 : vec3<f32> = ((vec3<f32>(x_1531.x, x_1531.x, x_1531.x) * vec3<f32>(x_1533.x, x_1533.y, x_1533.z)) + vec3<f32>(x_1536.x, x_1536.y, x_1536.z));
  let x_1539 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1538.x, x_1538.y, x_1538.z, x_1539.w);
  let x_1541 : vec4<f32> = u_xlat0;
  let x_1545 : vec3<f32> = (vec3<f32>(x_1541.x, x_1541.y, x_1541.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1546 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1545.x, x_1545.y, x_1545.z, x_1546.w);
  let x_1548 : vec4<f32> = u_xlat0;
  let x_1552 : vec3<f32> = (vec3<f32>(x_1548.x, x_1548.y, x_1548.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1553 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1552.x, x_1552.y, x_1552.z, x_1553.w);
  let x_1555 : vec4<f32> = u_xlat2;
  let x_1559 : vec3<f32> = (vec3<f32>(x_1555.x, x_1555.y, x_1555.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1560 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1559.x, x_1559.y, x_1559.z, x_1560.w);
  let x_1562 : vec4<f32> = u_xlat2;
  let x_1565 : vec3<f32> = max(abs(vec3<f32>(x_1562.x, x_1562.y, x_1562.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1577 : vec3<f32> = (vec3<f32>(x_1573.x, x_1573.y, x_1573.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1589 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1587.x, x_1587.y, x_1587.z, x_1587.x));
  ...
  u_xlat0.z = x_1625;
  let x_1627 : vec2<f32> = vs_TEXCOORD0;
  let x_1630 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1634 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1636 : vec2<f32> = ((x_1627 * vec2<f32>(x_1630.x, x_1630.y)) + vec2<f32>(x_1634.z, x_1634.w));
  let x_1637 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1636.x, x_1636.y, x_1637.z, x_1637.w);
  let x_1644 : vec4<f32> = u_xlat1;
  let x_1646 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1644.x, x_1644.y));
  u_xlat1.x = x_1646.w;
  let x_1650 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1650 * 2.0f) + -1.0f);
  let x_1655 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1655 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1661 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1661, 0.0f, 1.0f);
  let x_1665 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1665 * 2.0f) + -1.0f);
  let x_1670 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1670)) + 1.0f);
  let x_1676 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1676);
  let x_1680 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1680) + 1.0f);
  let x_1685 : f32 = u_xlat1.x;
  let x_1687 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1685 * x_1687);
  let x_1690 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1690.x, x_1690.y, x_1690.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1693 : vec4<f32> = u_xlat0;
  let x_1696 : vec3<f32> = max(abs(vec3<f32>(x_1693.x, x_1693.y, x_1693.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1697 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1696.x, x_1696.y, x_1696.z, x_1697.w);
  let x_1699 : vec4<f32> = u_xlat2;
  let x_1701 : vec3<f32> = log2(vec3<f32>(x_1699.x, x_1699.y, x_1699.z));
  let x_1702 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1701.x, x_1701.y, x_1701.z, x_1702.w);
  let x_1704 : vec4<f32> = u_xlat2;
  let x_1706 : vec3<f32> = (vec3<f32>(x_1704.x, x_1704.y, x_1704.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1717 : vec3<f32> = ((vec3<f32>(x_1714.x, x_1714.y, x_1714.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1718 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1717.x, x_1717.y, x_1717.z, x_1718.w);
  let x_1720 : vec4<f32> = u_xlat0;
  let x_1722 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1720.x, x_1720.y, x_1720.z, x_1720.x));
  u_xlatb0 = vec3<bool>(x_1722.x, x_1722.y, x_1722.z);
  let x_1725 : bool = u_xlatb0.x;
  if (x_1725) {
    let x_1730 : f32 = u_xlat11.x;
    x_1726 = x_1730;
  } else {
  ...
  u_xlat0.x = x_1734;
  let x_1737 : bool = u_xlatb0.y;
  if (x_1737) {
    let x_1742 : f32 = u_xlat11.y;
    x_1738 = x_1742;
  } else {
    let x_1745 : f32 = u_xlat2.y;
    x_1738 = x_1745;
  }
  let x_1746 : f32 = x_1738;
  u_xlat0.y = x_1746;
  let x_1749 : bool = u_xlatb0.z;
  if (x_1749) {
    let x_1754 : f32 = u_xlat11.z;
    x_1750 = x_1754;
  } else {
  ...
  let x_1765 : vec4<f32> = u_xlat0;
  let x_1767 : vec3<f32> = ((vec3<f32>(x_1760.x, x_1760.x, x_1760.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1765.x, x_1765.y, x_1765.z));
  let x_1768 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1767.x, x_1767.y, x_1767.z, x_1768.w);
  let x_1770 : vec4<f32> = u_xlat0;
  let x_1772 : vec3<f32> = (vec3<f32>(x_1770.x, x_1770.y, x_1770.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1773 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1772.x, x_1772.y, x_1772.z, x_1773.w);
  let x_1775 : vec4<f32> = u_xlat0;
  let x_1777 : vec3<f32> = (vec3<f32>(x_1775.x, x_1775.y, x_1775.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1778 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1777.x, x_1777.y, x_1777.z, x_1778.w);
  let x_1780 : vec4<f32> = u_xlat2;
  let x_1782 : vec3<f32> = (vec3<f32>(x_1780.x, x_1780.y, x_1780.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1783 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1782.x, x_1782.y, x_1782.z, x_1783.w);
  let x_1785 : vec4<f32> = u_xlat2;
  let x_1788 : vec3<f32> = max(abs(vec3<f32>(x_1785.x, x_1785.y, x_1785.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1789 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1788.x, x_1788.y, x_1788.z, x_1789.w);
  let x_1791 : vec4<f32> = u_xlat2;
  let x_1793 : vec3<f32> = log2(vec3<f32>(x_1791.x, x_1791.y, x_1791.z));
  let x_1794 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1793.x, x_1793.y, x_1793.z, x_1794.w);
  let x_1796 : vec4<f32> = u_xlat2;
  let x_1798 : vec3<f32> = (vec3<f32>(x_1796.x, x_1796.y, x_1796.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1799 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1798.x, x_1798.y, x_1798.z, x_1799.w);
  let x_1801 : vec4<f32> = u_xlat2;
  let x_1803 : vec3<f32> = exp2(vec3<f32>(x_1801.x, x_1801.y, x_1801.z));
  let x_1804 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1803.x, x_1803.y, x_1803.z, x_1804.w);
  let x_1806 : vec4<f32> = u_xlat0;
  let x_1808 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1806.x, x_1806.y, x_1806.z, x_1806.x));
  u_xlatb0 = vec3<bool>(x_1808.x, x_1808.y, x_1808.z);
  ...
  SV_Target0.x = x_1822;
  let x_1826 : bool = u_xlatb0.y;
  if (x_1826) {
    let x_1831 : f32 = u_xlat1.y;
    x_1827 = x_1831;
  } else {
    let x_1834 : f32 = u_xlat2.y;
    x_1827 = x_1834;
  }
  let x_1835 : f32 = x_1827;
  SV_Target0.y = x_1835;
  let x_1838 : bool = u_xlatb0.z;
  if (x_1838) {
    let x_1843 : f32 = u_xlat1.z;
    x_1839 = x_1843;
  } else {
    let x_1846 : f32 = u_xlat2.z;
    x_1839 = x_1846;
  }
  let x_1847 : f32 = x_1839;
  SV_Target0.z = x_1847;
  let x_1849 : f32 = u_xlat30;
  SV_Target0.w = x_1849;
  return;
}
