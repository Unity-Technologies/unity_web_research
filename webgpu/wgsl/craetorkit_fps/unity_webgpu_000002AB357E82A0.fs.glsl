...
bool u_xlatb55;
    ...
    u_xlat52 = texture(sampler2D(_DissolveNoise, sampler_DissolveNoise), vs_TEXCOORD0.xy).x;
    u_xlat53 = _EdgeSize + _Cutoff;
    u_xlat3.x = _Cutoff * u_xlat53 + _EdgeSize;
    u_xlat20 = max(u_xlat52, _EdgeSize);
    u_xlat20 = min(u_xlat20, 1.0);
    u_xlat37.x = _Cutoff * u_xlat53 + (-u_xlat3.x);
    u_xlat3.x = (-u_xlat3.x) + u_xlat20;
    u_xlat20 = float(1.0) / u_xlat37.x;
    u_xlat3.x = u_xlat20 * u_xlat3.x;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat20 = u_xlat3.x * -2.0 + 3.0;
    u_xlat3.x = u_xlat3.x * u_xlat3.x;
    u_xlat3.x = u_xlat3.x * u_xlat20;
    u_xlat4 = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD0.xy);
    u_xlat5 = u_xlat4 * _Color;
    u_xlat20 = texture(sampler2D(_Occlusion, sampler_Occlusion), vs_TEXCOORD0.xy).x;
    u_xlat37.xy = texture(sampler2D(_Specular, sampler_Specular), vs_TEXCOORD0.xy).xw;
    ...
    u_xlat55 = texture(sampler3D(_DisplacementNoise, sampler_DisplacementNoise), u_xlat7.xyz).x;
    u_xlat7.xyz = u_xlat3.xxx * _EdgeColor1.xyz;
    u_xlat6.xyz = u_xlat6.xyz * vec3(u_xlat55) + u_xlat7.xyz;
    u_xlat3.x = u_xlat37.x * _Metallic;
    u_xlat7.xyz = texture(sampler2D(_NormalMap, sampler_NormalMap), vs_TEXCOORD0.xy).xyw;
    u_xlat7.x = u_xlat7.z * u_xlat7.x;
    u_xlat7.xy = u_xlat7.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat37.x = dot(u_xlat7.xy, u_xlat7.xy);
    u_xlat37.x = min(u_xlat37.x, 1.0);
    u_xlat37.x = (-u_xlat37.x) + 1.0;
    u_xlat7.z = sqrt(u_xlat37.x);
    u_xlat52 = (-_Cutoff) * u_xlat53 + u_xlat52;
    ...
    if(u_xlatb52){
        ...
        u_xlat37.x = unity_ProbeVolumeParams.z * 0.5 + 0.75;
        u_xlat8.x = max(u_xlat53, u_xlat37.x);
    ...
    u_xlat37.x = (-u_xlat37.y) * _Glossiness + 1.0;
    ...
    u_xlat52 = (-u_xlat37.x) * 0.699999988 + 1.70000005;
    ...
    u_xlat0.xyz = vec3(u_xlat20) * u_xlat12.xyz;
    ...
    u_xlat18 = dot(vec2(u_xlat18), u_xlat37.xx);
    ...
    u_xlat35 = u_xlat37.x * u_xlat37.x;
    ...
    u_xlat52 = u_xlat37.y * _Glossiness + (-u_xlat52);
    u_xlat52 = u_xlat52 + 1.0;
    u_xlat52 = clamp(u_xlat52, 0.0, 1.0);
    u_xlat2.xyw = vec3(u_xlat18) * u_xlat9.xyz;
    u_xlat2.xyw = u_xlat10.xyz * vec3(u_xlat20) + u_xlat2.xyw;
