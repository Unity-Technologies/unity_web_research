...
fn main_1() {
  ...
  let x_799 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  u_xlat6 = floor(x_805);
  let x_808 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  let x_817 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  let x_827 : f32 = x_32.x_Lut2D_Params.y;
  ...
  let x_845 : f32 = x_32.x_Lut2D_Params.y;
  u_xlat3.x = x_845;
  u_xlat3.y = 0.0f;
  ...
  let x_868 : f32 = x_32.x_Lut2D_Params.z;
  ...
  let x_896 : vec4<f32> = x_32.x_Dithering_Coords;
  let x_900 : vec4<f32> = x_32.x_Dithering_Coords;
