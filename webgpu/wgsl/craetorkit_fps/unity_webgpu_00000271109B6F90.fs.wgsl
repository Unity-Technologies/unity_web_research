...
fn main_1() {
  ...
  let x_1394 : vec3<f32> = ((vec3<f32>(x_1387.x, x_1387.y, x_1387.z) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1423 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1425 : vec3<f32> = (vec3<f32>(x_1419.x, x_1419.y, x_1419.z) * vec3<f32>(x_1423.y, x_1423.y, x_1423.y));
  let x_1426 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1425.x, x_1425.y, x_1425.z, x_1426.w);
  let x_1429 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat1.x = (x_1429 * 0.5f);
  let x_1432 : vec4<f32> = u_xlat0;
  let x_1435 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1438 : vec3<f32> = u_xlat1;
  let x_1440 : vec3<f32> = ((vec3<f32>(x_1432.x, x_1432.y, x_1432.z) * vec3<f32>(x_1435.x, x_1435.x, x_1435.x)) + vec3<f32>(x_1438.x, x_1438.x, x_1438.x));
  let x_1441 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1440.x, x_1440.y, x_1440.z, x_1441.w);
  let x_1451 : vec4<f32> = u_xlat0;
  let x_1453 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1451.x, x_1451.y, x_1451.z));
  ...
  let x_1457 : vec2<f32> = vs_TEXCOORD0;
  let x_1460 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1464 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1466 : vec2<f32> = ((x_1457 * vec2<f32>(x_1460.x, x_1460.y)) + vec2<f32>(x_1464.z, x_1464.w));
  let x_1467 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1466.x, x_1466.y, x_1467.z);
  let x_1474 : vec3<f32> = u_xlat1;
  let x_1476 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1474.x, x_1474.y));
  u_xlat1.x = x_1476.w;
  let x_1480 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1480 * 2.0f) + -1.0f);
  let x_1485 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1485 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1491 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1491, 0.0f, 1.0f);
  let x_1495 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1495 * 2.0f) + -1.0f);
  let x_1500 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1500)) + 1.0f);
  let x_1506 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1506);
  let x_1510 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1510) + 1.0f);
  let x_1515 : f32 = u_xlat1.x;
  let x_1517 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1515 * x_1517);
  let x_1520 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1520.x, x_1520.y, x_1520.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1525 : vec4<f32> = u_xlat0;
  let x_1529 : vec3<f32> = max(abs(vec3<f32>(x_1525.x, x_1525.y, x_1525.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1530 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1529.x, x_1529.y, x_1529.z, x_1530.w);
  let x_1532 : vec4<f32> = u_xlat2;
  let x_1534 : vec3<f32> = log2(vec3<f32>(x_1532.x, x_1532.y, x_1532.z));
  let x_1535 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1534.x, x_1534.y, x_1534.z, x_1535.w);
  let x_1537 : vec4<f32> = u_xlat2;
  let x_1541 : vec3<f32> = (vec3<f32>(x_1537.x, x_1537.y, x_1537.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1556 : vec3<f32> = ((vec3<f32>(x_1549.x, x_1549.y, x_1549.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1557 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1556.x, x_1556.y, x_1556.z, x_1557.w);
  let x_1564 : vec4<f32> = u_xlat0;
  let x_1567 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1564.x, x_1564.y, x_1564.z, x_1564.x));
  ...
  let x_1612 : vec3<f32> = ((vec3<f32>(x_1605.x, x_1605.x, x_1605.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1610.x, x_1610.y, x_1610.z));
  ...
  let x_1656 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1654.x, x_1654.y, x_1654.z, x_1654.x));
  u_xlatb0 = vec3<bool>(x_1656.x, x_1656.y, x_1656.z);
  ...
  SV_Target0.x = x_1670;
  let x_1674 : bool = u_xlatb0.y;
  if (x_1674) {
    let x_1679 : f32 = u_xlat1.y;
    x_1675 = x_1679;
  } else {
    let x_1682 : f32 = u_xlat2.y;
    x_1675 = x_1682;
  }
  let x_1683 : f32 = x_1675;
  SV_Target0.y = x_1683;
  let x_1686 : bool = u_xlatb0.z;
  if (x_1686) {
    let x_1691 : f32 = u_xlat1.z;
    x_1687 = x_1691;
  } else {
