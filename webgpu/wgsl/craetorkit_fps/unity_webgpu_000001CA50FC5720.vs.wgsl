...
fn main_1() {
  ...
  let x_360 : f32 = u_xlat0.w;
  let x_362 : f32 = u_xlat0.z;
  u_xlat1.x = min(x_360, x_362);
  let x_366 : f32 = u_xlat0.z;
  let x_369 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_366) + x_369);
  let x_377 : f32 = x_260.unity_LightShadowBias.y;
  let x_379 : f32 = u_xlat1.x;
  let x_382 : f32 = u_xlat0.z;
  gl_Position.z = ((x_377 * x_379) + x_382);
  let x_386 : vec4<f32> = u_xlat0;
  let x_387 : vec3<f32> = vec3<f32>(x_386.x, x_386.y, x_386.w);
  let x_390 : vec4<f32> = gl_Position;
  gl_Position = vec4<f32>(x_387.x, x_387.y, x_390.z, x_387.z);
  return;
}
