...
fn main_1() {
  ...
  u_xlat0 = (x_327 * x_328);
  let x_331 : f32 = vs_TEXCOORD1.w;
  u_xlat9 = x_331;
  let x_332 : f32 = u_xlat9;
  u_xlat9 = clamp(x_332, 0.0f, 1.0f);
  let x_336 : vec3<f32> = u_xlat0;
  let x_337 : f32 = u_xlat9;
  let x_339 : vec3<f32> = (x_336 * vec3<f32>(x_337, x_337, x_337));
  let x_340 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_339.x, x_339.y, x_339.z, x_340.w);
  SV_Target0.w = 1.0f;
  return;
}
