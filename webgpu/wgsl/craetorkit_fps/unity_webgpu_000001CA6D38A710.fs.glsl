...
float u_xlat27;
    ...
    u_xlat4.xy = texture(sampler2D(_Metallic, sampler_Metallic), vs_TEXCOORD0.xy).xw;
    ...
    u_xlat27 = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat20.xy).w;
    ...
    u_xlat25 = (-u_xlat4.x) * 0.959999979 + 0.959999979;
