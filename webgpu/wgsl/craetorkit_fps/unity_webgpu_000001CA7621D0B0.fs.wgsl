...
fn main_1() {
  ...
  if (x_1131) {
    ...
    SV_Target0.w = ((x_1268 * x_1270) + 1.0f);
  } else {
    let x_1281 : vec2<f32> = u_xlat21;
    let x_1282 : vec4<f32> = textureSample(x_Vignette_Mask, sampler_Vignette_Mask, x_1281);
    u_xlat1.x = x_1282.w;
    let x_1286 : f32 = u_xlat1.x;
    u_xlat1.z = (x_1286 + 0.055f);
    let x_1290 : vec3<f32> = u_xlat1;
    let x_1295 : vec2<f32> = (vec2<f32>(x_1290.x, x_1290.z) * vec2<f32>(0.077399381f, 0.947867334f));
    let x_1296 : vec3<f32> = u_xlat11;
    u_xlat11 = vec3<f32>(x_1295.x, x_1295.y, x_1296.z);
    let x_1299 : f32 = u_xlat11.y;
    u_xlat21.x = max(abs(x_1299), 1.1920929e-07f);
    let x_1305 : f32 = u_xlat21.x;
    u_xlat21.x = log2(x_1305);
    let x_1309 : f32 = u_xlat21.x;
    u_xlat21.x = (x_1309 * 2.400000095f);
    let x_1314 : f32 = u_xlat21.x;
    u_xlat21.x = exp2(x_1314);
    let x_1319 : f32 = u_xlat1.x;
    u_xlatb1 = (0.040449999f >= x_1319);
    let x_1321 : bool = u_xlatb1;
    if (x_1321) {
      let x_1326 : f32 = u_xlat11.x;
      x_1322 = x_1326;
    } else {
      let x_1329 : f32 = u_xlat21.x;
      x_1322 = x_1329;
    }
    let x_1330 : f32 = x_1322;
    u_xlat1.x = x_1330;
    let x_1333 : vec3<f32> = x_26.x_Vignette_Color;
    u_xlat11 = (-(x_1333) + vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1336 : vec3<f32> = u_xlat1;
    let x_1338 : vec3<f32> = u_xlat11;
    let x_1341 : vec3<f32> = x_26.x_Vignette_Color;
    u_xlat11 = ((vec3<f32>(x_1336.x, x_1336.x, x_1336.x) * x_1338) + x_1341);
    let x_1343 : vec4<f32> = u_xlat0;
    let x_1345 : vec3<f32> = u_xlat11;
    let x_1347 : vec4<f32> = u_xlat0;
    u_xlat11 = ((vec3<f32>(x_1343.x, x_1343.y, x_1343.z) * x_1345) + -(vec3<f32>(x_1347.x, x_1347.y, x_1347.z)));
    let x_1353 : f32 = x_26.x_Vignette_Opacity;
    let x_1355 : vec3<f32> = u_xlat11;
    let x_1357 : vec4<f32> = u_xlat0;
    let x_1359 : vec3<f32> = ((vec3<f32>(x_1353, x_1353, x_1353) * x_1355) + vec3<f32>(x_1357.x, x_1357.y, x_1357.z));
    let x_1360 : vec4<f32> = u_xlat2;
    u_xlat2 = vec4<f32>(x_1359.x, x_1359.y, x_1359.z, x_1360.w);
    let x_1363 : f32 = u_xlat0.w;
    u_xlat0.x = (x_1363 + -1.0f);
    let x_1367 : f32 = u_xlat1.x;
    let x_1369 : f32 = u_xlat0.x;
    SV_Target0.w = ((x_1367 * x_1369) + 1.0f);
  }
  let x_1374 : vec2<f32> = vs_TEXCOORD1;
  let x_1377 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1381 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1383 : vec2<f32> = ((x_1374 * vec2<f32>(x_1377.x, x_1377.y)) + vec2<f32>(x_1381.z, x_1381.w));
  let x_1384 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1383.x, x_1383.y, x_1384.z, x_1384.w);
  let x_1391 : vec4<f32> = u_xlat0;
  let x_1393 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1391.x, x_1391.y));
  let x_1394 : vec3<f32> = vec3<f32>(x_1393.x, x_1393.y, x_1393.z);
  let x_1395 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1394.x, x_1394.y, x_1394.z, x_1395.w);
  let x_1397 : vec4<f32> = u_xlat2;
  u_xlat1 = vec3<f32>(x_1397.x, x_1397.y, x_1397.z);
  let x_1399 : vec3<f32> = u_xlat1;
  u_xlat1 = clamp(x_1399, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1404 : vec3<f32> = u_xlat1;
  u_xlat30 = dot(x_1404, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1410 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1410);
  let x_1414 : f32 = x_26.x_Grain_Params1.x;
  let x_1415 : f32 = u_xlat30;
  u_xlat30 = ((x_1414 * -(x_1415)) + 1.0f);
  let x_1419 : vec4<f32> = u_xlat0;
  let x_1421 : vec4<f32> = u_xlat2;
  let x_1423 : vec3<f32> = (vec3<f32>(x_1419.x, x_1419.y, x_1419.z) * vec3<f32>(x_1421.x, x_1421.y, x_1421.z));
  ...
  let x_1435 : vec3<f32> = (vec3<f32>(x_1426.x, x_1426.y, x_1426.z) * vec3<f32>(x_1429, x_1431, x_1433));
  ...
  let x_1445 : vec3<f32> = ((vec3<f32>(x_1438.x, x_1438.y, x_1438.z) * vec3<f32>(x_1440, x_1440, x_1440)) + vec3<f32>(x_1443.x, x_1443.y, x_1443.z));
  let x_1446 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1445.x, x_1445.y, x_1445.z, x_1446.w);
  let x_1448 : vec2<f32> = vs_TEXCOORD0;
  let x_1451 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1455 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1457 : vec2<f32> = ((x_1448 * vec2<f32>(x_1451.x, x_1451.y)) + vec2<f32>(x_1455.z, x_1455.w));
  let x_1458 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1457.x, x_1457.y, x_1458.z);
  let x_1465 : vec3<f32> = u_xlat1;
  let x_1467 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1465.x, x_1465.y));
  u_xlat30 = x_1467.w;
  let x_1469 : f32 = u_xlat30;
  u_xlat30 = ((x_1469 * 2.0f) + -1.0f);
  let x_1472 : f32 = u_xlat30;
  u_xlat1.x = ((x_1472 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1478 : f32 = u_xlat1.x;
  u_xlat1.x = clamp(x_1478, 0.0f, 1.0f);
  let x_1482 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1482 * 2.0f) + -1.0f);
  let x_1486 : f32 = u_xlat30;
  u_xlat30 = (-(abs(x_1486)) + 1.0f);
  let x_1490 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1490);
  let x_1492 : f32 = u_xlat30;
  u_xlat30 = (-(x_1492) + 1.0f);
  let x_1495 : f32 = u_xlat30;
  let x_1497 : f32 = u_xlat1.x;
  u_xlat30 = (x_1495 * x_1497);
  let x_1499 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1499.x, x_1499.y, x_1499.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1504 : vec4<f32> = u_xlat0;
  let x_1508 : vec3<f32> = max(abs(vec3<f32>(x_1504.x, x_1504.y, x_1504.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1509 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1508.x, x_1508.y, x_1508.z, x_1509.w);
  let x_1511 : vec4<f32> = u_xlat2;
  let x_1513 : vec3<f32> = log2(vec3<f32>(x_1511.x, x_1511.y, x_1511.z));
  let x_1514 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1513.x, x_1513.y, x_1513.z, x_1514.w);
  let x_1516 : vec4<f32> = u_xlat2;
  let x_1520 : vec3<f32> = (vec3<f32>(x_1516.x, x_1516.y, x_1516.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1535 : vec3<f32> = ((vec3<f32>(x_1528.x, x_1528.y, x_1528.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1536 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1535.x, x_1535.y, x_1535.z, x_1536.w);
  let x_1543 : vec4<f32> = u_xlat0;
  let x_1546 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1543.x, x_1543.y, x_1543.z, x_1543.x));
  u_xlatb0 = vec3<bool>(x_1546.x, x_1546.y, x_1546.z);
  ...
  u_xlat0.x = x_1558;
  let x_1561 : bool = u_xlatb0.y;
  if (x_1561) {
    let x_1566 : f32 = u_xlat1.y;
    x_1562 = x_1566;
  } else {
    let x_1569 : f32 = u_xlat2.y;
    x_1562 = x_1569;
  }
  let x_1570 : f32 = x_1562;
  u_xlat0.y = x_1570;
  let x_1573 : bool = u_xlatb0.z;
  if (x_1573) {
    let x_1578 : f32 = u_xlat1.z;
    x_1574 = x_1578;
  } else {
  ...
  u_xlat0.z = x_1582;
  let x_1584 : f32 = u_xlat30;
  let x_1589 : vec4<f32> = u_xlat0;
  let x_1591 : vec3<f32> = ((vec3<f32>(x_1584, x_1584, x_1584) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1589.x, x_1589.y, x_1589.z));
  let x_1592 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1591.x, x_1591.y, x_1591.z, x_1592.w);
  let x_1594 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1594.x, x_1594.y, x_1594.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1598 : vec4<f32> = u_xlat0;
  let x_1601 : vec3<f32> = (vec3<f32>(x_1598.x, x_1598.y, x_1598.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1602 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1601.x, x_1601.y, x_1601.z, x_1602.w);
  let x_1604 : vec4<f32> = u_xlat2;
  let x_1607 : vec3<f32> = (vec3<f32>(x_1604.x, x_1604.y, x_1604.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1608 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1607.x, x_1607.y, x_1607.z, x_1608.w);
  let x_1610 : vec4<f32> = u_xlat2;
  let x_1613 : vec3<f32> = max(abs(vec3<f32>(x_1610.x, x_1610.y, x_1610.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1624 : vec3<f32> = (vec3<f32>(x_1621.x, x_1621.y, x_1621.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1625 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1624.x, x_1624.y, x_1624.z, x_1625.w);
  let x_1627 : vec4<f32> = u_xlat2;
  let x_1629 : vec3<f32> = exp2(vec3<f32>(x_1627.x, x_1627.y, x_1627.z));
  let x_1630 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1629.x, x_1629.y, x_1629.z, x_1630.w);
  let x_1633 : vec4<f32> = u_xlat0;
  let x_1635 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1633.x, x_1633.y, x_1633.z, x_1633.x));
