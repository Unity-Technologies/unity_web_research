...
fn main_1() {
  ...
  if (x_612) {
    ...
    let x_812 : f32 = x_32.x_Vignette_Opacity;
  ...
  let x_834 : vec4<f32> = x_32.x_Grain_Params2;
  let x_838 : vec4<f32> = x_32.x_Grain_Params2;
  ...
  u_xlat18 = sqrt(x_866);
  let x_870 : f32 = x_32.x_Grain_Params1.x;
  ...
  let x_884 : f32 = x_32.x_Grain_Params1.y;
  let x_886 : f32 = x_32.x_Grain_Params1.y;
  let x_888 : f32 = x_32.x_Grain_Params1.y;
  ...
  let x_906 : vec4<f32> = x_32.x_Dithering_Coords;
  let x_910 : vec4<f32> = x_32.x_Dithering_Coords;
