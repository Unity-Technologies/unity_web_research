...
fn main_1() {
  ...
  let x_471 : vec3<f32> = u_xlat10;
  let x_472 : vec4<f32> = u_xlat3;
  let x_475 : vec3<f32> = u_xlat0;
  let x_476 : vec3<f32> = ((x_471 * vec3<f32>(x_472.x, x_472.y, x_472.w)) + x_475);
  let x_477 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_476.x, x_476.y, x_476.z, x_477.w);
  SV_Target0.w = 1.0f;
  return;
}
