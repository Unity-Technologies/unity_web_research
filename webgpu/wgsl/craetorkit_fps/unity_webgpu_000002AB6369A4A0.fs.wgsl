...
fn main_1() {
  ...
  let x_461 : f32 = x_32.x_Vignette_Mode;
  u_xlatb15 = (x_461 < 0.5f);
  let x_463 : bool = u_xlatb15;
  if (x_463) {
    let x_466 : vec2<f32> = u_xlat12;
    let x_470 : vec2<f32> = x_32.x_Vignette_Center;
    ...
    let x_480 : vec4<f32> = x_32.x_Vignette_Settings;
    ...
    let x_488 : f32 = x_32.x_ScreenParams.x;
    let x_490 : f32 = x_32.x_ScreenParams.y;
    u_xlat15 = (x_488 / x_490);
    let x_492 : f32 = u_xlat15;
    u_xlat15 = (x_492 + -1.0f);
    let x_495 : f32 = x_32.x_Vignette_Settings.w;
    ...
    let x_524 : vec4<f32> = x_32.x_Vignette_Settings;
    ...
    let x_548 : f32 = x_32.x_Vignette_Settings.y;
    u_xlat15 = (x_546 * x_548);
    let x_550 : f32 = u_xlat15;
    u_xlat15 = exp2(x_550);
    let x_555 : vec3<f32> = x_32.x_Vignette_Color;
    ...
    let x_567 : vec3<f32> = x_32.x_Vignette_Color;
    ...
    let x_642 : f32 = x_634;
    u_xlat15 = x_642;
    let x_644 : vec3<f32> = x_32.x_Vignette_Color;
    ...
    let x_655 : vec3<f32> = x_32.x_Vignette_Color;
    ...
    let x_672 : f32 = x_32.x_Vignette_Opacity;
  ...
  let x_695 : f32 = x_32.x_PostExposure;
  let x_697 : f32 = x_32.x_PostExposure;
  let x_699 : f32 = x_32.x_PostExposure;
  let x_701 : f32 = x_32.x_PostExposure;
  ...
  let x_745 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  u_xlat5 = floor(x_751);
  let x_754 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  let x_763 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  let x_773 : f32 = x_32.x_Lut2D_Params.y;
  ...
  let x_789 : f32 = x_32.x_Lut2D_Params.y;
  u_xlat3.x = x_789;
  u_xlat3.y = 0.0f;
  ...
  let x_811 : f32 = x_32.x_Lut2D_Params.z;
  ...
  let x_837 : vec4<f32> = x_32.x_Dithering_Coords;
  let x_841 : vec4<f32> = x_32.x_Dithering_Coords;
