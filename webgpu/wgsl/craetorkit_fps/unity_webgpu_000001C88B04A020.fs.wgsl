...
fn main_1() {
  ...
  if (x_986) {
    ...
    u_xlat1 = vec4<f32>(x_1054.x, x_1054.y, x_1055.z, x_1055.w);
  ...
  let x_1229 : f32 = x_26.x_PostExposure;
  let x_1231 : f32 = x_26.x_PostExposure;
  let x_1233 : f32 = x_26.x_PostExposure;
  let x_1235 : f32 = x_26.x_PostExposure;
  let x_1236 : vec4<f32> = vec4<f32>(x_1229, x_1231, x_1233, x_1235);
  u_xlat0 = (x_1226 * vec4<f32>(x_1236.x, x_1236.y, x_1236.z, x_1236.w));
  let x_1243 : vec4<f32> = u_xlat0;
  let x_1250 : vec3<f32> = ((vec3<f32>(x_1243.z, x_1243.x, x_1243.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1251 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1250.x, x_1250.y, x_1250.z, x_1251.w);
  let x_1253 : vec4<f32> = u_xlat0;
  let x_1255 : vec3<f32> = log2(vec3<f32>(x_1253.x, x_1253.y, x_1253.z));
  let x_1256 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1255.x, x_1255.y, x_1255.z, x_1256.w);
  let x_1258 : vec4<f32> = u_xlat0;
  let x_1265 : vec3<f32> = ((vec3<f32>(x_1258.x, x_1258.y, x_1258.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1266 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1265.x, x_1265.y, x_1265.z, x_1266.w);
  let x_1268 : vec4<f32> = u_xlat0;
  let x_1272 : vec3<f32> = clamp(vec3<f32>(x_1268.x, x_1268.y, x_1268.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1273 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1272.x, x_1272.y, x_1272.z, x_1273.w);
  let x_1275 : vec4<f32> = u_xlat0;
  let x_1279 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1281 : vec3<f32> = (vec3<f32>(x_1275.x, x_1275.y, x_1275.z) * vec3<f32>(x_1279.z, x_1279.z, x_1279.z));
  let x_1282 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1281.x, x_1281.y, x_1281.z, x_1282.w);
  let x_1286 : f32 = u_xlat1.x;
  u_xlat10 = floor(x_1286);
  let x_1289 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1291 : vec2<f32> = (vec2<f32>(x_1289.x, x_1289.y) * vec2<f32>(0.5f, 0.5f));
  let x_1292 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1291.x, x_1292.y, x_1292.z, x_1291.y);
  let x_1294 : vec4<f32> = u_xlat1;
  let x_1297 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1300 : vec4<f32> = u_xlat1;
  let x_1302 : vec2<f32> = ((vec2<f32>(x_1294.y, x_1294.z) * vec2<f32>(x_1297.x, x_1297.y)) + vec2<f32>(x_1300.x, x_1300.w));
  let x_1303 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1303.x, x_1302.x, x_1302.y, x_1303.w);
  let x_1305 : f32 = u_xlat10;
  let x_1307 : f32 = x_26.x_Lut2D_Params.y;
  let x_1310 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1305 * x_1307) + x_1310);
  let x_1318 : vec4<f32> = u_xlat1;
  let x_1320 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1318.x, x_1318.z));
  let x_1321 : vec3<f32> = vec3<f32>(x_1320.x, x_1320.y, x_1320.z);
  let x_1322 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1321.x, x_1321.y, x_1321.z, x_1322.w);
  let x_1325 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat3.x = x_1325;
  u_xlat3.y = 0.0f;
  let x_1328 : vec4<f32> = u_xlat1;
  let x_1330 : vec4<f32> = u_xlat3;
  let x_1332 : vec2<f32> = (vec2<f32>(x_1328.x, x_1328.z) + vec2<f32>(x_1330.x, x_1330.y));
  let x_1333 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1332.x, x_1332.y, x_1333.z, x_1333.w);
  let x_1338 : vec4<f32> = u_xlat1;
  let x_1340 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1338.x, x_1338.y));
  let x_1341 : vec3<f32> = vec3<f32>(x_1340.x, x_1340.y, x_1340.z);
  let x_1342 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1341.x, x_1341.y, x_1341.z, x_1342.w);
  let x_1345 : f32 = u_xlat0.x;
  let x_1347 : f32 = x_26.x_Lut2D_Params.z;
  let x_1349 : f32 = u_xlat10;
  u_xlat0.x = ((x_1345 * x_1347) + -(x_1349));
  ...
  let x_1368 : vec3<f32> = ((vec3<f32>(x_1361.x, x_1361.x, x_1361.x) * vec3<f32>(x_1363.x, x_1363.y, x_1363.z)) + vec3<f32>(x_1366.x, x_1366.y, x_1366.z));
  let x_1369 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1368.x, x_1368.y, x_1368.z, x_1369.w);
  let x_1371 : vec2<f32> = vs_TEXCOORD0;
  let x_1374 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1378 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1380 : vec2<f32> = ((x_1371 * vec2<f32>(x_1374.x, x_1374.y)) + vec2<f32>(x_1378.z, x_1378.w));
  let x_1381 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1380.x, x_1380.y, x_1381.z, x_1381.w);
  let x_1388 : vec4<f32> = u_xlat1;
  let x_1390 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1388.x, x_1388.y));
  u_xlat1.x = x_1390.w;
  let x_1394 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1394 * 2.0f) + -1.0f);
  let x_1399 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1399 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1405 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1405, 0.0f, 1.0f);
  let x_1409 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1409 * 2.0f) + -1.0f);
  let x_1414 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1414)) + 1.0f);
  let x_1420 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1420);
  let x_1424 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1424) + 1.0f);
  let x_1429 : f32 = u_xlat1.x;
  let x_1431 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1429 * x_1431);
  let x_1434 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1434.x, x_1434.y, x_1434.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1439 : vec4<f32> = u_xlat0;
  let x_1443 : vec3<f32> = max(abs(vec3<f32>(x_1439.x, x_1439.y, x_1439.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1455 : vec3<f32> = (vec3<f32>(x_1451.x, x_1451.y, x_1451.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1456 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1455.x, x_1455.y, x_1455.z, x_1456.w);
  let x_1458 : vec4<f32> = u_xlat2;
  let x_1460 : vec3<f32> = exp2(vec3<f32>(x_1458.x, x_1458.y, x_1458.z));
  let x_1461 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1460.x, x_1460.y, x_1460.z, x_1461.w);
  let x_1463 : vec4<f32> = u_xlat2;
  let x_1470 : vec3<f32> = ((vec3<f32>(x_1463.x, x_1463.y, x_1463.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1471 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1470.x, x_1470.y, x_1470.z, x_1471.w);
  let x_1478 : vec4<f32> = u_xlat0;
  let x_1481 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1478.x, x_1478.y, x_1478.z, x_1478.x));
  u_xlatb0 = vec3<bool>(x_1481.x, x_1481.y, x_1481.z);
  let x_1484 : bool = u_xlatb0.x;
  if (x_1484) {
    let x_1489 : f32 = u_xlat11.x;
    x_1485 = x_1489;
  } else {
    let x_1492 : f32 = u_xlat2.x;
    x_1485 = x_1492;
  }
  let x_1493 : f32 = x_1485;
  u_xlat0.x = x_1493;
  let x_1496 : bool = u_xlatb0.y;
  if (x_1496) {
    let x_1501 : f32 = u_xlat11.y;
    x_1497 = x_1501;
  } else {
    let x_1504 : f32 = u_xlat2.y;
    x_1497 = x_1504;
  }
  let x_1505 : f32 = x_1497;
  u_xlat0.y = x_1505;
  let x_1508 : bool = u_xlatb0.z;
  if (x_1508) {
    let x_1513 : f32 = u_xlat11.z;
    x_1509 = x_1513;
  } else {
  ...
  let x_1526 : vec3<f32> = ((vec3<f32>(x_1519.x, x_1519.x, x_1519.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1524.x, x_1524.y, x_1524.z));
  let x_1527 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1526.x, x_1526.y, x_1526.z, x_1527.w);
  let x_1529 : vec4<f32> = u_xlat0;
  let x_1532 : vec3<f32> = (vec3<f32>(x_1529.x, x_1529.y, x_1529.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1533 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1532.x, x_1532.y, x_1532.z, x_1533.w);
  let x_1535 : vec4<f32> = u_xlat0;
  let x_1538 : vec3<f32> = (vec3<f32>(x_1535.x, x_1535.y, x_1535.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1539 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1538.x, x_1538.y, x_1538.z, x_1539.w);
  let x_1541 : vec4<f32> = u_xlat2;
  let x_1544 : vec3<f32> = (vec3<f32>(x_1541.x, x_1541.y, x_1541.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1545 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1544.x, x_1544.y, x_1544.z, x_1545.w);
  let x_1547 : vec4<f32> = u_xlat2;
  let x_1550 : vec3<f32> = max(abs(vec3<f32>(x_1547.x, x_1547.y, x_1547.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1551 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1550.x, x_1550.y, x_1550.z, x_1551.w);
  let x_1553 : vec4<f32> = u_xlat2;
  let x_1555 : vec3<f32> = log2(vec3<f32>(x_1553.x, x_1553.y, x_1553.z));
  let x_1556 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1555.x, x_1555.y, x_1555.z, x_1556.w);
  let x_1558 : vec4<f32> = u_xlat2;
  let x_1561 : vec3<f32> = (vec3<f32>(x_1558.x, x_1558.y, x_1558.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1562 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1561.x, x_1561.y, x_1561.z, x_1562.w);
  let x_1564 : vec4<f32> = u_xlat2;
  let x_1566 : vec3<f32> = exp2(vec3<f32>(x_1564.x, x_1564.y, x_1564.z));
  let x_1567 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1566.x, x_1566.y, x_1566.z, x_1567.w);
  let x_1570 : vec4<f32> = u_xlat0;
  let x_1572 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1570.x, x_1570.y, x_1570.z, x_1570.x));
  u_xlatb0 = vec3<bool>(x_1572.x, x_1572.y, x_1572.z);
  let x_1577 : bool = u_xlatb0.x;
  if (x_1577) {
    let x_1582 : f32 = u_xlat1.x;
    x_1578 = x_1582;
  } else {
    let x_1585 : f32 = u_xlat2.x;
    x_1578 = x_1585;
  }
  let x_1586 : f32 = x_1578;
  SV_Target0.x = x_1586;
  let x_1590 : bool = u_xlatb0.y;
  if (x_1590) {
    let x_1595 : f32 = u_xlat1.y;
    x_1591 = x_1595;
  } else {
    let x_1598 : f32 = u_xlat2.y;
    x_1591 = x_1598;
  }
  let x_1599 : f32 = x_1591;
  SV_Target0.y = x_1599;
  let x_1602 : bool = u_xlatb0.z;
  if (x_1602) {
    let x_1607 : f32 = u_xlat1.z;
    x_1603 = x_1607;
  } else {
