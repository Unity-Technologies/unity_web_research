...
fn main_1() {
  ...
  u_xlat6 = (vec3<f32>(x_567.x, x_567.y, x_567.z) * vec3<f32>(x_571.z, x_571.z, x_571.z));
  let x_575 : f32 = u_xlat6.x;
  u_xlat6.x = floor(x_575);
  let x_579 : vec3<f32> = x_49.x_Lut2D_Params;
  let x_582 : vec2<f32> = (vec2<f32>(x_579.x, x_579.y) * vec2<f32>(0.5f, 0.5f));
  let x_583 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_582.x, x_582.y, x_583.z, x_583.w);
  let x_585 : vec3<f32> = u_xlat6;
  let x_588 : vec3<f32> = x_49.x_Lut2D_Params;
  ...
  u_xlat2 = vec4<f32>(x_594.x, x_593.x, x_593.y, x_594.w);
  let x_597 : f32 = u_xlat6.x;
  let x_599 : f32 = x_49.x_Lut2D_Params.y;
  let x_602 : f32 = u_xlat2.y;
  u_xlat2.x = ((x_597 * x_599) + x_602);
  ...
  let x_617 : f32 = x_49.x_Lut2D_Params.y;
  u_xlat4.x = x_617;
  u_xlat4.y = 0.0f;
  let x_622 : vec4<f32> = u_xlat2;
  let x_624 : vec4<f32> = u_xlat4;
  u_xlat11 = (vec2<f32>(x_622.x, x_622.z) + vec2<f32>(x_624.x, x_624.y));
  let x_630 : vec2<f32> = u_xlat11;
  let x_631 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, x_630);
  ...
  let x_638 : f32 = x_49.x_Lut2D_Params.z;
  let x_641 : f32 = u_xlat6.x;
  u_xlat1.x = ((x_636 * x_638) + -(x_641));
  let x_645 : vec4<f32> = u_xlat3;
  let x_648 : vec4<f32> = u_xlat2;
  u_xlat6 = (-(vec3<f32>(x_645.x, x_645.y, x_645.z)) + vec3<f32>(x_648.x, x_648.y, x_648.z));
  ...
  let x_662 : f32 = x_49.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_662);
