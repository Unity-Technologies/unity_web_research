...
fn main_1() {
  ...
  if (x_163) {
    ...
    if (x_2648) {
      let x_2653 : bool = u_xlatb8.x;
      x_2649 = x_2653;
    } else {
      let x_2656 : bool = u_xlatb8.y;
      x_2649 = x_2656;
    }
    let x_2657 : bool = x_2649;
    u_xlatb2 = x_2657;
    let x_2659 : f32 = u_xlat6.x;
    let x_2661 : f32 = u_xlat6.x;
    u_xlat6.x = (x_2659 * x_2661);
    let x_2664 : f32 = u_xlat12;
    let x_2665 : f32 = u_xlat20;
    u_xlat12 = ((x_2664 * -(x_2665)) + 0.5f);
    let x_2669 : bool = u_xlatb2;
    let x_2670 : f32 = u_xlat12;
    u_xlat12 = select(0.0f, x_2670, x_2669);
    let x_2673 : f32 = u_xlat6.x;
    let x_2674 : f32 = u_xlat12;
    u_xlat6.x = max(x_2673, x_2674);
    let x_2677 : vec3<f32> = u_xlat6;
    let x_2679 : f32 = u_xlat18;
    let x_2682 : vec2<f32> = vs_TEXCOORD0;
    let x_2683 : vec2<f32> = ((vec2<f32>(x_2677.x, x_2677.x) * vec2<f32>(x_2679, x_2679)) + x_2682);
    let x_2684 : vec3<f32> = u_xlat6;
    u_xlat6 = vec3<f32>(x_2683.x, x_2683.y, x_2684.z);
    let x_2687 : bool = u_xlatb0.x;
    if (x_2687) {
      let x_2692 : f32 = vs_TEXCOORD0.x;
      x_2688 = x_2692;
    } else {
      let x_2695 : f32 = u_xlat6.x;
      x_2688 = x_2695;
    }
    let x_2696 : f32 = x_2688;
    u_xlat2.x = x_2696;
    let x_2699 : f32 = u_xlat2.x;
    u_xlat2.x = clamp(x_2699, 0.0f, 1.0f);
    let x_2703 : bool = u_xlatb0.x;
    if (x_2703) {
      let x_2708 : f32 = u_xlat6.y;
      x_2704 = x_2708;
    } else {
      let x_2711 : f32 = vs_TEXCOORD0.y;
      x_2704 = x_2711;
    }
    let x_2712 : f32 = x_2704;
    u_xlat2.y = x_2712;
    let x_2715 : f32 = u_xlat2.y;
    u_xlat2.y = clamp(x_2715, 0.0f, 1.0f);
    let x_2718 : vec3<f32> = u_xlat2;
    let x_2721 : f32 = x_30.x_RenderViewportScaleFactor;
    let x_2723 : vec2<f32> = (vec2<f32>(x_2718.x, x_2718.y) * vec2<f32>(x_2721, x_2721));
    let x_2724 : vec3<f32> = u_xlat0;
    u_xlat0 = vec3<f32>(x_2723.x, x_2723.y, x_2724.z);
    let x_2729 : vec3<f32> = u_xlat0;
    let x_2731 : vec4<f32> = textureSampleLevel(x_MainTex, sampler_MainTex, vec2<f32>(x_2729.x, x_2729.y), 0.0f);
    let x_2732 : vec3<f32> = vec3<f32>(x_2731.x, x_2731.y, x_2731.z);
    let x_2733 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_2732.x, x_2732.y, x_2732.z, x_2733.w);
  }
  let x_2735 : vec2<f32> = vs_TEXCOORD0;
  let x_2738 : vec4<f32> = x_30.x_Dithering_Coords;
  let x_2742 : vec4<f32> = x_30.x_Dithering_Coords;
  let x_2744 : vec2<f32> = ((x_2735 * vec2<f32>(x_2738.x, x_2738.y)) + vec2<f32>(x_2742.z, x_2742.w));
  let x_2745 : vec3<f32> = u_xlat0;
  u_xlat0 = vec3<f32>(x_2744.x, x_2744.y, x_2745.z);
  let x_2752 : vec3<f32> = u_xlat0;
  let x_2754 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_2752.x, x_2752.y));
  u_xlat0.x = x_2754.w;
  let x_2758 : f32 = u_xlat0.x;
  u_xlat0.x = ((x_2758 * 2.0f) + -1.0f);
  let x_2764 : f32 = u_xlat0.x;
  u_xlat6.x = ((x_2764 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_2770 : f32 = u_xlat6.x;
  u_xlat6.x = clamp(x_2770, 0.0f, 1.0f);
  let x_2774 : f32 = u_xlat6.x;
  u_xlat6.x = ((x_2774 * 2.0f) + -1.0f);
  let x_2779 : f32 = u_xlat0.x;
  u_xlat0.x = (-(abs(x_2779)) + 1.0f);
  let x_2785 : f32 = u_xlat0.x;
  u_xlat0.x = sqrt(x_2785);
  let x_2789 : f32 = u_xlat0.x;
  u_xlat0.x = (-(x_2789) + 1.0f);
  let x_2794 : f32 = u_xlat0.x;
  let x_2796 : f32 = u_xlat6.x;
  u_xlat0.x = (x_2794 * x_2796);
  let x_2799 : vec4<f32> = u_xlat1;
  u_xlat6 = (vec3<f32>(x_2799.x, x_2799.y, x_2799.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_2804 : vec4<f32> = u_xlat1;
  u_xlat2 = max(abs(vec3<f32>(x_2804.x, x_2804.y, x_2804.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_2810 : vec3<f32> = u_xlat2;
  u_xlat2 = log2(x_2810);
  let x_2812 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_2812 * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_2816 : vec3<f32> = u_xlat2;
  u_xlat2 = exp2(x_2816);
  let x_2818 : vec3<f32> = u_xlat2;
  u_xlat2 = ((x_2818 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_2828 : vec4<f32> = u_xlat1;
  let x_2830 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_2828.x, x_2828.y, x_2828.z, x_2828.x));
  u_xlatb1 = vec3<bool>(x_2830.x, x_2830.y, x_2830.z);
  let x_2833 : vec3<f32> = u_xlat6;
  hlslcc_movcTemp = x_2833;
  let x_2835 : bool = u_xlatb1.x;
  if (x_2835) {
    let x_2840 : f32 = u_xlat6.x;
    x_2836 = x_2840;
  } else {
    let x_2843 : f32 = u_xlat2.x;
    x_2836 = x_2843;
  }
  let x_2844 : f32 = x_2836;
  hlslcc_movcTemp.x = x_2844;
  let x_2847 : bool = u_xlatb1.y;
  if (x_2847) {
    let x_2852 : f32 = u_xlat6.y;
    x_2848 = x_2852;
  } else {
    let x_2855 : f32 = u_xlat2.y;
    x_2848 = x_2855;
  }
  let x_2856 : f32 = x_2848;
  hlslcc_movcTemp.y = x_2856;
  let x_2859 : bool = u_xlatb1.z;
  if (x_2859) {
    let x_2864 : f32 = u_xlat6.z;
    x_2860 = x_2864;
  } else {
    let x_2867 : f32 = u_xlat2.z;
    x_2860 = x_2867;
  }
  let x_2868 : f32 = x_2860;
  hlslcc_movcTemp.z = x_2868;
  let x_2870 : vec3<f32> = hlslcc_movcTemp;
  u_xlat6 = x_2870;
  let x_2871 : vec3<f32> = u_xlat0;
  let x_2876 : vec3<f32> = u_xlat6;
  u_xlat0 = ((vec3<f32>(x_2871.x, x_2871.x, x_2871.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_2876);
  let x_2878 : vec3<f32> = u_xlat0;
  let x_2881 : vec3<f32> = (x_2878 * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_2882 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_2881.x, x_2881.y, x_2881.z, x_2882.w);
  let x_2884 : vec3<f32> = u_xlat0;
  u_xlat2 = (x_2884 + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_2888 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_2888 * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_2892 : vec3<f32> = u_xlat2;
  u_xlat2 = max(abs(x_2892), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_2895 : vec3<f32> = u_xlat2;
  u_xlat2 = log2(x_2895);
  let x_2897 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_2897 * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_2901 : vec3<f32> = u_xlat2;
  u_xlat2 = exp2(x_2901);
  let x_2905 : vec3<f32> = u_xlat0;
  let x_2907 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_2905.x, x_2905.y, x_2905.z, x_2905.x));
  u_xlatb0 = vec3<bool>(x_2907.x, x_2907.y, x_2907.z);
  let x_2912 : bool = u_xlatb0.x;
  if (x_2912) {
    let x_2917 : f32 = u_xlat1.x;
    x_2913 = x_2917;
  } else {
    let x_2920 : f32 = u_xlat2.x;
    x_2913 = x_2920;
  }
  let x_2921 : f32 = x_2913;
  SV_Target0.x = x_2921;
  let x_2925 : bool = u_xlatb0.y;
  if (x_2925) {
    let x_2930 : f32 = u_xlat1.y;
    x_2926 = x_2930;
  } else {
    let x_2933 : f32 = u_xlat2.y;
    x_2926 = x_2933;
  }
  let x_2934 : f32 = x_2926;
  SV_Target0.y = x_2934;
  let x_2937 : bool = u_xlatb0.z;
  if (x_2937) {
    let x_2942 : f32 = u_xlat1.z;
    x_2938 = x_2942;
  } else {
    let x_2945 : f32 = u_xlat2.z;
    x_2938 = x_2945;
  }
  let x_2946 : f32 = x_2938;
  SV_Target0.z = x_2946;
  let x_2949 : f32 = u_xlat1.w;
  SV_Target0.w = x_2949;
  return;
}
