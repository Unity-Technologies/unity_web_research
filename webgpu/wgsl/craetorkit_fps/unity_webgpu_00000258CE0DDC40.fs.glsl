...
layout(set = 0, binding = 2) uniform mediump  sampler sampler_DitheringTex;
...
float u_xlat22;
    ...
    u_xlat12 = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.xy, 0.0, ivec2(0, 1)).w;
    u_xlat18 = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.xy, 0.0, ivec2(1, 0)).w;
    u_xlat2.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.xy, 0.0, ivec2(0, -1)).w;
    u_xlat8 = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.xy, 0.0, ivec2(-1, 0)).w;
    ...
    if(u_xlatb20){
        u_xlat20 = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.xy, 0.0, ivec2(-1, -1)).w;
        u_xlat3.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.xy, 0.0, ivec2(1, 1)).w;
        u_xlat9.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.xy, 0.0, ivec2(1, -1)).w;
        u_xlat0.x = textureLodOffset(sampler2D(_MainTex, sampler_MainTex), u_xlat0.xy, 0.0, ivec2(-1, 1)).w;
        ...
        u_xlat15.x = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat15.xy, 0.0).w;
        u_xlat6.x = u_xlat6.x * u_xlat6.x;
        u_xlat16.xy = u_xlat5.xy;
        u_xlat16.xy = clamp(u_xlat16.xy, 0.0, 1.0);
        u_xlat16.xy = u_xlat16.xy * vec2(_RenderViewportScaleFactor);
        u_xlat21 = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat16.xy, 0.0).w;
        ...
        if(u_xlati10.x != 0) {
            if(u_xlati15.x == 0) {
                ...
                u_xlat3.x = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat10.xz, 0.0).w;
            }
            if(u_xlati15.y == 0) {
                u_xlat10.xz = u_xlat5.xz;
                u_xlat10.xz = clamp(u_xlat10.xz, 0.0, 1.0);
                u_xlat10.xz = u_xlat10.xz * vec2(_RenderViewportScaleFactor);
                u_xlat3.y = textureLod(sampler2D(_MainTex, sampler_MainTex), u_xlat10.xz, 0.0).w;
            }
