...
fn main_1() {
  ...
  let x_1305 : vec4<f32> = vs_TEXCOORD0;
  let x_1307 : vec4<f32> = textureSample(x_EmissionMap, sampler_EmissionMap, vec2<f32>(x_1305.x, x_1305.y));
  u_xlat1 = vec3<f32>(x_1307.x, x_1307.y, x_1307.z);
  let x_1309 : vec3<f32> = u_xlat1;
  let x_1312 : vec4<f32> = x_45.x_EmissionColor;
  let x_1315 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1309 * vec3<f32>(x_1312.x, x_1312.y, x_1312.z)) + x_1315);
  let x_1318 : f32 = vs_TEXCOORD1.w;
  let x_1320 : f32 = x_45.x_ProjectionParams.y;
  u_xlat45 = (x_1318 / x_1320);
  let x_1322 : f32 = u_xlat45;
  u_xlat45 = (-(x_1322) + 1.0f);
  let x_1325 : f32 = u_xlat45;
  let x_1327 : f32 = x_45.x_ProjectionParams.z;
  u_xlat45 = (x_1325 * x_1327);
  let x_1329 : f32 = u_xlat45;
  u_xlat45 = max(x_1329, 0.0f);
  let x_1331 : f32 = u_xlat45;
  let x_1334 : f32 = x_45.unity_FogParams.x;
  u_xlat45 = (x_1331 * x_1334);
  let x_1336 : f32 = u_xlat45;
  let x_1337 : f32 = u_xlat45;
  u_xlat45 = (x_1336 * -(x_1337));
  let x_1340 : f32 = u_xlat45;
  u_xlat45 = exp2(x_1340);
  let x_1342 : vec3<f32> = u_xlat0;
  let x_1345 : vec4<f32> = x_45.unity_FogColor;
  u_xlat0 = (x_1342 + -(vec3<f32>(x_1345.x, x_1345.y, x_1345.z)));
  let x_1351 : f32 = u_xlat45;
  let x_1353 : vec3<f32> = u_xlat0;
  let x_1356 : vec4<f32> = x_45.unity_FogColor;
  let x_1358 : vec3<f32> = ((vec3<f32>(x_1351, x_1351, x_1351) * x_1353) + vec3<f32>(x_1356.x, x_1356.y, x_1356.z));
