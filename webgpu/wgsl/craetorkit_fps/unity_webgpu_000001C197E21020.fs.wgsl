...
fn main_1() {
  ...
  u_xlat0 = ((vec4<f32>(x_1253.w, x_1253.x, x_1253.y, x_1253.z) * vec4<f32>(x_1255.w, x_1255.x, x_1255.y, x_1255.z)) + vec4<f32>(x_1258.w, x_1258.x, x_1258.y, x_1258.z));
  let x_1263 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1263);
  let x_1265 : bool = u_xlatb1;
  if (x_1265) {
    let x_1268 : vec4<f32> = u_xlat0;
    let x_1269 : vec3<f32> = vec3<f32>(x_1268.y, x_1268.z, x_1268.w);
    let x_1270 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1269.x, x_1269.y, x_1269.z, x_1270.w);
    let x_1272 : vec4<f32> = u_xlat1;
    let x_1276 : vec3<f32> = clamp(vec3<f32>(x_1272.x, x_1272.y, x_1272.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1277 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1276.x, x_1276.y, x_1276.z, x_1277.w);
    let x_1279 : vec4<f32> = u_xlat1;
    u_xlat0.x = dot(vec3<f32>(x_1279.x, x_1279.y, x_1279.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1289 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1289.y, x_1289.z, x_1289.w, x_1289.x);
  return;
}
