...
fn main_1() {
  ...
  let x_53 : vec4<f32> = x_30.unity_FogColor;
  u_xlat0 = ((x_48 * x_49) + -(vec3<f32>(x_53.x, x_53.y, x_53.z)));
  let x_61 : f32 = vs_TEXCOORD3;
...
@fragment
fn main(@location(0) vs_TEXCOORD0_param : vec2<f32>, @location(1) vs_TEXCOORD2_param : vec2<f32>, @location(2) vs_TEXCOORD3_param : f32, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
