...
fn main_1() {
  ...
  u_xlat0 = (x_693 * vec3<f32>(x_694.x, x_694.y, x_694.z));
  let x_699 : f32 = vs_TEXCOORD4;
  u_xlat18 = x_699;
  let x_700 : f32 = u_xlat18;
  u_xlat18 = clamp(x_700, 0.0f, 1.0f);
  let x_704 : vec3<f32> = u_xlat0;
  let x_705 : f32 = u_xlat18;
  let x_707 : vec3<f32> = (x_704 * vec3<f32>(x_705, x_705, x_705));
