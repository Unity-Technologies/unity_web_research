...
fn main_1() {
  ...
  u_xlat0 = (vec4<f32>(x_1226.w, x_1226.x, x_1226.y, x_1226.z) * vec4<f32>(x_1237.x, x_1237.y, x_1237.z, x_1237.w));
  let x_1244 : vec4<f32> = u_xlat0;
  u_xlat1 = ((vec3<f32>(x_1244.y, x_1244.z, x_1244.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1252 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1252);
  let x_1254 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1254 * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  ...
  let x_1268 : vec2<f32> = x_26.x_Lut3D_Params;
  u_xlat1 = (x_1265 * vec3<f32>(x_1268.y, x_1268.y, x_1268.y));
  let x_1272 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat31 = (x_1272 * 0.5f);
  let x_1274 : vec3<f32> = u_xlat1;
  let x_1276 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1279 : f32 = u_xlat31;
  u_xlat1 = ((x_1274 * vec3<f32>(x_1276.x, x_1276.x, x_1276.x)) + vec3<f32>(x_1279, x_1279, x_1279));
  let x_1290 : vec3<f32> = u_xlat1;
  let x_1291 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, x_1290);
  let x_1292 : vec3<f32> = vec3<f32>(x_1291.x, x_1291.y, x_1291.z);
  let x_1293 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1293.x, x_1292.x, x_1292.y, x_1292.z);
  let x_1297 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1297);
  let x_1299 : bool = u_xlatb1;
  if (x_1299) {
    let x_1302 : vec4<f32> = u_xlat0;
    u_xlat1 = vec3<f32>(x_1302.y, x_1302.z, x_1302.w);
    let x_1304 : vec3<f32> = u_xlat1;
    u_xlat1 = clamp(x_1304, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1308 : vec3<f32> = u_xlat1;
    u_xlat0.x = dot(x_1308, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1317 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1317.y, x_1317.z, x_1317.w, x_1317.x);
  return;
}
