...
fn main_1() {
  ...
  if (x_1269) {
    ...
    u_xlat2.w = ((x_1502 * x_1504) + 1.0f);
  }
  let x_1508 : vec4<f32> = u_xlat2;
  let x_1511 : f32 = x_26.x_PostExposure;
  let x_1513 : f32 = x_26.x_PostExposure;
  let x_1515 : f32 = x_26.x_PostExposure;
  let x_1517 : f32 = x_26.x_PostExposure;
  let x_1518 : vec4<f32> = vec4<f32>(x_1511, x_1513, x_1515, x_1517);
  u_xlat0 = (x_1508 * vec4<f32>(x_1518.x, x_1518.y, x_1518.z, x_1518.w));
  let x_1525 : vec4<f32> = u_xlat0;
  let x_1532 : vec3<f32> = ((vec3<f32>(x_1525.z, x_1525.x, x_1525.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1533 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1532.x, x_1532.y, x_1532.z, x_1533.w);
  ...
  let x_1547 : vec3<f32> = ((vec3<f32>(x_1540.x, x_1540.y, x_1540.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1548 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1547.x, x_1547.y, x_1547.z, x_1548.w);
  let x_1550 : vec4<f32> = u_xlat0;
  let x_1554 : vec3<f32> = clamp(vec3<f32>(x_1550.x, x_1550.y, x_1550.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1555 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1554.x, x_1554.y, x_1554.z, x_1555.w);
  let x_1557 : vec4<f32> = u_xlat0;
  let x_1561 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1563 : vec3<f32> = (vec3<f32>(x_1557.x, x_1557.y, x_1557.z) * vec3<f32>(x_1561.z, x_1561.z, x_1561.z));
  let x_1564 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1563.x, x_1563.y, x_1563.z, x_1564.w);
  let x_1568 : f32 = u_xlat1.x;
  u_xlat10 = floor(x_1568);
  let x_1571 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1573 : vec2<f32> = (vec2<f32>(x_1571.x, x_1571.y) * vec2<f32>(0.5f, 0.5f));
  let x_1574 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1573.x, x_1574.y, x_1574.z, x_1573.y);
  let x_1576 : vec4<f32> = u_xlat1;
  let x_1579 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1582 : vec4<f32> = u_xlat1;
  let x_1584 : vec2<f32> = ((vec2<f32>(x_1576.y, x_1576.z) * vec2<f32>(x_1579.x, x_1579.y)) + vec2<f32>(x_1582.x, x_1582.w));
  let x_1585 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1585.x, x_1584.x, x_1584.y, x_1585.w);
  let x_1587 : f32 = u_xlat10;
  let x_1589 : f32 = x_26.x_Lut2D_Params.y;
  let x_1592 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1587 * x_1589) + x_1592);
  let x_1600 : vec4<f32> = u_xlat1;
  let x_1602 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1600.x, x_1600.z));
  let x_1603 : vec3<f32> = vec3<f32>(x_1602.x, x_1602.y, x_1602.z);
  let x_1604 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1603.x, x_1603.y, x_1603.z, x_1604.w);
  let x_1607 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat3.x = x_1607;
  u_xlat3.y = 0.0f;
  let x_1610 : vec4<f32> = u_xlat1;
  let x_1612 : vec4<f32> = u_xlat3;
  let x_1614 : vec2<f32> = (vec2<f32>(x_1610.x, x_1610.z) + vec2<f32>(x_1612.x, x_1612.y));
  let x_1615 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1614.x, x_1614.y, x_1615.z, x_1615.w);
  let x_1620 : vec4<f32> = u_xlat1;
  let x_1622 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1620.x, x_1620.y));
  let x_1623 : vec3<f32> = vec3<f32>(x_1622.x, x_1622.y, x_1622.z);
  let x_1624 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1623.x, x_1623.y, x_1623.z, x_1624.w);
  let x_1627 : f32 = u_xlat0.x;
  let x_1629 : f32 = x_26.x_Lut2D_Params.z;
  let x_1631 : f32 = u_xlat10;
  u_xlat0.x = ((x_1627 * x_1629) + -(x_1631));
  ...
  let x_1650 : vec3<f32> = ((vec3<f32>(x_1643.x, x_1643.x, x_1643.x) * vec3<f32>(x_1645.x, x_1645.y, x_1645.z)) + vec3<f32>(x_1648.x, x_1648.y, x_1648.z));
  let x_1651 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1650.x, x_1650.y, x_1650.z, x_1651.w);
  let x_1653 : vec2<f32> = vs_TEXCOORD0;
  let x_1656 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1660 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1662 : vec2<f32> = ((x_1653 * vec2<f32>(x_1656.x, x_1656.y)) + vec2<f32>(x_1660.z, x_1660.w));
  let x_1663 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1662.x, x_1662.y, x_1663.z, x_1663.w);
  let x_1670 : vec4<f32> = u_xlat1;
  let x_1672 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1670.x, x_1670.y));
  u_xlat1.x = x_1672.w;
  let x_1676 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1676 * 2.0f) + -1.0f);
  let x_1681 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1681 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1687 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1687, 0.0f, 1.0f);
  let x_1691 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1691 * 2.0f) + -1.0f);
  let x_1696 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1696)) + 1.0f);
  let x_1702 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1702);
  let x_1706 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1706) + 1.0f);
  let x_1711 : f32 = u_xlat1.x;
  let x_1713 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1711 * x_1713);
  let x_1716 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1716.x, x_1716.y, x_1716.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1721 : vec4<f32> = u_xlat0;
  let x_1725 : vec3<f32> = max(abs(vec3<f32>(x_1721.x, x_1721.y, x_1721.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1726 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1725.x, x_1725.y, x_1725.z, x_1726.w);
  let x_1728 : vec4<f32> = u_xlat2;
  let x_1730 : vec3<f32> = log2(vec3<f32>(x_1728.x, x_1728.y, x_1728.z));
  let x_1731 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1730.x, x_1730.y, x_1730.z, x_1731.w);
  let x_1733 : vec4<f32> = u_xlat2;
  let x_1737 : vec3<f32> = (vec3<f32>(x_1733.x, x_1733.y, x_1733.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1738 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1737.x, x_1737.y, x_1737.z, x_1738.w);
  let x_1740 : vec4<f32> = u_xlat2;
  let x_1742 : vec3<f32> = exp2(vec3<f32>(x_1740.x, x_1740.y, x_1740.z));
  let x_1743 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1742.x, x_1742.y, x_1742.z, x_1743.w);
  let x_1745 : vec4<f32> = u_xlat2;
  let x_1752 : vec3<f32> = ((vec3<f32>(x_1745.x, x_1745.y, x_1745.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1753 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1752.x, x_1752.y, x_1752.z, x_1753.w);
  let x_1760 : vec4<f32> = u_xlat0;
  let x_1763 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1760.x, x_1760.y, x_1760.z, x_1760.x));
  u_xlatb0 = vec3<bool>(x_1763.x, x_1763.y, x_1763.z);
  let x_1766 : bool = u_xlatb0.x;
  if (x_1766) {
    let x_1771 : f32 = u_xlat11.x;
    x_1767 = x_1771;
  } else {
  ...
  u_xlat0.x = x_1775;
  let x_1778 : bool = u_xlatb0.y;
  if (x_1778) {
    let x_1783 : f32 = u_xlat11.y;
    x_1779 = x_1783;
  } else {
    let x_1786 : f32 = u_xlat2.y;
    x_1779 = x_1786;
  }
  let x_1787 : f32 = x_1779;
  u_xlat0.y = x_1787;
  let x_1790 : bool = u_xlatb0.z;
  if (x_1790) {
    let x_1795 : f32 = u_xlat11.z;
    x_1791 = x_1795;
  } else {
    let x_1798 : f32 = u_xlat2.z;
    x_1791 = x_1798;
  }
  ...
  let x_1808 : vec3<f32> = ((vec3<f32>(x_1801.x, x_1801.x, x_1801.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1806.x, x_1806.y, x_1806.z));
  let x_1809 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1808.x, x_1808.y, x_1808.z, x_1809.w);
  let x_1811 : vec4<f32> = u_xlat0;
  let x_1814 : vec3<f32> = (vec3<f32>(x_1811.x, x_1811.y, x_1811.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1815 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1814.x, x_1814.y, x_1814.z, x_1815.w);
  let x_1817 : vec4<f32> = u_xlat0;
  let x_1820 : vec3<f32> = (vec3<f32>(x_1817.x, x_1817.y, x_1817.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1821 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1820.x, x_1820.y, x_1820.z, x_1821.w);
  let x_1823 : vec4<f32> = u_xlat2;
  let x_1826 : vec3<f32> = (vec3<f32>(x_1823.x, x_1823.y, x_1823.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1827 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1826.x, x_1826.y, x_1826.z, x_1827.w);
  let x_1829 : vec4<f32> = u_xlat2;
  let x_1832 : vec3<f32> = max(abs(vec3<f32>(x_1829.x, x_1829.y, x_1829.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1833 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1832.x, x_1832.y, x_1832.z, x_1833.w);
  let x_1835 : vec4<f32> = u_xlat2;
  let x_1837 : vec3<f32> = log2(vec3<f32>(x_1835.x, x_1835.y, x_1835.z));
  let x_1838 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1837.x, x_1837.y, x_1837.z, x_1838.w);
  let x_1840 : vec4<f32> = u_xlat2;
  let x_1843 : vec3<f32> = (vec3<f32>(x_1840.x, x_1840.y, x_1840.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1844 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1843.x, x_1843.y, x_1843.z, x_1844.w);
  let x_1846 : vec4<f32> = u_xlat2;
  let x_1848 : vec3<f32> = exp2(vec3<f32>(x_1846.x, x_1846.y, x_1846.z));
  ...
  let x_1859 : bool = u_xlatb0.x;
  if (x_1859) {
    let x_1864 : f32 = u_xlat1.x;
    x_1860 = x_1864;
  } else {
    let x_1867 : f32 = u_xlat2.x;
    x_1860 = x_1867;
  }
  let x_1868 : f32 = x_1860;
  SV_Target0.x = x_1868;
  let x_1872 : bool = u_xlatb0.y;
  if (x_1872) {
    let x_1877 : f32 = u_xlat1.y;
    x_1873 = x_1877;
  } else {
    let x_1880 : f32 = u_xlat2.y;
    x_1873 = x_1880;
  }
  let x_1881 : f32 = x_1873;
  SV_Target0.y = x_1881;
  let x_1884 : bool = u_xlatb0.z;
  if (x_1884) {
    let x_1889 : f32 = u_xlat1.z;
    x_1885 = x_1889;
  } else {
    let x_1892 : f32 = u_xlat2.z;
    x_1885 = x_1892;
  }
  let x_1893 : f32 = x_1885;
  SV_Target0.z = x_1893;
  let x_1896 : f32 = u_xlat0.w;
  SV_Target0.w = x_1896;
  return;
}
