...
fn main_1() {
  ...
  let x_405 : vec4<f32> = textureSample(x_LightTextureB0, sampler_LightTextureB0, vec2<f32>(x_403, x_403));
  u_xlat19 = x_405.x;
  let x_415 : vec4<f32> = u_xlat3;
  let x_417 : vec4<f32> = textureSample(x_LightTexture0, sampler_LightTexture0, vec3<f32>(x_415.x, x_415.y, x_415.z));
  u_xlat3.x = x_417.w;
  let x_420 : f32 = u_xlat19;
  let x_422 : f32 = u_xlat3.x;
  u_xlat19 = (x_420 * x_422);
  let x_424 : f32 = u_xlat18;
  let x_425 : f32 = u_xlat19;
  u_xlat18 = (x_424 * x_425);
  let x_427 : f32 = u_xlat18;
  let x_431 : vec4<f32> = x_20.x_LightColor0;
  let x_433 : vec3<f32> = (vec3<f32>(x_427, x_427, x_427) * vec3<f32>(x_431.x, x_431.y, x_431.z));
  let x_434 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_433.x, x_433.y, x_433.z, x_434.w);
  let x_437 : vec3<f32> = vs_TEXCOORD0;
  let x_438 : vec3<f32> = vs_TEXCOORD0;
  u_xlat18 = dot(x_437, x_438);
  let x_440 : f32 = u_xlat18;
  u_xlat18 = inverseSqrt(x_440);
  ...
  u_xlat5 = (vec3<f32>(x_449.x, x_449.y, x_449.z) + vec3<f32>(-0.039999999f, -0.039999999f, -0.039999999f));
  let x_456 : f32 = x_20.x_Metallic;
  let x_458 : f32 = x_20.x_Metallic;
  let x_460 : f32 = x_20.x_Metallic;
  let x_461 : vec3<f32> = vec3<f32>(x_456, x_458, x_460);
  let x_466 : vec3<f32> = u_xlat5;
  u_xlat5 = ((vec3<f32>(x_461.x, x_461.y, x_461.z) * x_466) + vec3<f32>(0.039999999f, 0.039999999f, 0.039999999f));
  let x_472 : f32 = x_20.x_Metallic;
  u_xlat18 = ((-(x_472) * 0.959999979f) + 0.959999979f);
  let x_477 : vec3<f32> = u_xlat1;
  let x_478 : vec4<f32> = u_xlat4;
  u_xlat19 = dot(x_477, vec3<f32>(x_478.x, x_478.y, x_478.z));
  let x_481 : f32 = u_xlat19;
  let x_482 : f32 = u_xlat19;
  u_xlat19 = (x_481 + x_482);
  let x_484 : vec4<f32> = u_xlat4;
  let x_486 : f32 = u_xlat19;
  let x_490 : vec3<f32> = u_xlat1;
  u_xlat1 = ((vec3<f32>(x_484.x, x_484.y, x_484.z) * -(vec3<f32>(x_486, x_486, x_486))) + x_490);
  let x_492 : vec4<f32> = u_xlat4;
  let x_494 : vec3<f32> = u_xlat0;
  u_xlat19 = dot(vec3<f32>(x_492.x, x_492.y, x_492.z), x_494);
  let x_496 : f32 = u_xlat19;
  u_xlat19 = clamp(x_496, 0.0f, 1.0f);
  let x_498 : vec3<f32> = u_xlat1;
  let x_499 : vec3<f32> = u_xlat0;
  u_xlat0.x = dot(x_498, x_499);
  let x_503 : f32 = u_xlat0.x;
  let x_505 : f32 = u_xlat0.x;
  u_xlat0.x = (x_503 * x_505);
  let x_509 : f32 = u_xlat0.x;
  let x_511 : f32 = u_xlat0.x;
  u_xlat0.x = (x_509 * x_511);
  let x_516 : f32 = x_20.x_Glossiness;
  let x_519 : f32 = u_xlat2.w;
  u_xlat0.y = ((-(x_516) * x_519) + 1.0f);
  let x_528 : vec3<f32> = u_xlat0;
  let x_530 : vec4<f32> = textureSample(unity_NHxRoughness, samplerunity_NHxRoughness, vec2<f32>(x_528.x, x_528.y));
  u_xlat0.x = x_530.x;
  let x_534 : f32 = u_xlat0.x;
  u_xlat0.x = (x_534 * 16.0f);
  let x_537 : vec3<f32> = u_xlat5;
  let x_538 : vec3<f32> = u_xlat0;
  u_xlat0 = (x_537 * vec3<f32>(x_538.x, x_538.x, x_538.x));
  let x_541 : vec4<f32> = u_xlat2;
  let x_543 : f32 = u_xlat18;
  let x_546 : vec3<f32> = u_xlat0;
  u_xlat0 = ((vec3<f32>(x_541.x, x_541.y, x_541.z) * vec3<f32>(x_543, x_543, x_543)) + x_546);
  let x_548 : f32 = u_xlat19;
  let x_550 : vec4<f32> = u_xlat3;
  u_xlat1 = (vec3<f32>(x_548, x_548, x_548) * vec3<f32>(x_550.x, x_550.y, x_550.z));
  let x_553 : vec3<f32> = u_xlat0;
  let x_554 : vec3<f32> = u_xlat1;
  u_xlat0 = (x_553 * x_554);
  let x_558 : f32 = vs_TEXCOORD4;
  u_xlat18 = x_558;
  let x_559 : f32 = u_xlat18;
  u_xlat18 = clamp(x_559, 0.0f, 1.0f);
  let x_563 : vec3<f32> = u_xlat0;
  let x_564 : f32 = u_xlat18;
  let x_566 : vec3<f32> = (x_563 * vec3<f32>(x_564, x_564, x_564));
