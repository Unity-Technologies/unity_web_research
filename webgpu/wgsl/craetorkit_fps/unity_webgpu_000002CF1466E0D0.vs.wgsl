...
fn main_1() {
  ...
  u_xlat7 = dot(vec3<f32>(x_230.x, x_230.y, x_230.z), vec3<f32>(x_232.x, x_232.y, x_232.z));
  let x_235 : f32 = u_xlat7;
  u_xlat7 = inverseSqrt(x_235);
  let x_237 : f32 = u_xlat7;
  ...
  vs_TEXCOORD2 = vec4<f32>(x_246.w, x_246.w, x_246.w, x_246.x);
  let x_249 : vec4<f32> = u_xlat0;
  vs_TEXCOORD3 = vec4<f32>(x_249.w, x_249.w, x_249.w, x_249.y);
  let x_253 : f32 = u_xlat0.z;
  vs_TEXCOORD4.w = x_253;
  let x_257 : vec3<f32> = in_NORMAL0;
  let x_259 : vec4<f32> = x_18.unity_WorldToObject[0i];
  u_xlat0.x = dot(x_257, vec3<f32>(x_259.x, x_259.y, x_259.z));
  ...
  u_xlat6 = dot(vec3<f32>(x_276.x, x_276.y, x_276.z), vec3<f32>(x_278.x, x_278.y, x_278.z));
  let x_281 : f32 = u_xlat6;
  u_xlat6 = inverseSqrt(x_281);
  ...
  let x_288 : vec4<f32> = vs_TEXCOORD4;
  vs_TEXCOORD4 = vec4<f32>(x_287.x, x_287.y, x_287.z, x_288.w);
