...
layout(set = 0, binding = 2) uniform mediump texture2D _Vignette_Mask;
...
layout(set = 0, binding = 5) uniform mediump  sampler sampler_Vignette_Mask;
void main()
{
vec4 u_xlat0;
bool u_xlatb0;
...
float u_xlat18;
    ...
    if(u_xlatb7){
        u_xlat12.xy = vec2(u_xlat2) * _Distortion_Amount.xy;
        ...
        u_xlat2 = u_xlat2 * _Distortion_Amount.y;
        ...
        u_xlat2 = u_xlat3.x * u_xlat2 + -1.0;
        u_xlat12.xy = u_xlat0.xy * vec2(u_xlat2) + u_xlat1.xy;
    }
    ...
    if(u_xlatb7){
        ...
        u_xlat2 = u_xlat2 * u_xlat7 + u_xlat3.x;
