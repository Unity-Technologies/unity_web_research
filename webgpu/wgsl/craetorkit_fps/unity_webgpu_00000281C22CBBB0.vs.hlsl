...
float3 aHSL = RGBtoHSV ( albedo . rgb ) ; float3 bHSL = RGBtoHSV ( IN . color . rgb ) ; float3 rHSL = float3 ( bHSL . x , bHSL . y , aHSL . z ) ; albedo = float4 ( HSVtoRGB ( rHSL ) , albedo . a * IN . color . a ) ; ;
