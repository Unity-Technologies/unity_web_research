...
float u_xlat39;
    ...
    u_xlat5.xy = texture(sampler2D(_Metallic, sampler_Metallic), vs_TEXCOORD0.xy).xw;
    u_xlat6.xyz = texture(sampler2D(_NormalMap, sampler_NormalMap), vs_TEXCOORD0.xy).xyw;
    ...
    if(u_xlatb14){
        ...
        u_xlat29.xy = u_xlat14.xy * _ShadowMapTexture_TexelSize.zw + vec2(0.5, 0.5);
        u_xlat29.xy = floor(u_xlat29.xy);
        u_xlat14.xy = u_xlat14.xy * _ShadowMapTexture_TexelSize.zw + (-u_xlat29.xy);
        ...
        u_xlat9 = u_xlat29.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat11.xzyz;
        ...
        u_xlat9 = u_xlat29.xyxy * _ShadowMapTexture_TexelSize.xyxy + u_xlat11.xwyw;
    ...
    u_xlat37 = (-u_xlat5.x) * 0.959999979 + 0.959999979;
    ...
    u_xlat12.xyz = u_xlat6.xyz * vec3(u_xlat24);
