...
fn main_1() {
  ...
  let x_686 : f32 = x_32.x_PostExposure;
  let x_688 : f32 = x_32.x_PostExposure;
  let x_690 : f32 = x_32.x_PostExposure;
  let x_692 : f32 = x_32.x_PostExposure;
  ...
  let x_737 : vec2<f32> = x_32.x_Lut3D_Params;
  ...
  let x_743 : f32 = x_32.x_Lut3D_Params.x;
  u_xlat16 = (x_743 * 0.5f);
  let x_745 : vec4<f32> = u_xlat1;
  let x_748 : vec2<f32> = x_32.x_Lut3D_Params;
  ...
  let x_773 : f32 = x_32.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_773);
