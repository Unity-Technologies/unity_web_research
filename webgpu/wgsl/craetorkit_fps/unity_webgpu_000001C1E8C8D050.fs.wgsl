...
fn main_1() {
  ...
  u_xlat3 = (x_1222 * vec4<f32>(0.0625f, 0.0625f, 0.0625f, 0.0625f));
  let x_1226 : vec4<f32> = u_xlat1;
  let x_1229 : vec3<f32> = x_26.x_Bloom_Settings;
  let x_1231 : vec3<f32> = (vec3<f32>(x_1226.x, x_1226.y, x_1226.z) * vec3<f32>(x_1229.z, x_1229.z, x_1229.z));
  let x_1232 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1231.x, x_1231.y, x_1231.z, x_1232.w);
  u_xlat1.w = 0.0f;
  let x_1235 : vec4<f32> = u_xlat2;
  u_xlat2 = (x_1235 * vec4<f32>(0.0625f, 0.0625f, 0.0625f, 1.0f));
  let x_1238 : vec4<f32> = u_xlat2;
  let x_1242 : vec3<f32> = x_26.x_Bloom_Color;
  let x_1243 : vec3<f32> = (vec3<f32>(x_1238.x, x_1238.y, x_1238.z) * x_1242);
  let x_1244 : vec4<f32> = u_xlat4;
  u_xlat4 = vec4<f32>(x_1243.x, x_1243.y, x_1243.z, x_1244.w);
  let x_1247 : f32 = u_xlat2.w;
  u_xlat4.w = (x_1247 * 0.0625f);
  let x_1250 : vec4<f32> = u_xlat0;
  let x_1251 : vec4<f32> = u_xlat4;
  u_xlat0 = (x_1250 + x_1251);
  let x_1253 : vec4<f32> = u_xlat1;
  let x_1254 : vec4<f32> = u_xlat3;
  let x_1256 : vec4<f32> = u_xlat0;
  u_xlat0 = ((x_1253 * x_1254) + x_1256);
  let x_1259 : vec2<f32> = vs_TEXCOORD1;
  let x_1262 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1266 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1268 : vec2<f32> = ((x_1259 * vec2<f32>(x_1262.x, x_1262.y)) + vec2<f32>(x_1266.z, x_1266.w));
  let x_1269 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1268.x, x_1268.y, x_1269.z, x_1269.w);
  let x_1276 : vec4<f32> = u_xlat1;
  let x_1278 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1276.x, x_1276.y));
  let x_1279 : vec3<f32> = vec3<f32>(x_1278.x, x_1278.y, x_1278.z);
  let x_1280 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1279.x, x_1279.y, x_1279.z, x_1280.w);
  let x_1282 : vec4<f32> = u_xlat0;
  let x_1283 : vec3<f32> = vec3<f32>(x_1282.x, x_1282.y, x_1282.z);
  let x_1284 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1283.x, x_1283.y, x_1283.z, x_1284.w);
  let x_1286 : vec4<f32> = u_xlat2;
  let x_1290 : vec3<f32> = clamp(vec3<f32>(x_1286.x, x_1286.y, x_1286.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1291 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1290.x, x_1290.y, x_1290.z, x_1291.w);
  let x_1293 : vec4<f32> = u_xlat2;
  u_xlat31 = dot(vec3<f32>(x_1293.x, x_1293.y, x_1293.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1300 : f32 = u_xlat31;
  u_xlat31 = sqrt(x_1300);
  let x_1304 : f32 = x_26.x_Grain_Params1.x;
  let x_1305 : f32 = u_xlat31;
  u_xlat31 = ((x_1304 * -(x_1305)) + 1.0f);
  ...
  let x_1319 : f32 = x_26.x_Grain_Params1.y;
  let x_1321 : f32 = x_26.x_Grain_Params1.y;
  let x_1323 : f32 = x_26.x_Grain_Params1.y;
  let x_1325 : vec3<f32> = (vec3<f32>(x_1316.x, x_1316.y, x_1316.z) * vec3<f32>(x_1319, x_1321, x_1323));
  let x_1326 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1325.x, x_1325.y, x_1325.z, x_1326.w);
  let x_1328 : vec4<f32> = u_xlat1;
  let x_1330 : f32 = u_xlat31;
  let x_1333 : vec4<f32> = u_xlat0;
  let x_1335 : vec3<f32> = ((vec3<f32>(x_1328.x, x_1328.y, x_1328.z) * vec3<f32>(x_1330, x_1330, x_1330)) + vec3<f32>(x_1333.x, x_1333.y, x_1333.z));
  let x_1336 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1335.x, x_1335.y, x_1335.z, x_1336.w);
  let x_1338 : vec4<f32> = u_xlat0;
  let x_1342 : f32 = x_26.x_PostExposure;
  let x_1344 : f32 = x_26.x_PostExposure;
  let x_1346 : f32 = x_26.x_PostExposure;
  let x_1348 : f32 = x_26.x_PostExposure;
  let x_1349 : vec4<f32> = vec4<f32>(x_1342, x_1344, x_1346, x_1348);
  u_xlat0 = (vec4<f32>(x_1338.w, x_1338.x, x_1338.y, x_1338.z) * vec4<f32>(x_1349.x, x_1349.y, x_1349.z, x_1349.w));
  let x_1356 : vec4<f32> = u_xlat0;
  let x_1363 : vec3<f32> = ((vec3<f32>(x_1356.y, x_1356.z, x_1356.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1364 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1363.x, x_1363.y, x_1363.z, x_1364.w);
  let x_1366 : vec4<f32> = u_xlat1;
  let x_1368 : vec3<f32> = log2(vec3<f32>(x_1366.x, x_1366.y, x_1366.z));
  let x_1369 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1368.x, x_1368.y, x_1368.z, x_1369.w);
  let x_1371 : vec4<f32> = u_xlat1;
  let x_1378 : vec3<f32> = ((vec3<f32>(x_1371.x, x_1371.y, x_1371.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1379 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1378.x, x_1378.y, x_1378.z, x_1379.w);
  let x_1381 : vec4<f32> = u_xlat1;
  let x_1385 : vec3<f32> = clamp(vec3<f32>(x_1381.x, x_1381.y, x_1381.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1386 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1385.x, x_1385.y, x_1385.z, x_1386.w);
  let x_1388 : vec4<f32> = u_xlat1;
  let x_1393 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1395 : vec3<f32> = (vec3<f32>(x_1388.x, x_1388.y, x_1388.z) * vec3<f32>(x_1393.y, x_1393.y, x_1393.y));
  let x_1396 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1395.x, x_1395.y, x_1395.z, x_1396.w);
  let x_1399 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat31 = (x_1399 * 0.5f);
  let x_1401 : vec4<f32> = u_xlat1;
  let x_1404 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1407 : f32 = u_xlat31;
  let x_1409 : vec3<f32> = ((vec3<f32>(x_1401.x, x_1401.y, x_1401.z) * vec3<f32>(x_1404.x, x_1404.x, x_1404.x)) + vec3<f32>(x_1407, x_1407, x_1407));
  let x_1410 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1409.x, x_1409.y, x_1409.z, x_1410.w);
  let x_1420 : vec4<f32> = u_xlat1;
  let x_1422 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1420.x, x_1420.y, x_1420.z));
  let x_1423 : vec3<f32> = vec3<f32>(x_1422.x, x_1422.y, x_1422.z);
  let x_1424 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1424.x, x_1423.x, x_1423.y, x_1423.z);
  let x_1428 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1428);
  let x_1430 : bool = u_xlatb1;
  if (x_1430) {
    let x_1433 : vec4<f32> = u_xlat0;
    let x_1434 : vec3<f32> = vec3<f32>(x_1433.y, x_1433.z, x_1433.w);
    let x_1435 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1434.x, x_1434.y, x_1434.z, x_1435.w);
    let x_1437 : vec4<f32> = u_xlat1;
    let x_1441 : vec3<f32> = clamp(vec3<f32>(x_1437.x, x_1437.y, x_1437.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1442 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1441.x, x_1441.y, x_1441.z, x_1442.w);
    let x_1444 : vec4<f32> = u_xlat1;
    u_xlat0.x = dot(vec3<f32>(x_1444.x, x_1444.y, x_1444.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1450 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1450.y, x_1450.z, x_1450.w, x_1450.x);
  return;
}
