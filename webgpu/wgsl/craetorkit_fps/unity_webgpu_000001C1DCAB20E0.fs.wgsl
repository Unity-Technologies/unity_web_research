...
fn main_1() {
  ...
  let x_1511 : f32 = x_26.x_LumaInAlpha;
  u_xlatb0 = (0.5f < x_1511);
  let x_1513 : bool = u_xlatb0;
  if (x_1513) {
    let x_1516 : vec4<f32> = u_xlat2;
    let x_1517 : vec3<f32> = vec3<f32>(x_1516.x, x_1516.y, x_1516.z);
    let x_1518 : vec4<f32> = u_xlat0;
    u_xlat0 = vec4<f32>(x_1517.x, x_1517.y, x_1517.z, x_1518.w);
    let x_1520 : vec4<f32> = u_xlat0;
    let x_1524 : vec3<f32> = clamp(vec3<f32>(x_1520.x, x_1520.y, x_1520.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1525 : vec4<f32> = u_xlat0;
    u_xlat0 = vec4<f32>(x_1524.x, x_1524.y, x_1524.z, x_1525.w);
    let x_1527 : vec4<f32> = u_xlat0;
    u_xlat2.w = dot(vec3<f32>(x_1527.x, x_1527.y, x_1527.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
