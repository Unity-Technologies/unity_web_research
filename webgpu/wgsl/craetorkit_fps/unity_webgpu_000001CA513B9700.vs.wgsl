...
fn main_1() {
  ...
  let x_511 : f32 = x_51.unity_LightShadowBias.x;
  let x_513 : f32 = u_xlat0.w;
  u_xlat1.x = (x_511 / x_513);
  let x_517 : f32 = u_xlat1.x;
  u_xlat1.x = min(x_517, 0.0f);
  let x_521 : f32 = u_xlat1.x;
  u_xlat1.x = max(x_521, -1.0f);
  let x_526 : f32 = u_xlat0.z;
  let x_528 : f32 = u_xlat1.x;
  u_xlat14 = (x_526 + x_528);
  let x_531 : f32 = u_xlat0.w;
  let x_532 : f32 = u_xlat14;
  u_xlat1.x = min(x_531, x_532);
  let x_539 : vec4<f32> = u_xlat0;
  let x_540 : vec3<f32> = vec3<f32>(x_539.x, x_539.y, x_539.w);
  let x_542 : vec4<f32> = gl_Position;
  gl_Position = vec4<f32>(x_540.x, x_540.y, x_542.z, x_540.z);
  let x_544 : f32 = u_xlat14;
  let x_547 : f32 = u_xlat1.x;
  u_xlat0.x = (-(x_544) + x_547);
  let x_551 : f32 = x_51.unity_LightShadowBias.y;
  let x_553 : f32 = u_xlat0.x;
  let x_555 : f32 = u_xlat14;
  gl_Position.z = ((x_551 * x_553) + x_555);
  return;
}
