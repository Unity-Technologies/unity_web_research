...
layout(set = 0, binding = 1) uniform mediump  sampler sampler_Curves;
void main()
{
vec4 u_xlat0;
vec4 u_xlat1;
...
bool u_xlatb12;
    ...
    u_xlat5.x = texture(sampler2D(_Curves, sampler_Curves), u_xlat0.yw).w;
    u_xlat5.y = texture(sampler2D(_Curves, sampler_Curves), u_xlat0.zw).w;
