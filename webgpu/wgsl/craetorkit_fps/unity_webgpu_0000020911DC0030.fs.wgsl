...
fn main_1() {
  ...
  let x_506 : vec4<f32> = textureSample(x_LightTextureB0, sampler_LightTextureB0, vec2<f32>(x_504.x, x_504.x));
  u_xlat2.x = x_506.x;
  let x_517 : vec3<f32> = u_xlat4;
  let x_518 : vec4<f32> = textureSample(x_LightTexture0, sampler_LightTexture0, x_517);
  u_xlat9.x = x_518.w;
  ...
  u_xlat22 = (x_527 * x_529);
  let x_531 : f32 = u_xlat22;
  let x_535 : vec4<f32> = x_18.x_LightColor0;
  let x_537 : vec3<f32> = (vec3<f32>(x_531, x_531, x_531) * vec3<f32>(x_535.x, x_535.y, x_535.z));
  ...
  u_xlat22 = dot(x_541, x_542);
  let x_544 : f32 = u_xlat22;
  u_xlat22 = inverseSqrt(x_544);
  let x_546 : f32 = u_xlat22;
  let x_548 : vec3<f32> = vs_TEXCOORD1;
  u_xlat4 = (vec3<f32>(x_546, x_546, x_546) * x_548);
  let x_552 : vec4<f32> = x_18.x_Color;
  let x_556 : vec3<f32> = (vec3<f32>(x_552.x, x_552.y, x_552.z) + vec3<f32>(-0.039999999f, -0.039999999f, -0.039999999f));
  let x_557 : vec4<f32> = u_xlat5;
  u_xlat5 = vec4<f32>(x_556.x, x_556.y, x_556.z, x_557.w);
  let x_561 : f32 = x_18.x_Metallic;
  let x_563 : f32 = x_18.x_Metallic;
  let x_565 : f32 = x_18.x_Metallic;
  let x_566 : vec3<f32> = vec3<f32>(x_561, x_563, x_565);
  let x_571 : vec4<f32> = u_xlat5;
  let x_576 : vec3<f32> = ((vec3<f32>(x_566.x, x_566.y, x_566.z) * vec3<f32>(x_571.x, x_571.y, x_571.z)) + vec3<f32>(0.039999999f, 0.039999999f, 0.039999999f));
  let x_577 : vec4<f32> = u_xlat5;
  u_xlat5 = vec4<f32>(x_576.x, x_576.y, x_576.z, x_577.w);
  let x_580 : f32 = x_18.x_Metallic;
  u_xlat22 = ((-(x_580) * 0.959999979f) + 0.959999979f);
  let x_585 : f32 = u_xlat22;
  let x_588 : vec4<f32> = x_18.x_Color;
  u_xlat6 = (vec3<f32>(x_585, x_585, x_585) * vec3<f32>(x_588.x, x_588.y, x_588.z));
  let x_593 : f32 = x_18.x_Glossiness;
  u_xlat22 = (-(x_593) + 1.0f);
  let x_596 : vec3<f32> = u_xlat0;
  let x_597 : f32 = u_xlat21;
  let x_600 : vec3<f32> = u_xlat3;
  u_xlat0 = ((x_596 * vec3<f32>(x_597, x_597, x_597)) + x_600);
  let x_602 : vec3<f32> = u_xlat0;
  let x_603 : vec3<f32> = u_xlat0;
  u_xlat21 = dot(x_602, x_603);
  let x_605 : f32 = u_xlat21;
  u_xlat21 = max(x_605, 0.001f);
  let x_608 : f32 = u_xlat21;
  u_xlat21 = inverseSqrt(x_608);
  let x_610 : f32 = u_xlat21;
  let x_612 : vec3<f32> = u_xlat0;
  u_xlat0 = (vec3<f32>(x_610, x_610, x_610) * x_612);
  let x_614 : vec3<f32> = u_xlat4;
  let x_615 : vec3<f32> = u_xlat3;
  u_xlat21 = dot(x_614, x_615);
  let x_617 : vec3<f32> = u_xlat4;
  let x_618 : vec3<f32> = u_xlat1;
  u_xlat23 = dot(x_617, x_618);
  let x_620 : f32 = u_xlat23;
  u_xlat23 = clamp(x_620, 0.0f, 1.0f);
  let x_622 : vec3<f32> = u_xlat4;
  let x_623 : vec3<f32> = u_xlat0;
  u_xlat3.x = dot(x_622, x_623);
  let x_627 : f32 = u_xlat3.x;
  u_xlat3.x = clamp(x_627, 0.0f, 1.0f);
  let x_630 : vec3<f32> = u_xlat1;
  let x_631 : vec3<f32> = u_xlat0;
  u_xlat0.x = dot(x_630, x_631);
  let x_635 : f32 = u_xlat0.x;
  u_xlat0.x = clamp(x_635, 0.0f, 1.0f);
  let x_640 : f32 = u_xlat0.x;
  let x_642 : f32 = u_xlat0.x;
  u_xlat7.x = (x_640 * x_642);
  let x_645 : vec3<f32> = u_xlat7;
  let x_647 : f32 = u_xlat22;
  u_xlat7.x = dot(vec2<f32>(x_645.x, x_645.x), vec2<f32>(x_647, x_647));
  let x_652 : f32 = u_xlat7.x;
  u_xlat7.x = (x_652 + -0.5f);
  let x_657 : f32 = u_xlat23;
  u_xlat14 = (-(x_657) + 1.0f);
  let x_660 : f32 = u_xlat14;
  let x_661 : f32 = u_xlat14;
  u_xlat1.x = (x_660 * x_661);
  let x_665 : f32 = u_xlat1.x;
  let x_667 : f32 = u_xlat1.x;
  u_xlat1.x = (x_665 * x_667);
  let x_670 : f32 = u_xlat14;
  let x_672 : f32 = u_xlat1.x;
  u_xlat14 = (x_670 * x_672);
  let x_675 : f32 = u_xlat7.x;
  let x_676 : f32 = u_xlat14;
  u_xlat14 = ((x_675 * x_676) + 1.0f);
  let x_679 : f32 = u_xlat21;
  u_xlat1.x = (-(abs(x_679)) + 1.0f);
  ...
  u_xlat1.x = ((x_761 * x_763) + 1.0f);
  let x_767 : f32 = u_xlat14;
  u_xlat14 = (x_767 * 0.318309873f);
  let x_771 : f32 = u_xlat1.x;
  let x_773 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_771 * x_773) + 0.0000001f);
  let x_778 : f32 = u_xlat14;
  let x_780 : f32 = u_xlat1.x;
  u_xlat14 = (x_778 / x_780);
  let x_782 : f32 = u_xlat14;
  let x_783 : f32 = u_xlat21;
  u_xlat7.y = (x_782 * x_783);
  let x_786 : f32 = u_xlat23;
  let x_788 : vec3<f32> = u_xlat7;
  let x_790 : vec2<f32> = (vec2<f32>(x_786, x_786) * vec2<f32>(x_788.x, x_788.y));
  let x_791 : vec3<f32> = u_xlat7;
  u_xlat7 = vec3<f32>(x_790.x, x_790.y, x_791.z);
  let x_794 : f32 = u_xlat7.y;
  u_xlat14 = (x_794 * 3.141592741f);
  let x_797 : f32 = u_xlat14;
  u_xlat14 = max(x_797, 0.0f);
  let x_799 : vec4<f32> = u_xlat5;
  let x_801 : vec4<f32> = u_xlat5;
  u_xlat21 = dot(vec3<f32>(x_799.x, x_799.y, x_799.z), vec3<f32>(x_801.x, x_801.y, x_801.z));
  let x_805 : f32 = u_xlat21;
  u_xlatb21 = !((x_805 == 0.0f));
  let x_807 : bool = u_xlatb21;
  u_xlat21 = select(0.0f, 1.0f, x_807);
  let x_809 : f32 = u_xlat21;
  let x_810 : f32 = u_xlat14;
  u_xlat14 = (x_809 * x_810);
  let x_812 : vec3<f32> = u_xlat7;
  let x_814 : vec4<f32> = u_xlat2;
  u_xlat1 = (vec3<f32>(x_812.x, x_812.x, x_812.x) * vec3<f32>(x_814.x, x_814.y, x_814.z));
  let x_817 : vec4<f32> = u_xlat2;
  let x_819 : f32 = u_xlat14;
  u_xlat7 = (vec3<f32>(x_817.x, x_817.y, x_817.z) * vec3<f32>(x_819, x_819, x_819));
  let x_823 : f32 = u_xlat0.x;
  u_xlat0.x = (-(x_823) + 1.0f);
  let x_828 : f32 = u_xlat0.x;
  let x_830 : f32 = u_xlat0.x;
  u_xlat22 = (x_828 * x_830);
  let x_832 : f32 = u_xlat22;
  let x_833 : f32 = u_xlat22;
  u_xlat22 = (x_832 * x_833);
  let x_836 : f32 = u_xlat0.x;
  let x_837 : f32 = u_xlat22;
  u_xlat0.x = (x_836 * x_837);
  let x_840 : vec4<f32> = u_xlat5;
  let x_844 : vec3<f32> = (-(vec3<f32>(x_840.x, x_840.y, x_840.z)) + vec3<f32>(1.0f, 1.0f, 1.0f));
  ...
  let x_854 : vec3<f32> = ((vec3<f32>(x_847.x, x_847.y, x_847.z) * vec3<f32>(x_849.x, x_849.x, x_849.x)) + vec3<f32>(x_852.x, x_852.y, x_852.z));
  ...
  u_xlat21 = (x_874 * x_876);
  let x_878 : f32 = u_xlat21;
  u_xlat21 = max(x_878, 0.0f);
  let x_880 : f32 = u_xlat21;
  let x_883 : f32 = x_18.unity_FogParams.x;
  u_xlat21 = (x_880 * x_883);
  let x_885 : f32 = u_xlat21;
  let x_886 : f32 = u_xlat21;
  u_xlat21 = (x_885 * -(x_886));
  let x_889 : f32 = u_xlat21;
  u_xlat21 = exp2(x_889);
