...
layout(set = 0, binding = 8) uniform mediump  sampler sampler_OcclusionMap;
void main()
{
vec4 u_xlat0;
vec4 u_xlat1;
...
bool u_xlatb45;
    ...
    u_xlat40 = texture(sampler2D(_OcclusionMap, sampler_OcclusionMap), vs_TEXCOORD0.xy).y;
    u_xlat4.x = (-_OcclusionStrength) + 1.0;
    u_xlat40 = u_xlat40 * _OcclusionStrength + u_xlat4.x;
    ...
    if(u_xlatb39){
        ...
        u_xlat6.xyz = vec3(u_xlat39) * u_xlat17.xyz;
    ...
    u_xlat6 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat39);
    ...
    if(u_xlatb45){
        ...
        u_xlat8 = textureLod(samplerCube(unity_SpecCube1, samplerunity_SpecCube0), u_xlat17.xyz, u_xlat39);
    ...
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat16.xyz = vec3(u_xlat28) * u_xlat5.xyz;
    ...
    u_xlat15.xyz = u_xlat17.xyz * vec3(u_xlat40);
