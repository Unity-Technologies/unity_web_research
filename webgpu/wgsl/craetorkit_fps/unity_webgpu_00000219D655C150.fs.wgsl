...
fn main_1() {
  ...
  u_xlat2 = vec4<f32>(x_514.x, x_514.y, x_515.z, x_515.w);
  let x_518 : f32 = x_20.x_Glossiness;
  let x_520 : f32 = u_xlat1.w;
  let x_522 : f32 = u_xlat21;
  u_xlat0.x = ((x_518 * x_520) + -(x_522));
  let x_527 : f32 = u_xlat0.x;
  u_xlat0.x = (x_527 + 1.0f);
  let x_531 : f32 = u_xlat0.x;
  u_xlat0.x = clamp(x_531, 0.0f, 1.0f);
  let x_540 : vec4<f32> = u_xlat2;
  let x_542 : vec4<f32> = textureSample(unity_NHxRoughness, samplerunity_NHxRoughness, vec2<f32>(x_540.x, x_540.z));
  u_xlat7.x = x_542.x;
  let x_546 : f32 = u_xlat7.x;
  u_xlat7.x = (x_546 * 16.0f);
  let x_549 : vec3<f32> = u_xlat6;
  let x_550 : vec3<f32> = u_xlat7;
  let x_552 : vec3<f32> = (x_549 * vec3<f32>(x_550.x, x_550.x, x_550.x));
  ...
  u_xlat7 = ((vec3<f32>(x_555.x, x_555.y, x_555.z) * vec3<f32>(x_557, x_557, x_557)) + vec3<f32>(x_560.x, x_560.z, x_560.w));
  ...
  let x_573 : vec3<f32> = (-(x_569) + vec3<f32>(x_571.x, x_571.x, x_571.x));
  ...
  let x_582 : vec3<f32> = ((vec3<f32>(x_576.y, x_576.y, x_576.y) * vec3<f32>(x_578.x, x_578.z, x_578.w)) + x_581);
  ...
  let x_589 : vec3<f32> = (vec3<f32>(x_585.x, x_585.y, x_585.z) * vec3<f32>(x_587.x, x_587.y, x_587.z));
  ...
  let x_600 : vec3<f32> = ((x_594 * vec3<f32>(x_595.x, x_595.y, x_595.z)) + vec3<f32>(x_598.x, x_598.y, x_598.z));
