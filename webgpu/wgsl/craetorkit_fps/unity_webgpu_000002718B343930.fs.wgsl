...
fn main_1() {
  ...
  u_xlat0 = ((x_467 * vec3<f32>(x_468, x_468, x_468)) + x_471);
  let x_475 : f32 = vs_TEXCOORD4;
  let x_477 : f32 = x_31.x_ProjectionParams.y;
  u_xlat18 = (x_475 / x_477);
  let x_479 : f32 = u_xlat18;
  u_xlat18 = (-(x_479) + 1.0f);
  let x_482 : f32 = u_xlat18;
  let x_484 : f32 = x_31.x_ProjectionParams.z;
  u_xlat18 = (x_482 * x_484);
  let x_486 : f32 = u_xlat18;
  u_xlat18 = max(x_486, 0.0f);
  let x_488 : f32 = u_xlat18;
  let x_491 : f32 = x_31.unity_FogParams.x;
  u_xlat18 = (x_488 * x_491);
  let x_493 : f32 = u_xlat18;
  let x_494 : f32 = u_xlat18;
  u_xlat18 = (x_493 * -(x_494));
  let x_497 : f32 = u_xlat18;
  u_xlat18 = exp2(x_497);
  let x_499 : vec3<f32> = u_xlat0;
  let x_502 : vec4<f32> = x_31.unity_FogColor;
  u_xlat0 = (x_499 + -(vec3<f32>(x_502.x, x_502.y, x_502.z)));
  let x_508 : f32 = u_xlat18;
  let x_510 : vec3<f32> = u_xlat0;
  let x_513 : vec4<f32> = x_31.unity_FogColor;
  let x_515 : vec3<f32> = ((vec3<f32>(x_508, x_508, x_508) * x_510) + vec3<f32>(x_513.x, x_513.y, x_513.z));
  let x_516 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_515.x, x_515.y, x_515.z, x_516.w);
  SV_Target0.w = 1.0f;
  return;
}
...
@fragment
fn main(@location(0) vs_TEXCOORD0_param : vec2<f32>, @location(3) vs_TEXCOORD2_param : vec3<f32>, @location(5) vs_TEXCOORD5_param : vec4<f32>, @location(2) vs_TEXCOORD1_param : vec3<f32>, @location(4) vs_TEXCOORD3_param : vec3<f32>, @location(1) vs_TEXCOORD4_param : f32, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
