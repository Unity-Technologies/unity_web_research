...
fn main_1() {
  ...
  let x_239 : f32 = in_TEXCOORD1.y;
  u_xlatb0 = (0.0f >= x_239);
  let x_241 : bool = u_xlatb0;
  u_xlat0.x = select(0.0f, 1.0f, x_241);
  let x_247 : f32 = x_18.x_WeightNormal;
  let x_251 : f32 = x_18.x_WeightBold;
  u_xlat2.x = (-(x_247) + x_251);
  let x_255 : f32 = u_xlat0.x;
  let x_257 : f32 = u_xlat2.x;
  let x_260 : f32 = x_18.x_WeightNormal;
  u_xlat0.x = ((x_255 * x_257) + x_260);
  let x_264 : f32 = u_xlat0.x;
  let x_269 : f32 = x_18.x_FaceDilate;
  u_xlat0.x = ((x_264 * 0.25f) + x_269);
  let x_273 : f32 = u_xlat0.x;
  let x_276 : f32 = x_18.x_ScaleRatioA;
  u_xlat0.x = (x_273 * x_276);
  let x_281 : f32 = u_xlat0.x;
  vs_TEXCOORD1.x = ((-(x_281) * 0.5f) + 0.5f);
  let x_289 : f32 = x_18.x_GradientScale;
  u_xlat0.x = (x_289 * 1.333299994f);
  let x_295 : f32 = x_18.x_Sharpness;
  u_xlat2.x = (x_295 + 1.0f);
  let x_299 : f32 = u_xlat2.x;
  let x_301 : f32 = u_xlat0.x;
  u_xlat0.x = (x_299 * x_301);
  let x_305 : f32 = u_xlat0.x;
  let x_308 : f32 = x_18.x_MainTex_TexelSize.w;
  vs_TEXCOORD1.y = (x_305 / x_308);
  let x_313 : f32 = x_18.x_OutlineWidth;
  let x_315 : f32 = x_18.x_ScaleRatioA;
  u_xlat0.x = (x_313 * x_315);
  let x_319 : f32 = u_xlat0.x;
  vs_TEXCOORD1.z = (x_319 * 0.5f);
  vs_TEXCOORD1.w = 0.0f;
  return;
}
