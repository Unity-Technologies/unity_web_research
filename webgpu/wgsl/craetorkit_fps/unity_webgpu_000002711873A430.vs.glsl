...
layout(location = 2) out highp float vs_TEXCOORD5;
...
float u_xlat15;
    ...
    u_xlat10.xy = in_TEXCOORD0.zz + vec2(-1.0, -0.300000012);
    u_xlat10.xy = u_xlat10.xy * vec2(-9.99999809, 50.0000496);
    u_xlat10.xy = clamp(u_xlat10.xy, 0.0, 1.0);
    u_xlat1.xz = u_xlat0.xy * u_xlat10.yy + in_POSITION0.xz;
    u_xlat0.y = (-u_xlat10.x) + in_TEXCOORD0.y;
    ...
    u_xlat5 = u_xlat0.w * 0.25 + u_xlat0.y;
    u_xlat1 = vec4(u_xlat5) * unity_ObjectToWorld[1];
