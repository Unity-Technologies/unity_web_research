...
fn main_1() {
  ...
  let x_605 : f32 = x_32.x_PostExposure;
  let x_607 : f32 = x_32.x_PostExposure;
  let x_609 : f32 = x_32.x_PostExposure;
  let x_611 : f32 = x_32.x_PostExposure;
  ...
  let x_656 : vec2<f32> = x_32.x_Lut3D_Params;
  ...
  let x_663 : f32 = x_32.x_Lut3D_Params.x;
  u_xlat16 = (x_663 * 0.5f);
  let x_665 : vec4<f32> = u_xlat1;
  let x_668 : vec2<f32> = x_32.x_Lut3D_Params;
  ...
  let x_693 : f32 = x_32.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_693);
