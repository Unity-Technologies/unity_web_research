...
fn main_1() {
  ...
  let x_583 : vec3<f32> = vs_TEXCOORD4;
...
@fragment
fn main(@location(0) vs_TEXCOORD0_param : vec4<f32>, @location(1) vs_TEXCOORD1_param : vec4<f32>, @location(2) vs_TEXCOORD2_param : vec4<f32>, @location(4) vs_TEXCOORD3_param : vec2<f32>, @location(3) vs_COLOR0_param : vec4<f32>, @location(7) vs_TEXCOORD6_param : vec4<f32>, @location(6) vs_TEXCOORD4_param : vec3<f32>, @location(5) vs_TEXCOORD5_param : f32, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
