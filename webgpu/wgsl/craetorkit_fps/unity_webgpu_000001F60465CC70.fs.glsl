...
layout(set = 0, binding = 2) uniform highp texture2D unity_NHxRoughness;
...
float u_xlat27;
    ...
    u_xlat3.x = texture(sampler2D(_OcclusionMap, sampler_OcclusionMap), vs_TEXCOORD0.xy).y;
    u_xlat4.xw = (-vec2(vec2(_Glossiness, _Glossiness))) + vec2(1.0, 1.0);
    u_xlat11.x = dot(vs_TEXCOORD1.xyz, u_xlat2.xyz);
    u_xlat11.x = u_xlat11.x + u_xlat11.x;
    u_xlat11.xyz = u_xlat2.xyz * (-u_xlat11.xxx) + vs_TEXCOORD1.xyz;
    u_xlat5.xyz = vec3(u_xlat26) * _LightColor0.xyz;
    u_xlat6.xyz = u_xlat3.xxx * vs_TEXCOORD5.xyz;
    u_xlat26 = (-u_xlat4.x) * 0.699999988 + 1.70000005;
    u_xlat26 = u_xlat26 * u_xlat4.x;
    u_xlat26 = u_xlat26 * 6.0;
    u_xlat7 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat11.xyz, u_xlat26);
    ...
    u_xlat11.xyz = u_xlat7.xyz * vec3(u_xlat26);
    ...
    u_xlat10.x = texture(sampler2D(unity_NHxRoughness, samplerunity_NHxRoughness), u_xlat4.yw).x;
    u_xlat10.x = u_xlat10.x * 16.0;
    u_xlat10.xyz = u_xlat10.xxx * u_xlat0.xyz + u_xlat9.xyz;
    ...
    u_xlat0.xyz = u_xlat6.xyz * u_xlat9.xyz + u_xlat0.xyz;
