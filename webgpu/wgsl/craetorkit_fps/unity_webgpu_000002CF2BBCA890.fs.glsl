...
layout(set = 0, binding = 13) uniform mediump  sampler sampler_AlbedoRamp1;
layout(set = 0, binding = 14) uniform mediump  sampler sampler_AlbedoRamp2;
layout(set = 0, binding = 15) uniform mediump  sampler sampler_VolumeNoise;
void main()
{
vec3 u_xlat0;
vec4 u_xlat1;
...
float u_xlat20;
    ...
    u_xlat1.x = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), u_xlat1.xx).x;
    u_xlat7.x = texture(samplerCube(_LightTexture0, sampler_LightTexture0), u_xlat4.xyz).w;
    u_xlat1.x = u_xlat7.x * u_xlat1.x;
