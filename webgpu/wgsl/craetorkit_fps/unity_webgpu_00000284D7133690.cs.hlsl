...
#line 31 "Packages/com.unity.postprocessing/PostProcessing/Shaders/Builtins/MultiScaleVODownsample2.compute"
...
#line 51
[ numthreads ( 8 , 8 , 1 ) ]
void MultiScaleVODownsample2_MSAA ( uint3 Gid : SV_GroupID , uint GI : SV_GroupIndex , uint3 GTid : SV_GroupThreadID , uint3 DTid : SV_DispatchThreadID )
{
