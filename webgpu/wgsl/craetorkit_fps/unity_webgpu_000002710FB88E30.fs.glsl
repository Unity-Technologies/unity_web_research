...
float u_xlat27;
    ...
    u_xlat27 = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), vec2(u_xlat27)).x;
    ...
    u_xlat5.xzw = vec3(u_xlat27) * u_xlat7.xyz;
    u_xlat6.xyz = vec3(u_xlat26) * _LightColor0.xyz;
    u_xlat3.xyz = u_xlat3.xyz * _Color.xyz + vec3(-0.0399999991, -0.0399999991, -0.0399999991);
    u_xlat3.xyz = vec3(u_xlat25) * u_xlat3.xyz + vec3(0.0399999991, 0.0399999991, 0.0399999991);
    u_xlat25 = (-u_xlat25) * 0.959999979 + 0.959999979;
