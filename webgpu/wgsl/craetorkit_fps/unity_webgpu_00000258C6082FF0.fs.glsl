...
layout(set = 0, binding = 7) uniform mediump  sampler sampler_NormalMap;
layout(set = 0, binding = 8) uniform mediump  sampler sampler_Specular;
layout(set = 0, binding = 9) uniform mediump  sampler sampler_DissolveNoise;
void main()
{
vec3 u_xlat0;
vec3 u_xlat1;
...
float u_xlat23;
    ...
    if(u_xlatb22){
        ...
        u_xlat6.x = max(u_xlat22, u_xlat2.x);
