...
int u_xlati22;
    ...
    if(u_xlatb21){
        ...
        u_xlat1.x = u_xlat21 * 0.0773993805;
        u_xlat8.x = u_xlat21 + 0.0549999997;
        u_xlat8.x = u_xlat8.x * 0.947867334;
        u_xlat8.x = max(abs(u_xlat8.x), 1.1920929e-07);
    ...
    u_xlat4.xyz = texture(sampler2D(_Lut2D, sampler_Lut2D), u_xlat1.xz).xyz;
    ...
    u_xlat7.xyz = (-u_xlat4.xyz) + u_xlat1.xyz;
