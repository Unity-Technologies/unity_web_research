...
fn main_1() {
  ...
  let x_269 : vec2<f32> = (vec2<f32>(x_264.y, x_264.y) * vec2<f32>(x_267.x, x_267.y));
  ...
  vs_TEXCOORD4 = ((vec2<f32>(x_297.x, x_297.y) * vec2<f32>(x_299.w, x_299.w)) + vec2<f32>(x_302.x, x_302.y));
