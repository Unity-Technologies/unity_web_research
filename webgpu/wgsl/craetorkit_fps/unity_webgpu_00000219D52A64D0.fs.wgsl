...
fn main_1() {
  ...
  let x_339 : vec3<f32> = (vec3<f32>(x_336.x, x_336.y, x_336.z) * x_338);
  let x_340 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_339.x, x_339.y, x_339.z, x_340.w);
  let x_343 : f32 = vs_TEXCOORD1.w;
  u_xlat18 = x_343;
  let x_344 : f32 = u_xlat18;
  u_xlat18 = clamp(x_344, 0.0f, 1.0f);
  ...
  SV_Target0 = vec4<f32>(x_352.x, x_352.y, x_352.z, x_353.w);
