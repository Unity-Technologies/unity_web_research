...
float u_xlat24;
    ...
    u_xlat5 = vs_TEXCOORD2.yyyy * unity_WorldToShadow[1 / 4][1 % 4];
    u_xlat5 = unity_WorldToShadow[0 / 4][0 % 4] * vs_TEXCOORD2.xxxx + u_xlat5;
    u_xlat5 = unity_WorldToShadow[2 / 4][2 % 4] * vs_TEXCOORD2.zzzz + u_xlat5;
    u_xlat5 = u_xlat5 + unity_WorldToShadow[3 / 4][3 % 4];
    u_xlat9.xyz = u_xlat5.xyz / u_xlat5.www;
    vec3 txVec0 = vec3(u_xlat9.xy,u_xlat9.z);
    u_xlat9.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec0, 0.0);
    ...
    u_xlat9.x = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat9.xy).w;
    u_xlat2.x = u_xlat9.x * u_xlat2.x;
    u_xlat9.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat9.x = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), u_xlat9.xx).x;
    u_xlat2.x = u_xlat9.x * u_xlat2.x;
