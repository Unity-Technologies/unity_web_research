...
fn main_1() {
  ...
  let x_339 : f32 = x_176.unity_ParticleUVShiftData.y;
  let x_342 : f32 = u_xlat1.x;
  u_xlat1.x = ((-(x_336) * x_339) + x_342);
  let x_346 : f32 = u_xlat1.x;
  u_xlat1.x = floor(x_346);
  let x_350 : f32 = u_xlat1.x;
  let x_352 : f32 = x_176.unity_ParticleUVShiftData.z;
  u_xlat1.x = (x_350 * x_352);
  let x_356 : f32 = x_176.unity_ParticleUVShiftData.w;
  u_xlat13 = (-(x_356) + 1.0f);
  ...
  let x_371 : vec4<f32> = x_176.unity_ParticleUVShiftData;
  ...
  let x_383 : f32 = x_176.unity_ParticleUVShiftData.x;
  ...
  let x_403 : vec4<f32> = x_176.x_MainTex_ST;
  let x_407 : vec4<f32> = x_176.x_MainTex_ST;
  vs_TEXCOORD1 = ((vec2<f32>(x_400.x, x_400.y) * vec2<f32>(x_403.x, x_403.y)) + vec2<f32>(x_407.z, x_407.w));
  let x_411 : f32 = u_xlat0.y;
  let x_413 : f32 = x_176.x_ProjectionParams.x;
