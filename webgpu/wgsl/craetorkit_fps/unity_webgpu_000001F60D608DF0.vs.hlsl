...
#line 32 "D:/src/unity_webgpu/Shaders/Includes/UnityStandardShadow.cginc"
float4 _Color ;
float _Cutoff ;
sampler2D _MainTex ;
float4 _MainTex_ST ;
...
#line 173
float outModifiedAlpha ;
PreMultiplyAlpha ( float3 ( 0 , 0 , 0 ) , alpha , MetallicSetup_ShadowGetOneMinusReflectivity ( i . tex ) , outModifiedAlpha ) ;
