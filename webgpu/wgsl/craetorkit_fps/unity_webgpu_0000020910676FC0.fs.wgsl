...
fn main_1() {
  ...
  let x_1210 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1214 : vec4<f32> = x_26.x_Dithering_Coords;
  ...
  let x_1226 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1224.x, x_1224.y));
  u_xlat1.x = x_1226.w;
  let x_1230 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1230 * 2.0f) + -1.0f);
  let x_1235 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1235 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1241 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1241, 0.0f, 1.0f);
  let x_1245 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1245 * 2.0f) + -1.0f);
  let x_1250 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1250)) + 1.0f);
  let x_1256 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1256);
  let x_1260 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1260) + 1.0f);
  let x_1265 : f32 = u_xlat1.x;
  let x_1267 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1265 * x_1267);
  let x_1270 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1270.x, x_1270.y, x_1270.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1275 : vec4<f32> = u_xlat0;
  let x_1280 : vec3<f32> = max(abs(vec3<f32>(x_1275.x, x_1275.y, x_1275.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1281 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1280.x, x_1280.y, x_1280.z, x_1281.w);
  let x_1283 : vec4<f32> = u_xlat2;
  let x_1285 : vec3<f32> = log2(vec3<f32>(x_1283.x, x_1283.y, x_1283.z));
  let x_1286 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1285.x, x_1285.y, x_1285.z, x_1286.w);
  let x_1288 : vec4<f32> = u_xlat2;
  let x_1292 : vec3<f32> = (vec3<f32>(x_1288.x, x_1288.y, x_1288.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1293 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1292.x, x_1292.y, x_1292.z, x_1293.w);
  let x_1295 : vec4<f32> = u_xlat2;
  let x_1297 : vec3<f32> = exp2(vec3<f32>(x_1295.x, x_1295.y, x_1295.z));
  let x_1298 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1297.x, x_1297.y, x_1297.z, x_1298.w);
  let x_1300 : vec4<f32> = u_xlat2;
  let x_1307 : vec3<f32> = ((vec3<f32>(x_1300.x, x_1300.y, x_1300.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1308 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1307.x, x_1307.y, x_1307.z, x_1308.w);
  let x_1315 : vec4<f32> = u_xlat0;
  let x_1318 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1315.x, x_1315.y, x_1315.z, x_1315.x));
  u_xlatb0 = vec3<bool>(x_1318.x, x_1318.y, x_1318.z);
  let x_1321 : bool = u_xlatb0.x;
  if (x_1321) {
    let x_1326 : f32 = u_xlat11.x;
    x_1322 = x_1326;
  } else {
    let x_1329 : f32 = u_xlat2.x;
    x_1322 = x_1329;
  }
  let x_1330 : f32 = x_1322;
  u_xlat0.x = x_1330;
  let x_1333 : bool = u_xlatb0.y;
  if (x_1333) {
    let x_1338 : f32 = u_xlat11.y;
    x_1334 = x_1338;
  } else {
    let x_1341 : f32 = u_xlat2.y;
    x_1334 = x_1341;
  }
  let x_1342 : f32 = x_1334;
  u_xlat0.y = x_1342;
  let x_1346 : bool = u_xlatb0.z;
  if (x_1346) {
  ...
  let x_1364 : vec3<f32> = ((vec3<f32>(x_1357.x, x_1357.x, x_1357.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1362.x, x_1362.y, x_1362.z));
  let x_1365 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1364.x, x_1364.y, x_1364.z, x_1365.w);
  let x_1367 : vec4<f32> = u_xlat0;
  let x_1371 : vec3<f32> = (vec3<f32>(x_1367.x, x_1367.y, x_1367.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1372 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1371.x, x_1371.y, x_1371.z, x_1372.w);
  let x_1374 : vec4<f32> = u_xlat0;
  let x_1378 : vec3<f32> = (vec3<f32>(x_1374.x, x_1374.y, x_1374.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1379 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1378.x, x_1378.y, x_1378.z, x_1379.w);
  let x_1381 : vec4<f32> = u_xlat2;
  let x_1385 : vec3<f32> = (vec3<f32>(x_1381.x, x_1381.y, x_1381.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1386 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1385.x, x_1385.y, x_1385.z, x_1386.w);
  let x_1388 : vec4<f32> = u_xlat2;
  let x_1391 : vec3<f32> = max(abs(vec3<f32>(x_1388.x, x_1388.y, x_1388.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1392 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1391.x, x_1391.y, x_1391.z, x_1392.w);
  let x_1394 : vec4<f32> = u_xlat2;
  let x_1396 : vec3<f32> = log2(vec3<f32>(x_1394.x, x_1394.y, x_1394.z));
  let x_1397 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1396.x, x_1396.y, x_1396.z, x_1397.w);
  let x_1399 : vec4<f32> = u_xlat2;
  let x_1403 : vec3<f32> = (vec3<f32>(x_1399.x, x_1399.y, x_1399.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1404 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1403.x, x_1403.y, x_1403.z, x_1404.w);
  let x_1406 : vec4<f32> = u_xlat2;
  let x_1408 : vec3<f32> = exp2(vec3<f32>(x_1406.x, x_1406.y, x_1406.z));
  let x_1409 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1408.x, x_1408.y, x_1408.z, x_1409.w);
  let x_1413 : vec4<f32> = u_xlat0;
  let x_1415 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1413.x, x_1413.y, x_1413.z, x_1413.x));
  u_xlatb0 = vec3<bool>(x_1415.x, x_1415.y, x_1415.z);
  let x_1420 : bool = u_xlatb0.x;
  if (x_1420) {
  ...
  SV_Target0.x = x_1429;
  let x_1433 : bool = u_xlatb0.y;
  if (x_1433) {
    let x_1438 : f32 = u_xlat1.y;
    x_1434 = x_1438;
  } else {
    let x_1441 : f32 = u_xlat2.y;
    x_1434 = x_1441;
  }
  let x_1442 : f32 = x_1434;
  SV_Target0.y = x_1442;
  let x_1445 : bool = u_xlatb0.z;
  if (x_1445) {
