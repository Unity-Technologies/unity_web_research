...
float u_xlat7;
bool u_xlatb7;
    u_xlat0 = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD2.xy);
    u_xlat1 = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD1.xy);
    u_xlat0 = u_xlat0 + (-u_xlat1);
    u_xlat0 = vs_TEXCOORD2.zzzz * u_xlat0 + u_xlat1;
    u_xlat0 = u_xlat0 * _Color;
    u_xlat1.xyz = u_xlat0.xyz * vs_COLOR0.xyz + (-unity_FogColor.xyz);
    u_xlat0 = u_xlat0 * vs_COLOR0;
    u_xlat7 = vs_TEXCOORD0;
    u_xlat7 = clamp(u_xlat7, 0.0, 1.0);
    u_xlat1.xyz = vec3(u_xlat7) * u_xlat1.xyz + unity_FogColor.xyz;
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat7);
    u_xlatb7 = _DstBlend==1;
    SV_Target0.xyz = (bool(u_xlatb7)) ? u_xlat0.xyz : u_xlat1.xyz;
