...
fn main_1() {
  ...
  u_xlat1 = ((x_105 * vec3<f32>(0.305306017f, 0.305306017f, 0.305306017f)) + vec3<f32>(0.682171106f, 0.682171106f, 0.682171106f));
  let x_112 : vec3<f32> = u_xlat0;
  let x_113 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_112 * x_113) + vec3<f32>(0.012522878f, 0.012522878f, 0.012522878f));
