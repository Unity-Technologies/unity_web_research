...
fn main_1() {
  ...
  let x_756 : vec2<f32> = vs_TEXCOORD1;
  let x_757 : vec4<f32> = textureSample(x_CameraDepthTexture, sampler_CameraDepthTexture, x_756);
  u_xlat16.x = x_757.x;
  let x_761 : f32 = u_xlat16.x;
  let x_763 : f32 = x_31.x_ZBufferParams.x;
  u_xlat16.x = (x_761 * x_763);
  let x_767 : f32 = x_31.unity_OrthoParams.w;
  let x_770 : f32 = u_xlat16.x;
  u_xlat24 = ((-(x_767) * x_770) + 1.0f);
  let x_773 : f32 = u_xlat8;
  let x_775 : f32 = u_xlat16.x;
  let x_778 : f32 = x_31.x_ZBufferParams.y;
  u_xlat8 = ((x_773 * x_775) + x_778);
  let x_780 : f32 = u_xlat24;
  let x_781 : f32 = u_xlat8;
  u_xlat8 = (x_780 / x_781);
  let x_783 : f32 = u_xlat8;
  let x_785 : f32 = x_31.x_ProjectionParams.z;
  let x_788 : f32 = x_31.x_ProjectionParams.y;
  u_xlat8 = ((x_783 * x_785) + -(x_788));
  let x_791 : f32 = u_xlat8;
  let x_794 : f32 = x_31.x_FogParams.x;
  u_xlat8 = (x_791 * x_794);
  ...
  u_xlat8 = exp2(x_800);
  let x_804 : f32 = u_xlat8;
  let x_806 : f32 = u_xlat0.x;
  SV_Target0.x = (x_804 * x_806);
  let x_810 : vec4<f32> = u_xlat1;
  let x_814 : vec3<f32> = ((vec3<f32>(x_810.x, x_810.y, x_810.z) * vec3<f32>(0.5f, 0.5f, 0.5f)) + vec3<f32>(0.5f, 0.5f, 0.5f));
  let x_815 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_815.x, x_814.x, x_814.y, x_814.z);
  return;
}
