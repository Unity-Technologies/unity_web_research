...
fn main_1() {
  ...
  u_xlat0 = (vec4<f32>(x_1445.w, x_1445.x, x_1445.y, x_1445.z) * vec4<f32>(x_1456.x, x_1456.y, x_1456.z, x_1456.w));
  let x_1463 : vec4<f32> = u_xlat0;
  u_xlat1 = ((vec3<f32>(x_1463.y, x_1463.z, x_1463.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1487 : vec2<f32> = x_26.x_Lut3D_Params;
  u_xlat1 = (x_1484 * vec3<f32>(x_1487.y, x_1487.y, x_1487.y));
  let x_1491 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat31 = (x_1491 * 0.5f);
  let x_1493 : vec3<f32> = u_xlat1;
  let x_1495 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1498 : f32 = u_xlat31;
  u_xlat1 = ((x_1493 * vec3<f32>(x_1495.x, x_1495.x, x_1495.x)) + vec3<f32>(x_1498, x_1498, x_1498));
  let x_1509 : vec3<f32> = u_xlat1;
  let x_1510 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, x_1509);
  let x_1511 : vec3<f32> = vec3<f32>(x_1510.x, x_1510.y, x_1510.z);
  let x_1512 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1512.x, x_1511.x, x_1511.y, x_1511.z);
  let x_1516 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1516);
  let x_1518 : bool = u_xlatb1;
  if (x_1518) {
    let x_1521 : vec4<f32> = u_xlat0;
    u_xlat1 = vec3<f32>(x_1521.y, x_1521.z, x_1521.w);
    let x_1523 : vec3<f32> = u_xlat1;
    u_xlat1 = clamp(x_1523, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1527 : vec3<f32> = u_xlat1;
    u_xlat0.x = dot(x_1527, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1532 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1532.y, x_1532.z, x_1532.w, x_1532.x);
  return;
}
