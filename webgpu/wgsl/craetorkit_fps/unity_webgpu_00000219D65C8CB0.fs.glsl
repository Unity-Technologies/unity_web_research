...
vec3 u_xlat2;
    ...
    u_xlat2.xyz = u_xlat2.xyz * vec3(_EmissionColor.x, _EmissionColor.y, _EmissionColor.z) + u_xlat1.xyz;
    SV_Target0.w = u_xlat1.w;
    u_xlat1.xyz = u_xlat2.xyz + (-unity_FogColor.xyz);
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat0);
    u_xlat1.xyz = vec3(u_xlat0) * u_xlat1.xyz + unity_FogColor.xyz;
    u_xlatb0 = _DstBlend==1;
    SV_Target0.xyz = (bool(u_xlatb0)) ? u_xlat2.xyz : u_xlat1.xyz;
    return;
}
