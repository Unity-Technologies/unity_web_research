...
fn main_1() {
  ...
  u_xlat9 = clamp(x_159, 0.0f, 1.0f);
  let x_161 : f32 = u_xlat9;
  let x_163 : vec3<f32> = u_xlat1;
  let x_166 : vec4<f32> = x_34.unity_FogColor;
  u_xlat1 = ((vec3<f32>(x_161, x_161, x_161) * x_163) + vec3<f32>(x_166.x, x_166.y, x_166.z));
  let x_169 : vec4<f32> = u_xlat0;
  let x_171 : f32 = u_xlat9;
  let x_173 : vec3<f32> = (vec3<f32>(x_169.x, x_169.y, x_169.z) * vec3<f32>(x_171, x_171, x_171));
  let x_174 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_173.x, x_173.y, x_173.z, x_174.w);
  let x_180 : i32 = x_34.x_DstBlend;
  u_xlatb9 = (x_180 == 1i);
  ...
  let x_191 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_190.x, x_190.y, x_190.z, x_191.w);
  return;
}
