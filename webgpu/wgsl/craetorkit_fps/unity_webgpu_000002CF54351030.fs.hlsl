...
#line 127 "D:/unity/fps_webgpu/Library/PackageCache/com.unity.postprocessing@3.2.2/PostProcessing/Shaders/Builtins/DiskKernels.hlsl"
...
#line 8 "D:/unity/fps_webgpu/Library/PackageCache/com.unity.postprocessing@3.2.2/PostProcessing/Shaders/Builtins/DepthOfField.hlsl"
...
Texture2D _CoCTex ; SamplerState sampler_CoCTex ;

Texture2D _DepthOfFieldTex ; SamplerState sampler_DepthOfFieldTex ;
...
{
float depth = LinearEyeDepth ( _CameraDepthTexture . Sample ( sampler_CameraDepthTexture , i . texcoordStereo ) . r ) ;
...
#line 51
half coc1 = _CoCTex . Sample ( sampler_CoCTex , UnityStereoTransformScreenSpaceTex ( i . texcoord - uvOffs . xz ) ) . r ;
half coc2 = _CoCTex . Sample ( sampler_CoCTex , UnityStereoTransformScreenSpaceTex ( i . texcoord - uvOffs . zy ) ) . r ;
half coc3 = _CoCTex . Sample ( sampler_CoCTex , UnityStereoTransformScreenSpaceTex ( i . texcoord + uvOffs . zy ) ) . r ;
half coc4 = _CoCTex . Sample ( sampler_CoCTex , UnityStereoTransformScreenSpaceTex ( i . texcoord + uvOffs . xz ) ) . r ;
#line 59
half coc0 = _CoCTex . Sample ( sampler_CoCTex , UnityStereoTransformScreenSpaceTex ( i . texcoord - _TaaParams . xy ) ) . r ;
#line 62
...
#line 69
float2 motion = _CameraMotionVectorsTexture . Sample ( sampler_CameraMotionVectorsTexture , UnityStereoTransformScreenSpaceTex ( i . texcoord + closest . xy ) ) . xy ;
half cocHis = _MainTex . Sample ( sampler_MainTex , UnityStereoTransformScreenSpaceTex ( i . texcoord - motion ) ) . r ;
#line 73
...
#line 112
half3 c0 = _MainTex . Sample ( sampler_MainTex , uv0 ) . rgb ;
half3 c1 = _MainTex . Sample ( sampler_MainTex , uv1 ) . rgb ;
half3 c2 = _MainTex . Sample ( sampler_MainTex , uv2 ) . rgb ;
half3 c3 = _MainTex . Sample ( sampler_MainTex , uv3 ) . rgb ;
#line 118
half coc0 = _CoCTex . Sample ( sampler_CoCTex , uv0 ) . r * 2.0 - 1.0 ;
half coc1 = _CoCTex . Sample ( sampler_CoCTex , uv1 ) . r * 2.0 - 1.0 ;
half coc2 = _CoCTex . Sample ( sampler_CoCTex , uv2 ) . r * 2.0 - 1.0 ;
half coc3 = _CoCTex . Sample ( sampler_CoCTex , uv3 ) . r * 2.0 - 1.0 ;
#line 126
...
{
half4 samp0 = _MainTex . Sample ( sampler_MainTex , i . texcoordStereo ) ;
...
half4 samp = _MainTex . Sample ( sampler_MainTex , UnityStereoTransformScreenSpaceTex ( i . texcoord + duv ) ) ;
#line 169
...
half4 acc ;
acc = _MainTex . Sample ( sampler_MainTex , UnityStereoTransformScreenSpaceTex ( i . texcoord - duv . xy ) ) ;
acc += _MainTex . Sample ( sampler_MainTex , UnityStereoTransformScreenSpaceTex ( i . texcoord - duv . zy ) ) ;
acc += _MainTex . Sample ( sampler_MainTex , UnityStereoTransformScreenSpaceTex ( i . texcoord + duv . zy ) ) ;
acc += _MainTex . Sample ( sampler_MainTex , UnityStereoTransformScreenSpaceTex ( i . texcoord + duv . xy ) ) ;
return acc / 4.0 ;
}
...
{
half4 dof = _DepthOfFieldTex . Sample ( sampler_DepthOfFieldTex , i . texcoordStereo ) ;
half coc = _CoCTex . Sample ( sampler_CoCTex , i . texcoordStereo ) . r ;
coc = ( coc - 0.5 ) * 2.0 * _MaxCoC ;
#line 225
float ffa = smoothstep ( _MainTex_TexelSize . y * 2.0 , _MainTex_TexelSize . y * 4.0 , coc ) ;

half4 color = _MainTex . Sample ( sampler_MainTex , i . texcoordStereo ) ;
#line 233
...
{
half3 color = _MainTex . Sample ( sampler_MainTex , i . texcoordStereo ) . rgb ;
#line 251
half4 src = _DepthOfFieldTex . Sample ( sampler_DepthOfFieldTex , i . texcoordStereo ) ;
float depth = LinearEyeDepth ( _CameraDepthTexture . Sample ( sampler_CameraDepthTexture , i . texcoordStereo ) . r ) ;
