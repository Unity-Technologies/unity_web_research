...
layout(set = 0, binding = 16) uniform mediump texture3D _DisplacementNoise;
layout(set = 0, binding = 17) uniform mediump texture2D _DisplacementRamp;
...
layout(set = 0, binding = 18) uniform mediump  sampler sampler_DisplacementNoise;
layout(set = 0, binding = 19) uniform mediump  sampler sampler_DisplacementRamp;
void main()
{
vec4 u_xlat0;
vec4 u_xlat1;
