...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_345.y, x_345.y, x_345.y, x_345.y) * x_349);
  let x_352 : vec4<f32> = x_18.unity_WorldToLight[0i];
  let x_353 : vec4<f32> = u_xlat0;
  let x_356 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_352 * vec4<f32>(x_353.x, x_353.x, x_353.x, x_353.x)) + x_356);
  ...
  let x_368 : vec4<f32> = x_18.unity_WorldToLight[3i];
  let x_369 : vec4<f32> = u_xlat0;
  let x_372 : vec4<f32> = u_xlat1;
  vs_TEXCOORD6 = ((x_368 * vec4<f32>(x_369.w, x_369.w, x_369.w, x_369.w)) + x_372);
