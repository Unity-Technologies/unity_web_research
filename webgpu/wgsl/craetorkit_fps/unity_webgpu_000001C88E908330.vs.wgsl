...
fn main_1() {
  ...
  let x_216 : f32 = x_41.unity_LightShadowBias.x;
  let x_219 : f32 = u_xlat0.w;
  u_xlat1.x = (x_216 / x_219);
  let x_223 : f32 = u_xlat1.x;
  u_xlat1.x = min(x_223, 0.0f);
  let x_227 : f32 = u_xlat1.x;
  u_xlat1.x = max(x_227, -1.0f);
  let x_233 : f32 = u_xlat0.z;
  let x_235 : f32 = u_xlat1.x;
  u_xlat6 = (x_233 + x_235);
  let x_238 : f32 = u_xlat0.w;
  let x_239 : f32 = u_xlat6;
  u_xlat1.x = min(x_238, x_239);
  let x_246 : vec4<f32> = u_xlat0;
  let x_247 : vec3<f32> = vec3<f32>(x_246.x, x_246.y, x_246.w);
  let x_249 : vec4<f32> = gl_Position;
  gl_Position = vec4<f32>(x_247.x, x_247.y, x_249.z, x_247.z);
  let x_251 : f32 = u_xlat6;
  let x_254 : f32 = u_xlat1.x;
  u_xlat0.x = (-(x_251) + x_254);
  let x_258 : f32 = x_41.unity_LightShadowBias.y;
  let x_260 : f32 = u_xlat0.x;
  let x_262 : f32 = u_xlat6;
  gl_Position.z = ((x_258 * x_260) + x_262);
  return;
}
