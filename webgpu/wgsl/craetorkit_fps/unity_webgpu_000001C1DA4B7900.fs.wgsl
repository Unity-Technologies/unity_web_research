...
fn main_1() {
  ...
  u_xlat0 = (vec4<f32>(x_1583.w, x_1583.x, x_1583.y, x_1583.z) * vec4<f32>(x_1594.x, x_1594.y, x_1594.z, x_1594.w));
  let x_1601 : vec4<f32> = u_xlat0;
  u_xlat1 = ((vec3<f32>(x_1601.y, x_1601.z, x_1601.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1609 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1609);
  let x_1611 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1611 * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1618 : vec3<f32> = u_xlat1;
  u_xlat1 = clamp(x_1618, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1622 : vec3<f32> = u_xlat1;
  let x_1625 : vec2<f32> = x_26.x_Lut3D_Params;
  u_xlat1 = (x_1622 * vec3<f32>(x_1625.y, x_1625.y, x_1625.y));
  let x_1629 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat31 = (x_1629 * 0.5f);
  let x_1631 : vec3<f32> = u_xlat1;
  let x_1633 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1636 : f32 = u_xlat31;
  u_xlat1 = ((x_1631 * vec3<f32>(x_1633.x, x_1633.x, x_1633.x)) + vec3<f32>(x_1636, x_1636, x_1636));
  let x_1647 : vec3<f32> = u_xlat1;
  let x_1648 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, x_1647);
  let x_1649 : vec3<f32> = vec3<f32>(x_1648.x, x_1648.y, x_1648.z);
  let x_1650 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1650.x, x_1649.x, x_1649.y, x_1649.z);
  let x_1654 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1654);
  let x_1656 : bool = u_xlatb1;
  if (x_1656) {
    let x_1659 : vec4<f32> = u_xlat0;
    u_xlat1 = vec3<f32>(x_1659.y, x_1659.z, x_1659.w);
    let x_1661 : vec3<f32> = u_xlat1;
    u_xlat1 = clamp(x_1661, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1665 : vec3<f32> = u_xlat1;
    u_xlat0.x = dot(x_1665, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1670 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1670.y, x_1670.z, x_1670.w, x_1670.x);
  return;
}
