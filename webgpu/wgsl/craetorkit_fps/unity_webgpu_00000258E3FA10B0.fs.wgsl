...
fn main_1() {
  ...
  u_xlat0 = (vec4<f32>(x_351.w, x_351.x, x_351.y, x_351.z) + vec4<f32>(x_353.w, x_353.x, x_353.y, x_353.z));
  let x_362 : f32 = x_49.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_362);
  let x_364 : bool = u_xlatb1;
  if (x_364) {
    let x_367 : vec4<f32> = u_xlat0;
    let x_368 : vec3<f32> = vec3<f32>(x_367.y, x_367.z, x_367.w);
    ...
    u_xlat0.x = dot(vec3<f32>(x_378.x, x_378.y, x_378.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_388 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_388.y, x_388.z, x_388.w, x_388.x);
  return;
}
