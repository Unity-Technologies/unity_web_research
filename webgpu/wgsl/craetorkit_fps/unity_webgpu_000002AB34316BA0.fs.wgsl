...
fn main_1() {
  ...
  u_xlat0 = ((vec3<f32>(x_1255.x, x_1255.y, x_1255.z) * x_1257) + x_1259);
  let x_1266 : vec4<f32> = vs_TEXCOORD0;
  let x_1268 : vec4<f32> = textureSample(x_EmissionMap, sampler_EmissionMap, vec2<f32>(x_1266.x, x_1266.y));
  u_xlat1 = vec3<f32>(x_1268.x, x_1268.y, x_1268.z);
  let x_1272 : vec3<f32> = u_xlat1;
  let x_1275 : vec4<f32> = x_33.x_EmissionColor;
  let x_1278 : vec3<f32> = u_xlat0;
  let x_1279 : vec3<f32> = ((x_1272 * vec3<f32>(x_1275.x, x_1275.y, x_1275.z)) + x_1278);
