...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_260.y, x_260.y, x_260.y, x_260.y) * x_263);
  let x_266 : vec4<f32> = x_131.unity_WorldToLight[0i];
  let x_267 : vec4<f32> = u_xlat0;
  let x_270 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_266 * vec4<f32>(x_267.x, x_267.x, x_267.x, x_267.x)) + x_270);
  let x_273 : vec4<f32> = x_131.unity_WorldToLight[2i];
  let x_274 : vec4<f32> = u_xlat0;
  let x_277 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_273 * vec4<f32>(x_274.z, x_274.z, x_274.z, x_274.z)) + x_277);
  let x_282 : vec4<f32> = x_131.unity_WorldToLight[3i];
  let x_283 : vec4<f32> = u_xlat0;
  let x_286 : vec4<f32> = u_xlat1;
  vs_TEXCOORD4 = ((x_282 * vec4<f32>(x_283.w, x_283.w, x_283.w, x_283.w)) + x_286);
