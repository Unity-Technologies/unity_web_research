...
float u_xlat24;
    ...
    u_xlatu2.z = floatBitsToUint(u_xlat2.w) >> (24u & uint(0x1F));
    ...
    u_xlat14 = u_xlat8.y * u_xlat8.y;
    u_xlat14 = u_xlat8.x * u_xlat8.x + (-u_xlat14);
    u_xlat1 = u_xlat8.yzzx * u_xlat8.xyzz;
    u_xlat2.x = dot(unity_SHBr, u_xlat1);
    u_xlat2.y = dot(unity_SHBg, u_xlat1);
    u_xlat2.z = dot(unity_SHBb, u_xlat1);
    vs_TEXCOORD3.xyz = unity_SHC.xyz * vec3(u_xlat14) + u_xlat2.xyz;
