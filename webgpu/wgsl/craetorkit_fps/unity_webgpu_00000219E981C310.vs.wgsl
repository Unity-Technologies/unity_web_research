...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_264.y, x_264.y, x_264.y, x_264.y) * x_267);
  let x_270 : vec4<f32> = x_131.unity_WorldToLight[0i];
  let x_271 : vec4<f32> = u_xlat0;
  let x_274 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_270 * vec4<f32>(x_271.x, x_271.x, x_271.x, x_271.x)) + x_274);
  let x_277 : vec4<f32> = x_131.unity_WorldToLight[2i];
  let x_278 : vec4<f32> = u_xlat0;
  let x_281 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_277 * vec4<f32>(x_278.z, x_278.z, x_278.z, x_278.z)) + x_281);
  let x_286 : vec4<f32> = x_131.unity_WorldToLight[3i];
  let x_287 : vec4<f32> = u_xlat0;
  let x_290 : vec4<f32> = u_xlat1;
  vs_TEXCOORD4 = ((x_286 * vec4<f32>(x_287.w, x_287.w, x_287.w, x_287.w)) + x_290);
