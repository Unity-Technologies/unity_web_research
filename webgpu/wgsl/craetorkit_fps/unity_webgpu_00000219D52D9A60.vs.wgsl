...
fn main_1() {
  ...
  let x_376 : vec2<f32> = (vec2<f32>(x_370.y, x_370.y) * vec2<f32>(x_374.x, x_374.y));
  ...
  vs_TEXCOORD6 = ((vec2<f32>(x_404.x, x_404.y) * vec2<f32>(x_406.w, x_406.w)) + vec2<f32>(x_409.x, x_409.y));
