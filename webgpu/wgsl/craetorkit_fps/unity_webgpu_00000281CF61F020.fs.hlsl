#line 1 "Hidden/PostProcessing/FinalPass"
static const int FXAA_LOW = 0 ;
static const int FXAA_NO_ALPHA = 0 ;
static const int STEREO_DOUBLEWIDE_TARGET = 0 ;
...
#line 4 "D:/unity/fps_webgpu/Library/PackageCache/com.unity.postprocessing@3.2.2/PostProcessing/Shaders/Builtins/Dithering.hlsl"
...
#line 690 "D:/unity/fps_webgpu/Library/PackageCache/com.unity.postprocessing@3.2.2/PostProcessing/Shaders/Builtins/FastApproximateAntialiasing.hlsl"
...
posM . y = pos . y ;
#line 914
float4 rgbyM = tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 ) ;
#line 920
float lumaS = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 , int2 ( 0 , 1 ) ) ) ;
float lumaE = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 , int2 ( 1 , 0 ) ) ) ;
float lumaN = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 , int2 ( 0 , - 1 ) ) ) ;
float lumaW = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 , int2 ( - 1 , 0 ) ) ) ;
#line 926
...
return rgbyM ;
#line 947
float lumaNW = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 , int2 ( - 1 , - 1 ) ) ) ;
float lumaSE = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 , int2 ( 1 , 1 ) ) ) ;
float lumaNE = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 , int2 ( 1 , - 1 ) ) ) ;
float lumaSW = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 , int2 ( - 1 , 1 ) ) ) ;
#line 956
...
float lumaEndN = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posN ) , 0.0 ) ) ;
float subpixE = subpixC * subpixC ;
float lumaEndP = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posP ) , 0.0 ) ) ;
...
if ( doneNP )
{
if ( ! doneN ) lumaEndN = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posN . xy ) , 0.0 ) ) ;
if ( ! doneP ) lumaEndP = FxaaLuma ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posP . xy ) , 0.0 ) ) ;
...
#line 1252
return float4 ( tex . tex . SampleLevel ( tex . smpl , UnityStereoTransformScreenSpaceTex ( posM ) , 0.0 ) . xyz , rgbyM . y ) ;
...
#line 79
{
color . a = _MainTex . Sample ( sampler_MainTex , i . texcoordStereo ) . a ;
}
