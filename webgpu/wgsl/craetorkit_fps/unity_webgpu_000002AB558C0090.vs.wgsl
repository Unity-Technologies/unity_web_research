...
fn main_1() {
  ...
  vs_TEXCOORD0 = ((x_89 * vec2<f32>(x_92.x, x_92.y)) + vec2<f32>(x_96.z, x_96.w));
  ...
  vs_TEXCOORD2 = vec4<f32>(x_166.x, x_166.y, x_167.z, x_167.w);
  return;
}
