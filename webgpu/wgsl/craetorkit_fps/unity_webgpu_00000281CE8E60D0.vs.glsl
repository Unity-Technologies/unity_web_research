...
float u_xlat25;
    ...
    u_xlati8 = u_xlati0 << (3 & int(0x1F));
    u_xlati0 = u_xlati0 * 7;
    u_xlat1 = in_POSITION0.yyyy * unity_Builtins0Array[u_xlati8 / 8].unity_ObjectToWorldArray[1];
    u_xlat1 = unity_Builtins0Array[u_xlati8 / 8].unity_ObjectToWorldArray[0] * in_POSITION0.xxxx + u_xlat1;
    u_xlat1 = unity_Builtins0Array[u_xlati8 / 8].unity_ObjectToWorldArray[2] * in_POSITION0.zzzz + u_xlat1;
    u_xlat2 = u_xlat1 + unity_Builtins0Array[u_xlati8 / 8].unity_ObjectToWorldArray[3];
    u_xlat1.xyz = unity_Builtins0Array[u_xlati8 / 8].unity_ObjectToWorldArray[3].xyz * in_POSITION0.www + u_xlat1.xyz;
    ...
    u_xlat4.xyz = in_TANGENT0.yyy * unity_Builtins0Array[u_xlati8 / 8].unity_ObjectToWorldArray[1].yzx;
    u_xlat4.xyz = unity_Builtins0Array[u_xlati8 / 8].unity_ObjectToWorldArray[0].yzx * in_TANGENT0.xxx + u_xlat4.xyz;
    u_xlat4.xyz = unity_Builtins0Array[u_xlati8 / 8].unity_ObjectToWorldArray[2].yzx * in_TANGENT0.zzz + u_xlat4.xyz;
    u_xlat16 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat16 = inversesqrt(u_xlat16);
    u_xlat4.xyz = vec3(u_xlat16) * u_xlat4.xyz;
    u_xlat5.x = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati8 / 8].unity_WorldToObjectArray[0].xyz);
    u_xlat5.y = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati8 / 8].unity_WorldToObjectArray[1].xyz);
    u_xlat5.z = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati8 / 8].unity_WorldToObjectArray[2].xyz);
    u_xlat8.x = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat8.x = inversesqrt(u_xlat8.x);
    u_xlat5 = u_xlat8.xxxx * u_xlat5.xyzz;
    u_xlat8.xyz = u_xlat4.xyz * u_xlat5.wxy;
    u_xlat8.xyz = u_xlat5.ywx * u_xlat4.yzx + (-u_xlat8.xyz);
    ...
    vs_TEXCOORD3.z = u_xlat5.w;
    vs_COLOR0 = in_COLOR0;
    u_xlat8.x = u_xlat2.y * unity_MatrixV[1].z;
    u_xlat8.x = unity_MatrixV[0].z * u_xlat2.x + u_xlat8.x;
    u_xlat8.x = unity_MatrixV[2].z * u_xlat2.z + u_xlat8.x;
    u_xlat8.x = unity_MatrixV[3].z * u_xlat2.w + u_xlat8.x;
    vs_TEXCOORD4.z = (-u_xlat8.x);
    u_xlat8.xyz = u_xlat2.yyy * unity_MatrixVP[1].xyw;
    u_xlat8.xyz = unity_MatrixVP[0].xyw * u_xlat2.xxx + u_xlat8.xyz;
    u_xlat8.xyz = unity_MatrixVP[2].xyw * u_xlat2.zzz + u_xlat8.xyz;
    u_xlat8.xyz = unity_MatrixVP[3].xyw * u_xlat2.www + u_xlat8.xyz;
    vs_TEXCOORD4.w = u_xlat8.z;
    u_xlat2.x = float(0.5);
    u_xlat2.z = float(0.5);
    u_xlat2.y = _ProjectionParams.x;
    u_xlat4.xyz = u_xlat8.xyz * u_xlat2.xyz;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat3.xyw;
    u_xlat4.w = u_xlat4.y * 0.5;
    vs_TEXCOORD4.xy = u_xlat4.zz + u_xlat4.xw;
    u_xlat8.x = u_xlat5.y * u_xlat5.y;
    u_xlat8.x = u_xlat5.x * u_xlat5.x + (-u_xlat8.x);
    u_xlat4 = u_xlat5.ywzx * u_xlat5;
    u_xlat6.x = dot(unity_Builtins2Array[u_xlati0 / 7].unity_SHBrArray, u_xlat4);
    u_xlat6.y = dot(unity_Builtins2Array[u_xlati0 / 7].unity_SHBgArray, u_xlat4);
    u_xlat6.z = dot(unity_Builtins2Array[u_xlati0 / 7].unity_SHBbArray, u_xlat4);
    u_xlat0.xyz = unity_Builtins2Array[u_xlati0 / 7].unity_SHCArray.xyz * u_xlat8.xxx + u_xlat6.xyz;
    ...
    u_xlat5 = u_xlat1 * u_xlat5.wwzw + u_xlat6;
    u_xlat4 = u_xlat7 * u_xlat7 + u_xlat4;
