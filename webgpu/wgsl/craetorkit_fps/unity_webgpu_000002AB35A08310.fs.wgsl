...
fn main_1() {
  ...
  u_xlat0 = (x_111 * x_112);
  let x_117 : f32 = u_xlat0.w;
  SV_Target0.w = x_117;
  let x_121 : f32 = SV_Target0.w;
  SV_Target0.w = clamp(x_121, 0.0f, 1.0f);
  let x_124 : vec4<f32> = u_xlat0;
  let x_125 : vec3<f32> = vec3<f32>(x_124.x, x_124.y, x_124.z);
  let x_126 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_125.x, x_125.y, x_125.z, x_126.w);
  return;
}
