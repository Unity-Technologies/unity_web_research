...
fn main_1() {
  ...
  let x_1231 : vec3<f32> = ((vec3<f32>(x_1224.z, x_1224.x, x_1224.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1260 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1262 : vec3<f32> = (vec3<f32>(x_1256.x, x_1256.y, x_1256.z) * vec3<f32>(x_1260.z, x_1260.z, x_1260.z));
  let x_1263 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1262.x, x_1262.y, x_1262.z, x_1263.w);
  let x_1267 : f32 = u_xlat1.x;
  u_xlat10 = floor(x_1267);
  let x_1270 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1272 : vec2<f32> = (vec2<f32>(x_1270.x, x_1270.y) * vec2<f32>(0.5f, 0.5f));
  let x_1273 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1272.x, x_1273.y, x_1273.z, x_1272.y);
  let x_1275 : vec4<f32> = u_xlat1;
  let x_1278 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1281 : vec4<f32> = u_xlat1;
  let x_1283 : vec2<f32> = ((vec2<f32>(x_1275.y, x_1275.z) * vec2<f32>(x_1278.x, x_1278.y)) + vec2<f32>(x_1281.x, x_1281.w));
  let x_1284 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1284.x, x_1283.x, x_1283.y, x_1284.w);
  let x_1286 : f32 = u_xlat10;
  let x_1288 : f32 = x_26.x_Lut2D_Params.y;
  let x_1291 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1286 * x_1288) + x_1291);
  ...
  let x_1313 : vec2<f32> = (vec2<f32>(x_1309.x, x_1309.z) + vec2<f32>(x_1311.x, x_1311.y));
  let x_1314 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1313.x, x_1313.y, x_1314.z, x_1314.w);
  let x_1319 : vec4<f32> = u_xlat1;
  let x_1321 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1319.x, x_1319.y));
  let x_1322 : vec3<f32> = vec3<f32>(x_1321.x, x_1321.y, x_1321.z);
  let x_1323 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1322.x, x_1322.y, x_1322.z, x_1323.w);
  let x_1326 : f32 = u_xlat0.x;
  let x_1329 : f32 = x_26.x_Lut2D_Params.z;
  let x_1331 : f32 = u_xlat10;
  u_xlat0.x = ((x_1326 * x_1329) + -(x_1331));
  let x_1335 : vec4<f32> = u_xlat2;
  let x_1338 : vec4<f32> = u_xlat1;
  let x_1340 : vec3<f32> = (-(vec3<f32>(x_1335.x, x_1335.y, x_1335.z)) + vec3<f32>(x_1338.x, x_1338.y, x_1338.z));
  ...
  let x_1350 : vec3<f32> = ((vec3<f32>(x_1343.x, x_1343.x, x_1343.x) * vec3<f32>(x_1345.x, x_1345.y, x_1345.z)) + vec3<f32>(x_1348.x, x_1348.y, x_1348.z));
  let x_1351 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1350.x, x_1350.y, x_1350.z, x_1351.w);
  let x_1353 : vec2<f32> = vs_TEXCOORD0;
  let x_1356 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1360 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1362 : vec2<f32> = ((x_1353 * vec2<f32>(x_1356.x, x_1356.y)) + vec2<f32>(x_1360.z, x_1360.w));
  let x_1363 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1362.x, x_1362.y, x_1363.z, x_1363.w);
  let x_1370 : vec4<f32> = u_xlat1;
  let x_1372 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1370.x, x_1370.y));
  u_xlat1.x = x_1372.w;
  let x_1376 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1376 * 2.0f) + -1.0f);
  let x_1381 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1381 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1387 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1387, 0.0f, 1.0f);
  let x_1391 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1391 * 2.0f) + -1.0f);
  let x_1396 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1396)) + 1.0f);
  let x_1402 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1402);
  let x_1406 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1406) + 1.0f);
  let x_1411 : f32 = u_xlat1.x;
  let x_1413 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1411 * x_1413);
  let x_1416 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1416.x, x_1416.y, x_1416.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1421 : vec4<f32> = u_xlat0;
  let x_1426 : vec3<f32> = max(abs(vec3<f32>(x_1421.x, x_1421.y, x_1421.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1427 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1426.x, x_1426.y, x_1426.z, x_1427.w);
  let x_1429 : vec4<f32> = u_xlat2;
  let x_1431 : vec3<f32> = log2(vec3<f32>(x_1429.x, x_1429.y, x_1429.z));
  let x_1432 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1431.x, x_1431.y, x_1431.z, x_1432.w);
  let x_1434 : vec4<f32> = u_xlat2;
  let x_1438 : vec3<f32> = (vec3<f32>(x_1434.x, x_1434.y, x_1434.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1439 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1438.x, x_1438.y, x_1438.z, x_1439.w);
  let x_1441 : vec4<f32> = u_xlat2;
  let x_1443 : vec3<f32> = exp2(vec3<f32>(x_1441.x, x_1441.y, x_1441.z));
  let x_1444 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1443.x, x_1443.y, x_1443.z, x_1444.w);
  let x_1446 : vec4<f32> = u_xlat2;
  let x_1453 : vec3<f32> = ((vec3<f32>(x_1446.x, x_1446.y, x_1446.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1454 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1453.x, x_1453.y, x_1453.z, x_1454.w);
  let x_1461 : vec4<f32> = u_xlat0;
  let x_1464 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1461.x, x_1461.y, x_1461.z, x_1461.x));
  ...
  let x_1509 : vec3<f32> = ((vec3<f32>(x_1502.x, x_1502.x, x_1502.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1507.x, x_1507.y, x_1507.z));
  let x_1510 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1509.x, x_1509.y, x_1509.z, x_1510.w);
  let x_1512 : vec4<f32> = u_xlat0;
  let x_1516 : vec3<f32> = (vec3<f32>(x_1512.x, x_1512.y, x_1512.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1517 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1516.x, x_1516.y, x_1516.z, x_1517.w);
  let x_1519 : vec4<f32> = u_xlat0;
  let x_1523 : vec3<f32> = (vec3<f32>(x_1519.x, x_1519.y, x_1519.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1524 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1523.x, x_1523.y, x_1523.z, x_1524.w);
  let x_1526 : vec4<f32> = u_xlat2;
  let x_1530 : vec3<f32> = (vec3<f32>(x_1526.x, x_1526.y, x_1526.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1548 : vec3<f32> = (vec3<f32>(x_1544.x, x_1544.y, x_1544.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1549 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1548.x, x_1548.y, x_1548.z, x_1549.w);
  let x_1551 : vec4<f32> = u_xlat2;
  let x_1553 : vec3<f32> = exp2(vec3<f32>(x_1551.x, x_1551.y, x_1551.z));
  let x_1554 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1553.x, x_1553.y, x_1553.z, x_1554.w);
  let x_1558 : vec4<f32> = u_xlat0;
  let x_1560 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1558.x, x_1558.y, x_1558.z, x_1558.x));
  u_xlatb0 = vec3<bool>(x_1560.x, x_1560.y, x_1560.z);
  let x_1565 : bool = u_xlatb0.x;
  if (x_1565) {
  ...
  SV_Target0.x = x_1574;
  let x_1578 : bool = u_xlatb0.y;
  if (x_1578) {
    let x_1583 : f32 = u_xlat1.y;
    x_1579 = x_1583;
  } else {
    let x_1586 : f32 = u_xlat2.y;
    x_1579 = x_1586;
  }
  let x_1587 : f32 = x_1579;
  SV_Target0.y = x_1587;
  let x_1590 : bool = u_xlatb0.z;
  if (x_1590) {
    let x_1595 : f32 = u_xlat1.z;
    x_1591 = x_1595;
  } else {
