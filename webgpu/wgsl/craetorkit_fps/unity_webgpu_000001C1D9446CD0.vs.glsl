...
layout(location = 2) out highp float vs_TEXCOORD8;
...
float u_xlat17;
    ...
    vs_COLOR0 = in_COLOR0;
    u_xlat2.x = u_xlat1.y * unity_MatrixV[1].z;
    u_xlat2.x = unity_MatrixV[0].z * u_xlat1.x + u_xlat2.x;
    u_xlat2.x = unity_MatrixV[2].z * u_xlat1.z + u_xlat2.x;
    u_xlat2.x = unity_MatrixV[3].z * u_xlat1.w + u_xlat2.x;
