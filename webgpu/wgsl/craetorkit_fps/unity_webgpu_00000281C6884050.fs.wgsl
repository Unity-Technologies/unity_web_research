...
fn main_1() {
  ...
  let x_1121 : vec2<f32> = vs_TEXCOORD1;
  let x_1124 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1128 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1130 : vec2<f32> = ((x_1121 * vec2<f32>(x_1124.x, x_1124.y)) + vec2<f32>(x_1128.z, x_1128.w));
  let x_1131 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1130.x, x_1130.y, x_1131.z, x_1131.w);
  let x_1138 : vec4<f32> = u_xlat1;
  let x_1140 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1138.x, x_1138.y));
  let x_1141 : vec3<f32> = vec3<f32>(x_1140.x, x_1140.y, x_1140.z);
  let x_1142 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1141.x, x_1141.y, x_1141.z, x_1142.w);
  let x_1144 : vec4<f32> = u_xlat0;
  let x_1145 : vec3<f32> = vec3<f32>(x_1144.x, x_1144.y, x_1144.z);
  let x_1146 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1145.x, x_1145.y, x_1145.z, x_1146.w);
  let x_1148 : vec4<f32> = u_xlat2;
  let x_1152 : vec3<f32> = clamp(vec3<f32>(x_1148.x, x_1148.y, x_1148.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1153 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1152.x, x_1152.y, x_1152.z, x_1153.w);
  let x_1155 : vec4<f32> = u_xlat2;
  u_xlat31 = dot(vec3<f32>(x_1155.x, x_1155.y, x_1155.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1162 : f32 = u_xlat31;
  u_xlat31 = sqrt(x_1162);
  let x_1166 : f32 = x_26.x_Grain_Params1.x;
  ...
  u_xlat1 = vec4<f32>(x_1175.x, x_1175.y, x_1175.z, x_1176.w);
  let x_1178 : vec4<f32> = u_xlat1;
  let x_1181 : f32 = x_26.x_Grain_Params1.y;
  let x_1183 : f32 = x_26.x_Grain_Params1.y;
  let x_1185 : f32 = x_26.x_Grain_Params1.y;
  let x_1187 : vec3<f32> = (vec3<f32>(x_1178.x, x_1178.y, x_1178.z) * vec3<f32>(x_1181, x_1183, x_1185));
  ...
  let x_1197 : vec3<f32> = ((vec3<f32>(x_1190.x, x_1190.y, x_1190.z) * vec3<f32>(x_1192, x_1192, x_1192)) + vec3<f32>(x_1195.x, x_1195.y, x_1195.z));
  let x_1198 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1197.x, x_1197.y, x_1197.z, x_1198.w);
  let x_1202 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1202);
  let x_1204 : bool = u_xlatb1;
  if (x_1204) {
    let x_1207 : vec4<f32> = u_xlat0;
    let x_1208 : vec3<f32> = vec3<f32>(x_1207.x, x_1207.y, x_1207.z);
    let x_1209 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1208.x, x_1208.y, x_1208.z, x_1209.w);
    let x_1211 : vec4<f32> = u_xlat1;
    let x_1215 : vec3<f32> = clamp(vec3<f32>(x_1211.x, x_1211.y, x_1211.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1216 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1215.x, x_1215.y, x_1215.z, x_1216.w);
    let x_1218 : vec4<f32> = u_xlat1;
    u_xlat0.w = dot(vec3<f32>(x_1218.x, x_1218.y, x_1218.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
