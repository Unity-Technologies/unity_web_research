...
#line 17 "D:/src/unity_webgpu/Shaders/Includes/UnityStandardParticleEditor.cginc"
sampler2D _MainTex ;
float4 _MainTex_ST ;
...
float4 fragSceneHighlightPass ( VertexOutput i ) : COLOR
{
fragSceneClip ( i ) ;
return float4 ( _ObjectId , _PassValue , 1 , 1 ) ;
}

float4 fragScenePickingPass ( VertexOutput i ) : COLOR
{
fragSceneClip ( i ) ;
return _SelectionID ;
}
