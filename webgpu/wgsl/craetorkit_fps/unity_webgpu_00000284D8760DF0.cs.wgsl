...
fn main_1() {
  ...
  u_xlat0.x = (-(x_1284) + 1.0f);
  let x_1292 : vec4<i32> = u_xlati4;
  let x_1294 : vec4<f32> = u_xlat0;
  textureStore(AoResult_origX0X, vec2<i32>(x_1292.x, x_1292.y), vec4<f32>(x_1294.x, x_1294.x, x_1294.x, x_1294.x));
  let x_1296 : vec4<f32> = u_xlat3;
  let x_1299 : vec4<f32> = u_xlat0;
  u_xlat5 = (-(vec4<f32>(x_1296.y, x_1296.z, x_1296.w, x_1296.x)) + vec4<f32>(x_1299.y, x_1299.y, x_1299.y, x_1299.y));
  let x_1302 : vec4<f32> = u_xlat5;
  let x_1305 : vec4<f32> = x_65.AdditionalParams;
  u_xlat5 = (abs(x_1302) + vec4<f32>(x_1305.w, x_1305.w, x_1305.w, x_1305.w));
  let x_1308 : vec4<f32> = u_xlat5;
  u_xlat5 = (vec4<f32>(9.0f, 3.0f, 1.0f, 3.0f) / x_1308);
  let x_1310 : vec4<f32> = u_xlat5;
  u_xlat0.x = dot(x_1310, vec4<f32>(1.0f, 1.0f, 1.0f, 1.0f));
  let x_1313 : vec4<f32> = u_xlat1;
  let x_1315 : vec4<f32> = u_xlat5;
  u_xlat0.y = dot(vec4<f32>(x_1313.z, x_1313.w, x_1313.x, x_1313.y), x_1315);
  let x_1318 : vec4<f32> = u_xlat0;
  let x_1321 : vec4<f32> = x_65.AdditionalParams;
  let x_1323 : vec2<f32> = (vec2<f32>(x_1318.x, x_1318.y) + vec2<f32>(x_1321.x, x_1321.x));
  let x_1324 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1323.x, x_1323.y, x_1324.z, x_1324.w);
  let x_1327 : f32 = u_xlat0.y;
  let x_1329 : f32 = u_xlat0.x;
  u_xlat0.x = (x_1327 / x_1329);
  let x_1333 : f32 = u_xlat0.x;
  u_xlat0.x = (-(x_1333) + 1.0f);
  ...
  u_xlat0.x = (-(x_1380) + 1.0f);
  let x_1385 : vec4<i32> = u_xlati4;
  let x_1387 : vec4<f32> = u_xlat0;
  textureStore(AoResult_origX0X, vec2<i32>(x_1385.z, x_1385.w), vec4<f32>(x_1387.x, x_1387.x, x_1387.x, x_1387.x));
  let x_1389 : vec4<u32> = u_xlatu2;
  u_xlati2 = (bitcast<vec4<i32>>(x_1389) + vec4<i32>(-1i, -1i, -1i, -1i));
  let x_1393 : vec4<f32> = u_xlat3;
  let x_1396 : vec4<f32> = u_xlat0;
  u_xlat0 = (-(vec4<f32>(x_1393.w, x_1393.x, x_1393.y, x_1393.z)) + vec4<f32>(x_1396.w, x_1396.w, x_1396.w, x_1396.w));
  let x_1399 : vec4<f32> = u_xlat0;
  let x_1402 : vec4<f32> = x_65.AdditionalParams;
  u_xlat0 = (abs(x_1399) + vec4<f32>(x_1402.w, x_1402.w, x_1402.w, x_1402.w));
  let x_1405 : vec4<f32> = u_xlat0;
  u_xlat0 = (vec4<f32>(9.0f, 3.0f, 1.0f, 3.0f) / x_1405);
  let x_1407 : vec4<f32> = u_xlat0;
  u_xlat3.x = dot(x_1407, vec4<f32>(1.0f, 1.0f, 1.0f, 1.0f));
  let x_1411 : f32 = u_xlat3.x;
  let x_1413 : f32 = x_65.AdditionalParams.x;
  u_xlat3.x = (x_1411 + x_1413);
  let x_1416 : vec4<f32> = u_xlat1;
  let x_1417 : vec4<f32> = u_xlat0;
  u_xlat0.x = dot(x_1416, x_1417);
  let x_1421 : f32 = u_xlat0.x;
  let x_1423 : f32 = x_65.AdditionalParams.x;
  ...
  let x_1438 : vec4<i32> = u_xlati2;
  let x_1440 : vec4<f32> = u_xlat0;
  textureStore(AoResult_origX0X, vec2<i32>(x_1438.x, x_1438.y), vec4<f32>(x_1440.x, x_1440.x, x_1440.x, x_1440.x));
  return;
}
