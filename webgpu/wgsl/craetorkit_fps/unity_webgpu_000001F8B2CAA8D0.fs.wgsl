...
fn main_1() {
  ...
  let x_1371 : f32 = vs_TEXCOORD1.w;
  let x_1373 : f32 = x_45.x_ProjectionParams.y;
  u_xlat45 = (x_1371 / x_1373);
  let x_1375 : f32 = u_xlat45;
  u_xlat45 = (-(x_1375) + 1.0f);
  let x_1378 : f32 = u_xlat45;
  let x_1380 : f32 = x_45.x_ProjectionParams.z;
  u_xlat45 = (x_1378 * x_1380);
  let x_1382 : f32 = u_xlat45;
  u_xlat45 = max(x_1382, 0.0f);
  let x_1384 : f32 = u_xlat45;
  let x_1387 : f32 = x_45.unity_FogParams.x;
  u_xlat45 = (x_1384 * x_1387);
  let x_1389 : f32 = u_xlat45;
  let x_1390 : f32 = u_xlat45;
  u_xlat45 = (x_1389 * -(x_1390));
  let x_1393 : f32 = u_xlat45;
  u_xlat45 = exp2(x_1393);
  let x_1395 : vec3<f32> = u_xlat0;
  let x_1398 : vec4<f32> = x_45.unity_FogColor;
  u_xlat0 = (x_1395 + -(vec3<f32>(x_1398.x, x_1398.y, x_1398.z)));
  let x_1404 : f32 = u_xlat45;
  let x_1406 : vec3<f32> = u_xlat0;
  let x_1409 : vec4<f32> = x_45.unity_FogColor;
  let x_1411 : vec3<f32> = ((vec3<f32>(x_1404, x_1404, x_1404) * x_1406) + vec3<f32>(x_1409.x, x_1409.y, x_1409.z));
  let x_1412 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1411.x, x_1411.y, x_1411.z, x_1412.w);
  SV_Target0.w = 1.0f;
  return;
}
