...
fn main_1() {
  ...
  u_xlat0 = ((vec4<f32>(x_1115.w, x_1115.x, x_1115.y, x_1115.z) * vec4<f32>(x_1117.w, x_1117.x, x_1117.y, x_1117.z)) + vec4<f32>(x_1120.w, x_1120.x, x_1120.y, x_1120.z));
  let x_1125 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1125);
  let x_1127 : bool = u_xlatb1;
  if (x_1127) {
    let x_1130 : vec4<f32> = u_xlat0;
    let x_1131 : vec3<f32> = vec3<f32>(x_1130.y, x_1130.z, x_1130.w);
    let x_1132 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1131.x, x_1131.y, x_1131.z, x_1132.w);
    let x_1134 : vec4<f32> = u_xlat1;
    let x_1138 : vec3<f32> = clamp(vec3<f32>(x_1134.x, x_1134.y, x_1134.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1139 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1138.x, x_1138.y, x_1138.z, x_1139.w);
    let x_1141 : vec4<f32> = u_xlat1;
    u_xlat0.x = dot(vec3<f32>(x_1141.x, x_1141.y, x_1141.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1151 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1151.y, x_1151.z, x_1151.w, x_1151.x);
  return;
}
