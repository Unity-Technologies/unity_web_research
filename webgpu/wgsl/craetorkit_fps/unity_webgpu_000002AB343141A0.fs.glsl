...
layout(location = 6) in highp float vs_TEXCOORD6;
...
float u_xlat51;
    ...
    u_xlat47 = u_xlat3.w * _Color.w + (-u_xlat47);
    ...
    u_xlat47 = u_xlat47 * u_xlat49 + u_xlat50;
    ...
    if(u_xlatb48){
        ...
        u_xlat5.w = 1.0;
        u_xlat9.x = dot(unity_Builtins2Array[u_xlati0 / 7].unity_SHArArray, u_xlat5);
        u_xlat9.y = dot(unity_Builtins2Array[u_xlati0 / 7].unity_SHAgArray, u_xlat5);
        u_xlat9.z = dot(unity_Builtins2Array[u_xlati0 / 7].unity_SHAbArray, u_xlat5);
    }
    ...
    u_xlat0.x = (-u_xlat49) * 0.699999988 + 1.70000005;
    u_xlat0.x = u_xlat0.x * u_xlat49;
    u_xlat0.x = u_xlat0.x * 6.0;
    u_xlat9 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat9.xyz, u_xlat0.x);
    ...
    if(u_xlatb48){
        ...
        u_xlat6 = textureLod(samplerCube(unity_SpecCube1, samplerunity_SpecCube0), u_xlat6.xyz, u_xlat0.x);
        ...
        u_xlat6.xyz = vec3(u_xlat47) * u_xlat9.xyz + (-u_xlat1.xyz);
    ...
    u_xlat30 = dot(vec2(u_xlat30), vec2(u_xlat49));
