...
fn main_1() {
  ...
  u_xlat0 = (vec3<f32>(x_254.x, x_254.x, x_254.x) * x_256);
  let x_260 : f32 = vs_TEXCOORD5;
  u_xlat12 = x_260;
  let x_261 : f32 = u_xlat12;
  u_xlat12 = clamp(x_261, 0.0f, 1.0f);
  let x_265 : vec3<f32> = u_xlat0;
  let x_266 : f32 = u_xlat12;
  let x_268 : vec3<f32> = (x_265 * vec3<f32>(x_266, x_266, x_266));
  let x_269 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_268.x, x_268.y, x_268.z, x_269.w);
  SV_Target0.w = 1.0f;
  return;
}
