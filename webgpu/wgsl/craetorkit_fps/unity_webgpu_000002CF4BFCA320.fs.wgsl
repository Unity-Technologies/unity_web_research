...
fn main_1() {
  ...
  if (x_243) {
    ...
    hlslcc_movcTemp = x_306;
    let x_308 : bool = u_xlatb8.x;
    if (x_308) {
    ...
    let x_317 : f32 = x_309;
    hlslcc_movcTemp.x = x_317;
    let x_320 : bool = u_xlatb8.y;
    if (x_320) {
      let x_325 : f32 = u_xlat6.y;
      x_321 = x_325;
    } else {
      let x_328 : f32 = u_xlat5.y;
      x_321 = x_328;
    }
    let x_329 : f32 = x_321;
    hlslcc_movcTemp.y = x_329;
    let x_332 : bool = u_xlatb8.z;
    if (x_332) {
    ...
    let x_341 : f32 = x_333;
    hlslcc_movcTemp.z = x_341;
    let x_343 : vec3<f32> = hlslcc_movcTemp;
    u_xlat5 = x_343;
    let x_345 : f32 = u_xlat5.y;
    let x_347 : f32 = u_xlat5.x;
    u_xlat31 = min(x_345, x_347);
    let x_350 : f32 = u_xlat5.z;
    let x_351 : f32 = u_xlat31;
    u_xlat31 = min(x_350, x_351);
    let x_353 : vec4<f32> = u_xlat0;
    let x_356 : vec4<f32> = x_14.unity_SpecCube0_ProbePosition;
    u_xlat5 = (vec3<f32>(x_353.x, x_353.y, x_353.z) + -(vec3<f32>(x_356.x, x_356.y, x_356.z)));
    let x_360 : vec3<f32> = u_xlat7;
    let x_361 : f32 = u_xlat31;
    let x_364 : vec3<f32> = u_xlat5;
    let x_365 : vec3<f32> = ((x_360 * vec3<f32>(x_361, x_361, x_361)) + x_364);
    let x_366 : vec4<f32> = u_xlat4;
    u_xlat4 = vec4<f32>(x_365.x, x_365.y, x_365.z, x_366.w);
  }
  let x_368 : f32 = u_xlat30;
  u_xlat31 = ((-(x_368) * 0.699999988f) + 1.700000048f);
  let x_374 : f32 = u_xlat30;
  let x_375 : f32 = u_xlat31;
  u_xlat31 = (x_374 * x_375);
  let x_377 : f32 = u_xlat31;
  u_xlat31 = (x_377 * 6.0f);
  let x_388 : vec4<f32> = u_xlat4;
  let x_390 : f32 = u_xlat31;
  let x_391 : vec4<f32> = textureSampleLevel(unity_SpecCube0, samplerunity_SpecCube0, vec3<f32>(x_388.x, x_388.y, x_388.z), x_390);
  u_xlat4 = x_391;
  let x_393 : f32 = u_xlat4.w;
  u_xlat31 = (x_393 + -1.0f);
  let x_397 : f32 = x_14.unity_SpecCube0_HDR.w;
  let x_398 : f32 = u_xlat31;
  u_xlat31 = ((x_397 * x_398) + 1.0f);
  let x_401 : f32 = u_xlat31;
  u_xlat31 = log2(x_401);
  let x_403 : f32 = u_xlat31;
  let x_405 : f32 = x_14.unity_SpecCube0_HDR.y;
  u_xlat31 = (x_403 * x_405);
  let x_407 : f32 = u_xlat31;
  u_xlat31 = exp2(x_407);
  let x_409 : f32 = u_xlat31;
  let x_411 : f32 = x_14.unity_SpecCube0_HDR.x;
  u_xlat31 = (x_409 * x_411);
  let x_413 : vec4<f32> = u_xlat4;
  let x_415 : f32 = u_xlat31;
  ...
  let x_504 : vec3<f32> = (vec3<f32>(x_500.x, x_500.z, x_500.w) * vec3<f32>(x_502.x, x_502.y, x_502.z));
  let x_505 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_504.x, x_504.y, x_504.z, x_505.w);
  let x_507 : vec4<f32> = u_xlat0;
  let x_510 : vec4<f32> = x_14.unity_SpecCube0_BoxMax;
  let x_513 : vec3<f32> = (vec3<f32>(x_507.x, x_507.y, x_507.z) + -(vec3<f32>(x_510.x, x_510.y, x_510.z)));
  let x_514 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_513.x, x_513.y, x_513.z, x_514.w);
  let x_516 : vec4<f32> = u_xlat0;
  let x_520 : vec4<f32> = x_14.unity_SpecCube0_BoxMin;
  let x_522 : vec3<f32> = (-(vec3<f32>(x_516.x, x_516.y, x_516.z)) + vec3<f32>(x_520.x, x_520.y, x_520.z));
  ...
  let x_529 : vec3<f32> = max(vec3<f32>(x_525.x, x_525.y, x_525.z), vec3<f32>(x_527.x, x_527.y, x_527.z));
  let x_530 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_529.x, x_529.y, x_529.z, x_530.w);
  let x_532 : vec4<f32> = u_xlat0;
  let x_535 : vec3<f32> = max(vec3<f32>(x_532.x, x_532.y, x_532.z), vec3<f32>(0.0f, 0.0f, 0.0f));
  ...
  u_xlat0.x = dot(vec3<f32>(x_538.x, x_538.y, x_538.z), vec3<f32>(x_540.x, x_540.y, x_540.z));
  let x_545 : f32 = u_xlat0.x;
  u_xlat0.x = sqrt(x_545);
  let x_549 : f32 = u_xlat0.x;
  let x_551 : f32 = x_14.unity_SpecCube1_ProbePosition.w;
  u_xlat0.x = (x_549 / x_551);
  let x_555 : f32 = u_xlat0.x;
  SV_Target0.w = (-(x_555) + 1.0f);
  let x_561 : f32 = SV_Target0.w;
  SV_Target0.w = clamp(x_561, 0.0f, 1.0f);
  return;
}
