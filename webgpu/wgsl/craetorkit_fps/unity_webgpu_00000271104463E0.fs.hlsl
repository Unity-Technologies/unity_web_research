#line 1 "Hidden/PostProcessing/Lut2DBaker"
static const int TONEMAPPING_ACES = 0 ;
static const int TONEMAPPING_NEUTRAL = 0 ;
static const int TONEMAPPING_CUSTOM = 0 ;
...
Texture2D _Curves ; SamplerState sampler_Curves ;
...
#line 88
colorLinear = YrgbCurve ( saturate ( colorLinear ) , _Curves , sampler_Curves ) ;
...
float3 lookup = ApplyLut2D ( _MainTex , sampler_MainTex , neutralColorLinear , _UserLut2D_Params . xyz ) ;
...
colorLog = Contrast ( colorLog , 0.4135884 , _HueSatCon . z ) ;
return colorLog ;
}
