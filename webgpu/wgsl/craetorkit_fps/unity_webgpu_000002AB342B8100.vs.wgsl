...
fn main_1() {
  ...
  vs_COLOR0 = x_82;
  let x_88 : vec2<f32> = in_TEXCOORD0;
  let x_90 : vec4<f32> = x_17.x_FlareTexture_ST;
  let x_94 : vec4<f32> = x_17.x_FlareTexture_ST;
  vs_TEXCOORD0 = ((x_88 * vec2<f32>(x_90.x, x_90.y)) + vec2<f32>(x_94.z, x_94.w));
  return;
}
