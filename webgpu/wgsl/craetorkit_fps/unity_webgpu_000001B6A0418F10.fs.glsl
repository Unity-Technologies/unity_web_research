...
float u_xlat30;
    ...
    u_xlat11.x = textureLod(sampler2DShadow(_ShadowMapTexture, sampler_ShadowMapTexture), txVec0, 0.0);
    ...
    u_xlat11.x = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat11.xy).w;
    u_xlat2.x = u_xlat11.x * u_xlat2.x;
    u_xlat11.x = dot(u_xlat7.xyz, u_xlat7.xyz);
    u_xlat11.x = texture(sampler2D(_LightTextureB0, sampler_LightTextureB0), u_xlat11.xx).x;
    u_xlat2.x = u_xlat11.x * u_xlat2.x;
    ...
    u_xlat28 = (-u_xlat5.x) * 0.959999979 + 0.959999979;
