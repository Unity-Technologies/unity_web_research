...
@group(1) @binding(0) var<uniform> x_52 : VGlobals;
...
fn main_1() {
  ...
  let x_455 : f32 = x_52.unity_LightShadowBias.x;
  let x_457 : f32 = u_xlat0.w;
  u_xlat1.x = (x_455 / x_457);
  let x_461 : f32 = u_xlat1.x;
  u_xlat1.x = min(x_461, 0.0f);
  let x_465 : f32 = u_xlat1.x;
  u_xlat1.x = max(x_465, -1.0f);
  let x_470 : f32 = u_xlat0.z;
  let x_472 : f32 = u_xlat1.x;
  u_xlat14 = (x_470 + x_472);
  let x_475 : f32 = u_xlat0.w;
  let x_476 : f32 = u_xlat14;
  u_xlat1.x = min(x_475, x_476);
  let x_483 : vec4<f32> = u_xlat0;
  let x_484 : vec3<f32> = vec3<f32>(x_483.x, x_483.y, x_483.w);
  let x_486 : vec4<f32> = gl_Position;
  gl_Position = vec4<f32>(x_484.x, x_484.y, x_486.z, x_484.z);
  let x_488 : f32 = u_xlat14;
  let x_491 : f32 = u_xlat1.x;
  u_xlat0.x = (-(x_488) + x_491);
  let x_495 : f32 = x_52.unity_LightShadowBias.y;
  let x_497 : f32 = u_xlat0.x;
  let x_499 : f32 = u_xlat14;
  gl_Position.z = ((x_495 * x_497) + x_499);
  return;
}
