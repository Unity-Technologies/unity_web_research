...
#line 422
float unityFogFactor = unity_FogParams . x * ( max ( ( ( 1.0 - ( ( o . pos ) . z ) / _ProjectionParams . y ) * _ProjectionParams . z ) , 0 ) ) ; unityFogFactor = exp2 ( - unityFogFactor * unityFogFactor ) ; o . eyeVec . w = unityFogFactor ;
return o ;
}
...
c . rgb . rgb = lerp ( ( float4 ( 0 , 0 , 0 , 0 ) ) . rgb , ( c . rgb ) . rgb , saturate ( ( _unity_fogCoord ) . x ) ) ;
