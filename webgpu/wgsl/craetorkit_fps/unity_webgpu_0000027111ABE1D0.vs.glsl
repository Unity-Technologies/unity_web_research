...
layout(location = 1) in highp vec3 in_TEXCOORD1;
layout(location = 2) in highp vec3 in_TEXCOORD0;
layout(location = 0) out highp vec2 vs_TEXCOORD0;
highp vec2 vs_TEXCOORD1;
layout(location = 1) out highp vec2 vs_TEXCOORD2;
layout(location = 2) out highp float vs_TEXCOORD3;
void main()
{
vec4 u_xlat0;
vec4 u_xlat1;
    ...
    u_xlat1.xyz = unity_MatrixV[2].xyz * u_xlat0.zzz + u_xlat1.xyz;
    u_xlat1.xyz = unity_MatrixV[3].xyz * u_xlat0.www + u_xlat1.xyz;
