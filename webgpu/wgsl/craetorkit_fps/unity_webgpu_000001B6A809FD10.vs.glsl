...
layout(location = 6) out highp float vs_TEXCOORD8;
...
float u_xlat21;
    ...
    vs_COLOR0 = in_COLOR0;
    u_xlat3.x = u_xlat1.y * unity_MatrixV[1].z;
    u_xlat3.x = unity_MatrixV[0].z * u_xlat1.x + u_xlat3.x;
    u_xlat3.x = unity_MatrixV[2].z * u_xlat1.z + u_xlat3.x;
    u_xlat3.x = unity_MatrixV[3].z * u_xlat1.w + u_xlat3.x;
    vs_TEXCOORD5.z = (-u_xlat3.x);
