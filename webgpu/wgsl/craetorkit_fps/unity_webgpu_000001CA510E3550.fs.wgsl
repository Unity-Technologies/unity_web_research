...
fn main_1() {
  ...
  let x_229 : vec4<f32> = textureSample(x_LightTextureB0, sampler_LightTextureB0, vec2<f32>(x_227, x_227));
  u_xlat13 = x_229.x;
  let x_239 : vec3<f32> = u_xlat2;
  let x_240 : vec4<f32> = textureSample(x_LightTexture0, sampler_LightTexture0, x_239);
  u_xlat2.x = x_240.w;
  let x_243 : f32 = u_xlat13;
  let x_245 : f32 = u_xlat2.x;
  u_xlat13 = (x_243 * x_245);
  let x_247 : f32 = u_xlat12;
  let x_248 : f32 = u_xlat13;
  u_xlat12 = (x_247 * x_248);
  let x_250 : f32 = u_xlat12;
  let x_254 : vec4<f32> = x_18.x_LightColor0;
  u_xlat2 = (vec3<f32>(x_250, x_250, x_250) * vec3<f32>(x_254.x, x_254.y, x_254.z));
  let x_258 : vec3<f32> = vs_TEXCOORD1;
  let x_259 : vec3<f32> = u_xlat0;
  u_xlat0.x = dot(x_258, x_259);
  let x_263 : f32 = u_xlat0.x;
  u_xlat0.x = max(x_263, 0.0f);
  ...
  let x_276 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_275.x, x_275.y, x_275.z, x_276.w);
  SV_Target0.w = 1.0f;
  return;
}
