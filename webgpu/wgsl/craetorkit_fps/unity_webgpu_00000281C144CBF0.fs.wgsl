...
fn main_1() {
  ...
  let x_301 : f32 = x_192.x_ProjectionParams.y;
  u_xlat9 = (x_298 / x_301);
  let x_303 : f32 = u_xlat9;
  u_xlat9 = (-(x_303) + 1.0f);
  let x_306 : f32 = u_xlat9;
  let x_308 : f32 = x_192.x_ProjectionParams.z;
  u_xlat9 = (x_306 * x_308);
  let x_310 : f32 = u_xlat9;
  u_xlat9 = max(x_310, 0.0f);
  let x_312 : f32 = u_xlat9;
  let x_315 : f32 = x_192.unity_FogParams.x;
  u_xlat9 = (x_312 * x_315);
  ...
  u_xlat9 = exp2(x_321);
  let x_323 : f32 = u_xlat9;
  let x_325 : vec4<f32> = u_xlat1;
  let x_329 : vec4<f32> = x_192.unity_FogColor;
  let x_331 : vec3<f32> = ((vec3<f32>(x_323, x_323, x_323) * vec3<f32>(x_325.x, x_325.y, x_325.z)) + vec3<f32>(x_329.x, x_329.y, x_329.z));
  ...
  let x_344 : i32 = x_192.x_DstBlend;
  u_xlatb9 = (x_344 == 1i);
  let x_346 : bool = u_xlatb9;
  if (x_346) {
