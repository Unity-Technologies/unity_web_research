...
bool u_xlatb18;
    ...
    u_xlat18 = u_xlat12 / unity_ParticleUVShiftData.y;
    u_xlat18 = floor(u_xlat18);
    u_xlat12 = (-u_xlat18) * unity_ParticleUVShiftData.y + u_xlat12;
    u_xlat12 = floor(u_xlat12);
    u_xlat1.x = u_xlat12 * unity_ParticleUVShiftData.z;
    u_xlat12 = (-unity_ParticleUVShiftData.w) + 1.0;
    u_xlat1.y = (-u_xlat18) * unity_ParticleUVShiftData.w + u_xlat12;
    u_xlat1.xy = in_TEXCOORD0.xy * unity_ParticleUVShiftData.zw + u_xlat1.xy;
    u_xlatb18 = unity_ParticleUVShiftData.x!=0.0;
    vs_TEXCOORD0.xy = (bool(u_xlatb18)) ? u_xlat1.xy : in_TEXCOORD0.xy;
    u_xlat1.x = u_xlat6.x + 1.0;
    u_xlat2.z = fract(u_xlat6.x);
    u_xlat6.x = floor(u_xlat1.x);
    u_xlat1.x = u_xlat6.x / unity_ParticleUVShiftData.y;
    u_xlat1.x = floor(u_xlat1.x);
    u_xlat6.x = (-u_xlat1.x) * unity_ParticleUVShiftData.y + u_xlat6.x;
    u_xlat1.y = (-u_xlat1.x) * unity_ParticleUVShiftData.w + u_xlat12;
    ...
    u_xlat1.z = 0.0;
    vs_TEXCOORD1.xyz = (bool(u_xlatb18)) ? u_xlat2.xyz : u_xlat1.xyz;
