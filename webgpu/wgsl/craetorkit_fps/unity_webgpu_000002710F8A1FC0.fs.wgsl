...
fn main_1() {
  ...
  u_xlat0 = (vec4<f32>(x_663.w, x_663.x, x_663.y, x_663.z) * vec4<f32>(x_674.x, x_674.y, x_674.z, x_674.w));
  let x_681 : vec4<f32> = u_xlat0;
  let x_688 : vec3<f32> = ((vec3<f32>(x_681.y, x_681.z, x_681.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_733 : vec3<f32> = ((vec3<f32>(x_725.x, x_725.y, x_725.z) * vec3<f32>(x_728.x, x_728.x, x_728.x)) + vec3<f32>(x_731, x_731, x_731));
  ...
  u_xlat0 = vec4<f32>(x_748.x, x_747.x, x_747.y, x_747.z);
  let x_752 : f32 = x_55.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_752);
  let x_754 : bool = u_xlatb1;
  if (x_754) {
    let x_757 : vec4<f32> = u_xlat0;
    let x_758 : vec3<f32> = vec3<f32>(x_757.y, x_757.z, x_757.w);
    ...
    u_xlat0.x = dot(vec3<f32>(x_768.x, x_768.y, x_768.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
