...
fn main_1() {
  ...
  let x_271 : vec3<f32> = (vec3<f32>(x_265.y, x_265.y, x_265.y) * vec3<f32>(x_269.x, x_269.y, x_269.z));
  let x_272 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_271.x, x_271.y, x_271.z, x_272.w);
  let x_275 : vec4<f32> = x_19.unity_WorldToLight[0i];
  ...
  let x_286 : vec4<f32> = x_19.unity_WorldToLight[2i];
  let x_288 : vec4<f32> = u_xlat0;
  let x_291 : vec4<f32> = u_xlat1;
  let x_293 : vec3<f32> = ((vec3<f32>(x_286.x, x_286.y, x_286.z) * vec3<f32>(x_288.z, x_288.z, x_288.z)) + vec3<f32>(x_291.x, x_291.y, x_291.z));
  let x_294 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_293.x, x_293.y, x_293.z, x_294.w);
  let x_299 : vec4<f32> = x_19.unity_WorldToLight[3i];
  let x_301 : vec4<f32> = u_xlat0;
  let x_304 : vec4<f32> = u_xlat0;
  vs_TEXCOORD2 = ((vec3<f32>(x_299.x, x_299.y, x_299.z) * vec3<f32>(x_301.w, x_301.w, x_301.w)) + vec3<f32>(x_304.x, x_304.y, x_304.z));
