...
fn main_1() {
  ...
  let x_290 : vec4<f32> = x_17.unity_WorldToLight[3i];
  let x_292 : vec4<f32> = u_xlat0;
  let x_295 : vec4<f32> = u_xlat0;
  vs_TEXCOORD5 = ((vec3<f32>(x_290.x, x_290.y, x_290.z) * vec3<f32>(x_292.w, x_292.w, x_292.w)) + vec3<f32>(x_295.x, x_295.y, x_295.z));
