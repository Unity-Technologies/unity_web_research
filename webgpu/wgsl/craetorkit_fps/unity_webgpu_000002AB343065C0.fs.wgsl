...
fn main_1() {
  ...
  let x_326 : f32 = x_21.x_Glossiness;
  u_xlat1.y = (-(x_326) + 1.0f);
  let x_335 : vec4<f32> = u_xlat1;
  let x_337 : vec4<f32> = textureSample(unity_NHxRoughness, samplerunity_NHxRoughness, vec2<f32>(x_335.x, x_335.y));
  u_xlat9 = x_337.x;
  let x_339 : f32 = u_xlat9;
  u_xlat9 = (x_339 * 16.0f);
  let x_347 : vec4<f32> = vs_TEXCOORD0;
  let x_349 : vec4<f32> = textureSample(x_MainTex, sampler_MainTex, vec2<f32>(x_347.x, x_347.y));
  ...
  let x_354 : vec4<f32> = x_21.x_Color;
  let x_356 : vec4<f32> = u_xlat1;
  u_xlat2 = ((vec3<f32>(x_354.x, x_354.y, x_354.z) * vec3<f32>(x_356.x, x_356.y, x_356.z)) + vec3<f32>(-0.039999999f, -0.039999999f, -0.039999999f));
  let x_362 : vec4<f32> = u_xlat1;
  let x_365 : vec4<f32> = x_21.x_Color;
  ...
  let x_372 : f32 = x_21.x_Metallic;
  let x_374 : f32 = x_21.x_Metallic;
  let x_376 : f32 = x_21.x_Metallic;
  let x_377 : vec3<f32> = vec3<f32>(x_372, x_374, x_376);
  let x_382 : vec3<f32> = u_xlat2;
  u_xlat2 = ((vec3<f32>(x_377.x, x_377.y, x_377.z) * x_382) + vec3<f32>(0.039999999f, 0.039999999f, 0.039999999f));
  let x_387 : f32 = u_xlat9;
  let x_389 : vec3<f32> = u_xlat2;
  u_xlat2 = (vec3<f32>(x_387, x_387, x_387) * x_389);
  let x_392 : f32 = x_21.x_Metallic;
  u_xlat9 = ((-(x_392) * 0.959999979f) + 0.959999979f);
  ...
  let x_414 : f32 = vs_TEXCOORD1.w;
  u_xlat9 = x_414;
  let x_415 : f32 = u_xlat9;
  u_xlat9 = clamp(x_415, 0.0f, 1.0f);
  let x_419 : vec4<f32> = u_xlat0;
  let x_421 : f32 = u_xlat9;
  let x_423 : vec3<f32> = (vec3<f32>(x_419.x, x_419.y, x_419.z) * vec3<f32>(x_421, x_421, x_421));
