...
#line 80 "D:/src/unity_webgpu/Shaders/Includes/UnityInstancing.cginc"
...
#line 55
cbuffer UnityInstancing_Props { struct _type_Props {
...
o . projectedPosition . z = - UnityObjectToViewPos ( v . vertex ) . z ;
}
...
#line 72
float sceneDepth = LinearEyeDepth ( ( tex2Dproj ( _CameraDepthTexture , IN . projectedPosition ) . r ) ) ;
...
o . custompack0 . xyzw = customInputData . projectedPosition ;
o . pos = UnityObjectToClipPosInstanced ( v . vertex ) ;
...
surfIN . uv_Normal . x = 1.0 ;
surfIN . projectedPosition . x = 1.0 ;
surfIN . color . x = 1.0 ;
surfIN . uv_MainTex = IN . pack0 . xy ;
surfIN . uv_Normal = IN . pack0 . zw ;
surfIN . projectedPosition = IN . custompack0 . xyzw ;
