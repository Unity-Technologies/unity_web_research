...
layout(set = 0, binding = 2) uniform mediump texture2D _CameraReflectionsTexture;
...
layout(set = 0, binding = 6) uniform mediump texture2D _Resolve;
...
layout(set = 0, binding = 9) uniform mediump  sampler sampler_CameraReflectionsTexture;
layout(set = 0, binding = 10) uniform mediump  sampler sampler_Resolve;
void main()
{
vec3 u_xlat0;
uvec4 u_xlatu0;
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat3.x = u_xlat11.x * unity_CameraInvProjection[0].x;
    u_xlat3.y = u_xlat11.y * unity_CameraInvProjection[1].y;
    u_xlat3.z = u_xlat6.x * unity_CameraInvProjection[2].z + unity_CameraInvProjection[3].z;
