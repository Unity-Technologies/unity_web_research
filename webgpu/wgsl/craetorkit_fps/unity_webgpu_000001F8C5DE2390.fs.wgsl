...
@group(0) @binding(4) var sampler_OcclusionMap : sampler;
...
fn main_1() {
  ...
  let x_158 : vec4<f32> = x_36.x_EmissionColor;
  u_xlat0 = (x_155 * vec3<f32>(x_158.x, x_158.y, x_158.z));
  let x_162 : vec3<f32> = u_xlat0;
  let x_164 : vec3<f32> = exp2(-(x_162));
