...
fn main_1() {
  ...
  let x_1217 : vec2<f32> = vs_TEXCOORD1;
  let x_1220 : vec4<f32> = x_26.x_Grain_Params2;
  ...
  let x_1236 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1234.x, x_1234.y));
  ...
  u_xlat1 = clamp(x_1241, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1246 : vec3<f32> = u_xlat1;
  u_xlat30 = dot(x_1246, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1252 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1252);
  let x_1256 : f32 = x_26.x_Grain_Params1.x;
  let x_1257 : f32 = u_xlat30;
  u_xlat30 = ((x_1256 * -(x_1257)) + 1.0f);
  let x_1261 : vec4<f32> = u_xlat0;
  let x_1263 : vec3<f32> = u_xlat2;
  let x_1264 : vec3<f32> = (vec3<f32>(x_1261.x, x_1261.y, x_1261.z) * x_1263);
  let x_1265 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1264.x, x_1264.y, x_1264.z, x_1265.w);
  let x_1267 : vec4<f32> = u_xlat0;
  let x_1270 : f32 = x_26.x_Grain_Params1.y;
  let x_1272 : f32 = x_26.x_Grain_Params1.y;
  let x_1274 : f32 = x_26.x_Grain_Params1.y;
  let x_1276 : vec3<f32> = (vec3<f32>(x_1267.x, x_1267.y, x_1267.z) * vec3<f32>(x_1270, x_1272, x_1274));
  ...
  let x_1285 : vec3<f32> = ((vec3<f32>(x_1279.x, x_1279.y, x_1279.z) * vec3<f32>(x_1281, x_1281, x_1281)) + x_1284);
  let x_1286 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_1285.x, x_1285.y, x_1285.z, x_1286.w);
  let x_1291 : f32 = x_26.x_LumaInAlpha;
  u_xlatb0 = (0.5f < x_1291);
  let x_1293 : bool = u_xlatb0;
  if (x_1293) {
    let x_1296 : vec4<f32> = u_xlat3;
    let x_1297 : vec3<f32> = vec3<f32>(x_1296.x, x_1296.y, x_1296.z);
    ...
    u_xlat0 = vec4<f32>(x_1304.x, x_1304.y, x_1304.z, x_1305.w);
    let x_1307 : vec4<f32> = u_xlat0;
    u_xlat3.w = dot(vec3<f32>(x_1307.x, x_1307.y, x_1307.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
