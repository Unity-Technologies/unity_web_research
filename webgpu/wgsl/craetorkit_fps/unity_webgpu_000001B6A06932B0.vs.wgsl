...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_366.y, x_366.y, x_366.y, x_366.y) * x_370);
  let x_373 : vec4<f32> = x_19.unity_WorldToLight[0i];
  let x_374 : vec4<f32> = u_xlat0;
  let x_377 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_373 * vec4<f32>(x_374.x, x_374.x, x_374.x, x_374.x)) + x_377);
  let x_380 : vec4<f32> = x_19.unity_WorldToLight[2i];
  let x_381 : vec4<f32> = u_xlat0;
  let x_384 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_380 * vec4<f32>(x_381.z, x_381.z, x_381.z, x_381.z)) + x_384);
  let x_389 : vec4<f32> = x_19.unity_WorldToLight[3i];
  let x_390 : vec4<f32> = u_xlat0;
  let x_393 : vec4<f32> = u_xlat1;
  vs_TEXCOORD5 = ((x_389 * vec4<f32>(x_390.w, x_390.w, x_390.w, x_390.w)) + x_393);
  return;
}
