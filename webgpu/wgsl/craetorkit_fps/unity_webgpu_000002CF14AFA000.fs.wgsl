...
fn main_1() {
  ...
  u_xlat0 = (x_372 * x_373);
  let x_376 : f32 = vs_TEXCOORD1.w;
  u_xlat9 = x_376;
  let x_377 : f32 = u_xlat9;
  u_xlat9 = clamp(x_377, 0.0f, 1.0f);
  let x_381 : vec3<f32> = u_xlat0;
  let x_382 : f32 = u_xlat9;
  let x_384 : vec3<f32> = (x_381 * vec3<f32>(x_382, x_382, x_382));
  let x_385 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_384.x, x_384.y, x_384.z, x_385.w);
  SV_Target0.w = 1.0f;
  return;
}
