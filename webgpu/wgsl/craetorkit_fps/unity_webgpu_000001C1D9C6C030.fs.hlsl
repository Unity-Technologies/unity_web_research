...
#line 20 "D:/src/unity_webgpu/Shaders/Includes/UnityStandardInput.cginc"
float4 _Color ;
float _Cutoff ;
...
#line 17 "D:/src/unity_webgpu/Shaders/Includes/UnityStandardCore.cginc"
...
float _unity_fogCoord = i . eyeVec . w ;
float unityFogFactor = unity_FogParams . x * ( max ( ( ( 1.0 - ( ( _unity_fogCoord ) . x ) / _ProjectionParams . y ) * _ProjectionParams . z ) , 0 ) ) ; unityFogFactor = exp2 ( - unityFogFactor * unityFogFactor ) ; c . rgb . rgb = lerp ( ( float4 ( 0 , 0 , 0 , 0 ) ) . rgb , ( c . rgb ) . rgb , saturate ( unityFogFactor ) ) ;
...
#line 18 "D:/src/unity_webgpu/Shaders/Includes/UnityStandardCoreForward.cginc"
