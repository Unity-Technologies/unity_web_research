...
fn main_1() {
  ...
  u_xlat1 = ((vec3<f32>(x_1462.z, x_1462.x, x_1462.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1470 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1470);
  let x_1472 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1472 * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1479 : vec3<f32> = u_xlat1;
  u_xlat1 = clamp(x_1479, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1483 : vec3<f32> = u_xlat1;
  let x_1486 : vec3<f32> = x_26.x_Lut2D_Params;
  u_xlat11 = (x_1483 * vec3<f32>(x_1486.z, x_1486.z, x_1486.z));
  let x_1490 : f32 = u_xlat11.x;
  u_xlat11.x = floor(x_1490);
  let x_1494 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1496 : vec2<f32> = (vec2<f32>(x_1494.x, x_1494.y) * vec2<f32>(0.5f, 0.5f));
  let x_1497 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1496.x, x_1496.y, x_1497.z, x_1497.w);
  let x_1499 : vec3<f32> = u_xlat11;
  let x_1502 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1505 : vec4<f32> = u_xlat2;
  let x_1507 : vec2<f32> = ((vec2<f32>(x_1499.y, x_1499.z) * vec2<f32>(x_1502.x, x_1502.y)) + vec2<f32>(x_1505.x, x_1505.y));
  let x_1508 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1508.x, x_1507.x, x_1507.y, x_1508.w);
  let x_1511 : f32 = u_xlat11.x;
  let x_1513 : f32 = x_26.x_Lut2D_Params.y;
  let x_1516 : f32 = u_xlat2.y;
  u_xlat2.x = ((x_1511 * x_1513) + x_1516);
  let x_1524 : vec4<f32> = u_xlat2;
  let x_1526 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1524.x, x_1524.z));
  let x_1527 : vec3<f32> = vec3<f32>(x_1526.x, x_1526.y, x_1526.z);
  let x_1528 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_1527.x, x_1527.y, x_1527.z, x_1528.w);
  let x_1531 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat4.x = x_1531;
  u_xlat4.y = 0.0f;
  let x_1534 : vec4<f32> = u_xlat2;
  let x_1536 : vec4<f32> = u_xlat4;
  u_xlat21 = (vec2<f32>(x_1534.x, x_1534.z) + vec2<f32>(x_1536.x, x_1536.y));
  let x_1542 : vec2<f32> = u_xlat21;
  let x_1543 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, x_1542);
  ...
  let x_1550 : f32 = x_26.x_Lut2D_Params.z;
  let x_1553 : f32 = u_xlat11.x;
  u_xlat1.x = ((x_1548 * x_1550) + -(x_1553));
  let x_1557 : vec4<f32> = u_xlat3;
  let x_1560 : vec4<f32> = u_xlat2;
  u_xlat11 = (-(vec3<f32>(x_1557.x, x_1557.y, x_1557.z)) + vec3<f32>(x_1560.x, x_1560.y, x_1560.z));
  let x_1563 : vec3<f32> = u_xlat1;
  let x_1565 : vec3<f32> = u_xlat11;
  let x_1567 : vec4<f32> = u_xlat3;
  let x_1569 : vec3<f32> = ((vec3<f32>(x_1563.x, x_1563.x, x_1563.x) * x_1565) + vec3<f32>(x_1567.x, x_1567.y, x_1567.z));
  let x_1570 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1569.x, x_1569.y, x_1569.z, x_1570.w);
  let x_1574 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1574);
  let x_1576 : bool = u_xlatb1;
  if (x_1576) {
    let x_1579 : vec4<f32> = u_xlat0;
    u_xlat1 = vec3<f32>(x_1579.x, x_1579.y, x_1579.z);
    let x_1581 : vec3<f32> = u_xlat1;
    u_xlat1 = clamp(x_1581, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1585 : vec3<f32> = u_xlat1;
    u_xlat0.w = dot(x_1585, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
