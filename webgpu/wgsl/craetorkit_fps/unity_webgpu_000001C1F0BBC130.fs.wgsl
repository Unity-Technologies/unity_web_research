...
fn main_1() {
  ...
  let x_1268 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1272 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1274 : vec2<f32> = ((x_1265 * vec2<f32>(x_1268.x, x_1268.y)) + vec2<f32>(x_1272.z, x_1272.w));
  let x_1275 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1274.x, x_1274.y, x_1275.z, x_1275.w);
  let x_1282 : vec4<f32> = u_xlat1;
  let x_1284 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1282.x, x_1282.y));
  u_xlat1.x = x_1284.w;
  let x_1288 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1288 * 2.0f) + -1.0f);
  let x_1293 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1293 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1299 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1299, 0.0f, 1.0f);
  let x_1303 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1303 * 2.0f) + -1.0f);
  let x_1308 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1308)) + 1.0f);
  let x_1314 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1314);
  let x_1318 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1318) + 1.0f);
  let x_1323 : f32 = u_xlat1.x;
  let x_1325 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1323 * x_1325);
  let x_1328 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1328.x, x_1328.y, x_1328.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1333 : vec4<f32> = u_xlat0;
  let x_1338 : vec3<f32> = max(abs(vec3<f32>(x_1333.x, x_1333.y, x_1333.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  let x_1422 : vec3<f32> = ((vec3<f32>(x_1415.x, x_1415.x, x_1415.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1420.x, x_1420.y, x_1420.z));
  let x_1423 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1422.x, x_1422.y, x_1422.z, x_1423.w);
  let x_1425 : vec4<f32> = u_xlat0;
  let x_1429 : vec3<f32> = (vec3<f32>(x_1425.x, x_1425.y, x_1425.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1430 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1429.x, x_1429.y, x_1429.z, x_1430.w);
  let x_1432 : vec4<f32> = u_xlat0;
  let x_1436 : vec3<f32> = (vec3<f32>(x_1432.x, x_1432.y, x_1432.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1437 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1436.x, x_1436.y, x_1436.z, x_1437.w);
  let x_1439 : vec4<f32> = u_xlat2;
  let x_1443 : vec3<f32> = (vec3<f32>(x_1439.x, x_1439.y, x_1439.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1444 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1443.x, x_1443.y, x_1443.z, x_1444.w);
  let x_1446 : vec4<f32> = u_xlat2;
  let x_1449 : vec3<f32> = max(abs(vec3<f32>(x_1446.x, x_1446.y, x_1446.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1450 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1449.x, x_1449.y, x_1449.z, x_1450.w);
  let x_1452 : vec4<f32> = u_xlat2;
  let x_1454 : vec3<f32> = log2(vec3<f32>(x_1452.x, x_1452.y, x_1452.z));
  let x_1455 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1454.x, x_1454.y, x_1454.z, x_1455.w);
  let x_1457 : vec4<f32> = u_xlat2;
  let x_1461 : vec3<f32> = (vec3<f32>(x_1457.x, x_1457.y, x_1457.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1462 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1461.x, x_1461.y, x_1461.z, x_1462.w);
  let x_1464 : vec4<f32> = u_xlat2;
  let x_1466 : vec3<f32> = exp2(vec3<f32>(x_1464.x, x_1464.y, x_1464.z));
  let x_1467 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1466.x, x_1466.y, x_1466.z, x_1467.w);
  let x_1471 : vec4<f32> = u_xlat0;
  let x_1473 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1471.x, x_1471.y, x_1471.z, x_1471.x));
  u_xlatb0 = vec3<bool>(x_1473.x, x_1473.y, x_1473.z);
  ...
  SV_Target0.x = x_1487;
  let x_1491 : bool = u_xlatb0.y;
  if (x_1491) {
    let x_1496 : f32 = u_xlat1.y;
    x_1492 = x_1496;
  } else {
  ...
  SV_Target0.y = x_1500;
  let x_1503 : bool = u_xlatb0.z;
  if (x_1503) {
    let x_1508 : f32 = u_xlat1.z;
    x_1504 = x_1508;
  } else {
