...
fn main_1() {
  ...
  phase0_Output0_1 = ((x_40 * vec4<f32>(0.5f, -0.5f, 0.5f, -0.5f)) + vec4<f32>(0.0f, 1.0f, 0.0f, 1.0f));
  let x_49 : vec4<f32> = phase0_Output0_1;
  vs_TEXCOORD0 = vec2<f32>(x_49.x, x_49.y);
  let x_53 : vec4<f32> = phase0_Output0_1;
  vs_TEXCOORD1 = vec2<f32>(x_53.z, x_53.w);
  return;
}
