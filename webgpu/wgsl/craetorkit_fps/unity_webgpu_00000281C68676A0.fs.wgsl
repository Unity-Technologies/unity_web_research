...
fn main_1() {
  ...
  let x_1210 : f32 = x_26.x_PostExposure;
  let x_1212 : f32 = x_26.x_PostExposure;
  let x_1214 : f32 = x_26.x_PostExposure;
  let x_1216 : f32 = x_26.x_PostExposure;
  let x_1217 : vec4<f32> = vec4<f32>(x_1210, x_1212, x_1214, x_1216);
  u_xlat0 = (x_1207 * vec4<f32>(x_1217.x, x_1217.y, x_1217.z, x_1217.w));
  let x_1224 : vec4<f32> = u_xlat0;
  let x_1231 : vec3<f32> = ((vec3<f32>(x_1224.x, x_1224.y, x_1224.z) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1246 : vec3<f32> = ((vec3<f32>(x_1239.x, x_1239.y, x_1239.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1247 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1246.x, x_1246.y, x_1246.z, x_1247.w);
  let x_1249 : vec4<f32> = u_xlat0;
  let x_1253 : vec3<f32> = clamp(vec3<f32>(x_1249.x, x_1249.y, x_1249.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1254 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1253.x, x_1253.y, x_1253.z, x_1254.w);
  let x_1256 : vec4<f32> = u_xlat0;
  let x_1261 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1263 : vec3<f32> = (vec3<f32>(x_1256.x, x_1256.y, x_1256.z) * vec3<f32>(x_1261.y, x_1261.y, x_1261.y));
  let x_1264 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1263.x, x_1263.y, x_1263.z, x_1264.w);
  let x_1267 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat1.x = (x_1267 * 0.5f);
  let x_1270 : vec4<f32> = u_xlat0;
  let x_1273 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1276 : vec4<f32> = u_xlat1;
  let x_1278 : vec3<f32> = ((vec3<f32>(x_1270.x, x_1270.y, x_1270.z) * vec3<f32>(x_1273.x, x_1273.x, x_1273.x)) + vec3<f32>(x_1276.x, x_1276.x, x_1276.x));
  let x_1279 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1278.x, x_1278.y, x_1278.z, x_1279.w);
  let x_1289 : vec4<f32> = u_xlat0;
  let x_1291 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1289.x, x_1289.y, x_1289.z));
  let x_1292 : vec3<f32> = vec3<f32>(x_1291.x, x_1291.y, x_1291.z);
  let x_1293 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1292.x, x_1292.y, x_1292.z, x_1293.w);
  let x_1295 : vec2<f32> = vs_TEXCOORD0;
  let x_1298 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1302 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1304 : vec2<f32> = ((x_1295 * vec2<f32>(x_1298.x, x_1298.y)) + vec2<f32>(x_1302.z, x_1302.w));
  let x_1305 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1304.x, x_1304.y, x_1305.z, x_1305.w);
  let x_1312 : vec4<f32> = u_xlat1;
  let x_1314 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1312.x, x_1312.y));
  u_xlat1.x = x_1314.w;
  let x_1318 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1318 * 2.0f) + -1.0f);
  let x_1323 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1323 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1329 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1329, 0.0f, 1.0f);
  let x_1333 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1333 * 2.0f) + -1.0f);
  let x_1338 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1338)) + 1.0f);
  let x_1344 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1344);
  let x_1348 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1348) + 1.0f);
  let x_1353 : f32 = u_xlat1.x;
  let x_1355 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1353 * x_1355);
  let x_1358 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1358.x, x_1358.y, x_1358.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1363 : vec4<f32> = u_xlat0;
  let x_1368 : vec3<f32> = max(abs(vec3<f32>(x_1363.x, x_1363.y, x_1363.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1369 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1368.x, x_1368.y, x_1368.z, x_1369.w);
  let x_1371 : vec4<f32> = u_xlat2;
  let x_1373 : vec3<f32> = log2(vec3<f32>(x_1371.x, x_1371.y, x_1371.z));
  let x_1374 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1373.x, x_1373.y, x_1373.z, x_1374.w);
  let x_1376 : vec4<f32> = u_xlat2;
  let x_1380 : vec3<f32> = (vec3<f32>(x_1376.x, x_1376.y, x_1376.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1381 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1380.x, x_1380.y, x_1380.z, x_1381.w);
  let x_1383 : vec4<f32> = u_xlat2;
  let x_1385 : vec3<f32> = exp2(vec3<f32>(x_1383.x, x_1383.y, x_1383.z));
  let x_1386 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1385.x, x_1385.y, x_1385.z, x_1386.w);
  let x_1388 : vec4<f32> = u_xlat2;
  let x_1395 : vec3<f32> = ((vec3<f32>(x_1388.x, x_1388.y, x_1388.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1396 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1395.x, x_1395.y, x_1395.z, x_1396.w);
  let x_1403 : vec4<f32> = u_xlat0;
  let x_1406 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1403.x, x_1403.y, x_1403.z, x_1403.x));
  u_xlatb0 = vec3<bool>(x_1406.x, x_1406.y, x_1406.z);
  let x_1409 : bool = u_xlatb0.x;
  if (x_1409) {
    let x_1414 : f32 = u_xlat11.x;
    x_1410 = x_1414;
  } else {
    let x_1417 : f32 = u_xlat2.x;
    x_1410 = x_1417;
  }
  let x_1418 : f32 = x_1410;
  u_xlat0.x = x_1418;
  let x_1421 : bool = u_xlatb0.y;
  if (x_1421) {
    let x_1426 : f32 = u_xlat11.y;
    x_1422 = x_1426;
  } else {
    let x_1429 : f32 = u_xlat2.y;
    x_1422 = x_1429;
  }
  let x_1430 : f32 = x_1422;
  u_xlat0.y = x_1430;
  let x_1434 : bool = u_xlatb0.z;
  if (x_1434) {
    let x_1439 : f32 = u_xlat11.z;
    x_1435 = x_1439;
  } else {
  ...
  let x_1452 : vec3<f32> = ((vec3<f32>(x_1445.x, x_1445.x, x_1445.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1450.x, x_1450.y, x_1450.z));
  let x_1453 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1452.x, x_1452.y, x_1452.z, x_1453.w);
  let x_1455 : vec4<f32> = u_xlat0;
  let x_1459 : vec3<f32> = (vec3<f32>(x_1455.x, x_1455.y, x_1455.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1460 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1459.x, x_1459.y, x_1459.z, x_1460.w);
  let x_1462 : vec4<f32> = u_xlat0;
  let x_1466 : vec3<f32> = (vec3<f32>(x_1462.x, x_1462.y, x_1462.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1467 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1466.x, x_1466.y, x_1466.z, x_1467.w);
  let x_1469 : vec4<f32> = u_xlat2;
  let x_1473 : vec3<f32> = (vec3<f32>(x_1469.x, x_1469.y, x_1469.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1474 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1473.x, x_1473.y, x_1473.z, x_1474.w);
  let x_1476 : vec4<f32> = u_xlat2;
  let x_1479 : vec3<f32> = max(abs(vec3<f32>(x_1476.x, x_1476.y, x_1476.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1480 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1479.x, x_1479.y, x_1479.z, x_1480.w);
  let x_1482 : vec4<f32> = u_xlat2;
  let x_1484 : vec3<f32> = log2(vec3<f32>(x_1482.x, x_1482.y, x_1482.z));
  let x_1485 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1484.x, x_1484.y, x_1484.z, x_1485.w);
  let x_1487 : vec4<f32> = u_xlat2;
  let x_1491 : vec3<f32> = (vec3<f32>(x_1487.x, x_1487.y, x_1487.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1492 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1491.x, x_1491.y, x_1491.z, x_1492.w);
  let x_1494 : vec4<f32> = u_xlat2;
  let x_1496 : vec3<f32> = exp2(vec3<f32>(x_1494.x, x_1494.y, x_1494.z));
  let x_1497 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1496.x, x_1496.y, x_1496.z, x_1497.w);
  let x_1501 : vec4<f32> = u_xlat0;
  let x_1503 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1501.x, x_1501.y, x_1501.z, x_1501.x));
  u_xlatb0 = vec3<bool>(x_1503.x, x_1503.y, x_1503.z);
  let x_1508 : bool = u_xlatb0.x;
  if (x_1508) {
