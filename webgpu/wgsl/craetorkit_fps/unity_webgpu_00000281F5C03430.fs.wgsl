...
fn main_1() {
  ...
  if (x_361) {
    ...
    let x_385 : vec4<f32> = x_37.unity_ProbeVolumeWorldToObject[2i];
    let x_387 : vec4<f32> = vs_TEXCOORD3;
    let x_390 : vec3<f32> = u_xlat17;
    u_xlat17 = ((vec3<f32>(x_385.x, x_385.y, x_385.z) * vec3<f32>(x_387.w, x_387.w, x_387.w)) + x_390);
    let x_392 : vec3<f32> = u_xlat17;
    let x_394 : vec4<f32> = x_37.unity_ProbeVolumeWorldToObject[3i];
    u_xlat17 = (x_392 + vec3<f32>(x_394.x, x_394.y, x_394.z));
  ...
  let x_1116 : vec4<f32> = x_37.x_WorldSpaceLightPos0;
  u_xlat1 = ((x_1110 * vec3<f32>(x_1111, x_1111, x_1111)) + vec3<f32>(x_1116.x, x_1116.y, x_1116.z));
  let x_1119 : vec3<f32> = u_xlat1;
  let x_1120 : vec3<f32> = u_xlat1;
  u_xlat42 = dot(x_1119, x_1120);
  let x_1122 : f32 = u_xlat42;
  u_xlat42 = max(x_1122, 0.001f);
  let x_1125 : f32 = u_xlat42;
  u_xlat42 = inverseSqrt(x_1125);
  let x_1127 : f32 = u_xlat42;
  let x_1129 : vec3<f32> = u_xlat1;
  u_xlat1 = (vec3<f32>(x_1127, x_1127, x_1127) * x_1129);
  let x_1131 : vec4<f32> = u_xlat5;
  let x_1133 : vec4<f32> = u_xlat2;
  u_xlat42 = dot(vec3<f32>(x_1131.x, x_1131.y, x_1131.z), vec3<f32>(x_1133.x, x_1133.y, x_1133.z));
  let x_1136 : vec4<f32> = u_xlat5;
  let x_1139 : vec4<f32> = x_37.x_WorldSpaceLightPos0;
  u_xlat2.x = dot(vec3<f32>(x_1136.x, x_1136.y, x_1136.z), vec3<f32>(x_1139.x, x_1139.y, x_1139.z));
  let x_1144 : f32 = u_xlat2.x;
  u_xlat2.x = clamp(x_1144, 0.0f, 1.0f);
  let x_1148 : vec4<f32> = u_xlat5;
  let x_1150 : vec3<f32> = u_xlat1;
  u_xlat16 = dot(vec3<f32>(x_1148.x, x_1148.y, x_1148.z), x_1150);
  let x_1152 : f32 = u_xlat16;
  u_xlat16 = clamp(x_1152, 0.0f, 1.0f);
  let x_1155 : vec4<f32> = x_37.x_WorldSpaceLightPos0;
  let x_1157 : vec3<f32> = u_xlat1;
  u_xlat1.x = dot(vec3<f32>(x_1155.x, x_1155.y, x_1155.z), x_1157);
  let x_1161 : f32 = u_xlat1.x;
  u_xlat1.x = clamp(x_1161, 0.0f, 1.0f);
  let x_1166 : f32 = u_xlat1.x;
  let x_1168 : f32 = u_xlat1.x;
  u_xlat15 = (x_1166 * x_1168);
  let x_1170 : f32 = u_xlat15;
  let x_1172 : vec3<f32> = u_xlat17;
  u_xlat15 = dot(vec2<f32>(x_1170, x_1170), vec2<f32>(x_1172.x, x_1172.x));
  let x_1175 : f32 = u_xlat15;
  u_xlat15 = (x_1175 + -0.5f);
  let x_1180 : f32 = u_xlat2.x;
  u_xlat29 = (-(x_1180) + 1.0f);
  let x_1184 : f32 = u_xlat29;
  let x_1185 : f32 = u_xlat29;
  u_xlat30 = (x_1184 * x_1185);
  let x_1187 : f32 = u_xlat30;
  let x_1188 : f32 = u_xlat30;
  u_xlat30 = (x_1187 * x_1188);
  let x_1190 : f32 = u_xlat29;
  let x_1191 : f32 = u_xlat30;
  u_xlat29 = (x_1190 * x_1191);
  let x_1193 : f32 = u_xlat15;
  let x_1194 : f32 = u_xlat29;
  u_xlat29 = ((x_1193 * x_1194) + 1.0f);
  let x_1197 : f32 = u_xlat42;
  u_xlat30 = (-(abs(x_1197)) + 1.0f);
  let x_1201 : f32 = u_xlat30;
  let x_1202 : f32 = u_xlat30;
  u_xlat46 = (x_1201 * x_1202);
  let x_1204 : f32 = u_xlat46;
  let x_1205 : f32 = u_xlat46;
  u_xlat46 = (x_1204 * x_1205);
  let x_1207 : f32 = u_xlat30;
  let x_1208 : f32 = u_xlat46;
  u_xlat30 = (x_1207 * x_1208);
  let x_1210 : f32 = u_xlat15;
  let x_1211 : f32 = u_xlat30;
  u_xlat15 = ((x_1210 * x_1211) + 1.0f);
  let x_1214 : f32 = u_xlat15;
  let x_1215 : f32 = u_xlat29;
  u_xlat15 = (x_1214 * x_1215);
  let x_1218 : f32 = u_xlat2.x;
  let x_1219 : f32 = u_xlat15;
  u_xlat15 = (x_1218 * x_1219);
  let x_1222 : f32 = u_xlat17.x;
  let x_1224 : f32 = u_xlat17.x;
  u_xlat29 = (x_1222 * x_1224);
  let x_1226 : f32 = u_xlat29;
  u_xlat29 = max(x_1226, 0.002f);
  let x_1229 : f32 = u_xlat29;
  u_xlat17.x = (-(x_1229) + 1.0f);
  let x_1233 : f32 = u_xlat42;
  let x_1236 : f32 = u_xlat17.x;
  let x_1238 : f32 = u_xlat29;
  u_xlat46 = ((abs(x_1233) * x_1236) + x_1238);
  let x_1241 : f32 = u_xlat2.x;
  let x_1243 : f32 = u_xlat17.x;
  let x_1245 : f32 = u_xlat29;
  u_xlat17.x = ((x_1241 * x_1243) + x_1245);
  let x_1248 : f32 = u_xlat42;
  let x_1251 : f32 = u_xlat17.x;
  u_xlat42 = (abs(x_1248) * x_1251);
  let x_1254 : f32 = u_xlat2.x;
  let x_1255 : f32 = u_xlat46;
  let x_1257 : f32 = u_xlat42;
  u_xlat42 = ((x_1254 * x_1255) + x_1257);
  let x_1259 : f32 = u_xlat42;
  u_xlat42 = (x_1259 + 0.00001f);
  let x_1262 : f32 = u_xlat42;
  u_xlat42 = (0.5f / x_1262);
  let x_1264 : f32 = u_xlat29;
  let x_1265 : f32 = u_xlat29;
  u_xlat17.x = (x_1264 * x_1265);
  let x_1268 : f32 = u_xlat16;
  let x_1270 : f32 = u_xlat17.x;
  let x_1272 : f32 = u_xlat16;
  u_xlat46 = ((x_1268 * x_1270) + -(x_1272));
  let x_1275 : f32 = u_xlat46;
  let x_1276 : f32 = u_xlat16;
  u_xlat16 = ((x_1275 * x_1276) + 1.0f);
  let x_1280 : f32 = u_xlat17.x;
  u_xlat17.x = (x_1280 * 0.318309873f);
  let x_1284 : f32 = u_xlat16;
  let x_1285 : f32 = u_xlat16;
  u_xlat16 = ((x_1284 * x_1285) + 0.0000001f);
  let x_1290 : f32 = u_xlat17.x;
  let x_1291 : f32 = u_xlat16;
  u_xlat16 = (x_1290 / x_1291);
  let x_1293 : f32 = u_xlat42;
  let x_1294 : f32 = u_xlat16;
  u_xlat42 = (x_1293 * x_1294);
  let x_1297 : f32 = u_xlat2.x;
  let x_1298 : f32 = u_xlat42;
  u_xlat42 = (x_1297 * x_1298);
  let x_1300 : f32 = u_xlat42;
  u_xlat42 = (x_1300 * 3.141592741f);
  let x_1303 : f32 = u_xlat42;
  u_xlat42 = max(x_1303, 0.0f);
  let x_1305 : f32 = u_xlat29;
  let x_1306 : f32 = u_xlat29;
  u_xlat29 = ((x_1305 * x_1306) + 1.0f);
  let x_1309 : f32 = u_xlat29;
  u_xlat29 = (1.0f / x_1309);
  let x_1311 : vec3<f32> = u_xlat0;
  let x_1312 : vec3<f32> = u_xlat0;
  u_xlat2.x = dot(x_1311, x_1312);
  let x_1317 : f32 = u_xlat2.x;
  u_xlatb2 = !((x_1317 == 0.0f));
  let x_1319 : bool = u_xlatb2;
  u_xlat2.x = select(0.0f, 1.0f, x_1319);
  let x_1322 : f32 = u_xlat42;
  let x_1324 : f32 = u_xlat2.x;
  u_xlat42 = (x_1322 * x_1324);
  let x_1326 : f32 = u_xlat43;
  let x_1328 : f32 = x_37.x_Glossiness;
  let x_1330 : f32 = u_xlat44;
  u_xlat43 = ((x_1326 * x_1328) + -(x_1330));
  let x_1333 : f32 = u_xlat43;
  u_xlat43 = (x_1333 + 1.0f);
  ...
  let x_1344 : vec3<f32> = ((vec3<f32>(x_1337.x, x_1337.z, x_1337.w) * vec3<f32>(x_1339, x_1339, x_1339)) + vec3<f32>(x_1342.x, x_1342.y, x_1342.z));
  let x_1345 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1344.x, x_1344.y, x_1345.z, x_1344.z);
  let x_1347 : vec4<f32> = u_xlat3;
  let x_1349 : f32 = u_xlat42;
  let x_1351 : vec3<f32> = (vec3<f32>(x_1347.x, x_1347.z, x_1347.w) * vec3<f32>(x_1349, x_1349, x_1349));
  let x_1352 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_1351.x, x_1351.y, x_1351.z, x_1352.w);
  let x_1355 : f32 = u_xlat1.x;
  u_xlat42 = (-(x_1355) + 1.0f);
  let x_1358 : f32 = u_xlat42;
  let x_1359 : f32 = u_xlat42;
  u_xlat1.x = (x_1358 * x_1359);
  let x_1363 : f32 = u_xlat1.x;
  let x_1365 : f32 = u_xlat1.x;
  u_xlat1.x = (x_1363 * x_1365);
  let x_1368 : f32 = u_xlat42;
  let x_1370 : f32 = u_xlat1.x;
  u_xlat42 = (x_1368 * x_1370);
  let x_1372 : vec3<f32> = u_xlat0;
  let x_1375 : vec3<f32> = (-(x_1372) + vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1376 : vec4<f32> = u_xlat5;
  u_xlat5 = vec4<f32>(x_1375.x, x_1375.y, x_1375.z, x_1376.w);
  let x_1378 : vec4<f32> = u_xlat5;
  let x_1380 : f32 = u_xlat42;
  let x_1383 : vec3<f32> = u_xlat0;
  let x_1384 : vec3<f32> = ((vec3<f32>(x_1378.x, x_1378.y, x_1378.z) * vec3<f32>(x_1380, x_1380, x_1380)) + x_1383);
  let x_1385 : vec4<f32> = u_xlat5;
  u_xlat5 = vec4<f32>(x_1384.x, x_1384.y, x_1384.z, x_1385.w);
  let x_1387 : vec4<f32> = u_xlat3;
  let x_1389 : vec4<f32> = u_xlat5;
  let x_1391 : vec3<f32> = (vec3<f32>(x_1387.x, x_1387.y, x_1387.z) * vec3<f32>(x_1389.x, x_1389.y, x_1389.z));
  ...
  let x_1401 : vec3<f32> = ((vec3<f32>(x_1394.x, x_1394.y, x_1394.z) * vec3<f32>(x_1396.x, x_1396.y, x_1396.w)) + vec3<f32>(x_1399.x, x_1399.y, x_1399.z));
  let x_1402 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1401.x, x_1401.y, x_1402.z, x_1401.z);
  let x_1404 : vec4<f32> = u_xlat9;
  let x_1406 : f32 = u_xlat29;
  u_xlat1 = (vec3<f32>(x_1404.x, x_1404.y, x_1404.z) * vec3<f32>(x_1406, x_1406, x_1406));
  let x_1409 : vec3<f32> = u_xlat0;
  let x_1411 : f32 = u_xlat43;
  let x_1413 : vec3<f32> = (-(x_1409) + vec3<f32>(x_1411, x_1411, x_1411));
  ...
  u_xlat0 = ((vec3<f32>(x_1416, x_1416, x_1416) * vec3<f32>(x_1418.x, x_1418.y, x_1418.z)) + x_1421);
  let x_1423 : vec3<f32> = u_xlat1;
  let x_1424 : vec3<f32> = u_xlat0;
  let x_1426 : vec4<f32> = u_xlat2;
  u_xlat0 = ((x_1423 * x_1424) + vec3<f32>(x_1426.x, x_1426.y, x_1426.w));
  let x_1430 : f32 = vs_TEXCOORD8;
  let x_1432 : f32 = x_37.x_ProjectionParams.y;
  u_xlat42 = (x_1430 / x_1432);
  let x_1434 : f32 = u_xlat42;
  u_xlat42 = (-(x_1434) + 1.0f);
  let x_1437 : f32 = u_xlat42;
  let x_1439 : f32 = x_37.x_ProjectionParams.z;
  u_xlat42 = (x_1437 * x_1439);
  let x_1441 : f32 = u_xlat42;
  u_xlat42 = max(x_1441, 0.0f);
  let x_1443 : f32 = u_xlat42;
  let x_1446 : f32 = x_37.unity_FogParams.x;
  u_xlat42 = (x_1443 * x_1446);
  let x_1448 : f32 = u_xlat42;
  let x_1449 : f32 = u_xlat42;
  u_xlat42 = (x_1448 * -(x_1449));
  let x_1452 : f32 = u_xlat42;
  u_xlat42 = exp2(x_1452);
  let x_1454 : vec3<f32> = u_xlat0;
  let x_1457 : vec4<f32> = x_37.unity_FogColor;
  u_xlat0 = (x_1454 + -(vec3<f32>(x_1457.x, x_1457.y, x_1457.z)));
  let x_1461 : f32 = u_xlat42;
  let x_1463 : vec3<f32> = u_xlat0;
  let x_1466 : vec4<f32> = x_37.unity_FogColor;
  let x_1468 : vec3<f32> = ((vec3<f32>(x_1461, x_1461, x_1461) * x_1463) + vec3<f32>(x_1466.x, x_1466.y, x_1466.z));
  let x_1469 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1468.x, x_1468.y, x_1468.z, x_1469.w);
  return;
}
...
@fragment
fn main(@location(1) vs_TEXCOORD1_param : vec4<f32>, @location(2) vs_TEXCOORD2_param : vec4<f32>, @location(3) vs_TEXCOORD3_param : vec4<f32>, @location(4) vs_TEXCOORD4_param : vec4<f32>, @location(0) vs_TEXCOORD0_param : vec4<f32>, @location(6) vs_TEXCOORD7_param : vec3<f32>, @location(5) vs_TEXCOORD8_param : f32, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
