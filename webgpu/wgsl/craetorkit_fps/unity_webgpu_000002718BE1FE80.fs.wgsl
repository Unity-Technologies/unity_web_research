...
fn main_1() {
  ...
  let x_1370 : vec2<f32> = vs_TEXCOORD0;
  let x_1373 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1377 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1379 : vec2<f32> = ((x_1370 * vec2<f32>(x_1373.x, x_1373.y)) + vec2<f32>(x_1377.z, x_1377.w));
  let x_1380 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1379.x, x_1379.y, x_1380.z, x_1380.w);
  let x_1387 : vec4<f32> = u_xlat0;
  let x_1389 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1387.x, x_1387.y));
  u_xlat0.x = x_1389.w;
  let x_1393 : f32 = u_xlat0.x;
  u_xlat0.x = ((x_1393 * 2.0f) + -1.0f);
  let x_1399 : f32 = u_xlat0.x;
  u_xlat10.x = ((x_1399 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1405 : f32 = u_xlat10.x;
  u_xlat10.x = clamp(x_1405, 0.0f, 1.0f);
  let x_1409 : f32 = u_xlat10.x;
  u_xlat10.x = ((x_1409 * 2.0f) + -1.0f);
  let x_1414 : f32 = u_xlat0.x;
  u_xlat0.x = (-(abs(x_1414)) + 1.0f);
  let x_1420 : f32 = u_xlat0.x;
  u_xlat0.x = sqrt(x_1420);
  let x_1424 : f32 = u_xlat0.x;
  u_xlat0.x = (-(x_1424) + 1.0f);
  let x_1429 : f32 = u_xlat0.x;
  let x_1431 : f32 = u_xlat10.x;
  u_xlat0.x = (x_1429 * x_1431);
  let x_1434 : vec4<f32> = u_xlat2;
  u_xlat10 = (vec3<f32>(x_1434.x, x_1434.y, x_1434.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1439 : vec4<f32> = u_xlat2;
  u_xlat1 = max(abs(vec3<f32>(x_1439.x, x_1439.y, x_1439.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1444 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1444);
  let x_1446 : vec3<f32> = u_xlat1;
  u_xlat1 = (x_1446 * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1450 : vec3<f32> = u_xlat1;
  u_xlat1 = exp2(x_1450);
  let x_1452 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1452 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1464 : vec4<f32> = u_xlat2;
  let x_1467 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1464.x, x_1464.y, x_1464.z, x_1464.x));
  u_xlatb2 = vec3<bool>(x_1467.x, x_1467.y, x_1467.z);
  let x_1470 : vec3<f32> = u_xlat10;
  hlslcc_movcTemp = x_1470;
  let x_1472 : bool = u_xlatb2.x;
  if (x_1472) {
  ...
  hlslcc_movcTemp.x = x_1481;
  let x_1484 : bool = u_xlatb2.y;
  if (x_1484) {
    let x_1489 : f32 = u_xlat10.y;
    x_1485 = x_1489;
  } else {
  ...
  hlslcc_movcTemp.y = x_1493;
  let x_1496 : bool = u_xlatb2.z;
  if (x_1496) {
  ...
  hlslcc_movcTemp.z = x_1505;
  let x_1507 : vec3<f32> = hlslcc_movcTemp;
  u_xlat10 = x_1507;
  let x_1508 : vec4<f32> = u_xlat0;
  let x_1513 : vec3<f32> = u_xlat10;
  let x_1514 : vec3<f32> = ((vec3<f32>(x_1508.x, x_1508.x, x_1508.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + x_1513);
  let x_1515 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1514.x, x_1514.y, x_1514.z, x_1515.w);
  let x_1517 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1517.x, x_1517.y, x_1517.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1521 : vec4<f32> = u_xlat0;
  let x_1524 : vec3<f32> = (vec3<f32>(x_1521.x, x_1521.y, x_1521.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1525 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1524.x, x_1524.y, x_1524.z, x_1525.w);
  let x_1527 : vec4<f32> = u_xlat2;
  let x_1530 : vec3<f32> = (vec3<f32>(x_1527.x, x_1527.y, x_1527.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1531 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1530.x, x_1530.y, x_1530.z, x_1531.w);
  let x_1533 : vec4<f32> = u_xlat2;
  let x_1536 : vec3<f32> = max(abs(vec3<f32>(x_1533.x, x_1533.y, x_1533.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1537 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1536.x, x_1536.y, x_1536.z, x_1537.w);
  let x_1539 : vec4<f32> = u_xlat2;
  let x_1541 : vec3<f32> = log2(vec3<f32>(x_1539.x, x_1539.y, x_1539.z));
  let x_1542 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1541.x, x_1541.y, x_1541.z, x_1542.w);
  let x_1544 : vec4<f32> = u_xlat2;
  let x_1547 : vec3<f32> = (vec3<f32>(x_1544.x, x_1544.y, x_1544.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1548 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1547.x, x_1547.y, x_1547.z, x_1548.w);
  let x_1550 : vec4<f32> = u_xlat2;
  let x_1552 : vec3<f32> = exp2(vec3<f32>(x_1550.x, x_1550.y, x_1550.z));
  let x_1553 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1552.x, x_1552.y, x_1552.z, x_1553.w);
  let x_1557 : vec4<f32> = u_xlat0;
  let x_1559 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1557.x, x_1557.y, x_1557.z, x_1557.x));
  u_xlatb0 = vec3<bool>(x_1559.x, x_1559.y, x_1559.z);
  ...
  u_xlat3.x = x_1571;
  let x_1574 : bool = u_xlatb0.y;
  if (x_1574) {
    let x_1579 : f32 = u_xlat1.y;
    x_1575 = x_1579;
  } else {
    let x_1582 : f32 = u_xlat2.y;
    x_1575 = x_1582;
  }
  let x_1583 : f32 = x_1575;
  u_xlat3.y = x_1583;
  let x_1586 : bool = u_xlatb0.z;
  if (x_1586) {
    let x_1591 : f32 = u_xlat1.z;
    x_1587 = x_1591;
  } else {
