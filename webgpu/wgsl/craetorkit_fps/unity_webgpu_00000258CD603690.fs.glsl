...
layout(set = 0, binding = 15) uniform mediump  sampler sampler_GrainTex;
void main()
{
vec4 u_xlat0;
bvec3 u_xlatb0;
...
float u_xlat15;
    ...
    u_xlat2 = u_xlat2 + u_xlat3;
    u_xlat3 = texture(sampler2D(_BloomTex, sampler_BloomTex), u_xlat1.xy);
    ...
    u_xlat6.xyz = texture(sampler2D(_GrainTex, sampler_GrainTex), u_xlat6.xy).xyz;
    ...
    u_xlat5.xyz = texture(sampler2D(_Lut2D, sampler_Lut2D), u_xlat5.xy).xyz;
