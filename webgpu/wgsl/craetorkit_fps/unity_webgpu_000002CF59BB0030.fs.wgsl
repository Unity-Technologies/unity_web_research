...
fn main_1() {
  ...
  u_xlat1 = vec4<f32>(x_1088.x, x_1088.y, x_1088.z, x_1089.w);
  let x_1091 : vec4<f32> = u_xlat2;
  u_xlat3 = (x_1091 * vec4<f32>(0.25f, 0.25f, 0.25f, 0.25f));
  ...
  u_xlat1 = vec4<f32>(x_1100.x, x_1100.y, x_1100.z, x_1101.w);
  u_xlat1.w = 0.0f;
  ...
  let x_1128 : vec2<f32> = vs_TEXCOORD1;
  let x_1131 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1135 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1137 : vec2<f32> = ((x_1128 * vec2<f32>(x_1131.x, x_1131.y)) + vec2<f32>(x_1135.z, x_1135.w));
  let x_1138 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1137.x, x_1137.y, x_1138.z, x_1138.w);
  let x_1145 : vec4<f32> = u_xlat1;
  let x_1147 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1145.x, x_1145.y));
  let x_1148 : vec3<f32> = vec3<f32>(x_1147.x, x_1147.y, x_1147.z);
  let x_1149 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1148.x, x_1148.y, x_1148.z, x_1149.w);
  ...
  let x_1159 : vec3<f32> = clamp(vec3<f32>(x_1155.x, x_1155.y, x_1155.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1160 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1159.x, x_1159.y, x_1159.z, x_1160.w);
  let x_1162 : vec4<f32> = u_xlat2;
  u_xlat31 = dot(vec3<f32>(x_1162.x, x_1162.y, x_1162.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1169 : f32 = u_xlat31;
  u_xlat31 = sqrt(x_1169);
  let x_1173 : f32 = x_26.x_Grain_Params1.x;
  let x_1174 : f32 = u_xlat31;
  u_xlat31 = ((x_1173 * -(x_1174)) + 1.0f);
  ...
  u_xlat1 = vec4<f32>(x_1182.x, x_1182.y, x_1182.z, x_1183.w);
  let x_1185 : vec4<f32> = u_xlat1;
  let x_1188 : f32 = x_26.x_Grain_Params1.y;
  let x_1190 : f32 = x_26.x_Grain_Params1.y;
  let x_1192 : f32 = x_26.x_Grain_Params1.y;
  let x_1194 : vec3<f32> = (vec3<f32>(x_1185.x, x_1185.y, x_1185.z) * vec3<f32>(x_1188, x_1190, x_1192));
  let x_1195 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1194.x, x_1194.y, x_1194.z, x_1195.w);
  let x_1197 : vec4<f32> = u_xlat1;
  let x_1199 : f32 = u_xlat31;
  ...
  let x_1211 : vec3<f32> = clamp(vec3<f32>(x_1207.x, x_1207.y, x_1207.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  ...
  let x_1223 : vec3<f32> = (vec3<f32>(x_1219.z, x_1219.x, x_1219.y) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1224 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1223.x, x_1223.y, x_1223.z, x_1224.w);
  let x_1226 : vec4<f32> = u_xlat0;
  let x_1230 : vec3<f32> = max(vec3<f32>(x_1226.z, x_1226.x, x_1226.y), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1231 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1230.x, x_1230.y, x_1230.z, x_1231.w);
  let x_1233 : vec4<f32> = u_xlat2;
  let x_1235 : vec3<f32> = log2(vec3<f32>(x_1233.x, x_1233.y, x_1233.z));
  let x_1236 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1235.x, x_1235.y, x_1235.z, x_1236.w);
  let x_1238 : vec4<f32> = u_xlat2;
  let x_1242 : vec3<f32> = (vec3<f32>(x_1238.x, x_1238.y, x_1238.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1243 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1242.x, x_1242.y, x_1242.z, x_1243.w);
  let x_1245 : vec4<f32> = u_xlat2;
  let x_1247 : vec3<f32> = exp2(vec3<f32>(x_1245.x, x_1245.y, x_1245.z));
  let x_1248 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1247.x, x_1247.y, x_1247.z, x_1248.w);
  let x_1250 : vec4<f32> = u_xlat2;
  let x_1257 : vec3<f32> = ((vec3<f32>(x_1250.x, x_1250.y, x_1250.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1258 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1257.x, x_1257.y, x_1257.z, x_1258.w);
  let x_1265 : vec4<f32> = u_xlat0;
  let x_1268 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1265.z, x_1265.x, x_1265.y, x_1265.z));
  u_xlatb0 = vec3<bool>(x_1268.x, x_1268.y, x_1268.z);
  let x_1271 : bool = u_xlatb0.x;
  if (x_1271) {
  ...
  u_xlat0.x = x_1280;
  let x_1283 : bool = u_xlatb0.y;
  if (x_1283) {
    let x_1288 : f32 = u_xlat1.y;
    x_1284 = x_1288;
  } else {
    let x_1291 : f32 = u_xlat2.y;
    x_1284 = x_1291;
  }
  ...
  let x_1313 : vec3<f32> = (vec3<f32>(x_1307.x, x_1307.y, x_1307.z) * vec3<f32>(x_1311.z, x_1311.z, x_1311.z));
  let x_1314 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1313.x, x_1313.y, x_1313.z, x_1314.w);
  let x_1318 : f32 = u_xlat1.x;
  u_xlat10 = floor(x_1318);
  let x_1321 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1323 : vec2<f32> = (vec2<f32>(x_1321.x, x_1321.y) * vec2<f32>(0.5f, 0.5f));
  let x_1324 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1323.x, x_1324.y, x_1324.z, x_1323.y);
  let x_1326 : vec4<f32> = u_xlat1;
  let x_1329 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1332 : vec4<f32> = u_xlat1;
  let x_1334 : vec2<f32> = ((vec2<f32>(x_1326.y, x_1326.z) * vec2<f32>(x_1329.x, x_1329.y)) + vec2<f32>(x_1332.x, x_1332.w));
  let x_1335 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1335.x, x_1334.x, x_1334.y, x_1335.w);
  let x_1337 : f32 = u_xlat10;
  let x_1339 : f32 = x_26.x_Lut2D_Params.y;
  let x_1342 : f32 = u_xlat1.y;
  u_xlat1.x = ((x_1337 * x_1339) + x_1342);
  let x_1350 : vec4<f32> = u_xlat1;
  let x_1352 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1350.x, x_1350.z));
  let x_1353 : vec3<f32> = vec3<f32>(x_1352.x, x_1352.y, x_1352.z);
  let x_1354 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1353.x, x_1353.y, x_1353.z, x_1354.w);
  let x_1357 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat3.x = x_1357;
  u_xlat3.y = 0.0f;
  let x_1360 : vec4<f32> = u_xlat1;
  let x_1362 : vec4<f32> = u_xlat3;
  let x_1364 : vec2<f32> = (vec2<f32>(x_1360.x, x_1360.z) + vec2<f32>(x_1362.x, x_1362.y));
  let x_1365 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1364.x, x_1364.y, x_1365.z, x_1365.w);
  let x_1370 : vec4<f32> = u_xlat1;
  let x_1372 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1370.x, x_1370.y));
  ...
  let x_1379 : f32 = x_26.x_Lut2D_Params.z;
  let x_1381 : f32 = u_xlat10;
  u_xlat0.x = ((x_1377 * x_1379) + -(x_1381));
  let x_1385 : vec4<f32> = u_xlat2;
  let x_1388 : vec4<f32> = u_xlat1;
  let x_1390 : vec3<f32> = (-(vec3<f32>(x_1385.x, x_1385.y, x_1385.z)) + vec3<f32>(x_1388.x, x_1388.y, x_1388.z));
  let x_1391 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1390.x, x_1390.y, x_1390.z, x_1391.w);
  let x_1393 : vec4<f32> = u_xlat0;
  let x_1395 : vec4<f32> = u_xlat1;
  let x_1398 : vec4<f32> = u_xlat2;
  let x_1400 : vec3<f32> = ((vec3<f32>(x_1393.x, x_1393.x, x_1393.x) * vec3<f32>(x_1395.x, x_1395.y, x_1395.z)) + vec3<f32>(x_1398.x, x_1398.y, x_1398.z));
  let x_1401 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1400.x, x_1400.y, x_1400.z, x_1401.w);
  let x_1403 : vec4<f32> = u_xlat0;
  let x_1407 : vec3<f32> = (vec3<f32>(x_1403.x, x_1403.y, x_1403.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1408 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1407.x, x_1407.y, x_1407.z, x_1408.w);
  let x_1410 : vec4<f32> = u_xlat0;
  let x_1414 : vec3<f32> = (vec3<f32>(x_1410.x, x_1410.y, x_1410.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1415 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1414.x, x_1414.y, x_1414.z, x_1415.w);
  let x_1417 : vec4<f32> = u_xlat2;
  let x_1421 : vec3<f32> = (vec3<f32>(x_1417.x, x_1417.y, x_1417.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1422 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1421.x, x_1421.y, x_1421.z, x_1422.w);
  let x_1424 : vec4<f32> = u_xlat2;
  let x_1427 : vec3<f32> = max(abs(vec3<f32>(x_1424.x, x_1424.y, x_1424.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1428 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1427.x, x_1427.y, x_1427.z, x_1428.w);
  let x_1430 : vec4<f32> = u_xlat2;
  let x_1432 : vec3<f32> = log2(vec3<f32>(x_1430.x, x_1430.y, x_1430.z));
  let x_1433 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1432.x, x_1432.y, x_1432.z, x_1433.w);
  let x_1435 : vec4<f32> = u_xlat2;
  let x_1439 : vec3<f32> = (vec3<f32>(x_1435.x, x_1435.y, x_1435.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1451 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1449.x, x_1449.y, x_1449.z, x_1449.x));
  ...
  u_xlat0.z = x_1487;
  let x_1489 : vec2<f32> = vs_TEXCOORD0;
  let x_1492 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1496 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1498 : vec2<f32> = ((x_1489 * vec2<f32>(x_1492.x, x_1492.y)) + vec2<f32>(x_1496.z, x_1496.w));
  let x_1499 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1498.x, x_1498.y, x_1499.z, x_1499.w);
  let x_1506 : vec4<f32> = u_xlat1;
  let x_1508 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1506.x, x_1506.y));
  u_xlat1.x = x_1508.w;
  let x_1512 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1512 * 2.0f) + -1.0f);
  let x_1517 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1517 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1523 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1523, 0.0f, 1.0f);
  let x_1527 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1527 * 2.0f) + -1.0f);
  let x_1532 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1532)) + 1.0f);
  let x_1538 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1538);
  let x_1542 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1542) + 1.0f);
  let x_1547 : f32 = u_xlat1.x;
  let x_1549 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1547 * x_1549);
  let x_1552 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1552.x, x_1552.y, x_1552.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1555 : vec4<f32> = u_xlat0;
  let x_1558 : vec3<f32> = max(abs(vec3<f32>(x_1555.x, x_1555.y, x_1555.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1559 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1558.x, x_1558.y, x_1558.z, x_1559.w);
  let x_1561 : vec4<f32> = u_xlat2;
  let x_1563 : vec3<f32> = log2(vec3<f32>(x_1561.x, x_1561.y, x_1561.z));
  let x_1564 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1563.x, x_1563.y, x_1563.z, x_1564.w);
  let x_1566 : vec4<f32> = u_xlat2;
  let x_1568 : vec3<f32> = (vec3<f32>(x_1566.x, x_1566.y, x_1566.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  ...
  let x_1579 : vec3<f32> = ((vec3<f32>(x_1576.x, x_1576.y, x_1576.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1580 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1579.x, x_1579.y, x_1579.z, x_1580.w);
  let x_1582 : vec4<f32> = u_xlat0;
  let x_1584 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1582.x, x_1582.y, x_1582.z, x_1582.x));
  u_xlatb0 = vec3<bool>(x_1584.x, x_1584.y, x_1584.z);
  let x_1587 : bool = u_xlatb0.x;
  if (x_1587) {
  ...
  let x_1596 : f32 = x_1588;
  u_xlat0.x = x_1596;
  let x_1599 : bool = u_xlatb0.y;
  if (x_1599) {
    let x_1604 : f32 = u_xlat11.y;
    x_1600 = x_1604;
  } else {
    let x_1607 : f32 = u_xlat2.y;
    x_1600 = x_1607;
  }
  let x_1608 : f32 = x_1600;
  u_xlat0.y = x_1608;
  let x_1611 : bool = u_xlatb0.z;
  if (x_1611) {
  ...
  let x_1620 : f32 = x_1612;
  u_xlat0.z = x_1620;
  let x_1622 : vec4<f32> = u_xlat1;
  let x_1627 : vec4<f32> = u_xlat0;
  let x_1629 : vec3<f32> = ((vec3<f32>(x_1622.x, x_1622.x, x_1622.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1627.x, x_1627.y, x_1627.z));
  let x_1630 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1629.x, x_1629.y, x_1629.z, x_1630.w);
  let x_1632 : vec4<f32> = u_xlat0;
  let x_1634 : vec3<f32> = (vec3<f32>(x_1632.x, x_1632.y, x_1632.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1635 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1634.x, x_1634.y, x_1634.z, x_1635.w);
  let x_1637 : vec4<f32> = u_xlat0;
  let x_1639 : vec3<f32> = (vec3<f32>(x_1637.x, x_1637.y, x_1637.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1640 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1639.x, x_1639.y, x_1639.z, x_1640.w);
  let x_1642 : vec4<f32> = u_xlat2;
  let x_1644 : vec3<f32> = (vec3<f32>(x_1642.x, x_1642.y, x_1642.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1645 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1644.x, x_1644.y, x_1644.z, x_1645.w);
  let x_1647 : vec4<f32> = u_xlat2;
  let x_1650 : vec3<f32> = max(abs(vec3<f32>(x_1647.x, x_1647.y, x_1647.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1651 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1650.x, x_1650.y, x_1650.z, x_1651.w);
  let x_1653 : vec4<f32> = u_xlat2;
  let x_1655 : vec3<f32> = log2(vec3<f32>(x_1653.x, x_1653.y, x_1653.z));
  ...
  let x_1675 : bool = u_xlatb0.x;
  if (x_1675) {
    let x_1680 : f32 = u_xlat1.x;
    x_1676 = x_1680;
  } else {
    let x_1683 : f32 = u_xlat2.x;
    x_1676 = x_1683;
  }
  let x_1684 : f32 = x_1676;
  SV_Target0.x = x_1684;
  let x_1688 : bool = u_xlatb0.y;
  if (x_1688) {
    let x_1693 : f32 = u_xlat1.y;
    x_1689 = x_1693;
  } else {
    let x_1696 : f32 = u_xlat2.y;
    x_1689 = x_1696;
  }
  let x_1697 : f32 = x_1689;
  SV_Target0.y = x_1697;
  let x_1700 : bool = u_xlatb0.z;
  if (x_1700) {
    let x_1705 : f32 = u_xlat1.z;
    x_1701 = x_1705;
  } else {
