...
fn main_1() {
  ...
  u_xlat0 = ((vec4<f32>(x_460.w, x_460.x, x_460.y, x_460.z) * vec4<f32>(x_462.w, x_462.x, x_462.y, x_462.z)) + vec4<f32>(x_465.w, x_465.x, x_465.y, x_465.z));
  let x_473 : f32 = x_55.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_473);
  let x_475 : bool = u_xlatb1;
  if (x_475) {
    let x_478 : vec4<f32> = u_xlat0;
    let x_479 : vec3<f32> = vec3<f32>(x_478.y, x_478.z, x_478.w);
    ...
    u_xlat0.x = dot(vec3<f32>(x_489.x, x_489.y, x_489.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_499 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_499.y, x_499.z, x_499.w, x_499.x);
  return;
}
