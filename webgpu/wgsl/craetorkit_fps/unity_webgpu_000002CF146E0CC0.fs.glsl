...
bool u_xlatb9;
    ...
    u_xlat6.xy = texture(sampler2D(_MainTex, sampler_MainTex), u_xlat0.zw).xy;
    ...
    u_xlat7.xy = texture(sampler2D(_MainTex, sampler_MainTex), vs_TEXCOORD0.xy).xy;
    u_xlat7.xy = u_xlat7.xy * vec2(1.00999999, 1.00999999);
    ...
    u_xlat7.xy = texture(sampler2D(_MainTex, sampler_MainTex), u_xlat2.zw).xy;
    u_xlat2.xy = texture(sampler2D(_MainTex, sampler_MainTex), u_xlat2.xy).xy;
