...
fn main_1() {
  ...
  let x_214 : f32 = x_17.unity_LightShadowBias.x;
  let x_217 : f32 = u_xlat0.w;
  u_xlat1.x = (x_214 / x_217);
  let x_221 : f32 = u_xlat1.x;
  u_xlat1.x = min(x_221, 0.0f);
  let x_225 : f32 = u_xlat1.x;
  u_xlat1.x = max(x_225, -1.0f);
  let x_231 : f32 = u_xlat0.z;
  let x_233 : f32 = u_xlat1.x;
  u_xlat6 = (x_231 + x_233);
  let x_236 : f32 = u_xlat0.w;
  let x_237 : f32 = u_xlat6;
  u_xlat1.x = min(x_236, x_237);
  let x_244 : vec4<f32> = u_xlat0;
  let x_245 : vec3<f32> = vec3<f32>(x_244.x, x_244.y, x_244.w);
  let x_247 : vec4<f32> = gl_Position;
  gl_Position = vec4<f32>(x_245.x, x_245.y, x_247.z, x_245.z);
  let x_249 : f32 = u_xlat6;
  let x_252 : f32 = u_xlat1.x;
  u_xlat0.x = (-(x_249) + x_252);
  let x_256 : f32 = x_17.unity_LightShadowBias.y;
  let x_258 : f32 = u_xlat0.x;
  let x_260 : f32 = u_xlat6;
  gl_Position.z = ((x_256 * x_258) + x_260);
  return;
}
