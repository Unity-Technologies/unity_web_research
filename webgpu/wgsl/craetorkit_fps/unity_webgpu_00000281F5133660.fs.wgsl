...
fn main_1() {
  ...
  let x_1127 : vec2<f32> = vs_TEXCOORD0;
  let x_1130 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1134 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1136 : vec2<f32> = ((x_1127 * vec2<f32>(x_1130.x, x_1130.y)) + vec2<f32>(x_1134.z, x_1134.w));
  let x_1137 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1136.x, x_1136.y, x_1137.z, x_1137.w);
  let x_1144 : vec4<f32> = u_xlat1;
  let x_1146 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1144.x, x_1144.y));
  u_xlat1.x = x_1146.w;
  let x_1150 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1150 * 2.0f) + -1.0f);
  let x_1155 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1155 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1161 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1161, 0.0f, 1.0f);
  let x_1165 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1165 * 2.0f) + -1.0f);
  let x_1170 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1170)) + 1.0f);
  let x_1176 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1176);
  let x_1180 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1180) + 1.0f);
  let x_1185 : f32 = u_xlat1.x;
  let x_1187 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1185 * x_1187);
  let x_1190 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1190.x, x_1190.y, x_1190.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1195 : vec4<f32> = u_xlat0;
  let x_1200 : vec3<f32> = max(abs(vec3<f32>(x_1195.x, x_1195.y, x_1195.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1201 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1200.x, x_1200.y, x_1200.z, x_1201.w);
  let x_1203 : vec4<f32> = u_xlat2;
  let x_1205 : vec3<f32> = log2(vec3<f32>(x_1203.x, x_1203.y, x_1203.z));
  let x_1206 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1205.x, x_1205.y, x_1205.z, x_1206.w);
  let x_1208 : vec4<f32> = u_xlat2;
  let x_1212 : vec3<f32> = (vec3<f32>(x_1208.x, x_1208.y, x_1208.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1213 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1212.x, x_1212.y, x_1212.z, x_1213.w);
  let x_1215 : vec4<f32> = u_xlat2;
  let x_1217 : vec3<f32> = exp2(vec3<f32>(x_1215.x, x_1215.y, x_1215.z));
  let x_1218 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1217.x, x_1217.y, x_1217.z, x_1218.w);
  let x_1220 : vec4<f32> = u_xlat2;
  let x_1227 : vec3<f32> = ((vec3<f32>(x_1220.x, x_1220.y, x_1220.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1228 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1227.x, x_1227.y, x_1227.z, x_1228.w);
  let x_1235 : vec4<f32> = u_xlat0;
  let x_1238 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1235.x, x_1235.y, x_1235.z, x_1235.x));
  u_xlatb0 = vec3<bool>(x_1238.x, x_1238.y, x_1238.z);
  let x_1241 : bool = u_xlatb0.x;
  if (x_1241) {
  ...
  u_xlat0.y = x_1262;
  let x_1266 : bool = u_xlatb0.z;
  if (x_1266) {
    let x_1271 : f32 = u_xlat11.z;
    x_1267 = x_1271;
  } else {
    let x_1274 : f32 = u_xlat2.z;
    x_1267 = x_1274;
  }
  let x_1275 : f32 = x_1267;
  u_xlat0.z = x_1275;
  let x_1277 : vec4<f32> = u_xlat1;
  let x_1282 : vec4<f32> = u_xlat0;
  let x_1284 : vec3<f32> = ((vec3<f32>(x_1277.x, x_1277.x, x_1277.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1282.x, x_1282.y, x_1282.z));
  let x_1285 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1284.x, x_1284.y, x_1284.z, x_1285.w);
  let x_1287 : vec4<f32> = u_xlat0;
  let x_1291 : vec3<f32> = (vec3<f32>(x_1287.x, x_1287.y, x_1287.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1292 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1291.x, x_1291.y, x_1291.z, x_1292.w);
  let x_1294 : vec4<f32> = u_xlat0;
  let x_1298 : vec3<f32> = (vec3<f32>(x_1294.x, x_1294.y, x_1294.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1299 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1298.x, x_1298.y, x_1298.z, x_1299.w);
  let x_1301 : vec4<f32> = u_xlat2;
  let x_1305 : vec3<f32> = (vec3<f32>(x_1301.x, x_1301.y, x_1301.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1306 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1305.x, x_1305.y, x_1305.z, x_1306.w);
  let x_1308 : vec4<f32> = u_xlat2;
  let x_1311 : vec3<f32> = max(abs(vec3<f32>(x_1308.x, x_1308.y, x_1308.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1312 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1311.x, x_1311.y, x_1311.z, x_1312.w);
  let x_1314 : vec4<f32> = u_xlat2;
  let x_1316 : vec3<f32> = log2(vec3<f32>(x_1314.x, x_1314.y, x_1314.z));
  let x_1317 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1316.x, x_1316.y, x_1316.z, x_1317.w);
  let x_1319 : vec4<f32> = u_xlat2;
  let x_1323 : vec3<f32> = (vec3<f32>(x_1319.x, x_1319.y, x_1319.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  ...
  let x_1335 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1333.x, x_1333.y, x_1333.z, x_1333.x));
  u_xlatb0 = vec3<bool>(x_1335.x, x_1335.y, x_1335.z);
  let x_1340 : bool = u_xlatb0.x;
  if (x_1340) {
  ...
  SV_Target0.x = x_1349;
  let x_1353 : bool = u_xlatb0.y;
  if (x_1353) {
    let x_1358 : f32 = u_xlat1.y;
    x_1354 = x_1358;
  } else {
    let x_1361 : f32 = u_xlat2.y;
    x_1354 = x_1361;
  }
  let x_1362 : f32 = x_1354;
  SV_Target0.y = x_1362;
  let x_1365 : bool = u_xlatb0.z;
  if (x_1365) {
    let x_1370 : f32 = u_xlat1.z;
    x_1366 = x_1370;
  } else {
    let x_1373 : f32 = u_xlat2.z;
    x_1366 = x_1373;
  }
  let x_1374 : f32 = x_1366;
  SV_Target0.z = x_1374;
  let x_1377 : f32 = u_xlat0.w;
  SV_Target0.w = x_1377;
  return;
}
