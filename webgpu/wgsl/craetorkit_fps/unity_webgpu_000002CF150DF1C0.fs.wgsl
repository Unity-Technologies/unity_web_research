...
@group(1) @binding(0) var<uniform> x_191 : PGlobals;
...
fn main_1() {
  ...
  let x_196 : vec4<f32> = x_191.x_Color;
  u_xlat2 = (x_188 * x_196);
  ...
  let x_268 : f32 = x_191.x_EmissionColor.x;
  let x_270 : f32 = x_191.x_EmissionColor.y;
  let x_272 : f32 = x_191.x_EmissionColor.z;
...
@fragment
fn main(@location(0) vs_COLOR0_param : vec4<f32>, @location(1) vs_TEXCOORD1_param : vec2<f32>, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
