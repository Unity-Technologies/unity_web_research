...
fn main_1() {
  ...
  let x_827 : f32 = x_32.x_PostExposure;
  let x_829 : f32 = x_32.x_PostExposure;
  let x_831 : f32 = x_32.x_PostExposure;
  let x_833 : f32 = x_32.x_PostExposure;
  ...
  let x_878 : vec2<f32> = x_32.x_Lut3D_Params;
  ...
  let x_884 : f32 = x_32.x_Lut3D_Params.x;
  u_xlat19 = (x_884 * 0.5f);
  let x_886 : vec4<f32> = u_xlat1;
  let x_889 : vec2<f32> = x_32.x_Lut3D_Params;
  ...
  let x_914 : f32 = x_32.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_914);
