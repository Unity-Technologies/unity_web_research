...
fn main_1() {
  ...
  let x_954 : f32 = x_26.x_PostExposure;
  ...
  u_xlat0 = (vec4<f32>(x_950.w, x_950.x, x_950.y, x_950.z) * vec4<f32>(x_961.x, x_961.y, x_961.z, x_961.w));
  let x_968 : vec4<f32> = u_xlat0;
  let x_975 : vec3<f32> = ((vec3<f32>(x_968.y, x_968.z, x_968.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_976 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_975.x, x_975.y, x_975.z, x_976.w);
  let x_978 : vec4<f32> = u_xlat1;
  let x_980 : vec3<f32> = log2(vec3<f32>(x_978.x, x_978.y, x_978.z));
  let x_981 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_980.x, x_980.y, x_980.z, x_981.w);
  let x_983 : vec4<f32> = u_xlat1;
  let x_990 : vec3<f32> = ((vec3<f32>(x_983.x, x_983.y, x_983.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  ...
  let x_1005 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1007 : vec3<f32> = (vec3<f32>(x_1000.x, x_1000.y, x_1000.z) * vec3<f32>(x_1005.y, x_1005.y, x_1005.y));
  let x_1008 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1007.x, x_1007.y, x_1007.z, x_1008.w);
  let x_1011 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat31 = (x_1011 * 0.5f);
  let x_1013 : vec4<f32> = u_xlat1;
  let x_1016 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1019 : f32 = u_xlat31;
  let x_1021 : vec3<f32> = ((vec3<f32>(x_1013.x, x_1013.y, x_1013.z) * vec3<f32>(x_1016.x, x_1016.x, x_1016.x)) + vec3<f32>(x_1019, x_1019, x_1019));
  let x_1022 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1021.x, x_1021.y, x_1021.z, x_1022.w);
  let x_1032 : vec4<f32> = u_xlat1;
  let x_1034 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1032.x, x_1032.y, x_1032.z));
  let x_1035 : vec3<f32> = vec3<f32>(x_1034.x, x_1034.y, x_1034.z);
  let x_1036 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1036.x, x_1035.x, x_1035.y, x_1035.z);
  let x_1040 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1040);
  let x_1042 : bool = u_xlatb1;
  if (x_1042) {
    ...
    let x_1053 : vec3<f32> = clamp(vec3<f32>(x_1049.x, x_1049.y, x_1049.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1054 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1053.x, x_1053.y, x_1053.z, x_1054.w);
    let x_1056 : vec4<f32> = u_xlat1;
    u_xlat0.x = dot(vec3<f32>(x_1056.x, x_1056.y, x_1056.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_1062 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_1062.y, x_1062.z, x_1062.w, x_1062.x);
  return;
}
