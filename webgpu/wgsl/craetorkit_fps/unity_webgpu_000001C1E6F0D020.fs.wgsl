...
fn main_1() {
  ...
  if (x_986) {
    ...
    SV_Target0.w = ((x_1116 * x_1118) + 1.0f);
  } else {
    let x_1129 : vec2<f32> = u_xlat21;
    let x_1130 : vec4<f32> = textureSample(x_Vignette_Mask, sampler_Vignette_Mask, x_1129);
    u_xlat1.x = x_1130.w;
    let x_1134 : f32 = u_xlat1.x;
    u_xlat1.z = (x_1134 + 0.055f);
    let x_1138 : vec3<f32> = u_xlat1;
    let x_1143 : vec2<f32> = (vec2<f32>(x_1138.x, x_1138.z) * vec2<f32>(0.077399381f, 0.947867334f));
    let x_1144 : vec3<f32> = u_xlat11;
    u_xlat11 = vec3<f32>(x_1143.x, x_1143.y, x_1144.z);
    let x_1147 : f32 = u_xlat11.y;
    u_xlat21.x = max(abs(x_1147), 1.1920929e-07f);
    let x_1153 : f32 = u_xlat21.x;
    u_xlat21.x = log2(x_1153);
    let x_1157 : f32 = u_xlat21.x;
    u_xlat21.x = (x_1157 * 2.400000095f);
    let x_1162 : f32 = u_xlat21.x;
    u_xlat21.x = exp2(x_1162);
    let x_1167 : f32 = u_xlat1.x;
    u_xlatb1 = (0.040449999f >= x_1167);
    let x_1169 : bool = u_xlatb1;
    if (x_1169) {
      let x_1174 : f32 = u_xlat11.x;
      x_1170 = x_1174;
    } else {
      let x_1177 : f32 = u_xlat21.x;
      x_1170 = x_1177;
    }
    let x_1178 : f32 = x_1170;
    u_xlat1.x = x_1178;
    let x_1181 : vec3<f32> = x_26.x_Vignette_Color;
    u_xlat11 = (-(x_1181) + vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1184 : vec3<f32> = u_xlat1;
    let x_1186 : vec3<f32> = u_xlat11;
    let x_1189 : vec3<f32> = x_26.x_Vignette_Color;
    u_xlat11 = ((vec3<f32>(x_1184.x, x_1184.x, x_1184.x) * x_1186) + x_1189);
    let x_1191 : vec4<f32> = u_xlat0;
    let x_1193 : vec3<f32> = u_xlat11;
    let x_1195 : vec4<f32> = u_xlat0;
    u_xlat11 = ((vec3<f32>(x_1191.x, x_1191.y, x_1191.z) * x_1193) + -(vec3<f32>(x_1195.x, x_1195.y, x_1195.z)));
    let x_1201 : f32 = x_26.x_Vignette_Opacity;
    let x_1203 : vec3<f32> = u_xlat11;
    let x_1205 : vec4<f32> = u_xlat0;
    u_xlat2 = ((vec3<f32>(x_1201, x_1201, x_1201) * x_1203) + vec3<f32>(x_1205.x, x_1205.y, x_1205.z));
    let x_1209 : f32 = u_xlat0.w;
    u_xlat0.x = (x_1209 + -1.0f);
    let x_1213 : f32 = u_xlat1.x;
    let x_1215 : f32 = u_xlat0.x;
    SV_Target0.w = ((x_1213 * x_1215) + 1.0f);
  }
  let x_1220 : vec2<f32> = vs_TEXCOORD1;
  let x_1223 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1227 : vec4<f32> = x_26.x_Grain_Params2;
  let x_1229 : vec2<f32> = ((x_1220 * vec2<f32>(x_1223.x, x_1223.y)) + vec2<f32>(x_1227.z, x_1227.w));
  let x_1230 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1229.x, x_1229.y, x_1230.z, x_1230.w);
  let x_1237 : vec4<f32> = u_xlat0;
  let x_1239 : vec4<f32> = textureSample(x_GrainTex, sampler_GrainTex, vec2<f32>(x_1237.x, x_1237.y));
  let x_1240 : vec3<f32> = vec3<f32>(x_1239.x, x_1239.y, x_1239.z);
  ...
  u_xlat1 = clamp(x_1244, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1249 : vec3<f32> = u_xlat1;
  u_xlat30 = dot(x_1249, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  let x_1255 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1255);
  let x_1259 : f32 = x_26.x_Grain_Params1.x;
  let x_1260 : f32 = u_xlat30;
  u_xlat30 = ((x_1259 * -(x_1260)) + 1.0f);
  let x_1264 : vec4<f32> = u_xlat0;
  let x_1266 : vec3<f32> = u_xlat2;
  let x_1267 : vec3<f32> = (vec3<f32>(x_1264.x, x_1264.y, x_1264.z) * x_1266);
  let x_1268 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1267.x, x_1267.y, x_1267.z, x_1268.w);
  let x_1270 : vec4<f32> = u_xlat0;
  let x_1273 : f32 = x_26.x_Grain_Params1.y;
  let x_1275 : f32 = x_26.x_Grain_Params1.y;
  let x_1277 : f32 = x_26.x_Grain_Params1.y;
  let x_1279 : vec3<f32> = (vec3<f32>(x_1270.x, x_1270.y, x_1270.z) * vec3<f32>(x_1273, x_1275, x_1277));
  ...
  let x_1288 : vec3<f32> = ((vec3<f32>(x_1282.x, x_1282.y, x_1282.z) * vec3<f32>(x_1284, x_1284, x_1284)) + x_1287);
  let x_1289 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1288.x, x_1288.y, x_1288.z, x_1289.w);
  let x_1291 : vec2<f32> = vs_TEXCOORD0;
  let x_1294 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1298 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1300 : vec2<f32> = ((x_1291 * vec2<f32>(x_1294.x, x_1294.y)) + vec2<f32>(x_1298.z, x_1298.w));
  let x_1301 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1300.x, x_1300.y, x_1301.z);
  let x_1308 : vec3<f32> = u_xlat1;
  let x_1310 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1308.x, x_1308.y));
  u_xlat30 = x_1310.w;
  let x_1312 : f32 = u_xlat30;
  u_xlat30 = ((x_1312 * 2.0f) + -1.0f);
  let x_1315 : f32 = u_xlat30;
  u_xlat1.x = ((x_1315 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1321 : f32 = u_xlat1.x;
  u_xlat1.x = clamp(x_1321, 0.0f, 1.0f);
  let x_1325 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1325 * 2.0f) + -1.0f);
  let x_1329 : f32 = u_xlat30;
  u_xlat30 = (-(abs(x_1329)) + 1.0f);
  let x_1333 : f32 = u_xlat30;
  u_xlat30 = sqrt(x_1333);
  let x_1335 : f32 = u_xlat30;
  u_xlat30 = (-(x_1335) + 1.0f);
  let x_1338 : f32 = u_xlat30;
  let x_1340 : f32 = u_xlat1.x;
  u_xlat30 = (x_1338 * x_1340);
  let x_1342 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1342.x, x_1342.y, x_1342.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1347 : vec4<f32> = u_xlat0;
  u_xlat2 = max(abs(vec3<f32>(x_1347.x, x_1347.y, x_1347.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  ...
  u_xlat2 = ((x_1360 * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1372 : vec4<f32> = u_xlat0;
  let x_1375 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1372.x, x_1372.y, x_1372.z, x_1372.x));
  ...
  let x_1420 : vec3<f32> = ((vec3<f32>(x_1413, x_1413, x_1413) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1418.x, x_1418.y, x_1418.z));
  let x_1421 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1420.x, x_1420.y, x_1420.z, x_1421.w);
  let x_1423 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1423.x, x_1423.y, x_1423.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1427 : vec4<f32> = u_xlat0;
  u_xlat2 = (vec3<f32>(x_1427.x, x_1427.y, x_1427.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1431 : vec3<f32> = u_xlat2;
  u_xlat2 = (x_1431 * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  ...
  let x_1447 : vec4<bool> = (vec4<f32>(0.040449999f, 0.040449999f, 0.040449999f, 0.0f) >= vec4<f32>(x_1445.x, x_1445.y, x_1445.z, x_1445.x));
  u_xlatb0 = vec3<bool>(x_1447.x, x_1447.y, x_1447.z);
