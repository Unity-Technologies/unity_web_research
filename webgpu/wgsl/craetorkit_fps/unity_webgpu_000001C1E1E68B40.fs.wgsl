...
fn main_1() {
  ...
  let x_400 : f32 = vs_TEXCOORD1.w;
  u_xlat9 = x_400;
  let x_401 : f32 = u_xlat9;
  u_xlat9 = clamp(x_401, 0.0f, 1.0f);
  let x_405 : vec3<f32> = u_xlat0;
  let x_406 : f32 = u_xlat9;
  let x_408 : vec3<f32> = (x_405 * vec3<f32>(x_406, x_406, x_406));
  let x_409 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_408.x, x_408.y, x_408.z, x_409.w);
  SV_Target0.w = 1.0f;
  return;
}
