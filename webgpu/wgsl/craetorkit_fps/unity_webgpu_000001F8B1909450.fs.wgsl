...
fn main_1() {
  ...
  let x_1267 : vec4<f32> = vs_TEXCOORD0;
  let x_1269 : vec4<f32> = textureSample(x_EmissionMap, sampler_EmissionMap, vec2<f32>(x_1267.x, x_1267.y));
  u_xlat1 = vec3<f32>(x_1269.x, x_1269.y, x_1269.z);
  let x_1271 : vec3<f32> = u_xlat1;
  let x_1274 : vec4<f32> = x_33.x_EmissionColor;
  let x_1277 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1271 * vec3<f32>(x_1274.x, x_1274.y, x_1274.z)) + x_1277);
  let x_1280 : f32 = vs_TEXCOORD1.w;
  let x_1282 : f32 = x_33.x_ProjectionParams.y;
  u_xlat45 = (x_1280 / x_1282);
  let x_1284 : f32 = u_xlat45;
  u_xlat45 = (-(x_1284) + 1.0f);
  let x_1287 : f32 = u_xlat45;
  let x_1289 : f32 = x_33.x_ProjectionParams.z;
  u_xlat45 = (x_1287 * x_1289);
  let x_1291 : f32 = u_xlat45;
  u_xlat45 = max(x_1291, 0.0f);
  let x_1293 : f32 = u_xlat45;
  let x_1296 : f32 = x_33.unity_FogParams.x;
  u_xlat45 = (x_1293 * x_1296);
  let x_1298 : f32 = u_xlat45;
  let x_1299 : f32 = u_xlat45;
  u_xlat45 = (x_1298 * -(x_1299));
  let x_1302 : f32 = u_xlat45;
  u_xlat45 = exp2(x_1302);
  let x_1304 : vec3<f32> = u_xlat0;
  let x_1307 : vec4<f32> = x_33.unity_FogColor;
  u_xlat0 = (x_1304 + -(vec3<f32>(x_1307.x, x_1307.y, x_1307.z)));
  let x_1313 : f32 = u_xlat45;
  let x_1315 : vec3<f32> = u_xlat0;
  let x_1318 : vec4<f32> = x_33.unity_FogColor;
  let x_1320 : vec3<f32> = ((vec3<f32>(x_1313, x_1313, x_1313) * x_1315) + vec3<f32>(x_1318.x, x_1318.y, x_1318.z));
  let x_1321 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1320.x, x_1320.y, x_1320.z, x_1321.w);
  SV_Target0.w = 1.0f;
  return;
}
