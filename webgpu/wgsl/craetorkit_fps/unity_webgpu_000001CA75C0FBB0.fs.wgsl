...
fn main_1() {
  ...
  let x_499 : vec3<f32> = ((vec3<f32>(x_492.x, x_492.y, x_492.w) * vec3<f32>(x_494.x, x_494.y, x_494.z)) + vec3<f32>(x_497.x, x_497.y, x_497.z));
  let x_500 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_499.x, x_499.y, x_499.z, x_500.w);
  SV_Target0.w = 1.0f;
  return;
}
