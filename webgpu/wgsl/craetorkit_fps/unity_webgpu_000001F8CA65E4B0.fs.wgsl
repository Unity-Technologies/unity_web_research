...
fn main_1() {
  ...
  let x_1064 : f32 = vs_TEXCOORD1.w;
  let x_1066 : f32 = x_45.x_ProjectionParams.y;
  u_xlat42 = (x_1064 / x_1066);
  let x_1068 : f32 = u_xlat42;
  u_xlat42 = (-(x_1068) + 1.0f);
  let x_1071 : f32 = u_xlat42;
  let x_1073 : f32 = x_45.x_ProjectionParams.z;
  u_xlat42 = (x_1071 * x_1073);
  let x_1075 : f32 = u_xlat42;
  u_xlat42 = max(x_1075, 0.0f);
  let x_1077 : f32 = u_xlat42;
  let x_1080 : f32 = x_45.unity_FogParams.x;
  u_xlat42 = (x_1077 * x_1080);
  let x_1082 : f32 = u_xlat42;
  let x_1083 : f32 = u_xlat42;
  u_xlat42 = (x_1082 * -(x_1083));
  let x_1086 : f32 = u_xlat42;
  u_xlat42 = exp2(x_1086);
  let x_1088 : vec3<f32> = u_xlat0;
  let x_1090 : vec4<f32> = x_45.unity_FogColor;
  u_xlat0 = (x_1088 + -(vec3<f32>(x_1090.x, x_1090.y, x_1090.z)));
  let x_1096 : f32 = u_xlat42;
  let x_1098 : vec3<f32> = u_xlat0;
  let x_1101 : vec4<f32> = x_45.unity_FogColor;
  let x_1103 : vec3<f32> = ((vec3<f32>(x_1096, x_1096, x_1096) * x_1098) + vec3<f32>(x_1101.x, x_1101.y, x_1101.z));
