...
layout(set = 0, binding = 9) uniform mediump  sampler sampler_Specular;
void main()
{
vec3 u_xlat0;
vec3 u_xlat1;
...
float u_xlat25;
    ...
    u_xlat4.xz = vs_TEXCOORD4.yy * unity_WorldToLight[1].xy;
    u_xlat4.xz = unity_WorldToLight[0].xy * vs_TEXCOORD4.xx + u_xlat4.xz;
    u_xlat4.xz = unity_WorldToLight[2].xy * vs_TEXCOORD4.zz + u_xlat4.xz;
    u_xlat4.xz = u_xlat4.xz + unity_WorldToLight[3].xy;
    ...
    u_xlat4.x = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat4.xz).w;
