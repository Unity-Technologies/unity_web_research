...
fn main_1() {
  ...
  let x_1132 : f32 = x_26.x_PostExposure;
  let x_1134 : f32 = x_26.x_PostExposure;
  let x_1136 : f32 = x_26.x_PostExposure;
  let x_1137 : vec4<f32> = vec4<f32>(x_1130, x_1132, x_1134, x_1136);
  u_xlat0 = (x_1127 * vec4<f32>(x_1137.x, x_1137.y, x_1137.z, x_1137.w));
  let x_1144 : vec4<f32> = u_xlat0;
  let x_1151 : vec3<f32> = ((vec3<f32>(x_1144.z, x_1144.x, x_1144.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_1166 : vec3<f32> = ((vec3<f32>(x_1159.x, x_1159.y, x_1159.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1167 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1166.x, x_1166.y, x_1166.z, x_1167.w);
  let x_1169 : vec4<f32> = u_xlat1;
  let x_1173 : vec3<f32> = clamp(vec3<f32>(x_1169.x, x_1169.y, x_1169.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1174 : vec4<f32> = u_xlat1;
  u_xlat1 = vec4<f32>(x_1173.x, x_1173.y, x_1173.z, x_1174.w);
  let x_1176 : vec4<f32> = u_xlat1;
  let x_1180 : vec3<f32> = x_26.x_Lut2D_Params;
  u_xlat11 = (vec3<f32>(x_1176.x, x_1176.y, x_1176.z) * vec3<f32>(x_1180.z, x_1180.z, x_1180.z));
  let x_1184 : f32 = u_xlat11.x;
  u_xlat11.x = floor(x_1184);
  let x_1188 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1190 : vec2<f32> = (vec2<f32>(x_1188.x, x_1188.y) * vec2<f32>(0.5f, 0.5f));
  let x_1191 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1190.x, x_1190.y, x_1191.z, x_1191.w);
  let x_1193 : vec3<f32> = u_xlat11;
  let x_1196 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1199 : vec4<f32> = u_xlat2;
  let x_1201 : vec2<f32> = ((vec2<f32>(x_1193.y, x_1193.z) * vec2<f32>(x_1196.x, x_1196.y)) + vec2<f32>(x_1199.x, x_1199.y));
  let x_1202 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1202.x, x_1201.x, x_1201.y, x_1202.w);
  let x_1205 : f32 = u_xlat11.x;
  let x_1207 : f32 = x_26.x_Lut2D_Params.y;
  let x_1210 : f32 = u_xlat2.y;
  u_xlat2.x = ((x_1205 * x_1207) + x_1210);
  let x_1218 : vec4<f32> = u_xlat2;
  let x_1220 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1218.x, x_1218.z));
  ...
  let x_1225 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat4.x = x_1225;
  u_xlat4.y = 0.0f;
  let x_1228 : vec4<f32> = u_xlat2;
  let x_1230 : vec4<f32> = u_xlat4;
  u_xlat21 = (vec2<f32>(x_1228.x, x_1228.z) + vec2<f32>(x_1230.x, x_1230.y));
  let x_1236 : vec2<f32> = u_xlat21;
  let x_1237 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, x_1236);
  ...
  let x_1245 : f32 = x_26.x_Lut2D_Params.z;
  let x_1248 : f32 = u_xlat11.x;
  u_xlat1.x = ((x_1242 * x_1245) + -(x_1248));
  let x_1252 : vec4<f32> = u_xlat3;
  let x_1255 : vec4<f32> = u_xlat2;
  u_xlat11 = (-(vec3<f32>(x_1252.x, x_1252.y, x_1252.z)) + vec3<f32>(x_1255.x, x_1255.y, x_1255.z));
  ...
  let x_1269 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1269);
  let x_1271 : bool = u_xlatb1;
  if (x_1271) {
    let x_1274 : vec4<f32> = u_xlat0;
    let x_1275 : vec3<f32> = vec3<f32>(x_1274.x, x_1274.y, x_1274.z);
    let x_1276 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1275.x, x_1275.y, x_1275.z, x_1276.w);
    let x_1278 : vec4<f32> = u_xlat1;
    let x_1282 : vec3<f32> = clamp(vec3<f32>(x_1278.x, x_1278.y, x_1278.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1283 : vec4<f32> = u_xlat1;
    u_xlat1 = vec4<f32>(x_1282.x, x_1282.y, x_1282.z, x_1283.w);
    let x_1285 : vec4<f32> = u_xlat1;
    u_xlat0.w = dot(vec3<f32>(x_1285.x, x_1285.y, x_1285.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
