...
fn main_1() {
  ...
  let x_612 : f32 = x_32.x_PostExposure;
  let x_614 : f32 = x_32.x_PostExposure;
  ...
  let x_658 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  u_xlat5 = floor(x_664);
  let x_667 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  let x_676 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  let x_686 : f32 = x_32.x_Lut2D_Params.y;
  ...
  let x_704 : f32 = x_32.x_Lut2D_Params.y;
  u_xlat3.x = x_704;
  u_xlat3.y = 0.0f;
  ...
  let x_727 : f32 = x_32.x_Lut2D_Params.z;
  ...
  let x_755 : vec4<f32> = x_32.x_Dithering_Coords;
  let x_759 : vec4<f32> = x_32.x_Dithering_Coords;
