...
{
half4 color = DownsampleBox13Tap ( _MainTex , sampler_MainTex , i . texcoord , UnityStereoAdjustedTexelSize ( _MainTex_TexelSize ) . xy ) ;
return Prefilter ( SafeHDR ( color ) , i . texcoord ) ;
}

half4 FragPrefilter4 ( VaryingsDefault i ) : SV_Target
{
half4 color = DownsampleBox4Tap ( _MainTex , sampler_MainTex , i . texcoord , UnityStereoAdjustedTexelSize ( _MainTex_TexelSize ) . xy ) ;
return Prefilter ( SafeHDR ( color ) , i . texcoord ) ;
}
#line 47
...
{
half4 color = _BloomTex . Sample ( sampler_BloomTex , uv ) ;
return bloom + color ;
}

half4 FragUpsampleTent ( VaryingsDefault i ) : SV_Target
{
half4 bloom = UpsampleTent ( _MainTex , sampler_MainTex , i . texcoord , UnityStereoAdjustedTexelSize ( _MainTex_TexelSize ) . xy , _SampleScale ) ;
return Combine ( bloom , i . texcoordStereo ) ;
}

half4 FragUpsampleBox ( VaryingsDefault i ) : SV_Target
{
half4 bloom = UpsampleBox ( _MainTex , sampler_MainTex , i . texcoord , UnityStereoAdjustedTexelSize ( _MainTex_TexelSize ) . xy , _SampleScale ) ;
return Combine ( bloom , i . texcoordStereo ) ;
}
#line 83
