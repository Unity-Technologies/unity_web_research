...
static const int EDITOR_VISUALIZATION = 0 ;
...
#line 8 "D:/src/unity_webgpu/Shaders/Includes/UnityMetaPass.cginc"
...
return mul ( unity_MatrixVP , float4 ( vertex . xyz , 1.0 ) ) ;
#line 280
}
...
float4 UnityMetaFragment ( UnityMetaInput IN )
{
float4 res = 0 ;

if ( unity_MetaFragmentControl . x )
{
res = float4 ( IN . Albedo , 1 ) ;
#line 295
