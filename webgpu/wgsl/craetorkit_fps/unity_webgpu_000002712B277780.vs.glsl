...
float u_xlat14;
    ...
    u_xlat8 = u_xlat1.y * unity_MatrixV[1].z;
    u_xlat8 = unity_MatrixV[0].z * u_xlat1.x + u_xlat8;
    u_xlat8 = unity_MatrixV[2].z * u_xlat1.z + u_xlat8;
    u_xlat8 = unity_MatrixV[3].z * u_xlat1.w + u_xlat8;
    vs_TEXCOORD3.z = (-u_xlat8);
