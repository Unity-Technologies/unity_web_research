...
float u_xlat6;
bool u_xlatb6;
    u_xlat0.xyz = texture(sampler2D(_EmissionMap, sampler_EmissionMap), vs_TEXCOORD1.xy).xyz;
    ...
    SV_Target0.w = u_xlat6 * u_xlat1.w;
    u_xlat1.xyz = u_xlat0.xyz + (-unity_FogColor.xyz);
    u_xlat6 = vs_TEXCOORD0;
    u_xlat6 = clamp(u_xlat6, 0.0, 1.0);
    u_xlat1.xyz = vec3(u_xlat6) * u_xlat1.xyz + unity_FogColor.xyz;
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat6);
    u_xlatb6 = _DstBlend==1;
