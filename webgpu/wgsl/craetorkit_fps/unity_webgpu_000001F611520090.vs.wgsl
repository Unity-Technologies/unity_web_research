...
fn main_1() {
  ...
  let x_206 : vec4<f32> = x_17.unity_WorldToLight[0i];
  ...
  let x_217 : vec4<f32> = x_17.unity_WorldToLight[2i];
  ...
  let x_230 : vec4<f32> = x_17.unity_WorldToLight[3i];
  let x_232 : vec4<f32> = u_xlat0;
  let x_235 : vec4<f32> = u_xlat0;
  vs_TEXCOORD3 = ((vec3<f32>(x_230.x, x_230.y, x_230.z) * vec3<f32>(x_232.w, x_232.w, x_232.w)) + vec3<f32>(x_235.x, x_235.y, x_235.z));
