...
fn main_1() {
  ...
  let x_1586 : f32 = x_26.x_PostExposure;
  let x_1588 : f32 = x_26.x_PostExposure;
  let x_1590 : f32 = x_26.x_PostExposure;
  let x_1592 : f32 = x_26.x_PostExposure;
  let x_1593 : vec4<f32> = vec4<f32>(x_1586, x_1588, x_1590, x_1592);
  u_xlat0 = (x_1583 * vec4<f32>(x_1593.x, x_1593.y, x_1593.z, x_1593.w));
  let x_1600 : vec4<f32> = u_xlat0;
  let x_1607 : vec3<f32> = ((vec3<f32>(x_1600.x, x_1600.y, x_1600.z) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1608 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1607.x, x_1607.y, x_1607.z, x_1608.w);
  let x_1610 : vec4<f32> = u_xlat0;
  let x_1612 : vec3<f32> = log2(vec3<f32>(x_1610.x, x_1610.y, x_1610.z));
  let x_1613 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1612.x, x_1612.y, x_1612.z, x_1613.w);
  let x_1615 : vec4<f32> = u_xlat0;
  let x_1622 : vec3<f32> = ((vec3<f32>(x_1615.x, x_1615.y, x_1615.z) * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1623 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1622.x, x_1622.y, x_1622.z, x_1623.w);
  let x_1625 : vec4<f32> = u_xlat0;
  let x_1629 : vec3<f32> = clamp(vec3<f32>(x_1625.x, x_1625.y, x_1625.z), vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1630 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1629.x, x_1629.y, x_1629.z, x_1630.w);
  let x_1632 : vec4<f32> = u_xlat0;
  let x_1636 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1638 : vec3<f32> = (vec3<f32>(x_1632.x, x_1632.y, x_1632.z) * vec3<f32>(x_1636.y, x_1636.y, x_1636.y));
  let x_1639 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1638.x, x_1638.y, x_1638.z, x_1639.w);
  let x_1642 : f32 = x_26.x_Lut3D_Params.x;
  u_xlat1.x = (x_1642 * 0.5f);
  let x_1645 : vec4<f32> = u_xlat0;
  let x_1648 : vec2<f32> = x_26.x_Lut3D_Params;
  let x_1651 : vec3<f32> = u_xlat1;
  let x_1653 : vec3<f32> = ((vec3<f32>(x_1645.x, x_1645.y, x_1645.z) * vec3<f32>(x_1648.x, x_1648.x, x_1648.x)) + vec3<f32>(x_1651.x, x_1651.x, x_1651.x));
  let x_1654 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1653.x, x_1653.y, x_1653.z, x_1654.w);
  let x_1664 : vec4<f32> = u_xlat0;
  let x_1666 : vec4<f32> = textureSample(x_Lut3D, sampler_Lut3D, vec3<f32>(x_1664.x, x_1664.y, x_1664.z));
  let x_1667 : vec3<f32> = vec3<f32>(x_1666.x, x_1666.y, x_1666.z);
  let x_1668 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1667.x, x_1667.y, x_1667.z, x_1668.w);
  let x_1670 : vec2<f32> = vs_TEXCOORD0;
  let x_1673 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1677 : vec4<f32> = x_26.x_Dithering_Coords;
  let x_1679 : vec2<f32> = ((x_1670 * vec2<f32>(x_1673.x, x_1673.y)) + vec2<f32>(x_1677.z, x_1677.w));
  let x_1680 : vec3<f32> = u_xlat1;
  u_xlat1 = vec3<f32>(x_1679.x, x_1679.y, x_1680.z);
  let x_1687 : vec3<f32> = u_xlat1;
  let x_1689 : vec4<f32> = textureSample(x_DitheringTex, sampler_DitheringTex, vec2<f32>(x_1687.x, x_1687.y));
  u_xlat1.x = x_1689.w;
  let x_1693 : f32 = u_xlat1.x;
  u_xlat1.x = ((x_1693 * 2.0f) + -1.0f);
  let x_1698 : f32 = u_xlat1.x;
  u_xlat11.x = ((x_1698 * 340282346638528859811704183484516925440.0f) + 0.5f);
  let x_1704 : f32 = u_xlat11.x;
  u_xlat11.x = clamp(x_1704, 0.0f, 1.0f);
  let x_1708 : f32 = u_xlat11.x;
  u_xlat11.x = ((x_1708 * 2.0f) + -1.0f);
  let x_1713 : f32 = u_xlat1.x;
  u_xlat1.x = (-(abs(x_1713)) + 1.0f);
  let x_1719 : f32 = u_xlat1.x;
  u_xlat1.x = sqrt(x_1719);
  let x_1723 : f32 = u_xlat1.x;
  u_xlat1.x = (-(x_1723) + 1.0f);
  let x_1728 : f32 = u_xlat1.x;
  let x_1730 : f32 = u_xlat11.x;
  u_xlat1.x = (x_1728 * x_1730);
  let x_1733 : vec4<f32> = u_xlat0;
  u_xlat11 = (vec3<f32>(x_1733.x, x_1733.y, x_1733.z) * vec3<f32>(12.920000076f, 12.920000076f, 12.920000076f));
  let x_1738 : vec4<f32> = u_xlat0;
  let x_1742 : vec3<f32> = max(abs(vec3<f32>(x_1738.x, x_1738.y, x_1738.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1743 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1742.x, x_1742.y, x_1742.z, x_1743.w);
  let x_1745 : vec4<f32> = u_xlat2;
  let x_1747 : vec3<f32> = log2(vec3<f32>(x_1745.x, x_1745.y, x_1745.z));
  let x_1748 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1747.x, x_1747.y, x_1747.z, x_1748.w);
  let x_1750 : vec4<f32> = u_xlat2;
  let x_1754 : vec3<f32> = (vec3<f32>(x_1750.x, x_1750.y, x_1750.z) * vec3<f32>(0.416666657f, 0.416666657f, 0.416666657f));
  let x_1755 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1754.x, x_1754.y, x_1754.z, x_1755.w);
  let x_1757 : vec4<f32> = u_xlat2;
  let x_1759 : vec3<f32> = exp2(vec3<f32>(x_1757.x, x_1757.y, x_1757.z));
  let x_1760 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1759.x, x_1759.y, x_1759.z, x_1760.w);
  let x_1762 : vec4<f32> = u_xlat2;
  let x_1769 : vec3<f32> = ((vec3<f32>(x_1762.x, x_1762.y, x_1762.z) * vec3<f32>(1.054999948f, 1.054999948f, 1.054999948f)) + vec3<f32>(-0.055f, -0.055f, -0.055f));
  let x_1770 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1769.x, x_1769.y, x_1769.z, x_1770.w);
  let x_1777 : vec4<f32> = u_xlat0;
  let x_1780 : vec4<bool> = (vec4<f32>(0.0031308f, 0.0031308f, 0.0031308f, 0.0f) >= vec4<f32>(x_1777.x, x_1777.y, x_1777.z, x_1777.x));
  u_xlatb0 = vec3<bool>(x_1780.x, x_1780.y, x_1780.z);
  let x_1783 : bool = u_xlatb0.x;
  if (x_1783) {
    let x_1788 : f32 = u_xlat11.x;
    x_1784 = x_1788;
  } else {
  ...
  u_xlat0.x = x_1792;
  let x_1795 : bool = u_xlatb0.y;
  if (x_1795) {
    let x_1800 : f32 = u_xlat11.y;
    x_1796 = x_1800;
  } else {
    let x_1803 : f32 = u_xlat2.y;
    x_1796 = x_1803;
  }
  let x_1804 : f32 = x_1796;
  u_xlat0.y = x_1804;
  let x_1807 : bool = u_xlatb0.z;
  if (x_1807) {
    let x_1812 : f32 = u_xlat11.z;
    x_1808 = x_1812;
  } else {
    let x_1815 : f32 = u_xlat2.z;
    x_1808 = x_1815;
  }
  let x_1816 : f32 = x_1808;
  u_xlat0.z = x_1816;
  let x_1818 : vec3<f32> = u_xlat1;
  let x_1823 : vec4<f32> = u_xlat0;
  let x_1825 : vec3<f32> = ((vec3<f32>(x_1818.x, x_1818.x, x_1818.x) * vec3<f32>(0.003921569f, 0.003921569f, 0.003921569f)) + vec3<f32>(x_1823.x, x_1823.y, x_1823.z));
  let x_1826 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1825.x, x_1825.y, x_1825.z, x_1826.w);
  let x_1828 : vec4<f32> = u_xlat0;
  u_xlat1 = (vec3<f32>(x_1828.x, x_1828.y, x_1828.z) * vec3<f32>(0.077399381f, 0.077399381f, 0.077399381f));
  let x_1832 : vec4<f32> = u_xlat0;
  let x_1835 : vec3<f32> = (vec3<f32>(x_1832.x, x_1832.y, x_1832.z) + vec3<f32>(0.055f, 0.055f, 0.055f));
  let x_1836 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1835.x, x_1835.y, x_1835.z, x_1836.w);
  let x_1838 : vec4<f32> = u_xlat2;
  let x_1841 : vec3<f32> = (vec3<f32>(x_1838.x, x_1838.y, x_1838.z) * vec3<f32>(0.947867334f, 0.947867334f, 0.947867334f));
  let x_1842 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1841.x, x_1841.y, x_1841.z, x_1842.w);
  let x_1844 : vec4<f32> = u_xlat2;
  let x_1847 : vec3<f32> = max(abs(vec3<f32>(x_1844.x, x_1844.y, x_1844.z)), vec3<f32>(1.1920929e-07f, 1.1920929e-07f, 1.1920929e-07f));
  let x_1848 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1847.x, x_1847.y, x_1847.z, x_1848.w);
  let x_1850 : vec4<f32> = u_xlat2;
  let x_1852 : vec3<f32> = log2(vec3<f32>(x_1850.x, x_1850.y, x_1850.z));
  let x_1853 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1852.x, x_1852.y, x_1852.z, x_1853.w);
  let x_1855 : vec4<f32> = u_xlat2;
  let x_1858 : vec3<f32> = (vec3<f32>(x_1855.x, x_1855.y, x_1855.z) * vec3<f32>(2.400000095f, 2.400000095f, 2.400000095f));
  let x_1859 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1858.x, x_1858.y, x_1858.z, x_1859.w);
  let x_1861 : vec4<f32> = u_xlat2;
  let x_1863 : vec3<f32> = exp2(vec3<f32>(x_1861.x, x_1861.y, x_1861.z));
