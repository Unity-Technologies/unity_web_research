...
fn main_1() {
  ...
  let x_492 : vec3<f32> = ((vec3<f32>(x_486.x, x_486.y, x_486.z) * vec3<f32>(x_488.x, x_488.y, x_488.z)) + x_491);
  let x_493 : vec4<f32> = SV_Target3;
  SV_Target3 = vec4<f32>(x_492.x, x_492.y, x_492.z, x_493.w);
  let x_496 : vec4<f32> = u_xlat0;
  SV_Target0 = x_496;
  let x_498 : f32 = u_xlat1.w;
  SV_Target1.w = x_498;
  SV_Target2.w = 1.0f;
  SV_Target3.w = 1.0f;
  return;
