...
fn main_1() {
  ...
  u_xlat0 = (x_401 * x_402);
  let x_405 : f32 = vs_TEXCOORD1.w;
  u_xlat18 = x_405;
  let x_406 : f32 = u_xlat18;
  u_xlat18 = clamp(x_406, 0.0f, 1.0f);
  let x_410 : vec3<f32> = u_xlat0;
  let x_411 : f32 = u_xlat18;
  let x_413 : vec3<f32> = (x_410 * vec3<f32>(x_411, x_411, x_411));
  let x_414 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_413.x, x_413.y, x_413.z, x_414.w);
  SV_Target0.w = 1.0f;
  return;
}
