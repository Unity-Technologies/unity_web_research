...
layout(set = 0, binding = 3) uniform highp textureCube _ShadowMapTexture;
...
layout(set = 0, binding = 5) uniform highp  samplerShadow sampler_ShadowMapTexture;
...
float u_xlat27;
    ...
    SV_Target0.w = u_xlat1.w * u_xlat24 + u_xlat26;
    ...
    u_xlat25 = texture(sampler2D(_LightTexture0, sampler_LightTexture0), vec2(u_xlat25)).x;
