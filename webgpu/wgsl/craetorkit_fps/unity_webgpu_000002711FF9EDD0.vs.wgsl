...
fn main_1() {
  ...
  let x_278 : vec4<f32> = x_17.unity_SHBr;
  let x_279 : vec4<f32> = u_xlat1;
  u_xlat0.x = dot(x_278, x_279);
  let x_283 : vec4<f32> = x_17.unity_SHBg;
  let x_284 : vec4<f32> = u_xlat1;
  u_xlat0.y = dot(x_283, x_284);
  let x_288 : vec4<f32> = x_17.unity_SHBb;
  let x_289 : vec4<f32> = u_xlat1;
  u_xlat0.z = dot(x_288, x_289);
  let x_295 : vec4<f32> = x_17.unity_SHC;
  let x_297 : f32 = u_xlat9;
  let x_300 : vec4<f32> = u_xlat0;
  vs_TEXCOORD6 = ((vec3<f32>(x_295.x, x_295.y, x_295.z) * vec3<f32>(x_297, x_297, x_297)) + vec3<f32>(x_300.x, x_300.y, x_300.z));
  return;
}
