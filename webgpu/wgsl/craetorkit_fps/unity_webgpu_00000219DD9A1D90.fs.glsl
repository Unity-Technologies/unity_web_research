...
bool u_xlatb6;
    ...
    u_xlat6 = u_xlat0.w * vs_COLOR0.w + (-_Cutoff);
    ...
    u_xlat0.xyz = u_xlat1.xyz * vec3(_EmissionColor.x, _EmissionColor.y, _EmissionColor.z) + u_xlat0.xyz;
    u_xlat0.xyz = u_xlat0.xyz + (-unity_FogColor.xyz);
    u_xlat6 = vs_TEXCOORD0 / _ProjectionParams.y;
    u_xlat6 = (-u_xlat6) + 1.0;
