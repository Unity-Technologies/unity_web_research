...
float u_xlat20;
    ...
    if(u_xlatb2){
        ...
        u_xlat8.xyz = vs_TEXCOORD2.yyy * unity_ProbeVolumeWorldToObject[1].xyz;
        u_xlat8.xyz = unity_ProbeVolumeWorldToObject[0].xyz * vs_TEXCOORD2.xxx + u_xlat8.xyz;
        u_xlat8.xyz = unity_ProbeVolumeWorldToObject[2].xyz * vs_TEXCOORD2.zzz + u_xlat8.xyz;
    ...
    u_xlat8.x = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat8.xy).x;
    u_xlat2.x = (-u_xlat8.x) + u_xlat2.x;
    u_xlat19 = u_xlat19 * u_xlat2.x + u_xlat8.x;
