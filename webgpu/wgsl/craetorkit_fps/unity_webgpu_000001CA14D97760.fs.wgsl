...
fn main_1() {
  ...
  let x_1000 : vec4<f32> = vs_TEXCOORD0;
  let x_1002 : vec4<f32> = textureSample(x_EmissionMap, sampler_EmissionMap, vec2<f32>(x_1000.x, x_1000.y));
  u_xlat1 = vec3<f32>(x_1002.x, x_1002.y, x_1002.z);
  let x_1004 : vec3<f32> = u_xlat1;
  let x_1007 : vec4<f32> = x_33.x_EmissionColor;
  let x_1010 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1004 * vec3<f32>(x_1007.x, x_1007.y, x_1007.z)) + x_1010);
  let x_1013 : f32 = vs_TEXCOORD1.w;
  let x_1015 : f32 = x_33.x_ProjectionParams.y;
  u_xlat39 = (x_1013 / x_1015);
  let x_1017 : f32 = u_xlat39;
  u_xlat39 = (-(x_1017) + 1.0f);
  let x_1020 : f32 = u_xlat39;
  let x_1022 : f32 = x_33.x_ProjectionParams.z;
  u_xlat39 = (x_1020 * x_1022);
  let x_1024 : f32 = u_xlat39;
  u_xlat39 = max(x_1024, 0.0f);
  let x_1026 : f32 = u_xlat39;
  let x_1029 : f32 = x_33.unity_FogParams.x;
  u_xlat39 = (x_1026 * x_1029);
  let x_1031 : f32 = u_xlat39;
  let x_1032 : f32 = u_xlat39;
  u_xlat39 = (x_1031 * -(x_1032));
  let x_1035 : f32 = u_xlat39;
  u_xlat39 = exp2(x_1035);
  let x_1037 : vec3<f32> = u_xlat0;
  let x_1039 : vec4<f32> = x_33.unity_FogColor;
  u_xlat0 = (x_1037 + -(vec3<f32>(x_1039.x, x_1039.y, x_1039.z)));
  let x_1045 : f32 = u_xlat39;
  let x_1047 : vec3<f32> = u_xlat0;
  let x_1050 : vec4<f32> = x_33.unity_FogColor;
  let x_1052 : vec3<f32> = ((vec3<f32>(x_1045, x_1045, x_1045) * x_1047) + vec3<f32>(x_1050.x, x_1050.y, x_1050.z));
  let x_1053 : vec4<f32> = SV_Target0;
  SV_Target0 = vec4<f32>(x_1052.x, x_1052.y, x_1052.z, x_1053.w);
  SV_Target0.w = 1.0f;
  return;
}
