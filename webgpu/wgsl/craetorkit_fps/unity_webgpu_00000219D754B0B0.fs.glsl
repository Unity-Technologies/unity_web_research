...
bool u_xlatb48;
    ...
    if(u_xlatb48){
        ...
        u_xlat7.x = max(u_xlat48, u_xlat19.x);
    ...
    u_xlat19.x = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat19.xy).x;
    u_xlat48 = u_xlat48 + (-u_xlat19.x);
    u_xlat47 = u_xlat47 * u_xlat48 + u_xlat19.x;
    ...
    if(u_xlatb19){
        ...
        if(u_xlatb19){
            ...
            u_xlat11.xyz = u_xlat19.xxx * u_xlat7.xyz;
            ...
            u_xlat7.xyz = u_xlat11.xyz * u_xlat19.xxx + u_xlat0.xyz;
        }
