...
fn main_1() {
  ...
  let x_439 : f32 = x_49.x_PostExposure;
  let x_441 : f32 = x_49.x_PostExposure;
  let x_443 : f32 = x_49.x_PostExposure;
  let x_445 : f32 = x_49.x_PostExposure;
  let x_446 : vec4<f32> = vec4<f32>(x_439, x_441, x_443, x_445);
  u_xlat0 = (vec4<f32>(x_435.w, x_435.x, x_435.y, x_435.z) * vec4<f32>(x_446.x, x_446.y, x_446.z, x_446.w));
  let x_453 : vec4<f32> = u_xlat0;
  let x_460 : vec3<f32> = ((vec3<f32>(x_453.y, x_453.z, x_453.w) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  ...
  let x_490 : vec2<f32> = x_49.x_Lut3D_Params;
  ...
  let x_496 : f32 = x_49.x_Lut3D_Params.x;
  u_xlat16 = (x_496 * 0.5f);
  let x_499 : vec4<f32> = u_xlat1;
  let x_502 : vec2<f32> = x_49.x_Lut3D_Params;
  ...
  u_xlat0 = vec4<f32>(x_522.x, x_521.x, x_521.y, x_521.z);
  let x_529 : f32 = x_49.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_529);
  let x_531 : bool = u_xlatb1;
  if (x_531) {
    let x_534 : vec4<f32> = u_xlat0;
    let x_535 : vec3<f32> = vec3<f32>(x_534.y, x_534.z, x_534.w);
    ...
    u_xlat0.x = dot(vec3<f32>(x_545.x, x_545.y, x_545.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
  let x_551 : vec4<f32> = u_xlat0;
  SV_Target0 = vec4<f32>(x_551.y, x_551.z, x_551.w, x_551.x);
  return;
}
