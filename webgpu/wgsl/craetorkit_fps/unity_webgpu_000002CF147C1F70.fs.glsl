...
layout(set = 0, binding = 14) uniform mediump  sampler sampler_EmissionMap;
void main()
{
vec3 u_xlat0;
vec3 u_xlat1;
...
bool u_xlatb46;
    ...
    if(u_xlatb46){
        ...
        u_xlat5 = textureLod(samplerCube(unity_SpecCube1, samplerunity_SpecCube0), u_xlat5.xyz, u_xlat42);
    ...
    u_xlat42 = vs_TEXCOORD1.w / _ProjectionParams.y;
