...
fn main_1() {
  ...
  let x_1069 : f32 = vs_TEXCOORD1.w;
  let x_1071 : f32 = x_33.x_ProjectionParams.y;
  u_xlat39 = (x_1069 / x_1071);
  let x_1073 : f32 = u_xlat39;
  u_xlat39 = (-(x_1073) + 1.0f);
  let x_1076 : f32 = u_xlat39;
  let x_1078 : f32 = x_33.x_ProjectionParams.z;
  u_xlat39 = (x_1076 * x_1078);
  let x_1080 : f32 = u_xlat39;
  u_xlat39 = max(x_1080, 0.0f);
  let x_1082 : f32 = u_xlat39;
  let x_1085 : f32 = x_33.unity_FogParams.x;
  u_xlat39 = (x_1082 * x_1085);
  let x_1087 : f32 = u_xlat39;
  let x_1088 : f32 = u_xlat39;
  u_xlat39 = (x_1087 * -(x_1088));
  let x_1091 : f32 = u_xlat39;
  u_xlat39 = exp2(x_1091);
  let x_1093 : vec3<f32> = u_xlat0;
  let x_1096 : vec4<f32> = x_33.unity_FogColor;
  u_xlat0 = (x_1093 + -(vec3<f32>(x_1096.x, x_1096.y, x_1096.z)));
  let x_1102 : f32 = u_xlat39;
  let x_1104 : vec3<f32> = u_xlat0;
  let x_1107 : vec4<f32> = x_33.unity_FogColor;
  let x_1109 : vec3<f32> = ((vec3<f32>(x_1102, x_1102, x_1102) * x_1104) + vec3<f32>(x_1107.x, x_1107.y, x_1107.z));
