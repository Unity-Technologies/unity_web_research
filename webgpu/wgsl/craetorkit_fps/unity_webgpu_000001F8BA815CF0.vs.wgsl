...
fn main_1() {
  ...
  let x_364 : vec2<f32> = (vec2<f32>(x_358.y, x_358.y) * vec2<f32>(x_362.x, x_362.y));
  ...
  u_xlat0 = vec4<f32>(x_375.x, x_375.y, x_376.z, x_376.w);
  ...
  let x_392 : vec4<f32> = x_18.unity_WorldToLight[3i];
  let x_394 : vec4<f32> = u_xlat0;
  let x_397 : vec4<f32> = u_xlat0;
  vs_TEXCOORD8 = ((vec2<f32>(x_392.x, x_392.y) * vec2<f32>(x_394.w, x_394.w)) + vec2<f32>(x_397.x, x_397.y));
  return;
}
