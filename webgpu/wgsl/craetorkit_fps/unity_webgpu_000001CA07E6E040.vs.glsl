...
uint u_xlatu28;
    ...
    u_xlat7 = vec4(u_xlat19) * unity_MatrixVP[1];
    u_xlat4.w = u_xlat2.x;
    u_xlat5.z = u_xlat4.y;
    u_xlat4.x = u_xlat5.y;
    ...
    u_xlat7 = unity_MatrixVP[0] * u_xlat10.xxxx + u_xlat7;
    u_xlat5.w = u_xlat2.z;
    ...
    u_xlatu28 = floatBitsToUint(u_xlat2.w) >> (24u & uint(0x1F));
    ...
    u_xlat1.x = u_xlat19 * unity_MatrixV[1].z;
    u_xlat2.xyz = vec3(u_xlat19) * unity_MatrixVP[1].xyw;
    u_xlat2.xyz = unity_MatrixVP[0].xyw * u_xlat10.xxx + u_xlat2.xyz;
    u_xlat1.x = unity_MatrixV[0].z * u_xlat10.x + u_xlat1.x;
    u_xlat1.x = unity_MatrixV[2].z * u_xlat0.x + u_xlat1.x;
    u_xlat10.xyz = unity_MatrixVP[2].xyw * u_xlat0.xxx + u_xlat2.xyz;
    u_xlat10.xyz = u_xlat10.xyz + unity_MatrixVP[3].xyw;
    ...
    u_xlat1 = u_xlat3 * u_xlat9.xxxx + u_xlat1;
    u_xlat1 = u_xlat5 * u_xlat9.zzzz + u_xlat1;
    ...
    u_xlat0.x = u_xlat9.x * u_xlat9.x + (-u_xlat0.x);
