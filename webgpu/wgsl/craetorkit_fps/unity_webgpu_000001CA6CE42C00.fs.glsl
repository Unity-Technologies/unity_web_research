...
float u_xlat24;
    ...
    u_xlat10.x = dot(vs_TEXCOORD1.xyz, u_xlat2.xyz);
    u_xlat10.x = u_xlat10.x + u_xlat10.x;
    u_xlat10.xyz = u_xlat2.xyz * (-u_xlat10.xxx) + vs_TEXCOORD1.xyz;
    u_xlat5.xyz = vec3(u_xlat23) * _LightColor0.xyz;
    u_xlat23 = (-u_xlat4.x) * 0.699999988 + 1.70000005;
    u_xlat23 = u_xlat23 * u_xlat4.x;
    u_xlat23 = u_xlat23 * 6.0;
    u_xlat6 = textureLod(samplerCube(unity_SpecCube0, samplerunity_SpecCube0), u_xlat10.xyz, u_xlat23);
    ...
    u_xlat10.xyz = u_xlat6.xyz * vec3(u_xlat23);
    ...
    u_xlat9.x = texture(sampler2D(unity_NHxRoughness, samplerunity_NHxRoughness), u_xlat4.yw).x;
    ...
    u_xlat4.xyw = (-u_xlat0.xyz) + vec3(u_xlat21);
    u_xlat0.xyz = u_xlat4.zzz * u_xlat4.xyw + u_xlat0.xyz;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat3.xyz;
    SV_Target0.xyz = u_xlat8.xyz * u_xlat2.xyz + u_xlat0.xyz;
