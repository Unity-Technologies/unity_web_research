...
float u_xlat19;
    ...
    u_xlat4.xyz = in_TANGENT0.yyy * unity_Builtins0Array[u_xlati6 / 8].unity_ObjectToWorldArray[1].yzx;
    u_xlat4.xyz = unity_Builtins0Array[u_xlati6 / 8].unity_ObjectToWorldArray[0].yzx * in_TANGENT0.xxx + u_xlat4.xyz;
    u_xlat4.xyz = unity_Builtins0Array[u_xlati6 / 8].unity_ObjectToWorldArray[2].yzx * in_TANGENT0.zzz + u_xlat4.xyz;
    u_xlat12 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat12 = inversesqrt(u_xlat12);
    u_xlat4.xyz = vec3(u_xlat12) * u_xlat4.xyz;
    u_xlat5.x = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati6 / 8].unity_WorldToObjectArray[0].xyz);
    u_xlat5.y = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati6 / 8].unity_WorldToObjectArray[1].xyz);
    u_xlat5.z = dot(in_NORMAL0.xyz, unity_Builtins0Array[u_xlati6 / 8].unity_WorldToObjectArray[2].xyz);
    u_xlat6.x = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat6.x = inversesqrt(u_xlat6.x);
    u_xlat5 = u_xlat6.xxxx * u_xlat5.xyzz;
    ...
    vs_TEXCOORD4.z = (-u_xlat6.x);
    u_xlat6.xyz = u_xlat2.yyy * unity_MatrixVP[1].xyw;
    u_xlat6.xyz = unity_MatrixVP[0].xyw * u_xlat2.xxx + u_xlat6.xyz;
    u_xlat6.xyz = unity_MatrixVP[2].xyw * u_xlat2.zzz + u_xlat6.xyz;
    u_xlat6.xyz = unity_MatrixVP[3].xyw * u_xlat2.www + u_xlat6.xyz;
    ...
    u_xlat6.x = u_xlat5.y * u_xlat5.y;
    u_xlat6.x = u_xlat5.x * u_xlat5.x + (-u_xlat6.x);
    ...
    vs_TEXCOORD5.xyz = unity_Builtins2Array[u_xlati0 / 7].unity_SHCArray.xyz * u_xlat6.xxx + u_xlat3.xyz;
