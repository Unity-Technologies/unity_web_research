...
fn main_1() {
  ...
  let x_1147 : vec4<f32> = vs_TEXCOORD0;
  let x_1149 : vec4<f32> = textureSample(x_EmissionMap, sampler_EmissionMap, vec2<f32>(x_1147.x, x_1147.y));
  u_xlat1 = vec3<f32>(x_1149.x, x_1149.y, x_1149.z);
  let x_1151 : vec3<f32> = u_xlat1;
  let x_1154 : vec4<f32> = x_45.x_EmissionColor;
  let x_1157 : vec3<f32> = u_xlat0;
  u_xlat0 = ((x_1151 * vec3<f32>(x_1154.x, x_1154.y, x_1154.z)) + x_1157);
  let x_1160 : f32 = vs_TEXCOORD1.w;
  let x_1162 : f32 = x_45.x_ProjectionParams.y;
  u_xlat42 = (x_1160 / x_1162);
  let x_1164 : f32 = u_xlat42;
  u_xlat42 = (-(x_1164) + 1.0f);
  let x_1167 : f32 = u_xlat42;
  let x_1169 : f32 = x_45.x_ProjectionParams.z;
  u_xlat42 = (x_1167 * x_1169);
  let x_1171 : f32 = u_xlat42;
  u_xlat42 = max(x_1171, 0.0f);
  let x_1173 : f32 = u_xlat42;
  let x_1176 : f32 = x_45.unity_FogParams.x;
  u_xlat42 = (x_1173 * x_1176);
  let x_1178 : f32 = u_xlat42;
  let x_1179 : f32 = u_xlat42;
  u_xlat42 = (x_1178 * -(x_1179));
  let x_1182 : f32 = u_xlat42;
  u_xlat42 = exp2(x_1182);
  let x_1184 : vec3<f32> = u_xlat0;
  let x_1187 : vec4<f32> = x_45.unity_FogColor;
  u_xlat0 = (x_1184 + -(vec3<f32>(x_1187.x, x_1187.y, x_1187.z)));
  let x_1193 : f32 = u_xlat42;
  let x_1195 : vec3<f32> = u_xlat0;
  let x_1198 : vec4<f32> = x_45.unity_FogColor;
  let x_1200 : vec3<f32> = ((vec3<f32>(x_1193, x_1193, x_1193) * x_1195) + vec3<f32>(x_1198.x, x_1198.y, x_1198.z));
