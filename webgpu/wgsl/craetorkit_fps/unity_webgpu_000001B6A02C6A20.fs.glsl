...
float u_xlat30;
    ...
    u_xlat28 = texture(sampler2D(_DissolveNoise, sampler_DissolveNoise), vs_TEXCOORD0.xy).x;
    u_xlat29 = _EdgeSize + _Cutoff;
    ...
    u_xlat28 = (-_Cutoff) * u_xlat29 + u_xlat28;
    ...
    if(u_xlatb28){
        ...
        u_xlat5.xzw = (bool(u_xlatb28)) ? u_xlat5.xzw : vs_TEXCOORD4.xyz;
    ...
    u_xlat27 = vs_TEXCOORD6 / _ProjectionParams.y;
