...
fn main_1() {
  ...
  u_xlat0 = ((vec4<f32>(x_596.w, x_596.x, x_596.y, x_596.z) * vec4<f32>(x_598.w, x_598.x, x_598.y, x_598.z)) + vec4<f32>(x_601.w, x_601.x, x_601.y, x_601.z));
  let x_607 : f32 = x_32.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_607);
  ...
  SV_Target0 = vec4<f32>(x_633.y, x_633.z, x_633.w, x_633.x);
  return;
}
