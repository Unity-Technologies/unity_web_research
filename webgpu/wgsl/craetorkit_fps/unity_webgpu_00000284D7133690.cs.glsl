...
int u_xlati6;
    ...
    u_xlati6 = int(int_bitfieldInsert(int(gl_GlobalInvocationID.x), int(gl_GlobalInvocationID.y), 2 & int(0x1F), 30));
    ...
    if(u_xlati6 == 0) {
        ...
        u_xlati6 = int(int_bitfieldInsert(int(u_xlatu1.x), int(u_xlatu1.w), 2 & int(0x1F), 30));
