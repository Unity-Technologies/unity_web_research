...
fn main_1() {
  ...
  let x_251 : vec2<f32> = in_TEXCOORD0;
  let x_254 : vec4<f32> = x_17.x_MainTex_ST;
  let x_258 : vec4<f32> = x_17.x_MainTex_ST;
  vs_TEXCOORD1 = ((x_251 * vec2<f32>(x_254.x, x_254.y)) + vec2<f32>(x_258.z, x_258.w));
  return;
}
