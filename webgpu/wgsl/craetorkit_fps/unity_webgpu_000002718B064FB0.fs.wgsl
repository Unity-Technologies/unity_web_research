...
fn main_1() {
  ...
  let x_800 : f32 = x_55.x_LumaInAlpha;
  u_xlatb0 = (0.5f < x_800);
  let x_802 : bool = u_xlatb0;
  if (x_802) {
    let x_805 : vec4<f32> = u_xlat1;
    u_xlat0 = vec3<f32>(x_805.x, x_805.y, x_805.z);
    let x_807 : vec3<f32> = u_xlat0;
    u_xlat0 = clamp(x_807, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_811 : vec3<f32> = u_xlat0;
    u_xlat1.w = dot(x_811, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
