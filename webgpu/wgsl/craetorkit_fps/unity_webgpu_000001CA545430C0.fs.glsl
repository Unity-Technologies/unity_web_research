...
layout(set = 0, binding = 5) uniform mediump  sampler sampler_CameraGBufferTexture0;
layout(set = 0, binding = 6) uniform mediump  sampler sampler_CameraGBufferTexture1;
layout(set = 0, binding = 7) uniform mediump  sampler sampler_CameraGBufferTexture2;
void main()
{
vec4 u_xlat0;
vec4 u_xlat1;
