...
fn main_1() {
  ...
  u_xlat1 = (vec4<f32>(x_374.y, x_374.y, x_374.y, x_374.y) * x_378);
  let x_381 : vec4<f32> = x_17.unity_WorldToLight[0i];
  let x_382 : vec4<f32> = u_xlat0;
  let x_385 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_381 * vec4<f32>(x_382.x, x_382.x, x_382.x, x_382.x)) + x_385);
  let x_388 : vec4<f32> = x_17.unity_WorldToLight[2i];
  let x_389 : vec4<f32> = u_xlat0;
  let x_392 : vec4<f32> = u_xlat1;
  u_xlat1 = ((x_388 * vec4<f32>(x_389.z, x_389.z, x_389.z, x_389.z)) + x_392);
  let x_396 : vec4<f32> = x_17.unity_WorldToLight[3i];
  let x_397 : vec4<f32> = u_xlat0;
  let x_400 : vec4<f32> = u_xlat1;
  vs_TEXCOORD6 = ((x_396 * vec4<f32>(x_397.w, x_397.w, x_397.w, x_397.w)) + x_400);
