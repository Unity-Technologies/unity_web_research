...
float custompack0 : TEXCOORD3 ;
float3 _LightCoord : TEXCOORD4 ; float4 _ShadowCoord : TEXCOORD5 ;
...
o . custompack0 . x = customInputData . lifetime ;
o . pos = UnityObjectToClipPos ( v . vertex ) ;
o . pack0 . xy = ( v . texcoord . xy * _Gradient_ST . xy + _Gradient_ST . zw ) ;
...
surfIN = ( Input ) 0 ; ;
surfIN . uv_Gradient . x = 1.0 ;
surfIN . lifetime . x = 1.0 ;
surfIN . worldPos . x = 1.0 ;
surfIN . uv_Gradient = IN . pack0 . xy ;
surfIN . lifetime = IN . custompack0 . x ;
