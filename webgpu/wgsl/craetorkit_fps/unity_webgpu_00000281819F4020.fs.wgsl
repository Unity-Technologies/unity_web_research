...
fn main_1() {
  ...
  let x_1373 : f32 = x_26.x_LumaInAlpha;
  u_xlatb0 = (0.5f < x_1373);
  let x_1375 : bool = u_xlatb0;
  if (x_1375) {
    ...
    u_xlat2.w = dot(vec3<f32>(x_1389.x, x_1389.y, x_1389.z), vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
