...
fn main_1() {
  ...
  let x_33 : f32 = vs_TEXCOORD3.w;
  u_xlat0 = ((x_28 * x_33) + -0.5f);
...
@fragment
fn main(@location(0) vs_TEXCOORD1_param : vec2<f32>, @location(1) vs_TEXCOORD3_param : vec4<f32>, @builtin(position) gl_FragCoord_param : vec4<f32>) -> main_out {
