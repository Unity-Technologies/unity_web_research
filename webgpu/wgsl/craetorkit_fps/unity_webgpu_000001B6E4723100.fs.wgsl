...
fn main_1() {
  ...
  let x_211 : f32 = x_55.x_LumaInAlpha;
  u_xlatb0 = (0.5f < x_211);
  let x_213 : bool = u_xlatb0;
  if (x_213) {
    let x_216 : vec4<f32> = u_xlat1;
    u_xlat0 = vec3<f32>(x_216.x, x_216.y, x_216.z);
    let x_218 : vec3<f32> = u_xlat0;
    u_xlat0 = clamp(x_218, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_222 : vec3<f32> = u_xlat0;
    u_xlat1.w = dot(x_222, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
