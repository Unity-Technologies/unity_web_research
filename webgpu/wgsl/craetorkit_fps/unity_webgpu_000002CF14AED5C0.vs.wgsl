...
@group(0) @binding(16) var x_DisplacementNoise : texture_3d<f32>;

@group(0) @binding(18) var sampler_DisplacementNoise : sampler;

@group(0) @binding(17) var x_DisplacementRamp : texture_2d<f32>;

@group(0) @binding(19) var sampler_DisplacementRamp : sampler;
...
fn main_1() {
  ...
  let x_309 : vec3<f32> = (vec3<f32>(x_303.y, x_303.y, x_303.y) * vec3<f32>(x_307.x, x_307.y, x_307.z));
  ...
  vs_TEXCOORD2 = ((vec3<f32>(x_337.x, x_337.y, x_337.z) * vec3<f32>(x_339.w, x_339.w, x_339.w)) + vec3<f32>(x_342.x, x_342.y, x_342.z));
