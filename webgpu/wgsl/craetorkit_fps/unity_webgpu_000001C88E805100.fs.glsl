...
float u_xlat21;
    ...
    u_xlat19 = unity_ShadowFadeCenterAndType.w * u_xlat15 + u_xlat19;
    ...
    u_xlat21 = texture(sampler2D(_ShadowMapTexture, sampler_ShadowMapTexture), u_xlat4.xy).x;
    u_xlat15 = (-u_xlat21) + u_xlat15;
    u_xlat19 = u_xlat19 * u_xlat15 + u_xlat21;
    u_xlat3.x = texture(sampler2D(_LightTexture0, sampler_LightTexture0), u_xlat3.xy).w;
