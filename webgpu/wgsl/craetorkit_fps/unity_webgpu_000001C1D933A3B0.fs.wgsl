...
fn main_1() {
  ...
  u_xlat1 = ((vec3<f32>(x_1600.z, x_1600.x, x_1600.y) * vec3<f32>(5.55555582f, 5.55555582f, 5.55555582f)) + vec3<f32>(0.047995999f, 0.047995999f, 0.047995999f));
  let x_1608 : vec3<f32> = u_xlat1;
  u_xlat1 = log2(x_1608);
  let x_1610 : vec3<f32> = u_xlat1;
  u_xlat1 = ((x_1610 * vec3<f32>(0.073499784f, 0.073499784f, 0.073499784f)) + vec3<f32>(0.386036009f, 0.386036009f, 0.386036009f));
  let x_1617 : vec3<f32> = u_xlat1;
  u_xlat1 = clamp(x_1617, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
  let x_1621 : vec3<f32> = u_xlat1;
  let x_1624 : vec3<f32> = x_26.x_Lut2D_Params;
  u_xlat11 = (x_1621 * vec3<f32>(x_1624.z, x_1624.z, x_1624.z));
  let x_1628 : f32 = u_xlat11.x;
  u_xlat11.x = floor(x_1628);
  let x_1632 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1634 : vec2<f32> = (vec2<f32>(x_1632.x, x_1632.y) * vec2<f32>(0.5f, 0.5f));
  let x_1635 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1634.x, x_1634.y, x_1635.z, x_1635.w);
  let x_1637 : vec3<f32> = u_xlat11;
  let x_1640 : vec3<f32> = x_26.x_Lut2D_Params;
  let x_1643 : vec4<f32> = u_xlat2;
  let x_1645 : vec2<f32> = ((vec2<f32>(x_1637.y, x_1637.z) * vec2<f32>(x_1640.x, x_1640.y)) + vec2<f32>(x_1643.x, x_1643.y));
  let x_1646 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1646.x, x_1645.x, x_1645.y, x_1646.w);
  let x_1649 : f32 = u_xlat11.x;
  let x_1651 : f32 = x_26.x_Lut2D_Params.y;
  let x_1654 : f32 = u_xlat2.y;
  u_xlat2.x = ((x_1649 * x_1651) + x_1654);
  let x_1662 : vec4<f32> = u_xlat2;
  let x_1664 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, vec2<f32>(x_1662.x, x_1662.z));
  let x_1665 : vec3<f32> = vec3<f32>(x_1664.x, x_1664.y, x_1664.z);
  let x_1666 : vec4<f32> = u_xlat3;
  u_xlat3 = vec4<f32>(x_1665.x, x_1665.y, x_1665.z, x_1666.w);
  let x_1669 : f32 = x_26.x_Lut2D_Params.y;
  u_xlat4.x = x_1669;
  u_xlat4.y = 0.0f;
  let x_1672 : vec4<f32> = u_xlat2;
  let x_1674 : vec4<f32> = u_xlat4;
  u_xlat21 = (vec2<f32>(x_1672.x, x_1672.z) + vec2<f32>(x_1674.x, x_1674.y));
  let x_1680 : vec2<f32> = u_xlat21;
  let x_1681 : vec4<f32> = textureSample(x_Lut2D, sampler_Lut2D, x_1680);
  let x_1682 : vec3<f32> = vec3<f32>(x_1681.x, x_1681.y, x_1681.z);
  let x_1683 : vec4<f32> = u_xlat2;
  u_xlat2 = vec4<f32>(x_1682.x, x_1682.y, x_1682.z, x_1683.w);
  let x_1686 : f32 = u_xlat1.x;
  let x_1688 : f32 = x_26.x_Lut2D_Params.z;
  let x_1691 : f32 = u_xlat11.x;
  u_xlat1.x = ((x_1686 * x_1688) + -(x_1691));
  let x_1695 : vec4<f32> = u_xlat3;
  let x_1698 : vec4<f32> = u_xlat2;
  u_xlat11 = (-(vec3<f32>(x_1695.x, x_1695.y, x_1695.z)) + vec3<f32>(x_1698.x, x_1698.y, x_1698.z));
  let x_1701 : vec3<f32> = u_xlat1;
  let x_1703 : vec3<f32> = u_xlat11;
  let x_1705 : vec4<f32> = u_xlat3;
  let x_1707 : vec3<f32> = ((vec3<f32>(x_1701.x, x_1701.x, x_1701.x) * x_1703) + vec3<f32>(x_1705.x, x_1705.y, x_1705.z));
  let x_1708 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_1707.x, x_1707.y, x_1707.z, x_1708.w);
  let x_1712 : f32 = x_26.x_LumaInAlpha;
  u_xlatb1 = (0.5f < x_1712);
  let x_1714 : bool = u_xlatb1;
  if (x_1714) {
    let x_1717 : vec4<f32> = u_xlat0;
    u_xlat1 = vec3<f32>(x_1717.x, x_1717.y, x_1717.z);
    let x_1719 : vec3<f32> = u_xlat1;
    u_xlat1 = clamp(x_1719, vec3<f32>(0.0f, 0.0f, 0.0f), vec3<f32>(1.0f, 1.0f, 1.0f));
    let x_1723 : vec3<f32> = u_xlat1;
    u_xlat0.w = dot(x_1723, vec3<f32>(0.212672904f, 0.715152204f, 0.072175004f));
  }
