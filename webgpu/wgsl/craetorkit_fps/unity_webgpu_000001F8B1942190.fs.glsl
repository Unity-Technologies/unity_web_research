...
float u_xlat22;
    ...
    u_xlat18 = u_xlat18 * u_xlat14.x;
    u_xlat14.xy = u_xlat0.yy * unity_WorldToLight[1].xy;
    u_xlat0.xy = unity_WorldToLight[0].xy * u_xlat0.xx + u_xlat14.xy;
    ...
    u_xlat18 = u_xlat8 * u_xlat18;
    u_xlat0.xyz = vec3(u_xlat18) * u_xlat0.xyz;
    SV_Target0.xyz = u_xlat1.xyw * u_xlat0.xyz + u_xlat3.xyz;
    SV_Target0.w = 1.0;
    return;
}
