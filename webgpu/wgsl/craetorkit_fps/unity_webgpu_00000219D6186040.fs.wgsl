...
fn main_1() {
  ...
  let x_613 : vec4<f32> = x_32.x_Grain_Params2;
  ...
  u_xlat16 = sqrt(x_648);
  let x_652 : f32 = x_32.x_Grain_Params1.x;
  ...
  let x_669 : f32 = x_32.x_Grain_Params1.y;
  let x_671 : f32 = x_32.x_Grain_Params1.y;
  ...
  let x_787 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  u_xlat5 = floor(x_793);
  let x_796 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  let x_805 : vec3<f32> = x_32.x_Lut2D_Params;
  ...
  let x_815 : f32 = x_32.x_Lut2D_Params.y;
  ...
  let x_833 : f32 = x_32.x_Lut2D_Params.y;
  u_xlat3.x = x_833;
  u_xlat3.y = 0.0f;
  ...
  let x_855 : f32 = x_32.x_Lut2D_Params.z;
  ...
  let x_969 : vec4<f32> = x_32.x_Dithering_Coords;
  let x_973 : vec4<f32> = x_32.x_Dithering_Coords;
