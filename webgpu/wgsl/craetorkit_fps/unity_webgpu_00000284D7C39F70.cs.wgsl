...
@group(0) @binding(0) var<storage, read> x_28 : x_HistogramBuffer;

var<workgroup> TGSM0 : array<S, 128u>;

@group(1) @binding(0) var<uniform> x_2845 : Params;

@group(0) @binding(1) var x_Destination_origX0X : texture_storage_2d<r32float, write>;
