...
fn main_1() {
  ...
  u_xlat22 = ((x_282 * x_285) + x_288);
  let x_290 : f32 = u_xlat22;
  u_xlat22 = clamp(x_290, 0.0f, 1.0f);
  let x_298 : f32 = x_49.unity_ProbeVolumeParams.x;
  u_xlatb23 = (x_298 == 1.0f);
  let x_300 : bool = u_xlatb23;
  if (x_300) {
  ...
  let x_833 : vec3<f32> = ((vec3<f32>(x_827.x, x_827.z, x_827.w) * vec3<f32>(x_829.x, x_829.z, x_829.w)) + x_832);
  let x_834 : vec4<f32> = u_xlat0;
  u_xlat0 = vec4<f32>(x_833.x, x_833.y, x_833.z, x_834.w);
  let x_838 : f32 = vs_TEXCOORD1.w;
  let x_840 : f32 = x_49.x_ProjectionParams.y;
  u_xlat21 = (x_838 / x_840);
  let x_842 : f32 = u_xlat21;
  u_xlat21 = (-(x_842) + 1.0f);
  let x_845 : f32 = u_xlat21;
  let x_847 : f32 = x_49.x_ProjectionParams.z;
  u_xlat21 = (x_845 * x_847);
  let x_849 : f32 = u_xlat21;
  u_xlat21 = max(x_849, 0.0f);
  let x_851 : f32 = u_xlat21;
  let x_854 : f32 = x_49.unity_FogParams.x;
  u_xlat21 = (x_851 * x_854);
  let x_856 : f32 = u_xlat21;
  let x_857 : f32 = u_xlat21;
  u_xlat21 = (x_856 * -(x_857));
  let x_860 : f32 = u_xlat21;
  u_xlat21 = exp2(x_860);
  let x_864 : vec4<f32> = u_xlat0;
  let x_866 : f32 = u_xlat21;
  let x_868 : vec3<f32> = (vec3<f32>(x_864.x, x_864.y, x_864.z) * vec3<f32>(x_866, x_866, x_866));
