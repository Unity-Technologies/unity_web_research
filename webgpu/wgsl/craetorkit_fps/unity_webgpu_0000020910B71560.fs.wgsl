...
fn main_1() {
  ...
  let x_307 : vec4<f32> = x_21.x_Color;
  u_xlat2 = ((vec3<f32>(x_304.x, x_304.y, x_304.z) * vec3<f32>(x_307.x, x_307.y, x_307.z)) + vec3<f32>(-0.039999999f, -0.039999999f, -0.039999999f));
  let x_313 : vec4<f32> = u_xlat1;
  let x_316 : vec4<f32> = x_21.x_Color;
  u_xlat1 = (vec4<f32>(x_313.w, x_313.x, x_313.y, x_313.z) * vec4<f32>(x_316.w, x_316.x, x_316.y, x_316.z));
  let x_321 : f32 = x_21.x_Metallic;
  let x_323 : f32 = x_21.x_Metallic;
  let x_325 : f32 = x_21.x_Metallic;
  let x_326 : vec3<f32> = vec3<f32>(x_321, x_323, x_325);
  let x_331 : vec3<f32> = u_xlat2;
  u_xlat2 = ((vec3<f32>(x_326.x, x_326.y, x_326.z) * x_331) + vec3<f32>(0.039999999f, 0.039999999f, 0.039999999f));
  let x_336 : f32 = u_xlat9;
  let x_338 : vec3<f32> = u_xlat2;
  u_xlat2 = (vec3<f32>(x_336, x_336, x_336) * x_338);
  let x_341 : f32 = x_21.x_Metallic;
  u_xlat9 = ((-(x_341) * 0.959999979f) + 0.959999979f);
  let x_347 : f32 = u_xlat9;
  let x_349 : vec4<f32> = u_xlat1;
  u_xlat4 = (vec3<f32>(x_347, x_347, x_347) * vec3<f32>(x_349.y, x_349.z, x_349.w));
  let x_352 : vec3<f32> = u_xlat4;
  let x_353 : vec4<f32> = u_xlat1;
  let x_356 : vec3<f32> = u_xlat2;
  u_xlat4 = ((x_352 * vec3<f32>(x_353.x, x_353.x, x_353.x)) + x_356);
  ...
  let x_371 : f32 = vs_TEXCOORD1.w;
  u_xlat9 = x_371;
  let x_372 : f32 = u_xlat9;
  u_xlat9 = clamp(x_372, 0.0f, 1.0f);
