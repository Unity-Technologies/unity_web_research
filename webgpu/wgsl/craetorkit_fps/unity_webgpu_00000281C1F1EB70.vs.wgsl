...
fn main_1() {
  ...
  let x_189 : f32 = u_xlat1.w;
  vs_TEXCOORD2.w = x_189;
  let x_191 : vec4<f32> = u_xlat0;
  let x_193 : vec4<f32> = u_xlat0;
  let x_195 : vec2<f32> = (vec2<f32>(x_191.z, x_191.z) + vec2<f32>(x_193.x, x_193.w));
  let x_196 : vec4<f32> = vs_TEXCOORD2;
  vs_TEXCOORD2 = vec4<f32>(x_195.x, x_195.y, x_196.z, x_196.w);
  return;
}
